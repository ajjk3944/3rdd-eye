...
public abstract class AbstractC3522d1 {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final C3520d G(ArrayList arrayList, int i10, int i11) {
    ...
    public static final void M(int[] iArr, int i10, int i11, boolean z10, boolean z11, boolean z12, int i12, int i13) {
        ...
        int i16 = z12 ? SQLiteDatabase.CREATE_IF_NECESSARY : 0;
        int i17 = i10 * 5;
        iArr[i17] = i11;
    ...
    public static final int U(ArrayList arrayList, int i10, int i11) {
        ...
        while (i12 <= size) {
            int i13 = (i12 + size) >>> 1;
            int iA = ((C3520d) arrayList.get(i13)).a();
            if (iA < 0) {
                iA += i11;
            }
            int iK = AbstractC6492s.k(iA, i10);
            if (iK < 0) {
                i12 = i13 + 1;
            } else {
                if (iK <= 0) {
    ...
    public static final void a0(int[] iArr, int i10, int i11) {
        AbstractC3546o.O(i11 >= 0 && i11 < 67108863);
        int i12 = (i10 * 5) + 1;
