...
public final class BouncyCastleSocketAdapter implements SocketAdapter {
    ...
    private static final DeferredSocketAdapter.Factory f56748b = new DeferredSocketAdapter.Factory() { // from class: okhttp3.internal.platform.android.BouncyCastleSocketAdapter$Companion$factory$1
        @Override // okhttp3.internal.platform.android.DeferredSocketAdapter.Factory
        public boolean a(SSLSocket sslSocket) {
            AbstractC6492s.i(sslSocket, "sslSocket");
            BouncyCastlePlatform.INSTANCE.b();
            return false;
        }
    ...
    public static final class Companion {
        ...
        public final DeferredSocketAdapter.Factory a() {
            return BouncyCastleSocketAdapter.f56748b;
        }
    ...
    public void c(SSLSocket sslSocket, String hostname, List protocols) {
        ...
        if (a(sslSocket)) {
            ...
            parameters.setApplicationProtocols((String[]) Platform.INSTANCE.b(protocols).toArray(new String[0]));
    ...
    public boolean isSupported() {
        return BouncyCastlePlatform.INSTANCE.b();
    }
}
