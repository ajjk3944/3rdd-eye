...
public abstract class k extends h implements List, RandomAccess {
    ...
    private static final c f4030b = new i(m.f4031e, 0);

    k() {
    }

    static k v(Object[] objArr, int i10) {
        return i10 == 0 ? m.f4031e : new m(objArr, i10);
    }
    ...
    public final c listIterator(int i10) {
        e.b(i10, size(), "index");
        return isEmpty() ? f4030b : new i(this, i10);
    }
    ...
    public k subList(int i10, int i11) {
        e.c(i10, i11, size());
        int i12 = i11 - i10;
        return i12 == size() ? this : i12 == 0 ? m.f4031e : new j(this, i10, i12);
    }
