...
public abstract class c {
    ...
    private static final ThreadLocal f63370a = new ThreadLocal();
    ...
    private static TypedValue c() {
        ThreadLocal threadLocal = f63370a;
    ...
    */
    private static android.content.res.ColorStateList e(android.content.res.Resources r17, org.xmlpull.v1.XmlPullParser r18, android.util.AttributeSet r19, android.content.res.Resources.Theme r20) throws org.xmlpull.v1.XmlPullParserException, java.io.IOException {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: v1.c.e(android.content.res.Resources, org.xmlpull.v1.XmlPullParser, android.util.AttributeSet, android.content.res.Resources$Theme):android.content.res.ColorStateList");
    }
    ...
    private static int g(int i10, float f10, float f11) {
        ...
        int iB = AbstractC8707a.b((int) ((Color.alpha(i10) * f10) + 0.5f), 0, 255);
        if (z10) {
            C8185a c8185aC = C8185a.c(i10);
            i10 = C8185a.m(c8185aC.j(), c8185aC.i(), f11);
        }
