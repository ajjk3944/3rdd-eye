...
public final class C7008G extends O {

    /* renamed from: f, reason: collision with root package name */
    private int f54880f;

    public /* synthetic */ C7008G(int i10, int i11, DefaultConstructorMarker defaultConstructorMarker) {
        this((i11 & 1) != 0 ? 6 : i10);
    }

    private final void h() {
        if (this.f54918d <= 8 || Long.compareUnsigned(Yg.E.b(Yg.E.b(this.f54919e) * 32), Yg.E.b(Yg.E.b(this.f54918d) * 25)) > 0) {
            o(S.e(this.f54918d));
        } else {
            i();
        }
    ...
    private final void i() {
        ...
        Object[] objArr2 = this.f54916b;
        long[] jArr2 = this.f54917c;
        S.a(jArr, i12);
        int i13 = 0;
        int i14 = 0;
        int iB = -1;
    ...
    private final int k(Object obj) {
        ...
        while (true) {
            ...
            if ((((~j10) << 6) & j10 & (-9187201950435737472L)) != 0) {
                int iJ = j(i11);
                if (this.f54880f == 0 && ((this.f54915a[iJ >> 3] >> ((iJ & 7) << 3)) & 255) != 254) {
                    h();
                    iJ = j(i11);
                }
                this.f54919e++;
                int i19 = this.f54880f;
                long[] jArr2 = this.f54915a;
                int i20 = iJ >> 3;
                long j14 = jArr2[i20];
                int i21 = (iJ & 7) << 3;
                this.f54880f = i19 - (((j14 >> i21) & 255) == 128 ? 1 : 0);
                int i22 = this.f54918d;
    ...
    private final void l() {
        this.f54880f = S.c(d()) - this.f54919e;
    }
    ...
    private final void n(int i10) {
        ...
        this.f54918d = iMax;
        m(iMax);
        this.f54916b = new Object[iMax];
        this.f54917c = new long[iMax];
    }
    ...
    private final void o(int i10) {
        ...
        int i12 = this.f54918d;
        n(i10);
        long[] jArr3 = this.f54915a;
        Object[] objArr2 = this.f54916b;
        long[] jArr4 = this.f54917c;
        int i13 = this.f54918d;
        int i14 = 0;
        while (i14 < i12) {
