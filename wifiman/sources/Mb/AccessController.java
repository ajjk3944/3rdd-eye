...
public final /* data */ class AccessController extends x {
    ...
    public static final Parcelable.Creator<AccessController> CREATOR = new c();

    /* renamed from: mb.a$a, reason: collision with other inner class name */
    public /* synthetic */ class C1954a implements M {

        /* renamed from: a, reason: collision with root package name */
        public static final C1954a f53746a;
        private static final Xi.f descriptor;

        static {
            C1954a c1954a = new C1954a();
            f53746a = c1954a;
            H0 h02 = new H0("access", c1954a, 13);
        ...
        public final AccessController c(Yi.e decoder) {
            int i10;
            Boolean bool;
            j jVar;
            String str;
            ...
            cVarC.b(fVar);
            return new AccessController(i10, bool, bool5, bool4, str2, bool3, bool2, gVar, iVar, controllerUi, str, num, str3, jVar, null);
        }

        @Override // Vi.o
        /* renamed from: h, reason: merged with bridge method [inline-methods] */
        public final void e(Yi.f encoder, AccessController value) {
            AbstractC6492s.i(encoder, "encoder");
            AbstractC6492s.i(value, "value");
            Xi.f fVar = descriptor;
            Yi.d dVarC = encoder.c(fVar);
            AccessController.r(value, dVarC, fVar);
            dVarC.b(fVar);
        }
    }
    ...
    public static final class c implements Parcelable.Creator {
        ...
        public final AccessController createFromParcel(Parcel parcel) {
            Boolean boolValueOf;
            ...
            return new AccessController(boolValueOf, boolValueOf2, boolValueOf3, string, boolValueOf4, boolValueOf5, parcel.readInt() == 0 ? null : g.valueOf(parcel.readString()), parcel.readInt() == 0 ? null : i.valueOf(parcel.readString()), ControllerUi.CREATOR.createFromParcel(parcel), parcel.readString(), parcel.readInt() == 0 ? null : Integer.valueOf(parcel.readInt()));
        }

        @Override // android.os.Parcelable.Creator
        /* renamed from: b, reason: merged with bridge method [inline-methods] */
        public final AccessController[] newArray(int i10) {
            return new AccessController[i10];
        }
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public /* synthetic */ AccessController(int i10, Boolean bool, Boolean bool2, Boolean bool3, String str, Boolean bool4, Boolean bool5, g gVar, i iVar, ControllerUi controllerUi, String str2, Integer num, String str3, j jVar, R0 r02) {
        super(i10, r02);
        if (256 != (i10 & PSKKeyManager.MAX_KEY_LENGTH_BYTES)) {
            C0.a(i10, PSKKeyManager.MAX_KEY_LENGTH_BYTES, C1954a.f53746a.a());
        }
        if ((i10 & 1) == 0) {
        ...
        this.name = (i10 & 2048) == 0 ? "access" : str3;
        this.controllerType = (i10 & 4096) == 0 ? j.ACCESS : jVar;
    }

    public static final /* synthetic */ void r(AccessController self, Yi.d output, Xi.f serialDesc) {
        ...
        if (output.o(serialDesc, 11) || !AbstractC6492s.d(self.getName(), "access")) {
            output.y(serialDesc, 11, self.getName());
        }
        if (!output.o(serialDesc, 12) && self.getControllerType() == j.ACCESS) {
            return;
        }
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof AccessController)) {
            return false;
        }
        AccessController accessController = (AccessController) other;
        return AbstractC6492s.d(this.isConfigured, accessController.isConfigured) && AbstractC6492s.d(this.isRunning, accessController.isRunning) && AbstractC6492s.d(this.isInstalled, accessController.isInstalled) && AbstractC6492s.d(this.version, accessController.version) && AbstractC6492s.d(this.required, accessController.required) && AbstractC6492s.d(this.harddriveRequired, accessController.harddriveRequired) && this.installState == accessController.installState && this.state == accessController.state && AbstractC6492s.d(this.ui, accessController.ui) && AbstractC6492s.d(this.updateAvailable, accessController.updateAvailable) && AbstractC6492s.d(this.updateProgress, accessController.updateProgress);
    }
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public AccessController(Boolean bool, Boolean bool2, Boolean bool3, String str, Boolean bool4, Boolean bool5, g gVar, i iVar, ControllerUi ui2, String str2, Integer num) {
        super(null);
