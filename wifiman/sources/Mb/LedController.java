...
public final /* data */ class LedController extends x {
    ...
    public static final Parcelable.Creator<LedController> CREATOR = new c();
    ...
    public /* synthetic */ class a implements M {
        ...
        public final LedController c(Yi.e decoder) {
            int i10;
            Boolean bool;
            j jVar;
            String str;
            ...
            cVarC.b(fVar);
            return new LedController(i10, bool, bool5, bool4, str2, bool3, bool2, gVar, iVar, controllerUi, str, num, str3, jVar, null);
        }

        @Override // Vi.o
        /* renamed from: h, reason: merged with bridge method [inline-methods] */
        public final void e(Yi.f encoder, LedController value) {
            AbstractC6492s.i(encoder, "encoder");
            AbstractC6492s.i(value, "value");
            Xi.f fVar = descriptor;
            Yi.d dVarC = encoder.c(fVar);
            LedController.r(value, dVarC, fVar);
            dVarC.b(fVar);
        }
    }

    /* renamed from: mb.q$b, reason: from kotlin metadata */
    ...
    public static final class c implements Parcelable.Creator {
        ...
        public final LedController createFromParcel(Parcel parcel) {
            Boolean boolValueOf;
            ...
            return new LedController(boolValueOf, boolValueOf2, boolValueOf3, string, boolValueOf4, boolValueOf5, parcel.readInt() == 0 ? null : g.valueOf(parcel.readString()), parcel.readInt() == 0 ? null : i.valueOf(parcel.readString()), ControllerUi.CREATOR.createFromParcel(parcel), parcel.readString(), parcel.readInt() == 0 ? null : Integer.valueOf(parcel.readInt()));
        }

        @Override // android.os.Parcelable.Creator
        /* renamed from: b, reason: merged with bridge method [inline-methods] */
        public final LedController[] newArray(int i10) {
            return new LedController[i10];
        }
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public /* synthetic */ LedController(int i10, Boolean bool, Boolean bool2, Boolean bool3, String str, Boolean bool4, Boolean bool5, g gVar, i iVar, ControllerUi controllerUi, String str2, Integer num, String str3, j jVar, R0 r02) {
        super(i10, r02);
        if (256 != (i10 & PSKKeyManager.MAX_KEY_LENGTH_BYTES)) {
            C0.a(i10, PSKKeyManager.MAX_KEY_LENGTH_BYTES, a.f53872a.a());
        }
        if ((i10 & 1) == 0) {
        ...
        this.name = (i10 & 2048) == 0 ? "led" : str3;
        this.controllerType = (i10 & 4096) == 0 ? j.LED : jVar;
    }

    public static final /* synthetic */ void r(LedController self, Yi.d output, Xi.f serialDesc) {
        ...
        if (output.o(serialDesc, 11) || !AbstractC6492s.d(self.getName(), "led")) {
            output.y(serialDesc, 11, self.getName());
        }
        if (!output.o(serialDesc, 12) && self.getControllerType() == j.LED) {
            return;
        }
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof LedController)) {
            return false;
        }
        LedController ledController = (LedController) other;
        return AbstractC6492s.d(this.isConfigured, ledController.isConfigured) && AbstractC6492s.d(this.isRunning, ledController.isRunning) && AbstractC6492s.d(this.isInstalled, ledController.isInstalled) && AbstractC6492s.d(this.version, ledController.version) && AbstractC6492s.d(this.required, ledController.required) && AbstractC6492s.d(this.harddriveRequired, ledController.harddriveRequired) && this.installState == ledController.installState && this.state == ledController.state && AbstractC6492s.d(this.ui, ledController.ui) && AbstractC6492s.d(this.updateAvailable, ledController.updateAvailable) && AbstractC6492s.d(this.updateProgress, ledController.updateProgress);
    }
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public LedController(Boolean bool, Boolean bool2, Boolean bool3, String str, Boolean bool4, Boolean bool5, g gVar, i iVar, ControllerUi ui2, String str2, Integer num) {
        super(null);
