...
public final /* data */ class DirectController extends x {
    ...
    public static final Parcelable.Creator<DirectController> CREATOR = new c();
    ...
    public /* synthetic */ class a implements M {
        ...
        public final DirectController c(Yi.e decoder) {
            boolean z10;
            int i10;
            String str;
            j jVar;
            ...
            cVarC.b(fVar);
            return new DirectController(i10, z10, z12, z11, str, bool2, bool, gVar, iVar, controllerUi, str2, num, str3, jVar, null);
        }

        @Override // Vi.o
        /* renamed from: h, reason: merged with bridge method [inline-methods] */
        public final void e(Yi.f encoder, DirectController value) {
            AbstractC6492s.i(encoder, "encoder");
            AbstractC6492s.i(value, "value");
            Xi.f fVar = descriptor;
            Yi.d dVarC = encoder.c(fVar);
            DirectController.r(value, dVarC, fVar);
            dVarC.b(fVar);
        }
    }

    /* renamed from: mb.n$b, reason: from kotlin metadata */
    ...
    public static final class c implements Parcelable.Creator {
        ...
        public final DirectController createFromParcel(Parcel parcel) {
            Boolean boolValueOf;
            ...
            return new DirectController(z10, z11, z12, string, boolValueOf, boolValueOf2, parcel.readInt() == 0 ? null : g.valueOf(parcel.readString()), parcel.readInt() == 0 ? null : i.valueOf(parcel.readString()), ControllerUi.CREATOR.createFromParcel(parcel), parcel.readString(), parcel.readInt() == 0 ? null : Integer.valueOf(parcel.readInt()));
        }

        @Override // android.os.Parcelable.Creator
        /* renamed from: b, reason: merged with bridge method [inline-methods] */
        public final DirectController[] newArray(int i10) {
            return new DirectController[i10];
        }
    }

    public /* synthetic */ DirectController(int i10, boolean z10, boolean z11, boolean z12, String str, Boolean bool, Boolean bool2, g gVar, i iVar, ControllerUi controllerUi, String str2, Integer num, String str3, j jVar, R0 r02) {
        super(i10, r02);
        if ((i10 & 1) == 0) {
        ...
        this.ui = (i10 & PSKKeyManager.MAX_KEY_LENGTH_BYTES) == 0 ? new ControllerUi(MqttTopic.TOPIC_LEVEL_SEPARATOR, MqttTopic.TOPIC_LEVEL_SEPARATOR, MqttTopic.TOPIC_LEVEL_SEPARATOR, null, 0, "", null) : controllerUi;
        if ((i10 & 512) == 0) {
        ...
        this.name = (i10 & 2048) == 0 ? "direct" : str3;
        this.controllerType = (i10 & 4096) == 0 ? j.UNKNOWN : jVar;
    }

    public static final /* synthetic */ void r(DirectController self, Yi.d output, Xi.f serialDesc) {
        ...
        if (output.o(serialDesc, 8) || !AbstractC6492s.d(self.getUi(), new ControllerUi(MqttTopic.TOPIC_LEVEL_SEPARATOR, MqttTopic.TOPIC_LEVEL_SEPARATOR, MqttTopic.TOPIC_LEVEL_SEPARATOR, null, 0, "", null))) {
        ...
        if (output.o(serialDesc, 11) || !AbstractC6492s.d(self.getName(), "direct")) {
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof DirectController)) {
            return false;
        }
        DirectController directController = (DirectController) other;
        return this.isConfigured == directController.isConfigured && this.isRunning == directController.isRunning && this.isInstalled == directController.isInstalled && AbstractC6492s.d(this.version, directController.version) && AbstractC6492s.d(this.required, directController.required) && AbstractC6492s.d(this.harddriveRequired, directController.harddriveRequired) && this.installState == directController.installState && this.state == directController.state && AbstractC6492s.d(this.ui, directController.ui) && AbstractC6492s.d(this.updateAvailable, directController.updateAvailable) && AbstractC6492s.d(this.updateProgress, directController.updateProgress);
    }
    ...
    public /* synthetic */ DirectController(boolean z10, boolean z11, boolean z12, String str, Boolean bool, Boolean bool2, g gVar, i iVar, ControllerUi controllerUi, String str2, Integer num, int i10, DefaultConstructorMarker defaultConstructorMarker) {
        this((i10 & 1) != 0 ? true : z10, (i10 & 2) != 0 ? true : z11, (i10 & 4) == 0 ? z12 : true, (i10 & 8) != 0 ? null : str, (i10 & 16) != 0 ? null : bool, (i10 & 32) != 0 ? null : bool2, (i10 & 64) != 0 ? null : gVar, (i10 & 128) != 0 ? null : iVar, (i10 & PSKKeyManager.MAX_KEY_LENGTH_BYTES) != 0 ? new ControllerUi(MqttTopic.TOPIC_LEVEL_SEPARATOR, MqttTopic.TOPIC_LEVEL_SEPARATOR, MqttTopic.TOPIC_LEVEL_SEPARATOR, null, 0, "", null) : controllerUi, (i10 & 512) != 0 ? null : str2, (i10 & 1024) == 0 ? num : null);
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public DirectController(boolean z10, boolean z11, boolean z12, String str, Boolean bool, Boolean bool2, g gVar, i iVar, ControllerUi ui2, String str2, Integer num) {
        super(null);
