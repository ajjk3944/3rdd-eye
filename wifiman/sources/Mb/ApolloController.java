...
public final /* data */ class ApolloController extends x {
    ...
    public static final Parcelable.Creator<ApolloController> CREATOR = new c();
    ...
    public /* synthetic */ class a implements M {
        ...
        public final ApolloController c(Yi.e decoder) {
            int i10;
            Boolean bool;
            j jVar;
            String str;
            ...
            cVarC.b(fVar);
            return new ApolloController(i10, bool, bool5, bool4, str2, bool3, bool2, gVar, iVar, controllerUi, str, num, str3, jVar, null);
        }

        @Override // Vi.o
        /* renamed from: h, reason: merged with bridge method [inline-methods] */
        public final void e(Yi.f encoder, ApolloController value) {
            AbstractC6492s.i(encoder, "encoder");
            AbstractC6492s.i(value, "value");
            Xi.f fVar = descriptor;
            Yi.d dVarC = encoder.c(fVar);
            ApolloController.r(value, dVarC, fVar);
            dVarC.b(fVar);
        }
    }
    ...
    public static final class c implements Parcelable.Creator {
        ...
        public final ApolloController createFromParcel(Parcel parcel) {
            Boolean boolValueOf;
            ...
            return new ApolloController(boolValueOf, boolValueOf2, boolValueOf3, string, boolValueOf4, boolValueOf5, parcel.readInt() == 0 ? null : g.valueOf(parcel.readString()), parcel.readInt() == 0 ? null : i.valueOf(parcel.readString()), ControllerUi.CREATOR.createFromParcel(parcel), parcel.readString(), parcel.readInt() == 0 ? null : Integer.valueOf(parcel.readInt()));
        }

        @Override // android.os.Parcelable.Creator
        /* renamed from: b, reason: merged with bridge method [inline-methods] */
        public final ApolloController[] newArray(int i10) {
            return new ApolloController[i10];
        }
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public /* synthetic */ ApolloController(int i10, Boolean bool, Boolean bool2, Boolean bool3, String str, Boolean bool4, Boolean bool5, g gVar, i iVar, ControllerUi controllerUi, String str2, Integer num, String str3, j jVar, R0 r02) {
        super(i10, r02);
        if (256 != (i10 & PSKKeyManager.MAX_KEY_LENGTH_BYTES)) {
            C0.a(i10, PSKKeyManager.MAX_KEY_LENGTH_BYTES, a.f53760a.a());
        }
        if ((i10 & 1) == 0) {
        ...
        this.name = (i10 & 2048) == 0 ? "apollo" : str3;
        this.controllerType = (i10 & 4096) == 0 ? j.APOLLO : jVar;
    }

    public static final /* synthetic */ void r(ApolloController self, Yi.d output, Xi.f serialDesc) {
        ...
        if (output.o(serialDesc, 11) || !AbstractC6492s.d(self.getName(), "apollo")) {
            output.y(serialDesc, 11, self.getName());
        }
        if (!output.o(serialDesc, 12) && self.getControllerType() == j.APOLLO) {
            return;
        }
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof ApolloController)) {
            return false;
        }
        ApolloController apolloController = (ApolloController) other;
        return AbstractC6492s.d(this.isConfigured, apolloController.isConfigured) && AbstractC6492s.d(this.isRunning, apolloController.isRunning) && AbstractC6492s.d(this.isInstalled, apolloController.isInstalled) && AbstractC6492s.d(this.version, apolloController.version) && AbstractC6492s.d(this.required, apolloController.required) && AbstractC6492s.d(this.harddriveRequired, apolloController.harddriveRequired) && this.installState == apolloController.installState && this.state == apolloController.state && AbstractC6492s.d(this.ui, apolloController.ui) && AbstractC6492s.d(this.updateAvailable, apolloController.updateAvailable) && AbstractC6492s.d(this.updateProgress, apolloController.updateProgress);
    }
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ApolloController(Boolean bool, Boolean bool2, Boolean bool3, String str, Boolean bool4, Boolean bool5, g gVar, i iVar, ControllerUi ui2, String str2, Integer num) {
        super(null);
