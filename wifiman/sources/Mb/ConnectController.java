...
public final /* data */ class ConnectController extends x {
    ...
    public static final Parcelable.Creator<ConnectController> CREATOR = new c();

    /* renamed from: mb.d$a */
    public /* synthetic */ class a implements M {

        /* renamed from: a, reason: collision with root package name */
        public static final a f53779a;
        private static final Xi.f descriptor;

        static {
            a aVar = new a();
            f53779a = aVar;
            H0 h02 = new H0("connect", aVar, 13);
        ...
        public final ConnectController c(Yi.e decoder) {
            int i10;
            Boolean bool;
            j jVar;
            String str;
            ...
            cVarC.b(fVar);
            return new ConnectController(i10, bool, bool5, bool4, str2, bool3, bool2, gVar, iVar, controllerUi, str, num, str3, jVar, null);
        }

        @Override // Vi.o
        /* renamed from: h, reason: merged with bridge method [inline-methods] */
        public final void e(Yi.f encoder, ConnectController value) {
            AbstractC6492s.i(encoder, "encoder");
            AbstractC6492s.i(value, "value");
            Xi.f fVar = descriptor;
            Yi.d dVarC = encoder.c(fVar);
            ConnectController.r(value, dVarC, fVar);
            dVarC.b(fVar);
        }
    }
    ...
    public static final class c implements Parcelable.Creator {
        ...
        public final ConnectController createFromParcel(Parcel parcel) {
            Boolean boolValueOf;
            ...
            return new ConnectController(boolValueOf, boolValueOf2, boolValueOf3, string, boolValueOf4, boolValueOf5, parcel.readInt() == 0 ? null : g.valueOf(parcel.readString()), parcel.readInt() == 0 ? null : i.valueOf(parcel.readString()), ControllerUi.CREATOR.createFromParcel(parcel), parcel.readString(), parcel.readInt() == 0 ? null : Integer.valueOf(parcel.readInt()));
        }

        @Override // android.os.Parcelable.Creator
        /* renamed from: b, reason: merged with bridge method [inline-methods] */
        public final ConnectController[] newArray(int i10) {
            return new ConnectController[i10];
        }
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public /* synthetic */ ConnectController(int i10, Boolean bool, Boolean bool2, Boolean bool3, String str, Boolean bool4, Boolean bool5, g gVar, i iVar, ControllerUi controllerUi, String str2, Integer num, String str3, j jVar, R0 r02) {
        super(i10, r02);
        if (256 != (i10 & PSKKeyManager.MAX_KEY_LENGTH_BYTES)) {
            C0.a(i10, PSKKeyManager.MAX_KEY_LENGTH_BYTES, a.f53779a.a());
        }
        if ((i10 & 1) == 0) {
        ...
        this.name = (i10 & 2048) == 0 ? "connect" : str3;
        this.controllerType = (i10 & 4096) == 0 ? j.CONNECT : jVar;
    }

    public static final /* synthetic */ void r(ConnectController self, Yi.d output, Xi.f serialDesc) {
        ...
        if (output.o(serialDesc, 11) || !AbstractC6492s.d(self.getName(), "connect")) {
            output.y(serialDesc, 11, self.getName());
        }
        if (!output.o(serialDesc, 12) && self.getControllerType() == j.CONNECT) {
            return;
        }
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof ConnectController)) {
            return false;
        }
        ConnectController connectController = (ConnectController) other;
        return AbstractC6492s.d(this.isConfigured, connectController.isConfigured) && AbstractC6492s.d(this.isRunning, connectController.isRunning) && AbstractC6492s.d(this.isInstalled, connectController.isInstalled) && AbstractC6492s.d(this.version, connectController.version) && AbstractC6492s.d(this.required, connectController.required) && AbstractC6492s.d(this.harddriveRequired, connectController.harddriveRequired) && this.installState == connectController.installState && this.state == connectController.state && AbstractC6492s.d(this.ui, connectController.ui) && AbstractC6492s.d(this.updateAvailable, connectController.updateAvailable) && AbstractC6492s.d(this.updateProgress, connectController.updateProgress);
    }
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ConnectController(Boolean bool, Boolean bool2, Boolean bool3, String str, Boolean bool4, Boolean bool5, g gVar, i iVar, ControllerUi ui2, String str2, Integer num) {
        super(null);
