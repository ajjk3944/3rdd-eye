...
public class ThreadUtils {
        ...
        handler.post(new Runnable() { // from class: org.webrtc.ThreadUtils.3
            ...
            public void run() {
                try {
                    ...
                    c1CaughtException.f57212e = e11;
                }
                countDownLatch.countDown();
            }
        });
        awaitUninterruptibly(countDownLatch);
        if (c1CaughtException.f57212e == null) {
            return c1Result.value;
        }
        RuntimeException runtimeException = new RuntimeException(c1CaughtException.f57212e);
        runtimeException.setStackTrace(concatStackTraces(c1CaughtException.f57212e.getStackTrace(), runtimeException.getStackTrace()));
        throw runtimeException;
    }

    public static boolean joinUninterruptibly(Thread thread, long j10) throws InterruptedException {
    ...
    public static boolean awaitUninterruptibly(CountDownLatch countDownLatch, long j10) throws InterruptedException {
        long jElapsedRealtime = SystemClock.elapsedRealtime();
