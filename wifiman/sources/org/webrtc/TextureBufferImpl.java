...
public class TextureBufferImpl implements VideoFrame.TextureBuffer {
    ...
    public VideoFrame.Buffer cropAndScale(int i10, int i11, int i12, int i13, int i14, int i15) {
        ...
        matrix.preTranslate(i10 / this.width, (r0 - (i11 + i13)) / this.height);
    ...
    public VideoFrame.I420Buffer toI420() {
        return (VideoFrame.I420Buffer) ThreadUtils.invokeAtFrontUninterruptibly(this.toI420Handler, new Callable() { // from class: org.webrtc.q0
            @Override // java.util.concurrent.Callable
            public final Object call() {
                return this.f57243a.lambda$toI420$1();
            }
        });
    }
    ...
    private TextureBufferImpl(int i10, int i11, int i12, int i13, VideoFrame.TextureBuffer.Type type, int i14, Matrix matrix, Handler handler, YuvConverter yuvConverter, final RefCountMonitor refCountMonitor) {
        ...
        this.refCountDelegate = new RefCountDelegate(new Runnable() { // from class: org.webrtc.p0
            @Override // java.lang.Runnable
            public final void run() {
                this.f57241a.lambda$new$0(refCountMonitor);
            }
        });
    ...
    private TextureBufferImpl applyTransformMatrix(Matrix matrix, int i10, int i11, int i12, int i13) {
        ...
        retain();
        return new TextureBufferImpl(i10, i11, i12, i13, this.type, this.f57211id, matrix2, this.toI420Handler, this.yuvConverter, new RefCountMonitor() { // from class: org.webrtc.TextureBufferImpl.2
            @Override // org.webrtc.TextureBufferImpl.RefCountMonitor
            public void onDestroy(TextureBufferImpl textureBufferImpl) {
