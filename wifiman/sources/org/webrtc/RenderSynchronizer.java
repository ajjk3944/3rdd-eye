...
public final class RenderSynchronizer {
    ...
    public /* synthetic */ void lambda$registerListener$1() {
        this.choreographer.postFrameCallback(new c0(this));
    }
        ...
        synchronized (this.lock) {
            try {
                if (!this.isListening) {
                    ...
                    this.mainThreadHandler.post(new Runnable() { // from class: org.webrtc.b0
                        @Override // java.lang.Runnable
                        public final void run() {
                            this.f57218a.lambda$registerListener$1();
                        }
                    });
                }
            } catch (Throwable th2) {
