...
public class JavaI420Buffer implements VideoFrame.I420Buffer {
    ...
    public static JavaI420Buffer allocate(int i10, int i11) {
        ...
        return new JavaI420Buffer(i10, i11, byteBufferSlice, i10, byteBufferSlice2, i13, byteBufferNativeAllocateByteBuffer.slice(), i13, new Runnable() { // from class: org.webrtc.N
    ...
    public static VideoFrame.Buffer cropAndScaleI420(final VideoFrame.I420Buffer i420Buffer, int i10, int i11, int i12, int i13, int i14, int i15) {
        ...
        int i17 = i11 / 2;
        i420Buffer.retain();
        return wrap(i14, i15, dataY.slice(), i420Buffer.getStrideY(), dataU.slice(), i420Buffer.getStrideU(), dataV.slice(), i420Buffer.getStrideV(), new Runnable() { // from class: org.webrtc.M
            @Override // java.lang.Runnable
            public final void run() {
                i420Buffer.release();
            }
