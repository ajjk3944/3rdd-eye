...
class Camera2Session implements CameraSession {
            ...
            try {
                ...
                Camera2Session.this.surfaceTextureHelper.startListening(new VideoSink() { // from class: org.webrtc.f
                    ...
                    public final void onFrame(VideoFrame videoFrame) {
                        this.f57224a.lambda$onConfigured$0(videoFrame);
                    }
                });
    ...
    private Camera2Session(CameraSession.CreateSessionCallback createSessionCallback, CameraSession.Events events, Context context, CameraManager cameraManager, SurfaceTextureHelper surfaceTextureHelper, String str, int i10, int i11, int i12) throws CameraAccessException {
