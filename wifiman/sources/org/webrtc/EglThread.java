...
public class EglThread implements RenderSynchronizer.Listener {
    ...
    public static EglThread create(ReleaseMonitor releaseMonitor, final EglBase.Context context, final int[] iArr, RenderSynchronizer renderSynchronizer) {
        ...
        EglBase.EglConnection eglConnection = (EglBase.EglConnection) ThreadUtils.invokeAtFrontUninterruptibly(handlerWithExceptionCallbacks, new Callable() { // from class: org.webrtc.B
        ...
        if (releaseMonitor == null) {
            releaseMonitor = new ReleaseMonitor() { // from class: org.webrtc.C
    ...
    public void onRenderWindowClose() {
        this.handler.post(new Runnable() { // from class: org.webrtc.E
            @Override // java.lang.Runnable
            public final void run() {
                this.f57199a.lambda$onRenderWindowClose$3();
            }
        });
    }
    ...
    public void onRenderWindowOpen() {
        this.handler.post(new Runnable() { // from class: org.webrtc.D
            @Override // java.lang.Runnable
            public final void run() {
                this.f57197a.lambda$onRenderWindowOpen$2();
            }
        });
    }
    ...
    public void release() {
        if (this.releaseMonitor.onRelease(this)) {
            ...
            handlerWithExceptionCallbacks.post(new Runnable() { // from class: org.webrtc.F
                @Override // java.lang.Runnable
                public final void run() {
