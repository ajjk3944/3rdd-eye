...
public final class GCMParameters extends AlgorithmParametersSpi {
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    th = th2;
                    long j12 = jAsn1_write_sequence;
                    jAsn1_write_sequence = j10;
                    jAsn1_write_init = j12;
                    NativeCrypto.asn1_write_free(jAsn1_write_sequence);
                    NativeCrypto.asn1_write_free(jAsn1_write_init);
                    throw th;
                }
    ...
    @Override // java.security.AlgorithmParametersSpi
    protected void engineInit(AlgorithmParameterSpec algorithmParameterSpec) throws NoSuchMethodException, InvalidParameterSpecException, ClassNotFoundException, SecurityException {
