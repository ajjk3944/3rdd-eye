...
final class ConscryptServerSocket extends SSLServerSocket {
    ...
    ConscryptServerSocket(int i10, SSLParametersImpl sSLParametersImpl) throws IOException {
        super(i10);
        this.sslParameters = sSLParametersImpl;
    }

    ConscryptServerSocket(int i10, int i11, SSLParametersImpl sSLParametersImpl) throws IOException {
        super(i10, i11);
        this.sslParameters = sSLParametersImpl;
    }

    ConscryptServerSocket(int i10, int i11, InetAddress inetAddress, SSLParametersImpl sSLParametersImpl) throws IOException {
