...
public abstract class OpenSSLAeadCipherAES extends OpenSSLAeadCipher {
    ...
    protected AlgorithmParameters engineGetParameters() throws NoSuchAlgorithmException, InvalidParameterSpecException, ClassNotFoundException {
        byte[] bArr = this.iv;
        if (bArr == null) {
            return null;
        }
    ...
    @Override // org.conscrypt.OpenSSLCipher
    protected AlgorithmParameterSpec getParameterSpec(AlgorithmParameters algorithmParameters) throws ClassNotFoundException, InvalidAlgorithmParameterException {
