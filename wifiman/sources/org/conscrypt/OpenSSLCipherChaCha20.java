...
public class OpenSSLCipherChaCha20 extends OpenSSLCipher {
    ...
    int updateInternal(byte[] bArr, int i10, int i11, byte[] bArr2, int i12, int i13) throws ShortBufferException {
        ...
        if (i17 > 0) {
            int iMin = Math.min(64 - i17, i11);
            byte[] bArr3 = new byte[64];
            byte[] bArr4 = new byte[64];
            System.arraycopy(bArr, i10, bArr3, this.currentBlockConsumedBytes, iMin);
            NativeCrypto.chacha20_encrypt_decrypt(bArr3, 0, bArr4, 0, 64, this.encodedKey, this.iv, this.blockCounter);
            System.arraycopy(bArr4, this.currentBlockConsumedBytes, bArr2, i12, iMin);
            int i18 = this.currentBlockConsumedBytes + iMin;
