...
final class SSLUtils {
    ...
    static String[] decodeProtocols(byte[] bArr) {
        ...
        while (i10 < bArr.length) {
            byte b11 = bArr[i10];
            int i14 = i13 + 1;
            strArr[i13] = b11 > 0 ? new String(bArr, i10 + 1, b11, US_ASCII) : "";
            i10 += b11 + 1;
            i13 = i14;
        }
        return strArr;
    ...
    static String getClientKeyTypeFromSignatureAlg(int i10) {
        int iSSL_get_signature_algorithm_key_type = NativeCrypto.SSL_get_signature_algorithm_key_type(i10);
    ...
    static String getServerX509KeyType(long j10) {
        String strSSL_CIPHER_get_kx_name = NativeCrypto.SSL_CIPHER_get_kx_name(j10);
    ...
    static javax.security.cert.X509Certificate[] toCertificateChain(X509Certificate[] x509CertificateArr) throws Throwable {
        try {
    ...
    static SSLException toSSLException(Throwable th2) {
        return th2 instanceof SSLException ? (SSLException) th2 : new SSLException(th2);
    }

    static SSLHandshakeException toSSLHandshakeException(Throwable th2) {
