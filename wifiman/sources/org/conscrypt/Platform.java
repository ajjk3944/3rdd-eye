...
final class Platform {
    ...
    static AlgorithmParameterSpec fromGCMParameters(AlgorithmParameters algorithmParameters) throws ClassNotFoundException {
        Class<?> cls;
        try {
            cls = Class.forName("javax.crypto.spec.GCMParameterSpec");
        } catch (ClassNotFoundException unused) {
    ...
    public static void setSocketWriteTimeout(Socket socket, long j10) throws IllegalAccessException, SocketException, NoSuchFieldException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
        try {
            ...
            Object objInvoke = declaredMethod.invoke(null, Long.valueOf(j10));
    ...
    public static AlgorithmParameterSpec toGCMParameterSpec(int i10, byte[] bArr) throws ClassNotFoundException {
        Class<?> cls;
        try {
            cls = Class.forName("javax.crypto.spec.GCMParameterSpec");
        } catch (ClassNotFoundException unused) {
    ...
    static ConscryptEngineSocket createEngineSocket(String str, int i10, SSLParametersImpl sSLParametersImpl) throws IOException {
        return new Java8EngineSocket(str, i10, sSLParametersImpl);
    }

    static ConscryptFileDescriptorSocket createFileDescriptorSocket(String str, int i10, SSLParametersImpl sSLParametersImpl) throws IOException {
        return new Java8FileDescriptorSocket(str, i10, sSLParametersImpl);
    }

    static ConscryptEngineSocket createEngineSocket(InetAddress inetAddress, int i10, SSLParametersImpl sSLParametersImpl) throws IOException {
        return new Java8EngineSocket(inetAddress, i10, sSLParametersImpl);
    }

    static ConscryptFileDescriptorSocket createFileDescriptorSocket(InetAddress inetAddress, int i10, SSLParametersImpl sSLParametersImpl) throws IOException {
        return new Java8FileDescriptorSocket(inetAddress, i10, sSLParametersImpl);
    }

    static ConscryptEngineSocket createEngineSocket(String str, int i10, InetAddress inetAddress, int i11, SSLParametersImpl sSLParametersImpl) throws IOException {
        return new Java8EngineSocket(str, i10, inetAddress, i11, sSLParametersImpl);
    }

    static ConscryptFileDescriptorSocket createFileDescriptorSocket(String str, int i10, InetAddress inetAddress, int i11, SSLParametersImpl sSLParametersImpl) throws IOException {
    ...
    static ConscryptEngineSocket createEngineSocket(InetAddress inetAddress, int i10, InetAddress inetAddress2, int i11, SSLParametersImpl sSLParametersImpl) throws IOException {
        return new Java8EngineSocket(inetAddress, i10, inetAddress2, i11, sSLParametersImpl);
    }

    static ConscryptFileDescriptorSocket createFileDescriptorSocket(InetAddress inetAddress, int i10, InetAddress inetAddress2, int i11, SSLParametersImpl sSLParametersImpl) throws IOException {
    ...
    static ConscryptEngineSocket createEngineSocket(Socket socket, String str, int i10, boolean z10, SSLParametersImpl sSLParametersImpl) throws IOException {
        return new Java8EngineSocket(socket, str, i10, z10, sSLParametersImpl);
    }

    static ConscryptFileDescriptorSocket createFileDescriptorSocket(Socket socket, String str, int i10, boolean z10, SSLParametersImpl sSLParametersImpl) throws IOException {
