...
abstract class AbstractConscryptSocket extends SSLSocket {
    ...
    void setHandshakeTimeout(int i10) throws SocketException {
    ...
    void setSoWriteTimeout(int i10) throws SocketException {
    ...
    AbstractConscryptSocket(String str, int i10) throws IOException {
        super(str, i10);
        this.peerInfoProvider = new PeerInfoProvider() { // from class: org.conscrypt.AbstractConscryptSocket.1
            @Override // org.conscrypt.PeerInfoProvider
            String getHostname() {
    ...
    AbstractConscryptSocket(InetAddress inetAddress, int i10) throws IOException {
    ...
    AbstractConscryptSocket(String str, int i10, InetAddress inetAddress, int i11) throws IOException {
    ...
    AbstractConscryptSocket(InetAddress inetAddress, int i10, InetAddress inetAddress2, int i11) throws IOException {
    ...
    AbstractConscryptSocket(Socket socket, String str, int i10, boolean z10) throws IOException {
        this.peerInfoProvider = new PeerInfoProvider() { // from class: org.conscrypt.AbstractConscryptSocket.1
            @Override // org.conscrypt.PeerInfoProvider
            String getHostname() {
                return AbstractConscryptSocket.this.getHostname();
