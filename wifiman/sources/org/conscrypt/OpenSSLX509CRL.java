...
final class OpenSSLX509CRL extends X509CRL {
    ...
    private OpenSSLX509CRL(long j10) throws OpenSSLX509CertificateFactory.ParsingException {
        this.mContext = j10;
    ...
    static List<OpenSSLX509CRL> fromPkcs7DerInputStream(InputStream inputStream) throws OpenSSLX509CertificateFactory.ParsingException {
        ...
        try {
            try {
                ...
                for (long j10 : jArrD2i_PKCS7_bio) {
                    if (j10 != 0) {
    ...
    static List<OpenSSLX509CRL> fromPkcs7PemInputStream(InputStream inputStream) throws OpenSSLX509CertificateFactory.ParsingException {
        ...
        try {
            try {
                ...
                for (long j10 : jArrPEM_read_bio_PKCS7) {
                    if (j10 != 0) {
                        arrayList.add(new OpenSSLX509CRL(j10));
                    }
                }
    ...
    static Date toDate(long j10) throws OpenSSLX509CertificateFactory.ParsingException {
    ...
    public Set<? extends X509CRLEntry> getRevokedCertificates() {
        ...
        for (long j10 : jArrX509_CRL_get_REVOKED) {
            try {
