...
public class OpenSSLSignature extends SignatureSpi {
    ...
    static abstract class RSAPKCS1Padding extends OpenSSLSignature {
        ...
        protected final void configureEVP_PKEY_CTX(long j10) throws InvalidAlgorithmParameterException {
    ...
    private void initInternal(OpenSSLKey openSSLKey, boolean z10) throws InvalidKeyException {
    ...
    protected void configureEVP_PKEY_CTX(long j10) throws InvalidAlgorithmParameterException {
    }
    ...
    protected void engineUpdate(ByteBuffer byteBuffer) {
        if (byteBuffer.hasRemaining()) {
            ...
            if (iPosition >= 0) {
                long j10 = directBufferAddress + iPosition;
                int iRemaining = byteBuffer.remaining();
                if (iRemaining >= 0) {
                    NativeRef.EVP_MD_CTX evp_md_ctx = this.ctx;
                    if (this.signing) {
                        NativeCrypto.EVP_DigestSignUpdateDirect(evp_md_ctx, j10, iRemaining);
                    } else {
                        NativeCrypto.EVP_DigestVerifyUpdateDirect(evp_md_ctx, j10, iRemaining);
                    }
