...
final class OpenSSLKey {
    ...
    static PrivateKey getPrivateKey(PKCS8EncodedKeySpec pKCS8EncodedKeySpec, int i10) throws InvalidKeySpecException {
        try {
    ...
    static PublicKey getPublicKey(X509EncodedKeySpec x509EncodedKeySpec, int i10) throws InvalidKeySpecException {
        try {
