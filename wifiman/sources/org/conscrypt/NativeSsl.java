...
final class NativeSsl {
    ...
    final class BioWrapper {
        ...
        int readDirectByteBuffer(long j10, int i10) throws IOException {
        ...
        int writeDirectByteBuffer(long j10, int i10) throws IOException {
    ...
    void doHandshake(FileDescriptor fileDescriptor, int i10) throws IOException, CertificateException {
    ...
    void offerToResumeSession(long j10) throws SSLException {
        NativeCrypto.SSL_set_session(this.ssl, this, j10);
    }

    int read(FileDescriptor fileDescriptor, byte[] bArr, int i10, int i11, int i12) throws IOException {
        this.lock.readLock().lock();
        try {
            if (isClosed() || fileDescriptor == null || !fileDescriptor.valid()) {
                throw new SocketException("Socket is closed");
    ...
    int readDirectByteBuffer(long j10, int i10) throws IOException, CertificateException {
        this.lock.readLock().lock();
        try {
    ...
    void write(FileDescriptor fileDescriptor, byte[] bArr, int i10, int i11, int i12) throws IOException {
        this.lock.readLock().lock();
        try {
            if (isClosed() || fileDescriptor == null || !fileDescriptor.valid()) {
                throw new SocketException("Socket is closed");
