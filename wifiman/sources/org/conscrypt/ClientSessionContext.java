...
public final class ClientSessionContext extends AbstractSessionContext {
    ...
    private NativeSslSession getSession(String str, int i10) {
        ...
        if (sSLClientSessionCache == null || (sessionData = sSLClientSessionCache.getSessionData(str, i10)) == null || (nativeSslSessionNewInstance = NativeSslSession.newInstance(this, sessionData, str, i10)) == null || !nativeSslSessionNewInstance.isValid()) {
            return null;
        }
