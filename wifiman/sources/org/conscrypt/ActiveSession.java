...
final class ActiveSession implements ConscryptSession {
    ...
    public int getApplicationBufferSize() {
        return TLSTM.TLS_MAX_FRAGMENT_SIZE;
    }
    ...
    @Override // javax.net.ssl.SSLSession
    public byte[] getId() {
        if (this.f56891id == null) {
            synchronized (this.ssl) {
                this.f56891id = this.ssl.getSessionId();
            }
        }
        byte[] bArr = this.f56891id;
    ...
    void onPeerCertificateAvailable(String str, int i10) throws CertificateException {
        synchronized (this.ssl) {
            try {
                this.f56891id = null;
                if (this.localCertificates == null) {
