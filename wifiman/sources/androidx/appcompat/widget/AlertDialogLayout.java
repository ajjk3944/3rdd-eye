    ...
    private boolean C(int i10, int i11) {
        ...
        for (int i12 = 0; i12 < childCount; i12++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (id2 == AbstractC5932f.f48027E) {
                    view = childAt;
                } else if (id2 == AbstractC5932f.f48038k) {
                    view2 = childAt;
                } else {
                    if ((id2 != AbstractC5932f.f48040m && id2 != AbstractC5932f.f48042o) || view3 != null) {
                        return false;
                    }
                    view3 = childAt;
                }
    ...
    */
    protected void onLayout(boolean r18, int r19, int r20, int r21, int r22) {
        ...
        L7e:
            ...
            int r2 = F1.AbstractC2771s.b(r2, r3)
            r2 = r2 & 7
            r3 = 1
            if (r2 == r3) goto L98
            r3 = 5
