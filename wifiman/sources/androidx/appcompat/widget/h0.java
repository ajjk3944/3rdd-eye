...
public class h0 extends U {
    ...
    private static boolean f27403c = false;
    ...
    public h0(Context context, Resources resources) {
        super(resources);
        this.f27404b = new WeakReference(context);
    }
    ...
    public Drawable getDrawable(int i10) {
        Context context = (Context) this.f27404b.get();
        return context != null ? T.g().s(context, this, i10) : a(i10);
    }
