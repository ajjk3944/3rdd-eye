...
abstract class AbstractC3898x {
    ...
    private static final class a {
        static boolean a(DragEvent dragEvent, TextView textView, Activity activity) {
            ...
            try {
                ...
                F1.W.c0(textView, new C2742d.a(dragEvent.getClipData(), 3).a());
        ...
        static boolean b(DragEvent dragEvent, View view, Activity activity) {
            activity.requestDragAndDropPermissions(dragEvent);
            F1.W.c0(view, new C2742d.a(dragEvent.getClipData(), 3).a());
            return true;
        }
    }

    static boolean a(View view, DragEvent dragEvent) {
        if (Build.VERSION.SDK_INT < 31 && dragEvent.getLocalState() == null && F1.W.C(view) != null) {
    ...
    static boolean b(TextView textView, int i10) {
        if (Build.VERSION.SDK_INT >= 31 || F1.W.C(textView) == null || !(i10 == 16908322 || i10 == 16908337)) {
            return false;
        }
        ClipboardManager clipboardManager = (ClipboardManager) textView.getContext().getSystemService("clipboard");
        ClipData primaryClip = clipboardManager == null ? null : clipboardManager.getPrimaryClip();
        if (primaryClip != null && primaryClip.getItemCount() > 0) {
            F1.W.c0(textView, new C2742d.a(primaryClip, 1).c(i10 != 16908322 ? 1 : 0).a());
        }
        return true;
    }
