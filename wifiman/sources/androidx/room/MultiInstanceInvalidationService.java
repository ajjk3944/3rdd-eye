...
@Metadata(d1 = {"\u0000B\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\b\u0007\n\u0002\u0010%\n\u0002\u0010\u000e\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0003\b\u0007\u0018\u00002\u00020\u0001B\u0007¢\u0006\u0004\b\u0002\u0010\u0003J\u0017\u0010\u0007\u001a\u00020\u00062\u0006\u0010\u0005\u001a\u00020\u0004H\u0016¢\u0006\u0004\b\u0007\u0010\bR\"\u0010\u0010\u001a\u00020\t8\u0000@\u0000X\u0080\u000e¢\u0006\u0012\n\u0004\b\n\u0010\u000b\u001a\u0004\b\f\u0010\r\"\u0004\b\u000e\u0010\u000fR&\u0010\u0016\u001a\u000e\u0012\u0004\u0012\u00020\t\u0012\u0004\u0012\u00020\u00120\u00118\u0000X\u0080\u0004¢\u0006\f\n\u0004\b\u0013\u0010\u0014\u001a\u0004\b\u0013\u0010\u0015R \u0010\u001b\u001a\b\u0012\u0004\u0012\u00020\u00180\u00178\u0000X\u0080\u0004¢\u0006\f\n\u0004\b\f\u0010\u0019\u001a\u0004\b\n\u0010\u001aR\u0014\u0010\u001e\u001a\u00020\u001c8\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u000e\u0010\u001d¨\u0006\u001f"}, d2 = {"Landroidx/room/MultiInstanceInvalidationService;", "Landroid/app/Service;", "<init>", "()V", "Landroid/content/Intent;", "intent", "Landroid/os/IBinder;", "onBind", "(Landroid/content/Intent;)Landroid/os/IBinder;", "", SnmpConfigurator.O_AUTH_PROTOCOL, "I", SnmpConfigurator.O_COMMUNITY, "()I", "d", "(I)V", "maxClientId", "", "", SnmpConfigurator.O_BIND_ADDRESS, "Ljava/util/Map;", "()Ljava/util/Map;", "clientNames", "Landroid/os/RemoteCallbackList;", "Landroidx/room/a;", "Landroid/os/RemoteCallbackList;", "()Landroid/os/RemoteCallbackList;", "callbackList", "Landroidx/room/b$a;", "Landroidx/room/b$a;", "binder", "room-runtime_release"}, k = 1, mv = {1, 8, 0}, xi = 48)
...
public final class MultiInstanceInvalidationService extends Service {
    ...
    public static final class a extends b.a {
        ...
        public void f0(int i10, String[] tables) {
            ...
            synchronized (callbackList) {
                ...
                for (int i11 = 0; i11 < iBeginBroadcast; i11++) {
                    try {
                        ...
                        AbstractC6492s.g(broadcastCookie, "null cannot be cast to non-null type kotlin.Int");
                        Integer num = (Integer) broadcastCookie;
                        int iIntValue = num.intValue();
                        String str2 = (String) multiInstanceInvalidationService.getClientNames().get(num);
                        if (i10 != iIntValue && AbstractC6492s.d(str, str2)) {
                            try {
                                ((androidx.room.a) multiInstanceInvalidationService.getCallbackList().getBroadcastItem(i11)).r(tables);
        ...
        @Override // androidx.room.b
        public void l0(androidx.room.a callback, int i10) {
        ...
        @Override // androidx.room.b
        public int y(androidx.room.a callback, String str) {
            AbstractC6492s.i(callback, "callback");
            int i10 = 0;
            if (str == null) {
                return 0;
