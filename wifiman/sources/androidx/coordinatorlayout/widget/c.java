...
public abstract class c {
    ...
    private static final ThreadLocal f30664a = new ThreadLocal();

    /* renamed from: b, reason: collision with root package name */
    private static final ThreadLocal f30665b = new ThreadLocal();
    ...
    static void c(ViewGroup viewGroup, View view, Rect rect) {
        ThreadLocal threadLocal = f30664a;
        ...
        ThreadLocal threadLocal2 = f30665b;
