...
public final class FragmentContainerView extends FrameLayout {
    ...
    public static final class a {
        ...
        public final WindowInsets a(View.OnApplyWindowInsetsListener onApplyWindowInsetsListener, View v10, WindowInsets insets) {
            AbstractC6492s.i(onApplyWindowInsetsListener, "onApplyWindowInsetsListener");
            ...
            AbstractC6492s.h(windowInsetsOnApplyWindowInsets, "onApplyWindowInsetsListe…lyWindowInsets(v, insets)");
    ...
    public WindowInsets dispatchApplyWindowInsets(WindowInsets insets) {
        C2780w0 c2780w0Y;
        AbstractC6492s.i(insets, "insets");
        C2780w0 c2780w0W = C2780w0.w(insets);
        AbstractC6492s.h(c2780w0W, "toWindowInsetsCompat(insets)");
        View.OnApplyWindowInsetsListener onApplyWindowInsetsListener = this.applyWindowInsetsListener;
        if (onApplyWindowInsetsListener != null) {
            a aVar = a.f31306a;
            AbstractC6492s.f(onApplyWindowInsetsListener);
            c2780w0Y = C2780w0.w(aVar.a(onApplyWindowInsetsListener, this, insets));
        } else {
            c2780w0Y = W.Y(this, c2780w0W);
        }
        AbstractC6492s.h(c2780w0Y, "if (applyWindowInsetsLis…, insetsCompat)\n        }");
        if (!c2780w0Y.o()) {
            int childCount = getChildCount();
            for (int i10 = 0; i10 < childCount; i10++) {
                W.g(getChildAt(i10), c2780w0Y);
            }
        }
        return insets;
    }
    ...
    public FragmentContainerView(Context context, AttributeSet attributeSet, int i10) {
        ...
        if (attributeSet != null) {
            ...
            int[] FragmentContainerView = U1.c.f22131e;
            AbstractC6492s.h(FragmentContainerView, "FragmentContainerView");
            TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, FragmentContainerView, 0, 0);
            if (classAttribute == null) {
                classAttribute = typedArrayObtainStyledAttributes.getString(U1.c.f22132f);
                str = "android:name";
            } else {
                str = "class";
            }
    ...
    public FragmentContainerView(Context context, AttributeSet attrs, w fm) {
        ...
        super(context, attrs);
        AbstractC6492s.i(context, "context");
        AbstractC6492s.i(attrs, "attrs");
        AbstractC6492s.i(fm, "fm");
        this.disappearingFragmentChildren = new ArrayList();
        this.transitioningFragmentViews = new ArrayList();
        this.drawDisappearingViewsFirst = true;
        ...
        classAttribute = classAttribute == null ? typedArrayObtainStyledAttributes.getString(U1.c.f22132f) : classAttribute;
        String string = typedArrayObtainStyledAttributes.getString(U1.c.f22133g);
        typedArrayObtainStyledAttributes.recycle();
        int id2 = getId();
        Fragment fragmentE0 = fm.e0(id2);
        if (classAttribute != null && fragmentE0 == null) {
            if (id2 == -1) {
                if (string != null) {
                    str = " with tag " + string;
                } else {
            ...
            Fragment fragmentA = fm.p0().a(context.getClassLoader(), classAttribute);
            AbstractC6492s.h(fragmentA, "fm.fragmentFactory.insta…ontext.classLoader, name)");
            fragmentA.A0(context, attrs, null);
            fm.m().p(true).d(this, fragmentA, string).j();
        }
        fm.U0(this);
    }
}
