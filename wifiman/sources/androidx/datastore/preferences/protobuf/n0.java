...
abstract class n0 {
    ...
    private static final b f30943a;
    ...
    static final class e extends b {
        ...
        */
        ...
        private static int h(byte[] bArr, int i10, long j10, int i11) {
            ...
            if (i11 == 1) {
                return n0.j(i10, m0.s(bArr, j10));
            }
            if (i11 == 2) {
                return n0.k(i10, m0.s(bArr, j10), m0.s(bArr, j10 + 1));
            }
        ...
        String a(byte[] bArr, int i10, int i11) throws InvalidProtocolBufferException {
            ...
            while (i10 < i12) {
                int i15 = i10 + 1;
                byte bS2 = m0.s(bArr, i10);
                if (a.n(bS2)) {
                    int i16 = i14 + 1;
                    a.i(bS2, cArr, i14);
                    while (i15 < i12) {
                        byte bS3 = m0.s(bArr, i15);
                        if (!a.n(bS3)) {
                            break;
                        }
                        i15++;
                    ...
                    i10 += 2;
                    a.k(bS2, m0.s(bArr, i15), cArr, i14);
                    i14++;
                } else if (a.o(bS2)) {
                    if (i15 >= i12 - 1) {
                        throw InvalidProtocolBufferException.d();
                    ...
                    int i17 = i10 + 2;
                    i10 += 3;
                    a.j(bS2, m0.s(bArr, i15), m0.s(bArr, i17), cArr, i14);
                    i14++;
                } else {
                    if (i15 >= i12 - 2) {
                        throw InvalidProtocolBufferException.d();
                    }
                    byte bS4 = m0.s(bArr, i15);
                    int i18 = i10 + 3;
                    byte bS5 = m0.s(bArr, i10 + 2);
                    i10 += 4;
                    a.h(bS2, bS4, bS5, m0.s(bArr, i18), cArr, i14);
                    i14 += 2;
                }
            }
            return new String(cArr, 0, i14);
            ...
            while (i13 < length) {
                ...
                if (cCharAt2 >= 128 || j13 >= j14) {
                    if (cCharAt2 >= 2048 || j13 > j14 - 2) {
                        ...
                        if ((cCharAt2 >= 55296 && 57343 >= cCharAt2) || j13 > j14 - 3) {
                            ...
                            if (i14 != length) {
                                ...
                                if (Character.isSurrogatePair(cCharAt2, cCharAt3)) {
                                    int codePoint = Character.toCodePoint(cCharAt2, cCharAt3);
                                    j11 = 1;
                                    m0.H(bArr, j13, (byte) ((codePoint >>> 18) | 240));
                                    j12 = j14;
                                    m0.H(bArr, j13 + 1, (byte) (((codePoint >>> 12) & 63) | 128));
                                    long j15 = j13 + 3;
                                    m0.H(bArr, j13 + 2, (byte) (((codePoint >>> 6) & 63) | 128));
                                    j13 += 4;
                                    m0.H(bArr, j15, (byte) ((codePoint & 63) | 128));
                                    i13 = i14;
                                } else {
                                    i13 = i14;
                                }
                        ...
                        m0.H(bArr, j13, (byte) ((cCharAt2 >>> '\f') | 480));
                        long j16 = j13 + 2;
                        m0.H(bArr, j13 + 1, (byte) (((cCharAt2 >>> 6) & 63) | 128));
                        j13 += 3;
                        m0.H(bArr, j16, (byte) ((cCharAt2 & '?') | 128));
                    } else {
                        str = str3;
                        str2 = str4;
                        long j17 = j13 + j10;
                        m0.H(bArr, j13, (byte) ((cCharAt2 >>> 6) | 960));
                        j13 += 2;
                        m0.H(bArr, j17, (byte) ((cCharAt2 & '?') | 128));
                    }
                    j12 = j14;
                    j11 = 1;
                } else {
                    m0.H(bArr, j13, (byte) cCharAt2);
                    j12 = j14;
                    str2 = str4;
                    j11 = j10;
                    j13 += j10;
        ...
        /* JADX WARN: Code restructure failed: missing block: B:35:0x0058, code lost:
            ...
            if (androidx.datastore.preferences.protobuf.m0.s(r12, r0) > (-65)) goto L38;
         */
        /* JADX WARN: Code restructure failed: missing block: B:58:0x009e, code lost:
        
            if (androidx.datastore.preferences.protobuf.m0.s(r12, r0) > (-65)) goto L59;
         */
        @Override // androidx.datastore.preferences.protobuf.n0.b
        /*
            Code decompiled incorrectly, please refer to instructions dump.
    ...
    static {
        f30943a = (!e.e() || AbstractC3968d.c()) ? new c() : new e();
    }

    static String e(byte[] bArr, int i10, int i11) {
        return f30943a.a(bArr, i10, i11);
    }

    static int f(CharSequence charSequence, byte[] bArr, int i10, int i11) {
        return f30943a.b(charSequence, bArr, i10, i11);
    }
    ...
    public static boolean m(byte[] bArr) {
        return f30943a.c(bArr, 0, bArr.length);
    }

    public static boolean n(byte[] bArr, int i10, int i11) {
        return f30943a.c(bArr, i10, i11);
    }
}
