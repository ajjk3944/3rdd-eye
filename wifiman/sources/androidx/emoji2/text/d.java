...
public abstract class d {
    ...
    public static class a {
        ...
        public a(b bVar) {
            this.f30977a = bVar == null ? e() : bVar;
        }

        private f.c a(Context context, B1.e eVar) {
            if (eVar == null) {
                return null;
            }
        ...
        private B1.e d(ProviderInfo providerInfo, PackageManager packageManager) {
            String str = providerInfo.authority;
            String str2 = providerInfo.packageName;
            return new B1.e(str, str2, "emojicompat-emoji-font", b(this.f30977a.b(packageManager, str2)));
        }

        private static b e() {
            return Build.VERSION.SDK_INT >= 28 ? new C1098d() : new c();
        }
        ...
        private ProviderInfo g(PackageManager packageManager) {
            Iterator it = this.f30977a.c(packageManager, new Intent("androidx.content.action.LOAD_EMOJI_FONT"), 0).iterator();
            while (it.hasNext()) {
                ProviderInfo providerInfoA = this.f30977a.a((ResolveInfo) it.next());
                if (f(providerInfoA)) {
        ...
        B1.e h(Context context) {
            PackageManager packageManager = context.getPackageManager();
            E1.h.h(packageManager, "Package manager required to locate emoji font provider");
    ...
    public static class C1098d extends c {
        @Override // androidx.emoji2.text.d.b
        public Signature[] b(PackageManager packageManager, String str) {
            return packageManager.getPackageInfo(str, 64).signatures;
        }
