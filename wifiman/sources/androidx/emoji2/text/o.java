...
public final class o extends SpannableStringBuilder {
    ...
    private final Class f31062a;

    /* renamed from: b, reason: collision with root package name */
    private final List f31063b;
    ...
    private static class a implements TextWatcher, SpanWatcher {
        ...
        /* renamed from: b, reason: collision with root package name */
        private final AtomicInteger f31065b = new AtomicInteger(0);
        ...
        final void a() {
            this.f31065b.incrementAndGet();
        }

        @Override // android.text.TextWatcher
        public void afterTextChanged(Editable editable) {
            ((TextWatcher) this.f31064a).afterTextChanged(editable);
        }

        @Override // android.text.TextWatcher
        public void beforeTextChanged(CharSequence charSequence, int i10, int i11, int i12) {
            ((TextWatcher) this.f31064a).beforeTextChanged(charSequence, i10, i11, i12);
        }

        final void c() {
            this.f31065b.decrementAndGet();
        }

        @Override // android.text.SpanWatcher
        public void onSpanAdded(Spannable spannable, Object obj, int i10, int i11) {
            if (this.f31065b.get() <= 0 || !b(obj)) {
                ((SpanWatcher) this.f31064a).onSpanAdded(spannable, obj, i10, i11);
            }
        }
  ...
  0x001e: PHI (r11v1 int) = (r11v0 int), (r11v3 int) binds: [B:8:0x0013, B:12:0x0019] A[DONT_GENERATE, DONT_INLINE]] */
        ...
        */
        public void onSpanChanged(android.text.Spannable r9, java.lang.Object r10, int r11, int r12, int r13, int r14) {
            /*
                r8 = this;
                java.util.concurrent.atomic.AtomicInteger r0 = r8.f31065b
                int r0 = r0.get()
                if (r0 <= 0) goto Lf
                boolean r0 = r8.b(r10)
                if (r0 == 0) goto Lf
            ...
            L1e:
                ...
                r6 = r13
            L20:
                java.lang.Object r11 = r8.f31064a
                r1 = r11
        ...
        public void onSpanRemoved(Spannable spannable, Object obj, int i10, int i11) {
            if (this.f31065b.get() <= 0 || !b(obj)) {
                ((SpanWatcher) this.f31064a).onSpanRemoved(spannable, obj, i10, i11);
            }
        }

        @Override // android.text.TextWatcher
        public void onTextChanged(CharSequence charSequence, int i10, int i11, int i12) {
            ((TextWatcher) this.f31064a).onTextChanged(charSequence, i10, i11, i12);
        }
    }
    ...
    o(Class cls, CharSequence charSequence) {
        ...
        E1.h.h(cls, "watcherClass cannot be null");
        this.f31062a = cls;
    }

    private void b() {
        for (int i10 = 0; i10 < this.f31063b.size(); i10++) {
            ((a) this.f31063b.get(i10)).a();
        }
    }
    ...
    private void e() {
        for (int i10 = 0; i10 < this.f31063b.size(); i10++) {
            ((a) this.f31063b.get(i10)).onTextChanged(this, 0, length(), length());
        }
    }

    private a f(Object obj) {
        for (int i10 = 0; i10 < this.f31063b.size(); i10++) {
            a aVar = (a) this.f31063b.get(i10);
            if (aVar.f31064a == obj) {
                return aVar;
            }
        }
    ...
    public Object[] getSpans(int i10, int i11, Class cls) {
        ...
        for (int i12 = 0; i12 < aVarArr.length; i12++) {
            objArr[i12] = aVarArr[i12].f31064a;
        }
        return objArr;
    }
    ...
    public CharSequence subSequence(int i10, int i11) {
        return new o(this.f31062a, this, i10, i11);
    }
