    ...
    */
    private static final android.view.inputmethod.CursorAnchorInfo.Builder a(android.view.inputmethod.CursorAnchorInfo.Builder r17, int r18, int r19, R0.H r20, L0.M r21, l0.C6533i r22) {
        ...
        L8e:
            return r17
        */
        throw new UnsupportedOperationException("Method not decompiled: I.L0.a(android.view.inputmethod.CursorAnchorInfo$Builder, int, int, R0.H, L0.M, l0.i):android.view.inputmethod.CursorAnchorInfo$Builder");
    }

    public static final CursorAnchorInfo b(CursorAnchorInfo.Builder builder, R0.Q q10, R0.H h10, L0.M m10, Matrix matrix, C6533i c6533i, C6533i c6533i2, boolean z10, boolean z11, boolean z12, boolean z13) {
        builder.reset();
    ...
    public static final boolean c(C6533i c6533i, float f10, float f11) {
        float fK = c6533i.k();
    ...
    private static final CursorAnchorInfo.Builder d(CursorAnchorInfo.Builder builder, int i10, R0.H h10, L0.M m10, C6533i c6533i) {
        if (i10 < 0) {
            return builder;
        }
        int iB = h10.b(i10);
