...
public final class p extends AbstractC5095w implements N {
    ...
    static /* synthetic */ class a {
        ...
        static {
            ...
            try {
                f308a[AbstractC5095w.d.NEW_BUILDER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f308a[AbstractC5095w.d.BUILD_MESSAGE_INFO.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f308a[AbstractC5095w.d.GET_DEFAULT_INSTANCE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f308a[AbstractC5095w.d.GET_PARSER.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f308a[AbstractC5095w.d.GET_MEMOIZED_IS_INITIALIZED.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f308a[AbstractC5095w.d.SET_MEMOIZED_IS_INITIALIZED.ordinal()] = 7;
    ...
    public static final class b extends AbstractC5095w.a implements N {
        ...
        public b t(AbstractC5081h abstractC5081h) {
            m();
            ((p) this.f38595b).a0(abstractC5081h);
            return this;
        }

        public b u(int i10) {
            m();
            ((p) this.f38595b).b0(i10);
            return this;
        }
    ...
    public static p Z(AbstractC5081h abstractC5081h, C5088o c5088o) {
        return (p) AbstractC5095w.J(DEFAULT_INSTANCE, abstractC5081h, c5088o);
    }
