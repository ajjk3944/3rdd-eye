...
public class ImageMetadata {
    ...
    private void getMetdataEntry(int i10, G g10) {
        ...
        g10.f38178b = nativeGetMetadataEntryValueType(this.session.nativeWrapperHandle, jNativeGetMetadataEntry);
        g10.f38179c = nativeGetMetadataEntryValueCount(this.session.nativeWrapperHandle, g10.f38177a);
    }
    ...
    public byte getByte(int i10) throws MetadataNotFoundException {
        getMetdataEntry(i10, this.sketchEntry);
        G g10 = this.sketchEntry;
        if (g10.f38178b != 0 || g10.f38179c != 1) {
            throw new IllegalArgumentException(String.format("Wrong return type for ImageMetadata key: %1$d.", Integer.valueOf(i10)));
        }
        byte bNativeGetByteFromMetadataEntry = nativeGetByteFromMetadataEntry(this.session.nativeWrapperHandle, g10.f38177a);
        nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f38177a);
        return bNativeGetByteFromMetadataEntry;
    }

    public byte[] getByteArray(int i10) throws MetadataNotFoundException {
        getMetdataEntry(i10, this.sketchEntry);
        G g10 = this.sketchEntry;
        if (g10.f38178b != 0) {
            throw new IllegalArgumentException(String.format("Wrong return type for ImageMetadata key: %1$d.", Integer.valueOf(i10)));
        }
        byte[] bArrNativeGetByteArrayFromMetadataEntry = nativeGetByteArrayFromMetadataEntry(this.session.nativeWrapperHandle, g10.f38177a);
        nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f38177a);
        return bArrNativeGetByteArrayFromMetadataEntry;
    }

    public double getDouble(int i10) throws MetadataNotFoundException {
        getMetdataEntry(i10, this.sketchEntry);
        G g10 = this.sketchEntry;
        if (g10.f38178b != 4 || g10.f38179c != 1) {
            throw new IllegalArgumentException(String.format("Wrong return type for ImageMetadata key: %1$d.", Integer.valueOf(i10)));
        }
        double dNativeGetDoubleFromMetadataEntry = nativeGetDoubleFromMetadataEntry(this.session.nativeWrapperHandle, g10.f38177a);
        nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f38177a);
        return dNativeGetDoubleFromMetadataEntry;
    }

    public double[] getDoubleArray(int i10) throws MetadataNotFoundException {
        getMetdataEntry(i10, this.sketchEntry);
        G g10 = this.sketchEntry;
        if (g10.f38178b != 4) {
            throw new IllegalArgumentException(String.format("Wrong return type for ImageMetadata key: %1$d.", Integer.valueOf(i10)));
        }
        double[] dArrNativeGetDoubleArrayFromMetadataEntry = nativeGetDoubleArrayFromMetadataEntry(this.session.nativeWrapperHandle, g10.f38177a);
        nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f38177a);
        return dArrNativeGetDoubleArrayFromMetadataEntry;
    }

    public float getFloat(int i10) throws MetadataNotFoundException {
        getMetdataEntry(i10, this.sketchEntry);
        G g10 = this.sketchEntry;
        if (g10.f38178b != 2 || g10.f38179c != 1) {
            throw new IllegalArgumentException(String.format("Wrong return type for ImageMetadata key: %1$d.", Integer.valueOf(i10)));
        }
        float fNativeGetFloatFromMetadataEntry = nativeGetFloatFromMetadataEntry(this.session.nativeWrapperHandle, g10.f38177a);
        nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f38177a);
        return fNativeGetFloatFromMetadataEntry;
    }

    public float[] getFloatArray(int i10) throws MetadataNotFoundException {
        getMetdataEntry(i10, this.sketchEntry);
        G g10 = this.sketchEntry;
        if (g10.f38178b != 2) {
            throw new IllegalArgumentException(String.format("Wrong return type for ImageMetadata key: %1$d.", Integer.valueOf(i10)));
        }
        float[] fArrNativeGetFloatArrayFromMetadataEntry = nativeGetFloatArrayFromMetadataEntry(this.session.nativeWrapperHandle, g10.f38177a);
        nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f38177a);
        return fArrNativeGetFloatArrayFromMetadataEntry;
    }

    public int getInt(int i10) throws MetadataNotFoundException {
        getMetdataEntry(i10, this.sketchEntry);
        G g10 = this.sketchEntry;
        if (g10.f38178b != 1 || g10.f38179c != 1) {
            throw new IllegalArgumentException(String.format("Wrong return type for ImageMetadata key: %1$d.", Integer.valueOf(i10)));
        }
        int iNativeGetIntFromMetadataEntry = nativeGetIntFromMetadataEntry(this.session.nativeWrapperHandle, g10.f38177a);
        nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f38177a);
        return iNativeGetIntFromMetadataEntry;
    }

    public int[] getIntArray(int i10) throws MetadataNotFoundException {
        getMetdataEntry(i10, this.sketchEntry);
        G g10 = this.sketchEntry;
        if (g10.f38178b != 1) {
            throw new IllegalArgumentException(String.format("Wrong return type for ImageMetadata key: %1$d.", Integer.valueOf(i10)));
        }
        int[] iArrNativeGetIntArrayFromMetadataEntry = nativeGetIntArrayFromMetadataEntry(this.session.nativeWrapperHandle, g10.f38177a);
        nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f38177a);
    ...
    public long getLong(int i10) throws MetadataNotFoundException {
        getMetdataEntry(i10, this.sketchEntry);
        G g10 = this.sketchEntry;
        if (g10.f38178b != 3 || g10.f38179c != 1) {
            throw new IllegalArgumentException(String.format("Wrong return type for ImageMetadata key: %1$d, type: %2$d, count: %3$d.", Integer.valueOf(i10), Integer.valueOf(this.sketchEntry.f38178b), Integer.valueOf(this.sketchEntry.f38179c)));
        }
        long jNativeGetLongFromMetadataEntry = nativeGetLongFromMetadataEntry(this.session.nativeWrapperHandle, g10.f38177a);
        nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f38177a);
        return jNativeGetLongFromMetadataEntry;
    }

    public long[] getLongArray(int i10) throws MetadataNotFoundException {
        getMetdataEntry(i10, this.sketchEntry);
        G g10 = this.sketchEntry;
        if (g10.f38178b != 3) {
            throw new IllegalArgumentException(String.format("Wrong return type for ImageMetadata key: %1$d.", Integer.valueOf(i10)));
        }
        long[] jArrNativeGetLongArrayFromMetadataEntry = nativeGetLongArrayFromMetadataEntry(this.session.nativeWrapperHandle, g10.f38177a);
        nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f38177a);
        return jArrNativeGetLongArrayFromMetadataEntry;
    }

    public Rational getRational(int i10) throws MetadataNotFoundException {
        getMetdataEntry(i10, this.sketchEntry);
        G g10 = this.sketchEntry;
        if (g10.f38178b != 5 || g10.f38179c != 1) {
            throw new IllegalArgumentException(String.format("Wrong return type for ImageMetadata key: %1$d.", Integer.valueOf(i10)));
        }
        Rational rationalNativeGetRationalFromMetadataEntry = nativeGetRationalFromMetadataEntry(this.session.nativeWrapperHandle, g10.f38177a);
        nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f38177a);
        return rationalNativeGetRationalFromMetadataEntry;
    }

    public Rational[] getRationalArray(int i10) throws MetadataNotFoundException {
        getMetdataEntry(i10, this.sketchEntry);
        G g10 = this.sketchEntry;
        if (g10.f38178b != 5) {
            throw new IllegalArgumentException(String.format("Wrong return type for ImageMetadata key: %1$d.", Integer.valueOf(i10)));
        }
        Rational[] rationalArrNativeGetRationalArrayFromMetadataEntry = nativeGetRationalArrayFromMetadataEntry(this.session.nativeWrapperHandle, g10.f38177a);
        nativeDestroyMetadataEntry(this.session.nativeWrapperHandle, this.sketchEntry.f38177a);
        return rationalArrNativeGetRationalArrayFromMetadataEntry;
    }

    ImageMetadata(long j10, Session session) {
        this.session = session;
        this.nativeHandle = j10;
        this.nativeSymbolTableHandle = session.nativeSymbolTableHandle;
        this.sketchEntry = new G();
    }
}
