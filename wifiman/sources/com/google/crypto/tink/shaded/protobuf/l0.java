...
abstract class l0 {
    ...
    private static final Unsafe f38552a = D();

    /* renamed from: b, reason: collision with root package name */
    private static final Class f38553b = AbstractC5077d.b();

    /* renamed from: c, reason: collision with root package name */
    private static final boolean f38554c = o(Long.TYPE);

    /* renamed from: d, reason: collision with root package name */
    private static final boolean f38555d = o(Integer.TYPE);

    /* renamed from: e, reason: collision with root package name */
    private static final e f38556e = B();

    /* renamed from: f, reason: collision with root package name */
    private static final boolean f38557f = T();

    /* renamed from: g, reason: collision with root package name */
    private static final boolean f38558g = S();

    /* renamed from: h, reason: collision with root package name */
    static final long f38559h;

    /* renamed from: i, reason: collision with root package name */
    private static final long f38560i;

    /* renamed from: j, reason: collision with root package name */
    private static final long f38561j;

    /* renamed from: k, reason: collision with root package name */
    private static final long f38562k;

    /* renamed from: l, reason: collision with root package name */
    private static final long f38563l;

    /* renamed from: m, reason: collision with root package name */
    private static final long f38564m;

    /* renamed from: n, reason: collision with root package name */
    private static final long f38565n;

    /* renamed from: o, reason: collision with root package name */
    private static final long f38566o;

    /* renamed from: p, reason: collision with root package name */
    private static final long f38567p;

    /* renamed from: q, reason: collision with root package name */
    private static final long f38568q;

    /* renamed from: r, reason: collision with root package name */
    private static final long f38569r;

    /* renamed from: s, reason: collision with root package name */
    private static final long f38570s;

    /* renamed from: t, reason: collision with root package name */
    private static final long f38571t;

    /* renamed from: u, reason: collision with root package name */
    private static final long f38572u;

    /* renamed from: v, reason: collision with root package name */
    private static final int f38573v;

    /* renamed from: w, reason: collision with root package name */
    static final boolean f38574w;
    ...
    private static final class b extends e {
        ...
        public boolean c(Object obj, long j10) {
            return l0.f38574w ? l0.s(obj, j10) : l0.t(obj, j10);
        }

        @Override // com.google.crypto.tink.shaded.protobuf.l0.e
        public byte d(Object obj, long j10) {
            return l0.f38574w ? l0.v(obj, j10) : l0.w(obj, j10);
        }
    ...
    private static final class d extends e {
        ...
        @Override // com.google.crypto.tink.shaded.protobuf.l0.e
        public boolean c(Object obj, long j10) {
            return this.f38575a.getBoolean(obj, j10);
        }

        @Override // com.google.crypto.tink.shaded.protobuf.l0.e
        public byte d(Object obj, long j10) {
            return this.f38575a.getByte(obj, j10);
        }

        @Override // com.google.crypto.tink.shaded.protobuf.l0.e
        public double e(Object obj, long j10) {
            return this.f38575a.getDouble(obj, j10);
        }

        @Override // com.google.crypto.tink.shaded.protobuf.l0.e
        public float f(Object obj, long j10) {
            return this.f38575a.getFloat(obj, j10);
        }

        @Override // com.google.crypto.tink.shaded.protobuf.l0.e
        public void k(Object obj, long j10, boolean z10) {
            this.f38575a.putBoolean(obj, j10, z10);
        }

        @Override // com.google.crypto.tink.shaded.protobuf.l0.e
        public void l(Object obj, long j10, byte b10) {
            this.f38575a.putByte(obj, j10, b10);
        }

        @Override // com.google.crypto.tink.shaded.protobuf.l0.e
        public void m(Object obj, long j10, double d10) {
            this.f38575a.putDouble(obj, j10, d10);
        }

        @Override // com.google.crypto.tink.shaded.protobuf.l0.e
        public void n(Object obj, long j10, float f10) {
            this.f38575a.putFloat(obj, j10, f10);
        }
        ...
        public boolean r() {
            ...
            try {
                Class<?> cls = this.f38575a.getClass();
    ...
    private static abstract class e {
        ...
        public final int a(Class cls) {
            return this.f38575a.arrayBaseOffset(cls);
        }

        public final int b(Class cls) {
            return this.f38575a.arrayIndexScale(cls);
        }
        ...
        public final int g(Object obj, long j10) {
            return this.f38575a.getInt(obj, j10);
        }

        public final long h(Object obj, long j10) {
            return this.f38575a.getLong(obj, j10);
        }

        public final Object i(Object obj, long j10) {
            return this.f38575a.getObject(obj, j10);
        }

        public final long j(Field field) {
            return this.f38575a.objectFieldOffset(field);
        }
        ...
        public final void o(Object obj, long j10, int i10) {
            this.f38575a.putInt(obj, j10, i10);
        }

        public final void p(Object obj, long j10, long j11) {
            this.f38575a.putLong(obj, j10, j11);
        }

        public final void q(Object obj, long j10, Object obj2) {
            this.f38575a.putObject(obj, j10, obj2);
        }

        public boolean r() {
            Unsafe unsafe = this.f38575a;
            if (unsafe == null) {
                return false;
            }
            try {
    ...
    static {
        ...
        f38559h = jL;
        f38560i = l(boolean[].class);
        f38561j = m(boolean[].class);
        f38562k = l(int[].class);
        f38563l = m(int[].class);
        f38564m = l(long[].class);
        f38565n = m(long[].class);
        f38566o = l(float[].class);
        f38567p = m(float[].class);
        f38568q = l(double[].class);
        f38569r = m(double[].class);
        f38570s = l(Object[].class);
        f38571t = m(Object[].class);
        f38572u = q(n());
        f38573v = (int) (jL & 7);
        f38574w = ByteOrder.nativeOrder() == ByteOrder.BIG_ENDIAN;
    }

    static long A(Object obj, long j10) {
        return f38556e.h(obj, j10);
    }

    private static e B() {
        Unsafe unsafe = f38552a;
        if (unsafe == null) {
            return null;
        }
        if (!AbstractC5077d.c()) {
    ...
    public static void G(Throwable th2) {
        Logger.getLogger(l0.class.getName()).log(Level.WARNING, "platform method missing - proto runtime falling back to safer methods: " + th2);
    }

    static void H(Object obj, long j10, boolean z10) {
        f38556e.k(obj, j10, z10);
    }
    ...
    static void K(byte[] bArr, long j10, byte b10) {
        f38556e.l(bArr, f38559h + j10, b10);
    }
    ...
    static Object k(Class cls) {
        try {
            return f38552a.allocateInstance(cls);
    ...
    public static Field n() {
        Field fieldP;
        if (AbstractC5077d.c() && (fieldP = p(Buffer.class, "effectiveDirectAddress")) != null) {
            return fieldP;
        }
        Field fieldP2 = p(Buffer.class, SnmpConfigurator.O_ADDRESS);
    ...
    private static long q(Field field) {
        e eVar;
        if (field == null || (eVar = f38556e) == null) {
            return -1L;
        }
        return eVar.j(field);
    }
    ...
    static byte u(byte[] bArr, long j10) {
        return f38556e.d(bArr, f38559h + j10);
    }
    ...
    static double x(Object obj, long j10) {
        return f38556e.e(obj, j10);
    }

    static float y(Object obj, long j10) {
        return f38556e.f(obj, j10);
    }

    static int z(Object obj, long j10) {
        return f38556e.g(obj, j10);
    }
}
