...
public abstract class b {
    ...
    private static final ThreadLocal f37572a = new ThreadLocal();

    /* renamed from: b, reason: collision with root package name */
    private static final ThreadLocal f37573b = new ThreadLocal();
    ...
    public static void c(ViewGroup viewGroup, View view, Rect rect) {
        ThreadLocal threadLocal = f37572a;
        ...
        ThreadLocal threadLocal2 = f37573b;
