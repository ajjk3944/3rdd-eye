...
final class S5 extends T5 {
    ...
    @Override // com.google.android.gms.internal.measurement.T5
    final String c(byte[] bArr, int i10, int i11) throws zzkq {
        ...
        while (i10 < i12) {
            ...
            if (b11 >= 0) {
                ...
                int i17 = i10 + 2;
                i10 += 3;
                Q5.b(b11, bArr[i15], bArr[i17], cArr, i14);
                i14++;
            } else {
                if (i15 >= i12 - 2) {
                    throw zzkq.d();
                ...
                byte b14 = bArr[i10 + 2];
                i10 += 4;
                Q5.a(b11, b13, b14, bArr[i18], cArr, i14);
                i14 += 2;
            }
        }
