...
/* renamed from: com.google.android.gms.internal.mlkit_vision_internal_vkp.h3, reason: case insensitive filesystem */
/* loaded from: classes.dex */
abstract class AbstractC4594h3 {

    /* renamed from: a, reason: collision with root package name */
    private static final AbstractC4561e3 f35693a;

    static {
        if (AbstractC4539c3.C() && AbstractC4539c3.D()) {
        ...
        while (i15 < length) {
            ...
            if (cCharAt2 < 128 && i16 < i12) {
                ...
                if ((cCharAt2 >= 55296 && cCharAt2 <= 57343) || i16 > i12 - 3) {
                    ...
                    throw new C4583g3(i15 - 1, length);
                }
    ...
    static String d(byte[] bArr, int i10, int i11) throws zzbew {
        int i12;
        ...
        while (i10 < i13) {
            int i16 = i10 + 1;
            byte b11 = bArr[i10];
            if (AbstractC4550d3.d(b11)) {
                cArr[i15] = (char) b11;
                i15++;
                i10 = i16;
                while (i10 < i13) {
                    byte b12 = bArr[i10];
                    if (AbstractC4550d3.d(b12)) {
                        i10++;
                        cArr[i15] = (char) b12;
                        i15++;
                    }
                ...
                if (b11 < -32) {
                    ...
                    i12 = i15 + 1;
                    i10 += 2;
                    AbstractC4550d3.c(b11, bArr[i16], cArr, i15);
                } else if (b11 < -16) {
                    if (i16 >= i13 - 1) {
                        throw new zzbew("Protocol message had invalid UTF-8.");
                    }
                    ...
                    int i17 = i10 + 2;
                    i10 += 3;
                    AbstractC4550d3.b(b11, bArr[i16], bArr[i17], cArr, i15);
                } else {
                    if (i16 >= i13 - 2) {
                        throw new zzbew("Protocol message had invalid UTF-8.");
                    }
                    ...
                    byte b14 = bArr[i10 + 2];
                    i10 += 4;
                    AbstractC4550d3.a(b11, b13, b14, bArr[i18], cArr, i15);
                    i15 += 2;
                }
                i15 = i12;
            }
    ...
    */
    static boolean e(byte[] r6, int r7, int r8) {
        ...
        L7a:
            ...
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.mlkit_vision_internal_vkp.AbstractC4594h3.e(byte[], int, int):boolean");
    }
}
