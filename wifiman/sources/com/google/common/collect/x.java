...
public abstract class x {
    static boolean a(List list, Object obj) {
        ...
        for (int i10 = 0; i10 < size; i10++) {
            if (!AbstractC6767f.a(list.get(i10), list2.get(i10))) {
                return false;
            }
        }
        return true;
    ...
    static int b(List list, Object obj) {
        ...
        while (listIterator.hasNext()) {
            if (AbstractC6767f.a(obj, listIterator.next())) {
    ...
    static int d(List list, Object obj) {
        ...
        while (listIterator.hasPrevious()) {
            if (AbstractC6767f.a(obj, listIterator.previous())) {
