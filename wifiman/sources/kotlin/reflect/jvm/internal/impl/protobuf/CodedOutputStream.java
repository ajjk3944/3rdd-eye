...
public final class CodedOutputStream {
    ...
    private CodedOutputStream(OutputStream outputStream, byte[] bArr) {
        this.f51934e = outputStream;
        this.f51930a = bArr;
        this.f51931b = bArr.length;
    }
    ...
    private void J() throws IOException {
        OutputStream outputStream = this.f51934e;
        if (outputStream == null) {
            throw new OutOfSpaceException();
        }
        outputStream.write(this.f51930a, 0, this.f51932c);
        this.f51932c = 0;
    }
    ...
    public static int r(int i10, n nVar) {
        return C(i10) + s(nVar);
    }
    ...
    public void N(int i10, d dVar) throws IOException {
        v0(i10, 2);
        O(dVar);
    }
    ...
    public void X(int i10, n nVar) throws IOException {
        v0(i10, 3);
        Y(nVar);
        v0(i10, 4);
    }
    ...
    public void c0(int i10, n nVar) throws IOException {
        v0(i10, 2);
        d0(nVar);
    }
    ...
    public void e0(int i10, n nVar) throws IOException {
        v0(1, 3);
        w0(2, i10);
        c0(3, nVar);
        v0(1, 4);
    ...
    public void i0(d dVar, int i10, int i11) throws IOException {
        int i12 = this.f51931b;
        int i13 = this.f51932c;
        if (i12 - i13 >= i11) {
            dVar.k(this.f51930a, i10, i13, i11);
            this.f51932c += i11;
            this.f51933d += i11;
            return;
        }
        int i14 = i12 - i13;
        dVar.k(this.f51930a, i10, i13, i14);
        int i15 = i10 + i14;
        int i16 = i11 - i14;
        this.f51932c = this.f51931b;
        this.f51933d += i14;
        J();
        if (i16 <= this.f51931b) {
            dVar.k(this.f51930a, i15, 0, i16);
            this.f51932c = i16;
        } else {
            dVar.C(this.f51934e, i15, i16);
        }
        this.f51933d += i16;
    }
    ...
    public void k0(byte[] bArr, int i10, int i11) throws IOException {
        ...
        int i13 = this.f51932c;
        if (i12 - i13 >= i11) {
            System.arraycopy(bArr, i10, this.f51930a, i13, i11);
            this.f51932c += i11;
            this.f51933d += i11;
            return;
        }
        int i14 = i12 - i13;
        System.arraycopy(bArr, i10, this.f51930a, i13, i14);
        int i15 = i10 + i14;
        int i16 = i11 - i14;
        this.f51932c = this.f51931b;
        this.f51933d += i14;
        J();
        if (i16 <= this.f51931b) {
            System.arraycopy(bArr, i15, this.f51930a, 0, i16);
            this.f51932c = i16;
        } else {
            this.f51934e.write(bArr, i15, i16);
        }
        this.f51933d += i16;
    }
    ...
    public void o0(long j10) throws IOException {
        while (((-128) & j10) != 0) {
            g0((((int) j10) & BER.MAX_OID_LENGTH) | 128);
            j10 >>>= 7;
        }
        g0((int) j10);
    }
