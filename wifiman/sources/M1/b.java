...
abstract class b {
    ...
    private static class c implements Comparator {
        ...
        private final Rect f12431a = new Rect();

        /* renamed from: b, reason: collision with root package name */
        private final Rect f12432b = new Rect();

        /* renamed from: c, reason: collision with root package name */
        private final boolean f12433c;

        /* renamed from: d, reason: collision with root package name */
        private final a f12434d;
        ...
        public int compare(Object obj, Object obj2) {
            ...
            Rect rect2 = this.f12432b;
            this.f12434d.a(obj, rect);
            this.f12434d.a(obj2, rect2);
            int i10 = rect.top;
            int i11 = rect2.top;
            if (i10 < i11) {
                return -1;
    ...
    public static Object c(Object obj, InterfaceC0491b interfaceC0491b, a aVar, Object obj2, Rect rect, int i10) {
        ...
        int iB = interfaceC0491b.b(obj);
        Rect rect3 = new Rect();
        Object obj3 = null;
        for (int i11 = 0; i11 < iB; i11++) {
            Object objA = interfaceC0491b.a(obj, i11);
            if (objA != obj2) {
                aVar.a(objA, rect3);
    ...
    public static Object d(Object obj, InterfaceC0491b interfaceC0491b, a aVar, Object obj2, int i10, boolean z10, boolean z11) {
        int iB = interfaceC0491b.b(obj);
        ArrayList arrayList = new ArrayList(iB);
        for (int i11 = 0; i11 < iB; i11++) {
            arrayList.add(interfaceC0491b.a(obj, i11));
        }
