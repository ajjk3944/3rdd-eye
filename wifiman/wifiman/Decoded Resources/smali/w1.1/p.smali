...
.method private h(Landroid/graphics/fonts/FontFamily;I)Landroid/graphics/fonts/Font;
    ...
    invoke-static {v0, v1}, Lw1/p;->j(Landroid/graphics/fonts/FontStyle;Landroid/graphics/fonts/FontStyle;)I
    ...
    invoke-static {v0, v4}, Lw1/p;->j(Landroid/graphics/fonts/FontStyle;Landroid/graphics/fonts/FontStyle;)I
...
.method private static i(Landroid/os/CancellationSignal;[LB1/k$b;Landroid/content/ContentResolver;)Landroid/graphics/fonts/FontFamily;
    .locals 8
...
.method public a(Landroid/content/Context;Lv1/e$c;Landroid/content/res/Resources;I)Landroid/graphics/Typeface;
    ...
    invoke-virtual {v3}, Lv1/e$d;->d()Ljava/lang/String;
    ...
    invoke-direct {p0, p2, p4}, Lw1/p;->h(Landroid/graphics/fonts/FontFamily;I)Landroid/graphics/fonts/Font;
...
.method public b(Landroid/content/Context;Landroid/os/CancellationSignal;[LB1/k$b;I)Landroid/graphics/Typeface;
    ...
    :try_start_0
    invoke-static {p2, p3, p1}, Lw1/p;->i(Landroid/os/CancellationSignal;[LB1/k$b;Landroid/content/ContentResolver;)Landroid/graphics/fonts/FontFamily;
    ...
    invoke-direct {p0, p1, p4}, Lw1/p;->h(Landroid/graphics/fonts/FontFamily;I)Landroid/graphics/fonts/Font;
...
.method public c(Landroid/content/Context;Landroid/os/CancellationSignal;Ljava/util/List;I)Landroid/graphics/Typeface;
    ...
    invoke-static {p2, v0, p1}, Lw1/p;->i(Landroid/os/CancellationSignal;[LB1/k$b;Landroid/content/ContentResolver;)Landroid/graphics/fonts/FontFamily;
    ...
    check-cast v4, [LB1/k$b;

    invoke-static {p2, v4, p1}, Lw1/p;->i(Landroid/os/CancellationSignal;[LB1/k$b;Landroid/content/ContentResolver;)Landroid/graphics/fonts/FontFamily;
    ...
    :cond_2
    invoke-direct {p0, v0, p4}, Lw1/p;->h(Landroid/graphics/fonts/FontFamily;I)Landroid/graphics/fonts/Font;
...
.method protected g([LB1/k$b;I)LB1/k$b;
    .locals 0
