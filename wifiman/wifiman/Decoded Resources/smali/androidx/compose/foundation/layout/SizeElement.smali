...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "inspectorInfo",
        "<init>",
        "(FFFFZLmh/l;Lkotlin/jvm/internal/DefaultConstructorMarker;)V",
        "d",
        "()Landroidx/compose/foundation/layout/s;",
        "node",
        "e",
...
# direct methods
.method private constructor <init>(FFFFZLmh/l;)V
    .locals 0
    ...
    .line 13
    iput-object p6, p0, Landroidx/compose/foundation/layout/SizeElement;->f:Lmh/l;

    return-void
.end method

.method public synthetic constructor <init>(FFFFZLmh/l;ILkotlin/jvm/internal/DefaultConstructorMarker;)V
    .locals 9
...
.method public synthetic constructor <init>(FFFFZLmh/l;Lkotlin/jvm/internal/DefaultConstructorMarker;)V
    .locals 0

    .line 1
    invoke-direct/range {p0 .. p6}, Landroidx/compose/foundation/layout/SizeElement;-><init>(FFFFZLmh/l;)V
...
.method public bridge synthetic a()Landroidx/compose/ui/e$c;
    ...
    invoke-virtual {p0}, Landroidx/compose/foundation/layout/SizeElement;->d()Landroidx/compose/foundation/layout/s;
...
.method public bridge synthetic c(Landroidx/compose/ui/e$c;)V
    ...
    invoke-virtual {p0, p1}, Landroidx/compose/foundation/layout/SizeElement;->e(Landroidx/compose/foundation/layout/s;)V

    return-void
.end method

.method public d()Landroidx/compose/foundation/layout/s;
    .locals 8

    new-instance v7, Landroidx/compose/foundation/layout/s;
    ...
    invoke-direct/range {v0 .. v6}, Landroidx/compose/foundation/layout/s;-><init>(FFFFZLkotlin/jvm/internal/DefaultConstructorMarker;)V

    return-object v7
.end method

.method public e(Landroidx/compose/foundation/layout/s;)V
    .locals 1

    iget v0, p0, Landroidx/compose/foundation/layout/SizeElement;->a:F

    invoke-virtual {p1, v0}, Landroidx/compose/foundation/layout/s;->I2(F)V

    iget v0, p0, Landroidx/compose/foundation/layout/SizeElement;->b:F

    invoke-virtual {p1, v0}, Landroidx/compose/foundation/layout/s;->H2(F)V

    iget v0, p0, Landroidx/compose/foundation/layout/SizeElement;->c:F

    invoke-virtual {p1, v0}, Landroidx/compose/foundation/layout/s;->G2(F)V

    iget v0, p0, Landroidx/compose/foundation/layout/SizeElement;->d:F

    invoke-virtual {p1, v0}, Landroidx/compose/foundation/layout/s;->F2(F)V

    iget-boolean v0, p0, Landroidx/compose/foundation/layout/SizeElement;->e:Z

    invoke-virtual {p1, v0}, Landroidx/compose/foundation/layout/s;->E2(Z)V
