...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "compositingStrategy",
        "<init>",
        "(FFFFFFFFFFJLm0/i1;ZLm0/d1;JJILkotlin/jvm/internal/DefaultConstructorMarker;)V",
        "d",
        "()Landroidx/compose/ui/graphics/e;",
        "node",
        "LYg/J;",
...
# direct methods
.method private constructor <init>(FFFFFFFFFFJLm0/i1;ZLm0/d1;JJI)V
    .locals 3
    ...
    .line 14
    iput-object v1, v0, Landroidx/compose/ui/graphics/GraphicsLayerElement;->l:Lm0/i1;
...
.method public synthetic constructor <init>(FFFFFFFFFFJLm0/i1;ZLm0/d1;JJILkotlin/jvm/internal/DefaultConstructorMarker;)V
    .locals 0

    .line 1
    invoke-direct/range {p0 .. p20}, Landroidx/compose/ui/graphics/GraphicsLayerElement;-><init>(FFFFFFFFFFJLm0/i1;ZLm0/d1;JJI)V
...
.method public bridge synthetic a()Landroidx/compose/ui/e$c;
    ...
    invoke-virtual {p0}, Landroidx/compose/ui/graphics/GraphicsLayerElement;->d()Landroidx/compose/ui/graphics/e;
...
.method public bridge synthetic c(Landroidx/compose/ui/e$c;)V
    ...
    invoke-virtual {p0, p1}, Landroidx/compose/ui/graphics/GraphicsLayerElement;->e(Landroidx/compose/ui/graphics/e;)V

    return-void
.end method

.method public d()Landroidx/compose/ui/graphics/e;
    .locals 26
    ...
    iget v2, v0, Landroidx/compose/ui/graphics/GraphicsLayerElement;->a:F

    iget v3, v0, Landroidx/compose/ui/graphics/GraphicsLayerElement;->b:F

    iget v4, v0, Landroidx/compose/ui/graphics/GraphicsLayerElement;->c:F

    iget v5, v0, Landroidx/compose/ui/graphics/GraphicsLayerElement;->d:F

    iget v6, v0, Landroidx/compose/ui/graphics/GraphicsLayerElement;->e:F

    iget v7, v0, Landroidx/compose/ui/graphics/GraphicsLayerElement;->f:F

    iget v8, v0, Landroidx/compose/ui/graphics/GraphicsLayerElement;->g:F

    iget v9, v0, Landroidx/compose/ui/graphics/GraphicsLayerElement;->h:F

    iget v10, v0, Landroidx/compose/ui/graphics/GraphicsLayerElement;->i:F

    iget v11, v0, Landroidx/compose/ui/graphics/GraphicsLayerElement;->j:F

    iget-wide v12, v0, Landroidx/compose/ui/graphics/GraphicsLayerElement;->k:J

    iget-object v14, v0, Landroidx/compose/ui/graphics/GraphicsLayerElement;->l:Lm0/i1;

    iget-boolean v15, v0, Landroidx/compose/ui/graphics/GraphicsLayerElement;->m:Z
    ...
    iget v1, v0, Landroidx/compose/ui/graphics/GraphicsLayerElement;->p:I
    ...
    invoke-direct/range {v1 .. v22}, Landroidx/compose/ui/graphics/e;-><init>(FFFFFFFFFFJLm0/i1;ZLm0/d1;JJILkotlin/jvm/internal/DefaultConstructorMarker;)V

    return-object v23
.end method

.method public e(Landroidx/compose/ui/graphics/e;)V
    .locals 2
    ...
    invoke-virtual {p1, v0, v1}, Landroidx/compose/ui/graphics/e;->y1(J)V

    iget-object v0, p0, Landroidx/compose/ui/graphics/GraphicsLayerElement;->l:Lm0/i1;

    invoke-virtual {p1, v0}, Landroidx/compose/ui/graphics/e;->I1(Lm0/i1;)V

    iget-boolean v0, p0, Landroidx/compose/ui/graphics/GraphicsLayerElement;->m:Z

    invoke-virtual {p1, v0}, Landroidx/compose/ui/graphics/e;->G(Z)V

    const/4 v0, 0x0

    invoke-virtual {p1, v0}, Landroidx/compose/ui/graphics/e;->k(Lm0/d1;)V
    ...
    invoke-virtual {p1, v0, v1}, Landroidx/compose/ui/graphics/e;->I(J)V

    iget v0, p0, Landroidx/compose/ui/graphics/GraphicsLayerElement;->p:I

    invoke-virtual {p1, v0}, Landroidx/compose/ui/graphics/e;->t(I)V

    invoke-virtual {p1}, Landroidx/compose/ui/graphics/e;->M2()V
...
.method public equals(Ljava/lang/Object;)Z
    ...
    :cond_c
    iget-object v1, p0, Landroidx/compose/ui/graphics/GraphicsLayerElement;->l:Lm0/i1;

    iget-object v3, p1, Landroidx/compose/ui/graphics/GraphicsLayerElement;->l:Lm0/i1;
