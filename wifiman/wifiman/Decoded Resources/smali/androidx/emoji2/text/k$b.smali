...
# direct methods
.method constructor <init>(Landroid/content/Context;LB1/e;Landroidx/emoji2/text/k$a;)V
    .locals 1
    ...
    iput-object p2, p0, Landroidx/emoji2/text/k$b;->b:LB1/e;
...
.method private e()LB1/k$b;
    ...
    iget-object v2, p0, Landroidx/emoji2/text/k$b;->b:LB1/e;

    invoke-virtual {v0, v1, v2}, Landroidx/emoji2/text/k$a;->b(Landroid/content/Context;LB1/e;)LB1/k$a;

    move-result-object v0
    :try_end_0
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_0 .. :try_end_0} :catch_0

    invoke-virtual {v0}, LB1/k$a;->e()I

    move-result v1

    if-nez v1, :cond_1

    invoke-virtual {v0}, LB1/k$a;->c()[LB1/k$b;
...
.method c()V
    ...
    :try_start_1
    invoke-direct {p0}, Landroidx/emoji2/text/k$b;->e()LB1/k$b;

    move-result-object v0

    invoke-virtual {v0}, LB1/k$b;->b()I
    ...
    invoke-virtual {v1, v2, v0}, Landroidx/emoji2/text/k$a;->a(Landroid/content/Context;LB1/k$b;)Landroid/graphics/Typeface;

    move-result-object v1

    iget-object v2, p0, Landroidx/emoji2/text/k$b;->a:Landroid/content/Context;

    invoke-virtual {v0}, LB1/k$b;->d()Landroid/net/Uri;

    move-result-object v0

    const/4 v3, 0x0

    invoke-static {v2, v3, v0}, Lw1/r;->e(Landroid/content/Context;Landroid/os/CancellationSignal;Landroid/net/Uri;)Ljava/nio/ByteBuffer;
