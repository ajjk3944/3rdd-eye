.class abstract Landroidx/security/crypto/b$b$a;
...
.annotation system Ldalvik/annotation/EnclosingClass;
    value = Landroidx/security/crypto/b$b;
.end annotation
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Landroidx/security/crypto/b$b$a$b;,
        Landroidx/security/crypto/b$b$a$a;
    }
.end annotation


# direct methods
.method static a(Landroidx/security/crypto/b$b;)Landroidx/security/crypto/b;
    .locals 4

    iget-object v0, p0, Landroidx/security/crypto/b$b;->c:Landroidx/security/crypto/b$c;

    if-nez v0, :cond_1

    iget-object v1, p0, Landroidx/security/crypto/b$b;->b:Landroid/security/keystore/KeyGenParameterSpec;
    ...
    iget-object v1, p0, Landroidx/security/crypto/b$b;->a:Ljava/lang/String;
    ...
    iget-boolean v1, p0, Landroidx/security/crypto/b$b;->d:Z
    ...
    iget v1, p0, Landroidx/security/crypto/b$b;->e:I

    invoke-static {v0, v1, v2}, Landroidx/security/crypto/b$b$a$b;->a(Landroid/security/keystore/KeyGenParameterSpec$Builder;II)V
    ...
    iget-boolean v1, p0, Landroidx/security/crypto/b$b;->f:Z

    if-eqz v1, :cond_4

    iget-object v1, p0, Landroidx/security/crypto/b$b;->g:Landroid/content/Context;
    ...
    invoke-static {v0}, Landroidx/security/crypto/b$b$a$a;->a(Landroid/security/keystore/KeyGenParameterSpec$Builder;)V
    ...
    iput-object v0, p0, Landroidx/security/crypto/b$b;->b:Landroid/security/keystore/KeyGenParameterSpec;
    ...
    iget-object p0, p0, Landroidx/security/crypto/b$b;->b:Landroid/security/keystore/KeyGenParameterSpec;
