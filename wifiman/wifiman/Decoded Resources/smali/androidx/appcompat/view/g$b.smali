...
.method private i(Landroid/view/MenuItem;)V
    ...
    :cond_8
    :goto_3
    iget-object v0, p0, Landroidx/appcompat/view/g$b;->A:LF1/b;

    if-eqz v0, :cond_9

    invoke-static {p1, v0}, LF1/y;->a(Landroid/view/MenuItem;LF1/b;)Landroid/view/MenuItem;

    :cond_9
    iget-object v0, p0, Landroidx/appcompat/view/g$b;->B:Ljava/lang/CharSequence;

    invoke-static {p1, v0}, LF1/y;->c(Landroid/view/MenuItem;Ljava/lang/CharSequence;)V

    iget-object v0, p0, Landroidx/appcompat/view/g$b;->C:Ljava/lang/CharSequence;

    invoke-static {p1, v0}, LF1/y;->g(Landroid/view/MenuItem;Ljava/lang/CharSequence;)V

    iget-char v0, p0, Landroidx/appcompat/view/g$b;->n:C

    iget v1, p0, Landroidx/appcompat/view/g$b;->o:I

    invoke-static {p1, v0, v1}, LF1/y;->b(Landroid/view/MenuItem;CI)V

    iget-char v0, p0, Landroidx/appcompat/view/g$b;->p:C

    iget v1, p0, Landroidx/appcompat/view/g$b;->q:I

    invoke-static {p1, v0, v1}, LF1/y;->f(Landroid/view/MenuItem;CI)V

    iget-object v0, p0, Landroidx/appcompat/view/g$b;->E:Landroid/graphics/PorterDuff$Mode;

    if-eqz v0, :cond_a

    invoke-static {p1, v0}, LF1/y;->e(Landroid/view/MenuItem;Landroid/graphics/PorterDuff$Mode;)V
    ...
    invoke-static {p1, v0}, LF1/y;->d(Landroid/view/MenuItem;Landroid/content/res/ColorStateList;)V
...
.method public g(Landroid/util/AttributeSet;)V
    ...
    iput-object v0, p0, Landroidx/appcompat/view/g$b;->A:LF1/b;
    ...
    :cond_3
    iput-object v4, p0, Landroidx/appcompat/view/g$b;->A:LF1/b;
    ...
    :goto_4
    invoke-virtual {p1}, Landroidx/appcompat/widget/b0;->x()V
