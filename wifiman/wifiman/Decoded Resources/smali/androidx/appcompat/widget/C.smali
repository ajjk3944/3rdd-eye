...
.method private C(Landroid/content/Context;Landroidx/appcompat/widget/b0;)V
    ...
    invoke-virtual {p2, v4, p1, v9}, Landroidx/appcompat/widget/b0;->j(IILv1/h$e;)Landroid/graphics/Typeface;
...
.method private a(Landroid/graphics/drawable/Drawable;Landroidx/appcompat/widget/Z;)V
    ...
    invoke-static {p1, p2, v0}, Landroidx/appcompat/widget/k;->i(Landroid/graphics/drawable/Drawable;Landroidx/appcompat/widget/Z;[I)V

    :cond_0
    return-void
.end method

.method private static d(Landroid/content/Context;Landroidx/appcompat/widget/k;I)Landroidx/appcompat/widget/Z;
    .locals 0
...
.method private z()V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/C;->h:Landroidx/appcompat/widget/Z;

    iput-object v0, p0, Landroidx/appcompat/widget/C;->b:Landroidx/appcompat/widget/Z;

    iput-object v0, p0, Landroidx/appcompat/widget/C;->c:Landroidx/appcompat/widget/Z;

    iput-object v0, p0, Landroidx/appcompat/widget/C;->d:Landroidx/appcompat/widget/Z;

    iput-object v0, p0, Landroidx/appcompat/widget/C;->e:Landroidx/appcompat/widget/Z;

    iput-object v0, p0, Landroidx/appcompat/widget/C;->f:Landroidx/appcompat/widget/Z;

    iput-object v0, p0, Landroidx/appcompat/widget/C;->g:Landroidx/appcompat/widget/Z;
...
.method b()V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/C;->c:Landroidx/appcompat/widget/Z;

    if-nez v0, :cond_0

    iget-object v0, p0, Landroidx/appcompat/widget/C;->d:Landroidx/appcompat/widget/Z;

    if-nez v0, :cond_0

    iget-object v0, p0, Landroidx/appcompat/widget/C;->e:Landroidx/appcompat/widget/Z;
    ...
    iget-object v4, p0, Landroidx/appcompat/widget/C;->b:Landroidx/appcompat/widget/Z;

    invoke-direct {p0, v3, v4}, Landroidx/appcompat/widget/C;->a(Landroid/graphics/drawable/Drawable;Landroidx/appcompat/widget/Z;)V

    const/4 v3, 0x1

    aget-object v3, v0, v3

    iget-object v4, p0, Landroidx/appcompat/widget/C;->c:Landroidx/appcompat/widget/Z;

    invoke-direct {p0, v3, v4}, Landroidx/appcompat/widget/C;->a(Landroid/graphics/drawable/Drawable;Landroidx/appcompat/widget/Z;)V

    aget-object v3, v0, v1

    iget-object v4, p0, Landroidx/appcompat/widget/C;->d:Landroidx/appcompat/widget/Z;
    ...
    iget-object v3, p0, Landroidx/appcompat/widget/C;->e:Landroidx/appcompat/widget/Z;

    invoke-direct {p0, v0, v3}, Landroidx/appcompat/widget/C;->a(Landroid/graphics/drawable/Drawable;Landroidx/appcompat/widget/Z;)V

    :cond_1
    iget-object v0, p0, Landroidx/appcompat/widget/C;->f:Landroidx/appcompat/widget/Z;

    if-nez v0, :cond_2

    iget-object v0, p0, Landroidx/appcompat/widget/C;->g:Landroidx/appcompat/widget/Z;
    ...
    iget-object v3, p0, Landroidx/appcompat/widget/C;->f:Landroidx/appcompat/widget/Z;

    invoke-direct {p0, v2, v3}, Landroidx/appcompat/widget/C;->a(Landroid/graphics/drawable/Drawable;Landroidx/appcompat/widget/Z;)V

    aget-object v0, v0, v1

    iget-object v1, p0, Landroidx/appcompat/widget/C;->g:Landroidx/appcompat/widget/Z;

    invoke-direct {p0, v0, v1}, Landroidx/appcompat/widget/C;->a(Landroid/graphics/drawable/Drawable;Landroidx/appcompat/widget/Z;)V
...
.method m(Landroid/util/AttributeSet;I)V
    ...
    invoke-static/range {v0 .. v6}, LF1/W;->k0(Landroid/view/View;Landroid/content/Context;[ILandroid/util/AttributeSet;Landroid/content/res/TypedArray;II)V
    ...
    invoke-static {v10, v11, v1}, Landroidx/appcompat/widget/C;->d(Landroid/content/Context;Landroidx/appcompat/widget/k;I)Landroidx/appcompat/widget/Z;

    move-result-object v1

    iput-object v1, v7, Landroidx/appcompat/widget/C;->b:Landroidx/appcompat/widget/Z;
    ...
    iput-object v1, v7, Landroidx/appcompat/widget/C;->c:Landroidx/appcompat/widget/Z;
    ...
    iput-object v1, v7, Landroidx/appcompat/widget/C;->d:Landroidx/appcompat/widget/Z;
    ...
    iput-object v1, v7, Landroidx/appcompat/widget/C;->e:Landroidx/appcompat/widget/Z;
    ...
    iput-object v1, v7, Landroidx/appcompat/widget/C;->f:Landroidx/appcompat/widget/Z;
    ...
    iput-object v1, v7, Landroidx/appcompat/widget/C;->g:Landroidx/appcompat/widget/Z;

    :cond_5
    invoke-virtual {v13}, Landroidx/appcompat/widget/b0;->x()V
    ...
    sget-object v3, Lh/j;->n2:[I

    invoke-static {v10, v0, v3}, Landroidx/appcompat/widget/b0;->t(Landroid/content/Context;I[I)Landroidx/appcompat/widget/b0;
    ...
    invoke-virtual {v0, v3, v12}, Landroidx/appcompat/widget/b0;->a(IZ)Z
    ...
    :goto_0
    invoke-direct {v7, v10, v0}, Landroidx/appcompat/widget/C;->C(Landroid/content/Context;Landroidx/appcompat/widget/b0;)V
    ...
    invoke-virtual {v0, v5}, Landroidx/appcompat/widget/b0;->o(I)Ljava/lang/String;
    ...
    invoke-virtual {v0, v15, v12}, Landroidx/appcompat/widget/b0;->a(IZ)Z
    ...
    invoke-virtual {v0, v4, v14}, Landroidx/appcompat/widget/b0;->f(II)I
    ...
    invoke-static {v0, v13}, Landroidx/appcompat/widget/K;->d(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;
    ...
    invoke-virtual {v8, v2}, Landroidx/appcompat/widget/b0;->s(I)Z

    move-result v3

    if-eqz v3, :cond_1e

    invoke-virtual {v8, v2}, Landroidx/appcompat/widget/b0;->w(I)Landroid/util/TypedValue;
    ...
    :goto_e
    invoke-virtual {v8}, Landroidx/appcompat/widget/b0;->x()V

    if-eq v0, v14, :cond_1f

    iget-object v4, v7, Landroidx/appcompat/widget/C;->a:Landroid/widget/TextView;

    invoke-static {v4, v0}, Landroidx/core/widget/h;->j(Landroid/widget/TextView;I)V
    ...
    invoke-static {v0, v2, v3}, Landroidx/core/widget/h;->m(Landroid/widget/TextView;IF)V
...
.method q(Landroid/content/Context;I)V
    ...
    invoke-virtual {p2, v0, v1}, Landroidx/appcompat/widget/b0;->f(II)I
    ...
    :cond_1
    invoke-direct {p0, p1, p2}, Landroidx/appcompat/widget/C;->C(Landroid/content/Context;Landroidx/appcompat/widget/b0;)V
...
.method r(Landroid/widget/TextView;Landroid/view/inputmethod/InputConnection;Landroid/view/inputmethod/EditorInfo;)V
    ...
    invoke-static {p3, p1}, LI1/a;->e(Landroid/view/inputmethod/EditorInfo;Ljava/lang/CharSequence;)V
...
.method w(Landroid/content/res/ColorStateList;)V
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/C;->h:Landroidx/appcompat/widget/Z;
