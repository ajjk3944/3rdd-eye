...
.method public constructor <init>(Lej/g;Z)V
    .locals 7
    ...
    iput-object p1, p0, Lokhttp3/internal/http2/Http2Reader;->a:Lej/g;
    ...
    invoke-direct {v2, p1}, Lokhttp3/internal/http2/Http2Reader$ContinuationSource;-><init>(Lej/g;)V
    ...
    invoke-direct/range {v1 .. v6}, Lokhttp3/internal/http2/Hpack$Reader;-><init>(Lej/D;IIILkotlin/jvm/internal/DefaultConstructorMarker;)V
...
.method private final C(Lokhttp3/internal/http2/Http2Reader$Handler;I)V
    .locals 5

    iget-object v0, p0, Lokhttp3/internal/http2/Http2Reader;->a:Lej/g;

    invoke-interface {v0}, Lej/g;->readInt()I
    ...
    iget-object v3, p0, Lokhttp3/internal/http2/Http2Reader;->a:Lej/g;

    invoke-interface {v3}, Lej/g;->readByte()B
...
.method private final J(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    invoke-direct {p0, p1, p4}, Lokhttp3/internal/http2/Http2Reader;->C(Lokhttp3/internal/http2/Http2Reader$Handler;I)V
...
.method private final P(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    :goto_0
    iget-object v1, p0, Lokhttp3/internal/http2/Http2Reader;->a:Lej/g;

    invoke-interface {v1}, Lej/g;->readInt()I
    ...
    invoke-direct {p0, p2, v0, p3, p4}, Lokhttp3/internal/http2/Http2Reader;->s(IIII)Ljava/util/List;

    move-result-object p2

    invoke-interface {p1, p4, v1, p2}, Lokhttp3/internal/http2/Http2Reader$Handler;->l(IILjava/util/List;)V
...
.method private final S(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    iget-object p2, p0, Lokhttp3/internal/http2/Http2Reader;->a:Lej/g;

    invoke-interface {p2}, Lej/g;->readInt()I
...
.method private final T(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    invoke-static {v0, p2}, Lsh/m;->s(II)Lsh/i;

    move-result-object p2

    const/4 v1, 0x6

    invoke-static {p2, v1}, Lsh/m;->r(Lsh/g;I)Lsh/g;
    ...
    invoke-interface {v3}, Lej/g;->readShort()S
    ...
    iget-object v4, p0, Lokhttp3/internal/http2/Http2Reader;->a:Lej/g;

    invoke-interface {v4}, Lej/g;->readInt()I
...
.method private final Y(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    invoke-interface {p1, p4, p2, p3}, Lokhttp3/internal/http2/Http2Reader$Handler;->f(IJ)V
...
.method private final j(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    invoke-interface {v1}, Lej/g;->readByte()B
    ...
    iget-object p3, p0, Lokhttp3/internal/http2/Http2Reader;->a:Lej/g;

    invoke-interface {p1, v0, p4, p3, p2}, Lokhttp3/internal/http2/Http2Reader$Handler;->h(ZILej/g;I)V

    iget-object p1, p0, Lokhttp3/internal/http2/Http2Reader;->a:Lej/g;

    int-to-long p2, v1

    invoke-interface {p1, p2, p3}, Lej/g;->d(J)V
...
.method private final p(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    iget-object p4, p0, Lokhttp3/internal/http2/Http2Reader;->a:Lej/g;

    invoke-interface {p4}, Lej/g;->readInt()I
    ...
    invoke-interface {v0, v1, v2}, Lej/g;->l(J)Lej/h;

    move-result-object v0

    :cond_0
    invoke-interface {p1, p4, p3, v0}, Lokhttp3/internal/http2/Http2Reader$Handler;->e(ILokhttp3/internal/http2/ErrorCode;Lej/h;)V
...
.method private final s(IIII)Ljava/util/List;
    ...
    invoke-virtual {p1, p2}, Lokhttp3/internal/http2/Http2Reader$ContinuationSource;->s(I)V
    ...
    invoke-virtual {p1, p4}, Lokhttp3/internal/http2/Http2Reader$ContinuationSource;->v(I)V
...
.method private final v(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    invoke-direct {p0, p2, v1, p3, p4}, Lokhttp3/internal/http2/Http2Reader;->s(IIII)Ljava/util/List;
...
.method public final g(ZLokhttp3/internal/http2/Http2Reader$Handler;)Z
    ...
    invoke-static {v0}, Lokhttp3/internal/Util;->K(Lej/g;)I
...
.method public final h(Lokhttp3/internal/http2/Http2Reader$Handler;)V
    .locals 4
    ...
    sget-object v0, Lokhttp3/internal/http2/Http2;->b:Lej/h;
    ...
    invoke-interface {p1, v1, v2}, Lej/g;->l(J)Lej/h;
    ...
    invoke-virtual {p1}, Lej/h;->q0()Ljava/lang/String;
