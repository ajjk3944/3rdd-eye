...
.method public constructor <init>(Lmh/p;)V
    ...
    iput-object p1, p0, LZi/u;->a:Lmh/p;

    new-instance p1, LZi/v;

    invoke-direct {p1}, LZi/v;-><init>()V

    iput-object p1, p0, LZi/u;->b:LZi/v;
...
.method public a(Lth/d;Ljava/util/List;)Ljava/lang/Object;
    ...
    iget-object v0, p0, LZi/u;->b:LZi/v;
    ...
    :cond_0
    new-instance v1, LZi/u$a;

    invoke-direct {v1}, LZi/u$a;-><init>()V
    ...
    :cond_1
    invoke-static {v1}, LZi/y0;->a(LZi/y0;)Ljava/util/concurrent/ConcurrentHashMap;
    ...
    iget-object v1, p0, LZi/u;->a:Lmh/p;
    ...
    invoke-virtual {v1}, LYg/u;->o()Ljava/lang/Object;
