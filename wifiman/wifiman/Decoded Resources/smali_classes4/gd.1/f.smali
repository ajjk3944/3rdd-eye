...
.method static constructor <clinit>()V
    ...
    const-string v1, "model.network.portscan"
    ...
    sput-object v7, Lgd/f;->a:Lorg/kodein/di/DI$g;

    return-void
.end method

.method public static synthetic a(Luj/j;)Lgd/b;
    .locals 0

    invoke-static {p0}, Lgd/f;->f(Luj/j;)Lgd/b;
...
.method public static synthetic b(Luj/j;)Lgd/h;
    .locals 0

    invoke-static {p0}, Lgd/f;->g(Luj/j;)Lgd/h;
...
.method public static synthetic c(Lorg/kodein/di/DI$b;)LYg/J;
    ...
    invoke-static {p0}, Lgd/f;->e(Lorg/kodein/di/DI$b;)LYg/J;
...
.method public static final d()Lorg/kodein/di/DI$g;
    ...
    sget-object v0, Lgd/f;->a:Lorg/kodein/di/DI$g;
...
.method private static final e(Lorg/kodein/di/DI$b;)LYg/J;
    ...
    new-instance v1, Lgd/f$a;

    invoke-direct {v1}, Lgd/f$a;-><init>()V
    ...
    invoke-direct {v10}, Lgd/d;-><init>()V
    ...
    new-instance v3, Lgd/f$c;

    invoke-direct {v3}, Lgd/f$c;-><init>()V
    ...
    new-instance v3, Lgd/f$b;

    invoke-direct {v3}, Lgd/f$b;-><init>()V
    ...
    new-instance v10, Lgd/e;

    invoke-direct {v10}, Lgd/e;-><init>()V
    ...
    new-instance p0, Lgd/f$d;

    invoke-direct {p0}, Lgd/f$d;-><init>()V
...
.method private static final f(Luj/j;)Lgd/b;
    .locals 1
...
.method private static final g(Luj/j;)Lgd/h;
    .locals 8
    ...
    new-instance v3, Lgd/f$e;

    invoke-direct {v3}, Lgd/f$e;-><init>()V
    ...
    check-cast v1, Lgd/a$b;

    sget-object v2, Lfe/u$a;->HEAVY_PARALLEL:Lfe/u$a;
    ...
    new-instance v6, Lgd/f$f;

    invoke-direct {v6}, Lgd/f$f;-><init>()V
    ...
    new-instance v7, Lgd/f$g;

    invoke-direct {v7}, Lgd/f$g;-><init>()V
    ...
    invoke-direct {v0, v1, p0}, Lgd/h;-><init>(Lgd/a$b;Lgg/y;)V
