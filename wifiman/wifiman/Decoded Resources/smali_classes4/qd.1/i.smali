...
.method static constructor <clinit>()V
    ...
    invoke-direct {v4}, Lqd/e;-><init>()V

    const/4 v5, 0x6

    const/4 v6, 0x0

    const-string v1, "speedtest.a2a"
    ...
    sput-object v7, Lqd/i;->a:Lorg/kodein/di/DI$g;

    return-void
.end method

.method public static synthetic a(Luj/j;)Lrd/j;
    .locals 0

    invoke-static {p0}, Lqd/i;->i(Luj/j;)Lrd/j;
...
.method public static synthetic b(Luj/j;)Lrd/d;
    .locals 0

    invoke-static {p0}, Lqd/i;->h(Luj/j;)Lrd/d;
...
.method public static synthetic c(Luj/b;Ljava/lang/Object;)Lqd/b;
    .locals 0

    invoke-static {p0, p1}, Lqd/i;->g(Luj/b;Ljava/lang/Object;)Lqd/b;
...
.method public static synthetic d(Lorg/kodein/di/DI$b;)LYg/J;
    .locals 0

    invoke-static {p0}, Lqd/i;->f(Lorg/kodein/di/DI$b;)LYg/J;
...
.method public static final e()Lorg/kodein/di/DI$g;
    ...
    sget-object v0, Lqd/i;->a:Lorg/kodein/di/DI$g;
...
.method private static final f(Lorg/kodein/di/DI$b;)LYg/J;
    ...
    new-instance v1, Lqd/i$a;

    invoke-direct {v1}, Lqd/i$a;-><init>()V
    ...
    new-instance v11, Lqd/f;

    invoke-direct {v11}, Lqd/f;-><init>()V

    new-instance v13, Luj/i;
    ...
    new-instance v3, Lqd/i$d;

    invoke-direct {v3}, Lqd/i$d;-><init>()V
    ...
    new-instance v3, Lqd/i$e;

    invoke-direct {v3}, Lqd/i$e;-><init>()V
    ...
    const-class v9, Lqd/b;

    invoke-direct {v8, v3, v9}, Lorg/kodein/type/d;-><init>(Lorg/kodein/type/i;Ljava/lang/Class;)V
    ...
    new-instance v3, Lqd/i$b;

    invoke-direct {v3}, Lqd/i$b;-><init>()V
    ...
    new-instance v10, Lqd/g;

    invoke-direct {v10}, Lqd/g;-><init>()V
    ...
    new-instance v3, Lqd/i$f;

    invoke-direct {v3}, Lqd/i$f;-><init>()V
    ...
    new-instance v3, Lqd/i$c;

    invoke-direct {v3}, Lqd/i$c;-><init>()V
    ...
    new-instance v10, Lqd/h;

    invoke-direct {v10}, Lqd/h;-><init>()V
    ...
    new-instance p0, Lqd/i$g;

    invoke-direct {p0}, Lqd/i$g;-><init>()V
...
.method private static final g(Luj/b;Ljava/lang/Object;)Lqd/b;
    .locals 10
    ...
    new-instance v2, Lqd/i$h;

    invoke-direct {v2}, Lqd/i$h;-><init>()V
    ...
    new-instance v5, Lqd/i$i;

    invoke-direct {v5}, Lqd/i$i;-><init>()V
    ...
    new-instance v6, Lqd/i$j;

    invoke-direct {v6}, Lqd/i$j;-><init>()V
    ...
    new-instance v7, Lqd/i$k;

    invoke-direct {v7}, Lqd/i$k;-><init>()V
    ...
    new-instance v8, Lqd/i$l;

    invoke-direct {v8}, Lqd/i$l;-><init>()V
    ...
    invoke-interface {v1, v7, v2}, Lrj/o2;->e(Lorg/kodein/type/q;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    new-instance v8, Lqd/i$m;

    invoke-direct {v8}, Lqd/i$m;-><init>()V
    ...
    invoke-direct {v1, v8, v3}, Lorg/kodein/type/d;-><init>(Lorg/kodein/type/i;Ljava/lang/Class;)V
    ...
    invoke-direct/range {v1 .. v7}, Lqd/b;-><init>(Lzd/a;Lyd/a;Lwd/f;Lvd/a;Lud/a;Ltd/d;)V

    return-object p1
.end method

.method private static final h(Luj/j;)Lrd/d;
    .locals 8
    ...
    new-instance v2, Lqd/i$n;

    invoke-direct {v2}, Lqd/i$n;-><init>()V
    ...
    new-instance v5, Lqd/i$o;

    invoke-direct {v5}, Lqd/i$o;-><init>()V
    ...
    new-instance v6, Lqd/i$p;

    invoke-direct {v6}, Lqd/i$p;-><init>()V
    ...
    const-class v7, Lcom/ui/wifiman/model/discovery/engine/bonjour/RxBonjour;
    ...
    check-cast v4, Lcom/ui/wifiman/model/discovery/engine/bonjour/RxBonjour;
    ...
    new-instance v6, Lqd/i$q;

    invoke-direct {v6}, Lqd/i$q;-><init>()V
    ...
    invoke-direct {v2, v0, v1, p0, v4}, Lrd/d;-><init>(LZc/f;Lje/u;Lld/b;Lcom/ui/wifiman/model/discovery/engine/bonjour/RxBonjour;)V

    return-object v2
.end method

.method private static final i(Luj/j;)Lrd/j;
    .locals 11
    ...
    new-instance v3, Lqd/i$r;

    invoke-direct {v3}, Lqd/i$r;-><init>()V
    ...
    new-instance v6, Lqd/i$s;

    invoke-direct {v6}, Lqd/i$s;-><init>()V
    ...
    new-instance v7, Lqd/i$t;

    invoke-direct {v7}, Lqd/i$t;-><init>()V
    ...
    new-instance v8, Lqd/i$u;

    invoke-direct {v8}, Lqd/i$u;-><init>()V
    ...
    new-instance v9, Lqd/i$v;

    invoke-direct {v9}, Lqd/i$v;-><init>()V
    ...
    const-class v10, Lcom/ui/wifiman/model/discovery/engine/bonjour/RxBonjour;
    ...
    check-cast v8, Lcom/ui/wifiman/model/discovery/engine/bonjour/RxBonjour;
    ...
    new-instance v9, Lqd/i$w;

    invoke-direct {v9}, Lqd/i$w;-><init>()V
    ...
    invoke-direct/range {v1 .. v7}, Lrd/j;-><init>(LZc/f;Lmc/a;Lld/b;Lvc/b;Lcom/ui/wifiman/model/discovery/engine/bonjour/RxBonjour;Ldc/a;)V
