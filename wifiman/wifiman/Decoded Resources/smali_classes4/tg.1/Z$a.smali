...
.method constructor <init>(Lgg/x;LHg/d;Lgg/v;)V
    ...
    iput-object p2, p0, Ltg/Z$a;->d:LHg/d;

    iput-object p3, p0, Ltg/Z$a;->g:Lgg/v;

    new-instance p1, Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-direct {p1}, Ljava/util/concurrent/atomic/AtomicInteger;-><init>()V

    iput-object p1, p0, Ltg/Z$a;->b:Ljava/util/concurrent/atomic/AtomicInteger;

    new-instance p1, Lzg/c;

    invoke-direct {p1}, Lzg/c;-><init>()V

    iput-object p1, p0, Ltg/Z$a;->c:Lzg/c;

    new-instance p1, Ltg/Z$a$a;

    invoke-direct {p1, p0}, Ltg/Z$a$a;-><init>(Ltg/Z$a;)V

    iput-object p1, p0, Ltg/Z$a;->e:Ltg/Z$a$a;

    new-instance p1, Ljava/util/concurrent/atomic/AtomicReference;

    invoke-direct {p1}, Ljava/util/concurrent/atomic/AtomicReference;-><init>()V

    iput-object p1, p0, Ltg/Z$a;->f:Ljava/util/concurrent/atomic/AtomicReference;
...
.method public c(Lhg/c;)V
    ...
    iget-object v0, p0, Ltg/Z$a;->f:Ljava/util/concurrent/atomic/AtomicReference;
...
.method m()V
    ...
    iget-object v0, p0, Ltg/Z$a;->b:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    :cond_0
    invoke-virtual {p0}, Ltg/Z$a;->isDisposed()Z
    ...
    :cond_1
    iget-boolean v0, p0, Ltg/Z$a;->h:Z

    if-nez v0, :cond_2

    const/4 v0, 0x1

    iput-boolean v0, p0, Ltg/Z$a;->h:Z

    iget-object v0, p0, Ltg/Z$a;->g:Lgg/v;
...
.method public onError(Ljava/lang/Throwable;)V
    ...
    iget-object v0, p0, Ltg/Z$a;->d:LHg/d;
