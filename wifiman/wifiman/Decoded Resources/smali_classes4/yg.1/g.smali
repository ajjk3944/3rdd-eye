...
.field public static final enum CANCELLED:Lyg/g;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lyg/g;->CANCELLED:Lyg/g;

    filled-new-array {v0}, [Lyg/g;
...
.method public static cancel(Ljava/util/concurrent/atomic/AtomicReference;)Z
    ...
    .line 5
    invoke-interface {p0}, LDj/c;->cancel()V
...
.method public static deferredRequest(Ljava/util/concurrent/atomic/AtomicReference;Ljava/util/concurrent/atomic/AtomicLong;J)V
    ...
    invoke-interface {v0, p2, p3}, LDj/c;->request(J)V

    goto :goto_0

    :cond_0
    invoke-static {p2, p3}, Lyg/g;->validate(J)Z

    move-result v0

    if-eqz v0, :cond_1

    invoke-static {p1, p2, p3}, Lzg/d;->a(Ljava/util/concurrent/atomic/AtomicLong;J)J
    ...
    invoke-interface {p0, v0, v1}, LDj/c;->request(J)V
...
.method public static deferredSetOnce(Ljava/util/concurrent/atomic/AtomicReference;Ljava/util/concurrent/atomic/AtomicLong;LDj/c;)Z
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {p0, p2}, Lyg/g;->setOnce(Ljava/util/concurrent/atomic/AtomicReference;LDj/c;)Z
    ...
    invoke-interface {p2, p0, p1}, LDj/c;->request(J)V
...
.method public static replace(Ljava/util/concurrent/atomic/AtomicReference;LDj/c;)Z
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static set(Ljava/util/concurrent/atomic/AtomicReference;LDj/c;)Z
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static setOnce(Ljava/util/concurrent/atomic/AtomicReference;LDj/c;)Z
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 5
    invoke-static {}, Lyg/g;->reportSubscriptionSet()V
...
.method public static setOnce(Ljava/util/concurrent/atomic/AtomicReference;LDj/c;J)Z
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 7
    invoke-interface {p1, p2, p3}, LDj/c;->request(J)V
...
.method public static validate(LDj/c;LDj/c;)Z
    .locals 1
