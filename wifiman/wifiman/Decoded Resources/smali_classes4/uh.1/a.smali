...
# direct methods
.method private static final a(Lpi/r0;Lpi/v0;Ljava/util/List;Z)Lpi/d0;
    .locals 8
    ...
    invoke-virtual {v2}, Lth/r;->c()Lth/p;

    move-result-object v5

    check-cast v5, Lwh/U0;

    if-eqz v5, :cond_1

    invoke-virtual {v5}, Lwh/U0;->u()Lpi/S;
    ...
    :goto_1
    invoke-virtual {v2}, Lth/r;->d()Lth/s;
    ...
    invoke-direct {v1, v2, v5}, Lpi/D0;-><init>(Lpi/N0;Lpi/S;)V
    ...
    invoke-direct {v2, v1}, Lpi/k0;-><init>(LBh/l0;)V
...
.method public static final b(Lth/e;Ljava/util/List;ZLjava/util/List;)Lth/p;
    .locals 4
    ...
    invoke-interface {v0}, Lwh/Y;->a()LBh/h;
    ...
    sget-object p3, Lpi/r0;->b:Lpi/r0$a;

    invoke-virtual {p3}, Lpi/r0$a;->j()Lpi/r0;
    ...
    invoke-static {p3, p0, p1, p2}, Luh/a;->a(Lpi/r0;Lpi/v0;Ljava/util/List;Z)Lpi/d0;

    move-result-object p0

    const/4 p1, 0x2

    invoke-direct {v0, p0, v1, p1, v1}, Lwh/U0;-><init>(Lpi/S;Lmh/a;ILkotlin/jvm/internal/DefaultConstructorMarker;)V
