...
.field private static final INPUT_KEY_LENGTH:I = 0x20

.field private static final KEY_LENGTH:I = 0x18

.field private static final PROTOCOL_CLASS:Ljava/lang/String; = "DESede"

.field private static final PROTOCOL_ID:Ljava/lang/String; = "DESede/CBC/NoPadding"
...
.method static constructor <clinit>()V
    ...
    sget-object v1, Lorg/snmp4j/mp/SnmpConstants;->usm3DESEDEPrivProtocol:Lorg/snmp4j/smi/OID;
    ...
    const-class v0, Lorg/snmp4j/security/Priv3DES;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lorg/snmp4j/security/PrivacyGeneric;->protocolId:Ljava/lang/String;

    const-string v0, "DESede"

    iput-object v0, p0, Lorg/snmp4j/security/PrivacyGeneric;->protocolClass:Ljava/lang/String;
...
.method public decrypt([BII[BJJLorg/snmp4j/security/DecryptParams;)[B
    ...
    :cond_1
    sget-object p1, Lorg/snmp4j/security/Priv3DES;->logger:Lorg/snmp4j/log/LogAdapter;

    new-instance p2, Ljava/lang/StringBuilder;

    invoke-direct {p2}, Ljava/lang/StringBuilder;-><init>()V

    const-string p3, "Wrong Key length: need at least 32 bytes, is "
    ...
    const-string p3, " (should be at least 32)."
...
.method public encrypt([BII[BJJLorg/snmp4j/security/DecryptParams;)[B
    ...
    iget-object v3, v1, Lorg/snmp4j/security/Priv3DES;->salt:Lorg/snmp4j/security/Salt;
    ...
    sget-object v6, Lorg/snmp4j/security/Priv3DES;->logger:Lorg/snmp4j/log/LogAdapter;
    ...
    sget-object v3, Lorg/snmp4j/security/Priv3DES;->logger:Lorg/snmp4j/log/LogAdapter;
    ...
    :cond_6
    :goto_2
    sget-object v0, Lorg/snmp4j/security/Priv3DES;->logger:Lorg/snmp4j/log/LogAdapter;
    ...
    :cond_8
    sget-object v2, Lorg/snmp4j/security/Priv3DES;->logger:Lorg/snmp4j/log/LogAdapter;

    new-instance v3, Ljava/lang/StringBuilder;

    invoke-direct {v3}, Ljava/lang/StringBuilder;-><init>()V

    const-string v4, "Wrong Key length: need at least 32 bytes, is "
    ...
    const-string v0, " (should be at least 32)."
