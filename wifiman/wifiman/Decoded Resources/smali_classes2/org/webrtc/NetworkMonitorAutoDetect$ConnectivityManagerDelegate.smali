...
.method private addStackedIPAddresses(Landroid/net/LinkProperties;Ljava/util/ArrayList;)V
    .locals 9
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :try_start_0
    new-instance v6, Lorg/webrtc/NetworkChangeDetector$IPAddress;
    ...
    invoke-direct {v6, v7}, Lorg/webrtc/NetworkChangeDetector$IPAddress;-><init>([B)V
    ...
    const-string v8, "Stacked Link InetAddress could not be parsed from "
    ...
    const-string v7, "NetworkMonitorAutoDetect"

    invoke-static {v7, v5, v6}, Lorg/webrtc/Logging;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method createNetworkRequest()Landroid/net/NetworkRequest;
    ...
    invoke-static {v0, v1}, Lorg/webrtc/S;->a(Landroid/net/NetworkRequest$Builder;Z)Landroid/net/NetworkRequest$Builder;
...
.method getIPAddresses(Landroid/net/LinkProperties;)[Lorg/webrtc/NetworkChangeDetector$IPAddress;
    ...
    :cond_0
    invoke-direct {p0, p1, v0}, Lorg/webrtc/NetworkMonitorAutoDetect$ConnectivityManagerDelegate;->addStackedIPAddresses(Landroid/net/LinkProperties;Ljava/util/ArrayList;)V

    const/4 p1, 0x0

    new-array p1, p1, [Lorg/webrtc/NetworkChangeDetector$IPAddress;

    invoke-virtual {v0, p1}, Ljava/util/ArrayList;->toArray([Ljava/lang/Object;)[Ljava/lang/Object;

    move-result-object p1

    check-cast p1, [Lorg/webrtc/NetworkChangeDetector$IPAddress;
