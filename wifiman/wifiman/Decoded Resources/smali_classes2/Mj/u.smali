...
.method static constructor <clinit>()V
    ...
    sput-object v0, LMj/u;->m:Ljava/util/regex/Pattern;
...
.method constructor <init>(Ljava/lang/String;Lokhttp3/HttpUrl;Ljava/lang/String;Lokhttp3/Headers;Lokhttp3/MediaType;ZZZ)V
    ...
    iput-object p1, p0, LMj/u;->a:Ljava/lang/String;

    iput-object p2, p0, LMj/u;->b:Lokhttp3/HttpUrl;

    iput-object p3, p0, LMj/u;->c:Ljava/lang/String;

    new-instance p1, Lokhttp3/Request$Builder;

    invoke-direct {p1}, Lokhttp3/Request$Builder;-><init>()V

    iput-object p1, p0, LMj/u;->e:Lokhttp3/Request$Builder;

    iput-object p5, p0, LMj/u;->g:Lokhttp3/MediaType;

    iput-boolean p6, p0, LMj/u;->h:Z
    ...
    iput-object p1, p0, LMj/u;->f:Lokhttp3/Headers$Builder;
    ...
    iput-object p1, p0, LMj/u;->j:Lokhttp3/FormBody$Builder;
    ...
    iput-object p1, p0, LMj/u;->i:Lokhttp3/MultipartBody$Builder;
...
.method private static i(Ljava/lang/String;Z)Ljava/lang/String;
    ...
    invoke-virtual {v3, p0, v1, v2}, Lej/e;->T0(Ljava/lang/String;II)Lej/e;

    invoke-static {v3, p0, v2, v0, p1}, LMj/u;->j(Lej/e;Ljava/lang/String;IIZ)V

    invoke-virtual {v3}, Lej/e;->z0()Ljava/lang/String;
...
.method private static j(Lej/e;Ljava/lang/String;IIZ)V
    .locals 6
    ...
    :cond_1
    invoke-virtual {p0, v1}, Lej/e;->U0(I)Lej/e;
    ...
    :cond_3
    invoke-virtual {v0, v1}, Lej/e;->U0(I)Lej/e;
    ...
    invoke-virtual {p0, v4}, Lej/e;->L0(I)Lej/e;
...
.method a(Ljava/lang/String;Ljava/lang/String;Z)V
    ...
    iget-object p3, p0, LMj/u;->j:Lokhttp3/FormBody$Builder;
...
.method b(Ljava/lang/String;Ljava/lang/String;Z)V
    ...
    iput-object p1, p0, LMj/u;->g:Lokhttp3/MediaType;
    :try_end_0
    ...
    iget-object p3, p0, LMj/u;->f:Lokhttp3/Headers$Builder;
...
.method c(Lokhttp3/Headers;)V
    ...
    iget-object v0, p0, LMj/u;->f:Lokhttp3/Headers$Builder;
...
.method d(Lokhttp3/Headers;Lokhttp3/RequestBody;)V
    ...
    iget-object v0, p0, LMj/u;->i:Lokhttp3/MultipartBody$Builder;
...
.method f(Ljava/lang/String;Ljava/lang/String;Z)V
    ...
    iget-object v0, p0, LMj/u;->c:Ljava/lang/String;

    if-eqz v0, :cond_1

    invoke-static {p2, p3}, LMj/u;->i(Ljava/lang/String;Z)Ljava/lang/String;
    ...
    sget-object p3, LMj/u;->m:Ljava/util/regex/Pattern;
    ...
    iput-object p1, p0, LMj/u;->c:Ljava/lang/String;
...
.method g(Ljava/lang/String;Ljava/lang/String;Z)V
    ...
    iget-object v1, p0, LMj/u;->b:Lokhttp3/HttpUrl;

    invoke-virtual {v1, v0}, Lokhttp3/HttpUrl;->l(Ljava/lang/String;)Lokhttp3/HttpUrl$Builder;

    move-result-object v0

    iput-object v0, p0, LMj/u;->d:Lokhttp3/HttpUrl$Builder;

    if-eqz v0, :cond_0

    const/4 v0, 0x0

    iput-object v0, p0, LMj/u;->c:Ljava/lang/String;
    ...
    iget-object p3, p0, LMj/u;->b:Lokhttp3/HttpUrl;
    ...
    iget-object p3, p0, LMj/u;->c:Ljava/lang/String;
    ...
    iget-object p3, p0, LMj/u;->d:Lokhttp3/HttpUrl$Builder;
...
.method h(Ljava/lang/Class;Ljava/lang/Object;)V
    ...
    iget-object v0, p0, LMj/u;->e:Lokhttp3/Request$Builder;

    invoke-virtual {v0, p1, p2}, Lokhttp3/Request$Builder;->g(Ljava/lang/Class;Ljava/lang/Object;)Lokhttp3/Request$Builder;
...
.method k()Lokhttp3/Request$Builder;
    ...
    iget-object v0, p0, LMj/u;->d:Lokhttp3/HttpUrl$Builder;
    ...
    :cond_0
    iget-object v0, p0, LMj/u;->b:Lokhttp3/HttpUrl;

    iget-object v1, p0, LMj/u;->c:Ljava/lang/String;
    ...
    :goto_0
    iget-object v1, p0, LMj/u;->k:Lokhttp3/RequestBody;

    if-nez v1, :cond_3

    iget-object v2, p0, LMj/u;->j:Lokhttp3/FormBody$Builder;
    ...
    :cond_1
    iget-object v2, p0, LMj/u;->i:Lokhttp3/MultipartBody$Builder;
    ...
    invoke-static {v2, v1}, Lokhttp3/RequestBody;->e(Lokhttp3/MediaType;[B)Lokhttp3/RequestBody;

    move-result-object v1

    :cond_3
    :goto_1
    iget-object v2, p0, LMj/u;->g:Lokhttp3/MediaType;

    if-eqz v2, :cond_5

    if-eqz v1, :cond_4

    new-instance v3, LMj/u$a;

    invoke-direct {v3, v1, v2}, LMj/u$a;-><init>(Lokhttp3/RequestBody;Lokhttp3/MediaType;)V
    ...
    :cond_4
    iget-object v3, p0, LMj/u;->f:Lokhttp3/Headers$Builder;
    ...
    :cond_5
    :goto_2
    iget-object v2, p0, LMj/u;->e:Lokhttp3/Request$Builder;

    invoke-virtual {v2, v0}, Lokhttp3/Request$Builder;->i(Lokhttp3/HttpUrl;)Lokhttp3/Request$Builder;

    move-result-object v0

    iget-object v2, p0, LMj/u;->f:Lokhttp3/Headers$Builder;

    invoke-virtual {v2}, Lokhttp3/Headers$Builder;->f()Lokhttp3/Headers;

    move-result-object v2

    invoke-virtual {v0, v2}, Lokhttp3/Request$Builder;->d(Lokhttp3/Headers;)Lokhttp3/Request$Builder;

    move-result-object v0

    iget-object v2, p0, LMj/u;->a:Ljava/lang/String;

    invoke-virtual {v0, v2, v1}, Lokhttp3/Request$Builder;->e(Ljava/lang/String;Lokhttp3/RequestBody;)Lokhttp3/Request$Builder;
    ...
    iget-object v2, p0, LMj/u;->b:Lokhttp3/HttpUrl;
    ...
    iget-object v2, p0, LMj/u;->c:Ljava/lang/String;
...
.method l(Lokhttp3/RequestBody;)V
    ...
    iput-object p1, p0, LMj/u;->k:Lokhttp3/RequestBody;
