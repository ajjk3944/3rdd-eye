...
.method private final a()V
    ...
    const-string/jumbo v0, "SessionLifecycleService"
    ...
    invoke-virtual {v1}, Lcom/google/firebase/sessions/c;->c()Lo5/y;

    move-result-object v1

    invoke-interface {v0, v1}, Lcom/google/firebase/sessions/b;->a(Lo5/y;)V
...
.method private final b(Landroid/os/Message;)V
    ...
    const-string/jumbo v1, "SessionLifecycleService"
...
.method private final d(Landroid/os/Message;)V
    ...
    const-string/jumbo v0, "Session too long in background. Creating new session."
...
.method private final e(J)Z
    ...
    sget-object v0, Lq5/f;->c:Lq5/f$b;

    invoke-virtual {v0}, Lq5/f$b;->c()Lq5/f;

    move-result-object v0

    invoke-virtual {v0}, Lq5/f;->c()J

    move-result-wide v0

    invoke-static {v0, v1}, LAi/a;->v(J)J
...
.method private final f(Landroid/os/Messenger;)V
    ...
    invoke-virtual {v1}, Lo5/y;->b()Ljava/lang/String;
    ...
    invoke-interface {v1}, Lcom/google/firebase/sessions/a;->a()Ljava/lang/String;
    ...
    :goto_0
    const-string/jumbo v1, "Failed to send session to client."
...
.method private final g()V
    ...
    invoke-virtual {v2}, Lcom/google/firebase/sessions/c;->a()Lo5/y;

    const-string/jumbo v2, "Generated new session."

    invoke-static {v0, v2}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    invoke-direct {p0}, Lcom/google/firebase/sessions/SessionLifecycleService$b;->a()V

    sget-object v2, Lcom/google/firebase/sessions/a;->a:Lcom/google/firebase/sessions/a$a;

    invoke-virtual {v2}, Lcom/google/firebase/sessions/a$a;->a()Lcom/google/firebase/sessions/a;
    ...
    invoke-interface {v2, v1}, Lcom/google/firebase/sessions/a;->b(Ljava/lang/String;)V
    :try_end_0
    .catch Ljava/lang/IllegalStateException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    const-string/jumbo v2, "Failed to generate new session."
...
.method private final h(Landroid/os/Messenger;Ljava/lang/String;)V
    ...
    const-string/jumbo v2, "SessionUpdateExtra"
    ...
    const-string/jumbo v2, "Unable to push new session to "
    ...
    const-string/jumbo v1, "Removing dead client from list: "
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    const-string/jumbo v2, "Ignoring old message from "
    ...
    const-string/jumbo v2, "Received unexpected event from the SessionLifecycleClient: "
