...
.method f(FFFZZFFF)Lcom/google/android/material/carousel/f$b;
    ...
    const-string/jumbo v2, "Keylines marked as focal must be placed next to each other. There cannot be non-focal keylines between focal keylines."
    ...
    const-string/jumbo v2, "Keylines that are marked as focal must all have the same masked item size."
    ...
    const-string/jumbo v2, "Keylines before the first focal keyline must be ordered by incrementing masked item size."
    ...
    const-string/jumbo v2, "Keylines after the last focal keyline must be ordered by decreasing masked item size."
...
.method i()Lcom/google/android/material/carousel/f;
    ...
    const-string/jumbo v1, "There must be a keyline marked as focal."
