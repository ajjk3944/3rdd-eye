...
.method private final zzJ(I)Ljava/util/List;
    ...
    const-string/jumbo v0, "While parsing a protocol message, the input ended unexpectedly in the middle of a field.  This could mean either that the input has been truncated or that an embedded message misreported its own length."
...
.method private final zzL(I)V
    ...
    const-string/jumbo v0, "Protocol message was too large.  May be malicious.  Use CodedInputStream.setSizeLimit() to increase the size limit."
...
.method private final zzO(I)[B
    ...
    const-string/jumbo v4, "While parsing a protocol message, the input ended unexpectedly in the middle of a field.  This could mean either that the input has been truncated or that an embedded message misreported its own length."
...
.method public final zzE(I)Z
    ...
    const-string/jumbo v0, "Protocol message tag had invalid wire type."
