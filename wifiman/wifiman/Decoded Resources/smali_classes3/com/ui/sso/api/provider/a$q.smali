.class public final Lcom/ui/sso/api/provider/a$q;
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lcom/ui/sso/api/provider/a;->b(LNa/b;Ldh/e;)Ljava/lang/Object;
.end annotation
...
.method public constructor <init>(LWa/a;Landroid/content/ContentResolver;Lcom/ui/sso/api/provider/f;Ljava/lang/String;Lcom/ui/sso/api/provider/d;Lcom/ui/sso/api/provider/UiAccountProviderMessageSerializer;Lcom/ui/sso/api/provider/UiAccountProviderMessageSerializer;Ldh/e;)V
    ...
    iput-object p1, p0, Lcom/ui/sso/api/provider/a$q;->b:LWa/a;

    iput-object p2, p0, Lcom/ui/sso/api/provider/a$q;->c:Landroid/content/ContentResolver;

    iput-object p3, p0, Lcom/ui/sso/api/provider/a$q;->d:Lcom/ui/sso/api/provider/f;

    iput-object p4, p0, Lcom/ui/sso/api/provider/a$q;->e:Ljava/lang/String;

    iput-object p5, p0, Lcom/ui/sso/api/provider/a$q;->f:Lcom/ui/sso/api/provider/d;

    iput-object p6, p0, Lcom/ui/sso/api/provider/a$q;->g:Lcom/ui/sso/api/provider/UiAccountProviderMessageSerializer;

    iput-object p7, p0, Lcom/ui/sso/api/provider/a$q;->h:Lcom/ui/sso/api/provider/UiAccountProviderMessageSerializer;
...
.method public final create(Ljava/lang/Object;Ldh/e;)Ldh/e;
    ...
    new-instance p1, Lcom/ui/sso/api/provider/a$q;

    iget-object v1, p0, Lcom/ui/sso/api/provider/a$q;->b:LWa/a;

    iget-object v2, p0, Lcom/ui/sso/api/provider/a$q;->c:Landroid/content/ContentResolver;

    iget-object v3, p0, Lcom/ui/sso/api/provider/a$q;->d:Lcom/ui/sso/api/provider/f;

    iget-object v4, p0, Lcom/ui/sso/api/provider/a$q;->e:Ljava/lang/String;

    iget-object v5, p0, Lcom/ui/sso/api/provider/a$q;->f:Lcom/ui/sso/api/provider/d;

    iget-object v6, p0, Lcom/ui/sso/api/provider/a$q;->g:Lcom/ui/sso/api/provider/UiAccountProviderMessageSerializer;

    iget-object v7, p0, Lcom/ui/sso/api/provider/a$q;->h:Lcom/ui/sso/api/provider/UiAccountProviderMessageSerializer;

    move-object v0, p1

    move-object v8, p2

    invoke-direct/range {v0 .. v8}, Lcom/ui/sso/api/provider/a$q;-><init>(LWa/a;Landroid/content/ContentResolver;Lcom/ui/sso/api/provider/f;Ljava/lang/String;Lcom/ui/sso/api/provider/d;Lcom/ui/sso/api/provider/UiAccountProviderMessageSerializer;Lcom/ui/sso/api/provider/UiAccountProviderMessageSerializer;Ldh/e;)V
...
.method public bridge synthetic invoke(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2}, Lcom/ui/sso/api/provider/a$q;->n(LIi/N;Ldh/e;)Ljava/lang/Object;
...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget v0, p0, Lcom/ui/sso/api/provider/a$q;->a:I
    ...
    :try_start_0
    iget-object p1, p0, Lcom/ui/sso/api/provider/a$q;->b:LWa/a;
    ...
    iget-object p1, p0, Lcom/ui/sso/api/provider/a$q;->c:Landroid/content/ContentResolver;

    iget-object v1, p0, Lcom/ui/sso/api/provider/a$q;->d:Lcom/ui/sso/api/provider/f;

    invoke-interface {v1}, Lcom/ui/sso/api/provider/f;->b()Ljava/lang/String;

    move-result-object v1

    iget-object v2, p0, Lcom/ui/sso/api/provider/a$q;->e:Ljava/lang/String;

    iget-object v3, p0, Lcom/ui/sso/api/provider/a$q;->f:Lcom/ui/sso/api/provider/d;

    if-eqz v3, :cond_0

    iget-object v4, p0, Lcom/ui/sso/api/provider/a$q;->h:Lcom/ui/sso/api/provider/UiAccountProviderMessageSerializer;
    ...
    :try_start_1
    iget-object v3, p0, Lcom/ui/sso/api/provider/a$q;->g:Lcom/ui/sso/api/provider/UiAccountProviderMessageSerializer;
    ...
    iget-object v3, p0, Lcom/ui/sso/api/provider/a$q;->e:Ljava/lang/String;
...
.method public final n(LIi/N;Ldh/e;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2}, Lcom/ui/sso/api/provider/a$q;->create(Ljava/lang/Object;Ldh/e;)Ldh/e;

    move-result-object p1

    check-cast p1, Lcom/ui/sso/api/provider/a$q;

    sget-object p2, LYg/J;->a:LYg/J;

    invoke-virtual {p1, p2}, Lcom/ui/sso/api/provider/a$q;->invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
