.class public final Lcom/ui/wifiman/db/B$P;
.super Ln2/a;
.source "SourceFile"
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lcom/ui/wifiman/db/B;->R()Ln2/a;
.end annotation
...
.method public a(Landroidx/sqlite/db/SupportSQLiteDatabase;)V
    ...
    const-string v0, "ALTER TABLE speedTestMeasurement ADD COLUMN server_product_image_url TEXT"

    invoke-interface {p1, v0}, Landroidx/sqlite/db/SupportSQLiteDatabase;->execSQL(Ljava/lang/String;)V

    const-string/jumbo v0, "SELECT id, server_product_id FROM speedTestMeasurement"
    ...
    const-string/jumbo v3, "server_product_id"
    ...
    const-string/jumbo v8, "speedTestMeasurement"

    new-instance v10, Landroid/content/ContentValues;

    invoke-direct {v10}, Landroid/content/ContentValues;-><init>()V

    const-string/jumbo v7, "server_product_image_url"

    new-instance v9, Ljava/lang/StringBuilder;

    invoke-direct {v9}, Ljava/lang/StringBuilder;-><init>()V

    const-string/jumbo v11, "https://static.ubnt.com/fingerprint/0/"

    invoke-virtual {v9, v11}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v9, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/Object;)Ljava/lang/StringBuilder;

    const-string/jumbo v6, "_257x257.png"
