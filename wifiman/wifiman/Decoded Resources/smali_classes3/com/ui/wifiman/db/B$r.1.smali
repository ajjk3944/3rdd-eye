...
.method public a(Landroidx/sqlite/db/SupportSQLiteDatabase;)V
    ...
    const-string v0, "DB Migration onto 27 started"
    ...
    const-string/jumbo v4, "speedTestServertemp"
    ...
    const-string/jumbo v5, "` (`id` TEXT NOT NULL, `city` TEXT, `country` TEXT, `countryCode` TEXT, `latitude` REAL, `longitude` REAL, `provider` TEXT, `providerUrl` TEXT, `speedMbps` INTEGER, `url` TEXT, `timestamp` INTEGER NOT NULL, `type` TEXT NOT NULL, PRIMARY KEY(`id`))"
    ...
    const-string v0, "DB DROPPED table speedTestServer"
    ...
    const-string v3, " RENAME TO speedTestServer"
    ...
    const-string v3, "DB RENAMED table "

    invoke-virtual {v0, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v0, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    const-string v3, " to speedTestServer"
    ...
    const-string/jumbo v0, "SELECT * FROM speedTestServer"
    ...
    const-string p1, "DB Migration 27 finished"
