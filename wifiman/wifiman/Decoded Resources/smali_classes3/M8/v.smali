...
.super Lcom/ui/wifiman/ui/wifi/scan/prefs/networks/d;
.source "SourceFile"
...
.method public constructor <init>(Lorg/kodein/di/DI;)V
    ...
    invoke-direct {p0}, Lcom/ui/wifiman/ui/wifi/scan/prefs/networks/d;-><init>()V

    iput-object p1, p0, LM8/v;->g:Lorg/kodein/di/DI;

    new-instance p1, Lorg/kodein/type/d;

    new-instance v0, LM8/v$d;

    invoke-direct {v0}, LM8/v$d;-><init>()V
    ...
    iput-object p1, p0, LM8/v;->h:LYg/m;

    new-instance p1, Lorg/kodein/type/d;

    new-instance v3, LM8/v$e;

    invoke-direct {v3}, LM8/v$e;-><init>()V
    ...
    iput-object p1, p0, LM8/v;->i:LYg/m;

    sget-object p1, Lic/d;->SSID:Lic/d;

    sget-object v0, Lic/d;->SIGNAL:Lic/d;

    filled-new-array {p1, v0}, [Lic/d;
    ...
    iput-object p1, p0, LM8/v;->j:Ljava/util/List;

    invoke-direct {p0}, LM8/v;->r0()Lde/F;
    ...
    sget-object v1, LM8/v$b;->a:LM8/v$b;
    ...
    new-instance v1, LM8/v$c;

    invoke-direct {v1, p0}, LM8/v$c;-><init>(LM8/v;)V
    ...
    invoke-direct {p0, p1}, LM8/v;->s0(Lic/d;)LCi/c;
    ...
    iput-object p1, p0, LM8/v;->k:LLi/N;

    return-void
.end method

.method public static synthetic p0(Lcom/ui/wifiman/ui/wifi/scan/prefs/networks/c;Lde/E;)Lde/E;
    .locals 0

    invoke-static {p0, p1}, LM8/v;->u0(Lcom/ui/wifiman/ui/wifi/scan/prefs/networks/c;Lde/E;)Lde/E;
...
.method public static final synthetic q0(LM8/v;Lic/d;)LCi/c;
    .locals 0
...
.method private final r0()Lde/F;
    ...
    iget-object v0, p0, LM8/v;->h:LYg/m;
...
.method private final s0(Lic/d;)LCi/c;
    .locals 6

    iget-object v0, p0, LM8/v;->j:Ljava/util/List;
    ...
    new-instance v2, Lcom/ui/wifiman/ui/wifi/scan/prefs/networks/c$b;

    sget-object v5, Lic/d;->SIGNAL:Lic/d;
    ...
    :cond_0
    invoke-direct {v2, v3}, Lcom/ui/wifiman/ui/wifi/scan/prefs/networks/c$b;-><init>(Z)V
    ...
    :cond_2
    new-instance v2, Lcom/ui/wifiman/ui/wifi/scan/prefs/networks/c$a;

    sget-object v5, Lic/d;->SSID:Lic/d;
    ...
    :cond_3
    invoke-direct {v2, v3}, Lcom/ui/wifiman/ui/wifi/scan/prefs/networks/c$a;-><init>(Z)V
...
.method private final t0()Li8/a;
    ...
    iget-object v0, p0, LM8/v;->i:LYg/m;
...
.method private static final u0(Lcom/ui/wifiman/ui/wifi/scan/prefs/networks/c;Lde/E;)Lde/E;
    .locals 7
    ...
    instance-of v0, p0, Lcom/ui/wifiman/ui/wifi/scan/prefs/networks/c$a;

    if-eqz v0, :cond_0

    sget-object p0, Lic/d;->SSID:Lic/d;
    ...
    :cond_0
    instance-of p0, p0, Lcom/ui/wifiman/ui/wifi/scan/prefs/networks/c$b;

    if-eqz p0, :cond_1

    sget-object p0, Lic/d;->SIGNAL:Lic/d;
...
.method public d()Lorg/kodein/di/DI;
    ...
    iget-object v0, p0, LM8/v;->g:Lorg/kodein/di/DI;
...
.method public n0()LLi/N;
    ...
    iget-object v0, p0, LM8/v;->k:LLi/N;

    return-object v0
.end method

.method public o0(Lcom/ui/wifiman/ui/wifi/scan/prefs/networks/c;)V
    .locals 5
    ...
    new-instance v2, LM8/u;

    invoke-direct {v2, p1}, LM8/u;-><init>(Lcom/ui/wifiman/ui/wifi/scan/prefs/networks/c;)V

    invoke-interface {v1, v2}, Lee/c;->a(Lmh/l;)Lgg/b;

    move-result-object p1

    invoke-direct {p0}, LM8/v;->t0()Li8/a;
