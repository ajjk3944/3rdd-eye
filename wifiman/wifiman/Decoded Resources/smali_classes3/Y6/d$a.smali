...
.method private b(LY6/r;Ljava/lang/reflect/Type;Ljava/util/Map;)V
    .locals 10

    invoke-static {p2}, LY6/v;->g(Ljava/lang/reflect/Type;)Ljava/lang/Class;

    move-result-object v0

    invoke-static {v0}, La7/c;->j(Ljava/lang/Class;)Z
    ...
    invoke-direct {p0, v1, v6}, LY6/d$a;->c(ZI)Z
    ...
    invoke-interface {v6}, LY6/g;->ignore()Z
    ...
    invoke-static {p2, v0, v7}, La7/c;->q(Ljava/lang/reflect/Type;Ljava/lang/Class;Ljava/lang/reflect/Type;)Ljava/lang/reflect/Type;

    move-result-object v7

    invoke-static {v5}, La7/c;->k(Ljava/lang/reflect/AnnotatedElement;)Ljava/util/Set;
    ...
    invoke-virtual {p1, v7, v8, v9}, LY6/r;->f(Ljava/lang/reflect/Type;Ljava/util/Set;Ljava/lang/String;)LY6/h;
    ...
    invoke-static {v9, v6}, La7/c;->m(Ljava/lang/String;LY6/g;)Ljava/lang/String;

    move-result-object v6

    new-instance v8, LY6/d$b;

    invoke-direct {v8, v6, v5, v7}, LY6/d$b;-><init>(Ljava/lang/String;Ljava/lang/reflect/Field;LY6/h;)V

    invoke-interface {p3, v6, v8}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v5

    check-cast v5, LY6/d$b;
    ...
    iget-object p3, v5, LY6/d$b;->b:Ljava/lang/reflect/Field;
    ...
    iget-object p3, v8, LY6/d$b;->b:Ljava/lang/reflect/Field;
...
.method public a(Ljava/lang/reflect/Type;Ljava/util/Set;LY6/r;)LY6/h;
    ...
    invoke-direct {p0, p1, p2}, LY6/d$a;->d(Ljava/lang/reflect/Type;Ljava/lang/Class;)V
    ...
    invoke-static {v0}, La7/c;->i(Ljava/lang/Class;)Z

    move-result p2

    if-nez p2, :cond_8

    invoke-static {v0}, LY6/c;->a(Ljava/lang/Class;)LY6/c;
    ...
    invoke-direct {p0, p3, p1, v0}, LY6/d$a;->b(LY6/r;Ljava/lang/reflect/Type;Ljava/util/Map;)V

    invoke-static {p1}, LY6/v;->f(Ljava/lang/reflect/Type;)Ljava/lang/reflect/Type;
    ...
    invoke-direct {p1, p2, v0}, LY6/d;-><init>(LY6/c;Ljava/util/Map;)V
