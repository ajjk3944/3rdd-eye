...
.method public constructor <init>(Ljava/lang/String;Lkj/a;)V
    ...
    iput-object p2, p0, Lorg/eclipse/paho/client/mqttv3/MqttTopic;->comms:Lkj/a;
...
.method private createPublish(Lorg/eclipse/paho/client/mqttv3/MqttMessage;)Lnj/o;
    .locals 2
    ...
    invoke-direct {v0, v1, p1}, Lnj/o;-><init>(Ljava/lang/String;Lorg/eclipse/paho/client/mqttv3/MqttMessage;)V
...
.method public static validate(Ljava/lang/String;Z)V
    ...
    invoke-static {p0, p1}, Lqj/b;->d(Ljava/lang/CharSequence;[Ljava/lang/CharSequence;)Z
    ...
    :cond_0
    invoke-static {p0, v0}, Lqj/b;->c(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)I
    ...
    const-string/jumbo v1, "Invalid usage of multi-level wildcard in topic string: "
    ...
    invoke-static {p0, p1}, Lqj/b;->a(Ljava/lang/CharSequence;Ljava/lang/CharSequence;)Z
    ...
    const-string/jumbo p1, "The topic name MUST NOT contain any wildcard characters (#+)"
    ...
    const-string/jumbo v0, "Invalid topic length, should be in range[%d, %d]!"
...
.method private static validateSingleLevelWildcard(Ljava/lang/String;)V
    ...
    const-string/jumbo v1, "Invalid usage of single-level wildcard in topic string \'%s\'!"
...
.method public publish(Lorg/eclipse/paho/client/mqttv3/MqttMessage;)Lorg/eclipse/paho/client/mqttv3/MqttDeliveryToken;
    ...
    iget-object v1, p0, Lorg/eclipse/paho/client/mqttv3/MqttTopic;->comms:Lkj/a;
    ...
    invoke-direct {p0, p1}, Lorg/eclipse/paho/client/mqttv3/MqttTopic;->createPublish(Lorg/eclipse/paho/client/mqttv3/MqttMessage;)Lnj/o;

    move-result-object p1

    invoke-virtual {v1, p1, v0}, Lkj/a;->S(Lnj/u;Lorg/eclipse/paho/client/mqttv3/MqttToken;)V

    .line 8
    iget-object p1, v0, Lorg/eclipse/paho/client/mqttv3/MqttToken;->internalTok:Lkj/x;

    invoke-virtual {p1}, Lkj/x;->E()V
