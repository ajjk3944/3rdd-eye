...
.method constructor <init>(LLb/c;Lm2/q;)V
    ...
    iput-object p1, p0, LLb/c$b;->d:LLb/c;
...
.method protected e()Ljava/lang/String;
    ...
    const-string/jumbo v0, "UPDATE OR ABORT `ssoAccount` SET `uuid` = ?,`username` = ?,`first_name` = ?,`last_name` = ?,`email` = ?,`avatarUrl` = ?,`verified` = ?,`privacy_revision` = ?,`terms_revision` = ?,`isPrimary` = ?,`updated` = ? WHERE `uuid` = ?"
...
.method protected bridge synthetic i(Landroidx/sqlite/db/SupportSQLiteStatement;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, LLb/c$b;->l(Landroidx/sqlite/db/SupportSQLiteStatement;LLb/a;)V

    return-void
.end method

.method protected l(Landroidx/sqlite/db/SupportSQLiteStatement;LLb/a;)V
    .locals 4
