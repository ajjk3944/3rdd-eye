...
.method protected e()Ljava/lang/String;
    ...
    const-string/jumbo v0, "UPDATE OR ABORT `settings` SET `id` = ?,`themeId` = ?,`dayNightId` = ?,`distanceUnitId` = ?,`channelsShowFrequencies` = ?,`channelsShowFrequencies_5ghz` = ?,`discoveryKeepScreenOn` = ?,`speedtestKeepScreenOn` = ?,`screen_orientation` = ?,`teleport_tile_service_added` = ? WHERE `id` = ?"
...
.method protected bridge synthetic i(Landroidx/sqlite/db/SupportSQLiteStatement;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, LVb/b$b;->l(Landroidx/sqlite/db/SupportSQLiteStatement;LVb/c;)V

    return-void
.end method

.method protected l(Landroidx/sqlite/db/SupportSQLiteStatement;LVb/c;)V
    .locals 4
