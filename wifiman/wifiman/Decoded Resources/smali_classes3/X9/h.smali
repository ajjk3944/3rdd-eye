...
.method public constructor <init>(Landroidx/lifecycle/E;Lcom/ui/core/ui/sso/c;LU9/h;Lka/a;Lha/a;)V
    ...
    invoke-virtual {p0}, LX9/h;->n1()LEb/w$c;

    move-result-object p1

    invoke-virtual {p0, p1}, LX9/h;->p1(LEb/w$c;)V

    return-void
.end method

.method public static synthetic m1(LX9/h;Ljava/lang/Throwable;Ls9/d;)Lgg/b;
    .locals 0

    invoke-static {p0, p1, p2}, LX9/h;->o1(LX9/h;Ljava/lang/Throwable;Ls9/d;)Lgg/b;
...
.method private static final o1(LX9/h;Ljava/lang/Throwable;Ls9/d;)Lgg/b;
    .locals 1
    ...
    invoke-direct {v0, p1, p0, p2}, LX9/h$c;-><init>(Ljava/lang/Throwable;LX9/h;Ls9/d;)V
...
.method protected G0()Lgg/b;
    ...
    invoke-interface {v0, v1}, LAb/a;->n(LEb/w$c;)Lgg/b;

    move-result-object v0

    new-instance v1, LX9/g;

    invoke-direct {v1, p0}, LX9/g;-><init>(LX9/h;)V
...
.method protected n1()LEb/w$c;
    ...
    :goto_0
    instance-of v2, v0, LEb/w$c;

    if-eqz v2, :cond_1

    check-cast v0, LEb/w$c;
    ...
    :goto_3
    instance-of v0, v2, LEb/w$c;

    if-eqz v0, :cond_5

    move-object v1, v2

    check-cast v1, LEb/w$c;
    ...
    const-string/jumbo v1, "Email MFA Method params not found"
...
.method protected final p1(LEb/w$c;)V
    .locals 4
    ...
    new-instance v3, LX9/h$d;

    invoke-direct {v3, p1}, LX9/h$d;-><init>(LEb/w$c;)V
