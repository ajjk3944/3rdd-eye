...
public abstract class c {
    ...
    public static final ThreadLocal f20600a = new ThreadLocal();

    /* renamed from: b, reason: collision with root package name */
    public static final ThreadLocal f20601b = new ThreadLocal();
    ...
    public static void c(ViewGroup viewGroup, View view, Rect rect) {
        ThreadLocal threadLocal = f20600a;
        ...
        ThreadLocal threadLocal2 = f20601b;
