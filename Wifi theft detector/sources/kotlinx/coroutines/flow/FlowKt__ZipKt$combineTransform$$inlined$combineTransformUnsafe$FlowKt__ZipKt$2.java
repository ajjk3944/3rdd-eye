...
public final class FlowKt__ZipKt$combineTransform$$inlined$combineTransformUnsafe$FlowKt__ZipKt$2 extends SuspendLambda implements l9.p {
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public FlowKt__ZipKt$combineTransform$$inlined$combineTransformUnsafe$FlowKt__ZipKt$2(b[] bVarArr, c9.c cVar, l9.r rVar) {
        super(2, cVar);
        this.$flows = bVarArr;
        this.$transform$inlined = rVar;
    }
    ...
    public final Object invoke(c cVar, c9.c cVar2) {
        return ((FlowKt__ZipKt$combineTransform$$inlined$combineTransformUnsafe$FlowKt__ZipKt$2) create(cVar, cVar2)).invokeSuspend(y8.s.f25199a);
    }
}
