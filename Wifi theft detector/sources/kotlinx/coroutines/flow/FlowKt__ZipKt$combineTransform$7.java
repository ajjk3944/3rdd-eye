...
public final class FlowKt__ZipKt$combineTransform$7 extends SuspendLambda implements l9.p {
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public FlowKt__ZipKt$combineTransform$7(b[] bVarArr, l9.q qVar, c9.c cVar) {
        super(2, cVar);
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i10 == 0) {
            ...
            kotlin.jvm.internal.p.i();
            final b[] bVarArr2 = this.$flowArray;
            l9.a aVar = new l9.a() { // from class: kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$7.1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(0);
                }
    ...
    public final Object invoke(c cVar, c9.c cVar2) {
        return ((FlowKt__ZipKt$combineTransform$7) create(cVar, cVar2)).invokeSuspend(y8.s.f25199a);
    }
}
