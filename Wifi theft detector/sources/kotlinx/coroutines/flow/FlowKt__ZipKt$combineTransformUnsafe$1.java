...
public final class FlowKt__ZipKt$combineTransformUnsafe$1 extends SuspendLambda implements l9.p {
    ...
    public static final class AnonymousClass1 extends SuspendLambda implements l9.q {
        ...
        public AnonymousClass1(l9.q qVar, c9.c cVar) {
            super(3, cVar);
            this.$transform = qVar;
        }
        ...
        public final Object invoke(c cVar, Object[] objArr, c9.c cVar2) {
            ...
            AnonymousClass1 anonymousClass1 = new AnonymousClass1(this.$transform, cVar2);
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public FlowKt__ZipKt$combineTransformUnsafe$1(b[] bVarArr, l9.q qVar, c9.c cVar) {
        super(2, cVar);
        this.$flows = bVarArr;
        this.$transform = qVar;
    }
    ...
    public final Object invoke(c cVar, c9.c cVar2) {
        return ((FlowKt__ZipKt$combineTransformUnsafe$1) create(cVar, cVar2)).invokeSuspend(y8.s.f25199a);
    }
}
