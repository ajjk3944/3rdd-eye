...
public final class FlowKt__ZipKt$combineTransform$$inlined$combineTransformUnsafe$FlowKt__ZipKt$1 extends SuspendLambda implements l9.p {
    ...
    public static final class AnonymousClass1 extends SuspendLambda implements l9.q {
        ...
        public AnonymousClass1(c9.c cVar, l9.r rVar) {
            super(3, cVar);
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i10 == 0) {
                ...
                l9.r rVar = this.$transform$inlined;
                Object obj2 = objArr[0];
                Object obj3 = objArr[1];
                this.label = 1;
                kotlin.jvm.internal.n.c(6);
                Object objC = rVar.c(cVar, obj2, obj3, this);
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public FlowKt__ZipKt$combineTransform$$inlined$combineTransformUnsafe$FlowKt__ZipKt$1(b[] bVarArr, c9.c cVar, l9.r rVar) {
        super(2, cVar);
        this.$flows = bVarArr;
        this.$transform$inlined = rVar;
    }
    ...
    public final Object invoke(c cVar, c9.c cVar2) {
        return ((FlowKt__ZipKt$combineTransform$$inlined$combineTransformUnsafe$FlowKt__ZipKt$1) create(cVar, cVar2)).invokeSuspend(y8.s.f25199a);
    }
}
