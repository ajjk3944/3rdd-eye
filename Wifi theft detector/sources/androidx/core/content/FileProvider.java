    ...
    public static class c implements b {
        ...
        public Uri a(File file) throws IOException {
            try {
                ...
                for (Map.Entry entry2 : this.f2487b.entrySet()) {
                ...
                return new Uri.Builder().scheme("content").authority(this.f2486a).encodedPath(Uri.encode((String) entry.getKey()) + '/' + Uri.encode(path2.endsWith("/") ? canonicalPath.substring(path2.length()) : canonicalPath.substring(path2.length() + 1), "/")).build();
        ...
        public File b(Uri uri) throws IOException {
            ...
            File file = (File) this.f2487b.get(strDecode);
            if (file == null) {
        ...
        public void c(String str, File file) throws IOException {
            ...
            try {
                this.f2487b.put(str, file.getCanonicalFile());
