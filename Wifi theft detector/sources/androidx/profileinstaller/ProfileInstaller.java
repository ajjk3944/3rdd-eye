...
public abstract class ProfileInstaller {
    ...
    public static final c f3594a = new a();

    /* renamed from: b, reason: collision with root package name */
    public static final c f3595b = new b();
    ...
    public static boolean d(PackageInfo packageInfo, File file, c cVar) throws IOException {
    ...
    public static boolean g(AssetManager assetManager, String str, PackageInfo packageInfo, File file, String str2, Executor executor, c cVar) throws IOException {
    ...
    public static void j(Context context, Executor executor, c cVar, boolean z10) throws PackageManager.NameNotFoundException {
    ...
    public static void k(Context context, Executor executor, c cVar) throws PackageManager.NameNotFoundException, IOException {
        try {
