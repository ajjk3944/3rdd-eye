...
public class p extends MultiAutoCompleteTextView implements androidx.core.widget.j {

    /* renamed from: d, reason: collision with root package name */
    public static final int[] f1282d = {R.attr.popupBackground};
    ...
    public ColorStateList getSupportCompoundDrawablesTintList() {
        return this.f1284b.j();
    }

    @Nullable
    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP_PREFIX})
    public PorterDuff.Mode getSupportCompoundDrawablesTintMode() {
        return this.f1284b.k();
    }

    @Override // android.widget.TextView, android.view.View
    public InputConnection onCreateInputConnection(EditorInfo editorInfo) {
        return this.f1285c.d(m.a(super.onCreateInputConnection(editorInfo), editorInfo, this), editorInfo);
    }
    ...
    public void setKeyListener(@Nullable KeyListener keyListener) {
        super.setKeyListener(this.f1285c.a(keyListener));
    }
    ...
    public p(@NonNull Context context, @Nullable AttributeSet attributeSet, int i10) {
        ...
        z0 z0VarV = z0.v(getContext(), attributeSet, f1282d, i10, 0);
        if (z0VarV.s(0)) {
