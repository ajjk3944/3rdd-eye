...
public final class SegmentedByteString extends ByteString {
    ...
    public ByteBuffer asByteBuffer() {
        ...
        p.d(byteBufferAsReadOnlyBuffer, "wrap(toByteArray()).asReadOnlyBuffer()");
    ...
    public void copyInto(int offset, @NotNull byte[] target, int targetOffset, int byteCount) {
        p.e(target, "target");
        long j10 = byteCount;
        _UtilKt.checkOffsetAndCount(size(), offset, j10);
        ...
        while (offset < i10) {
            ...
            m.d(getSegments()[iSegment], target, targetOffset, i14, i14 + iMin);
            targetOffset += iMin;
            offset += iMin;
            iSegment++;
        }
    ...
    public ByteString substring(int beginIndex, int endIndex) {
        ...
        byte[][] bArr = (byte[][]) m.l(getSegments(), iSegment, iSegment2 + 1);
        ...
        int i15 = iSegment != 0 ? getDirectory()[iSegment - 1] : 0;
    ...
    public byte[] toByteArray() {
        ...
        while (i10 < length) {
            ...
            int i14 = getDirectory()[i10];
            int i15 = i14 - i11;
            m.d(getSegments()[i10], bArr, i12, i13, i13 + i15);
            i12 += i15;
            i10++;
            i11 = i14;
        }
    ...
    public boolean rangeEquals(int offset, @NotNull byte[] other, int otherOffset, int byteCount) {
        ...
        while (offset < i10) {
            ...
            int i13 = getDirectory()[getSegments().length + iSegment];
            int iMin = Math.min(i10, i12 + i11) - offset;
            if (!_UtilKt.arrayRangeEquals(getSegments()[iSegment], i13 + (offset - i11), other, otherOffset, iMin)) {
                return false;
            }
            otherOffset += iMin;
            offset += iMin;
