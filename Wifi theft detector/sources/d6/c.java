...
public abstract class c {
    ...
    public static WindowManager f20791a;

    /* renamed from: b, reason: collision with root package name */
    public static String[] f20792b = {"x", "y", "width", "height"};

    /* renamed from: c, reason: collision with root package name */
    public static float f20793c = Resources.getSystem().getDisplayMetrics().density;
    ...
    public static b b(JSONObject jSONObject) {
        ...
        if (f20791a != null) {
            ...
            f20791a.getDefaultDisplay().getRealSize(point);
            fA = a(point.x);
            fA2 = a(point.y);
        } else {
            fA = 0.0f;
    ...
    public static void d(Context context) {
        if (context != null) {
            f20793c = context.getResources().getDisplayMetrics().density;
            f20791a = (WindowManager) context.getSystemService("window");
        }
    }
    ...
    public static void f(JSONObject jSONObject, b.a aVar) throws JSONException {
        aVar.a();
    ...
    public static void g(JSONObject jSONObject, Boolean bool) throws JSONException {
        try {
    ...
    public static boolean k(OutputDeviceStatus outputDeviceStatus) {
        return a.f20794a[outputDeviceStatus.ordinal()] == 1;
    }
    ...
    public static void m(JSONObject jSONObject) throws JSONException {
        ...
        try {
            jSONObject.put("width", bVarB.f20795a);
            jSONObject.put("height", bVarB.f20796b);
        } catch (JSONException e10) {
            e10.printStackTrace();
        }
    }
    ...
    public static boolean o(JSONObject jSONObject, JSONObject jSONObject2) {
        ...
        for (int i10 = 0; i10 < jSONArrayOptJSONArray.length(); i10++) {
            if (!u(jSONArrayOptJSONArray.optJSONObject(i10), jSONArrayOptJSONArray2.optJSONObject(i10))) {
                return false;
            }
        }
        return true;
