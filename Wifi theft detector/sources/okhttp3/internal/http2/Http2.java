...
public final class Http2 {
    ...
    static {
        ...
        for (int i11 = 0; i11 < 256; i11++) {
            ...
            p.d(binaryString, "toBinaryString(it)");
            strArr[i11] = r.E(Util.format("%8s", binaryString), ' ', '0', false, 4, null);
        }
        BINARY = strArr;
        ...
        strArr2[8] = "PADDED";
        int i12 = iArr[0];
        strArr2[i12 | 8] = p.m(strArr2[i12], "|PADDED");
    ...
    public final String formatFlags(int type, int flags) {
        ...
        if (type != 2 && type != 3) {
            ...
            if (type != 7 && type != 8) {
                ...
                String str2 = str;
                return (type != 5 || (flags & 4) == 0) ? (type != 0 || (flags & 32) == 0) ? str2 : r.F(str2, "PRIORITY", "COMPRESSED", false, 4, null) : r.F(str2, "HEADERS", "PUSH_PROMISE", false, 4, null);
            }
        }
        return BINARY[flags];
    }
