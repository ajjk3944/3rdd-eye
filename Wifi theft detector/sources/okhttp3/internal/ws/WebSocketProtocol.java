...
public final class WebSocketProtocol {
    ...
    public final String acceptHeader(@NotNull String key) {
        p.e(key, "key");
        return ByteString.INSTANCE.encodeUtf8(p.m(key, "258EAFA5-E914-47DA-95CA-C5AB0DC85B11")).sha1().base64();
    }

    @Nullable
    public final String closeCodeExceptionMessage(int code) {
        if (code < 1000 || code >= 5000) {
            return p.m("Code must be in range [1000,5000): ", Integer.valueOf(code));
        }
