...
public final class PublicSuffixDatabase {
    ...
    private final List<String> findMatchingRule(List<String> domainLabels) throws InterruptedException {
        ...
        if (strBinarySearch != null) {
            return u.C0(p.m("!", strBinarySearch), new char[]{'.'}, false, 0, 6, null);
        }
        if (str == null && str2 == null) {
            return PREVAILING_RULE;
        }
        List<String> listC0 = str == null ? null : u.C0(str, new char[]{'.'}, false, 0, 6, null);
        if (listC0 == null) {
            listC0 = r.j();
        }
        List<String> listC02 = str2 != null ? u.C0(str2, new char[]{'.'}, false, 0, 6, null) : null;
        if (listC02 == null) {
            listC02 = r.j();
        }
        return listC0.size() > listC02.size() ? listC0 : listC02;
    }
