...
public final class BasicCertificateChainCleaner extends CertificateChainCleaner {
    ...
    public BasicCertificateChainCleaner(@NotNull TrustRootIndex trustRootIndex) {
        p.e(trustRootIndex, "trustRootIndex");
    ...
    private final boolean verifySignature(X509Certificate toVerify, X509Certificate signingCert) throws NoSuchAlgorithmException, SignatureException, InvalidKeyException, CertificateException, NoSuchProviderException {
        if (!p.a(toVerify.getIssuerDN(), signingCert.getSubjectDN())) {
            return false;
        }
        try {
    ...
    public List<Certificate> clean(@NotNull List<? extends Certificate> chain, @NotNull String hostname) throws SSLPeerUnverifiedException {
        ...
        p.d(objRemoveFirst, "queue.removeFirst()");
        ...
        while (i10 < 9) {
            ...
            if (x509CertificateFindByIssuerAndSignature == null) {
                ...
                if (!z10) {
                    throw new SSLPeerUnverifiedException(p.m("Failed to find a trusted cert that signed ", x509Certificate));
                }
                return arrayList;
            }
            if (arrayList.size() > 1 || !p.a(x509Certificate, x509CertificateFindByIssuerAndSignature)) {
        ...
        throw new SSLPeerUnverifiedException(p.m("Certificate chain too long: ", arrayList));
    }
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return (other instanceof BasicCertificateChainCleaner) && p.a(((BasicCertificateChainCleaner) other).trustRootIndex, this.trustRootIndex);
    }
