...
public class Platform {
    ...
    public void logCloseableLeak(@NotNull String message, @Nullable Object stackTrace) {
        p.e(message, "message");
        if (stackTrace == null) {
            message = p.m(message, " To see where this was allocated, set the OkHttpClient logger level to FINE: Logger.getLogger(OkHttpClient.class.getName()).setLevel(Level.FINE);");
        }
    ...
    public SSLSocketFactory newSslSocketFactory(@NotNull X509TrustManager trustManager) throws KeyManagementException {
        ...
        try {
            ...
            throw new AssertionError(p.m("No System TLS: ", e10), e10);
        }
    }
    ...
    public X509TrustManager platformTrustManager() throws NoSuchAlgorithmException, KeyStoreException {
        ...
        throw new IllegalStateException(p.m("Unexpected default trust managers: ", string).toString());
    }
