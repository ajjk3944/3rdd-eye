...
public final class DiskLruCache implements Closeable, Flushable {
    ...
    public final class Editor {
        ...
        public final void abort() throws IOException {
            ...
            synchronized (diskLruCache) {
                try {
                    ...
                    if (p.a(getEntry().getCurrentEditor(), this)) {
        ...
        public final Sink newSink(int index) {
            ...
            synchronized (diskLruCache) {
                ...
                try {
                    return new FaultHidingSink(diskLruCache.getFileSystem().sink(getEntry().getDirtyFiles$okhttp().get(index)), new l() { // from class: okhttp3.internal.cache.DiskLruCache$Editor$newSink$1$1
        ...
        public final Source newSource(int index) {
            ...
            synchronized (diskLruCache) {
                ...
                Source source = null;
                if (!getEntry().getReadable() || !p.a(getEntry().getCurrentEditor(), this) || getEntry().getZombie()) {
                    return null;
                }
                try {
    ...
    public final class Entry {
        ...
        private final Void invalidLengths(List<String> strings) throws IOException {
            throw new IOException(p.m("unexpected journal line: ", strings));
        }
    ...
    public DiskLruCache(@NotNull FileSystem fileSystem, @NotNull File directory, int i10, int i11, long j10, @NotNull TaskRunner taskRunner) {
        ...
        final String strM = p.m(Util.okHttpName, " Cache");
        this.cleanupTask = new Task(strM) { // from class: okhttp3.internal.cache.DiskLruCache$cleanupTask$1
    ...
    private final BufferedSink newJournalWriter() throws FileNotFoundException {
        return Okio.buffer(new FaultHidingSink(this.fileSystem.appendingSink(this.journalFile), new l() { // from class: okhttp3.internal.cache.DiskLruCache$newJournalWriter$faultHidingSink$1
            {
                super(1);
            }
    ...
    private final void readJournal() throws IllegalAccessException, IOException, IllegalArgumentException, InvocationTargetException {
        ...
        try {
            ...
            if (!p.a(MAGIC, utf8LineStrict) || !p.a(VERSION_1, utf8LineStrict2) || !p.a(String.valueOf(this.appVersion), utf8LineStrict3) || !p.a(String.valueOf(getValueCount()), utf8LineStrict4) || utf8LineStrict5.length() > 0) {
    ...
    private final void readJournalLine(String line) throws IOException {
        ...
        if (iA0 == -1) {
            throw new IOException(p.m("unexpected journal line: ", line));
        }
        int i10 = iA0 + 1;
