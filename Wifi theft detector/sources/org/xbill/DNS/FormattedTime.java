...
final class FormattedTime {
    ...
    private static NumberFormat f23838w2;

    /* renamed from: w4, reason: collision with root package name */
    private static NumberFormat f23839w4;

    static {
        DecimalFormat decimalFormat = new DecimalFormat();
        f23838w2 = decimalFormat;
        decimalFormat.setMinimumIntegerDigits(2);
        DecimalFormat decimalFormat2 = new DecimalFormat();
        f23839w4 = decimalFormat2;
        decimalFormat2.setMinimumIntegerDigits(4);
        f23839w4.setGroupingUsed(false);
    }
    ...
    public static String format(Date date) {
        ...
        stringBuffer.append(f23839w4.format(gregorianCalendar.get(1)));
        stringBuffer.append(f23838w2.format(gregorianCalendar.get(2) + 1));
        stringBuffer.append(f23838w2.format(gregorianCalendar.get(5)));
        stringBuffer.append(f23838w2.format(gregorianCalendar.get(11)));
        stringBuffer.append(f23838w2.format(gregorianCalendar.get(12)));
        stringBuffer.append(f23838w2.format(gregorianCalendar.get(13)));
