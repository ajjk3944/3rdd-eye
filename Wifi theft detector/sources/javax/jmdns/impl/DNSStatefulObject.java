...
public interface DNSStatefulObject {
    ...
    public static final class DNSStatefulObjectSemaphore {
        ...
        public void waitForEvent(long j10) throws InterruptedException {
            ...
            try {
                this._semaphores.get(threadCurrentThread).tryAcquire(j10, TimeUnit.MILLISECONDS);
            } catch (InterruptedException e10) {
                logger.debug("Exception ", (Throwable) e10);
            }
        }
    }
    ...
    public static class DefaultImplementation extends ReentrantLock implements DNSStatefulObject {
        ...
        public boolean advanceState(DNSTask dNSTask) {
            ...
            try {
                if (this._task == dNSTask) {
                    ...
                    logger.warn("Trying to advance state whhen not the owner. owner: " + this._task + " perpetrator: " + dNSTask);
                }
                unlock();
                return true;
            } catch (Throwable th) {
        ...
        */
        ...
        @Override // javax.jmdns.impl.DNSStatefulObject
        public boolean waitForAnnounced(long j10) throws InterruptedException {
            if (!isAnnounced() && !willCancel()) {
                this._announcing.waitForEvent(j10 + 10);
            }
            if (!isAnnounced()) {
        ...
        @Override // javax.jmdns.impl.DNSStatefulObject
        public boolean waitForCanceled(long j10) throws InterruptedException {
            if (!isCanceled()) {
                this._canceling.waitForEvent(j10);
            }
            if (!isCanceled()) {
