...
public enum DNSRecordType {
    ...
    TYPE_TKEY("tkey", Type.TKEY),
    TYPE_TSIG("tsig", 250),
    TYPE_IXFR("ixfr", Type.IXFR),
    TYPE_AXFR("axfr", 252),
    ...
    DNSRecordType(String str, int i10) {
        this._externalName = str;
        this._index = i10;
    }

    public static DNSRecordType typeForIndex(int i10) {
        for (DNSRecordType dNSRecordType : values()) {
            if (dNSRecordType._index == i10) {
                return dNSRecordType;
            }
        }
        logger.warn("Could not find record type for index: " + i10);
        return TYPE_IGNORE;
    }
