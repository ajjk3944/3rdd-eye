...
public class DNSQuestion extends DNSEntry {
    ...
    public static class AllRecords extends DNSQuestion {
        public AllRecords(String str, DNSRecordType dNSRecordType, DNSRecordClass dNSRecordClass, boolean z10) {
    ...
    public static class DNS4Address extends DNSQuestion {
        public DNS4Address(String str, DNSRecordType dNSRecordType, DNSRecordClass dNSRecordClass, boolean z10) {
            super(str, dNSRecordType, dNSRecordClass, z10);
        }
    ...
    public static class DNS6Address extends DNSQuestion {
        public DNS6Address(String str, DNSRecordType dNSRecordType, DNSRecordClass dNSRecordClass, boolean z10) {
            super(str, dNSRecordType, dNSRecordClass, z10);
        }
    ...
    public static class HostInformation extends DNSQuestion {
        public HostInformation(String str, DNSRecordType dNSRecordType, DNSRecordClass dNSRecordClass, boolean z10) {
            super(str, dNSRecordType, dNSRecordClass, z10);
        }
    }

    public static class Pointer extends DNSQuestion {
        public Pointer(String str, DNSRecordType dNSRecordType, DNSRecordClass dNSRecordClass, boolean z10) {
            super(str, dNSRecordType, dNSRecordClass, z10);
        }
    ...
    public static class Service extends DNSQuestion {
        public Service(String str, DNSRecordType dNSRecordType, DNSRecordClass dNSRecordClass, boolean z10) {
            super(str, dNSRecordType, dNSRecordClass, z10);
        }
    ...
    public static class Text extends DNSQuestion {
        public Text(String str, DNSRecordType dNSRecordType, DNSRecordClass dNSRecordClass, boolean z10) {
            super(str, dNSRecordType, dNSRecordClass, z10);
        }
    ...
    public DNSQuestion(String str, DNSRecordType dNSRecordType, DNSRecordClass dNSRecordClass, boolean z10) {
        super(str, dNSRecordType, dNSRecordClass, z10);
    }
    ...
    public static DNSQuestion newQuestion(String str, DNSRecordType dNSRecordType, DNSRecordClass dNSRecordClass, boolean z10) {
        switch (AnonymousClass1.$SwitchMap$javax$jmdns$impl$constants$DNSRecordType[dNSRecordType.ordinal()]) {
            case 1:
                return new DNS4Address(str, dNSRecordType, dNSRecordClass, z10);
            case 2:
                return new DNS6Address(str, dNSRecordType, dNSRecordClass, z10);
            case 3:
                return new DNS6Address(str, dNSRecordType, dNSRecordClass, z10);
            case 4:
                return new AllRecords(str, dNSRecordType, dNSRecordClass, z10);
            case 5:
                return new HostInformation(str, dNSRecordType, dNSRecordClass, z10);
            case 6:
                return new Pointer(str, dNSRecordType, dNSRecordClass, z10);
            case 7:
                return new Service(str, dNSRecordType, dNSRecordClass, z10);
            case 8:
                return new Text(str, dNSRecordType, dNSRecordClass, z10);
            default:
    ...
    public void addAnswersForServiceInfo(JmDNSImpl jmDNSImpl, Set<DNSRecord> set, ServiceInfoImpl serviceInfoImpl) {
        ...
        if (logger.isDebugEnabled()) {
            logger.debug(jmDNSImpl.getName() + " DNSQuestion(" + getName() + ").addAnswersForServiceInfo(): info: " + serviceInfoImpl + "\n" + set);
        }
    }
