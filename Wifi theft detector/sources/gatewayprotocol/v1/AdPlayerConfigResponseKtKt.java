...
public final class AdPlayerConfigResponseKtKt {
    ...
    public static final AdPlayerConfigResponseOuterClass.AdPlayerConfigResponse m393initializeadPlayerConfigResponse(@NotNull l block) {
        p.e(block, "block");
    ...
    @NotNull
    public static final AdPlayerConfigResponseOuterClass.AdPlayerConfigResponse copy(@NotNull AdPlayerConfigResponseOuterClass.AdPlayerConfigResponse adPlayerConfigResponse, @NotNull l block) {
        p.e(adPlayerConfigResponse, "<this>");
        p.e(block, "block");
        AdPlayerConfigResponseKt.Dsl.Companion companion = AdPlayerConfigResponseKt.Dsl.INSTANCE;
    ...
    public static final ErrorOuterClass.Error getErrorOrNull(@NotNull AdPlayerConfigResponseOuterClass.AdPlayerConfigResponseOrBuilder adPlayerConfigResponseOrBuilder) {
        p.e(adPlayerConfigResponseOrBuilder, "<this>");
