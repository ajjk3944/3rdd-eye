...
public final class DeveloperConsentOuterClass {
    ...
    public static final class DeveloperConsent extends GeneratedMessageLite<DeveloperConsent, Builder> implements DeveloperConsentOrBuilder {
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            ...
            a aVar = null;
            switch (a.f21267a[methodToInvoke.ordinal()]) {
                case 1:
    ...
    public enum DeveloperConsentChoice implements Internal.EnumLite {
        ...
        public static final class b implements Internal.EnumVerifier {
            ...
            public static final Internal.EnumVerifier f21265a = new b();
    ...
    public enum DeveloperConsentType implements Internal.EnumLite {
        ...
        public static final class b implements Internal.EnumVerifier {
            ...
            /* renamed from: a, reason: collision with root package name */
            public static final Internal.EnumVerifier f21266a = new b();
    ...
    public static /* synthetic */ class a {
        ...
        static {
            ...
            try {
                f21267a[GeneratedMessageLite.MethodToInvoke.NEW_BUILDER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f21267a[GeneratedMessageLite.MethodToInvoke.BUILD_MESSAGE_INFO.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f21267a[GeneratedMessageLite.MethodToInvoke.GET_DEFAULT_INSTANCE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f21267a[GeneratedMessageLite.MethodToInvoke.GET_PARSER.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f21267a[GeneratedMessageLite.MethodToInvoke.GET_MEMOIZED_IS_INITIALIZED.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f21267a[GeneratedMessageLite.MethodToInvoke.SET_MEMOIZED_IS_INITIALIZED.ordinal()] = 7;
