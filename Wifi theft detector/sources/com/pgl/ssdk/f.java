...
public class f {
    ...
    public static long f19916a = 28800;

    /* renamed from: b, reason: collision with root package name */
    public static int f19917b = 5;
    ...
    private static boolean e() {
        boolean z10 = f19917b == 100;
        return !z10 ? ((int) ((Math.random() * 100.0d) + 1.0d)) <= f19917b : z10;
    }
    ...
    public static JSONObject a(File file, boolean z10) throws IOException {
        ZipFile zipFile;
        int i10;
        char c10;
        JSONObject jSONObject = new JSONObject();
