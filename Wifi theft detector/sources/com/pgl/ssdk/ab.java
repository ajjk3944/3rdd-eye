...
public class ab {
    ...
    private static int f19812a = -1;

    /* renamed from: b, reason: collision with root package name */
    private static int f19813b = -1;
    ...
    private static void m(Context context) {
        ...
        ax.b(context, "hac", f19812a);
        ax.b(context, "tac", f19813b);
    }
    ...
    public static void b(Context context) {
        try {
            ...
            if (f19812a != 0) {
                m(context);
                com.pgl.ssdk.ces.a.meta(160, null, new int[]{f19812a, f19813b});
            }
        } catch (Throwable unused) {
        }
    }
