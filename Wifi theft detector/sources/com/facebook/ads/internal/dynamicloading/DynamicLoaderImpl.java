...
import com.instagram.common.viewpoint.core.AbstractC1172Ra;
import com.instagram.common.viewpoint.core.C1174Rc;
import com.instagram.common.viewpoint.core.C1175Rd;
import com.instagram.common.viewpoint.core.C1176Re;
import com.instagram.common.viewpoint.core.C1177Rf;
import com.instagram.common.viewpoint.core.C1179Rh;
import com.instagram.common.viewpoint.core.C1185Rn;
import com.instagram.common.viewpoint.core.C1187Rp;
import com.instagram.common.viewpoint.core.C1189Rr;
import com.instagram.common.viewpoint.core.C1190Rs;
import com.instagram.common.viewpoint.core.C1197Rz;
import com.instagram.common.viewpoint.core.C1248Tz;
import com.instagram.common.viewpoint.core.C1276Vb;
import com.instagram.common.viewpoint.core.C1277Vc;
import com.instagram.common.viewpoint.core.C1278Vd;
import com.instagram.common.viewpoint.core.C1287Vn;
import com.instagram.common.viewpoint.core.C1298Vz;
import com.instagram.common.viewpoint.core.C1843hB;
import com.instagram.common.viewpoint.core.C1844hC;
import com.instagram.common.viewpoint.core.C1861hT;
import com.instagram.common.viewpoint.core.InterfaceC1275Va;
...
public class DynamicLoaderImpl implements DynamicLoader, RemoteRenderingApi {
    ...
    public static final InitApi A06 = new C1189Rr();
    ...
    public AdOptionsViewApi createAdOptionsView(Context context, NativeAdBase nativeAdBase, NativeAdLayout nativeAdLayout, AdOptionsView.Orientation orientation, int i10, AdOptionsView adOptionsView) {
        return new C1861hT(context, nativeAdBase, nativeAdLayout, orientation, i10, adOptionsView);
    }
    ...
    public AdOptionsViewApi createAdOptionsView(Context context, NativeAdBase nativeAdBase, NativeAdLayout nativeAdLayout, AdOptionsView adOptionsView) {
        return new C1861hT(context, nativeAdBase, nativeAdLayout, adOptionsView);
    }
    ...
    public AdSizeApi createAdSizeApi(int i10) {
        return new C1248Tz(this, XG.A02(i10));
    }

    @Override // com.facebook.ads.internal.dynamicloading.DynamicLoader
    public AdViewApi createAdViewApi(Context context, String str, AdSize adSize, AdViewParentApi adViewParentApi, AdView adView) {
        return (AdViewApi) AbstractC1172Ra.A00(new C1175Rd(context, str, adSize, adViewParentApi, adView), AdViewApi.class);
    }
    ...
    public AdViewApi createAdViewApi(Context context, String str, String str2, AdViewParentApi adViewParentApi, AdView adView) throws Exception {
        try {
            return (AdViewApi) AbstractC1172Ra.A00(new C1175Rd(context, str, str2, adViewParentApi, adView), AdViewApi.class);
        } catch (C1287Vn e10) {
    ...
    public AudienceNetworkActivityApi createAudienceNetworkActivity(AudienceNetworkActivity audienceNetworkActivity, AudienceNetworkActivityApi audienceNetworkActivityApi) {
        return new C1177Rf(audienceNetworkActivity, audienceNetworkActivityApi, new C1176Re(audienceNetworkActivity, audienceNetworkActivityApi));
    }
    ...
    public InterstitialAdApi createInterstitialAd(Context context, String str, InterstitialAd interstitialAd) {
        return (InterstitialAdApi) AbstractC1172Ra.A00(new C1190Rs(context, str, interstitialAd), InterstitialAdApi.class);
    }
    ...
    public NativeAdBaseApi createNativeAdBaseApi(Context context, String str) {
        return new UK(context, str, (InterfaceC1275Va) UK.A0K(), false);
    }
    ...
    @Override // com.facebook.ads.internal.dynamicloading.DynamicLoader
    public C1277Vc createNativeAdRatingApi(JSONObject jSONObject) {
        return C1277Vc.A00(jSONObject);
    }
    ...
    public NativeAdsManagerApi createNativeAdsManagerApi(Context context, String str, int i10) {
        return (NativeAdsManagerApi) AbstractC1172Ra.A00(new S6(context, str, i10), NativeAdsManagerApi.class);
    }
    ...
    public RewardedInterstitialAdApi createRewardedInterstitialAd(Context context, String str, RewardedInterstitialAd rewardedInterstitialAd) {
        return (RewardedInterstitialAdApi) AbstractC1172Ra.A00(new SD(context, str, rewardedInterstitialAd), RewardedInterstitialAdApi.class);
    }

    @Override // com.facebook.ads.internal.dynamicloading.DynamicLoader
    public RewardedVideoAdApi createRewardedVideoAd(Context context, String str, RewardedVideoAd rewardedVideoAd) {
        return (RewardedVideoAdApi) AbstractC1172Ra.A00(new SH(context, str, rewardedVideoAd), RewardedVideoAdApi.class);
    }

    public static C1185Rn getBidderTokenProviderApi() {
        if (A04 == null) {
            A04 = new C1185Rn();
        }
        return A04;
