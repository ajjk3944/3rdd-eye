...
public final class SpliceInsertCommand extends SpliceCommand {
    ...
    public static SpliceInsertCommand A00(C06214v c06214v, long j10, AnonymousClass53 anonymousClass53) {
        ...
        if (!z10) {
            ...
            if (outOfNetworkIndicator && !z12) {
                jA00 = TimeSignalCommand.A00(c06214v, j10);
            }
            if (!outOfNetworkIndicator) {
                int componentCount = c06214v.A0I();
                listEmptyList = new ArrayList(componentCount);
                for (int i10 = 0; i10 < componentCount; i10++) {
                    int componentTag = c06214v.A0I();
                    long jA002 = C.TIME_UNSET;
                    if (!z12) {
                        jA002 = TimeSignalCommand.A00(c06214v, j10);
                    }
            ...
            if (autoReturn) {
                ...
                z13 = (jA0I & 128) != 0;
                jA0Q2 = (1000 * (((jA0I & 1) << 32) | c06214v.A0Q())) / 90;
            }
            iA0M = c06214v.A0M();
            iA0I = c06214v.A0I();
            iA0I2 = c06214v.A0I();
