...
public final class a {
    ...
    private JSONObject f5148b = null;
    ...
    public class b {
        ...
        /* renamed from: a, reason: collision with root package name */
        private final com.apm.insight.nativecrash.c f5150a;

        /* renamed from: b, reason: collision with root package name */
        private final com.apm.insight.h.b f5151b;
        ...
        public b(File file) {
            this.f5152c = file;
            this.f5153d = com.apm.insight.l.j.a(com.apm.insight.e.g(), file.getName());
        ...
        */
        public final long a() {
            /*
                r2 = this;
                com.apm.insight.h.b r0 = r2.f5151b
    ...
    public class c extends e {
        public c() {
            super();
            this.f5158b = "Total FD Count:";
            this.f5157a = com.apm.insight.l.j.i(a.this.f5149c.b());
            this.f5159c = ":";
            this.f5160d = -2;
        }
    }
    ...
    public class d extends e {
        public d() {
            super();
            this.f5158b = "VmSize:";
            this.f5157a = com.apm.insight.l.j.k(a.this.f5149c.b());
            this.f5159c = "\\s+";
            this.f5160d = -1;
        }
    }
    ...
    public class f extends e {
        public f() {
            super();
            this.f5158b = "Total Threads Count:";
            this.f5157a = com.apm.insight.l.j.j(a.this.f5149c.b());
            this.f5159c = ":";
            this.f5160d = -2;
        }
    }
    ...
    private String l() {
        ...
        String strC = bVar.f5150a.c();
        return (strC == null || strC.isEmpty()) ? this.f5149c.f5151b.e() : strC;
    }

    public final JSONObject b() {
        File fileF = com.apm.insight.l.j.f(this.f5149c.b());
        if (!fileF.exists()) {
            return null;
        }
        try {
  ...
  0x0124: PHI (r6v1 int) = (r6v0 int), (r6v2 int) binds: [B:55:0x0122, B:61:0x014e] A[DONT_GENERATE, DONT_INLINE], TryCatch #4 {IOException -> 0x0032, blocks: (B:3:0x0004, B:5:0x002e, B:8:0x0035, B:10:0x003e, B:12:0x0044, B:14:0x0065, B:15:0x0068, B:16:0x006b, B:17:0x0071, B:19:0x0077, B:21:0x0098, B:23:0x00a8, B:25:0x00b3, B:29:0x00be, B:28:0x00b8, B:30:0x00c1, B:36:0x00dd, B:38:0x00e3, B:42:0x00fa, B:54:0x011e, B:56:0x0124, B:58:0x012a, B:60:0x014b, B:61:0x014e, B:62:0x0151, B:63:0x0154, B:48:0x0104, B:52:0x0117), top: B:76:0x0004, inners: #1, #3 }] */
    ...
    */
    ...
    public final boolean e() {
        return com.apm.insight.e.a.a().a(com.apm.insight.l.j.f(this.f5149c.b()).getAbsolutePath());
    }

    public final void f() {
        com.apm.insight.e.a.a().a(com.apm.insight.d.a.b(com.apm.insight.l.j.f(this.f5149c.b()).getAbsolutePath()));
    }

    public final JSONObject h() {
        try {
            com.apm.insight.entity.a aVar = new com.apm.insight.entity.a();
            Header header = new Header(this.f5147a);
            JSONObject jSONObjectA = o.a().a(this.f5149c.a());
            if (jSONObjectA != null) {
            ...
            aVar.a("crash_uuid", this.f5149c.b().getName());
            b bVar = this.f5149c;
            Map<String, String> mapF = bVar != null ? bVar.f5151b.f() : null;
            if (mapF != null) {
            ...
            Map<String, String> mapB = this.f5149c.f5150a.b();
            if (!mapB.isEmpty()) {
            ...
            File fileE = com.apm.insight.l.j.e(this.f5149c.b());
            if (fileE.exists() || this.f5148b != null) {
                try {
                    JSONObject jSONObject2 = this.f5148b;
                    if (jSONObject2 == null) {
            ...
            File fileG = com.apm.insight.l.j.g(this.f5149c.b());
            String strA2 = "";
            if (fileG.exists()) {
                try {
            ...
            File fileO = com.apm.insight.l.j.o(this.f5149c.b());
            if (fileO.exists()) {
                String strB = C0066a.b(fileO);
            ...
            map.put("has_fds_file", com.apm.insight.l.j.i(this.f5149c.b()).exists() ? "true" : "false");
            File fileH = com.apm.insight.l.j.h(this.f5149c.b());
            map.put("has_logcat_file", (!fileH.exists() || fileH.length() <= 128) ? "false" : "true");
            map.put("has_maps_file", com.apm.insight.l.j.d(this.f5149c.b()).exists() ? "true" : "false");
            map.put("has_tombstone_file", com.apm.insight.l.j.b(this.f5149c.b()).exists() ? "true" : "false");
            map.put("has_meminfo_file", com.apm.insight.l.j.k(this.f5149c.b()).exists() ? "true" : "false");
            map.put("has_threads_file", com.apm.insight.l.j.j(this.f5149c.b()).exists() ? "true" : "false");
            int iA = new c().a();
            if (iA > 0) {
                if (iA > 960) {
            ...
            JSONArray jSONArrayA = com.apm.insight.nativecrash.b.a(com.apm.insight.l.j.l(this.f5149c.f5152c), com.apm.insight.l.j.m(this.f5149c.f5152c));
            map.put("leak_threads_count", String.valueOf(jSONArrayA.length()));
            if (jSONArrayA.length() > 0) {
                try {
                    com.apm.insight.l.f.a(com.apm.insight.l.j.n(this.f5149c.f5152c), jSONArrayA);
    ...
    public final boolean i() {
        return com.apm.insight.l.f.a(this.f5149c.b());
    }

    public final void j() {
        try {
            com.apm.insight.l.f.b(this.f5149c.b().getAbsolutePath(), Environment.getExternalStorageDirectory().getAbsolutePath() + "/localDebug/" + com.apm.insight.e.g().getPackageName() + "/" + this.f5149c.b().getName() + ".zip");
        } catch (Throwable th) {
            com.apm.insight.c.a();
            j.a(th, "NPTH_CATCH");
        }
    ...
    private void a(com.apm.insight.entity.a aVar) {
        File fileA = com.apm.insight.l.j.a(this.f5149c.b());
        if (fileA.exists()) {
            try {
    ...
    public class e {
        ...
        /* renamed from: a, reason: collision with root package name */
        protected File f5157a;

        /* renamed from: b, reason: collision with root package name */
        protected String f5158b;

        /* renamed from: c, reason: collision with root package name */
        protected String f5159c;
        ...
        public final int a() {
            int i10;
            Throwable th;
            if (!this.f5157a.exists() || !this.f5157a.isFile()) {
                return -1;
            }
            BufferedReader bufferedReader = null;
            try {
                BufferedReader bufferedReader2 = new BufferedReader(new FileReader(this.f5157a));
                int iA = -1;
                do {
                    try {
        ...
        private int a(String str) throws NumberFormatException {
            int i10 = this.f5160d;
            if (!str.startsWith(this.f5158b)) {
                return i10;
            }
            try {
                i10 = Integer.parseInt(str.split(this.f5159c)[1].trim());
    ...
    private void b(com.apm.insight.entity.a aVar) {
        ...
        JSONArray jSONArray = new JSONArray();
        String str = " " + this.f5149c.f5151b.f().get("pid") + " ";
        try {
