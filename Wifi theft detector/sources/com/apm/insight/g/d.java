...
public final class d implements c {
    ...
    public final void a(final long j10, final Thread thread, final Throwable th, final String str, final String str2, final boolean z10) {
        final File file = new File(j.a(this.f4985a), str);
        a.a().a(file.getName());
        file.mkdirs();
        f.d(file);
        ...
        com.apm.insight.entity.a aVarA = com.apm.insight.runtime.a.f.a().a(CrashType.JAVA, new c.a() { // from class: com.apm.insight.g.d.1
            ...
            public final com.apm.insight.entity.a a(int i10, com.apm.insight.entity.a aVar) throws JSONException {
                this.f4986a = SystemClock.uptimeMillis();
                if (i10 == 0) {
                    ...
                    if (i10 == 2) {
                        if (zC) {
                            com.apm.insight.l.a.a(d.this.f4985a, aVar.c());
                        }
                        if (e.x()) {
