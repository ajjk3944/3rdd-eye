...
public final class a {
    ...
    private static Class<?> f5104b = null;

    /* renamed from: c, reason: collision with root package name */
    private static Field f5105c = null;

    /* renamed from: d, reason: collision with root package name */
    private static Field f5106d = null;

    /* renamed from: e, reason: collision with root package name */
    private static boolean f5107e = false;
    ...
    public static String c(Context context) {
        ...
        if (f5105c == null && clsE != null) {
            try {
                f5105c = clsE.getDeclaredField("VERSION_NAME");
    ...
    public static int d(Context context) {
        Class<?> clsE = e(context);
        if (f5106d == null && clsE != null) {
            try {
                f5106d = clsE.getDeclaredField("VERSION_CODE");
            } catch (NoSuchFieldException unused) {
            }
        }
        Field field = f5106d;
    ...
    private static Class<?> e(Context context) {
        if (f5104b == null && !f5107e) {
            try {
                f5104b = Class.forName(context.getPackageName() + ".BuildConfig");
