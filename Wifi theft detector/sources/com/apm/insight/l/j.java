...
public final class j {
    ...
    private static File f5132b;

    /* renamed from: c, reason: collision with root package name */
    private static File f5133c;
    ...
    public static File d(@NonNull Context context) {
        if (f5132b == null) {
            ...
            f5132b = new File(j(context), "apminsight/CrashLogNative");
        }
        return f5132b;
    }
    ...
    public static File e(@NonNull Context context) {
        if (f5133c == null) {
            f5133c = new File(j(context) + "/apminsight/CrashCommonLog/" + com.apm.insight.e.f());
        }
        return f5133c;
    }
    ...
    public static String j(@NonNull Context context) {
        if (TextUtils.isEmpty(f5131a)) {
            try {
                f5131a = context.getFilesDir().getAbsolutePath();
            } catch (Exception e10) {
                f5131a = "/sdcard/";
                e10.printStackTrace();
            }
