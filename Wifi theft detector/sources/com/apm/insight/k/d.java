...
public final class d {
    ...
    private static volatile d f5060a;

    /* renamed from: b, reason: collision with root package name */
    private volatile Context f5061b;
    ...
    public static d a() {
        if (f5060a == null) {
            f5060a = new d(com.apm.insight.e.g());
        }
        return f5060a;
    }
    ...
    public final void b(JSONObject jSONObject) {
        ...
        try {
            String strF = e.f();
            File file = new File(com.apm.insight.l.j.a(this.f5061b), com.apm.insight.l.j.c());
    ...
    public final void a(JSONObject jSONObject, long j10, boolean z10) {
        ...
        try {
            String strC = e.c();
            int i10 = 0;
            File file = new File(com.apm.insight.l.j.a(this.f5061b), com.apm.insight.e.a(j10, CrashType.ANR, false, false));
            ...
            if (z10 && !Npth.isStopUpload()) {
                ...
                if (com.apm.insight.runtime.a.h()) {
                    ...
                    for (Map.Entry<String, n.a> entry : mapA.entrySet()) {
                        if (!entry.getKey().equals(com.apm.insight.l.a.b())) {
                            fileArr[i10] = com.apm.insight.l.j.a(this.f5061b, entry.getValue().f5279a);
                            i10++;
                        }
                    }
                } else {
                ...
                fileArr[fileArr.length - 1] = com.apm.insight.l.j.a(this.f5061b, com.apm.insight.e.f());
    ...
    public final boolean a(JSONObject jSONObject) {
        if (jSONObject != null && jSONObject.length() > 0) {
            try {
                String strC = e.c();
                File file = new File(com.apm.insight.l.j.a(this.f5061b), com.apm.insight.l.j.a(com.apm.insight.e.e()));
