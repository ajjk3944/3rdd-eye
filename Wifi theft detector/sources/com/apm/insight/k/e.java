...
public final class e {
    ...
    public static final class a {
        ...
        private static a f5068c = new a("NONE", 0, 0);

        /* renamed from: a, reason: collision with root package name */
        public static final a f5066a = new a("GZIP", 1, 1);

        /* renamed from: b, reason: collision with root package name */
        public static final a f5067b = new a("DEFLATER", 2, 2);
    ...
    private static com.apm.insight.l.f a(String str, byte[] bArr, a aVar, String str2) throws IOException {
        ...
        if (a.f5066a == aVar && length > 128) {
            bArr = a(bArr);
            str3 = "gzip";
        } else if (a.f5067b != aVar || length <= 128) {
            str3 = null;
        } else {
    ...
    private static com.apm.insight.l.f d(String str, String str2) {
        try {
            if (!TextUtils.isEmpty(str2) && !TextUtils.isEmpty(str)) {
                return a(str, str2.getBytes(), a.f5066a, "application/json; charset=utf-8");
            }
            return new com.apm.insight.l.f(201);
        } catch (Throwable th) {
    ...
    public static byte[] a(String str, byte[] bArr) {
        try {
            ...
            return a(str, bArr, a.f5066a, "application/json; charset=utf-8").b();
        } catch (IOException e10) {
            e10.printStackTrace();
            return null;
        }
