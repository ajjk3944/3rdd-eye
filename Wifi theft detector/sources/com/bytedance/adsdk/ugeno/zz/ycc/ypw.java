...
public class ypw extends xq<emc> {
    ...
    */
    ...
    private void zz() {
        float f10 = this.gyw;
        if (f10 <= 3.0f) {
            ((emc) this.bw).setLineSpacing(0.0f, f10);
            return;
        }
        if (Build.VERSION.SDK_INT >= 28) {
            int iRound = Math.round(msw.emc(this.ypw, (f10 - (this.hh * 1.2f)) / 2.0f));
            int paddingTop = ((emc) this.bw).getPaddingTop() + iRound;
            int paddingBottom = ((emc) this.bw).getPaddingBottom() + iRound;
            T t10 = this.bw;
            ((emc) t10).setPadding(((emc) t10).getPaddingLeft(), paddingTop, ((emc) this.bw).getPaddingRight(), paddingBottom);
    ...
    public void ypw() throws JSONException {
        ...
        int i11 = this.oa;
        if (i11 == 1) {
            ((emc) this.bw).setTypeface(Typeface.DEFAULT, i11);
        } else if (i10 >= 28) {
            ((emc) this.bw).setTypeface(Typeface.create(Typeface.DEFAULT, (int) this.qp, i11 == 2));
