...
public class xq extends com.bytedance.adsdk.ugeno.ypw.xq<emc> {
    ...
    private void ru() {
        if (this.nx > 0.0f) {
            bw.emc().ypw().emc(this.zz, this.emc, new emc.InterfaceC0094emc() { // from class: com.bytedance.adsdk.ugeno.zz.dg.xq.1
        ...
        String str = this.emc;
        T t10 = this.bw;
        emcVarYpw.emc(gblVar, str, (ImageView) t10, ((emc) t10).getWidth(), ((emc) this.bw).getHeight(), new emc.InterfaceC0094emc() { // from class: com.bytedance.adsdk.ugeno.zz.dg.xq.2
            @Override // com.bytedance.adsdk.ugeno.emc.InterfaceC0094emc
            public void emc(Bitmap bitmap) {
                if (bitmap == null) {
                    if (((com.bytedance.adsdk.ugeno.ypw.xq) xq.this).xxs != null) {
        ...
        if (this.hh || this.zhk > 0.0f) {
            bw.emc().ypw().emc(this.zz, this.emc, new emc.InterfaceC0094emc() { // from class: com.bytedance.adsdk.ugeno.zz.dg.xq.3
                @Override // com.bytedance.adsdk.ugeno.emc.InterfaceC0094emc
                public void emc(Bitmap bitmap) {
                    if (bitmap == null) {
                        return;
    ...
    public void ypw() throws JSONException, NumberFormatException {
        ...
        int i10 = this.oa;
        if (i10 != -1) {
            ((emc) this.bw).setColorFilter(i10);
        }
    }
