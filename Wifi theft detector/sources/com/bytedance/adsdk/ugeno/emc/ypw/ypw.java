...
public class ypw extends emc {
    ...
    public void emc(float f10, String str) {
        this.bw.add(Keyframe.ofFloat(f10, (this.ypw.startsWith(bw.TRANSLATE.emc()) || this.dg == bw.BORDER_RADIUS) ? msw.emc(this.emc, com.bytedance.adsdk.ugeno.uym.xq.emc(str, 0.0f)) : com.bytedance.adsdk.ugeno.uym.xq.emc(str, 0.0f)));
    }
