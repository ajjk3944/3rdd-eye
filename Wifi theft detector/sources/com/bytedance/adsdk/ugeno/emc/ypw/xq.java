...
public class xq extends emc {
    ...
    public void emc(float f10, String str) {
        this.bw.add(this.dg == bw.BACKGROUND_COLOR ? Keyframe.ofInt(f10, com.bytedance.adsdk.ugeno.uym.emc.emc(str)) : Keyframe.ofInt(f10, com.bytedance.adsdk.ugeno.uym.xq.emc(str, 0)));
    }
