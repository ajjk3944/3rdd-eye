...
public class bw extends emc {
    ...
    private void xq(Canvas canvas) {
        ...
        iWa = (int) (this.xq * this.ypw.wa());
        iWa2 = (int) (this.dg * this.ypw.wa());
        this.bw.setXfermode(this.sz);
        String str = this.uym;
        str.getClass();
        switch (str) {
            ...
            case "center":
                ...
                Path path = this.gbl;
                float f10 = this.xq;
                path.addRect(f10 / 2.0f, 0.0f, f10, this.dg, direction);
                Path path2 = this.gbl;
                Path path3 = this.ru;
    ...
    public void ypw() {
        ...
        this.uym = this.emc.optString("direction", TtmlNode.CENTER);
    }
