...
public class dg extends qh<Integer, Integer> {
    public dg(List<com.bytedance.adsdk.ypw.uym.emc<Integer>> list) {
        super(list);
    }

    @Override // com.bytedance.adsdk.ypw.xq.emc.sz
    public com.bytedance.adsdk.ypw.emc.ypw.emc<Integer, Integer> emc() {
        return new com.bytedance.adsdk.ypw.emc.ypw.ycc(this.emc);
    }
