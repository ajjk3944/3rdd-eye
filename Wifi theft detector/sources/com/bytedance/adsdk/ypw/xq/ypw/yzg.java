...
public class yzg implements xq {
    ...
    public yzg(String str, emc emcVar, com.bytedance.adsdk.ypw.xq.emc.ypw ypwVar, com.bytedance.adsdk.ypw.xq.emc.ypw ypwVar2, com.bytedance.adsdk.ypw.xq.emc.ypw ypwVar3, boolean z10) {
        this.emc = str;
        this.ypw = emcVar;
        this.xq = ypwVar;
        this.dg = ypwVar2;
