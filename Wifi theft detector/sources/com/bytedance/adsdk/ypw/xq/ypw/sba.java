...
public class sba implements xq {
    ...
    public enum emc {
        ...
        public Paint.Cap emc() {
            int i10 = AnonymousClass1.emc[ordinal()];
    ...
    public enum ypw {
        ...
        public Paint.Join emc() {
            int i10 = AnonymousClass1.ypw[ordinal()];
            if (i10 == 1) {
    ...
    public sba(String str, com.bytedance.adsdk.ypw.xq.emc.ypw ypwVar, List<com.bytedance.adsdk.ypw.xq.emc.ypw> list, com.bytedance.adsdk.ypw.xq.emc.emc emcVar, com.bytedance.adsdk.ypw.xq.emc.dg dgVar, com.bytedance.adsdk.ypw.xq.emc.ypw ypwVar2, emc emcVar2, ypw ypwVar3, float f10, boolean z10) {
        this.emc = str;
        this.ypw = ypwVar;
        this.xq = list;
        this.dg = emcVar;
