...
public class zz extends Drawable implements Animatable, Drawable.Callback {
    ...
    public void dg(final String str) {
        ...
        com.bytedance.adsdk.ypw.xq.ycc yccVarXq = uymVar.xq(str);
        if (yccVarXq != null) {
            int i10 = (int) yccVarXq.emc;
            emc(i10, ((int) yccVarXq.ypw) + i10);
        } else {
            throw new IllegalArgumentException("Cannot find marker with name " + str + ".");
        }
    }

    public void ypw(final float f10) {
        uym uymVar = this.dg;
        if (uymVar == null) {
            ...
            this.bw.ypw(com.bytedance.adsdk.ypw.ycc.bw.emc(uymVar.ycc(), this.dg.uym(), f10));
        }
    }
    ...
    public void dg(final float f10) {
        if (this.dg == null) {
    ...
    private void ypw(int i10, int i11) {
        ...
        if (bitmap != null && bitmap.getWidth() >= i10 && this.sf.getHeight() >= i11) {
            if (this.sf.getWidth() > i10 || this.sf.getHeight() > i11) {
                Bitmap bitmapCreateBitmap = Bitmap.createBitmap(this.sf, 0, 0, i10, i11);
    ...
    public void emc(final float f10) {
        uym uymVar = this.dg;
        if (uymVar == null) {
            ...
            emc((int) com.bytedance.adsdk.ypw.ycc.bw.emc(uymVar.ycc(), this.dg.uym(), f10));
        }
    }

    public void emc(final int i10, final int i11) {
        if (this.dg == null) {
    ...
    private void emc(RectF rectF, float f10, float f11) {
