...
public class msw {
    ...
    private sup<com.bytedance.adsdk.ypw.uym> xq(Context context, String str, String str2) throws IOException {
        ...
        try {
            try {
                ...
                sup<com.bytedance.adsdk.ypw.uym> supVar2 = new sup<>(e10);
                if (0 != 0) {
                    try {
                        closeable.close();
    ...
    private sup<com.bytedance.adsdk.ypw.uym> emc(Context context, String str, InputStream inputStream, String str2, String str3) throws IOException {
    ...
    private sup<com.bytedance.adsdk.ypw.uym> emc(Context context, String str, InputStream inputStream, String str2) throws IOException {
        uym uymVar;
    ...
    private sup<com.bytedance.adsdk.ypw.uym> emc(String str, InputStream inputStream, String str2) throws IOException {
        uym uymVar;
        if (str2 != null && (uymVar = this.emc) != null) {
