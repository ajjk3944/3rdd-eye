...
class yzg {
    ...
    private static PointF bw(JsonReader jsonReader, float f10) throws IOException {
        ...
        return new PointF(fYpw * f10, fYpw2 * f10);
    }

    private static PointF dg(JsonReader jsonReader, float f10) throws IOException {
    ...
    private static PointF xq(JsonReader jsonReader, float f10) throws IOException {
        float fNextDouble = (float) jsonReader.nextDouble();
        float fNextDouble2 = (float) jsonReader.nextDouble();
        while (jsonReader.hasNext()) {
            jsonReader.skipValue();
    ...
    public static PointF ypw(JsonReader jsonReader, float f10) throws IOException {
        int i10 = AnonymousClass1.emc[jsonReader.peek().ordinal()];
        if (i10 == 1) {
            return xq(jsonReader, f10);
        }
        if (i10 == 2) {
            return dg(jsonReader, f10);
        }
        if (i10 == 3) {
            return bw(jsonReader, f10);
        }
    ...
    public static float ypw(JsonReader jsonReader) throws IOException {
        ...
        int i10 = AnonymousClass1.emc[jsonTokenPeek.ordinal()];
        if (i10 == 1) {
    ...
    public static List<PointF> emc(JsonReader jsonReader, float f10) throws IOException {
        ArrayList arrayList = new ArrayList();
        jsonReader.beginArray();
        while (jsonReader.peek() == JsonToken.BEGIN_ARRAY) {
            jsonReader.beginArray();
            arrayList.add(ypw(jsonReader, f10));
            jsonReader.endArray();
        }
        jsonReader.endArray();
        return arrayList;
