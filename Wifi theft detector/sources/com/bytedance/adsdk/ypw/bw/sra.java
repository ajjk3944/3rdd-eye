...
public class sra {
    ...
    public static com.bytedance.adsdk.ypw.xq.xq.bw emc(JsonReader jsonReader, com.bytedance.adsdk.ypw.uym uymVar) throws IOException {
        Float f10;
        ...
        while (jsonReader.hasNext()) {
            ...
            switch (strNextName) {
                ...
                case "sc":
                    ...
                    break;
                case "sh":
                    iNextInt2 = (int) (jsonReader.nextInt() * com.bytedance.adsdk.ypw.ycc.ycc.emc());
                    break;
                case "sr":
                ...
                case "st":
                    ...
                    break;
                case "sw":
                    iNextInt = (int) (jsonReader.nextInt() * com.bytedance.adsdk.ypw.ycc.ycc.emc());
                    break;
                case "tm":
                ...
                case "tt":
                    ...
                    if (iNextInt4 >= bw.ypw.values().length) {
                        uymVar.emc("Unsupported matte type: ".concat(String.valueOf(iNextInt4)));
                        break;
                    } else {
                        ypwVar2 = bw.ypw.values()[iNextInt4];
                        int i10 = AnonymousClass1.emc[ypwVar2.ordinal()];
                        if (i10 == 1) {
                ...
                case "ty":
                    ...
                    if (iNextInt5 >= emcVar.ordinal()) {
                        break;
                    } else {
                        emcVar = bw.emc.values()[iNextInt5];
                        break;
                    }
                case "ind":
        ...
        arrayList4.add(new com.bytedance.adsdk.ypw.uym.emc(uymVar, f10, f10, null, fUym, Float.valueOf(Float.MAX_VALUE)));
        if (strNextString2.endsWith(".ai") || "ai".equals(strNextString3)) {
            uymVar.emc("Convert your Illustrator layers to shape layers.");
        }
        return new com.bytedance.adsdk.ypw.xq.xq.bw(arrayList2, uymVar, strNextString2, jNextInt, emcVar, jNextInt2, strNextString, arrayList, supVarEmc, iNextInt, iNextInt2, color, fNextDouble5, fNextDouble4, fNextDouble2, fNextDouble3, ruVarYcc, gblVarEmc, arrayList4, ypwVar2, ypwVarEmc, zNextBoolean, emcVarEmc, ruVarEmc);
    }
}
