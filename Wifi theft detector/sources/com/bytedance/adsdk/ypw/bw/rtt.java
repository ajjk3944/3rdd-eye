...
public class rtt implements wo<com.bytedance.adsdk.ypw.uym.xq> {
    ...
    public com.bytedance.adsdk.ypw.uym.xq ypw(JsonReader jsonReader, float f10) throws IOException {
        ...
        return new com.bytedance.adsdk.ypw.uym.xq((fNextDouble / 100.0f) * f10, (fNextDouble2 / 100.0f) * f10);
    }
}
