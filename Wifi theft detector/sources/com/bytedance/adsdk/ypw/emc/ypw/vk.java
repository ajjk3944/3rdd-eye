...
public class vk {
    ...
    public Matrix dg() {
        ...
        if (emcVar != null && (pointFUym2 = emcVar.uym()) != null) {
            float f10 = pointFUym2.x;
            if (f10 != 0.0f || pointFUym2.y != 0.0f) {
                this.emc.preTranslate(f10, pointFUym2.y);
            }
        }
    ...
    public Matrix ypw(float f10) {
        ...
        this.emc.reset();
        if (pointFUym != null) {
            this.emc.preTranslate(pointFUym.x * f10, pointFUym.y * f10);
        }
        if (xqVarUym != null) {
            double d10 = f10;
            this.emc.preScale((float) Math.pow(xqVarUym.emc(), d10), (float) Math.pow(xqVarUym.ypw(), d10));
        }
        ...
        if (emcVar3 != null) {
            ...
            this.emc.preRotate(fFloatValue * f10, pointFUym2 == null ? 0.0f : pointFUym2.x, pointFUym2 != null ? pointFUym2.y : 0.0f);
        }
        return this.emc;
    }

    public void emc(emc.InterfaceC0106emc interfaceC0106emc) {
        emc<Integer, Integer> emcVar = this.ru;
        if (emcVar != null) {
            emcVar.emc(interfaceC0106emc);
        }
        emc<?, Float> emcVar2 = this.sz;
        if (emcVar2 != null) {
            emcVar2.emc(interfaceC0106emc);
        }
        emc<?, Float> emcVar3 = this.qh;
        if (emcVar3 != null) {
            emcVar3.emc(interfaceC0106emc);
        }
        emc<PointF, PointF> emcVar4 = this.ycc;
        if (emcVar4 != null) {
            emcVar4.emc(interfaceC0106emc);
        }
        emc<?, PointF> emcVar5 = this.uym;
        if (emcVar5 != null) {
            emcVar5.emc(interfaceC0106emc);
        }
        emc<com.bytedance.adsdk.ypw.uym.xq, com.bytedance.adsdk.ypw.uym.xq> emcVar6 = this.msw;
        if (emcVar6 != null) {
            emcVar6.emc(interfaceC0106emc);
        }
        emc<Float, Float> emcVar7 = this.zz;
        if (emcVar7 != null) {
            emcVar7.emc(interfaceC0106emc);
        }
        dg dgVar = this.gbl;
        if (dgVar != null) {
            dgVar.emc(interfaceC0106emc);
        }
        dg dgVar2 = this.sup;
        if (dgVar2 != null) {
            dgVar2.emc(interfaceC0106emc);
        }
    }
