...
public class dg extends uym<Float> {
    ...
    public float xq(com.bytedance.adsdk.ypw.uym.emc<Float> emcVar, float f10) {
        if (emcVar.emc == null || emcVar.ypw == null) {
            throw new IllegalStateException("Missing values for keyframe.");
        }
        if (this.xq == null) {
            return com.bytedance.adsdk.ypw.ycc.bw.emc(emcVar.ycc(), emcVar.uym(), f10);
        }
        emcVar.uym.getClass();
        dg();
        msw();
    ...
    public Float emc(com.bytedance.adsdk.ypw.uym.emc<Float> emcVar, float f10) {
        return Float.valueOf(xq(emcVar, f10));
    }
