...
public class ypw extends uym<Integer> {
    public ypw(List<com.bytedance.adsdk.ypw.uym.emc<Integer>> list) {
        super(list);
    }
    ...
    public int xq(com.bytedance.adsdk.ypw.uym.emc<Integer> emcVar, float f10) {
        ...
        if (this.xq == null) {
            return com.bytedance.adsdk.ypw.ycc.ypw.emc(com.bytedance.adsdk.ypw.ycc.bw.ypw(f10, 0.0f, 1.0f), emcVar.emc.intValue(), emcVar.ypw.intValue());
        }
        emcVar.uym.getClass();
        dg();
        msw();
