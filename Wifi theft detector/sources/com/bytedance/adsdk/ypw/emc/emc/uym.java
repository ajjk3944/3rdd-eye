...
public class uym implements bw, gbl, emc.InterfaceC0106emc {
    ...
    public void emc(Canvas canvas, Matrix matrix, int i10) {
        ...
        this.xq.setColor((com.bytedance.adsdk.ypw.ycc.bw.emc((int) ((((i10 / 255.0f) * this.zz.uym().intValue()) / 100.0f) * 255.0f), 0, 255) << 24) | (((com.bytedance.adsdk.ypw.emc.ypw.ypw) this.msw).zz() & 16777215));
        ...
        for (int i11 = 0; i11 < this.uym.size(); i11++) {
            this.ypw.addPath(this.uym.get(i11).dg(), matrix);
        }
    ...
    public void emc(RectF rectF, Matrix matrix, boolean z10) {
        ...
        for (int i10 = 0; i10 < this.uym.size(); i10++) {
            this.ypw.addPath(this.uym.get(i10).dg(), matrix);
        }
