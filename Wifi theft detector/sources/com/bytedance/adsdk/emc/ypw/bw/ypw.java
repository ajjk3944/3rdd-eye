...
public class ypw {
    ...
    public static com.bytedance.adsdk.emc.ypw.ypw.emc emc(List<com.bytedance.adsdk.emc.ypw.ypw.emc> list, String str, int i10) {
        xq(list, str, i10);
        Deque<com.bytedance.adsdk.emc.ypw.ypw.emc> dequeEmc = emc(ypw(list, str, i10));
        if (dequeEmc.size() == 1) {
    ...
    private static void xq(List<com.bytedance.adsdk.emc.ypw.ypw.emc> list, String str, int i10) {
    ...
    private static Deque<com.bytedance.adsdk.emc.ypw.ypw.emc> ypw(List<com.bytedance.adsdk.emc.ypw.ypw.emc> list, String str, int i10) {
        ...
        while (i11 > 0) {
            ...
            for (com.bytedance.adsdk.emc.ypw.ypw.emc emcVar : linkedList) {
                if (!linkedList2.isEmpty() && xq.emc(((com.bytedance.adsdk.emc.ypw.ypw.emc) linkedList2.peekLast()).emc()) && ((xq) ((com.bytedance.adsdk.emc.ypw.ypw.emc) linkedList2.peekLast()).emc()).ypw() == i11) {
