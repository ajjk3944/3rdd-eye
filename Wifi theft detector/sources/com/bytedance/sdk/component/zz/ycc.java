...
public class ycc extends FrameLayout {
    ...
    private com.bytedance.sdk.component.zz.emc f9241aa;
    private String bw;
    private View cf;
    private ee cuf;
    private xq db;
    ...
    private boolean ul;
    private boolean uym;
    private emc.InterfaceC0130emc vk;
    private bw vw;
    private long wo;
    private int xmt;
    public int xq;
    ...
    public interface dg {
        WebView emc(Context context, AttributeSet attributeSet, int i10, xq xqVar);
    }
    ...
    public String getOriginalUrl() {
        ...
        try {
            ...
            if (originalUrl != null && originalUrl.startsWith("data:text/html") && (url = this.qh.getUrl()) != null) {
                if (url.startsWith(q7.a.FILE_SCHEME)) {
                    return url;
                }
            }
            return originalUrl;
    ...
    public void setAllowFileAccess(boolean z10) {
        try {
            this.qh.getSettings().setAllowFileAccess(z10);
        } catch (Throwable unused) {
        }
    }
    ...
    public void setBackgroundColor(int i10) {
        try {
            this.qh.setBackgroundColor(i10);
        } catch (Throwable unused) {
        }
    }
    ...
    public void setBuiltInZoomControls(boolean z10) {
        try {
            this.qh.getSettings().setBuiltInZoomControls(z10);
        } catch (Throwable unused) {
        }
    }
    ...
    public void setCacheMode(int i10) {
        try {
            this.qh.getSettings().setCacheMode(i10);
        } catch (Throwable unused) {
        }
    }
    ...
    public void setDatabaseEnabled(boolean z10) {
        try {
            this.qh.getSettings().setDatabaseEnabled(z10);
        } catch (Throwable unused) {
        }
    }
    ...
    public void setDefaultFontSize(int i10) {
        try {
            this.qh.getSettings().setDefaultFontSize(i10);
        } catch (Throwable unused) {
        }
    }
    ...
    public void setDisplayZoomControls(boolean z10) {
        try {
            this.qh.getSettings().setDisplayZoomControls(z10);
        } catch (Throwable unused) {
        }
    }
    ...
    public void setDomStorageEnabled(boolean z10) {
        try {
            this.qh.getSettings().setDomStorageEnabled(z10);
        } catch (Throwable unused) {
        }
    }
    ...
    public void setJavaScriptCanOpenWindowsAutomatically(boolean z10) {
        try {
            this.qh.getSettings().setJavaScriptCanOpenWindowsAutomatically(z10);
        } catch (Throwable unused) {
        }
    }
    ...
    public void setJavaScriptEnabled(boolean z10) {
        try {
            this.qh.getSettings().setJavaScriptEnabled(z10);
        } catch (Throwable unused) {
        }
    }
    ...
    public void setLayerType(int i10, Paint paint) {
        try {
            this.qh.setLayerType(i10, paint);
        } catch (Throwable unused) {
        }
    }
    ...
    public void setLoadWithOverviewMode(boolean z10) {
        try {
            this.qh.getSettings().setLoadWithOverviewMode(z10);
        } catch (Throwable unused) {
        }
    }
    ...
    public void setMixedContentMode(int i10) {
        try {
            this.qh.getSettings().setMixedContentMode(i10);
        } catch (Throwable unused) {
        }
    }
    ...
    public void setNetworkAvailable(boolean z10) {
        try {
            this.qh.setNetworkAvailable(z10);
        } catch (Throwable unused) {
        }
    }
    ...
    public void setRecycler(boolean z10) {
        ...
        ((com.bytedance.sdk.component.zz.bw) this.qh).setRecycler(z10);
    }
    ...
    public void setSupportZoom(boolean z10) {
        try {
            this.qh.getSettings().setSupportZoom(z10);
        } catch (Throwable unused) {
        }
    }
    ...
    public void setTag(String str) {
        this.bw = str;
        com.bytedance.sdk.component.zz.emc emcVar = this.f9241aa;
        if (emcVar != null) {
            emcVar.emc(str);
        }
    ...
    public void setUseWideViewPort(boolean z10) {
        try {
            this.qh.getSettings().setUseWideViewPort(z10);
        } catch (Throwable unused) {
        }
    }
    ...
    public ycc(Context context, boolean z10, xq xqVar) {
        super(emc(context));
        this.msw = 0.0f;
        this.zz = 0.0f;
        this.ru = 0L;
    ...
    @SuppressLint({"ClickableViewAccessibility"})
    public void emc(boolean z10, int i10, int i11, List<Integer> list, int i12, List<String> list2) {
        if (z10 && this.qh != null && (this.qh instanceof com.bytedance.sdk.component.zz.bw)) {
            this.f9241aa = new com.bytedance.sdk.component.zz.emc(this.mkp, i10, i11, list, i12);
            this.sba = list2;
            if (!TextUtils.isEmpty(this.bw)) {
                this.f9241aa.emc(this.bw);
            }
            ((com.bytedance.sdk.component.zz.bw) this.qh).setTouchListenerProxy(this.f9241aa);
            this.vk = this.f9241aa.emc();
        }
    }
    ...
    public void emc(int i10, long j10) {
        ...
        this.yzg = new com.bytedance.sdk.component.zz.dg(this.mkp, this.f9241aa, i10, j10, this);
        if (!TextUtils.isEmpty(this.bw)) {
    ...
    public void emc(boolean z10, View view) {
        if (z10) {
            this.cf = view;
    ...
    private WebView emc(AttributeSet attributeSet, int i10) {
        dg dgVar = ra;
        if (dgVar != null) {
            return dgVar.emc(getContext(), attributeSet, i10, this.db);
        }
