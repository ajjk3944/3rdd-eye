...
public class uym extends WebViewClient {
    ...
    private final emc.InterfaceC0130emc ypw;

    public uym(emc.InterfaceC0130emc interfaceC0130emc, WebViewClient webViewClient, List<String> list) {
        this.ypw = interfaceC0130emc;
    ...
    public void onPageStarted(WebView webView, String str, Bitmap bitmap) {
        emc.InterfaceC0130emc interfaceC0130emc = this.ypw;
        if (interfaceC0130emc != null) {
            interfaceC0130emc.emc(emc(webView));
        }
    ...
    public void onReceivedError(WebView webView, int i10, String str, String str2) {
        this.emc.onReceivedError(webView, i10, str, str2);
    }

    @Override // android.webkit.WebViewClient
    public WebResourceResponse shouldInterceptRequest(WebView webView, WebResourceRequest webResourceRequest) {
        emc.InterfaceC0130emc interfaceC0130emc;
        if (ypw.emc(this.xq, webResourceRequest.getUrl().toString()) && (interfaceC0130emc = this.ypw) != null) {
            interfaceC0130emc.emc();
        }
