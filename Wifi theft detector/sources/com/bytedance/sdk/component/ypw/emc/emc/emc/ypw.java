...
public class ypw implements com.bytedance.sdk.component.ypw.emc.ypw {
    ...
    private boolean bw() {
        ...
        return this.emc.dg().containsKey(CommonGatewayClient.HEADER_CONTENT_TYPE);
    }
    ...
    public qh ypw() throws IOException {
        ...
        if ((dgVar instanceof ycc) && (dgVar.xq().size() + this.ypw.dg().size() > this.ypw.emc() || this.xq.get())) {
        ...
        try {
            ...
            arrayList.add(new com.bytedance.sdk.component.ypw.emc.msw() { // from class: com.bytedance.sdk.component.ypw.emc.emc.emc.ypw.1
                ...
                public qh emc(msw.emc emcVar2) throws IOException {
    ...
    public qh emc(sup supVar, boolean z10) throws IOException {
            ...
            try {
                ...
                if (z10) {
                    try {
                        ...
                        strEmc = emc(httpURLConnection, e10);
                        this.ypw.dg().remove(this);
                ...
                if (supVar.msw() == null) {
                    ...
                    if (!bw() && supVar.msw().xq != null) {
                        httpURLConnection.addRequestProperty(CommonGatewayClient.HEADER_CONTENT_TYPE, supVar.msw().xq.emc());
                    }
