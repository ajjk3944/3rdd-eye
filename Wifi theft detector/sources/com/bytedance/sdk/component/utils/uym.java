...
public class uym {
    ...
    public static final class emc implements Comparator<File> {
        ...
        private int emc(long j10, long j11) {
            if (j10 < j11) {
                return -1;
            }
            return j10 == j11 ? 0 : 1;
    ...
    public static File emc(Context context, boolean z10, String str, String str2) {
    ...
    public static File emc(Context context, boolean z10, String str) {
