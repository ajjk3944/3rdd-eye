...
public class msw {
    ...
    public static HandlerThread emc(String str, int i10) {
        if (com.bytedance.sdk.component.msw.zz.dg) {
            return emc;
        }
        try {
            HandlerThread handlerThread = new HandlerThread(str, i10) { // from class: com.bytedance.sdk.component.utils.msw.1
                boolean emc = false;
