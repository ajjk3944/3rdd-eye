...
public class sb {
    ...
    public interface emc {
        void emc(Context context, Intent intent, boolean z10, int i10);
    }
    ...
    public static class ypw extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            try {
                ...
                sb.ypw(context, intent, z10, booleanExtra);
    ...
    public static void ypw(final Context context, final Intent intent, final boolean z10, final boolean z11) {
        if (!z10 && z11) {
            dg = 0;
            ...
            com.bytedance.sdk.component.msw.ycc.ypw(new com.bytedance.sdk.component.msw.msw("getNetworkType") { // from class: com.bytedance.sdk.component.utils.sb.1
                ...
                public void run() {
                    int unused = sb.dg = z11 ? 0 : sb.ypw(context);
                    sb.msw.set(false);
                    if (z10) {
                        sb.ypw(context, intent, sb.dg, z11);
                    }
                }
            });
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static void ypw(Context context, Intent intent, int i10, boolean z10) {
        ...
        for (emc emcVar : map.keySet()) {
            if (emcVar != null) {
                try {
                    emcVar.emc(context, intent, !z10, i10);
                } catch (Throwable unused) {
                }
            }
        }
    ...
    public static int emc(Context context, long j10) {
        long jElapsedRealtime = SystemClock.elapsedRealtime();
        if (bw + j10 <= jElapsedRealtime) {
            return ypw(context);
        }
        if (dg == -1) {
            return ypw(context);
