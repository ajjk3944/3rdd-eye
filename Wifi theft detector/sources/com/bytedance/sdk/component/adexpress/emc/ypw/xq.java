...
public abstract class xq {
    ...
    public void xq(List<emc.C0109emc> list) {
        if (list == null || list.isEmpty()) {
            return;
        }
        Iterator<emc.C0109emc> it = list.iterator();
        while (it.hasNext()) {
    ...
    public List<emc.C0109emc> ypw(com.bytedance.sdk.component.adexpress.emc.xq.emc emcVar, com.bytedance.sdk.component.adexpress.emc.xq.emc emcVar2) {
        ...
        if (emcVar2 == null || emcVar2.ycc().isEmpty()) {
            ...
            for (emc.C0109emc c0109emc : emcVar.ycc()) {
                if (!emcVar2.ycc().contains(c0109emc) && c0109emc != null && c0109emc.emc() != null && c0109emc.ypw() != null) {
                    arrayList2.add(c0109emc);
                }
            }
            for (emc.C0109emc c0109emc2 : emcVar2.ycc()) {
                if (!emcVar.ycc().contains(c0109emc2)) {
                    arrayList.add(c0109emc2);
                }
            }
        }
    ...
    public boolean emc(List<emc.C0109emc> list) throws IOException {
        if (list == null || list.size() <= 0 || emc() == null) {
            return false;
        }
        for (emc.C0109emc c0109emc : list) {
            String strEmc = com.bytedance.sdk.component.utils.bw.emc(c0109emc.emc());
            if (TextUtils.isEmpty(strEmc)) {
                return false;
            }
            File file = new File(emc(), strEmc);
            String strEmc2 = com.bytedance.sdk.component.utils.bw.emc(file);
            if (!file.exists() || !file.isFile() || c0109emc.ypw() == null || !c0109emc.ypw().equals(strEmc2)) {
                return false;
            }
        }
        return true;
    ...
    public void ypw(List<emc.C0109emc> list) {
        if (list == null || list.isEmpty()) {
            return;
        }
        Iterator<emc.C0109emc> it = list.iterator();
    ...
    public List<emc.C0109emc> emc(com.bytedance.sdk.component.adexpress.emc.xq.emc emcVar, com.bytedance.sdk.component.adexpress.emc.xq.emc emcVar2) {
        Map<String, com.bytedance.sdk.component.adexpress.emc.xq.emc> mapEmc = emcVar.emc();
        ArrayList arrayList = new ArrayList();
        ArrayList arrayList2 = new ArrayList();
        ArrayList arrayList3 = new ArrayList();
        if (mapEmc.size() == 0) {
            ...
            for (String str : mapEmc.keySet()) {
                ...
                if (emcVar5 == null && emcVar4 != null) {
                    ...
                    for (emc.C0109emc c0109emc : emcVar4.ycc()) {
                        if (c0109emc != null && !emcVar5.ycc().contains(c0109emc) && c0109emc.ypw() != null && c0109emc.emc() != null) {
                            arrayList2.add(c0109emc);
                        }
                    }
                    for (emc.C0109emc c0109emc2 : emcVar5.ycc()) {
                        if (c0109emc2 != null && !emcVar4.ycc().contains(c0109emc2)) {
                            arrayList.add(c0109emc2);
                        }
                    }
                }
    ...
    private boolean emc(List<emc.C0109emc> list, List<emc.C0109emc> list2) {
        for (emc.C0109emc c0109emc : list) {
            String strEmc = c0109emc.emc();
    ...
    public boolean emc(String str) {
        ...
        File file = new File(emc().getAbsoluteFile(), strEmc + ".zip");
        com.bytedance.sdk.component.uym.ypw.emc emcVarYcc = com.bytedance.sdk.component.adexpress.emc.emc.emc.emc().xq().ycc();
        emcVarYcc.ypw(str);
    ...
    public void emc(int i10) {
        if (com.bytedance.sdk.component.adexpress.emc.emc.emc.emc().dg() != null) {
            com.bytedance.sdk.component.adexpress.emc.emc.emc.emc().dg().emc(i10);
        }
    }

    public static void emc(File file, com.bytedance.sdk.component.adexpress.emc.xq.emc emcVar, String str) throws IOException {
