...
public class ycc {
        ...
        if (cursorEmc != null) {
            while (cursorEmc.moveToNext()) {
                try {
                    ...
                    this.xq.add(string2);
                    if (!z10 && com.bytedance.sdk.component.adexpress.emc.emc.emc.emc().ycc() != null) {
                        if (this.bw == null) {
    ...
    public void emc(com.bytedance.sdk.component.adexpress.emc.xq.ypw ypwVar, boolean z10) {
        ...
        boolean z11 = cursorEmc != null && cursorEmc.getCount() > 0;
        if (cursorEmc != null) {
            try {
    ...
    public void emc(Set<String> set) {
        ...
        if (strArr.length > 0) {
            for (int i10 = 0; i10 < strArr.length; i10++) {
                dg(strArr[i10]);
                com.bytedance.sdk.component.adexpress.emc.emc.emc.emc().ypw().emc("template_diff_new", "id=?", new String[]{strArr[i10]});
                xq(strArr[i10]);
            }
        }
    }
