...
public class ypw implements ru {
    ...
    public ypw(Context context, sz szVar, ThemeStatusBroadcastReceiver themeStatusBroadcastReceiver, boolean z10, com.bytedance.sdk.component.adexpress.dynamic.bw.msw mswVar, msw mswVar2, com.bytedance.sdk.component.adexpress.dynamic.ycc.emc emcVar, com.bytedance.sdk.component.adexpress.dynamic.emc.emc emcVar2) {
        this.emc = context;
        this.bw = szVar;
        ...
        if (emcVar2 != null) {
            ...
            this.ypw = new com.bytedance.sdk.component.adexpress.dynamic.emc.emc(context, themeStatusBroadcastReceiver, z10, mswVar, szVar, emcVar);
        }
    ...
    public boolean emc(final ru.emc emcVar) {
        ...
        this.ypw.emc(new uym() { // from class: com.bytedance.sdk.component.adexpress.ypw.ypw.1
            ...
            public void emc(int i10, String str) {
                ypw.this.bw.bw().emc(ypw.this.ycc, i10, str, emcVar.ypw(ypw.this));
