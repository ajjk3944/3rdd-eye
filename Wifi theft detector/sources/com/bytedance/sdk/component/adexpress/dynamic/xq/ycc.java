...
public class ycc extends aa<com.bytedance.sdk.component.adexpress.ycc.ycc> {
    public ycc(Context context, com.bytedance.sdk.component.adexpress.dynamic.dynamicview.bw bwVar, com.bytedance.sdk.component.adexpress.dynamic.dg.uym uymVar, int i10, int i11, int i12, JSONObject jSONObject) {
        super(context, bwVar, uymVar);
        this.ypw = context;
        this.dg = uymVar;
        this.xq = bwVar;
        emc(i10, i11, i12, jSONObject, uymVar);
    }

    private void emc(int i10, int i11, int i12, JSONObject jSONObject, com.bytedance.sdk.component.adexpress.dynamic.dg.uym uymVar) {
        this.emc = new com.bytedance.sdk.component.adexpress.ycc.ycc(this.ypw, i10, i11, i12, jSONObject);
