...
public class hxp extends ycc {
    ...
    public FrameLayout.LayoutParams getWidgetLayoutParams() {
        int iEmc = (int) ((com.bytedance.sdk.component.adexpress.dg.uym.emc(com.bytedance.sdk.component.adexpress.dg.emc(), this.sup.bw()) * 5.0f) + com.bytedance.sdk.component.adexpress.dg.uym.emc(com.bytedance.sdk.component.adexpress.dg.emc(), this.sup.xq() + com.bytedance.sdk.component.adexpress.dg.uym.emc(com.bytedance.sdk.component.adexpress.dg.emc(), this.sup.dg())));
    ...
    public boolean zz() throws NumberFormatException {
        ...
        double d10 = (dSz < 0.0d || dSz > 5.0d) ? 5.0d : dSz;
        this.cf.setVisibility(0);
        ((com.bytedance.sdk.component.adexpress.ycc.hxp) this.cf).emc(d10, this.sup.uym(), (int) this.sup.bw(), ((int) com.bytedance.sdk.component.adexpress.dg.uym.emc(this.gbl, this.sup.ypw())) + ((int) com.bytedance.sdk.component.adexpress.dg.uym.emc(this.gbl, this.sup.emc())) + ((int) com.bytedance.sdk.component.adexpress.dg.uym.emc(this.gbl, this.sup.bw())));
        return true;
    }
}
