...
public class cf extends dg {
    ...
    public List<ObjectAnimator> emc() {
        ...
        ObjectAnimator duration = ObjectAnimator.ofFloat(this.xq, "translationX", fEmc, f11).setDuration((int) (this.ypw.ru() * 1000.0d));
        ObjectAnimator duration2 = ObjectAnimator.ofFloat(this.xq, "translationY", fEmc2, f10).setDuration((int) (this.ypw.ru() * 1000.0d));
