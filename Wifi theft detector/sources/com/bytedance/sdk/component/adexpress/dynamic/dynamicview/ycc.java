...
public class ycc extends bw {
    ...
    public static class xq implements com.bytedance.sdk.component.bw.msw {
        ...
        public xq(Context context, int i10) {
    ...
    public ycc(Context context, DynamicRootView dynamicRootView, com.bytedance.sdk.component.adexpress.dynamic.dg.msw mswVar) {
        ...
        if ("logo-union".equals(strYpw)) {
            dynamicRootView.setLogoUnionHeight(this.msw - ((int) com.bytedance.sdk.component.adexpress.dg.uym.emc(context, this.sup.ypw() + this.sup.emc())));
        } else if ("scoreCountWithIcon".equals(strYpw)) {
            dynamicRootView.setScoreCountWithIcon(this.msw - ((int) com.bytedance.sdk.component.adexpress.dg.uym.emc(context, this.sup.ypw() + this.sup.emc())));
        }
    }
    ...
    public Drawable xq(String str) {
        try {
            ...
            for (int i11 = 0; i11 < arrayList.size(); i11++) {
                iArr[i11] = com.bytedance.sdk.component.adexpress.dynamic.dg.uym.emc(((String) arrayList.get(i11)).substring(0, 7));
            }
    ...
    private void emc(double d10, final View view) {
        if (d10 > 0.0d) {
    ...
    public void emc(ViewGroup viewGroup) {
        ...
        for (int i10 = 0; i10 < viewGroup.getChildCount(); i10++) {
            if (viewGroup.getChildAt(i10) instanceof com.bytedance.sdk.component.adexpress.dynamic.xq.zz) {
