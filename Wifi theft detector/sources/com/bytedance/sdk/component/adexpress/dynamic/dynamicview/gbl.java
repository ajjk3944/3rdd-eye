...
public class gbl extends ycc {
    ...
    public gbl(Context context, @NonNull DynamicRootView dynamicRootView, @NonNull com.bytedance.sdk.component.adexpress.dynamic.dg.msw mswVar) {
        ...
        if ("arrowButton".equals(mswVar.ru().ypw())) {
            if (this.sup.ypw() > 0 || this.sup.emc() > 0) {
                ...
                this.zz = (int) (this.zz + com.bytedance.sdk.component.adexpress.dg.uym.emc(context, this.sup.ypw() + (this.sup.emc() / 2) + 0.5f));
            } else {
    ...
    public boolean zz() {
        ...
        if ("user".equals(strXq)) {
            ...
            int i10 = this.uym;
            imageView.setPadding(i10 / 10, this.msw / 5, i10 / 10, 0);
