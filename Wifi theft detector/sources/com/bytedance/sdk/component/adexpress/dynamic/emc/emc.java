...
public class emc implements dg<DynamicRootView>, gbl {
    ...
    public class RunnableC0108emc implements Runnable {
        private int ypw;

        public RunnableC0108emc(int i10) {
            this.ypw = i10;
        }
    ...
    public emc(Context context, ThemeStatusBroadcastReceiver themeStatusBroadcastReceiver, boolean z10, com.bytedance.sdk.component.adexpress.dynamic.bw.msw mswVar, sz szVar, com.bytedance.sdk.component.adexpress.dynamic.ycc.emc emcVar) {
        this.xq = context;
        DynamicRootView dynamicRootView = new DynamicRootView(context, themeStatusBroadcastReceiver, z10, szVar, emcVar);
    ...
    public void ycc() {
        ...
        int i10 = this.ypw instanceof com.bytedance.sdk.component.adexpress.dynamic.bw.uym ? 123 : 113;
        DynamicRootView dynamicRootView = this.emc;
                ...
                if (mswVar2.uym() > mswVar.uym() - mswVar2.zz() || (listGbl = mswVar2.gbl()) == null || listGbl.size() <= 0) {
                    ...
                    for (com.bytedance.sdk.component.adexpress.dynamic.dg.msw mswVar3 : listGbl) {
                        if (mswVar3.ru().ypw().equals("logo-union")) {
                            fYcc = mswVar3.ru().ycc();
                            fUym = (((-fYcc) + mswVar.uym()) - mswVar2.uym()) + mswVar2.ru().bw().nx();
                        }
                    }
                }
                ypw(mswVar2);
    ...
    public void emc(uym uymVar) {
        ...
        this.uym = com.bytedance.sdk.component.adexpress.dg.dg.emc(new RunnableC0108emc(2), iYcc, TimeUnit.MILLISECONDS);
    ...
    public void xq(com.bytedance.sdk.component.adexpress.dynamic.dg.msw mswVar) {
        ...
        try {
            ...
            int i10 = this.ypw instanceof com.bytedance.sdk.component.adexpress.dynamic.bw.uym ? 128 : 118;
            this.emc.callBackRenderFail(i10, "exception is " + e10.getMessage());
        }
    }
    ...
    @Override // com.bytedance.sdk.component.adexpress.ypw.gbl
    public void emc(View view, int i10, xq xqVar) {
        msw mswVar = this.bw;
        if (mswVar != null) {
