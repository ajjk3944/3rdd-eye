...
public class cf implements uym<com.bytedance.sdk.component.adexpress.ycc.yzg> {
    ...
    public cf(Context context, com.bytedance.sdk.component.adexpress.dynamic.dynamicview.bw bwVar, com.bytedance.sdk.component.adexpress.dynamic.dg.uym uymVar, String str, int i10, int i11, int i12, JSONObject jSONObject) {
        this.ypw = context;
        this.xq = bwVar;
        this.dg = uymVar;
        this.bw = str;
