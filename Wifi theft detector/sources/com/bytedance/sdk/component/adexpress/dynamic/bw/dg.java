...
public class dg {
    public static JSONObject emc(JSONObject jSONObject, JSONObject jSONObject2) throws JSONException {
        ...
        try {
            ...
            while (itKeys.hasNext()) {
                ...
                if (objOpt2 == null || objOpt2 == JSONObject.NULL) {
                    ...
                    jSONObject3.put(next, emc((JSONObject) objOpt, (JSONObject) objOpt2));
                } else if ((objOpt instanceof JSONArray) && (objOpt2 instanceof JSONArray)) {
                    jSONObject3.put(next, emc((JSONArray) objOpt, (JSONArray) objOpt2));
                } else {
    ...
    private static JSONArray emc(JSONArray jSONArray, JSONArray jSONArray2) throws JSONException {
            ...
            try {
                ...
                if (objOpt2 != null && objOpt2 != JSONObject.NULL) {
                    if ((objOpt instanceof JSONObject) && (objOpt2 instanceof JSONObject)) {
                        jSONArray3.put(i10, emc((JSONObject) objOpt, (JSONObject) objOpt2));
                    } else if ((objOpt instanceof JSONArray) && (objOpt2 instanceof JSONArray)) {
                        jSONArray3.put(i10, emc((JSONArray) objOpt, (JSONArray) objOpt2));
                    } else {
