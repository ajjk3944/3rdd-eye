...
public class ycc {
    ...
    private void ypw(com.bytedance.sdk.component.adexpress.dynamic.dg.msw mswVar) {
        ...
        if (TextUtils.isEmpty(strValueOf) || (objEmc2 = this.xq.emc(CampaignEx.JSON_KEY_TITLE)) == null) {
            return;
        }
        ...
        if (TextUtils.isEmpty(strValueOf3) || (objEmc4 = this.xq.emc(RewardPlus.ICON)) == null) {
            return;
        }
        ...
        mswVar.emc(CampaignEx.JSON_KEY_TITLE, strValueOf2);
        mswVar.emc("description", strValueOf3);
        mswVar.emc(RewardPlus.ICON, strValueOf4);
        mswVar.emc("app_name", strValueOf5);
        mswVar.emc(true);
    }

    public com.bytedance.sdk.component.adexpress.dynamic.dg.msw emc(double d10, int i10, double d11, String str, sz szVar) throws JSONException {
        ...
        emc(mswVarEmc);
        bw bwVar = new bw(d10, i10, d11, str, szVar);
        ...
        for (int i10 = 0; i10 < jSONArrayOptJSONArray.length(); i10++) {
            ...
            if (jSONArrayOptJSONArray2 != null) {
                ...
                for (int i11 = 0; i11 < length; i11++) {
                    com.bytedance.sdk.component.adexpress.dynamic.dg.msw mswVarEmc2 = emc(jSONArrayOptJSONArray2.optJSONObject(i11), mswVarEmc);
    ...
    private void emc(com.bytedance.sdk.component.adexpress.dynamic.dg.bw bwVar, int i10) throws JSONException {
        int iLastIndexOf;
