...
public class lt extends ycc {
    ...
    public void emc() {
        ...
        boolean z10 = i10 + 1 >= getChildCount() || ((ViewGroup) getChildAt(this.ul + 1)).getChildCount() <= 0;
        if (this.sz.ru().bw().emc() || !z10) {
            View childAt3 = z10 ? getChildAt((this.ul + 2) % getChildCount()) : getChildAt((this.ul + 1) % getChildCount());
            this.emc = ObjectAnimator.ofFloat(childAt2, "translationY", 0.0f, (-(this.msw + getChildAt(this.ul).getHeight())) / 2);
            if (z10) {
                this.ul++;
            }
            childAt = childAt3;
        ...
        if (this.ylm) {
            this.ypw = ObjectAnimator.ofFloat(childAt, "translationY", (-(this.msw + childAt.getHeight())) / 2, 0.0f);
        } else {
            this.ypw = ObjectAnimator.ofFloat(childAt, "translationY", (this.msw + childAt.getHeight()) / 2, 0.0f);
        }
