...
public class gbl extends dg {
    ...
    public List<ObjectAnimator> emc() {
        ...
        ObjectAnimator duration = ObjectAnimator.ofFloat(this.xq, "scaleX", fGbl, f11).setDuration((int) (this.ypw.ru() * 1000.0d));
        ObjectAnimator duration2 = ObjectAnimator.ofFloat(this.xq, "scaleY", fSup, f10).setDuration((int) (this.ypw.ru() * 1000.0d));
