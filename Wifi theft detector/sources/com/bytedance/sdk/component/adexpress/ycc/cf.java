    ...
    public cf(@NonNull Context context) {
        ...
        post(new Runnable() { // from class: com.bytedance.sdk.component.adexpress.ycc.cf.1
            ...
            public void run() {
                ...
                layoutParams.bottomMargin = (int) (((-cf.this.xq.getMeasuredHeight()) / 2.0f) + com.bytedance.sdk.component.adexpress.dg.uym.emc(cf.this.getContext(), 5.0f));
                layoutParams.rightMargin = (int) (((-cf.this.xq.getMeasuredWidth()) / 2.0f) + com.bytedance.sdk.component.adexpress.dg.uym.emc(cf.this.getContext(), 5.0f));
