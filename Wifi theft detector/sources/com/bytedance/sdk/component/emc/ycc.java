...
class ycc {
    ...
    public static final class emc {
        ...
        private emc(boolean z10, String str) {
            this.emc = z10;
            this.ypw = str;
        }
    }
    ...
    public emc emc(qh qhVar, bw bwVar) throws Exception {
    ...
    private emc emc(qh qhVar, dg dgVar, bw bwVar) throws Exception {
        return new emc(true, yzg.emc(this.emc.emc((uym) dgVar.emc(qhVar.dg, emc(qhVar.bw, (ypw) dgVar), bwVar)), dgVar.ypw()));
    }

    private emc emc(final qh qhVar, final xq xqVar, bw bwVar) throws Exception {
        this.ycc.add(xqVar);
    ...
    private Object emc(String str, ypw ypwVar) throws JSONException {
