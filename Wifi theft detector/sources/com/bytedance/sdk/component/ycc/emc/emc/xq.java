...
public class xq implements dg {
    ...
    public List<com.bytedance.sdk.component.ycc.emc.dg.emc> ypw(com.bytedance.sdk.component.ycc.emc.dg.emc emcVar, int i10) {
        if (emcVar.dg() == 0 && emcVar.bw() == 1 && com.bytedance.sdk.component.ycc.emc.ypw.emc.emc()) {
            if (this.uym.ypw() <= i10) {
                return null;
            }
            List<com.bytedance.sdk.component.ycc.emc.dg.emc> listEmc = this.emc.emc(this.uym.ypw() - i10, "_id");
        ...
        if (emcVar.dg() == 3 && emcVar.bw() == 2 && com.bytedance.sdk.component.ycc.emc.ypw.emc.bw()) {
            if (this.zz.ypw() > i10) {
                return this.xq.emc(this.zz.ypw() - i10, "_id");
            }
        } else if (emcVar.dg() == 0 && emcVar.bw() == 2 && com.bytedance.sdk.component.ycc.emc.ypw.emc.ypw()) {
            if (this.msw.ypw() > i10) {
                List<com.bytedance.sdk.component.ycc.emc.dg.emc> listEmc2 = this.ypw.emc(this.msw.ypw() - i10, "_id");
            ...
            if (this.ru.ypw() > i10) {
                List<com.bytedance.sdk.component.ycc.emc.dg.emc> listEmc3 = this.dg.emc(this.ru.ypw() - i10, "_id");
            ...
            if (this.gbl.ypw() > i10) {
                List<com.bytedance.sdk.component.ycc.emc.dg.emc> listEmc4 = this.bw.emc(this.gbl.ypw() - i10, "_id");
        ...
        } else if (emcVar.dg() == 2 && emcVar.bw() == 3 && com.bytedance.sdk.component.ycc.emc.ypw.emc.ycc() && this.sup.ypw() > i10) {
            return this.ycc.emc(this.sup.ypw() - i10, "_id");
        }
        return null;
    }
    ...
    public boolean emc(int i10, boolean z10) {
        ...
        if (com.bytedance.sdk.component.ycc.emc.ypw.emc.emc() && (dgVar = this.emc) != null && dgVar.emc(i10)) {
            com.bytedance.sdk.component.ycc.emc.xq.ypw.emc(com.bytedance.sdk.component.ycc.emc.ypw.dg.dg.qh(), 1);
            return true;
        }
        if (com.bytedance.sdk.component.ycc.emc.ypw.emc.bw() && (ypwVar = this.xq) != null && ypwVar.emc(i10)) {
            return true;
        }
        if (com.bytedance.sdk.component.ycc.emc.ypw.emc.ypw() && (emcVar = this.ypw) != null && emcVar.emc(i10)) {
            com.bytedance.sdk.component.ycc.emc.xq.ypw.emc(com.bytedance.sdk.component.ycc.emc.ypw.dg.dg.cf(), 1);
            return true;
        }
        if (com.bytedance.sdk.component.ycc.emc.ypw.emc.xq() && (uymVar = this.dg) != null && uymVar.emc(i10)) {
            com.bytedance.sdk.component.ycc.emc.xq.ypw.emc(com.bytedance.sdk.component.ycc.emc.ypw.dg.dg.vk(), 1);
            return true;
        }
        if (!com.bytedance.sdk.component.ycc.emc.ypw.emc.dg() || (yccVar = this.bw) == null || !yccVar.emc(i10)) {
            return com.bytedance.sdk.component.ycc.emc.ypw.emc.ycc() && (bwVar = this.ycc) != null && bwVar.emc(i10);
        }
