...
public class xq extends HandlerThread implements Handler.Callback {
    ...
    public xq(PriorityBlockingQueue<com.bytedance.sdk.component.ycc.emc.dg.emc> priorityBlockingQueue) {
        ...
        this.sba = ChunkedTrackBlacklistUtil.DEFAULT_TRACK_BLACKLIST_MS;
        this.ul = 1;
        this.ylm = 2;
        this.sra = 3;
    ...
    public static void ypw(int i10) {
        yzg = i10;
    }
    ...
    public void xq(int i10) {
        try {
            boolean zEmc = emc(i10, com.bytedance.sdk.component.ycc.emc.ypw.dg.emc.ypw);
            if (i10 != 6 && !zEmc) {
                return;
            }
    ...
    public boolean emc(int i10, boolean z10) {
        ...
        return this.emc.emc(i10, z10);
    }

    public void emc(com.bytedance.sdk.component.ycc.emc.dg.emc emcVar, boolean z10) {
        if (emcVar == null) {
            return;
        }
        emcVar.dg();
    ...
    private void emc(com.bytedance.sdk.component.ycc.emc.dg.emc emcVar, int i10) throws JSONException {
        this.zz.set(0);
        if (i10 == 0) {
    ...
    private void ypw(List<com.bytedance.sdk.component.ycc.emc.dg.emc> list) {
        ...
        if (bwVarVk != null && bwVarVk.sup() != null) {
            f9239aa = bwVarVk.sup().ypw();
        }
        if (this.qh.size() >= f9239aa) {
            if (this.sz.hasMessages(11)) {
    ...
    private void ypw(List<com.bytedance.sdk.component.ycc.emc.dg.emc> list, final boolean z10, final long j10) {
                        ...
                        public void emc(List<emc> list2) {
                            try {
                                ...
                                for (int i10 = 0; i10 < size; i10++) {
                                    emc emcVar = list2.get(i10);
                                    if (emcVar != null) {
                                        xq.this.emc(z10, emcVar.emc(), emcVar.ypw(), j10);
                                    }
                                }
    ...
    private void emc(List<com.bytedance.sdk.component.ycc.emc.dg.emc> list, boolean z10, String str) {
        ...
        this.dg = xqVarMsw;
        if (xqVarMsw != null) {
            ypw(list, z10, jCurrentTimeMillis);
        } else {
            emc(list, z10, jCurrentTimeMillis);
        }
    }

    private void emc(final List<com.bytedance.sdk.component.ycc.emc.dg.emc> list, final boolean z10, final long j10) {
        bw bwVarVk = msw.uym().vk();
        if (bwVarVk != null) {
            ...
            executorBw.execute(new com.bytedance.sdk.component.ycc.emc.bw.bw("csj_log_upload") { // from class: com.bytedance.sdk.component.ycc.emc.ypw.xq.xq.1
                ...
                public void run() {
                    xq xqVar = xq.this;
                    xqVar.emc((List<com.bytedance.sdk.component.ycc.emc.dg.emc>) list, z10, j10, xqVar.ycc);
                }
            });
        }
    }
    ...
    public void emc(List<com.bytedance.sdk.component.ycc.emc.dg.emc> list, boolean z10, long j10, int i10) {
        xq xqVar;
        Throwable th;
        ypw ypwVarEmc;
        ypw ypwVar;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void emc(boolean z10, ypw ypwVar, List<com.bytedance.sdk.component.ycc.emc.dg.emc> list, long j10) {
        if (z10 || ypwVar == null) {
            return;
        }
        int i10 = ypwVar.ypw;
        ...
        if (ypwVar.emc || ((i10 < 500 || i10 >= 509) && i10 <= 513)) {
            i11 = i10;
        }
        if (list != null) {
            list.size();
    ...
    */
    ...
    public void emc(int i10, long j10) {
        ...
        if (i10 == 2) {
            this.sz.sendMessageDelayed(messageObtain, (((this.cf.incrementAndGet() - 1) % 4) + 1) * j10);
        } else if (i10 == 3) {
            this.sz.sendMessageDelayed(messageObtain, (((this.vk.incrementAndGet() - 1) % 4) + 1) * j10);
        }
    }
}
