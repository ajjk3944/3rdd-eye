...
public class xq implements ypw {
        ...
        public void run() {
            ...
            try {
                ...
                if (bwVarVk.emc(xq.this.emc())) {
                    ...
                    xqVarRu.emc(Command.HTTP_HEADER_USER_AGENT, bwVarVk.zz());
                    ...
                    if (dgVarEmc != null && dgVarEmc.emc()) {
                        xq.this.ypw.xq(this.ypw);
                        this.ypw.ypw();
                        bwVarVk.emc(true, 200, System.currentTimeMillis() - jCurrentTimeMillis, this.ypw);
                        return;
                    }
                    if (dgVarEmc != null) {
    ...
    public void emc(String str, List<String> list, boolean z10, Map<String, String> map, int i10, String str2) {
        com.bytedance.sdk.component.ycc.emc.bw bwVarVk = msw.uym().vk();
        ...
        while (it.hasNext()) {
            bwVarVk.dg().execute(new emc(new dg(UUID.randomUUID().toString() + "_" + System.currentTimeMillis(), it.next(), z10, i10, str2), str, map));
        }
    }
    ...
    public void emc(final String str, final boolean z10) {
        ...
        com.bytedance.sdk.component.ycc.emc.bw.bw bwVar = new com.bytedance.sdk.component.ycc.emc.bw.bw("trackFailedUrls") { // from class: com.bytedance.sdk.component.ycc.emc.ycc.xq.2
            @Override // java.lang.Runnable
            public void run() {
                xq.this.emc(xq.this.ypw.emc(), str, z10);
            }
        };
        bwVar.emc(1);
        if (bwVarVk.dg() != null) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void emc(List<dg> list, String str, boolean z10) {
        String str2;
