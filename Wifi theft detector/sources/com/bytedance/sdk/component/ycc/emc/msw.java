...
public class msw {
    ...
    public long aa() {
        return this.cf * SignalManager.TWENTY_FOUR_HOURS_MILLIS;
    }
    ...
    public void emc(String str, boolean z10) {
        com.bytedance.sdk.component.ycc.emc.ycc.emc.emc().emc(str, z10);
    }

    public void emc(String str, List<String> list, boolean z10, Map<String, String> map, int i10, String str2) {
        com.bytedance.sdk.component.ycc.emc.ycc.emc.emc().emc(str, list, z10, map, i10, str2);
    }
