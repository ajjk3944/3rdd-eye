...
public class dg {
    ...
    public void emc(final String str, final List<String> list, final boolean z10, Map<String, String> map, final int i10, final String str2) {
        final bw bwVarVk = msw.uym().vk();
        ...
        if (msw.uym().ypw() && !emc(msw.uym().ycc(), bwVarVk)) {
            if (xq()) {
                bwVarVk.dg().execute(new com.bytedance.sdk.component.ycc.emc.bw.bw("trackFailed") { // from class: com.bytedance.sdk.component.ycc.emc.dg.5
                    @Override // java.lang.Runnable
                    public void run() {
                        dg.this.emc(str, (List<String>) list, z10, bwVarVk.ycc(), i10, str2);
                    }
                });
                return;
            } else {
                emc(str, list, z10, bwVarVk.ycc(), i10, str2);
                return;
            }
        }
        msw.uym().emc(str, list, z10, map, i10, str2);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void emc(String str, List<String> list, boolean z10, int i10, int i11, String str2) {
        if (i10 == 0) {
            com.bytedance.sdk.component.ycc.emc.ypw.ypw.emc.emc(str, list, z10);
        } else if (i10 == 1) {
            com.bytedance.sdk.component.ycc.emc.ypw.ypw.ypw.emc(str, list, z10, i11, str2);
        }
    }
        ...
        if (msw.uym().ypw() && !emc(msw.uym().ycc(), bwVarVk)) {
            if (xq()) {
                bwVarVk.dg().execute(new com.bytedance.sdk.component.ycc.emc.bw.bw("trackFailed") { // from class: com.bytedance.sdk.component.ycc.emc.dg.6
                    @Override // java.lang.Runnable
                    public void run() {
                        dg.this.emc(str, bwVarVk.ycc(), z10);
                    }
                });
                return;
            } else {
                emc(str, bwVarVk.ycc(), z10);
                return;
            }
        }
        msw.uym().emc(str, z10);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void emc(String str, int i10, boolean z10) {
        if (i10 == 0) {
            com.bytedance.sdk.component.ycc.emc.ypw.ypw.emc.emc(str);
        } else if (i10 == 1) {
            com.bytedance.sdk.component.ycc.emc.ypw.ypw.ypw.emc(str, z10);
        }
    }
}
