...
public class emc extends xq {
    ...
    public List<com.bytedance.sdk.component.ycc.emc.dg.emc> emc(int i10, String str) {
        ...
        if (com.bytedance.sdk.component.ycc.emc.xq.emc.dg() && dg() == 3) {
            str3 = "id";
            b10 = 3;
            cursorEmc = com.bytedance.sdk.component.ycc.emc.emc.emc.xq.emc(bw(), ypw(), new String[]{"id", AppMeasurementSdk.ConditionalUserProperty.VALUE, "encrypt", "channel"}, str2, strArr, null, null, str4);
        } else {
            str3 = "id";
            b10 = 3;
            cursorEmc = com.bytedance.sdk.component.ycc.emc.emc.emc.xq.emc(bw(), ypw(), new String[]{str3, AppMeasurementSdk.ConditionalUserProperty.VALUE, "encrypt"}, str2, strArr, null, null, str4);
        }
            ...
            try {
                ...
                while (cursor.moveToNext()) {
                    try {
                        ...
                        int i12 = (com.bytedance.sdk.component.ycc.emc.xq.emc.dg() && dg() == b10) ? cursor.getInt(cursor.getColumnIndex("channel")) : 0;
                        if (i11 == 1) {
                            try {
                        ...
                        if (TextUtils.isEmpty(string2)) {
                            ...
                            emcVar.emc(dg());
                            emcVar.ypw(xq());
                            if (com.bytedance.sdk.component.ycc.emc.xq.emc.dg() && dg() == b10) {
                                emcVar.emc(i12);
                            }
    ...
    private void ypw(int i10, long j10) {
        if (j10 > 0 || i10 > 0) {
            com.bytedance.sdk.component.ycc.emc.emc.emc.xq.emc(bw(), ypw(), "gen_time <? OR retry >?", new String[]{String.valueOf(System.currentTimeMillis() - j10), String.valueOf(i10)});
            ypw();
        }
    }
    ...
    public boolean emc(int i10) {
        ...
        ypw();
        return (com.bytedance.sdk.component.ycc.emc.xq.emc.xq() && (i10 == 1 || i10 == 2)) ? iEmc > 0 : iEmc >= iEmc2;
    }
