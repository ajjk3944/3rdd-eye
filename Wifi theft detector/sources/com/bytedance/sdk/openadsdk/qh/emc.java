...
public class emc {
    ...
    public emc() {
        ...
        this.ypw = new Handler(Looper.getMainLooper(), new Handler.Callback() { // from class: com.bytedance.sdk.openadsdk.qh.emc.1
            ...
            public boolean handleMessage(@NonNull Message message) {
                ...
                if (emc.this.bw == null || (softReference = (SoftReference) emc.this.bw.get(Integer.valueOf(i10))) == null) {
                    return false;
                }
                ycc yccVar = (ycc) softReference.get();
                emc.this.emc(i10, 2, new rie(), yccVar == null ? "" : yccVar.getTag());
                return false;
            }
        });
    }
    ...
    public void emc(final int i10, final rie rieVar, final String str, final boolean z10) {
        iyl.emc(new Runnable() { // from class: com.bytedance.sdk.openadsdk.qh.emc.3
            private bw emc(@NonNull final ycc yccVar, sz szVar) {
                bw bwVar = new bw(aa.emc(), null, rieVar.ye(), szVar, true) { // from class: com.bytedance.sdk.openadsdk.qh.emc.3.3
                    ...
                    public void onReceivedError(WebView webView, int i11, String str2, String str3) {
                        ...
                        boolean z11 = false;
                        boolean z12 = strDg != null && strDg.startsWith("image");
                        if (strDg != null && strDg.startsWith("mp4")) {
                            z11 = true;
                        }
                        if (!z12 && !z11 && !yccVar.xq()) {
                            AnonymousClass3 anonymousClass3 = AnonymousClass3.this;
                            emc.this.emc(i10, 4, rieVar, str);
                        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void emc(int i10, int i11, rie rieVar, String str) {
        LinkedHashMap<Integer, SoftReference<ycc>> linkedHashMap = this.bw;
        if (linkedHashMap != null && linkedHashMap.containsKey(Integer.valueOf(i10))) {
            this.bw.remove(Integer.valueOf(i10));
        }
    ...
    public static void emc(rie rieVar, String str, final float f10, String str2) {
    ...
    public static void emc(rie rieVar, final String str, final int i10) {
