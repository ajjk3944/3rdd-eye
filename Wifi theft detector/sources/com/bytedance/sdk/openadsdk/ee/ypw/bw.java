...
public class bw {
    ...
    private static ypw emc(View view, rie rieVar, boolean z10, emc emcVar) {
        ...
        ypw ypwVarEmc = ypw.emc(z10, numYpw, view, rieVar, emcVar);
    ...
    public static void emc(rie rieVar, int i10) {
        ...
        emc(emc.get(ypw(rieVar)), i10);
    }

    public static void emc(ypw ypwVar, int i10) {
        if (ypwVar == null) {
            return;
        }
        ypwVar.emc(i10);
