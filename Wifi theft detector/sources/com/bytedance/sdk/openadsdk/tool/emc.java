    ...
    public static List<FilterWord> emc(String str) {
        ...
        try {
            ...
            for (int i10 = 0; i10 < jSONArray.length(); i10++) {
                FilterWord filterWordEmc = emc(jSONArray.optJSONObject(i10));
            ...
            ul.xq("MaterialMetaTools", e10.getMessage());
            return arrayList;
        }
    }
        ...
        try {
            ...
            if (jSONArrayOptJSONArray != null && jSONArrayOptJSONArray.length() > 0) {
                for (int i10 = 0; i10 < jSONArrayOptJSONArray.length(); i10++) {
                    FilterWord filterWordEmc = emc(jSONArrayOptJSONArray.optJSONObject(i10));
                    if (filterWordEmc != null && filterWordEmc.isValid()) {
