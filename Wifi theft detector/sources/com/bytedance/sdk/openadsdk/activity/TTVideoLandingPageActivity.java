...
public abstract class TTVideoLandingPageActivity extends TTBaseLandingPageActivity implements com.bytedance.sdk.openadsdk.gbl.dg {
    ...
    private final b.d ndl = new b.d() { // from class: com.bytedance.sdk.openadsdk.activity.TTVideoLandingPageActivity.11
        @Override // s2.b.d
        public void emc(boolean z10) {
            TTVideoLandingPageActivity tTVideoLandingPageActivity = TTVideoLandingPageActivity.this;
            tTVideoLandingPageActivity.xmt = z10;
            ...
            if (!z10) {
                ...
                marginLayoutParams.topMargin = tTVideoLandingPageActivity2.f9250aa;
            ...
            tTVideoLandingPageActivity3.f9250aa = marginLayoutParams2.topMargin;
    ...
    private final sb.emc hj = new sb.emc() { // from class: com.bytedance.sdk.openadsdk.activity.TTVideoLandingPageActivity.2
        ...
        public void emc(Context context, Intent intent, boolean z10, final int i10) {
        ...
        public void emc(int i10) throws JSONException {
            com.bytedance.sdk.component.zz.ycc yccVar;
            String str;
            TTVideoLandingPageActivity tTVideoLandingPageActivity = TTVideoLandingPageActivity.this;
            if (tTVideoLandingPageActivity.mxo == 0 && i10 != 0 && (yccVar = tTVideoLandingPageActivity.emc) != null && (str = tTVideoLandingPageActivity.iyl) != null) {
                yccVar.a_(str);
            }
            ...
            if (yccVar2 != null && yccVar2.getNativeVideoController() != null) {
                TTVideoLandingPageActivity tTVideoLandingPageActivity2 = TTVideoLandingPageActivity.this;
                if (!tTVideoLandingPageActivity2.cuf && tTVideoLandingPageActivity2.mxo != i10) {
                    tTVideoLandingPageActivity2.qh.getNativeVideoController().xq(i10);
                }
            }
            TTVideoLandingPageActivity.this.mxo = i10;
        }
    };
    ...
    public static class emc extends AsyncTask<Void, Void, Drawable> {
        ...
        private final WeakReference<s2.c> ypw;
        ...
        private emc(Bitmap bitmap, s2.c cVar) {
            this.emc = bitmap;
            this.ypw = new WeakReference<>(cVar);
        }

        @Override // android.os.AsyncTask
        /* renamed from: emc, reason: merged with bridge method [inline-methods] */
        public void onPostExecute(Drawable drawable) {
            WeakReference<s2.c> weakReference;
            ...
            if (this.emc != null) {
                ...
                sz szVarYpw = new sz(this.vk, this.emc.getWebView(), new sup() { // from class: com.bytedance.sdk.openadsdk.activity.TTVideoLandingPageActivity.1
                    ...
                    public void emc(int i10) {
                        xq.emc.emc(TTVideoLandingPageActivity.this.wd, TTVideoLandingPageActivity.this.but.get(), TTVideoLandingPageActivity.this.wad.get(), TTVideoLandingPageActivity.this.rqm.get() - TTVideoLandingPageActivity.this.wad.get(), TTVideoLandingPageActivity.this.vk, "landingpage_split_screen", i10);
                    }
                }, this.ffd).ypw(true);
                this.vw = szVarYpw;
    ...
    public void ycc() {
        if (uym()) {
            try {
                ...
                ul.xq("TTVideoLandingPage", e10.getMessage());
                if (this.qh == null) {
    ...
    private void emc(s2.b bVar) {
        this.cuf = this.cuf || bVar.sz();
        ...
        com.bytedance.sdk.openadsdk.multipro.dg.emc.emc("sp_multi_native_video_data", "key_video_current_play_position", Long.valueOf(bVar.ycc()));
        com.bytedance.sdk.openadsdk.multipro.dg.emc.emc("sp_multi_native_video_data", "key_video_total_play_duration", Long.valueOf(bVar.zz() + bVar.uym()));
        com.bytedance.sdk.openadsdk.multipro.dg.emc.emc("sp_multi_native_video_data", "key_video_duration", Long.valueOf(bVar.zz()));
    }
    ...
    private void emc(final int i10) {
        ...
        iyl.emc(new Runnable() { // from class: com.bytedance.sdk.openadsdk.activity.TTVideoLandingPageActivity.3
            @Override // java.lang.Runnable
            public void run() {
                vw.emc((View) TTVideoLandingPageActivity.this.xq, i10);
            }
        });
    }

    @Override // com.bytedance.sdk.openadsdk.gbl.dg
    public void emc(boolean z10, JSONArray jSONArray) {
