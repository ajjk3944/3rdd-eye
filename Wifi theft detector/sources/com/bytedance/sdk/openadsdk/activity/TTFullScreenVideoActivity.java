...
public class TTFullScreenVideoActivity extends TTBaseVideoActivity {
    ...
    private com.bytedance.sdk.openadsdk.emc.xq.ypw f9246aa;
    private boolean yzg;

    private void dg(int i10) {
        this.ypw.cuf.emc(null, String.format(rie.emc(aa.emc(), "tt_skip_ad_time_text"), Integer.valueOf(i10)));
    }
    ...
    public void mxo() {
        ...
        com.bytedance.sdk.openadsdk.emc.xq.ypw ypwVar = this.f9246aa;
        if (ypwVar != null) {
            ypwVar.onAdClicked();
        }
    }
    ...
    public void onCreate(@Nullable Bundle bundle) {
        ...
        com.bykv.vk.openvk.emc.emc.emc.xq.b bVarIat = this.ypw.ypw.iat();
        if (bVarIat == null) {
            com.bykv.vk.openvk.emc.emc.emc.xq.b bVar = new com.bykv.vk.openvk.emc.emc.emc.xq.b();
            bVar.j(10.0d);
            this.ypw.ypw.emc(bVar);
        } else if (bVarIat.E() <= 0.0d) {
            bVarIat.j(10.0d);
        }
    }
    ...
    public void rie() {
            ...
            View.OnClickListener onClickListener = new View.OnClickListener() { // from class: com.bytedance.sdk.openadsdk.activity.TTFullScreenVideoActivity.3
                ...
                public void onClick(View view) {
                    if (TTFullScreenVideoActivity.this.ypw.xmt.ul() && TTFullScreenVideoActivity.this.ypw.zz.get()) {
                        ...
                        TTFullScreenVideoActivity.this.ypw.ra.sendEmptyMessageDelayed(Sdk$SDKError.Reason.NATIVE_ASSET_ERROR_VALUE, 5000L);
        ...
        this.ypw.cuf.emc(new com.bytedance.sdk.openadsdk.component.reward.top.ypw() { // from class: com.bytedance.sdk.openadsdk.activity.TTFullScreenVideoActivity.4
            ...
            public void emc(View view, String str) {
                ...
                boolean z10 = !emcVar.yz;
                emcVar.yz = z10;
                emcVar.ylm.emc(z10, str);
    ...
    */
    ...
    public void emc(Bundle bundle) {
        if (this.sz) {
            super.emc(bundle);
            this.f9246aa = (com.bytedance.sdk.openadsdk.emc.xq.ypw) sf.emc().emc(this.ru, com.bytedance.sdk.openadsdk.emc.xq.ypw.class);
            return;
        }
        if (!com.bytedance.sdk.openadsdk.multipro.ypw.xq()) {
            this.f9246aa = sf.emc().xq();
        }
        if (this.f9246aa != null || bundle == null) {
            return;
        }
        this.f9246aa = sba;
        sba = null;
    ...
    public void emc(long j10, long j11) {
        ...
        int i10 = this.ycc;
        if (i10 >= 0) {
            this.ypw.cuf.emc(String.valueOf(i10), null);
        }
    }
