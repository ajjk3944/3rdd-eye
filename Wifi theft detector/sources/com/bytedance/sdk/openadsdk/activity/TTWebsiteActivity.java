...
public class TTWebsiteActivity extends TTBaseActivity {
    ...
    private void ypw(final rie rieVar, final String str, String str2, String str3, String str4) {
        ...
        try {
            ...
            this.vk = imageView2;
            if (imageView2 != null) {
                imageView2.setOnClickListener(new View.OnClickListener() { // from class: com.bytedance.sdk.openadsdk.activity.g
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view) {
                        this.f9253a.emc(view);
                    }
                });
            }
            ImageView imageView3 = (ImageView) viewDg.findViewById(520093740);
            this.f9251aa = imageView3;
            if (imageView3 != null) {
                imageView3.setOnClickListener(new View.OnClickListener() { // from class: com.bytedance.sdk.openadsdk.activity.h
                    @Override // android.view.View.OnClickListener
                    public final void onClick(View view) {
                        this.f9254a.emc(yccVar2, str, rieVar, view);
                    }
                });
            }
            try {
                ...
                if (!TextUtils.isEmpty(str2)) {
                    ...
                    if (this.ypw.contains("?")) {
                        this.ypw += "&gdid_encrypted=" + strEncode;
                    } else {
                        this.ypw += "?gdid_encrypted=" + strEncode;
                    }
                }
                ...
                this.dg.setWebViewClient(new ycc.emc() { // from class: com.bytedance.sdk.openadsdk.activity.TTWebsiteActivity.2
                    ...
                    public void onReceivedError(WebView webView2, int i10, String str5, String str6) {
                        super.onReceivedError(webView2, i10, str5, str6);
                    }
                });
                ...
                ul.emc("TTAD.TTWebsiteActivity", "onCreate: ", e10);
                finish();
            }
        } catch (Throwable unused3) {
            finish();
