...
public class TTDelegateActivity extends TTBaseActivity {
    private static final Map<String, uym.emc> dg = Collections.synchronizedMap(new HashMap());
    rie emc = null;
    private dr xq;
    private Intent ypw;
    ...
    private void bw() {
        ...
        String strEmc;
        String stringExtra;
        int intExtra = this.ypw.getIntExtra(HandleInvocationsFromAdViewer.KEY_AD_TYPE, 0);
        if (intExtra != 1) {
            if (intExtra != 6) {
                finish();
                return;
    ...
    public static void emc(rie rieVar, String str, uym.emc emcVar) {
        ...
        intent.putExtra(HandleInvocationsFromAdViewer.KEY_AD_TYPE, 6);
    ...
    private void emc(String str, String str2, final String str3, String str4, rie rieVar) {
        ...
        if (str2 == null || str == null || this.xq != null) {
            ...
            tTDelegateActivity.xq.emc(new dr.emc() { // from class: com.bytedance.sdk.openadsdk.activity.TTDelegateActivity.1
                ...
                public void emc(int i10, String str5) {
                    uym.emc emcVarBw;
