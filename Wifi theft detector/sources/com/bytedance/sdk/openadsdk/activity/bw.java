...
public class bw extends msw implements sf.emc {
    ...
    public bw(ypw ypwVar, rie rieVar, int i10, int i11, boolean z10, boolean z11, boolean z12) {
        super(ypwVar, rieVar, i10, i11, z11);
            ...
            View.OnClickListener onClickListener = new View.OnClickListener() { // from class: com.bytedance.sdk.openadsdk.activity.bw.1
                ...
                public void onClick(View view) {
                    if (bw.this.zz.xmt.ul()) {
                        ...
                        bw.this.zz.ra.sendEmptyMessageDelayed(Sdk$SDKError.Reason.NATIVE_ASSET_ERROR_VALUE, 5000L);
    ...
    public void xq(boolean z10) {
        ru ruVar;
        long j10 = this.cuf ? this.zz.hj : 0L;
        com.bytedance.sdk.openadsdk.component.reward.emc.emc emcVar = this.zz;
    ...
    private void emc(rie rieVar, Bundle bundle) {
        ...
        this.zz = emcVar;
        emcVar.bv = this.vk;
        boolean z10 = this.emc;
        emcVar.ipv = z10;
        emcVar.rgy = emcVar.wbn && !z10;
    ...
    public void emc(msw mswVar, msw mswVar2, ypw.bw bwVar) {
        ...
        boolean z10 = this.ru == mswVar2.ru + 1;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public boolean emc(final boolean z10, boolean z11, final Runnable runnable) {
        if (!this.zz.dg || this.uym.sup().getBoolean("reward_verify", false) || this.uym.vk()) {
            return false;
        }
        if (!z11 && this.uym.sup().getBoolean("user_has_give_up_reward", false)) {
            return false;
        }
        ...
        this.xq.sup.emc(new ypw.InterfaceC0165ypw() { // from class: com.bytedance.sdk.openadsdk.activity.bw.6
            @Override // com.bytedance.sdk.openadsdk.core.widget.ypw.InterfaceC0165ypw
            public void emc() {
                if (z10) {
                    bw.this.zz.rie.emc(1000);
                }
                ypwVar.dismiss();
                bw.this.zz.f9273aa.set(false);
            }
