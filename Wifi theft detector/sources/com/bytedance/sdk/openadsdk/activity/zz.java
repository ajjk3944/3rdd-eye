...
public class zz extends xq {
    ...
    private ypw.AbstractC0133ypw sz;
    ...
    private void dg(msw mswVar) {
        ...
        ypw.AbstractC0133ypw abstractC0133ypw = this.sz;
        if (abstractC0133ypw != null) {
            abstractC0133ypw.xq();
        }
    ...
    private void ylm() {
        ...
        if (this.uym.isEmpty() && !dr.xq(this.ypw)) {
            int i10 = iYpw + 1;
            this.uym.add(emc(this.dg, this.ypw, iYpw, i10, true));
            iYpw = i10;
        }
        emc(iYpw, zQh);
    }
  ...
  0x011e: PHI (r11v3 int) = (r11v2 int), (r11v4 int), (r11v2 int), (r11v2 int) binds: [B:28:0x00b7, B:42:0x0108, B:32:0x00c7, B:33:0x00c9] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    ...
    public bw qh() {
        ...
        msw mswVar = this.vk;
        int i10 = mswVar != null ? mswVar.ru : -1;
    ...
    public msw sz() {
        ...
        while (true) {
            i10++;
            if (i10 >= this.uym.size()) {
                return null;
            }
            msw mswVar2 = this.uym.get(i10);
    ...
    private static msw emc(ypw ypwVar, rie rieVar, int i10, int i11, boolean z10) {
        ...
        if (zZc) {
            return new uym(ypwVar, rieVar, i10, i11, z10);
        }
        return new ycc(ypwVar, rieVar, i10, i11, z10);
    }
    ...
    private void ypw(msw mswVar, msw mswVar2, ypw.bw bwVar) {
        ...
        boolean z10 = mswVar2 instanceof bw;
        if (z10 && !((bw) mswVar2).emc && !mswVar2.vk && (rieVar = mswVar2.ycc) != null && rieVar.tmx()) {
            this.sz.dg();
        } else {
            this.sz.emc(iYpw, mswVar2.ycc);
            boolean z11 = mswVar2 instanceof bw;
            if (z11 && ((bw) mswVar2).emc) {
                dg(mswVar);
            } else if (mswVar2.ycc.vcl()) {
                boolean z12 = false;
                boolean z13 = (mswVar2 instanceof emc) && com.bytedance.sdk.openadsdk.core.model.ul.bw(mswVar2.ycc);
                if (z11 && (mswVar2.vk || com.bytedance.sdk.openadsdk.core.model.ul.ycc(mswVar2.ycc))) {
                    z12 = true;
                }
                if (z13 || z12) {
                    this.sz.emc(mswVar2);
                ...
                this.sz.emc(mswVar2.ycc, mswVar2.f9258aa);
            } else if (z11) {
    ...
    public void emc(msw mswVar, msw mswVar2, ypw.bw bwVar) {
        ...
        if ((mswVar3 == null || mswVar3 == mswVar) && !com.bytedance.sdk.component.utils.ypw.emc(this.emc)) {
            ...
            if (mswVar2 == null) {
                msw mswVar4 = this.vk;
                int i10 = mswVar4 != null ? mswVar4.ru + 1 : 0;
                if (i10 < this.uym.size()) {
                    mswVar2 = this.uym.get(i10);
                }
                if (mswVar2 == null) {
                    this.dg.uym();
                    return;
            ...
            if (mswVar5 != null) {
                ...
                if (this.dg.bw()) {
                    ...
                    if (mswVar6 instanceof emc) {
                        int i11 = mswVar6.ru + 1;
                        msw mswVar7 = i11 < this.uym.size() ? this.uym.get(i11) : null;
            ...
            for (int i12 = mswVar8 != null ? mswVar8.ru : 0; i12 < this.uym.size(); i12++) {
                this.uym.get(i12).emc(mswVar8, this.vk, bwVar);
            }
            this.dg.ypw(this.vk);
        }
    }
    ...
    */
    private int ypw(com.bytedance.sdk.openadsdk.activity.msw r8) {
        ...
        L43:
            ...
            com.bykv.vk.openvk.emc.emc.emc.xq.b r1 = r1.iat()
            if (r1 == 0) goto L53
            double r2 = (double) r0
            double r0 = r1.E()
            double r2 = r2 + r0
    ...
    public void emc(int i10, int i11) {
        ...
        if (i10 >= 0) {
            if (TextUtils.isEmpty(this.xq)) {
                this.sup.setText(this.emc.getString(com.bytedance.sdk.component.utils.rie.ypw(aa.emc(), "tt_multiple_playable_wait_tips"), Integer.valueOf(i10)));
            } else {
                this.sup.setText(String.format(this.xq, Integer.valueOf(i10)));
            }
            this.sup.setVisibility(0);
            return;
        }
            ...
            if (mswVar2 != null && (mswVar2 instanceof emc)) {
                ...
                com.bytedance.sdk.openadsdk.dg.xq.emc(jCurrentTimeMillis, mswVar3.ycc, mswVar3.d_(), "dislike_skip", new com.bytedance.sdk.openadsdk.vk.xq.emc() { // from class: com.bytedance.sdk.openadsdk.activity.zz.2
                    ...
                    public JSONObject emc() {
                        return com.bytedance.sdk.openadsdk.dg.xq.emc(i10);
                    }
    ...
    public void emc(msw mswVar, boolean z10, boolean z11, boolean z12, int i10) {
        ...
        if ((mswVar2 == null || mswVar2 == mswVar) && (bwVarQh = qh()) != null) {
            ypw.bw bwVar = new ypw.bw(i10, mswVar != null ? mswVar.ee() : null);
            bwVar.emc.putBoolean("isSkip", z10);
            bwVar.emc.putBoolean("force", z11);
            bwVar.emc.putBoolean("isFromLandingPage", z12);
    ...
    public void emc(emc emcVar, boolean z10) {
        ypw.AbstractC0133ypw abstractC0133ypw;
        super.emc(emcVar, z10);
        if (emcVar == null || emcVar != this.vk || (abstractC0133ypw = this.sz) == null) {
            return;
        }
        abstractC0133ypw.ypw(z10);
    }
    ...
    public void emc(msw mswVar) {
        ...
        mswVar.toString();
        if (mswVar.sup && (abstractC0133ypw = this.sz) != null) {
            abstractC0133ypw.ycc();
        }
        msw mswVarSz = sz();
    ...
    public boolean emc(msw mswVar, int i10) {
        return i10 == this.uym.size() - 1 && this.uym.get(i10) != null && (this.uym.get(i10) instanceof bw);
    }
