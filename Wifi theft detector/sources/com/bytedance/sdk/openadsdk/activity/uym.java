...
public class uym extends emc {
    ...
    public uym(ypw ypwVar, rie rieVar, int i10, int i11, boolean z10) {
    ...
    */
            ...
            View.OnClickListener onClickListener = new View.OnClickListener() { // from class: com.bytedance.sdk.openadsdk.activity.uym.1
                ...
                public void onClick(View view) {
                    if (uym.this.zz.xmt.ul() && uym.this.zz.zz.get()) {
                        ...
                        uym.this.zz.ra.sendEmptyMessageDelayed(Sdk$SDKError.Reason.NATIVE_ASSET_ERROR_VALUE, 5000L);
    ...
    public boolean emc(final boolean z10, boolean z11, final Runnable runnable) {
        if (!z11 && this.uym.sup().getBoolean("user_has_give_up_reward", false) && runnable != null) {
            return false;
        }
        ...
        ((emc) this).ypw.sup.emc(new ypw.InterfaceC0165ypw() { // from class: com.bytedance.sdk.openadsdk.activity.uym.3
            @Override // com.bytedance.sdk.openadsdk.core.widget.ypw.InterfaceC0165ypw
            public void emc() {
                uym.this.zz.ylm.ul();
                if (z10) {
                    uym.this.zz.rie.emc(1000);
                }
                ypwVar.dismiss();
                uym.this.zz.f9273aa.set(false);
            }
