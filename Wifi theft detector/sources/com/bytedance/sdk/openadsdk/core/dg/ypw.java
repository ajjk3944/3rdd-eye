...
public class ypw extends com.bytedance.sdk.openadsdk.core.zz.emc {
    public static sba[] emc = {new sba(1, 6.4f, Sdk$SDKError.Reason.WEBVIEW_ERROR_VALUE, 50), new sba(4, 1.2f, 300, 250)};
    private PAGBannerAdWrapperListener cf;
    private String qh;
    private emc sup;
    private ul sz;

    public ypw(@NonNull Context context) {
        super(context);
        this.ypw = context;
    }
    ...
    private void bw() {
        ...
        if (rieVar != null) {
            ...
            com.bytedance.sdk.openadsdk.yzg.ypw.ypw().emc(this.xq.iat().r(), this.sup.bw);
            ...
            if (videoView != null) {
                ...
                videoView.setAdCreativeClickListener(new ycc.emc() { // from class: com.bytedance.sdk.openadsdk.core.dg.ypw.5
                    ...
                    public void emc(View view3, int i10) {
                        if (ypw.this.cf != null) {
    ...
    public static sba emc(int i10, int i11) {
        try {
            return ((double) i11) >= Math.floor((((double) i10) * 450.0d) / 600.0d) ? emc[1] : emc[0];
