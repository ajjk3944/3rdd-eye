...
public class msw extends ru {
    static final ArrayList<String> dg = new ArrayList<>(Arrays.asList("ja", "en", "ko", "zh", "th", "vi", "id", "ru", "ar", "fr", DownloadCommon.DOWNLOAD_REPORT_DOWNLOAD_ERROR, "it", "es", "hi", "pt", "zh-Hant", "ms", "pl", "tr"));
    ...
    public void emc(JSONObject jSONObject) {
        ...
        if (jSONObjectOptJSONObject2 != null) {
            ...
            if (jSONObjectOptJSONObject2.has(AppLovinMediationProvider.MAX)) {
                emcVarEmc.emc(AppLovinMediationProvider.MAX, jSONObjectOptJSONObject2.optInt(AppLovinMediationProvider.MAX));
            }
        }
        ...
        if (jSONObject.has(CampaignEx.JSON_KEY_PRIVACY_URL)) {
            emcVarEmc.emc("policy_url", jSONObject.optString(CampaignEx.JSON_KEY_PRIVACY_URL));
        }
                ...
                try {
                    ...
                    if (jSONArrayOptJSONArray != null && jSONArrayOptJSONArray.length() != 0) {
                        for (int i10 = 0; i10 < jSONArrayOptJSONArray.length(); i10++) {
                            this.bw.add(jSONArrayOptJSONArray.getString(i10));
                        }
                    }
                    this.bw = emc(this.bw);
        ...
        try {
            ...
            ul.xq("SettingsDefaultRepository", "coreSettingJson", e10.getMessage());
        }
