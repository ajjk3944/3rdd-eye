...
public class gbl implements zz.emc {
    ...
    private boolean yzg;
    public static final String emc = vc.a("_", new CharSequence[]{"bus_con_collect", tp.dr()});
    public static final String ypw = vc.a("_", new CharSequence[]{"bus_con", tp.dr(), tp.sf(), "timeout"});
    public static final String xq = vc.a("_", new CharSequence[]{"bus_con", tp.dr(), tp.sf(), "alpha"});
    private static final String zz = tp.sra();
    private static final com.bytedance.sdk.component.msw.msw gbl = new com.bytedance.sdk.component.msw.msw("TemplateReInitTask") { // from class: com.bytedance.sdk.openadsdk.core.settings.gbl.1
    ...
    public static String bw = AndroidTcfDataSource.TCF_TCSTRING_KEY;
    private static boolean sup = false;
    private static final ConcurrentLinkedQueue<ru.emc> ul = new ConcurrentLinkedQueue<>();
    static final ConcurrentHashMap<String, Integer> ycc = new ConcurrentHashMap<>();
    ...
    public int cuf() {
        return this.qh.emc(AppLovinMediationProvider.MAX, 50);
    }
        ...
        if (set == null || set.size() == 0) {
            ...
            if (jSONArray.length() != 0) {
                for (int i10 = 0; i10 < jSONArray.length(); i10++) {
                    this.ru.add(jSONArray.getString(i10));
                }
            }
    ...
    public long pe() {
        ...
        return (jEmc < 0 || jEmc > SignalManager.TWENTY_FOUR_HOURS_MILLIS) ? TTAdConstant.AD_MAX_EVENT_TIME : jEmc;
    }
        ...
        this.rie = new bw.ypw<Map<String, Integer>>() { // from class: com.bytedance.sdk.openadsdk.core.settings.gbl.12
            ...
            public Map<String, Integer> ypw(String str) {
                ...
                try {
                    ...
                    ul.xq("get applog rate from sp failed:" + e10.getMessage(), new Object[0]);
                    return null;
                }
            }
        };
        ...
        this.msw = new bw.ypw<com.bytedance.sdk.openadsdk.dg.emc.gbl>() { // from class: com.bytedance.sdk.openadsdk.core.settings.gbl.4
            ...
            public com.bytedance.sdk.openadsdk.dg.emc.gbl ypw(String str) {
                ...
                try {
                    ...
                    gblVar.emc(emc(jSONObject.optJSONObject(BuildConfig.FLAVOR)));
    ...
    public boolean bw(String str) {
        int i10 = db(str).bw;
        return i10 != 1 ? i10 == 2 && sba.xq(aa.emc()) != 0 : sba.dg(aa.emc());
    }
    ...
    private static void ypw(int i10, boolean z10) {
        Context contextEmc = aa.emc();
        if (contextEmc != null) {
            try {
    ...
    public int xq(int i10) {
        return db(String.valueOf(i10)).zz;
    }
    ...
    public void dg(@TTSdkSettings.FETCH_REQUEST_SOURCE int i10) {
        emc(i10, false);
    }
    ...
    public static int emc(Context context) {
        ...
        int i10 = sharedPreferencesDg.getInt("IABTCF_CmpSdkID", Integer.MIN_VALUE);
        int i11 = sharedPreferencesDg.getInt("IABTCF_CmpSdkVersion", Integer.MIN_VALUE);
    ...
    public int ypw(int i10) {
        return db(String.valueOf(i10)).ypw;
    }
    ...
    public int emc(int i10) {
        return db(String.valueOf(i10)).lt;
    }

    public void emc(long j10) {
        this.qh.emc().emc("last_req_time", j10).emc();
    }

    public void emc(@TTSdkSettings.FETCH_REQUEST_SOURCE int i10, boolean z10) {
        if (!qh.bw() && i10 != 1 && i10 != 2) {
            if (z10) {
                this.yzg = true;
                return;
            }
        ...
        try {
            ...
            long jPe = pe();
            long j10 = jCurrentTimeMillis - jYid;
            if (z10 || j10 >= jPe) {
                if (!zz.emc()) {
                    ypw(i10, z10);
