...
public class rie implements sra<com.bytedance.sdk.openadsdk.dg.emc> {
    ...
    public static class emc {
        ...
        private emc(String str, int i10, int i11, String str2, int i12, String str3, @Nullable com.bytedance.sdk.openadsdk.core.model.emc emcVar, long j10, long j11, ArrayList<Integer> arrayList) {
            this.emc = i10;
            this.dg = i11;
            this.bw = str2;
            this.uym = str3;
    ...
    public static class ypw {
        ...
        private ypw(int i10, boolean z10, com.bytedance.sdk.openadsdk.core.model.rtt rttVar) {
            this.emc = i10;
            this.ypw = z10;
            this.xq = rttVar;
        }
        ...
        public static ypw emc(JSONObject jSONObject) {
            ...
            if (jSONObjectOptJSONObject != null) {
                try {
                    ...
                    rttVar.xq(jSONObjectOptJSONObject.optInt(CampaignEx.JSON_KEY_REWARD_AMOUNT));
                    rttVar.emc(jSONObjectOptJSONObject.optString(CampaignEx.JSON_KEY_REWARD_NAME));
                } catch (Throwable th) {
    ...
    private void ycc(JSONObject jSONObject) throws JSONException {
        try {
            jSONObject.put(CampaignEx.JSON_KEY_PACKAGE_NAME, com.bytedance.sdk.openadsdk.utils.tp.ycc());
    ...
    public void ypw(final AdSlot adSlot, final com.bytedance.sdk.openadsdk.core.model.sb sbVar, final int i10, final sra.emc emcVar) {
        ...
        if (!com.bytedance.sdk.openadsdk.core.settings.uym.emc()) {
            if (emcVar != null) {
                emcVar.emc(1000, "Ad request is temporarily paused, Please contact your AM");
                xqVar.emc(1000);
        ...
        if (!TextUtils.isEmpty(adSlot.getBidAdm()) && !sbVar.ycc) {
            ...
            try {
                ...
                int i11 = emcVarEmc.dg;
                if (i11 != 20000) {
                    emcVar.emc(i11, emcVarEmc.bw);
        ...
        JSONObject jSONObjectEmc3 = emc(adSlot, sbVar, i10);
        ...
        if (mapEmc2 != null && mapEmc2.size() > 0) {
            for (String str : mapEmc2.keySet()) {
                try {
                    ...
                    com.bytedance.sdk.component.utils.ul.xq("NetApiImpl", e10.getMessage());
                }
            }
        }
        try {
        ...
        boolean z10 = zz.ypw().aa() && requestExtraMap != null;
        if (z10) {
        ...
        com.bytedance.sdk.openadsdk.sba.xq.emc(new com.bytedance.sdk.openadsdk.sba.dg() { // from class: com.bytedance.sdk.openadsdk.core.rie.8
            ...
            public com.bytedance.sdk.openadsdk.sba.ypw.emc emc() {
                com.bytedance.sdk.openadsdk.sba.ypw.emc emcVar4 = new com.bytedance.sdk.openadsdk.sba.ypw.emc();
                emcVar4.ypw("get_ad");
                emcVar4.xq(adSlot.getCodeId());
                emcVar4.dg(com.bytedance.sdk.openadsdk.utils.tp.xq(adSlot.getDurationSlotType()));
                return emcVar4;
            }
        });
        if (com.bytedance.sdk.component.utils.cf.dg()) {
        ...
        if (zXq) {
            ...
            try {
                ...
                if (ypwVar.ycc()) {
                    boolean z11 = z10;
                    try {
                        emc(dgVarYpw, ypwVar, z11, map, mxoVarYpw, adSlot, xqVar, emcVar, sbVar, i10);
                    } catch (Throwable th2) {
                        th = th2;
                        z10 = z11;
                        map = map;
                        xqVar = xqVar;
                        emc(dgVarYpw, new IOException(th.getMessage()), new com.bytedance.sdk.component.uym.ypw(false, 5002, "execute method throw exception", null, "REQUEST_BODY_EXCEPTION", 1L, 1L), adSlot, z10, map, emcVar, xqVar);
                        com.bytedance.sdk.openadsdk.ul.emc.ypw.emc.emc().emc(false);
                    }
                } else {
                    emc(dgVarYpw, new IOException(ypwVar.ypw()), ypwVar, adSlot, z10, map, emcVar, xqVar);
            ...
            dgVarYpw.emc(new com.bytedance.sdk.component.uym.emc.ypw() { // from class: com.bytedance.sdk.openadsdk.core.rie.9
                ...
                public void emc(com.bytedance.sdk.component.uym.ypw.xq xqVar2, com.bytedance.sdk.component.uym.ypw ypwVar2) {
                    rie.this.emc(xqVar2, ypwVar2, z12, (Map<String, Object>) requestExtraMap, mxoVarYpw, adSlot, xqVar, emcVar, sbVar, i10);
                }
                ...
                public void emc(com.bytedance.sdk.component.uym.ypw.xq xqVar2, IOException iOException, com.bytedance.sdk.component.uym.ypw ypwVar2) {
                    rie.this.emc(dgVarYpw, iOException, ypwVar2, adSlot, z12, (Map<String, Object>) requestExtraMap, emcVar, xqVar);
                    if (xqVar2 != null) {
    ...
    private byte[] bw(String str) throws Throwable {
                    ...
                    try {
                        ...
                        if (gZIPOutputStream != null) {
                            try {
                                ...
                                com.bytedance.sdk.component.utils.ul.xq("NetApiImpl", e12.toString());
                            }
                        }
                        ...
                        try {
                            ...
                            com.bytedance.sdk.component.utils.ul.xq("NetApiImpl", e14.toString());
                            throw th;
                        }
                    }
                } catch (Throwable th2) {
        ...
        try {
            ...
            com.bytedance.sdk.component.utils.ul.xq("NetApiImpl", e17.toString());
        }
        return byteArray;
    }
    ...
    public static JSONArray xq(String str) throws JSONException {
        try {
            ...
            com.bytedance.sdk.component.utils.ul.emc("NetApiImpl", "getUgenParentTplIds: ", e10);
            return null;
        }
    }

    @DungeonFlag
    private JSONObject emc(AdSlot adSlot, com.bytedance.sdk.openadsdk.core.model.sb sbVar, int i10) {
        int i11;
        int i12;
        int i13;
        JSONObject jSONObject = new JSONObject();
        try {
            ...
            if (i10 == 7) {
                if (sbVar != null && (i13 = sbVar.ypw) > 0) {
                    jSONObject2.put("req_type", i13);
                }
            } else if (i10 == 8) {
                if (sbVar != null && (i12 = sbVar.xq) > 0) {
                    jSONObject2.put("req_type", i12);
                }
            } else if (i10 == 3 && sbVar != null && (i11 = sbVar.dg) > 0) {
            ...
            jSONObject2.put(MBridgeConstans.DYNAMIC_VIEW_WX_APP, ypw());
            ...
            JSONArray jSONArray = new JSONArray();
            jSONArray.put(emc(adSlot, i10, sbVar));
    ...
    private Map<String, String> dg(JSONObject jSONObject) {
        ...
        map.put(CommonGatewayClient.HEADER_CONTENT_TYPE, "application/json; charset=utf-8");
        if (xq(jSONObject)) {
    ...
    public void emc(AdSlot adSlot, com.bytedance.sdk.openadsdk.core.model.sb sbVar, int i10, ul ulVar) {
        if (!sbVar.ycc && TextUtils.isEmpty(adSlot.getBidAdm())) {
            ...
            emc(adSlot, sbVar, i10, (sra.emc) ulVar);
            return;
        }
        emc(adSlot, sbVar, i10, (sra.emc) ulVar);
    }
    ...
    @Override // com.bytedance.sdk.openadsdk.core.sra
    public void emc(final AdSlot adSlot, final com.bytedance.sdk.openadsdk.core.model.sb sbVar, final int i10, sra.emc emcVar) {
        ...
        if (Looper.myLooper() == Looper.getMainLooper()) {
            qh.ypw().post(new com.bytedance.sdk.component.msw.msw("getAd") { // from class: com.bytedance.sdk.openadsdk.core.rie.1
                ...
                public void run() {
                    rie.this.ypw(adSlot, sbVar, i10, emcVar2);
                }
            });
        } else {
            ypw(adSlot, sbVar, i10, emcVar2);
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void emc(com.bytedance.sdk.component.uym.ypw.dg dgVar, IOException iOException, com.bytedance.sdk.component.uym.ypw ypwVar, final AdSlot adSlot, boolean z10, Map<String, Object> map, sra.emc emcVar, com.bytedance.sdk.openadsdk.core.model.xq xqVar) {
        String message;
        int iEmc;
        com.bytedance.sdk.openadsdk.sba.xq.xq(new com.bytedance.sdk.openadsdk.sba.dg() { // from class: com.bytedance.sdk.openadsdk.core.rie.10
            ...
            public com.bytedance.sdk.openadsdk.sba.ypw.emc emc() {
                ...
                emcVar2.ypw("get_ad");
                emcVar2.xq(adSlot.getCodeId());
                emcVar2.dg(com.bytedance.sdk.openadsdk.utils.tp.xq(adSlot.getDurationSlotType()));
    ...
    */
    ...
    private void ypw(com.bytedance.sdk.openadsdk.core.model.emc emcVar) {
        ...
        for (int i10 = 0; i10 < listDg.size(); i10++) {
            com.bytedance.sdk.openadsdk.core.model.rie rieVar = listDg.get(i10);
            if (rieVar != null && rieVar.ffd() == null) {
                ...
                if (listRr != null && listRr.size() > 0) {
                    for (int i11 = 0; i11 < listRr.size(); i11++) {
                        emc(rieVar, listRr.get(i11));
                    }
                }
                if (rieVar.iat() != null) {
                    emc(rieVar.iat().r(), rieVar.iat().B(), rieVar.iat().I(), (com.bytedance.sdk.openadsdk.core.model.sba) null, rieVar);
                }
            }
        }
    }
    ...
    @DungeonFlag
    private JSONObject ypw(@NonNull String str, List<FilterWord> list, JSONObject jSONObject, String str2, String str3) throws JSONException {
        JSONObject jSONObject2 = new JSONObject();
        try {
            JSONObject jSONObject3 = new JSONObject();
  ...
  0x009e: PHI (r2v15 int) = (r2v14 int), (r2v18 int) binds: [B:12:0x0091, B:16:0x0097] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    ...
    public com.bytedance.sdk.openadsdk.dg.bw ypw(JSONObject jSONObject) {
        ...
        try {
            ...
            try {
                ...
                z11 = iEmc;
                iEmc = i10;
                return new com.bytedance.sdk.openadsdk.dg.bw(z11, iEmc, strYpw, z10);
            }
            return new com.bytedance.sdk.openadsdk.dg.bw(z11, iEmc, strYpw, z10);
    ...
    private void emc(String str, int i10, int i11, com.bytedance.sdk.openadsdk.core.model.sba sbaVar, com.bytedance.sdk.openadsdk.core.model.rie rieVar) {
        if (!TextUtils.isEmpty(str)) {
            com.bytedance.sdk.openadsdk.ru.dg.emc(str).emc(i10).ypw(i11).bw(vw.bw(aa.emc())).dg(vw.xq(aa.emc())).xq(1).emc(new com.bytedance.sdk.openadsdk.ru.ypw(rieVar, str, null), 4);
        } else {
            if (sbaVar == null) {
                return;
            }
    ...
    */
    ...
    private static void emc(com.bytedance.sdk.component.ypw.emc.ru ruVar, com.bytedance.sdk.openadsdk.core.model.sb sbVar, com.bytedance.sdk.openadsdk.utils.mxo mxoVar, com.bytedance.sdk.openadsdk.utils.mxo mxoVar2, int i10, com.bytedance.sdk.openadsdk.utils.mxo mxoVar3, com.bytedance.sdk.openadsdk.core.model.rie rieVar, String str, JSONObject jSONObject, boolean z10) throws JSONException {
        ...
        long j10 = ruVar.ypw;
        if (j10 > 0) {
            jSONObject.put("enqueue_2_run_ts", ruVar.xq - j10);
    ...
    public static JSONArray ypw(String str) throws JSONException {
        try {
            ...
            com.bytedance.sdk.component.utils.ul.emc("NetApiImpl", "getParentTplIds: ", e10);
            return null;
        }
    }
    ...
    @WorkerThread
    @DungeonFlag
    public com.bytedance.sdk.openadsdk.dg.bw emc(JSONObject jSONObject, String str, boolean z10) {
        Object obj;
        try {
            System.currentTimeMillis();
            byte[] bArr = null;
            ...
            emc(jSONObject, z10);
            return new com.bytedance.sdk.openadsdk.dg.bw(zBw, iEmc, strYpw, z11);
        } catch (Throwable th) {
        ...
        if (map != null) {
            for (Map.Entry<String, String> entry : map.entrySet()) {
                try {
                    ...
                    com.bytedance.sdk.component.utils.ul.xq("NetApiImpl", "ADD header exceptopn", e10.getMessage());
                }
            }
        }
        try {
            dgVar.ypw(Command.HTTP_HEADER_USER_AGENT, com.bytedance.sdk.openadsdk.utils.tp.dg());
        } catch (Exception e11) {
            com.bytedance.sdk.component.utils.ul.xq("NetApiImpl", "ADD header exceptopn", e11.getMessage());
        }
    }

    private void emc(JSONObject jSONObject, boolean z10) throws JSONException {
        Object obj;
        if (zz.ypw().sba()) {
            try {
                jSONObject.getJSONObject("header").put("aid", "4562");
            } catch (Exception e10) {
                com.bytedance.sdk.component.utils.ul.xq("NetApiImpl", "reportETEvent error", e10.getMessage());
            }
            com.bytedance.sdk.component.uym.ypw.dg dgVarYpw = com.bytedance.sdk.openadsdk.yzg.ypw.ypw().xq().ypw();
    ...
    @Override // com.bytedance.sdk.openadsdk.core.sra
    public void emc(@NonNull String str, List<FilterWord> list, JSONObject jSONObject, String str2, String str3) {
        ...
        if (com.bytedance.sdk.openadsdk.core.settings.uym.emc() && (jSONObjectYpw = ypw(str, list, jSONObject, str2, str3)) != null) {
            ...
            try {
                ...
                com.bytedance.sdk.component.utils.ul.xq(e10.getMessage(), new Object[0]);
            }
        }
    }
    ...
    private JSONObject emc(AdSlot adSlot, int i10, com.bytedance.sdk.openadsdk.core.model.sb sbVar) throws JSONException {
        Object obj;
        Object obj2;
        JSONObject jSONObject = new JSONObject();
        try {
            ...
            if (i10 == 1) {
                ...
                jSONObject3.put(HandleInvocationsFromAdViewer.KEY_AD_TYPE, adSlot.getBannerType());
    ...
    private void emc(JSONObject jSONObject, String str, int i10, int i11) throws JSONException {
        if (i10 <= 0 || i11 <= 0) {
            return;
        }
        JSONObject jSONObject2 = new JSONObject();
    ...
    private void emc(JSONObject jSONObject, String str, float f10, float f11) throws JSONException {
    ...
    public void emc(JSONObject jSONObject, final sra.ypw ypwVar) {
        if (!com.bytedance.sdk.openadsdk.core.settings.uym.emc()) {
            if (ypwVar != null) {
                ypwVar.emc(1000, "Ad request is temporarily paused, Please contact your AM");
            }
        } else {
            ...
            dgVarYpw.emc(new com.bytedance.sdk.component.uym.emc.emc() { // from class: com.bytedance.sdk.openadsdk.core.rie.5
                ...
                public void emc(com.bytedance.sdk.component.uym.ypw.xq xqVar, com.bytedance.sdk.component.uym.ypw ypwVar2) {
                    ...
                    try {
                        ...
                        com.bytedance.sdk.component.utils.ul.xq("NetApiImpl", e11.getMessage());
                        rie.this.emc(ypwVar);
                    }
                    if (i10 != 20000) {
                        ypwVar.emc(i10, msw.emc(i10));
    ...
    @Nullable
    public static String emc(int i10, String str) {
        Object obj;
        if (i10 == 3) {
    ...
    private void emc(com.bytedance.sdk.component.uym.ypw.dg dgVar, JSONObject jSONObject) {
        try {
            if (xq(jSONObject) && jSONObject.optInt("cypher") == 4) {
                ...
                dgVar.ypw(CommonGatewayClient.HEADER_CONTENT_TYPE, "application/json; charset=utf-8");
            }
        } catch (Exception unused) {
        }
    }
