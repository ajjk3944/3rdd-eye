...
public class bw implements c, v2.c, sf.emc, ul.ypw, yzg.emc, emc.InterfaceC0166emc {
    ...
    public bw(Context context, ViewGroup viewGroup, boolean z10, int i10, rie rieVar, b bVar, boolean z11) {
        this.emc = 228;
        this.ypw = 160;
        this.ylm = true;
        this.dr = true;
    ...
    public long getVideoProgress() {
        if (this.mxo <= 0) {
            ...
            if (rieVar != null && rieVar.iat() != null) {
                this.mxo = (long) (this.ee.iat().E() * 1000.0d);
            }
            b bVar = this.lt;
            if (bVar != null) {
                this.mxo = bVar.zz();
    ...
    */
    ...
    private int bw(int i10) {
        if (this.yzg <= 0 || this.ul <= 0) {
            return 0;
        }
        int iYpw = vw.ypw(this.db, 228.0f);
        int iYpw2 = vw.ypw(this.db, 160.0f);
        int i11 = (int) (this.ul * ((i10 * 1.0f) / this.yzg));
        return i11 > iYpw ? iYpw : i11 < iYpw2 ? iYpw2 : i11;
    }
    ...
    public void xq(@Nullable ViewGroup viewGroup) {
        if (viewGroup == null) {
            return;
        }
    ...
    /* JADX WARN: Type inference failed for: r4v19, types: [v2.b] */
    public void emc(Context context, View view) {
        ...
        if (view instanceof RelativeLayout) {
            ...
            ((RelativeLayout) view).addView(dVar, 0, layoutParams);
        }
        vw.emc((View) dVar, 8);
        this.dg = dVar;
    ...
    public void ypw(SurfaceTexture surfaceTexture) {
        b bVar = this.lt;
        if (bVar != null) {
            bVar.emc(surfaceTexture);
        }
    }

    public bw(Context context, ViewGroup viewGroup, boolean z10, int i10, rie rieVar, b bVar) {
        this(context, viewGroup, z10, i10, rieVar, bVar, true);
    }
    ...
    public boolean emc(int i10, com.bykv.vk.openvk.emc.emc.emc.xq.b bVar, boolean z10) {
        ul ulVar = this.sb;
        return ulVar == null || ulVar.emc(i10, bVar, z10);
    }
    ...
    */
    ...
    public void emc(final int i10, final String str, final rie rieVar) {
    ...
    @Override // v2.c
    public void emc(SurfaceHolder surfaceHolder, int i10, int i11, int i12) {
        if (surfaceHolder != this.dg.getHolder()) {
            return;
        }
        vk();
    ...
    @Override // v2.c
    public void emc(SurfaceTexture surfaceTexture, int i10, int i11) {
        this.sra = true;
        if (vk()) {
