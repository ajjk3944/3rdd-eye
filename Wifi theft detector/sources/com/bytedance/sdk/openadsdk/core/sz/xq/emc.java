...
public class emc {
    ...
    public interface InterfaceC0163emc {
    ...
    public static class ypw {
        ...
        public ypw emc(long j10) {
            this.emc = j10;
            return this;
        }

        public ypw ypw(long j10) {
            this.ypw = j10;
            return this;
        }
    }
    ...
    public void ypw(rie rieVar) {
        if (rieVar == null || rieVar.iat() == null || TextUtils.isEmpty(rieVar.iat().w()) || !com.bytedance.sdk.openadsdk.sra.emc.emc("can_cancel_playable", false)) {
            return;
        }
        com.bytedance.sdk.component.uym.ypw.emc emcVar = this.uym.get(rieVar.iat().w());
        if (emcVar != null) {
            emcVar.ypw();
        }
    }
    ...
    public boolean emc(rie rieVar) {
        if (this.bw.get() && rieVar != null && rieVar.iat() != null && rieVar.iat().w() != null) {
            try {
                if (!TextUtils.isEmpty(this.msw.get(bw.emc(rieVar.iat().w())))) {
                    return true;
                }
            } catch (Throwable unused) {
            }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public JSONObject emc(File file, boolean z10) {
        byte[] bArrDg;
        String strYpw;
        try {
    ...
    public void emc(final rie rieVar, final InterfaceC0163emc interfaceC0163emc) {
        File file;
        if (dg.emc().ypw() && rieVar != null && dr.ycc(rieVar) && rieVar.vaf() != null && !TextUtils.isEmpty(rieVar.vaf().getBidAdm())) {
            ...
            emc(interfaceC0163emc, false);
            return;
        }
        if (rieVar != null && rieVar.iat() != null && !TextUtils.isEmpty(rieVar.iat().w())) {
            final String strW = rieVar.iat().w();
            if (this.ycc.contains(strW)) {
                return;
            }
            this.xq.put(rieVar, new ypw().emc(System.currentTimeMillis()));
            com.bytedance.sdk.openadsdk.core.sz.xq.ypw.emc(rieVar);
            String strEmc = bw.emc(strW);
            final File file2 = new File(dg(), strEmc);
            String str = this.msw.get(strEmc);
            if (TextUtils.isEmpty(str)) {
                file = emc(file2);
                if (file != null && file.exists()) {
            ...
            emcVarDg.emc(new com.bytedance.sdk.component.uym.emc.emc() { // from class: com.bytedance.sdk.openadsdk.core.sz.xq.emc.2
                ...
                public void emc(com.bytedance.sdk.component.uym.ypw.xq xqVar, final com.bytedance.sdk.component.uym.ypw ypwVar) {
                    emc.this.ycc.remove(strW);
                    emc.this.uym.remove(strW);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void emc(final InterfaceC0163emc interfaceC0163emc, final boolean z10) {
        iyl.emc(new Runnable() { // from class: com.bytedance.sdk.openadsdk.core.sz.xq.emc.3
            @Override // java.lang.Runnable
            public void run() {
                InterfaceC0163emc interfaceC0163emc2 = interfaceC0163emc;
                if (interfaceC0163emc2 != null) {
                    interfaceC0163emc2.emc(z10);
                }
            }
        });
    }
