...
public class ypw {
    ...
    public void emc(com.bytedance.sdk.openadsdk.core.gbl.msw.emc emcVar, String str) {
        ...
        final String str2 = str + "_" + emcVar.emc();
    ...
    public void emc(String str, String str2, String str3, String str4, String str5, final emc emcVar) {
        ...
        com.bytedance.sdk.openadsdk.core.gbl.emc.emc emcVarEmc = emc(str6, str4);
        ...
        emc(str2, str6, str4, str5, new emc() { // from class: com.bytedance.sdk.openadsdk.core.gbl.emc.ypw.2
            @Override // com.bytedance.sdk.openadsdk.core.gbl.emc.ypw.emc
            public void emc(JSONObject jSONObject, String str7) {
                emc emcVar2 = emcVar;
                if (emcVar2 != null) {
                    emcVar2.emc(jSONObject, str7);
                }
            }

            @Override // com.bytedance.sdk.openadsdk.core.gbl.emc.ypw.emc
            public void emc(int i10, String str7, String str8) {
                emc emcVar2 = emcVar;
                if (emcVar2 != null) {
                    emcVar2.emc(i10, str7, str8);
                }
            }
        });
    }
    ...
    public String emc(String str, String str2, String str3) {
        com.bytedance.sdk.openadsdk.core.gbl.emc.emc emcVarEmc = emc(str + "_" + str2, str3);
        if (emcVarEmc == null) {
            return null;
        }
        emc(emcVarEmc);
