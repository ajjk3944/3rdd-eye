...
public class emc implements cf, vk {
    ...
    public void ypw(JSONObject jSONObject, JSONObject jSONObject2, dg dgVar) throws JSONException {
        try {
            ...
            if (dgVar != null) {
                dgVar.emc(3000, "ugen render fail exception is" + e10.getMessage());
            }
        }
    }
    ...
    public void emc(InterfaceC0141emc interfaceC0141emc) {
        this.xq = interfaceC0141emc;
    }
    ...
    public void emc(sz szVar, cf.ypw ypwVar, cf.emc emcVar) {
        InterfaceC0141emc interfaceC0141emc;
        if (szVar == null) {
            return;
        }
        if ((szVar.ypw() == 1 || szVar.ypw() == 4) && (interfaceC0141emc = this.xq) != null) {
            interfaceC0141emc.emc(szVar);
        }
