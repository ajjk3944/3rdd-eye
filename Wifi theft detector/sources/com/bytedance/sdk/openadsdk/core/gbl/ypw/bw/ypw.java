...
public class ypw extends com.bytedance.adsdk.ugeno.ypw.emc<emc> {
    ...
    private void dg() throws JSONException {
        for (int i10 = 0; i10 < ((com.bytedance.adsdk.ugeno.ypw.emc) this).emc.size(); i10++) {
            xq<View> xqVar = ((com.bytedance.adsdk.ugeno.ypw.emc) this).emc.get(i10);
            if (xqVar != null) {
    ...
    private void xq() {
        ...
        for (int i10 = 0; i10 < this.hh.length(); i10++) {
            sup supVar = new sup(this.ypw);
            supVar.emc(this.vhn);
            try {
                JSONObject jSONObjectOptJSONObject = this.hh.optJSONObject(i10);
    ...
    public void ypw() throws JSONException {
        super.ypw();
        T t10 = this.bw;
        if (t10 instanceof emc) {
            ((emc) t10).setOrientation(this.dpk);
