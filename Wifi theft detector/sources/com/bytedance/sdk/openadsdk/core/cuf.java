...
public class cuf implements xmt {
    ...
    @Override // com.bytedance.sdk.openadsdk.core.xmt
    public xmt emc(int i10) {
        zz.ypw().ycc(i10);
        return this;
    }

    @Override // com.bytedance.sdk.openadsdk.core.xmt
    public xmt xq(int i10) {
        this.ypw = i10;
        return this;
    }

    @Override // com.bytedance.sdk.openadsdk.core.xmt
    public xmt ypw(int i10) {
        zz.ypw().dg(i10);
        return this;
    }
    ...
    private JSONObject ypw(PAGBiddingRequest pAGBiddingRequest) {
        try {
            ...
            if (bannerSize != null) {
                ...
                jSONObject.put(HandleInvocationsFromAdViewer.KEY_AD_TYPE, bannerSize.getType());
                return jSONObject;
            }
    ...
    */
    ...
    private JSONObject emc(JSONObject jSONObject, boolean z10) {
