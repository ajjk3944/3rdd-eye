...
public class ypw {
    ...
    public static JSONObject ypw() throws JSONException {
        ...
        try {
            ...
            ul.xq("TemplateUtils", e10.getMessage());
            return jSONObject;
        }
    }

    public static JSONObject emc(float f10, float f11, boolean z10, @NonNull rie rieVar) throws JSONException {
        JSONObject jSONObject = new JSONObject();
        try {
    ...
    public static JSONObject emc(rie rieVar, boolean z10, JSONObject jSONObject) {
        JSONObject jSONObjectEmc = null;
        if (rieVar == null) {
            return null;
        }
        try {
            jSONObjectEmc = emc(rieVar, false, z10);
    ...
    private static JSONObject emc(rie rieVar, boolean z10, boolean z11) {
    ...
    public static JSONObject emc(float f10, float f11, boolean z10, rie rieVar, String str, xq xqVar) throws JSONException {
        ypw = "";
        if (rieVar == null) {
            return null;
        }
        try {
            JSONObject jSONObjectEmc = emc(f10, f11, z10, rieVar, str);
            if (xqVar != null) {
                xqVar.emc("adv3");
            }
    ...
    public static JSONObject emc(float f10, float f11, boolean z10, rie rieVar, String str) {
        if (rieVar == null) {
            return null;
        }
        try {
    ...
    private static void emc(JSONObject jSONObject, rie rieVar, String str) throws JSONException {
        ...
        try {
            ...
            if (!jSONObject.has("video") || (bVarIat = rieVar.iat()) == null) {
                return;
            }
            JSONObject jSONObjectT = bVarIat.t();
            if (jSONObjectT != null) {
                if ("open_ad".equals(str)) {
                    jSONObjectT.put("video_duration", aa.dg().rie(String.valueOf(rieVar.tx())));
                } else {
                    jSONObjectT.put("video_duration", bVarIat.E() * bVarIat.u());
                }
            }
            jSONObject.put("video", jSONObjectT);
        } catch (Exception e10) {
            e10.getMessage();
        }
    }
    ...
    public static JSONObject emc(boolean z10, @NonNull rie rieVar) throws JSONException {
        JSONObject jSONObject = new JSONObject();
        try {
            jSONObject.put("button_text", rieVar.xxo());
            if (rieVar.ya() != null) {
                if (rieVar.ya() != null && !TextUtils.isEmpty(rieVar.ya().emc())) {
                    jSONObject.put(RewardPlus.ICON, rieVar.ya().emc());
                } else {
            ...
            if (rieVar.rr() != null) {
                for (int i10 = 0; i10 < rieVar.rr().size(); i10++) {
                    sba sbaVar = rieVar.rr().get(i10);
                    JSONObject jSONObject2 = new JSONObject();
            ...
            if (rieVar.mjd() != null) {
                ...
                jSONObject.put(CampaignEx.JSON_KEY_APP_SIZE, rieVar.mjd().ycc());
                jSONObject.put(MBridgeConstans.DYNAMIC_VIEW_WX_APP, rieVar.mjd().msw());
            }
