...
public class bw extends com.bytedance.sdk.component.zz.ycc implements xq.InterfaceC0168xq {
    ...
    public static class emc extends ycc.emc {
        ...
        xq.InterfaceC0168xq ypw;

        public emc(xq.InterfaceC0168xq interfaceC0168xq) {
            this.ypw = interfaceC0168xq;
        }

        private void emc(String str) {
            int iLastIndexOf;
            xq.InterfaceC0168xq interfaceC0168xq;
            if (!TextUtils.isEmpty(str) && (iLastIndexOf = str.lastIndexOf(".")) > 0) {
                if (!emc.contains(str.substring(iLastIndexOf).toLowerCase()) || (interfaceC0168xq = this.ypw) == null) {
                    return;
                }
                interfaceC0168xq.ypw(str);
            }
        }
        ...
        public void onPageFinished(WebView webView, String str) {
            ...
            xq.InterfaceC0168xq interfaceC0168xq = this.ypw;
        ...
        private void emc(String str, int i10, String str2) {
            xq.InterfaceC0168xq interfaceC0168xq = this.ypw;
            if (interfaceC0168xq != null) {
                interfaceC0168xq.emc(106, i10);
            }
        }
    }
    ...
    public void ul() {
        ...
        this.sup = 0;
        emc(null, str, "text/html", C.UTF8_NAME, null);
    ...
    @Override // com.bytedance.sdk.openadsdk.core.zz.xq.InterfaceC0168xq
    ...
    public static class xq {
        ...
        public void emc(boolean z10) {
            ...
            if (this.emc == 1 && z10 && (yccVar = this.ypw) != null) {
                yccVar.xq();
                this.emc = 3;
            }
        }

        public void emc(@Nullable View view, @Nullable FriendlyObstructionPurpose friendlyObstructionPurpose) {
        ...
        public void emc() {
            com.bytedance.sdk.openadsdk.core.sup.ycc yccVar;
            int i10 = this.emc;
            if (i10 != 0 && i10 != 4 && (yccVar = this.ypw) != null) {
                yccVar.dg();
            }
            this.emc = 4;
            this.ypw = null;
    ...
    public void emc(String str) throws JSONException {
        ...
        if (this.msw != null) {
            ...
            com.bytedance.sdk.openadsdk.dg.xq.emc(CampaignEx.JSON_NATIVE_VIDEO_CLICK, this.ru, supVarEmc, this.gbl, true, (Map<String, Object>) map, this.msw.ypw() ? 1 : 2);
        }
