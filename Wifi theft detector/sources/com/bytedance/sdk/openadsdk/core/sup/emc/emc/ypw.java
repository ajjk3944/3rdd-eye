...
public class ypw {
    public static com.bytedance.sdk.openadsdk.core.sup.emc emc(Context context, XmlPullParser xmlPullParser, List<com.bytedance.sdk.openadsdk.core.sup.ypw.xq> list, int i10, double d10) throws XmlPullParserException, IOException {
        String name;
                            ...
                            while (xmlPullParser.next() != 3) {
                                if (xmlPullParser.getEventType() == 2) {
                                    if ("Creative".equals(xmlPullParser.getName())) {
                                        emc(context, xmlPullParser, emcVar, i10, d10);
                                    } else {
    ...
    public static void emc(Context context, XmlPullParser xmlPullParser, com.bytedance.sdk.openadsdk.core.sup.emc emcVar, int i10, double d10) throws XmlPullParserException, IOException {
        while (xmlPullParser.next() != 3) {
            if (xmlPullParser.getEventType() == 2) {
                if ("Linear".equals(xmlPullParser.getName()) && TextUtils.isEmpty(emcVar.uym())) {
                    xq.emc(xmlPullParser, emcVar, i10, d10);
