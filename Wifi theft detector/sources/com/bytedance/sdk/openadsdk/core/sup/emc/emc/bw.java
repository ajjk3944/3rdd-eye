...
public class bw extends com.bytedance.sdk.openadsdk.core.sup.emc.ypw {
    ...
    public bw(Context context, int i10, int i11) {
    ...
    */
    ...
    public static class emc {
        ...
        public void emc(String str, emc.EnumC0157emc enumC0157emc, emc.ypw ypwVar) {
            this.emc = str;
            this.ypw = enumC0157emc;
            this.xq = ypwVar;
        }
        ...
        public emc(String str, emc.EnumC0157emc enumC0157emc, emc.ypw ypwVar) {
            emc(str, enumC0157emc, ypwVar);
        }
    }

    public static String ypw(XmlPullParser xmlPullParser, String str) throws XmlPullParserException, IOException {
        String strTrim;
        String str2 = uym;
    ...
    */
    ...
    public static List<com.bytedance.sdk.openadsdk.core.sup.ypw.xq> emc(XmlPullParser xmlPullParser, String str) throws XmlPullParserException, IOException {
        return emc(xmlPullParser, str, false);
    }

    public static List<com.bytedance.sdk.openadsdk.core.sup.ypw.xq> emc(XmlPullParser xmlPullParser, String str, boolean z10) throws XmlPullParserException, IOException {
        return emc(ypw(xmlPullParser, str), z10);
    }

    public static void emc(XmlPullParser xmlPullParser) throws XmlPullParserException, IOException {
        if (xmlPullParser.getEventType() != 2) {
    ...
    public static void emc(XmlPullParser xmlPullParser, String str, int i10) throws XmlPullParserException, IOException {
    ...
    private static List<com.bytedance.sdk.openadsdk.core.sup.ypw.xq> emc(String str, boolean z10) {
        if (TextUtils.isEmpty(str)) {
            return new ArrayList();
        }
        return Collections.singletonList(new xq.emc(str).emc(z10).emc());
    }
}
