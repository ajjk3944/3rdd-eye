...
public class bw extends ycc.emc {
    ...
    private TTCeilingLandingPageActivity.emc f9303aa;
    ...
    public bw(Context context, rtt rttVar, String str, com.bytedance.sdk.openadsdk.common.bw bwVar, sz szVar, boolean z10, boolean z11, TTCeilingLandingPageActivity.emc emcVar) {
        this(context, rttVar, str, bwVar, szVar, z10);
        this.vk = z11;
        this.f9303aa = emcVar;
    }
    ...
    public boolean shouldOverrideUrlLoading(WebView webView, final String str) {
        ...
        try {
            ...
            com.bytedance.sdk.component.utils.ypw.emc(this.dg, uri2, new ypw.InterfaceC0122ypw() { // from class: com.bytedance.sdk.openadsdk.core.widget.emc.bw.1
    ...
    public void xq() {
        ...
        sup supVar = this.ru;
        if (supVar != null) {
            com.bytedance.sdk.openadsdk.dg.xq.emc(CampaignEx.JSON_NATIVE_VIDEO_CLICK, this.ul, supVar, this.ypw, true, this.gbl, 1);
            this.sup = true;
            return;
        }
        JSONObject jSONObject = this.yzg;
        if (jSONObject != null) {
            com.bytedance.sdk.openadsdk.dg.xq.emc(this.ul, this.ypw, CampaignEx.JSON_NATIVE_VIDEO_CLICK, jSONObject);
            this.sup = true;
        }
    }
    ...
    public bw(Context context, rtt rttVar, String str, com.bytedance.sdk.openadsdk.common.bw bwVar, sz szVar, boolean z10) {
        this(context, rttVar, str, szVar, z10);
        this.sz = bwVar;
    }
    ...
    public bw(Context context, rtt rttVar, String str, sz szVar, boolean z10) {
        this.uym = true;
        this.msw = true;
        this.zz = false;
        this.dg = context;
    ...
    private boolean emc(WebView webView, String str) {
        ...
        TTCeilingLandingPageActivity.emc emcVar = this.f9303aa;
        if (emcVar != null) {
            emcVar.emc();
        }
        return true;
    ...
    public void emc(final String str, final boolean z10, final int i10, final String str2, final String str3) {
