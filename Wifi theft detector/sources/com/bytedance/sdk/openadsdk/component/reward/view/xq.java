...
public class xq extends ul {
    ...
    private void xq(qh qhVar) {
        ...
        try {
            ...
            if (mswVar == null || mswVar.wo() == null) {
                ...
                z10 = mswVarGbl == mswVar2;
                if (!mswVar2.wo().sra() && z10) {
                    z11 = false;
                }
            }
            boolean z12 = z11;
            com.bytedance.sdk.openadsdk.ylm.emc.emc emcVar = new com.bytedance.sdk.openadsdk.ylm.emc.emc(this.zz, this.sup, this.bw.rqm, z12, frameLayoutVk);
            this.uym = emcVar;
            emcVar.emc(this.bw.tp);
            this.uym.emc(false, (com.bytedance.sdk.openadsdk.sz.ycc) null);
            this.uym.emc();
            com.bytedance.sdk.component.utils.ul.emc("TTAD.FRExpressView", "initPlayable success mute = " + this.bw.yz + ",isCurrentScene->" + z10 + ",isMute = " + z12);
    ...
    @Override // com.bytedance.sdk.openadsdk.core.zz.ul, com.bytedance.sdk.openadsdk.core.zz.cf
    public void emc(int i10, qh qhVar) {
        cf cfVar = this.ypw;
        if (cfVar != null) {
            cfVar.emc(i10, qhVar);
        }
