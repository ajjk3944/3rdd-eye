...
public class ru {
    ...
    public ru(emc emcVar) {
        ...
        this.ypw = new com.bytedance.sdk.openadsdk.core.xq.ypw(emcVar.mxo, emcVar.ypw, emcVar.bw, emcVar.dg ? 7 : 5) { // from class: com.bytedance.sdk.openadsdk.component.reward.emc.ru.1
            ...
            public void emc(View view, float f10, float f11, float f12, float f13, SparseArray<xq.emc> sparseArray, boolean z10) {
                try {
                    ru.this.emc(view, f10, f11, f12, f13, sparseArray, this.sf, this.db, this.sb);
                } catch (Exception e10) {
                    ul.xq("TTAD.RFReportManager", "onClickReport error :" + e10.getMessage());
                }
    ...
    private boolean uym() {
        ...
        boolean z10 = mswVar != null && mswVar.wo().ee();
        emc emcVar2 = this.emc;
        boolean z11 = emcVar2.wpn;
        com.bytedance.sdk.openadsdk.activity.msw mswVar2 = emcVar2.pe;
        return z10 && !z11 && (mswVar2 != null && !mswVar2.wd());
    }
    ...
    public com.bytedance.sdk.openadsdk.core.xq.bw xq() {
        ...
        this.xq.emc(new emc.InterfaceC0166emc() { // from class: com.bytedance.sdk.openadsdk.component.reward.emc.ru.3
    ...
    public void ypw() {
        ...
        if (rieVar == null || !rieVar.yz()) {
            ...
            emc(jSONObject, msw(), z10, iGbl, false);
        }
    }
    ...
    public void emc() {
        ...
        emc(jSONObject, jSONObjectMsw, z10, iGbl, true);
    }

    public void xq(boolean z10) {
        emc emcVar = this.emc;
        if (emcVar != null && z10 && emcVar.ypw.pdv() && !this.emc.ypw.sb()) {
    ...
    public void ypw(boolean z10) {
        ...
        if (!z10 && emcVar.hj > 0 && (rieVar = emcVar.ypw) != null && rieVar.yz()) {
        ...
        com.bytedance.sdk.openadsdk.ee.ypw.bw.emc(this.emc.ypw, z10 ? 4 : 8);
        com.bytedance.sdk.openadsdk.ee.emc.xq.emc(this.emc.ypw, z10 ? 4 : 8);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void emc(JSONObject jSONObject, JSONObject jSONObject2, boolean z10, int i10, boolean z11) {
        ...
        if (rieVar == null || !rieVar.yz()) {
            ...
            Runnable runnable = new Runnable() { // from class: com.bytedance.sdk.openadsdk.component.reward.emc.ru.2
                ...
                public void run() {
                    ...
                    boolean z11 = z10;
                    ru ruVar = ru.this;
                    ruVar.emc(jSONObject3, ruVar.msw(), z11, i10, false);
                }
            };
    ...
    public void emc(boolean z10) {
        ...
        com.bytedance.sdk.openadsdk.vk.emc.dg dgVarBw = com.bytedance.sdk.openadsdk.vk.emc.dg.ypw().emc(z10 ? 7 : 8).xq(String.valueOf(rieVar.tx())).bw(this.emc.ypw.lvs());
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void emc(View view, float f10, float f11, float f12, float f13, SparseArray<xq.emc> sparseArray, int i10, int i11, int i12) {
        if (view == null) {
            return;
        }
        ...
        ypw(view, f10, f11, f12, f13, sparseArray, i10, i11, i12);
    }
    ...
    public com.bytedance.sdk.openadsdk.core.xq.bw emc(final emc emcVar, final rie rieVar) {
        return new com.bytedance.sdk.openadsdk.core.xq.bw(emcVar.mxo, rieVar, emcVar.bw, emcVar.dg ? 7 : 5) { // from class: com.bytedance.sdk.openadsdk.component.reward.emc.ru.4
            ...
            public void emc(View view, float f10, float f11, float f12, float f13, SparseArray<xq.emc> sparseArray, int i10, int i11, int i12, boolean z10) {
                ...
                com.bytedance.sdk.openadsdk.activity.msw mswVar = emcVar.pe;
                if (mswVar != null) {
                    mswVar.emc(map, f10, f11);
                }
                emc(map);
                emcVar.tp.mkp();
                emcVar.sra.emc(view, f10, f11, f12, f13, sparseArray, i10, i11, i12, new dg.emc() { // from class: com.bytedance.sdk.openadsdk.component.reward.emc.ru.4.1
                    ...
                    @Override // com.bytedance.sdk.openadsdk.component.reward.emc.dg.emc
                    public void emc(View view2, float f14, float f15, float f16, float f17, SparseArray<xq.emc> sparseArray2, int i13, int i14, int i15) {
                        ru.this.emc(view2, f14, f15, f16, f17, sparseArray2, i13, i14, i15);
                    }
                });
