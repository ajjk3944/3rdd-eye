...
public class sz {
    ...
    public void qh() {
        ...
        com.bytedance.sdk.openadsdk.core.gbl.dg.ypw ypwVar = new com.bytedance.sdk.openadsdk.core.gbl.dg.ypw(this.ypw.mxo, this.emc, emcVarMxo, this.zz, new com.bytedance.sdk.openadsdk.core.gbl.uym.ypw() { // from class: com.bytedance.sdk.openadsdk.component.reward.emc.sz.3
            ...
            public void ypw(String str) {
                sz szVar = sz.this;
                com.bytedance.sdk.openadsdk.dg.xq.emc(szVar.emc, true, szVar.zz, "success", SystemClock.elapsedRealtime() - sz.this.sup, str, CampaignEx.JSON_NATIVE_VIDEO_ENDCARD, 0, null);
            }
            ...
            public void emc(int i10, String str, String str2) {
                ...
                sz szVar = sz.this;
                com.bytedance.sdk.openadsdk.dg.xq.emc(szVar.emc, true, szVar.zz, "fail", SystemClock.elapsedRealtime() - sz.this.sup, str2, CampaignEx.JSON_NATIVE_VIDEO_ENDCARD, i10, str);
            }
    ...
    public void xq() {
        ...
        com.bytedance.sdk.openadsdk.core.gbl.dg.ypw ypwVar = new com.bytedance.sdk.openadsdk.core.gbl.dg.ypw(this.ypw.mxo, this.emc, emcVarIyl, this.zz, new com.bytedance.sdk.openadsdk.core.gbl.uym.ypw() { // from class: com.bytedance.sdk.openadsdk.component.reward.emc.sz.1
            ...
            public void ypw(String str) {
                sz.this.cf = str;
                sz szVar = sz.this;
                com.bytedance.sdk.openadsdk.dg.xq.emc(szVar.emc, false, szVar.zz, "success", SystemClock.elapsedRealtime() - sz.this.gbl, str, CampaignEx.JSON_NATIVE_VIDEO_ENDCARD, 0, null);
            }
            ...
            public void emc(int i10, String str, String str2) {
                ...
                sz szVar = sz.this;
                com.bytedance.sdk.openadsdk.dg.xq.emc(szVar.emc, false, szVar.zz, "fail", SystemClock.elapsedRealtime() - sz.this.gbl, str2, CampaignEx.JSON_NATIVE_VIDEO_ENDCARD, i10, str);
            }
            ...
            public void emc(int i10, String str) {
                ...
                sz szVar = sz.this;
                com.bytedance.sdk.openadsdk.dg.xq.emc(szVar.emc, szVar.zz, jElapsedRealtime - sz.this.ycc, i10, str, (String) null);
            }
    ...
    public void ypw() {
        this.xq = (FrameLayout) this.ypw.iyl.findViewById(com.bytedance.sdk.openadsdk.utils.vk.f9315aa);
    }
