...
public class zz {
            ...
            if (dr.uym(this.ru)) {
                ...
                if (emcVar2 == null || !emcVar2.bw()) {
                    ...
                    dg.ycc yccVar2 = new dg.ycc(iLce) { // from class: com.bytedance.sdk.openadsdk.component.reward.emc.zz.4
                        @Override // com.bytedance.sdk.openadsdk.activity.dg.ycc
                        public void emc() {
                            zz.this.sup.ra.sendEmptyMessage(Sdk$SDKError.Reason.NATIVE_ASSET_ERROR_VALUE);
                        }
                    };
                    this.ypw = yccVar2;
                    yccVar2.bw();
    ...
    public void qh() throws JSONException {
        ...
        this.sup.ra.removeMessages(Sdk$SDKError.Reason.NATIVE_ASSET_ERROR_VALUE);
    }
    ...
    public void ycc() {
        if (this.qh && !this.vk) {
            ...
            FrameLayout frameLayout = this.f9276aa;
            if (frameLayout != null) {
    ...
    public void ypw(boolean z10) {
        if (this.qh) {
            emc emcVar = this.sup;
            if (emcVar.wo) {
                this.f9276aa = (FrameLayout) emcVar.iyl.findViewById(com.bytedance.sdk.openadsdk.utils.vk.lce);
                emc(z10);
                vk();
            }
        }
    ...
    public void emc(boolean z10) {
        ...
        if (frameLayout != null) {
            ...
            int i10 = emcVar.rqm;
            com.bytedance.sdk.openadsdk.activity.msw mswVar = emcVar.pe;
            com.bytedance.sdk.openadsdk.ylm.emc.emc emcVar2 = new com.bytedance.sdk.openadsdk.ylm.emc.emc(context, rieVar, i10, z10, frameLayout, false, mswVar != null ? mswVar.ra() : 0);
            this.sba = emcVar2;
