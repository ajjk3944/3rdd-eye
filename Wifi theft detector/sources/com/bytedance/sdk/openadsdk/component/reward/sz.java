...
public class sz {
    ...
    public interface emc {
        Intent emc(Context context, rie rieVar, @Nullable Activity activity);

        void emc(Intent intent, @Nullable Activity activity, rie rieVar, boolean z10);
    ...
    public void emc(Double d10) {
        ...
        com.bytedance.sdk.openadsdk.core.model.emc emcVar = this.ypw;
        if (emcVar != null && emcVar.ycc() != null) {
            xmt.emc(this.ypw.ycc(), d10);
        }
        this.ycc = true;
    }

    public void emc(Double d10, String str, String str2) {
        if (this.uym) {
            return;
        }
        com.bytedance.sdk.openadsdk.core.model.emc emcVar = this.ypw;
        if (emcVar != null && emcVar.ycc() != null) {
            xmt.emc(this.ypw.ycc(), d10, str, str2);
        }
        this.uym = true;
    }

    public void emc(@Nullable Activity activity) {
        ...
        throw new IllegalStateException("Cannot be called in a child thread —— " + this.xq + ".show");
    }

    private void emc(Context context, Intent intent, final rie rieVar, boolean z10) {
        final boolean z11 = com.bytedance.sdk.openadsdk.sra.emc.emc("start_activity_async", 0) == 1;
        if (z11) {
            com.bytedance.sdk.openadsdk.sba.xq.emc(new com.bytedance.sdk.openadsdk.sba.dg() { // from class: com.bytedance.sdk.openadsdk.component.reward.sz.1
                ...
                public com.bytedance.sdk.openadsdk.sba.ypw.emc emc() {
                    ...
                    emcVar.ypw("start_activity");
                    emcVar.dg(sz.this.xq);
                    return emcVar;
                }
            });
        }
        final long jElapsedRealtime = SystemClock.elapsedRealtime();
        com.bytedance.sdk.component.utils.ypw.emc(context, intent, new ypw.InterfaceC0122ypw() { // from class: com.bytedance.sdk.openadsdk.component.reward.sz.2
