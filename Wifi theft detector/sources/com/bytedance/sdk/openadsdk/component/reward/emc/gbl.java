...
public class gbl {
    ...
    public static abstract class emc implements View.OnLayoutChangeListener {
        ...
        public abstract void emc(int i10, int i11);

        @Override // android.view.View.OnLayoutChangeListener
        public void onLayoutChange(View view, int i10, int i11, int i12, int i13, int i14, int i15, int i16, int i17) {
            int i18 = i12 - i10;
            int i19 = i13 - i11;
            if (i18 == this.emc && i19 == this.ypw) {
                return;
            }
            this.emc = i18;
            this.ypw = i19;
    ...
    private static boolean emc(int i10, int i11) {
        return i10 == 2 && i11 == 2;
    }
    ...
    private float[] ypw(int i10) {
        float fBw = bw();
        float fDg = dg();
        int i11 = this.ypw.rqm;
        if ((i11 == 1) != (fBw > fDg)) {
            float f10 = fBw + fDg;
            fDg = f10 - fDg;
            fBw = f10 - fDg;
    ...
    public static class ypw {
        ...
        public void emc(final Activity activity, final int i10, final float f10, final boolean z10) {
            if (this.emc == null) {
                try {
                    final boolean z11 = com.bytedance.sdk.openadsdk.core.aa.dg().yz() == 1;
                    ...
                    if (zXq || z11) {
                        try {
                            this.emc = new emc() { // from class: com.bytedance.sdk.openadsdk.component.reward.emc.gbl.ypw.1
                                ...
                                private void ypw() {
                                    try {
                                        int iXq = gbl.xq(activity, i10);
                                        View decorView = activity.getWindow().getDecorView();
                                        if (iXq == 0) {
                                            int[] iArrYpw = gbl.ypw(activity, decorView, i10, zXq, z11);
                                            if (iArrYpw[4] == 1) {
                                                this.emc = gbl.ypw(decorView, iArrYpw[0], iArrYpw[1], iArrYpw[2], iArrYpw[3], f10);
                                            }
                                        } else if (this.emc) {
                                ...
                                public void emc(int i11, int i12) {
                                    if (z10) {
                                        ypw();
                                    } else {
                                        emc();
    ...
    public static int xq(Activity activity, int i10) {
    ...
    private static void ypw(Activity activity, int i10) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static boolean ypw(View view, int i10, int i11, int i12, int i13, float f10) {
    ...
    */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static int[] ypw(Activity activity, View view, int i10, boolean z10, boolean z11) {
        int paddingLeft;
        int paddingBottom;
        int paddingTop;
        int paddingRight;
    ...
    public float[] emc(int i10) {
        ...
        if (this.xq && paddingLeft == 0 && paddingTop == 0 && xq(activity, i10) == 0) {
            int[] iArrYpw = ypw(activity, decorView, i10, vw.xq(activity), com.bytedance.sdk.openadsdk.core.aa.dg().yz() == 1);
            int i11 = iArrYpw[0];
            paddingTop = iArrYpw[1];
            paddingLeft = i11;
        }
        int i12 = Build.VERSION.SDK_INT;
        if (i12 >= 35 && this.ypw.ypw.kx() == 100.0f) {
            ...
            public void onSystemUiVisibilityChange(int i10) {
                if (i10 == 0) {
                    try {
                        ...
                        ul.xq("TTAD.RFSM", e10.getMessage());
                    }
                }
            }
        });
