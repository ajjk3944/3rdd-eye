...
public class vk {
    ...
    public static class emc implements PAGRewardedAdLoadListener {
        ...
        public emc(Context context, AdSlot adSlot, com.bytedance.sdk.openadsdk.core.model.emc emcVar, PAGRewardedAdLoadListener pAGRewardedAdLoadListener, boolean z10) {
            this.emc = context;
            this.ypw = adSlot;
            this.xq = emcVar;
    ...
    public static class ypw extends com.bytedance.sdk.component.msw.msw {
        ...
        public void run() {
            ...
            com.bytedance.sdk.openadsdk.core.sz.bw.emc.emc(ypwVarEmc, new b() { // from class: com.bytedance.sdk.openadsdk.component.reward.vk.ypw.1
    ...
    private void xq(AdSlot adSlot, PAGRewardedAdLoadListener pAGRewardedAdLoadListener) {
    ...
    public void emc(AdSlot adSlot, PAGRewardedAdLoadListener pAGRewardedAdLoadListener) {
        if (com.bytedance.sdk.openadsdk.utils.ypw.emc()) {
    ...
    private void emc(com.bytedance.sdk.openadsdk.core.model.emc emcVar, AdSlot adSlot, PAGRewardedAdLoadListener pAGRewardedAdLoadListener) {
        com.bytedance.sdk.openadsdk.core.model.emc emcVar2;
        vk vkVar;
        ...
        if (pAGRewardedAdLoadListener != null) {
            ...
            for (int i10 = 0; i10 < emcVar2.dg().size(); i10++) {
                emc(emcVar2.dg().get(i10), adSlot3, xqVar, yzgVar);
                if (emcVar2.ru()) {
                    break;
                }
            }
        ...
        for (final int i11 = 0; i11 < emcVar2.dg().size(); i11++) {
            com.bytedance.sdk.openadsdk.core.sz.xq.emc.emc().emc(emcVar2.dg().get(i11), new emc.InterfaceC0163emc() { // from class: com.bytedance.sdk.openadsdk.component.reward.vk.5
                @Override // com.bytedance.sdk.openadsdk.core.sz.xq.emc.InterfaceC0163emc
                public void emc(boolean z10) {
                    com.bytedance.sdk.component.utils.ul.emc("RewardVideoLoadManager", "onCachedResponse: i=" + i11 + ", isSuccess=" + z10);
                }
            });
        }
    }
    ...
    */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void emc(com.bytedance.sdk.openadsdk.core.model.emc emcVar, yzg yzgVar, AdSlot adSlot, boolean z10, PAGRewardedAdLoadListener pAGRewardedAdLoadListener) {
        if (!z10) {
        ...
        while (i10 < emcVar.dg().size()) {
            ...
            boolean z11 = z10;
            AdSlot adSlot3 = adSlot2;
            emc(emcVar, rieVar, yzgVar2, adSlot3, z11, xqVar);
            adSlot2 = adSlot3;
            if (emcVar.ru() && iFu != 43) {
                return;
            }
    ...
    private void emc(com.bytedance.sdk.openadsdk.core.model.emc emcVar) {
        ...
        for (final int i10 = 0; i10 < emcVar.dg().size(); i10++) {
            rie rieVar = emcVar.dg().get(i10);
            if (i10 >= iVk) {
                return;
            }
            com.bytedance.sdk.openadsdk.core.sz.xq.emc.emc().emc(rieVar, new emc.InterfaceC0163emc() { // from class: com.bytedance.sdk.openadsdk.component.reward.vk.8
                @Override // com.bytedance.sdk.openadsdk.core.sz.xq.emc.InterfaceC0163emc
                public void emc(boolean z10) {
                    com.bytedance.sdk.component.utils.ul.emc("RewardVideoLoadManager", "onCachedResponse: i=" + i10 + ", isSuccess=" + z10);
                }
            });
        }
    }

    private void emc(final com.bytedance.sdk.openadsdk.core.model.emc emcVar, rie rieVar, yzg yzgVar, final AdSlot adSlot, final boolean z10, xq xqVar) {
        final yzg yzgVar2;
        final xq xqVar2;
        if (z10 && !dr.xq(rieVar) && com.bytedance.sdk.openadsdk.core.aa.dg().db(adSlot.getCodeId()).dg == 1 && !com.bytedance.sdk.component.utils.sba.dg(this.ypw)) {
            emc(new ypw(rieVar, adSlot, emcVar));
            return;
        }
        boolean z11 = false;
        boolean z12 = xqVar != null && com.bytedance.sdk.openadsdk.core.aa.dg().sf() == 1;
        if (dr.xq(rieVar)) {
            yzgVar2 = yzgVar;
            xqVar2 = xqVar;
            if (z10) {
            ...
            if (rieVar.iat() != null) {
                ...
                yzgVar2 = yzgVar;
                xqVar2 = xqVar;
                com.bytedance.sdk.openadsdk.core.sz.bw.emc.emc(ypwVarEmc, new b() { // from class: com.bytedance.sdk.openadsdk.component.reward.vk.9
                    @Override // r2.a.InterfaceC0474a
                    public void emc(com.bykv.vk.openvk.emc.emc.emc.xq.xq xqVar3, int i10) {
                        yzgVar2.ypw();
                        if (z10) {
                    ...
                    @Override // r2.a.InterfaceC0474a
                    public void emc(com.bykv.vk.openvk.emc.emc.emc.xq.xq xqVar3, int i10, String str) {
                        if (xqVar2 == null || com.bytedance.sdk.openadsdk.core.aa.dg().sf() != 1) {
                            return;
                        }
                        xqVar2.onError(i10, str);
                    }
                });
            } else {
                yzgVar2 = yzgVar;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void emc(final AdSlot adSlot, final com.bytedance.sdk.openadsdk.core.model.emc emcVar, PAGRewardedAdLoadListener pAGRewardedAdLoadListener, PAGRewardedAd pAGRewardedAd, final boolean z10) {
