...
public abstract class ypw extends emc {
    ...
    public void aa() {
        ...
        try {
            ...
            boolean z10 = emcVar2.wpn;
            boolean z11 = emcVar2.yz;
            if (!emcVar2.ru.get()) {
                this.emc.ylm.cf();
            }
            qh();
    ...
    */
    public void rie() {
        ...
        L12:
            ...
            goto L4b
        L3a:
            int r0 = com.bytedance.sdk.openadsdk.dg.ypw.C0174ypw.emc
            r4.emc(r0)
    ...
    public void vk() {
        int i10;
        if (this.emc.zz.get() && this.emc.sba.getAndSet(false) && ((i10 = this.emc.uym) >= 0 || i10 == -1)) {
    ...
    public void emc(boolean z10, boolean z11, boolean z12, int i10) {
        this.emc.rtt.emc(z10, z11, z12, this, i10);
    }
    ...
    private boolean emc(com.bytedance.sdk.openadsdk.component.reward.emc.emc emcVar, int i10) {
        if (i10 == -1) {
            return false;
        }
        boolean z10 = !emcVar.zz.get() || dr.xq(emcVar.ypw);
        cf cfVar = emcVar.ylm;
        boolean z11 = cfVar != null && cfVar.sz() >= ((long) i10) * 1000;
        msw mswVar = emcVar.rie;
        return z10 && (z11 || (mswVar != null && mswVar.dg()));
    }
    ...
    */
    ...
    private void emc(long j10, long j11) {
        long j12 = j11 - j10;
        Activity activity = this.emc.mxo;
        if (activity instanceof TTRewardVideoActivity) {
            ((TTRewardVideoActivity) activity).xq(j12, j11);
        }
    }
    ...
    public static void emc(FrameLayout frameLayout, final com.bytedance.sdk.openadsdk.component.reward.emc.emc emcVar) {
        ...
        if (emcVar.wo) {
            ...
            frameLayout2.setId(com.bytedance.sdk.openadsdk.utils.vk.f9315aa);
