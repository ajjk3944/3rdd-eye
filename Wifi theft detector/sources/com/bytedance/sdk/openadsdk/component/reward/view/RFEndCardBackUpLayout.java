...
public class RFEndCardBackUpLayout extends com.bytedance.sdk.openadsdk.core.ycc.xq {
    ...
    public static final class emc extends Drawable {
        ...
        public void setBounds(int i10, int i11, int i12, int i13) {
            ...
            float f10 = i12;
            this.ypw.setBounds(i10, i11, i12, (int) (((1.0f * f10) / this.ypw.getIntrinsicWidth()) * this.ypw.getIntrinsicHeight()));
            this.emc.reset();
            Path path = this.emc;
    ...
    private void initOneSlotMultipleAdsLayoutForThreeAdVertical(com.bytedance.sdk.openadsdk.core.ycc.bw bwVar) {
        ...
        if (rieVar != null) {
            ...
            for (int i10 = 0; i10 < listDg.size() && i10 < 3; i10++) {
                initSingleCardInThreeCardStyle(bwVar, listDg.get(i10), i10);
            }
        }
    }
    ...
    private void initOneSlotMultipleAdsLayoutForTwoAdVertical(com.bytedance.sdk.openadsdk.core.ycc.bw bwVar) {
        ...
        if (rieVar != null) {
            List<com.bytedance.sdk.openadsdk.core.model.rie> listDg = rieVar.dg().dg();
            for (int i10 = 0; i10 < listDg.size() && i10 < 2; i10++) {
                initSingleCardInTwoCardStyle(bwVar, listDg.get(i10), i10);
            }
        }
    }

    private void initOneSlotMultipleAdsLayoutLandscape(com.bytedance.sdk.openadsdk.core.ycc.bw bwVar, int i10) {
        com.bytedance.sdk.openadsdk.core.model.rie rieVar = this.adContext.ypw;
        if (rieVar != null) {
            List<com.bytedance.sdk.openadsdk.core.model.rie> listDg = rieVar.dg().dg();
            for (int i11 = 0; i11 < listDg.size() && i11 < i10 && i11 < 3; i11++) {
                initSingleCardInTwoCardStyleLandscape(bwVar, listDg.get(i11), i11, i10);
            }
        }
    }

    private void initSingleCardInThreeCardStyle(com.bytedance.sdk.openadsdk.core.ycc.bw bwVar, com.bytedance.sdk.openadsdk.core.model.rie rieVar, int i10) {
        Context context = getContext();
        com.bytedance.sdk.openadsdk.core.ycc.bw bwVar2 = new com.bytedance.sdk.openadsdk.core.ycc.bw(context);
        bwVar2.setOrientation(1);
        bwVar2.setGravity(1);
        FrameLayout.LayoutParams layoutParams = new FrameLayout.LayoutParams(-1, -2);
        layoutParams.setMargins(0, i10 > 0 ? vw.ypw(context, 12.0f) : 0, 0, 0);
        ...
        setDownloadButtonData(mswVar4, rieVar, i10);
    }

    private void initSingleCardInTwoCardStyle(com.bytedance.sdk.openadsdk.core.ycc.bw bwVar, com.bytedance.sdk.openadsdk.core.model.rie rieVar, int i10) {
        Context context = getContext();
        com.bytedance.sdk.openadsdk.core.ycc.bw bwVar2 = new com.bytedance.sdk.openadsdk.core.ycc.bw(context);
        bwVar2.setOrientation(1);
        bwVar2.setGravity(1);
    ...
    private void initSingleCardInTwoCardStyleLandscape(com.bytedance.sdk.openadsdk.core.ycc.bw bwVar, com.bytedance.sdk.openadsdk.core.model.rie rieVar, int i10, int i11) {
        Context context = getContext();
        com.bytedance.sdk.openadsdk.core.ycc.bw bwVar2 = new com.bytedance.sdk.openadsdk.core.ycc.bw(context);
        bwVar2.setOrientation(1);
        bwVar2.setGravity(1);
    ...
    private void initViewsDefault() {
        Context context = getContext();
        boolean z10 = this.adContext.ypw.ono() == 1;
    ...
    private void setDownloadButtonData(com.bytedance.sdk.openadsdk.core.ycc.msw mswVar, com.bytedance.sdk.openadsdk.core.model.rie rieVar, int i10) {
        com.bytedance.sdk.openadsdk.component.reward.emc.emc emcVar = this.adContext;
