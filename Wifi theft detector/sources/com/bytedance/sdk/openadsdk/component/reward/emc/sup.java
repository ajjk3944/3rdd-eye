...
public class sup {
    ...
    public void emc(int i10) {
        ...
        com.bytedance.sdk.openadsdk.component.reward.top.xq xqVar = this.emc;
        if (xqVar == null || xqVar.getITopLayout() == null || i10 == 0 || (viewFindViewById = this.emc.getITopLayout().findViewById(520093713)) == null || !(viewFindViewById.getLayoutParams() instanceof ViewGroup.MarginLayoutParams) || viewFindViewById.getWidth() <= 0 || viewFindViewById.getVisibility() != 0) {
            return;
        }
        int[] iArr = new int[2];
        ...
        if (width < vw.ypw(this.xq, 16.0f)) {
            ((ViewGroup.MarginLayoutParams) viewFindViewById.getLayoutParams()).rightMargin += vw.ypw(this.xq, 16.0f) - width;
