...
public class TopLayoutDislike2 extends bw implements emc<TopLayoutDislike2> {
    ...
    @Override // com.bytedance.sdk.openadsdk.component.reward.top.emc
    public void setShowEndCardNextAd(boolean z10, com.bytedance.sdk.openadsdk.core.model.rie rieVar) {
        bw bwVar = this.mPlayableNextAd;
        if (bwVar != null) {
            bwVar.setVisibility(z10 ? 0 : 8);
            if (this.mNextAdTextTv == null || !z10 || rieVar == null || rieVar.ivb() == null) {
                return;
            }
    ...
    @Override // com.bytedance.sdk.openadsdk.component.reward.top.emc
    public void setShowPlayableNextAd(boolean z10, com.bytedance.sdk.openadsdk.core.model.rie rieVar) {
        bw bwVar = this.mPlayableNextAd;
        if (bwVar != null) {
            bwVar.setVisibility(z10 ? 0 : 8);
    ...
    public void setSoundMute(boolean z10) {
        ...
        this.mImgSound.setImageDrawable(this.mSkipIV != null ? z10 ? rie.xq(getContext(), "tt_reward_full_mute") : rie.xq(getContext(), "tt_reward_full_unmute") : z10 ? gbl.emc(getContext(), "tt_mute_wrapper") : gbl.emc(getContext(), "tt_unmute_wrapper"));
    ...
    */
    public com.bytedance.sdk.openadsdk.component.reward.top.TopLayoutDislike2 load(@androidx.annotation.NonNull com.bytedance.sdk.openadsdk.core.model.rie r7) {
        /*
