...
public class xq {
    ...
    public xq(Activity activity, rie rieVar, FrameLayout frameLayout, com.bytedance.sdk.openadsdk.component.emc emcVar, int i10, boolean z10, com.bytedance.sdk.openadsdk.component.msw.emc emcVar2) {
        this.emc = activity;
        this.ypw = rieVar;
        this.dg = frameLayout;
        this.uym = i10;
    ...
    public void emc(ViewGroup viewGroup) {
        ...
        this.f9278aa = xqVar.getBackImage();
    ...
    public void emc(Object obj) {
        try {
            if (obj instanceof Bitmap) {
                this.f9278aa.setImageDrawable(new BitmapDrawable(com.bytedance.sdk.openadsdk.core.aa.emc().getResources(), (Bitmap) obj));
            }
    ...
    public void emc(com.bytedance.sdk.openadsdk.yzg.emc.ypw ypwVar) {
        ...
        if (drawableDg != null) {
            ...
            if (Build.VERSION.SDK_INT >= 28 && a.a(drawableDg)) {
                b.a(drawableDg).start();
            }
