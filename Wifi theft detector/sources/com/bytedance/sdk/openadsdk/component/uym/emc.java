...
public class emc {
    ...
    public static File emc(String str) {
        return new File(CacheDirFactory.getICacheDir(0).ypw() + File.separator + str);
    }
    ...
    public static void emc(JSONObject jSONObject, int i10, boolean z10) throws JSONException {
        try {
            ...
            if (jSONObject2.optJSONObject("video") == null) {
                ...
                jSONObject4.put("video_duration", aa.dg().rie(String.valueOf(i10)));
                jSONObject2.put("video", jSONObject4);
            }
        } catch (Exception e10) {
            ul.xq("TTAppOpenUtils", e10.getMessage());
        }
    }

    public static int emc(rie rieVar, int i10) {
        return i10 - rieVar.wy();
    }

    public static void emc(int i10) {
        AdSlot adSlotXq;
        if (bw() && (adSlotXq = sba.emc().xq()) != null && TextUtils.isEmpty(adSlotXq.getBidAdm())) {
            adSlotXq.setCacheScene(i10);
