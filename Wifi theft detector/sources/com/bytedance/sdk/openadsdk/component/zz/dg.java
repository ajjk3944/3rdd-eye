...
public class dg extends xq {
    ...
    private final com.bytedance.sdk.openadsdk.core.ycc.bw f9279aa;
    ...
    public static final class emc extends Drawable {
        ...
        public void onBoundsChange(@NonNull Rect rect) {
            ...
            boolean z10 = this.dg;
            this.ypw.setShader(new LinearGradient(0.0f, 0.0f, f12, 0.0f, new int[]{z10 ? ycc : bw, z10 ? bw : ycc}, (float[]) null, Shader.TileMode.CLAMP));
        }
