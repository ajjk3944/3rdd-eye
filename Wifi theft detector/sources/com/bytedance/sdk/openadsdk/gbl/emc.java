...
public class emc implements xq {
    ...
    @Override // com.bytedance.sdk.openadsdk.gbl.xq
    public void emc(Context context, JSONObject jSONObject, String str, int i10, boolean z10) {
        JSONObject jSONObjectOptJSONObject;
        if (context == null || jSONObject == null || (jSONObjectOptJSONObject = jSONObject.optJSONObject("data")) == null) {
            return;
        }
        emc(context, emc(jSONObjectOptJSONObject, str), jSONObjectOptJSONObject, i10, z10);
    }

    private void emc(Context context, rie rieVar, JSONObject jSONObject, int i10, boolean z10) {
        if (context == null || rieVar == null || rieVar.mjd() == null || jSONObject == null || this.ypw == null || this.xq.get(rieVar.mjd().emc()) != null) {
            return;
        }
        String strYpw = tp.ypw(i10);
    ...
    private void emc(rie rieVar, JSONObject jSONObject) throws JSONException {
        ...
        if (this.xq.containsKey(strEmc)) {
            ...
            try {
                ...
                ul.xq("JsAppAdDownloadManager", e10.getMessage());
            }
        }
    }

    private com.bytedance.sdk.openadsdk.ul.emc.emc.xq emc(@NonNull Context context, @NonNull String str) {
