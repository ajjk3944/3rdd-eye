...
public class emc {
    ...
    public interface InterfaceC0135emc {
    ...
    public static boolean ypw(vk vkVar, com.bytedance.sdk.openadsdk.component.reward.emc.emc emcVar, boolean z10, String str) {
        if (vkVar == null) {
            return false;
        }
        if (!vkVar.emc(dr.xq(emcVar.ypw), z10, null) && (emcVar.pe instanceof com.bytedance.sdk.openadsdk.activity.bw)) {
    ...
    public static boolean ypw(com.bytedance.sdk.openadsdk.component.reward.emc.emc emcVar, View view) {
        ...
        emcVar.ra.sendEmptyMessageDelayed(Sdk$SDKError.Reason.NATIVE_ASSET_ERROR_VALUE, 5000L);
    ...
    public static void emc(com.bytedance.sdk.openadsdk.component.reward.emc.emc emcVar, com.bytedance.sdk.openadsdk.component.reward.ypw.ypw ypwVar, String str) {
        ...
        emcVar.yz = !emcVar.yz;
        boolean z10 = emcVar.pe instanceof com.bytedance.sdk.openadsdk.activity.bw;
        if (emcVar.wbn && !z10 && (zzVar = emcVar.hxp) != null && zzVar.emc() != null) {
