...
public class aa extends com.bytedance.sdk.openadsdk.core.ycc.xq implements ru.ypw {
    ...
    public aa(@NonNull Context context, @NonNull rie rieVar) {
    ...
    private sup.emc ycc() {
        return new sup.emc() { // from class: com.bytedance.sdk.openadsdk.common.aa.2
            ...
            @Override // com.bytedance.sdk.openadsdk.xq.sup.emc
            public void emc(int i10, FilterWord filterWord, String str) {
                aa.this.uym.xq(str);
                aa.this.setVisibility(0);
            }
        };
    ...
    public aa(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        this(context, attributeSet, 0);
    }

    public aa(@NonNull Context context, @Nullable AttributeSet attributeSet, int i10) {
    ...
    public void emc(int i10) {
        if (com.bytedance.sdk.openadsdk.xq.ru.ypw == i10) {
        ...
        if (com.bytedance.sdk.openadsdk.xq.ru.xq == i10) {
            ypw();
        } else if (com.bytedance.sdk.openadsdk.xq.ru.bw == i10) {
            xq();
        }
    }
}
