...
public class sz {
    ...
    public sz(Context context, rie rieVar, String str, boolean z10) {
        this.xq = context;
        this.emc = rieVar;
        this.ycc = str;
        this.msw = z10;
    ...
    private static RelativeLayout emc(Context context, boolean z10) {
        ...
        com.bytedance.sdk.component.zz.ycc yccVar = z10 ? new com.bytedance.sdk.component.zz.ycc(context, ycc.xq.PRIVACY) : new com.bytedance.sdk.component.zz.ycc(context, xqVar);
