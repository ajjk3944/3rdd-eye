...
public class ul extends com.bytedance.sdk.openadsdk.core.ycc.xq {
    ...
    public ul(Context context, boolean z10) {
        super(context);
        this.emc = context;
        this.dg = z10;
        ypw();
    ...
    private void ypw() {
        ...
        setOnTouchListener(new View.OnTouchListener() { // from class: com.bytedance.sdk.openadsdk.common.a
            ...
            public final boolean onTouch(View view, MotionEvent motionEvent) {
                return this.f9263a.emc(view, motionEvent);
            }
        });
        ...
        emc(bwVarEmc, context2.getString(rie.ypw(context2, "tt_more_retry")), "tt_more_retry_icon", new View.OnClickListener() { // from class: com.bytedance.sdk.openadsdk.common.c
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f9266a.bw(view);
            }
        ...
        emc(bwVarEmc, context3.getString(rie.ypw(context3, "tt_more_copy_link")), "tt_more_copy_icon", new View.OnClickListener() { // from class: com.bytedance.sdk.openadsdk.common.d
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f9267a.dg(view);
            }
        ...
        emc(bwVarEmc, context4.getString(rie.ypw(context4, "tt_more_open_browser")), "tt_more_browser_icon", new View.OnClickListener() { // from class: com.bytedance.sdk.openadsdk.common.e
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f9268a.xq(view);
            }
        ...
        emc(bwVarEmc2, context5.getString(rie.ypw(context5, "tt_more_report")), "tt_more_report_icon", new View.OnClickListener() { // from class: com.bytedance.sdk.openadsdk.common.f
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f9269a.ypw(view);
            }
        });
