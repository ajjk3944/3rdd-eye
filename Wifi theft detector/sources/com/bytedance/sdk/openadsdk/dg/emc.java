...
public class emc implements com.bytedance.sdk.component.ycc.emc.dg.emc.ypw {
    ...
    public static final class C0170emc {
        ...
        public C0170emc(long j10, rie rieVar) {
            this.f9312aa = -1;
            this.sba = -1;
            this.emc = -1;
            if (rieVar != null) {
                this.yzg = dr.ypw(rieVar);
                this.f9312aa = rieVar.nw();
                this.sba = rieVar.fu();
                this.emc = rieVar.in();
            }
            this.vk = j10;
        ...
        public C0170emc bw(String str) {
            this.msw = str;
            return this;
        }

        public C0170emc dg(String str) {
            this.bw = str;
            return this;
        }

        public C0170emc msw(String str) {
            this.ul = str;
            return this;
        }

        public C0170emc uym(String str) {
            this.uym = str;
            return this;
        }

        public C0170emc xq(String str) {
            this.dg = str;
            return this;
        }

        public C0170emc ycc(String str) {
            this.zz = str;
            return this;
        }

        public C0170emc ypw(String str) {
            this.xq = str;
            return this;
        }

        public C0170emc emc(String str) {
            this.sz = str;
            return this;
        }

        public C0170emc emc(JSONObject jSONObject) {
            if (jSONObject == null) {
                return this;
            }
            this.ru = jSONObject;
    ...
    private void uym() throws JSONException {
        ...
        if (!TextUtils.isEmpty(this.f9311aa)) {
            try {
                this.ypw.putOpt(AppMeasurementSdk.ConditionalUserProperty.VALUE, Long.valueOf(Long.parseLong(this.f9311aa)));
            } catch (NumberFormatException unused) {
                this.ypw.putOpt(AppMeasurementSdk.ConditionalUserProperty.VALUE, 0L);
            }
        }
    ...
    private void ycc() {
        ...
        if (jSONObject != null) {
            ...
            if (emc(this.f9311aa, this.vk, this.sra)) {
                ...
                if ((TextUtils.isEmpty(strOptString) || TextUtils.equals(strOptString, MBridgeConstans.ENDCARD_URL_TYPE_PL)) && (TextUtils.isEmpty(this.f9311aa) || TextUtils.equals(this.f9311aa, MBridgeConstans.ENDCARD_URL_TYPE_PL))) {
                    return;
                }
        ...
        } else if (!emc(this.f9311aa, this.vk, this.sra)) {
            return;
        }
            ...
            if (this.ypw.has("ad_extra_data")) {
                ...
                if (objOpt != null) {
                    try {
                        ...
                        ul.xq("AdEvent", "json error", e10.getMessage());
                    }
                }
            } else {
                ...
                try {
                    ...
                    ul.xq("AdEvent", "json error", e11.getMessage());
                }
            }
            this.sup.set(true);
        } catch (Throwable unused) {
    ...
    public emc(C0170emc c0170emc) throws JSONException {
        this.ycc = "adiff";
        this.sup = new AtomicBoolean(false);
        this.sz = new JSONObject();
        if (!TextUtils.isEmpty(c0170emc.ypw)) {
            this.emc = c0170emc.ypw;
        } else {
            this.emc = db.emc();
        }
        this.ul = c0170emc.cf;
        this.sra = c0170emc.ycc;
        this.qh = c0170emc.xq;
        this.cf = c0170emc.dg;
        if (!TextUtils.isEmpty(c0170emc.bw)) {
            this.vk = c0170emc.bw;
        } else {
            this.vk = "app_union";
        }
        this.ylm = c0170emc.gbl;
        this.f9311aa = c0170emc.msw;
        this.yzg = c0170emc.zz;
        this.sba = c0170emc.uym;
        this.rie = c0170emc.sup;
        this.hxp = c0170emc.sz;
        this.sz = c0170emc.ru = c0170emc.ru != null ? c0170emc.ru : new JSONObject();
        JSONObject jSONObject = new JSONObject();
        this.ypw = jSONObject;
        if (!TextUtils.isEmpty(c0170emc.sz)) {
            try {
                jSONObject.put("app_log_url", c0170emc.sz);
            } catch (JSONException e10) {
                ul.xq("AdEvent", e10.getMessage());
            }
        }
        this.uym = c0170emc.f9312aa;
        this.msw = c0170emc.sba;
        this.zz = c0170emc.emc;
        this.xq = c0170emc.yzg;
    ...
    public JSONObject emc(boolean z10) {
