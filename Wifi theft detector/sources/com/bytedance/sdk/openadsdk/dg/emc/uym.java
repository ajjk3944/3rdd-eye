...
public class uym implements com.bytedance.sdk.component.ycc.emc.ypw.xq {
    ...
    public com.bytedance.sdk.openadsdk.dg.bw ypw(List<dg.emc> list) {
        ...
        if (list != null && list.size() != 0 && com.bytedance.sdk.openadsdk.core.settings.uym.emc()) {
            ...
            try {
                ...
                jSONObject.put("req_sign", com.bytedance.sdk.component.utils.bw.emc(strDg + j10 + BuildConfig.VERSION_NAME));
    ...
    public void emc(final List<com.bytedance.sdk.component.ycc.emc.dg.emc> list, @Nullable final com.bytedance.sdk.component.ycc.emc.ypw.ypw ypwVar) {
                    ...
                    while (it2.hasNext()) {
                        try {
                            ...
                            if (ypwVar != null && bwVarEmc != null) {
                                boolean z10 = bwVarEmc.dg;
                                if (uym.this.emc(arrayList2, bwVarEmc)) {
                                    z10 = true;
                                }
                                boolean z11 = z10;
                                arrayList.add(new com.bytedance.sdk.component.ycc.emc.ypw.xq.emc(new com.bytedance.sdk.component.ycc.emc.ypw.xq.ypw(bwVarEmc.emc, bwVarEmc.ypw, bwVarEmc.xq, z11, ""), list2));
                                if (bwVarEmc.ypw == 200) {
                                    com.bytedance.sdk.openadsdk.sba.xq.ypw(new com.bytedance.sdk.openadsdk.sba.dg() { // from class: com.bytedance.sdk.openadsdk.dg.emc.uym.2.1
                                        @Override // com.bytedance.sdk.openadsdk.sba.dg
                                        public com.bytedance.sdk.openadsdk.sba.ypw.emc emc() {
                                            com.bytedance.sdk.openadsdk.sba.ypw.emc emcVar3 = new com.bytedance.sdk.openadsdk.sba.ypw.emc();
                                            emcVar3.ypw("applog");
                                            return emcVar3;
                                        }
                                    });
    ...
    public boolean emc(List<com.bytedance.sdk.openadsdk.dg.emc> list, com.bytedance.sdk.openadsdk.dg.bw bwVar) {
        int i10;
        return !xq(list) && (i10 = bwVar.ypw) >= 400 && i10 < 500;
    }
