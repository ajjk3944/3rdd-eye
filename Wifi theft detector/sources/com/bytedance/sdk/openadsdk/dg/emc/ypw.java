...
public class ypw {
    ...
    public static void emc(final List<String> list, final int i10, final String str) {
        ...
        com.bytedance.sdk.openadsdk.dg.xq.emc(new com.bytedance.sdk.component.msw.msw("track") { // from class: com.bytedance.sdk.openadsdk.dg.emc.ypw.1
            ...
            public void run() {
                ...
                com.bytedance.sdk.component.ycc.emc.ypw.emc(sup.emc(aa.emc()), list, true, i10, str);
            }
        });
    }
    ...
    public static void emc(String str, boolean z10) {
        ...
        com.bytedance.sdk.component.ycc.emc.ypw.emc(str, z10);
    }
}
