...
public class yzg implements com.bytedance.sdk.openadsdk.dg.dg.bw {
    ...
    public yzg(int i10, String str, rie rieVar) throws JSONException {
        ...
        emc(this.ycc, "webview_source", Integer.valueOf(i10));
    }
    ...
    public void cf() {
        com.bytedance.sdk.component.utils.zz.emc().post(new Runnable() { // from class: com.bytedance.sdk.openadsdk.dg.yzg.16
            ...
            public void run() throws JSONException {
                ...
                yzg.this.emc(jSONObject, CampaignEx.JSON_KEY_ST_TS, Long.valueOf(jCurrentTimeMillis));
                yzg yzgVar = yzg.this;
    ...
    public void ru() {
        com.bytedance.sdk.component.utils.zz.emc().post(new Runnable() { // from class: com.bytedance.sdk.openadsdk.dg.yzg.4
            ...
            public void run() throws JSONException {
                ...
                JSONObject jSONObject = new JSONObject();
                yzg.this.emc(jSONObject, CampaignEx.JSON_KEY_ST_TS, Long.valueOf(jCurrentTimeMillis));
                yzg.this.emc(jSONObject, HandleInvocationsFromAdViewer.KEY_AD_TYPE, "native_enterForeground");
                yzg yzgVar = yzg.this;
            ...
            public void run() throws JSONException {
                if (yzg.this.aa()) {
                    ...
                    try {
                        ...
                        ul.emc("WebviewTimeTrack", "trySendTrackInfo json error", e10);
                    }
    ...
    public void sz() {
        com.bytedance.sdk.component.utils.zz.emc().post(new Runnable() { // from class: com.bytedance.sdk.openadsdk.dg.yzg.14
            ...
            public void run() throws JSONException {
                ...
                yzg.this.emc(jSONObject2, CampaignEx.JSON_KEY_ST_TS, Long.valueOf(jCurrentTimeMillis2));
    ...
    public void zz() {
        com.bytedance.sdk.component.utils.zz.emc().post(new Runnable() { // from class: com.bytedance.sdk.openadsdk.dg.yzg.3
            ...
            public void run() throws JSONException {
                ...
                JSONObject jSONObject = new JSONObject();
                yzg.this.emc(jSONObject, CampaignEx.JSON_KEY_ST_TS, Long.valueOf(jCurrentTimeMillis));
                yzg.this.emc(jSONObject, HandleInvocationsFromAdViewer.KEY_AD_TYPE, "native_enterBackground");
                yzg yzgVar = yzg.this;
                yzgVar.emc(yzgVar.uym, jSONObject);
            }
        });
    ...
    @Override // com.bytedance.sdk.openadsdk.dg.dg.ycc
    public void ypw(final String str, final long j10, final long j11, final int i10) {
        com.bytedance.sdk.component.utils.zz.emc().post(new Runnable() { // from class: com.bytedance.sdk.openadsdk.dg.yzg.6
            ...
            public void run() throws JSONException {
                ...
                JSONObject jSONObject = new JSONObject();
                yzg.this.emc(jSONObject, "start_ts", Long.valueOf(j10));
                yzg.this.emc(jSONObject, "end_ts", Long.valueOf(j11));
                yzg.this.emc(jSONObject, "intercept_type", Integer.valueOf(i10));
                yzg.this.emc(jSONObject, HandleInvocationsFromAdViewer.KEY_AD_TYPE, "intercept_js");
                yzg.this.emc(jSONObject, "url", str);
                yzg.this.emc(jSONObject, "duration", Long.valueOf(j11 - j10));
                yzg yzgVar = yzg.this;
    ...
    @Override // com.bytedance.sdk.openadsdk.dg.dg.emc
    public void xq(final int i10, final String str) {
        try {
            com.bytedance.sdk.component.utils.zz.emc().post(new Runnable() { // from class: com.bytedance.sdk.openadsdk.dg.yzg.22
                ...
                public void run() throws JSONException {
                    ...
                    JSONObject jSONObject = new JSONObject();
                    yzg.this.emc(jSONObject, CampaignEx.JSON_KEY_ST_TS, Long.valueOf(jCurrentTimeMillis));
                    yzg.this.emc(jSONObject, "code", Integer.valueOf(i10));
                    yzg yzgVar = yzg.this;
                    yzgVar.emc(yzgVar.ycc, str, jSONObject);
                }
            });
    ...
    @Override // com.bytedance.sdk.openadsdk.dg.dg.emc
    public void ypw(final int i10, final String str) {
    ...
    public void emc(final JSONObject jSONObject) {
        com.bytedance.sdk.component.utils.zz.emc().post(new Runnable() { // from class: com.bytedance.sdk.openadsdk.dg.yzg.30
            ...
            public void run() throws JSONException {
                ...
                yzg.this.emc(jSONObject2, CampaignEx.JSON_KEY_ST_TS, Long.valueOf(System.currentTimeMillis()));
                yzg yzgVar = yzg.this;
    ...
    @Override // com.bytedance.sdk.openadsdk.dg.dg.ycc
    public void emc(final String str, final long j10, final long j11, final int i10) {
        com.bytedance.sdk.component.utils.zz.emc().post(new Runnable() { // from class: com.bytedance.sdk.openadsdk.dg.yzg.5
            ...
            public void run() throws JSONException {
                ...
                yzg.this.emc(jSONObject, "end_ts", Long.valueOf(j11));
                yzg.this.emc(jSONObject, "intercept_type", Integer.valueOf(i10));
                yzg.this.emc(jSONObject, HandleInvocationsFromAdViewer.KEY_AD_TYPE, "intercept_html");
                yzg.this.emc(jSONObject, "url", str);
                yzg.this.emc(jSONObject, "duration", Long.valueOf(j11 - j10));
                yzg yzgVar = yzg.this;
                yzgVar.emc(yzgVar.msw, jSONObject);
    ...
    public void emc(boolean z10) {
        this.bw = Boolean.valueOf(z10);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void emc(JSONObject jSONObject, String str, Object obj, boolean z10) throws JSONException {
    ...
    @Override // com.bytedance.sdk.openadsdk.dg.dg.emc
    public void emc(final String str, final boolean z10) {
        try {
            com.bytedance.sdk.component.utils.zz.emc().post(new Runnable() { // from class: com.bytedance.sdk.openadsdk.dg.yzg.19
                ...
                public void run() throws JSONException {
                    ...
                    JSONObject jSONObject = new JSONObject();
                    yzg.this.emc(jSONObject, CampaignEx.JSON_KEY_ST_TS, Long.valueOf(jCurrentTimeMillis));
                    yzg.this.emc(jSONObject, "isReuse", Integer.valueOf(z10 ? 1 : 0));
                    yzg yzgVar = yzg.this;
                    yzgVar.emc(yzgVar.ycc, str, jSONObject);
                }
            });
    ...
    public void emc(final int i10) {
        com.bytedance.sdk.component.utils.zz.emc().post(new Runnable() { // from class: com.bytedance.sdk.openadsdk.dg.yzg.25
            ...
            public void run() throws JSONException {
                ...
                JSONObject jSONObject = new JSONObject();
                yzg.this.emc(jSONObject, CampaignEx.JSON_KEY_ST_TS, Long.valueOf(jCurrentTimeMillis));
                yzg.this.emc(jSONObject, "isWebViewCache", Integer.valueOf(i10));
                if (yzg.this.ypw != null) {
                    if (yzg.this.ypw.dor()) {
