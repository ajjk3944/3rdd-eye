...
public class xq {
        ...
        if (context != null && emc && ypw.compareAndSet(false, true)) {
            try {
                if (Build.VERSION.SDK_INT >= 28) {
                    ...
                    String strYpw = ylm.ypw(context);
                    try {
                        if (TextUtils.isEmpty(strYpw)) {
                            strYpw = context.getPackageName() + Process.myPid();
                        }
                        WebView.setDataDirectorySuffix(strYpw);
    ...
    */
    private static void ypw(android.content.Context r3) throws java.lang.Throwable {
        /*
            java.lang.String r0 = ypw()
        ...
        L46:
            ...
            goto L4f
        L4c:
            emc(r0)     // Catch: java.lang.Throwable -> L44 java.lang.Exception -> L62
        L4f:
            if (r2 == 0) goto L59
        ...
        L6c:
            r1 = r3
        L6d:
            emc(r0)     // Catch: java.lang.Throwable -> L64
            if (r3 == 0) goto L7a
        ...
        L92:
            throw r3
        */
        throw new UnsupportedOperationException("Method not decompiled: com.bytedance.sdk.openadsdk.multipro.xq.ypw(android.content.Context):void");
    }
    ...
    private static void emc(File file) throws IOException {
        emc(file, file.exists() ? file.delete() : false);
    }
    ...
    private static void emc(File file, boolean z10) throws IOException {
        if (!z10 || file.exists()) {
            return;
        }
        try {
            ...
            ul.xq("TTAD.TTMultiInitHelper", e10.getMessage());
        }
    }
}
