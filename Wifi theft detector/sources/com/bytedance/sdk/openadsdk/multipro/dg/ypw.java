...
class ypw {
    ...
    public static synchronized <T> void emc(Context context, String str, String str2, T t10) {
        ...
        if (zz.uym(strEmc)) {
            ...
            if (t10.equals(emc(strEmc, str2))) {
                return;
            }
            emc.xq xqVarYpw = emcVarEmc.ypw();
            emc(xqVarYpw, str2, (Object) t10);
            xqVarYpw.apply();
            emc(strEmc, str2, t10);
            return;
        }
    ...
    public static <T> void emc(SharedPreferences.Editor editor, String str, T t10) {
    ...
    /* JADX WARN: Multi-variable type inference failed */
    public static <T> void emc(emc.xq xqVar, String str, T t10) {
        if (t10 instanceof Integer) {
            xqVar.putInt(str, ((Integer) t10).intValue());
        }
        if (t10 instanceof Long) {
            xqVar.putLong(str, ((Long) t10).longValue());
        }
        if (t10 instanceof Float) {
            xqVar.putFloat(str, ((Float) t10).floatValue());
        }
        if (t10 instanceof Boolean) {
            xqVar.putBoolean(str, ((Boolean) t10).booleanValue());
        }
        if (t10 instanceof String) {
            xqVar.putString(str, (String) t10);
        }
    }
