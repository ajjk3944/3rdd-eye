...
public class emc implements Application.ActivityLifecycleCallbacks {
    ...
    private final RunnableC0185emc bw = new RunnableC0185emc();
    ...
    public static class RunnableC0185emc implements Runnable {
        @Override // java.lang.Runnable
        public void run() {
    ...
    public class uym implements Runnable {
        ...
        public uym(long j10, long j11, boolean z10) {
            this.ypw = j10;
            this.xq = j11;
            this.dg = z10;
        }
    ...
    public class ycc implements Runnable {
        ...
        @Override // java.lang.Runnable
        public void run() {
            com.bytedance.sdk.openadsdk.core.qh.ypw().removeMessages(1001);
    ...
    public boolean emc(boolean z10) {
        Activity activity;
        Window window;
        return (this.qh == null || (activity = this.qh.get()) == null || (window = activity.getWindow()) == null) ? z10 : window.getDecorView().hasWindowFocus();
    }
}
