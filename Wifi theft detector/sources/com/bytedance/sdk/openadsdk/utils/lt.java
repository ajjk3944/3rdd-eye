...
public class lt implements Handler.Callback, emc.InterfaceC0162emc {
    ...
    private int ypw = 1000;
    private final Handler xq = new Handler(Looper.getMainLooper(), this);
    private int gbl = 0;

    public lt(@NonNull com.bytedance.sdk.openadsdk.component.reward.emc.emc emcVar, @NonNull com.bytedance.sdk.openadsdk.core.model.rie rieVar) {
        this.ru = 0;
        this.sup = 0;
        this.bw = emcVar;
        this.dg = rieVar;
    ...
    public boolean handleMessage(@NonNull Message message) throws NumberFormatException {
        if (message.what == 1024) {
            int i10 = this.ru;
            int i11 = this.gbl;
            int i12 = i10 - i11;
            this.bw.ylm.emc(i11 * 1000);
            com.bytedance.sdk.component.utils.ul.emc("TTAD.TopLayoutHelper", "handleMessage: currentTime= " + this.gbl + ", mRemainTimeInSeconds=" + i12);
            if (i12 > 0) {
                ...
                if (zzVar != null && zzVar.emc() != null) {
                    this.bw.hxp.emc().setTime(String.valueOf(i12), this.gbl, 0, false);
                }
                if (this.dg.zc()) {
                    ...
                    if (!this.zz || this.gbl < this.sup || this.bw.ypw.fu() == 5 || this.bw.ypw.fu() == 33) {
                        this.bw.cuf.emc(String.valueOf(i12), null);
                    } else {
                        this.bw.emc(true);
                        this.bw.cuf.emc(String.valueOf(i12), TTAdDislikeToast.getSkipText());
                        this.bw.cuf.bw(true);
                    }
                ...
                int i13 = (int) (1000.0f / this.emc);
                com.bytedance.sdk.component.utils.ul.emc("TTAD.TopLayoutHelper", "handleMessage: next msg intervalInMillis = ".concat(String.valueOf(i13)));
                this.xq.sendEmptyMessageDelayed(message.what, i13);
            }
        }
        return true;
    }
    ...
    public void emc(int i10) {
        com.bytedance.sdk.component.utils.ul.emc("TTAD.TopLayoutHelper", "onPlayerStateChanged: ".concat(String.valueOf(i10)));
        if (i10 == 1) {
            xq();
            return;
        }
