...
public class DeviceUtils {
    ...
    private static AtomicBoolean f9314aa = new AtomicBoolean(false);
    ...
    public static float bw() {
        ...
        try {
            Context contextEmc = com.bytedance.sdk.openadsdk.core.aa.emc();
            if (contextEmc != null) {
                i10 = Settings.System.getInt(contextEmc.getContentResolver(), "screen_brightness", -1);
            }
        } catch (Throwable th) {
            com.bytedance.sdk.component.utils.ul.xq("TTAD.DeviceUtils", th.getMessage());
        }
    ...
    public static JSONObject emc(Context context, boolean z10) throws JSONException {
        String strRu;
        JSONObject jSONObject = new JSONObject();
        try {
            jSONObject.put("sys_adb_status", msw(context));
            emc(jSONObject);
            jSONObject.put(HandleInvocationsFromAdViewer.KEY_AD_TYPE, dg(context));
            jSONObject.put("os", 1);
