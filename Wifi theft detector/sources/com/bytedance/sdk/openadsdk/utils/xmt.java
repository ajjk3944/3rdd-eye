...
public class xmt {
    public static void emc(com.bytedance.sdk.openadsdk.core.model.rie rieVar, Double d10) {
    ...
    public static void emc(com.bytedance.sdk.openadsdk.core.model.rie rieVar, Double d10, String str, String str2) {
        if (rieVar == null || rieVar.zek() == null) {
            return;
        }
        Map<String, Object> mapZek = rieVar.zek();
