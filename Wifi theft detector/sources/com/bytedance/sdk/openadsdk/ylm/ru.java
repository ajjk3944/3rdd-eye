...
public class ru {
    ...
    public static void dg(Context context, SensorEventListener sensorEventListener, int i10) {
    ...
    public static void xq(Context context, SensorEventListener sensorEventListener, int i10) {
        if (sensorEventListener == null || context == null) {
            return;
        }
        try {
    ...
    public static void ypw(Context context, SensorEventListener sensorEventListener, int i10) {
        if (sensorEventListener == null || context == null) {
            return;
        }
        try {
    ...
    public static void emc(Context context, SensorEventListener sensorEventListener, int i10) {
        if (sensorEventListener == null || context == null) {
            return;
        }
        try {
    ...
    public static void emc(Context context, long j10) {
        if (context == null) {
            return;
        }
