...
public class emc {
    ...
    private AtomicBoolean f9319aa;
    private final FrameLayout bw;
    private int cf;
    private InterfaceC0188emc db;
    ...
    public interface InterfaceC0188emc {
        void emc(int i10);
    }
    ...
    public emc(Context context, rie rieVar, int i10, boolean z10, FrameLayout frameLayout) {
        this(context, rieVar, i10, z10, frameLayout, false);
    }

    public emc(Context context, rie rieVar, int i10, boolean z10, FrameLayout frameLayout, boolean z11) {
        this(context, rieVar, i10, z10, frameLayout, z11, 0);
    }
    ...
    private void msw() {
        this.emc.setWebViewClient(new bw(aa.emc(), this.uym, this.xq.ye(), null, true) { // from class: com.bytedance.sdk.openadsdk.ylm.emc.emc.5
            ...
            public WebResourceResponse shouldInterceptRequest(WebView webView, String str) {
                try {
                    if (emc.this.xq.iat() != null && !TextUtils.isEmpty(emc.this.xq.iat().w())) {
                        if (emc.this.ru != null) {
                            emc.this.ru.ru(str);
                        }
                        String strSup = dr.sup(emc.this.xq);
                        WebResourceResponse webResourceResponseEmc = com.bytedance.sdk.openadsdk.core.sz.xq.emc.emc().emc(emc.this.xq.iat().w(), strSup, str);
    ...
    private void xq(boolean z10) {
        ...
        try {
            jSONObject.put(BidResponsedEx.KEY_CID, this.xq.ye());
                ...
                com.bytedance.sdk.openadsdk.dg.xq.emc(System.currentTimeMillis(), emc.this.xq, emc.this.msw, "playable_track", new com.bytedance.sdk.openadsdk.vk.xq.emc() { // from class: com.bytedance.sdk.openadsdk.ylm.emc.emc.3.1
                    ...
                    public JSONObject emc() throws JSONException {
                        try {
                            ...
                            ul.xq("PlayableManager", e10.getMessage());
                            return null;
                        }
                    }
        ...
        for (String str : setGbl) {
            if (!"subscribe_app_ad".equals(str) && !"adInfo".equals(str) && !"webview_time_track".equals(str) && !"download_app_ad".equals(str) && (cfVarYpw = this.uym.ypw()) != null) {
                cfVarYpw.emc(str, new com.bytedance.sdk.component.emc.dg<JSONObject, JSONObject>() { // from class: com.bytedance.sdk.openadsdk.ylm.emc.emc.4
                    ...
                    public JSONObject emc(String str2, @NonNull JSONObject jSONObject2, @NonNull com.bytedance.sdk.component.emc.bw bwVar) {
                        try {
    ...
    public emc(Context context, rie rieVar, int i10, boolean z10, FrameLayout frameLayout, boolean z11, int i11) throws JSONException {
        this.sup = true;
        this.vk = new AtomicBoolean(false);
        this.f9319aa = new AtomicBoolean(false);
        this.rie = 0;
        this.hxp = 0L;
        this.ypw = context;
        this.xq = rieVar;
    ...
    public void emc(InterfaceC0188emc interfaceC0188emc) {
        this.db = interfaceC0188emc;
    }
    ...
    private void emc(int i10) throws JSONException {
        ...
        this.uym.ypw(this.emc).emc(this.xq).emc(com.bytedance.sdk.openadsdk.core.zz.emc.ypw.emc(this.xq, true, jSONObject)).xq(this.xq.ye()).dg(this.xq.wdp()).ypw(i10).bw(strDrx).emc(this.emc).ypw(this.msw).emc(map).emc(new com.bytedance.sdk.openadsdk.dg.yzg(3, this.msw, this.xq));
    }
    ...
    public void emc(boolean z10, com.bytedance.sdk.openadsdk.sz.ycc yccVar) {
        this.gbl = yccVar;
        this.ru.ypw(z10);
    ...
    public void emc() throws JSONException {
        ...
        if (!this.qh && (ruVar = this.ycc) != null) {
            ...
            InterfaceC0188emc interfaceC0188emc = this.db;
            if (interfaceC0188emc != null) {
                interfaceC0188emc.emc(this.cf);
            }
            z10 = false;
        }
        if (this.ru != null) {
    ...
    public void emc(final int i10, final int i11) throws JSONException {
        InterfaceC0188emc interfaceC0188emc;
        msw mswVar;
        ypw ypwVar;
        if (this.qh) {
            return;
        ...
        if (!this.sz && (interfaceC0188emc = this.db) != null) {
            interfaceC0188emc.emc(i10);
        }
        ru ruVar = this.ycc;
        if (ruVar != null) {
