...
public class dg {
    ...
    @MainThread
    public void emc(@Nullable final rie rieVar) {
    ...
    @MainThread
    public ypw emc(@NonNull rie rieVar, FrameLayout frameLayout, ycc yccVar) {
        ypw ypwVar;
        if (ypw() && rieVar.vaf() != null && !TextUtils.isEmpty(rieVar.vaf().getBidAdm()) && dr.ycc(rieVar) && frameLayout != null) {
            ...
            int i10 = 0;
            while (true) {
                if (i10 >= this.ycc.size()) {
                    i10 = -1;
                    ypwVar = null;
                    break;
                }
                ypwVar = this.ycc.get(i10);
