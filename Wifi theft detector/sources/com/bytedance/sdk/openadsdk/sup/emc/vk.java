...
public class vk extends com.bytedance.sdk.component.emc.dg<JSONObject, JSONObject> {
    private rtt emc;

    public vk(rtt rttVar) {
        this.emc = rttVar;
    }

    public static void emc(com.bytedance.sdk.component.emc.cf cfVar, rtt rttVar) {
        cfVar.emc("sendLogV3", new vk(rttVar));
    }
