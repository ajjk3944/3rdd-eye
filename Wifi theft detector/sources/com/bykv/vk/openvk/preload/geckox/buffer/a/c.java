...
final class c implements com.bykv.vk.openvk.preload.geckox.buffer.a {
    ...
    private RandomAccessFile f9090c;

    /* renamed from: d, reason: collision with root package name */
    private AtomicBoolean f9091d = new AtomicBoolean(false);
    ...
    public c(long j10, File file) throws IOException {
        ...
        try {
            ...
            this.f9090c = randomAccessFile;
            randomAccessFile.setLength(j10);
        } catch (Exception e10) {
            CloseableUtils.close(this.f9090c);
  ...
  0x000e: PHI (r0v5 long) = (r0v2 long), (r0v3 long) binds: [B:5:0x000c, B:8:0x0014] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    public final void b(long r4) throws java.io.IOException {
        /*
            r3 = this;
            java.util.concurrent.atomic.AtomicBoolean r0 = r3.f9091d
            boolean r0 = r0.get()
            if (r0 != 0) goto L1f
            r0 = 0
        ...
        L17:
            r3.f9089b = r4
            java.io.RandomAccessFile r0 = r3.f9090c
            r0.seek(r4)
            return
        L1f:
    ...
    public final synchronized long a(long j10) throws IOException {
        ...
        int i10 = (int) j10;
        if (i10 == j10) {
            iSkipBytes = this.f9090c.skipBytes(i10);
            this.f9089b = this.f9090c.getFilePointer();
        } else {
    ...
    public final int b(byte[] bArr, int i10, int i11) throws IOException {
        if (!this.f9091d.get()) {
            ...
            synchronized (this) {
                try {
                    long j10 = this.f9089b;
                    long j11 = this.f9088a;
                    if (j10 == j11) {
                        return -1;
                    }
                    if (i11 + j10 > j11) {
                    ...
                    int i12 = this.f9090c.read(bArr, i10, i11);
                    if (i12 == -1) {
                        return -1;
                    }
                    this.f9089b += i12;
        ...
        if (!this.f9091d.get()) {
            ...
            synchronized (this) {
                try {
                    ...
                    this.f9090c.write(bArr, i10, i11);
                    this.f9089b += i11;
                    return i11;
                } catch (Throwable th) {
                    throw th;
