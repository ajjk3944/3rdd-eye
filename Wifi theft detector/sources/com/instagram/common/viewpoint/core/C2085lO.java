...
public final class C2085lO implements InterfaceC1016Kv {
    ...
    public final C06214v A09 = new C06214v(new byte[18]);
    public int A02 = 0;
    public long A05 = C.TIME_UNSET;

    public C2085lO(String str) {
        this.A0A = str;
    }
    ...
    private boolean A01(C06214v c06214v) {
        while (c06214v.A07() > 0) {
            this.A03 <<= 8;
            this.A03 |= c06214v.A0I();
            if (H7.A07(this.A03)) {
                byte[] bArrA0l = this.A09.A0l();
    ...
    private boolean A02(C06214v c06214v, byte[] bArr, int i10) {
    ...
    public final void A5A(C06214v c06214v) {
        ...
        while (c06214v.A07() > 0) {
            switch (this.A02) {
                ...
                case 1:
                    if (!A02(c06214v, this.A09.A0l(), 18)) {
                        break;
                    } else {
                        A00();
                        this.A09.A0f(0);
