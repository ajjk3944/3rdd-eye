...
public final class C1924iY implements T5 {
    public long A00;
    ...
    public C1924iY(C1814gi c1814gi, InterstitialAd interstitialAd, String str) {
        this(c1814gi, interstitialAd, str, new C1933ij());
    }

    public C1924iY(C1814gi c1814gi, InterstitialAd interstitialAd, String str, U3 u32) {
        this.A0A = c1814gi;
        this.A0B = str;
    ...
    public final void A0D(InterstitialAd interstitialAd) {
        if (interstitialAd == null && !C1264Up.A0u(this.A0A)) {
            return;
        }
        this.A01 = interstitialAd;
    }
