...
public class C0783Br<V> extends C2L<K, V>.WrappedCollection implements List<V> {
    ...
    public C0783Br(@ParametricNullness final C2L this$0, @CheckForNull Object key, List delegate, C2112lp ancestor) {
