...
public final class M6 extends LinearLayout implements InterfaceC1457av {
    ...
    public C1449an A05;
    public InterfaceC1456au A06;
    public String A07;
    public final WebView A08;
    public final C1814gi A09;
    public final InterfaceC1453ar A0A;
    ...
    static {
        ...
        A0M = new ViewOnTouchListenerC1438ac();
    ...
    public M6(C1814gi c1814gi, WebView webView) {
        this(c1814gi, webView, false, false);
    }

    public M6(C1814gi c1814gi, WebView webView, boolean z10, boolean z11) {
        super(c1814gi);
        this.A0A = new M7(this);
        this.A08 = webView;
        this.A09 = c1814gi;
        this.A0B = AbstractC1265Uq.A06(c1814gi);
        this.A0D = z10;
        this.A0C = z11;
        A08();
        if (z11) {
    ...
    private void A08() {
        ...
        this.A01.setOnClickListener(new ViewOnClickListenerC1439ad(this));
        addView(this.A01, layoutParams);
        if (this.A0B && !C1264Up.A2w(this.A09)) {
            ...
            this.A00.setOnClickListener(new ViewOnClickListenerC1440ae(this));
            addView(this.A00, backButtonParams);
        }
        this.A05 = new C1449an(this.A09);
        ...
        if (C1264Up.A2w(this.A09) && !this.A0D) {
        ...
        if (this.A0B && !C1264Up.A2w(this.A09)) {
            ...
            this.A02.setOnClickListener(new ViewOnClickListenerC1441af(this));
        ...
        this.A03.setOnClickListener(new ViewOnClickListenerC1442ag(this));
