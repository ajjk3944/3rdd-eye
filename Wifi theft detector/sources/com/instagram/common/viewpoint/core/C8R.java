...
public final class C8R {
    ...
    public static final AbstractC2266oX<Integer, Integer> A06;
    ...
    static {
        ...
        A06 = new C2264oV().A05(5, 6).A05(17, 6).A05(7, 6).A05(18, 6).A05(6, 8).A05(8, 8).A05(14, 8).A07();
    }
    ...
    */
    ...
    public static int A01(int i10, int i11) {
        ...
        return ((Integer) AbstractC05983y.A01(orDefault)).intValue();
    }
    ...
    public static C8R A03(Context context, Intent intent) {
        if (A07() && Settings.Global.getInt(context.getContentResolver(), A05(Sdk$SDKError.Reason.AD_ALREADY_FAILED_VALUE, 31, 58), 0) == 1) {
            return A05;
        }
        ...
        return new C8R(intent.getIntArrayExtra(A05(WKSRecord.Service.EMFIS_DATA, 29, 55)), intent.getIntExtra(A05(169, 37, 84), 8));
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final android.util.Pair<java.lang.Integer, java.lang.Integer> A09(com.instagram.common.viewpoint.core.C2374qI r9) {
        /*
            r8 = this;
    ...
    public final boolean A0B(C2374qI c2374qI) {
        return A09(c2374qI) != null;
    }
