...
public final class C1058Ml {
    ...
    public static C1058Ml A00(C1058Ml c1058Ml, long j10) {
        return c1058Ml.A03(A06(0, 7, 94), j10);
    }

    public static C1058Ml A01(C1058Ml c1058Ml, Uri uri) {
        String strA06 = A06(7, 9, 58);
        if (uri == null) {
            return c1058Ml.A02(strA06);
        }
        return c1058Ml.A05(strA06, uri.toString());
    }

    private final C1058Ml A02(String str) {
        this.A00.add(str);
        this.A01.remove(str);
        return this;
    }

    private final C1058Ml A03(String str, long j10) {
        return A04(str, Long.valueOf(j10));
    }

    private C1058Ml A04(String str, Object obj) {
        this.A01.put((String) AbstractC05983y.A01(str), AbstractC05983y.A01(obj));
        this.A00.remove(str);
        return this;
    }

    private final C1058Ml A05(String str, String str2) {
        return A04(str, str2);
    }
