...
public class C1814gi extends T8 {
    ...
    public final AtomicReference<InterfaceC1040Lt> A05;

    public C1814gi(Activity activity, TA ta, InterfaceC1040Lt interfaceC1040Lt) {
        ...
        this.A05.set(interfaceC1040Lt);
        this.A00 = new WeakReference<>(activity);
    }

    public C1814gi(Context context, TA ta, InterfaceC1040Lt interfaceC1040Lt) {
    ...
    public static Activity A00(Context context) {
        while (context instanceof ContextWrapper) {
            ...
            if ((context instanceof C1814gi) && ((C1814gi) context).A0E() != null) {
                return ((C1814gi) context).A0E();
            }
    ...
    public InterfaceC1040Lt A0F() {
        InterfaceC1040Lt funnel = this.A05.get();
        if (funnel == null) {
            return new C2034kX();
        }
        return funnel;
    ...
    public final void A0K(InterfaceC1040Lt interfaceC1040Lt) {
        this.A05.set(interfaceC1040Lt);
    }

    public final void A0L(C1814gi c1814gi) {
        c1814gi.A01.putAll(this.A01);
        this.A01 = c1814gi.A01;
    }

    public final void A0M(C1814gi c1814gi) {
        A0K(c1814gi.A0F());
        A0D(c1814gi.A0C());
        A0N(c1814gi.A0G());
    }
