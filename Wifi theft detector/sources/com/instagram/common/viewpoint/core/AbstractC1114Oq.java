...
public abstract class AbstractC1114Oq extends RelativeLayout implements InterfaceC1420aK {
    public Handler A00;
    public C1423aN A01;
    public boolean A02;
    public C1370Yw A03;
    ...
    public AbstractC1114Oq(C1814gi c1814gi, View.OnClickListener onClickListener, VI vi, AbstractC1979jd abstractC1979jd) {
        super(c1814gi);
        this.A02 = true;
        this.A08 = c1814gi;
    ...
    private void A0B() {
        if (this.A07 != null) {
            if (this.A07.A2Q()) {
                ...
                this.A05 = AbstractC1424aO.A00(this.A08, true, this.A07, this.A09, null, EnumC1422aM.A04, this, AbstractC1421aL.A00(this.A07));
            } else if (this.A07.A2W()) {
                this.A01 = AbstractC1424aO.A02(this.A08, EnumC1422aM.A04, this.A07);
                YB.A0K(this.A01);
            }
            if (this.A07.A2U()) {
                this.A04 = new C1405a5(this.A08, EnumC1422aM.A04);
                YB.A0K(this.A04);
                this.A04.setOnClickListener(this.A06);
            } else {
                this.A03 = new C1370Yw(this.A08);
