...
public final class C6X extends C0890Fy {
    ...
    public C6X(C1J c1j, int i10, List<C1652e5> list, C1759fp c1759fp, Bundle bundle) {
        super(c1j, i10, list, c1759fp, bundle);
        c1j.A1h(this);
    ...
    @Override // com.instagram.common.viewpoint.core.C0890Fy, com.instagram.common.viewpoint.core.R7
    ...
    public final void A0M(C7M c7m, int i10, int i11) {
        if (this.A0C.A25() != -1) {
            AbstractC0975Jg curCard = (AbstractC0975Jg) this.A0C.A1o(this.A0C.A25());
    ...
    @Override // com.instagram.common.viewpoint.core.C0890Fy
    public final void A0X(View view, boolean z10) {
        view.setAlpha(z10 ? 1.0f : 0.8f);
    }

    @Override // com.instagram.common.viewpoint.core.C0890Fy
    public final void A0Z(AbstractC0975Jg abstractC0975Jg, boolean z10) {
    ...
    public final void A0c(C1759fp c1759fp) {
        this.A04 = c1759fp;
    }

    public final void A0d(List<C1652e5> list) {
        this.A05 = list;
    }
}
