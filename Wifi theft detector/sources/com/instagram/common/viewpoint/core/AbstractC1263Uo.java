...
public abstract class AbstractC1263Uo {
    ...
    public static long A00(Context context) {
        return C1264Up.A0V(context).A33(A02(29, 25, 32), -1L);
    }

    public static long A01(Context context) {
        return C1264Up.A0V(context).A33(A02(131, 31, 31), -1L);
    }

    public static boolean A04(Context context) {
        return C1264Up.A0V(context).A38(A02(54, 39, 1), true);
    }

    public static boolean A05(Context context) {
        return C1264Up.A0V(context).A38(A02(0, 29, 97), false);
    }

    public static boolean A06(Context context) {
        return C1264Up.A0V(context).A38(A02(93, 16, 94), false);
    }

    public static boolean A07(Context context) {
        return C1264Up.A0V(context).A38(A02(109, 22, 37), false);
    }
}
