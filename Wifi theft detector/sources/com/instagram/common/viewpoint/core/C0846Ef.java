...
public class C0846Ef {
    ...
    public C0846Ef(Spatializer spatializer) {
        this.A02 = spatializer;
        this.A03 = spatializer.getImmersiveAudioLevel() != 0;
    }

    public static C0846Ef A00(Context context) {
        AudioManager audioManager = (AudioManager) context.getSystemService(A01(0, 5, 33));
        if (audioManager == null) {
            return null;
        }
        return new C0846Ef(audioManager.getSpatializer());
    }

    public final void A03(C07319h c07319h, Looper looper) {
        if (this.A00 != null || this.A01 != null) {
            return;
        }
        this.A00 = new C0845Ee(this, c07319h);
    ...
    public final boolean A07(C2380qQ c2380qQ, C2374qI c2374qI) throws IllegalArgumentException {
        int i10;
        if (A01(5, 14, 28).equals(c2374qI.A0W) && c2374qI.A06 == 16) {
            i10 = 12;
        } else {
            i10 = c2374qI.A06;
        }
        ...
        if (c2374qI.A0G != -1) {
            int linearChannelCount2 = c2374qI.A0G;
            channelMask.setSampleRate(linearChannelCount2);
        }
        Spatializer spatializer = this.A02;
        AudioAttributes audioAttributes = c2380qQ.A01().A00;
