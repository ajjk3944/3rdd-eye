...
public final class NO extends RelativeLayout implements InterfaceC1356Yi {
    ...
    public C1419aJ A08;
    public C1423aN A09;
    public ViewOnClickListenerC1012Kr A0A;
    public C1665eI A0B;
    public C1682ea A0C;
    public String A0D;
    public String A0E;
    ...
    public final AbstractC1979jd A0O;
    public final C1086No A0P;
    public final InterfaceC1182Rk A0Q;
    public final C1814gi A0R;
    public final VA A0S;
    public final VI A0T;
    public final XO A0U;
    public final ViewOnSystemUiVisibilityChangeListenerC1345Xx A0V;
    public final InterfaceC1355Yh A0W;
    public final ZU A0X;
    public final InterfaceC1505bh A0Y;
    public final C1506bi A0Z;
    public final C1669eM A0a;
    public final AtomicBoolean A0b;
    public final AtomicBoolean A0c;
    public final boolean A0d;
    public final boolean A0e;
    public final boolean A0f;
    public final AbstractC1349Yb A0g;

    /* JADX WARN: Failed to parse debug info
    java.lang.ArrayIndexOutOfBoundsException
     */
    public NO(C1814gi c1814gi, VA va, InterfaceC1355Yh interfaceC1355Yh, AbstractC1979jd abstractC1979jd, String str, ZU zu, boolean z10) {
        super(c1814gi);
        ...
        this.A0f = z10;
        this.A0R = c1814gi;
        this.A0W = interfaceC1355Yh;
        this.A0S = va;
        this.A0O = abstractC1979jd;
        this.A0P = abstractC1979jd.A29().A0H().A07();
        this.A0T = new VI(this.A0O.A2E(), this.A0S);
        this.A0X = zu;
        this.A0C = new C1682ea(c1814gi, this.A0X, str, this.A0W);
        if (abstractC1979jd.A29().A0H().A07() != null) {
            this.A0I = abstractC1979jd.A29().A0H().A07().A0X();
            this.A0E = abstractC1979jd.A29().A0H().A07().A0O();
            this.A0D = abstractC1979jd.A29().A0H().A07().A0N();
        }
        ...
        OV ov = null;
        this.A0U = new XO(iA03, new C1093Nv(this, ov));
        this.A0d = C1264Up.A0o(this.A0R);
        this.A0g = A07();
        if (this.A0P.A0c()) {
            this.A0g.A09();
        }
        this.A0a = new C1669eM(this.A0R, this.A0S, this.A0O);
        AbstractC1515br.A00(c1814gi, this, abstractC1979jd.A29().A0H().A08());
        this.A0V = new ViewOnSystemUiVisibilityChangeListenerC1345Xx(this);
        this.A0V.A05(EnumC1344Xw.A02);
        if (C1264Up.A2K(this.A0R)) {
            this.A0g.setProgressSpinnerInvisible(true);
        }
        NP np = new NP(this, ov);
        HashMap map = new HashMap();
        map.put(A0D(56, 9, 90), this.A0X.A8l());
        this.A0B = new C1665eI(this.A0R, this.A0O, this.A0P, this.A0S, np, map);
        A0K();
        this.A0W.A45(this, new RelativeLayout.LayoutParams(-1, -1));
        A0H();
        this.A0Y = new C1097Nz(this);
        this.A0Z = new C1506bi(this.A0R, this.A0g, this.A0O, (C0851Ek) null, this.A0W, this.A0Y, this.A0A, this.A02, this.A0B);
    ...
    public NO(C1814gi c1814gi, VA va, InterfaceC1355Yh interfaceC1355Yh, AbstractC1979jd abstractC1979jd, String str, ZU zu) {
        this(c1814gi, va, interfaceC1355Yh, abstractC1979jd, str, zu, false);
    }
    ...
    private FullScreenAdToolbar A07() {
        ...
        fullScreenAdToolbar.A0D(this.A0O.A28().A01(), ViewOnClickListenerC1012Kr.A05(this.A0O));
        ...
        fullScreenAdToolbar.setToolbarListener(new C1094Nw(this));
        return fullScreenAdToolbar;
    }

    private ViewOnClickListenerC1012Kr A09() {
        if (this.A0B == null || this.A0B.getViewabilityChecker() == null || this.A0B.getTouchDataRecorder() == null) {
            return null;
        }
        ViewOnClickListenerC1012Kr viewOnClickListenerC1012Kr = new ViewOnClickListenerC1012Kr(this.A0R, this.A0X.A7M(), this.A0O.A28().A01(), this.A0S, this.A0W, this.A0B.getViewabilityChecker(), this.A0B.getTouchDataRecorder(), this.A0O.A2A());
        YB.A0K(viewOnClickListenerC1012Kr);
        viewOnClickListenerC1012Kr.setText(this.A0O.A29().A0J().A04());
        viewOnClickListenerC1012Kr.setTextSize(14.0f);
        viewOnClickListenerC1012Kr.setPadding(XV.A02, XV.A02, XV.A02, XV.A02);
        viewOnClickListenerC1012Kr.setOnClickListener(new Z6(this));
        return viewOnClickListenerC1012Kr;
    }

    private C1514bq A0B() {
        C1814gi c1814gi = this.A0R;
        C1072Na c1072NaA01 = this.A0O.A28().A01();
        ...
        C1514bq c1514bq = new C1514bq(c1814gi, c1072NaA01, true, i10, !z10 ? 14 : 13, 0);
        c1514bq.A04(this.A0O.A29().A0I().A0G(), this.A0O.A29().A0I().A0F(), null, false, true);
        TextView descriptionTv = c1514bq.getDescriptionTextView();
        descriptionTv.setAlpha(0.8f);
        descriptionTv.setMaxLines(1);
        descriptionTv.setEllipsize(TextUtils.TruncateAt.END);
        TextView descriptionTv2 = c1514bq.getTitleTextView();
    ...
    private void A0G() {
        ...
        C1508bk c1508bk = new C1508bk(this.A0R);
        YB.A0N(c1508bk, 0);
        YB.A0K(c1508bk);
        new LM(c1508bk, this.A0R).A05(A0k, A0k).A07(this.A0O.A2C().A01());
        ...
        C1510bm c1510bm = new C1510bm(this.A0R, !this.A0I ? A0o : A0m, 5, A0n, -1);
        ...
        linearLayout.addView(c1510bm, layoutParams2);
        ...
        ratingInfoContainerParams.addRule(1, c1508bk.getId());
        ...
        if (this.A04 != null) {
            ...
            this.A04.addView(c1508bk, layoutParams);
        }
        ...
        c1510bm.setRating(Float.parseFloat(this.A0O.A29().A0I().A0C()));
        ...
        if (!this.A0I) {
            ...
            strA01 = AbstractC1328Xg.A01(Integer.parseInt(this.A0O.A29().A0I().A09()));
        }
        sb.append(strA01);
    ...
    private void A0J() {
        C1637dq c1637dqA0F = new Cdo(this.A0R, this.A0O.A29().A0I(), this.A0O.A2C()).A0A(this.A0O.A28().A01()).A0D(this.A0P.A0Q()).A0C(this.A0P.A0K()).A09(2000).A0E(this.A0I).A0B(this.A0E).A0F();
        VK.A04(c1637dqA0F, this.A0T, VH.A0U);
        addView(c1637dqA0F, A0p);
        c1637dqA0F.A04(new C1096Ny(this));
    }
    ...
    private void A0K() {
        ...
        if (this.A0d) {
            ...
            C1514bq c1514bqA0B = A0B();
            RelativeLayout.LayoutParams iconAndMetaDataContainerParams = new RelativeLayout.LayoutParams(-2, -2);
            relativeLayout.addView(c1514bqA0B, iconAndMetaDataContainerParams);
        }
        RelativeLayout.LayoutParams layoutParams2 = new RelativeLayout.LayoutParams(-1, -2);
        layoutParams2.setMargins(0, 0, XV.A09, 0);
        this.A02.addView(this.A04, layoutParams2);
        if (this.A0A != null) {
            ViewOnClickListenerC1012Kr viewOnClickListenerC1012Kr = this.A0A;
            String[] strArr = A0i;
            if (strArr[6].charAt(22) == strArr[1].charAt(22)) {
                throw new RuntimeException();
            }
            A0i[3] = "f";
            layoutParams2.addRule(0, viewOnClickListenerC1012Kr.getId());
            if (!this.A0I) {
    ...
    private void A0L() {
        this.A09 = AbstractC1424aO.A02(this.A0R, EnumC1422aM.A03, this.A0O);
        YB.A0K(this.A09);
    ...
    private void A0M() {
        this.A08 = AbstractC1424aO.A01(this.A0R, true, this.A0O, this.A0T, this.A0W, EnumC1422aM.A03, AbstractC1421aL.A00(this.A0O));
        RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-2, -2);
        layoutParams.addRule(11);
        layoutParams.topMargin = XV.A09;
    ...
    public void A0N() {
        if (this.A0O.A2M() && this.A08 != null) {
            this.A08.A0P();
            if (this.A0O.A2U()) {
                AbstractC1421aL.A04(this.A0R, EnumC1422aM.A02);
            } else {
                AbstractC1421aL.A05(this.A0R, EnumC1422aM.A02);
            }
        }
        if (this.A0O.A2W() && this.A09 != null) {
            AbstractC1421aL.A06(this.A0R, EnumC1422aM.A02);
        }
        ...
        YB.A0L(this.A0A);
        Pair<EnumC1668eL, View> pairA03 = this.A0a.A03(this.A0A);
        this.A00 = (View) pairA03.second;
        switch (Z7.A00[((EnumC1668eL) pairA03.first).ordinal()]) {
            case 1:
                ...
                if (!this.A0I) {
                    ...
                    View c1631dj = new C1631dj(this.A0R, this.A0O.A2C(), this.A0O.A29().A0I(), A09(), this.A0D, new Z5(this));
                    ...
                    addView(c1631dj, screenshotParams2);
                    View view = this.A0g;
                    String[] strArr3 = A0i;
    ...
    public void A0O() {
        ...
        if (this.A0A != null && this.A0O.A25() > 0 && this.A07 == null) {
            this.A07 = new XO(this.A0O.A25(), new C1095Nx(this));
            this.A07.A07();
        }
        this.A0U.A07();
        if (this.A08 != null && this.A0O.A2Q()) {
            C1419aJ c1419aJ = this.A08;
            String[] strArr2 = A0i;
    ...
    public void A0W(boolean z10, String str) {
        ...
        new C1493bV(this.A0R, this.A0X.A7M(), this.A0B.getViewabilityChecker(), this.A0B.getTouchDataRecorder(), this.A0S, this.A0O.A2A(), this.A0W).A05(this.A0O.A2E(), this.A0O.A29().A0J().A05(), map);
    }
    ...
    public final void onDestroy() {
        ...
        if (this.A0B != null) {
            if (!TextUtils.isEmpty(this.A0O.A2E())) {
                this.A0S.AB7(this.A0O.A2E(), new C1471b9().A03(this.A0B.getViewabilityChecker()).A02(this.A0B.getTouchDataRecorder()).A05());
            }
            C1665eI c1665eI = this.A0B;
            String[] strArr = A0i;
