...
public final class CX {
    ...
    private void A05() {
        ConnectivityManager connectivityManager = (ConnectivityManager) AbstractC05983y.A01((ConnectivityManager) this.A03.getSystemService(A02(Sdk$SDKError.Reason.MRAID_JS_CALL_EMPTY_VALUE, 12, 37)));
    ...
    public final int A09() {
        ...
        if (this.A05.A09()) {
            if (C5C.A02 >= 23) {
                ...
                intentFilter.addAction(A02(Sdk$SDKError.Reason.AD_CONSUMED_VALUE, 31, 50));
