...
public class RunnableC1319Wv implements Runnable {
    ...
    public RunnableC1319Wv(C1814gi c1814gi) {
        this.A00 = c1814gi;
    }
    ...
    public final void run() throws Throwable {
        ...
        try {
            C1227Te otsl = new C1227Te(A00(0, 4, 14));
            otsl.A05(1);
            otsl.A06(1);
            otsl.A0A(false);
            this.A00.A08().ABD(A00(4, 7, 44), AbstractC1226Td.A1Y, otsl);
        } catch (Throwable th) {
            WU.A00(th, this);
        }
    }
