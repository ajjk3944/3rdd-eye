...
public class C1945iw implements NG {
    ...
    public final /* synthetic */ C06847g A04;
    public final /* synthetic */ C1243Tu A05;
    ...
    public C1945iw(C06847g c06847g, Runnable runnable, long j10, C1243Tu c1243Tu) {
        this.A04 = c06847g;
        this.A06 = runnable;
        this.A03 = j10;
        this.A05 = c1243Tu;
    ...
    public final void AEv(C1996ju c1996ju) {
        if (!this.A00) {
            this.A00 = true;
            String[] strArr = A08;
            ...
            this.A04.A05(this.A05.A03(EnumC1247Ty.A02), null);
        }
    ...
    public final void AEw(C1996ju c1996ju) {
        ...
        this.A04.A01 = c1996ju;
        this.A04.A07.A0F(c1996ju);
        if (!this.A02) {
            this.A02 = true;
            ...
            this.A04.A05(this.A05.A03(EnumC1247Ty.A04), mapA01);
        }
    }

    @Override // com.instagram.common.viewpoint.core.NG
    public final void AEx(C1996ju c1996ju) {
        if (!this.A01) {
            this.A01 = true;
            this.A04.A05(this.A05.A03(EnumC1247Ty.A03), null);
        }
        this.A04.A0O();
    }

    @Override // com.instagram.common.viewpoint.core.NG
    public final void AEz(C1996ju c1996ju, C1286Vm c1286Vm) {
        if (c1996ju != this.A04.A00) {
            return;
        }
        this.A04.A0H().removeCallbacks(this.A06);
        this.A04.A0Q(c1996ju);
        if (!this.A02) {
            this.A02 = true;
            Map mapA01 = this.A04.A01(this.A03);
            mapA01.put(A00(0, 5, 14), String.valueOf(c1286Vm.A03().getErrorCode()));
            mapA01.put(A00(5, 3, 72), String.valueOf(c1286Vm.A04()));
            this.A04.A05(this.A05.A03(EnumC1247Ty.A04), mapA01);
        }
        this.A04.ADp(c1286Vm);
    }
}
