...
public abstract class YL {
    ...
    public static Bitmap A00(C1814gi c1814gi, Bitmap bitmap, int i10) throws RSRuntimeException {
        ...
        try {
            renderScriptCreate = RenderScript.create(c1814gi);
    ...
    public static Bitmap A01(C1814gi c1814gi, Bitmap bitmap, int i10, int i11) {
        ...
        if (width != 0 && height != 0) {
            ...
            try {
                bitmapCreateBitmap = A00(c1814gi, bitmapCreateBitmap, i10);
                if (i11 != 1) {
