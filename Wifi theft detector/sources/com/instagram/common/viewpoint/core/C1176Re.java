...
public final class C1176Re implements AudienceNetworkActivityApi, Repairable {
    ...
    public WK A07;
    public InterfaceC1356Yi A08;
    public AbstractC1377Zd A09;
    public C1662eF A0A;
    public String A0B;
    public String A0C;
    public boolean A0D;
    ...
    public final C1186Ro A0G;
    public final S1 A0H;
    public final SK A0I;
    public final C1814gi A0J;
    public final List<InterfaceC1182Rk> A0K = new ArrayList();
    public int A01 = -1;
    ...
    public C1176Re(AudienceNetworkActivity audienceNetworkActivity, AudienceNetworkActivityApi audienceNetworkActivityApi) {
        this.A0E = audienceNetworkActivity;
        this.A0F = audienceNetworkActivityApi;
        this.A0J = C1187Rp.A02(audienceNetworkActivity);
        this.A0J.A0O(this);
        this.A0H = new S1(this.A0J, this.A0E);
        this.A0I = new SK(this.A0J, this.A0E);
        this.A0G = new C1186Ro(this, this.A0J, this.A0E);
    }
    ...
    private void A03(Intent intent, Bundle bundle) {
        ...
        if (bundle != null) {
            Bundle bundleA03 = C1318Wu.A03(bundle, DynamicLoaderImpl.class.getClassLoader());
    ...
    public final void A0A(InterfaceC1182Rk interfaceC1182Rk) {
        this.A0K.add(interfaceC1182Rk);
    }

    public final void A0B(InterfaceC1182Rk interfaceC1182Rk) {
        this.A0K.remove(interfaceC1182Rk);
    }
    ...
    public final void A0D(String str, C1084Nm c1084Nm) {
        if (this.A08 == null) {
            return;
        }
        AbstractC1377Zd abstractC1377Zd = this.A09;
        if (A0M[6].charAt(30) != 'X') {
            throw new RuntimeException();
        }
        A0M[0] = "nOOhjPgmgj4ymGbfbhDfGuv2YA";
        if (abstractC1377Zd == null) {
            this.A09 = AbstractC1378Ze.A02(this.A0J, this.A0J.A0A(), str, c1084Nm, this.A08, new C1860hS(this));
    ...
    public final void dump(String str, FileDescriptor fileDescriptor, PrintWriter printWriter, String[] strArr) {
        X2.A00();
        if (0 != 0) {
            throw new NullPointerException(A01(WKSRecord.Service.BL_IDM, 15, 124));
        }
    ...
    public final void finish(int i10) {
        if (i10 == 9 && (this.A08 instanceof C0896Ge)) {
            C0896Ge c0896Ge = (C0896Ge) this.A08;
            if (c0896Ge.A0e()) {
                if (this.A09 != null) {
                    YB.A0J(this.A09);
                }
    ...
    public final void onBackPressed() {
        ...
        if (this.A03 > this.A02) {
            ...
            Iterator<InterfaceC1182Rk> it = this.A0K.iterator();
            while (it.hasNext()) {
                if (it.next().AAI()) {
    ...
    public final void onConfigurationChanged(Configuration configuration) {
        if (this.A00 != configuration.orientation) {
            ...
            String strA01 = A01(Sdk$SDKError.Reason.AD_IS_PLAYING_VALUE, 14, 44);
            if (i10 == 1) {
    ...
    public final void onCreate(Bundle bundle) {
        YD.A02();
        this.A0I.A04();
        this.A05 = C1318Wu.A02(this.A0E.getIntent(), DynamicLoaderImpl.class.getClassLoader());
        C1814gi c1814giA04 = C1318Wu.A04(this.A05);
        if (c1814giA04 != null) {
            C1814gi startAdContext = this.A0J;
            startAdContext.A0M(c1814giA04);
        }
        A03(this.A05, bundle);
        C1814gi startAdContext2 = this.A0J;
        ...
        C1814gi startAdContext3 = this.A0J;
        VA vaA0A = startAdContext3.A0A();
        C1814gi startAdContext4 = this.A0J;
        this.A08 = new C1181Rj(this, intent, vaA0A, startAdContext4).A0M(this.A07, this.A06);
        if (this.A08 == null) {
            C1814gi startAdContext5 = this.A0J;
            startAdContext5.A08().ABC(A01(58, 11, 105), AbstractC1226Td.A0A, new C1227Te(A01(0, 58, 116)));
            A09();
            finish(7);
            return;
        }
    ...
    public final void onResume() {
        ...
        this.A04 = System.currentTimeMillis();
        if (this.A08 != null) {
            InterfaceC1356Yi interfaceC1356Yi = this.A08;
            if (A0M[5].charAt(17) != 'w') {
                throw new RuntimeException();
            }
            A0M[6] = "WHwDulcP2dZca7YA0PmotSPySBaz7ZXD";
            interfaceC1356Yi.AFi(false);
            if (this.A0D) {
