    ...
    */
    public static float A00(float r6, int r7) {
        /*
            ...
            java.lang.String[] r1 = com.instagram.common.viewpoint.core.C1007Km.A0C
            r0 = 2
            r0 = r1[r0]
            int r1 = r0.length()
            r0 = 32
            ...
            throw r0
        L25:
            java.lang.String[] r2 = com.instagram.common.viewpoint.core.C1007Km.A0C
        ...
        L3c:
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C1007Km.A00(float, int):float");
    }
    ...
    public static Layout.Alignment A04(int i10) {
        switch (i10) {
            ...
            default:
                AbstractC06064g.A07(A05(23, 15, 34), A05(0, 23, 23) + i10);
                return null;
        }
    }

    public final C05883o A07() {
        int iA03;
        ...
        C05883o c05883oA0A = new C05883o().A0F(A04(this.A06)).A07(A00(this.A00, this.A04), this.A04).A09(this.A03).A04(fA01).A0A(iA03);
        float f10 = this.A02;
        float position = A02(iA03, fA01);
        C05883o c05883oA0B = c05883oA0A.A06(Math.min(f10, position)).A0B(this.A07);
        if (this.A0A != null) {
            c05883oA0B.A0G(this.A0A);
        }
        return c05883oA0B;
    }

    public final C1000Kf A08() {
        return new C1000Kf(A07().A0H(), this.A09, this.A08);
    }
}
