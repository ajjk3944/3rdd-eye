...
public final class C1197Rz implements MediaViewVideoRendererApi {
    ...
    public final AbstractC0838Dx A0E = new AbstractC0838Dx() { // from class: com.facebook.ads.redexgen.X.7H
        /* JADX INFO: Access modifiers changed from: private */
        @Override // com.instagram.common.viewpoint.core.UN
        /* renamed from: A00, reason: merged with bridge method [inline-methods] */
        public final void A03(C0839Dy c0839Dy) {
            this.A00.A00.onSeek();
        }
    };
    public final EA A09 = new EA() { // from class: com.facebook.ads.redexgen.X.7G
        ...
        public final void A03(C4K c4k) {
            ...
            if (!C1264Up.A1j(this.A00.A00.getContext())) {
                return;
            }
            this.A00.A00.play(VideoStartReason.AUTO_STARTED);
        }
    };
    public final AbstractC0832Dr A0F = new AbstractC0832Dr() { // from class: com.facebook.ads.redexgen.X.7F
        /* JADX INFO: Access modifiers changed from: private */
        @Override // com.instagram.common.viewpoint.core.UN
        /* renamed from: A00, reason: merged with bridge method [inline-methods] */
    ...
    public C1184Rm A02 = new C1184Rm();
    ...
    public final void A04(NativeAd nativeAd) {
        this.A08 = nativeAd;
        C1814gi c1814giA16 = ((UK) nativeAd.getInternalNativeAd()).A16();
        C1814gi adObjectContext = this.A03;
        ...
        C1996ju c1996juA12 = UK.A0L(nativeAd.getInternalNativeAd()).A12();
        if (c1996juA12 != null) {
            this.A05.setVideoProgressReportIntervalMs(c1996juA12.A0B());
        }
    ...
    public final void A07(InterfaceC1369Yv interfaceC1369Yv) {
        this.A05.setListener(interfaceC1369Yv);
    }
    ...
    public final void engageSeek() {
        if (this.A06) {
            ...
            this.A06 = true;
            this.A07 = EnumC1756fm.A0A.equals(this.A05.getState());
    ...
    public final void initialize(AdViewConstructorParams adViewConstructorParams, MediaViewVideoRenderer mediaViewVideoRenderer) {
        ...
        if (context instanceof C1814gi) {
            c1814giA03 = (C1814gi) context;
        } else {
            c1814giA03 = C1187Rp.A03(context);
        }
        this.A03 = c1814giA03;
        switch (adViewConstructorParams.getInitializationType()) {
            case 0:
                this.A05 = new C06696r(c1814giA03);
                break;
            case 1:
                this.A05 = new C06696r(c1814giA03, adViewConstructorParams.getAttributeSet());
                break;
            case 2:
                this.A05 = new C06696r(c1814giA03, adViewConstructorParams.getAttributeSet(), adViewConstructorParams.getDefStyleAttr());
                break;
            case 3:
                this.A05 = new C06696r(c1814giA03, adViewConstructorParams.getAttributeSet(), adViewConstructorParams.getDefStyleRes());
                break;
            default:
        ...
        EnumC1324Xc.A04(this.A05, EnumC1324Xc.A0B);
    ...
    public final boolean shouldAutoplay() {
        if (this.A05 == null || this.A05.getState() == EnumC1756fm.A06) {
            return false;
        }
