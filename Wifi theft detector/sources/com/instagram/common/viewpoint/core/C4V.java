...
public final class C4V extends AbstractC0901Gj {
    ...
    public int A00;
    public VH A01;
    public AbstractC1527c3 A02;
    public InterfaceC1645dy A03;
    public C1682ea A04;
    ...
    public final AbstractC1349Yb A0J;
    public final InterfaceC1644dx A0K;
    public final C0861Eu A0L;
    public final C0851Ek A0M;
    ...
    public final E2 A0R;
    public final E0 A0S;
    public final AbstractC0840Dz A0T;
    public final DZ A0U;
    ...
    private synchronized void A0S(boolean z10, boolean z11) {
        ...
        if (this.A08) {
            boolean zA2C = C1264Up.A2C(super.A05);
            if (!z10 && (!zA2C || !z11)) {
                if (z11) {
                    super.A05.A0F().ACC();
                }
    ...
    public C4V(C1814gi c1814gi, ZU zu, VA va, AbstractC1979jd abstractC1979jd, C1220Sx c1220Sx, InterfaceC1355Yh interfaceC1355Yh) {
        ...
        this.A0T = new AbstractC0840Dz() { // from class: com.facebook.ads.redexgen.X.4r
            /* JADX INFO: Access modifiers changed from: private */
            @Override // com.instagram.common.viewpoint.core.UN
            /* renamed from: A00, reason: merged with bridge method [inline-methods] */
        ...
        this.A0O = new EA() { // from class: com.facebook.ads.redexgen.X.4q
            ...
            public final void A03(C4K c4k) {
                this.A00.A0N(c4k, this.A00.A0M.getState() != EnumC1756fm.A06, false);
            }
        };
        this.A0P = new C06044e(this);
        boolean z10 = false;
        this.A0E = false;
        this.A0F = false;
        this.A0D = false;
        ...
        this.A0M = new C0851Ek(super.A05);
        this.A0M.setFunnelLoggingHandler(super.A07);
        this.A0M.getEventBus().A03(this.A0S, this.A0R, this.A0Q, this.A0T, this.A0O, this.A0P);
        this.A0B = abstractC1979jd.A1t();
        this.A0N = new C4L(super.A05, super.A06, this.A0M, super.A03.A2E(), 0, 0, super.A03.A29().A0U(), null, null);
        if (C1264Up.A20(super.A05)) {
            this.A0L = new C0861Eu(super.A05, super.A06, this.A0M, super.A03.A2E(), super.A03.A29().A0U(), this.A0N, null);
        } else {
            this.A0L = null;
        }
        this.A04 = new C1682ea(super.A05, super.A0B, super.A03.A1G(), interfaceC1355Yh);
        if (!A0m()) {
            this.A0H = new C0820Df(super.A05, super.A07);
        } else {
            this.A0H = new C0818Dd(super.A05, super.A07);
        }
        ...
        if (C1264Up.A2K(super.A05) || super.A03.A1h()) {
    ...
    public static int A02(AbstractC1979jd abstractC1979jd) {
        if (abstractC1979jd.A10().equals(A0A(18, 14, 49))) {
            return abstractC1979jd.A29().A0H().A03();
        }
        if (abstractC1979jd.A10().equals(A0A(6, 12, 112))) {
            return abstractC1979jd.A29().A0H().A04();
        }
        String[] strArr = A0W;
    ...
    private AbstractC1527c3 A06(int i10) throws SecurityException {
        C1530c6 c1530c6A0M = new C1530c6(super.A05, super.A06, super.A0A, super.A03, this.A0M, super.A0C, super.A08).A0J(super.A09.getToolbarHeight()).A0P(super.A09).A0I(i10).A0K(this.A0H).A0R(this.A0U).A0M(super.A07);
        if (super.A03.A29().A0S() && C1264Up.A1d(super.A05) && super.A03.A29().A0L() != null) {
            c1530c6A0M.A0O(getPackageInstallListener());
        }
        c1530c6A0M.A0L(C1067Mu.A00(super.A05, super.A06, A0A(0, 0, 98), XB.A00(super.A03.A29().A0J().A05()), new HashMap(), super.A03.A2A()));
        C1531c7 params = c1530c6A0M.A0U();
        return AbstractC1528c4.A00(params, null, true);
    }

    private void A0B() {
        this.A0M.postDelayed(new GV(this), C1264Up.A0O(super.A05));
    }

    private void A0C() {
        this.A0M.postDelayed(new GU(this), C1264Up.A0P(super.A05));
    }
    ...
    private void A0E() {
        ...
        if (this.A0H instanceof InterfaceC1702eu) {
            this.A0M.A0f((InterfaceC1702eu) this.A0H);
        }
        ...
        if (!A0m()) {
            ...
            this.A0M.A0f(new C0822Dh(anonymousClass34, EnumC1717f9.A02, true));
        }
    ...
    private void A0G(VH vh) {
        ...
        if (!super.A03.A1r()) {
            this.A0G.postDelayed(new RunnableC1640dt(this), 2000L);
        }
    }
    ...
    public void A0N(C4K c4k, boolean z10, boolean z11) {
        ...
        if (!z10 && this.A08 && this.A0B) {
            this.A00++;
            this.A0M.A0e(EnumC1701et.A02, 20);
            return;
        }
        if (!this.A0C) {
            A0D();
        ...
        if (!z10 && this.A00 < super.A03.A29().A0G()) {
            this.A0M.A0e(EnumC1701et.A02, 32);
        } else {
            this.A0D = true;
            if (this.A02 != null) {
                this.A02.A1I(c4k);
    ...
    public void A0O(C4A c4a) {
        if (this.A0M.getState() == EnumC1756fm.A02 && C1264Up.A1e(super.A05)) {
    ...
    public void A0P(C4A c4a) {
        ...
        if (this.A08) {
            ...
            AbstractC1979jd abstractC1979jd = super.A03;
            if (A0W[6].length() != 22) {
                String[] strArr = A0W;
                strArr[0] = "";
                strArr[1] = "CRWrhlQnYLwh";
                if (!ViewOnClickListenerC1012Kr.A05(abstractC1979jd)) {
        ...
        if (!zA1s) {
            ...
            AbstractC1349Yb abstractC1349Yb = super.A09;
            String[] strArr3 = A0W;
            ...
            if (totalSecondsForNextCta4 != currentPosMs6) {
                ...
                abstractC1349Yb.A0C(unskippableSeconds2, i10);
            } else {
                A0W[3] = "ksHgyK5pJeiIhpnbSmOLRLGEWkwS8h7S";
                float unskippableSeconds3 = 100.0f * f10;
                abstractC1349Yb.A0C(unskippableSeconds3, i10);
            }
        }
        if (f10 >= 1.0f && !this.A0C) {
            A0D();
            AbstractC1349Yb abstractC1349Yb2 = super.A09;
            int currentPosMs7 = getCloseButtonStyle();
            abstractC1349Yb2.setToolbarActionMode(currentPosMs7);
        }
    }
    ...
    public final AbstractC1349Yb A0c() {
        ...
        if (A0m() && super.A03.A2T()) {
            abstractC1349YbA0c.setOnTouchListener(new ViewOnTouchListenerC1642dv(this));
        }
        if (super.A03.A2T()) {
            abstractC1349YbA0c.setOnClickListener(new ViewOnClickListenerC1638dr(this));
        }
    ...
    public final void A0g() {
        if (this.A02 != null) {
            ...
            if (super.A03.A29().A0H().A07() != null) {
                this.A0M.A0d(EnumC1693el.A05);
                if (C1264Up.A1H(super.A05)) {
                    super.A03.A29().A0H().A07().A0U(false);
                }
            }
            EnumC1063Mq enumC1063MqA1B = this.A02.A1B(A0A(32, 4, 60));
            if (super.A03.A2N()) {
                return;
            }
    ...
    public final void A0k(C1176Re c1176Re) {
        ...
        this.A02.setAccidentalClickCappingListener(new InterfaceC1064Mr() { // from class: com.facebook.ads.redexgen.X.GW
        ...
        A0j(this.A02);
        if (super.A01 != null) {
            addView(super.A01, AbstractC0901Gj.A0H);
        }
        boolean z10 = false;
        if (A0m()) {
        ...
        AbstractC1527c3 abstractC1527c3 = this.A02;
        if (A0W[5].charAt(8) != 'f') {
            throw new RuntimeException();
        }
        String[] strArr = A0W;
    ...
    public final void A0n() {
        ...
        if (A0m()) {
            ...
            if (abstractC1527c3 instanceof C6H) {
    ...
    public final void AFi(boolean z10) {
        ...
        if (this.A0M.getVisibility() != 0 || this.A0M.A0o() || this.A0D || this.A0M.getState() == EnumC1756fm.A06 || this.A05 == null) {
            return;
        }
        if (!this.A0A || z10) {
    ...
    private InterfaceC1329Xh getPackageInstallListener() {
        return new GS(this);
    }
    ...
    public void setVideoLeadingPlayableAdListener(InterfaceC1645dy interfaceC1645dy) {
        this.A03 = interfaceC1645dy;
    }
}
