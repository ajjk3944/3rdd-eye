...
public final class TT implements Thread.UncaughtExceptionHandler {
    ...
    public final InterfaceC1223Ta A01;
    ...
    public TT(Thread.UncaughtExceptionHandler uncaughtExceptionHandler, C1810ge c1810ge, TS ts) {
        this(uncaughtExceptionHandler, c1810ge, ts, AbstractC1224Tb.A00());
    }

    public TT(Thread.UncaughtExceptionHandler uncaughtExceptionHandler, C1810ge c1810ge, TS ts, InterfaceC1223Ta interfaceC1223Ta) {
        this.A02 = uncaughtExceptionHandler;
        if (c1810ge != null) {
            this.A00 = c1810ge;
            this.A03 = ts.A97(c1810ge);
            this.A01 = interfaceC1223Ta;
            return;
        }
    ...
    public final void uncaughtException(Thread thread, Throwable th) {
        try {
            String strA03 = AbstractC1341Xt.A03(this.A00, th);
            if (!TextUtils.isEmpty(strA03)) {
                ...
                if (strA03.contains(stackTraceString)) {
                    ...
                    this.A01.AL7(new C1230Th(this.A00.A09().A01(), this.A00.A09().A02(), mapA02), this.A00);
                    if (C1264Up.A2A(this.A00)) {
                        C1264Up.A0e(this.A00);
                    }
                }
            }
