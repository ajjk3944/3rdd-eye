...
public final class C1590d4 extends FrameLayout {
    ...
    public EnumC1701et A00;
    public boolean A01;
    public boolean A02;
    public boolean A03;
    public boolean A04;
    public final AbstractC1979jd A05;
    public final C1220Sx A06;
    public final C1814gi A07;
    public final VI A08;
    public final InterfaceC1355Yh A09;
    public final ZU A0A;
    public final InterfaceC1589d3 A0B;
    public final C0861Eu A0C;
    public final C0851Ek A0D;
    ...
    public final E2 A0I;
    public final E0 A0J;
    public final AbstractC0840Dz A0K;
    ...
    public C1590d4(C1814gi c1814gi, VA va, AbstractC1979jd abstractC1979jd, C1220Sx c1220Sx, VI vi, InterfaceC1355Yh interfaceC1355Yh, ZU zu, InterfaceC1589d3 interfaceC1589d3) {
        boolean z10;
        super(c1814gi);
        ...
        this.A0K = new AbstractC0840Dz() { // from class: com.facebook.ads.redexgen.X.5q
            /* JADX INFO: Access modifiers changed from: private */
            @Override // com.instagram.common.viewpoint.core.UN
        ...
        this.A0G = new C06385m(this);
        this.A03 = false;
        this.A04 = false;
        this.A02 = false;
        this.A01 = false;
        this.A07 = c1814gi;
        this.A05 = abstractC1979jd;
        this.A06 = c1220Sx;
        this.A08 = vi;
        this.A09 = interfaceC1355Yh;
        this.A0A = zu;
        this.A0D = new C0851Ek(c1814gi);
        this.A0B = interfaceC1589d3;
        this.A0D.setFunnelLoggingHandler(vi);
        this.A0D.getEventBus().A03(this.A0J, this.A0I, this.A0H, this.A0K, this.A0F, this.A0G);
        this.A0E = new C4L(c1814gi, va, this.A0D, abstractC1979jd.A2E());
        if (C1264Up.A20(this.A07)) {
            z10 = true;
            this.A0C = new C0861Eu(c1814gi, va, this.A0D, abstractC1979jd.A2E(), false, this.A0E, null);
        } else {
            z10 = true;
            this.A0C = null;
        }
        ...
        String videoUrl = abstractC1979jd.A29().A0H().A08();
        if (!TextUtils.isEmpty(videoUrl)) {
            AbstractC1515br.A00(c1814gi, this, videoUrl);
        }
    ...
    private void A08() {
        this.A0D.postDelayed(new JC(this), C1264Up.A0O(this.A07));
    }

    private void A09() {
        this.A0D.postDelayed(new J8(this), C1264Up.A0P(this.A07));
    }
    ...
    private void A0B() {
        ...
        this.A0D.A0f(new C0822Dh(anonymousClass34, EnumC1717f9.A02, true));
        this.A0D.A0f(new C3B(this.A07));
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void A0H(C4A c4a) {
        if (this.A0D.getState() == EnumC1756fm.A02 && C1264Up.A1e(this.A07)) {
    ...
    public final void A0N() {
        ...
        this.A0D.A0e(EnumC1701et.A02, 26);
        A08();
    }
    ...
    public final void A0T(boolean z10) {
        if (this.A0D.A0o() || this.A02 || this.A0D.getState() == EnumC1756fm.A06 || this.A00 == null) {
            return;
        }
        if (!this.A01 || z10) {
    ...
    public final void A0V(boolean z10) {
        this.A0D.A0e(EnumC1701et.A04, 25);
    }
}
