...
public final class JL {
    ...
    public static final C2051kp A05;
    public static final C2051kp A06;
    public int A01;
     ...
     */
    private void A06(InterfaceC2165ms interfaceC2165ms, List<Metadata.Entry> list) throws IOException {
        long jA8n = interfaceC2165ms.A8n();
        int iA8O = (int) ((interfaceC2165ms.A8O() - interfaceC2165ms.A8n()) - this.A01);
        C06214v c06214v = new C06214v(iA8O);
        interfaceC2165ms.readFully(c06214v.A0l(), 0, iA8O);
        for (int i10 = 0; i10 < this.A02.size(); i10++) {
            JI ji = this.A02.get(i10);
            c06214v.A0f((int) (ji.A02 - jA8n));
            c06214v.A0g(4);
            ...
            int iA00 = A00(c06214v.A0W(iA0E));
            int i11 = ji.A01 - (iA0E + 8);
            switch (iA00) {
                case 2192:
                    list.add(A01(c06214v, i11));
                    break;
                case 2816:
                case 2817:
                case 2819:
    ...
    */
    ...
    public static SlowMotionData A01(C06214v c06214v, int i10) throws C3K, NumberFormatException {
        List<SlowMotionData.Segment> segments = new ArrayList<>();
        String dataString = c06214v.A0W(i10);
    ...
    private void A04(InterfaceC2165ms interfaceC2165ms, HV hv) throws IOException {
        C06214v c06214v = new C06214v(8);
        interfaceC2165ms.readFully(c06214v.A0l(), 0, 8);
        this.A01 = c06214v.A0E() + 8;
        if (c06214v.A0C() != 1397048916) {
            hv.A00 = 0L;
        } else {
            hv.A00 = interfaceC2165ms.A8n() - (this.A01 - 12);
            this.A00 = 2;
        }
    }

    private void A05(InterfaceC2165ms interfaceC2165ms, HV hv) throws IOException {
        ...
        for (int i11 = 0; i11 < i10 / 12; i11++) {
            ...
            switch (i12) {
                ...
                case 2820:
                    ...
                    long streamLength2 = c06214v.A0E();
                    int size = c06214v.A0E();
    ...
    public final int A07(InterfaceC2165ms interfaceC2165ms, HV hv, List<Metadata.Entry> slowMotionMetadataEntries) throws IOException {
        long j10 = 0;
        switch (this.A00) {
            case 0:
                long jA8O = interfaceC2165ms.A8O();
                ...
                return 1;
            case 1:
                A04(interfaceC2165ms, hv);
                return 1;
            case 2:
                A05(interfaceC2165ms, hv);
                return 1;
            case 3:
                A06(interfaceC2165ms, slowMotionMetadataEntries);
                hv.A00 = 0L;
                return 1;
            default:
                throw new IllegalStateException();
