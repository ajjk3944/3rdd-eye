...
public final class C7N extends AbstractC1862hU {
    ...
    public AbstractC1158Qm A00;
    public AbstractC1158Qm A01;

    private int A00(R2 r22, View view, AbstractC1158Qm abstractC1158Qm) {
        int containerCenter;
        int iA0F = abstractC1158Qm.A0F(view) + (abstractC1158Qm.A0D(view) / 2);
        if (r22.A1V()) {
            int iA0A = abstractC1158Qm.A0A();
            int childCenter = abstractC1158Qm.A0B();
            containerCenter = iA0A + (childCenter / 2);
        } else {
            int childCenter2 = abstractC1158Qm.A06();
            containerCenter = childCenter2 / 2;
        }
        return iA0F - containerCenter;
    }

    private View A01(R2 r22, AbstractC1158Qm abstractC1158Qm) {
        int i10;
        int iA0Y = r22.A0Y();
        if (iA0Y == 0) {
            return null;
        ...
        if (r22.A1V()) {
            int iA0A = abstractC1158Qm.A0A();
            int childCount = abstractC1158Qm.A0B();
            i10 = iA0A + (childCount / 2);
        } else {
            int childCount2 = abstractC1158Qm.A06();
            i10 = childCount2 / 2;
        }
        int i11 = Integer.MAX_VALUE;
        for (int i12 = 0; i12 < iA0Y; i12++) {
            View viewA0v = r22.A0v(i12);
            int iA0F = abstractC1158Qm.A0F(viewA0v);
            int childCount3 = abstractC1158Qm.A0D(viewA0v);
    ...
    private View A02(R2 r22, AbstractC1158Qm abstractC1158Qm) {
        int iA0Y = r22.A0Y();
        if (iA0Y == 0) {
            return null;
        }
    ...
    private AbstractC1158Qm A03(R2 r22) {
        if (this.A00 == null || this.A00.A02 != r22) {
            this.A00 = AbstractC1158Qm.A00(r22);
        }
        return this.A00;
    }

    private AbstractC1158Qm A04(R2 r22) {
        if (this.A01 == null || this.A01.A02 != r22) {
            this.A01 = AbstractC1158Qm.A01(r22);
        }
        return this.A01;
    }

    /* JADX WARN: Multi-variable type inference failed */
    @Override // com.instagram.common.viewpoint.core.AbstractC1862hU
    public final int A0C(R2 r22, int i10, int i11) {
        int iA0r;
        int centerPosition;
        int iA0b = r22.A0b();
        if (iA0b == 0) {
    ...
    @Override // com.instagram.common.viewpoint.core.AbstractC1862hU
    public final C1883hq A0E(R2 r22) {
        if (!(r22 instanceof RE)) {
            return null;
        }
        final Context context = super.A00.getContext();
        return new C1883hq(context) { // from class: com.facebook.ads.redexgen.X.7O
            @Override // com.instagram.common.viewpoint.core.C1883hq, com.instagram.common.viewpoint.core.RF
            public final void A0I(View view, RH rh, RD rd) {
                int[] iArrA0H = this.A00.A0H(((AbstractC1862hU) this.A00).A00.getLayoutManager(), view);
                int time = iArrA0H[0];
                int dy = iArrA0H[1];
                int dx = A0M(Math.max(Math.abs(time), Math.abs(dy)));
                if (dx > 0) {
                    rd.A04(time, dy, dx, ((C1883hq) this).A04);
                }
            }

            @Override // com.instagram.common.viewpoint.core.C1883hq
