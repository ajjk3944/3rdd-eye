...
public abstract class AbstractC2349pt implements AnonymousClass24 {
    ...
    public static final AnonymousClass23<AbstractC2349pt> A03;
    ...
    static {
        ...
        A03 = new AnonymousClass23() { // from class: com.facebook.ads.redexgen.X.pu
            ...
            public final AnonymousClass24 A6f(Bundle bundle) {
                return AbstractC2349pt.A04(bundle);
            }
        };
    }

    public static AbstractC2349pt A04(Bundle bundle) {
        int i10 = bundle.getInt(A02, -1);
        switch (i10) {
            case 0:
                return (AbstractC2349pt) AX.A02.A6f(bundle);
            case 1:
                AbstractC2349pt abstractC2349pt = (AbstractC2349pt) AV.A02.A6f(bundle);
                if (A01[6].charAt(2) != 'F') {
                    String[] strArr = A01;
                    strArr[7] = "RK";
                    strArr[1] = MBridgeConstans.ENDCARD_URL_TYPE_PL;
                    return abstractC2349pt;
                }
                break;
            case 2:
                return (AbstractC2349pt) AU.A04.A6f(bundle);
            case 3:
                ...
                if (A01[6].charAt(2) != 'F') {
                    ...
                    strArr2[7] = "Vr";
                    strArr2[1] = "2";
                    return (AbstractC2349pt) anonymousClass24A6f;
                }
                break;
            default:
