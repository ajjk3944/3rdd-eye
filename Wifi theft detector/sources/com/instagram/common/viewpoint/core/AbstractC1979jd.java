...
public abstract class AbstractC1979jd extends NQ implements Serializable {
    ...
    public AbstractC1979jd(List<NR> list) {
        this.A0P = list;
    }
    ...
    private HashMap<String, String> A07(JSONObject jSONObject) {
        JSONObject jSONObjectOptJSONObject = jSONObject.optJSONObject(A05(Type.IXFR, 18, 77));
    ...
    public static List<NR> A08(JSONObject jSONObject, C1814gi c1814gi, InterfaceC1076Ne interfaceC1076Ne) {
        JSONArray jSONArrayOptJSONArray = jSONObject.optJSONArray(A05(156, 8, 28));
        if (jSONArrayOptJSONArray != null && jSONArrayOptJSONArray.length() > 0) {
            return NZ.A01(jSONArrayOptJSONArray, jSONObject, c1814gi, interfaceC1076Ne);
        }
        List<AdInfo> adInfoList = new ArrayList<>();
        NR nrA00 = NR.A00(jSONObject);
        interfaceC1076Ne.A3y(nrA00, jSONObject);
    ...
    private final void A0D(C1078Ng c1078Ng) {
        this.A07 = c1078Ng;
    }

    private void A0E(C1081Nj c1081Nj) {
        this.A08 = c1081Nj;
    }

    private final void A0F(C1084Nm c1084Nm) {
        this.A09 = c1084Nm;
    }

    private void A0G(C1090Ns c1090Ns) {
        this.A0A = c1090Ns;
    }
    ...
    public final C1078Ng A2A() {
        return this.A07;
    }

    public final C1081Nj A2B() {
        return this.A08;
    }

    public final C1084Nm A2C() {
        return this.A09;
    }

    public final C1090Ns A2D() {
        return this.A0A;
    }
    ...
    */
    public final void A2H(com.instagram.common.viewpoint.core.InterfaceC1355Yh r5) {
        /*
            r4 = this;
        ...
        L10:
            ...
            r5.A4j(r0)
        L1d:
            com.facebook.ads.redexgen.X.ez r0 = com.instagram.common.viewpoint.core.EnumC1707ez.A08
        ...
        L39:
            ...
            goto Lc
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.AbstractC1979jd.A2H(com.facebook.ads.redexgen.X.Yh):void");
    }

    public final void A2I(JSONObject jSONObject) {
        String strA05;
        A0D(C1078Ng.A00(jSONObject.optJSONObject(A05(Sdk$SDKError.Reason.MRAID_ERROR_VALUE, 16, 74))));
        A0R = jSONObject.optJSONObject(A05(144, 12, 40));
        C1083Nl c1083NlA06 = new C1083Nl().A06(jSONObject.optString(A05(591, 5, 77)));
        ...
        A0F(c1083NlA06.A05(strA05).A04(jSONObject.optString(A05(0, 19, 64))).A07(AbstractC1085Nn.A03(jSONObject)).A08());
        ...
        C1072Na c1072NaA01 = C1072Na.A01(layoutObject);
        String[] strArr = A0T;
        ...
        A0C(new NN(c1072NaA01, C1072Na.A01(jSONObjectOptJSONObject != null ? jSONObjectOptJSONObject.optJSONObject(A05(361, 9, 71)) : null)));
        A0G(AbstractC1085Nn.A01(jSONObject));
        A0E(AbstractC1085Nn.A00(jSONObject));
        ...
        String strOptString = jSONObject.optString(A05(Type.TKEY, 2, 124));
        A0H(strOptString);
