...
public final class F2 extends FrameLayout implements InterfaceC1686ee {
    public TextView A00;
    public TextView A01;
    public TextView A02;
    public TextView A03;
    ...
    public F2(C1814gi c1814gi, NativeAd nativeAd, C1278Vd c1278Vd, EnumC1279Ve enumC1279Ve, C1508bk c1508bk, MediaView mediaView, AdOptionsView adOptionsView) {
        super(c1814gi);
        this.A07 = new ArrayList<>();
        this.A05 = nativeAd;
        this.A04 = mediaView;
        this.A06 = new C1687ef(c1814gi, this.A05, c1278Vd, c1508bk, adOptionsView);
        this.A06.setPadding(A0C, A0C, A0C, A0E);
        addView(this.A06, new FrameLayout.LayoutParams(-1, -2));
        if (enumC1279Ve == EnumC1279Ve.A09 || enumC1279Ve == EnumC1279Ve.A0B) {
            A07(c1278Vd);
        }
        addView(this.A04, new FrameLayout.LayoutParams(-1, -2));
        if (enumC1279Ve != EnumC1279Ve.A0B || this.A05.getAdCreativeType() != NativeAd.AdCreativeType.CAROUSEL) {
            A06(c1278Vd);
            A04(c1278Vd);
            A05(c1278Vd);
        }
        this.A07.add(c1508bk);
    ...
    */
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        C1687ef c1687ef = this.A06;
        int top = this.A06.getMeasuredHeight();
        c1687ef.layout(i10, i11, i12, top + i11);
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (emptySpace == 0) {
            ...
            if (emptySpace2 == 0 || ((C1844hC) this.A04.getMediaViewApi()).A0b()) {
                iMin = iA00;
            } else {
