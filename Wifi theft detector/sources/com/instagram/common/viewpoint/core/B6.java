...
public class B6 {
    ...
    public B0 A02(boolean z10, C1970jQ c1970jQ, EnumC1967jL enumC1967jL, String str) throws Exception {
        Set<B0> set;
        if (this.A02.A0I(z10, c1970jQ) && B7.A0G(str, c1970jQ)) {
            ...
            if (set != null) {
                synchronized (set) {
                    if (!set.isEmpty()) {
                        ...
                        B0 ret = it.next();
                        it.remove();
                        this.A02.A03().A0A(z10, str, enumC1967jL, ret.hashCode());
                        return ret;
                    }
                }
            }
        ...
        try {
            C1965jJ c1965jJA05 = this.A02.A03().A05(z10, str, enumC1967jL);
            B0 b0A03 = A03(z10, str);
            this.A02.A03().A06(c1965jJA05, b0A03.hashCode());
            return b0A03;
        } catch (Exception e10) {
    ...
    public B0 A03(boolean z10, String str) throws Exception {
        ...
        return new C2239o6(MediaCodec.createByCodecName(str));
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: A07, reason: merged with bridge method [inline-methods] */
    public void A0B(EnumC1967jL enumC1967jL) {
        String strA04;
        String str;
        B7 b72;
        Set<B0> set;
        ...
        while (it.hasNext()) {
            ...
            try {
                try {
                    if (!next.A05) {
                        A08(next.A01, enumC1967jL, Boolean.valueOf(next.A04), next.A00);
                    } else {
                        try {
                            try {
    ...
    private void A08(C1970jQ c1970jQ, EnumC1967jL enumC1967jL, Boolean bool, B0 b02) {
        try {
            if (!c1970jQ.A0R || (!bool.booleanValue() && !c1970jQ.A0Q)) {
                b02.stop();
            }
        } finally {
            this.A02.A03().A08(enumC1967jL, b02.hashCode());
            b02.AHb();
            this.A02.A03().A07(enumC1967jL, b02.hashCode());
        }
    }
    ...
    */
    public void A0A(boolean r24, com.instagram.common.viewpoint.core.C1970jQ r25, final com.instagram.common.viewpoint.core.EnumC1967jL r26, java.lang.String r27, com.instagram.common.viewpoint.core.B0 r28) throws java.lang.Throwable {
        /*
