...
public final class C05351j extends AQ {
    ...
    public final long AGi(C06345i c06345i) throws C2305pA {
        ...
        try {
            try {
                this.A02.seek(c06345i.A04);
                this.A00 = c06345i.A03 == -1 ? this.A02.length() - c06345i.A04 : c06345i.A03;
                AnonymousClass54.A00();
                if (this.A00 < 0) {
                    throw new C2305pA(null, null, 2008);
                }
                this.A03 = true;
                A0H(c06345i);
                long j10 = this.A00;
    ...
    public static RandomAccessFile A00(Uri uri) throws C2305pA {
        try {
            return new RandomAccessFile((String) AbstractC05983y.A01(uri.getPath()), A01(29, 1, 31));
            ...
            if (zIsEmpty && TextUtils.isEmpty(uri.getFragment())) {
                throw new C2305pA(e10, (C5C.A02 < 21 || !C06365k.A00(e10.getCause())) ? 2005 : 2006);
            }
            throw new C2305pA(String.format(A01(30, PsExtractor.AUDIO_STREAM, 19), uri.getPath(), uri.getQuery(), uri.getFragment()), e10, 1004);
        } catch (SecurityException e11) {
            throw new C2305pA(e11, 2006);
        } catch (RuntimeException e12) {
            throw new C2305pA(e12, 2000);
        }
    }
    ...
    */
    public final void close() throws com.instagram.common.viewpoint.core.C2305pA {
        /*
            r6 = this;
            r4 = 0
            r6.A01 = r4
        ...
        Ld:
            r6.A02 = r4
            boolean r4 = r6.A03
            java.lang.String[] r2 = com.instagram.common.viewpoint.core.C05351j.A05
            r0 = 0
            r1 = r2[r0]
            r0 = 2
            r0 = r2[r0]
        ...
        L73:
            ...
            goto L6d
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C05351j.close():void");
    }

    @Override // com.instagram.common.viewpoint.core.InterfaceC05542c
    @MetaExoPlayerCustomization("FB tracing added in D4783963 for calls to TraceUtil.beginSection and TraceUtil.endSection")
    public final int read(byte[] bArr, int i10, int i11) throws C2305pA {
        if (i11 == 0) {
            return 0;
        }
        try {
