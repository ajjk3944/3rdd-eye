...
public class CallableC1219Sw implements Callable<Boolean> {
    public static byte[] A02;
    public final C1218Sv A00;
    ...
    public CallableC1219Sw(C1220Sx c1220Sx, C1218Sv c1218Sv) {
        this.A01 = c1220Sx;
        this.A00 = c1218Sv;
    }
    ...
    private final Boolean A00() throws Throwable {
        ...
        try {
            ...
            if (this.A01.A08) {
                precacheResult = C1220Sx.A03(this.A01.A04.A02()).AIe(lx, false).A01();
    ...
    private void A04(String str, LX lx) {
        Bitmap bitmapA00 = C1220Sx.A03(this.A01.A04.A02()).AIe(lx, true).A00();
        if (bitmapA00 == null) {
            return;
        }
