...
public final class C1675eS {
    ...
    public final NN A0e;
    public final NY A0f;
    public final C1075Nd A0g;
    public final C1084Nm A0h;
    public final C1814gi A0i;
    public final VI A0j;
    public final InterfaceC1355Yh A0k;
    public final ViewOnClickListenerC1012Kr A0l;
    public int A06 = 160;
    public int A07 = 130;
    public int A03 = 56;
    public int A04 = 430;
    ...
    public C1675eS(final C1814gi c1814gi, AbstractC1979jd abstractC1979jd, InterfaceC1355Yh interfaceC1355Yh, ViewOnClickListenerC1012Kr viewOnClickListenerC1012Kr, Handler handler, VI vi) {
        this.A0i = c1814gi;
        this.A0d = abstractC1979jd;
        this.A0j = vi;
        this.A0h = abstractC1979jd.A2C();
        this.A0g = abstractC1979jd.A29().A0K();
        this.A0k = interfaceC1355Yh;
        this.A0b = handler;
        this.A0f = abstractC1979jd.A29().A0I();
        this.A0e = abstractC1979jd.A28();
        this.A0l = viewOnClickListenerC1012Kr;
        this.A0S = new C7M(c1814gi) { // from class: com.facebook.ads.redexgen.X.1E
        ...
        this.A0P = new RelativeLayout(c1814gi);
        this.A0W = new C1508bk(c1814gi);
        this.A0R = new TextView(c1814gi);
        this.A0M = new ImageView(c1814gi);
    ...
    private ImageView A03() {
        ...
        if (this.A0l != null && this.A0l.getCtaActionHelper().A06() == null) {
            this.A0l.getCtaActionHelper().A07(new InterfaceC1064Mr() { // from class: com.facebook.ads.redexgen.X.FQ
                @Override // com.instagram.common.viewpoint.core.InterfaceC1064Mr
    ...
    private LinearLayout A06() {
        ...
        arrayList.add(new C1678eV(this.A0i).A02(new C1497bZ(this.A0i, -1, -1, YM.RATINGS)).A04(this.A0f.A0C()).A03(this.A0f.A0B()));
        if (!this.A0f.A09().isEmpty()) {
            try {
                strA09 = AbstractC1328Xg.A01(Integer.parseInt(this.A0f.A09()));
            } catch (NumberFormatException unused) {
                strA09 = this.A0f.A09();
            }
            arrayList.add(new C1678eV(this.A0i).A02(new C1497bZ(this.A0i, -1, -1, YM.NUCLEUS_GROUP)).A04(strA09).A03(this.A0f.A0A()));
        }
        if (!this.A0f.A05().isEmpty()) {
            arrayList.add(new C1678eV(this.A0i).A02(new C1497bZ(this.A0i, -1, -1, YM.DOWNLOAD)).A04(this.A0f.A05()).A03(this.A0f.A06()));
        }
        NY ny = this.A0f;
        if (A0o[2].length() == 29) {
            throw new RuntimeException();
        ...
        A0o[2] = "3vpsIj";
        if (!ny.A01().isEmpty()) {
            arrayList.add(new C1678eV(this.A0i).A02(new C1497bZ(this.A0i, -1, -1, YM.NUCLEUS_DURATION)).A04(this.A0f.A01()).A03(this.A0f.A0D()));
        }
        if (!this.A0f.A02().isEmpty()) {
            arrayList.add(new C1678eV(this.A0i).A02(new C1497bZ(this.A0i, -1, -1, YM.GRID_4)).A04(this.A0f.A02()).A03(this.A0f.A03()));
        }
    ...
    private LinearLayout A07(RelativeLayout relativeLayout, ViewOnClickListenerC1012Kr viewOnClickListenerC1012Kr) {
        LinearLayout linearLayout = new LinearLayout(this.A0i);
        linearLayout.setOrientation(0);
        linearLayout.setGravity(17);
        RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-2, -2);
        layoutParams.addRule(3, viewOnClickListenerC1012Kr.getId());
        ...
        linearLayout.setId(View.generateViewId());
        C1497bZ iconView = new C1497bZ(this.A0i, -1, -1, YM.GOOGLE_PLAY_STORE);
    ...
    private RelativeLayout.LayoutParams A0B(C1508bk c1508bk) {
        RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-2, -2);
        layoutParams.addRule(14);
        layoutParams.addRule(3, c1508bk.getId());
    ...
    private TextView A0E(RelativeLayout relativeLayout, C1508bk c1508bk) {
        TextView textView = new TextView(this.A0i);
        ...
        textView.setLayoutParams(A0B(c1508bk));
        relativeLayout.addView(textView);
        textView.setId(View.generateViewId());
        return textView;
    }

    private C1508bk A0G(LinearLayout linearLayout) {
        C1508bk c1508bk = new C1508bk(this.A0i);
        c1508bk.setRadius(30);
        YB.A0N(c1508bk, 0);
        LM downloadImageTask = new LM(c1508bk, this.A0i).A04();
        downloadImageTask.A07(this.A0h.A01());
        c1508bk.setLayoutParams(A08(linearLayout));
        c1508bk.setId(View.generateViewId());
        return c1508bk;
    }
    ...
    private void A0I() {
        ...
        if (shouldShowThirdEndCard2 && this.A0g.A00() > 0) {
            ...
            AbstractC1677eU.A01(this.A0i, this.A0M, this.A0g.A00(), this.A0N);
        }
    }
    ...
    private void A0L() {
        ...
        if (parent2 instanceof ViewGroup) {
            this.A0m.set(true);
            this.A0X = new C1543cJ(this.A0i, this.A0d, this.A0j, this.A0b, this.A0k);
    ...
    private void A0Q(RelativeLayout relativeLayout, LinearLayout linearLayout, ViewOnClickListenerC1012Kr viewOnClickListenerC1012Kr) {
        this.A0T = AbstractC1424aO.A01(this.A0i, false, this.A0d, this.A0j, this.A0k, EnumC1422aM.A02, AbstractC1421aL.A00(this.A0d));
        YB.A0K(this.A0T);
        RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-2, -2);
        layoutParams.setMargins(0, this.A0B, 0, this.A0B);
        layoutParams.addRule(7, viewOnClickListenerC1012Kr.getId());
        layoutParams.addRule(3, linearLayout.getId());
        this.A0T.setLayoutParams(layoutParams);
        relativeLayout.addView(this.A0T);
    }

    private void A0R(RelativeLayout relativeLayout, LinearLayout linearLayout, ViewOnClickListenerC1012Kr viewOnClickListenerC1012Kr) {
        this.A0U = AbstractC1424aO.A01(this.A0i, false, this.A0d, this.A0j, this.A0k, EnumC1422aM.A02, EnumC1425aP.A04);
        YB.A0K(this.A0U);
        RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-2, -2);
        layoutParams.setMargins(0, this.A0H, 0, this.A0B);
        layoutParams.addRule(5, viewOnClickListenerC1012Kr.getId());
        layoutParams.addRule(3, linearLayout.getId());
        this.A0U.setLayoutParams(layoutParams);
        relativeLayout.addView(this.A0U);
    }

    private void A0S(RelativeLayout relativeLayout, LinearLayout linearLayout, ViewOnClickListenerC1012Kr viewOnClickListenerC1012Kr) {
        this.A0V = AbstractC1424aO.A02(this.A0i, EnumC1422aM.A02, this.A0d);
        RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-2, -2);
        layoutParams.setMargins(0, this.A0B, 0, this.A0B);
        layoutParams.addRule(5, viewOnClickListenerC1012Kr.getId());
        layoutParams.addRule(3, linearLayout.getId());
    ...
    private void A0T(RelativeLayout relativeLayout, ViewOnClickListenerC1012Kr viewOnClickListenerC1012Kr, LinearLayout linearLayout, TextView textView) {
        RelativeLayout.LayoutParams layoutParamsA09 = A09(linearLayout, textView);
        viewOnClickListenerC1012Kr.setIncludeFontPadding(false);
        viewOnClickListenerC1012Kr.setLayoutParams(layoutParamsA09);
        viewOnClickListenerC1012Kr.A0D();
        viewOnClickListenerC1012Kr.setHeight(this.A03);
        viewOnClickListenerC1012Kr.setTextSize(18.0f);
        viewOnClickListenerC1012Kr.setCornerRadiusPx(40);
        viewOnClickListenerC1012Kr.setTextColor(A00(this.A0e.A01().A04()));
        YB.A0V(viewOnClickListenerC1012Kr, YB.A06(this.A0e.A01().A04(), 40));
        viewOnClickListenerC1012Kr.setId(View.generateViewId());
        if (viewOnClickListenerC1012Kr.getParent() != null) {
            ((ViewGroup) viewOnClickListenerC1012Kr.getParent()).removeView(viewOnClickListenerC1012Kr);
        }
        relativeLayout.addView(viewOnClickListenerC1012Kr);
        String[] strArr = A0o;
        if (strArr[7].length() == strArr[5].length()) {
            throw new RuntimeException();
        }
    ...
    private void A0U(ViewOnClickListenerC1012Kr viewOnClickListenerC1012Kr) {
        this.A0S.setLayoutManager(new C1884hr(this.A0i, 0, false));
        ...
        this.A0S.setAdapter(new FO(this.A0i, this.A0g.A02(), this.A0H, this.A0S, viewOnClickListenerC1012Kr, i10));
    }

    private void A0V(final InterfaceC1674eR interfaceC1674eR) {
        final ImageView imageView = new ImageView(this.A0i);
        imageView.setAdjustViewBounds(true);
        LM lm = new LM(imageView, this.A0i);
        if (!this.A0g.A02().isEmpty()) {
            lm.A06(new InterfaceC1470b8() { // from class: com.facebook.ads.redexgen.X.FR
                @Override // com.instagram.common.viewpoint.core.InterfaceC1470b8
                public final void AE7(C1469b7 c1469b7) {
                    this.A02.A0c(imageView, interfaceC1674eR, c1469b7);
                }
            });
            lm.A07(this.A0g.A02().get(0));
        } else {
            interfaceC1674eR.AE9();
        }
    }
    ...
    public final FrameLayout A0W() {
        ...
        this.A0P = A0C();
        if (C1264Up.A1D(this.A0i)) {
            this.A0P.setOnClickListener(new ViewOnClickListenerC1672eP(this));
        }
        A0P(this.A0P);
        this.A0O = A06();
        ...
        if (this.A0d.A2T()) {
            ...
            blackBackgroundView.setOnClickListener(new ViewOnClickListenerC1673eQ(this));
        ...
        A0V(new InterfaceC1674eR() { // from class: com.facebook.ads.redexgen.X.FX
            @Override // com.instagram.common.viewpoint.core.InterfaceC1674eR
    ...
    public final void A0a(int i10) {
        if (!this.A0m.get()) {
            ...
            if (fo == null) {
                this.A0i.A08().ABC(A0H(16, 11, 8), AbstractC1226Td.A0A, new C1227Te(A0H(72, 42, 15)));
            }
            if (this.A0l != null) {
    ...
    public final /* synthetic */ void A0b(View view) {
        if (this.A0l != null) {
            EnumC1063Mq enumC1063MqA0E = this.A0l.A0E(A0H(114, 4, 84));
            if (this.A0d.A2N()) {
                return;
            }
            EnumC1063Mq actionOutcome = EnumC1063Mq.A09;
            if (enumC1063MqA0E != actionOutcome) {
                EnumC1063Mq actionOutcome2 = EnumC1063Mq.A06;
                if (enumC1063MqA0E != actionOutcome2) {
                    A0Z();
                }
            }
        }
    ...
    public final /* synthetic */ void A0c(ImageView imageView, InterfaceC1674eR interfaceC1674eR, C1469b7 c1469b7) {
