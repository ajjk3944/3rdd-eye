...
public final class MetaExoPlayerUpgradeConfig {
    ...
    public static final Map<EnumC1974jX, Boolean> A02;
    public static final Map<EnumC1975jY, Integer> A03;
    public static final Map<EnumC1976jZ, Long> A04;
    ...
    static {
        ...
        A02 = new EnumMap(EnumC1974jX.class);
        A03 = new EnumMap(EnumC1975jY.class);
        A04 = new EnumMap(EnumC1976jZ.class);
        for (EnumC1974jX enumC1974jX : EnumC1974jX.valuesCustom()) {
            A02.put(enumC1974jX, false);
        }
        for (EnumC1975jY enumC1975jY : EnumC1975jY.valuesCustom()) {
            A03.put(enumC1975jY, -1);
        }
        for (EnumC1976jZ id : EnumC1976jZ.values()) {
            A04.put(id, -1L);
        }
        A02.put(EnumC1974jX.A0W, true);
        A02.put(EnumC1974jX.A0Q, true);
        A02.put(EnumC1974jX.A1j, true);
        A03.put(EnumC1975jY.A05, 100);
    }

    @JvmStatic
    public static final int A00(EnumC1975jY enumC1975jY) {
        C2388qY.A09(enumC1975jY, A01(24, 17, 40));
        Integer num = A03.get(enumC1975jY);
        if (num != null) {
            return num.intValue();
        }
    ...
    @JvmStatic
    public static final boolean A03(EnumC1974jX enumC1974jX) {
        C2388qY.A09(enumC1974jX, A01(24, 17, 40));
        return C2388qY.A0C(true, A02.get(enumC1974jX));
    }
}
