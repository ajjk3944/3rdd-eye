...
public final class AnonymousClass13<T extends Enum<T>> extends AbstractC05431r<T> implements InterfaceC0744Ac<T>, Serializable {
    ...
    public AnonymousClass13(T[] tArr) {
        C2388qY.A09(tArr, A03(7, 7, 113));
        this.A00 = tArr;
    }

    private final int A00(T t10) {
        C2388qY.A09(t10, A03(0, 7, 111));
    ...
    public final T get(int i10) {
        AbstractC05431r.A02.A03(i10, this.A00.length);
        return this.A00[i10];
    }
    ...
    @Override // com.instagram.common.viewpoint.core.AbstractC0750Ai, java.util.Collection, java.util.List
