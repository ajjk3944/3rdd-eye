...
public class ViewOnClickListenerC1252Ud implements View.OnClickListener, View.OnLongClickListener, View.OnTouchListener, T4 {
    ...
    public static void A02() {
        A02 = new byte[]{101, 64, 4, 71, 69, 74, 74, 75, 80, 4, 70, 65, 4, 71, 72, 77, 71, 79, 65, 64, 4, 70, 65, 66, 75, 86, 65, 4, 77, 80, 4, 77, 87, 4, 82, 77, 65, 83, 65, 64, 10, 42, 5, 0, 10, 2, 26, 73, 1, 8, 25, 25, 12, 7, 12, 13, 73, 29, 6, 6, 73, 15, 8, 26, 29, 71, 13, 9, 10, 62, 47, 34, 46, 37, 40, 46, 5, 46, 63, 60, 36, 57, 32, 24, 57, 118, 34, 57, 35, 53, 62, 118, 50, 55, 34, 55, 118, 36, 51, 53, 57, 36, 50, 51, 50, 122, 118, 38, 58, 51, 55, 37, 51, 118, 51, 56, 37, 35, 36, 51, 118, 34, 57, 35, 53, 62, 118, 51, 32, 51, 56, 34, 37, 118, 36, 51, 55, 53, 62, 118, 34, 62, 51, 118, 55, 50, 118, 0, 63, 51, 33, 118, 52, 47, 118, 36, 51, 34, 35, 36, 56, 63, 56, 49, 118, 48, 55, 58, 37, 51, 118, 63, 48, 118, 47, 57, 35, 118, 63, 56, 34, 51, 36, 53, 51, 38, 34, 118, 34, 62, 51, 118, 51, 32, 51, 56, 34, 120, 13, Flags.CD, 16, 120, 98, 127};
    }
    ...
    public ViewOnClickListenerC1252Ud(UK uk, C1814gi c1814gi) {
        this.A01 = uk;
        this.A00 = c1814gi;
    }

    public /* synthetic */ ViewOnClickListenerC1252Ud(UK uk, C1814gi c1814gi, C1296Vx c1296Vx) {
        this(uk, c1814gi);
    }

    private Map<String, String> A01() {
        Map<String, String> mapA05 = new C1471b9().A03(this.A01.A0U).A02(this.A01.A0j).A05();
    ...
    public final void A04() {
        if (this.A01.A08 != null) {
            ((C1843hB) this.A01.A08.getNativeAdLayoutApi()).A04(new ZX(this.A01.A0g));
        }
    }
    ...
    public final void onClick(View view) {
        ...
        try {
            ...
            int minimumElapsedTime = C1264Up.A0K(this.A01.A0g);
