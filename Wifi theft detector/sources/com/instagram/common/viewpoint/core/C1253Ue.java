...
public class C1253Ue {
     ...
     */
    public static C1253Ue A04(File file) throws IOException {
        try {
            ...
            return new C1253Ue(randomAccessFile, jArr, randomAccessFile.length());
    ...
    public C1253Ue(RandomAccessFile randomAccessFile, long[] jArr, long j10) throws IOException {
        ...
        for (int i12 = 1; i12 < this.A00; i12++) {
            if (jArr[i12 - 1] > jArr[i12]) {
                throw new IOException(String.format(Locale.US, A05(Sdk$SDKError.Reason.PLACEMENT_AD_TYPE_MISMATCH_VALUE, 50, 76), Integer.valueOf(i12 - 1), Long.valueOf(jArr[i12 - 1]), Integer.valueOf(i12), Long.valueOf(jArr[i12])));
            }
        }
    ...
    public static C1253Ue A03(File file) throws IOException {
        RandomAccessFile randomAccessFile = new RandomAccessFile(file, A05(TTAdConstant.PACKAGE_NAME_CODE, 3, 33));
        try {
            randomAccessFile.writeLong(-360011992771067903L);
            randomAccessFile.writeLong(C1254Uf.A03);
            randomAccessFile.write(new byte[C1254Uf.A03 * 8]);
            randomAccessFile.getFD().sync();
            return new C1253Ue(randomAccessFile, new long[C1254Uf.A03], randomAccessFile.length());
        } catch (IOException unused) {
