...
public final class C0880Fo {
    ...
    public Handler A04;
    public Pair<Long, C2374qI> A05;
    public Pair<Surface, C06254z> A06;
    ...
    public final ArrayDeque<Pair<Long, C2374qI>> A0E = new ArrayDeque<>();
    public int A00 = -1;
    public boolean A09 = true;
    public long A02 = C.TIME_UNSET;
    public C2327pW A07 = C2327pW.A06;
    ...
    public C0880Fo(G7 g72, AnonymousClass10 anonymousClass10, boolean z10) {
        this.A0D = g72;
    ...
    public static boolean A04(long j10) {
        if (MetaExoPlayerUpgradeConfig.A03(EnumC1974jX.A1w)) {
            return j10 > ServiceProvider.SCAR_SIGNALS_FETCH_TIMEOUT;
        }
        int releaseLowerThresholdUs = MetaExoPlayerUpgradeConfig.A00(EnumC1975jY.A08);
        int releaseUpperThresholdUs = MetaExoPlayerUpgradeConfig.A00(EnumC1975jY.A07);
    ...
    /* JADX WARN: Code restructure failed: missing block: B:42:0x010e, code lost:
        ...
        r30.A0C.A0S(r24, r2, (com.instagram.common.viewpoint.core.C2374qI) r30.A05.second, null);
     */
    ...
    */
    public final void A0B(long r31, long r33) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C0880Fo.A0B(long, long):void");
    }

    public final void A0C(Surface surface, C06254z c06254z) {
        if (this.A06 != null && ((Surface) this.A06.first).equals(surface) && ((C06254z) this.A06.second).equals(c06254z)) {
            return;
        }
        this.A06 = Pair.create(surface, c06254z);
        if (A0G()) {
            AbstractC05983y.A01(null);
            new AnonymousClass50(surface, c06254z.A03(), c06254z.A02());
            throw new NullPointerException(A01(108, 20, 7));
        }
    }

    /* JADX WARN: Type inference failed for: r1v0, types: [com.facebook.ads.redexgen.X.4I] */
    public final void A0D(C2374qI c2374qI) {
        AbstractC05983y.A01(null);
        final int i10 = c2374qI.A0L;
        final int i11 = c2374qI.A0A;
        new Object(i10, i11) { // from class: com.facebook.ads.redexgen.X.4I
            ...
            public final C4J A01() {
                return new Object(this.A02, this.A01, this.A00, this.A03) { // from class: com.facebook.ads.redexgen.X.4J
                    ...
                    {
                        AbstractC05983y.A09(i > 0, A00(33, 32, 18) + i);
                        AbstractC05983y.A09(i > 0, A00(0, 33, 109) + i);
                        this.A02 = i;
                        this.A01 = i;
                        this.A00 = f;
                        this.A03 = j;
    ...
    public final boolean A0H() {
        return this.A06 == null || !((C06254z) this.A06.second).equals(C06254z.A03);
    }
    ...
    public final boolean A0J(C2374qI c2374qI, long j10) throws AD {
        AbstractC05983y.A08(!A0G());
        if (!this.A09) {
            return false;
        }
        if (this.A08 == null) {
        ...
        this.A04 = C5C.A0Y();
        this.A0C.A26(c2374qI.A0N);
        try {
            if (!AnonymousClass10.A0h() && c2374qI.A0F != 0) {
                CopyOnWriteArrayList<C4H> copyOnWriteArrayList = this.A08;
                C0879Fn.A00(c2374qI.A0F);
            ...
            throw this.A0C.A1S(e10, c2374qI, 7000);
        }
    }

    public final boolean A0K(C2374qI c2374qI, long j10, boolean z10) {
        AbstractC05983y.A02(null);
