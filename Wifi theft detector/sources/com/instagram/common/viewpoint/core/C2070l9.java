...
public final class C2070l9 implements LH {
    ...
    public boolean A02;
    public boolean A03;
    public final C06214v A04 = new C06214v(32);
    public final L8 A05;

    public C2070l9(L8 l82) {
        this.A05 = l82;
    }

    @Override // com.instagram.common.viewpoint.core.LH
    public final void A5B(C06214v c06214v, int i10) {
        boolean z10 = (i10 & 1) != 0;
        int iA09 = -1;
        if (z10) {
            iA09 = c06214v.A09() + c06214v.A0I();
        }
        ...
        while (c06214v.A07() > 0) {
            if (this.A00 < 3) {
                if (this.A00 == 0) {
                    ...
                    c06214v.A0f(c06214v.A09() - 1);
                    if (iA0I == 255) {
                        this.A03 = true;
                        return;
                    }
                }
                int iMin = Math.min(c06214v.A07(), 3 - this.A00);
                c06214v.A0k(this.A04.A0l(), this.A00, iMin);
                this.A00 += iMin;
                if (this.A00 == 3) {
                    this.A04.A0f(0);
                    this.A04.A0e(3);
                ...
                int iMin2 = Math.min(c06214v.A07(), this.A01 - this.A00);
                c06214v.A0k(this.A04.A0l(), this.A00, iMin2);
                this.A00 += iMin2;
