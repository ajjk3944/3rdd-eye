...
public final class C2U implements CY, InterfaceC1795gP {
    ...
    public final T8 A00;
    public final TP A01;
    public final InterfaceC1765fv A02;
    public final InterfaceC1796gQ A03;
    public final C1804gY A04;
    public final InterfaceC1805gZ A05;
    public final String A06;
    public final Map<EnumC1791gL, C0792Cb> A09 = new HashMap();
    public final Map<EnumC1791gL, AbstractC05552d> A08 = new HashMap();
    public final List<InterfaceC1809gd> A07 = new ArrayList();
    ...
    private void A04() throws Throwable {
        ...
        synchronized (this) {
            for (C0792Cb c0792Cb : this.A09.values()) {
                if (c0792Cb.AAe()) {
                    map.put(c0792Cb, EnumC1812gg.A05);
                } else {
                    map.put(c0792Cb, EnumC1812gg.A04);
                }
            }
            new AtomicReference();
            new AtomicReference();
            Iterator<AbstractC05552d> it = this.A08.values().iterator();
            while (it.hasNext()) {
                it.next();
                InterfaceC1790gK interfaceC1790gK = null;
                if (interfaceC1790gK.AAe()) {
                    throw new NullPointerException(A01(349, 20, 51));
                }
            }
            Iterator<InterfaceC1809gd> it2 = this.A07.iterator();
            if (it2.hasNext()) {
                it2.next();
        ...
        synchronized (this) {
            ...
            Set<InterfaceC1808gc> setA02 = A02((JSONObject) atomicReference.get());
            HashMap map5 = new HashMap();
            HashMap map6 = new HashMap();
            Iterator<InterfaceC1808gc> it3 = setA02.iterator();
            while (it3.hasNext()) {
                it3.next().A4D(map5, map6);
            }
            this.A03.A6b(A00((JSONObject) atomicReference.get()));
            Iterator<InterfaceC1809gd> it4 = this.A07.iterator();
            if (it4.hasNext()) {
                it4.next();
    ...
    private synchronized void A08(Throwable th) {
        Iterator<InterfaceC1809gd> it = this.A07.iterator();
        if (it.hasNext()) {
            it.next();
            new HashMap();
            new HashMap();
    ...
    public final synchronized InterfaceC1790gK A5U(EnumC1791gL enumC1791gL) {
        if (enumC1791gL.A03() != EnumC1793gN.A04) {
            throw new IllegalArgumentException(A01(47, 59, 101));
        }
        if (this.A09.containsKey(enumC1791gL)) {
            return this.A09.get(enumC1791gL);
        }
        C0792Cb c0792Cb = new C0792Cb(enumC1791gL);
        this.A09.put(enumC1791gL, c0792Cb);
        Iterator<InterfaceC1809gd> it = this.A07.iterator();
        if (it.hasNext()) {
            it.next();
            throw new NullPointerException(A01(377, 24, 120));
        }
        String.format(Locale.US, A01(153, 35, 123), enumC1791gL);
        return c0792Cb;
    }
    ...
    public C2U(T8 t82, TP tp, InterfaceC1765fv interfaceC1765fv, String str, InterfaceC1805gZ interfaceC1805gZ, C1804gY c1804gY, InterfaceC1794gO interfaceC1794gO) {
        this.A00 = t82;
        this.A01 = tp;
        this.A02 = interfaceC1765fv;
        this.A06 = str;
        this.A05 = interfaceC1805gZ;
        this.A04 = c1804gY;
        this.A03 = interfaceC1794gO.A5E(this);
    }
    ...
    private Set<InterfaceC1808gc> A02(JSONObject jSONObject) throws JSONException {
        HashSet hashSet = new HashSet();
        JSONObject jSONObject2 = jSONObject.getJSONObject(A01(369, 8, 52));
        JSONObject data = jSONObject.getJSONObject(A01(298, 7, 109));
        Iterator<C0792Cb> it = this.A09.values().iterator();
        while (true) {
            ...
            strArr2[3] = "8JT";
            if (zHasNext) {
                final C0792Cb next = it.next();
                switch (C1807gb.A01[EnumC1813gh.A00(jSONObject2.getString(next.A8F().A04())).ordinal()]) {
                    case 1:
                        ...
                        hashSet.add(new CL(next, fingerprint, responseObject) { // from class: com.facebook.ads.redexgen.X.2X
                            ...
                            {
                                EnumC1813gh enumC1813gh = EnumC1813gh.A03;
                                this.A00 = fingerprint;
                                this.A01 = responseObject;
                            }

                            @Override // com.instagram.common.viewpoint.core.CL, com.instagram.common.viewpoint.core.InterfaceC1808gc
                            public final void A4D(Map<InterfaceC1790gK, EnumC1813gh> map, Map<SyncModifiableBundle, EnumC1800gU> map2) {
                    ...
                    case 2:
                        hashSet.add(new CL(next) { // from class: com.facebook.ads.redexgen.X.2W
                            {
                                EnumC1813gh enumC1813gh = EnumC1813gh.A04;
                            }
                        });
                        break;
                    default:
                ...
                Iterator<AbstractC05552d> it2 = this.A08.values().iterator();
                while (it2.hasNext()) {
                    it2.next();
                    final AbstractC05552d abstractC05552d = null;
                    switch (C1807gb.A00[EnumC1800gU.A00(jSONObject2.getString(abstractC05552d.A8F().A04())).ordinal()]) {
                        case 1:
                            hashSet.add(new CM(abstractC05552d) { // from class: com.facebook.ads.redexgen.X.2b
                                {
                                    EnumC1800gU enumC1800gU = EnumC1800gU.A03;
                                }
                            });
                            break;
                        case 2:
                            hashSet.add(new CM(abstractC05552d) { // from class: com.facebook.ads.redexgen.X.2V
                                ...
                                {
                                    EnumC1800gU enumC1800gU = EnumC1800gU.A04;
                                }

                                @Override // com.instagram.common.viewpoint.core.CM, com.instagram.common.viewpoint.core.InterfaceC1808gc
                                public final void A4D(Map<InterfaceC1790gK, EnumC1813gh> map, Map<SyncModifiableBundle, EnumC1800gU> map2) {
    ...
    private JSONObject A03(Map<InterfaceC1790gK, EnumC1812gg> map, Map<SyncModifiableBundle, EnumC1799gT> map2, Map<SyncModifiableBundle, JSONObject> clientBundleData, Map<SyncModifiableBundle, JSONObject> clientBundleFingerprint) throws JSONException {
        String strA01;
        JSONObject syncRequest = new JSONObject();
        for (Map.Entry<InterfaceC1790gK, EnumC1812gg> entry : map.entrySet()) {
            syncRequest.put(entry.getKey().A8F().A04(), entry.getValue().A03());
        }
        for (Map.Entry<SyncModifiableBundle, EnumC1799gT> entry2 : map2.entrySet()) {
            entry2.getKey();
            InterfaceC1790gK interfaceC1790gK = null;
            String strA04 = interfaceC1790gK.A8F().A04();
        ...
        Iterator<Map.Entry<InterfaceC1790gK, EnumC1812gg>> it = map.entrySet().iterator();
        while (true) {
            boolean zHasNext = it.hasNext();
            ...
            Map.Entry<InterfaceC1790gK, EnumC1812gg> next = it.next();
            if (next.getValue() == EnumC1812gg.A05) {
                JSONObject updateData = new JSONObject();
                InterfaceC1790gK key = next.getKey();
                ...
                EnumC1791gL enumC1791gLA8F = key.A8F();
                String[] strArr2 = A0B;
                if (strArr2[7].length() != strArr2[2].length()) {
                    String[] strArr3 = A0B;
                    strArr3[1] = "cfjTgROdu8b";
                    strArr3[3] = "qIs";
                    jSONObject.put(enumC1791gLA8F.A04(), updateData);
                } else {
                    A0B[4] = "vaTQWmMwm";
                    jSONObject.put(enumC1791gLA8F.A04(), updateData);
                }
        ...
        for (Map.Entry<SyncModifiableBundle, EnumC1799gT> entry3 : map2.entrySet()) {
            JSONObject updateData2 = new JSONObject();
            InterfaceC1790gK key2 = entry3.getKey();
            JSONObject request2 = clientBundleFingerprint.get(entry3.getKey());
            updateData2.put(strA01, request2);
            if (entry3.getValue() == EnumC1799gT.A05) {
    ...
    @Override // com.instagram.common.viewpoint.core.InterfaceC1795gP
    public final void AIo() {
        ...
        try {
            if (!C1264Up.A27(this.A00) || this.A00.A04().AAU()) {
                A04();
                return;
            }
            throw new IllegalStateException(A01(29, 18, 127));
        } catch (Throwable th) {
            String.format(Locale.US, A01(Type.TKEY, 49, 109), Integer.valueOf(this.A04.A01()));
            A08(th);
