...
public final class P2 {
    ...
    public P2(Context context) {
        this.A00 = context;
        this.A01 = new HandlerC1123Oz(this, context.getMainLooper());
    }
    ...
    public final void A05(BroadcastReceiver broadcastReceiver) {
        synchronized (this.A04) {
            ...
            for (int size = arrayListRemove.size() - 1; size >= 0; size--) {
                ...
                p12.A01 = true;
                for (int j10 = 0; j10 < p12.A03.countActions(); j10++) {
                    String action = p12.A03.getAction(j10);
                    ArrayList<P1> arrayList = this.A03.get(action);
                    if (arrayList != null) {
                        int i10 = arrayList.size();
                        for (int i11 = i10 - 1; i11 >= 0; i11--) {
                            P1 p13 = arrayList.get(i11);
        ...
        synchronized (this.A04) {
            ...
            if (arrayList != null) {
                ...
                for (int i10 = 0; i10 < arrayList.size(); i10++) {
                    P1 p12 = arrayList.get(i10);
                    if (debug) {
                        StringBuilder sb3 = new StringBuilder();
                        String type6 = A01(104, 24, 106);
                        sb3.append(type6).append(p12.A03).toString();
                    }
                    if (!p12.A00) {
