...
public final class C1175Rd implements AdViewApi {
    ...
    public C1175Rd(Context context, String str, AdSize adSize, AdViewParentApi adViewParentApi, AdView adView) {
        this.A00 = -1L;
        if (adSize != null && adSize != AdSize.INTERSTITIAL) {
            ...
            this.A08 = adView;
            this.A0A = C1187Rp.A08(context);
            this.A0A.A0F().A3T(AdPlacementType.BANNER.toString(), str);
            O7 o72 = new O7(str, XG.A05(this.A0B), AdPlacementType.BANNER, XG.A04(adSize), 1, new C1933ij());
            o72.A06(this.A05);
            o72.A07(this.A06);
            this.A03 = new C06887k(this.A0A, o72);
            this.A03.A0S(new C1854hM(this));
            return;
        }
        throw new IllegalArgumentException(A01(108, 6, 37));
    }

    public C1175Rd(Context context, String str, String str2, AdViewParentApi adViewParentApi, AdView adView) throws C1287Vn {
        this(context, str, A00(str2), adViewParentApi, adView);
        this.A0A.A0F().A4T();
    }

    public static AdSize A00(String str) throws C1287Vn {
        EnumC1289Vq template = C1293Vu.A00(str);
        if (template != null) {
            C1293Vu.A03(template);
            return XG.A01(template);
        }
        throw new C1287Vn(AdErrorType.BID_PAYLOAD_ERROR, String.format(Locale.US, A01(67, 41, 115), str));
    }
    ...
    public final void A0B(RelativeLayout relativeLayout, View view) {
        ...
        if (this.A06 != null && (c1662eFA01 = AbstractC1661eE.A01(this.A0A, this.A06)) != null) {
            ViewGroup.LayoutParams layoutParams = view.getLayoutParams();
            relativeLayout.addView(c1662eFA01, new RelativeLayout.LayoutParams(layoutParams.width, layoutParams.height));
        }
    }
    ...
    public final void A0D(C1468b6 c1468b6) {
        this.A04 = c1468b6;
    }
    ...
    public final void destroy() {
        AbstractC1297Vy.A05(A01(114, 7, 45), A01(24, 19, 68), A01(16, 8, 6));
        this.A0A.A0F().A3U();
        if (this.A03 != null) {
            this.A03.A0Y(true);
            this.A03.A0K();
        ...
        if (this.A04 != null) {
            ...
            if (C1264Up.A1C(adView.getContext())) {
                this.A04.A07();
                if (this.A01 != null) {
    ...
    public final void loadAd() {
        AbstractC1297Vy.A05(A01(121, 6, 47), A01(43, 24, 116), A01(8, 8, 59));
        A03(null);
    }

    @Override // com.facebook.ads.internal.api.AdViewApi
    public final void loadAd(AdView.AdViewLoadConfig adViewLoadConfig) {
        AbstractC1297Vy.A05(A01(121, 6, 47), A01(43, 24, 116), A01(0, 8, 54));
    ...
    public final void onConfigurationChanged(Configuration configuration) {
        ...
        if (this.A01 != null) {
            AbstractC1291Vs.A01(this.A07, this.A01, this.A0B);
        }
    }
    ...
    public final void setExtraHints(ExtraHints extraHints) {
        ...
        if (C1264Up.A0l(this.A0A) && this.A03 != null) {
