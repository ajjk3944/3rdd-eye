...
public class RunnableC1602dG implements Runnable {
    public static byte[] A02;
    public final /* synthetic */ C1605dJ A00;
    ...
    public RunnableC1602dG(C1605dJ c1605dJ, String str) {
        this.A00 = c1605dJ;
        this.A01 = str;
    }
        ...
        try {
            try {
                ...
                if (this.A00.A05.equals(jSONObject.optString(A00(64, 7, 87)))) {
                    this.A00.A0C(EnumC1603dH.A00(jSONObject.optString(A00(81, 4, 27))), jSONObject.optString(A00(71, 10, 49), A00(85, 2, 32)));
                } else {
                    this.A00.A04.A04(AbstractC1226Td.A11, A00(0, 30, 47));
                }
            } catch (JSONException e10) {
                this.A00.A04.A04(AbstractC1226Td.A15, A00(30, 34, 108) + e10.getMessage());
            }
        } catch (Throwable th) {
            WU.A00(th, this);
        }
