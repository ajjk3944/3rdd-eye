...
public final class C2024kN implements InterfaceC1057Mk {
    ...
    public static final C2024kN A03 = new C2024kN(Collections.emptyMap());
    public int A00;
    ...
    public C2024kN(Map<String, byte[]> metadata) {
        this.A01 = Collections.unmodifiableMap(metadata);
    }

    public static Map<String, byte[]> A00(Map<String, byte[]> otherMetadata, C1058Ml c1058Ml) {
    ...
    */
    public static void A01(java.util.HashMap<java.lang.String, byte[]> r2, java.util.List<java.lang.String> r3) {
        ...
        L11:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C2024kN.A01(java.util.HashMap, java.util.List):void");
    }
    ...
    public static byte[] A04(Object obj) {
        ...
        if (obj instanceof String) {
            return ((String) obj).getBytes(AbstractC2011k9.A05);
        }
    ...
    public final C2024kN A05(C1058Ml c1058Ml) {
        Map<String, byte[]> mapA00 = A00(this.A01, c1058Ml);
        Map<String, byte[]> mutatedMetadata = this.A01;
        if (A03(mutatedMetadata, mapA00)) {
            return this;
        }
        return new C2024kN(mapA00);
    }
    ...
    @Override // com.instagram.common.viewpoint.core.InterfaceC1057Mk
    ...
    public final boolean equals(Object obj) {
        ...
        return A03(this.A01, ((C2024kN) obj).A01);
    }
