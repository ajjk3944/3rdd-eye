...
public final class C1318Wu {
    ...
    public static final Set<C1814gi> A06;
    ...
    public static int A00(C1814gi c1814gi, Intent intent) throws C1316Ws {
        Intent intentA01 = A01(intent);
        int usedContext = 0;
        try {
            Activity activityA00 = ActivityUtils.A00();
            if (activityA00 == null) {
                activityA00 = c1814gi.A0E();
                usedContext = 1;
            }
            if (activityA00 != null) {
            ...
            c1814gi.startActivity(intentA01);
            return 2;
        } catch (ActivityNotFoundException e10) {
            throw new C1316Ws(e10);
        }
    }
    ...
    public static C1814gi A04(Intent intent) {
        String stringExtra = intent.getStringExtra(A03);
        if (stringExtra != null) {
            for (C1814gi c1814gi : A06) {
                String adId = c1814gi.A0F().getId();
    ...
    public static AdActivityIntent A05(C1814gi c1814gi) {
        AdActivityIntent adActivityIntent = new AdActivityIntent(c1814gi.getApplicationContext(), A06());
        adActivityIntent.putExtra(A03, c1814gi.A0F().getId());
        A06.add(c1814gi);
    ...
    public static void A09(Activity activity, Intent intent) throws C1316Ws {
        try {
    ...
    public static void A0B(C1814gi c1814gi, AdActivityIntent adActivityIntent) throws C1316Ws {
        Context launchContext;
        Context applicationContext = c1814gi.getApplicationContext();
        if (C1264Up.A2d(c1814gi) && (launchContext = c1814gi.A0E()) != null) {
        ...
        try {
            if (ProcessUtils.isRemoteRenderingProcess()) {
                if (!A0I(c1814gi, adActivityIntent)) {
                    c1814gi.A0F().AIC();
                    return;
                }
                return;
    ...
    public static boolean A0D(C1814gi c1814gi, Intent intent) throws C1316Ws {
        A07.get();
        return A0F(c1814gi, intent, null);
    }

    public static boolean A0E(C1814gi c1814gi, Intent intent) throws C1316Ws {
        A07.get();
        if (0 != 0) {
            ...
            if (activityA0E != null) {
                ...
                try {
                    c1814gi.A0E();
                    throw new NullPointerException(A07(Sdk$SDKError.Reason.AD_IS_LOADING_VALUE, 22, 63));
                } catch (ActivityNotFoundException e10) {
                    throw new C1316Ws(e10);
                } catch (Exception e11) {
                    c1814gi.A08().ABC(A07(90, 8, 57), AbstractC1226Td.A07, new C1227Te(e11));
                    return false;
                }
            }
        }
    ...
    public static boolean A0F(C1814gi c1814gi, Intent intent, X3 x32) throws C1316Ws {
        if (A0C(intent, C1264Up.A0Z(c1814gi))) {
            return false;
        }
        Context context = c1814gi;
        if (A01[1].charAt(5) != 'g') {
            A01[2] = "mGLT8eS8inmCxtBfGXr0XCfYNSNKmj30";
            Context startContext = c1814gi.A0E();
            if (startContext != null) {
                context = startContext;
            } else {
                intent.addFlags(268435456);
            }
            if (x32 != null && !A0C(intent, C1264Up.A0b(c1814gi))) {
                c1814gi.A0C();
                try {
                    ...
                    c1814gi.A08().ABC(A07(90, 8, 57), AbstractC1226Td.A08, new C1227Te(e11));
                    return false;
                }
            }
            try {
                ...
                throw new C1316Ws(e12);
            }
        }
        throw new RuntimeException();
    }

    public static boolean A0G(C1814gi c1814gi, Uri uri, String str) throws ActivityNotFoundException {
        A08.get();
        return A0H(c1814gi, uri, str, null);
    }

    public static boolean A0H(C1814gi c1814gi, Uri uri, String str, X5 x52) throws ActivityNotFoundException {
        if (x52 == null || c1814gi.A0E() == null) {
            return false;
        }
    ...
    public static boolean A0I(C1814gi c1814gi, AdActivityIntent adActivityIntent) throws C1316Ws {
        Intent intentA01 = A01(adActivityIntent);
        try {
            Activity currentActivity = ActivityUtils.A00();
            if (currentActivity == null) {
                currentActivity = c1814gi.A0E();
            }
            if (currentActivity == null) {
                return false;
            }
