...
public final class C1220Sx {
    ...
    public static final Map<String, C1222Sz> A0G;
    public long A00;
    public VI A01;
    public final C1221Sy A03;
    public final T8 A04;
    ...
    public static C1818gm A05(C1810ge c1810ge) {
        return new C1818gm(c1810ge);
    }
    ...
    public static void A0H(T8 t82, String str) {
        if (T0.A06(t82) && !TextUtils.isEmpty(str)) {
            C1222Sz c1222Sz = A0G.get(str);
            if (A0D[7].length() == 16) {
                throw new RuntimeException();
            }
            A0D[6] = "a10tGuQmEwUEP0sxRmqxEmZkNnUikCvX";
            if (c1222Sz != null) {
                c1222Sz.A00 = A08(185, 4, 118);
                C1810ge c1810geA02 = t82.A02();
                C1745fb c1745fbA06 = C1745fb.A06(c1810geA02);
                String strA09 = C1745fb.A09(c1810geA02, XB.A00(str));
                if (strA09 == null) {
                    strA09 = str;
                }
                T0.A04(t82, c1222Sz, c1745fbA06.A0J(strA09));
            }
        }
    }
    ...
    public static void A0J(List<String> cacheDirs, T8 t82) {
        A0K(cacheDirs, C2054ks.A01(t82));
        A0K(cacheDirs, C1221Sy.A07(t82));
    }
    ...
    public final void A0U() {
        AbstractC1297Vy.A05(A08(127, 19, 125), A08(37, 16, 123), A08(16, 7, 75));
    }

    public final void A0V() {
        AbstractC1297Vy.A05(A08(146, 16, 80), A08(53, 14, 32), A08(8, 8, 50));
    }
    ...
    public final void A0X(InterfaceC1212Sp interfaceC1212Sp, C1213Sq c1213Sq) {
        AbstractC1297Vy.A05(A08(162, 7, 81), A08(67, 18, 90), A08(0, 8, 20));
        this.A00 = System.currentTimeMillis();
        T0.A02(this.A04, c1213Sq, T0.A07, A08(23, 14, 20), -1L);
        YG.A03().execute(new C1819gn(this, new ArrayList(this.A05), c1213Sq, interfaceC1212Sp, new ArrayList(this.A06)));
        this.A05.clear();
        this.A06.clear();
    }

    public final void A0Y(C1216St c1216St) {
        this.A05.add(new CallableC1217Su(this, c1216St));
    }

    public final void A0Z(C1216St c1216St) {
        c1216St.A05 = true;
        this.A06.add(new CallableC1217Su(this, c1216St));
    }

    public final void A0a(C1216St c1216St) {
        c1216St.A05 = true;
        if (this.A09) {
            this.A06.add(new CallableC1215Ss(this, c1216St));
        } else {
            this.A06.add(new CallableC1217Su(this, c1216St));
        }
    }

    public final void A0b(C1216St c1216St) {
        if (this.A09) {
            this.A05.add(new CallableC1215Ss(this, c1216St));
        } else {
            this.A05.add(new CallableC1217Su(this, c1216St));
        }
    }

    public final void A0c(C1218Sv c1218Sv) {
        CallableC1219Sw callableC1219Sw = new CallableC1219Sw(this, c1218Sv);
        if (!c1218Sv.A03) {
            this.A05.add(callableC1219Sw);
        } else {
            this.A06.add(callableC1219Sw);
        }
    }

    public final void A0d(C1218Sv c1218Sv) {
        c1218Sv.A03 = true;
        A0c(c1218Sv);
    }
