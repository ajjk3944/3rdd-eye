...
public class C2412rB {
    ...
    public final Map<String, C2423rN> A00;
    public final Set<C2423rN> A01;
    ...
    public Collection<C2423rN> A00() {
        return this.A01;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public Collection<C2423rN> A01() {
    ...
    public void A04() {
        this.A00.clear();
        Iterator<C2423rN> it = this.A01.iterator();
        while (true) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public boolean A06(C2423rN c2423rN) {
        if (this.A01.add(c2423rN)) {
            this.A00.remove(c2423rN.A02);
            return true;
        }
        return false;
    }
