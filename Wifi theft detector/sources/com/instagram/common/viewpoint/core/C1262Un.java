...
public final class C1262Un {
    ...
    public final ServiceConnection A02 = new ServiceConnectionC1261Um(this);
    ...
    public C1262Un(C1814gi c1814gi, String str, String str2) {
        this.A03 = c1814gi;
        this.A05 = str;
        this.A04 = str2;
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void A07(int i10, C1227Te c1227Te) {
        this.A03.A08().ABC(A05(PsExtractor.PRIVATE_STREAM_1, 14, 110), i10, c1227Te);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void A08(int i10, C1227Te c1227Te) {
        c1227Te.A05(1);
        this.A03.A08().ABD(A05(PsExtractor.PRIVATE_STREAM_1, 14, 110), i10, c1227Te);
    }

    public final void A0C() {
        A08(AbstractC1226Td.A1t, new C1227Te(A05(101, 18, 23), this.A05));
        Intent intent = new Intent();
        intent.setClassName(A05(170, 19, 75), A05(119, 51, 74));
        try {
            if (!this.A03.bindService(intent, this.A02, 1)) {
                A08(AbstractC1226Td.A1p, new C1227Te(A05(51, 50, 106)));
                this.A03.unbindService(this.A02);
            }
        } catch (Exception e10) {
            A07(AbstractC1226Td.A1o, new C1227Te(e10));
        }
    }
}
