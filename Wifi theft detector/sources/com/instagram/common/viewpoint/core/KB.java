...
public final class KB extends AbstractC1527c3 {
    ...
    public final VI A0O;
    public final C1508bk A0P;
    public final C1510bm A0Q;
    public final C1531c7 A0R;
    ...
    public KB(C1531c7 c1531c7) {
        ...
        this.A0T = new EA() { // from class: com.facebook.ads.redexgen.X.6D
            ...
            public final void A03(C4K c4k) {
                this.A00.A0S.A0e(EnumC1701et.A02, 20);
            }
        };
        this.A0V = new RunnableC1557cX(this);
        this.A0N = c1531c7.A06();
        this.A0R = c1531c7;
        ...
        YB.A0K(this.A0F);
        AbstractC1515br.A00(this.A0R.A06(), this, this.A0R.A05().A29().A0H().A08());
    ...
    private C1508bk A0D() {
        C1508bk c1508bk = new C1508bk(this.A0N);
        YB.A0N(c1508bk, 0);
        int i10 = (int) (this.A00 * 0.13f);
        new LM(c1508bk, this.A0N).A05(i10, i10).A07(this.A0R.A05().A2C().A01());
        return c1508bk;
    }

    private C1510bm A0E() {
        C1510bm c1510bm = new C1510bm(this.A0N, A0Y, 5, 0, -1);
        c1510bm.setRating(getRating());
        return c1510bm;
    }

    private C0851Ek A0G() {
        C0851Ek c0851Ek = new C0851Ek(this.A0R.A06());
        this.A0A = new C4L(this.A0N, getAdEventManager(), c0851Ek, this.A0R.A05().A2E(), 0, 0, true, null, null);
        if (C1264Up.A20(this.A0N)) {
            this.A09 = new C0861Eu(this.A0N, getAdEventManager(), c0851Ek, this.A0R.A05().A2E(), false, this.A0A, null);
        } else {
            String[] strArr = A0X;
            if (strArr[2].length() == strArr[4].length()) {
                throw new RuntimeException();
        ...
        c0851Ek.setRoundedCornerVideoView(44.0f);
        return c0851Ek;
    }

    private void A0K() {
        this.A0F.setOnClickListener(new ViewOnClickListenerC1559cZ(this));
        if (this.A0R.A05().A1p()) {
            this.A0M.setOnClickListener(new ViewOnClickListenerC1560ca(this));
        } else {
            this.A0H.setOnClickListener(new ViewOnClickListenerC1561cb(this));
        }
    }

    private void A0L() {
        if (this.A0R.A05().A2M()) {
            this.A06 = A00(this.A0N, this.A0R.A05(), this.A0O, EnumC1422aM.A06, this.A0R.A0C());
            YB.A0K(this.A06);
        } else {
            if (!this.A0R.A05().A1p()) {
                return;
            }
            this.A05 = AbstractC1105Oh.A00(this.A0N.A02());
            this.A04 = A03();
            YB.A0K(this.A04);
            A0O();
        }
    ...
    private void A0M() {
        if (this.A0R.A05().A2W()) {
            this.A07 = A01(this.A0N, EnumC1422aM.A06);
            YB.A0K(this.A07);
        }
    }
    ...
    private void A0O() {
        if (this.A04 != null) {
            this.A04.setOnClickListener(new ViewOnClickListenerC1558cY(this));
        }
        A0T(8);
    }
    ...
    public void A0P() {
        ...
        C1084Nm c1084NmA2C = this.A0R.A05().A2C();
        if (this.A05 != null && this.A05.A0O(this.A0N.A02(), true)) {
            this.A0R.A0C().AAo(this.A0R.A05().A2E(), c1084NmA2C);
        } else {
            if (TextUtils.isEmpty(c1084NmA2C.A00())) {
                return;
            }
            X6.A0O(new X6(), this.A0N, XB.A00(c1084NmA2C.A00()), this.A0R.A05().A2E());
        }
    }
