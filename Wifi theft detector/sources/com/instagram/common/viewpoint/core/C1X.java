...
public final class C1X extends C8M {
    ...
    public int A03;
    public long A05;
    public List<C2324pT> A07;
    public List<C2324pT> A08;
    public boolean A09;
    public boolean A0A;
    public boolean A0B;
    ...
    public final C06214v A0G = new C06214v();
    public final ArrayList<C0981Jm> A0H = new ArrayList<>();
    public C0981Jm A06 = new C0981Jm(0, 4);
    public int A04 = 0;
    ...
    public static void A09() {
        A0I = new byte[]{10, 44, 40, 127, 121, 113, 13, 44, 42, 38, 45, 44, 59, 90, 125, 101, 114, 127, 122, 119, 51, 112, 123, 114, 125, 125, 118, 127, 61, 51, 87, 118, 117, 114, 102, 127, 103, 122, 125, 116, 51, 103, 124, 51, 80, 80, 34, 61, 7, 22, 22, 10, 15, 5, 7, 18, 15, 9, 8, 73, 30, 75, Flags.CD, 22, 82, 75, 5, 3, 7, 75, 80, 86, 94};
    }
    ...
    static {
        ...
        A0N = new int[]{174, 176, PsExtractor.PRIVATE_STREAM_1, 191, 8482, 162, 163, 9834, 224, 32, 232, Sdk$SDKError.Reason.PRIVACY_ICON_FALLBACK_ERROR_VALUE, 234, 238, 244, Type.IXFR};
    ...
    public C1X(String str, int i10, long j10) {
        ...
        switch (i10) {
            ...
            case 4:
                ...
                break;
            default:
                AbstractC06064g.A07(A06(0, 13, 123), A06(13, 35, 33));
                this.A0D = 0;
                this.A0E = 0;
                break;
        }
    ...
    private List<C2324pT> A07() {
        int iMin = 2;
        int size = this.A0H.size();
        ArrayList arrayList = new ArrayList(size);
        for (int i10 = 0; i10 < size; i10++) {
            C2324pT c2324pTA08 = this.A0H.get(i10).A08(Integer.MIN_VALUE);
            arrayList.add(c2324pTA08);
            if (c2324pTA08 != null) {
                int positionAnchor = c2324pTA08.A08;
                iMin = Math.min(iMin, positionAnchor);
            }
        }
        List<Cue> displayCues = new ArrayList<>(size);
        for (int i11 = 0; i11 < size; i11++) {
            C2324pT c2324pT = (C2324pT) arrayList.get(i11);
            if (c2324pT != null) {
                int cueBuilderCount = c2324pT.A08;
                if (cueBuilderCount != iMin) {
                    c2324pT = (C2324pT) AbstractC05983y.A01(this.A0H.get(i11).A08(iMin));
                }
                displayCues.add(c2324pT);
            }
        }
        return displayCues;
    }
    ...
    private void A0C(byte b10, byte b11) {
        ...
        if (i10 != row3) {
            ...
            if (row4 != 1) {
                ...
                if (!c0981Jm.A0G()) {
                    this.A06 = new C0981Jm(this.A02, this.A03);
                    this.A0H.add(this.A06);
                }
            }
            this.A06.A03 = i10;
        ...
        int row7 = b11 >> 1;
        int i11 = row7 & 7;
        C0981Jm c0981Jm2 = this.A06;
        int row8 = cursorOrStyle != 0 ? 8 : i11;
        c0981Jm2.A0F(row8, isCursor);
        if (cursorOrStyle != 0) {
            C0981Jm c0981Jm3 = this.A06;
            int row9 = A0L[i11];
            c0981Jm3.A02 = row9;
        }
    }
    ...
    */
    private void A0E(int r3) {
        ...
        Ld:
            ...
            com.facebook.ads.redexgen.X.Jm r0 = (com.instagram.common.viewpoint.core.C0981Jm) r0
            r0.A0D(r3)
            int r1 = r1 + 1
            goto Ld
        L23:
    ...
    /* renamed from: A0W */
    public final /* bridge */ /* synthetic */ C8S A5r() throws C2106lj {
        return super.A5r();
    }
    ...
    @Override // com.instagram.common.viewpoint.core.C8M
    public final C2104lh A0Z() {
        this.A08 = this.A07;
        return new C2104lh((List) AbstractC05983y.A01(this.A07));
    }

    @Override // com.instagram.common.viewpoint.core.C8M
    /* renamed from: A0a */
    public final /* bridge */ /* synthetic */ void AHJ(C8S c8s) throws C2106lj {
        super.AHJ(c8s);
    }

    @Override // com.instagram.common.viewpoint.core.C8M
    public final void A0b(C8S c8s) {
        ByteBuffer subtitleData = (ByteBuffer) AbstractC05983y.A01(c8s.A02);
    ...
    @Override // com.instagram.common.viewpoint.core.C8M, com.instagram.common.viewpoint.core.InterfaceC2113lq
