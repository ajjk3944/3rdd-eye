, 110, 114, 123, 76, 127, 106, 123, 48, 125, 127, 110, 109, 2, 16, 28, 1, 29, 20, 35, 16, 5, 20, 95, 2, 4, 1, 1, 30, 3, 5, 93, 81, 1, 23, 17, 7, 0, 23, 95, 2, 30, 19, Flags.CD, 16, 19, 17, 25, 102, 124, 111, 112, 84, 123, 113, 71, 116, 97, 112, 59, 118, 116, 101, 102, 64, 90, 73, 86, 114, 93, 87, 97, 82, 71, 86, 29, 80, 92, 69, 86, 65, 31, 19, 108, 118, 101, 122, 94, 113, 123, 77, 126, 107, 122, 49, 109, 112, 107, 126, 107, 122, 123, 51, 63, 24, 2, 17, 14, 42, 5, 15, 57, 10, 31, 14, 69, 24, 30, 27, 27, 4, 25, 31, 71, 75, 100, 126, 109, 114, 86, 121, 115, 69, 118, 99, 114, 57, 97, 84, 118, 103, 100, 4, 5, 30, 30, 21, 28, 21, 20, 93, 0, 28, 17, 9, 18, 17, 19, 27, 48, 47, 34, 35, 41, 105, 39, 48, 37, 114, 109, 96, 97, 107, 43, 96, 107, 104, 102, 125, 41, 114, 109, 119, 109, 107, 106, 21, 10, 7, 6, 12, 76, Flags.CD, 6, 21, 0, 82, 77, 64, 65, 75, Flags.CD, 92, 9, 82, 74, 64, 10, 75, 74, 22, 10, 82, 84, 29, 92};
    }
    ...
    public B3(String str, String str2, String str3, MediaCodecInfo.CodecCapabilities codecCapabilities, boolean z10, boolean z11, boolean z12, boolean z13, boolean z14, boolean z15) {
        this.A03 = (String) AbstractC05983y.A01(str);
        this.A02 = str2;
        this.A01 = str3;
    ...
    */
    ...
    private void A05(String str) {
        ...
        AbstractC06064g.A04(A03(97, 14, 99), sbAppend.append(strA03).append(this.A03).append(A03(4, 2, 43)).append(this.A02).append(strA03).append(C5C.A04).append(A03(260, 1, 72)).toString());
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    private boolean A0G(com.instagram.common.viewpoint.core.C2374qI r12, boolean r13) {
        /*
    ...
    public static boolean A0J(String str) {
        if (C5C.A02 <= 22) {
            if ((A03(130, 10, 94).equals(C5C.A06) || A03(111, 8, 72).equals(C5C.A06)) && (A03(WKSRecord.Service.EMFIS_DATA, 22, 117).equals(str) || A03(162, 29, 74).equals(str))) {
                return true;
            }
        }
        return false;
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final com.instagram.common.viewpoint.core.C6L A0O(com.instagram.common.viewpoint.core.C2374qI r13, com.instagram.common.viewpoint.core.C2374qI r14) {
        /*
    ...
    public final boolean A0R(int i10, int i11, double d10) {
        ...
        if (i12 >= 29) {
            ...
            if (iA00 == 1) {
                A06(A03(629, 19, 41) + i10 + strA032 + i11 + strA03 + d10);
                return false;
            }
        }
    ...
    public final boolean A0S(C2374qI c2374qI) {
        String strA07;
        if (c2374qI.A0R == null || this.A02 == null || (strA07 = C3J.A07(c2374qI.A0R)) == null) {
            return true;
        }
        ...
        if (!codecMimeType.equals(strA07)) {
            ...
            String codecMimeType3 = c2374qI.A0R;
        ...
        return A0G(c2374qI, true);
    }

    public final boolean A0T(C2374qI c2374qI) {
        if (this.A0A) {
        ...
        Pair<Integer, Integer> profileLevel = C0766Ba.A0B(c2374qI);
        return profileLevel != null && ((Integer) profileLevel.first).intValue() == 42;
    }

    @Deprecated
    public final boolean A0U(C2374qI c2374qI, C2374qI c2374qI2, boolean z10) {
        if (!z10 && c2374qI.A0N != null) {
            ColorInfo colorInfo = c2374qI2.A0N;
            String[] strArr = A0C;
            ...
            A0C[2] = "CiueF8sE";
            if (colorInfo == null) {
                c2374qI2 = c2374qI2.A07().A0t(c2374qI.A0N).A14();
            }
        }
        int i10 = A0O(c2374qI, c2374qI2).A01;
        return i10 == 2 || i10 == 3;
    }
