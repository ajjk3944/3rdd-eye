...
public final class C2071lA implements H9 {
    ...
    */
    public final int AHL(com.instagram.common.viewpoint.core.InterfaceC2165ms r12, com.instagram.common.viewpoint.core.HV r13) throws java.io.IOException {
        /*
            Method dump skipped, instructions count: 460
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C2071lA.AHL(com.facebook.ads.redexgen.X.ms, com.facebook.ads.redexgen.X.HV):int");
    }
    ...
    public C2071lA(AnonymousClass53 anonymousClass53) {
        this.A09 = anonymousClass53;
        this.A08 = new C06214v(4096);
    ...
    private void A00(long j10) {
        if (!this.A06) {
            ...
            if (this.A0A.A0C() != C.TIME_UNSET) {
                this.A02 = new C2073lC(this.A0A.A0D(), this.A0A.A0C(), j10);
                this.A01.AJ7(this.A02.A07());
            } else {
                this.A01.AJ7(new C2160mn(this.A0A.A0C()));
            }
        }
    }

    public static /* synthetic */ H9[] A01() {
        return new H9[]{new C2071lA()};
    }
    ...
    public final boolean AK5(InterfaceC2165ms interfaceC2165ms) throws IOException {
        ...
        interfaceC2165ms.AGt(bArr, 0, 14);
        ...
        interfaceC2165ms.A47(packStuffingLength);
        interfaceC2165ms.AGt(bArr, 0, 3);
