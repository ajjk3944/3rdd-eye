...
public abstract class AbstractC2390qa {
    ...
    public static final Object[] A02(Collection<?> collection) {
        C2388qY.A09(collection, A00(0, 10, 17));
        ...
        while (true) {
            ...
            if (i11 >= objArrCopyOf.length) {
                ...
                if (!it.hasNext()) {
                    ...
                    C2388qY.A08(objArrCopyOf2, A00(10, 11, 103));
            ...
            if (size == 0) {
                ...
                if (!it.hasNext()) {
                    ...
                    if (size <= length) {
                        ...
                        C2388qY.A07(objNewInstance, A00(21, 62, 11));
