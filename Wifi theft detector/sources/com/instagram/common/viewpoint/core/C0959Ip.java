...
public final class C0959Ip {
    ...
    public int A00;
    public final C06214v A01 = new C06214v(8);
    ...
    */
    private long A00(com.instagram.common.viewpoint.core.InterfaceC2165ms r6) throws java.io.IOException {
        /*
            r5 = this;
        ...
        L46:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C0959Ip.A00(com.facebook.ads.redexgen.X.ms):long");
    }

    public final boolean A01(InterfaceC2165ms interfaceC2165ms) throws IOException {
        ...
        int i10 = (int) j10;
        boolean z10 = false;
        interfaceC2165ms.AGt(this.A01.A0l(), 0, 4);
        ...
        while (jA0Q != 440786851) {
            ...
            interfaceC2165ms.AGt(this.A01.A0l(), 0, 1);
            long j11 = jA0Q << 8;
            if (A02[5].charAt(9) == 'Z') {
            ...
            strArr[2] = "OXY";
            jA0Q = (j11 & (-256)) | (this.A01.A0l()[0] & 255);
        }
        long jA00 = A00(interfaceC2165ms);
        int i12 = this.A00;
        String[] strArr2 = A02;
        ...
        while (this.A00 < j12 + jA00) {
            if (A00(interfaceC2165ms) == Long.MIN_VALUE) {
                return z10;
            }
            long jA002 = A00(interfaceC2165ms);
            String[] strArr4 = A02;
            ...
            if (jA002 > TTL.MAX_VALUE) {
                return false;
            }
            if (jA002 != 0) {
                int i13 = (int) jA002;
                interfaceC2165ms.A47(i13);
                this.A00 += i13;
            }
            z10 = false;
        }
