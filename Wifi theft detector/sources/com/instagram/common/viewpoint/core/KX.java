...
public final class KX {
    ...
    public final C06214v A00 = new C06214v();
    ...
    public static char A00(C06214v c06214v, int i10) {
        return (char) c06214v.A0l()[i10];
    }

    public static String A02(C06214v c06214v) {
        int limit = c06214v.A09();
        int iA0A = c06214v.A0A();
        char c10 = 0;
        while (limit < iA0A && c10 == 0) {
            int i10 = limit + 1;
            int position = c06214v.A0l()[limit];
            int limit2 = (char) position;
            c10 = limit2 == 41 ? (char) 1 : (char) 0;
            limit = i10;
        }
        int position2 = c06214v.A09();
        String strTrim = c06214v.A0W((limit - 1) - position2).trim();
    ...
    public static String A03(C06214v c06214v, StringBuilder sb) {
        sb.setLength(0);
        int iA09 = c06214v.A09();
        int iA0A = c06214v.A0A();
        boolean z10 = false;
        while (iA09 < iA0A && !z10) {
            int position = c06214v.A0l()[iA09];
        ...
        int position2 = c06214v.A09();
        c06214v.A0g(iA09 - position2);
        return sb.toString();
    }

    public static String A04(C06214v c06214v, StringBuilder sb) {
        A09(c06214v);
        if (c06214v.A07() == 0) {
            return null;
        }
        String strA03 = A03(c06214v, sb);
        String strA01 = A01(0, 0, 111);
        if (!strA01.equals(strA03)) {
            return strA03;
        }
        String identifier = strA01 + ((char) c06214v.A0I());
        return identifier;
    }

    public static String A05(C06214v c06214v, StringBuilder sb) {
        StringBuilder sb2 = new StringBuilder();
        boolean z10 = false;
        while (!z10) {
            int iA09 = c06214v.A09();
            String token = A04(c06214v, sb);
            if (token == null) {
                return null;
            }
    ...
    public static String A06(C06214v c06214v, StringBuilder sb) {
        A09(c06214v);
        if (c06214v.A07() < 5) {
            return null;
        }
        String strA0W = c06214v.A0W(5);
        ...
        String cueSelector2 = A01(Type.IXFR, 1, 47);
    ...
    public static void A08(C06214v c06214v) {
        String line;
        do {
            line = c06214v.A0T();
    ...
    public static void A09(C06214v c06214v) {
        boolean skipping = true;
        while (c06214v.A07() > 0 && skipping) {
            boolean zA0E = A0E(c06214v);
            String[] strArr = A03;
            if (strArr[5].charAt(6) == strArr[0].charAt(6)) {
                throw new RuntimeException();
            }
    ...
    public static void A0A(C06214v c06214v, C0996Kb c0996Kb, StringBuilder sb) {
        A09(c06214v);
        String strA03 = A03(c06214v, sb);
        String strA01 = A01(0, 0, 111);
        if (strA01.equals(strA03)) {
        ...
        if (property.length() != 9) {
            ...
            String property2 = A04(c06214v, sb);
            if (!strA012.equals(property2)) {
                return;
            }
            A09(c06214v);
            String token = A05(c06214v, sb);
            if (token == null || strA01.equals(token)) {
                return;
            }
            int iA09 = c06214v.A09();
            String strA04 = A04(c06214v, sb);
            ...
            if (property5.equals(strA03)) {
                c0996Kb.A0C(AnonymousClass47.A00(token));
                return;
            }
            String property6 = A01(103, 16, 0);
            if (property6.equals(strA03)) {
                c0996Kb.A0B(AnonymousClass47.A00(token));
                return;
            }
            ...
            if (position != value.charAt(6)) {
                A03[7] = "r";
                String property10 = A01(Sdk$SDKError.Reason.AD_CONSUMED_VALUE, 20, 47);
    ...
    private void A0B(C0996Kb c0996Kb, String str) {
        ...
        if (iIndexOf != -1) {
            ...
            if (matcher.matches()) {
                c0996Kb.A0N((String) AbstractC05983y.A01(matcher.group(1)));
            }
        ...
        if (iIndexOf2 != -1) {
            c0996Kb.A0M(str2.substring(0, iIndexOf2));
            int voiceStartIndex = iIndexOf2 + 1;
            c0996Kb.A0L(str2.substring(voiceStartIndex));
        } else {
            c0996Kb.A0M(str2);
        }
        ...
        if (voiceStartIndex2 > 1) {
            ...
            c0996Kb.A0O((String[]) C5C.A1J(strArrA1O, 1, voiceStartIndex3));
        }
    }
    ...
    */
    public static void A0C(java.lang.String r6, com.instagram.common.viewpoint.core.C0996Kb r7) {
        /*
            java.util.regex.Pattern r1 = com.instagram.common.viewpoint.core.KX.A04
            java.lang.String r0 = com.instagram.common.viewpoint.core.AbstractC2009k7.A01(r6)
        ...
        L94:
            r3 = 3
            java.lang.String[] r1 = com.instagram.common.viewpoint.core.KX.A03
            r0 = 6
            r0 = r1[r0]
            int r1 = r0.length()
            r0 = 22
            if (r1 == r0) goto Lad
            java.lang.String[] r2 = com.instagram.common.viewpoint.core.KX.A03
        ...
        Lba:
            ...
            java.lang.Object r0 = com.instagram.common.viewpoint.core.AbstractC05983y.A01(r0)
            java.lang.String r0 = (java.lang.String) r0
            float r0 = java.lang.Float.parseFloat(r0)
            r7.A0A(r0)
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.KX.A0C(java.lang.String, com.facebook.ads.redexgen.X.Kb):void");
    }

    public static boolean A0D(C06214v c06214v) {
        int position = c06214v.A09();
        int limit = c06214v.A0A();
        ...
        if (bArrA0l[i10] == 42) {
            ...
            c06214v.A0g(limit - c06214v.A09());
            return true;
        }
        return false;
    }

    public static boolean A0E(C06214v c06214v) {
        switch (A00(c06214v, c06214v.A09())) {
            case '\t':
            case '\n':
            case '\f':
            case '\r':
    ...
    public final List<C0996Kb> A0F(C06214v c06214v) {
        String selector;
        this.A01.setLength(0);
        int iA09 = c06214v.A09();
        A08(c06214v);
        C06214v c06214v2 = this.A00;
        byte[] bArrA0l = c06214v.A0l();
        int initialInputPosition = c06214v.A09();
        c06214v2.A0j(bArrA0l, initialInputPosition);
        this.A00.A0f(iA09);
        ...
        while (true) {
            ...
            if (!A01(Type.IXFR, 1, 47).equals(A04(this.A00, this.A01))) {
                return arrayList;
            }
            C0996Kb c0996Kb = new C0996Kb();
            A0B(c0996Kb, selector2);
            String strA04 = null;
            boolean z10 = false;
            while (true) {
                ...
                if (!z10) {
                    this.A00.A0f(iA092);
                    A0A(this.A00, c0996Kb, this.A01);
                }
            }
            if (selector.equals(strA04)) {
                arrayList.add(c0996Kb);
            }
        }
    }
}
