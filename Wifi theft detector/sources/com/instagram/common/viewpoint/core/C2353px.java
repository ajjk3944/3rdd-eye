...
public final class C2353px implements AnonymousClass24 {
    ...
    public static final AnonymousClass23<C2353px> A05;
    public static final C2353px A06;
    ...
    static {
        A02();
        A06 = new C2353px(1.0f);
        A08 = C5C.A0h(0);
        A07 = C5C.A0h(1);
        A05 = new AnonymousClass23() { // from class: com.facebook.ads.redexgen.X.py
            @Override // com.instagram.common.viewpoint.core.AnonymousClass23
            public final AnonymousClass24 A6f(Bundle bundle) {
                return C2353px.A00(bundle);
            }
        };
    }

    public C2353px(float f10) {
        this(f10, 1.0f);
    }

    public C2353px(float f10, float f11) {
        AbstractC05983y.A07(f10 > 0.0f);
        AbstractC05983y.A07(f11 > 0.0f);
        this.A01 = f10;
        this.A00 = f11;
        this.A02 = Math.round(1000.0f * f10);
    }

    public static /* synthetic */ C2353px A00(Bundle bundle) {
        float f10 = bundle.getFloat(A08, 1.0f);
        float pitch = bundle.getFloat(A07, 1.0f);
        return new C2353px(f10, pitch);
    }
    ...
    public final boolean equals(Object obj) {
        ...
        C2353px c2353px = (C2353px) obj;
        if (this.A01 == c2353px.A01) {
            float f10 = this.A00;
            float f11 = c2353px.A00;
