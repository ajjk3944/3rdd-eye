...
public abstract class XB {
    ...
    public static Uri A00(String str) throws SecurityException {
        ...
        if (c1810geA00 != null && !C1264Up.A2x(c1810geA00)) {
            return uri;
        }
        if (!A0D(uri)) {
    ...
    public static void A0C(String str, URI uri, Uri uri2, boolean z10) {
        ...
        if (!z10 && !zA0E2) {
            strA05 = strA05 + String.format(Locale.US, A05(WKSRecord.Service.EMFIS_DATA, 52, 103), uri.getAuthority(), uri2.getAuthority());
        }
        if (!zA0E3) {
