...
public final class LM extends AsyncTask<String, Void, Bitmap[]> implements T4 {
    ...
    public int A00;
    public int A01;
    public InterfaceC1470b8 A02;
    public boolean A03;
    public final int A04;
    public final int A05;
    public final WeakReference<C1467b5> A06;
    public final WeakReference<C1814gi> A07;
    ...
    private final Bitmap[] A03(String... strArr) throws Throwable {
        ...
        try {
            ...
            try {
                bitmapA0O = new C1220Sx(c1814gi).A0O(str, this.A00, this.A01);
                if (bitmapA0O != null && !this.A03) {
                    bitmapA01 = YL.A01(c1814gi, bitmapA0O, this.A04, this.A05);
                }
            } catch (Throwable th) {
                c1814gi.A08().ABC(A00(0, 7, 30), AbstractC1226Td.A1V, new C1227Te(th));
            }
    ...
    public LM(ViewGroup viewGroup, int i10, int i11, C1814gi c1814gi) {
        this.A03 = false;
        this.A00 = -1;
        this.A01 = -1;
        this.A07 = new WeakReference<>(c1814gi);
        this.A06 = null;
        this.A08 = null;
    ...
    public LM(ViewGroup viewGroup, C1814gi c1814gi) {
        this(viewGroup, 12, 16, c1814gi);
    }

    public LM(ImageView imageView, C1814gi c1814gi) {
        this.A03 = false;
        this.A00 = -1;
        this.A01 = -1;
        this.A07 = new WeakReference<>(c1814gi);
    ...
    public LM(C1467b5 c1467b5, C1814gi c1814gi) {
        this.A03 = false;
        this.A00 = -1;
        this.A01 = -1;
        this.A07 = new WeakReference<>(c1814gi);
        this.A06 = new WeakReference<>(c1467b5);
        this.A08 = null;
        this.A09 = null;
        this.A04 = 12;
        this.A05 = 16;
    ...
    private final void A02(Bitmap[] bitmapArr) throws Throwable {
        ...
        try {
            ...
            if (this.A06 != null && (c1467b5 = this.A06.get()) != null) {
                c1467b5.setImage(bitmapArr[0], bitmapArr[1]);
            }
            ...
            if (this.A02 != null) {
                this.A02.AE7(new C1469b7(bitmapArr[0]));
            }
        } catch (Throwable th) {
            WU.A00(th, this);
        }
    ...
    public final LM A06(InterfaceC1470b8 interfaceC1470b8) {
        this.A02 = interfaceC1470b8;
        return this;
    }
