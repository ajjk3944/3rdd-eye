    ...
    */
    public static com.instagram.common.viewpoint.core.SX A01(com.instagram.common.viewpoint.core.T8 r5, com.instagram.common.viewpoint.core.SX r6) {
        /*
            ...
            if (r0 == 0) goto L29
        Lc:
            com.facebook.ads.redexgen.X.SX r0 = com.instagram.common.viewpoint.core.AbstractC1202Sf.A00(r5)     // Catch: java.lang.Throwable -> L11
            return r0
        L11:
            r0 = move-exception
            com.facebook.ads.redexgen.X.Tc r5 = r5.A08()
            int r4 = com.instagram.common.viewpoint.core.AbstractC1226Td.A1Q
    ...
    public static SX A02(T8 t82, SX sx, SY sy) {
        C1198Sa c1198SaA00 = null;
        try {
            if (AbstractC1263Uo.A06(t82) && (sx == null || TextUtils.isEmpty(sx.A03()))) {
                c1198SaA00 = AbstractC1199Sb.A00(t82.getContentResolver());
            }
        } catch (Throwable th) {
            t82.A08().ABC(A04(12, 7, 84), AbstractC1226Td.A1S, new C1227Te(th));
        }
        if (c1198SaA00 != null && c1198SaA00.A01 != null) {
            A03.set(c1198SaA00.A01);
            sy.A05(c1198SaA00.A01);
        }
        if (sx == null && c1198SaA00 != null && !TextUtils.isEmpty(c1198SaA00.A00)) {
            return new SX(c1198SaA00.A00, c1198SaA00.A02, SW.A04);
        }
        return sx;
    }
    ...
    public static void A07(T8 t82) {
        ...
        try {
            ...
            if (jA01 > 0 && System.currentTimeMillis() - jA01 < AbstractC1263Uo.A00(t82)) {
                return;
            }
            if (AbstractC1263Uo.A07(t82)) {
            ...
            t82.A08().ABC(A04(12, 7, 84), AbstractC1226Td.A1R, new C1227Te(t10));
        }
    }
