...
public final class L6 {
    ...
    private int A01(InterfaceC2165ms interfaceC2165ms, HV hv) throws IOException {
        int iMin = (int) Math.min(20000L, interfaceC2165ms.A8O());
        if (interfaceC2165ms.A8n() != 0) {
            hv.A00 = 0;
            return 1;
        }
        C06214v c06214v = this.A06;
        ...
        c06214v.A0d(iMin);
        interfaceC2165ms.AIl();
        interfaceC2165ms.AGt(this.A06.A0l(), 0, iMin);
        this.A01 = A04(this.A06);
        this.A04 = true;
        return 0;
    }

    private int A02(InterfaceC2165ms interfaceC2165ms, HV hv) throws IOException {
        long jA8O = interfaceC2165ms.A8O();
        int iMin = (int) Math.min(20000L, jA8O);
        long j10 = jA8O - iMin;
        long searchStartPosition = interfaceC2165ms.A8n();
    ...
    */
    private long A04(com.instagram.common.viewpoint.core.C06214v r8) {
        /*
            r7 = this;
            int r6 = r8.A09()
            int r5 = r8.A0A()
    ...
    private long A05(C06214v c06214v) {
        int iA09 = c06214v.A09();
        int searchStartPosition = c06214v.A0A();
        for (int nextStartCode = searchStartPosition - 4; nextStartCode >= iA09; nextStartCode--) {
            int searchEndPosition = A03(c06214v.A0l(), nextStartCode);
            if (searchEndPosition == 442) {
                int searchStartPosition2 = nextStartCode + 4;
                c06214v.A0f(searchStartPosition2);
                long jA06 = A06(c06214v);
    ...
    public static long A06(C06214v c06214v) {
        int iA09 = c06214v.A09();
        if (c06214v.A07() < 9) {
            return C.TIME_UNSET;
        }
        ...
        c06214v.A0k(bArr, 0, originalPosition);
        c06214v.A0f(iA09);
    ...
    public final int A0B(InterfaceC2165ms interfaceC2165ms, HV hv) throws IOException {
        if (!this.A05) {
            return A02(interfaceC2165ms, hv);
        }
        ...
        if (this.A00 < 0) {
            AbstractC06064g.A07(A08(45, 16, 119), A08(27, 18, 122) + this.A00 + A08(0, 27, 112));
