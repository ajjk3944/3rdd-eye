...
public abstract class AbstractC1460ay extends WebView {
    ...
    static {
        A0C();
        A02 = AbstractC1460ay.class.getSimpleName();
    }

    public AbstractC1460ay(Activity activity, C1814gi c1814gi) {
        super(activity);
        A0E(c1814gi);
    }

    public AbstractC1460ay(C1814gi c1814gi) {
        super(c1814gi);
        A0E(c1814gi);
    }
    ...
    public static void A0D(int i10) {
        ...
        if (context != null) {
            context.A08().ABC(A0B(56, 8, 37), i10, new C1227Te(A0B(35, 10, 3)));
        }
    }
