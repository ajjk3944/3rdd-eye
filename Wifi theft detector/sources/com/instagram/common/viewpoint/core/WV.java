...
public final class WV implements V8 {
    ...
    public WV(C1810ge c1810ge, ZH zh) {
        this.A00 = c1810ge;
        this.A01 = zh;
    }

    public static JSONArray A01(C1810ge c1810ge, JSONArray jSONArray, JSONArray jSONArray2) {
        int i10 = 0;
        if (jSONArray != null) {
        ...
        return A02(c1810ge, jSONArray, jSONArray2, i10);
    }
    ...
    */
    public static org.json.JSONArray A02(com.instagram.common.viewpoint.core.C1810ge r19, org.json.JSONArray r20, org.json.JSONArray r21, int r22) throws org.json.JSONException {
        /*
    ...
    */
    private org.json.JSONObject A03() throws org.json.JSONException {
        /*
            ...
            boolean r0 = com.instagram.common.viewpoint.core.AbstractC1266Ur.A0P(r0)
            if (r0 == 0) goto L46
            com.facebook.ads.redexgen.X.ge r0 = r7.A00
            org.json.JSONArray r6 = com.instagram.common.viewpoint.core.C1228Tf.A03(r0)
            if (r6 == 0) goto L46
            int r0 = r6.length()
            if (r0 <= 0) goto L46
    ...
    private JSONObject A04(int i10) throws JSONException {
        ...
        if (AbstractC1266Ur.A0P(this.A00) && (jSONArrayA04 = C1228Tf.A04(this.A00, (iA08 = AbstractC1266Ur.A08(this.A00)))) != null && jSONArrayA04.length() > 0) {
    ...
    private void A06(String str) {
        if (C1228Tf.A0I(str)) {
            C1810ge c1810ge = this.A00;
            String[] strArr = A03;
            if (strArr[4].charAt(22) == strArr[7].charAt(22)) {
                throw new RuntimeException();
            }
            A03[2] = "U9Gor";
            C1228Tf.A0B(c1810ge, str);
            return;
        }
        this.A01.AA5(str);
    }
    ...
    public final JSONObject A5L() {
        int eventLimit = AbstractC1266Ur.A0F(this.A00);
        return eventLimit > 0 ? A04(eventLimit) : A03();
    }

    @Override // com.instagram.common.viewpoint.core.V8
    public final boolean AAb() {
        int eventCount = AbstractC1266Ur.A0F(this.A00);
        if (eventCount < 1) {
            return false;
        }
        int iA82 = this.A01.A82();
        int eventLimit = C1228Tf.A00(this.A00);
        return iA82 + eventLimit > eventCount;
    }

    @Override // com.instagram.common.viewpoint.core.V8
    public final void ACu() {
        int iA50 = this.A01.A50(AbstractC1266Ur.A0G(this.A00));
        if (iA50 > 0) {
            this.A00.A08().ABC(A00(379, 8, 37), AbstractC1226Td.A10, new C1227Te(A00(28, 44, 62) + iA50));
        }
