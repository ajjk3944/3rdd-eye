...
public final class C1423aN extends LinearLayout {
    ...
    public C1423aN(C1814gi c1814gi, EnumC1422aM enumC1422aM, AbstractC1979jd abstractC1979jd) {
        super(c1814gi);
        this.A02 = YN.A01(YM.CREDIT_LINE_DETAIL_ICON);
        this.A04 = c1814gi;
        this.A03 = abstractC1979jd;
        AbstractC1421aL.A03(c1814gi, enumC1422aM);
        A02();
    }
    ...
    private void A01() {
        ...
        int i11 = -2;
        if (this.A00 != null) {
            AbstractC1979jd abstractC1979jd = this.A03;
            String[] strArr = A06;
            String str = strArr[4];
            ...
            if (abstractC1979jd != null && this.A03.A0t() != null) {
    ...
    public final void A04() {
        ...
        A06[3] = "jEdvzIR";
        if (abstractC1979jd != null && this.A03.A0t() != null && this.A03.A0t().A04() > 0) {
    ...
    private void getDownloadedBitmap() {
        if (this.A03 != null && this.A03.A0t() != null && this.A03.A0t().A05() != null && this.A03.A0t().A04() > 0 && this.A03.A0t().A03() > 0) {
            try {
                this.A00 = new C1220Sx(this.A04).A0O(this.A03.A0t().A05(), (int) (this.A03.A0t().A03() * XX.A02), (int) (this.A03.A0t().A04() * XX.A02));
            } catch (Exception e10) {
                this.A04.A08().ABC(A00(0, 11, 27), 3900, new C1227Te(e10));
            }
        }
    }
