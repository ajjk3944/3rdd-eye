...
public class C0749Ah<E> implements Iterator<E> {
    public static byte[] A02;
    public int A00;
    public final /* synthetic */ AbstractC05431r<E> A01;
    ...
    public C0749Ah(AbstractC05431r abstractC05431r) {
        this.A01 = abstractC05431r;
    }
    ...
    public final E next() {
        if (hasNext()) {
            AbstractC05431r<E> abstractC05431r = this.A01;
            int i10 = this.A00;
            this.A00 = i10 + 1;
            return abstractC05431r.get(i10);
        }
