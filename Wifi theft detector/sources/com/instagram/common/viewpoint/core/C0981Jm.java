...
public final class C0981Jm {
    ...
    private SpannableString A04() {
        ...
        for (int length = 0; length < this.A06.size(); length++) {
            C0980Jl c0980Jl = this.A06.get(length);
            boolean z10 = c0980Jl.A02;
            int i12 = c0980Jl.A01;
            if (i12 != 8) {
                style = i12 == 7 ? 1 : 0;
                if (i12 != 7) {
    ...
    */
    public final com.instagram.common.viewpoint.core.C2324pT A08(int r10) {
        /*
            Method dump skipped, instructions count: 346
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C0981Jm.A08(int):com.facebook.ads.redexgen.X.pT");
    }
    ...
    public final void A09() {
        ...
        if (length > 0) {
            ...
            for (int i10 = length3 - 1; i10 >= 0; i10--) {
                C0980Jl c0980Jl = this.A06.get(i10);
                String[] strArr = A08;
                String str = strArr[2];
                ...
                int length5 = c0980Jl.A00;
                if (length5 == length) {
                    int length6 = c0980Jl.A00;
                    c0980Jl.A00 = length6 - 1;
                } else {
                    return;
                }
            }
    ...
    */
    public final void A0A() {
        ...
        L2a:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C0981Jm.A0A():void");
    }
    ...
    public final void A0F(int i10, boolean z10) {
        this.A06.add(new C0980Jl(i10, z10, this.A05.length()));
    }
