...
public abstract class AbstractC05431r<E> extends AbstractC0750Ai<E> implements List<E> {
    ...
    public static final C2398qk A02;
    ...
    public int lastIndexOf(E element) {
        AbstractC05431r<E> abstractC05431r = this;
        ListIterator<E> listIterator = abstractC05431r.listIterator(abstractC05431r.size());
        while (listIterator.hasPrevious()) {
            if (C2388qY.A0C(listIterator.previous(), element)) {
    ...
    @Override // com.instagram.common.viewpoint.core.AbstractC0750Ai, java.util.Collection, java.lang.Iterable, java.util.List
    public Iterator<E> iterator() {
        return new C0749Ah(this);
    }

    @Override // java.util.List
    public ListIterator<E> listIterator() {
        return new C05441s(this, 0);
    }

    @Override // java.util.List
    public ListIterator<E> listIterator(int index) {
        return new C05441s(this, index);
    }
