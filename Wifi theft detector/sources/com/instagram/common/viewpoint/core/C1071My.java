...
public final class C1071My {
     ...
     */
    @Nullable
    public static C1071My A00(@Nullable JSONObject jSONObject) {
        if (jSONObject == null) {
            return null;
        }
        ...
        return new C1071My(strOptString, strOptString2, strOptString3, arrayList, jSONObject.optString(A01(40, 10, 127)), jSONObject.optString(A01(18, 12, 5)));
    }
    ...
    public C1071My(String str, String str2, String str3, List<String> mKeyHashes, String str4, String str5) {
        this.A04 = str;
        this.A01 = str2;
        this.A00 = str3;
        this.A05 = mKeyHashes;
