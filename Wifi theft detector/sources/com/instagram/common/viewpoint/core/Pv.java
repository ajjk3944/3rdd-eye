...
public class Pv extends ViewGroup {
    ...
    public static final C1142Pu A0w;
    public static final Comparator<C1135Pn> A0x;
    public int A00;
    public PS A01;
    public float A02;
    public float A03;
    ...
    public final C1135Pn A0p;
    public final Runnable A0q;
    public final ArrayList<C1135Pn> A0r;
    ...
    private C1135Pn A03() {
        ...
        float f12 = 0.0f;
        boolean z10 = true;
        C1135Pn c1135Pn = null;
        int i11 = 0;
        while (i11 < this.A0r.size()) {
            C1135Pn c1135Pn2 = this.A0r.get(i11);
            if (!z10 && c1135Pn2.A02 != i10 + 1) {
                c1135Pn2 = this.A0p;
                c1135Pn2.A00 = f11 + f12 + f10;
                c1135Pn2.A02 = i10 + 1;
                c1135Pn2.A01 = this.A01.A00(c1135Pn2.A02);
                i11--;
            }
            f11 = c1135Pn2.A00;
            float f13 = c1135Pn2.A01 + f11;
            String[] strArr = A0t;
    ...
    public static void A0C() {
        A0s = new byte[]{-32, -3, -2, -32, -6, 42, 59, 65, 63, 76, -6, 61, 70, 59, 77, 77, 20, -6, -88, -40, -23, -17, -19, -6, -88, -15, -20, -62, -88, Flags.CD, 59, 93, 90, 77, 87, 80, 88, 76, 95, 84, 78, Flags.CD, 76, 79, 76, 91, 95, 80, 93, 37, Flags.CD, -66, 18, 13, 13, -66, 17, Flags.CD, -1, 10, 10, -39, -66, 2, 3, 4, -1, 19, 10, 18, 7, 12, 5, -66, 18, 13, -66, 16, 4, 74, 83, 89, 82, 72, 30, 4, -49, -19, -6, -6, -5, 0, -84, -19, -16, -16, -84, -4, -19, -13, -15, -2, -84, -16, -15, -17, -5, -2, -84, 2, -11, -15, 3, -84, -16, 1, -2, -11, -6, -13, -84, -8, -19, 5, -5, 1, 0, 61, 80, 92, 96, 80, 94, 95, 80, 79, Flags.CD, 90, 81, 81, 94, 78, 93, 80, 80, 89, Flags.CD, 91, 76, 82, 80, Flags.CD, 87, 84, 88, 84, 95, Flags.CD, -57, -37, -40, -109, -44, -29, -29, -33, -36, -42, -44, -25, -36, -30, -31, -102, -26, -109, -61, -44, -38, -40, -27, -76, -41, -44, -29, -25, -40, -27, -109, -42, -37, -44, -31, -38, -40, -41, -109, -25, -37, -40, -109, -44, -41, -44, -29, -25, -40, -27, -102, -26, -109, -42, -30, -31, -25, -40, -31, -25, -26, -109, -22, -36, -25, -37, -30, -24, -25, -109, -42, -44, -33, -33, -36, -31, -38, -109, -61, -44, -38, -40, -27, -76, -41, -44, -29, -25, -40, -27, -106, -31, -30, -25, -36, -39, -20, -73, -44, -25, -44, -58, -40, -25, -74, -37, -44, -31, -38, -40, -41, -108, -109, -72, -21, -29, -40, -42, -25, -40, -41, -109, -44, -41, -44, -29, -25, -40, -27, -109, -36, -25, -40, -32, -109, -42, -30, -24, -31, -25, -83, -109, 16, 35, 31, 49, 10, 27, 33, 31, 44, -3, 14, 14, Flags.CD, 19, -17, -1, 14, Flags.CD, 8, 8, -68, 16, 14, 5, 1, 0, -68, 16, Flags.CD, -68, 2, 5, 10, 0, -68, 2, Flags.CD, -1, 17, 15, -68, -2, -3, 15, 1, 0, -68, Flags.CD, 10, -68, 10, Flags.CD, 10, -55, -1, 4, 5, 8, 0, -68, -1, 17, 14, 14, 1, 10, 16, -68, 2, Flags.CD, -1, 17, 15, 1, 0, -68, 18, 5, 1, 19, -68, 67, 66, 21, 56, 53, 68, 72, 57, 70, 23, 60, 53, 66, 59, 57, 56, 1, 0, -30, -13, -7, -9, -27, -11, 4, 1, -2, -2, -9, -10, -78, -10, -5, -10, -78, 0, 1, 6, -78, -11, -13, -2, -2, -78, 5, 7, 2, -9, 4, -11, -2, -13, 5, 5, -78, -5, -1, 2, -2, -9, -1, -9, 0, 6, -13, 6, -5, 1, 0, 96, 94, 77, 90, 95, 82, 91, 94, 89, 60, 77, 83, 81};
    }
    ...
    private final void A0J(int i10, int i11, int i12) throws Resources.NotFoundException {
        ...
        int iMin = Math.min(iAbs > 0 ? Math.round(Math.abs(fA00 / iAbs) * 1000.0f) * 4 : (int) ((1.0f + (Math.abs(i13) / (this.A0M + (clientWidth * this.A01.A00(this.A00))))) * 100.0f), Sdk$SDKError.Reason.NATIVE_ASSET_ERROR_VALUE);
        this.A0j = false;
    ...
    public final void addTouchables(ArrayList<View> arrayList) {
        ...
        for (int i10 = 0; i10 < getChildCount(); i10++) {
            ...
            if (childAt.getVisibility() == 0 && (c1135PnA07 = A07(childAt)) != null && c1135PnA07.A02 == this.A00) {
  ...
  0x0164: PHI (r5v4 float) = (r5v3 float), (r5v5 float) binds: [B:56:0x01c3, B:44:0x0162] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    ...
    public Pv(Context context) {
        ...
        this.A0g = true;
        this.A0l = false;
        this.A0q = new RunnableC1134Pl(this);
        this.A0P = 0;
        A0D();
    }
    ...
    private int A01(int i10, float f10, int i11, int i12) {
        ...
        if (targetPage2 > 0) {
            C1135Pn lastItem = this.A0r.get(0);
            ArrayList<C1135Pn> arrayList = this.A0r;
            int targetPage3 = this.A0r.size();
            C1135Pn c1135Pn = arrayList.get(targetPage3 - 1);
            int i13 = lastItem.A02;
            int targetPage4 = c1135Pn.A02;
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    private final com.instagram.common.viewpoint.core.C1135Pn A04(int r7) {
        /*
            r6 = this;
            r5 = 0
        L1:
            ...
            com.facebook.ads.redexgen.X.Pn r4 = (com.instagram.common.viewpoint.core.C1135Pn) r4
            int r3 = r4.A02
    ...
    private final C1135Pn A05(int i10, int i11) {
        C1135Pn c1135Pn = new C1135Pn();
        c1135Pn.A02 = i10;
        c1135Pn.A03 = this.A01.A04(this, i10);
        c1135Pn.A01 = this.A01.A00(i10);
        if (i11 < 0 || i11 >= this.A0r.size()) {
            this.A0r.add(c1135Pn);
        } else {
            this.A0r.add(i11, c1135Pn);
        }
        return c1135Pn;
    }

    private final C1135Pn A06(View view) {
        while (true) {
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    private final com.instagram.common.viewpoint.core.C1135Pn A07(android.view.View r5) {
        /*
            r4 = this;
            r3 = 0
        L1:
            ...
            com.facebook.ads.redexgen.X.Pn r2 = (com.instagram.common.viewpoint.core.C1135Pn) r2
    ...
    */
    private void A0A() {
        ...
        L1:
            ...
            com.facebook.ads.redexgen.X.Po r0 = (com.instagram.common.viewpoint.core.C1136Po) r0
            boolean r0 = r0.A05
            if (r0 != 0) goto L1a
            r2.removeViewAt(r1)
            int r1 = r1 + (-1)
    ...
    private final void A0D() {
        ...
        Ph.A0B(this, new C1893i1(this));
        if (Ph.A00(this) == 0) {
            Ph.A09(this, 1);
        }
        Ph.A0C(this, new C1894i2(this));
    }

    private void A0E(int i10) {
        List<InterfaceC1138Pq> list = this.A0d;
        String[] strArr = A0t;
        if (strArr[5].charAt(3) == strArr[3].charAt(3)) {
            throw new RuntimeException();
        }
    ...
    */
    ...
    private final void A0I(int i10, float f10, int i11) {
        ...
        if (this.A0D > 0) {
            ...
            for (int childCount = 0; childCount < i12; childCount++) {
                ...
                C1136Po lp = (C1136Po) childAt.getLayoutParams();
        ...
        if (0 != 0) {
            ...
            for (int i14 = 0; i14 < childCount2; i14++) {
                ...
                if (!((C1136Po) childAt2.getLayoutParams()).A05) {
                    childAt2.getLeft();
                    getClientWidth();
    ...
    private void A0M(int i10, boolean z10, int i11, boolean z11) throws Resources.NotFoundException {
        C1135Pn c1135PnA04 = A04(i10);
        int destX = 0;
        if (c1135PnA04 != null) {
            destX = (int) (getClientWidth() * Math.max(this.A02, Math.min(c1135PnA04.A00, this.A07)));
        }
        if (z10) {
            A0J(destX, 0, i11);
            if (z11) {
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    private void A0Q(com.instagram.common.viewpoint.core.C1135Pn r13, int r14, com.instagram.common.viewpoint.core.C1135Pn r15) {
        /*
    ...
    private void A0R(boolean z10) {
        ...
        for (int i10 = 0; i10 < this.A0r.size(); i10++) {
            C1135Pn c1135Pn = this.A0r.get(i10);
            boolean needPopulate2 = c1135Pn.A04;
            if (needPopulate2) {
                z11 = true;
                c1135Pn.A04 = false;
            }
    ...
    private boolean A0X(float f10) {
        ...
        C1135Pn c1135Pn = this.A0r.get(0);
        C1135Pn c1135Pn2 = this.A0r.get(this.A0r.size() - 1);
        if (c1135Pn.A02 != 0) {
            rightAbsolute = false;
            f12 = c1135Pn.A00 * clientWidth;
        }
        if (c1135Pn2.A02 != this.A01.A01() - 1) {
            leftAbsolute = false;
            float leftBound3 = c1135Pn2.A00;
    ...
    private boolean A0Z(int i10) {
        ...
        C1135Pn c1135PnA03 = A03();
        int currentPage = getClientWidth();
        int widthWithMargin = this.A0M + currentPage;
        int i11 = c1135PnA03.A02;
        float f10 = ((i10 / currentPage) - c1135PnA03.A00) / (c1135PnA03.A01 + (this.A0M / currentPage));
        this.A0e = false;
    ...
    */
    ...
    public final void addFocusables(ArrayList<View> views, int i10, int i11) {
        ...
        if (descendantFocusability != 393216) {
            ...
            while (true) {
                ...
                if (focusableCount == 0 && (c1135PnA07 = A07(childAt)) != null) {
                    int descendantFocusability3 = c1135PnA07.A02;
    ...
    public final void addView(View view, int i10, ViewGroup.LayoutParams layoutParams) {
        ...
        C1136Po c1136Po = (C1136Po) layoutParams;
        boolean z10 = c1136Po.A05;
        String[] strArr = A0t;
        if (strArr[4].charAt(21) != strArr[2].charAt(21)) {
            throw new RuntimeException();
        }
        A0t[6] = "0hKurRTmjdCHvNVYXWivI507L49T3Iz9";
        c1136Po.A05 = z10 | A0c(view);
        if (this.A0h) {
            if (c1136Po == null || !c1136Po.A05) {
                c1136Po.A03 = true;
    ...
    public final boolean checkLayoutParams(ViewGroup.LayoutParams layoutParams) {
        return (layoutParams instanceof C1136Po) && super.checkLayoutParams(layoutParams);
    }
        ...
        if (accessibilityEvent.getEventType() == 4096) {
            ...
            if (A0t[0].length() == 15) {
                ...
                for (int i10 = 0; i10 < childCount; i10++) {
                    ...
                    if (childCount2 == 0) {
                        C1135Pn c1135PnA07 = A07(childAt);
                        String[] strArr3 = A0t;
    ...
    public final ViewGroup.LayoutParams generateLayoutParams(AttributeSet attributeSet) {
        return new C1136Po(getContext(), attributeSet);
    }
    ...
    public final int getChildDrawingOrder(int i10, int i11) {
        ...
        int index = ((C1136Po) this.A0b.get(result).getLayoutParams()).A01;
        return index;
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (this.A0M > 0 && this.A0S != null && this.A0r.size() > 0 && this.A01 != null) {
            ...
            int firstPos = 0;
            C1135Pn c1135Pn = this.A0r.get(0);
            float marginOffset = c1135Pn.A00;
            int itemCount = this.A0r.size();
            int i10 = this.A0r.get(itemCount - 1).A02;
            for (int i11 = c1135Pn.A02; i11 < i10; i11++) {
                while (i11 > c1135Pn.A02 && firstPos < itemCount) {
                    firstPos++;
                    c1135Pn = this.A0r.get(firstPos);
                }
                if (i11 == c1135Pn.A02) {
                    f10 = (c1135Pn.A00 + c1135Pn.A01) * pos;
                    float marginOffset2 = c1135Pn.A00;
                    marginOffset = marginOffset2 + c1135Pn.A01 + f11;
                } else {
    ...
    */
        ...
        while (true) {
            ...
            if (paddingTop < scrollX) {
                ...
                if (childAt.getVisibility() != 8) {
                    C1136Po c1136Po = (C1136Po) childAt.getLayoutParams();
                    if (c1136Po.A05) {
                        int count3 = c1136Po.A04 & 7;
                        int childTop2 = c1136Po.A04 & 112;
                        switch (count3) {
                            case 1:
                ...
                while (paddingBottom3 < scrollX) {
                    ...
                    if (childAt2.getVisibility() != count2) {
                        C1136Po c1136Po2 = (C1136Po) childAt2.getLayoutParams();
                        if (!c1136Po2.A05 && (c1135PnA07 = A07(childAt2)) != null) {
                            int i15 = vgrav + ((int) (childLeft2 * c1135PnA07.A00));
                            if (c1136Po2.A03) {
                                c1136Po2.A03 = false;
                                int widthSpec = View.MeasureSpec.makeMeasureSpec((int) (childLeft2 * c1136Po2.A00), 1073741824);
    ...
    public final boolean onRequestFocusInDescendants(int i10, Rect rect) {
        ...
        while (i11 != childCount) {
            ...
            if (count2 == 0 && (c1135PnA07 = A07(childAt)) != null) {
                int index = c1135PnA07.A02;
                int count3 = this.A00;
    ...
    */
    public void setAdapter(com.instagram.common.viewpoint.core.PS r7) throws android.content.res.Resources.NotFoundException {
        ...
        Lc:
            ...
            com.facebook.ads.redexgen.X.Pn r0 = (com.instagram.common.viewpoint.core.C1135Pn) r0
    ...
    @Deprecated
    public void setOnPageChangeListener(InterfaceC1138Pq interfaceC1138Pq) {
        this.A0Y = interfaceC1138Pq;
    }
    ...
    public void setPageMarginDrawable(int i10) {
        setPageMarginDrawable(AbstractC1122Oy.A00(getContext(), i10));
    }
