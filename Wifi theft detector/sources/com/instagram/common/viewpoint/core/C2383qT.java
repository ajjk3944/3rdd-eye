...
public final class C2383qT implements AnonymousClass24 {
    ...
    public static final AnonymousClass23<C2383qT> A09 = new AnonymousClass23() { // from class: com.facebook.ads.redexgen.X.qU
        @Override // com.instagram.common.viewpoint.core.AnonymousClass23
        public final AnonymousClass24 A6f(Bundle bundle) {
            return C2383qT.A00(bundle);
        }
    };
     ...
     */
    public static C2383qT A00(Bundle bundle) {
        ...
        return new C2383qT(j10, i10, i11, intArray, uriArr, longArray, j11, z10);
    }

    /* JADX WARN: Failed to parse debug info
    java.lang.ArrayIndexOutOfBoundsException
     */
    public final C2383qT A06(int i10) {
        int[] iArrA02 = A02(this.A05, i10);
        long[] jArrA03 = A03(this.A06, i10);
        return new C2383qT(this.A03, i10, this.A01, iArrA02, (Uri[]) Arrays.copyOf(this.A07, i10), jArrA03, this.A02, this.A04);
    }

    public C2383qT(long j10) {
        this(j10, -1, -1, new int[0], new Uri[0], new long[0], 0L, false);
    }

    public C2383qT(long j10, int i10, int i11, int[] iArr, Uri[] uriArr, long[] jArr, long j11, boolean z10) {
        AbstractC05983y.A07(iArr.length == uriArr.length);
        this.A03 = j10;
        this.A00 = i10;
        this.A01 = i11;
        this.A05 = iArr;
    ...
    */
    public final boolean A07() {
        ...
        L1c:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C2383qT.A07():boolean");
    }
    ...
    public final boolean equals(Object obj) {
        ...
        C2383qT c2383qT = (C2383qT) obj;
        if (this.A03 == c2383qT.A03 && this.A00 == c2383qT.A00 && this.A01 == c2383qT.A01 && Arrays.equals(this.A07, c2383qT.A07) && Arrays.equals(this.A05, c2383qT.A05) && Arrays.equals(this.A06, c2383qT.A06)) {
            long j10 = this.A02;
            ...
            if (j10 == c2383qT.A02 && this.A04 == c2383qT.A04) {
                return true;
            }
        }
        return false;
