...
public final class C06345i {
    public static byte[] A0B;

    @MetaExoPlayerCustomization
    public static final C06345i A0C;
    ...
    public C06345i(Uri uri, long j10, int i10, byte[] bArr, Map<String, String> map, long j11, long j12, String str, int i11, ML ml) {
        boolean z10 = true;
        AbstractC05983y.A07(j10 + j11 >= 0);
    ...
    static {
        ...
        A0C = new C06345i(Uri.parse(A02(43, 16, 34)));
    }

    public C06345i(Uri uri) {
        this(uri, 0, -1);
    }

    @MetaExoPlayerCustomization
    @Deprecated
    public C06345i(Uri uri, int i10, int i11) {
    ...
    @Deprecated
    public C06345i(Uri uri, long j10, long j11, String str) {
    ...
    public final C06315f A04() {
        return new C06315f(this);
    }

    @MetaExoPlayerCustomization("Replacement of customData Object with fbDataSpecExtension + new copy creation")
    public final C06345i A05(long j10, long j11) {
        if (j10 == 0 && this.A03 == j11) {
            return this;
        }
        return new C06345i(this.A06, this.A05, this.A01, this.A0A, this.A09, this.A04 + j10, j11, this.A08, this.A00, new ML(this.A07));
    }
