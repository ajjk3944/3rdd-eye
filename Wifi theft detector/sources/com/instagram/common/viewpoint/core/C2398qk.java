...
public final class C2398qk {
    ...
    public /* synthetic */ C2398qk(AbstractC2389qZ abstractC2389qZ) {
        this();
    }
    ...
    public final int A02(Collection<?> collection) {
        C2388qY.A09(collection, A00(31, 1, 39));
        int i10 = 1;
    ...
    public final boolean A06(Collection<?> collection, Collection<?> collection2) {
        C2388qY.A09(collection, A00(31, 1, 39));
        C2388qY.A09(collection2, A00(50, 5, 95));
        ...
        while (it2.hasNext()) {
            if (!C2388qY.A0C(it2.next(), it.next())) {
                return false;
            }
        }
        return true;
