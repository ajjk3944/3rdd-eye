...
public final class OO extends Handler {
    ...
    public InterfaceC1329Xh A01;
    public boolean A02;
    public final ServiceConnection A03;
    public final Handler A04;
    public final Messenger A05;
    public final InterfaceC1040Lt A06;
    public final C1810ge A07;
    public final AbstractRunnableC1301Wc A08;
    ...
    public OO(C1810ge c1810ge) {
        super(Looper.getMainLooper());
        this.A04 = new Handler(Looper.getMainLooper());
        this.A03 = new ON(this);
        this.A07 = c1810ge;
        this.A05 = new Messenger(this);
        InterfaceC1044Lx funnelModule = c1810ge.A00(c1810ge);
        if (funnelModule != null) {
            this.A06 = funnelModule.ACM();
        } else {
            this.A06 = new C2034kX();
        }
        this.A08 = new C1914iO(this);
    }
    ...
    public final void A0A(String str, InterfaceC1329Xh interfaceC1329Xh, int i10) throws RemoteException {
        if (this.A02) {
            this.A06.AIN(i10);
            this.A01 = interfaceC1329Xh;
    ...
    public final void A0B(boolean z10) {
        ...
        if (this.A02) {
            ...
            if (messenger == null) {
                this.A04.postDelayed(this.A08, AbstractC1267Us.A01(this.A07));
                return;
            }
            return;
        }
