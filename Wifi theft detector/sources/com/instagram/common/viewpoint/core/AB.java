...
public final class AB implements Handler.Callback, InterfaceC2224nq, InterfaceC0862Ev, InterfaceC0811Cw, C6P, InterfaceC06797b {
    ...
    public InterfaceC2283oo A0B;
    public C06987u A0C;
    public InterfaceC0812Cx A0D;
    public boolean A0G;
    public boolean A0H;
    public boolean A0I;
    public boolean A0K;
    ...
    public boolean A0U;
    public boolean A0V;
    public InterfaceC2283oo[] A0W;
    public final long A0Y;
    public final long A0Z;
    public final Handler A0a;
    public final HandlerThread A0b;
    public final C2341pl A0c;
    public final C2339pj A0d;
    public final AnonymousClass45 A0e;
    public final C4X A0f;
    public final C2291ow A0g;
    public final C06646m A0h;
    public final AnonymousClass74 A0i;
    public final C2279ok A0k;
    public final AbstractC0863Ew A0l;
    public final C0864Ex A0m;
    public final F6 A0n;
    public final C07309g A0o;
    public final ArrayList<C06636l> A0p;
    public final boolean A0q;
    public final boolean A0r;
    public final boolean A0s;
    public final boolean A0t;
    public final boolean A0u;
    public final InterfaceC2283oo[] A0v;
    public final InterfaceC06937p[] A0w;
    public long A05 = C.TIME_UNSET;

    @MetaExoPlayerCustomization("D18870411: Adding start stall debug reason")
    public EnumC1940ir A0E = EnumC1940ir.A09;
  ...
  0x021b: PHI (r8v4 com.facebook.ads.redexgen.X.no) = (r8v2 com.facebook.ads.redexgen.X.no), (r8v6 com.facebook.ads.redexgen.X.no) binds: [B:93:0x024d, B:83:0x0219] A[DONT_GENERATE, DONT_INLINE]] */
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    private void A0e(com.instagram.common.viewpoint.core.C06626k r15) throws com.instagram.common.viewpoint.core.AD {
        /*
    ...
    java.lang.ArrayIndexOutOfBoundsException
     */
    private void A0f(C06656n c06656n) throws Throwable {
        long jLongValue;
        C2222no c2222noA0K;
        long jLongValue2;
        boolean z10;
        this.A0h.A03(1);
        Pair<Object, Long> pairA09 = A09(c06656n, true);
        if (pairA09 == null) {
            c2222noA0K = A0A();
            ...
            c2222noA0K = this.A0j.A0K(this.A0A.A03, obj, jLongValue);
            if (c2222noA0K.A00()) {
                jLongValue2 = 0;
                z10 = true;
            } else {
                jLongValue2 = ((Long) pairA09.second).longValue();
                z10 = c06656n.A01 == C.TIME_UNSET;
            }
        }
        try {
            try {
                if (this.A0D == null || this.A02 > 0) {
                    ...
                    try {
                        if (jLongValue2 == C.TIME_UNSET) {
                            ...
                            long jA06 = A06(c2222noA0K, jA6r);
                            z10 |= jLongValue2 != jA06;
                            jLongValue2 = jA06;
                        }
                    } catch (Throwable th) {
                        th = th;
                        this.A0A = this.A0A.A06(c2222noA0K, jLongValue2, jLongValue, A01());
                        if (z10) {
                            this.A0h.A04(2);
                        }
                        throw th;
    ...
    public AB(InterfaceC2283oo[] interfaceC2283ooArr, AbstractC0863Ew abstractC0863Ew, C0864Ex c0864Ex, AnonymousClass74 anonymousClass74, F6 f62, boolean z10, int i10, boolean z11, Handler handler, AnonymousClass45 anonymousClass45, boolean z12, boolean z13, boolean z14, boolean z15, boolean z16, boolean z17, long j10, boolean z18, int i11, boolean z19, boolean z20, boolean z21, boolean z22, boolean z23, boolean z24, C8O c8o) {
        this.A0v = interfaceC2283ooArr;
        this.A0l = abstractC0863Ew;
        this.A0m = c0864Ex;
        ...
        this.A0C = C06987u.A03;
        this.A0A = new C7Z(Timeline.A02, C.TIME_UNSET, C2204nW.A06, c0864Ex);
        this.A0h = new C06646m();
        this.A0w = new InterfaceC06937p[interfaceC2283ooArr.length];
        for (int i12 = 0; i12 < interfaceC2283ooArr.length; i12++) {
            interfaceC2283ooArr[i12].AA9(i12, c8o);
            this.A0w[i12] = interfaceC2283ooArr[i12].A7D();
        }
        this.A0g = new C2291ow(this, anonymousClass45);
        this.A0k = new C2279ok(anonymousClass45);
        this.A0o = z20 ? new C07309g(anonymousClass45) : null;
        this.A0p = new ArrayList<>();
        this.A0W = new InterfaceC2283oo[0];
        this.A0d = new C2339pj();
        this.A0c = new C2341pl();
        abstractC0863Ew.A02(this, f62);
    ...
    @MetaExoPlayerCustomization
    private int A00() {
        int exoplayerThreadPollingIntervalMs = MetaExoPlayerUpgradeConfig.A00(EnumC1975jY.A04);
    ...
    private long A06(C2222no c2222no, long j10) throws AD {
        return A07(false, c2222no, j10, this.A0j.A0F() != this.A0j.A0G());
    }

    private long A07(boolean z10, C2222no c2222no, long j10, boolean z11) throws AD {
        A0O();
        this.A0R = false;
        A0V(2);
        C7A c7aA0F = this.A0j.A0F();
        ...
        if (c7aA0F != c7aA0B || z11) {
            for (InterfaceC2283oo interfaceC2283oo : this.A0W) {
                A0l(interfaceC2283oo);
            }
            this.A0W = new InterfaceC2283oo[0];
            if (A0y[1].length() == 31) {
                throw new RuntimeException();
    ...
    private Pair<Object, Long> A09(C06656n c06656n, boolean z10) {
        int iA0A;
        Timeline timeline = this.A0A.A03;
        Timeline timeline2 = c06656n.A02;
        if (timeline.A0N()) {
            return null;
        }
        if (timeline2.A0N()) {
        ...
        try {
            Pair<Object, Long> periodPosition = timeline2.A0E(this.A0d, this.A0c, c06656n.A00, c06656n.A01);
            ...
            throw new C05662q(timeline, c06656n.A00, c06656n.A01);
        }
    }
    ...
    private C2222no A0A() {
        ...
        return new C2222no(timeline.A0M(timeline.A0K(timeline.A0B(this.A0V), this.A0d).A00));
    }
    ...
    private void A0L() throws AD {
        ...
        for (C7A c7aA0F = this.A0j.A0F(); c7aA0F != null && c7aA0F.A02; c7aA0F = c7aA0F.A0I()) {
            C0864Ex c0864ExA0L = c7aA0F.A0L(f10, this.A0A.A03);
            if (c0864ExA0L != null) {
                if (z11) {
                    C7A c7aA0F2 = this.A0j.A0F();
                    boolean zA0S = this.A0j.A0S(c7aA0F2);
                    boolean[] zArr = new boolean[this.A0v.length];
                    long jA0G = c7aA0F2.A0G(c0864ExA0L, this.A0A.A0C, zA0S, zArr);
                    ...
                    for (int i11 = 0; i11 < this.A0v.length; i11++) {
                        InterfaceC2283oo interfaceC2283oo = this.A0v[i11];
                        zArr2[i11] = interfaceC2283oo.A9A() != 0;
                        DT dt = c7aA0F2.A09[i11];
                        if (dt != null) {
                            i10++;
                        }
                        if (zArr2[i11]) {
                            DT dtA9D = interfaceC2283oo.A9D();
                    ...
                    if (c7aA0F.A02) {
                        z10 = false;
                        c7aA0F.A0F(c0864ExA0L, Math.max(c7aA0F.A00.A03, c7aA0F.A0D(this.A06)), false);
                    } else {
                        z10 = false;
                    }
                }
    ...
    private void A0Q() throws AD {
        ...
        if (jAHQ != C.TIME_UNSET) {
            ...
            C2291ow c2291ow = this.A0g;
            C7A playingPeriodHolder = this.A0j.A0G();
            this.A06 = c2291ow.A04(c7aA0F != playingPeriodHolder);
    ...
    private void A0T(float f10) {
        for (C7A c7aA0D = this.A0j.A0D(); c7aA0D != null && c7aA0D.A02; c7aA0D = c7aA0D.A0I()) {
            for (InterfaceC2186nE interfaceC2186nE : c7aA0D.A0K().A04) {
    ...
    private void A0X(int i10, boolean playing, int i11) throws AD {
        C7A c7aA0F = this.A0j.A0F();
        InterfaceC2283oo interfaceC2283oo = this.A0v[i10];
        this.A0W[i11] = interfaceC2283oo;
        if (interfaceC2283oo.A9A() == 0) {
            C7A c7aA0G = this.A0j.A0G();
            C7A playingPeriodHolder = this.A0j.A0F();
            boolean z10 = c7aA0G == playingPeriodHolder;
            C06967s c06967s = c7aA0F.A0K().A03[i10];
            C2374qI[] c2374qIArrA1A = A1A(c7aA0F.A0K().A04[i10]);
            boolean z11 = this.A0P && this.A0A.A00 == 3;
            interfaceC2283oo.A6L(c06967s, c2374qIArrA1A, c7aA0F.A09[i10], this.A06, !playing && z11, z10, c7aA0G.A0H(this.A0K), c7aA0F.A0B());
            this.A0g.A09(interfaceC2283oo);
            if (z11) {
                interfaceC2283oo.start();
            }
        }
    ...
    */
    ...
    private void A0b(C2353px c2353px) {
        this.A0g.AJd(c2353px);
        if (this.A0o != null) {
            this.A0o.AJd(c2353px);
        }
        if (this.A0k != null) {
            this.A0k.AJd(c2353px);
        }
    }

    private void A0c(C06616j c06616j) throws AD {
        throw new NullPointerException(A0D(376, 16, 17));
    }

    private void A0d(C06616j c06616j, boolean z10) throws AD {
        this.A0h.A03(1);
    ...
    */
    ...
    private void A0h(C06817d c06817d) throws AD {
        if (c06817d.A0D()) {
            return;
        }
        try {
            c06817d.A05().A9i(c06817d.A01(), c06817d.A09());
        } finally {
            c06817d.A0A(true);
        }
    }

    private void A0i(C06817d c06817d) throws AD {
        if (c06817d.A02() == C.TIME_UNSET) {
            A0j(c06817d);
            return;
        }
        if (this.A0D == null || this.A02 > 0) {
            this.A0p.add(new C06636l(c06817d));
            return;
        }
        C06636l c06636l = new C06636l(c06817d);
        if (A16(c06636l)) {
            this.A0p.add(c06636l);
            Collections.sort(this.A0p);
        } else {
            c06817d.A0A(false);
        }
    ...
    private void A0j(C06817d c06817d) throws AD {
        if (c06817d.A03() == this.A0f.A8R()) {
            A0h(c06817d);
        ...
        this.A0f.ACj(15, c06817d).A02();
    }

    private void A0k(final C06817d c06817d) {
        Looper looperA03 = c06817d.A03();
        if (!looperA03.getThread().isAlive()) {
            ...
            this.A0e.A5P(looperA03, null).A03(new Runnable() { // from class: com.facebook.ads.redexgen.X.6h
                ...
                public final void run() {
                    this.A00.A1E(c06817d);
                }
            });
        }
    }

    private void A0l(InterfaceC2283oo interfaceC2283oo) throws AD {
        this.A0g.A08(interfaceC2283oo);
        A0m(interfaceC2283oo);
        interfaceC2283oo.A5x();
    }

    private void A0m(InterfaceC2283oo interfaceC2283oo) throws AD {
        if (interfaceC2283oo.A9A() == 2) {
            interfaceC2283oo.stop();
        }
    }

    private void A0n(C06987u c06987u) {
        this.A0C = c06987u;
    }

    private void A0o(InterfaceC2223np interfaceC2223np) {
        if (!this.A0j.A0T(interfaceC2223np)) {
            return;
        }
        this.A0j.A0L(this.A06);
        A0w(false);
    ...
    private void A0p(InterfaceC2223np interfaceC2223np) throws AD {
        byte b10;
        if (!this.A0j.A0T(interfaceC2223np)) {
            return;
        }
    ...
    public final void ADV(InterfaceC2223np interfaceC2223np) {
        this.A0f.ACj(10, interfaceC2223np).A02();
    }

    private void A0r(InterfaceC0812Cx interfaceC0812Cx, boolean z10, boolean z11) {
        this.A02++;
        A13(true, z10, z11);
        this.A0i.AFR(C8O.A03);
        this.A0D = interfaceC0812Cx;
        A0V(2);
        interfaceC0812Cx.AH7(this, null);
        this.A0f.AJA(2);
    }

    private void A0s(C2204nW c2204nW, C0864Ex c0864Ex) {
        this.A0i.AGF(new AnonymousClass73(C8O.A03, this.A0A.A03, this.A0A.A04, this.A0A.A0C, A01(), this.A0g.A8m().A01, this.A0P, this.A0R, C.TIME_UNSET, this.A04), c2204nW, c0864Ex.A04);
    }

    @MetaExoPlayerCustomization("D18870411: Adding start stall debug reason")
    private void A0t(EnumC1940ir enumC1940ir, boolean z10) {
        if (this.A0A.A00 != 3) {
            this.A0A = this.A0A.A02(3, enumC1940ir, z10);
            this.A04 = -1L;
        }
    }
    ...
    private void A0v(boolean z10) {
        ...
        if (c7aA0E == null) {
            ...
            c2222no = c7aA0E.A00.A04;
        }
        C2222no loadingMediaPeriodId = this.A0A.A04;
        boolean loadingMediaPeriodChanged = !loadingMediaPeriodId.equals(c2222no);
        if (loadingMediaPeriodChanged) {
            this.A0A = this.A0A.A05(c2222no);
        }
    ...
    private void A0w(boolean z10) {
        ...
        Timeline timeline = this.A0A.A03;
        C2222no c2222no = c7aA0E.A00.A04;
        float f10 = this.A0g.A8m().A01;
        boolean z11 = this.A0P || z10;
        boolean z12 = this.A0R;
        long nextLoadPositionUs2 = this.A04;
        boolean zAJv = this.A0i.AJv(new AnonymousClass73(null, timeline, c2222no, jA0D, jA0C, f10, z11, z12, C.TIME_UNSET, nextLoadPositionUs2));
    ...
    private void A0x(boolean z10) throws AD {
        C2222no c2222no = this.A0j.A0F().A00.A04;
        long jA07 = A07(false, c2222no, this.A0A.A0C, true);
        if (jA07 != this.A0A.A0C) {
            this.A0A = this.A0A.A06(c2222no, jA07, this.A0A.A01, A01());
            if (z10) {
                C06646m c06646m = this.A0h;
                String[] strArr = A0y;
                if (strArr[4].charAt(1) == strArr[3].charAt(1)) {
                    throw new RuntimeException();
                }
    ...
    private void A13(boolean z10, boolean z11, boolean z12) {
        ...
        for (InterfaceC2283oo interfaceC2283oo : this.A0W) {
            try {
                ...
                Log.e(A0D(0, 21, 22), A0D(Sdk$SDKError.Reason.INVALID_BID_PAYLOAD_VALUE, 12, 44), e10);
            }
        }
        this.A0W = new InterfaceC2283oo[0];
        this.A0j.A0M(!z11);
        ...
        if (z12) {
            Iterator<C06636l> it = this.A0p.iterator();
            while (it.hasNext()) {
        ...
        C2222no c2222noA0A = z11 ? A0A() : this.A0A.A05;
        ...
        if (z12) {
            ...
            c0864Ex = this.A0A.A07;
        }
        this.A0A = new C7Z(timeline, c2222noA0A, j10, j11, i10, false, c2204nW, c0864Ex, c2222noA0A, j10, 0L, j10);
    ...
    */
    private void A14(boolean[] r6, int r7) throws com.instagram.common.viewpoint.core.AD {
        /*
            r5 = this;
            com.facebook.ads.redexgen.X.oo[] r0 = new com.instagram.common.viewpoint.core.InterfaceC2283oo[r7]
            r5.A0W = r0
            r4 = 0
    ...
    private boolean A16(C06636l c06636l) {
        if (c06636l.A02 == null) {
            Pair<Object, Long> pairA09 = A09(new C06656n(c06636l.A03.A04(), c06636l.A03.A00(), C2Y.A00(c06636l.A03.A02())), false);
            if (pairA09 == null) {
                return false;
            }
            ...
            if (A0y[5].charAt(1) != 'q') {
                ...
                c06636l.A01(iA0A, ((Long) pairA09.second).longValue(), pairA09.first);
                return true;
            }
            throw new RuntimeException();
        }
        int iA0A2 = this.A0A.A03.A0A(c06636l.A02);
        if (iA0A2 == -1) {
            return false;
        }
        c06636l.A00 = iA0A2;
    ...
    private boolean A17(InterfaceC2283oo interfaceC2283oo) {
        C7A c7aA0G = this.A0j.A0G();
        C7A readingPeriodHolder = c7aA0G.A0I();
        if (readingPeriodHolder != null) {
            C7A readingPeriodHolder2 = c7aA0G.A0I();
            if (readingPeriodHolder2.A02 && interfaceC2283oo.A9p()) {
                return true;
            }
        }
        return false;
    ...
    private boolean A18(C2222no c2222no, long j10, C7A c7a) {
        if (!c2222no.equals(c7a.A00.A04)) {
            return false;
        }
        boolean z10 = c7a.A02;
        if (A0y[1].length() == 31) {
    ...
    */
    private boolean A19(boolean r19) {
        ...
        La6:
            if (r9 != 0) goto Lac
            com.facebook.ads.redexgen.X.ir r0 = com.instagram.common.viewpoint.core.EnumC1940ir.A04
            r3.A0E = r0
        Lac:
            return r9
        Lad:
    ...
    public static C2374qI[] A1A(InterfaceC0857Eq interfaceC0857Eq) {
        int length = interfaceC0857Eq != null ? interfaceC0857Eq.length() : 0;
        C2374qI[] c2374qIArr = new C2374qI[length];
        for (int i10 = 0; i10 < length; i10++) {
            c2374qIArr[i10] = interfaceC0857Eq.A8B(i10);
        }
        return c2374qIArr;
    }
    ...
    */
    ...
    public final void A1D(Timeline timeline, int i10, long j10) {
        this.A0f.ACj(3, new C06656n(timeline, i10, j10)).A02();
    }

    public final /* synthetic */ void A1E(C06817d c06817d) {
        try {
            A0h(c06817d);
        } catch (AD e10) {
    ...
    public final void A1F(InterfaceC0812Cx interfaceC0812Cx, boolean z10, boolean z11) {
        this.A0f.ACi(0, z10 ? 1 : 0, z11 ? 1 : 0, interfaceC0812Cx).A02();
    }
    ...
    public final void AFI(C2353px c2353px) {
        this.A0a.obtainMessage(1, c2353px).sendToTarget();
        A0T(c2353px.A01);
    }

    @Override // com.instagram.common.viewpoint.core.InterfaceC2224nq
    public final void AFS(InterfaceC2223np interfaceC2223np) {
        this.A0f.ACj(9, interfaceC2223np).A02();
    }

    @Override // com.instagram.common.viewpoint.core.InterfaceC0811Cw
    public final void AG1(InterfaceC0812Cx interfaceC0812Cx, Timeline timeline) {
        this.A0f.ACj(8, new C06626k(interfaceC0812Cx, timeline)).A02();
    }

    @Override // com.instagram.common.viewpoint.core.InterfaceC0862Ev
    public final void AGD() {
        this.A0f.AJA(11);
    }

    @Override // com.instagram.common.viewpoint.core.InterfaceC06797b
    public final synchronized void AJC(C06817d c06817d) {
        if (this.A0S) {
            Log.w(A0D(0, 21, 22), A0D(50, 37, 39));
            c06817d.A0A(false);
        } else {
            this.A0f.ACj(14, c06817d).A02();
        }
    }
    ...
    public final boolean handleMessage(Message message) throws Throwable {
        ...
        switch (message.what) {
            case 0:
                A0r((InterfaceC0812Cx) message.obj, message.arg1 != 0, message.arg2 != 0);
                A0H();
                return true;
            case 1:
                A0z(message.arg1 != 0);
            ...
            case 2:
                ...
                return true;
            case 3:
                A0f((C06656n) message.obj);
                A0H();
                return true;
            case 4:
                A0b((C2353px) message.obj);
                A0H();
                return true;
            case 5:
                A0n((C06987u) message.obj);
                A0H();
                return true;
            case 6:
            ...
            case 7:
                ...
                return true;
            case 8:
                A0e((C06626k) message.obj);
                A0H();
                return true;
            case 9:
                A0p((InterfaceC2223np) message.obj);
                A0H();
                return true;
            case 10:
                A0o((InterfaceC2223np) message.obj);
                A0H();
                return true;
            case 11:
                A0L();
            ...
            case 13:
                ...
                return true;
            case 14:
                A0i((C06817d) message.obj);
                A0H();
                return true;
            case 15:
                A0k((C06817d) message.obj);
                A0H();
                return true;
            case 16:
                A0H();
