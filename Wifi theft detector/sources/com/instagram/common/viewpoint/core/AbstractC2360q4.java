...
public abstract class AbstractC2360q4<K0> {
    ...
    private final BD<K0, Object> A00(final int expectedValuesPerKey) {
        AbstractC2191nJ.A00(expectedValuesPerKey, A01(0, 20, 35));
        return new BD<K0, Object>(this) { // from class: com.facebook.ads.redexgen.X.2F
            public final /* synthetic */ AbstractC2360q4 A01;
            ...
            public final <K extends K0, V> BM<K, V> A00() {
                return AbstractC2364q8.A00(this.A01.A04(), new BE(expectedValuesPerKey));
            }
        };
    }
