...
public final class C1375Zb extends RelativeLayout {
    public final int A00;
    public final int A01;
    public final C1104Og A02;
    public final C1814gi A03;
    public final InterfaceC1379Zf A04;
    ...
    public C1375Zb(C1374Za c1374Za) {
        super(c1374Za.A0B);
        this.A03 = c1374Za.A0B;
        this.A02 = AbstractC1105Oh.A00(this.A03.A02());
        this.A04 = c1374Za.A02;
        this.A01 = c1374Za.A0A ? A0E : A0F;
        this.A00 = c1374Za.A0A ? A0B : A0C;
        this.A05 = c1374Za.A07;
        setFocusable(true);
        View viewA01 = A01(c1374Za);
        View viewA00 = A00(c1374Za);
    ...
    private View A00(C1374Za c1374Za) {
        ...
        subtitleView.setText(c1374Za.A06);
        ...
        if (c1374Za.A08) {
            ...
            if (!TextUtils.isEmpty(c1374Za.A04)) {
                ...
                new LM(c1508bk, this.A03).A05(A0F, A0F).A07(c1374Za.A04);
                linearLayout2.addView(c1508bk, iconParams);
            }
            C1381Zh c1381Zh = new C1381Zh(this.A03);
            c1381Zh.setData(c1374Za.A03, YM.CHECKMARK);
            c1381Zh.setSelected(true);
            linearLayout2.addView(c1381Zh, new LinearLayout.LayoutParams(-2, -2));
            linearLayout.addView(linearLayout2);
        }
        return linearLayout;
    }

    private View A01(C1374Za c1374Za) {
        LinearLayout linearLayout = new LinearLayout(getContext());
