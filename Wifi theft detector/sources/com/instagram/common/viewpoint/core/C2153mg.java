...
public final class C2153mg implements H9 {
    ...
    public C2153mg(int i10) {
        this.A0D = new byte[42];
        this.A0A = new C06214v(new byte[32768], 0);
        this.A0C = (i10 & 1) != 0;
        this.A0B = new HE();
        this.A03 = 0;
    }

    private int A00(InterfaceC2165ms interfaceC2165ms, HV hv) throws IOException {
        AbstractC05983y.A01(this.A08);
        AbstractC05983y.A01(this.A07);
        if (this.A09 != null && this.A09.A09()) {
            return this.A09.A06(interfaceC2165ms, hv);
        }
        long j10 = this.A04;
        if (A0E[2].length() == 19) {
            A0E[2] = "5vsaEOzV8f26KwvJg69";
            if (j10 == -1) {
                this.A04 = HF.A01(interfaceC2165ms, this.A07);
                return 0;
            }
            ...
            if (strArr[6].length() != strArr[1].length()) {
                ...
                if (iA0A < 32768) {
                    ...
                    int i10 = interfaceC2165ms.read(this.A0A.A0l(), iA0A, currentLimit);
                    z10 = i10 == -1;
                    if (!z10) {
    ...
    */
    private long A01(com.instagram.common.viewpoint.core.C06214v r6, boolean r7) {
        /*
            r5 = this;
            com.facebook.ads.redexgen.X.HJ r0 = r5.A07
            com.instagram.common.viewpoint.core.AbstractC05983y.A01(r0)
            int r3 = r6.A09()
        L9:
            int r0 = r6.A0A()
            int r0 = r0 + (-16)
        ...
        L68:
            r3 = -1
            java.lang.String[] r2 = com.instagram.common.viewpoint.core.C2153mg.A0E
            r0 = 3
            r1 = r2[r0]
            r0 = 4
            r0 = r2[r0]
        ...
        L82:
            ...
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C2153mg.A01(com.facebook.ads.redexgen.X.4v, boolean):long");
    }

    private HY A02(long j10, long j11) {
        AbstractC05983y.A01(this.A07);
        if (this.A07.A0A != null) {
            return new C2162mp(this.A07, j10);
        }
        if (j11 != -1 && this.A07.A09 > 0) {
            this.A09 = new C2155mi(this.A07, this.A01, j10, j11);
            return this.A09.A07();
        }
        return new C2160mn(this.A07.A06());
    }

    private void A03() {
        ((InterfaceC0921Hd) C5C.A0f(this.A08)).AIu((this.A04 * 1000000) / ((HJ) C5C.A0f(this.A07)).A07, 1, this.A00, 0, null);
    }

    private void A04(InterfaceC2165ms interfaceC2165ms) throws IOException {
        this.A01 = HH.A00(interfaceC2165ms);
        ((HA) C5C.A0f(this.A06)).AJ7(A02(interfaceC2165ms.A8n(), interfaceC2165ms.A8O()));
        this.A03 = 5;
    }

    private void A05(InterfaceC2165ms interfaceC2165ms) throws IOException {
        interfaceC2165ms.AGt(this.A0D, 0, this.A0D.length);
        interfaceC2165ms.AIl();
        this.A03 = 2;
    }

    private void A06(InterfaceC2165ms interfaceC2165ms) throws IOException {
        this.A05 = HH.A02(interfaceC2165ms, !this.A0C);
        this.A03 = 1;
    }
    ...
    private void A07(InterfaceC2165ms interfaceC2165ms) throws IOException {
        ...
        while (!zA0B) {
            zA0B = HH.A0B(interfaceC2165ms, metadataHolder);
            this.A07 = (HJ) C5C.A0f(metadataHolder.A00);
        }
        AbstractC05983y.A01(this.A07);
        this.A02 = Math.max(this.A07.A06, 6);
        ((InterfaceC0921Hd) C5C.A0f(this.A08)).A6e(this.A07.A08(this.A0D, this.A05));
        this.A03 = 4;
    }

    private void A08(InterfaceC2165ms interfaceC2165ms) throws IOException {
        HH.A09(interfaceC2165ms);
        this.A03 = 3;
    }

    public static /* synthetic */ H9[] A09() {
        return new H9[]{new C2153mg()};
    }
    ...
    public final int AHL(InterfaceC2165ms interfaceC2165ms, HV hv) throws IOException {
        switch (this.A03) {
            ...
            case 4:
                ...
                return 0;
            case 5:
                return A00(interfaceC2165ms, hv);
            default:
    ...
    public final boolean AK5(InterfaceC2165ms interfaceC2165ms) throws IOException {
        HH.A01(interfaceC2165ms, false);
        return HH.A0A(interfaceC2165ms);
    }
}
