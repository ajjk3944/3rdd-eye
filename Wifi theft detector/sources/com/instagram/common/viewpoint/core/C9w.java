...
public final class C9w implements InterfaceC2230nw {
     ...
     */
    public static C0776Bk A01(Cursor cursor) {
        byte[] blob = cursor.getBlob(14);
        C8 c8A02 = new C8((String) AbstractC05983y.A01(cursor.getString(0)), Uri.parse((String) AbstractC05983y.A01(cursor.getString(2)))).A01(cursor.getString(1)).A02(A09(cursor.getString(3)));
        if (blob.length <= 0) {
            blob = null;
        }
        ...
        return new C0776Bk(downloadRequestA05, i10, cursor.getLong(7), cursor.getLong(8), cursor.getLong(9), cursor.getInt(10), i10 == 4 ? cursor.getInt(11) : 0, c62);
    }

    /* JADX WARN: Failed to parse debug info
    java.lang.ArrayIndexOutOfBoundsException
     */
    public static C0776Bk A02(Cursor cursor) {
        DownloadRequest downloadRequestA05 = new C8((String) AbstractC05983y.A01(cursor.getString(0)), Uri.parse((String) AbstractC05983y.A01(cursor.getString(2)))).A01(A05(cursor.getString(1))).A02(A09(cursor.getString(3))).A00(cursor.getString(4)).A03(cursor.getBlob(5)).A05();
        C6 c62 = new C6();
        c62.A01 = cursor.getLong(13);
        c62.A00 = cursor.getFloat(12);
        int i10 = cursor.getInt(6);
    ...
    private List<C0776Bk> A08(SQLiteDatabase sQLiteDatabase) {
    ...
    public static List<StreamKey> A09(String str) {
        ...
        for (String str2 : C5C.A1O(str, A04(TTAdConstant.IMAGE_URL_CODE, 1, 1))) {
            ...
            AbstractC05983y.A08(strArrA1O.length == 3);
            ...
            try {
                ...
                if (iA00 != 3) {
                    ...
                    try {
                        ...
                        List<C0776Bk> listA08 = iA00 == 2 ? A08(writableDatabase) : new ArrayList<>();
                        writableDatabase.execSQL(A04(427, 21, 3) + this.A04);
                        writableDatabase.execSQL(A04(TTAdConstant.VIDEO_URL_CODE, 13, 1) + this.A04 + A04(0, 1, 39) + A04(11, TTAdConstant.MATE_IS_NULL_CODE, 82));
                        Iterator<C0776Bk> it = listA08.iterator();
                        while (it.hasNext()) {
    ...
    private void A0C(C0776Bk c0776Bk, SQLiteDatabase sQLiteDatabase) throws SQLException {
        byte[] bArr = c0776Bk.A07.A06 == null ? C5C.A07 : c0776Bk.A07.A06;
        ContentValues contentValues = new ContentValues();
        contentValues.put(A04(607, 2, 119), c0776Bk.A07.A02);
        contentValues.put(A04(625, 9, 108), c0776Bk.A07.A03);
        contentValues.put(A04(739, 3, 12), c0776Bk.A07.A00.toString());
        contentValues.put(A04(709, 11, 1), A06(c0776Bk.A07.A04));
        contentValues.put(A04(566, 16, 36), c0776Bk.A07.A01);
        contentValues.put(A04(586, 4, 41), c0776Bk.A07.A05);
        contentValues.put(A04(684, 5, 42), Integer.valueOf(c0776Bk.A02));
        contentValues.put(A04(654, 13, 81), Long.valueOf(c0776Bk.A05));
        contentValues.put(A04(725, 14, 8), Long.valueOf(c0776Bk.A06));
        contentValues.put(A04(552, 14, 17), Long.valueOf(c0776Bk.A04));
        contentValues.put(A04(698, 11, 116), Integer.valueOf(c0776Bk.A03));
        contentValues.put(A04(590, 14, 52), Integer.valueOf(c0776Bk.A01));
        contentValues.put(A04(634, 18, 59), Float.valueOf(c0776Bk.A00()));
        contentValues.put(A04(536, 16, 16), Long.valueOf(c0776Bk.A01()));
        contentValues.put(A04(615, 10, 25), bArr);
        sQLiteDatabase.replaceOrThrow(this.A04, null, contentValues);
    }

    @Override // com.instagram.common.viewpoint.core.InterfaceC0789Bx
    public final C0776Bk A7q(String str) throws C5N {
        A0A();
        try {
            ...
            try {
                ...
                C0776Bk c0776BkA01 = A01(cursorA00);
                if (cursorA00 != null) {
                    cursorA00.close();
                }
                return c0776BkA01;
    ...
    @Override // com.instagram.common.viewpoint.core.InterfaceC0789Bx
    public final C2237o4 A7r(int... iArr) throws C5N {
        A0A();
        return new C2237o4(A00(A07(iArr), null));
    }

    @Override // com.instagram.common.viewpoint.core.InterfaceC2230nw
    public final void AHF(C0776Bk c0776Bk) throws C5N, SQLException {
        A0A();
        try {
            SQLiteDatabase writableDatabase = this.A01.getWritableDatabase();
            A0C(c0776Bk, writableDatabase);
        } catch (SQLiteException e10) {
            throw new C5N(e10);
        }
    }
