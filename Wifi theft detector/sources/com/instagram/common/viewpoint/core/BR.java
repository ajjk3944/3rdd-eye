...
public abstract class BR<E> extends AbstractC2256oN<E> {
    ...
    public BR(int initialCapacity) {
        AbstractC2191nJ.A00(initialCapacity, A00(0, 15, 58));
    ...
    private void A02(int newElements) {
        ...
        int newCapacity = AbstractC2256oN.A03(objArr.length, this.A00 + newElements);
