...
public abstract class AbstractC0928Hk {
     ...
     */
    public static C0927Hj A06(C06214v c06214v) throws C3K {
        A0C(1, c06214v, false);
        int iA0F = c06214v.A0F();
        int iA0I = c06214v.A0I();
        int iA0F2 = c06214v.A0F();
        int iA0E = c06214v.A0E();
        if (iA0E <= 0) {
            iA0E = -1;
        }
        int iA0E2 = c06214v.A0E();
        if (iA0E2 <= 0) {
            iA0E2 = -1;
        }
        int iA0E3 = c06214v.A0E();
        if (iA0E3 <= 0) {
            iA0E3 = -1;
            String[] strArr = A01;
        ...
        return new C0927Hj(iA0F, iA0I, iA0F2, iA0E, iA0E2, iA0E3, (int) Math.pow(2.0d, iA0I2 & 15), (int) Math.pow(2.0d, (iA0I2 & PsExtractor.VIDEO_STREAM_MASK) >> 4), (c06214v.A0I() & 1) > 0, Arrays.copyOf(c06214v.A0l(), c06214v.A0A()));
    }
    ...
    public static Metadata A02(List<String> list) {
        ...
        for (int i10 = 0; i10 < list.size(); i10++) {
            ...
            if (length != 2) {
                AbstractC06064g.A07(strA07, A07(1, 32, 49) + str);
            } else {
                String[] strArr = A01;
                ...
                if (strArrA1P[0].equals(A07(63, 22, 85))) {
                    try {
                        vorbisComments.add(PictureFrame.A00(new C06214v(Base64.decode(strArrA1P[1], 0))));
                    } catch (RuntimeException e10) {
                        AbstractC06064g.A0A(strA07, A07(33, 30, 0), e10);
                    }
                } else {
    ...
    */
    public static com.instagram.common.viewpoint.core.C0924Hg A03(com.instagram.common.viewpoint.core.C0923Hf r15) throws com.instagram.common.viewpoint.core.C3K {
        /*
            Method dump skipped, instructions count: 345
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.AbstractC0928Hk.A03(com.facebook.ads.redexgen.X.Hf):com.facebook.ads.redexgen.X.Hg");
    }

    public static C0925Hh A04(C06214v c06214v) throws C3K {
        return A05(c06214v, true, true);
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public static com.instagram.common.viewpoint.core.C0925Hh A05(com.instagram.common.viewpoint.core.C06214v r9, boolean r10, boolean r11) throws com.instagram.common.viewpoint.core.C3K {
        /*
            if (r10 == 0) goto L7
            r1 = 3
            r0 = 0
        ...
        L50:
            ...
            r0 = 0
            com.facebook.ads.redexgen.X.3K r0 = com.instagram.common.viewpoint.core.C3K.A01(r1, r0)
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.AbstractC0928Hk.A05(com.facebook.ads.redexgen.X.4v, boolean, boolean):com.facebook.ads.redexgen.X.Hh");
    }

    public static void A09(int i10, C0923Hf c0923Hf) throws C3K {
        int i11;
        int iA02 = c0923Hf.A02(6) + 1;
        for (int i12 = 0; i12 < iA02; i12++) {
            int iA022 = c0923Hf.A02(16);
            if (iA022 != 0) {
                AbstractC06064g.A05(A07(85, 10, 6), A07(355, 41, 59) + iA022);
            } else {
                if (c0923Hf.A04()) {
                    int iA023 = c0923Hf.A02(4);
                    String[] strArr = A01;
                    String str = strArr[7];
                ...
                if (c0923Hf.A04()) {
                    int i13 = c0923Hf.A02(8);
                    int i14 = i13 + 1;
                    for (int i15 = 0; i15 < i14; i15++) {
                        int mappingsCount2 = i10 - 1;
                        c0923Hf.A03(A00(mappingsCount2));
                        int mappingsCount3 = i10 - 1;
                        c0923Hf.A03(A00(mappingsCount3));
                    }
                }
                int mappingsCount4 = c0923Hf.A02(2);
                if (mappingsCount4 == 0) {
                    if (i11 > 1) {
    ...
    public static void A0A(C0923Hf c0923Hf) throws C3K {
        int iA02 = c0923Hf.A02(6) + 1;
            ...
            switch (iA022) {
                ...
                case 1:
                    ...
                    for (int j11 = 0; j11 < iArr.length; j11++) {
                        iArr[j11] = c0923Hf.A02(3) + 1;
                        int iA024 = c0923Hf.A02(2);
                        if (iA024 > 0) {
                            c0923Hf.A03(8);
                        }
    ...
    public static void A0B(C0923Hf c0923Hf) throws C3K {
        int iA02 = c0923Hf.A02(6) + 1;
        for (int i10 = 0; i10 < iA02; i10++) {
            int residueCount = c0923Hf.A02(16);
            if (residueCount <= 2) {
                c0923Hf.A03(24);
                c0923Hf.A03(24);
                c0923Hf.A03(24);
                int iA022 = c0923Hf.A02(6) + 1;
                c0923Hf.A03(8);
                int[] iArr = new int[iA022];
                for (int i11 = 0; i11 < iA022; i11++) {
                    int residueCount2 = 0;
                    int iA023 = c0923Hf.A02(3);
                    if (c0923Hf.A04()) {
                        String[] strArr = A01;
                        String str = strArr[7];
                        String str2 = strArr[0];
    ...
    public static boolean A0C(int i10, C06214v c06214v, boolean z10) throws C3K {
        if (c06214v.A07() < 7) {
            if (z10) {
                return false;
            }
            throw C3K.A01(A07(549, 18, 10) + c06214v.A07(), null);
        }
        if (c06214v.A0I() != i10) {
            if (z10) {
                return false;
        ...
        if (c06214v.A0I() != 118 || c06214v.A0I() != 111 || c06214v.A0I() != 114 || c06214v.A0I() != 98 || c06214v.A0I() != 105 || c06214v.A0I() != 115) {
            if (z10) {
                return false;
            }
    ...
    public static C0926Hi[] A0D(C06214v c06214v, int i10) throws C3K {
        A0C(5, c06214v, false);
        int iA0I = c06214v.A0I() + 1;
        C0923Hf c0923Hf = new C0923Hf(c06214v.A0l());
        int numberOfBooks = c06214v.A09();
        c0923Hf.A03(numberOfBooks * 8);
        for (int numberOfBooks2 = 0; numberOfBooks2 < iA0I; numberOfBooks2++) {
            A03(c0923Hf);
        }
        int numberOfBooks3 = c0923Hf.A02(6);
        int timeCount = numberOfBooks3 + 1;
        for (int i11 = 0; i11 < timeCount; i11++) {
            int numberOfBooks4 = c0923Hf.A02(16);
            if (numberOfBooks4 != 0) {
        ...
        A0B(c0923Hf);
        A09(i10, c0923Hf);
        C0926Hi[] c0926HiArrA0E = A0E(c0923Hf);
        if (c0923Hf.A04()) {
            return c0926HiArrA0E;
        }
        throw C3K.A01(A07(PsExtractor.VIDEO_STREAM_MASK, 43, 105), null);
    }

    public static C0926Hi[] A0E(C0923Hf c0923Hf) {
        int iA02 = c0923Hf.A02(6) + 1;
        C0926Hi[] c0926HiArr = new C0926Hi[iA02];
        for (int windowType = 0; windowType < iA02; windowType++) {
            boolean zA04 = c0923Hf.A04();
            int iA022 = c0923Hf.A02(16);
            int i10 = c0923Hf.A02(16);
            c0926HiArr[windowType] = new C0926Hi(zA04, iA022, i10, c0923Hf.A02(8));
        }
        return c0926HiArr;
    }
}
