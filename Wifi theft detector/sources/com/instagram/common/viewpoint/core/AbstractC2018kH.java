...
public abstract class AbstractC2018kH extends AbstractC1066Mt {
    ...
    public abstract EnumC1063Mq A0H();
    ...
    public AbstractC2018kH(C1814gi c1814gi, VA va, String str, N0 n02, boolean z10) {
        this(c1814gi, va, str, n02, z10, false);
    }

    public AbstractC2018kH(C1814gi c1814gi, VA va, String str, N0 n02, boolean z10, boolean z11) {
        ...
        this.A01 = z11;
        if (this.A02 != null) {
            this.A02.A07(new InterfaceC1065Ms() { // from class: com.facebook.ads.redexgen.X.kI
                @Override // com.instagram.common.viewpoint.core.InterfaceC1065Ms
    ...
    public final EnumC1063Mq A0G(String str) {
        ...
        if (C1493bV.A04(super.A01)) {
            return EnumC1063Mq.A06;
        }
        if (A0L(str)) {
            return EnumC1063Mq.A06;
        }
    ...
    public final /* synthetic */ void A0I() {
        this.A00++;
        if (A0L(null)) {
            InterfaceC1064Mr interfaceC1064Mr = super.A00;
            if (A08[1].length() != 9) {
                throw new RuntimeException();
            }
            A08[0] = "ZLZB3DtfqcSTIr4ga6zBSlI";
            if (interfaceC1064Mr != null) {
                super.A00.ACk();
            }
        }
    }

    public final void A0J(Map<String, String> extraData, EnumC1063Mq enumC1063Mq) {
        if (!TextUtils.isEmpty(super.A03)) {
            ...
            boolean zA02 = EnumC1063Mq.A02(enumC1063Mq);
            boolean z10 = this.A02 != null;
            boolean isError = C1264Up.A2U(super.A01);
            if (isError) {
            ...
            if (this.A02 != null) {
                ...
                map.put(A0D(57, 7, 125), EnumC1063Mq.A05.name());
    ...
    public final boolean A0K(Uri uri) {
        try {
            ...
            return C1318Wu.A0D(super.A01, intent);
    ...
    public final boolean A0L(String str) {
        return (str == null || !str.equals(A0D(109, 9, 66))) && this.A00 != 0 && this.A00 >= C1264Up.A0I(super.A01);
    }
}
