...
public class C2313pI extends SQLiteOpenHelper implements C5O {
    ...
    public C2313pI(Context context) {
            ...
            try {
                ...
                if (!A00(88, 15, 125).equals(string2)) {
                    ...
                    try {
                        ...
                        AbstractC06064g.A08(type, A00(16, 16, 55) + str, e10);
                    }
                }
            } catch (Throwable th) {
                if (cursorQuery != null) {
