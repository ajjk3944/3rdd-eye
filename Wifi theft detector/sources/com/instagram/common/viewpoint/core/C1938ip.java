...
public class C1938ip implements NJ {
    ...
    public final /* synthetic */ C06787a A00;
    ...
    public C1938ip(C06787a c06787a, Runnable runnable) {
        this.A00 = c06787a;
        this.A01 = runnable;
    }

    @Override // com.instagram.common.viewpoint.core.NJ
    public final void AFj(AbstractC1983jh abstractC1983jh) {
        this.A00.A07.A06();
    }

    @Override // com.instagram.common.viewpoint.core.NJ
    public final void AFk(AbstractC1983jh abstractC1983jh) {
        this.A00.A07.A07();
    }

    @Override // com.instagram.common.viewpoint.core.NJ
    public final void AFl(AbstractC1983jh abstractC1983jh) {
        this.A00.A07.A0C();
    }

    @Override // com.instagram.common.viewpoint.core.NJ
    public final void AFm(AbstractC1983jh abstractC1983jh) {
        this.A00.A0H().removeCallbacks(this.A01);
        this.A00.A01 = abstractC1983jh;
        this.A00.A0L();
        if (this.A00.A07 != null) {
            this.A00.A07.A0F(abstractC1983jh);
        }
    }

    @Override // com.instagram.common.viewpoint.core.NJ
    public final void AFn(AbstractC1983jh abstractC1983jh) {
        AbstractC1297Vy.A05(A00(39, 34, 56), A00(8, 31, 51), A00(0, 8, 47));
        this.A00.A07.A0D();
        this.A00.A0O();
    }

    @Override // com.instagram.common.viewpoint.core.NJ
    public final void AFo(AbstractC1983jh abstractC1983jh) {
        this.A00.A07.A08();
    }

    @Override // com.instagram.common.viewpoint.core.NJ
    public final void AFp(AbstractC1983jh abstractC1983jh, AdError adError) {
        this.A00.A0H().removeCallbacks(this.A01);
        this.A00.A0B.A0F().A5g(adError.getErrorCode(), adError.getErrorMessage());
        if (AdError.AD_PRESENTATION_ERROR.equals(adError) && C1264Up.A1y(this.A00.A0B)) {
            this.A00.A07.A0G(C1286Vm.A00(AdErrorType.AD_PRESENTATION_ERROR));
        } else if (AdError.NO_FILL.equals(adError)) {
            this.A00.A07.A0G(C1286Vm.A00(AdErrorType.NO_FILL));
        } else {
            this.A00.A07.A0G(C1286Vm.A00(AdErrorType.INTERNAL_ERROR));
        }
        this.A00.A0Q(abstractC1983jh);
        if (A03[7].charAt(7) != 'L') {
            throw new RuntimeException();
        }
        String[] strArr = A03;
