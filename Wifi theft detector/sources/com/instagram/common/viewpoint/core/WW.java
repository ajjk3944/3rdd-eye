...
public final class WW implements VA {
    ...
    public WW(C1810ge c1810ge) {
        V8 dispatchCallback;
        this.A00 = c1810ge;
        if (AbstractC1266Ur.A0T(c1810ge)) {
            this.A01 = UP.A00(c1810ge);
            dispatchCallback = VF.A00(c1810ge, this.A01);
        } else {
            AnonymousClass71 anonymousClass71A01 = UP.A01(c1810ge);
            dispatchCallback = VF.A01(c1810ge, anonymousClass71A01);
            this.A01 = anonymousClass71A01;
        }
        this.A02 = new Wm(c1810ge, dispatchCallback);
        YG.A08.execute(new WY(this));
        A04(c1810ge);
    }

    public static synchronized VA A01(C1810ge c1810ge) {
        if (A03 == null) {
            A03 = new WW(c1810ge);
        }
        return A03;
    ...
    public static synchronized void A04(C1810ge c1810ge) {
        if (A06) {
            return;
        }
        c1810ge.A04().ACn();
    ...
    private void A06(V7 v72) {
        switch (v72.A06()) {
            ...
            case A0T:
            case A0U:
                C1227Te c1227Te = new C1227Te(new Exception(A02(36, 5, 86)));
                c1227Te.A05(1);
                try {
                    c1227Te.A07(new JSONObject().put(A02(48, 4, 41), v72.A06().toString()));
                } catch (JSONException unused) {
                }
                this.A00.A08().ABD(A02(41, 7, 112), AbstractC1226Td.A1H, c1227Te);
                break;
        }
    }
    ...
    public final void AGz(String str) {
        new AsyncTaskC1785gF(this.A00).execute(str);
    }
}
