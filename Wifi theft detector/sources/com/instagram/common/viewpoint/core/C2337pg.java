...
public final class C2337pg implements AnonymousClass24 {
    public static byte[] A05;
    public static final AnonymousClass23<C2337pg> A06;
    ...
    static {
        ...
        A06 = new AnonymousClass23() { // from class: com.facebook.ads.redexgen.X.ph
            ...
            public final AnonymousClass24 A6f(Bundle bundle) {
                return C2337pg.A01(bundle);
            }
        };
    }

    public C2337pg(String str, C2374qI... c2374qIArr) {
        AbstractC05983y.A07(c2374qIArr.length > 0);
        this.A03 = str;
        this.A04 = c2374qIArr;
        this.A01 = c2374qIArr.length;
        int iA01 = C3J.A01(c2374qIArr[0].A0W);
        this.A02 = iA01 == -1 ? C3J.A01(c2374qIArr[0].A0S) : iA01;
        A04();
    }

    public C2337pg(C2374qI... c2374qIArr) {
        this(A02(0, 0, 114), c2374qIArr);
    }
    ...
    public static /* synthetic */ C2337pg A01(Bundle bundle) {
        List listA01;
        List<Format> formats = bundle.getParcelableArrayList(A07);
        if (formats == null) {
            listA01 = MetaExoPlayerCustomizedCollections.A01();
        } else {
            listA01 = AnonymousClass44.A01(C2374qI.A0b, formats);
        }
        String id = bundle.getString(A08, A02(0, 0, 114));
        return new C2337pg(id, (C2374qI[]) listA01.toArray(new C2374qI[0]));
    }
    ...
    public static void A06(String str, String str2, String str3, int i10) {
        AbstractC06064g.A08(A02(67, 10, 77), A02(0, 0, 114), new IllegalStateException(A02(57, 10, 33) + str + A02(0, 30, 112) + str2 + A02(39, 17, 88) + str3 + A02(30, 9, 76) + i10 + A02(56, 1, 24)));
    }
    ...
    */
    public final int A07(com.instagram.common.viewpoint.core.C2374qI r3) {
        /*
            r2 = this;
            r1 = 0
        L1:
        ...
        L10:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C2337pg.A07(com.facebook.ads.redexgen.X.qI):int");
    }
    ...
    public final boolean equals(Object obj) {
        ...
        return this.A03.equals(c2337pg.A03) && Arrays.equals(this.A04, c2337pg.A04);
    }
