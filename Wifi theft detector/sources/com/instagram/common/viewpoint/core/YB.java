...
public abstract class YB {
     ...
     */
    public static boolean A0i(C1814gi c1814gi, EnumC1063Mq enumC1063Mq, Map<String, String> map) {
        String str = map.get(A0C(89, 21, 37));
        boolean z10 = str != null && str.equals(Boolean.TRUE.toString());
        if (z10 && (A0h(c1814gi, enumC1063Mq) || A0f(enumC1063Mq, map))) {
            return true;
        }
        String str2 = map.get(A0C(62, 27, 11));
        return z10 && (str2 != null && str2.equals(Boolean.TRUE.toString())) && A0g(enumC1063Mq, map);
    }
    ...
    */
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public static void A0c(java.util.Map<java.lang.String, java.lang.String> r5, com.instagram.common.viewpoint.core.AbstractC1979jd r6) {
        /*
            if (r6 != 0) goto L3
            return
        L3:
    ...
    public static boolean A0f(EnumC1063Mq enumC1063Mq, Map<String, String> extraData) {
        boolean nonIabDestination = !A0C(162, 9, 82).equals(extraData.get(A0C(15, 12, 15)));
        boolean nonCtaClick = enumC1063Mq != EnumC1063Mq.A08;
        return nonIabDestination && nonCtaClick;
    }

    public static boolean A0g(EnumC1063Mq enumC1063Mq, Map<String, String> extraData) {
        boolean zEquals = A0C(162, 9, 82).equals(extraData.get(A0C(15, 12, 15)));
        boolean ctaClick = enumC1063Mq != EnumC1063Mq.A08;
        return zEquals && ctaClick;
    }

    public static boolean A0h(C1814gi c1814gi, EnumC1063Mq enumC1063Mq) {
        return enumC1063Mq == EnumC1063Mq.A08 && C1264Up.A2w(c1814gi);
    }
}
