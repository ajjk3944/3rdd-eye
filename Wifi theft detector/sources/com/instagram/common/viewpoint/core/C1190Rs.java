...
public final class C1190Rs implements InterstitialAdApi, Repairable {
    public static byte[] A04;
    public final InterstitialAd A00;
    public final C1924iY A01;
    ...
    public C1190Rs(Context context, String str, InterstitialAd interstitialAd) {
        String string;
        this.A00 = interstitialAd;
        if (context instanceof C1814gi) {
            this.A03 = (C1814gi) context;
            string = this.A03.A0F().getId();
        } else {
            string = UUID.randomUUID().toString();
            this.A03 = C1187Rp.A06(context, string);
        }
        InterfaceC1040Lt interfaceC1040LtA0F = this.A03.A0F();
        String adId = AdPlacementType.INTERSTITIAL.toString();
        interfaceC1040LtA0F.A3T(adId, str);
        this.A01 = new C1924iY(this.A03, interstitialAd, str);
        this.A03.A0O(this);
    ...
    public final void A05(EnumSet<CacheFlag> enumSet, String str) {
        AbstractC1297Vy.A05(A00(129, 8, 122), A00(65, 30, 111), A00(16, 8, 42));
        if (str == null) {
            this.A03.A0F().A3Q();
        } else {
            this.A03.A0F().A3P();
    ...
    public final void destroy() {
        AbstractC1297Vy.A05(A00(122, 7, 21), A00(40, 25, 105), A00(0, 8, 21));
        if (C1264Up.A2M(this.A03)) {
            return;
        }
        this.A02.A08();
        this.A03.A0F().A3U();
    ...
    public final void loadAd(InterstitialAd.InterstitialLoadAdConfig interstitialLoadAdConfig) {
        ((C1191Rt) interstitialLoadAdConfig).A00();
    }

    @Override // com.facebook.ads.internal.context.Repairable
    public final void repair(Throwable th) {
        if (this.A01.A6o() != null) {
            this.A01.A6o().onError(this.A00, new AdError(2001, A00(24, 16, 63) + AbstractC1341Xt.A03(this.A03, th)));
        }
    }
    ...
    public final boolean show() {
        AbstractC1297Vy.A05(A00(137, 4, 11), A00(95, 27, 100), A00(8, 8, 56));
        this.A03.A0F().A3Z();
        boolean zA0I = this.A02.A0I(this.A00, new C1192Ru());
