...
public final class NL extends BroadcastReceiver {
    ...
    public static void A01() {
        A03 = new byte[]{53, 24, 20, 22, 85, 29, 26, 24, 30, 25, 20, 20, 16, 85, 26, 31, 8, 85, 18, 21, 15, 30, 9, 8, 15, 18, 15, 18, 26, 23, 85, 31, 18, 8, Flags.CD, 23, 26, 2, 30, 31, 55, 59, 57, 122, 50, 53, 55, 49, 54, 59, 59, 63, 122, 53, 48, 39, 122, 61, 58, 32, 49, 38, 39, 32, 61, 32, 61, 53, 56, 122, 48, 61, 39, 36, 56, 53, 45, 49, 48, 110, 81, 66, 81, 90, 64, 73, 92, 75, 95, 86, 75, 84, 122, 77, 88, 122, 85, 80, 90, 82, 71, 82, 69, 81, 88, 69, 90, 116, 67, 86, 116, 91, 94, 84, 92, 13, 90, 69, 72, 73, 67, 101, 66, 88, 73, 94, 95, 88, 69, 88, 77, 64, 105, 90, 73, 66, 88, 105, 118, 123, 122, 112, 86, 113, 107, 122, 109, 108, 107, 118, 107, 126, 115, 90, 105, 122, 113, 107, 37};
    }
    ...
    public NL(C06696r c06696r, Context context) {
        this.A01 = c06696r;
        this.A00 = context;
    }
    ...
    public final void onReceive(Context context, Intent intent) {
        ...
        if (str3.length() == action4.length()) {
            ...
            if (str4.equals(action6)) {
                ...
                if (serializableExtra instanceof C0839Dy) {
                    if (this.A01.getListener() != null) {
                    ...
                    if (this.A02) {
                        ...
                        this.A01.A0a(((C0839Dy) serializableExtra).A01());
                    }
                    this.A01.setVisibility(0);
                    this.A01.A0e(EnumC1701et.A04, 1);
                    return;
                }
