...
public class C1594d8 extends WebViewClient {
    ...
    public C1594d8(C1598dC c1598dC) {
        this.A00 = c1598dC;
    }
    ...
    private void A02(int i10, String str, String str2, boolean z10) throws JSONException {
        ...
        this.A00.A0E.A04(AbstractC1226Td.A16, string);
    }
    ...
    public final boolean onRenderProcessGone(WebView webView, RenderProcessGoneDetail renderProcessGoneDetail) throws JSONException {
        ...
        String string = jSONObject.toString();
        C1814gi c1814gi = this.A00.A0B;
        String message = A02[5];
        if (message.charAt(10) == 'q') {
            A02[3] = "cKmn9F08G0LbJgt48cswTZGSotGQ5jj";
            c1814gi.A0F().A6A(string);
            AbstractC1599dD.A04(this.A00.A09.A1D());
    ...
    public final WebResourceResponse shouldInterceptRequest(WebView webView, WebResourceRequest webResourceRequest) {
        return C1608dM.A00(this.A00.A0B, this.A00.A0A, webResourceRequest, this.A00.A0H, this.A00.A09.A1T());
    }
}
