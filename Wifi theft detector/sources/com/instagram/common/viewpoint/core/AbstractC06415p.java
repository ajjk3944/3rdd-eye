...
public abstract class AbstractC06415p {
    ...
    public static long A00(String str) {
        ...
        if (matcher.matches()) {
            return Long.parseLong((String) AbstractC05983y.A01(matcher.group(1)));
        }
        return -1L;
    }
    ...
    public static long A01(String str, String str2) throws NumberFormatException {
        ...
        if (!zIsEmpty) {
            try {
                ...
                AbstractC06064g.A05(strA022, A02(31, 27, 88) + str + strA02);
            }
        }
        if (!TextUtils.isEmpty(str2)) {
            ...
            if (matcher.matches()) {
                try {
                    long j10 = (Long.parseLong((String) AbstractC05983y.A01(matcher.group(2))) - Long.parseLong((String) AbstractC05983y.A01(matcher.group(1)))) + 1;
                    if (jMax < 0) {
                        return j10;
                    }
                    if (jMax != j10) {
                        AbstractC06064g.A07(strA022, A02(9, 22, 119) + str + A02(85, 3, 111) + str2 + strA02);
                        jMax = Math.max(jMax, j10);
                        return jMax;
                    }
                    return jMax;
                } catch (NumberFormatException unused2) {
                    AbstractC06064g.A05(strA022, A02(58, 26, 121) + str2 + strA02);
                    return jMax;
                }
            }
            return jMax;
    ...
    */
    public static java.lang.String A03(long r6, long r8) {
        /*
            ...
            java.lang.String[] r2 = com.instagram.common.viewpoint.core.AbstractC06415p.A01
            r0 = 7
            r1 = r2[r0]
            r0 = 5
            r2 = r2[r0]
        ...
        L74:
            ...
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.AbstractC06415p.A03(long, long):java.lang.String");
    }
}
