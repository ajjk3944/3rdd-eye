...
public abstract class LI {
    ...
    public static long A01(C06214v c06214v, int i10, int i11) {
        c06214v.A0f(i10);
        if (c06214v.A07() < 5) {
            return C.TIME_UNSET;
        }
        ...
        int tsPacketHeader5 = c06214v.A0I();
        if (tsPacketHeader5 >= 7) {
            int tsPacketHeader6 = c06214v.A07();
            if (tsPacketHeader6 >= 7) {
                int tsPacketHeader7 = c06214v.A0I();
                if ((tsPacketHeader7 & 16) == 16) {
                    byte[] bArr = new byte[6];
                    int tsPacketHeader8 = bArr.length;
                    c06214v.A0k(bArr, 0, tsPacketHeader8);
                    long jA02 = A02(bArr);
                    String[] strArr = A00;
                    String str = strArr[4];
