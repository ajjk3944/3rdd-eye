...
public final class C06696r extends C0851Ek {
    ...
    public static void A03() {
        A0F = new byte[]{32, 2, 13, 68, 23, 67, 16, 23, 2, 17, 23, 67, 34, 22, 7, 10, 6, 13, 0, 6, 45, 6, 23, 20, 12, 17, 8, 34, 0, 23, 10, 21, 10, 23, 26, 77, 67, 46, 2, 8, 6, 67, 16, 22, 17, 6, 67, 23, Flags.CD, 2, 23, 67, 10, 23, 68, 16, 67, 10, 13, 67, 26, 12, 22, 17, 67, 34, 13, 7, 17, 12, 10, 7, 46, 2, 13, 10, 5, 6, 16, 23, 77, 27, 14, 15, 67, 5, 10, 15, 6, 77, 29, 42, 42, 55, 42, 98, 120, 35, 39, 36, 16, 1, 12, 0, Flags.CD, 6, 0, 43, 0, 17, 18, 10, 23, 14, 21, 45, 43, 44, 120, 43, 61, 44, 27, 52, 49, 61, 54, 44, 12, 55, 51, 61, 54, 120, 62, 49, 42, 43, 44, 3, 59, 61, 58, 110, 61, 43, 58, 24, 39, 42, 43, 33, 27, 28, 7, 110, 33, 60, 110, 61, 43, 58, 24, 39, 42, 43, 33, 3, 30, 10, 110, 40, 39, 60, 61, 58, 30, 17, 32, 30, 28, Flags.CD, 22, 9, 22, Flags.CD, 6, 51, 60, 57, 53, 62, 36, 4, 63, 59, 53, 62, 62, 47, 60, 61, 39, 32, 41, 23, 21, 2, 3, 2, 1, 14, 9, 2, 3, 40, 21, 14, 2, 9, 19, 6, 19, 14, 8, 9, 44, 2, 30, 86, 77, 74, 82, 86, 70, 106, 71, 42, 44, 58, 17, 62, 43, 54, 41, 58, 28, 43, 62, 29, 42, 43, 43, 48, 49, 117, 106, 103, 102, 108, 79, 108, 100, 100, 102, 113, 85, 74, 71, 70, 76, 110, 115, 103, 66, 93, 80, 81, 91, 103, 81, 81, 95, 96, 93, 89, 81, 99, 124, 113, 112, 122, 64, 71, 89, 17, 14, 3, 2, 8, 56, 19, 14, 10, 2, 56, 23, 8, Flags.CD, Flags.CD, 14, 9, 0, 56, 14, 9, 19, 2, 21, 17, 6, Flags.CD, 19, 12, 0, 18, 49, 28, 21, 0};
    }

    static {
        A03();
        A0H = C06696r.class.getSimpleName();
    }

    public C06696r(C1814gi c1814gi) {
        super(c1814gi);
        ...
        this.A09 = new NL(this, c1814gi);
        this.A0A = c1814gi;
        A02();
    }

    public C06696r(C1814gi c1814gi, AttributeSet attributeSet) {
    ...
    public C06696r(C1814gi c1814gi, AttributeSet attributeSet, int i10) {
    ...
    private void A04(Intent intent) {
        ...
        if (this.A00 == null && this.A08 == null) {
            A05(A01(WKSRecord.Service.NETBIOS_SSN, 37, 74));
            String[] strArr = A0G;
        ...
        intent.putExtra(A01(Sdk$SDKError.Reason.AD_IS_PLAYING_VALUE, 24, 99), XX.A00(this.A0A));
    ...
    private void A05(String str) {
        this.A0A.A08().ABC(A01(198, 7, 74), AbstractC1226Td.A28, new C1227Te(AdErrorType.PARSER_FAILURE.getDefaultErrorMessage(), A01(90, 7, 92) + str));
    ...
    public final void A0s() {
        AdActivityIntent adActivityIntentA05 = C1318Wu.A05(this.A0A);
        A04(adActivityIntentA05);
        try {
            A0i(false, 6);
            setVisibility(8);
            C1318Wu.A0B(this.A0A, adActivityIntentA05);
        } catch (Exception e10) {
            this.A0A.A08().ABC(A01(176, 11, 123), AbstractC1226Td.A0D, new C1227Te(e10));
            Log.e(A01(97, 17, 97), A01(0, 90, 103), e10);
        }
    }

    public InterfaceC1369Yv getListener() {
        return this.A03;
    }
    ...
    @Override // com.instagram.common.viewpoint.core.C0851Ek, android.view.ViewGroup, android.view.View
    ...
    public void setClientToken(String str) {
        ...
        this.A05 = c4l;
        if (this.A05 != null && C1264Up.A20(this.A0A)) {
            if (str != null) {
                c0861Eu2 = new C0861Eu(this.A0A, this.A02, this, str, false, this.A05, null);
            }
            this.A04 = c0861Eu2;
            return;
        }
    ...
    public void setListener(InterfaceC1369Yv interfaceC1369Yv) {
        this.A03 = interfaceC1369Yv;
    }
    ...
    @Override // com.instagram.common.viewpoint.core.C0851Ek
