...
public final class C3S extends ED {
    ...
    public C3S(C1814gi c1814gi) {
        this(c1814gi, false);
    }

    public C3S(C1814gi c1814gi, boolean z10) {
        ImageView.ScaleType scaleType;
        int color;
        super(c1814gi);
        this.A03 = new C0817Dc(this);
        this.A02 = new C0816Db(this);
        this.A01 = c1814gi;
    ...
    public void setImage(String str, InterfaceC1470b8 interfaceC1470b8) {
        if (str == null) {
            setVisibility(8);
            return;
        }
        ...
        if (interfaceC1470b8 != null) {
            downloadImageTask.A06(interfaceC1470b8);
        }
