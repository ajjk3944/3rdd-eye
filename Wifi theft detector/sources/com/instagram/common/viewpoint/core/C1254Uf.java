...
public final class C1254Uf {
    ...
    public final synchronized UW A06(int i10, byte[] bArr, int i11, int[] iArr, int i12) throws IOException {
        ...
        while (true) {
            ...
            long j11 = c1253UeA00.A03[i14];
            long j12 = (i14 == c1253UeA00.A00 - i13 ? c1253UeA00.A01 : c1253UeA00.A03[i14 + 1]) - j11;
            if (j10 == -1) {
                j10 = j11;
            }
        ...
        c1253UeA00.A02.seek(j10);
        c1253UeA00.A02.read(bArr, i11, i15);
    ...
    public final synchronized boolean A09(byte[] bArr) throws IOException {
        ...
        A03(c1253UeA00.A00, c1253UeA00.A01);
        A04(c1253UeA00.A01, bArr);
        c1253UeA00.A02.getFD().sync();
        c1253UeA00.A00++;
        c1253UeA00.A01 += bArr.length;
        return true;
    }
    ...
    public C1254Uf(File file) throws IOException {
        this.A02 = file;
        if (!file.exists()) {
            this.A00 = C1253Ue.A03(file);
        } else if (!file.isFile()) {
            throw new IOException(String.format(Locale.US, A01(25, 32, 2), file.getCanonicalPath()));
        }
    }

    private C1253Ue A00() throws IOException {
        if (!this.A01) {
            if (this.A00 == null) {
                this.A00 = C1253Ue.A04(this.A02);
            }
            return this.A00;
        }
    ...
    private void A03(int i10, long j10) throws IOException {
        ...
        this.A00.A02.seek(C1253Ue.A02(i10));
