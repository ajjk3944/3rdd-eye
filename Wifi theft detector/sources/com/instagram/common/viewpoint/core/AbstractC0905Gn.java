...
public abstract class AbstractC0905Gn {
    ...
    public static int A00(C06204u c06204u) {
        int iA04 = c06204u.A04(5);
        if (iA04 == 31) {
            int audioObjectType = c06204u.A04(6);
            return audioObjectType + 32;
        }
        return iA04;
    }

    public static int A01(C06204u c06204u) throws C3K {
        ...
        if (iA04 == 15) {
            ...
            if (iA01 >= 24) {
                int frequencyIndex = c06204u.A04(24);
    ...
    public static C0904Gm A02(C06204u c06204u, boolean z10) throws C3K {
        int iA00 = A00(c06204u);
        int iA01 = A01(c06204u);
        int iA04 = c06204u.A04(4);
        ...
        if (channelCount != -1) {
            return new C0904Gm(iA01, channelCount, str);
        }
        throw C3K.A01(null, null);
    }

    public static C0904Gm A03(byte[] bArr) throws C3K {
        return A02(new C06204u(bArr), false);
    }
    ...
    */
    public static void A06(com.instagram.common.viewpoint.core.C06204u r4, int r5, int r6) {
        /*
            boolean r0 = r4.A0H()
            if (r0 == 0) goto L1c
            r2 = 69
        ...
        L1c:
            ...
            if (r0 == 0) goto L42
            r3 = 14
            java.lang.String[] r1 = com.instagram.common.viewpoint.core.AbstractC0905Gn.A01
            r0 = 5
            r1 = r1[r0]
            r0 = 15
            ...
            if (r1 == r0) goto L9a
            java.lang.String[] r2 = com.instagram.common.viewpoint.core.AbstractC0905Gn.A01
        ...
        L9a:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.AbstractC0905Gn.A06(com.facebook.ads.redexgen.X.4u, int, int):void");
    }
