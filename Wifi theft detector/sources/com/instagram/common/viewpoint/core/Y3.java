...
public final class Y3<T> implements InterfaceC1251Uc<T> {
    ...
    public Y3(UZ uz, InterfaceC1256Uh interfaceC1256Uh) throws IOException {
        this.A05 = new C1258Uj(uz.A04(A00(515, 4, 103)), interfaceC1256Uh);
        this.A04 = new UT(new File(uz.A05(), A00(509, 6, 60)));
        this.A00 = this.A04.A03();
        A05(interfaceC1256Uh);
        this.A01 = this.A00;
    }
    ...
    public synchronized void A03(Y8 y82) throws C1260Ul {
        if (!this.A03) {
            if (A06(y82)) {
                if (y82.A6X() == 0) {
                    return;
                ...
                if (this.A00.A04(y82.A00().A02) == 0) {
                    try {
                        Iterator<C1255Ug> it = y82.A00.iterator();
                        while (it.hasNext()) {
                        ...
                        throw new C1260Ul(A00(361, 30, 22), e10);
                    }
                }
                throw new C1260Ul(A00(0, 54, 30));
            }
            throw new C1260Ul(A00(466, 43, 59));
        }
        throw new C1260Ul(A00(427, 39, 60));
    }
    ...
    */
    private void A05(com.instagram.common.viewpoint.core.InterfaceC1256Uh r13) throws java.io.IOException {
        /*
            r12 = this;
        ...
        L7c:
            ...
            goto L5c
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.Y3.A05(com.facebook.ads.redexgen.X.Uh):void");
    }

    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.Y3 != com.facebook.ads.internal.eventstorage.record.RecordFileBasedRecordDatabase<T> */
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.Y8 != com.facebook.ads.internal.eventstorage.record.RecordFileBasedRecordDatabase<T>$RecordFileBasedFetch */
    @Override // com.instagram.common.viewpoint.core.InterfaceC1251Uc
    public final synchronized InterfaceC1250Ub A6W(byte[] bArr, int[] iArr) throws C1260Ul {
        ...
        if (!this.A03) {
            ...
            try {
                ...
                throw new C1260Ul(A00(306, 29, 84), e10);
            }
        } else {
            throw new C1260Ul(A00(391, 36, 123));
        }
        return y82;
    }
    ...
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.Y3 != com.facebook.ads.internal.eventstorage.record.RecordFileBasedRecordDatabase<T> */
    @Override // com.instagram.common.viewpoint.core.InterfaceC1251Uc
    public final synchronized int A8s() throws C1260Ul {
        int iA09;
        if (!this.A03) {
            try {
                iA09 = this.A05.A09();
                ...
                throw new C1260Ul(A00(335, 26, 57), e10);
            }
        } else {
            throw new C1260Ul(A00(427, 39, 60));
        }
    ...
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.Y3 != com.facebook.ads.internal.eventstorage.record.RecordFileBasedRecordDatabase<T> */
    @Override // com.instagram.common.viewpoint.core.InterfaceC1251Uc
    public final synchronized void AKH(byte[] bArr) throws C1260Ul {
        if (!this.A03) {
            try {
                this.A05.A0C(bArr);
            } catch (IOException e10) {
                throw new C1260Ul(A00(257, 25, 62), e10);
            }
        } else {
            throw new C1260Ul(A00(427, 39, 60));
        }
    ...
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.Y3 != com.facebook.ads.internal.eventstorage.record.RecordFileBasedRecordDatabase<T> */
    @Override // com.instagram.common.viewpoint.core.InterfaceC1251Uc
    public final synchronized void clear() throws C1260Ul {
        try {
            this.A05.A0B();
            A02(this.A05.A06(), 0);
            this.A02.clear();
        } catch (IOException e10) {
            throw new C1260Ul(A00(282, 24, 87), e10);
        }
    }
