...
public final class C0977Ji extends AbstractC1527c3 {
    ...
    public final AbstractC1066Mt A0W;
    public final AbstractC1979jd A0X;
    public final VI A0Y;
    public final LK A0Z;
    public final InterfaceC1492bU A0a;
    public final C1531c7 A0b;
    ...
    public C0977Ji(C1531c7 c1531c7) {
        super(c1531c7, true);
        this.A0K = false;
        this.A0M = false;
        this.A0N = false;
        ...
        this.A0C = true;
        this.A0c = new RunnableC1568ci(this);
        this.A0a = new C0988Jt(this);
        this.A0R = new Handler(Looper.getMainLooper());
        this.A0V = (InputMethodManager) c1531c7.A06().getSystemService(A0L(12, 12, 46));
        this.A0b = c1531c7;
        this.A0X = this.A0b.A05();
        this.A0Y = new VI(c1531c7.A05().A2E(), c1531c7.A07());
        this.A0Q = A00(c1531c7);
        this.A0U = this.A0b.A03();
        this.A0W = C1067Mu.A01(c1531c7.A06(), c1531c7.A07(), c1531c7.A05().A2E(), XB.A00(c1531c7.A05().A29().A0J().A05()), new HashMap(), false, true, this.A0X.A2A());
        AbstractC1515br.A00(c1531c7.A06(), this, c1531c7.A05().A29().A0H().A08());
        this.A0D = false;
        ...
        if (this.A0T != null && A0w()) {
            this.A0A = A0I((C0851Ek) this.A0T);
        }
        this.A0d = c1531c7.A05().A1m();
        getAdContextWrapper().A0F().ACI(this.A0d, true, c1531c7.A05().A2L());
        if (!(this.A0T instanceof C0851Ek)) {
            A0P();
        }
        A0O();
    }

    private float A00(C1531c7 c1531c7) {
        if (this.A0b.A02() instanceof C0851Ek) {
            double dA0k = c1531c7.A05().A0k();
            String[] strArr = A0f;
        ...
        float mAspectRatio2 = new C1220Sx(c1531c7.A06()).A0M(this.A0X.A29().A0H().A08());
        return mAspectRatio2;
    }

    public static /* synthetic */ int A02(C0977Ji c0977Ji) {
        int i10 = c0977Ji.A00;
        c0977Ji.A00 = i10 + 1;
        return i10;
    }

    public static /* synthetic */ int A04(C0977Ji c0977Ji) {
        int i10 = c0977Ji.A01;
        c0977Ji.A01 = i10 + 1;
        return i10;
    }

    private LK A0F(C1531c7 c1531c7) {
        LK lkA03 = new C1516bs(this.A0Q, c1531c7.A05().A0w(), c1531c7.A06(), getColors(), c1531c7.A05(), c1531c7.A0C(), getCtaButton(), AbstractC0995Ka.A0G, true, c1531c7.A07(), c1531c7.A0F(), c1531c7.A0A(), c1531c7.A0E(), c1531c7.A08(), true).A03();
    ...
    private C1506bi A0I(C0851Ek c0851Ek) {
        return new C1506bi(this.A0b, this.A0X, c0851Ek, this.A0b.A0C(), new K4(this), this.A0U, this.A0Z, this.A03);
    }
    ...
    private void A0N() {
        if (this.A0X.A1e() && this.A0E) {
            this.A0E = false;
            Map<String, String> mapA05 = new C1471b9().A03(null).A02(null).A05();
    ...
    private void A0P() {
        this.A0b.A06().A0F().AKh(XL.A00(this.A0Q), getResources().getConfiguration().orientation, false, this.A0b.A0G() != null, AbstractC1066Mt.A0A());
    ...
    private void A0Q() {
        AbstractC1349Yb abstractC1349YbA0B;
        if (this.A0b.A05().A1x() && (abstractC1349YbA0B = this.A0b.A0B()) != null) {
            abstractC1349YbA0B.setProgressSpinnerInvisible(false);
        }
    }
    ...
    private void A0S() {
        if (this.A0b.A05().A1X() && this.A0W != null && XL.A03(this.A0Q)) {
            this.A09 = new C1491bT(this.A0b.A06(), this.A0b.A0C(), this.A0b.A05().A0l(), this.A0W, this.A0Z.getCTAButton(), this.A0Z);
            addView(this.A09.getBrowserPeekView());
            this.A0S.postDelayed(new RunnableC1567ch(this), 5900L);
        }
    }

    private void A0T() {
        if (this.A0T != null && this.A0X.A1e()) {
            this.A0T.setOnClickListener(new ViewOnClickListenerC1570ck(this));
        }
        YB.A0J(this.A0T);
        ...
        if (C1264Up.A17(this.A0b.A06())) {
            View.OnClickListener onClickListener = new ViewOnClickListenerC1571cl(this);
            this.A0Z.setCTAClickListener(onClickListener);
            if (this.A0b.A0B() != null) {
                View.OnClickListener onClickListener2 = new ViewOnClickListenerC1572cm(this);
                this.A0b.A0B().setCTAClickListener(onClickListener2);
            }
        }
        if (this.A0T != null) {
            if (C1264Up.A1L(getAdContextWrapper())) {
                AbstractC1474bC.A00(this.A0T, C1264Up.A1M(getAdContextWrapper()), new ViewOnClickListenerC1573cn(this));
                return;
            }
            C1814gi adContextWrapper = getAdContextWrapper();
            if (A0f[6].length() == 10) {
                throw new RuntimeException();
            }
            A0f[7] = "Oiyftodkn5sp5o8TW1yBI7W6XQQ10Nb7";
            if (!C1264Up.A1J(adContextWrapper)) {
                return;
            }
            AbstractC1474bC.A00(this.A0T, C1264Up.A1K(getAdContextWrapper()), new ViewOnClickListenerC1574co(this));
        }
    }
    ...
    private void A0U() {
        if (this.A0U != null) {
            YB.A0J(this.A0U);
            RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(AbstractC1527c3.A0A, AbstractC1527c3.A0A);
    ...
    private void A0V() {
        AbstractC1349Yb abstractC1349YbA0B = this.A0b.A0B();
        if (abstractC1349YbA0B == null) {
            return;
        }
        abstractC1349YbA0B.setPageDetailsVisible((this.A0D || abstractC1349YbA0B.A0E()) ? false : true);
        String[] strArr = A0f;
        if (strArr[2].charAt(22) == strArr[3].charAt(22)) {
            throw new RuntimeException();
        }
    ...
    private void A0X() {
        ...
        int videoDuration = this.A0T != null ? ((C0851Ek) this.A0T).getDuration() : 0;
    ...
    private void A0Z(int i10) {
        ...
        if (A0w()) {
            ...
            adjacentView = (RelativeLayout) ((C0851Ek) this.A0T).getVideoView();
            ((C0851Ek) this.A0T).A0Z(i10);
        } else {
            A0a(i10);
            viewGroup = this.A05;
    ...
    private void A0e(ViewGroup viewGroup, View view, AbstractC1349Yb abstractC1349Yb, int i10) {
        YB.A0d(this.A03);
        YB.A0J(abstractC1349Yb);
        ...
        A0Z(i10);
        viewGroup.addView(abstractC1349Yb, layoutParams);
    }

    private void A0f(ViewGroup viewGroup, View view, AbstractC1349Yb abstractC1349Yb, int i10) {
        YB.A0J(this.A03);
        YB.A0J(abstractC1349Yb);
        YB.A0J(this.A0Z);
        ...
        if (isBrowserBelowMediaView2) {
            addView(this.A03);
            addView(abstractC1349Yb, layoutParams);
        } else {
    ...
    public void A0m(String str) {
        ...
        if (AbstractC1265Uq.A02(this.A0b.A06()) || this.A0b.A06().A0E() == null) {
            m32 = new M3(this.A0b.A06(), ka);
        } else {
            m32 = new M3(this.A0b.A06(), this.A0b.A06().A0E(), ka);
        }
        this.A08 = m32;
        this.A08.setOnTouchListener(new ViewOnTouchListenerC1564ce(this));
    ...
    private void A0n(String str) {
        ...
        if (C1264Up.A2U(this.A0b.A06())) {
            HashMap map = new HashMap();
            map.put(AbstractC2018kH.A04, Boolean.TRUE.toString());
            map.put(AbstractC2018kH.A05, Boolean.TRUE.toString());
            map.put(AbstractC2018kH.A06, Boolean.TRUE.toString());
    ...
    public void A0q(boolean z10) {
        ...
        if (this.A0T != null) {
            ...
            duration.addUpdateListener(new C1565cf(this));
            AnimatorSet animatorSet = new AnimatorSet();
            animatorSet.setInterpolator(new AccelerateDecelerateInterpolator());
            animatorSet.playTogether(objectAnimatorOfFloat, objectAnimatorOfFloat2, duration);
            animatorSet.addListener(new C1566cg(this, z10));
            if (this.A0T instanceof C0851Ek) {
                ((C0851Ek) this.A0T).A0c(animatorSet, z10);
            }
        }
        A0t(this.A0D, true);
        String[] strArr2 = A0f;
    ...
    private void A0r(boolean z10) {
        ...
        strArr[1] = "MPMP";
        if (view2 != null && A0w()) {
            C0851Ek c0851Ek = (C0851Ek) this.A0T;
            Iterator<InterfaceC1702eu> it = c0851Ek.getPlugins().iterator();
            while (true) {
                if (!it.hasNext()) {
                    break;
                }
                InterfaceC1702eu next = it.next();
        ...
        this.A0B = new C1543cJ(this.A0b.A06(), this.A0X, this.A0Y, this.A0S, this.A0b.A0C());
        this.A0B.A0I(z10);
        ...
        if (!z10) {
            ...
            if (this.A0b.A0D() != null) {
                ...
                if (this.A0b.A0B() != null && this.A0b.A05().A29().A0K().A00() > 0) {
                    ...
                    new Handler(Looper.getMainLooper()).postDelayed(new RunnableC1569cj(this), this.A0b.A05().A29().A0K().A00());
                }
            }
        }
    }
    ...
    public void A0t(boolean z10, boolean z11) {
        ...
        if (z10) {
            A0f(parentView, containerView, abstractC1349YbA0B, i10);
        } else if (z11) {
            A0e(parentView, containerView, abstractC1349YbA0B, i10);
        } else {
    ...
    private boolean A0w() {
        return this.A0T != null && (this.A0T instanceof C0851Ek);
    }
    ...
    public final EnumC1063Mq A1B(String str) {
        EnumC1063Mq enumC1063Mq = EnumC1063Mq.A09;
        if (!A1R()) {
            C1543cJ c1543cJ = this.A0B;
            String[] strArr = A0f;
            if (strArr[0].length() != strArr[4].length()) {
                throw new RuntimeException();
            }
            ...
            strArr2[1] = "9M0w";
            if (c1543cJ != null && this.A0B.A0E() != null) {
    ...
    public final void A1D() {
        AbstractC1349Yb abstractC1349YbA0B = this.A0b.A0B();
        if (abstractC1349YbA0B != null) {
            abstractC1349YbA0B.setPageDetailsVisible((A1R() || abstractC1349YbA0B.A0E()) ? false : true);
        }
        this.A0N = false;
    }
    ...
    public final void A1J(E1 e12) {
        super.A1J(e12);
        this.A0b.A06().A0F().AKh(XL.A00(this.A0Q), getResources().getConfiguration().orientation, true, false, AbstractC1066Mt.A0A());
        this.A0P = true;
        A0Z(getResources().getConfiguration().orientation);
        this.A0Z.setVisibility(0);
        A0t(this.A0D, false);
    ...
    public final void A1K(C4A c4a, int i10) {
        super.A1K(c4a, i10);
        int duration = this.A0T != null ? ((C0851Ek) this.A0T).getDuration() : 0;
    ...
    public final boolean A1P(boolean z10) {
        ...
        if (A0y()) {
            ...
            if (this.A0T instanceof C0851Ek) {
                C0851Ek simpleVideoView = (C0851Ek) this.A0T;
    ...
    private View getContainerView() {
        if (this.A0T != null && A0w()) {
            return ((C0851Ek) this.A0T).getVideoView();
        }
        return this.A04;
    }
    ...
    private ViewOnClickListenerC1012Kr getRegularCtaForEndCard() {
        ViewOnClickListenerC1012Kr viewOnClickListenerC1012Kr = new ViewOnClickListenerC1012Kr(getAdContextWrapper(), this.A0b.A05().A0w(), this.A0X.A28().A01(), getAdEventManager(), this.A0b.A0C(), (C1759fp) null, this.A0b.A0A(), this.A0X.A2A());
        viewOnClickListenerC1012Kr.setViewShowsOverMedia(true);
        YB.A0K(viewOnClickListenerC1012Kr);
        viewOnClickListenerC1012Kr.setText(this.A0X.A29().A0J().A04());
        YB.A0G(1001, viewOnClickListenerC1012Kr);
        viewOnClickListenerC1012Kr.setCta(this.A0X.A29().A0J(), this.A0X.A2E(), new HashMap(), null);
        return viewOnClickListenerC1012Kr;
    }
    ...
    private void setUpBrowserControls(M3 m32) {
        ...
        this.A06.setListener(new C0979Jk(this));
        this.A03.addView(this.A06, layoutParams);
        YB.A0J(this.A07);
        this.A07 = new C1443ah(this.A0b.A06(), null, R.attr.progressBarStyleHorizontal);
