...
public abstract class VK {
    ...
    public static void A03() {
        A00 = new byte[]{33, 50, -25, -28, -9, -28, 20, 35, 28, 28, 19, 26, 7, 10, -4, -1, -6, 15, 4, 8, 0, -6, 8, 14, 9, -4, 8, 12, -4, 10, Flags.CD, -10, Flags.CD, 0, 4, -4, -10, 4, 10, 21, 24, -1, 6, 21, 14, 14, 5, 12, -1, 12, 15, 7, 7, 9, 14, 7};
    }
    ...
    public static List<String> A02(C1814gi c1814gi, JSONArray jSONArray) {
        ArrayList arrayList = new ArrayList();
        for (int eventIndex = 0; eventIndex < jSONArray.length(); eventIndex++) {
            try {
                arrayList.add(jSONArray.getString(eventIndex));
            } catch (JSONException e10) {
                c1814gi.A08().ABC(A00(39, 17, 76), AbstractC1226Td.A1C, new C1227Te(e10));
            }
        }
        return arrayList;
    }
    ...
    public static void A05(C1814gi c1814gi, String str, long j10) {
        VA adEventManager = c1814gi.A0A();
    ...
    public static void A06(C1814gi c1814gi, JSONObject jSONObject, long j10, String str) {
        ...
        if (TextUtils.isEmpty(str) && jSONArrayOptJSONArray != null) {
            A07(c1814gi, jSONObjectOptJSONObject, A02(c1814gi, jSONArrayOptJSONArray), j10, null);
            return;
        }
        ...
        A07(c1814gi, jSONObjectOptJSONObject, A03.get(str), j10, str);
    }

    public static void A07(C1814gi c1814gi, JSONObject jSONObject, List<String> list, long j10, String str) {
        String strA00 = A00(0, 2, 106);
        if (jSONObject.has(strA00)) {
            String clientToken = jSONObject.optString(strA00);
            A08(clientToken, str);
            A09(clientToken, list);
            A05(c1814gi, clientToken, j10);
        }
    }
