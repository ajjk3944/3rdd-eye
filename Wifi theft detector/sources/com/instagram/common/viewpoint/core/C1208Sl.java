...
public class C1208Sl implements InterfaceC1766fw {
    ...
    public C1208Sl(WD wd, WA wa, long j10) {
        this.A02 = wd;
        this.A01 = wa;
        this.A00 = j10;
    }

    private final void A02(C1778g8 c1778g8) {
        W9.A06(this.A01);
        try {
            InterfaceC1764fu response = c1778g8.A00();
            if (response != null) {
                ...
                if (serverResponse.A01() == WF.A03) {
                    ...
                    this.A02.A0E(C1286Vm.A01(adErrorTypeAdErrorTypeFromCode, strA73));
                    return;
                }
            }
            AdErrorType adErrorType = AdErrorType.NETWORK_ERROR;
            String message = c1778g8.getMessage();
            InterfaceC1040Lt interfaceC1040LtA0F = this.A02.A05.A0F();
            ...
            A04[4] = "NZ18w";
            interfaceC1040LtA0F.A3W(jA01, errorCode, message, zIsPublicError);
            this.A02.A0E(C1286Vm.A01(adErrorType, message));
        } catch (JSONException e10) {
            AdErrorType adErrorType2 = AdErrorType.NETWORK_ERROR;
            String errorMessage = c1778g8.getMessage();
            ...
            this.A02.A0E(C1286Vm.A01(adErrorType2, errorMessage));
        }
    }

    @Override // com.instagram.common.viewpoint.core.InterfaceC1766fw
    public final void ADR(InterfaceC1764fu interfaceC1764fu) throws JSONException {
        AbstractC1297Vy.A05(A00(79, 10, 40), A00(52, 27, 87), A00(8, 8, 114));
        if (interfaceC1764fu != null) {
            String strA73 = interfaceC1764fu.A73();
            int iA02 = C1264Up.A02(this.A02.A05);
            String[] strArr = A04;
            String str = strArr[5];
            ...
            if (iA02 > 0) {
                C1310Wl.A00(this.A02.A05).A0C(strA73);
            }
            W9.A06(this.A01);
    ...
    public final void ADq(Exception exc) {
        AbstractC1297Vy.A05(A00(89, 7, 7), A00(31, 21, 101), A00(0, 8, 30));
        if (C1778g8.class.equals(exc.getClass())) {
            A02((C1778g8) exc);
            return;
        }
        AdErrorType adErrorType = AdErrorType.NETWORK_ERROR;
        ...
        this.A02.A0E(C1286Vm.A01(adErrorType, errorMessage));
    }
}
