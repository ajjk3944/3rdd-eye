...
public final class C1104Og {
    ...
    public final InterfaceC1110Om A00;
    ...
    public static List<C1108Ok> A04(String str) throws JSONException {
        ...
        for (int i10 = 0; i10 < jSONArray.length(); i10++) {
            ...
            C1108Ok c1108Ok = new C1108Ok(jSONObject.getInt(A02(604, 12, 116)), jSONObject.getString(A02(593, 11, 55)), jSONObject.optString(A02(369, 16, 63)));
            Iterator<C1108Ok> it = A04(jSONObject.optString(A02(385, 16, 127))).iterator();
            while (it.hasNext()) {
                c1108Ok.A06(it.next());
            }
            arrayList.add(c1108Ok);
        }
        return arrayList;
    }
            ...
            if (!str.equals(A02(353, 2, 45))) {
                ...
                try {
                    ...
                    if (A04(jSONObject.getString(A02(673, 17, 10))).size() == 0) {
                        A08(AbstractC1226Td.A28, new C1227Te(A02(239, 20, 107)));
                        return null;
                    }
                    if (A04(jSONObject.getString(A02(PglCryptUtils.DECRYPT_FAILED, 15, 8))).size() == 0) {
                        A08(AbstractC1226Td.A25, new C1227Te(A02(Sdk$SDKError.Reason.AD_LOAD_FAIL_RETRY_AFTER_VALUE, 18, 45)));
                        return null;
                    }
                    return map;
                } catch (JSONException e10) {
                    A08(AbstractC1226Td.A27, new C1227Te(e10));
                    return null;
                }
            }
        }
    ...
    private final void A07() {
        C1903iC c1903iCA6I = this.A00.A6I();
        c1903iCA6I.A00(A02(521, 22, 15), 0L);
        c1903iCA6I.A02();
    }

    public static void A08(int i10, C1227Te c1227Te) {
        C1810ge sdkContext = T7.A00();
        if (sdkContext != null) {
            sdkContext.A08().ABC(A02(690, 9, 19), i10, c1227Te);
        }
    }
    ...
    public final C1108Ok A0A() {
        C1108Ok c1108Ok = new C1108Ok(A00());
        try {
            for (C1108Ok hideAdParent : A04(A03(A02(PglCryptUtils.DECRYPT_FAILED, 15, 8), A02(0, 0, 48)))) {
                c1108Ok.A06(hideAdParent);
            }
        } catch (JSONException e10) {
            A07();
            A08(AbstractC1226Td.A26, new C1227Te(e10));
        }
        return c1108Ok;
    }

    public final C1108Ok A0B() {
        C1108Ok c1108Ok = new C1108Ok(A01());
        try {
            for (C1108Ok reportAdParent : A04(A03(A02(673, 17, 10), A02(0, 0, 48)))) {
                c1108Ok.A06(reportAdParent);
            }
        } catch (JSONException e10) {
            A07();
            A08(AbstractC1226Td.A29, new C1227Te(e10));
        }
        return c1108Ok;
    }
    ...
    public final String A0D() {
        return A03(A02(TTAdConstant.MATE_IS_NULL_CODE, 20, 41), A02(Sdk$SDKError.Reason.JSON_PARAMS_ENCODE_ERROR_VALUE, 38, 95));
    }
    ...
    public final void A0N(String str) {
        ...
        C1903iC c1903iCA6I = this.A00.A6I();
        for (String str2 : A03) {
            c1903iCA6I.A01(str2, mapA05.get(str2));
        }
        if (A02[1].length() == 0) {
            throw new RuntimeException();
        }
        ...
        strArr[5] = "LB7njF";
        c1903iCA6I.A00(A02(521, 22, 15), System.currentTimeMillis());
        c1903iCA6I.A02();
    }

    public final boolean A0O(Context context, boolean z10) {
        return (z10 || C1264Up.A2h(context)) && ((A09() > 0L ? 1 : (A09() == 0L ? 0 : -1)) > 0);
    }
}
