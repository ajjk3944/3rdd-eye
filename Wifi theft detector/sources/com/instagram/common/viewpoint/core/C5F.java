...
public final class C5F extends AbstractC0953Ij {
    ...
    public final AbstractC1066Mt A0V;
    public final C1814gi A0W;
    public final VI A0X;
    public final AbstractC1349Yb A0Y;
    ...
    public C5F(C1814gi c1814gi, VA va, AbstractC1349Yb abstractC1349Yb, AbstractC1979jd abstractC1979jd, C1220Sx c1220Sx, ZU zu, int i10, InterfaceC1355Yh interfaceC1355Yh, VI vi, int i11, boolean z10, boolean z11, InterfaceC1634dm interfaceC1634dm, int i12, int i13) {
        C1072Na c1072NaA00;
        ...
        this.A02 = 0;
        this.A0R = true;
        this.A0l = new RunnableC1619dX(this);
        this.A0L = false;
        this.A0T = false;
        this.A01 = 0.0f;
        ...
        this.A0i = new AbstractC0840Dz() { // from class: com.facebook.ads.redexgen.X.5K
            /* JADX INFO: Access modifiers changed from: private */
            @Override // com.instagram.common.viewpoint.core.UN
            /* renamed from: A00, reason: merged with bridge method [inline-methods] */
        ...
        this.A0Y = abstractC1349Yb;
        this.A0U = i12;
        this.A08 = new Handler(Looper.getMainLooper());
        this.A09 = (InputMethodManager) c1814gi.getSystemService(A0L(12, 12, 28));
        this.A0V = C1067Mu.A01(c1814gi, va, abstractC1979jd.A2E(), XB.A00(abstractC1979jd.A29().A0J().A05()), new HashMap(), false, true, abstractC1979jd.A2A());
        this.A0W = c1814gi;
        this.A0X = vi;
        this.A0j = new C0820Df(this.A0W, this.A0X);
        ...
        A0O();
        A0N();
        C1814gi c1814gi2 = this.A0W;
        String videoUrl2 = abstractC1979jd.A29().A0H().A08();
        AbstractC1515br.A00(c1814gi2, this, videoUrl2);
        setupLayoutConfiguration(false);
        A0T();
        A0S();
        postDelayed(new C0936Hs(this), 1000L);
        if (C1264Up.A1z(this.A0W)) {
            VM vmA0B = this.A0W.A0B();
            C0851Ek c0851Ek = this.A0b;
            String videoUrl3 = super.A06.A2E();
            vmA0B.AKn(c0851Ek, videoUrl3, true);
        }
        if (C1264Up.A20(this.A0W)) {
            this.A0a = new C0861Eu(this.A0W, va, this.A0b, super.A06.A2E(), false, this.A0c, null);
        } else {
            this.A0a = null;
        }
        A0Y(abstractC1979jd.A29());
    ...
    private void A0O() {
        ...
        layoutParams.setMargins(0, AbstractC1349Yb.A00, A0t, 0);
    ...
    private void A0R() {
        postDelayed(new C0939Hv(this), C1264Up.A0P(this.A0W));
    }
    ...
    private void A0T() {
        View view = this.A0b;
        if (super.A06.A1e()) {
            view.setOnClickListener(new ViewOnClickListenerC1621dZ(this));
        }
        YB.A0J(view);
        YB.A0K(view);
        ...
        YB.A0K(mMediaView3);
        this.A0H = new C1563cd(this.A0W, null, super.A06, super.A08, super.A0B, super.A0D, super.A0A, getColors(), new I4(this));
        ...
        A0W();
        A0M();
        if (C1264Up.A17(this.A0W)) {
            this.A0B.setOnClickListener(new ViewOnClickListenerC1613dR(this));
            View mMediaView6 = this.A0Y;
            if (mMediaView6 != null) {
                this.A0Y.setCTAClickListener(new ViewOnClickListenerC1614dS(this));
            }
        }
    }
    ...
    private void A0Y(NR nr) {
        double dA00 = AbstractC1518bu.A00(nr);
    ...
    public void A0f(C4A c4a) {
        if (this.A0b.getState() == EnumC1756fm.A02 && C1264Up.A1e(this.A0W)) {
            postDelayed(new C0937Ht(this, c4a), 5000L);
        }
    }
    ...
    public void A0g(String str) {
        ...
        boolean zA02 = AbstractC1265Uq.A02(this.A0W);
        ...
        this.A0G = m32;
        this.A0G.setOnTouchListener(new ViewOnTouchListenerC1615dT(this));
    ...
    public void A0j(boolean z10) {
        ...
        duration.addUpdateListener(new C1617dV(this));
        ...
        animatorSet.addListener(new C1618dW(this, z10));
        if (this.A0n) {
    ...
    public final EnumC1063Mq A1D(String str) {
        if (!A0m()) {
            EnumC1063Mq enumC1063MqA02 = this.A0H.A02(str);
            String[] strArr = A0p;
            if (strArr[2].length() != strArr[3].length()) {
                throw new RuntimeException();
            }
            A0p[1] = "gDqV8VnRL5n4dziTmRcIoSoDocYisV3G";
            return enumC1063MqA02;
        }
    ...
    public final void A1H() {
        ...
        if (iA02 != 0) {
            ...
            if (iA02 < secondsForNextCta2) {
                ...
                new XO(iA02, new C0941Hx(this)).A07();
                return;
            }
        }
    ...
    public final void A1K(boolean z10) {
        if (this.A0b.getState() != EnumC1756fm.A06) {
            EnumC1701et enumC1701et = this.A0I;
            String[] strArr = A0p;
            if (strArr[4].length() != strArr[5].length()) {
                throw new RuntimeException();
            }
    ...
    private void setUpBrowserControls(M3 m32) {
        ...
        this.A0E.setListener(new C0942Hy(this));
        this.A0E.setOnTouchListener(new ViewOnTouchListenerC1616dU(this));
        this.A0A.addView(this.A0E, layoutParams);
        YB.A0J(this.A0F);
        this.A0F = new C1443ah(this.A0W, null, R.attr.progressBarStyleHorizontal);
