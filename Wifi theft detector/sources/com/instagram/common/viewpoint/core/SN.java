...
public final class SN {
    ...
    public SN(C1220Sx c1220Sx, JSONObject jSONObject, String str, String str2, boolean z10, SM sm) {
        this.A02 = c1220Sx;
        this.A05 = jSONObject;
        this.A03 = str;
        this.A04 = str2;
    ...
    public void A09(boolean z10, SL sl) {
        String strA03 = A03(6, 4, 8);
        String strA032 = A03(15, 5, 16);
        String strA033 = A03(10, 5, 53);
        if (z10) {
            if (strA033.equals(sl.A02)) {
                this.A02.A0d(new C1218Sv(sl.A03, -1, -1, this.A04, this.A03));
                return;
            } else if (strA032.equals(sl.A02)) {
                this.A02.A0a(new C1216St(sl.A03, this.A04, this.A03));
                return;
            } else {
                if (!strA03.equals(sl.A02)) {
                    return;
                }
                this.A02.A0Z(new C1216St(sl.A03, this.A04, this.A03));
                return;
            }
        }
        ...
        if (zEquals) {
            this.A02.A0c(new C1218Sv(sl.A03, -1, -1, this.A04, this.A03));
        } else if (strA032.equals(sl.A02)) {
            this.A02.A0b(new C1216St(sl.A03, this.A04, this.A03));
        } else {
            if (!strA03.equals(sl.A02)) {
                return;
            }
            this.A02.A0Y(new C1216St(sl.A03, this.A04, this.A03));
        }
    }
    ...
    public final void A0B() {
        ...
        YG.A06.execute(new C1832h0(this));
    }
}
