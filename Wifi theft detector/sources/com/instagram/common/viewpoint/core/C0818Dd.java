...
public final class C0818Dd extends ImageView implements InterfaceC1702eu {
    ...
    public final VI A03;
    public final AbstractC0832Dr A04;
    ...
    public C0818Dd(C1814gi c1814gi, VI vi) {
        super(c1814gi);
        this.A04 = new AbstractC0832Dr() { // from class: com.facebook.ads.redexgen.X.3V
        ...
        A05();
        setOnClickListener(new ViewOnClickListenerC1720fC(this));
    }
    ...
    public final void AKV(C0851Ek c0851Ek) {
        if (this.A00 != null) {
            ...
            AbstractC0832Dr abstractC0832Dr = this.A04;
            String[] strArr = A06;
