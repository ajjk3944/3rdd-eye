...
public class EF {
    ...
    public boolean A0A;
    public boolean A0B;
    public final C1905iE A0C;
    public final C1814gi A0D;
    public final VA A0E;
    public final InterfaceC1690ei A0F;
    public final InterfaceC1699er A0G;
    public final C1700es A0H;
     ...
     */
    public EF(C1814gi c1814gi, VA va, InterfaceC1690ei interfaceC1690ei, String str, boolean z10, int i10, int i11, boolean z11, Bundle bundle, Map<String, String> map, InterfaceC1699er interfaceC1699er) {
        this.A02 = 0;
        this.A01 = 0;
        this.A05 = false;
        this.A0B = false;
        ...
        this.A0D = c1814gi;
        this.A0E = va;
        this.A0F = interfaceC1690ei;
        this.A0J = str;
        this.A0K = map;
        this.A08 = z10;
        this.A07 = z11;
        this.A0G = interfaceC1699er;
        ArrayList arrayList = new ArrayList();
        arrayList.add(new EH(this, 0.5d, -1.0d, 2.0d, true));
        arrayList.add(new EG(this, 1.0E-7d, -1.0d, 0.001d, false));
        if (bundle != null) {
            this.A0C = new C1905iE(arrayList, bundle.getBundle(A0H(6, 16, 57)), this.A0G);
            ...
            this.A02 = i10;
            this.A01 = i11;
            this.A0C = new C1905iE(arrayList, this.A0G);
        }
        this.A05 = C1264Up.A2W(this.A0D);
        this.A0B = C1264Up.A2a(this.A0D);
        this.A0H = new C1700es(new Handler(), this);
    }
    ...
    public Map<String, String> A0J(EnumC1692ek enumC1692ek) {
        int currentPositionInMillis = this.A0F.getCurrentPositionInMillis();
        int i10 = this.A00 + 1;
        this.A00 = i10;
        return A0K(enumC1692ek, currentPositionInMillis, i10);
    }

    private Map<String, String> A0K(EnumC1692ek enumC1692ek, int i10, int i11) {
        HashMap map = new HashMap();
        Y7.A03(map, this.A0F.getVideoStartReason() == EnumC1701et.A02, !this.A0F.AAV());
        A0U(map);
        A0S(map);
        A0W(map, i10);
        A0V(map);
        A0T(map);
        A0n(enumC1692ek, map);
        map.put(A0H(0, 6, 24), String.valueOf(enumC1692ek.A00));
    ...
    private void A0M() {
        ...
        A0R(this.A0J, A0J(EnumC1692ek.A04));
    }
    ...
    private final void A0P(int i10, boolean z10, boolean z11) {
        ...
        if (i10 > this.A02) {
            ...
            if (dA9V < 0.5d && C1264Up.A1i(this.A0D)) {
                this.A0D.A0F().AKk(String.valueOf(dA9V));
            }
            this.A02 = i10;
            if (z11 || i10 - this.A01 >= 5000) {
                String str = this.A0J;
                EnumC1692ek enumC1692ek = EnumC1692ek.A09;
                int i11 = this.A00 + 1;
                this.A00 = i11;
                A0R(str, A0K(enumC1692ek, i10, i11));
                this.A01 = this.A02;
                this.A0C.A05();
                return;
            }
        ...
        if (z10) {
            ...
            EnumC1692ek enumC1692ek2 = EnumC1692ek.A09;
            int i12 = this.A00 + 1;
            this.A00 = i12;
            A0R(str2, A0K(enumC1692ek2, i10, i12));
        }
    }
    ...
    private void A0S(Map<String, String> params) {
        C1103Of c1103OfA03 = this.A0C.A03();
        C1102Oe c1102OeA00 = c1103OfA03.A00();
        params.put(A0H(Sdk$SDKError.Reason.PRIVACY_ICON_FALLBACK_ERROR_VALUE, 3, 25), String.valueOf(c1102OeA00.A00()));
        params.put(A0H(229, 3, 8), String.valueOf(c1102OeA00.A06()));
        params.put(A0H(232, 5, 59), String.valueOf(c1102OeA00.A03()));
        params.put(A0H(Sdk$SDKError.Reason.PLACEMENT_SLEEP_VALUE, 8, 108), String.valueOf(c1102OeA00.A02() * 1000.0d));
        params.put(A0H(47, 12, 65), String.valueOf(c1102OeA00.A01() * 1000.0d));
        params.put(A0H(122, 7, 81), String.valueOf(c1102OeA00.A04() * 1000.0d));
        if (this.A04 != null) {
            params.put(A0H(Sdk$SDKError.Reason.AD_RESPONSE_RETRY_AFTER_VALUE, 6, 19), this.A04);
        }
        C1102Oe c1102OeA01 = c1103OfA03.A01();
        params.put(A0H(195, 3, 83), String.valueOf(c1102OeA01.A00()));
        params.put(A0H(198, 3, 76), String.valueOf(c1102OeA01.A06()));
        params.put(A0H(201, 5, 61), String.valueOf(c1102OeA01.A03()));
        params.put(A0H(22, 8, 35), String.valueOf(c1102OeA01.A02() * 1000.0d));
        params.put(A0H(35, 12, 36), String.valueOf(c1102OeA01.A01() * 1000.0d));
        params.put(A0H(115, 7, 52), String.valueOf(c1102OeA01.A04() * 1000.0d));
    }
    ...
    private void A0V(Map<String, String> params) {
        ...
        params.put(A0H(Sdk$SDKError.Reason.AD_ALREADY_FAILED_VALUE, 3, 4), String.valueOf(displayMetrics.heightPixels));
    ...
    private void A0W(Map<String, String> map, int i10) {
        ...
        map.put(A0H(WKSRecord.Service.NETBIOS_SSN, 5, 33), String.valueOf(this.A01 / 1000.0f));
    ...
    public final void A0d() {
        ...
        A0R(this.A0J, A0J(EnumC1692ek.A07));
    }
    ...
    public final void A0e() {
        ...
        A0R(this.A0J, A0J(EnumC1692ek.A08));
    }
    ...
    public final void A0i(int i10) {
        ...
        this.A0C.A04();
        A0R(this.A0J, A0J(EnumC1692ek.A05));
        if (this.A05) {
            A0P(i10, false, true);
        } else {
    ...
    public final void A0m(InterfaceC1691ej interfaceC1691ej) {
        this.A03 = interfaceC1691ej;
    }

    public void A0n(EnumC1692ek enumC1692ek, Map<String, String> params) {
    }
