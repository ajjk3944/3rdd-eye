...
public abstract class AbstractC0909Gr {
    ...
    static {
        ...
        A02 = new int[]{32, 40, 48, 56, 64, 80, 96, 112, 128, 160, PsExtractor.AUDIO_STREAM, 224, 256, Sdk$SDKError.Reason.WEBVIEW_ERROR_VALUE, 384, 448, 512, 576, 640};
        A07 = new int[]{69, 87, 104, 121, WKSRecord.Service.NETBIOS_SSN, 174, Sdk$SDKError.Reason.INVALID_BID_PAYLOAD_VALUE, WKSRecord.Service.SUR_MEAS, 278, 348, TTAdConstant.DOWNLOAD_URL_AND_PACKAGE_NAME, 487, 557, 696, 835, 975, 1114, 1253, 1393};
    }
    ...
    public static C2374qI A07(C06214v c06214v, String str, String str2, DrmInitData drmInitData) {
        C06204u c06204u = new C06204u();
        c06204u.A0C(c06214v);
        int fscod = c06204u.A04(2);
        int constantBitrate = A05[fscod];
        c06204u.A09(8);
        int i10 = A04[c06204u.A04(3)];
        if (c06204u.A04(1) != 0) {
            i10++;
        }
        int fscod2 = c06204u.A04(5);
        int halfFrmsizecod = A02[fscod2] * 1000;
        c06204u.A06();
        c06214v.A0f(c06204u.A02());
        return new C05652p().A0y(str).A11(A0A(0, 9, 4)).A0b(i10).A0m(constantBitrate).A0u(drmInitData).A10(str2).A0a(halfFrmsizecod).A0j(halfFrmsizecod).A14();
    }

    public static C2374qI A08(C06214v c06214v, String str, String str2, DrmInitData drmInitData) {
        C06204u c06204u = new C06204u();
        c06204u.A0C(c06214v);
        int fscod = c06204u.A04(13) * 1000;
        c06204u.A09(3);
        int peakBitrate = c06204u.A04(2);
        int sampleRate = A05[peakBitrate];
        c06204u.A09(10);
        int channelCount = A04[c06204u.A04(3)];
        if (c06204u.A04(1) != 0) {
            channelCount++;
        }
        c06204u.A09(3);
        ...
        c06204u.A06();
        c06214v.A0f(c06204u.A02());
        return new C05652p().A0y(str).A11(strA0A).A0b(channelCount).A0m(sampleRate).A0u(drmInitData).A10(str2).A0j(fscod).A14();
    }
    ...
    */
    public static com.instagram.common.viewpoint.core.C0908Gq A09(com.instagram.common.viewpoint.core.C06204u r24) {
        /*
            Method dump skipped, instructions count: 888
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.AbstractC0909Gr.A09(com.facebook.ads.redexgen.X.4u):com.facebook.ads.redexgen.X.Gq");
    }
}
