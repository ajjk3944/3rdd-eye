...
public abstract class AbstractC1862hU extends R5 {
    ...
    public C7M A00;
    public Scroller A01;
    public final R7 A02 = new C1867hZ(this);
    ...
    public abstract int A0C(R2 r22, int i10, int i11);

    public abstract View A0D(R2 r22);

    @Deprecated
    public abstract C1883hq A0E(R2 r22);
    ...
    private final C1883hq A05(R2 r22) {
        return A0E(r22);
    }
    ...
    private boolean A0A(R2 r22, int i10, int i11) {
        C1883hq c1883hqA05;
        int iA0C;
        if (!(r22 instanceof RE) || (c1883hqA05 = A05(r22)) == null || (iA0C = A0C(r22, i10, i11)) == -1) {
            return false;
        }
        c1883hqA05.A0A(iA0C);
        r22.A1N(c1883hqA05);
