...
public abstract class AbstractC1661eE {
    ...
    public static BitmapDrawable A00(C1814gi c1814gi, String str) {
        try {
            ...
            if (overlayBm != null && (!A00 || A05(c1814gi, overlayBm))) {
                ...
                Resources resources = c1814gi.getResources();
                if (resources != null) {
                    DisplayMetrics displayMetrics = resources.getDisplayMetrics();
                    if (displayMetrics != null) {
                        overlayRepeat.setTargetDensity(displayMetrics.densityDpi);
                    } else {
                        A04(c1814gi, A02(0, 23, 41));
                    }
                } else {
                    A04(c1814gi, A02(23, 18, 119));
                }
                return overlayRepeat;
            }
            return null;
        } catch (Throwable th) {
            c1814gi.A08().ABC(A02(59, 3, 58), AbstractC1226Td.A1u, new C1227Te(th));
            return null;
        }
    }

    public static C1662eF A01(C1814gi c1814gi, String str) {
        BitmapDrawable bitmapDrawableA00;
        try {
            if (TextUtils.isEmpty(str) || (bitmapDrawableA00 = A00(c1814gi, str)) == null) {
                return null;
            }
            C1662eF c1662eF = new C1662eF(c1814gi);
            c1662eF.setBackground(bitmapDrawableA00);
            c1662eF.setClickable(false);
            c1662eF.setFocusable(false);
            return c1662eF;
        } catch (Throwable th) {
            c1814gi.A08().ABC(A02(59, 3, 58), AbstractC1226Td.A1u, new C1227Te(th));
            return null;
    ...
    public static void A04(C1814gi c1814gi, String str) {
        c1814gi.A08().ABC(A02(59, 3, 58), AbstractC1226Td.A1u, new C1227Te(str));
    }
    ...
    */
    public static boolean A05(com.instagram.common.viewpoint.core.C1814gi r4, android.graphics.Bitmap r5) {
        /*
            r3 = 0
        L1:
            int r0 = r5.getWidth()
        ...
        L36:
            r3 = 1
            java.lang.String[] r2 = com.instagram.common.viewpoint.core.AbstractC1661eE.A02
            r0 = 2
            r1 = r2[r0]
            r0 = 3
            r0 = r2[r0]
        ...
        L4f:
            ...
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.AbstractC1661eE.A05(com.facebook.ads.redexgen.X.gi, android.graphics.Bitmap):boolean");
    }
}
