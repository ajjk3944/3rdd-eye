...
public abstract class R2 {
    ...
    public int A0C;
    public int A0D;
    public final RN A0G = new C1876hj(this);
    public final RN A0H = new C1874hh(this);
    ...
    public abstract int A1f(int i10, RA ra, RH rh);

    public abstract int A1g(int i10, RA ra, RH rh);
    ...
    public abstract View A1p(View view, int i10, RA ra, RH rh);

    public abstract R3 A1q();

    public abstract void A1r(int i10);

    public abstract void A1s(int i10, int i11, RH rh, R0 r02);

    public abstract void A1t(int i10, R0 r02);

    public abstract void A1u(Parcelable parcelable);

    public abstract void A1w(RA ra, RH rh);

    public abstract void A1z(C7M c7m, RH rh, int i10);
    ...
    private final void A0H(View view, int i10, R3 r32) {
        ...
        this.A01.A0H(view, i10, r32, rkA0F.A0g());
    }
    ...
    private void A0L(RA ra, int i10, View view) {
        RK rkA0F = C7M.A0F(view);
        if (rkA0F.A0l()) {
            return;
        }
    ...
    */
    ...
    private final boolean A0S(RA ra, RH rh, int i10, Bundle bundle) {
        if (this.A03 == null) {
            return false;
        }
        int hScroll = 0;
    ...
    private final boolean A0T(RA ra, RH rh, View view, int i10, Bundle bundle) {
        return false;
    }
    ...
    public final void A16(int i10, RA ra) {
        View view = A0v(i10);
        A0C(i10);
        ra.A0T(view);
    }
    ...
    public final void A1C(View view, int i10, int i11) {
        ...
        int iA03 = A03(A0j(), A0k(), A0g() + A0h() + r32.leftMargin + r32.rightMargin + i12, r32.width, A22());
        int iA0Z = A0Z();
        int iA0a = A0a();
        int widthSpec = A0i();
        int iA032 = A03(iA0Z, iA0a, widthSpec + A0f() + r32.topMargin + r32.bottomMargin + i13, r32.height, A23());
    ...
    public final void A1D(View view, int i10, int i11, int i12, int i13) {
        R3 r32 = (R3) view.getLayoutParams();
        Rect rect = r32.A03;
        view.layout(rect.left + i10 + r32.leftMargin, rect.top + i11 + r32.topMargin, (i12 - rect.right) - r32.rightMargin, (i13 - rect.bottom) - r32.bottomMargin);
    }
    ...
    public void A1L(RA ra, RH rh, int i10, int i11) {
        this.A03.A1c(i10, i11);
    }
    ...
    public final boolean A1Y(View view, int i10, int i11, R3 r32) {
        if (!view.isLayoutRequested()) {
            ...
            if (z10 && A0Q(view.getWidth(), i10, r32.width) && A0Q(view.getHeight(), i11, r32.height)) {
                return false;
            }
        }
        return true;
