...
public final class ZD implements UR {
    ...
    public final InterfaceC1251Uc<V7> A01;
    public final InterfaceC1251Uc<V7> A02;
    ...
    */
    ...
    public ZD(C1810ge c1810ge) throws IOException {
        this.A00 = c1810ge;
        this.A01 = new Y3(UZ.A00(A00(11, 28, 27), c1810ge), new ZF(this));
        this.A02 = new Y3(UZ.A00(A00(322, 37, 96), c1810ge), new ZE(this));
    }
    ...
    public void A04(int i10, String str) {
        ...
        c1227Te.A05(1);
        this.A00.A08().ABD(A00(425, 15, 3), i10, c1227Te);
    }

    private void A05(int i10, Throwable th) {
        this.A00.A08().ABC(A00(425, 15, 3), i10, new C1227Te(th));
    }
    ...
    public final int A0A() {
        try {
            ...
            if (this.A00.A05().AAO()) {
                Log.e(A05, A00(WKSRecord.Service.LINK, 49, 19), e10);
                return 0;
            }
            return 0;
        }
    ...
    */
    public final java.util.List<org.json.JSONObject> A0C(int r8) {
        ...
        L7:
            ...
            r3.<init>()
            com.facebook.ads.redexgen.X.Uc<com.facebook.ads.redexgen.X.V7> r0 = r7.A01     // Catch: com.instagram.common.viewpoint.core.C1260Ul -> L79
            com.facebook.ads.redexgen.X.Ub r0 = r0.A6W(r4, r1)     // Catch: com.instagram.common.viewpoint.core.C1260Ul -> L79
            r3.add(r0)     // Catch: com.instagram.common.viewpoint.core.C1260Ul -> L79
            int r2 = r0.A6X()     // Catch: com.instagram.common.viewpoint.core.C1260Ul -> L79
            java.util.List r5 = r7.A01(r5, r4, r1)     // Catch: com.instagram.common.viewpoint.core.C1260Ul -> L79
        L28:
            boolean r0 = r0.ACO()     // Catch: com.instagram.common.viewpoint.core.C1260Ul -> L79
            if (r0 == 0) goto L4b
            if (r2 < r8) goto L32
            if (r6 == 0) goto L4b
        L32:
            if (r6 == 0) goto L39
            r0 = 0
            java.util.Arrays.fill(r1, r0)     // Catch: com.instagram.common.viewpoint.core.C1260Ul -> L79
            goto L3d
        L39:
            int r0 = r8 - r2
            int[] r1 = new int[r0]     // Catch: com.instagram.common.viewpoint.core.C1260Ul -> L79
        L3d:
            com.facebook.ads.redexgen.X.Uc<com.facebook.ads.redexgen.X.V7> r0 = r7.A01     // Catch: com.instagram.common.viewpoint.core.C1260Ul -> L79
            com.facebook.ads.redexgen.X.Ub r0 = r0.A6W(r4, r1)     // Catch: com.instagram.common.viewpoint.core.C1260Ul -> L79
            r3.add(r0)     // Catch: com.instagram.common.viewpoint.core.C1260Ul -> L79
            ...
            goto L28
        L4b:
            java.util.Iterator r2 = r5.iterator()     // Catch: com.instagram.common.viewpoint.core.C1260Ul -> L79
        L4f:
            boolean r0 = r2.hasNext()     // Catch: com.instagram.common.viewpoint.core.C1260Ul -> L79
            if (r0 == 0) goto L65
            java.lang.Object r0 = r2.next()     // Catch: com.instagram.common.viewpoint.core.C1260Ul -> L79
            org.json.JSONObject r0 = (org.json.JSONObject) r0     // Catch: com.instagram.common.viewpoint.core.C1260Ul -> L79
            com.facebook.ads.redexgen.X.Uc<com.facebook.ads.redexgen.X.V7> r1 = r7.A02     // Catch: com.instagram.common.viewpoint.core.C1260Ul -> L79
            byte[] r0 = A09(r0)     // Catch: com.instagram.common.viewpoint.core.C1260Ul -> L79
            r1.AKH(r0)     // Catch: com.instagram.common.viewpoint.core.C1260Ul -> L79
            goto L4f
        L65:
            java.util.Iterator r1 = r3.iterator()     // Catch: com.instagram.common.viewpoint.core.C1260Ul -> L79
        L69:
            boolean r0 = r1.hasNext()     // Catch: com.instagram.common.viewpoint.core.C1260Ul -> L79
            if (r0 == 0) goto L9a
            java.lang.Object r0 = r1.next()     // Catch: com.instagram.common.viewpoint.core.C1260Ul -> L79
            com.facebook.ads.redexgen.X.Ub r0 = (com.instagram.common.viewpoint.core.InterfaceC1250Ub) r0     // Catch: com.instagram.common.viewpoint.core.C1260Ul -> L79
            r0.A5p()     // Catch: com.instagram.common.viewpoint.core.C1260Ul -> L79
            goto L69
        L79:
            r4 = move-exception
        ...
        L95:
            int r0 = com.instagram.common.viewpoint.core.AbstractC1226Td.A2M
            r7.A05(r0, r4)
        L9a:
            return r5
        */
