...
public class PZ extends RelativeLayout implements InterfaceC1356Yi {
    ...
    public String A04;
    public boolean A05;
    public final InterfaceC1182Rk A06;
    public final LinearLayout A07;
    public final C1176Re A08;
    public final C1814gi A09;
    public final VA A0A;
    public final InterfaceC1355Yh A0B;
    public final C1443ah A0C;
    public final InterfaceC1452aq A0D;
    public final M3 A0E;
    public final InterfaceC1457av A0F;
    ...
    public PZ(C1176Re c1176Re, C1814gi c1814gi, VA va, InterfaceC1355Yh interfaceC1355Yh, boolean z10) {
        M3 m32;
        super(c1814gi);
        this.A06 = new C1126Pc(this);
        this.A05 = true;
        this.A01 = -1L;
        this.A03 = true;
        this.A08 = c1176Re;
        ...
        this.A0D = A0F();
        if (AbstractC1265Uq.A02(c1814gi) || c1814gi.A0E() == null) {
            m32 = new M3(c1814gi, this.A0D);
        } else {
            m32 = new M3(c1814gi, c1814gi.A0E(), this.A0D);
        }
        this.A0E = m32;
        this.A0F = A0C(z10);
        this.A07 = (LinearLayout) this.A0F;
        this.A07.setId(View.generateViewId());
        this.A0F.setListener(new C1125Pb(this));
        this.A0E.setBrowserNavigationListener(this.A0F.getBrowserNavigationListener());
        this.A0C = new C1443ah(c1814gi, null, R.attr.progressBarStyleHorizontal);
        A0G();
        c1176Re.A0A(this.A06);
    }

    private InterfaceC1457av A0C(boolean z10) {
        if (z10) {
    ...
    public InterfaceC1452aq A0F() {
        return new C1124Pa(this);
    }
    ...
    public void AAu(Intent intent, Bundle bundle, C1176Re c1176Re) {
        if (this.A01 < 0) {
    ...
    public final void AFA(boolean z10) {
        ...
        if (this.A03) {
            this.A03 = false;
            C1446ak c1446akA07 = new C1445aj(this.A0E.getFirstUrl()).A01(this.A00).A03(this.A01).A04(this.A0E.getResponseEndMs()).A00(this.A0E.getDomContentLoadedMs()).A05(this.A0E.getScrollReadyMs()).A02(this.A0E.getLoadFinishMs()).A06(System.currentTimeMillis()).A07();
            this.A0A.AB5(this.A04, c1446akA07.A02());
            if (BuildConfigApi.isDebug()) {
                String str = A0D(169, 30, 15) + System.currentTimeMillis() + A0D(149, 20, 60) + c1446akA07.A01 + A0D(53, 22, 121) + c1446akA07.A03 + A0D(75, 24, 83) + c1446akA07.A04 + A0D(0, 30, 124) + c1446akA07.A00 + A0D(99, 24, 75) + c1446akA07.A05 + A0D(30, 23, 22) + c1446akA07.A02 + A0D(123, 26, 113) + c1446akA07.A06;
            }
        }
    }
