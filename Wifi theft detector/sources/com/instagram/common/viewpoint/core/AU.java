...
public final class AU extends AbstractC2349pt {
    ...
    public AU(int i10) {
        AbstractC05983y.A09(i10 > 0, A02(0, 35, 26));
        this.A01 = i10;
        this.A00 = -1.0f;
    }
    ...
    public AU(int i10, float f10) {
        AbstractC05983y.A09(i10 > 0, A02(0, 35, 26));
        AbstractC05983y.A09(f10 >= 0.0f && f10 <= ((float) i10), A02(35, 40, 60));
        this.A01 = i10;
        this.A00 = f10;
    }

    public static AU A00(Bundle bundle) {
        AbstractC05983y.A07(bundle.getInt(AbstractC2349pt.A02, -1) == 2);
