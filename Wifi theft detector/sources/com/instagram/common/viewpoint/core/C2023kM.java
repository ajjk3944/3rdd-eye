...
public final class C2023kM implements MP {
    ...
    public MM A02;
    public boolean A03;
    public final InterfaceC2029kS A04;
    public final MV A05;
    public final C1055Mi A06;
    ...
    */
    private void A0G(java.io.File r18, boolean r19, java.io.File[] r20, java.util.Map<java.lang.String, com.instagram.common.viewpoint.core.MU> r21) throws java.lang.NumberFormatException {
        ...
        L12:
            if (r3 >= r5) goto Laa
            r11 = r8[r3]
            java.lang.String[] r1 = com.instagram.common.viewpoint.core.C2023kM.A0C
            r0 = 2
            r1 = r1[r0]
            r0 = 26
            ...
            r0 = 56
            if (r1 == r0) goto La4
            java.lang.String[] r2 = com.instagram.common.viewpoint.core.C2023kM.A0C
        ...
        L4c:
            if (r19 == 0) goto L7b
            boolean r10 = com.instagram.common.viewpoint.core.C1055Mi.A0A(r2)
            java.lang.String[] r1 = com.instagram.common.viewpoint.core.C2023kM.A0C
            r0 = 0
            r0 = r1[r0]
            int r1 = r0.length()
            r0 = 2
            if (r1 == r0) goto La4
            java.lang.String[] r9 = com.instagram.common.viewpoint.core.C2023kM.A0C
        ...
        L90:
            ...
            r16 = r0
            com.facebook.ads.redexgen.X.kL r0 = com.instagram.common.viewpoint.core.C2022kL.A01(r11, r12, r14, r16)
            if (r0 == 0) goto La0
            r6.A0C(r0)
            goto L49
        L9e:
        ...
        Laa:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C2023kM.A0G(java.io.File, boolean, java.io.File[], java.util.Map):void");
    }
    ...
    public final synchronized NavigableSet<MZ> A0I(String str) {
        C1053Mg c1053MgA0C;
        AbstractC05983y.A08(!this.A03);
        c1053MgA0C = this.A06.A0C(str);
        return (c1053MgA0C == null || c1053MgA0C.A09()) ? new TreeSet() : new TreeSet((Collection) c1053MgA0C.A06());
    }
    ...
    @Deprecated
    public C2023kM(File file, InterfaceC2029kS interfaceC2029kS) {
        this(file, interfaceC2029kS, (byte[]) null, false);
    }

    public C2023kM(File file, InterfaceC2029kS interfaceC2029kS, C5O c5o, byte[] bArr, boolean z10, boolean z11) {
        MV mv;
        C1055Mi c1055Mi = new C1055Mi(c5o, file, bArr, z10, z11);
        if (c5o != null && !z11) {
            mv = new MV(c5o);
        } else {
            mv = null;
        }
        this(file, interfaceC2029kS, c1055Mi, mv);
    }

    public C2023kM(File file, InterfaceC2029kS interfaceC2029kS, C1055Mi c1055Mi, MV mv) {
        if (A0H(file)) {
            this.A07 = file;
            this.A04 = interfaceC2029kS;
            this.A06 = c1055Mi;
            this.A05 = mv;
            this.A08 = new HashMap<>();
            this.A09 = new Random();
            this.A0A = interfaceC2029kS.AIj();
            this.A01 = -1L;
            ConditionVariable conditionVariable = new ConditionVariable();
            new C1062Mp(this, A04(50, 25, 28), conditionVariable).start();
    ...
    @Deprecated
    public C2023kM(File file, InterfaceC2029kS interfaceC2029kS, byte[] bArr, boolean z10) {
        this(file, interfaceC2029kS, null, bArr, z10, true);
    }
        ...
        for (File file : fileArr) {
            ...
            if (fileName.endsWith(A04(0, 4, 107))) {
                try {
                    ...
                    AbstractC06064g.A05(A04(297, 11, 30), A04(277, 20, 94) + file);
                    file.delete();
                }
            }
        }
    ...
    private C2022kL A03(String str, long j10, long j11) {
        C2022kL c2022kLA04;
        C1053Mg c1053MgA0C = this.A06.A0C(str);
        if (c1053MgA0C == null) {
            return C2022kL.A04(str, j10, j11);
        }
        while (true) {
            c2022kLA04 = c1053MgA0C.A04(j10, j11);
            if (!c2022kLA04.A05 || c2022kLA04.A03.length() == c2022kLA04.A01) {
                break;
            }
            A06();
        }
    ...
    public void A05() throws NumberFormatException {
        ...
        if (fileArrListFiles == null) {
            ...
            AbstractC06064g.A05(strA04, str);
            this.A02 = new MM(str);
            return;
        }
        ...
        if (this.A01 == -1) {
            try {
                ...
                AbstractC06064g.A08(strA04, str2, e11);
        ...
        try {
            ...
            try {
                ...
                AbstractC06064g.A08(strA04, A04(308, 25, 25), e12);
            }
        } catch (IOException e13) {
            String str3 = A04(164, 36, 29) + this.A07;
            AbstractC06064g.A08(strA04, str3, e13);
    ...
    private void A06() {
        ...
        Iterator<C1053Mg> it = this.A06.A0G().iterator();
        while (it.hasNext()) {
            Iterator<C2022kL> it2 = it.next().A06().iterator();
            while (it2.hasNext()) {
                C2022kL next = it2.next();
    ...
    private void A0A(MZ mz) {
        C1053Mg c1053MgA0C = this.A06.A0C(mz.A04);
        if (c1053MgA0C == null || !c1053MgA0C.A0D(mz)) {
            return;
        }
        this.A00 -= mz.A01;
        if (this.A05 != null) {
            ...
            try {
                ...
                AbstractC06064g.A07(A04(297, 11, 30), A04(238, 39, 93) + name);
            }
        }
        this.A06.A0K(c1053MgA0C.A02);
        A09(mz);
    }

    private void A0C(C2022kL c2022kL) {
        this.A06.A0D(c2022kL.A04).A08(c2022kL);
        this.A00 += c2022kL.A01;
        A0D(c2022kL);
    }

    private void A0D(C2022kL c2022kL) {
        ArrayList<MO> arrayList = this.A08.get(c2022kL.A04);
        if (arrayList != null) {
        ...
        this.A04.AG2(this, c2022kL);
    }

    private void A0E(C2022kL c2022kL, MZ mz) {
        ArrayList<MO> arrayList = this.A08.get(c2022kL.A04);
        if (arrayList != null) {
            for (int i10 = arrayList.size() - 1; i10 >= 0; i10--) {
                arrayList.get(i10).AG4(this, c2022kL, mz);
            }
        }
        this.A04.AG4(this, c2022kL, mz);
    }
    ...
    public static void A0F(File file) throws MM {
        ...
        AbstractC06064g.A05(message, str);
        throw new MM(str);
    }
    ...
    @Override // com.instagram.common.viewpoint.core.MP
    public final synchronized void A4E(String str, C1058Ml c1058Ml) throws MM {
        AbstractC05983y.A08(!this.A03);
        A08();
        this.A06.A0L(str, c1058Ml);
        try {
            this.A06.A0I();
    ...
    public final synchronized void A55(File file, long j10) throws MM {
        ...
        if (file.exists()) {
            ...
            C2022kL c2022kL = (C2022kL) AbstractC05983y.A01(C2022kL.A02(file, j10, this.A06));
            C1053Mg c1053Mg = (C1053Mg) AbstractC05983y.A01(this.A06.A0C(c2022kL.A04));
            AbstractC05983y.A08(c1053Mg.A0B(c2022kL.A02, c2022kL.A01));
            long jA00 = AbstractC1056Mj.A00(c1053Mg.A03());
            if (jA00 != -1) {
                AbstractC05983y.A08(c2022kL.A02 + c2022kL.A01 <= jA00);
            }
            if (this.A05 != null) {
                try {
                    this.A05.A08(file.getName(), c2022kL.A01, c2022kL.A00);
                    A0C(c2022kL);
                    try {
                        this.A06.A0I();
                        notifyAll();
    ...
    @Override // com.instagram.common.viewpoint.core.MP
    public final synchronized InterfaceC1057Mk A7S(String str) {
        AbstractC05983y.A08(!this.A03);
    ...
    public final synchronized void AHg(MZ mz) {
        AbstractC05983y.A08(!this.A03);
        C1053Mg c1053Mg = (C1053Mg) AbstractC05983y.A01(this.A06.A0C(mz.A04));
        c1053Mg.A07(mz.A02);
        this.A06.A0K(c1053Mg.A02);
        notifyAll();
    }
    ...
    public final synchronized File AK8(String str, long lastTouchTimestamp, long j10) throws MM {
        ...
        A08();
        c1053MgA0C = this.A06.A0C(str);
        AbstractC05983y.A01(c1053MgA0C);
        AbstractC05983y.A08(c1053MgA0C.A0B(lastTouchTimestamp, j10));
        if (!this.A07.exists()) {
            A0F(this.A07);
            A06();
        }
        ...
        return C2022kL.A05(file, c1053MgA0C.A01, lastTouchTimestamp, System.currentTimeMillis());
    }

    @Override // com.instagram.common.viewpoint.core.MP
    public final synchronized MZ AKA(String str, long j10, long j11, MN mn) throws InterruptedException, MM {
        MZ span;
        AbstractC05983y.A08(!this.A03);
        A08();
        while (true) {
            span = AKB(str, j10, j11, mn);
            if (span == null) {
                wait();
            }
        }
    ...
    @Override // com.instagram.common.viewpoint.core.MP
    public final synchronized C2022kL AKB(String str, long j10, long j11, MN mn) throws MM {
        AbstractC05983y.A08(!this.A03);
        A08();
        C2022kL c2022kLA03 = A03(str, j10, j11);
        if (c2022kLA03.A05) {
            C2022kL span = this.A06.A0C(str).A05(c2022kLA03, c2022kLA03.A00, false);
            A0E(c2022kLA03, span);
            return span;
        }
        if (this.A06.A0D(str).A0C(j10, c2022kLA03.A01)) {
            return c2022kLA03;
        }
        return null;
    }
