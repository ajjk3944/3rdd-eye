...
public final class Z3 extends RelativeLayout {
    ...
    public Z3(C1814gi c1814gi, int i10, int i11, String str, String str2, String str3, String str4, Bitmap bitmap) {
        super(c1814gi);
        this.A05 = new TextView(c1814gi);
        this.A02 = new Button(c1814gi);
        this.A01 = new Button(c1814gi);
