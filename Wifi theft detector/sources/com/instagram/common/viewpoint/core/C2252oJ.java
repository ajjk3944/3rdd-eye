...
public final class C2252oJ implements InterfaceC05843k {
    public long A03;
    public long A04;
    public C9Y A09;
    public boolean A0D;
    ...
    public C05823i A07 = C05823i.A05;
    public C05823i A08 = C05823i.A05;
    public C05823i A05 = C05823i.A05;
    public C05823i A06 = C05823i.A05;
    public ByteBuffer A0A = InterfaceC05843k.A00;
    public ShortBuffer A0C = this.A0A.asShortBuffer();
    public ByteBuffer A0B = InterfaceC05843k.A00;
    public int A02 = -1;

    public final long A00(long j10) {
        if (this.A04 >= 1024) {
            long jA0I = this.A03 - ((C9Y) AbstractC05983y.A01(this.A09)).A0I();
    ...
    public final C05823i A57(C05823i c05823i) throws C05833j {
        ...
        if (c05823i.A02 == 2) {
            ...
            this.A07 = c05823i;
            this.A08 = new C05823i(i10, c05823i.A01, 2);
            this.A0E = true;
            return this.A08;
        }
    ...
    public final void AHH(ByteBuffer byteBuffer) {
        ...
        C9Y c9y = (C9Y) AbstractC05983y.A01(this.A09);
