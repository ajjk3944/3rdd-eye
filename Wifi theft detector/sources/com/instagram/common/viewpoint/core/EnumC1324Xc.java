...
public enum EnumC1324Xc {
    ...
    EnumC1324Xc(int i10, NativeAdBase.NativeComponentTag nativeComponentTag) {
        this.A00 = i10;
        this.A01 = nativeComponentTag;
    }

    @Nullable
    public static EnumC1324Xc A00(NativeAdBase.NativeComponentTag nativeComponentTag) {
        for (EnumC1324Xc enumC1324Xc : values()) {
            if (enumC1324Xc.A01 == nativeComponentTag) {
                return enumC1324Xc;
            }
        }
        return null;
    ...
    public static void A03(@Nullable View view, NativeAdBase.NativeComponentTag nativeComponentTag) {
        EnumC1324Xc internalTag = A00(nativeComponentTag);
        if (view != null && internalTag != null) {
            view.setTag(A02, nativeComponentTag);
        }
    }

    public static void A04(@Nullable View view, @Nullable EnumC1324Xc enumC1324Xc) {
        if (view != null && enumC1324Xc != null) {
            view.setTag(A02, enumC1324Xc);
        }
    }
