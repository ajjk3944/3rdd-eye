...
public final class JR {
    ...
    public JR(JO jo, long[] jArr, int[] iArr, int i10, long[] jArr2, int[] iArr2, long j10) {
        AbstractC05983y.A07(iArr.length == jArr2.length);
        AbstractC05983y.A07(jArr.length == jArr2.length);
        AbstractC05983y.A07(iArr2.length == jArr2.length);
        this.A03 = jo;
        this.A06 = jArr;
        this.A05 = iArr;
        this.A00 = i10;
