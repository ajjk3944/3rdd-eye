...
public final class C1119Ov extends Drawable {
    ...
    public C1119Ov(ColorStateList colorStateList, float f10) {
        this.A01 = f10;
        A01(colorStateList);
        this.A0A = new RectF();
        this.A09 = new Rect();
    ...
    private void A02(Rect rect) {
        ...
        this.A09.set(rect);
        if (this.A06) {
            float fA01 = AbstractC1121Ox.A01(this.A00, this.A01, this.A07);
            float vInset = AbstractC1121Ox.A00(this.A00, this.A01, this.A07);
