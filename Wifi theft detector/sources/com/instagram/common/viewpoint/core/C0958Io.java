...
public final class C0958Io {
     ...
     */
    public static Pair<String, List<byte[]>> A02(C06214v c06214v) throws C3K {
        try {
            c06214v.A0g(16);
            long jA0O = c06214v.A0O();
            if (jA0O == 1482049860) {
            ...
            A0q[2] = "JoNevXQ";
            if (jA0O != 826496599) {
                AbstractC06064g.A07(A03(Sdk$SDKError.Reason.DEEPLINK_OPEN_FAILED_VALUE, 17, 46), A03(492, 51, 65));
                return new Pair<>(A03(1189, 15, 45), null);
            }
            byte[] bArrA0l = c06214v.A0l();
            for (int iA09 = c06214v.A09() + 20; iA09 < bArrA0l.length - 4; iA09++) {
    ...
    public void A06() {
        AbstractC05983y.A01(this.A0b);
    }

    public static boolean A09(C06214v c06214v) throws C3K {
        try {
            ...
            c06214v.A0f(24);
            if (c06214v.A0P() == MatroskaExtractor.A0x.getMostSignificantBits()) {
                if (c06214v.A0P() == MatroskaExtractor.A0x.getLeastSignificantBits()) {
                    return true;
                }
            }
            return false;
    ...
    public final void A0E() {
        if (this.A0c != null) {
            C0922He c0922He = this.A0c;
            InterfaceC0921Hd interfaceC0921Hd = this.A0b;
            String[] strArr = A0q;
            ...
            c0922He.A05(interfaceC0921Hd, this.A0a);
        }
    }
    ...
    */
    public final void A0G(com.instagram.common.viewpoint.core.HA r20, int r21) throws com.instagram.common.viewpoint.core.C3K {
        /*
            Method dump skipped, instructions count: 2498
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C0958Io.A0G(com.facebook.ads.redexgen.X.HA, int):void");
    }
}
