...
public final class MetaExoPlayerCustomizedCollections {
    ...
    public static final <T> List<T> A01() {
        return AbstractC0747Af.A06();
    }

    @JvmStatic
    public static final <T> List<T> A02(T... tArr) {
        C2388qY.A09(tArr, A00(0, 8, 96));
        Object[] objArrCopyOf = Arrays.copyOf(tArr, tArr.length);
        return new ArrayList(AbstractC0747Af.A07(Arrays.copyOf(objArrCopyOf, objArrCopyOf.length)));
    }

    @JvmStatic
    public static final <T> List<T> A03(T... tArr) {
        C2388qY.A09(tArr, A00(0, 8, 96));
        return new ArrayList(AbstractC0747Af.A07(Arrays.copyOf(tArr, tArr.length)));
    }
    ...
    public static final <T> Set<T> A05(T... tArr) {
        C2388qY.A09(tArr, A00(0, 8, 96));
        return new HashSet(AbstractC0747Af.A07(Arrays.copyOf(tArr, tArr.length)));
    }
}
