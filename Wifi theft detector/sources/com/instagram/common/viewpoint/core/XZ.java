...
public class XZ implements InvocationHandler {
    ...
    public static void A01() {
        A03 = new byte[]{40, 42, 33, 42, 61, 38, 44, 43, 41, 56, 31, 60, 32, 37, 56, 2, 45, 33, 41, 43, 41, 56, 24, 53, 60, 41, 73, 75, 90, 120, 79, 66, 91, 75, 29, 28, 49, 26, 23, 17, 25, 1, 7, 31, 1, 32, 23, 19, 22, Flags.CD};
    }

    public XZ(int i10, LinkedBlockingQueue linkedBlockingQueue, T8 t82) {
        this.A00 = i10;
    ...
    public final Object invoke(Object obj, Method method, Object[] objArr) throws Throwable {
        try {
            ...
            this.A01.A08().ABC(A00(0, 7, 123), AbstractC1226Td.A1G, new C1227Te(t10));
        }
        return null;
    }
}
