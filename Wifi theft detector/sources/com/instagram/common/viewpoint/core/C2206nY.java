...
public class C2206nY<E> extends AbstractCollection<E> {
    ...
    public final InterfaceC2045kj<? super E> A00;
    ...
    public C2206nY(Collection<E> unfiltered, InterfaceC2045kj<? super E> predicate) {
        this.A01 = unfiltered;
        this.A00 = predicate;
    }
    ...
    public final boolean add(@ParametricNullness E element) {
        AbstractC2044ki.A0C(this.A00.A4C(element));
    ...
    public final void clear() {
        AbstractC2297p2.A03(this.A01, this.A00);
    }

    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.nY != com.google.common.collect.Collections2$FilteredCollection<E> */
    @Override // java.util.AbstractCollection, java.util.Collection
    public final boolean contains(@CheckForNull Object element) {
        if (AbstractC2210nc.A03(this.A01, element)) {
    ...
    public final boolean containsAll(Collection<?> collection) {
        return AbstractC2210nc.A04(this, collection);
    }

    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.nY != com.google.common.collect.Collections2$FilteredCollection<E> */
    @Override // java.util.AbstractCollection, java.util.Collection
    public final boolean isEmpty() {
        return !AbstractC2297p2.A02(this.A01, this.A00);
    }

    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.nY != com.google.common.collect.Collections2$FilteredCollection<E> */
    @Override // java.util.AbstractCollection, java.util.Collection, java.lang.Iterable
    public final Iterator<E> iterator() {
        return AbstractC2304p9.A01(this.A01.iterator(), this.A00);
    }
    ...
    */
    public final boolean removeAll(final java.util.Collection<?> r5) {
        ...
        L24:
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C2206nY.removeAll(java.util.Collection):boolean");
    }
    ...
    public final Object[] toArray() {
        return AbstractC2325pU.A05(iterator()).toArray();
    }

    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.nY != com.google.common.collect.Collections2$FilteredCollection<E> */
    @Override // java.util.AbstractCollection, java.util.Collection
    public final <T> T[] toArray(T[] tArr) {
        return (T[]) AbstractC2325pU.A05(iterator()).toArray(tArr);
    }
}
