...
public final class K9 {
    ...
    public static int A00(String str) {
        ...
        return KC.A01((String) AbstractC05983y.A01(matcher.group(1)));
    }
    ...
    public static PointF A01(String str) {
        ...
        if (zFind) {
            if (zFind2) {
                AbstractC06064g.A06(A03(82, 18, 115), A03(1, 81, 62) + str + A03(0, 1, 109));
            }
        ...
        return new PointF(Float.parseFloat(((String) AbstractC05983y.A01(strGroup)).trim()), Float.parseFloat(((String) AbstractC05983y.A01(strGroup2)).trim()));
    }
    ...
    public static K9 A02(String str) {
        ...
        while (true) {
            ...
            if (zFind) {
                ...
                String str2 = (String) AbstractC05983y.A01(strGroup);
                try {
