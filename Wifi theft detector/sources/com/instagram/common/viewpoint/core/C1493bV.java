...
public final class C1493bV {
    ...
    public AbstractC1066Mt A01;
    public AbstractC1979jd A02;
    public XS A03;
    public InterfaceC1329Xh A04;
    public InterfaceC1492bU A05;
    public boolean A06;
    public final C1078Ng A07;
    ...
    public C1493bV(C1814gi c1814gi, String str, C1759fp c1759fp, Y2 y22, VA va, C1078Ng c1078Ng) {
        this(c1814gi, str, c1759fp, y22, va, c1078Ng, new C1013Ks());
    }

    public C1493bV(C1814gi c1814gi, String str, C1759fp c1759fp, Y2 y22, VA va, C1078Ng c1078Ng, InterfaceC1355Yh interfaceC1355Yh) {
        this.A0E = true;
        this.A08 = c1814gi;
        this.A0D = str;
        this.A0C = c1759fp;
    ...
    public C1493bV(C1814gi c1814gi, String str, C1759fp c1759fp, Y2 y22, VA va, C1078Ng c1078Ng, InterfaceC1355Yh interfaceC1355Yh, InterfaceC1329Xh interfaceC1329Xh) {
        this.A0E = true;
        this.A08 = c1814gi;
        this.A0D = str;
        this.A0C = c1759fp;
        ...
        this.A07 = c1078Ng;
        this.A0B = interfaceC1355Yh;
        this.A04 = interfaceC1329Xh;
    }

    private EnumC1063Mq A00(String str, String str2, Map<String, String> map) {
        ...
        try {
            ...
            if (this.A01 == null) {
                this.A01 = C1067Mu.A01(this.A08, this.A09, str, uriA00, new C1471b9(map).A03(this.A0C).A02(this.A0A).A05(), true, this.A06, this.A07);
                A02();
            }
            ...
            if (this.A01 != null) {
                ...
                if (this.A06 && (this.A01 instanceof AnonymousClass85)) {
                    actionOutcome = EnumC1063Mq.A08;
                }
            }
            if (!(((this.A01 instanceof AnonymousClass84) || (this.A01 instanceof AnonymousClass87)) && YB.A0i(this.A08, actionOutcome, map)) && actionOutcome != EnumC1063Mq.A06) {
                if (this.A05 != null) {
                    this.A05.ADY();
                }
    ...
    public static boolean A04(C1814gi c1814gi) {
        boolean zA2w = C1264Up.A2w(c1814gi);
        int iA07 = C1264Up.A07(c1814gi);
    ...
    public final EnumC1063Mq A05(String str, String str2, Map<String, String> extraData) {
        EnumC1063Mq enumC1063MqA00 = EnumC1063Mq.A09;
        new VI(str, this.A09).A04(VH.A0J, extraData);
        if (this.A0A.A09(this.A08)) {
            this.A09.AB6(str, extraData);
        } else {
            enumC1063MqA00 = A00(str, str2, extraData);
            if (this.A02 != null && this.A02.A29().A0L() != null && this.A04 != null) {
                XI.A07(this.A08.A02(), this.A02.A29().A0L(), this.A04);
            }
        }
        return enumC1063MqA00;
    }

    public final InterfaceC1064Mr A06() {
        if (this.A01 != null) {
            InterfaceC1064Mr interfaceC1064MrA0E = this.A01.A0E();
            String[] strArr = A0H;
            if (strArr[4].charAt(11) == strArr[6].charAt(11)) {
                throw new RuntimeException();
            }
            ...
            return interfaceC1064MrA0E;
        }
        return null;
    }

    public final void A07(InterfaceC1064Mr interfaceC1064Mr) {
        this.A00 = interfaceC1064Mr;
        A02();
    }

    public final void A08(AbstractC1979jd abstractC1979jd) {
    ...
    public final void A0A(InterfaceC1329Xh interfaceC1329Xh) {
        this.A04 = interfaceC1329Xh;
    }

    public final void A0B(InterfaceC1492bU interfaceC1492bU) {
        this.A05 = interfaceC1492bU;
    }
