...
public enum EnumC1063Mq {
    ...
    public static void A01() {
        A00 = new byte[]{41, 56, 56, 55, 59, 60, 39, 58, 45, 40, 42, 37, 37, 36, 63, 52, 36, 59, 46, 37, 118, 116, 123, 123, 122, 97, 106, 97, 103, 116, 118, 126, 32, 54, 43, 52, 52, 33, 32, 28, 1, 13, 28, Flags.CD, 23, 24, 21, 6, 27, Flags.CD, 22, 14, 10, 28, Flags.CD, 98, 106, 105, 81, 80, 81, 90, 115, 100, 101, 104, 115, 100, 98, 117, 126, 117, 110, 126, 96, 113, 113};
    }
    ...
    public static boolean A02(EnumC1063Mq enumC1063Mq) {
        return A04.equals(enumC1063Mq) || A05.equals(enumC1063Mq);
    }

    /* renamed from: values, reason: to resolve conflict with enum method */
    public static EnumC1063Mq[] valuesCustom() {
        EnumC1063Mq[] enumC1063MqArr = (EnumC1063Mq[]) values().clone();
        String[] strArr = A01;
