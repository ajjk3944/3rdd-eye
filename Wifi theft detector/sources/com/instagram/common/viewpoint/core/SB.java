...
public final class SB implements NativeBannerAdViewApi {
    ...
    public static View A00(C1814gi c1814gi, NativeBannerAd nativeBannerAd, NativeBannerAdView.Type type, NativeAdViewAttributes nativeAdViewAttributes) {
        if (nativeAdViewAttributes == null) {
            nativeAdViewAttributes = new NativeAdViewAttributes();
        }
        UK.A0L(nativeBannerAd.getInternalNativeAd()).A1h(EnumC1279Ve.A00(type.getEnumCode()));
        ?? r12 = new C1843hB() { // from class: com.facebook.ads.redexgen.X.7L
            public InterfaceC1686ee A00;

            /* JADX WARN: Failed to parse debug info
            java.lang.ArrayIndexOutOfBoundsException
             */
            public final void A08(C1814gi c1814gi2, NativeBannerAd nativeBannerAd2, C1278Vd c1278Vd, NativeAdLayout nativeAdLayout) {
                ...
                c1278Vd.A09(adOptionsView, 20);
                UK ukA0L = UK.A0L(nativeBannerAd2.getInternalNativeAd());
                EnumC1279Ve enumC1279VeA1C = ukA0L.A1C();
                ukA0L.A1m(true);
                this.A00 = new F7(c1814gi2, nativeBannerAd2, c1278Vd, enumC1279VeA1C, mediaView, adOptionsView, ukA0L.A1F());
        ...
        NativeAdLayout nativeAdLayout = new NativeAdLayout(c1814gi, (NativeAdLayoutApi) r12);
        r12.A08(c1814gi, nativeBannerAd, (C1278Vd) nativeAdViewAttributes.getInternalAttributes(), nativeAdLayout);
    ...
    public final View render(Context context, NativeBannerAd nativeBannerAd, NativeBannerAdView.Type type, NativeAdViewAttributes nativeAdViewAttributes) {
        try {
            return A00(C1187Rp.A03(context), nativeBannerAd, type, nativeAdViewAttributes);
        } catch (Throwable th) {
