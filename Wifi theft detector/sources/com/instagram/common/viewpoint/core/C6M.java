...
public class C6M extends AbstractC0975Jg {
    public ZI A00;
    public InterfaceC1576cq A01;
    public C1655e8 A02;
    public boolean A03;
    public boolean A04;
    public boolean A05;
    ...
    public final E2 A0B;
    public final E0 A0C;
    public final AbstractC0832Dr A0D;
    public final String A0E;
    public final Paint A0F;
    public final Path A0G;
    public final RectF A0H;
    public final C1531c7 A0I;
    ...
    public C6M(C1531c7 c1531c7, boolean z10, String str, C0890Fy c0890Fy) {
        super(c1531c7, z10);
        this.A0G = new Path();
        this.A0H = new RectF();
        this.A0D = new AbstractC0832Dr() { // from class: com.facebook.ads.redexgen.X.6S
    ...
    public void A00() {
        if (this.A0I.A0E() != null && this.A02 != null) {
            ...
            C0851Ek simpleVideoView = this.A02.getSimpleVideoView();
    ...
    */
    ...
    public void setCTAInfo(C1074Nc c1074Nc, Map<String, String> extraData) {
        getCtaButton().setCta(c1074Nc, this.A0E, extraData);
    }

    public void setImageUrl(String str) {
        if (this.A00 != null) {
            this.A00.setVisibility(0);
            new LM(this.A00, this.A08).A04().A06(new C0999Ke(this)).A07(str);
        }
        if (this.A02 != null) {
    ...
    public void setOnAssetsLoadedListener(InterfaceC1576cq interfaceC1576cq) {
        this.A01 = interfaceC1576cq;
    }

    public void setUpImageView(C1814gi c1814gi) {
        this.A00 = new ZI(c1814gi);
        if (C1264Up.A1J(c1814gi)) {
            AbstractC1474bC.A00(this.A00, C1264Up.A1K(c1814gi), new ViewOnClickListenerC1500bc(this));
        }
        A04(this.A00);
    }
    ...
    public void setUpVideoView(C1814gi c1814gi) {
        this.A02 = new C1655e8(c1814gi, new VI(this.A0E, getAdEventManager()));
        if (C1264Up.A1L(c1814gi)) {
            AbstractC1474bC.A00(this.A02, C1264Up.A1M(c1814gi), new ViewOnClickListenerC1501bd(this));
        }
        C1655e8 c1655e8 = this.A02;
        if (A0J[2].charAt(30) != 'G') {
            throw new RuntimeException();
