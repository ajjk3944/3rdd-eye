...
public final class WE {
    ...
    private RG A01(C1814gi c1814gi, JSONObject data, long j10) throws JSONException {
        JSONArray placements = data.getJSONArray(A04(190, 10, 45));
        JSONObject jSONObject = placements.getJSONObject(0);
        C1246Tx c1246TxA00 = C1246Tx.A00(jSONObject.getJSONObject(A04(124, 10, 90)));
        String strOptString = jSONObject.optString(A04(WKSRecord.Service.NETBIOS_SSN, 14, 9));
        ...
        C1245Tw c1245Tw = new C1245Tw(c1246TxA00, strOptString, adReportingConfig, cache, flashConfig, strOptString2, A06(jSONObject));
        ...
        if (jSONObject.has(strA044)) {
            ...
            while (i10 < jSONArray.length()) {
                ...
                VK.A06(c1814gi, jSONObject2, j10, str);
                ...
                JSONArray jSONArrayOptJSONArray = jSONObject2.optJSONArray(A04(Sdk$SDKError.Reason.INVALID_JSON_BID_PAYLOAD_VALUE, 8, 121));
                if (ad != null) {
                    c1245Tw.A0F(new C1243Tu(strOptString3, strOptString4, ad, jSONArrayOptJSONArray));
                } else {
                    ...
                    interfaceC1040LtA0F.A5g(errorCode, A04(72, 18, 80));
                }
                i10++;
                str = null;
            }
        ...
        if (jSONObject.has(strA045)) {
            c1245Tw.A0G(jSONObject.getJSONObject(strA045));
        }
        String anValidationUuid = data.optString(A04(29, 18, 33));
        return new RG(c1245Tw, anValidationUuid);
    }
    ...
    private R4 A03(JSONObject jSONObject) throws JSONException {
        ...
        try {
            ...
            C1246Tx c1246TxA00 = C1246Tx.A00(jSONObject2.getJSONObject(A04(124, 10, 90)));
            String strOptString = jSONObject2.optString(A04(WKSRecord.Service.NETBIOS_SSN, 14, 9));
            ...
            return new R4(jSONObject.optString(A04(183, 7, 16), A04(0, 0, 92)), jSONObject.optInt(A04(64, 4, 96), 0), new C1245Tw(c1246TxA00, strOptString, featureConfig, null, strOptString2, cache, A06(jSONObject2)));
    ...
    */
    public final com.instagram.common.viewpoint.core.WG A07(com.instagram.common.viewpoint.core.C1814gi r8, java.lang.String r9, long r10) throws org.json.JSONException {
        /*
            r7 = this;
        ...
        L54:
            ...
            return r0
        L59:
            com.facebook.ads.redexgen.X.WF r1 = com.instagram.common.viewpoint.core.WF.A04
            com.facebook.ads.redexgen.X.WG r0 = new com.facebook.ads.redexgen.X.WG
            r0.<init>(r1)
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.WE.A07(com.facebook.ads.redexgen.X.gi, java.lang.String, long):com.facebook.ads.redexgen.X.WG");
    }
}
