...
public class C06746w extends C1883hq {
    ...
    public final /* synthetic */ C06736v A00;
    ...
    public final int A0O(View view, int i10) {
        ...
        int iA0N = A0N(r2A08.A0m(view) - r32.leftMargin, r2A08.A0p(view) + r32.rightMargin, r2A08.A0g(), r2A08.A0j() - r2A08.A0h(), i10) + this.A00.A02;
        if (A01[0].length() != 6) {
    ...
    public C06746w(C06736v c06736v, C1814gi c1814gi) {
        super(c1814gi);
        this.A00 = c06736v;
    }
