...
public final class C2158ml implements H9 {
    ...
    private int A00(int i10) throws C3K {
        if (!A0B(i10)) {
            throw C3K.A01(A05(53, 12, 124) + (this.A0C ? A05(105, 2, 47) : A05(103, 2, 51)) + A05(0, 12, 22) + i10, null);
        }
    ...
    private int A02(InterfaceC2165ms interfaceC2165ms) throws IOException {
        ...
        interfaceC2165ms.AGt(this.A0E, 0, 1);
        byte b10 = this.A0E[0];
        if ((b10 & 131) <= 0) {
            return A00((b10 >> 3) & 15);
        }
    ...
    private int A03(InterfaceC2165ms interfaceC2165ms) throws IOException {
        if (this.A00 == 0) {
            try {
                this.A01 = A02(interfaceC2165ms);
                this.A00 = this.A01;
                if (this.A02 == -1) {
                    this.A05 = interfaceC2165ms.A8n();
                    this.A02 = this.A01;
                }
        ...
        int iAIp = this.A09.AIp(interfaceC2165ms, this.A00, true);
        if (iAIp == -1) {
            return -1;
        }
    ...
    private C2169mx A04(long j10, boolean z10) {
        return new C2169mx(j10, this.A05, A01(this.A02, 20000L), this.A02, z10);
    }
    ...
    private void A07() {
        if (!this.A0A) {
            ...
            this.A09.A6e(new C05652p().A11(mimeType).A0h(A0I).A0b(1).A0m(this.A0C ? 16000 : 8000).A14());
        }
    }
    ...
    private void A09(long j10, int i10) {
        ...
        if ((this.A0D & 1) == 0 || j10 == -1 || (this.A02 != -1 && this.A02 != this.A01)) {
            this.A08 = new C2160mn(C.TIME_UNSET);
    ...
    private boolean A0D(InterfaceC2165ms interfaceC2165ms) throws IOException {
        if (A0E(interfaceC2165ms, A0J)) {
            this.A0C = false;
            interfaceC2165ms.AK3(A0J.length);
            return true;
        }
        if (!A0E(interfaceC2165ms, A0K)) {
            return false;
        }
        this.A0C = true;
        interfaceC2165ms.AK3(A0K.length);
        return true;
    }

    public static boolean A0E(InterfaceC2165ms interfaceC2165ms, byte[] bArr) throws IOException {
        interfaceC2165ms.AIl();
        byte[] bArr2 = new byte[bArr.length];
        interfaceC2165ms.AGt(bArr2, 0, bArr.length);
        return Arrays.equals(bArr2, bArr);
    }

    public static /* synthetic */ H9[] A0F() {
        return new H9[]{new C2158ml()};
    }
    ...
    public final int AHL(InterfaceC2165ms interfaceC2165ms, HV hv) throws IOException {
        A06();
        if (interfaceC2165ms.A8n() != 0 || A0D(interfaceC2165ms)) {
            A07();
            int iA03 = A03(interfaceC2165ms);
            A09(interfaceC2165ms.A8O(), iA03);
            return iA03;
        }
    ...
    public final void AJ6(long j10, long j11) {
        ...
        this.A00 = 0;
        if (j10 != 0) {
            boolean z10 = this.A08 instanceof C2169mx;
            ...
            if (z10) {
                this.A06 = ((C2169mx) this.A08).A02(j10);
                return;
            }
        }
        this.A06 = 0L;
