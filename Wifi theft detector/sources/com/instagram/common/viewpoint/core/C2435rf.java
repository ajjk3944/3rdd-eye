...
public class C2435rf extends AbstractList<Integer> implements RandomAccess, Serializable {
    ...
    public C2435rf(int[] array) {
        this(array, 0, array.length);
    }

    public C2435rf(int[] array, int start, int end) {
        this.A02 = array;
        this.A01 = start;
        this.A00 = end;
    }
    ...
    public final Integer get(int index) {
        AbstractC2044ki.A00(index, size());
    ...
    public final Integer set(int index, Integer element) {
        ...
        int oldValue = ((Integer) AbstractC2044ki.A04(element)).intValue();
        iArr[i11] = oldValue;
    ...
    public final boolean contains(@CheckForNull Object target) {
        return (target instanceof Integer) && AbstractC0758As.A04(this.A02, ((Integer) target).intValue(), this.A01, this.A00) != -1;
    }
    ...
    public final boolean equals(@CheckForNull Object object) {
        ...
        boolean z10 = object instanceof C2435rf;
        if (A04[2].length() != 24) {
            throw new RuntimeException();
        }
        A04[2] = "hkNtVJfoNZugUfjtOIkeX8Ri";
        if (z10) {
            C2435rf c2435rf = (C2435rf) object;
            int size = size();
            if (c2435rf.size() != size) {
                return false;
            }
            for (int i10 = 0; i10 < size; i10++) {
                int size2 = this.A02[this.A01 + i10];
                if (size2 != c2435rf.A02[c2435rf.A01 + i10]) {
                    return false;
                }
            }
            return true;
    ...
    */
    public final int hashCode() {
        ...
        L3:
            ...
            int[] r0 = r3.A02
            r0 = r0[r2]
            int r0 = com.instagram.common.viewpoint.core.AbstractC0758As.A00(r0)
            int r1 = r1 + r0
            int r2 = r2 + 1
            goto L3
        L15:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C2435rf.hashCode():int");
    }
    ...
    public final int indexOf(@CheckForNull Object target) {
        if (target instanceof Integer) {
            ...
            int i10 = AbstractC0758As.A04(iArr, ((Integer) target).intValue(), this.A01, this.A00);
            if (i10 >= 0) {
                return i10 - this.A01;
            }
            return -1;
    ...
    public final int lastIndexOf(@CheckForNull Object target) {
        int iA05;
        if ((target instanceof Integer) && (iA05 = AbstractC0758As.A05(this.A02, ((Integer) target).intValue(), this.A01, this.A00)) >= 0) {
            int i10 = this.A01;
            return iA05 - i10;
        }
        return -1;
    ...
    public final List<Integer> subList(int fromIndex, int toIndex) {
        int size = size();
        AbstractC2044ki.A0B(fromIndex, toIndex, size);
        if (fromIndex == toIndex) {
            return Collections.emptyList();
        }
        return new C2435rf(this.A02, this.A01 + fromIndex, this.A01 + toIndex);
    }
