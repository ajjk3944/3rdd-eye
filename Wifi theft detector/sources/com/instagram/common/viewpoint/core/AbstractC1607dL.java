...
public abstract class AbstractC1607dL {
     ...
     */
    public static C1606dK A00(C1814gi c1814gi, JSONObject jSONObject, C1220Sx c1220Sx, VI vi, C1585cz c1585cz, boolean z10) throws JSONException {
        boolean z11;
        String strA0S;
        boolean z12 = z10;
        ...
        if (z12) {
            strA0S = c1220Sx.A0S(strOptString);
        ...
        try {
            ...
            if (jSONObjectOptJSONObject != null && jSONObjectOptJSONObject.optString(strA01) != null) {
                ...
                if (z11) {
                    jSONObjectOptJSONObject.put(strA01, c1220Sx.A0R(jSONObjectOptJSONObject.optString(strA01)));
                }
            }
            ...
            if (jSONArrayOptJSONArray != null) {
                for (int i10 = 0; i10 < jSONArrayOptJSONArray.length(); i10++) {
                    ...
                    if (z11) {
                        jSONArrayOptJSONArray.put(i10, c1220Sx.A0R(strOptString2));
                    }
                }
            }
            ...
            if (jSONArrayOptJSONArray2 != null) {
                for (int i11 = 0; i11 < jSONArrayOptJSONArray2.length(); i11++) {
                    A03(arrayList, arrayList2, jSONArrayOptJSONArray2.optJSONObject(i11), c1220Sx, z11);
                }
            } else {
                A03(arrayList, arrayList2, jSONObject, c1220Sx, z11);
            }
        } catch (JSONException unused) {
            c1585cz.A04(AbstractC1226Td.A15, A01(0, 43, 35));
        }
        return new C1606dK(jSONObject, strA0S, arrayList, arrayList2, arrayList3, z12);
    }
    ...
    public static void A03(ArrayList<String> imageUrls, ArrayList<String> videoUrls, JSONObject jSONObject, C1220Sx c1220Sx, boolean z10) throws JSONException {
        ...
        if (jSONObjectOptJSONObject != null) {
            ...
            if (jSONObjectOptJSONObject.optString(strA01) != null) {
                ...
                if (z10) {
                    jSONObjectOptJSONObject.put(strA01, c1220Sx.A0R(strOptString));
                }
            }
        }
        ...
        if (!TextUtils.isEmpty(jSONObject.optString(strA012))) {
            ...
            if (z10) {
                jSONObject.put(strA012, c1220Sx.A0S(strOptString2));
            }
        }
    }
}
