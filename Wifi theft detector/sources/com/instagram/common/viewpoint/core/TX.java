...
public final class TX {
    ...
    public static void A04() {
        A04 = new byte[]{117, 105, -86, -83, -83, -78, -67, -78, -72, -73, -86, -75, -110, -73, -81, -72, 105, -122, 105, -53, -65, 12, 4, 18, 18, 0, 6, 4, -65, -36, -65, -43, -55, 28, 30, Flags.CD, 29, 34, 25, 14, -20, 24, 13, 14, -55, -26, -55, -46, -91, -61, -48, -119, -42, -126, -50, -47, -55, -126, -90, -57, -60, -41, -55, -126, -89, -40, -57, -48, -42, -112, -126, -91, -47, -48, -42, -57, -38, -42, -126, -53, -43, -126, -48, -41, -50, -50, -112, -74, -30, -24, -31, -25, -40, -27, -83, -109, -46, -13, -16, 3, -11, -82, -15, 0, -17, 1, -10, -82, -16, -13, -15, -17, 3, 1, -13, -82, -3, -12, -82, -13, 4, -13, -4, 2, -82, 5, -9, 2, -10, -82, 1, 3, -16, 2, 7, -2, -13, -82, -53, -82, -56, -5, -26, -24, -24, -25, -24, -25, -93, -20, -15, -80, -16, -24, -16, -14, -11, -4, -93, -17, -14, -22, -93, -17, -20, -16, -20, -9, -92, -93, -49, -28, -10, -9, -93, -24, -7, -24, -15, -9, -67, -93, -12, 39, 18, 20, 31, 35, 24, 30, 29, -49, -13, 20, 17, 36, 22, -49, -12, 37, 20, 29, 35, -49, 38, 24, 35, 23, -49, 34, 36, 17, 35, 40, 31, 20, -49, -20, -49, -123, -72, -93, -91, -80, -76, -87, -81, -82, 96, -92, -75, -78, -87, -82, -89, 96, -84, -81, -89, -89, -87, -82, -89, 96, -92, -91, -94, -75, -89, 96, -91, -74, -91, -82, -76, 110, -55, -4, -25, -23, -12, -8, -19, -13, -14, -92, -9, -20, -13, -7, -16, -24, -92, -14, -13, -8, -92, -20, -27, -12, -12, -23, -14, -92, -20, -23, -10, -23, -78, -122, -126, -127, -75, -92, -87, -91, -82, -93, -91, -114, -91, -76, -73, -81, -78, -85, -20, 17, 9, 18, -61, -25, 8, 5, 24, 10, -61, -24, 25, 8, 17, 23, -61, 26, 12, 23, Flags.CD, -61, 22, 24, 5, 23, 28, 19, 8, -61, -32, -61, -99, -72, -72, 105, -74, -86, -73, -62, 105, -82, -65, -82, -73, -67, -68, 105, -72, -81, 105, -68, -66, -85, -67, -62, -71, -82, 105, -84, -72, -83, -82, -125, 105, -8, -6, -11, -6, -9, 10, -9, -11, 2, 5, -3, -3, -1, 4, -3, -90, -77, -72, -93, -88, -87, -72, -87, -89, -72, -83, -77, -78, -93, -69, -77, -93, -73, -83, -85, -78, -91, -80, -93, -88, -91, -72, -91, -93, -80, -77, -85, -85, -83, -78, -85, -6, -8, -6, -1, -4, -60, -59, -65, -52, -49, -57, -57, -55, -50, -57, -49, -43, -54, -36, -47, -31, -16, -23, -23, -32, -25, Flags.CD, 18, 5, 1, 24, 3, 14, Flags.CD, 6, 3, 22, Flags.CD, 17, 16, -80, -89, -74, -71, -79, -76, -83};
    }
    ...
    public static int A00(String str, int i10, T8 t82) {
        if ((A01(462, 7, 5).equals(str) && AbstractC1226Td.A20 == i10) || A01(422, 5, 90).equals(str) || A01(442, 6, 62).equals(str)) {
            return 200;
        }
        ...
        if (A01(371, 15, 89).equals(str)) {
            return AbstractC1266Ur.A05(t82);
        }
        return -1;
    }
    ...
    public static void A05(T8 t82, int i10, int i11) {
        t82.A08().ABC(A01(427, 10, 35), AbstractC1226Td.A2Z, new C1227Te(A01(338, 33, 12) + i10, A01(87, 9, 54) + i11));
    }

    @Deprecated
    public static void A06(T8 t82, String str, int i10, C1227Te c1227Te) {
        if (t82 == null) {
            A0F(new RuntimeException(A01(48, 39, 37)));
            return;
        }
        T7.A01(t82.A02());
        if (A02 && c1227Te.A01() == 0) {
            A0D(new RuntimeException(A01(96, 44, 81) + str + A01(31, 16, 108) + i10, c1227Te));
        }
        try {
            if (A0J(t82, str, i10, Math.random(), c1227Te)) {
                A09(t82, str, i10, c1227Te);
            }
        } catch (Throwable th) {
            if (A05[7].length() == 7) {
                throw new RuntimeException();
    ...
    @Deprecated
    public static void A07(T8 t82, String str, int i10, C1227Te c1227Te) {
        try {
            c1227Te.A05(2);
            c1227Te.A0A(false);
            c1227Te.A06(1);
            if (AbstractC1266Ur.A0Q(t82)) {
                c1227Te.A08(true);
            } else {
                c1227Te.A08(false);
            }
            A06(t82, str, i10, c1227Te);
        } catch (Throwable t10) {
            A0F(t10);
        }
    }
    ...
    @Deprecated
    public static void A08(T8 t82, String str, int i10, C1227Te c1227Te) {
        try {
            c1227Te.A05(2);
            c1227Te.A08(false);
            A06(t82, str, i10, c1227Te);
    ...
    public static void A09(T8 t82, String str, int i10, C1227Te c1227Te) {
        synchronized (TX.class) {
            if (!A03) {
                int iA01 = AbstractC1266Ur.A01(t82);
                int threshold = A09.getAndIncrement();
                if (threshold < iA01 - 1) {
                    A07.add(new TY(str, i10, c1227Te));
                } else if (A09.get() == iA01) {
                    A07.add(new TY(A01(427, 10, 35), AbstractC1226Td.A2W, new C1227Te(A01(WKSRecord.Service.EMFIS_DATA, 42, 70) + str + A01(47, 1, 91) + i10)));
                }
            } else {
                A0A(t82, str, i10, c1227Te, true);
            }
        }
    }

    public static void A0A(T8 t82, String str, int i10, C1227Te c1227Te, boolean z10) {
        TW tw = A0B.get();
        ...
        if (z12 || z11) {
            int iA01 = c1227Te.A01();
            String strA01 = A01(289, 17, 3);
            String strA012 = A01(31, 16, 108);
            if (iA01 == 0) {
                Log.e(strA01, A01(182, 37, 114) + str + strA012 + i10, c1227Te);
            } else {
                Log.i(strA01, A01(306, 32, 102) + str + strA012 + i10 + A01(19, 12, 98) + c1227Te.getMessage() + A01(0, 19, 12) + c1227Te.A03());
            }
        }
        C1711f3 c1711f3 = new C1711f3(t82, str, i10, c1227Te, tw);
        if (z10) {
            A01.execute(c1711f3);
        } else {
            c1711f3.run();
    ...
    public static void A0C(C1810ge c1810ge, TW tw, TV tv, boolean z10) {
        A0A.set(tv);
        A0B.set(tw);
        A08.set(z10);
        synchronized (TX.class) {
            if (!A03) {
                A03 = true;
                A01.execute(new C1712f4(c1810ge));
            }
        }
    }
    ...
    public static boolean A0H(T8 t82) {
        ...
        return (shouldSkipFunnelEventsForSession == null || !shouldSkipFunnelEventsForSession.booleanValue()) && AbstractC1266Ur.A0A(t82) != 0;
    }
    ...
    public static boolean A0I(T8 t82) {
        ...
        double funnelEventLogProbability = 1.0d / AbstractC1266Ur.A0A(t82);
    ...
    /* JADX WARN: Code restructure failed: missing block: B:98:0x0175, code lost:
        ...
        r0 = com.instagram.common.viewpoint.core.AbstractC1266Ur.A0A(r13);
     */
    ...
    */
    public static boolean A0J(com.instagram.common.viewpoint.core.T8 r13, java.lang.String r14, int r15, double r16, com.instagram.common.viewpoint.core.C1227Te r18) {
        /*
    ...
    public static boolean A0K(T8 t82, String str, int i10, C1227Te c1227Te) {
        if (!AbstractC1266Ur.A0P(t82)) {
            return true;
        }
        int customLimit = A00.get(i10);
        int eventsLimit = AbstractC1266Ur.A00(t82);
        if (c1227Te.A02() != -1) {
            eventsLimit = c1227Te.A02();
        } else {
            int currentCounter = A00(str, i10, t82);
            if (eventsLimit < currentCounter) {
                eventsLimit = currentCounter;
            }
        }
        if (customLimit >= eventsLimit) {
            if (A06.contains(Integer.valueOf(customLimit)) && c1227Te.A0D()) {
                A05(t82, i10, customLimit);
            }
