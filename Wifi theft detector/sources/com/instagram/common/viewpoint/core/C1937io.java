...
public final class C1937io implements OE {
    ...
    public final AbstractC1934ik A03;
    ...
    public C1937io(C1814gi c1814gi, AbstractC1934ik abstractC1934ik) {
        this.A04 = c1814gi;
        this.A03 = abstractC1934ik;
    }
    ...
    private void A02(OD od, OD od2) {
        ...
        InterfaceC1225Tc interfaceC1225TcA08 = this.A04.A08();
        int i10 = AbstractC1226Td.A0e;
        C1227Te c1227Te = new C1227Te(strA00, string);
        String errorTitle3 = A00(WKSRecord.Service.NETBIOS_SSN, 3, 61);
        interfaceC1225TcA08.ABC(errorTitle3, i10, c1227Te);
    ...
    private void A03(String str, String str2, boolean z10) {
        ...
        String strA00 = A00(WKSRecord.Service.NETBIOS_SSN, 3, 61);
        String strA002 = A00(91, 17, 66);
        if (!z10) {
            Log.e(strA002, str3);
            this.A04.A08().ABC(strA00, AbstractC1226Td.A0c, new C1227Te(str3));
    ...
    public final boolean A6U() {
        ...
        if (z10) {
            ...
            A03(A00(WKSRecord.Service.BL_IDM, 6, 39), A00(154, 42, 45), false);
        }
        return !z10;
    }
    ...
    public final boolean A6V() {
        ...
        boolean z10 = od == od2 && (this.A02 != OD.A07 || C1264Up.A0i(this.A04));
        if (z10) {
            this.A01 = OD.A02;
            this.A02 = OD.A07;
        } else {
