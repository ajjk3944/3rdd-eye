...
public enum EnumC2400qp {
    ...
    public static EnumC2400qp[] valuesCustom() {
        EnumC2400qp[] enumC2400qpArrValuesCustom = values();
        if (A01[4].length() == 0) {
            throw new RuntimeException();
        }
        A01[5] = "kC8OQjnUJR";
        return (EnumC2400qp[]) enumC2400qpArrValuesCustom.clone();
    }
}
