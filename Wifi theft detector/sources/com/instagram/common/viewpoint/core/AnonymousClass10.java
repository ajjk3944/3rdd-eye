...
public final class AnonymousClass10 extends AbstractC05321g {
     ...
     */
    public static Point A07(B3 b32, C2374qI c2374qI) throws BX {
        boolean z10 = c2374qI.A0A > c2374qI.A0L;
        int i10 = z10 ? c2374qI.A0A : c2374qI.A0L;
        int i11 = z10 ? c2374qI.A0L : c2374qI.A0A;
        float f10 = i11 / i10;
        for (int i12 : A13) {
            int i13 = (int) (i12 * f10);
            if (i12 <= i10 || i13 <= i11) {
            ...
            if (C5C.A02 >= 21) {
                ...
                Point pointA0N = b32.A0N(i14, i12);
                if (b32.A0R(pointA0N.x, pointA0N.y, c2374qI.A01)) {
                    return pointA0N;
                }
            } else {
                int iA05 = C5C.A05(i12, 16) * 16;
                int iA052 = C5C.A05(i13, 16) * 16;
                if (iA05 * iA052 <= C0766Ba.A00()) {
    ...
    static {
        A0P();
        A13 = new int[]{1920, 1600, 1440, SimpleResolver.DEFAULT_EDNS_PAYLOADSIZE, 960, 854, 640, 540, 480};
    }

    @MetaExoPlayerCustomization(type = {"FEATURE_LOGIC"}, value = "D69547806: Only become ready once we have a surface")
    public AnonymousClass10(Context context, C1970jQ c1970jQ, MediaCodecRendererMetaParameters mediaCodecRendererMetaParameters, BT bt, long j10, A6 a62, boolean z10, boolean z11, Handler handler, GQ gq, int i10, int i11, int i12, int i13, int i14) {
        super(2, c1970jQ, mediaCodecRendererMetaParameters, bt, a62, z10, z11, i12, i13);
        this.A0e = true;
        this.A0Z = true;
        boolean z12 = false;
        this.A0f = false;
        ...
        this.A0c = false;
        this.A0h = false;
        this.A0w = MetaExoPlayerUpgradeConfig.A03(EnumC1974jX.A1v);
        this.A0h = MetaExoPlayerUpgradeConfig.A03(EnumC1974jX.A0w);
        this.A0p = j10;
        this.A0l = i10;
        this.A0m = i11;
        ...
        this.A0r = new C0880Fo(this.A0s, this, this.A0w);
        this.A0v = A0i();
    ...
    private int A00(C2374qI c2374qI) {
        if (c2374qI.A0B != -1) {
            int i10 = 0;
            int i11 = c2374qI.A0X.size();
            for (int initializationDataCount = 0; initializationDataCount < i11; initializationDataCount++) {
                int totalInitializationDataSize = c2374qI.A0X.get(initializationDataCount).length;
                i10 += totalInitializationDataSize;
            }
            int totalInitializationDataSize2 = c2374qI.A0B;
            return totalInitializationDataSize2 + i10;
        }
        int i12 = c2374qI.A0L;
        String str = c2374qI.A0W;
        int width = c2374qI.A0A;
    ...
    */
    public static int A01(com.instagram.common.viewpoint.core.BT r8, com.instagram.common.viewpoint.core.C2374qI r9, boolean r10) throws com.instagram.common.viewpoint.core.BX {
        /*
    ...
    */
    ...
    private final MediaFormat A08(C2374qI c2374qI, C0878Fm c0878Fm, boolean z10, int i10) {
        MediaFormat mediaFormat = new MediaFormat();
        mediaFormat.setString(A0B(1462, 4, 83), c2374qI.A0W);
        mediaFormat.setInteger(A0B(1755, 5, 79), c2374qI.A0L);
        mediaFormat.setInteger(A0B(1307, 6, 73), c2374qI.A0A);
        AbstractC06084i.A06(mediaFormat, c2374qI.A0X);
        AbstractC06084i.A03(mediaFormat, A0B(1286, 10, 109), c2374qI.A01);
        AbstractC06084i.A04(mediaFormat, A0B(1548, 16, 7), c2374qI.A0F);
        AbstractC06084i.A02(mediaFormat, c2374qI.A0N);
        mediaFormat.setInteger(A0B(1447, 9, 1), c0878Fm.A02);
        mediaFormat.setInteger(A0B(1423, 10, 25), c0878Fm.A00);
        AbstractC06084i.A04(mediaFormat, A0B(1433, 14, 113), c0878Fm.A01);
        if (C5C.A02 >= 23) {
        ...
        AbstractC1941is.A03(this.A0z, mediaFormat);
        if (i10 != 0) {
            A0T(mediaFormat, i10);
        }
        return mediaFormat;
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    private final com.instagram.common.viewpoint.core.C0878Fm A0A(com.instagram.common.viewpoint.core.B3 r12, com.instagram.common.viewpoint.core.C2374qI r13, com.instagram.common.viewpoint.core.C2374qI[] r14) throws com.instagram.common.viewpoint.core.BX {
        /*
            r11 = this;
            int r5 = r13.A0L
            int r4 = r13.A0A
        ...
        L61:
            ...
            com.instagram.common.viewpoint.core.AbstractC06064g.A07(r6, r7)
            ...
            com.instagram.common.viewpoint.core.AbstractC06064g.A07(r6, r0)
        Ldd:
            com.facebook.ads.redexgen.X.Fm r0 = new com.facebook.ads.redexgen.X.Fm
            r0.<init>(r5, r4, r3)
            return r0
    ...
    public static List<B3> A0C(BT bt, C2374qI c2374qI) throws BX {
        ArrayList arrayList = new ArrayList();
        String alternativeMimeType = C0766Ba.A0P(c2374qI);
        if (alternativeMimeType != null) {
            List<B3> listA7o = bt.A7o(alternativeMimeType, false, false);
            if (C5C.A02 >= 26) {
                if (A0B(1664, 18, 7).equals(c2374qI.A0W) && !listA7o.isEmpty()) {
                    return listA7o;
                }
                return arrayList;
            }
    ...
    public static List<B3> A0D(BT bt, C2374qI c2374qI, boolean z10) throws BX {
        String str = c2374qI.A0W;
        if (str == null) {
    ...
    private void A0E() {
        ...
        if (C5C.A02 >= 23 && this.A0k && (b0A1j = A1j()) != null) {
            this.A00 = new C2177n5(this, b0A1j);
        }
    }
    ...
    private void A0G() {
        if (this.A0r.A0G() && MetaExoPlayerUpgradeConfig.A03(EnumC1974jX.A1t)) {
            this.A0r.A0A();
            throw null;
        }
    }
    ...
    private void A0K() {
        ...
        if (this.A0G != this.A08 || this.A0E != this.A06 || this.A0F != this.A07 || this.A03 != this.A01) {
            this.A0u.A07(new C2327pW(this.A08, this.A06, this.A07, this.A01));
            this.A0G = this.A08;
            this.A0E = this.A06;
            this.A0F = this.A07;
            this.A03 = this.A01;
    ...
    private void A0M() {
        if (this.A0G != -1 || this.A0E != -1) {
            this.A0u.A07(new C2327pW(this.A0G, this.A0E, this.A0F, this.A03));
        }
    }
    ...
    */
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void A0S(long j10, long j11, C2374qI c2374qI, MediaFormat mediaFormat) {
        if (this.A0X != null) {
            this.A0X.AGS(j10, j11, c2374qI, mediaFormat);
        }
    }
    ...
    */
    ...
    private void A0V(C2374qI c2374qI) {
        B0 codec = A1j();
        if (codec != null && c2374qI != null) {
            ...
            if (((Long) pairA8j.first).longValue() > 0) {
                ...
                gp.A04(super.A0h.A00, c2374qI);
            }
        }
    }

    private final void A0W(B0 b02, int i10, long j10) {
    ...
    @MetaExoPlayerCustomization("D36797879: Adding implementation for calculating avg render time")
    private final void A0X(B0 b02, int i10, long j10) {
        if (this.A0w) {
            A0Y(b02, i10, j10);
            return;
        }
    ...
    @MetaExoPlayerCustomization("D36797879: Adding implementation for calculating avg render time")
    private final void A0Y(B0 b02, int i10, long j10) {
        AnonymousClass54.A02(A0B(1529, 19, 51));
        long jElapsedRealtime = SystemClock.elapsedRealtime();
        b02.AHi(i10, true);
        long j11 = super.A0f;
    ...
    private final void A0Z(B0 b02, int i10, long j10) {
    ...
    @MetaExoPlayerCustomization("D36797879: Adding implementation for calculating avg render time")
    private final void A0a(B0 b02, int i10, long j10, long j11) {
        if (this.A0w) {
            A0c(b02, i10, j10, j11, true);
            return;
        }
        A0K();
    ...
    private final void A0b(@MetaExoPlayerCustomization B0 b02, int i10, long j10, long j11, boolean z10) {
        if (this.A0w) {
            A0c(b02, i10, j10, j11, z10);
            return;
        }
        A0K();
        A0S(j10, j11, super.A0g, this.A0S);
    ...
    */
    ...
    private boolean A0g() {
        ...
        if (this.A0K == C.TIME_UNSET) {
            AbstractC06064g.A07(A0B(682, 23, 0), A0B(901, 20, 62));
    ...
    public static boolean A0i() {
        return C5C.A02 <= 22 && A0B(SimpleResolver.DEFAULT_EDNS_PAYLOADSIZE, 6, 87).equals(C5C.A03) && A0B(725, 6, 88).equals(C5C.A05);
    }
    ...
    */
    ...
    private final boolean A0q(B0 b02, int i10, long j10, long j11) throws AD {
        int iA1Q = A1Q(j11);
        if (iA1Q == 0) {
            return false;
        }
    ...
    */
    ...
    public static boolean A0v(boolean z10, C2374qI c2374qI, C2374qI c2374qI2) {
        return c2374qI.A0W.equals(c2374qI2.A0W) && c2374qI.A0F == c2374qI2.A0F && (z10 || (c2374qI.A0L == c2374qI2.A0L && c2374qI.A0A == c2374qI2.A0A)) && C5C.A1E(c2374qI.A0N, c2374qI2.A0N);
    }

    @Override // com.instagram.common.viewpoint.core.AbstractC05321g, com.instagram.common.viewpoint.core.AE
    ...
    @Override // com.instagram.common.viewpoint.core.AbstractC05321g, com.instagram.common.viewpoint.core.AE
    public final void A1c(C2374qI[] c2374qIArr, long j10, long j11) throws AD {
        if (this.A0R == C.TIME_UNSET) {
            this.A0R = j11;
        } else {
            if (this.A0C == this.A0x.length) {
                AbstractC06064g.A07(A0B(682, 23, 0), A0B(1069, 45, 88) + this.A0x[this.A0C - 1]);
            } else {
                this.A0C++;
            }
            long[] jArr = this.A0x;
        ...
        super.A1c(c2374qIArr, j10, j11);
    }

    @Override // com.instagram.common.viewpoint.core.AbstractC05321g
    public final int A1g(B0 b02, B3 b32, C2374qI c2374qI, C2374qI c2374qI2) {
        if (AbstractC1941is.A04(this.A0z, c2374qI.A0L, c2374qI.A0A, c2374qI2.A0L, c2374qI2.A0A)) {
            return 0;
        }
        if (A21() && c2374qI.A0W.equals(c2374qI2.A0W) && c2374qI.A0F == c2374qI2.A0F) {
            return 1;
        }
        if (!A0v(b32.A04, c2374qI, c2374qI2) || c2374qI2.A0L > this.A0W.A02 || c2374qI2.A0A > this.A0W.A00 || A00(c2374qI2) > this.A0W.A01) {
            return 0;
        }
        boolean zA0A = c2374qI.A0A(c2374qI2);
        if (A12[2].charAt(6) == 'n') {
            throw new RuntimeException();
        }
    ...
    @Override // com.instagram.common.viewpoint.core.AbstractC05321g
    public final int A1h(BT bt, A6 a62, C2374qI c2374qI) throws BX {
        if (A24(c2374qI)) {
            return 20;
        }
        return A01(bt, c2374qI, super.A0j);
    }

    @Override // com.instagram.common.viewpoint.core.AbstractC05321g
    public final List<B3> A1l(BT bt, C2374qI c2374qI, boolean z10) throws BX {
        return A0D(bt, c2374qI, z10);
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final void A1r(com.instagram.common.viewpoint.core.C2374qI r6) {
        /*
            r5 = this;
        ...
        L33:
            com.facebook.ads.redexgen.X.Fo r0 = r5.A0r
            com.instagram.common.viewpoint.core.C0880Fo.A05(r0, r3)
            java.lang.String[] r1 = com.instagram.common.viewpoint.core.AnonymousClass10.A12
            r0 = 2
            r1 = r1[r0]
            r0 = 6
        ...
        L53:
            ...
            throw r0
        L59:
            com.facebook.ads.redexgen.X.jY r0 = com.instagram.common.viewpoint.core.EnumC1975jY.A09
    ...
    @Override // com.instagram.common.viewpoint.core.AbstractC05321g
    public final void A1s(C2374qI c2374qI) throws AD {
        super.A1s(c2374qI);
        this.A0u.A05(c2374qI, null);
        this.A02 = c2374qI.A02;
        this.A0D = c2374qI.A0F;
    }

    @Override // com.instagram.common.viewpoint.core.AbstractC05321g
    public final void A1t(C2374qI c2374qI) throws AD {
        if (!this.A0r.A0G()) {
            this.A0r.A0J(c2374qI, A1i());
        }
    }

    @Override // com.instagram.common.viewpoint.core.AbstractC05321g
    public final void A1u(C2295p0 c2295p0) {
        this.A04++;
        this.A0O = Math.max(c2295p0.A01, this.A0O);
    ...
    public final void A1v(B0 b02, MediaFormat mediaFormat) {
        ...
        this.A0V = new C2327pW(this.A08, this.A06, this.A07, this.A01);
        this.A0s.A0F(super.A0g.A01);
        if (this.A0r.A0G()) {
            C0880Fo c0880Fo = this.A0r;
            C05652p c05652pA07 = super.A0g.A07();
            int unappliedRotationDegrees6 = this.A08;
            C05652p c05652pA0r = c05652pA07.A0r(unappliedRotationDegrees6);
            int unappliedRotationDegrees7 = this.A06;
            C05652p c05652pA0f = c05652pA0r.A0f(unappliedRotationDegrees7);
            int unappliedRotationDegrees8 = this.A07;
            c0880Fo.A0D(c05652pA0f.A0l(unappliedRotationDegrees8).A0Y(this.A01).A14());
            throw null;
        }
    }
    ...
    public final void A1w(B3 b32, B0 b02, C2374qI c2374qI, MediaCrypto mediaCrypto) throws BX {
        this.A0W = A0A(b32, c2374qI, A1e());
        MediaFormat mediaFormatA08 = A08(c2374qI, this.A0W, this.A0v, this.A0o);
        if (this.A0U == null) {
            AbstractC05983y.A08(A0r(b32));
            if (this.A0T == null) {
        ...
        boolean z13 = z11 && b32.A00 != null && b32.A00.isFeatureSupported(strA0B);
    ...
    public final void A1z(String str, C2374qI c2374qI) throws AD {
        this.A0u.A0F(str);
        if (!this.A0r.A0G()) {
            this.A0r.A0J(c2374qI, A1i());
        }
    ...
    */
    ...
    @Override // com.instagram.common.viewpoint.core.AE, com.instagram.common.viewpoint.core.InterfaceC06807c
    public final void A9i(int i10, Object obj) throws AD {
        ...
        if (i10 == 13) {
            this.A0r.A0F((List) AbstractC05983y.A01(obj));
            return;
        }
        if (A12[3].length() != 21) {
            A12[1] = "MccsEzjpf2F4QgbfkxLUs5z2ugRdHbCL";
            if (i10 == 14) {
                C06254z c06254z = (C06254z) AbstractC05983y.A01(obj);
                if (c06254z.A03() == 0 || c06254z.A02() == 0) {
                    return;
                }
    ...
    @Override // com.instagram.common.viewpoint.core.AbstractC05321g, com.instagram.common.viewpoint.core.InterfaceC2283oo
    ...
    */
    public final boolean AAe() {
        ...
        L14:
            ...
            boolean r0 = r9.A0k
            if (r0 != 0) goto L22
            com.facebook.ads.redexgen.X.ir r0 = com.instagram.common.viewpoint.core.EnumC1940ir.A08
            r9.A0B = r0
        L22:
            boolean r0 = super.AAe()
            r8 = 1
