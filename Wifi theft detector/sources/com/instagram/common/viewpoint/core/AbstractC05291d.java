...
public abstract class AbstractC05291d<F, T> implements Iterator<T> {
    ...
    public AbstractC05291d(Iterator<? extends F> backingIterator) {
        this.A00 = (Iterator) AbstractC2044ki.A04(backingIterator);
    }
