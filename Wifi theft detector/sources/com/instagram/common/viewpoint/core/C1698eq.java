...
public final class C1698eq extends RelativeLayout {
    ...
    public int A00;
    public C3S A01;
    public WeakReference<InterfaceC1697ep> A02;
    public final InterfaceC1754fk A03;

    public C1698eq(C1814gi c1814gi, InterfaceC1754fk interfaceC1754fk) {
        super(c1814gi);
        this.A00 = 0;
        this.A03 = interfaceC1754fk;
    ...
    public final void A01(AnimatorSet animatorSet, boolean z10) {
        if (z10) {
            ...
            C1695en c1695en = new C1695en(this);
            this.A03.getView().setOutlineProvider(c1695en);
            if (this.A01 != null) {
                this.A01.setClipToOutline(true);
                this.A01.setOutlineProvider(c1695en);
            }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        WeakReference<InterfaceC1697ep> weakReference = this.A02;
    ...
    public void setRoundedCornersVideoStyle(float f10) {
        this.A03.getView().setClipToOutline(true);
        this.A03.getView().setOutlineProvider(new C1696eo(this, f10));
    }

    public void setViewImplInflationListener(InterfaceC1697ep interfaceC1697ep) {
        this.A02 = new WeakReference<>(interfaceC1697ep);
    }
}
