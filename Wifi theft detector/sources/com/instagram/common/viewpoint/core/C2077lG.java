...
public final class C2077lG implements InterfaceC1016Kv {
    ...
    public C2077lG(String str) {
        this.A02 = 0;
        this.A09 = new C06214v(4);
        this.A09.A0l()[0] = -1;
        this.A0A = new HN();
    ...
    */
    private void A00(com.instagram.common.viewpoint.core.C06214v r10) {
        /*
            r9 = this;
            byte[] r8 = r10.A0l()
            int r4 = r10.A09()
        ...
        L24:
            r9.A08 = r2
            java.lang.String[] r2 = com.instagram.common.viewpoint.core.C2077lG.A0C
            r0 = 1
            r1 = r2[r0]
            r0 = 4
            r2 = r2[r0]
        ...
        L6c:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C2077lG.A00(com.facebook.ads.redexgen.X.4v):void");
    }

    @RequiresNonNull({"output"})
    private void A01(C06214v c06214v) {
        int iMin = Math.min(c06214v.A07(), this.A01 - this.A00);
        this.A05.AIr(c06214v, iMin);
        ...
        if (this.A04 != C.TIME_UNSET) {
            InterfaceC0921Hd interfaceC0921Hd = this.A05;
            String[] strArr = A0C;
            String str = strArr[5];
            ...
            interfaceC0921Hd.AIu(this.A04, 1, this.A01, 0, null);
            this.A04 += this.A03;
        }
        this.A00 = 0;
        this.A02 = 0;
    ...
    @RequiresNonNull({"output"})
    private void A02(C06214v c06214v) {
        int iMin = Math.min(c06214v.A07(), 4 - this.A00);
        byte[] bArrA0l = this.A09.A0l();
        int bytesToRead = this.A00;
        c06214v.A0k(bArrA0l, bytesToRead, iMin);
        ...
        if (!this.A07) {
            ...
            C05652p c05652pA0h = new C05652p().A0y(this.A06).A11(this.A0A.A06).A0h(4096);
            int bytesToRead8 = this.A0A.A01;
            C05652p c05652pA0b = c05652pA0h.A0b(bytesToRead8);
            int bytesToRead9 = this.A0A.A03;
            this.A05.A6e(c05652pA0b.A0m(bytesToRead9).A10(this.A0B).A14());
            this.A07 = true;
        }
        this.A09.A0f(0);
