...
public final class C6H extends AbstractC0995Ka {
    ...
    public C1814gi A03;
    public XO A04;
    public AbstractC1349Yb A05;
    public AbstractC1527c3 A06;
    public C1543cJ A07;
    public C1669eM A08;
    public C1675eS A09;
    public DA A0A;
    ...
    public final InterfaceC1355Yh A0E;
    public final InterfaceC1505bh A0F;
    public final C1506bi A0G;
    public final C1531c7 A0H;
    public final C0851Ek A0I;
    public final DZ A0J;
    ...
    public static void A0D() {
        A0K = new byte[]{-23, -117, 1, -6, 15, -2, 24, 12, 13, -6, Flags.CD, 13, 2, 7, 0, 24, -6, 7, 2, 6, -6, 13, 2, 8, 7, 12, 24, 9, 5, -6, 18, -2, -3, 26, 29, 33, 19, 45, 32, 19, 37, 15, 32, 18, 45, 33, 17, 32, 19, 19, 28, 45, 33, 22, 29, 37, 28, -7, -29, -11, 1, -25, -16, -26, 1, -27, -29, -12, -26, 1, -11, -22, -15, -7, -16, -17, -19, -33, -20, -35, -26, -29, -35, -27};
    }
    ...
    public C6H(C1531c7 c1531c7) {
        super(c1531c7, false);
        this.A0D = new Handler(Looper.getMainLooper());
        this.A0C = false;
        this.A0B = false;
        this.A03 = c1531c7.A06();
        this.A05 = c1531c7.A0B();
        this.A0H = c1531c7;
        ...
        A0A();
        this.A0E = c1531c7.A0C();
        AbstractC1515br.A00(c1531c7.A06(), this, getAdInfo().A0H().A08());
        this.A0I = A02(c1531c7);
        YB.A0K(this.A0I);
        getAdDetailsView().bringToFront();
        if (!A04()) {
            this.A0J = A03(c1531c7);
        } else {
            this.A0J = null;
        }
        ...
        A1S();
        this.A08 = new C1669eM(this.A03, c1531c7.A07(), getAdDataBundle());
        this.A0F = new KW(this);
        this.A0G = A01(c1531c7);
        XR xrA02 = super.A08.A02(getAdDataBundle());
        this.A03.A0H().A00(xrA02.A01);
        getCtaButton().setCreativeAsCtaLoggingHelper(super.A08);
        if (xrA02.A00) {
            this.A0I.getVideoImplView().setOnClickListener(new ViewOnClickListenerC1534cA(this));
        } else if (C1264Up.A1L(getAdContextWrapper())) {
            AbstractC1474bC.A00(this.A0I.getVideoImplView(), C1264Up.A1M(getAdContextWrapper()), new ViewOnClickListenerC1535cB(this));
        }
        if (c1531c7.A05().A1o()) {
            if (this.A0H.A05().A1r()) {
                this.A06 = new KB(c1531c7);
            } else {
                this.A06 = new KD(c1531c7);
            }
            View view = this.A06;
    ...
    private C1506bi A01(C1531c7 c1531c7) {
        if (this.A0J != null) {
            return new C1506bi(c1531c7, getAdDataBundle(), this.A0I, this.A0J, getAdDetailsView(), this.A0E, this.A0F);
        }
        return new C1506bi(c1531c7, getAdDataBundle(), this.A0I, this.A0E, this.A0F, getAdDetailsView());
    }

    private C0851Ek A02(C1531c7 c1531c7) {
        RelativeLayout.LayoutParams layoutParams;
        C0851Ek c0851Ek = (C0851Ek) c1531c7.A02();
        if (c0851Ek == null) {
            c0851Ek = new C0851Ek(this.A03);
        }
        RelativeLayout.LayoutParams layoutParams2 = new RelativeLayout.LayoutParams(-1, -1);
        if (getAdDataBundle().A1u()) {
            c0851Ek.getVideoView().setPadding(c0851Ek.getVideoView().getPaddingLeft(), c0851Ek.getVideoView().getPaddingTop(), c0851Ek.getVideoView().getPaddingRight(), c0851Ek.getVideoView().getPaddingBottom() + A0Y);
        }
        layoutParams2.addRule(13);
        addView(c0851Ek, layoutParams2);
        int iA1Q = A1Q(c1531c7.A0B());
        this.A02 = (ImageView) c1531c7.A03();
        if (this.A02 != null) {
            if (!A04()) {
                ImageView imageView = this.A02;
                int i10 = AbstractC0995Ka.A0J;
                int toolbarHeight = AbstractC0995Ka.A0J;
                imageView.setPadding(i10, toolbarHeight, AbstractC0995Ka.A0J, AbstractC0995Ka.A0J);
                layoutParams = new RelativeLayout.LayoutParams(AbstractC0995Ka.A0K, AbstractC0995Ka.A0K);
                layoutParams.setMargins(0, iA1Q, AbstractC0995Ka.A0I, 0);
                layoutParams.addRule(11);
            } else {
                layoutParams = new RelativeLayout.LayoutParams(AbstractC1527c3.A0A, AbstractC1527c3.A0A);
                int i11 = XV.A0b;
            ...
            c0851Ek.addView(this.A02, layoutParams);
        }
        return c0851Ek;
    }

    private DZ A03(C1531c7 c1531c7) {
        DZ dzA0E = c1531c7.A0E();
        if (dzA0E == null) {
            return null;
        }
        dzA0E.A08(-1, AbstractC0995Ka.A0C, false);
        dzA0E.setPadding(AbstractC0995Ka.A0N, AbstractC0995Ka.A0N, AbstractC0995Ka.A0N, AbstractC0995Ka.A0N);
        RelativeLayout.LayoutParams progressBarLayoutParams = new RelativeLayout.LayoutParams(-1, AbstractC0995Ka.A0M);
    ...
    private void A06() {
        this.A07 = new C1543cJ(this.A0H.A06(), getAdDataBundle(), this.A0H.A08(), this.A0D, this.A0H.A0C());
        addView(this.A07.A0C(getCtaButton()));
    }

    private void A07() {
        YB.A0d(this.A02, getCtaButton(), getAdDetailsView(), this.A01, this.A0G, this.A0H.A0B());
        for (InterfaceC1702eu interfaceC1702eu : this.A0I.getPlugins()) {
            if (interfaceC1702eu instanceof AnonymousClass34) {
                this.A0I.A0g(interfaceC1702eu);
                return;
            }
        }
    }
    ...
    private void A09() {
        ...
        ViewOnClickListenerC1012Kr ctaButton = getCtaButton();
    ...
    private void A0B() {
        ...
        YB.A0L(this.A05);
        Pair<EnumC1668eL, View> pairA03 = this.A08.A03(getCtaButton());
        this.A00 = (View) pairA03.second;
        A0F((EnumC1668eL) pairA03.first);
    ...
    private void A0E(RelativeLayout relativeLayout) {
        ...
        YB.A0N(c1508bk, 0);
        YB.A0K(c1508bk);
        new LM(c1508bk, this.A03).A05(A0Q, A0Q).A07(getAdDataBundle().A2C().A01());
        ...
        C1510bm c1510bm = new C1510bm(c1814gi, i10, 5, A0V, -1);
        ...
        linearLayout.addView(c1510bm, ratingCountParams);
        ...
        iconParams.addRule(1, c1508bk.getId());
        ...
        c1510bm.setRating(Float.parseFloat(getAdDataBundle().A29().A0I().A0C()));
        ...
        if (!getAdDataBundle().A1s()) {
            ...
            formattingRatingCount = AbstractC1328Xg.A01(Integer.parseInt(getAdDataBundle().A29().A0I().A09()));
        }
    ...
    private void A0F(EnumC1668eL enumC1668eL) {
        if (!getAdDataBundle().A29().A0K().A02().isEmpty()) {
            if (getAdDataBundle().A29().A0K().A03()) {
                this.A09 = new C1675eS(this.A03, getAdDataBundle(), this.A0E, getCtaButton(), this.A0D, this.A0H.A08());
    ...
    private void A0G(EnumC1668eL enumC1668eL) {
        if (this.A00 == null) {
        }
        this.A0I.A0h(false);
        ...
        switch (enumC1668eL) {
            ...
            case A02:
                ...
                RelativeLayout.LayoutParams layoutParams2 = new RelativeLayout.LayoutParams(-1, -1);
                layoutParams2.setMargins(AbstractC0995Ka.A0L, AbstractC0995Ka.A0L, AbstractC0995Ka.A0L, AbstractC0995Ka.A0L);
    ...
    public final void A1I(C4K c4k) {
        super.A1I(c4k);
        if (A04()) {
            AbstractC1979jd adDataBundle = getAdDataBundle();
    ...
    public final void A1J(E1 e12) {
        ...
        if (A04()) {
            this.A03.A0F().AKh(XL.A00((float) this.A0H.A05().A0k()), getResources().getConfiguration().orientation, true, false, AbstractC1066Mt.A0C(this.A0H.A04()));
        }
    ...
    public final AbstractC1477bF A1R(C1531c7 c1531c7, NR nr, String str) {
        ...
        if (A04()) {
            return new C1516bs((float) dA0k, str, c1531c7.A06(), getColors(), c1531c7.A05(), c1531c7.A0C(), getCtaButton(), AbstractC0995Ka.A0G, false, c1531c7.A07(), c1531c7.A0F(), c1531c7.A0A(), c1531c7.A0E(), c1531c7.A08(), false).A03();
        }
        return new C0998Kd(c1531c7.A06(), getCtaButton(), AbstractC0995Ka.A0H, nr.A0I().A00() == NW.A05, getColors(), nr.A0J().A06(), str, c1531c7.A07(), c1531c7.A0C(), c1531c7.A0F(), c1531c7.A0A(), c1531c7.A05());
    }
    ...
    public final void A1Z() {
        ...
        if (this.A0H.A0B() != null) {
            AbstractC1349Yb abstractC1349YbA0B = this.A0H.A0B();
            if (A0L[4].charAt(31) == 'A') {
                throw new RuntimeException();
            }
            A0L[2] = "qVUXWES3bTCAG5k5pbCpCu4g17099rEp";
            abstractC1349YbA0B.setVisibility(8);
    ...
    public final void A1b(C4L c4l) {
        if (this.A06 != null) {
            ...
            this.A06.A1C();
            AbstractC1527c3 abstractC1527c3 = this.A06;
            String[] strArr = A0L;
            if (strArr[3].charAt(21) == strArr[6].charAt(21)) {
                throw new RuntimeException();
            }
    ...
    @Override // com.instagram.common.viewpoint.core.AbstractC0995Ka, com.instagram.common.viewpoint.core.AbstractC1527c3, android.view.View
    public final void onConfigurationChanged(Configuration configuration) {
        ...
        if (this.A06 != null) {
            ...
            if (abstractC1527c3.getVisibility() == 0) {
                getAdDetailsView().setVisibility(8);
                return;
            }
        }
    ...
    public void setVideoAdViewListener(InterfaceC1644dx interfaceC1644dx) {
        if (this.A06 instanceof KB) {
            ((KB) this.A06).setVideoAdViewListener(interfaceC1644dx);
        }
        if (this.A06 instanceof KD) {
            ((KD) this.A06).setVideoAdViewListener(interfaceC1644dx);
        }
    }
}
