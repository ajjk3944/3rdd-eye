...
public final class C1361Yn extends AdNativeComponentView {
    ...
    public C1361Yn(C1814gi c1814gi, C1278Vd c1278Vd) {
        super(c1814gi);
        this.A06 = c1278Vd;
        this.A05 = new TextView(c1814gi);
        this.A04 = new TextView(c1814gi);
        this.A03 = new TextView(c1814gi);
        this.A02 = new RelativeLayout(c1814gi);
        this.A00 = new LinearLayout(c1814gi);
        this.A01 = new RelativeLayout(c1814gi);
        this.A07 = new MR(c1814gi);
        A09();
        A0D();
        A05();
        A0A();
    ...
    */
    public final void onMeasure(int r3, int r4) {
        /*
            ...
            int r0 = com.instagram.common.viewpoint.core.C1264Up.A0F(r0)
            int r1 = r1 * r0
        ...
        L22:
            ...
            goto L1e
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C1361Yn.onMeasure(int, int):void");
    }
