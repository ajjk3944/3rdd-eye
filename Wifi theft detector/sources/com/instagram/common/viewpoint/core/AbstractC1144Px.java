...
public abstract class AbstractC1144Px {
    ...
    public static final C1143Pw A02;
    ...
    static {
        A01();
        A02 = new C1892hz() { // from class: com.facebook.ads.redexgen.X.7T
            public static byte[] A00;
            ...
            @Override // com.instagram.common.viewpoint.core.C1143Pw
    ...
    public static void A05(ViewParent viewParent, View view, View view2, int i10, int i11) {
        ...
        if (i11 == 0) {
            ...
            if (A01[1].length() != 12) {
                ...
                c1143Pw.A05(viewParent, view, view2, i10);
                return;
            }
            throw new RuntimeException();
        }
