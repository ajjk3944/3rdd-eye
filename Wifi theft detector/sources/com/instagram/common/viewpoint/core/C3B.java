...
public final class C3B extends ED {
    ...
    public C3B(C1814gi c1814gi) {
        this(c1814gi, null);
    }

    public C3B(C1814gi c1814gi, AttributeSet attributeSet) {
        this(c1814gi, attributeSet, 0);
    }

    public C3B(C1814gi c1814gi, AttributeSet attributeSet, int i10) {
        super(c1814gi, attributeSet, i10);
        this.A00 = new C0815Da(this);
