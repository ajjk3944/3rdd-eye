...
public final class C1298Vz extends C1184Rm implements DefaultMediaViewVideoRendererApi {
    ...
    public static void A0K() {
        A0I = new byte[]{Flags.CD, 44, 52, 35, 46, 43, 38, 98, 48, 39, 44, 38, 39, 48, 39, 48, 98, 33, 42, 43, 46, 38, 98, 33, 45, 44, 36, 43, 37, 108, 7, 47, 46, 35, 43, 28, 35, 47, 61, 28, 35, 46, 47, 37, 106, 35, 57, 106, 36, 63, 38, 38, 113, 106, 63, 36, 43, 40, 38, 47, 106, 62, 37, 106, 44, 35, 36, 46, 106, 35, 62, 100, 122, 65, 78, 77, 67, 74, 15, 91, 64, 15, 73, 70, 65, 75, 15, 98, 74, 75, 70, 78, 121, 70, 74, 88, 121, 70, 75, 74, 64, 15, 76, 71, 70, 67, 75, 1};
    }

    static {
        A0K();
        A0K = C1298Vz.class.getSimpleName();
    }
    ...
    private C1759fp A08() {
        return new C1759fp(this.A01, 50, true, new WeakReference(this.A0A), this.A04);
    }

    private void A0C() {
        if (this.A07 != null) {
            C06696r c06696r = this.A07;
            if (A0J[6].charAt(16) != 'd') {
                throw new RuntimeException();
            }
            A0J[5] = "Ntv0Vby76dSesAjQjgB6ptCIElpzOEzL";
            ((C1698eq) c06696r.getVideoView()).setViewImplInflationListener(this.A0F);
        }
    }
        ...
        if (this.A07 != null) {
            this.A07.getVideoView().setOnTouchListener(new View.OnTouchListener() { // from class: com.facebook.ads.redexgen.X.VQ
                ...
                public final boolean onTouch(View view, MotionEvent motionEvent) {
                    return C1298Vz.A0U(view, motionEvent);
                }
            });
        }
    }
    ...
    private void A0F() {
        if (this.A07 != null) {
            ((C1698eq) this.A07.getVideoView()).setViewImplInflationListener(null);
        }
    }
    ...
    public void A0G() {
        ...
        if (this.A09 != null) {
            if (this.A02 != null && this.A02.getHideMediaControls() != null && this.A02.getHideMediaControls().booleanValue() && !C1264Up.A1Z(this.A04)) {
    ...
    public void A0H() {
        ...
        if (!C1264Up.A1a(this.A04)) {
            InterfaceC1040Lt interfaceC1040LtA0F = this.A04.A0F();
            String[] strArr = A0J;
        ...
        if (this.A03 != null) {
            ...
            if (nativeOptions != null && this.A02.getUnMuteVolume() != null && this.A02.getUnMuteVolume().booleanValue() && !C1264Up.A1a(this.A04)) {
    ...
    private void A0I() {
        ...
        if (this.A07 != null) {
            EnumC1756fm state = this.A07.getState();
            String[] strArr = A0J;
            if (strArr[7].length() != strArr[1].length()) {
                throw new RuntimeException();
            }
            A0J[4] = "z79LrkWpr7afRwAllWq14kp6jWBswbkV";
            if (state == EnumC1756fm.A05) {
                this.A0E = true;
            }
        }
        this.A0B.A0V();
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void A0R(EnumC1701et enumC1701et) {
        if (this.A07 != null) {
            this.A07.A0e(enumC1701et, 24);
        } else {
    ...
    private boolean A0S() {
        ...
        if (!C1264Up.A1Y(this.A04)) {
            this.A04.A0F().ABf();
        }
        return (this.A02 == null || this.A02.getDisableFullScreen() == null || !this.A02.getDisableFullScreen().booleanValue() || C1264Up.A1Y(this.A04)) ? false : true;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public boolean A0T() {
        if (this.A07 == null || this.A07.getState() == EnumC1756fm.A06) {
            return false;
        }
        return this.A06 == EnumC1280Vf.A05 || this.A06 == EnumC1280Vf.A03;
    }
    ...
    public final void initialize(Context context, MediaViewVideoRenderer mediaViewVideoRenderer, MediaViewVideoRendererApi mediaViewVideoRendererApi, int i10) {
        VX vxA04;
        ((C1184Rm) mediaViewVideoRendererApi.getAdComponentViewApi()).A00(this);
        ...
        ((C1197Rz) mediaViewVideoRendererApi).A06(vxA04);
        this.A04 = C1187Rp.A03(context);
        ...
        while (true) {
            ...
            if (i11 < i12) {
                ...
                if (childAt instanceof C06696r) {
                    this.A07 = (C06696r) childAt;
                } else {
                    i11++;
                }
            }
    ...
    public final void onPrepared() {
        boolean zA0s = C1264Up.A0s(this.A04);
        boolean zA0S = A0S();
