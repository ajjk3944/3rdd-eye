...
public final class C1844hC extends C1184Rm implements MediaViewApi, Repairable, T4, InterfaceC1376Zc {
    ...
    public boolean A0J;
    public boolean A0K;
    public EnumC1193Rv A0B = EnumC1193Rv.A04;
    public int A01 = 0;
    public int A00 = 0;
    ...
    private void A06() {
        this.A0C.A0F().ABd();
        this.A0G = new C1495bX(this.A0C, false);
    ...
    private void A0B() {
        EnumC1324Xc.A04(this.A07, EnumC1324Xc.A0B);
        EnumC1324Xc.A04(this.A0F, EnumC1324Xc.A0B);
        EnumC1324Xc.A04(this.A09, EnumC1324Xc.A0B);
    ...
    private void A0E(View view, UK uk) {
        ...
        this.A0I = AbstractC1661eE.A01(this.A0C, strA1I);
        if (this.A0I != null) {
            RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-1, -1);
    ...
    private final void A0G(C1814gi c1814gi, AttributeSet attributeSet, int i10, int i11, MediaView mediaView) {
        this.A07 = mediaView;
        A0F(new ImageView(c1814gi, attributeSet, i10, i11));
        A0S(new C1467b5(c1814gi, attributeSet, i10, i11));
        this.A0E = new C0x(c1814gi, attributeSet, i10);
        A0A();
        setVideoRenderer(new DefaultMediaViewVideoRenderer(c1814gi, attributeSet, i10, i11));
        A0B();
    }

    private final void A0H(C1814gi c1814gi, AttributeSet attributeSet, int i10, MediaView mediaView) {
        this.A07 = mediaView;
        A0F(new ImageView(c1814gi, attributeSet, i10));
        A0S(new C1467b5(c1814gi, attributeSet, i10));
        this.A0E = new C0x(c1814gi, attributeSet, i10);
        A0A();
        setVideoRenderer(new DefaultMediaViewVideoRenderer(c1814gi, attributeSet, i10));
        A0B();
    }

    private final void A0I(C1814gi c1814gi, AttributeSet attributeSet, MediaView mediaView) {
        this.A07 = mediaView;
        A0F(new ImageView(c1814gi, attributeSet));
        A0S(new C1467b5(c1814gi, attributeSet));
        this.A0E = new C0x(c1814gi, attributeSet);
        A0A();
        setVideoRenderer(new DefaultMediaViewVideoRenderer(c1814gi, attributeSet));
        A0B();
    }

    private final void A0J(C1814gi c1814gi, MediaView mediaView) {
        this.A07 = mediaView;
        A0F(new ImageView(c1814gi));
        A0S(new C1467b5(c1814gi));
        this.A0E = new C0x(c1814gi);
        A0A();
        setVideoRenderer(new DefaultMediaViewVideoRenderer(c1814gi));
        A0B();
    }
    ...
    private void A0P(UK uk) {
        if (this.A0G != null) {
            int iA0y = uk.A0y();
            this.A0D = new XO(iA0y, new C1845hD(this, iA0y));
            this.A0D.A07();
        }
    }

    private void A0Q(final UK uk, boolean z10) {
        if (this.A06 != null) {
        ...
        if (uk.A13() != null && uk.A13().A2U()) {
            ...
            C1405a5 c1405a5 = new C1405a5(this.A0C, EnumC1422aM.A05);
            ...
            this.A06.addView(c1405a5, layoutParams2);
            c1405a5.setOnClickListener(new View.OnClickListener() { // from class: com.facebook.ads.redexgen.X.Ry
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
    ...
    private void A0R(UK uk, boolean z10, C1276Vb c1276Vb) {
        LM lmA04 = new LM(this.A04, this.A0C).A04();
        if (z10) {
            lmA04.A06(new C1852hK(this, uk));
        }
        lmA04.A07(c1276Vb.getUrl());
    }

    private void A0S(C1467b5 c1467b5) {
        if (!this.A0K) {
            if (this.A0F != null) {
                this.A07.removeView(this.A0F);
            }
            c1467b5.setVisibility(8);
            RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-1, -1);
            layoutParams.addRule(13);
            this.A07.addView(c1467b5, layoutParams);
            this.A0F = c1467b5;
            return;
        }
    ...
    */
    public final void A0W(com.facebook.ads.NativeAd r18) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C1844hC.A0W(com.facebook.ads.NativeAd):void");
    }

    public final void A0X(NativeAdBaseApi nativeAdBaseApi, boolean z10) {
        C1814gi c1814giA16 = ((UK) nativeAdBaseApi).A16();
        C1814gi adObjectContext = this.A0C;
        adObjectContext.A0L(c1814giA16);
        c1814giA16.A0O(this);
        this.A0K = true;
        ...
        ((C1197Rz) this.A09.getMediaViewVideoRendererApi()).A03();
        if (this.A03 != null) {
            this.A03.setVisibility(8);
            if (this.A03 instanceof C1458aw) {
                ((C1458aw) this.A03).A04();
            } else {
        ...
        this.A02 = this.A04;
        C1276Vb adIcon = ukA0L.getAdIcon();
        if (adIcon != null) {
            C1220Sx c1220SxA14 = ukA0L.A14();
            if (A0M[1].charAt(7) == 'A') {
                throw new RuntimeException();
            }
            String[] strArr = A0M;
            strArr[3] = "8vonm0Gh";
            strArr[7] = "EfYx5Mmt";
            Bitmap bitmapA0N = c1220SxA14.A0N(adIcon.getUrl());
            if (bitmapA0N != null) {
                this.A04.setImageBitmap(bitmapA0N);
                if (z10) {
                    this.A07.post(new C1853hL(this, ukA0L));
                }
            } else {
            ...
            c1814giA16.A0F().A3N(ukA0L.A11(), adErrorType.getErrorCode(), adErrorType.getDefaultErrorMessage());
            ...
            if (nativeAdBaseApi.isAdLoaded()) {
                C1814gi adObjectContext2 = this.A0C;
                adObjectContext2.A08().ABC(A05(258, 3, 44), AbstractC1226Td.A0W, new C1227Te(A05(PsExtractor.AUDIO_STREAM, 23, 42)));
            }
        }
        A0E(this.A04, ukA0L);
    ...
    public final /* synthetic */ void A0Y(UK uk, View view) {
        this.A0C.A0F().AAy(EnumC1422aM.A05.name().toLowerCase(Locale.US));
        uk.A1O();
    }
    ...
    @Override // com.instagram.common.viewpoint.core.InterfaceC1376Zc
    ...
    */
    public final int getMediaWidth() {
        /*
            ...
            java.lang.String[] r2 = com.instagram.common.viewpoint.core.C1844hC.A0M
            r0 = 2
            r1 = r2[r0]
            r0 = 0
            r2 = r2[r0]
        ...
        L35:
            ...
            java.lang.String[] r1 = com.instagram.common.viewpoint.core.C1844hC.A0M
            r0 = 1
            r1 = r1[r0]
            r0 = 7
            char r1 = r1.charAt(r0)
        ...
        L7c:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C1844hC.getMediaWidth():int");
    }
    ...
    public final void initialize(AdViewConstructorParams adViewConstructorParams, MediaView mediaView) {
        ...
        if (context instanceof C1814gi) {
            this.A0C = (C1814gi) context;
        } else {
            this.A0C = C1187Rp.A03(context);
        }
        this.A0C.A0O(this);
    ...
    public final boolean isVideoContent() {
        this.A0C.A0F().ABl();
        return this.A0B == EnumC1193Rv.A05;
    }

    @Override // com.instagram.common.viewpoint.core.C1184Rm, com.facebook.ads.internal.api.AdComponentViewApi
    ...
    public final void setListener(MediaViewListener mediaViewListener) {
        ...
        if (mediaViewListener == null) {
            ((C1197Rz) this.A09.getMediaViewVideoRendererApi()).A07(null);
        } else {
            ((C1197Rz) this.A09.getMediaViewVideoRendererApi()).A07(new C1846hE(this, mediaViewListener));
        }
    }
    ...
    public final void setVideoRenderer(MediaViewVideoRenderer mediaViewVideoRenderer) {
        if (!this.A0K) {
            ...
            ((C1197Rz) mediaViewVideoRenderer.getMediaViewVideoRendererApi()).A05(this.A0C.A0A());
            mediaViewVideoRenderer.setVisibility(8);
            RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-1, -1);
            layoutParams.addRule(13);
            ((C1844hC) this.A07.getMediaViewApi()).A0D(mediaViewVideoRenderer, layoutParams);
