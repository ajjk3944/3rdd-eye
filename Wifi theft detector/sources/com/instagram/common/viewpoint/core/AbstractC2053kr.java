...
public abstract class AbstractC2053kr implements InterfaceC1023Lc {
    ...
    static {
        A04();
        A03 = AbstractC2053kr.class.getSimpleName();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void A06(File file) throws IOException {
        C1026Lf.A03(file);
        List<File> files = C1026Lf.A01(file.getParentFile());
        A07(files);
    }

    @Override // com.instagram.common.viewpoint.core.InterfaceC1023Lc
    public void AKR(File file) throws IOException {
        this.A00.submit(new CallableC1027Lg(this, file));
    }
}
