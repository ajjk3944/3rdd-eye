...
public final class C9U extends AbstractC2146mZ {
     ...
     */
    public static ApicFrame A04(C06214v c06214v, int i10, int i11) {
        int iA02;
        String strA01;
        int iA0I = c06214v.A0I();
        Charset charsetA0M = A0M(iA0I);
        byte[] bArr = new byte[i10 - 1];
        c06214v.A0k(bArr, 0, i10 - 1);
        String strA0J = A0J(TTAdConstant.AD_ID_IS_NULL_CODE, 6, 90);
        if (i11 == 2) {
            iA02 = 2;
            strA01 = strA0J + AbstractC2009k7.A01(new String(bArr, 0, 3, AbstractC2011k9.A00));
            if (A0J(418, 9, 47).equals(strA01)) {
                strA01 = A0J(TTAdConstant.DOWNLOAD_URL_CODE, 10, 122);
            }
        } else {
            iA02 = A02(bArr, 0);
            strA01 = AbstractC2009k7.A01(new String(bArr, 0, iA02, AbstractC2011k9.A00));
    ...
    java.lang.ArrayIndexOutOfBoundsException
     */
    public static ChapterFrame A06(C06214v c06214v, int i10, int i11, boolean z10, int i12, IE ie) {
        int iA09 = c06214v.A09();
        int iA02 = A02(c06214v.A0l(), iA09);
        String str = new String(c06214v.A0l(), iA09, iA02 - iA09, AbstractC2011k9.A00);
        c06214v.A0f(iA02 + 1);
        ...
        while (true) {
            ...
            Id3Frame id3FrameA0B = A0B(i11, c06214v, z10, i12, ie);
            if (id3FrameA0B != null) {
    ...
    java.lang.ArrayIndexOutOfBoundsException
     */
    public static GeobFrame A09(C06214v c06214v, int i10) {
        int iA0I = c06214v.A0I();
        Charset charsetA0M = A0M(iA0I);
        byte[] bArr = new byte[i10 - 1];
        c06214v.A0k(bArr, 0, i10 - 1);
        int iA02 = A02(bArr, 0);
        String str = new String(bArr, 0, iA02, AbstractC2011k9.A00);
        int i11 = iA02 + 1;
    ...
    java.lang.ArrayIndexOutOfBoundsException
     */
    public static MlltFrame A0C(C06214v c06214v, int i10) {
        int iA0M = c06214v.A0M();
        int iA0K = c06214v.A0K();
        int iA0K2 = c06214v.A0K();
        int iA0I = c06214v.A0I();
        int iA0I2 = c06214v.A0I();
        C06204u c06204u = new C06204u();
        c06204u.A0C(c06214v);
        int i11 = ((i10 - 10) * 8) / (iA0I + iA0I2);
        int[] iArr = new int[i11];
        int[] iArr2 = new int[i11];
        for (int i12 = 0; i12 < i11; i12++) {
            int iA04 = c06204u.A04(iA0I);
            int iA042 = c06204u.A04(iA0I2);
            iArr[i12] = iA04;
            iArr2[i12] = iA042;
            if (A02[5].charAt(22) == 'F') {
                throw new RuntimeException();
    ...
    */
    public static int A01(com.instagram.common.viewpoint.core.C06214v r8, int r9) {
        /*
            byte[] r6 = r8.A0l()
            int r8 = r8.A09()
            r7 = r8
    ...
    */
    ...
    public static BinaryFrame A05(C06214v c06214v, int i10, String str) {
        byte[] bArr = new byte[i10];
        c06214v.A0k(bArr, 0, i10);
        return new BinaryFrame(str, bArr);
    }

    public static ChapterTocFrame A07(C06214v c06214v, int i10, int i11, boolean z10, int elementIdEndIndex, IE ie) {
        int iA09 = c06214v.A09();
        int iA02 = A02(c06214v.A0l(), iA09);
        String str = new String(c06214v.A0l(), iA09, iA02 - iA09, AbstractC2011k9.A00);
        c06214v.A0f(iA02 + 1);
        int framePosition = c06214v.A0I();
        boolean z11 = (framePosition & 2) != 0;
        boolean z12 = (framePosition & 1) != 0;
        int iA0I = c06214v.A0I();
        String[] strArr = new String[iA0I];
        for (int i12 = 0; i12 < iA0I; i12++) {
            int startIndex = c06214v.A09();
            int iA022 = A02(c06214v.A0l(), startIndex);
            int elementIdEndIndex2 = iA022 - startIndex;
            strArr[i12] = new String(c06214v.A0l(), startIndex, elementIdEndIndex2, AbstractC2011k9.A00);
            c06214v.A0f(iA022 + 1);
        }
        ArrayList arrayList = new ArrayList();
        int i13 = iA09 + i10;
        while (c06214v.A09() < i13) {
            Id3Frame id3FrameA0B = A0B(i11, c06214v, z10, elementIdEndIndex, ie);
            if (id3FrameA0B != null) {
                arrayList.add(id3FrameA0B);
            }
        }
    ...
    public static CommentFrame A08(C06214v c06214v, int i10) {
        if (i10 < 4) {
            return null;
        }
        int textStartIndex = c06214v.A0I();
        Charset charsetA0M = A0M(textStartIndex);
        byte[] bArr = new byte[3];
        c06214v.A0k(bArr, 0, 3);
        String description = new String(bArr, 0, 3);
        int encoding = i10 - 4;
        byte[] data = new byte[encoding];
        int encoding2 = i10 - 4;
        c06214v.A0k(data, 0, encoding2);
    ...
    public static IF A0A(C06214v c06214v) {
        int iA07 = c06214v.A07();
        String strA0J = A0J(170, 10, 14);
        if (iA07 < 10) {
            AbstractC06064g.A07(strA0J, A0J(30, 31, 108));
            return null;
        }
        int iA0K = c06214v.A0K();
        boolean z10 = false;
        if (iA0K != 4801587) {
            AbstractC06064g.A07(strA0J, A0J(348, 50, 47) + String.format(A0J(0, 4, 50), Integer.valueOf(iA0K)));
            return null;
        }
        int iA0I = c06214v.A0I();
        c06214v.A0g(1);
        int flags = c06214v.A0I();
        int iA0H = c06214v.A0H();
        if (iA0I == 2) {
            int id = flags & 64;
            int id2 = id != 0 ? 1 : 0;
            if (id2 != 0) {
                AbstractC06064g.A07(strA0J, A0J(180, 68, 11));
                return null;
            }
        } else if (iA0I == 3) {
            int id3 = flags & 64;
            ...
            AbstractC06064g.A07(strA0J, A0J(248, 46, 54) + iA0I);
            return null;
        }
        if (iA0I < 4) {
            int id11 = flags & 128;
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public static com.facebook.ads.androidx.media3.extractor.metadata.id3.Id3Frame A0B(int r21, com.instagram.common.viewpoint.core.C06214v r22, boolean r23, int r24, com.instagram.common.viewpoint.core.IE r25) {
        /*
    ...
    public static PrivFrame A0D(C06214v c06214v, int i10) {
        byte[] bArr = new byte[i10];
        c06214v.A0k(bArr, 0, i10);
        int iA02 = A02(bArr, 0);
        return new PrivFrame(new String(bArr, 0, iA02, AbstractC2011k9.A00), A0Q(bArr, iA02 + 1, bArr.length));
    }
    ...
    public static TextInformationFrame A0E(C06214v c06214v, int i10) {
        if (i10 < 1) {
            return null;
        }
        int iA0I = c06214v.A0I();
    ...
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.BP != com.google.common.collect.ImmutableList<java.lang.String> */
    public static TextInformationFrame A0F(C06214v c06214v, int i10, String str) {
        if (i10 < 1) {
            return null;
        }
        int iA0I = c06214v.A0I();
        int encoding = i10 - 1;
        byte[] data = new byte[encoding];
        c06214v.A0k(data, 0, i10 - 1);
        return new TextInformationFrame(str, null, A0I(data, iA0I, 0));
    }

    public static UrlLinkFrame A0G(C06214v c06214v, int i10) {
        if (i10 < 1) {
            return null;
        }
        int iA0I = c06214v.A0I();
        ...
        String description = A0L(bArr, descriptionEndIndex, A02(bArr, descriptionEndIndex), AbstractC2011k9.A00);
        return new UrlLinkFrame(A0J(398, 4, 35), str, description);
    }

    public static UrlLinkFrame A0H(C06214v c06214v, int i10, String str) {
        byte[] bArr = new byte[i10];
        c06214v.A0k(bArr, 0, i10);
        return new UrlLinkFrame(str, null, new String(bArr, 0, A02(bArr, 0), AbstractC2011k9.A00));
    }
    ...
    public static Charset A0M(int i10) {
        switch (i10) {
            case 1:
                return AbstractC2011k9.A02;
            case 2:
                return AbstractC2011k9.A03;
            case 3:
                return AbstractC2011k9.A05;
            default:
                Charset charset = AbstractC2011k9.A00;
                if (A02[5].charAt(22) == 'F') {
                    throw new RuntimeException();
                }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public static boolean A0P(com.instagram.common.viewpoint.core.C06214v r18, int r19, int r20, boolean r21) throws java.lang.Throwable {
        /*
    ...
    @Override // com.instagram.common.viewpoint.core.AbstractC2146mZ
    public final Metadata A0R(C07289e c07289e, ByteBuffer byteBuffer) {
        return A0S(byteBuffer.array(), byteBuffer.limit());
    }

    public final Metadata A0S(byte[] bArr, int i10) {
        ArrayList arrayList = new ArrayList();
        C06214v c06214v = new C06214v(bArr, i10);
        IF ifA0A = A0A(c06214v);
        if (ifA0A == null) {
            return null;
        }
        int startPosition = c06214v.A09();
        int frameHeaderSize = ifA0A.A01 == 2 ? 6 : 10;
        int iA01 = ifA0A.A00;
        if (ifA0A.A02) {
            iA01 = A01(c06214v, ifA0A.A00);
        }
        c06214v.A0e(startPosition + iA01);
        boolean z10 = false;
        if (!A0P(c06214v, ifA0A.A01, frameHeaderSize, false)) {
            if (ifA0A.A01 == 4 && A0P(c06214v, 4, frameHeaderSize, true)) {
                z10 = true;
            } else {
                AbstractC06064g.A07(A0J(170, 10, 14), A0J(88, 45, 57) + ifA0A.A01);
                return null;
            }
        }
        while (c06214v.A07() >= frameHeaderSize) {
            Id3Frame id3FrameA0B = A0B(ifA0A.A01, c06214v, z10, frameHeaderSize, this.A00);
            if (id3FrameA0B != null) {
                arrayList.add(id3FrameA0B);
            }
        }
