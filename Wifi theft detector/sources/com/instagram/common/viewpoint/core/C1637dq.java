...
public final class C1637dq extends LinearLayout {
    ...
    public C1637dq(Cdo cdo) {
        super(cdo.A08);
        this.A02 = false;
        this.A01 = "";
        this.A04 = cdo.A08;
        this.A05 = new C1508bk(this.A04);
        this.A06 = new C1514bq(this.A04, cdo.A01, true, false, true);
        this.A03 = cdo.A00;
        this.A02 = cdo.A05;
        this.A01 = cdo.A04;
        A03(cdo);
    ...
    public /* synthetic */ C1637dq(Cdo cdo, GX gx) {
        this(cdo);
    }
    ...
    private void A02(Cdo cdo) {
        if (!TextUtils.isEmpty(cdo.A03)) {
            ...
            if (this.A02) {
                C1502be c1502be = new C1502be(getContext(), 0, -1, YM.PLAYABLE_ICON);
                c1502be.setLayoutParams(new LinearLayout.LayoutParams(A0B, A0B));
                this.A00.addView(c1502be);
            } else {
    ...
    public final void A04(InterfaceC1636dp interfaceC1636dp) {
        A00();
        postDelayed(new GX(this, interfaceC1636dp), this.A03);
    }
}
