...
public final class C1823gr implements InterfaceC1206Sj {
    ...
    public final Map<String, AbstractC1204Sh> A00 = new HashMap();
     ...
     */
    @Override // com.instagram.common.viewpoint.core.InterfaceC1206Sj
    public final synchronized String AIb() {
        StringBuilder sb;
        sb = new StringBuilder();
        Iterator<AbstractC1204Sh> it = this.A00.values().iterator();
        if (it.hasNext()) {
            it.next();
