...
public abstract class RL {
    ...
    public static int A00(@Nullable RH rh, @Nullable AbstractC1158Qm abstractC1158Qm, View view, View view2, R2 r22, boolean z10) {
        if (r22.A0Y() != 0) {
            int iA03 = rh.A03();
            if (A00[0].length() != 28) {
            ...
            int iA0C = abstractC1158Qm.A0C(view2) - abstractC1158Qm.A0F(view);
            int extend = abstractC1158Qm.A0B();
            return Math.min(extend, iA0C);
        }
        return 0;
    }

    public static int A01(@Nullable RH rh, @Nullable AbstractC1158Qm abstractC1158Qm, View view, View view2, R2 r22, boolean z10) {
    ...
    public static int A02(@Nullable RH rh, @Nullable AbstractC1158Qm abstractC1158Qm, View view, View view2, R2 r22, boolean z10, boolean z11) {
        int laidOutArea;
        if (r22.A0Y() == 0 || rh.A03() == 0 || view == null || view2 == null) {
            return 0;
        }
        ...
        int itemsBefore = abstractC1158Qm.A0C(view2);
        int minPosition3 = abstractC1158Qm.A0F(view);
        ...
        int itemsBefore3 = abstractC1158Qm.A0A();
        int minPosition5 = abstractC1158Qm.A0F(view);
