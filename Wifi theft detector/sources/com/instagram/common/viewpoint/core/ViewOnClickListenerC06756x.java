...
public final class ViewOnClickListenerC06756x extends PZ implements View.OnClickListener, View.OnTouchListener {
    ...
    public ViewOnClickListenerC06756x(C1176Re c1176Re, C1814gi c1814gi, VA va, InterfaceC1355Yh interfaceC1355Yh, String str, int i10) {
        super(c1176Re, c1814gi, va, interfaceC1355Yh, false);
        this.A00 = 0;
        this.A01 = 0;
        this.A03 = false;
        this.A07 = new RunnableC1358Yk(this);
        this.A08 = str;
        this.A05 = new Handler(Looper.getMainLooper());
        this.A06 = (InputMethodManager) c1814gi.getSystemService(A05(112, 12, 70));
        this.A04 = i10;
    }

    public static /* synthetic */ int A02(ViewOnClickListenerC06756x viewOnClickListenerC06756x) {
        int i10 = viewOnClickListenerC06756x.A00;
        viewOnClickListenerC06756x.A00 = i10 + 1;
        return i10;
    }
    ...
    private void A07() {
        ...
        if (AdPlacementType.NATIVE.name().equals(this.A08)) {
            ...
            super.A08.A0E(EnumC1707ez.A04.A03(), null);
        }
    }
    ...
    public final InterfaceC1452aq A0F() {
        return new C1127Pd(this);
    }
    ...
    public final void A0G() {
        ...
        super.A07.setOnTouchListener(new View.OnTouchListener() { // from class: com.facebook.ads.redexgen.X.Yj
            ...
            public final boolean onTouch(View view, MotionEvent motionEvent) {
                return ViewOnClickListenerC06756x.A0B(view, motionEvent);
            }
        });
    ...
    public final void A0H() {
        ...
        translateAnimation.setAnimationListener(new AnimationAnimationListenerC1360Ym(this));
    ...
    @Override // com.instagram.common.viewpoint.core.PZ, com.instagram.common.viewpoint.core.InterfaceC1356Yi
    public final void AAu(Intent intent, Bundle bundle, C1176Re c1176Re) {
        super.AAu(intent, bundle, c1176Re);
    ...
    public final void onAttachedToWindow() {
        ...
        translateAnimation.setFillAfter(true);
        translateAnimation.setAnimationListener(new AnimationAnimationListenerC1359Yl(this));
        startAnimation(translateAnimation);
    }
