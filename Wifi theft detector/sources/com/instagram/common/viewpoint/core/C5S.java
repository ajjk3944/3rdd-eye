...
public final class C5S extends AbstractC0953Ij {
    ...
    public final C1814gi A0K;
    public final VI A0L;
    public final AbstractC1349Yb A0M;
    public final AbstractC1477bF A0N;
    public final ViewOnClickListenerC1012Kr A0O;
    public final InterfaceC1634dm A0P;
    public final C1669eM A0Q;
    public final C0861Eu A0R;
    public final C0851Ek A0S;
    ...
    public final E2 A0X;
    public final E0 A0Y;
    public final AbstractC0840Dz A0Z;
    public final C0827Dm A0a;
    public final DZ A0b;
    ...
    public C5S(C1814gi c1814gi, VA va, AbstractC1979jd abstractC1979jd, C1220Sx c1220Sx, ZU zu, int i10, InterfaceC1355Yh interfaceC1355Yh, VI vi, AbstractC1349Yb abstractC1349Yb, int i11, int customVideoDurationMs, int i12, boolean z10, int i13, boolean z11, boolean z12, boolean z13, InterfaceC1634dm interfaceC1634dm, int i14, int i15) {
        C1072Na c1072NaA00;
        super(c1814gi, zu, va, abstractC1979jd, i10, z12, z13, interfaceC1355Yh, i15);
        ...
        this.A0Y = new E0() { // from class: com.facebook.ads.redexgen.X.5g
            ...
            public final void A03(E1 e12) {
                ...
                if (this.A00.getAdDataBundle().A1c()) {
                    this.A00.A0K.A0F().AKh(XL.A00((float) ((AbstractC0953Ij) this.A00).A06.A0k()), this.A00.getResources().getConfiguration().orientation, true, true, AbstractC1066Mt.A0C(C1067Mu.A00(this.A00.A0K, ((AbstractC0953Ij) this.A00).A08, "", XB.A00(((AbstractC0953Ij) this.A00).A06.A29().A0J().A05()), new HashMap(), ((AbstractC0953Ij) this.A00).A06.A2A())));
        ...
        this.A0Z = new AbstractC0840Dz() { // from class: com.facebook.ads.redexgen.X.5Z
            /* JADX INFO: Access modifiers changed from: private */
            @Override // com.instagram.common.viewpoint.core.UN
            /* renamed from: A00, reason: merged with bridge method [inline-methods] */
        ...
        this.A0U = new EA() { // from class: com.facebook.ads.redexgen.X.5U
            ...
            public final void A03(C4K c4k) {
                ...
                if (this.A00.A00 < ((AbstractC0953Ij) this.A00).A06.A29().A0G()) {
                    C5S.A01(this.A00, 1.0f);
                    this.A00.A0S.A0e(EnumC1701et.A02, 28);
                    return;
                }
                C5S c5s = this.A00;
                String[] strArr = A01;
        ...
        this.A0K = c1814gi;
        this.A0L = vi;
        this.A0M = abstractC1349Yb;
        this.A0H = i14;
        int i16 = -1;
        if (!super.A06.A1c()) {
            this.A0J = new C0820Df(this.A0K, vi);
        } else {
            i16 = i14;
            this.A0J = new C0818Dd(this.A0K, vi);
        }
        this.A0b = new DZ(this.A0K, i16);
        if (this.A00 < abstractC1979jd.A29().A0G()) {
        ...
        this.A0P = interfaceC1634dm;
        this.A0D = i12;
        this.A0c = z10;
        this.A0Q = new C1669eM(this.A0K, va, super.A06);
        ...
        this.A01 = c1072NaA00;
        this.A0S = new C0851Ek(this.A0K);
        this.A0S.getEventBus().A03(this.A0Y, this.A0X, this.A0W, this.A0Z, this.A0U, this.A0V);
        this.A0T = new C4L(c1814gi, va, this.A0S, abstractC1979jd.A2E(), 0, 0, abstractC1979jd.A29().A0U(), null, null);
        A0I();
        this.A0S.setVideoURI(c1220Sx.A0T(super.A06.A29().A0H().A09()));
        A0H();
        XR xrA02 = super.A09.A02(abstractC1979jd);
        this.A0K.A0H().A00(xrA02.A01);
        this.A0N = A06();
        if (this.A0N instanceof C0998Kd) {
            new DA(this.A0N, 400, 100, 0).A4A(true, false);
        } else {
            this.A0N.setVisibility(8);
        }
        this.A0a = new C0827Dm(true, abstractC1979jd.A29().A0U());
        A0K();
        ...
        if (C1264Up.A1z(this.A0K)) {
            this.A0K.A0B().AKn(this.A0S, super.A06.A2E(), true);
        }
        if (C1264Up.A20(this.A0K)) {
            this.A0R = new C0861Eu(this.A0K, va, this.A0S, super.A06.A2E(), abstractC1979jd.A29().A0U(), this.A0T, null);
        } else {
            this.A0R = null;
        }
    }
    ...
    private AbstractC1477bF A06() {
        String strA0C;
        AbstractC1477bF c0998Kd;
        ...
        if (super.A06.A10().equals(A0C(37, 14, 3))) {
            strA0C = EnumC1707ez.A04.A03();
        } else {
            strA0C = A0C(0, 37, 118);
        }
        double dA0k = super.A06.A0k();
        if (!getAdDataBundle().A1c()) {
            C1814gi c1814gi = this.A0K;
            int i10 = A0k;
            boolean z10 = super.A06.A29().A0I().A00() == NW.A05;
            C1072Na colors = getColors();
            boolean zA06 = super.A06.A29().A0J().A06();
            VA va = super.A08;
            InterfaceC1355Yh interfaceC1355Yh = super.A0B;
            C1759fp c1759fp = super.A0D;
            Y2 y22 = super.A0A;
            AbstractC1979jd abstractC1979jd = super.A06;
            if (A0f[1].charAt(3) != 'F') {
                throw new RuntimeException();
            }
            String[] strArr = A0f;
            ...
            c0998Kd = new C0998Kd(c1814gi, null, i10, z10, colors, zA06, strA0C, va, interfaceC1355Yh, c1759fp, y22, abstractC1979jd);
        } else {
            c0998Kd = new C1516bs((float) dA0k, strA0C, this.A0K, getColors(), super.A06, super.A0B, this.A0O, AbstractC0953Ij.A0G, false, super.A08, super.A0D, super.A0A, this.A0b, this.A0L, false).A03();
            ((LK) c0998Kd).setChainedAdInfo(super.A00);
        }
        c0998Kd.getCTAButton().getCtaActionHelper().A08(super.A06);
        c0998Kd.getCTAButton().setCreativeAsCtaLoggingHelper(super.A09);
        YB.A0G(1008, c0998Kd);
        c0998Kd.A0l(this.A0G);
        addView(c0998Kd, adDetailsParams);
        c0998Kd.setInfo(super.A06.A29().A0I(), super.A06.A29().A0J(), super.A06.A2E(), super.A06.A2C().A01(), null, null);
        return c0998Kd;
    }
    ...
    private void A0E() {
        if (getAdDataBundle().A29().A0K().A03() && !getAdDataBundle().A29().A0K().A02().isEmpty()) {
            ...
            this.A04 = new C1675eS(this.A0K, getAdDataBundle(), super.A0B, this.A0O, this.A0I, this.A0L);
            A0D();
        } else {
            if (getAdDataBundle().A29().A0K().A04() || getAdDataBundle().A29().A0K().A03()) {
                YB.A0d(this.A0N, this.A0J, this.A0O);
                this.A03 = new C1543cJ(this.A0K, super.A06, this.A0L, this.A0I, super.A0B);
                this.A03.A0I(false);
                addView(this.A03.A0C(this.A0O));
                return;
            }
            Pair<EnumC1668eL, View> pairA03 = this.A0Q.A03(this.A0O);
            View endCardView = (View) pairA03.second;
            YB.A0G(1101, endCardView);
            A0Q((EnumC1668eL) pairA03.first, endCardView);
        }
    }
    ...
    private void A0G() {
        ...
        if (!super.A06.A1c()) {
            ...
            layoutParams.setMargins(0, AbstractC1349Yb.A00, A0l, 0);
    ...
    private void A0H() {
        postDelayed(new IL(this), C1264Up.A0P(this.A0K));
    }

    private void A0I() {
        this.A0S.A0f(this.A0b);
        if (this.A0J instanceof InterfaceC1702eu) {
            this.A0S.A0f((InterfaceC1702eu) this.A0J);
        }
    ...
    private final void A0K() {
        ...
        if (expandableLayout != null) {
            ...
            C1072Na c1072NaA01 = super.A06.A28().A01();
            this.A0a.A0L(new DB(this.A0N.getCTAButton(), 300, -1, c1072NaA01.A0A(true)));
            Drawable drawableA08 = YB.A08(A0i, A0j, A0h);
            Drawable endDrawable = YB.A05(c1072NaA01.A09(true), A0h);
    ...
    private void A0Q(EnumC1668eL enumC1668eL, View view) {
        this.A0S.A0h(false);
        this.A0S.setVisibility(8);
        switch (C1611dP.A00[enumC1668eL.ordinal()]) {
            case 1:
                this.A0N.setVisibility(0);
                RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-1, -1);
                layoutParams.setMargins(0, AbstractC1349Yb.A00, 0, 0);
    ...
    public void A0R(C4A c4a) {
        if (this.A0S.getState() == EnumC1756fm.A02 && C1264Up.A1e(this.A0K)) {
    ...
    public final void A1G() {
        ...
        if (this.A0D != 0 || !this.A0c) {
            ...
            if (this.A0M != null && getAdDataBundle().A29().A0K().A00() > 0) {
                ...
                new Handler(Looper.getMainLooper()).postDelayed(new RunnableC1610dO(this), getAdDataBundle().A29().A0K().A00());
                return;
            }
            this.A08 = true;
            return;
    ...
    public final void A1H() {
        ...
        AbstractC1349Yb abstractC1349Yb = this.A0M;
        if (A0f[6].length() != 13) {
            throw new RuntimeException();
        }
        A0f[6] = "z6ph3MLFkPTln";
        abstractC1349Yb.setToolbarActionMode(8);
    }
    ...
    public final void A1K(boolean z10) {
        ...
        if (this.A07 || this.A0S.getState() == EnumC1756fm.A06 || this.A05 == null) {
            return;
        }
        if (!this.A0B || z10) {
