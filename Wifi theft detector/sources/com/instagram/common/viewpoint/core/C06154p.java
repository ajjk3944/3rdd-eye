...
public final class C06154p {
    public static C06154p A04;
    ...
    public final CopyOnWriteArrayList<WeakReference<InterfaceC06134n>> A03 = new CopyOnWriteArrayList<>();
    ...
    public C06154p(Context context) {
        IntentFilter intentFilter = new IntentFilter();
        intentFilter.addAction(A04(0, 36, 40));
        context.registerReceiver(new C06144o(this), intentFilter);
    }
    ...
    public static synchronized C06154p A03(Context context) {
        if (A04 == null) {
            A04 = new C06154p(context);
        }
        return A04;
    }

    private void A05() {
        Iterator<WeakReference<InterfaceC06134n>> it = this.A03.iterator();
        while (it.hasNext()) {
            WeakReference<InterfaceC06134n> next = it.next();
            if (next.get() == null) {
    ...
    public void A07(int i10) {
        synchronized (this.A02) {
            ...
            while (it.hasNext()) {
                WeakReference<InterfaceC06134n> next = it.next();
                InterfaceC06134n interfaceC06134n = next.get();
                if (interfaceC06134n != null) {
                    interfaceC06134n.AF1(i10);
                } else {
                    this.A03.remove(next);
                }
            }
    ...
    public final void A0A(final InterfaceC06134n interfaceC06134n) {
        A05();
        this.A03.add(new WeakReference<>(interfaceC06134n));
        this.A01.post(new Runnable() { // from class: com.facebook.ads.redexgen.X.4j
            @Override // java.lang.Runnable
            public final void run() {
                this.A01.A0B(interfaceC06134n);
            }
        });
    }

    public final /* synthetic */ void A0B(InterfaceC06134n interfaceC06134n) {
        interfaceC06134n.AF1(A09());
    }
}
