...
public final class AnonymousClass55 extends AbstractC0953Ij {
    ...
    public M3 A06;
    public C1491bT A07;
    public ViewOnClickListenerC1012Kr A08;
    public C1543cJ A09;
    public EnumC1701et A0A;
    public boolean A0B;
    public boolean A0C;
    public boolean A0D;
    public boolean A0E;
    ...
    public final AbstractC1066Mt A0S;
    public final C1072Na A0T;
    public final C1814gi A0U;
    public final VI A0V;
    public final AbstractC1349Yb A0W;
    public final LK A0X;
    public final InterfaceC1492bU A0Y;
    public final InterfaceC1634dm A0Z;
    public final C0861Eu A0a;
    public final C0851Ek A0b;
    ...
    public final E2 A0g;
    public final E0 A0h;
    public final AbstractC0840Dz A0i;
    public final C0818Dd A0j;
    public final DZ A0k;
    ...
    public AnonymousClass55(C1814gi c1814gi, VA va, AbstractC1349Yb abstractC1349Yb, AbstractC1979jd abstractC1979jd, C1220Sx c1220Sx, ZU zu, int i10, InterfaceC1355Yh interfaceC1355Yh, VI vi, int i11, boolean z10, boolean z11, InterfaceC1634dm interfaceC1634dm, int i12, int i13) {
        C1072Na c1072NaA00;
        super(c1814gi, zu, va, abstractC1979jd, i10, z10, z11, interfaceC1355Yh, i13);
        this.A0H = false;
        this.A0G = false;
        this.A0F = false;
        this.A01 = 0;
        ...
        this.A0l = new RunnableC1627df(this);
        this.A0E = false;
        this.A00 = 0.0f;
        this.A0B = true;
        this.A0C = false;
        ...
        this.A0h = new E0() { // from class: com.facebook.ads.redexgen.X.5D
            ...
            public final void A03(E1 e12) {
                if (!this.A00.A0M) {
                    this.A00.A0M = true;
                    this.A00.A0U.A0F().AKh(XL.A00((float) ((AbstractC0953Ij) this.A00).A06.A0k()), this.A00.getResources().getConfiguration().orientation, true, true, AbstractC1066Mt.A0A());
        ...
        this.A0g = new E2() { // from class: com.facebook.ads.redexgen.X.5B
            ...
            public final void A03(E3 e32) {
                if (!((AbstractC0953Ij) this.A00).A0A.A07()) {
                    this.A00.A1F();
                }
            }
        };
        ...
        this.A0i = new AbstractC0840Dz() { // from class: com.facebook.ads.redexgen.X.58
            /* JADX INFO: Access modifiers changed from: private */
            @Override // com.instagram.common.viewpoint.core.UN
            /* renamed from: A00, reason: merged with bridge method [inline-methods] */
        ...
        this.A0d = new EA() { // from class: com.facebook.ads.redexgen.X.57
            ...
            public final void A03(C4K c4k) {
                ...
                this.A00.A0b.A0e(EnumC1701et.A02, 28);
            }
        };
        this.A0e = new AnonymousClass56(this);
        this.A0Y = new HW(this);
        this.A0W = abstractC1349Yb;
        this.A0O = i12;
        this.A0P = new Handler(Looper.getMainLooper());
        this.A0S = C1067Mu.A01(c1814gi, va, abstractC1979jd.A2E(), XB.A00(abstractC1979jd.A29().A0J().A05()), new HashMap(), false, true, abstractC1979jd.A2A());
        this.A0U = c1814gi;
        this.A0V = vi;
        this.A0j = new C0818Dd(this.A0U, this.A0V);
        this.A0k = new DZ(this.A0U, i12);
        this.A0Z = interfaceC1634dm;
        if (i11 == 1) {
            c1072NaA00 = super.A06.A28().A01();
        } else {
            c1072NaA00 = super.A06.A28().A00();
        }
        this.A0T = c1072NaA00;
        AbstractC1515br.A00(this.A0U, this, abstractC1979jd.A29().A0H().A08());
        this.A0b = new C0851Ek(this.A0U);
        this.A0b.getEventBus().A03(this.A0h, this.A0g, this.A0f, this.A0i, this.A0d, this.A0e);
        this.A0c = new C4L(c1814gi, va, this.A0b, abstractC1979jd.A2E());
        A0U();
        String videoUrl = super.A06.A29().A0H().A09();
        this.A0b.setVideoURI(c1220Sx.A0T(videoUrl));
        this.A0N = (float) abstractC1979jd.A0k();
        A0Q();
        A0M();
        A0L();
        this.A0X = A0D();
        ...
        if (C1264Up.A1z(this.A0U)) {
            VM vmA0B = this.A0U.A0B();
            C0851Ek c0851Ek = this.A0b;
            String videoUrl2 = super.A06.A2E();
            vmA0B.AKn(c0851Ek, videoUrl2, true);
        }
        if (C1264Up.A20(this.A0U)) {
            this.A0a = new C0861Eu(this.A0U, va, this.A0b, super.A06.A2E(), false, this.A0c, null);
        } else {
            this.A0a = null;
        }
        A0d(abstractC1979jd.A29());
        this.A0m = super.A06.A1m();
        this.A0n = super.A06.A1z();
        A0P();
        c1814gi.A0F().ACI(this.A0m, this.A0n, true);
    ...
    private LK A0D() {
        ...
        if (super.A06.A10().equals(A0J(49, 14, 78))) {
            strA0J = EnumC1707ez.A04.A03();
        } else {
            strA0J = A0J(12, 37, 68);
        }
        LK lkA03 = new C1516bs(this.A0N, strA0J, this.A0U, getColors(), super.A06, super.A0B, this.A08, AbstractC0953Ij.A0G, false, super.A08, super.A0D, super.A0A, this.A0k, this.A0V, true).A03();
    ...
    private void A0K() {
        this.A09 = new C1543cJ(this.A0U, super.A06, this.A0V, this.A0Q, super.A0B);
        this.A09.A0I(false);
    ...
    private void A0P() {
        ...
        new LM(this.A02, this.A0U).A04().A06(new C0920Hc(this)).A07(super.A06.A29().A0H().A08());
    }

    private void A0Q() {
        postDelayed(new C0931Hn(this), C1264Up.A0P(this.A0U));
    }
    ...
    private void A0S() {
        if (super.A06.A1X() && this.A0S != null && XL.A03(this.A0N)) {
            this.A07 = new C1491bT(this.A0U, super.A0B, super.A06.A0l(), this.A0S, this.A0X.getCTAButton(), this.A0X);
            addView(this.A07.getBrowserPeekView());
            this.A0R.postDelayed(new RunnableC1624dc(this), 5900L);
        }
    }

    private void A0T() {
        if (super.A06.A1e()) {
            this.A0b.setOnClickListener(new ViewOnClickListenerC1630di(this));
        }
        YB.A0J(this.A0b);
        YB.A0K(this.A0b);
        addView(this.A0b, new RelativeLayout.LayoutParams(-1, -2));
        this.A08 = new ViewOnClickListenerC1012Kr(this.A0U, super.A06, this.A0T, super.A08, super.A0B, super.A0D, super.A0A, (InterfaceC1329Xh) null);
        YB.A0G(1001, this.A08);
        if (C1264Up.A17(this.A0U)) {
            View.OnClickListener onClickListener = new ViewOnClickListenerC1622da(this);
            this.A0X.setCTAClickListener(onClickListener);
            if (this.A0W != null) {
                View.OnClickListener onClickListener2 = new ViewOnClickListenerC1623db(this);
    ...
    private void A0b(ViewGroup viewGroup, View view, AbstractC1349Yb abstractC1349Yb, int i10) {
        YB.A0d(this.A03);
        YB.A0J(abstractC1349Yb);
        RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-1, abstractC1349Yb.getToolbarHeight());
        layoutParams.addRule(10);
    ...
    private void A0c(ViewGroup viewGroup, View view, AbstractC1349Yb abstractC1349Yb, int i10) {
        YB.A0J(this.A03);
        YB.A0J(abstractC1349Yb);
        YB.A0J(this.A0X);
    ...
    public void A0o(C4A c4a) {
        if (this.A0b.getState() == EnumC1756fm.A02 && C1264Up.A1e(this.A0U)) {
            postDelayed(new C0930Hm(this, c4a), 5000L);
        }
    }
    ...
    public void A0p(String str) {
        M3 m32;
        YB.A0J(this.A06);
        C0935Hr c0935Hr = new C0935Hr(this);
        ...
        if (AbstractC1265Uq.A02(this.A0U) || this.A0U.A0E() == null) {
            m32 = new M3(this.A0U, c0935Hr);
        } else {
            m32 = new M3(this.A0U, this.A0U.A0E(), c0935Hr);
        }
        this.A06 = m32;
    ...
    */
    ...
    public void A0w(boolean z10, boolean z11) {
        ...
        if (z11) {
            ...
            A0b(c0851Ek, c0851Ek2.getVideoView(), this.A0W, i10);
            return;
        }
    ...
    public final void A1G() {
        ...
        if (this.A0W != null && getAdDataBundle().A29().A0K().A00() > 0) {
            ...
            new Handler(Looper.getMainLooper()).postDelayed(new RunnableC1628dg(this), getAdDataBundle().A29().A0K().A00());
        }
    }
    ...
    public final void A1H() {
        ...
        c0851Ek.setVolume(secondsForNextCta);
        this.A0b.A0e(EnumC1701et.A02, 20);
        ...
        if (iA02 != 0) {
            ...
            if (iA02 < secondsForNextCta2) {
                ...
                new XO(iA02, new C0933Hp(this)).A07();
                return;
            }
        }
        this.A0W.setToolbarActionMode(8);
    ...
    */
    ...
    public final void A1K(boolean z10) {
        if (this.A0b.getState() == EnumC1756fm.A06 || this.A0A == null) {
            return;
        }
        if (!this.A0L || z10) {
            C0851Ek c0851Ek = this.A0b;
            EnumC1701et enumC1701et = this.A0A;
            String[] strArr = A0p;
    ...
    public C1632dk getFullScreenAdStyle() {
        return new C1632dk(true, C1632dk.A06, super.A06.A28().A01(), ViewOnClickListenerC1012Kr.A05(super.A06), super.A06.A28().A01().A08(true), super.A06.A29().A0H().A08());
    }
    ...
    private ViewOnClickListenerC1012Kr getRegularCtaForEndCard() {
        ViewOnClickListenerC1012Kr viewOnClickListenerC1012Kr = new ViewOnClickListenerC1012Kr(this.A0U, super.A06.A0w(), super.A06.A28().A01(), super.A08, super.A0B, (C1759fp) null, super.A0A, super.A06.A2A());
        viewOnClickListenerC1012Kr.setViewShowsOverMedia(true);
        YB.A0K(viewOnClickListenerC1012Kr);
        viewOnClickListenerC1012Kr.setText(super.A06.A29().A0J().A04());
        YB.A0G(1001, viewOnClickListenerC1012Kr);
        viewOnClickListenerC1012Kr.setCta(super.A06.A29().A0J(), super.A06.A2E(), new HashMap(), null);
    ...
    private void setUpBrowserControls(M3 m32) {
        ...
        this.A04.setListener(new C0934Hq(this));
        this.A03.addView(this.A04, layoutParams);
        if (this.A05 != null) {
            YB.A0J(this.A05);
        }
        this.A05 = new C1443ah(this.A0U, null, R.attr.progressBarStyleHorizontal);
