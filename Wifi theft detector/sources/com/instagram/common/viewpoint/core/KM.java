...
public final class KM {
    ...
    public KM(String str, String str2, long j10, long j11, KT kt, String[] strArr, String str3, String str4, KM km) {
        this.A07 = str;
        this.A08 = str2;
        this.A05 = str4;
        this.A04 = kt;
        ...
        this.A02 = j10;
        this.A01 = j11;
        this.A06 = (String) AbstractC05983y.A01(str3);
        this.A03 = km;
        this.A0B = new HashMap<>();
        this.A0A = new HashMap<>();
    }

    public static SpannableStringBuilder A00(String str, Map<String, C05883o> map) {
        if (!map.containsKey(str)) {
            C05883o c05883o = new C05883o();
            c05883o.A0G(new SpannableStringBuilder());
            map.put(str, c05883o);
        }
        C05883o regionOutput = map.get(str);
        return (SpannableStringBuilder) AbstractC05983y.A01(regionOutput.A0I());
    }

    public static KM A01(String str) {
        return new KM(null, KO.A04(str), C.TIME_UNSET, C.TIME_UNSET, null, null, A03(0, 0, 119), null, null);
    }

    public static KM A02(String str, long j10, long j11, KT kt, String[] strArr, String str2, String str3, KM km) {
        return new KM(str, null, j10, j11, kt, strArr, str2, str3, km);
    }
    ...
    */
    private void A06(long r21, java.util.Map<java.lang.String, com.instagram.common.viewpoint.core.KT> r23, java.util.Map<java.lang.String, com.instagram.common.viewpoint.core.KN> r24, java.lang.String r25, java.util.Map<java.lang.String, com.instagram.common.viewpoint.core.C05883o> r26) {
        /*
            r20 = this;
            r2 = r20
            r3 = r25
        ...
        L54:
            ...
            com.facebook.ads.redexgen.X.3o r0 = (com.instagram.common.viewpoint.core.C05883o) r0
            java.lang.Object r10 = com.instagram.common.viewpoint.core.AbstractC05983y.A01(r0)
            com.facebook.ads.redexgen.X.3o r10 = (com.instagram.common.viewpoint.core.C05883o) r10
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    private void A07(long r12, boolean r14, java.lang.String r15, java.util.Map<java.lang.String, com.instagram.common.viewpoint.core.C05883o> r16) {
        /*
    ...
    private void A09(Map<String, KT> map, C05883o c05883o, int i10, int i11, int i12) {
        KT ktA02 = KO.A02(this.A04, this.A0C, map);
        SpannableStringBuilder spannableStringBuilder = (SpannableStringBuilder) c05883o.A0I();
        if (spannableStringBuilder == null) {
            spannableStringBuilder = new SpannableStringBuilder();
            c05883o.A0G(spannableStringBuilder);
        }
        if (ktA02 != null) {
            KO.A06(spannableStringBuilder, i10, i11, ktA02, this.A03, map, i12);
            if (A03(13, 1, 127).equals(this.A07)) {
                if (ktA02.A04() != Float.MAX_VALUE) {
                    c05883o.A05((ktA02.A04() * (-90.0f)) / 100.0f);
                }
                if (ktA02.A0C() != null) {
                    c05883o.A0F(ktA02.A0C());
                }
                if (ktA02.A0B() != null) {
                    c05883o.A0E(ktA02.A0B());
                }
            }
        }
    }
    ...
    */
    ...
    public final List<C2324pT> A0E(long j10, Map<String, KT> map, Map<String, KN> map2, Map<String, String> imageMap) {
        ...
        for (Pair<String, String> pair : arrayList) {
            ...
            if (str != null) {
                ...
                KN kn = (KN) AbstractC05983y.A01(map2.get(pair.first));
                arrayList2.add(new C05883o().A0D(bitmapDecodeByteArray).A04(kn.A02).A0A(0).A07(kn.A01, 0).A09(kn.A05).A06(kn.A04).A03(kn.A00).A0B(kn.A08).A0H());
            }
        }
        for (Map.Entry entry : treeMap.entrySet()) {
            KN kn2 = (KN) AbstractC05983y.A01(map2.get(entry.getKey()));
            C05883o c05883o = (C05883o) entry.getValue();
            A08((SpannableStringBuilder) AbstractC05983y.A01(c05883o.A0I()));
            c05883o.A07(kn2.A01, kn2.A06);
            c05883o.A09(kn2.A05);
            c05883o.A04(kn2.A02);
            c05883o.A06(kn2.A04);
            c05883o.A08(kn2.A03, kn2.A07);
            c05883o.A0B(kn2.A08);
            arrayList2.add(c05883o.A0H());
        }
        return arrayList2;
    }
