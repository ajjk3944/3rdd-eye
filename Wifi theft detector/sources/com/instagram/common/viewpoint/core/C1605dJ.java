...
public final class C1605dJ {
    ...
    public WeakReference<C1598dC> A00;
    public WeakReference<InterfaceC0961Is> A01 = new WeakReference<>(null);
    public boolean A02 = false;
    public final C1814gi A03;
    public final C1585cz A04;
    ...
    public C1605dJ(C1814gi c1814gi, C1598dC c1598dC, VA va, C1585cz c1585cz, String str, String str2) {
        this.A03 = c1814gi;
        this.A00 = new WeakReference<>(c1598dC);
    ...
    private void A04() {
        InterfaceC0961Is uxListener = this.A01.get();
        if (uxListener == null) {
            return;
        }
        uxListener.close();
    ...
    private void A08() {
        InterfaceC0961Is uxActionsJavascriptListener = this.A01.get();
    ...
    private void A0A(C1598dC c1598dC, String str) throws JSONException {
        ...
        c1598dC.A0g(storageValue, strA012);
    }

    private void A0B(C1598dC c1598dC, String str) throws JSONException {
        JSONObject jSONObject = new JSONObject(str);
        ...
        c1598dC.A0f(strOptString2);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void A0C(EnumC1603dH enumC1603dH, String str) throws JSONException {
        switch (enumC1603dH.ordinal()) {
            case 0:
        ...
        switch (enumC1603dH.ordinal()) {
            ...
            case 4:
                ...
                break;
            case 6:
                c1598dC.A0i(A03(new JSONObject(str)));
                break;
            case 17:
                A0B(c1598dC, str);
                break;
    ...
    private void A0D(EnumC1603dH enumC1603dH, String str) throws JSONException {
        InterfaceC0961Is interfaceC0961Is = this.A01.get();
        if (interfaceC0961Is == null) {
        }
        switch (enumC1603dH.ordinal()) {
            case 12:
                A0E(interfaceC0961Is, str);
                break;
            case 13:
                interfaceC0961Is.AE4();
                break;
            case 14:
                interfaceC0961Is.AFz();
                break;
            case 15:
                A0G(interfaceC0961Is, str);
                break;
            case 16:
                A0F(interfaceC0961Is, str);
                break;
        }
    }

    private void A0E(InterfaceC0961Is interfaceC0961Is, String str) throws JSONException {
        JSONObject jSONObject = new JSONObject(str);
        String STATE_KEY = A01(87, 5, 115);
        interfaceC0961Is.AEu(jSONObject.optBoolean(STATE_KEY, false));
    }

    private void A0F(InterfaceC0961Is interfaceC0961Is, String str) throws JSONException {
        JSONObject jSONObject = new JSONObject(str);
        String PAUSED_BY_USER_KEY = A01(62, 12, 5);
        interfaceC0961Is.AGX(jSONObject.optBoolean(PAUSED_BY_USER_KEY, false));
    }

    private void A0G(InterfaceC0961Is interfaceC0961Is, String str) throws JSONException {
        JSONObject jSONObject = new JSONObject(str);
        String STARTED_BY_USER_KEY = A01(74, 13, 98);
        interfaceC0961Is.AGZ(jSONObject.optBoolean(STARTED_BY_USER_KEY, false));
    }
    ...
    private void A0I(JSONObject jSONObject) {
        ...
        if (TextUtils.isEmpty(productUrl)) {
            interfaceC0961Is.A9f();
        } else {
            interfaceC0961Is.A9g(productUrl);
        }
    }
    ...
    private void A0M(JSONObject jSONObject) {
        ...
        interfaceC0961Is.AGo(strOptString);
    }

    public final void A0N(InterfaceC0961Is interfaceC0961Is) {
        this.A01 = new WeakReference<>(interfaceC0961Is);
    }
    ...
    public void postMessage(String str) {
        Y4.A00(new RunnableC1602dG(this, str));
    }
}
