...
public final class C2022kL extends MZ {
  ...
  0x00aa: PHI (r8v2 long) = (r8v0 long), (r8v3 long) binds: [B:30:0x00d7, B:25:0x00a8] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    public static com.instagram.common.viewpoint.core.C2022kL A01(java.io.File r14, long r15, long r17, com.instagram.common.viewpoint.core.C1055Mi r19) throws java.lang.NumberFormatException {
        /*
            r12 = r17
            r10 = r15
        ...
        L1f:
            java.lang.String r3 = r14.getName()
        L23:
            java.util.regex.Pattern r0 = com.instagram.common.viewpoint.core.C2022kL.A04
        ...
        L50:
            r4 = 0
            java.lang.String[] r2 = com.instagram.common.viewpoint.core.C2022kL.A01
            r0 = 0
            r1 = r2[r0]
            r0 = 2
            r2 = r2[r0]
        ...
        L77:
            ...
            java.lang.String[] r1 = com.instagram.common.viewpoint.core.C2022kL.A01
            r0 = 7
            r1 = r1[r0]
            r0 = 17
            char r1 = r1.charAt(r0)
            ...
            r0 = 3
            r2[r0] = r1
            java.lang.Object r0 = com.instagram.common.viewpoint.core.AbstractC05983y.A01(r4)
            java.lang.String r0 = (java.lang.String) r0
        ...
        Lda:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C2022kL.A01(java.io.File, long, long, com.facebook.ads.redexgen.X.Mi):com.facebook.ads.redexgen.X.kL");
    }
    ...
    public static void A08() {
        A00 = new byte[]{93, -93, -21, -88, -93, -38, -19, -28, -28, -82, -76, -79, -81, -30, -76, -82, -30, -22, -79, -81, -30, -76, -82, -30, -22, -79, -81, -30, -76, -4, -73, -30, -76, -21, -2, -11, -86, -13, -67, -61, -64, -66, -15, -61, -67, -15, -7, -64, -66, -15, -61, -67, -15, -7, -64, -66, -15, -61, Flags.CD, -57, -15, -61, -6, 13, 4, -71, -40, -94, -42, -34, -91, -93, -42, -88, -94, -42, -34, -91, -93, -42, -88, -94, -42, -34, -91, -93, -42, -88, -16, -83, -42, -88, -33, -14, -23, -98};
    }
    ...
    public C2022kL(String str, long j10, long j11, long j12, File file) {
        super(str, j10, j11, j12, file);
    }

    public static C2022kL A02(File file, long j10, C1055Mi c1055Mi) {
        return A01(file, j10, C.TIME_UNSET, c1055Mi);
    }

    public static C2022kL A03(String str, long j10) {
        return new C2022kL(str, j10, -1L, C.TIME_UNSET, null);
    }

    public static C2022kL A04(String str, long j10, long j11) {
        return new C2022kL(str, j10, j11, C.TIME_UNSET, null);
    }
    ...
    public static File A06(File file, C1055Mi c1055Mi) throws NumberFormatException {
        String strA0l = null;
        String name = file.getName();
        Matcher matcher = A03.matcher(name);
        if (matcher.matches()) {
            String key = matcher.group(1);
            strA0l = C5C.A0l((String) AbstractC05983y.A01(key));
        } else {
            matcher = A02.matcher(name);
            if (matcher.matches()) {
                String key2 = matcher.group(1);
                Object objA01 = AbstractC05983y.A01(key2);
                String[] strArr = A01;
        ...
        File file2 = (File) AbstractC05983y.A02(file.getParentFile());
        int iA0B = c1055Mi.A0B(strA0l);
        String key3 = matcher.group(2);
        long j10 = Long.parseLong((String) AbstractC05983y.A01(key3));
        String key4 = matcher.group(3);
        File fileA05 = A05(file2, iA0B, j10, Long.parseLong((String) AbstractC05983y.A01(key4)));
    ...
    public final C2022kL A09(File file, long j10) {
        AbstractC05983y.A08(this.A05);
        return new C2022kL(this.A04, this.A02, this.A01, j10, file);
    }
}
