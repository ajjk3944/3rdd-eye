...
public final class C1186Ro {
    ...
    public C1186Ro(AudienceNetworkActivityApi audienceNetworkActivityApi, C1814gi c1814gi, AudienceNetworkActivity audienceNetworkActivity) {
    ...
    */
    private final boolean A03(com.instagram.common.viewpoint.core.WK r5) {
        /*
            r4 = this;
            com.facebook.ads.redexgen.X.WK r0 = com.instagram.common.viewpoint.core.WK.A0I
            if (r5 == r0) goto L56
            com.facebook.ads.redexgen.X.WK r0 = com.instagram.common.viewpoint.core.WK.A0H
            if (r5 == r0) goto L56
            com.facebook.ads.redexgen.X.WK r3 = com.instagram.common.viewpoint.core.WK.A08
            java.lang.String[] r2 = com.instagram.common.viewpoint.core.C1186Ro.A08
            r0 = 3
            r1 = r2[r0]
            r0 = 0
            r2 = r2[r0]
            ...
            r2[r0] = r1
            if (r5 == r3) goto L56
            com.facebook.ads.redexgen.X.WK r0 = com.instagram.common.viewpoint.core.WK.A05
            if (r5 == r0) goto L56
            com.facebook.ads.redexgen.X.WK r0 = com.instagram.common.viewpoint.core.WK.A0G
            if (r5 == r0) goto L56
            com.facebook.ads.redexgen.X.WK r3 = com.instagram.common.viewpoint.core.WK.A0J
            java.lang.String[] r2 = com.instagram.common.viewpoint.core.C1186Ro.A08
            r0 = 6
            r1 = r2[r0]
            r0 = 2
        ...
        L69:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C1186Ro.A03(com.facebook.ads.redexgen.X.WK):boolean");
    }

    public final void A04(WK wk, String str) {
        boolean z10 = !this.A03 || C1264Up.A23(this.A06);
        boolean shouldCallOnDestroy = this.A02;
        if (!shouldCallOnDestroy && z10) {
            boolean shouldCallOnDestroy2 = A03(wk);
            if (shouldCallOnDestroy2) {
                A09(EnumC1707ez.A03.A03(), str);
            } else {
    ...
    public final void A05(WK wk, String str) {
        if (A03(wk)) {
            A09(EnumC1707ez.A09.A03(), str);
        } else {
            A09(A00(WKSRecord.Service.EMFIS_CNTL, 35, 121), str);
        }
    }

    public final void A06(WK wk, String str) {
        if (A03(wk)) {
            A09(EnumC1707ez.A05.A03(), str);
        } else {
    ...
    public final void A07(WK wk, String str) {
        if (C1264Up.A1x(this.A06) && !this.A01 && !this.A00) {
            InterfaceC1040Lt interfaceC1040LtA0F = this.A06.A0F();
            String[] strArr = A08;
    ...
    public final void A09(String str, String str2) {
        if (A00(Sdk$SDKError.Reason.AD_LOAD_FAIL_RETRY_AFTER_VALUE, 47, 71).equals(str) || EnumC1707ez.A0A.A03().equals(str)) {
            this.A01 = true;
        }
        boolean zEquals = A00(WKSRecord.Service.EMFIS_CNTL, 35, 121).equals(str);
        if (A08[7].length() == 29) {
            throw new RuntimeException();
        }
        String[] strArr = A08;
        ...
        if (zEquals || EnumC1707ez.A09.A03().equals(str)) {
            this.A00 = true;
        }
