...
public final class ZX extends FrameLayout {
    ...
    public final /* synthetic */ void A05(C1381Zh c1381Zh, View view) {
        this.A02.A0F().AB2();
        c1381Zh.A01();
        A01();
    }
    ...
    private LinearLayout getAdHideView() {
        ...
        final C1381Zh c1381Zh = new C1381Zh(this.A02);
        c1381Zh.setData(A00(16, 4, 44), null);
        LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(-2, -2);
        layoutParams.gravity = 17;
        c1381Zh.setOnClickListener(new View.OnClickListener() { // from class: com.facebook.ads.redexgen.X.ZV
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.A00.A05(c1381Zh, view);
            }
        });
        linearLayout.addView(textView, undoAdHideParams);
        linearLayout.addView(c1381Zh, layoutParams);
        return linearLayout;
    }
}
