...
public abstract class C2L<K, V> extends AbstractC0782Bq<K, V> implements Serializable {
    ...
    public C2L(Map<K, Collection<V>> map) {
        AbstractC2044ki.A0C(map.isEmpty());
        this.A01 = map;
    }
    ...
    public void A0A(@CheckForNull Object key) {
        Collection<V> collection = (Collection) AbstractC2344po.A06(this.A01, key);
        if (collection != null) {
    ...
    public final Collection<V> A0B() {
        return new C2115ls(this);
    }

    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.2L != com.google.common.collect.AbstractMapBasedMultimap<K, V> */
    @Override // com.instagram.common.viewpoint.core.AbstractC0782Bq
    public Iterator<V> A0C() {
        return new C0786Bu(this);
    }
    ...
    public final List A0H(@ParametricNullness Object key, @CheckForNull List list, C2112lp ancestor) {
        if (list instanceof RandomAccess) {
            return new C2N(this, key, list, ancestor);
        }
        return new C0783Br(this, key, list, ancestor);
    }
    ...
    public final Map<K, Collection<V>> A0J() {
        ...
        return new C0785Bt(this, this.A01);
    }
    ...
    public final void A0L(Map<K, Collection<V>> map) {
        ...
        for (Collection<V> collection : map.values()) {
            AbstractC2044ki.A0C(!collection.isEmpty());
