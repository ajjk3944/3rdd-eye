...
public final class S6 implements NativeAdsManagerApi {
    ...
    public final void loadAds(NativeAdBase.MediaCacheFlag mediaCacheFlag) {
        EnumC1289Vq enumC1289Vq = EnumC1289Vq.A06;
        int i10 = this.A07;
        C1943iu c1943iu = this.A03;
        this.A03 = new C1943iu(this.A08, this.A09, enumC1289Vq, null, i10);
        if (this.A06) {
            this.A03.A06();
        }
        this.A03.A09(this.A04);
        this.A03.A08(new C1837h5(this, this.A08, mediaCacheFlag, this.A01));
        this.A03.A07();
    }
