...
public final class C7X extends AbstractC1934ik {
    ...
    public C7X(C1909iI c1909iI, String str) {
        super(c1909iI.A0B, str, A00(c1909iI));
        this.A01 = c1909iI;
    }

    public static C1908iH A00(C1909iI c1909iI) {
        return new C1908iH(c1909iI);
    }

    @Override // com.instagram.common.viewpoint.core.AbstractC1934ik
    ...
    public final void A09() {
        this.A00 = new C1925iZ(this.A01, this, A04());
    ...
    public final C1909iI A0E() {
        return this.A01;
    }

    public final void A0F(Ad ad, String str, AdExperienceType adExperienceType, boolean z10) {
        if (super.A00.A6U()) {
            return;
        }
        this.A01.A02(ad);
        ...
        this.A01.A08 = z10;
        if (AbstractC1267Us.A09(this.A02) && AbstractC1267Us.A0B(this.A02)) {
            if (AbstractC1267Us.A0M(str)) {
                A05();
                return;
            } else {
                A09();
