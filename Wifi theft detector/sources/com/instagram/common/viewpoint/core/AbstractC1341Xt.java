...
public abstract class AbstractC1341Xt {
    ...
    public static void A07() {
        A00 = new byte[]{13, 121, 86, 14, 68, 81, 121, 86, 14, 126, 68, 8, 95, Flags.CD, 120, 14, 12, 126, 100, 8, 127, 120, Flags.CD, 15, 125, 75, 76, 76, 91, 80, 74, 30, 77, 74, 95, 93, 85, 30, 74, 76, 95, 93, 91, 77, 65, 67, 0, 72, 79, 77, 75, 76, 65, 65, 69, 0, 79, 74, 93};
    }
    ...
    public static String A03(Context context, Throwable th) {
        int iA0M = C1264Up.A0M(context);
        int maxStacktraceLines = C1264Up.A03(context);
        return A06(th, iA0M, maxStacktraceLines, C1264Up.A1h(context));
    }
    ...
    public static String A06(Throwable th, int i10, int i11, boolean z10) {
        ...
        try {
            ...
            if (i10 >= 0) {
                qj = new QF(qj, i10, i10);
            }
            if (z10) {
                qj = new QJ(qj);
            }
            QL ql = new QL(qk, 1, qj);
            th.printStackTrace(new PrintWriter(new C1340Xs(ql)));
            ql.flush();
            return qk.toString();
    ...
    public static boolean A08(C1338Xq c1338Xq) {
        String middle = c1338Xq.A02();
        if (middle == null) {
            return false;
        }
        ...
        Iterator<String> it = c1338Xq.A00().iterator();
        while (it.hasNext()) {
            if (A0A(it.next())) {
                return true;
            }
