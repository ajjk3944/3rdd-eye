...
public final class YW {
    ...
    public static Map<String, String> A01(@Nullable C1814gi c1814gi) {
        Window window;
        ...
        try {
            map.put(A00(40, 3, 0), String.valueOf(A04(c1814gi)));
            ...
            InterfaceC1225Tc interfaceC1225TcA08 = c1814gi.A08();
            int type3 = AbstractC1226Td.A2T;
            interfaceC1225TcA08.ABC(A00(43, 5, 77), type3, new C1227Te(e10));
        }
        return map;
    }

    public static boolean A03(C1814gi c1814gi) {
        return !YC.A04(A01(c1814gi));
    }

    public static boolean A04(C1814gi c1814gi) {
        KeyguardManager keyguardManager = (KeyguardManager) c1814gi.getSystemService(A00(32, 8, 57));
