...
public class C1883hq extends RF {
    ...
    private final int A03(View view, int i10) {
        ...
        return A0N(r2A08.A0q(view) - r32.topMargin, r2A08.A0l(view) + r32.bottomMargin, r2A08.A0i(), r2A08.A0Z() - r2A08.A0f(), i10);
    }
    ...
    public int A0O(View view, int i10) {
        ...
        R3 r32 = (R3) view.getLayoutParams();
        return A0N(r2A08.A0m(view) - r32.leftMargin, r2A08.A0p(view) + r32.rightMargin, r2A08.A0g(), r2A08.A0j() - r2A08.A0h(), i10);
    }
    ...
    public C1883hq(Context context) {
    ...
    @Override // com.instagram.common.viewpoint.core.RF
    public final void A0H(int i10, int i11, RH rh, RD rd) {
        if (A06() == 0) {
            A09();
            if (A07[2].length() != 19) {
                throw new RuntimeException();
