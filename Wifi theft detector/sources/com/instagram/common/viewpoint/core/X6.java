...
public final class X6 {
    ...
    private int A00(C1814gi c1814gi) {
        PackageInfo packageInfo;
        try {
            PackageManager packageManager = c1814gi.getPackageManager();
    ...
    public static Intent A02(C1814gi c1814gi, Uri uri) {
        ...
        intentA01.putExtra(A07(288, 34, 93), c1814gi.getPackageName());
        intentA01.putExtra(A07(494, 14, 41), false);
        if (C1264Up.A24(c1814gi)) {
    ...
    public static Intent A03(C1814gi c1814gi, Uri uri) {
        Intent intentA01 = A01(uri);
        intentA01.setPackage(A07(322, 19, 35));
        intentA01.putExtra(A07(259, 8, 30), c1814gi.getPackageName());
        intentA01.putExtra(A07(694, 7, 6), true);
        return intentA01;
    }

    public static Uri A04(C1814gi c1814gi, Uri uri) {
    ...
    private final EnumC1063Mq A05(C1814gi c1814gi, Uri uri, String str, Map<String, String> map) throws C1316Ws {
        boolean zA05 = AbstractC1265Uq.A05(c1814gi);
        boolean isInAppBrowserEnabled = A0F(uri);
        if (isInAppBrowserEnabled && zA05) {
            A0C(c1814gi, uri, str, map);
            EnumC1063Mq enumC1063Mq = EnumC1063Mq.A08;
            if (A01[7].length() == 30) {
        ...
        c1814gi.A0F().A9x(zA05);
        A0A(c1814gi, uri);
        return EnumC1063Mq.A07;
    }

    public static EnumC1063Mq A06(X6 x62, C1814gi c1814gi, Uri uri, String str, Map<String, String> extraData) throws PackageManager.NameNotFoundException, C1316Ws {
        ...
        if (!isGooglePlayWebLink && !z10) {
            return x62.A05(c1814gi, uri, str, extraData);
        }
        try {
            x62.A0B(c1814gi, uri, str);
            return EnumC1063Mq.A03;
        } catch (X4 unused) {
            return x62.A05(c1814gi, uri, str, extraData);
        }
    }
    ...
    private void A0A(C1814gi c1814gi, Uri uri) throws C1316Ws {
        C1318Wu.A0D(c1814gi, A02(c1814gi, uri));
    }

    private final void A0B(C1814gi c1814gi, Uri uri, String str) throws PackageManager.NameNotFoundException, C1316Ws, X4 {
        if (A0H(c1814gi)) {
            if (C1264Up.A1I(c1814gi)) {
                ...
                if (!TextUtils.isEmpty(queryParameter)) {
                    ...
                    AbstractC1098Oa.A03(queryParameter, strA07, packageName);
                }
            }
            boolean z10 = (c1814gi.A0H().A01() && C1264Up.A1g(c1814gi)) || (C1264Up.A25(c1814gi) && A0I(c1814gi));
            if (!z10) {
                boolean shouldTryToOpenSplitScreen = C1264Up.A2S(c1814gi);
                if (shouldTryToOpenSplitScreen) {
                    boolean shouldTryToOpenSplitScreen2 = C1318Wu.A0E(c1814gi, A03(c1814gi, uri));
                    if (shouldTryToOpenSplitScreen2) {
                        return;
                    }
                }
            }
            boolean zA0M = A0M(c1814gi, uri, str);
            if (A01[3].charAt(29) != 'Z') {
            ...
            boolean shouldTryToOpenSplitScreen3 = A0K(c1814gi, uri);
            if (shouldTryToOpenSplitScreen3) {
                return;
            }
            Intent intentA02 = A02(c1814gi, uri);
            intentA02.setPackage(A07(322, 19, 35));
            if (Build.VERSION.SDK_INT >= 24 && z10) {
                intentA02.addFlags(268472320);
            }
            C1318Wu.A0D(c1814gi, intentA02);
            return;
        }
        throw new X4();
    }

    private void A0C(C1814gi c1814gi, Uri uri, String str, Map<String, String> map) {
        AdActivityIntent adActivityIntentA05 = C1318Wu.A05(c1814gi);
        if (!ProcessUtils.isRemoteRenderingProcess()) {
            adActivityIntentA05.addFlags(268435456);
        }
        adActivityIntentA05.putExtra(A07(734, 8, 68), WK.A03);
        adActivityIntentA05.putExtra(A07(Type.TKEY, 10, 107), uri.toString());
        ...
        try {
            C1318Wu.A0B(c1814gi, adActivityIntentA05);
        } catch (C1316Ws e10) {
            ...
            c1814gi.A08().ABC(A07(168, 11, 110), AbstractC1226Td.A0D, new C1227Te(cause2));
            Log.e(A07(149, 17, 28), A07(50, 90, 84), cause2);
        }
    }

    public static void A0D(X6 x62, C1814gi c1814gi, Uri uri, String str) {
        x62.A0N(c1814gi, uri, str);
    }

    public static void A0E(X6 x62, C1814gi c1814gi, Uri uri, String str) throws PackageManager.NameNotFoundException, C1316Ws {
        A06(x62, c1814gi, uri, str, null);
    }
    ...
    */
    public static boolean A0F(android.net.Uri r5) {
        ...
        L45:
            ...
            goto L20
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.X6.A0F(android.net.Uri):boolean");
    }

    private boolean A0G(C1814gi c1814gi) {
        if (!C1264Up.A1F(c1814gi)) {
            return false;
        }
        int deviceFBVersion = C1264Up.A0E(c1814gi);
        int iA00 = A00(c1814gi);
    ...
    private boolean A0H(C1814gi c1814gi) throws SecurityException {
        Intent playStoreIntent = new Intent(A07(186, 26, 10), XB.A00(A07(548, 34, 3)));
        Iterator<ResolveInfo> it = c1814gi.getPackageManager().queryIntentActivities(playStoreIntent, 0).iterator();
        do {
  ...
  0x0079: PHI (r5v2 java.lang.String) = (r5v0 java.lang.String), (r5v3 java.lang.String) binds: [B:33:0x00d7, B:19:0x0077] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public static boolean A0I(com.instagram.common.viewpoint.core.C1814gi r12) throws java.lang.IllegalAccessException, java.lang.NoSuchFieldException, android.content.res.Resources.NotFoundException, android.content.pm.PackageManager.NameNotFoundException, java.lang.IllegalArgumentException {
        /*
            Method dump skipped, instructions count: 221
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.X6.A0I(com.facebook.ads.redexgen.X.gi):boolean");
    }

    public static boolean A0J(C1814gi c1814gi) throws IllegalAccessException, NoSuchFieldException, PackageManager.NameNotFoundException, IllegalArgumentException {
        Activity activityA0E;
        PackageManager packageManager;
        ActivityInfo activityInfo;
        try {
            activityA0E = c1814gi.A0E();
            packageManager = c1814gi.getPackageManager();
        } catch (PackageManager.NameNotFoundException | IllegalAccessException | NoSuchFieldException e10) {
            c1814gi.A0F().AC5(e10.getMessage());
        }
    ...
    public static boolean A0K(C1814gi c1814gi, Uri uri) throws PackageManager.NameNotFoundException {
        String strA07 = A07(322, 19, 35);
        if (!C1264Up.A1H(c1814gi)) {
            return false;
        }
        ...
        try {
            ...
            if (packageInfo != null && !TextUtils.isEmpty(packageInfo.versionName)) {
                ...
                if (Integer.parseInt(strArrSplit[0]) < C1264Up.A0G(c1814gi)) {
                    c1814gi.A0F().ABH(3);
                    return false;
                }
            }
            Intent intent = new Intent(A07(186, 26, 10));
            String packageName = c1814gi.getPackageName();
            intent.setPackage(strA07);
            Uri hsdpUri = A04(c1814gi, uri);
            if (hsdpUri == null) {
                return false;
            }
            ...
            if (intent.resolveActivity(packageManager) != null) {
                Activity activityA0E = c1814gi.A0E();
                if (activityA0E == null) {
            ...
            InterfaceC1040Lt interfaceC1040LtA0F = c1814gi.A0F();
            String[] strArr = A01;
            if (strArr[2].length() == strArr[1].length()) {
                throw new RuntimeException();
            }
    ...
    private boolean A0L(C1814gi c1814gi, Uri uri, String str) throws C1316Ws {
        try {
            Activity activityA0E = c1814gi.A0E();
            String string = uri.toString();
            if (activityA0E != null && !TextUtils.isEmpty(string)) {
                Intent fbIntent = new Intent();
                if (C1264Up.A1G(c1814gi)) {
                    String strA06 = AbstractC1979jd.A06(str);
                ...
                fbIntent.putExtra(A07(WKSRecord.Service.EMFIS_DATA, 9, 22), string);
                fbIntent.putExtra(A07(37, 13, 89), A08(A07(20, 17, 90)));
                if (!C1318Wu.A0E(c1814gi, fbIntent)) {
            ...
            c1814gi.A0F().ABG(e10.getMessage());
            return false;
        }
    }

    private boolean A0M(C1814gi c1814gi, Uri uri, String str) throws C1316Ws {
        return A0G(c1814gi) && A0L(c1814gi, uri, str);
    }

    private final boolean A0N(C1814gi c1814gi, Uri uri, String str) {
        return C1318Wu.A0G(c1814gi, uri, str);
    }

    public static boolean A0O(X6 x62, C1814gi c1814gi, Uri uri, String str) {
        try {
            A0E(x62, c1814gi, uri, str);
            return true;
        } catch (C1316Ws e10) {
            Throwable cause = e10.getCause();
            Throwable cause2 = e10;
            ...
            c1814gi.A08().ABC(A07(168, 11, 110), AbstractC1226Td.A05, new C1227Te(cause2));
            return false;
        }
    }
}
