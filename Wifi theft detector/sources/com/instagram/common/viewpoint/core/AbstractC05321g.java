...
public abstract class AbstractC05321g extends AE {
    ...
    public InterfaceC07409s A0D;
    public InterfaceC07409s A0E;
    public B0 A0F;
    public B3 A0G;
    public BA A0H;
    public BC A0I;
    ...
    public final C2295p0 A0o;
    public final C2295p0 A0p;
    public final C06776z A0q;
    public final A6 A0r;
    public final BT A0s;
    ...
    public abstract boolean A23(long j10, long j11, B0 b02, ByteBuffer byteBuffer, int i10, int i11, long j12, boolean z10, boolean z11) throws AD;

    static {
        A15();
        A13 = new byte[]{0, 0, 1, 103, 66, -64, Flags.CD, -38, 37, -112, 0, 0, 1, 104, -50, 15, 19, 32, 0, 0, 1, 101, -120, -124, 13, -50, 113, 24, -96, 0, 47, -65, 28, 49, -61, 39, 93, 120};
    }

    public AbstractC05321g(int i10, C1970jQ c1970jQ, MediaCodecRendererMetaParameters mediaCodecRendererMetaParameters, BT bt, A6 a62, boolean z10, boolean z11, int i11, int i12) {
        super(i10);
        this.A09 = C.TIME_UNSET;
        this.A08 = C.TIME_UNSET;
        this.A0k = false;
        this.A0i = false;
        AbstractC05983y.A08(C5C.A02 >= 16);
        this.A0z = (C1970jQ) AbstractC05983y.A01(c1970jQ);
        this.A0y = (MediaCodecRendererMetaParameters) AbstractC05983y.A01(mediaCodecRendererMetaParameters);
        this.A0s = (BT) AbstractC05983y.A01(bt);
        this.A0r = a62;
        this.A0x = z10;
        this.A0v = z11;
        this.A0m = i11;
        this.A0l = i12;
        this.A0o = new C2295p0(0);
        this.A0p = C2295p0.A02();
        this.A0q = new C06776z();
        ...
        this.A10 = MetaExoPlayerUpgradeConfig.A03(EnumC1974jX.A1g);
    }
    ...
    */
    private int A0w(java.lang.String r6) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.AbstractC05321g.A0w(java.lang.String):int");
    }
    ...
    private List<B3> A10(boolean z10) throws BX {
        ...
        if (listA1l.isEmpty() && z10) {
            ...
            if (!listA1l.isEmpty()) {
                AbstractC06064g.A07(A0x(Sdk$SDKError.Reason.AD_RESPONSE_RETRY_AFTER_VALUE, 18, 67), A0x(116, 40, 101) + this.A0g.A0W + A0x(0, 58, 73) + listA1l + A0x(58, 1, 35));
            }
        }
        if (listA1l.isEmpty() && this.A0j && (alternativeMimeType = C0766Ba.A0P(this.A0g)) != null) {
    ...
    private void A16(B3 b32, MediaCrypto mediaCrypto) throws Exception {
        ...
        try {
            ...
            new C2245oC().A00();
            b0A0K = B7.A02().A0K(A22(), this.A0z, this.A0y.getA00(), EnumC1967jL.A05, str);
            try {
                this.A0J = str;
            ...
            try {
                A1w(b32, b0A0K, this.A0g, mediaCrypto);
                AnonymousClass54.A00();
    ...
    private void A17(B3 b32, B3 b33, MediaCrypto mediaCrypto) throws Exception {
        int iA00 = MetaExoPlayerUpgradeConfig.A00(EnumC1975jY.A06);
        if (iA00 >= 0) {
            try {
                A16(b33, mediaCrypto);
                return;
                ...
                if (b33 == b32) {
                    AbstractC06064g.A07(A0x(Sdk$SDKError.Reason.AD_RESPONSE_RETRY_AFTER_VALUE, 18, 67), A0x(590, 63, 38));
                    Thread.sleep(iA00);
                    A16(b33, mediaCrypto);
                    return;
                }
    ...
    private boolean A19() {
        ...
        if (this.A08 == C.TIME_UNSET) {
            AbstractC06064g.A07(A0x(Sdk$SDKError.Reason.AD_RESPONSE_RETRY_AFTER_VALUE, 18, 67), A0x(95, 21, 98));
            try {
                this.A0L = null;
                A1n();
    ...
    private boolean A1A() throws AD {
        ...
        if (this.A0e) {
            ...
            boolean zA03 = MetaExoPlayerUpgradeConfig.A03(EnumC1974jX.A0z);
        ...
        if (this.A0o.A05()) {
            ...
            try {
                ...
                C2374qI c2374qI = this.A0g;
                int adaptiveReconfigurationBytes = e10.getErrorCode();
                throw A1S(e10, c2374qI, C5C.A02(adaptiveReconfigurationBytes));
            }
        }
        ...
        try {
            ...
            C2374qI c2374qI2 = this.A0g;
            int adaptiveReconfigurationBytes2 = e11.getErrorCode();
            throw A1S(e11, c2374qI2, C5C.A02(adaptiveReconfigurationBytes2));
        }
    }
    ...
    private boolean A1C(int i10) throws AD {
        ...
        this.A0p.A0A();
        int iA1R = A1R(c06776zA1U, this.A0p, i10 | 4);
        if (iA1R == -5) {
            A1s(c06776zA1U.A00);
            return true;
        }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    private boolean A1E(long r21, long r23) throws com.instagram.common.viewpoint.core.AD {
        /*
            Method dump skipped, instructions count: 450
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.AbstractC05321g.A1E(long, long):boolean");
    }
        ...
        if (!this.A0L.isEmpty()) {
            ...
            do {
                ...
                try {
                    ...
                    AbstractC06064g.A0A(A0x(Sdk$SDKError.Reason.AD_RESPONSE_RETRY_AFTER_VALUE, 18, 67), A0x(156, 30, 18) + b3PeekFirst2, e11);
    ...
    public static boolean A1G(C2374qI c2374qI) {
        return c2374qI.A07 == 0 || c2374qI.A07 == 2;
    }
    ...
    */
    public static boolean A1I(java.lang.String r6) {
        /*
            ...
            java.lang.String[] r2 = com.instagram.common.viewpoint.core.AbstractC05321g.A12
            r0 = 4
            r1 = r2[r0]
            r0 = 3
            r0 = r2[r0]
        ...
        L34:
            ...
            r0 = 19
            if (r1 > r0) goto L96
            java.lang.String r3 = com.instagram.common.viewpoint.core.C5C.A03
        ...
        L98:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.AbstractC05321g.A1I(java.lang.String):boolean");
    }
    ...
    public static boolean A1L(String str, C2374qI c2374qI) {
        return C5C.A02 < 21 && c2374qI.A0X.isEmpty() && A0x(306, 25, 22).equals(str);
    }

    public static boolean A1M(String str, C2374qI c2374qI) {
        return C5C.A02 <= 18 && c2374qI.A06 == 1 && A0x(281, 25, 33).equals(str);
    }
    ...
    private boolean A1N(boolean z10) throws AD {
        ...
        C07389q c07389q = (C07389q) AbstractC05983y.A01(this.A0D.A80());
        C07389q c07389qA80 = this.A0D.A80();
        C2374qI c2374qI = this.A0g;
        int drmSessionState = c07389q.A00;
        throw A1S(c07389qA80, c2374qI, drmSessionState);
    }
    ...
    @Override // com.instagram.common.viewpoint.core.AE
    public void A1c(C2374qI[] c2374qIArr, long j10, long j11) throws AD {
    }
    ...
    public void A1n() {
        ...
        if (this.A0F != null) {
            this.A0h.A03++;
            try {
                B7.A02().A0L(A22(), this.A0z, this.A0y.getA00(), EnumC1967jL.A05, this.A0J, this.A0F);
                this.A0F = null;
                InterfaceC07409s interfaceC07409s = this.A0D;
                String[] strArr = A12;
                if (strArr[6].length() == strArr[5].length()) {
                    String[] strArr2 = A12;
                    strArr2[7] = "JSCNcek9dAkyOPO1KkbpJsRj9JD6rmzz";
                    strArr2[1] = "RONQ7IAwO8Bcbv1Krrdz5fvlVLwlovmm";
                    if (interfaceC07409s != null && this.A0E != this.A0D) {
                        try {
                            this.A0D.AHc(null);
                            return;
                        } finally {
        ...
        try {
            ...
            if (this.A0m > 0 && (this.A09 == C.TIME_UNSET || System.currentTimeMillis() - this.A09 <= this.A0m)) {
                if (this.A09 == C.TIME_UNSET) {
                    ...
                    AbstractC06064g.A07(strA0x, mimeType2);
    ...
    public void A1r(C2374qI c2374qI) {
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public void A1s(com.instagram.common.viewpoint.core.C2374qI r9) throws com.instagram.common.viewpoint.core.AD {
        /*
            Method dump skipped, instructions count: 318
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.AbstractC05321g.A1s(com.facebook.ads.redexgen.X.qI):void");
    }

    public void A1t(C2374qI c2374qI) throws AD {
    }

    public void A1z(String str, C2374qI c2374qI) throws AD {
        A1t(c2374qI);
    }
    ...
    public final boolean A24(C2374qI c2374qI) {
        if (c2374qI == null || !this.A0k || !A0x(838, 10, 89).equalsIgnoreCase(c2374qI.A0W)) {
            return false;
        }
        return true;
    }
    ...
    public boolean AAe() {
        if (this.A0g == null) {
            super.A0B = EnumC1940ir.A07;
        } else if (this.A0e) {
            super.A0B = EnumC1940ir.A0A;
        } else if (!A1d() && !A1B()) {
            super.A0B = EnumC1940ir.A06;
        }
        if (this.A0g != null) {
    ...
    public final int AKM(C2374qI c2374qI) throws AD {
        try {
            return A1h(this.A0s, this.A0r, c2374qI);
        } catch (BX e10) {
            throw A1S(e10, c2374qI, 4002);
        }
    }

    @Override // com.instagram.common.viewpoint.core.AE, com.instagram.common.viewpoint.core.InterfaceC06937p
