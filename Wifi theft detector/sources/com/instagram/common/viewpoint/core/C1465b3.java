...
public class C1465b3 extends WebViewClient {
    ...
    public final WeakReference<C1759fp> A07;
    ...
    public C1465b3(C1814gi c1814gi, WeakReference<InterfaceC1463b1> weakReference, WeakReference<C1759fp> weakReference2, WeakReference<Y2> weakReference3, WeakReference<AtomicBoolean> checkAssetsByJavascriptBridge, WeakReference<LV> weakReference4, AtomicInteger atomicInteger, AtomicReference<String> requestId, boolean z10) {
        this.A02 = c1814gi;
    ...
    private WebResourceResponse A00() {
        return new WebResourceResponse(A01(Sdk$SDKError.Reason.AD_RESPONSE_INVALID_TEMPLATE_TYPE_VALUE, 10, 100), StandardCharsets.UTF_8.name(), TTAdConstant.DEEPLINK_UNAVAILABLE_CODE, A01(13, 6, 1), Collections.singletonMap(A01(0, 13, 79), A01(198, 8, 55)), new ByteArrayInputStream(A01(13, 6, 1).getBytes()));
    }
    ...
    private final void A04(WebResourceRequest webResourceRequest, WebResourceResponse webResourceResponse) throws JSONException {
        ...
        this.A02.A0F().AL2(webResourceResponse.getStatusCode(), AbstractC1323Xb.A01(webResourceResponse.getStatusCode(), A01(67, 10, 126), A01(0, 0, 53) + webResourceRequest.getUrl()));
    }
    ...
    private void A06(String str, String str2) throws JSONException {
        ...
        try {
            ...
            jSONObject.put(A01(Sdk$SDKError.Reason.AD_ALREADY_FAILED_VALUE, 10, 122), this.A09.get());
        } catch (JSONException unused) {
        }
        if (this.A02 != null) {
            this.A02.A08().ABC(A01(236, 8, 74), AbstractC1226Td.A2c, new C1227Te(AdErrorType.WEB_VIEW_CACHE_FILE_WAS_DENIED.getDefaultErrorMessage(), A01(55, 12, 23) + jSONObject.toString()));
        }
    }
    ...
    */
    private boolean A07(android.net.Uri r8) throws org.json.JSONException {
        /*
            ...
            java.lang.String[] r2 = com.instagram.common.viewpoint.core.C1465b3.A0C
            r0 = 3
            r1 = r2[r0]
            r0 = 6
            r0 = r2[r0]
        ...
        L6c:
            ...
            java.util.List r5 = com.instagram.common.viewpoint.core.C1220Sx.A09(r0)
        ...
        Lbb:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C1465b3.A07(android.net.Uri):boolean");
    }
    ...
    public final void onReceivedError(WebView webView, WebResourceRequest webResourceRequest, WebResourceError webResourceError) throws JSONException {
        boolean zA12 = C1264Up.A12(this.A02);
        ...
        if (zA12 || webResourceRequest.isForMainFrame()) {
            ...
            this.A02.A0F().AL1(AbstractC1323Xb.A01(webResourceError.getErrorCode(), strA01 + ((Object) webResourceError.getDescription()), strA01 + webResourceRequest.getUrl()));
        }
    }
    ...
    public final boolean onRenderProcessGone(WebView webView, RenderProcessGoneDetail renderProcessGoneDetail) {
        AbstractC1460ay.A0D(AbstractC1226Td.A2b);
        InterfaceC1463b1 adWebViewListener = this.A04.get();
    ...
    public final boolean shouldOverrideUrlLoading(WebView webView, String str) {
        if (this.A04.get() != null) {
            this.A04.get().ADN(str, new C1471b9().A03(this.A07.get()).A02(this.A06.get()).A05());
        }
