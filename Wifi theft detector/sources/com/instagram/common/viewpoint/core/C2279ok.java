...
public class C2279ok implements AnonymousClass78 {
    ...
    public long A00;
    public long A01;
    public C2353px A02 = C2353px.A06;
    public boolean A03;
    public final AnonymousClass45 A04;

    public C2279ok(AnonymousClass45 anonymousClass45) {
    ...
    @Override // com.instagram.common.viewpoint.core.AnonymousClass78
    public void AJd(C2353px c2353px) {
        if (this.A03) {
            long jA8p = A8p();
            String[] strArr = A05;
