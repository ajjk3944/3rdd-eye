...
public class C2211nd<K, V> extends AbstractSet<Map.Entry<K, V>> {
    ...
    public C2211nd(final C2215nh this$0) {
        this.A00 = this$0;
    }
    ...
    public final boolean remove(@CheckForNull Object o10) {
        ...
        Map.Entry entry = (Map.Entry) o10;
        if (this.A00.A0p() || (iA06 = AbstractC2218nk.A06(entry.getKey(), entry.getValue(), (iA00 = this.A00.A00()), this.A00.A0C(), this.A00.A0T(), this.A00.A0V(), this.A00.A0W())) == -1) {
            return false;
        }
