...
public final class C3L extends ED implements View.OnClickListener {
    ...
    public final E2 A02;
    public final E0 A03;
    public final C1726fI A04;

    public C3L(C1814gi c1814gi) {
        this(c1814gi, null);
    }

    public C3L(C1814gi c1814gi, AttributeSet attributeSet) {
        this(c1814gi, attributeSet, 0);
    }

    public C3L(C1814gi c1814gi, AttributeSet attributeSet, int i10) {
    ...
    public final void onClick(View view) throws Throwable {
        ...
        try {
            C0851Ek videoView = getVideoView();
            if (videoView == null) {
                return;
            }
            if (videoView.getState() == EnumC1756fm.A07 || videoView.getState() == EnumC1756fm.A05 || videoView.getState() == EnumC1756fm.A06) {
                videoView.A0e(EnumC1701et.A04, 11);
            } else if (videoView.getState() == EnumC1756fm.A0A) {
