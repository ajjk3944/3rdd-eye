...
public final class ImfSpecParser {
    ...
    public static void A02() {
        A00 = new byte[]{23, 29, 26, 45, 26, 12, 30, 32, 38, 30, 39, 45, 44, 8, 5, 24, 5, -8, 22, 5, 7, 15, 61, 70, 60, 44, 65, 69, 61, 72, 76, 69, 40, 77, 75, 72, 77, 68, 50, 79, 68, 66, 15, 2, 9, -2, 17, 6, 19, 2, -27, 2, 6, 4, 5, 17, 47, 34, 41, 30, 49, 38, 51, 34, 20, 38, 33, 49, 37, 98, 85, 92, 81, 100, 89, 102, 85, 72, 41, 28, 35, 24, 43, 32, 45, 28, 16, 15, 12, 17, -2, 17, 6, 12, Flags.CD, -31, 2, 4, 15, 2, 2, 16, 58, 44, 46, 52, 44, 53, 59, Flags.CD, 40, 59, 40, 17, 58, 54, 53, 108, 109, 90, 107, 109, 77, 98, 102, 94, 23, 24, 13, 7, 15, 9, 22, -27, 23, 23, 9, 24, -19, 8, 20, 21, 10, 4, 12, 6, 19, -11, 26, 17, 6, 104, 93, 97, 89, 70, 85, 98, 91, 89, 106, 95, 99, 91, 76, 87, 98, 107, 91, 105, 103, 86, 88, 96, 56, 100, 98, 101, 100, 104, 94, 105, 94, 100, 99, 104, 48, 46, 29, 31, 39, 0, 29, 48, 29, 6, 47, 43, 42, -12, -14, -31, -29, -21, -50, -31, -19, -27};
    }

    @JvmStatic
    public static final List<ImfDataTrack> A01(String str) throws JSONException {
        C2388qY.A09(str, A00(29, 13, 101));
        ...
        for (int i10 = 0; i10 < length; i10++) {
            ...
            String string2 = jSONObject.getString(A00(WKSRecord.Service.EMFIS_DATA, 11, 39));
            String string3 = jSONObject.getString(A00(126, 14, 42));
            C2388qY.A06(string2);
            C2388qY.A06(string3);
            C1956j7 c1956j7 = new C1956j7(string2, string3);
            ...
            for (int i11 = 0; i11 < length2; i11++) {
                ...
                C2388qY.A06(string);
                arrayList.add(new ImfDataTrack(string, j10, j11, c1956j7, new C1955j6(jSONObject3.getDouble(A00(69, 9, 118)), jSONObject3.getDouble(A00(78, 9, 61)), jSONObject3.getDouble(A00(56, 13, 67)), jSONObject3.getDouble(A00(42, 14, 35)), jSONObject3.getDouble(A00(87, 15, 35)))));
            }
        }
        return arrayList;
    }
