...
public final class C1682ea {
    ...
    public C1682ea(C1814gi c1814gi, ZU zu, String str, InterfaceC1355Yh interfaceC1355Yh) {
        this.A01 = c1814gi;
        this.A03 = zu;
        this.A04 = str;
        this.A02 = interfaceC1355Yh;
    }
    ...
    public final void A06() {
        if (!TextUtils.isEmpty(this.A04)) {
            AsyncTaskC1785gF asyncTaskC1785gF = new AsyncTaskC1785gF(this.A01, new HashMap());
            asyncTaskC1785gF.A07(new F8(this));
            asyncTaskC1785gF.executeOnExecutor(this.A00, this.A04);
        }
    }
}
