...
public class AN extends BS<String, List<String>> {
    ...
    @Override // com.instagram.common.viewpoint.core.AbstractC2246oD
    ...
    public final Set<Map.Entry<String, List<String>>> entrySet() {
        return AbstractC2397qj.A07(super.entrySet(), new InterfaceC2045kj() { // from class: com.facebook.ads.redexgen.X.pC
    ...
    public final Set<String> keySet() {
        return AbstractC2397qj.A07(super.keySet(), new InterfaceC2045kj() { // from class: com.facebook.ads.redexgen.X.pD
            @Override // com.instagram.common.viewpoint.core.InterfaceC2045kj
            public final boolean A4C(Object obj) {
