...
public abstract class AbstractC1202Sf {
    ...
    public static SX A02(T8 t82) {
        ...
        Method methodA02;
        Object objA002;
        Method methodA022 = AbstractC1203Sg.A02(A00, A04(257, 29, 2), Context.class);
        if (methodA022 == null || (objA00 = AbstractC1203Sg.A00(null, methodA022, t82)) == null || ((Integer) objA00).intValue() != 0 || (methodA02 = AbstractC1203Sg.A02(A04(65, 57, 83), A04(232, 20, 98), Context.class)) == null || (objA002 = AbstractC1203Sg.A00(null, methodA02, t82)) == null) {
            return null;
        }
        Method methodA01 = AbstractC1203Sg.A01(objA002.getClass(), A04(252, 5, 124), new Class[0]);
        Method methodA012 = AbstractC1203Sg.A01(objA002.getClass(), A04(286, 24, 126), new Class[0]);
        if (methodA01 == null || methodA012 == null) {
            return null;
        }
        String str = (String) AbstractC1203Sg.A00(objA002, methodA01, new Object[0]);
        Boolean bool = (Boolean) AbstractC1203Sg.A00(objA002, methodA012, new Object[0]);
        if (str != null) {
    ...
    */
    public static com.instagram.common.viewpoint.core.SX A00(com.instagram.common.viewpoint.core.T8 r5) {
        /*
            ...
            java.lang.String[] r1 = com.instagram.common.viewpoint.core.AbstractC1202Sf.A02
            r0 = 5
            r1 = r1[r0]
            r0 = 3
            ...
            throw r0
        L2c:
            java.lang.String[] r2 = com.instagram.common.viewpoint.core.AbstractC1202Sf.A02
        ...
        L4a:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.AbstractC1202Sf.A00(com.facebook.ads.redexgen.X.T8):com.facebook.ads.redexgen.X.SX");
    }
    ...
    public static SX A03(T8 t82) {
        ServiceConnectionC1201Se serviceConnectionC1201Se = new ServiceConnectionC1201Se();
        Intent intent = new Intent(A04(122, 51, 31));
        intent.setPackage(A04(43, 22, 97));
        if (t82.bindService(intent, serviceConnectionC1201Se, 1)) {
            try {
                final IBinder iBinderA02 = serviceConnectionC1201Se.A02();
                ...
                try {
                    t82.A08().ABC(A04(225, 7, 73), AbstractC1226Td.A1Q, new C1227Te(th));
                } finally {
                    t82.unbindService(serviceConnectionC1201Se);
                }
            }
        }
        return null;
