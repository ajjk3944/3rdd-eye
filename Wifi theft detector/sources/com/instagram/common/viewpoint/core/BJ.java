...
public abstract class BJ implements InterfaceC2025kO<Map.Entry<?, ?>, Object> {
    ...
    static {
        ...
        final int i11 = 1;
        A03 = new BJ(strA012, i11) { // from class: com.facebook.ads.redexgen.X.2G
            {
                BL bl = null;
            }
    ...
    public /* synthetic */ BJ(String str, int i10, BL bl) {
        this(str, i10);
    }
