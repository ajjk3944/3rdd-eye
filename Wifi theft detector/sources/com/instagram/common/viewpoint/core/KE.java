...
public final class KE extends AbstractC1527c3 {
    ...
    public TextView A0D;
    public AbstractC1979jd A0E;
    public AbstractRunnableC1301Wc A0F;
    public M6 A0G;
    public C1443ah A0H;
    public M3 A0I;
    public C1531c7 A0J;
    ...
    public final AbstractC1066Mt A0b;
    public final VI A0c;
    public final InterfaceC1492bU A0d;
    public final InterfaceC1505bh A0e;
    public final C1506bi A0f;
    public final DZ A0g;
    ...
    public KE(C1531c7 c1531c7) {
        ...
        this.A0h = new RunnableC1548cO(this);
        this.A0N = false;
        this.A08 = new Handler(Looper.getMainLooper());
        this.A0A = (InputMethodManager) c1531c7.A06().getSystemService(A0I(12, 12, 29));
        this.A0J = c1531c7;
        this.A0E = this.A0J.A05();
        this.A0c = new VI(c1531c7.A05().A2E(), c1531c7.A07());
        this.A0g = this.A0J.A0E();
        if (this.A0g != null) {
            YB.A0K(this.A0g);
        }
        this.A0a = this.A0J.A03();
        this.A0b = C1067Mu.A01(c1531c7.A06(), c1531c7.A07(), c1531c7.A05().A2E(), XB.A00(c1531c7.A05().A29().A0J().A05()), new HashMap(), false, true, this.A0E.A2A());
        ...
        C0851Ek c0851Ek = this.A0J.A02() instanceof C0851Ek ? (C0851Ek) this.A0J.A02() : null;
        this.A0f = new C1506bi(c1531c7, this.A0E, c0851Ek, this.A0J.A0C(), this.A0e, this.A0D, this.A0K, this.A0g, this.A0a);
        if (c0851Ek != null && C1264Up.A1L(getAdContextWrapper())) {
            AbstractC1474bC.A00(c0851Ek.getVideoImplView(), C1264Up.A1M(getAdContextWrapper()), new ViewOnClickListenerC1549cP(this));
        } else if (c0851Ek == null && this.A09 != null && C1264Up.A1J(getAdContextWrapper())) {
            AbstractC1474bC.A00(this.A09, C1264Up.A1K(getAdContextWrapper()), new ViewOnClickListenerC1550cQ(this));
        }
        this.A0i = c1531c7.A05().A1m();
        this.A0j = c1531c7.A05().A1z();
        getAdContextWrapper().A0F().ACI(this.A0i, this.A0j, c1531c7.A05().A2L());
    }
    ...
    private void A0M() {
        ...
        if (this.A0J.A05().A1x() && (abstractC1349YbA0B = this.A0J.A0B()) != null) {
    ...
    private void A0O() {
        if (this.A0a != null) {
            YB.A0J(this.A0a);
            RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(AbstractC1527c3.A09, AbstractC1527c3.A09);
            layoutParams.addRule(10);
            layoutParams.addRule(11);
            layoutParams.setMargins(AbstractC1527c3.A08, this.A06, AbstractC1527c3.A08, AbstractC1527c3.A08);
    ...
    private void A0Q() {
        AbstractC1349Yb abstractC1349YbA0B = this.A0J.A0B();
        if (abstractC1349YbA0B == null) {
            return;
        }
        abstractC1349YbA0B.setPageDetailsVisible((this.A0M || abstractC1349YbA0B.A0E()) ? false : true);
    }
    ...
    private void A0R() {
        ...
        if (this.A09 != null) {
            if (this.A0E.A1e()) {
                this.A09.setOnClickListener(new ViewOnClickListenerC1551cR(this));
            }
            YB.A0J(this.A09);
            YB.A0K(this.A09);
        ...
        YB.A0K(this.A0D);
        this.A0K = new C1563cd(this.A0J.A06(), getCtaButton(), this.A0J.A05(), this.A0J.A07(), this.A0J.A0C(), this.A0J.A0F(), this.A0J.A0A(), getColors(), this.A0d);
        this.A0K.setAutoClickTime(this.A0J.A05(), this.A0J.A0B());
        YB.A0G(TTAdConstant.IMAGE_MODE_1010, this.A0K);
        addView(this.A0K);
        A0U();
        A0J();
        if (C1264Up.A17(this.A0J.A06())) {
            View.OnClickListener onClickListener = new ViewOnClickListenerC1552cS(this);
            this.A0C.setOnClickListener(onClickListener);
            if (this.A0J.A0B() != null) {
                View.OnClickListener onClickListener2 = new ViewOnClickListenerC1553cT(this);
    ...
    private void A0S() {
        ...
        if (this.A09 instanceof C0851Ek) {
            C0851Ek c0851Ek = (C0851Ek) this.A09;
        ...
        addView(new C1543cJ(this.A0J.A06(), this.A0E, this.A0c, this.A0Z, this.A0J.A0C()).A0C(getRegularCtaForEndCard()));
    }
    ...
    public void A0f(String str) {
        ...
        if (AbstractC1265Uq.A02(this.A0J.A06()) || this.A0J.A06().A0E() == null) {
            m32 = new M3(this.A0J.A06(), kr);
        } else {
            m32 = new M3(this.A0J.A06(), this.A0J.A06().A0E(), kr);
        }
        this.A0I = m32;
        this.A0I.setOnTouchListener(new ViewOnTouchListenerC1545cL(this));
    ...
    public void A0i(boolean z10) {
        ...
        if (this.A09 != null) {
            ...
            duration.addUpdateListener(new C1546cM(this));
            ...
            animatorSet.addListener(new C1547cN(this, z10));
            if (this.A0j) {
                boolean z11 = this.A09 instanceof C0851Ek;
                String[] strArr = A0l;
                if (strArr[6].charAt(18) != strArr[5].charAt(18)) {
                    throw new RuntimeException();
                }
                ...
                strArr2[1] = "o2de";
                if (z11) {
                    ((C0851Ek) this.A09).A0c(animatorSet, z10);
                }
            }
            animatorSet.start();
        }
    ...
    private void A0j(boolean z10) {
        ...
        if (z11) {
            ...
            if (C1264Up.A1J(getAdContextWrapper()) && getResources().getConfiguration().orientation == 2 && !(this.A09 instanceof C0851Ek)) {
    ...
    public final void A1D() {
        AbstractC1349Yb abstractC1349YbA0B = this.A0J.A0B();
        if (abstractC1349YbA0B != null) {
            abstractC1349YbA0B.setPageDetailsVisible((A1Q() || abstractC1349YbA0B.A0E()) ? false : true);
        }
        this.A0X = false;
    }
    ...
    */
    public final void A1H(com.instagram.common.viewpoint.core.NR r6, java.lang.String r7, double r8, android.os.Bundle r10) {
        /*
            r5 = this;
        ...
        L33:
            ...
            r0 = 8
            com.instagram.common.viewpoint.core.YB.A0O(r1, r0)
            com.facebook.ads.redexgen.X.c7 r0 = r5.A0J
            com.facebook.ads.redexgen.X.gi r0 = r0.A06()
            boolean r0 = com.instagram.common.viewpoint.core.C1264Up.A17(r0)
            if (r0 == 0) goto L4c
            android.widget.LinearLayout r1 = r5.A0C
            r0 = 0
            r1.setClickable(r0)
        ...
        L65:
            ...
            r3 = 1
            java.lang.String[] r2 = com.instagram.common.viewpoint.core.KE.A0l
            r0 = 2
            r1 = r2[r0]
            r0 = 7
            r2 = r2[r0]
        ...
        L9d:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.KE.A1H(com.facebook.ads.redexgen.X.NR, java.lang.String, double, android.os.Bundle):void");
    }
    ...
    public final boolean A1P(boolean z10) {
        ...
        if (this.A0E.A29().A0K().A04()) {
            ...
            if (this.A09 instanceof C0851Ek) {
                C0851Ek simpleVideoView = (C0851Ek) this.A09;
    ...
    private ViewOnClickListenerC1012Kr getRegularCtaForEndCard() {
        ViewOnClickListenerC1012Kr viewOnClickListenerC1012Kr = new ViewOnClickListenerC1012Kr(getAdContextWrapper(), this.A0J.A05().A0w(), this.A0E.A28().A01(), getAdEventManager(), this.A0J.A0C(), (C1759fp) null, this.A0J.A0A(), this.A0E.A2A());
        viewOnClickListenerC1012Kr.setViewShowsOverMedia(true);
        YB.A0K(viewOnClickListenerC1012Kr);
        viewOnClickListenerC1012Kr.setText(this.A0E.A29().A0J().A04());
        YB.A0G(1001, viewOnClickListenerC1012Kr);
        viewOnClickListenerC1012Kr.setCta(this.A0E.A29().A0J(), this.A0E.A2E(), new HashMap(), null);
    ...
    private void setUpBrowserControls(M3 m32) {
        ...
        this.A0G.setOnTouchListener(new ViewOnTouchListenerC1544cK(this));
        this.A0B.addView(this.A0G, layoutParams);
        YB.A0J(this.A0H);
        this.A0H = new C1443ah(this.A0J.A06(), null, R.attr.progressBarStyleHorizontal);
