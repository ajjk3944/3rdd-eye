...
public abstract class OX {
    ...
    public static Bundle A01(T8 t82) {
        ...
        String adTypeString3 = A06(WKSRecord.Service.BL_IDM, 35, 79);
    ...
    public static Bundle A02(String str, C1924iY c1924iY) {
        Bundle bundle = new Bundle();
        A08(bundle, c1924iY.A05());
        bundle.putString(A06(451, 17, 16), c1924iY.A0A());
        bundle.putString(A06(259, 13, 76), str);
        bundle.putString(A06(292, 19, 18), c1924iY.A07());
        bundle.putString(A06(366, 19, 0), c1924iY.A08());
        bundle.putString(A06(TTAdConstant.DEEPLINK_FALLBACK_CODE, 22, 98), c1924iY.A09());
        bundle.putString(A06(385, 19, 96), OT.A01(c1924iY.A0B()));
        RewardData rewardDataA03 = c1924iY.A03();
        if (rewardDataA03 != null) {
            OY.A00(bundle, rewardDataA03);
        }
        C1814gi c1814giA05 = c1924iY.A05();
        if (A01[7].charAt(1) != 'G') {
            throw new RuntimeException();
        }
        String[] strArr = A01;
        ...
        bundle.putBundle(A06(123, 19, 81), A01(c1814giA05));
        return bundle;
    }

    public static Bundle A03(String str, C1909iI c1909iI) {
        Bundle bundle = new Bundle();
        A08(bundle, c1909iI.A0B);
        bundle.putString(A06(451, 17, 16), c1909iI.A0D);
        bundle.putString(A06(259, 13, 76), str);
        bundle.putString(A06(292, 19, 18), c1909iI.A05);
        bundle.putString(A06(366, 19, 0), c1909iI.A06);
        bundle.putString(A06(TTAdConstant.DEEPLINK_FALLBACK_CODE, 22, 98), c1909iI.A07);
        AdExperienceType adExperienceType = c1909iI.A02;
        if (adExperienceType != null) {
            bundle.putString(A06(237, 22, 24), OS.A02(adExperienceType));
        }
        bundle.putBoolean(A06(90, 33, 27), c1909iI.A08);
        RewardData rewardData = c1909iI.A03;
        if (rewardData != null) {
            OY.A00(bundle, rewardData);
        }
        bundle.putBundle(A06(123, 19, 81), A01(c1909iI.A0B));
        return bundle;
    }

    public static C1924iY A04(C1814gi c1814gi, Bundle bundle, String str) {
        ...
        C1924iY c1924iY = new C1924iY(c1814gi, null, string, new C1915iP(str, string4, bundle2));
        c1924iY.A0I(string3);
        c1924iY.A0H(string2);
        c1924iY.A0J(sdkVersion);
        String placement6 = A06(385, 19, 96);
        c1924iY.A0K(OT.A02(bundle.getString(placement6)));
        RewardData rewardDataA01 = OY.A01(bundle);
        if (rewardDataA01 != null) {
            c1924iY.A0F(rewardDataA01);
        }
        return c1924iY;
    }

    public static C1909iI A05(C1814gi c1814gi, Bundle bundle, String str) {
        String string = bundle.getString(A06(451, 17, 16));
        ...
        C1909iI c1909iI = new C1909iI(c1814gi, string, null, new C1915iP(str, string4, bundle2));
        c1909iI.A06 = adExperienceType;
        c1909iI.A05 = string2;
        c1909iI.A08 = z10;
        c1909iI.A02 = OS.A00(string3);
        c1909iI.A07 = mediationData;
        RewardData rewardDataA01 = OY.A01(bundle);
        if (rewardDataA01 != null) {
            c1909iI.A03 = rewardDataA01;
        }
        return c1909iI;
    }
    ...
    public static void A08(Bundle bundle, T8 t82) {
        ...
        boolean zAAT = false;
        boolean isForcedFunnelLogging = t82 instanceof C1814gi;
        if (isForcedFunnelLogging) {
            zAAT = ((C1814gi) t82).A0F().AAT();
        }
        ...
        boolean isForcedFunnelLogging3 = AbstractC1267Us.A0G(t82);
        if (isForcedFunnelLogging3) {
            bundle.putString(A06(Sdk$SDKError.Reason.MRAID_JS_CALL_EMPTY_VALUE, 19, 51), new C1210Sn().A03(t82));
        }
    }
}
