...
public final class TI extends SQLiteOpenHelper {
    ...
    public static void A02() {
        A01 = new byte[]{-105, 101, -119, -118, -117, -122, -102, -111, -103, 101, 117, 0, Flags.CD, 19, 4, 17, -33, 19, 0, 1, Flags.CD, 4, -33, 36, 53, 36, 45, 51, 50, -33, 0, 3, 3, -33, 2, 14, Flags.CD, 20, 12, 13, -33, -122, -87, -119, -90, -71, -90, -89, -90, -72, -86, -115, -86, -79, -75, -86, -73, 101, -88, -90, -77, 101, -77, -76, -71, 101, -89, -86, 101, -77, -70, -79, -79, -16, -2, -5, -4, -52, 0, -19, -18, -8, -15, -52, -11, -14, -52, -15, 4, -11, -1, 0, -1, -52, 15, 30, 13, 31, 20, 17, 31, -10, -8, -25, -19, -13, -25, -58, 12, 21, 24, Flags.CD, 15, 13, 20, 5, 17, Flags.CD, 31, 25, -58, -29, -58, -11, -12, -31, -51, -48, -33, -111, -33, -102, -48, -50};
        if (A02[7].length() == 23) {
    ...
    public TI(C1810ge c1810ge, TH th) {
        super(c1810ge, A01(c1810ge), (SQLiteDatabase.CursorFactory) null, 4);
        if (th != null) {
            this.A00 = th;
            return;
        }
    ...
    public static String A01(C1810ge c1810ge) throws IllegalAccessException, NoSuchFieldException, SecurityException, IllegalArgumentException {
        Locale locale = Locale.US;
        Object[] objArr = {A00(0, 0, 19)};
        String strA00 = A00(126, 8, 41);
        String str = String.format(locale, strA00, objArr);
        if (!C1264Up.A2k(c1810ge)) {
            return str;
        }
        String defaultDbName = c1810ge.getPackageName();
        String processName = ProcessUtils.getProcessName(c1810ge);
