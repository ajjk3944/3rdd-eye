...
public abstract class JB {
    ...
    public static ApicFrame A01(C06214v c06214v) {
        ...
        if (iA0C2 == 1684108385) {
            ...
            int flags = AbstractC0963Iu.A00(atomSize);
            if (flags == 13) {
            ...
            if (mimeType == null) {
                AbstractC06064g.A07(strA0A, A0A(1955, 30, 80) + flags);
                return null;
            }
            c06214v.A0g(4);
            ...
            c06214v.A0k(bArr, 0, atomSize3);
            return new ApicFrame(mimeType, null, 3, bArr);
        }
        AbstractC06064g.A07(strA0A, A0A(635, 35, 6));
        return null;
    }

    public static CommentFrame A02(int i10, C06214v c06214v) {
        int iA0C = c06214v.A0C();
        int atomType = c06214v.A0C();
        if (atomType == 1684108385) {
            c06214v.A0g(8);
            int atomSize = iA0C - 16;
            String strA0V = c06214v.A0V(atomSize);
            return new CommentFrame(A0A(2043, 3, 64), strA0V, strA0V);
        }
        AbstractC06064g.A07(A0A(1228, 12, 21), A0A(Sdk$SDKError.Reason.NATIVE_ASSET_ERROR_VALUE, 35, 78) + AbstractC0963Iu.A02(i10));
        return null;
    }

    @MetaExoPlayerCustomization("Replace ImmutableList with MetaExoPlayerCustomizedCollections")
    public static Id3Frame A03(int i10, String str, C06214v c06214v, boolean z10, boolean z11) {
        ...
        AbstractC06064g.A07(A0A(1228, 12, 21), A0A(813, 33, 122) + AbstractC0963Iu.A02(i10));
        return null;
    }

    public static Id3Frame A04(C06214v c06214v) {
        int position = c06214v.A09();
        int shortType = c06214v.A0C() + position;
        int typeTopByte = c06214v.A0C();
        ...
        try {
            if (endPosition == 169 || endPosition == 253) {
                ...
                if (i10 == 6516084) {
                    return A02(typeTopByte, c06214v);
                }
                if (i10 != 7233901 && i10 != 7631467) {
                    if (i10 != 6516589 && i10 != 7828084) {
                        if (i10 == 6578553) {
                            return A07(typeTopByte, A0A(1795, 4, 61), c06214v);
                        }
                        if (i10 == 4280916) {
                            return A07(typeTopByte, A0A(1807, 4, 93), c06214v);
                        }
                        if (i10 == 7630703) {
                            return A07(typeTopByte, A0A(1843, 4, 109), c06214v);
                        }
                        if (i10 == 6384738) {
                            return A07(typeTopByte, A0A(1775, 4, 94), c06214v);
                        }
                        if (i10 == 7108978) {
                            return A07(typeTopByte, A0A(1951, 4, 89), c06214v);
                        }
                        if (A01[7].charAt(0) != 122) {
                            A01[4] = "PbKnEML0B11BnhLl3Mtx38aJxEbcIZXa";
                            if (i10 == 6776174) {
                                return A07(typeTopByte, A0A(1791, 4, 72), c06214v);
                            }
                            if (i10 == 6779504) {
                                return A07(typeTopByte, A0A(1799, 4, 15), c06214v);
                            }
                            AbstractC06064g.A04(A0A(1228, 12, 21), A0A(1627, 32, 52) + AbstractC0963Iu.A02(typeTopByte));
                            c06214v.A0f(shortType);
                            return null;
                        }
                        throw new RuntimeException();
                    }
                    return A07(typeTopByte, A0A(1787, 4, 55), c06214v);
                }
                return A07(typeTopByte, A0A(1803, 4, 123), c06214v);
            }
            if (typeTopByte == 1735291493) {
                return A08(c06214v);
            }
            if (typeTopByte == 1684632427) {
                return A06(typeTopByte, A0A(1815, 4, 104), c06214v);
            }
            if (typeTopByte == 1953655662) {
                return A06(typeTopByte, A0A(1819, 4, 68), c06214v);
            }
            if (typeTopByte == 1953329263) {
                return A03(typeTopByte, A0A(1779, 4, 110), c06214v, true, false);
            }
            if (typeTopByte == 1668311404) {
                return A03(typeTopByte, A0A(1783, 4, 75), c06214v, true, true);
            }
            if (typeTopByte == 1668249202) {
                return A01(c06214v);
            }
            if (typeTopByte == 1631670868) {
                return A07(typeTopByte, A0A(1811, 4, 100), c06214v);
            }
            if (typeTopByte == 1936682605) {
                return A07(typeTopByte, A0A(1839, 4, 48), c06214v);
            }
            if (typeTopByte == 1936679276) {
                TextInformationFrame textInformationFrameA07 = A07(typeTopByte, A0A(1823, 4, 80), c06214v);
                c06214v.A0f(shortType);
            ...
            if (typeTopByte == 1936679282) {
                return A07(typeTopByte, A0A(1827, 4, 39), c06214v);
            }
            if (typeTopByte == 1936679265) {
                return A07(typeTopByte, A0A(1835, 4, 48), c06214v);
            }
            if (typeTopByte == 1936679791) {
                return A07(typeTopByte, A0A(1831, 4, 72), c06214v);
            }
            if (typeTopByte == 1920233063) {
                return A03(typeTopByte, A0A(1018, 14, 42), c06214v, false, false);
            }
            if (typeTopByte == 1885823344) {
                return A03(typeTopByte, A0A(1032, 13, 104), c06214v, false, true);
            }
            if (typeTopByte == 1936683886) {
                return A07(typeTopByte, A0A(1853, 10, 126), c06214v);
            }
            if (A01[7].charAt(0) != 122) {
                A01[4] = "pV0yRHtOnOdCVty8ixamggbGH5FhKnUJ";
                if (typeTopByte == 1953919848) {
                    return A07(typeTopByte, A0A(1847, 6, 21), c06214v);
                }
                if (typeTopByte == 757935405) {
                    return A05(c06214v, shortType);
                }
                AbstractC06064g.A04(A0A(1228, 12, 21), A0A(1627, 32, 52) + AbstractC0963Iu.A02(typeTopByte));
                c06214v.A0f(shortType);
                return null;
    ...
    public static InternalFrame A05(C06214v c06214v, int i10) {
        String value = null;
        String strA0V = null;
        int dataAtomSize = -1;
        int i11 = -1;
                ...
                if (name.charAt(25) != 'K') {
                    ...
                    if (atomType == 1851878757) {
                        ...
                        if (name3.charAt(4) != 'a') {
                            ...
                            c06214v.A0g(atomType2);
                        }
                    }
                }
                throw new RuntimeException();
            }
            value = c06214v.A0V(iA0C - 12);
        }
        if (value != null && strA0V != null && dataAtomSize != -1) {
            c06214v.A0f(dataAtomSize);
            c06214v.A0g(16);
            String name4 = c06214v.A0V(i11 - 16);
    ...
    @MetaExoPlayerCustomization("Replace ImmutableList with MetaExoPlayerCustomizedCollections")
    public static TextInformationFrame A06(int i10, String str, C06214v c06214v) {
        int iA0C = c06214v.A0C();
        int atomType = c06214v.A0C();
        ...
        AbstractC06064g.A07(A0A(1228, 12, 21), A0A(670, 39, 29) + AbstractC0963Iu.A02(i10));
        return null;
    }

    @MetaExoPlayerCustomization("Replace ImmutableList with MetaExoPlayerCustomizedCollections")
    public static TextInformationFrame A07(int i10, String str, C06214v c06214v) {
        int iA0C = c06214v.A0C();
        int atomType = c06214v.A0C();
        if (atomType == 1684108385) {
            c06214v.A0g(8);
            int atomSize = iA0C - 16;
            return new TextInformationFrame(str, null, MetaExoPlayerCustomizedCollections.A03(c06214v.A0V(atomSize)));
        }
        AbstractC06064g.A07(A0A(1228, 12, 21), A0A(744, 32, 94) + AbstractC0963Iu.A02(i10));
        return null;
    }
    ...
    */
    public static com.facebook.ads.androidx.media3.extractor.metadata.id3.TextInformationFrame A08(com.instagram.common.viewpoint.core.C06214v r4) {
        /*
            int r2 = A00(r4)
            r4 = 0
            if (r2 <= 0) goto L2b
    ...
    public static MdtaMetadataEntry A09(C06214v c06214v, int i10, String str) {
        while (true) {
            int typeIndicator = c06214v.A09();
            if (typeIndicator < i10) {
                int atomType = c06214v.A0C();
                int atomPosition = c06214v.A0C();
                if (atomPosition == 1684108385) {
                    int localeIndicator = c06214v.A0C();
                    int typeIndicator2 = c06214v.A0C();
                    int atomType2 = atomType - 16;
                    byte[] bArr = new byte[atomType2];
                    c06214v.A0k(bArr, 0, atomType2);
                    return new MdtaMetadataEntry(str, bArr, typeIndicator2, localeIndicator);
                }
                c06214v.A0f(typeIndicator + atomType);
            } else {
                return null;
            }
        }
    ...
    public static void A0C(int i10, Metadata metadata, Metadata metadata2, C05652p c05652p, Metadata... metadataArr) {
        ...
        if (metadata3.A02() > 0) {
            c05652p.A0v(metadata3);
        }
    }

    public static void A0D(int i10, HK hk, C05652p c05652p) {
        if (i10 == 1 && hk.A03()) {
            c05652p.A0d(hk.A00).A0e(hk.A01);
        }
    }
}
