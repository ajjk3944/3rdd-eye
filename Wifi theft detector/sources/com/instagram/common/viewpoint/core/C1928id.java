...
public final class C1928id implements OG {
    ...
    static {
        A0A();
        A0A = C1928id.class.getSimpleName();
    }

    public C1928id(C1924iY c1924iY, OW ow, String str) {
        this.A08 = c1924iY;
        this.A06 = c1924iY.A05();
        this.A07 = new C1907iG(str, ow, this);
    }
    ...
    public final C1924iY A0E() {
        return this.A08;
    }

    public final C1814gi A0F() {
        return this.A06;
    }
    ...
    public final void A0G(EnumSet<CacheFlag> cacheFlags, String str) {
        ...
        this.A05 = false;
        if (this.A04 && !C1264Up.A0i(this.A06)) {
            this.A06.A08().ABC(A09(130, 3, 68), AbstractC1226Td.A0L, new C1227Te(A09(78, 52, 22)));
        ...
        if (this.A03 != null) {
            this.A03.A0S(new C1932ii(this));
            this.A03.A0N();
            this.A03.A0K();
            this.A03 = null;
        }
        O7 o72 = new O7(this.A08.A0A(), AbstractC1291Vs.A00(this.A06.getResources().getDisplayMetrics()), AdPlacementType.INTERSTITIAL, EnumC1288Vp.A08, 1, cacheFlags, this.A08.A06());
        if (C1264Up.A2g(this.A06) && (strA02 = XC.A02(this.A06, this.A08.A08())) != null) {
            this.A08.A0I(strA02);
        }
        o72.A06(this.A08.A08());
        o72.A07(this.A08.A09());
        o72.A04(this.A08.A03());
        this.A03 = new C06877j(this.A06, o72);
    ...
    public final boolean A0J() {
        ...
        if (this.A03 == null) {
            this.A06.A08().ABC(A09(130, 3, 68), AbstractC1226Td.A0S, new C1227Te(AdErrorType.INTERSTITIAL_CONTROLLER_IS_NULL.getDefaultErrorMessage()));
            this.A06.A0F().A3N(Y1.A01(this.A00), adError.getErrorCode(), adError.getErrorMessage());
            this.A07.onError(this.A08.A6k(), adError);
            return false;
        }
