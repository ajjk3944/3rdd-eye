...
public abstract class AbstractC0750Ai<E> implements Collection<E> {
    ...
    public boolean contains(E element) {
        AbstractC0750Ai<E> abstractC0750Ai = this;
        if ((abstractC0750Ai instanceof Collection) && abstractC0750Ai.isEmpty()) {
            return false;
        }
        Iterator<E> it = abstractC0750Ai.iterator();
        while (it.hasNext()) {
            if (C2388qY.A0C(it.next(), element)) {
                return true;
            }
        }
        return false;
    ...
    public final boolean containsAll(Collection<? extends Object> elements) {
        C2388qY.A09(elements, A0A(77, 8, 122));
    ...
    public static final CharSequence A08(AbstractC0750Ai abstractC0750Ai, Object obj) {
        return obj == abstractC0750Ai ? A0A(0, 17, 33) : String.valueOf(obj);
    }
    ...
    public Object[] toArray() {
        return AbstractC2390qa.A02(this);
    }

    @Override // java.util.Collection
    public <T> T[] toArray(T[] array) {
        C2388qY.A09(array, A0A(72, 5, 90));
        return (T[]) AbstractC2390qa.A03(this, array);
    }
    ...
    public final String toString() {
        return C0d.A03(this, A0A(17, 2, 49), A0A(70, 1, 109), A0A(71, 1, 15), 0, null, new AZ() { // from class: com.facebook.ads.redexgen.X.1t
            ...
            public final Object AAK(Object obj) {
                return AbstractC0750Ai.A08(this.A00, obj);
            }
        }, 24, null);
    }
}
