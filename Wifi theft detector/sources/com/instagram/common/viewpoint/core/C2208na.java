...
public final class C2208na implements InterfaceC0921Hd {
    ...
    public C0919Hb[] A0S = new C0919Hb[this.A01];
    public final C0819De<DO> A0X = new C0819De<>(new AnonymousClass49() { // from class: com.facebook.ads.redexgen.X.nb
     ...
     */
    private synchronized int A03(C06776z c06776z, C2295p0 c2295p0, boolean z10, boolean z11, DN dn) {
        c2295p0.A04 = false;
        if (!A0K()) {
            if (!z11 && !this.A0G) {
                ...
                A0H((C2374qI) AbstractC05983y.A01(this.A0D), c06776z);
                return -5;
            }
            c2295p0.A02(4);
            return -4;
        }
        C2374qI c2374qI = this.A0X.A01(A0O()).A00;
        if (z10 || c2374qI != this.A0B) {
            A0H(c2374qI, c06776z);
            return -5;
        }
        ...
        c2295p0.A02(this.A0N[iA00]);
        c2295p0.A01 = this.A0R[iA00];
        if (c2295p0.A01 < this.A09) {
            c2295p0.A00(Integer.MIN_VALUE);
        }
    ...
    java.lang.ArrayIndexOutOfBoundsException
     */
    private synchronized void A0G(long j10, int i10, long j11, int i11, C0919Hb c0919Hb) {
        if (this.A02 > 0) {
            int iA00 = A00(this.A02 - 1);
            AbstractC05983y.A07(this.A0Q[iA00] + ((long) this.A0O[iA00]) <= j11);
        }
        ...
        this.A0O[iA002] = i11;
        this.A0N[iA002] = i10;
        this.A0S[iA002] = c0919Hb;
        this.A0P[iA002] = this.A05;
        if (this.A0X.A06() || !this.A0X.A00().A00.equals(this.A0D)) {
            this.A0X.A05(A0P(), new DO((C2374qI) AbstractC05983y.A01(this.A0D), this.A0U != null ? this.A0U.AH3(this.A0T, this.A0D) : A5.A00));
        }
        this.A02++;
        if (this.A02 == this.A01) {
            ...
            C0919Hb[] c0919HbArr = new C0919Hb[i12];
            ...
            System.arraycopy(this.A0S, this.A04, c0919HbArr, 0, i13);
            ...
            System.arraycopy(this.A0S, 0, c0919HbArr, i13, i14);
    ...
    public C2208na(F0 f02, A6 a62, A1 a12) {
        this.A0U = a62;
        this.A0T = a12;
        this.A0V = new DL(f02);
    }
    ...
    */
    private int A01(int r6, int r7, long r8, boolean r10) {
        ...
        L27:
            ...
            goto L2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C2208na.A01(int, int, long, boolean):int");
    }
    ...
    */
    private int A02(long r6) {
        ...
        La:
            ...
            if (r3 != r0) goto La
            int r3 = r5.A01
            java.lang.String[] r2 = com.instagram.common.viewpoint.core.C2208na.A0Z
            r0 = 5
            r1 = r2[r0]
            r0 = 2
            r2 = r2[r0]
        ...
        L42:
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C2208na.A02(long):int");
    }
    ...
    */
    private long A07(int r8) {
        /*
            ...
            r0 = 1
        L11:
            com.instagram.common.viewpoint.core.AbstractC05983y.A07(r0)
            int r0 = r7.A02
            int r0 = r0 - r6
            r7.A02 = r0
            long r2 = r7.A06
        ...
        L71:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C2208na.A07(int):long");
    }
    ...
    private final C2374qI A0A(C2374qI c2374qI) {
        if (this.A08 != 0 && c2374qI.A0M != Long.MAX_VALUE) {
            return c2374qI.A07().A0s(c2374qI.A0M + this.A08).A14();
        }
        return c2374qI;
    }

    public static C2208na A0B(F0 f02, A6 a62, A1 a12) {
        return new C2208na(f02, (A6) AbstractC05983y.A01(a62), (A1) AbstractC05983y.A01(a12));
    }
    ...
    private void A0H(C2374qI c2374qI, C06776z c06776z) {
        C2374qI c2374qIA08;
        boolean z10 = this.A0B == null;
        DrmInitData newDrmInitData = z10 ? null : this.A0B.A0O;
        this.A0B = c2374qI;
        DrmInitData oldDrmInitData = c2374qI.A0O;
        if (this.A0U != null) {
            c2374qIA08 = c2374qI.A08(this.A0U.A7W(c2374qI));
        } else {
            c2374qIA08 = c2374qI;
        }
        c06776z.A00 = c2374qIA08;
        c06776z.A01 = this.A0E;
        if (this.A0U == null) {
            return;
        }
        if (!z10) {
        ...
        InterfaceC07409s interfaceC07409s = this.A0E;
        this.A0E = this.A0U.A3C(this.A0T, c2374qI);
        c06776z.A01 = this.A0E;
        if (interfaceC07409s != null) {
            interfaceC07409s.AHc(this.A0T);
        }
    }
    ...
    private synchronized boolean A0N(C2374qI c2374qI) {
        this.A0L = false;
        if (C5C.A1E(c2374qI, this.A0D)) {
            return false;
        }
        if (!this.A0X.A06() && this.A0X.A00().A00.equals(c2374qI)) {
    ...
    public final int A0R(C06776z c06776z, C2295p0 c2295p0, int i10, boolean z10) {
        int iA03 = A03(c06776z, c2295p0, (i10 & 2) != 0, z10, this.A0W);
        if (iA03 == -4 && !c2295p0.A05()) {
            int result = i10 & 1;
            boolean z11 = result != 0;
            int result2 = i10 & 4;
            if (result2 == 0) {
                if (z11) {
                    this.A0V.A0E(c2295p0, this.A0W);
                } else {
                    this.A0V.A0F(c2295p0, this.A0W);
                }
            }
            if (!z11) {
    ...
    public final synchronized C2374qI A0U() {
    ...
    public final void A0W() throws IOException {
        if (this.A0E == null || this.A0E.A9A() != 1) {
            ...
            throw ((C07389q) AbstractC05983y.A01(this.A0E.A80()));
        }
    }
    ...
    */
    public final synchronized void A0a(int r3) {
        ...
        Lc:
            r0 = 0
        Ld:
            com.instagram.common.viewpoint.core.AbstractC05983y.A07(r0)     // Catch: java.lang.Throwable -> L17
        ...
        L17:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C2208na.A0a(int):void");
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final void AIu(long r16, int r18, int r19, int r20, com.instagram.common.viewpoint.core.C0919Hb r21) {
        /*
            r15 = this;
            r10 = r18
            r8 = r16
            ...
            java.lang.Object r0 = com.instagram.common.viewpoint.core.AbstractC05983y.A02(r0)
        ...
        L97:
            ...
            long r11 = r0.A09()
            java.lang.String[] r1 = com.instagram.common.viewpoint.core.C2208na.A0Z
            r0 = 1
            r1 = r1[r0]
            r0 = 24
            char r1 = r1.charAt(r0)
        ...
        Lad:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C2208na.AIu(long, int, int, int, com.facebook.ads.redexgen.X.Hb):void");
    }
