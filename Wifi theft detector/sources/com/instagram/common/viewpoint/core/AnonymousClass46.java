...
public abstract class AnonymousClass46 {
    ...
    public static Pair<Integer, Integer> A00(byte[] bArr) {
        ...
        c06214v.A0f(9);
        int sampleRate = c06214v.A0I();
        c06214v.A0f(20);
        return Pair.create(Integer.valueOf(c06214v.A0L()), Integer.valueOf(sampleRate));
    }
    ...
    public static String A03(int i10, boolean z10, int i11, int i12, int[] iArr, int i13) {
        StringBuilder sb = new StringBuilder(C5C.A0n(A02(25, 17, 35), A03[i10], Integer.valueOf(i11), Integer.valueOf(i12), Character.valueOf(z10 ? 'H' : 'L'), Integer.valueOf(i13)));
