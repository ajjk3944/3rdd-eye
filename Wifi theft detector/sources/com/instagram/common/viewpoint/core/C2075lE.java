...
public final class C2075lE implements LH {
    ...
    public boolean A08;
    public boolean A09;
    public final InterfaceC1016Kv A0B;
    public final C06204u A0A = new C06204u(new byte[10]);
    public int A03 = 0;
    ...
    public static void A02() {
        A0C = new byte[]{-23, 54, 56, 59, 46, -23, 43, 66, 61, 46, 60, 49, 90, 96, 89, 79, Flags.CD, 89, 80, 82, 76, 95, 84, 97, 80, Flags.CD, 91, 76, 78, 86, 80, 95, Flags.CD, 91, 76, 100, 87, 90, 76, 79, Flags.CD, 94, 84, 101, 80, 37, Flags.CD, 36, 57, 71, 38, 57, 53, 56, 57, 70, -7, 18, 9, 28, 20, 9, 7, 24, 9, 8, -60, 23, 24, 5, 22, 24, -60, 7, 19, 8, 9, -60, 20, 22, 9, 10, 13, 28, -34, -60, Flags.CD, 36, 27, 46, 38, 27, 25, 42, 27, 26, -42, 41, 42, 23, 40, 42, -42, 31, 36, 26, 31, 25, 23, 42, 37, 40, -42, 40, 27, 23, 26, 31, 36, 29, -42, 27, 46, 42, 27, 36, 26, 27, 26, -42, 30, 27, 23, 26, 27, 40, 4, 29, 20, 39, 31, 20, 18, 35, 20, 19, -49, 34, 35, 16, 33, 35, -49, 24, 29, 19, 24, 18, 16, 35, 30, 33, -23, -49, 20, 39, 31, 20, 18, 35, 20, 19, -49};
    }
    ...
    public C2075lE(InterfaceC1016Kv interfaceC1016Kv) {
        this.A0B = interfaceC1016Kv;
    }
    ...
    private boolean A04() {
        ...
        if (iA04 != 1) {
            AbstractC06064g.A07(strA00, A00(56, 30, 46) + iA04);
            this.A02 = -1;
            return false;
        }
        this.A0A.A09(8);
        ...
        if (iA042 == 0) {
            ...
            if (startCodePrefix4 < 0) {
                ...
                AbstractC06064g.A07(strA00, sbAppend.append(startCodePrefix5).toString());
                this.A02 = -1;
            }
        }
        return true;
    ...
    private boolean A05(C06214v c06214v, byte[] bArr, int i10) {
    ...
    public final void A5B(C06214v c06214v, int i10) throws C3K {
        ...
        if ((i10 & 1) != 0) {
            ...
            switch (i11) {
                ...
                case 1:
                    ...
                    break;
                case 2:
                    AbstractC06064g.A07(strA00, A00(86, 50, 64));
                    A03(1);
                    break;
                case 3:
                    if (this.A02 != -1) {
                        AbstractC06064g.A07(strA00, A00(136, 37, 57) + this.A02 + A00(0, 11, 83));
                    }
                    this.A0B.AGp();
                    A03(1);
                    break;
        ...
        while (c06214v.A07() > 0) {
            switch (this.A03) {
                case 0:
                    c06214v.A0g(c06214v.A07());
                case 1:
                    if (A05(c06214v, this.A0A.A00, 9)) {
                        boolean zA04 = A04();
                        if (A0D[5].length() == 12) {
                            break;
                        } else {
                ...
                case 2:
                    ...
                    if (A0D[1].length() != 20) {
                        A0D[4] = "l8YJPAfB3X";
                        if (A05(c06214v, bArr, iMin) && A05(c06214v, null, this.A01)) {
                            A01();
                            i10 |= this.A06 ? 4 : 0;
