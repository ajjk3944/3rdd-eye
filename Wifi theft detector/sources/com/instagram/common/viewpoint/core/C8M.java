...
public abstract class C8M implements InterfaceC2113lq {
    ...
    public C8M() {
        ...
        for (int i11 = 0; i11 < 2; i11++) {
            ...
            final AnonymousClass64 anonymousClass64 = new AnonymousClass64() { // from class: com.facebook.ads.redexgen.X.li
                ...
                public final void AHj(AbstractC2294oz abstractC2294oz) {
                    this.A00.A0c((C1U) abstractC2294oz);
                }
            };
    ...
    public C8S A5r() throws C2106lj {
        AbstractC05983y.A08(this.A02 == null);
        if (this.A03.isEmpty()) {
            return null;
        }
    ...
    */
    public com.instagram.common.viewpoint.core.C8P A5t() throws com.instagram.common.viewpoint.core.C2106lj {
        /*
    ...
    public void AHJ(C8S c8s) throws C2106lj {
        AbstractC05983y.A07(c8s == this.A02);
        C1V c1v = (C1V) c8s;
        if (c1v.A04()) {
            A0U(c1v);
        } else {
