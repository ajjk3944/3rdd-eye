...
public final class ViewOnSystemUiVisibilityChangeListenerC1345Xx implements View.OnSystemUiVisibilityChangeListener {
    ...
    public EnumC1344Xw A02 = EnumC1344Xw.A02;
    public final Runnable A04 = new QB(this);

    public ViewOnSystemUiVisibilityChangeListenerC1345Xx(View view) {
        this.A03 = view;
    ...
    public void A02(boolean z10) {
        if (EnumC1344Xw.A02.equals(this.A02)) {
            return;
        }
        int i10 = 3840;
        if (!z10) {
    ...
    public final void A05(EnumC1344Xw enumC1344Xw) {
        this.A02 = enumC1344Xw;
