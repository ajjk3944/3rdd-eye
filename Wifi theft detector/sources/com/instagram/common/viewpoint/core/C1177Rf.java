...
public final class C1177Rf implements AudienceNetworkActivityApi {
    ...
    public C1177Rf(AudienceNetworkActivity audienceNetworkActivity, AudienceNetworkActivityApi audienceNetworkActivityApi, C1176Re c1176Re) {
    ...
    private void A02(Throwable th) {
        ...
        if (logContext != null) {
            logContext.A08().ABC(A00(38, 11, 116), AbstractC1226Td.A0C, new C1227Te(th));
            return;
        }
