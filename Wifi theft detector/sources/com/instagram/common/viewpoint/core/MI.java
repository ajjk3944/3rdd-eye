...
public final class MI implements InterfaceC1356Yi {
    ...
    public MI(C1814gi c1814gi, ZP zp, VA va, InterfaceC1355Yh interfaceC1355Yh) {
        this.A04 = c1814gi;
        this.A05 = va;
        this.A07 = zp;
        this.A08 = new C0851Ek(c1814gi);
        this.A08.A0f(new C05903q(c1814gi));
        ...
        interfaceC1355Yh.A45(this.A08, layoutParams);
        C1363Yp closeButton = new C1363Yp(c1814gi);
        closeButton.setOnClickListener(new ZN(this));
        RelativeLayout.LayoutParams params = closeButton.getDefaultLayoutParams();
        interfaceC1355Yh.A45(closeButton, params);
    }
    ...
    public final void AAu(Intent intent, Bundle bundle, C1176Re c1176Re) {
        ...
        if (stringExtra != null && !stringExtra.isEmpty()) {
            C1650e3 c1650e3 = new C1650e3(this.A04, stringExtra);
            RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-2, -2);
            int i10 = (int) (16.0f * XX.A02);
            layoutParams.setMargins(i10, i10, i10, i10);
            layoutParams.addRule(10);
            layoutParams.addRule(9);
            c1650e3.setOnClickListener(new ZO(this));
            this.A06.A45(c1650e3, layoutParams);
        }
        ...
        if (C1264Up.A20(this.A04)) {
            this.A01 = new C0861Eu(this.A04, this.A05, this.A08, this.A03, false, this.A02, null);
        } else {
            this.A01 = null;
        }
        ...
        if (intent.getBooleanExtra(A02(0, 8, 43), false)) {
            this.A08.A0e(EnumC1701et.A04, 17);
        }
    }
    ...
    public final void AFi(boolean z10) {
        ...
        if (!this.A08.A0o()) {
            this.A08.A0e(EnumC1701et.A04, 18);
        }
    }
    ...
    public final void onDestroy() {
        this.A06.A4k(A02(37, 21, 39), new C0839Dy(this.A00, this.A08.getCurrentPositionInMillis()));
