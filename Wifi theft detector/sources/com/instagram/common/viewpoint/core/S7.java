...
public class S7 extends AsyncTask<S9, Void, Drawable> {
        ...
        if (!WU.A02(this) && s9Arr != null) {
            try {
                if (s9Arr.length >= 1) {
                    ...
                    try {
                        bitmapA0O = new C1220Sx(this.A01).A0O(str, -1, -1);
                    } catch (Throwable th) {
                        this.A01.A08().ABC(A01(0, 7, 4), AbstractC1226Td.A1V, new C1227Te(th));
                    }
                    if (bitmapA0O != null) {
    ...
    public S7(C1814gi c1814gi, S8 s82, boolean z10) {
        this.A01 = c1814gi;
        this.A00 = s82;
        this.A02 = z10;
    }

    public /* synthetic */ S7(C1814gi c1814gi, S8 s82, boolean z10, C1836h4 c1836h4) {
        this(c1814gi, s82, z10);
    }
