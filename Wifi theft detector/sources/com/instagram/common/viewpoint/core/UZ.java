    ...
    public static void A03(File file) throws IOException {
        if (file.exists() || file.mkdir()) {
            if (file.isDirectory()) {
                ...
                throw new C1249Ua(String.format(Locale.US, A01(0, 33, 62), file.getCanonicalPath()));
            }
        }
        throw new C1249Ua(String.format(Locale.US, A01(33, 31, 59), file.getCanonicalPath()));
    }
