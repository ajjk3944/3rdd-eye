...
public final class C1825gt implements SR {
    ...
    public final InterfaceC1790gK A01;
    ...
    public C1825gt(CY cy) {
        this.A01 = cy.A5U(EnumC1791gL.A0B);
        this.A01.A41(new C1826gu(this));
        A03();
    }
    ...
    public static Set<SU> A01(JSONObject jSONObject) {
        ...
        while (true) {
            ...
            if (i10 < i11) {
                ...
                if (jSONObjectOptJSONObject == null || (c1824gsA00 = C1824gs.A00(jSONObjectOptJSONObject)) == null) {
                    return null;
                }
                hashSet.add(c1824gsA00);
                i10++;
            } else {
                return hashSet;
            }
