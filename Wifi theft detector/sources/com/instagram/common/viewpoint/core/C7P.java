...
public final class C7P extends AbstractC1868ha {
    ...
    public ArrayList<C1147Qa> A09 = new ArrayList<>();
    public ArrayList<QZ> A08 = new ArrayList<>();
    public ArrayList<ArrayList<RK>> A01 = new ArrayList<>();
    public ArrayList<ArrayList<C1147Qa>> A05 = new ArrayList<>();
    ...
    public final void A0H() {
        ...
        for (int size2 = this.A09.size() - 1; size2 >= 0; size2--) {
            C1147Qa c1147Qa = this.A09.get(size2);
            View view = c1147Qa.A04.A0H;
        ...
        if (A0M()) {
            for (int size6 = this.A05.size() - 1; size6 >= 0; size6--) {
                ArrayList<C1147Qa> arrayList2 = this.A05.get(size6);
                for (int size7 = arrayList2.size() - 1; size7 >= 0; size7--) {
                    C1147Qa c1147Qa2 = arrayList2.get(size7);
                    View view2 = c1147Qa2.A04.A0H;
    ...
    java.lang.ArrayIndexOutOfBoundsException
     */
    @Override // com.instagram.common.viewpoint.core.AbstractC1868ha
    public final boolean A0Z(RK rk, int i10, int i11, int i12, int i13) {
        View view = rk.A0H;
        int translationX = i10 + ((int) rk.A0H.getTranslationX());
        int translationY = i11 + ((int) rk.A0H.getTranslationY());
        A02(rk);
        ...
        this.A09.add(new C1147Qa(rk, translationX, translationY, i12, i13));
        return true;
    }
    ...
    */
    ...
    public final void A0L(RK rk) {
        ...
        for (int size = this.A05.size() - 1; size >= 0; size--) {
            ArrayList<C1147Qa> arrayList2 = this.A05.get(size);
            int i12 = arrayList2.size() - 1;
            while (true) {
                if (i12 < 0) {
                    break;
                }
                if (arrayList2.get(i12).A04 == rk) {
                    view.setTranslationY(0.0f);
                    view.setTranslationX(0.0f);
                    A0U(rk);
    ...
    @Override // com.instagram.common.viewpoint.core.AbstractC1868ha
    public final boolean A0a(RK rk, RK rk2, int i10, int i11, int i12, int i13) {
        if (rk == rk2) {
            return A0Z(rk, i10, i11, i12, i13);
        }
        ...
        this.A08.add(new QZ(rk, rk2, i10, i11, i12, i13));
        return true;
    }
    ...
    public final void A0e(RK rk, int i10, int i11, int i12, int i13) {
        View view = rk.A0H;
        int i14 = i12 - i10;
        int i15 = i13 - i11;
        if (i14 != 0) {
        ...
        ViewPropertyAnimator viewPropertyAnimatorAnimate = view.animate();
        this.A04.add(rk);
        viewPropertyAnimatorAnimate.setDuration(A0C()).setListener(new QW(this, rk, i14, view, i15, viewPropertyAnimatorAnimate)).start();
    }
}
