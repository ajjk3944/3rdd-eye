...
public class ProxyBillingActivityV2 extends ComponentActivity {
    private androidx.activity.result.b zza;
    private androidx.activity.result.b zzb;
    ...
    public final void onCreate(@Nullable Bundle bundle) {
        ...
        this.zza = registerForActivityResult(new b.d(), new androidx.activity.result.a() { // from class: com.android.billingclient.api.zzct
            @Override // androidx.activity.result.a
            public final void onActivityResult(Object obj) {
                this.zza.zza((ActivityResult) obj);
            }
        });
        this.zzb = registerForActivityResult(new b.d(), new androidx.activity.result.a() { // from class: com.android.billingclient.api.zzcu
            @Override // androidx.activity.result.a
            public final void onActivityResult(Object obj) {
        ...
        if (getIntent().hasExtra("ALTERNATIVE_BILLING_ONLY_DIALOG_INTENT")) {
            ...
            this.zza.a(new IntentSenderRequest.Builder(pendingIntent).a());
            ...
            this.zzb.a(new IntentSenderRequest.Builder(pendingIntent2).a());
        }
    }
    ...
    public final void zza(ActivityResult activityResult) {
        ...
        if (activityResult.e() != -1 || responseCode != 0) {
            com.google.android.gms.internal.play_billing.zze.zzl("ProxyBillingActivityV2", "Alternative billing only dialog finished with resultCode " + activityResult.e() + " and billing's responseCode: " + responseCode);
        }
        finish();
    }
    ...
    public final void zzb(ActivityResult activityResult) {
        ...
        if (activityResult.e() != -1 || responseCode != 0) {
            com.google.android.gms.internal.play_billing.zze.zzl("ProxyBillingActivityV2", String.format("External offer dialog finished with resultCode: %s and billing's responseCode: %s", Integer.valueOf(activityResult.e()), Integer.valueOf(responseCode)));
        }
        finish();
    }
}
