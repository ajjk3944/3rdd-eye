...
public class a {
    ...
    private final LinkedHashMap<String, JSONObject> f15054a;
    ...
    public a(int i10) {
        ...
        this.f15055b = i10;
        this.f15054a = new LinkedHashMap<>(0, 0.75f, true);
    }
    ...
    public final boolean a(String str, JSONObject jSONObject) {
        ...
        synchronized (this) {
            try {
                this.f15056c += b(str, jSONObject);
                JSONObject jSONObjectPut = this.f15054a.put(str, jSONObject);
                if (jSONObjectPut != null) {
                    this.f15056c -= b(str, jSONObjectPut);
                }
            } catch (Throwable th) {
                throw th;
            }
    ...
    public final synchronized String toString() {
        return String.format("LruCache[maxSize=%d]", Integer.valueOf(this.f15055b));
    }
    ...
    public final JSONObject a(String str) {
        ...
        if (str != null) {
            synchronized (this) {
                jSONObject = this.f15054a.get(str);
            }
            return jSONObject;
        }
    ...
    public Collection<String> a() {
        HashSet hashSet;
        synchronized (this) {
            hashSet = new HashSet(this.f15054a.keySet());
        }
        return hashSet;
    }
    ...
    */
    private void a(int r4) {
        ...
        L0:
            monitor-enter(r3)
            int r0 = r3.f15056c     // Catch: java.lang.Throwable -> L12
            if (r0 < 0) goto L56
            java.util.LinkedHashMap<java.lang.String, org.json.JSONObject> r0 = r3.f15054a     // Catch: java.lang.Throwable -> L12
        ...
        L35:
            ...
            java.util.LinkedHashMap<java.lang.String, org.json.JSONObject> r2 = r3.f15054a     // Catch: java.lang.Throwable -> L52
            ...
            int r1 = r3.f15056c     // Catch: java.lang.Throwable -> L52
            int r1 = r1 - r0
            r3.f15056c = r1     // Catch: java.lang.Throwable -> L52
        L52:
            monitor-exit(r3)     // Catch: java.lang.Throwable -> L12
            goto L0
        L54:
