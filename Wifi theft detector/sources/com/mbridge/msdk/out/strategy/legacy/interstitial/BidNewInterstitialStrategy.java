...
public class BidNewInterstitialStrategy implements IBidVideoAdStrategy {
    ...
    public BidNewInterstitialStrategy(String str, String str2) throws JSONException {
        initData(str, str2);
    }
    ...
    @Override // com.mbridge.msdk.out.strategy.IBidVideoAdStrategy
    public void showFromBid(Activity activity) throws JSONException {
        checkAndCreateController();
        if (this.controller != null) {
            e eVarA = d.b().a(1, MBSupportMuteAdType.INTERSTITIAL_VIDEO, this.unitId, false, -1);
    ...
    @Override // com.mbridge.msdk.out.strategy.IBidVideoAdStrategy
    public void showFromBid(String str) throws JSONException {
        showFromBid();
    }

    @Override // com.mbridge.msdk.out.strategy.IBidVideoAdStrategy
    public void showFromBid(String str, String str2) throws JSONException {
        showFromBid();
    }

    @Override // com.mbridge.msdk.out.strategy.IBidVideoAdStrategy
    public void showFromBid(Activity activity, String str) throws JSONException {
        showFromBid(activity);
    }

    @Override // com.mbridge.msdk.out.strategy.IBidVideoAdStrategy
    public void showFromBid(Activity activity, String str, String str2) throws JSONException {
        showFromBid(activity);
    }
}
