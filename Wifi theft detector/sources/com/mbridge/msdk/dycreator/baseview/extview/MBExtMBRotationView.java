...
public class MBExtMBRotationView extends MBRotationView implements InterBase {
    ...
    private Map<String, String> f14343q;

    /* renamed from: r, reason: collision with root package name */
    private Map<String, Boolean> f14344r;
    ...
    public static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            try {
                f14346a[c.background.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f14346a[c.contentDescription.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f14346a[c.visibility.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f14346a[c.layout_width.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f14346a[c.layout_height.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f14346a[c.layout_gravity.ordinal()] = 7;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f14346a[c.layout_marginLeft.ordinal()] = 8;
            } catch (NoSuchFieldError unused8) {
            }
            try {
                f14346a[c.layout_margin.ordinal()] = 9;
    ...
    public String getActionDes() {
        Map<String, String> map = this.f14343q;
        return (map == null || !map.containsKey("mbridgeAction")) ? "" : this.f14343q.get("mbridgeAction");
    }

    @Override // com.mbridge.msdk.dycreator.baseview.inter.InterBase
    public String getBindDataDes() {
        Map<String, String> map = this.f14343q;
        return (map == null || !map.containsKey("mbridgeData")) ? "" : this.f14343q.get("mbridgeData");
    }

    @Override // com.mbridge.msdk.dycreator.baseview.inter.InterBase
    public String getEffectDes() {
        Map<String, String> map = this.f14343q;
        return (map == null || !map.containsKey("mbridgeEffect")) ? "" : this.f14343q.get("mbridgeEffect");
    }

    @Override // com.mbridge.msdk.dycreator.baseview.inter.InterBase
    public String getReportDes() {
        Map<String, String> map = this.f14343q;
        return (map == null || !map.containsKey("mbridgeReport")) ? "" : this.f14343q.get("mbridgeReport");
    }

    @Override // com.mbridge.msdk.dycreator.baseview.inter.InterBase
    public String getStrategyDes() {
        Map<String, String> map = this.f14343q;
        return (map == null || !map.containsKey("mbridgeStrategy")) ? "" : this.f14343q.get("mbridgeStrategy");
    }

    @Override // android.view.ViewGroup, android.view.View
    public void onAttachedToWindow() {
        super.onAttachedToWindow();
        Map<String, Boolean> map = this.f14344r;
        if (map != null && map.containsKey("mbridgeAttached") && this.f14344r.get("mbridgeAttached").booleanValue()) {
            new l.b("mbridgeAttached").a().b(this.f14345s);
        }
    }
    ...
    public void onDetachedFromWindow() {
        ...
        Map<String, Boolean> map = this.f14344r;
        if (map != null && map.containsKey("mbridgeDetached") && this.f14344r.get("mbridgeDetached").booleanValue()) {
            new l.b("mbridgeDetached").a().b(this.f14345s);
        }
    }
    ...
    public void setAttributeSet(AttributeSet attributeSet) {
        ...
        for (int i10 = 0; i10 < attributeCount; i10++) {
            ...
            if (cVar != null) {
                int i11 = AnonymousClass1.f14346a[cVar.ordinal()];
                if (i11 == 1) {
    ...
    public void setDynamicReport(String str, CampaignEx campaignEx) {
        this.f14344r = com.mbridge.msdk.dycreator.utils.c.a(str);
        if (campaignEx != null) {
            this.f14345s = campaignEx.getCampaignUnitId();
        }
    }
    ...
    public FrameLayout.LayoutParams generateLayoutParams(AttributeSet attributeSet) throws NumberFormatException {
        ...
        for (int i10 = 0; i10 < attributeCount; i10++) {
            ...
            if (cVar != null) {
                switch (AnonymousClass1.f14346a[cVar.ordinal()]) {
                    case 5:
                        String attributeValue = attributeSet.getAttributeValue(i10);
    ...
    public MBExtMBRotationView(Context context, AttributeSet attributeSet) {
        ...
        this.f14345s = "";
        try {
            this.f14343q = com.mbridge.msdk.dycreator.utils.c.a(context, attributeSet);
            setAttributeSet(attributeSet);
            setLayoutParams(generateLayoutParams(attributeSet));
            com.mbridge.msdk.dycreator.utils.c.a(this.f14343q, this);
        } catch (Exception e10) {
