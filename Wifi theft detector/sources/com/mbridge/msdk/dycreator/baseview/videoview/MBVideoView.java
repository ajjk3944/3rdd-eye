...
public class MBVideoView extends FrameLayout implements Player.EventListener {
    ...
    private VideoViewEventListener f14412f;

    /* renamed from: g, reason: collision with root package name */
    private final SurfaceHolder.Callback f14413g;

    /* renamed from: h, reason: collision with root package name */
    private final Runnable f14414h;

    /* renamed from: i, reason: collision with root package name */
    private final Runnable f14415i;

    /* renamed from: com.mbridge.msdk.dycreator.baseview.videoview.MBVideoView$1, reason: invalid class name */
    class AnonymousClass1 implements Runnable {

        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ MBVideoView f14416a;

        @Override // java.lang.Runnable
        public void run() {
            if (this.f14416a.f14412f != null) {
                this.f14416a.f14412f.onBufferingFail("Buffering timeout");
            }
        }
    }
    ...
    public MBVideoView(@NonNull Context context) {
        super(context);
        this.f14407a = "MBVideoView";
        this.f14408b = 1000;
        this.f14410d = 5000L;
        this.f14413g = new SurfaceHolder.Callback() { // from class: com.mbridge.msdk.dycreator.baseview.videoview.MBVideoView.2
            ...
            public void surfaceCreated(@NonNull SurfaceHolder surfaceHolder) {
                try {
                    Player.VideoComponent videoComponent = MBVideoView.this.f14409c.getVideoComponent();
        ...
        this.f14414h = new Runnable() { // from class: com.mbridge.msdk.dycreator.baseview.videoview.MBVideoView.3
            @Override // java.lang.Runnable
            public void run() {
                if (MBVideoView.this.f14412f != null) {
                    MBVideoView.this.f14412f.onBufferingFail("Buffering fail.");
                }
            }
        };
        this.f14415i = new Runnable() { // from class: com.mbridge.msdk.dycreator.baseview.videoview.MBVideoView.4
            @Override // java.lang.Runnable
            public void run() {
                try {
                    if (MBVideoView.this.f14409c == null || !MBVideoView.this.isPlaying()) {
                        return;
                    }
                    long currentPosition = MBVideoView.this.f14409c.getCurrentPosition();
                    long duration = MBVideoView.this.f14409c.getDuration();
                    ...
                    if (MBVideoView.this.f14412f != null) {
                        MBVideoView.this.f14412f.onPlayProgress(iRound, iRound2);
                    }
    ...
    public boolean isPlaying() {
        ExoPlayer exoPlayer = this.f14409c;
        return exoPlayer != null && exoPlayer.getPlaybackState() == 3 && this.f14409c.getPlayWhenReady();
    }
    ...
    */
    public void onPlayerError(com.mbridge.msdk.playercommon.exoplayer2.ExoPlaybackException r4) {
        ...
        L34:
            ...
            com.mbridge.msdk.dycreator.baseview.videoview.listener.VideoViewEventListener r1 = r3.f14412f
            if (r1 == 0) goto L53
            int r4 = r4.type
    ...
    public void onPositionDiscontinuity(int i10) {
        this.f14409c.getCurrentWindowIndex();
    }
    ...
    public void setVideoViewEventLister(VideoViewEventListener videoViewEventListener) {
        this.f14412f = videoViewEventListener;
    }
    ...
    private void a() {
        try {
            this.f14409c = ExoPlayerFactory.newSimpleInstance(new DefaultRenderersFactory(getContext()), new DefaultTrackSelector(), new DefaultLoadControl());
            ConcatenatingMediaSource concatenatingMediaSource = new ConcatenatingMediaSource();
            for (String str : this.f14411e) {
            ...
            this.f14409c.setRepeatMode(0);
            this.f14409c.prepare(concatenatingMediaSource);
            this.f14409c.addListener(this);
        } catch (Throwable th) {
            q0.b("MBVideoView", th.getMessage());
            th.toString();
        }
