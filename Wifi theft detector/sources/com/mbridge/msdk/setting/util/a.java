...
public class a {
    ...
    private static volatile a f17043c;
    ...
    public class C0312a extends com.mbridge.msdk.foundation.same.net.handler.a {
    ...
    public class b implements Runnable {
        ...
        public void run() throws Throwable {
            try {
                ...
                o0.a(this.f17047a.getBytes(), file);
                com.mbridge.msdk.foundation.buffer.sharedperference.a.b().a("MraidJSController", this.f17048b);
            } catch (Exception e10) {
    ...
    public String b() {
        try {
            ...
            if (gVarD != null && !TextUtils.isEmpty(gVarD.P())) {
                a(com.mbridge.msdk.foundation.controller.c.n().d(), gVarD.P());
            }
            return f17042b;
    ...
    public void a(Context context, String str) {
        ...
        if (TextUtils.isEmpty(strA) || !strA.equals(str)) {
            try {
                new com.mbridge.msdk.setting.net.a(context).get(0, str, (com.mbridge.msdk.foundation.same.net.wrapper.e) null, new C0312a(str), "mraid_js", ChunkedTrackBlacklistUtil.DEFAULT_TRACK_BLACKLIST_MS);
            } catch (Exception e10) {
