...
public final class e {
    ...
    static final com.mbridge.msdk.thrid.okio.f f17807a = com.mbridge.msdk.thrid.okio.f.c("PRI * HTTP/2.0\r\n\r\nSM\r\n\r\n");

    /* renamed from: b, reason: collision with root package name */
    private static final String[] f17808b = {"DATA", "HEADERS", "PRIORITY", "RST_STREAM", "SETTINGS", "PUSH_PROMISE", "PING", "GOAWAY", "WINDOW_UPDATE", "CONTINUATION"};

    /* renamed from: c, reason: collision with root package name */
    static final String[] f17809c = new String[64];

    /* renamed from: d, reason: collision with root package name */
    static final String[] f17810d = new String[256];

    static {
        int i10 = 0;
        int i11 = 0;
        while (true) {
            String[] strArr = f17810d;
        ...
        for (int i12 = 0; i12 < 3; i12++) {
            int i13 = iArr2[i12];
            int i14 = iArr[0];
            String[] strArr3 = f17809c;
            int i15 = i14 | i13;
            strArr3[i15] = strArr3[i14] + '|' + strArr3[i13];
            strArr3[i15 | 8] = strArr3[i14] + '|' + strArr3[i13] + "|PADDED";
        }
        while (true) {
            String[] strArr4 = f17809c;
            if (i10 >= strArr4.length) {
                return;
            }
            if (strArr4[i10] == null) {
                strArr4[i10] = f17810d[i10];
            }
            i10++;
        }
    }
    ...
    public static String a(byte b10, byte b11) {
        ...
        if (b10 != 2 && b10 != 3) {
            if (b10 == 4 || b10 == 6) {
                return b11 == 1 ? "ACK" : f17810d[b11];
            }
            if (b10 != 7 && b10 != 8) {
                String[] strArr = f17809c;
                String str = b11 < strArr.length ? strArr[b11] : f17810d[b11];
                if (b10 != 5 || (b11 & 4) == 0) {
