...
public final class MediaType {
    ...
    public static final class Companion {
        ...
        @Deprecated(level = DeprecationLevel.f21903b, message = "moved to extension function", replaceWith = @ReplaceWith(expression = "mediaType.toMediaType()", imports = {"com.applovin.shadow.okhttp3.MediaType.Companion.toMediaType"}))
        @JvmName(name = "-deprecated_get")
        @NotNull
        /* renamed from: -deprecated_get, reason: not valid java name */
        public final MediaType m79deprecated_get(@NotNull String mediaType) {
            p.e(mediaType, "mediaType");
            return get(mediaType);
        }

        @Deprecated(level = DeprecationLevel.f21903b, message = "moved to extension function", replaceWith = @ReplaceWith(expression = "mediaType.toMediaTypeOrNull()", imports = {"com.applovin.shadow.okhttp3.MediaType.Companion.toMediaTypeOrNull"}))
        @JvmName(name = "-deprecated_parse")
        @Nullable
        /* renamed from: -deprecated_parse, reason: not valid java name */
        public final MediaType m80deprecated_parse(@NotNull String mediaType) {
            p.e(mediaType, "mediaType");
    ...
    public final String parameter(@NotNull String name) {
        p.e(name, "name");
        int i10 = 0;
        int iB = f9.c.b(0, this.parameterNamesAndValues.length - 1, 2);
        if (iB < 0) {
            return null;
        }
        while (!r.x(this.parameterNamesAndValues[i10], name, true)) {
            if (i10 == iB) {
                return null;
            }
            i10 += 2;
