...
public final class Handshake {
    ...
    public static final class Companion {
        ...
        public final Handshake m50deprecated_get(@NotNull SSLSession sslSession) throws IOException {
        ...
        public final Handshake get(@NotNull SSLSession sSLSession) throws IOException {
            ...
            return new Handshake(tlsVersionForJavaName, cipherSuiteForJavaName, toImmutableList(sSLSession.getLocalCertificates()), new l9.a() { // from class: com.applovin.shadow.okhttp3.Handshake$Companion$handshake$1
        ...
        public final Handshake get(@NotNull TlsVersion tlsVersion, @NotNull CipherSuite cipherSuite, @NotNull List<? extends Certificate> peerCertificates, @NotNull List<? extends Certificate> localCertificates) {
            ...
            return new Handshake(tlsVersion, cipherSuite, Util.toImmutableList(localCertificates), new l9.a() { // from class: com.applovin.shadow.okhttp3.Handshake$Companion$get$1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                /* JADX WARN: Multi-variable type inference failed */
                {
                    super(0);
    ...
    /* JADX WARN: Multi-variable type inference failed */
    public Handshake(@NotNull TlsVersion tlsVersion, @NotNull CipherSuite cipherSuite, @NotNull List<? extends Certificate> localCertificates, @NotNull final l9.a peerCertificatesFn) {
        p.e(tlsVersion, "tlsVersion");
        p.e(cipherSuite, "cipherSuite");
        p.e(localCertificates, "localCertificates");
        ...
        this.peerCertificates = kotlin.b.b(new l9.a() { // from class: com.applovin.shadow.okhttp3.Handshake.peerCertificates.2
            {
                super(0);
            }
    ...
    public final List<Certificate> m45deprecated_localCertificates() {
    ...
    public final Principal m46deprecated_localPrincipal() {
    ...
    public final List<Certificate> m47deprecated_peerCertificates() {
    ...
    public final Principal m48deprecated_peerPrincipal() {
