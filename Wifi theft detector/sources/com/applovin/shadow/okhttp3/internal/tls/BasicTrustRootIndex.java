...
public final class BasicTrustRootIndex implements TrustRootIndex {
    ...
    public BasicTrustRootIndex(@NotNull X509Certificate... caCerts) {
        ...
        for (X509Certificate x509Certificate : caCerts) {
            ...
            p.d(subjectX500Principal, "caCert.subjectX500Principal");
    ...
    public boolean equals(@Nullable Object other) {
        if (other != this) {
            return (other instanceof BasicTrustRootIndex) && p.a(((BasicTrustRootIndex) other).subjectToCaCerts, this.subjectToCaCerts);
        }
        return true;
    }
