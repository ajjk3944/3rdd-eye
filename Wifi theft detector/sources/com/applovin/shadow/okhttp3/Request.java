...
public final class Request {
    ...
    public static class Builder {
        ...
        public Builder(@NotNull Request request) {
            ...
            if (request.getTags$okhttp().isEmpty()) {
                ...
                mapW = kotlin.collections.a.w(request.getTags$okhttp());
            }
            this.tags = mapW;
    ...
    public final CacheControl m116deprecated_cacheControl() {
        return cacheControl();
    }
