...
public final class FileMetadata {
    ...
    @NotNull
    private final Map<r9.c, Object> extras;
    ...
    @NotNull
    public final FileMetadata copy(boolean z10, boolean z11, @Nullable Path path, @Nullable Long l10, @Nullable Long l11, @Nullable Long l12, @Nullable Long l13, @NotNull Map<r9.c, ? extends Object> extras) {
        kotlin.jvm.internal.p.e(extras, "extras");
        return new FileMetadata(z10, z11, path, l10, l11, l12, l13, extras);
    }

    @Nullable
    public final <T> T extra(@NotNull r9.c type) {
        kotlin.jvm.internal.p.e(type, "type");
        Object obj = this.extras.get(type);
        if (obj == null) {
            return null;
        }
        return (T) r9.d.a(type, obj);
    }
    ...
    @NotNull
    public final Map<r9.c, Object> getExtras() {
        return this.extras;
    }
    ...
    public String toString() {
        ...
        return z8.z.O(arrayList, ", ", "FileMetadata(", ")", 0, null, null, 56, null);
    }

    public FileMetadata(boolean z10, boolean z11, @Nullable Path path, @Nullable Long l10, @Nullable Long l11, @Nullable Long l12, @Nullable Long l13, @NotNull Map<r9.c, ? extends Object> extras) {
        kotlin.jvm.internal.p.e(extras, "extras");
    ...
    public /* synthetic */ FileMetadata(boolean z10, boolean z11, Path path, Long l10, Long l11, Long l12, Long l13, Map map, int i10, kotlin.jvm.internal.i iVar) {
