...
public abstract class f2 {
    ...
    public static String b(com.applovin.impl.sdk.ad.b bVar) throws JSONException {
    ...
    public static Map a(com.applovin.impl.sdk.ad.b bVar) {
        ...
        if (bVar != null) {
            ...
            if (((Boolean) sdk.a(x4.L)).booleanValue()) {
                ...
                map.put(MBridgeConstans.DYNAMIC_VIEW_WX_PATH, map2.toString());
            }
    ...
    public static Map a(y2 y2Var) {
        ...
        CollectionUtils.putStringIfValid(CampaignEx.JSON_KEY_CREATIVE_ID, y2Var.getCreativeId(), mapA);
