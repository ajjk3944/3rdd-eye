...
public class JsonUtils {
    ...
    public static void putBoolean(JSONObject jSONObject, String str, boolean z10) throws JSONException {
        if (jSONObject != null) {
            try {
    ...
    public static void putDouble(JSONObject jSONObject, String str, double d10) throws JSONException {
        if (jSONObject != null) {
            try {
    ...
    public static void putInt(JSONObject jSONObject, String str, int i10) throws JSONException {
        if (jSONObject != null) {
            try {
    ...
    public static void putLong(JSONObject jSONObject, String str, long j10) throws JSONException {
        if (jSONObject != null) {
            try {
    ...
    @Nullable
    public static Float getFloat(JSONObject jSONObject, String str, @Nullable Float f10) throws JSONException {
        if (jSONObject != null && jSONObject.has(str)) {
            try {
                double d10 = jSONObject.getDouble(str);
                if (-3.4028234663852886E38d < d10 && d10 < 3.4028234663852886E38d) {
