...
public class b2 extends v1 {
    ...
    */
    ...
    public void a(com.applovin.impl.adview.g gVar, com.applovin.impl.adview.k kVar, View view, ProgressBar progressBar) {
        ...
        s.a(this.f8276d, view);
        if (gVar != null) {
            a(this.f8275c.n(), (this.f8275c.u0() ? 3 : 5) | 48, gVar);
        }
        if (progressBar != null) {
            FrameLayout.LayoutParams layoutParams = new FrameLayout.LayoutParams(-1, 20, ((Boolean) this.f8273a.a(x4.f8557q2)).booleanValue() ? 80 : 48);
            layoutParams.setMargins(0, 0, 0, ((Integer) this.f8273a.a(x4.f8565r2)).intValue());
            this.f8276d.addView(progressBar, layoutParams);
        }
        if (kVar != null) {
