...
public class b3 extends h3 {
    ...
    public long r0() {
        ...
        return jA >= 0 ? jA : b("ad_refresh_ms", ((Long) this.f6313a.a(r3.f7491y7)).longValue());
    }
    ...
    public long u0() {
        return a("viewability_imp_delay_ms", ((Long) this.f6313a.a(x4.f8532n1)).longValue());
    }
    ...
    public boolean x0() {
        return a("proe", (Boolean) this.f6313a.a(r3.f7455a8)).booleanValue();
    }

    private b3(b3 b3Var, com.applovin.impl.mediation.h hVar) {
        super(b3Var.N(), b3Var.a(), b3Var.g(), hVar, b3Var.f6313a);
    }
}
