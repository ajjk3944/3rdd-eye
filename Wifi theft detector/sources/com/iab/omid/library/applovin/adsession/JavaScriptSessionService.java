...
public class JavaScriptSessionService {
    ...
    private void addWebViewListener() {
        ...
        webViewUtil.a(this.webView, JS_MESSAGE_LISTENER_JS_SESSION_SERVICE, new HashSet(Arrays.asList(Marker.ANY_MARKER)), new g.a() { // from class: com.iab.omid.library.applovin.adsession.JavaScriptSessionService.2
            @Override // b2.g.a
