...
public abstract class AdSessionStatePublisher {
    ...
    private com.iab.omid.library.bytedance2.weakreference.b f12389b;

    /* renamed from: c, reason: collision with root package name */
    private AdEvents f12390c;

    /* renamed from: d, reason: collision with root package name */
    private MediaEvents f12391d;
    ...
    public AdSessionStatePublisher(String str) {
        a();
        this.f12388a = str;
        this.f12389b = new com.iab.omid.library.bytedance2.weakreference.b(null);
    }

    public void a() {
        this.f12393f = f.b();
        this.f12392e = a.AD_STATE_IDLE;
    }
    ...
    public boolean e() {
        return this.f12389b.get() != null;
    }

    public void f() {
        h.a().a(getWebView(), this.f12388a);
    }

    public void g() {
        h.a().b(getWebView(), this.f12388a);
    }
    ...
    public void a(float f10) {
        h.a().a(getWebView(), this.f12388a, f10);
    }

    public void b(String str, long j10) {
        if (j10 >= this.f12393f) {
            this.f12392e = a.AD_STATE_VISIBLE;
            h.a().a(getWebView(), this.f12388a, str);
        }
    }

    public void a(WebView webView) {
        this.f12389b = new com.iab.omid.library.bytedance2.weakreference.b(webView);
    }

    public void a(AdEvents adEvents) {
        this.f12390c = adEvents;
    }

    public void a(AdSessionConfiguration adSessionConfiguration) {
        h.a().a(getWebView(), this.f12388a, adSessionConfiguration.toJsonObject());
    }

    public void a(ErrorType errorType, String str) {
        h.a().a(getWebView(), this.f12388a, errorType, str);
    }
    ...
    public void a(String str, @Nullable JSONObject jSONObject) {
        h.a().a(getWebView(), this.f12388a, str, jSONObject);
    }
    ...
    public void a(@Nullable JSONObject jSONObject) {
        h.a().b(getWebView(), this.f12388a, jSONObject);
    }

    public void a(boolean z10) {
        if (e()) {
            h.a().b(getWebView(), this.f12388a, z10 ? "foregrounded" : "backgrounded");
        }
    }
}
