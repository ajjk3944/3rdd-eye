        ...
        public EnumTypeAdapter(Class<T> cls) {
            try {
                for (T t10 : cls.getEnumConstants()) {
                    ...
                    this.nameToConstant.put(strName, t10);
                    this.constantToName.put(t10, strName);
                }
    ...
    static {
        ...
        TypeAdapter<Number> typeAdapter7 = new TypeAdapter<Number>() { // from class: com.google.gson.internal.bind.TypeAdapters.14
            ...
            public Number read(JsonReader jsonReader) throws IOException {
                ...
                int i10 = AnonymousClass36.$SwitchMap$com$google$gson$stream$JsonToken[jsonTokenPeek.ordinal()];
                if (i10 == 1) {
