...
public abstract class d {
    ...
    public static final ThreadLocal f10686a = new ThreadLocal();

    /* renamed from: b, reason: collision with root package name */
    public static final ThreadLocal f10687b = new ThreadLocal();
    ...
    public static void c(ViewGroup viewGroup, View view, Rect rect) {
        ThreadLocal threadLocal = f10686a;
        ...
        ThreadLocal threadLocal2 = f10687b;
