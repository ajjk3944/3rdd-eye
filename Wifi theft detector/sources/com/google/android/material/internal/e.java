...
public abstract class e {
    public static void a(Window window, boolean z10, Integer num, Integer num2) {
        ...
        if (z11 || z12) {
            int iB = u4.a.b(window.getContext(), R.attr.colorBackground, -16777216);
            if (z11) {
        ...
        f(window, d(iC, u4.a.h(num.intValue())));
        e(window, d(iB2, u4.a.h(num2.intValue())));
    }

    public static int b(Context context, boolean z10) {
        if (z10 && Build.VERSION.SDK_INT < 27) {
            return j0.a.k(u4.a.b(context, R.attr.navigationBarColor, -16777216), 128);
        }
        if (z10) {
            return 0;
        }
        return u4.a.b(context, R.attr.navigationBarColor, -16777216);
    }
    ...
    public static int c(Context context, boolean z10) {
        ...
        return u4.a.b(context, R.attr.statusBarColor, -16777216);
    }
    ...
    public static void e(Window window, boolean z10) {
        k1.a(window, window.getDecorView()).b(z10);
    }

    public static void f(Window window, boolean z10) {
        k1.a(window, window.getDecorView()).c(z10);
    }
}
