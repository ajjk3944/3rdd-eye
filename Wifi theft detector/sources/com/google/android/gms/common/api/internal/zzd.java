...
public final class zzd extends Fragment implements LifecycleFragment {
    ...
    public static zzd zza(FragmentActivity fragmentActivity) {
        zzd zzdVar;
        FragmentManager fragmentManagerZ = fragmentActivity.z();
        ...
        try {
            zzd zzdVar2 = (zzd) fragmentManagerZ.i0("SLifecycleFragmentImpl");
            if (zzdVar2 == null || zzdVar2.isRemoving()) {
                zzdVar2 = new zzd();
                fragmentManagerZ.p().e(zzdVar2, "SLifecycleFragmentImpl").h();
            }
