...
public class GoogleApiAvailability extends GoogleApiAvailabilityLight {
    ...
    public void showErrorNotification(@NonNull Context context, int i10) throws Resources.NotFoundException {
    ...
    public final void zad(Activity activity, Dialog dialog, String str, @Nullable DialogInterface.OnCancelListener onCancelListener) {
        try {
            if (activity instanceof FragmentActivity) {
                SupportErrorDialogFragment.newInstance(dialog, onCancelListener).show(((FragmentActivity) activity).z(), str);
                return;
            }
    ...
    @TargetApi(20)
    public final void zae(Context context, int i10, @Nullable String str, @Nullable PendingIntent pendingIntent) throws Resources.NotFoundException {
        int i11;
        String str2;
        ...
        NotificationCompat.l lVarQ = new NotificationCompat.l(context).n(true).e(true).j(strZae).q(new NotificationCompat.j().h(strZad));
        if (DeviceProperties.isWearable(context)) {
            Preconditions.checkState(PlatformVersion.isAtLeastKitKatWatch());
            lVarQ.p(context.getApplicationInfo().icon).o(2);
            if (DeviceProperties.isWearableWithoutPlayStore(context)) {
                lVarQ.a(com.google.android.gms.base.R.drawable.common_full_open_on_phone, resources.getString(com.google.android.gms.base.R.string.common_open_on_phone), pendingIntent);
            } else {
                lVarQ.h(pendingIntent);
            }
        } else {
            lVarQ.p(android.R.drawable.stat_sys_warning).r(resources.getString(com.google.android.gms.base.R.string.common_google_play_services_notification_ticker)).s(System.currentTimeMillis()).h(pendingIntent).i(strZad);
        }
        if (PlatformVersion.isAtLeastO()) {
        ...
        Notification notificationB = lVarQ.b();
    ...
    public final boolean zah(@NonNull Context context, @NonNull ConnectionResult connectionResult, int i10) throws Resources.NotFoundException {
    ...
    public boolean showErrorDialogFragment(@NonNull Activity activity, int i10, @NonNull androidx.activity.result.b bVar, @Nullable DialogInterface.OnCancelListener onCancelListener) {
        Dialog dialogZaa = zaa(activity, i10, null, onCancelListener, new zac(this, activity, i10, bVar));
        if (dialogZaa == null) {
            return false;
        }
        zad(activity, dialogZaa, GooglePlayServicesUtil.GMS_ERROR_DIALOG, onCancelListener);
