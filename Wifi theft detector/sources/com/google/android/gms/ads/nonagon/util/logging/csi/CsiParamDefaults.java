...
public class CsiParamDefaults {
    ...
    public void set(@NonNull Map<String, String> map) {
        ...
        map.put("is_lite_sdk", true != zzs.zzJ(context) ? MBridgeConstans.ENDCARD_URL_TYPE_PL : "1");
        ...
        if (((Boolean) zzbd.zzc().zzd(zzbhe.zzmN)).booleanValue()) {
            zzt.zzc();
            map.put("is_bstar", true != zzs.zzG(context) ? MBridgeConstans.ENDCARD_URL_TYPE_PL : "1");
        }
