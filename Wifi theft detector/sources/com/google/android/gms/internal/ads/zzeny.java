...
public final class zzeny implements zzgyw {
    ...
    */
    ...
    public final /* synthetic */ com.google.common.util.concurrent.a zza(Object obj) throws Exception {
        int i10;
        Bundle bundle;
    ...
    public final /* synthetic */ com.google.common.util.concurrent.a zzc(zzfir zzfirVar, zzfjc zzfjcVar, zzekg zzekgVar, Throwable th) {
        zzfoe zzfoeVarA = v1.a(this.zzj, 12);
        zzfoeVarA.zzi(zzfirVar.zzE);
        zzfoeVarA.zza();
        com.google.common.util.concurrent.a aVarZzi = zzgzo.zzi(zzekgVar.zzb(zzfjcVar, zzfirVar), zzfirVar.zzR, TimeUnit.MILLISECONDS, this.zzf);
        this.zzh.zze(zzfjcVar, zzfirVar, aVarZzi, this.zzc);
        zzfon.zzd(aVarZzi, this.zzk, zzfoeVarA);
        return aVarZzi;
    }
}
