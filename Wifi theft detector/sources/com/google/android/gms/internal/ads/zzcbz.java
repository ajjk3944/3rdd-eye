...
public final class zzcbz implements zzcce {
    ...
    */
    ...
    public final void zzf() {
        synchronized (this.zzj) {
            this.zze.keySet();
            com.google.common.util.concurrent.a aVarZza = zzgzo.zza(Collections.EMPTY_MAP);
            ...
            com.google.common.util.concurrent.a aVarZzj = zzgzo.zzj(aVarZza, zzgywVar, zzgzyVar);
            com.google.common.util.concurrent.a aVarZzi = zzgzo.zzi(aVarZzj, 10L, TimeUnit.SECONDS, zzcei.zzd);
            zzgzo.zzr(aVarZzj, new zzcbu(this, aVarZzi), zzgzyVar);
            zzc.add(aVarZzi);
        }
    }
    ...
    public final /* synthetic */ com.google.common.util.concurrent.a zzh(Map map) {
        int length;
        zzihj zzihjVar;
        com.google.common.util.concurrent.a aVarZzk;
        if (map != null) {
            try {
        ...
        synchronized (this.zzj) {
            try {
                ...
                com.google.common.util.concurrent.a aVarZzb = new com.google.android.gms.ads.internal.util.zzbl(this.zzh).zzb(1, this.zzi.zzb, null, ((zzihz) zzifvVar.zzbu()).zzaN());
                if (zzccd.zzb()) {
                    aVarZzb.addListener(zzcbx.zza, zzcei.zza);
                }
                aVarZzk = zzgzo.zzk(aVarZzb, zzcbw.zza, zzcei.zzg);
            } finally {
            }
        }
        return aVarZzk;
