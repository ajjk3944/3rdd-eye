...
public abstract class zzfsa {
    ...
    */
    ...
    public abstract com.google.common.util.concurrent.a zza(Context context);
    ...
    public final synchronized void zzv() {
        ...
        try {
            ...
            if (activityZzd == null) {
                ...
                aVarZza = zza(this.zzb);
            } else {
                aVarZza = zza(activityZzd);
            }
            zzgzo.zzr(aVarZza, new zzfrp(this), this.zzn);
        } catch (Throwable th) {
            throw th;
        }
    }
