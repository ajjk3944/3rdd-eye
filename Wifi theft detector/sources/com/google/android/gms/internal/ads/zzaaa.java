...
public final class zzaaa extends zzaag implements zzmm {
    ...
    public zzaaa(Context context) {
        ...
        this.zzj = zzytVar;
        if (androidx.activity.o.a(zzzlVar)) {
            this.zze = zzzlVar;
        } else {
    ...
    */
    ...
    public final Pair zzh(zzaaf zzaafVar, int[][][] iArr, final int[] iArr2, zzwk zzwkVar, zzbf zzbfVar) throws zziw {
        ...
        Pair pairZzw4 = zzw(3, zzaafVar, iArr, new zzzr() { // from class: com.google.android.gms.internal.ads.zzzd
            ...
            public final /* synthetic */ List zza(int i17, zzbg zzbgVar, int[] iArr4) {
                ...
                for (int i20 = 0; i20 < zzbgVar.zza; i20++) {
                    zzgucVar.zzf(new zzzq(i17, zzbgVar, i20, zzzlVar, iArr4[i20], str, languageTag));
                }
                return zzgucVar.zzi();
            }
        }, zzza.zza);
        ...
        int i27 = 0;
        while (i27 < i26) {
            zzaab zzaabVar = zzaabVarArr[i27];
            if (zzaabVar != null && (length = (iArr3 = zzaabVar.zzb).length) != 0) {
                zzaacVarArr[i27] = length == 1 ? new zzaad(zzaabVar.zza, iArr3[0], 0, 0, null) : zzytVar.zza(zzaabVar.zza, iArr3, 0, zzaasVarZzt, (zzguf) zzgufVarZzd.get(i27));
            }
            i27++;
            i26 = 2;
        }
        zzmo[] zzmoVarArr = new zzmo[i26];
        for (int i28 = 0; i28 < i26; i28++) {
            zzmoVarArr[i28] = (zzzlVar.zza(i28) || zzzlVar.zzI.contains(Integer.valueOf(zzaafVar.zza(i28))) || (zzaafVar.zza(i28) != -2 && zzaacVarArr[i28] == null)) ? null : zzmo.zza;
        }
    ...
    public final /* synthetic */ boolean zzk(zzzl zzzlVar, zzv zzvVar) {
        ...
        if (i10 != -1 && i10 > 2) {
            ...
            if (str != null) {
                ...
                if ((c10 == 0 || c10 == 1 || c10 == 2 || c10 == 3) && (Build.VERSION.SDK_INT < 32 || (zzzpVar2 = this.zzg) == null || !zzzpVar2.zza())) {
                    return true;
                }
            }
