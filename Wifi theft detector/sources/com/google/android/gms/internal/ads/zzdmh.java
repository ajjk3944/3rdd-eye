...
public final class zzdmh implements zzdbf, zzdir {
    ...
    private String zze;
    private final zzbgj.zza.EnumC0198zza zzf;
    private final zzfir zzg;

    public zzdmh(zzccn zzccnVar, Context context, zzccq zzccqVar, @Nullable View view, zzbgj.zza.EnumC0198zza enumC0198zza, zzfir zzfirVar) {
        this.zza = zzccnVar;
        this.zzb = context;
        this.zzc = zzccqVar;
        this.zzd = view;
        this.zzf = enumC0198zza;
        this.zzg = zzfirVar;
    }
    ...
    public final void zzh() {
        zzbgj.zza.EnumC0198zza enumC0198zza = this.zzf;
        if (enumC0198zza != zzbgj.zza.EnumC0198zza.APP_OPEN && this.zzg.zzaG) {
            String strZzf = this.zzc.zzf(this.zzb);
            this.zze = strZzf;
            this.zze = String.valueOf(strZzf).concat(enumC0198zza == zzbgj.zza.EnumC0198zza.REWARD_BASED_VIDEO_AD ? "/Rewarded" : "/Interstitial");
        }
    }
}
