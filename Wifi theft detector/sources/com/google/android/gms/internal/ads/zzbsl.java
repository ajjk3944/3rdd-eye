...
public final class zzbsl {
    ...
    public final zzbsk zza(@Nullable zzazh zzazhVar) {
        zzfoe zzfoeVarA = v1.a(this.zzb, 6);
        zzfoeVarA.zza();
        ...
        synchronized (this.zza) {
            try {
                ...
                if (zzbskVar.zzi() != -1 && zzbskVar.zzi() != 1) {
                    ...
                    StringBuilder sb = new StringBuilder(strValueOf.length() + 94 + String.valueOf(iZzi).length() + 39 + String.valueOf(i10).length() + 57 + strValueOf2.length() + 42 + String.valueOf(jCurrentTimeMillis).length() + 15);
