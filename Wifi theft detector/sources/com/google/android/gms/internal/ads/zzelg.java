...
public final class zzelg implements zzekg {
    ...
    public final /* synthetic */ com.google.common.util.concurrent.a zzc(zzfjc zzfjcVar, zzfir zzfirVar, Object obj) throws zzcka {
        ...
        zzctyVarZzf.zzj();
        com.google.common.util.concurrent.a aVarZzj = zzduu.zzj(zzcjlVarZza, zzfiwVar.zzb, strZza, zzdxtVar.zze(), zzcvcVar.zze());
        if (zzfirVar.zzM) {
            aVarZzj.addListener(new Runnable() { // from class: com.google.android.gms.internal.ads.zzela
        ...
        aVarZzj.addListener(new Runnable() { // from class: com.google.android.gms.internal.ads.zzeld
            @Override // java.lang.Runnable
            public final /* synthetic */ void run() {
                this.zza.zzd(zzcjlVarZza);
            }
        }, this.zze);
        return zzgzo.zzk(aVarZzj, new zzgqt() { // from class: com.google.android.gms.internal.ads.zzele
