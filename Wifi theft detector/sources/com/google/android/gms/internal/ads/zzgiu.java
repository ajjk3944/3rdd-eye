...
public final class zzgiu implements zzfxb {
    ...
    public final void zza(Map map) {
        ...
        try {
            aVar = (com.google.common.util.concurrent.a) map.get("gs");
        } catch (ClassCastException | InterruptedException | ExecutionException | TimeoutException unused) {
        }
        String strZzb = (aVar == null || (Build.VERSION.SDK_INT >= 31 && !aVar.isDone()) || (zzaxgVar = (zzaxg) aVar.get(this.zzd, TimeUnit.MILLISECONDS)) == null || zzaxgVar.zzb().length() <= 1) ? "E" : zzaxgVar.zzb();
        if (strZzb.equals("E")) {
            try {
                com.google.common.util.concurrent.a aVar2 = (com.google.common.util.concurrent.a) map.get("ai");
                if (aVar2 != null) {
