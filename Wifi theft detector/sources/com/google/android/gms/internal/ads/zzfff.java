...
public final class zzfff implements zzesf {
    ...
    public final boolean zza(com.google.android.gms.ads.internal.client.zzm zzmVar, String str, @Nullable zzesd zzesdVar, zzese zzeseVar) throws JSONException, RemoteException {
        zzcvc zzcvcVarZza;
        if (str == null) {
        ...
        if (!zzb()) {
            ...
            zzfoe zzfoeVarB = v1.b(context, zzfon.zzg(zzfjkVarZzA), 3, zzmVar);
            ...
            if (!((Boolean) zzbjk.zze.zze()).booleanValue() || !zzfjjVar.zzf().zzk) {
                ...
                com.google.common.util.concurrent.a aVarZzc = zzcxjVarZzc.zzc(zzcxjVarZzc.zzb());
                this.zzl = aVarZzc;
                zzgzo.zzr(aVarZzc, new zzffb(this, zzfooVarZze, zzfoeVarB, zzcvcVarZza), this.zzb);
                return true;
            }
