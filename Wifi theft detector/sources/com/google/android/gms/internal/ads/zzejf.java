...
public final class zzejf extends zzbxk {
    ...
    private final void zzs(final Activity activity, @Nullable final com.google.android.gms.ads.internal.overlay.zzm zzmVar) throws IllegalAccessException, InstantiationException, IllegalArgumentException, InvocationTargetException {
    ...
    */
    ...
    public final void zzj(IObjectWrapper iObjectWrapper, com.google.android.gms.ads.internal.offline.buffering.zza zzaVar) {
        ...
        if (TextUtils.isEmpty(strZzz)) {
            lVar.j(zzx(R.string.offline_notification_title, "You are back online! Let's pick up where we left off"));
        } else {
            lVar.j(String.format(zzx(R.string.offline_notification_title_with_advertiser, "You are back online! Continue learning about %s"), strZzz));
        }
        lVar.e(true).k(pendingIntentZzr2).h(pendingIntentZzr).p(context.getApplicationInfo().icon).o(((Integer) com.google.android.gms.ads.internal.client.zzbd.zzc().zzd(zzbhe.zzjN)).intValue());
        ...
        if (bitmapDecodeStream != null) {
            try {
                lVar.m(bitmapDecodeStream).q(new NotificationCompat.i().i(bitmapDecodeStream).h(null));
