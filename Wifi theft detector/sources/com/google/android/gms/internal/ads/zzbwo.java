...
public final class zzbwo extends zzbwx {
    ...
    public final void zza() throws JSONException {
        ...
        builderZzP.setTitle(resourcesZzf != null ? resourcesZzf.getString(R.string.f9775s5) : "Create calendar event");
        builderZzP.setMessage(resourcesZzf != null ? resourcesZzf.getString(R.string.f9776s6) : "Allow Ad to create a calendar event?");
        builderZzP.setPositiveButton(resourcesZzf != null ? resourcesZzf.getString(R.string.f9773s3) : "Accept", new zzbwm(this));
        builderZzP.setNegativeButton(resourcesZzf != null ? resourcesZzf.getString(R.string.f9774s4) : "Decline", new zzbwn(this));
