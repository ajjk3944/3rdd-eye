...
public final class zzbwu extends zzbwx {
    ...
    public final void zza() throws JSONException {
        ...
        builderZzP.setTitle(resourcesZzf != null ? resourcesZzf.getString(R.string.f9771s1) : "Save image");
        builderZzP.setMessage(resourcesZzf != null ? resourcesZzf.getString(R.string.f9772s2) : "Allow Ad to store image in Picture gallery?");
        builderZzP.setPositiveButton(resourcesZzf != null ? resourcesZzf.getString(R.string.f9773s3) : "Accept", new zzbws(this, str, lastPathSegment));
        builderZzP.setNegativeButton(resourcesZzf != null ? resourcesZzf.getString(R.string.f9774s4) : "Decline", new zzbwt(this));
