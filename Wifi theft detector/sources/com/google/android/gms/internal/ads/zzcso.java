...
public final class zzcso implements zzbss {
    ...
    public final JSONObject zzb(zzcsr zzcsrVar) throws JSONException {
        ...
        if (zzbddVar == null) {
            ...
            JSONObject jSONObjectPut = jSONObject3.put("afmaVersion", zzbdbVar.zzb()).put("activeViewJSON", zzbdbVar.zzc()).put(CampaignEx.JSON_KEY_TIMESTAMP, zzcsrVar.zzd).put("adFormat", zzbdbVar.zza()).put("hashCode", zzbdbVar.zzd()).put("isMraid", false).put("isStopped", false).put("isPaused", zzcsrVar.zzb).put("isNative", zzbdbVar.zze()).put("isScreenOn", this.zzc.isInteractive()).put("appMuted", com.google.android.gms.ads.internal.zzt.zzi().zzd()).put("appVolume", com.google.android.gms.ads.internal.zzt.zzi().zzb());
