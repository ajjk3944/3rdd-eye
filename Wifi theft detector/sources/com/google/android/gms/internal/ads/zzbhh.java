...
public final class zzbhh {
    ...
    public zzbhh(Context context, String str) {
        ...
        com.google.android.gms.ads.internal.zzt.zzc();
        linkedHashMap.put("is_lite_sdk", true != com.google.android.gms.ads.internal.util.zzs.zzJ(context) ? MBridgeConstans.ENDCARD_URL_TYPE_PL : "1");
        ...
        if (((Boolean) com.google.android.gms.ads.internal.client.zzbd.zzc().zzd(zzbhe.zzmN)).booleanValue()) {
            Map map = this.zzb;
            com.google.android.gms.ads.internal.zzt.zzc();
            map.put("is_bstar", true != com.google.android.gms.ads.internal.util.zzs.zzG(context) ? MBridgeConstans.ENDCARD_URL_TYPE_PL : "1");
        }
