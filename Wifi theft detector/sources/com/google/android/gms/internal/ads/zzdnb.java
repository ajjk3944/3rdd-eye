...
public final class zzdnb implements zzdop {
    ...
    private final boolean zzK(@Nullable JSONObject jSONObject, @Nullable JSONObject jSONObject2, @Nullable JSONObject jSONObject3, @Nullable JSONObject jSONObject4, @Nullable String str, @Nullable JSONObject jSONObject5, boolean z10, @Nullable View view) throws JSONException {
    ...
    @Override // com.google.android.gms.internal.ads.zzdop
    public final void zzc(View view, @Nullable View view2, @Nullable Map map, @Nullable Map map2, boolean z10, @Nullable ImageView.ScaleType scaleType) throws JSONException {
    ...
    @Override // com.google.android.gms.internal.ads.zzdop
    public final void zzf(@Nullable View view, @Nullable View view2, @Nullable Map map, @Nullable Map map2, boolean z10, @Nullable ImageView.ScaleType scaleType, int i10) throws JSONException {
        Point point;
        Point point2;
        ...
        if (z12) {
            try {
                ...
                com.google.android.gms.ads.internal.util.client.zzo.zzg("Error occurred while adding CustomClickGestureSignals to adJson.", e11);
                com.google.android.gms.ads.internal.zzt.zzh().zzg(e11, "FirstPartyNativeAdCore.performCustomClickGesture");
            }
            try {
    ...
    @VisibleForTesting
    public final void zzi(@Nullable View view, @Nullable JSONObject jSONObject, @Nullable JSONObject jSONObject2, @Nullable JSONObject jSONObject3, @Nullable JSONObject jSONObject4, @Nullable String str, @Nullable JSONObject jSONObject5, @Nullable JSONObject jSONObject6, boolean z10, boolean z11) throws JSONException {
        String strZzg;
        try {
            zzJ();
