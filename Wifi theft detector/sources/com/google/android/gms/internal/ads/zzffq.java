...
public final class zzffq implements zzfgj {
    ...
    private final com.google.common.util.concurrent.a zzg(zzfli zzfliVar, zzfgk zzfgkVar) {
    ...
    public final synchronized com.google.common.util.concurrent.a zzb(final zzfgk zzfgkVar, final zzfgi zzfgiVar, zzdam zzdamVar) {
    ...
    @Override // com.google.android.gms.internal.ads.zzfgj
    public final /* bridge */ /* synthetic */ com.google.common.util.concurrent.a zzc(zzfgk zzfgkVar, zzfgi zzfgiVar, Object obj) {
        return zzb(zzfgkVar, zzfgiVar, null);
    }

    public final /* synthetic */ com.google.common.util.concurrent.a zze(zzfgk zzfgkVar, zzffp zzffpVar, zzfgi zzfgiVar, zzdam zzdamVar, zzffv zzffvVar) {
        if (zzffvVar != null) {
            ...
            com.google.common.util.concurrent.a aVarZzb = zzflvVar.zzb(zzffpVar2);
            if (aVarZzb != null) {
                this.zze = null;
                return zzgzo.zzj(aVarZzb, new zzgyw() { // from class: com.google.android.gms.internal.ads.zzffn
                    @Override // com.google.android.gms.internal.ads.zzgyw
                    public final /* synthetic */ com.google.common.util.concurrent.a zza(Object obj) {
        ...
        com.google.common.util.concurrent.a aVarZzb2 = ((zzfga) this.zza).zzb(zzfgkVar, zzfgiVar, zzdamVar);
        this.zze = zzdamVar;
        return aVarZzb2;
    }

    public final /* synthetic */ com.google.common.util.concurrent.a zzf(zzflr zzflrVar) throws zzecr {
        zzfli zzfliVar;
        zzflt zzfltVar;
        ...
        c0201zzaZzs.zzg(zzbgj.zzb.zze.zzs());
