...
final class zzsk {
    ...
    private final long zzh(long j10) {
        long jMax = Math.max(0L, (this.zzt == 0 ? this.zzu != C.TIME_UNSET ? zzfj.zzr(zzl(), this.zze) : zzj() : zzfj.zzv(j10 + this.zzk, this.zzi)) - this.zzn);
        return this.zzu != C.TIME_UNSET ? Math.min(zzfj.zzr(this.zzx, this.zze), jMax) : jMax;
    }
    ...
    */
    ...
    /* JADX WARN: Removed duplicated region for block: B:25:0x0096 A[Catch: Exception -> 0x009e, TRY_LEAVE, TryCatch #0 {Exception -> 0x009e, blocks: (B:23:0x0076, B:25:0x0096), top: B:52:0x0076 }] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
