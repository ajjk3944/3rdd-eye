...
public final class zzedt {
    ...
    public final com.google.common.util.concurrent.a zza(final zzbzu zzbzuVar) {
        ...
        if (com.google.android.gms.ads.internal.util.zzs.zzH(str)) {
            aVarZzc = zzgzo.zzc(new zzeff(1));
        } else {
            aVarZzc = (((Boolean) com.google.android.gms.ads.internal.client.zzbd.zzc().zzd(zzbhe.zziv)).booleanValue() || ((Boolean) zzbjp.zza.zze()).booleanValue()) ? this.zzc.zzc(new Callable() { // from class: com.google.android.gms.internal.ads.zzedq
        ...
        return (zzgzg) zzgzo.zzh((zzgzg) zzgzo.zzi(zzgzg.zzw(aVarZzc), ((Integer) com.google.android.gms.ads.internal.client.zzbd.zzc().zzd(zzbhe.zzgC)).intValue(), TimeUnit.SECONDS, this.zza), Throwable.class, new zzgyw() { // from class: com.google.android.gms.internal.ads.zzeds
    ...
    public final /* synthetic */ com.google.common.util.concurrent.a zzb(final zzbzu zzbzuVar, int i10, Throwable th) {
        Bundle bundle;
