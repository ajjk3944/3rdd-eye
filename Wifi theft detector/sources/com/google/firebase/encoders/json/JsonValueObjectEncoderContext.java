...
final class JsonValueObjectEncoderContext implements ObjectEncoderContext, ValueEncoderContext {
    ...
    public JsonValueObjectEncoderContext(@NonNull Writer writer, @NonNull Map<Class<?>, ObjectEncoder<?>> map, @NonNull Map<Class<?>, ValueEncoder<?>> map2, ObjectEncoder<Object> objectEncoder, boolean z10) {
    ...
    @NonNull
    public JsonValueObjectEncoderContext add(@Nullable Object obj, boolean z10) throws IOException {
        int i10 = 0;
