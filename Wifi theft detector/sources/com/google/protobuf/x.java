...
public final class x extends a implements Internal.LongList, RandomAccess, l0 {
    private static final x EMPTY_LIST = new x(new long[0], 0, false);
    private long[] array;
    private int size;
    ...
    public boolean addAll(Collection<? extends Long> collection) {
        ...
        System.arraycopy(xVar.array, 0, this.array, this.size, xVar.size);
        this.size = i12;
    ...
    private x(long[] jArr, int i10, boolean z10) {
        super(z10);
        this.array = jArr;
        this.size = i10;
    }
    ...
    public Internal.ProtobufList<Long> mutableCopyWithCapacity2(int i10) {
        if (i10 >= this.size) {
            return new x(Arrays.copyOf(this.array, i10), this.size, true);
        }
