...
public final class FieldInfo implements Comparable {
    ...
    public static final class Builder {
        ...
        public FieldInfo build() {
            k0 k0Var = this.oneof;
            if (k0Var != null) {
                return FieldInfo.forOneofMemberField(this.fieldNumber, this.type, k0Var, this.oneofStoredType, this.enforceUtf8, this.enumVerifier);
            }
    ...
    private FieldInfo(java.lang.reflect.Field field, int i10, FieldType fieldType, Class<?> cls, java.lang.reflect.Field field2, int i11, boolean z10, boolean z11, k0 k0Var, Class<?> cls2, Object obj, Internal.EnumVerifier enumVerifier, java.lang.reflect.Field field3) {
        this.field = field;
        this.type = fieldType;
    ...
    public static FieldInfo forOneofMemberField(int i10, FieldType fieldType, k0 k0Var, Class<?> cls, boolean z10, Internal.EnumVerifier enumVerifier) {
        checkFieldNumber(i10);
        Internal.checkNotNull(fieldType, "fieldType");
        Internal.checkNotNull(k0Var, "oneof");
