...
public final class StringValueKtKt {
    ...
    public static final StringValue m185initializestringValue(@NotNull l9.l block) {
    ...
    @NotNull
    public static final StringValue copy(@NotNull StringValue stringValue, @NotNull l9.l block) {
        kotlin.jvm.internal.p.e(stringValue, "<this>");
        kotlin.jvm.internal.p.e(block, "block");
        StringValueKt.Dsl.Companion companion = StringValueKt.Dsl.INSTANCE;
