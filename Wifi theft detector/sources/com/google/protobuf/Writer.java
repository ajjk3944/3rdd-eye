...
public interface Writer {
    ...
    @Deprecated
    void writeGroup(int i10, Object obj, q0 q0Var) throws IOException;

    @Deprecated
    void writeGroupList(int i10, List<?> list) throws IOException;

    @Deprecated
    void writeGroupList(int i10, List<?> list, q0 q0Var) throws IOException;
    ...
    <K, V> void writeMap(int i10, MapEntryLite.b bVar, Map<K, V> map) throws IOException;

    void writeMessage(int i10, Object obj) throws IOException;

    void writeMessage(int i10, Object obj, q0 q0Var) throws IOException;

    void writeMessageList(int i10, List<?> list) throws IOException;

    void writeMessageList(int i10, List<?> list, q0 q0Var) throws IOException;
