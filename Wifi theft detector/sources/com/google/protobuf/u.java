...
public class u extends InputStream {
    ...
    private boolean getNextByteBuffer() {
        ...
        if (this.currentByteBuffer.hasArray()) {
            ...
            this.hasArray = false;
            this.currentAddress = x0.addressOffset(this.currentByteBuffer);
    ...
    public int read() throws IOException {
        ...
        int i11 = x0.getByte(this.currentByteBufferPos + this.currentAddress) & 255;
        updateCurrentByteBufferPos(1);
        return i11;
    }
    ...
    public int read(byte[] bArr, int i10, int i11) throws IOException {
        ...
        v.position(this.currentByteBuffer, this.currentByteBufferPos);
        this.currentByteBuffer.get(bArr, i10, i11);
        v.position(this.currentByteBuffer, iPosition);
        updateCurrentByteBufferPos(i11);
        return i11;
    }
}
