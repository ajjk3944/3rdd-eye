...
public interface p0 {
    ...
    <T> void mergeGroupField(T t10, q0 q0Var, ExtensionRegistryLite extensionRegistryLite) throws IOException;

    <T> void mergeMessageField(T t10, q0 q0Var, ExtensionRegistryLite extensionRegistryLite) throws IOException;
    ...
    @Deprecated
    <T> T readGroupBySchemaWithCheck(q0 q0Var, ExtensionRegistryLite extensionRegistryLite) throws IOException;

    @Deprecated
    <T> void readGroupList(List<T> list, q0 q0Var, ExtensionRegistryLite extensionRegistryLite) throws IOException;
    ...
    <K, V> void readMap(Map<K, V> map, MapEntryLite.b bVar, ExtensionRegistryLite extensionRegistryLite) throws IOException;

    <T> T readMessage(Class<T> cls, ExtensionRegistryLite extensionRegistryLite) throws IOException;

    <T> T readMessageBySchemaWithCheck(q0 q0Var, ExtensionRegistryLite extensionRegistryLite) throws IOException;

    <T> void readMessageList(List<T> list, q0 q0Var, ExtensionRegistryLite extensionRegistryLite) throws IOException;
