...
public final class f implements p0 {
    ...
    private <T> void mergeGroupFieldInternal(T t10, q0 q0Var, ExtensionRegistryLite extensionRegistryLite) throws IOException {
        int i10 = this.endGroupTag;
        this.endGroupTag = WireFormat.makeTag(WireFormat.getTagFieldNumber(this.tag), 4);
        try {
            q0Var.mergeFrom(t10, this, extensionRegistryLite);
    ...
    private <T> void mergeMessageFieldInternal(T t10, q0 q0Var, ExtensionRegistryLite extensionRegistryLite) throws IOException {
    ...
    @Override // com.google.protobuf.p0
    public <T> void mergeGroupField(T t10, q0 q0Var, ExtensionRegistryLite extensionRegistryLite) throws IOException {
        requireWireType(3);
        mergeGroupFieldInternal(t10, q0Var, extensionRegistryLite);
    }

    @Override // com.google.protobuf.p0
    public <T> void mergeMessageField(T t10, q0 q0Var, ExtensionRegistryLite extensionRegistryLite) throws IOException {
        requireWireType(2);
        mergeMessageFieldInternal(t10, q0Var, extensionRegistryLite);
    }
    ...
    public void readFixed64List(List<Long> list) throws IOException {
        ...
        if (tagWireType2 == 1) {
            do {
                xVar.addLong(this.input.readFixed64());
                if (this.input.isAtEnd()) {
                    return;
                } else {
                    tag2 = this.input.readTag();
    ...
    public <T> T readGroup(Class<T> cls, ExtensionRegistryLite extensionRegistryLite) throws IOException {
        requireWireType(3);
        return (T) readGroup(m0.getInstance().schemaFor((Class) cls), extensionRegistryLite);
    }

    @Override // com.google.protobuf.p0
    @Deprecated
    public <T> T readGroupBySchemaWithCheck(q0 q0Var, ExtensionRegistryLite extensionRegistryLite) throws IOException {
        requireWireType(3);
        return (T) readGroup(q0Var, extensionRegistryLite);
    }

    @Override // com.google.protobuf.p0
    @Deprecated
    public <T> void readGroupList(List<T> list, Class<T> cls, ExtensionRegistryLite extensionRegistryLite) throws IOException {
        readGroupList(list, m0.getInstance().schemaFor((Class) cls), extensionRegistryLite);
    }
    ...
    public void readInt64List(List<Long> list) throws IOException {
        ...
        if (tagWireType2 == 0) {
            do {
                xVar.addLong(this.input.readInt64());
                if (this.input.isAtEnd()) {
                    return;
                } else {
                    tag2 = this.input.readTag();
    ...
    */
    public <K, V> void readMap(java.util.Map<K, V> r8, com.google.protobuf.MapEntryLite.b r9, com.google.protobuf.ExtensionRegistryLite r10) throws java.io.IOException {
        /*
            r7 = this;
            r0 = 2
    ...
    public <T> T readMessage(Class<T> cls, ExtensionRegistryLite extensionRegistryLite) throws IOException {
        requireWireType(2);
        return (T) readMessage(m0.getInstance().schemaFor((Class) cls), extensionRegistryLite);
    }

    @Override // com.google.protobuf.p0
    public <T> T readMessageBySchemaWithCheck(q0 q0Var, ExtensionRegistryLite extensionRegistryLite) throws IOException {
        requireWireType(2);
        return (T) readMessage(q0Var, extensionRegistryLite);
    }

    @Override // com.google.protobuf.p0
    public <T> void readMessageList(List<T> list, Class<T> cls, ExtensionRegistryLite extensionRegistryLite) throws IOException {
        readMessageList(list, m0.getInstance().schemaFor((Class) cls), extensionRegistryLite);
    }
    ...
    public void readSFixed64List(List<Long> list) throws IOException {
        ...
        if (tagWireType2 == 1) {
            do {
                xVar.addLong(this.input.readSFixed64());
                if (this.input.isAtEnd()) {
                    return;
                } else {
                    tag2 = this.input.readTag();
    ...
    public void readSInt64List(List<Long> list) throws IOException {
        ...
        if (tagWireType2 == 0) {
            do {
                xVar.addLong(this.input.readSInt64());
                if (this.input.isAtEnd()) {
                    return;
                } else {
                    tag2 = this.input.readTag();
    ...
    public void readUInt64List(List<Long> list) throws IOException {
        ...
        if (tagWireType2 == 0) {
            do {
                xVar.addLong(this.input.readUInt64());
                if (this.input.isAtEnd()) {
                    return;
                } else {
                    tag2 = this.input.readTag();
    ...
    private <T> T readGroup(q0 q0Var, ExtensionRegistryLite extensionRegistryLite) throws IOException {
        T t10 = (T) q0Var.newInstance();
        mergeGroupFieldInternal(t10, q0Var, extensionRegistryLite);
        q0Var.makeImmutable(t10);
        return t10;
    }

    private <T> T readMessage(q0 q0Var, ExtensionRegistryLite extensionRegistryLite) throws IOException {
        T t10 = (T) q0Var.newInstance();
        mergeMessageFieldInternal(t10, q0Var, extensionRegistryLite);
        q0Var.makeImmutable(t10);
        return t10;
    ...
    @Override // com.google.protobuf.p0
    @Deprecated
    public <T> void readGroupList(List<T> list, q0 q0Var, ExtensionRegistryLite extensionRegistryLite) throws IOException {
        int tag;
        if (WireFormat.getTagWireType(this.tag) == 3) {
            int i10 = this.tag;
            do {
                list.add(readGroup(q0Var, extensionRegistryLite));
    ...
    /* JADX WARN: Multi-variable type inference failed */
    @Override // com.google.protobuf.p0
    public <T> void readMessageList(List<T> list, q0 q0Var, ExtensionRegistryLite extensionRegistryLite) throws IOException {
        int tag;
        if (WireFormat.getTagWireType(this.tag) == 2) {
            int i10 = this.tag;
            do {
                list.add(readMessage(q0Var, extensionRegistryLite));
                if (this.input.isAtEnd() || this.nextTag != 0) {
                    return;
                } else {
                    tag = this.input.readTag();
