...
public final class AdDataRefreshToken {
    ...
    public static final /* synthetic */ AdDataRefreshToken m200boximpl(String str) {
        return new AdDataRefreshToken(str);
    }

    @NotNull
    /* renamed from: constructor-impl, reason: not valid java name */
    public static String m201constructorimpl(@NotNull String data) {
        p.e(data, "data");
        return data;
    }
    ...
    public static boolean m202equalsimpl(String str, Object obj) {
        return (obj instanceof AdDataRefreshToken) && p.a(str, ((AdDataRefreshToken) obj).m206unboximpl());
    }
