...
public final class AndroidGetLifecycleFlow$invoke$2$listener$1$onActivityStopped$1 extends SuspendLambda implements p {
    final /* synthetic */ l $$this$channelFlow;
    final /* synthetic */ Activity $activity;
    int label;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public AndroidGetLifecycleFlow$invoke$2$listener$1$onActivityStopped$1(l lVar, Activity activity, c cVar) {
        super(2, cVar);
    ...
    public final Object invoke(@NotNull j0 j0Var, @Nullable c cVar) {
        return ((AndroidGetLifecycleFlow$invoke$2$listener$1$onActivityStopped$1) create(j0Var, cVar)).invokeSuspend(s.f25199a);
    }
}
