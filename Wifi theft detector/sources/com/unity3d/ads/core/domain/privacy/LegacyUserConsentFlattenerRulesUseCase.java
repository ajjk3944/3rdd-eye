...
public final class LegacyUserConsentFlattenerRulesUseCase implements FlattenerRulesUseCase {
    ...
    public JsonFlattenerRules invoke() {
        return new JsonFlattenerRules(r.n("privacy", "unity", "pipl"), q.e(AppMeasurementSdk.ConditionalUserProperty.VALUE), r.n(CampaignEx.JSON_KEY_ST_TS, "exclude", "pii", "nonBehavioral", "nonbehavioral"));
    }
}
