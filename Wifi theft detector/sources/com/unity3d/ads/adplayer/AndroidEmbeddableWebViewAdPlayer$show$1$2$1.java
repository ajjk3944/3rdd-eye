...
public final class AndroidEmbeddableWebViewAdPlayer$show$1$2$1 extends SuspendLambda implements p {
    int label;
    ...
    public final Object invoke(@NotNull j0 j0Var, @Nullable c cVar) {
        return ((AndroidEmbeddableWebViewAdPlayer$show$1$2$1) create(j0Var, cVar)).invokeSuspend(s.f25199a);
    }
}
