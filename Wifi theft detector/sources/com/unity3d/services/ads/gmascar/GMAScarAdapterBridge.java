...
public class GMAScarAdapterBridge {
    ...
    private void loadRewardedAd(c cVar) {
        this._scarAdapter.e(ClientProperties.getApplicationContext(), cVar, new ScarRewardedAdHandler(cVar, getScarEventSubject(cVar.e()), this._gmaEventSender));
    }
    ...
    public void getSCARBiddingSignals(List<UnityAdFormat> list, BiddingSignalsHandler biddingSignalsHandler) {
        ...
        if (scarAdapterObject != null) {
            scarAdapterObject.b(ClientProperties.getApplicationContext(), list, biddingSignalsHandler);
        } else {
    ...
    public void getSCARSignal(String str, UnityAdFormat unityAdFormat) {
        ...
        if (eVar != null) {
            eVar.c(ClientProperties.getApplicationContext(), str, unityAdFormat, signalsHandler);
        } else {
    ...
    public void loadBanner(Context context, BannerView bannerView, String str, c cVar, UnityBannerSize unityBannerSize) {
        ...
        e eVar = this._scarAdapter;
        if (eVar != null) {
            eVar.d(context, bannerView, cVar, unityBannerSize.getWidth(), unityBannerSize.getHeight(), scarBannerAdHandler);
        } else {
    ...
    public void getSCARBiddingSignals(boolean z10, BiddingSignalsHandler biddingSignalsHandler) {
        ...
        if (mobileAdsBridgeBase != null && mobileAdsBridgeBase.hasSCARBiddingSupport()) {
            ...
            this._scarAdapter = scarAdapterObject;
            if (scarAdapterObject != null) {
                scarAdapterObject.a(ClientProperties.getApplicationContext(), z10, biddingSignalsHandler);
                return;
            } else {
                biddingSignalsHandler.onSignalsCollectionFailed("Could not create SCAR adapter object.");
                return;
