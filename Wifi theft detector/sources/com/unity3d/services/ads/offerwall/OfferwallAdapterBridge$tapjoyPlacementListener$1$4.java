...
public final class OfferwallAdapterBridge$tapjoyPlacementListener$1$4 extends SuspendLambda implements p {
    ...
    public final Object invoke(@NotNull j0 j0Var, @Nullable c cVar) {
        return ((OfferwallAdapterBridge$tapjoyPlacementListener$1$4) create(j0Var, cVar)).invokeSuspend(s.f25199a);
    }
}
