...
public final class UnityAdsImplementation implements IUnityAds {
    ...
    @Override // com.unity3d.services.ads.IUnityAds
    public void initialize(Context context, String str, boolean z10, final IUnityAdsInitializationListener iUnityAdsInitializationListener) throws IllegalAccessException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
        DeviceLog.entered();
    ...
    @Override // com.unity3d.services.ads.IUnityAds
    public void load(@Nullable final String str, @NonNull UnityAdsLoadOptions unityAdsLoadOptions, @Nullable final IUnityAdsLoadListener iUnityAdsLoadListener) throws IllegalAccessException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
        if (hasInvalidContext()) {
    ...
    @Override // com.unity3d.services.ads.IUnityAds
    public void getToken(@Nullable TokenConfiguration tokenConfiguration, @Nullable final IUnityAdsTokenListener iUnityAdsTokenListener) throws IllegalAccessException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
        if (hasInvalidContext()) {
            DeviceLog.error("No valid Context for getting token");
