...
public class BannerBridge {
    ...
    public static void resize(String str, int i10, int i11, int i12, int i13, float f10) throws IllegalAccessException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
        WebViewApp currentApp = WebViewApp.getCurrentApp();
        if (currentApp != null) {
    ...
    public static void visibilityChanged(String str, int i10) throws IllegalAccessException, NoSuchMethodException, SecurityException, IllegalArgumentException, InvocationTargetException {
        WebViewApp currentApp = WebViewApp.getCurrentApp();
        if (currentApp != null) {
