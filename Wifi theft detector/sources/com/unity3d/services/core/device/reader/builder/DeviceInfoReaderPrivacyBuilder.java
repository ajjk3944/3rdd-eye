...
public class DeviceInfoReaderPrivacyBuilder extends DeviceInfoReaderBuilder {
    ...
    private JsonFlattenerRules getPrivacyRequestStorageRules() {
        return new JsonFlattenerRules(Arrays.asList("privacy", "gdpr", "unity", "pipl"), Collections.singletonList(AppMeasurementSdk.ConditionalUserProperty.VALUE), Arrays.asList(CampaignEx.JSON_KEY_ST_TS, "exclude", "mode"));
    }
