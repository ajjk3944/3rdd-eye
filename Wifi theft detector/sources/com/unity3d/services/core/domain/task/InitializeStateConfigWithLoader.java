...
public final class InitializeStateConfigWithLoader implements BaseTask<Params, Configuration> {
    ...
    */
    public java.lang.Object mo230doWorkgIAlus(@org.jetbrains.annotations.NotNull com.unity3d.services.core.domain.task.InitializeStateConfigWithLoader.Params r6, @org.jetbrains.annotations.NotNull c9.c r7) {
        /*
            r5 = this;
        ...
        L49:
            ...
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: com.unity3d.services.core.domain.task.InitializeStateConfigWithLoader.mo230doWorkgIAlus(com.unity3d.services.core.domain.task.InitializeStateConfigWithLoader$Params, c9.c):java.lang.Object");
    }

    @Override // com.unity3d.services.core.domain.task.BaseTask
    @Nullable
    /* renamed from: invoke-gIAlu-s, reason: not valid java name and merged with bridge method [inline-methods] */
    public Object mo231invokegIAlus(@NotNull Params params, @NotNull c cVar) {
        return BaseTask.DefaultImpls.m232invokegIAlus(this, params, cVar);
    }
}
