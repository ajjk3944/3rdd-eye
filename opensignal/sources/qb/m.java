...
public abstract class m {
    ...
    public static final ArrayList f20789a = new ArrayList();

    /* renamed from: b, reason: collision with root package name */
    public static final Pattern f20790b = Pattern.compile("^mp4a\\.([a-zA-Z0-9]{2})(?:\\.([0-9]{1,2}))?$");

    public static String a(String str, String str2) {
        if (str != null && str2 != null) {
            String[] strArrJ = v.J(str);
    ...
    public static i0 e(String str) {
        Matcher matcher = f20790b.matcher(str);
        if (!matcher.matches()) {
            return null;
        }
