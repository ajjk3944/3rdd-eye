...
public final class j {
    ...
    public static final byte[] f9468h = {0, 7, 8, 15};

    /* renamed from: i, reason: collision with root package name */
    public static final byte[] f9469i = {0, 119, -120, -1};
    ...
    public j(int i10, int i11) {
        ...
        this.f9472c = new Canvas();
        this.f9473d = new c(719, 575, 0, 719, 0, 575);
        this.f9474e = new b(0, new int[]{0, -1, -16777216, -8421505}, b(), c());
        this.f9475f = new i(i10, i11, 0);
    }
    ...
    */
    public static void e(byte[] r21, int[] r22, int r23, int r24, int r25, android.graphics.Paint r26, android.graphics.Canvas r27) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: gb.j.e(byte[], int[], int, int, int, android.graphics.Paint, android.graphics.Canvas):void");
    }
    ...
    public static b f(u uVar, int i10) {
        ...
        while (i19 > 0) {
            ...
            double d10 = i15 - 128;
            double d11 = i11 - 128;
            iArr2[i21] = d((byte) (255 - (i13 & 255)), v.i((int) ((1.402d * d10) + d6), 0, 255), v.i((int) ((d6 - (0.34414d * d11)) - (d10 * 0.71414d)), 0, 255), v.i((int) ((d11 * 1.772d) + d6), 0, 255));
            i19 = i12;
            i20 = 0;
            i17 = i17;
            iArrC = iArrC;
    ...
    public static d g(u uVar) {
        ...
        if (i11 != 1) {
            ...
            return new d(i10, zH, bArr2, bArr);
        }
        uVar.s(uVar.i(8) * 16);
        bArr = bArr2;
        return new d(i10, zH, bArr2, bArr);
