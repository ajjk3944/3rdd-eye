...
public final class v extends ReplacementSpan {
    ...
    public TextPaint f13252x;

    /* renamed from: a, reason: collision with root package name */
    public final Paint.FontMetricsInt f13248a = new Paint.FontMetricsInt();

    /* renamed from: g, reason: collision with root package name */
    public short f13250g = -1;

    /* renamed from: r, reason: collision with root package name */
    public float f13251r = 1.0f;

    public v(u uVar) {
        se.b.m(uVar, "rasterizer cannot be null");
        this.f13249d = uVar;
    }
    ...
    */
    public final void draw(android.graphics.Canvas r19, java.lang.CharSequence r20, int r21, int r22, float r23, int r24, int r25, int r26, android.graphics.Paint r27) {
        /*
            ...
            goto L46
        L26:
            android.text.TextPaint r3 = r0.f13252x
            if (r3 != 0) goto L31
        ...
        L94:
            j4.u r2 = r0.f13249d
            kg.r r3 = r2.f13246b
            java.lang.Object r4 = r3.f14398r
            android.graphics.Typeface r4 = (android.graphics.Typeface) r4
            android.graphics.Typeface r5 = r10.getTypeface()
            r10.setTypeface(r4)
            int r2 = r2.f13245a
            int r13 = r2 * 2
            java.lang.Object r2 = r3.f14396d
            r12 = r2
            char[] r12 = (char[]) r12
            r14 = 2
            r11 = r19
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: j4.v.draw(android.graphics.Canvas, java.lang.CharSequence, int, int, float, int, int, int, android.graphics.Paint):void");
    }

    @Override // android.text.style.ReplacementSpan
    public final int getSize(Paint paint, CharSequence charSequence, int i10, int i11, Paint.FontMetricsInt fontMetricsInt) {
        Paint.FontMetricsInt fontMetricsInt2 = this.f13248a;
        paint.getFontMetricsInt(fontMetricsInt2);
        float fAbs = Math.abs(fontMetricsInt2.descent - fontMetricsInt2.ascent) * 1.0f;
        u uVar = this.f13249d;
        this.f13251r = fAbs / (uVar.b().a(14) != 0 ? ((ByteBuffer) r8.f14040r).getShort(r1 + r8.f14037a) : (short) 0);
        k4.a aVarB = uVar.b();
        int iA = aVarB.a(14);
        if (iA != 0) {
            ((ByteBuffer) aVarB.f14040r).getShort(iA + aVarB.f14037a);
        }
        short s8 = (short) ((uVar.b().a(12) != 0 ? ((ByteBuffer) r5.f14040r).getShort(r7 + r5.f14037a) : (short) 0) * this.f13251r);
        this.f13250g = s8;
