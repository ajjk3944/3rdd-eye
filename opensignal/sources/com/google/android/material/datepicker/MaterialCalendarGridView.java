...
final class MaterialCalendarGridView extends GridView {
    ...
    public MaterialCalendarGridView(Context context, AttributeSet attributeSet) {
        ...
        y.c(null);
        if (o.m0(getContext(), R.attr.windowFullscreen)) {
            setNextFocusLeftId(ed.f.cancel_button);
            setNextFocusRightId(ed.f.confirm_button);
        }
        this.f5579a = o.m0(getContext(), ed.b.nestedScrollable);
        i0.n(this, new g(2));
    }
