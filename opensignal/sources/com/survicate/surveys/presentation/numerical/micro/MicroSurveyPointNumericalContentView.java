...
public final class MicroSurveyPointNumericalContentView extends FrameLayout {
    ...
    public MicroColorScheme f6473x;

    /* renamed from: y, reason: collision with root package name */
    public final MicroQuestionHeader f6474y;
    ...
    public MicroSurveyPointNumericalContentView(Context context, AttributeSet attributeSet) {
        ...
        View viewInflate = View.inflate(context, t.view_micro_survey_point_numerical_content, this);
        View viewFindViewById = viewInflate.findViewById(r.view_micro_survey_point_numerical_content_header);
        l.d(viewFindViewById, "findViewById(...)");
        this.f6474y = (MicroQuestionHeader) viewFindViewById;
        View viewFindViewById2 = viewInflate.findViewById(r.view_micro_survey_point_numerical_content_recycler);
        ...
        View viewFindViewById5 = viewInflate.findViewById(r.view_micro_survey_point_numerical_content_comment_field);
    ...
    */
    public static final java.lang.Object a(com.survicate.surveys.presentation.numerical.micro.MicroSurveyPointNumericalContentView r6, rq.c r7) {
        /*
            boolean r0 = r7 instanceof pp.b
            if (r0 == 0) goto L13
            r0 = r7
            pp.b r0 = (pp.b) r0
            int r1 = r0.B
        ...
        L13:
            ...
            r0.<init>(r6, r7)
        L18:
            java.lang.Object r7 = r0.f20604x
            ...
            if (r2 == 0) goto L33
            if (r2 != r4) goto L2b
            com.survicate.surveys.presentation.numerical.micro.MicroSurveyPointNumericalContentView r6 = r0.f20603r
            lf.t1.G(r7)
            goto L53
        L2b:
        ...
        L67:
            ...
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: com.survicate.surveys.presentation.numerical.micro.MicroSurveyPointNumericalContentView.a(com.survicate.surveys.presentation.numerical.micro.MicroSurveyPointNumericalContentView, rq.c):java.lang.Object");
    }

    private final SurveyQuestionSurveyPoint getSurveyPoint() {
        pp.a aVar = this.f6472r;
        if (aVar != null) {
            return aVar.f20599a;
        }
        l.l("bindingData");
    ...
    private final SurveyPointNumericalSettings getSurveyPointSettings() {
        ...
        return (SurveyPointNumericalSettings) settings;
    }
    ...
    private final void setupAdapter(Bundle savedState) {
        ...
        if (zE) {
            ...
            MicroColorScheme microColorScheme = this.f6473x;
            if (microColorScheme == null) {
                l.l("colorScheme");
                throw null;
            }
            this.G = new b(answers, microColorScheme, getSurveyPointSettings(), 1);
        } else {
            List<QuestionPointAnswer> answers2 = getSurveyPoint().getAnswers();
            MicroColorScheme microColorScheme2 = this.f6473x;
            if (microColorScheme2 == null) {
                l.l("colorScheme");
                throw null;
            }
            this.G = new b(answers2, microColorScheme2, getSurveyPointSettings(), 0);
            recyclerView.i(new xo.a(getResources().getDimensionPixelSize(p.survicate_micro_question_numerical_horizontal_item_spacing)));
        ...
        eVar.f18478h = new io.sentry.android.replay.capture.e(22, this);
    ...
    public final void b(pp.a aVar, Bundle bundle) throws Resources.NotFoundException {
        this.f6472r = aVar;
        this.f6474y.a(aVar.f20600b);
        setupList(bundle);
        ...
        microSurvicateCommentField.a(this.commentFieldText, new g(1, this, MicroSurveyPointNumericalContentView.class, "onCommentChanged", "onCommentChanged(Ljava/lang/String;)V", 0, 6));
    }
    ...
    */
    public final com.survicate.surveys.infrastructure.network.SurveyAnswer c(com.survicate.surveys.entities.survey.questions.question.QuestionPointAnswer r19) {
        ...
        L1d:
            ...
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.survicate.surveys.presentation.numerical.micro.MicroSurveyPointNumericalContentView.c(com.survicate.surveys.entities.survey.questions.question.QuestionPointAnswer):com.survicate.surveys.infrastructure.network.SurveyAnswer");
    }
    ...
    public final QuestionPointAnswer getSelectedAnswer() {
        e eVar = this.G;
        if (eVar != null) {
            return (QuestionPointAnswer) eVar.f18477g;
        }
        l.l("adapter");
        throw null;
    }
