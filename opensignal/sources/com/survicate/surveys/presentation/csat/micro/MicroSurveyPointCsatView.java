...
public final class MicroSurveyPointCsatView extends FrameLayout {
    ...
    public MicroSurveyPointCsatView(Context context, AttributeSet attributeSet) {
        super(context, attributeSet, 0);
        l.e(context, "context");
        View viewInflate = View.inflate(context, t.view_micro_survey_point_csat, this);
        View viewFindViewById = viewInflate.findViewById(r.view_micro_survey_point_csat_card);
        l.d(viewFindViewById, "findViewById(...)");
        this.B = (CardView) viewFindViewById;
        View viewFindViewById2 = viewInflate.findViewById(r.view_micro_survey_point_csat_container);
        l.d(viewFindViewById2, "findViewById(...)");
        ViewGroup viewGroup = (ViewGroup) viewFindViewById2;
        this.D = viewGroup;
        View viewFindViewById3 = viewInflate.findViewById(r.view_micro_survey_point_csat_wrapper);
        l.d(viewFindViewById3, "findViewById(...)");
        ViewGroup viewGroup2 = (ViewGroup) viewFindViewById3;
        View viewFindViewById4 = viewInflate.findViewById(r.view_micro_survey_point_csat_survey_header);
        ...
        View viewFindViewById5 = viewInflate.findViewById(r.view_micro_survey_point_csat_content);
        l.d(viewFindViewById5, "findViewById(...)");
        MicroSurveyPointCsatContentView microSurveyPointCsatContentView = (MicroSurveyPointCsatContentView) viewFindViewById5;
        this.F = microSurveyPointCsatContentView;
        View viewFindViewById6 = viewInflate.findViewById(r.view_micro_survey_point_csat_disclaimer);
        ...
        View viewFindViewById7 = viewInflate.findViewById(r.view_micro_survey_point_csat_submit);
        ...
        View viewFindViewById8 = viewInflate.findViewById(r.view_micro_survey_point_csat_footer);
        ...
        microSurveyPointCsatContentView.setOnAnswerSelected(new f(0, this));
        microSurveyHeader.setOnCloseButtonListener(new d(this, 10));
    ...
    public static final boolean a(MicroSurveyPointCsatView microSurveyPointCsatView) {
        e eVar = microSurveyPointCsatView.f6388y;
        if (eVar == null) {
            l.l("bindingData");
            throw null;
        }
        ...
        DisclaimerSettings disclaimerSettings = microSurveyPointCsatView.getDisclaimerSettings();
    ...
    private final DisclaimerSettings getDisclaimerSettings() {
        e eVar = this.f6388y;
        if (eVar != null) {
            return eVar.f27487f.getDisclaimerSettings();
        }
        l.l("bindingData");
        throw null;
    }
    ...
    public final void b(e eVar, Bundle bundle) {
        this.f6388y = eVar;
        boolean z10 = !eVar.f27486e;
        CardView cardView = this.B;
        xu.d.b(cardView, z10);
        q qVar = new q(4, z10);
        WeakHashMap weakHashMap = i0.f23177a;
        z.j(cardView, qVar);
        zo.b bVar = eVar.f27482a;
        MicroSurveyPointCsatContentView microSurveyPointCsatContentView = this.F;
        microSurveyPointCsatContentView.b(bVar, bundle);
        microSurveyPointCsatContentView.setOnValidationStateUpdate(new c(0, this, MicroSurveyPointCsatView.class, "updateSubmitState", "updateSubmitState()V", 0, 8));
        this.E.a(eVar.f27483b);
        this.I.setVisibility(eVar.f27485d ? 0 : 8);
        ...
        microDisclaimerView.setOnCheckboxToggle(new c(0, this, MicroSurveyPointCsatView.class, "updateSubmitState", "updateSubmitState()V", 0, 9));
        d();
    }
    ...
    public final void d() {
        ...
        this.H.setState(f0.k(eVar.f27484c, getCurrentValidationState()));
    }
    ...
    public final QuestionValidationState getCurrentValidationState() {
        ...
        SurveyPointCsatSettings surveyPointCsatSettings = eVar.f27487f;
        boolean z10 = this.F.getSelectedAnswer() != null;
        e eVar2 = this.f6388y;
        if (eVar2 != null) {
            return y3.d(surveyPointCsatSettings, z10, eVar2.f27482a.a(), !tt.l.D0(r3.getCommentFieldText()), this.G.f6544r.isChecked());
        }
        l.l("bindingData");
        throw null;
    }
