...
public final /* data */ class SurveyPointSingleSettings implements SurveyQuestionPointSettings {
    ...
    private final List<SurveyPointSingleLogic> logic;
    ...
    public static final class Creator implements Parcelable.Creator<SurveyPointSingleSettings> {
        ...
        public final SurveyPointSingleSettings createFromParcel(Parcel parcel) {
            Boolean boolValueOf;
            ...
            if (parcel.readInt() == 0) {
                ...
                int iF2 = 0;
                while (iF2 != i10) {
                    iF2 = a.f(SurveyPointSingleSettings.class, parcel, arrayList, iF2, 1);
                }
            }
            if (parcel.readInt() == 0) {
                boolValueOf3 = null;
            ...
            while (iF != i11) {
                iF = a.f(SurveyPointSingleSettings.class, parcel, arrayList2, iF, 1);
            }
            return new SurveyPointSingleSettings(boolValueOf, boolValueOf2, arrayList, boolValueOf3, string, boolValueOf4, disclaimerSettingsCreateFromParcel, surveyLogicOperatorValueOf, arrayList2, parcel.readInt() != 0 ? SurveyPointImage.CREATOR.createFromParcel(parcel) : null);
        }

        /* JADX WARN: Can't rename method to resolve collision */
        @Override // android.os.Parcelable.Creator
        public final SurveyPointSingleSettings[] newArray(int i10) {
            return new SurveyPointSingleSettings[i10];
        }
    }

    /* JADX WARN: Multi-variable type inference failed */
    public SurveyPointSingleSettings(@o(name = "randomize_answers") Boolean bool, @o(name = "randomize_except_last") Boolean bool2, @o(name = "logic") List<SurveyPointSingleLogic> list, @o(name = "mandatory") Boolean bool3, @o(name = "comment_label") String str, @o(name = "mandatory_comment") Boolean bool4, @o(name = "disclaimer_settings") DisclaimerSettings disclaimerSettings, @o(name = "display_logic_operator") SurveyLogicOperator surveyLogicOperator, @o(name = "display_logic") List<? extends DisplayLogic> list2, @o(name = "point_image") SurveyPointImage surveyPointImage) {
    ...
    public static /* synthetic */ SurveyPointSingleSettings copy$default(SurveyPointSingleSettings surveyPointSingleSettings, Boolean bool, Boolean bool2, List list, Boolean bool3, String str, Boolean bool4, DisclaimerSettings disclaimerSettings, SurveyLogicOperator surveyLogicOperator, List list2, SurveyPointImage surveyPointImage, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            bool = surveyPointSingleSettings.randomizeAnswers;
        }
        if ((i10 & 2) != 0) {
            bool2 = surveyPointSingleSettings.randomizeExceptLast;
        }
        if ((i10 & 4) != 0) {
            list = surveyPointSingleSettings.logic;
        }
        if ((i10 & 8) != 0) {
            bool3 = surveyPointSingleSettings.mandatory;
        }
        if ((i10 & 16) != 0) {
            str = surveyPointSingleSettings.commentLabel;
        }
        if ((i10 & 32) != 0) {
            bool4 = surveyPointSingleSettings.isCommentMandatory;
        }
        if ((i10 & 64) != 0) {
            disclaimerSettings = surveyPointSingleSettings.disclaimerSettings;
        }
        if ((i10 & 128) != 0) {
            surveyLogicOperator = surveyPointSingleSettings.displayLogicOperator;
        }
        if ((i10 & 256) != 0) {
            list2 = surveyPointSingleSettings.displayLogic;
        }
        if ((i10 & 512) != 0) {
            surveyPointImage = surveyPointSingleSettings.surveyPointImage;
        }
        List list3 = list2;
        ...
        String str2 = str;
        Boolean bool5 = bool4;
        return surveyPointSingleSettings.copy(bool, bool2, list, bool3, str2, bool5, disclaimerSettings2, surveyLogicOperator2, list3, surveyPointImage2);
    }
    ...
    public final List<SurveyPointSingleLogic> component3() {
        return this.logic;
    }
    ...
    public final SurveyPointSingleSettings copy(@o(name = "randomize_answers") Boolean randomizeAnswers, @o(name = "randomize_except_last") Boolean randomizeExceptLast, @o(name = "logic") List<SurveyPointSingleLogic> logic, @o(name = "mandatory") Boolean mandatory, @o(name = "comment_label") String commentLabel, @o(name = "mandatory_comment") Boolean isCommentMandatory, @o(name = "disclaimer_settings") DisclaimerSettings disclaimerSettings, @o(name = "display_logic_operator") SurveyLogicOperator displayLogicOperator, @o(name = "display_logic") List<? extends DisplayLogic> displayLogic, @o(name = "point_image") SurveyPointImage surveyPointImage) {
        l.e(displayLogic, "displayLogic");
        return new SurveyPointSingleSettings(randomizeAnswers, randomizeExceptLast, logic, mandatory, commentLabel, isCommentMandatory, disclaimerSettings, displayLogicOperator, displayLogic, surveyPointImage);
    }
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof SurveyPointSingleSettings)) {
            return false;
        }
        SurveyPointSingleSettings surveyPointSingleSettings = (SurveyPointSingleSettings) other;
        return l.a(this.randomizeAnswers, surveyPointSingleSettings.randomizeAnswers) && l.a(this.randomizeExceptLast, surveyPointSingleSettings.randomizeExceptLast) && l.a(this.logic, surveyPointSingleSettings.logic) && l.a(this.mandatory, surveyPointSingleSettings.mandatory) && l.a(this.commentLabel, surveyPointSingleSettings.commentLabel) && l.a(this.isCommentMandatory, surveyPointSingleSettings.isCommentMandatory) && l.a(this.disclaimerSettings, surveyPointSingleSettings.disclaimerSettings) && this.displayLogicOperator == surveyPointSingleSettings.displayLogicOperator && l.a(this.displayLogic, surveyPointSingleSettings.displayLogic) && l.a(this.surveyPointImage, surveyPointSingleSettings.surveyPointImage);
    }
    ...
    public int hashCode() {
        ...
        List<SurveyPointSingleLogic> list = this.logic;
    ...
    public String toString() {
        return "SurveyPointSingleSettings(randomizeAnswers=" + this.randomizeAnswers + ", randomizeExceptLast=" + this.randomizeExceptLast + ", logic=" + this.logic + ", mandatory=" + this.mandatory + ", commentLabel=" + this.commentLabel + ", isCommentMandatory=" + this.isCommentMandatory + ", disclaimerSettings=" + this.disclaimerSettings + ", displayLogicOperator=" + this.displayLogicOperator + ", displayLogic=" + this.displayLogic + ", surveyPointImage=" + this.surveyPointImage + ')';
    }
    ...
    public void writeToParcel(Parcel parcel, int flags) {
        ...
        if (list == null) {
            ...
            Iterator<SurveyPointSingleLogic> it = list.iterator();
            while (it.hasNext()) {
