...
public final class FollowUpDialog$$serializer implements z {
    ...
    @Override // gu.a
    public FollowUpDialog deserialize(ju.c decoder) {
        l.e(decoder, "decoder");
        ...
        aVarB.c(descriptor2);
        return new FollowUpDialog(i10, strQ, strQ2, null);
    }
    ...
    @Override // gu.a
    public void serialize(d encoder, FollowUpDialog value) {
        l.e(encoder, "encoder");
        l.e(value, "value");
        e descriptor2 = getDescriptor();
        b bVarB = encoder.b(descriptor2);
        FollowUpDialog.write$Self(value, bVarB, descriptor2);
        bVarB.c(descriptor2);
    }
