            ...
            while (i17 < childCount) {
                ...
                if (childAt3.getVisibility() != 8) {
                    ...
                    if (((LinearLayout.LayoutParams) m1Var).width == -1) {
                        int i18 = ((LinearLayout.LayoutParams) m1Var).height;
                        ((LinearLayout.LayoutParams) m1Var).height = childAt3.getMeasuredHeight();
                        alertDialogLayout.measureChildWithMargins(childAt3, iMakeMeasureSpec, 0, i16, 0);
                        ((LinearLayout.LayoutParams) m1Var).height = i18;
                    }
                }
                i17++;
