...
public final class c {
    ...
    public static c b(e eVar, ByteOrder byteOrder) {
        ...
        byteBufferWrap.putInt((int) eVar2.f16278a);
        byteBufferWrap.putInt((int) eVar2.f16279b);
    ...
    public final double d(ByteOrder byteOrder) throws Throwable {
        ...
        e eVar = eVarArr[0];
        return eVar.f16278a / eVar.f16279b;
    }
    ...
    public final String f(ByteOrder byteOrder) throws Throwable {
        ...
        while (i10 < eVarArr.length) {
            sb2.append(eVarArr[i10].f16278a);
            sb2.append('/');
            sb2.append(eVarArr[i10].f16279b);
            i10++;
    ...
    /* JADX WARN: Type inference failed for: r14v25, types: [m4.e[]] */
    /* JADX WARN: Type inference failed for: r14v26, types: [int[]] */
    /* JADX WARN: Type inference failed for: r14v27, types: [int[]] */
    /* JADX WARN: Type inference failed for: r14v28, types: [m4.e[]] */
    ...
    */
    public final java.io.Serializable g(java.nio.ByteOrder r14) throws java.lang.Throwable {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: m4.c.g(java.nio.ByteOrder):java.io.Serializable");
    }

    public final String toString() {
        StringBuilder sb2 = new StringBuilder("(");
        sb2.append(g.A[this.f16270a]);
        sb2.append(", data length:");
        return h0.b.i(this.f16273d.length, ")", sb2);
    }
