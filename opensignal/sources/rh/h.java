...
public final class h implements r5.d, b0, Serializable {
    public long B;
    public long D;
    public int E;
    public long F;
    ...
    public final HashMap f21538a;

    /* renamed from: d, reason: collision with root package name */
    public final pb.f f21539d;

    /* renamed from: g, reason: collision with root package name */
    public final nh.f f21540g;

    /* renamed from: r, reason: collision with root package name */
    public final a5.b f21541r;
    ...
    public h(Context context, Map map, int i10, a5.b bVar, boolean z10, oh.e eVar) {
        int i11;
        n.b("SdkDefaultBandwidthMeter", "CustomDefaultBandwidthMeterMinimal constructor");
        this.f21538a = new HashMap(map);
        this.f21539d = new pb.f(1);
        this.f21540g = new nh.f(i10);
        this.f21541r = bVar;
        this.f21542x = z10;
        if (context == null) {
            this.E = 0;
    ...
    public final void c(Handler handler, AnalyticsCollector analyticsCollector) {
        ...
        pb.f fVar = this.f21539d;
        fVar.getClass();
        fVar.b(analyticsCollector);
        fVar.f20371b.add(new r5.c(handler, analyticsCollector));
    }
    ...
    */
    public final synchronized void d(b5.k r2, boolean r3) {
        ...
        L11:
            ...
            return
        L15:
            int r2 = r1.f21543y     // Catch: java.lang.Throwable -> Le
            if (r2 != 0) goto L26
            a5.b r2 = r1.f21541r     // Catch: java.lang.Throwable -> Le
        ...
        L26:
            int r2 = r1.f21543y     // Catch: java.lang.Throwable -> Le
            int r2 = r2 + r0
            r1.f21543y = r2     // Catch: java.lang.Throwable -> Le
            monitor-exit(r1)
            return
        L2d:
            ...
            throw r2
        */
        throw new UnsupportedOperationException("Method not decompiled: rh.h.d(b5.k, boolean):void");
    }

    @Override // r5.d
    public final void e(AnalyticsCollector analyticsCollector) {
        this.f21539d.b(analyticsCollector);
    }
    ...
    */
    public final synchronized void f(b5.k r13, boolean r14) {
        ...
        L14:
            ...
            return
        L18:
            int r13 = r12.f21543y     // Catch: java.lang.Throwable -> Lf
            if (r13 <= 0) goto L1d
            r0 = r1
        L1d:
            a5.a.i(r0)     // Catch: java.lang.Throwable -> Lf
            a5.b r13 = r12.f21541r     // Catch: java.lang.Throwable -> Lf
            ...
            float r0 = r0 / r2
            nh.f r2 = r12.f21540g     // Catch: java.lang.Throwable -> Lf
            ...
            if (r0 < 0) goto L6a
        L61:
            nh.f r0 = r12.f21540g     // Catch: java.lang.Throwable -> Lf
        ...
        L7d:
            ...
            pb.f r4 = r12.f21539d     // Catch: java.lang.Throwable -> Lf
        ...
        L88:
            int r13 = r12.f21543y     // Catch: java.lang.Throwable -> Lf
            int r13 = r13 - r1
            r12.f21543y = r13     // Catch: java.lang.Throwable -> Lf
            monitor-exit(r12)
            return
        L8f:
            ...
            throw r13
        */
        throw new UnsupportedOperationException("Method not decompiled: rh.h.f(b5.k, boolean):void");
    }
    ...
    */
    public final synchronized void g(b5.k r3, boolean r4, int r5) {
        ...
        L1c:
            ...
            throw r3
        */
        throw new UnsupportedOperationException("Method not decompiled: rh.h.g(b5.k, boolean, int):void");
    }

    public final long h(int i10) {
        Integer numValueOf = Integer.valueOf(i10);
        HashMap map = this.f21538a;
