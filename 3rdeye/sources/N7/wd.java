...
public final class wd implements D7.j<JSONObject, xd, td> {
    public static td b(D7.f context, xd template, JSONObject data) throws z7.d {
        kotlin.jvm.internal.l.f(context, "context");
        kotlin.jvm.internal.l.f(template, "template");
        kotlin.jvm.internal.l.f(data, "data");
        AbstractC5371a<String> abstractC5371a = template.f9803a;
        ...
        Object objB2 = l7.d.b(template.f9804b, data, AppMeasurementSdk.ConditionalUserProperty.VALUE, dVar, lVar);
        kotlin.jvm.internal.l.e(objB2, "resolve(context, template.value, data, \"value\")");
        return new td((String) objB, (String) objB2);
    }

    @Override // D7.j
    public final /* bridge */ /* synthetic */ Object a(D7.f fVar, Z6.b bVar, JSONObject jSONObject) {
        return b(fVar, (xd) bVar, jSONObject);
    }
}
