...
public final class m extends kotlin.jvm.internal.m implements InterfaceC5480a<List<? extends j.d>> {

    /* renamed from: g, reason: collision with root package name */
    public final /* synthetic */ j.c f13616g;
    ...
    public final List<? extends j.d> invoke() {
        ...
        int i11;
        int i12;
        j.c cVar = this.f13616g;
        List list = (List) cVar.f13601b.f();
        if (list.isEmpty()) {
            i = 0;
        } else {
            j.a aVar = (j.a) C2097r.v0(list);
            i = aVar.f13592c + aVar.f13594e;
        }
        List list2 = (List) cVar.f13601b.f();
        ...
        while (true) {
            ...
            j.a aVar2 = (j.a) list2.get(i14);
            View child = kVar.getChildAt(aVar2.f13590a);
            ...
            int i16 = ((ViewGroup.MarginLayoutParams) c5533d).topMargin;
            int i17 = ((ViewGroup.MarginLayoutParams) c5533d).bottomMargin;
            int i18 = aVar2.f13594e;
            float f12 = c5533d.f45760c;
            int i19 = aVar2.f13592c;
            if (i18 == 1) {
                ((j.d) arrayList.get(i19)).a(f12, measuredHeight, i16 + measuredHeight + i17);
            } else {
                int i20 = i18 - 1;
                float f13 = f12 / i18;
                if (i20 >= 0) {
                    while (true) {
                        j.d.b((j.d) arrayList.get(i19 + i12), 0, 0, f13, 3);
                        i12 = i12 != i20 ? i12 + 1 : 0;
                    }
                }
            }
        ...
        for (int i21 = 0; i21 < size2; i21++) {
            j.a aVar3 = (j.a) list2.get(i21);
            View child2 = kVar.getChildAt(aVar3.f13590a);
            ...
            int i23 = ((ViewGroup.MarginLayoutParams) c5533d2).topMargin;
            int i24 = ((ViewGroup.MarginLayoutParams) c5533d2).bottomMargin;
            int i25 = aVar3.f13594e;
            j.b bVar = new j.b(aVar3.f13592c, measuredHeight2, i23, i24, c5533d2.f45760c, i25);
            if (i25 > 1) {
                arrayList2.add(bVar);
            }
        }
            ...
            if (f11 > f10) {
                if (i27 <= i29) {
                    while (true) {
                        ...
                        if (dVar2.c()) {
                            int iCeil = (int) Math.ceil((dVar2.f13610d / f11) * i10);
