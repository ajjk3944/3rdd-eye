...
public final class e {
    ...
    public static final String f16892b = m.g("Data");

    /* renamed from: c, reason: collision with root package name */
    public static final e f16893c;

    /* renamed from: a, reason: collision with root package name */
    public final HashMap f16894a;
    ...
    public static final class a {
        ...
        public final void a(Object obj, String str) {
            ...
            if (cls == boolean[].class) {
                map.put(str, e.a((boolean[]) obj));
                return;
            }
            if (cls == byte[].class) {
                map.put(str, e.b((byte[]) obj));
                return;
            }
            if (cls == int[].class) {
                map.put(str, e.e((int[]) obj));
                return;
            }
            if (cls == long[].class) {
                map.put(str, e.f((long[]) obj));
                return;
            }
            if (cls == float[].class) {
                map.put(str, e.d((float[]) obj));
                return;
            }
            if (cls == double[].class) {
                map.put(str, e.c((double[]) obj));
                return;
            }
    ...
    */
    public static androidx.work.e g(byte[] r8) throws java.lang.Throwable {
        /*
            java.lang.String r0 = "Error in Data#fromByteArray: "
            java.lang.String r1 = androidx.work.e.f16892b
            int r2 = r8.length
    ...
    public static byte[] i(e eVar) throws Throwable {
        String str = f16892b;
        ...
        try {
            try {
                ...
                try {
                    objectOutputStream2.writeInt(eVar.f16894a.size());
                    for (Map.Entry entry : eVar.f16894a.entrySet()) {
    ...
    public final boolean equals(Object obj) {
        if (this != obj) {
            if (obj != null && e.class == obj.getClass()) {
                HashMap map = this.f16894a;
                Set<String> setKeySet = map.keySet();
                HashMap map2 = ((e) obj).f16894a;
    ...
    public final String h(String str) {
        Object obj = this.f16894a.get(str);
    ...
    public final int hashCode() {
        return this.f16894a.hashCode() * 31;
    }
    ...
    public e(e eVar) {
        this.f16894a = new HashMap(eVar.f16894a);
    }

    public e(HashMap map) {
        this.f16894a = new HashMap(map);
    }
}
