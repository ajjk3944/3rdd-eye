...
public final class z extends A {
    ...
    public final int b(View view) {
        ...
        return view.getBottom() + ((RecyclerView.q) view.getLayoutParams()).f16519b.bottom + ((ViewGroup.MarginLayoutParams) qVar).bottomMargin;
    }
    ...
    public final int e(View view) {
        RecyclerView.q qVar = (RecyclerView.q) view.getLayoutParams();
        this.f16364a.getClass();
        return (view.getTop() - ((RecyclerView.q) view.getLayoutParams()).f16519b.top) - ((ViewGroup.MarginLayoutParams) qVar).topMargin;
    }

    @Override // androidx.recyclerview.widget.A
    public final int f() {
        return this.f16364a.f16511o;
    }
    ...
    @Override // androidx.recyclerview.widget.A
    public final int k() {
        return this.f16364a.a0();
    }

    @Override // androidx.recyclerview.widget.A
    public final int l() {
        RecyclerView.p pVar = this.f16364a;
        return (pVar.f16511o - pVar.a0()) - pVar.X();
    }
