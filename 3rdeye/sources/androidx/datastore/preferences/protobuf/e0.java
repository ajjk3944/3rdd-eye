...
public interface e0 {
    <T> T a(f0<T> f0Var, C1737o c1737o) throws IOException;

    <K, V> void b(Map<K, V> map, I.a<K, V> aVar, C1737o c1737o) throws IOException;

    @Deprecated
    <T> void c(List<T> list, f0<T> f0Var, C1737o c1737o) throws IOException;

    <T> void d(List<T> list, f0<T> f0Var, C1737o c1737o) throws IOException;

    @Deprecated
    <T> T e(f0<T> f0Var, C1737o c1737o) throws IOException;
    ...
    AbstractC1730h readBytes() throws IOException;

    void readBytesList(List<AbstractC1730h> list) throws IOException;
