...
public class ApiStartSession extends BaseApi {
    ...
    public class OnSessionStartCallback implements Api.OnApiCallback {
                            ...
                            public void run() {
                                try {
                                    if (!OnSessionStartCallback.this.isLicenseResponseValid(i) && ApiStartSession.this.licenseAttemptsCounter < 3) {
                                        ...
                                        OnSessionStartCallback.this.performLicenseCheck(anonymousClass1.val$singular, anonymousClass1.val$identifier);
                                    } else {
        ...
        public boolean handle(SingularInstance singularInstance, int i, String str) {
            ...
            try {
                ...
                String str3 = ApiStartSession.this.get(SingularParamsBase.Constants.IDENTIFIER_UNIQUE_ID_KEY);
                ...
                ApiStartSession.logger.error("error in handle()", e4);
                return false;
            }
        }

        public void handleDDL(SingularInstance singularInstance, final String str, String str2) {
        ...
        public void performLicenseCheck(SingularInstance singularInstance, String str) {
    ...
    public static class Params extends SingularParamsBase {
        ...
        public static Params build(long j4, SingularInstance singularInstance) {
            return new Params().withId(j4).withSingularConfig(singularInstance.getSingularConfig()).withDeviceInfo(singularInstance.getDeviceInfo()).withConnectionType(Utils.getConnectionType(singularInstance.getContext())).withAppInstallInfo(singularInstance).withInstallReferrer(singularInstance).withDTInstallReferrer(singularInstance).withUtils();
        }
        ...
        private Params withSingularConfig(SingularConfig singularConfig) throws IOException {
    ...
    public ApiStartSession(long j4) {
        super(Constants.API_TYPE_SESSION_START, j4);
