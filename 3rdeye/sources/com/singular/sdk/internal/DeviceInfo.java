...
class DeviceInfo {
    ...
    public DeviceInfo(Context context, boolean z10, Boolean bool) throws PackageManager.NameNotFoundException, Settings.SettingNotFoundException {
        setAppInfo(context);
    ...
    private void getInstallTimestamps(Context context) throws PackageManager.NameNotFoundException {
        try {
            ...
            logger.error("getInstallDates failed", e4);
        }
    }
