...
public class SLReflectionInstallReferrer implements InvocationHandler {
    ...
    private void closeReferrerClient() {
        ...
        try {
            ...
            logger.error("closeReferrerClient %s", e4.getMessage());
        }
    ...
    private Object createProxyInstallReferrerStateListener(Class cls) {
        try {
            ...
            logger.error("InstallReferrer proxy exception %s", e4.getMessage());
            return null;
        }
    }
    ...
    private long getInstallBeginTimestampSeconds(Object obj) {
        ...
        try {
            ...
            logger.error("getInstallBeginTimestampSeconds error %s", e4.getMessage());
            return -1L;
        }
    }
    ...
    private Object getInstallReferrer() {
        ...
        try {
            ...
            logger.error("getInstallReferrer error %s", e4.getMessage());
            return null;
        }
    }
    ...
    private Class getInstallReferrerStateListenerClass() {
        try {
            ...
            logger.error("getInstallReferrerStateListenerClass %s", e4.getMessage());
            return null;
        }
    }
    ...
    private long getReferrerClickTimestampSeconds(Object obj) {
        ...
        try {
            ...
            logger.error("getReferrerClickTimestampSeconds error %s", e4.getMessage());
            return -1L;
        }
    }
    ...
    private String getStringInstallReferrer(Object obj) {
        ...
        try {
            ...
            logger.error("getStringInstallReferrer error %s", e4.getMessage());
            return null;
        }
    }

    private void handleOnInstallReferrerSetupFinished(int i) {
        int i10 = AnonymousClass1.$SwitchMap$com$singular$sdk$internal$InstallReferrer$SLReflectionInstallReferrer$InstallReferrerCodes[InstallReferrerCodes.values()[i].ordinal()];
        if (i10 == 1) {
            try {
                ...
                logger.error("Couldn't get install referrer %s", e4.getMessage());
                return;
            }
        }
        if (i10 == 2) {
    ...
    private void startConnection(Class cls, Object obj) {
        try {
            ...
            logger.error("startConnection error %s", e4.getMessage());
        }
    }
}
