...
public final class k extends MessageNano {
    ...
    public long[] f36958b = WireFormatNano.EMPTY_LONG_ARRAY;
    ...
    public final int computeSerializedSize() {
        ...
        if (!this.f36957a.equals("")) {
            iComputeSerializedSize += CodedOutputByteBufferNano.computeStringSize(1, this.f36957a);
        }
        long[] jArr = this.f36958b;
    ...
    public final MessageNano mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        while (true) {
            ...
            if (tag == 10) {
                this.f36957a = codedInputByteBufferNano.readString();
            } else if (tag == 16) {
    ...
    public final void writeTo(CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
        if (!this.f36957a.equals("")) {
            codedOutputByteBufferNano.writeString(1, this.f36957a);
        }
        long[] jArr = this.f36958b;
        if (jArr != null && jArr.length > 0) {
            int i = 0;
