...
public final class t7 {
    ...
    public static ProgressBar d(Context context) {
        ...
        progressBar.setProgressDrawable(s7.a());
    ...
    private static ImageView a(Context context, String str, int i) {
        ...
        ColorDrawable colorDrawable = s7.f32884a;
        ColorDrawable colorDrawable2 = new ColorDrawable(r7.a());
