...
public class SdkConfigurationImpl implements AppLovinSdkConfiguration {
    ...
    public AppLovinSdkConfiguration.ConsentDialogState getConsentDialogState() {
        String str = this.f21012a.n0().getExtraParameters().get("consent_dialog_state");
        if (!StringUtils.isValidString(str)) {
            str = (String) this.f21012a.a(l4.f19993o6);
        }
    ...
    public AppLovinSdkConfiguration.ConsentFlowUserGeography getConsentFlowUserGeography() {
        String str = (String) this.f21012a.a(l4.f19993o6);
    ...
    public String getCountryCode() {
        return (String) this.f21012a.a(l4.f20001p6);
    }
