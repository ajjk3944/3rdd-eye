...
public class JsonUtils {
    ...
    public static double getDouble(JSONObject jSONObject, String str, double d10) {
        if (jSONObject != null && jSONObject.has(str)) {
            try {
                ...
                o.b("JsonUtils", "Failed to retrieve double property for key = " + str, e4);
            }
        }
        return d10;
    }
    ...
    public static float getFloat(JSONObject jSONObject, String str, float f10) throws JSONException {
        if (jSONObject != null && jSONObject.has(str)) {
            try {
                ...
                o.b("JsonUtils", "Failed to retrieve float property for key = " + str, e4);
            }
        }
        return f10;
    }
    ...
    public static int getInt(JSONObject jSONObject, String str, int i) {
        if (jSONObject != null && jSONObject.has(str)) {
            try {
                ...
                o.b("JsonUtils", "Failed to retrieve int property for key = " + str, e4);
            }
        }
        return i;
    }
    ...
    public static JSONArray getJSONArray(JSONObject jSONObject, String str, JSONArray jSONArray) {
        if (jSONObject != null && jSONObject.has(str)) {
            try {
                ...
                o.b("JsonUtils", "Failed to retrieve JSON array for key = " + str, e4);
            }
        }
        return jSONArray;
    }
    ...
    public static long getLong(JSONObject jSONObject, String str, long j4) {
        if (jSONObject != null && jSONObject.has(str)) {
            try {
                ...
                o.b("JsonUtils", "Failed to retrieve long property for key = " + str, e4);
            }
        }
        return j4;
    }
    ...
    public static Object getObject(JSONObject jSONObject, String str, Object obj) throws JSONException {
        if (jSONObject != null && jSONObject.has(str)) {
            try {
                ...
                o.b("JsonUtils", "Failed to retrieve Object for key = " + str, e4);
            }
        }
        return obj;
    }
    ...
    public static Object getObjectAtIndex(JSONArray jSONArray, int i, Object obj) {
        if (jSONArray != null && jSONArray.length() > i) {
            try {
                ...
                o.b("JsonUtils", "Failed to retrieve object at index " + i + " for JSON array", e4);
            }
        }
        return obj;
    }
    ...
    public static String getString(JSONObject jSONObject, String str, String str2) {
        if (jSONObject != null) {
            try {
                ...
                o.b("JsonUtils", "Failed to retrieve string property for key = " + str, e4);
            }
        }
        return str2;
    }
    ...
    public static JSONObject jsonObjectFromJsonString(String str, JSONObject jSONObject) {
        try {
            ...
            o.b("JsonUtils", "Failed to convert JSON string '" + str + "' to JSONObject", e4);
            return jSONObject;
        }
    }
    ...
    public static void putBoolean(JSONObject jSONObject, String str, boolean z10) {
        if (jSONObject != null) {
            try {
                ...
                o.b("JsonUtils", "Failed to put boolean property for key = " + str, e4);
            }
        }
    }
    ...
    public static void putDouble(JSONObject jSONObject, String str, double d10) {
        if (jSONObject != null) {
            try {
                ...
                o.b("JsonUtils", "Failed to put double property for key = " + str, e4);
            }
        }
    }
    ...
    public static void putInt(JSONObject jSONObject, String str, int i) {
        if (jSONObject != null) {
            try {
                ...
                o.b("JsonUtils", "Failed to put int property for key = " + str, e4);
            }
        }
    }
    ...
    public static void putJSONObject(JSONObject jSONObject, String str, JSONObject jSONObject2) throws JSONException {
        if (jSONObject != null) {
            try {
                ...
                o.b("JsonUtils", "Failed to put JSON property for key = " + str, e4);
            }
        }
    }
    ...
    public static void putJsonArray(JSONObject jSONObject, String str, JSONArray jSONArray) throws JSONException {
        if (jSONObject != null) {
            try {
                ...
                o.b("JsonUtils", "Failed to put JSONArray property for key = " + str, e4);
            }
        }
    }
    ...
    public static void putLong(JSONObject jSONObject, String str, long j4) {
        if (jSONObject != null) {
            try {
                jSONObject.put(str, j4);
            } catch (JSONException e4) {
                o.b("JsonUtils", "Failed to put long property for key = " + str, e4);
            }
        }
    }
    ...
    public static void putObject(JSONObject jSONObject, String str, Object obj) throws JSONException {
        if (jSONObject != null) {
            try {
                ...
                o.b("JsonUtils", "Failed to put Object property for key = " + str, e4);
            }
        }
    }
    ...
    public static void putString(JSONObject jSONObject, String str, String str2) throws JSONException {
        if (jSONObject != null) {
            try {
                ...
                o.b("JsonUtils", "Failed to put String property for key = " + str, e4);
            }
        }
    }
    ...
    public static JSONObject getJSONObject(JSONObject jSONObject, String str, JSONObject jSONObject2) {
        if (jSONObject != null && jSONObject.has(str)) {
            try {
                ...
                o.b("JsonUtils", "Failed to retrieve JSON property for key = " + str, e4);
            }
        }
        return jSONObject2;
    }
    ...
    public static JSONObject getJSONObject(JSONArray jSONArray, int i, JSONObject jSONObject) {
        if (jSONArray != null && i < jSONArray.length()) {
            try {
                ...
                o.b("JsonUtils", "Failed to retrieve JSON object from array for index = " + i, e4);
            }
        }
        return jSONObject;
    }
    ...
    public static Map<String, Object> toStringObjectMap(String str) {
        try {
            ...
            o.b("JsonUtils", "Failed to convert json string '" + str + "' to map", e4);
            return new HashMap();
        }
    }
