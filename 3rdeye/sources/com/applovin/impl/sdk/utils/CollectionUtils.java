...
public class CollectionUtils {
    ...
    public static void putLongIfValid(String str, Long l5, Map map) {
        if (!StringUtils.isValidString(str) || l5 == null) {
            return;
        }
        map.put(str, l5);
    }
    ...
    public static String toJsonString(Map<String, String> map, String str) {
        try {
            ...
            o.c("CollectionUtils", "Failed to convert map '" + map + "' to JSON string.", e4);
            return str;
        }
    }
