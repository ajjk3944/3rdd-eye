...
public class StringUtils {
    ...
    private static final char[] f21432a = "0123456789abcdef".toCharArray();
    ...
    private static String a(String str, Integer num) {
        ...
        try {
            ...
            throw new RuntimeException(C1154e9.i("SHA-1 for \"", str, "\" failed."), th);
        }
    }
    ...
    public static SpannedString createSpannedString(String str, int i, int i10) {
        return createSpannedString(str, i, i10, 0);
    }
    ...
    public static String getHostAndPath(String str) {
        ...
        Uri uri = Uri.parse(str);
        return G8.s(emptyIfNull(uri.getHost()), emptyIfNull(uri.getPath()));
    }
    ...
    public static long parseLong(String str, long j4) {
        return isNumeric(str) ? Long.parseLong(str) : j4;
    }
    ...
    public static SpannedString createSpannedString(String str, int i, int i10, int i11) {
