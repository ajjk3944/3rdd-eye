...
public class BundleUtils {
    ...
    public static void putLong(String str, Long l5, Bundle bundle) {
        if (l5 != null) {
    ...
    public static JSONObject toJSONObject(Bundle bundle) throws JSONException {
        ...
        try {
            ...
            o.c("AppLovinSdk", "Failed to convert Bundle to JSONObject", e4);
        }
        return jSONObject;
    }
    ...
    public static boolean getBoolean(String str, boolean z10, Bundle bundle) {
        if (!TextUtils.isEmpty(str) && bundle != null && bundle.containsKey(str)) {
            ...
            if (obj instanceof String) {
                ...
                if (str2.equalsIgnoreCase("false") || str2.equalsIgnoreCase(CommonUrlParts.Values.FALSE_INTEGER)) {
                    return false;
                }
            }
        }
    ...
    public static long getLong(String str, long j4, Bundle bundle) {
        if (!TextUtils.isEmpty(str) && bundle != null && bundle.containsKey(str)) {
            Object obj = bundle.get(str);
            if (obj instanceof Number) {
