...
public class v3 extends s3 {
    ...
    public AdSessionContext a(WebView webView) {
        try {
            return AdSessionContext.createNativeAdSessionContext(this.f20928b.d0().b(), this.f20928b.d0().a(), this.f20927a.getOpenMeasurementVerificationScriptResources(), this.f20927a.getOpenMeasurementContentUrl(), this.f20927a.getOpenMeasurementCustomReferenceData());
        } catch (Throwable th) {
