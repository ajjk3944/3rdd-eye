...
public class JavaScriptSessionService {
    ...
    private void addWebViewListener() {
        ...
        webViewUtil.a(this.webView, JS_MESSAGE_LISTENER_JS_SESSION_SERVICE, new HashSet(Arrays.asList("*")), new d.a() { // from class: com.iab.omid.library.applovin.adsession.JavaScriptSessionService.2
            @Override // R1.d.a
            public void onPostMessage(WebView webView, c cVar, Uri uri, boolean z10, R1.a aVar) throws JSONException {
                try {
