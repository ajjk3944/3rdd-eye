...
public class c {
    ...
    private static WindowManager f23601a;

    /* renamed from: b, reason: collision with root package name */
    private static String[] f23602b = {"x", "y", "width", "height"};

    /* renamed from: c, reason: collision with root package name */
    static float f23603c = Resources.getSystem().getDisplayMetrics().density;
    ...
    public static void b(JSONObject jSONObject) throws JSONException {
        ...
        try {
            jSONObject.put("width", bVarA.f23605a);
            jSONObject.put("height", bVarA.f23606b);
    ...
    private static b a(JSONObject jSONObject) {
        ...
        if (f23601a != null) {
            ...
            f23601a.getDefaultDisplay().getRealSize(point);
            fA = a(point.x);
            fA2 = a(point.y);
        } else {
            fA = 0.0f;
    ...
    public static void a(Context context) {
        if (context != null) {
            f23603c = context.getResources().getDisplayMetrics().density;
            f23601a = (WindowManager) context.getSystemService("window");
        }
    }
    ...
    public static void a(JSONObject jSONObject, a.C0360a c0360a) throws JSONException {
        com.iab.omid.library.applovin.internal.e eVarA = c0360a.a();
        JSONArray jSONArray = new JSONArray();
        Iterator<String> it = c0360a.b().iterator();
        while (it.hasNext()) {
    ...
    private static boolean a(OutputDeviceStatus outputDeviceStatus) {
        return a.f23604a[outputDeviceStatus.ordinal()] == 1;
    }
