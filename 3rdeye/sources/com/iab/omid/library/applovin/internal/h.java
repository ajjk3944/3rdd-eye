...
public class h {
    ...
    private static h f23565a = new h();

    public class a implements Runnable {

        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ WebView f23566a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ String f23567b;

        public a(WebView webView, String str) {
            this.f23566a = webView;
            this.f23567b = str;
        }

        @Override // java.lang.Runnable
        public void run() {
            h.this.c(this.f23566a, this.f23567b);
        }
    }
    ...
    public void a(WebView webView, String str, ErrorType errorType, String str2) {
        a(webView, com.vungle.ads.internal.presenter.g.ERROR, errorType.toString(), str2, str);
    }
