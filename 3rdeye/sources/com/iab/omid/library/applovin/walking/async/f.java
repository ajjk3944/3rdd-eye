...
public class f extends a {
    public f(b.InterfaceC0361b interfaceC0361b, HashSet<String> hashSet, JSONObject jSONObject, long j4) {
    ...
    public String doInBackground(Object... objArr) {
        if (com.iab.omid.library.applovin.utils.c.h(this.f23633d, this.f23636b.a())) {
            return null;
        }
        this.f23636b.a(this.f23633d);
