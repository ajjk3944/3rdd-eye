...
public interface l0 {
    ...
    <T> void mergeGroupField(T t10, n0<T> n0Var, C4034q c4034q) throws IOException;

    <T> void mergeMessageField(T t10, n0<T> n0Var, C4034q c4034q) throws IOException;

    boolean readBool() throws IOException;

    void readBoolList(List<Boolean> list) throws IOException;

    AbstractC4026i readBytes() throws IOException;

    void readBytesList(List<AbstractC4026i> list) throws IOException;
    ...
    @Deprecated
    <T> T readGroup(Class<T> cls, C4034q c4034q) throws IOException;

    @Deprecated
    <T> T readGroupBySchemaWithCheck(n0<T> n0Var, C4034q c4034q) throws IOException;

    @Deprecated
    <T> void readGroupList(List<T> list, n0<T> n0Var, C4034q c4034q) throws IOException;

    @Deprecated
    <T> void readGroupList(List<T> list, Class<T> cls, C4034q c4034q) throws IOException;
    ...
    <K, V> void readMap(Map<K, V> map, M.b<K, V> bVar, C4034q c4034q) throws IOException;

    <T> T readMessage(Class<T> cls, C4034q c4034q) throws IOException;

    <T> T readMessageBySchemaWithCheck(n0<T> n0Var, C4034q c4034q) throws IOException;

    <T> void readMessageList(List<T> list, n0<T> n0Var, C4034q c4034q) throws IOException;

    <T> void readMessageList(List<T> list, Class<T> cls, C4034q c4034q) throws IOException;
