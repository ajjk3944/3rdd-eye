...
public final class C4024g {
    ...
    private static long getChannelFieldOffset(Class<?> cls) {
        ...
        try {
            if (y0.hasUnsafeArrayOperations()) {
                return y0.objectFieldOffset(cls.getDeclaredField("channel"));
            }
            return -1L;
    ...
    private static boolean needToReallocate(int i, int i10) {
        return i10 < i && ((float) i10) < ((float) i) * BUFFER_REALLOCATION_THRESHOLD;
    }
    ...
    private static boolean writeToChannel(ByteBuffer byteBuffer, OutputStream outputStream) throws IOException {
        ...
        try {
            writableByteChannel = (WritableByteChannel) y0.getObject(outputStream, j4);
