...
public class RequestConfiguration {
    ...
    public /* synthetic */ RequestConfiguration(int i, int i10, String str, List list, PublisherPrivacyPersonalizationState publisherPrivacyPersonalizationState, zzi zziVar) {
        this.zzb = i;
        this.zzc = i10;
        this.zzd = str;
        this.zze = list;
