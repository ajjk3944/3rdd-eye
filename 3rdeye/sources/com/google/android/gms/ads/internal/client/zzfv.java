...
public final class zzfv extends AbstractSafeParcelable {
    ...
    public zzfv(@SafeParcelable.Param(id = 1) String str, @SafeParcelable.Param(id = 2) int i, @SafeParcelable.Param(id = 3) zzm zzmVar, @SafeParcelable.Param(id = 4) int i10) {
        this.zza = str;
        this.zzb = i;
        this.zzc = zzmVar;
        this.zzd = i10;
