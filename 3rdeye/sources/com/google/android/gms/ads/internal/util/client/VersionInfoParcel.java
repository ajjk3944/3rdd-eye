...
public final class VersionInfoParcel extends AbstractSafeParcelable {
    ...
    public VersionInfoParcel(int i, int i10, boolean z10) {
    ...
    public VersionInfoParcel(int i, int i10, boolean z10, boolean z11) {
        this(i, i10, z10, false, z11);
    }

    /* JADX WARN: Illegal instructions before constructor call */
    public VersionInfoParcel(int i, int i10, boolean z10, boolean z11, boolean z12) {
        String str;
        if (z10) {
        ...
        StringBuilder sbI = s.i("afma-sdk-a-v", i, ".", i10, ".");
        sbI.append(str);
        this(sbI.toString(), i, i10, z10, z12);
    }

    @SafeParcelable.Constructor
    public VersionInfoParcel(@SafeParcelable.Param(id = 2) String str, @SafeParcelable.Param(id = 3) int i, @SafeParcelable.Param(id = 4) int i10, @SafeParcelable.Param(id = 5) boolean z10, @SafeParcelable.Param(id = 6) boolean z11) {
