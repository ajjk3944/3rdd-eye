...
public final class zzl {
    ...
    private static synchronized void zzm(String str) {
        try {
            ...
            while (i < str.length()) {
                int i10 = i + 4000;
                zzo.zzi("GMA Debug CONTENT ".concat(String.valueOf(str.substring(i, Math.min(i10, str.length())))));
                i = i10;
            }
        ...
        zzn("onNetworkResponseBody", new zzk() { // from class: com.google.android.gms.ads.internal.util.client.zzh
            ...
            public final void zza(JsonWriter jsonWriter) throws IOException {
                ...
                if (length < 10000) {
                    ...
                    String strZzk = zzf.zzk(strEncode);
                    if (strZzk != null) {
                        jsonWriter.name("bodydigest").value(strZzk);
                    }
                }
