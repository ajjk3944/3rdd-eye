...
public final class zzbs {
                ...
                if (objOpt instanceof Boolean) {
                    ...
                    if (jSONArray.length() != 0) {
                        ...
                        if (objOpt2 == null) {
                            ...
                            String strF = Oo.f("JSONArray with unsupported type ", objOpt2.getClass().getCanonicalName(), " for key:", next);
                            int i12 = zze.zza;
    ...
    public static String zzm(zzfby zzfbyVar) throws JSONException, IOException {
        if (zzfbyVar == null) {
            return null;
        }
        ...
        try {
            ...
            zzo(jsonWriter, zzfbyVar);
            jsonWriter.close();
            return stringWriter.toString();
        } catch (IOException e4) {
            int i = zze.zza;
            com.google.android.gms.ads.internal.util.client.zzo.zzh("Error when writing JSON.", e4);
            return null;
        }
    }
