...
public final class zzd {
    ...
    public static /* synthetic */ void zzb(zzd zzdVar, long j4, Exception exc) {
    ...
    public final synchronized void zzc(int i, int i10, long j4, long j10, int i11) {
        ...
        if (this.zze.get() == -1 || jElapsedRealtime - this.zze.get() > zzc.toMillis()) {
            ...
            if (telemetryLoggingClient != null) {
                telemetryLoggingClient.log(new TelemetryData(0, Arrays.asList(new MethodInvocation(35401, i10, 0, j4, j10, null, null, 0, i11)))).addOnFailureListener(new OnFailureListener() { // from class: com.google.android.gms.ads.identifier.zzc
