...
public final class zzs extends zzbz {
    ...
    private static final C5308a zzb;
    ...
    static {
        ...
        zzb = c5308a;
        c5308a.put("registered", FastJsonResponse.Field.forStrings("registered", 2));
        c5308a.put("in_progress", FastJsonResponse.Field.forStrings("in_progress", 3));
        c5308a.put("success", FastJsonResponse.Field.forStrings("success", 4));
        c5308a.put("failed", FastJsonResponse.Field.forStrings("failed", 5));
        c5308a.put("escrowed", FastJsonResponse.Field.forStrings("escrowed", 6));
    }
