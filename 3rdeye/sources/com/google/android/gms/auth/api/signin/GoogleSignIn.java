...
public final class GoogleSignIn {
    ...
    public static void requestPermissions(ComponentCallbacksC1759l componentCallbacksC1759l, int i, GoogleSignInAccount googleSignInAccount, GoogleSignInOptionsExtension googleSignInOptionsExtension) {
        Preconditions.checkNotNull(componentCallbacksC1759l, "Please provide a non-null Fragment");
        Preconditions.checkNotNull(googleSignInOptionsExtension, "Please provide a non-null GoogleSignInOptionsExtension");
        requestPermissions(componentCallbacksC1759l, i, googleSignInAccount, zbb(googleSignInOptionsExtension.getImpliedScopes()));
    }

    public static void requestPermissions(ComponentCallbacksC1759l componentCallbacksC1759l, int i, GoogleSignInAccount googleSignInAccount, Scope... scopeArr) {
        Preconditions.checkNotNull(componentCallbacksC1759l, "Please provide a non-null Fragment");
        Preconditions.checkNotNull(scopeArr, "Please provide at least one scope");
        componentCallbacksC1759l.startActivityForResult(zba(componentCallbacksC1759l.getActivity(), googleSignInAccount, scopeArr), i);
    }
}
