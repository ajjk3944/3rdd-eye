...
public class GoogleSignInAccount extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    public static GoogleSignInAccount fromAccount(Account account) {
        return zae(account, new C5309b(0));
    }
    ...
    public static GoogleSignInAccount zab(String str) throws JSONException, NumberFormatException {
        ...
        GoogleSignInAccount googleSignInAccountZaa = zaa(jSONObject.optString(FacebookMediationAdapter.KEY_ID), jSONObject.has("tokenId") ? jSONObject.optString("tokenId") : null, jSONObject.has(Scopes.EMAIL) ? jSONObject.optString(Scopes.EMAIL) : null, jSONObject.has("displayName") ? jSONObject.optString("displayName") : null, jSONObject.has("givenName") ? jSONObject.optString("givenName") : null, jSONObject.has("familyName") ? jSONObject.optString("familyName") : null, uri, Long.valueOf(j4), jSONObject.getString("obfuscatedIdentifier"), hashSet);
