...
public class DeviceMetaData extends AbstractSafeParcelable {
    ...
    public DeviceMetaData(@SafeParcelable.Param(id = 1) int i, @SafeParcelable.Param(id = 2) boolean z10, @SafeParcelable.Param(id = 3) long j4, @SafeParcelable.Param(id = 4) boolean z11) {
        this.zza = i;
        this.zzb = z10;
        this.zzc = j4;
        this.zzd = z11;
