...
public class ProxyRequest extends AbstractSafeParcelable {
    ...
    public static class Builder {
        ...
        public Builder(String str) {
            ...
            if (!Patterns.WEB_URL.matcher(str).matches()) {
                throw new IllegalArgumentException(C1154e9.i("The supplied url [ ", str, "] is not match Patterns.WEB_URL!"));
            }
            this.zza = str;
        }
    ...
    public ProxyRequest(@SafeParcelable.Param(id = 1000) int i, @SafeParcelable.Param(id = 1) String str, @SafeParcelable.Param(id = 2) int i10, @SafeParcelable.Param(id = 3) long j4, @SafeParcelable.Param(id = 4) byte[] bArr, @SafeParcelable.Param(id = 5) Bundle bundle) {
        this.zza = i;
        this.url = str;
        this.httpMethod = i10;
