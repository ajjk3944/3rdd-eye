...
public class zzl {
    ...
    private static Object zzh(Context context, ComponentName componentName, zzk zzkVar, long j4) throws IOException, GoogleAuthException {
    ...
    private static Object zzi(Task task, String str) throws IOException, ApiException {
        try {
            ...
            String strI = C1154e9.i("Interrupted while waiting for the task of ", str, " to finish.");
            zzd.w(strI, new Object[0]);
            throw new IOException(strI, e4);
        } catch (CancellationException e10) {
            String strI2 = C1154e9.i("Canceled while waiting for the task of ", str, " to finish.");
            zzd.w(strI2, new Object[0]);
            throw new IOException(strI2, e10);
        } catch (ExecutionException e11) {
            Throwable cause = e11.getCause();
            if (cause instanceof ApiException) {
                throw ((ApiException) cause);
            }
            String strI3 = C1154e9.i("Unable to get a result for ", str, " due to ExecutionException.");
            zzd.w(strI3, new Object[0]);
            throw new IOException(strI3, e11);
        }
    }
