...
public final class SignInButton extends FrameLayout implements View.OnClickListener {
    ...
    private final void zaa(Context context) throws Resources.NotFoundException {
        ...
        try {
            ...
            zaaaVar.zaa(context.getResources(), i, i10);
            this.zac = zaaaVar;
        }
        addView(this.zac);
    ...
    public void setStyle(int i, int i10) throws Resources.NotFoundException {
        this.zaa = i;
        this.zab = i10;
        zaa(getContext());
    }
    ...
    @Deprecated
    public void setStyle(int i, int i10, Scope[] scopeArr) throws Resources.NotFoundException {
        setStyle(i, i10);
    }
