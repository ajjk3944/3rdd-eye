...
public final class DataBufferObserverSet implements DataBufferObserver, DataBufferObserver.Observable {
    ...
    public void onDataRangeChanged(int i, int i10) {
        Iterator it = this.zaa.iterator();
        while (it.hasNext()) {
            ((DataBufferObserver) it.next()).onDataRangeChanged(i, i10);
        }
    }
    ...
    public void onDataRangeInserted(int i, int i10) {
        Iterator it = this.zaa.iterator();
        while (it.hasNext()) {
            ((DataBufferObserver) it.next()).onDataRangeInserted(i, i10);
        }
    }
    ...
    public void onDataRangeMoved(int i, int i10, int i11) {
        Iterator it = this.zaa.iterator();
        while (it.hasNext()) {
            ((DataBufferObserver) it.next()).onDataRangeMoved(i, i10, i11);
        }
    }
    ...
    public void onDataRangeRemoved(int i, int i10) {
        Iterator it = this.zaa.iterator();
        while (it.hasNext()) {
            ((DataBufferObserver) it.next()).onDataRangeRemoved(i, i10);
        }
    }
