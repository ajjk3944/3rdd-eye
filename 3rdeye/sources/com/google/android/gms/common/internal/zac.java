...
public final class zac {
    private static final C5316i zaa = new C5316i();
    ...
    private static String zah(Context context, String str) {
        ...
        synchronized (c5316i) {
            try {
                ...
                Locale locale = (Build.VERSION.SDK_INT >= 24 ? new j(new r(f.a(configuration))) : j.a(configuration.locale)).f1852a.get(0);
                if (!locale.equals(zab)) {
                    c5316i.clear();
                    zab = locale;
                }
                String str2 = (String) c5316i.get(str);
                if (str2 != null) {
                    return str2;
                }
