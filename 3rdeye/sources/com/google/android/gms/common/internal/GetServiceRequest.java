...
public class GetServiceRequest extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(defaultValue = CommonUrlParts.Values.FALSE_INTEGER, id = 13)
    final int zzn;
