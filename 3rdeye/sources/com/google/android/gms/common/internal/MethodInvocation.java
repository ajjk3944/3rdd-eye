...
public class MethodInvocation extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(defaultValue = CommonUrlParts.Values.FALSE_INTEGER, getter = "getServiceId", id = 8)
    ...
    @KeepForSdk
    @Deprecated
    public MethodInvocation(int i, int i10, int i11, long j4, long j10, String str, String str2, int i12) {
        this(i, i10, i11, j4, j10, str, str2, i12, -1);
    }
