...
public class SafeParcelReader {
    ...
    public static void ensureAtEnd(Parcel parcel, int i) {
        if (parcel.dataPosition() != i) {
            throw new ParseException(C4356c.h(i, "Overread allowed size end="), parcel);
        }
    }
    ...
    public static int validateObjectHeader(Parcel parcel) {
        ...
        if (i < iDataPosition || i > parcel.dataSize()) {
            throw new ParseException(H7.n(iDataPosition, i, "Size read is invalid start=", " end="), parcel);
        }
        return i;
    }
    ...
    private static void zza(Parcel parcel, int i, int i10, int i11) {
        ...
        throw new ParseException(f.c(s.i("Expected size ", i11, " got ", i10, " (0x"), Integer.toHexString(i10), ")"), parcel);
    }
    ...
    private static void zzb(Parcel parcel, int i, int i10) {
        ...
        throw new ParseException(f.c(s.i("Expected size ", i10, " got ", size, " (0x"), Integer.toHexString(size), ")"), parcel);
    }
}
