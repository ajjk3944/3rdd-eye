...
public final class zaaw implements zabf {
    ...
    public final boolean zaG(int i) {
        ...
        StringBuilder sbK = B8.k("GoogleApiClient connecting is in step ", zaJ(this.zag), " but received callback for step ");
        sbK.append(zaJ(i));
        Log.e("GACConnecting", sbK.toString(), new Exception());
