...
public final class PendingResults {
    ...
    @KeepForSdk
    public static <R extends Result> PendingResult<R> immediateFailedResult(R r9, GoogleApiClient googleApiClient) {
    ...
    public static <R extends Result> OptionalPendingResult<R> immediatePendingResult(R r9) {
        Preconditions.checkNotNull(r9, "Result must not be null");
    ...
    public static <R extends Result> PendingResult<R> canceledPendingResult(R r9) {
        Preconditions.checkNotNull(r9, "Result must not be null");
    ...
    @KeepForSdk
    public static <R extends Result> OptionalPendingResult<R> immediatePendingResult(R r9, GoogleApiClient googleApiClient) {
        Preconditions.checkNotNull(r9, "Result must not be null");
