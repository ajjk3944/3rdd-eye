...
public class GoogleApiManager implements Handler.Callback {
    ...
    private final Set zap = new C5309b(0);
    private final Set zaq = new C5309b(0);
    ...
    public static Status zaF(ApiKey apiKey, ConnectionResult connectionResult) {
        return new Status(connectionResult, Oo.f("API: ", apiKey.zaa(), " is not available on this device. Connection failed with: ", String.valueOf(connectionResult)));
    }
    ...
    public final boolean handleMessage(Message message) {
        ...
        switch (i) {
            ...
            case 5:
                ...
                if (zabqVar == null) {
                    Log.wtf("GoogleApiManager", C4356c.i(i10, "Could not find API instance ", " while trying to fail enqueued calls."), new Exception());
                } else if (connectionResult.getErrorCode() == 13) {
                    zabqVar.zaE(new Status(17, Oo.f("Error resolution was canceled by the user, original error message: ", this.zaj.getErrorString(connectionResult.getErrorCode()), ": ", connectionResult.getErrorMessage())));
                } else {
    ...
    public final void zaw(MethodInvocation methodInvocation, int i, long j4, int i10) {
        this.zar.sendMessage(this.zar.obtainMessage(18, new zace(methodInvocation, i, j4, i10)));
    }
