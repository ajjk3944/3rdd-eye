...
public final class zabe extends GoogleApiClient implements zabz {
    ...
    public zabe(Context context, Lock lock, Looper looper, ClientSettings clientSettings, GoogleApiAvailability googleApiAvailability, Api.AbstractClientBuilder abstractClientBuilder, Map map, List list, List list2, Map map2, int i, int i10, ArrayList arrayList) {
    ...
    public final <L> ListenerHolder<L> registerListener(L l5) {
        this.zaj.lock();
        try {
            return this.zau.zaa(l5, this.zao, "NO_TYPE");
        } finally {
            this.zaj.unlock();
        }
    }
    ...
    @Override // com.google.android.gms.common.api.GoogleApiClient
    public final void stopAutoManage(ActivityC1762o activityC1762o) {
    ...
    public final ConnectionResult blockingConnect(long j4, TimeUnit timeUnit) {
        ...
        try {
            ...
            zal(((Integer) Preconditions.checkNotNull(this.zaw)).intValue());
            this.zak.zab();
            ConnectionResult connectionResultZac = ((zaca) Preconditions.checkNotNull(this.zal)).zac(j4, timeUnit);
            this.zaj.unlock();
