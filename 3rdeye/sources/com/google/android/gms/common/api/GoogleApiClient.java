...
public abstract class GoogleApiClient {
    ...
    @KeepForSdk
    public <L> ListenerHolder<L> registerListener(L l5) {
        throw new UnsupportedOperationException();
    }

    public abstract void stopAutoManage(ActivityC1762o activityC1762o);
    ...
    public static final class Builder {
        ...
        public GoogleApiClient build() {
            ...
            for (Api api2 : this.zaj.keySet()) {
                ...
                c5308a.put(api2, Boolean.valueOf(z11));
                ...
                c5308a2.put(api2.zab(), clientBuildClient);
                if (abstractClientBuilder.getPriority() == 1) {
                    z10 = obj != null;
                }
                if (clientBuildClient.providesSignIn()) {
                    if (api != null) {
                        throw new IllegalStateException(g.o(api2.zad(), " cannot be used with ", api.zad()));
                    }
                    api = api2;
                }
            }
            if (api != null) {
                if (z10) {
                    throw new IllegalStateException(C1154e9.i("With using ", api.zad(), ", GamesOptions can only be specified within GoogleSignInOptions.Builder"));
                }
            ...
            zabe zabeVar = new zabe(this.zai, new ReentrantLock(), this.zan, clientSettingsZaa, this.zao, this.zap, c5308a, this.zaq, this.zar, c5308a2, this.zal, zabe.zad(c5308a2.values(), true), arrayList);
        ...
        public Builder enableAutoManage(ActivityC1762o activityC1762o, int i, OnConnectionFailedListener onConnectionFailedListener) {
            LifecycleActivity lifecycleActivity = new LifecycleActivity((Activity) activityC1762o);
        ...
        public Builder enableAutoManage(ActivityC1762o activityC1762o, OnConnectionFailedListener onConnectionFailedListener) {
            enableAutoManage(activityC1762o, 0, onConnectionFailedListener);
            return this;
        }
