...
public abstract class GoogleApi<O extends Api.ApiOptions> implements HasApiKey<O> {
    ...
    @KeepForSdk
    @Deprecated
    public <A extends Api.AnyClient, T extends RegisterListenerMethod<A, ?>, U extends UnregisterListenerMethod<A, ?>> Task<Void> doRegisterEventListener(T t10, U u8) {
        ...
        Preconditions.checkArgument(Objects.equal(t10.getListenerKey(), u8.getListenerKey()), "Listener registration and unregistration methods must be constructed with the same ListenerHolder.");
        return this.zaa.zao(this, t10, u8, new Runnable() { // from class: com.google.android.gms.common.api.zad
    ...
    public <L> ListenerHolder<L> registerListener(L l5, String str) {
        return ListenerHolders.createListenerHolder(l5, this.zag, str);
    }
