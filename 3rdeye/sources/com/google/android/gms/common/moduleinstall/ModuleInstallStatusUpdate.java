...
public class ModuleInstallStatusUpdate extends AbstractSafeParcelable {
    ...
    @KeepForSdk
    public ModuleInstallStatusUpdate(@SafeParcelable.Param(id = 1) int i, @SafeParcelable.Param(id = 2) @InstallState int i10, @SafeParcelable.Param(id = 3) Long l5, @SafeParcelable.Param(id = 4) Long l10, @SafeParcelable.Param(id = 5) int i11) {
        this.zaa = i;
        this.zab = i10;
        this.zac = l5;
        this.zad = l10;
