...
public abstract class FastJsonResponse {
    ...
    private final void zaE(Field field, Object obj) {
        ...
        switch (i) {
            ...
            case 3:
            default:
                throw new IllegalStateException(C4356c.h(i, "Unsupported type for conversion: "));
            case 4:
                if (objZae != null) {
    ...
    public static class Field<I, O> extends AbstractSafeParcelable {
        ...
        public Field(int i, boolean z10, int i10, boolean z11, String str, int i11, Class cls, FieldConverter fieldConverter) {
            this.zai = 1;
            this.zaa = i;
            this.zab = z10;
            this.zac = i10;
