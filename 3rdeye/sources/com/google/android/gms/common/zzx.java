...
class zzx {
    ...
    private zzx(boolean z10, int i, int i10, String str, Throwable th) {
        this.zza = z10;
        this.zzd = i;
        this.zzb = str;
        this.zzc = th;
    ...
    public static zzx zzg(int i, int i10, String str, Throwable th) {
        return new zzx(false, i, i10, str, th);
    }
