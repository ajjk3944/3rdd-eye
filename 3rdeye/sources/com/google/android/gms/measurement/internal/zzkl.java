...
public final class zzkl extends zzkn {
    ...
    public final void zza() {
        zzW();
        C1094a9.j(this.zzs, "Unscheduling upload");
    ...
    public final void zzd(long j4) {
        ...
        long jElapsedRealtime = this.zzs.zzav().elapsedRealtime() + j4;
        this.zzs.zzf();
        if (j4 < Math.max(0L, ((Long) zzeb.zzw.zza(null)).longValue()) && !zzi().zze()) {
            zzi().zzd(j4);
        }
        this.zzs.zzaw();
        if (Build.VERSION.SDK_INT < 24) {
            ...
            if (alarmManager != null) {
                this.zzs.zzf();
                alarmManager.setInexactRepeating(2, jElapsedRealtime, Math.max(((Long) zzeb.zzr.zza(null)).longValue(), j4), zzh());
                return;
            }
            return;
        }
        ...
        com.google.android.gms.internal.measurement.zzbt.zza(contextZzau2, new JobInfo.Builder(iZzf, componentName).setMinimumLatency(j4).setOverrideDeadline(j4 + j4).setExtras(persistableBundle).build(), "com.google.android.gms", "UploadAlarm");
    }
}
