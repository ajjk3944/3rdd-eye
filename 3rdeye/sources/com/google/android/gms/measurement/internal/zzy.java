...
abstract class zzy {
    ...
    private static Boolean zzd(String str, int i, boolean z10, String str2, List list, String str3, zzeo zzeoVar) {
        if (i == 7) {
    ...
    public static Boolean zzh(long j4, com.google.android.gms.internal.measurement.zzeq zzeqVar) {
        try {
            return zze(new BigDecimal(j4), zzeqVar, 0.0d);
        } catch (NumberFormatException unused) {
            return null;
        }
    }
