...
final class zzeg extends SQLiteOpenHelper {
    ...
    public final SQLiteDatabase getWritableDatabase() throws SQLiteException {
        try {
            ...
            a.k(this.zza.zzs, "Opening the local database failed, dropping and recreating it");
            this.zza.zzs.zzf();
            ...
            try {
                ...
                this.zza.zzs.zzay().zzd().zzb("Failed to open local database. Events will bypass local storage", e10);
                return null;
            }
        }
    }
