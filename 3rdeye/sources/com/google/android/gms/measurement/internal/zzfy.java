...
public final class zzfy implements zzgt {
        ...
        if (context.getApplicationContext() instanceof Application) {
            ...
            if (zzidVarZzq.zzs.zze.getApplicationContext() instanceof Application) {
                ...
                if (z10) {
                    ...
                    C1094a9.j(zzidVarZzq.zzs, "Registered activity lifecycle callback");
                }
            }
        } else {
            s.m(this, "Application context is not an Application");
        }
    ...
    public static zzfy zzp(Context context, com.google.android.gms.internal.measurement.zzcl zzclVar, Long l5) {
        Bundle bundle;
        ...
        if (zzd == null) {
            synchronized (zzfy.class) {
                try {
                    if (zzd == null) {
                        zzd = new zzfy(new zzhb(context, zzclVar, l5));
                    }
                } finally {
                }
            }
    ...
    */
    ...
    public final void zzE() throws IllegalStateException {
        ...
        if (activeNetworkInfo == null || !activeNetworkInfo.isConnected()) {
            s.m(this, "Network is not available for Deferred Deep Link request. Skipping");
            return;
        }
        zzlh zzlhVarZzv = zzv();
        zzh().zzs.zzk.zzh();
    ...
    public final void zzH(com.google.android.gms.internal.measurement.zzcl zzclVar) throws ClassNotFoundException {
        ...
        zzfdVarZzm.zzg();
        int i = 100;
        int i10 = zzfdVarZzm.zza().getInt("consent_source", 100);
        ...
        if (zzM()) {
            ...
            if (!zzv().zzad("android.permission.INTERNET")) {
                a.k(this, "App is missing INTERNET permission");
            }
            if (!zzv().zzad("android.permission.ACCESS_NETWORK_STATE")) {
                a.k(this, "App is missing ACCESS_NETWORK_STATE permission");
            }
            if (!Wrappers.packageManager(this.zze).isCallerInstantApp() && !this.zzk.zzx()) {
                if (!zzlh.zzaj(this.zze)) {
                    a.k(this, "AppMeasurementReceiver not registered/enabled");
                }
                if (!zzlh.zzak(this.zze, false)) {
                    a.k(this, "AppMeasurementService not registered/enabled");
                }
            }
            a.k(this, "Uploading is not possible. App measurement disabled");
        }
        zzm().zzi.zza(true);
    }
