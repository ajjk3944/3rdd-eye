...
public final class zzlh extends zzgs {
    ...
    public static ArrayList zzH(List list) {
        ...
        while (it.hasNext()) {
            ...
            bundle.putString(CommonUrlParts.APP_ID, zzacVar.zza);
    ...
    public static void zzK(zzik zzikVar, Bundle bundle, boolean z10) {
    ...
    public final String zzD(String str, int i, boolean z10) {
        if (str == null) {
            return null;
        }
    ...
    public final URL zzE(long j4, String str, String str2, long j10) {
        try {
            Preconditions.checkNotEmpty(str2);
            Preconditions.checkNotEmpty(str);
            String strConcat = "https://www.googleadservices.com/pagead/conversion/app/deeplink?id_type=adid&sdk_version=" + ("v73000." + zzm()) + "&rdid=" + str2 + "&bundleid=" + str + "&retry=" + j10;
    ...
    public final void zzI(Bundle bundle, long j4) {
        ...
        if (j10 != 0) {
            this.zzs.zzay().zzk().zzb("Params already contained engagement", Long.valueOf(j10));
        } else {
            j10 = 0;
        }
    ...
    public final void zzM(zzep zzepVar, int i) {
        Iterator it = new TreeSet(zzepVar.zzd.keySet()).iterator();
        int i10 = 0;
        while (it.hasNext()) {
            String str = (String) it.next();
            if (zzai(str) && (i10 = i10 + 1) > i) {
                this.zzs.zzay().zze().zzc(C4356c.j(i, "Event can't contain more than ", " params").toString(), this.zzs.zzj().zzd(zzepVar.zza), this.zzs.zzj().zzb(zzepVar.zzd));
                zzao(zzepVar.zzd, 5);
    ...
    public final void zzN(zzlg zzlgVar, String str, int i, String str2, String str3, int i10) {
        Bundle bundle = new Bundle();
        zzao(bundle, i);
    ...
    public final void zzP(com.google.android.gms.internal.measurement.zzcf zzcfVar, boolean z10) {
        Bundle bundle = new Bundle();
        bundle.putBoolean(Constants.REVENUE_AMOUNT_KEY, z10);
        try {
            zzcfVar.zzd(bundle);
        } catch (RemoteException e4) {
            this.zzs.zzay().zzk().zzb("Error returning boolean value to wrapper", e4);
        }
    }
    ...
    public final void zzQ(com.google.android.gms.internal.measurement.zzcf zzcfVar, ArrayList arrayList) {
        ...
        try {
            ...
            this.zzs.zzay().zzk().zzb("Error returning bundle list to wrapper", e4);
        }
    }
    ...
    public final void zzR(com.google.android.gms.internal.measurement.zzcf zzcfVar, Bundle bundle) {
        try {
            ...
            this.zzs.zzay().zzk().zzb("Error returning bundle value to wrapper", e4);
        }
    }
    ...
    public final void zzS(com.google.android.gms.internal.measurement.zzcf zzcfVar, byte[] bArr) {
        ...
        try {
            ...
            this.zzs.zzay().zzk().zzb("Error returning byte array to wrapper", e4);
        }
    }
    ...
    public final void zzT(com.google.android.gms.internal.measurement.zzcf zzcfVar, int i) {
        ...
        try {
            ...
            this.zzs.zzay().zzk().zzb("Error returning int value to wrapper", e4);
        }
    }

    public final void zzU(com.google.android.gms.internal.measurement.zzcf zzcfVar, long j4) {
        Bundle bundle = new Bundle();
        bundle.putLong(Constants.REVENUE_AMOUNT_KEY, j4);
        try {
            zzcfVar.zzd(bundle);
        } catch (RemoteException e4) {
            this.zzs.zzay().zzk().zzb("Error returning long value to wrapper", e4);
        }
    }
    ...
    public final void zzV(com.google.android.gms.internal.measurement.zzcf zzcfVar, String str) {
        ...
        try {
            ...
            this.zzs.zzay().zzk().zzb("Error returning string value to wrapper", e4);
        }
    }
        ...
        while (it.hasNext()) {
            ...
            if (i != 0) {
                ...
                if (zzaf(bundle2.get(str4))) {
                    ...
                    int iZza = zza(str, str2, str4, bundle2.get(str4), bundle2, list2, z10, false);
                    bundle2 = bundle2;
                    i10 = iZza;
                }
                if (i10 != 0 && !"_ev".equals(str4)) {
                    zzJ(bundle2, i10, str4, str4, bundle2.get(str4));
                    bundle2.remove(str4);
                } else if (zzai(str4) && !zzas(str4, zzgw.zzd) && (i11 = i11 + 1) > 0) {
    ...
    */
    ...
    public final void zzaA() {
        ...
        if (jNextLong == 0) {
            ...
            if (jNextLong == 0) {
                s.m(this.zzs, "Utils falling back to Random for random id");
            }
        }
    ...
    public final boolean zzag(Context context, String str) {
        ...
        try {
            ...
            this.zzs.zzay().zzd().zzb("Package name not found", e4);
            return true;
        } catch (CertificateException e10) {
            this.zzs.zzay().zzd().zzb("Error obtaining certificate", e10);
            return true;
        }
    }
    ...
    public final long zzr(long j4, long j10) {
        return ((j10 * 60000) + j4) / b.TWENTY_FOUR_HOURS_MILLIS;
    }
        ...
        if (uri != null) {
            try {
                ...
                if (!TextUtils.isEmpty(queryParameter2)) {
                    bundle.putString(AdRevenueConstants.SOURCE_KEY, queryParameter2);
                }
                ...
                if (!TextUtils.isEmpty(queryParameter9)) {
                    bundle.putString(AppLovinEventTypes.USER_VIEWED_CONTENT, queryParameter9);
                }
                ...
                this.zzs.zzay().zzk().zzb("Install referrer url isn't a hierarchical URI", e4);
            }
        }
        return null;
    }
    ...
    public final Bundle zzy(String str, String str2, Bundle bundle, List list, boolean z10) {
        ...
        String str3 = str2;
        List list2 = list;
        boolean zZzas = zzas(str3, zzgv.zzd);
        if (bundle == null) {
            return null;
        }
        ...
        while (it.hasNext()) {
            ...
            if (iZzj != 0) {
                ...
                String str5 = str3;
                int iZza = zza(str, str5, str4, bundle.get(str4), bundle3, list2, z10, zZzas);
                str3 = str5;
                bundle2 = bundle3;
                if (iZza == 17) {
                ...
                if (zzai(str4) && (i = i + 1) > iZzc) {
                    this.zzs.zzay().zze().zzc(C4356c.j(iZzc, "Event can't contain more than ", " params").toString(), this.zzs.zzj().zzd(str3), this.zzs.zzj().zzb(bundle));
                    zzao(bundle2, 5);
                    bundle2.remove(str4);
                }
            }
    ...
    public final zzaw zzz(String str, String str2, Bundle bundle, String str3, long j4, boolean z10, boolean z11) {
        if (TextUtils.isEmpty(str2)) {
            return null;
        }
        if (zzh(str2) != 0) {
        ...
        return new zzaw(str2, new zzau(bundleZzy), str3, j4);
    }
}
