...
public final class zzgq extends zzed {
    ...
    public final List zzf(String str, String str2, zzq zzqVar) {
        ...
        try {
            ...
            this.zza.zzay().zzd().zzb("Failed to get conditional user properties", e4);
    ...
    public final List zzg(String str, String str2, String str3) {
        ...
        try {
            ...
            this.zza.zzay().zzd().zzb("Failed to get conditional user properties as", e4);
            return Collections.EMPTY_LIST;
        }
    }
    ...
    @Override // com.google.android.gms.measurement.internal.zzee
    public final void zzq(long j4, String str, String str2, String str3) throws IllegalStateException {
        zzx(new zzgp(this, str2, str3, str, j4));
    }
    ...
    public final /* synthetic */ void zzw(String str, Bundle bundle) {
        ...
        try {
            ...
            zzamVarZzi.zzs.zzay().zzd().zzc("Error storing default event parameters. appId", zzeo.zzn(str), e4);
        }
    }
