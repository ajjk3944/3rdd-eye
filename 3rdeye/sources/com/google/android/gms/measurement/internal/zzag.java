...
public final class zzag extends zzgr {
    ...
    private final String zzB(String str, String str2) {
        try {
            ...
            this.zzs.zzay().zzd().zzb("Could not find SystemProperties class", e4);
            return "";
        } catch (IllegalAccessException e10) {
            this.zzs.zzay().zzd().zzb("Could not access SystemProperties.get()", e10);
            return "";
        } catch (NoSuchMethodException e11) {
            this.zzs.zzay().zzd().zzb("Could not find SystemProperties.get() method", e11);
            return "";
        } catch (InvocationTargetException e12) {
            this.zzs.zzay().zzd().zzb("SystemProperties.get() threw an exception", e12);
            return "";
        }
    }
    ...
    public final int zzf(String str, zzea zzeaVar, int i, int i10) {
        return Math.max(Math.min(zze(str, zzeaVar), i10), i);
    }
    ...
    public final Bundle zzj() {
        try {
            ...
            this.zzs.zzay().zzd().zzb("Failed to load metadata: Package name not found", e4);
            return null;
        }
    }
    ...
    public final Boolean zzk(String str) {
        ...
        if (bundleZzj == null) {
            a.k(this.zzs, "Failed to load metadata: Metadata bundle is null");
            return null;
        }
    ...
    */
    public final java.util.List zzp(java.lang.String r4) throws android.content.res.Resources.NotFoundException {
        /*
            r3 = this;
            ...
            com.google.android.gms.measurement.internal.a.k(r4, r0)
        L13:
            r4 = r1
            goto L24
        L15:
        ...
        L24:
            if (r4 == 0) goto L50
            com.google.android.gms.measurement.internal.zzfy r0 = r3.zzs     // Catch: android.content.res.Resources.NotFoundException -> L40
