...
public final class zzis extends zzf {
    ...
    */
    public final void zzA(com.google.android.gms.measurement.internal.zzik r15, com.google.android.gms.measurement.internal.zzik r16, long r17, boolean r19, android.os.Bundle r20) throws java.lang.IllegalAccessException, java.lang.IllegalArgumentException, java.lang.reflect.InvocationTargetException {
        /*
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public final void zzB(zzik zzikVar, boolean z10, long j4) {
        this.zzs.zzd().zzf(this.zzs.zzav().elapsedRealtime());
        if (!this.zzs.zzu().zzb.zzd(zzikVar != null && zzikVar.zzd, z10, j4) || zzikVar == null) {
            return;
        }
        zzikVar.zzd = false;
    }

    public static /* bridge */ /* synthetic */ void zzp(zzis zzisVar, Bundle bundle, zzik zzikVar, zzik zzikVar2, long j4) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        bundle.remove("screen_name");
        bundle.remove("screen_class");
        zzisVar.zzA(zzikVar, zzikVar2, j4, true, zzisVar.zzs.zzv().zzy(null, "screen_view", bundle, null, false));
    }
    ...
    private final void zzz(Activity activity, zzik zzikVar, boolean z10) throws IllegalStateException {
        zzik zzikVar2;
        ...
        this.zzc = this.zzb;
        this.zzb = zzikVar2;
        this.zzs.zzaz().zzp(new zzin(this, zzikVar2, zzikVar3, this.zzs.zzav().elapsedRealtime(), z10));
    }
