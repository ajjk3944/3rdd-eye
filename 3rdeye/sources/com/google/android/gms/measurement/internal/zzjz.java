...
public final class zzjz {
    ...
    public final int zza(final Intent intent, int i, final int i10) throws IllegalStateException {
        ...
        zzfyVarZzp.zzaw();
        zzeoVarZzay.zzj().zzc("Local AppMeasurementService called. startId, action", Integer.valueOf(i10), action);
        if ("com.google.android.gms.measurement.UPLOAD".equals(action)) {
            zzh(new Runnable() { // from class: com.google.android.gms.measurement.internal.zzjw
                @Override // java.lang.Runnable
                public final void run() {
                    this.zza.zzc(i10, zzeoVarZzay, intent);
                }
            });
        }
        return 2;
