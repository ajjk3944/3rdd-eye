...
public abstract class zzcs<MessageType extends zzcs<MessageType, BuilderType>, BuilderType extends zzcn<MessageType, BuilderType>> extends zzay<MessageType, BuilderType> {
    ...
    private static zzcs zzz(zzcs zzcsVar, byte[] bArr, int i, int i10, zzcd zzcdVar) throws zzdc {
        if (i10 == 0) {
            return zzcsVar;
        }
    ...
    public final int zza(zzeo zzeoVar) {
        if (zzw()) {
            ...
            throw new IllegalStateException(C4356c.h(iZza, "serialized size must be non-negative, was "));
        }
        ...
        if (iZza2 < 0) {
            throw new IllegalStateException(C4356c.h(iZza2, "serialized size must be non-negative, was "));
        }
        this.zzd = (this.zzd & RecyclerView.UNDEFINED_DURATION) | iZza2;
        return iZza2;
    }
    ...
    public final int zzf() {
        if (zzw()) {
            ...
            throw new IllegalStateException(C4356c.h(iZzy, "serialized size must be non-negative, was "));
        }
        int i = this.zzd & Integer.MAX_VALUE;
        if (i != Integer.MAX_VALUE) {
            return i;
        ...
        int iZzy2 = zzy(null);
        if (iZzy2 < 0) {
            throw new IllegalStateException(C4356c.h(iZzy2, "serialized size must be non-negative, was "));
        }
        this.zzd = (this.zzd & RecyclerView.UNDEFINED_DURATION) | iZzy2;
        return iZzy2;
    }
