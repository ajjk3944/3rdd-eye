...
final class zzfp {
    ...
    public static void zzD(Object obj, long j4, byte b10) {
        zzfo zzfoVar = zzf;
        long j10 = (-4) & j4;
        int i = zzfoVar.zza.getInt(obj, j10);
        int i10 = ((~((int) j4)) & 3) << 3;
        zzfoVar.zza.putInt(obj, j10, ((255 & b10) << i10) | (i & (~(KotlinVersion.MAX_COMPONENT_VALUE << i10))));
    }
    ...
    public static void zzE(Object obj, long j4, byte b10) {
        ...
        long j10 = (-4) & j4;
        int i = (((int) j4) & 3) << 3;
        zzfoVar.zza.putInt(obj, j10, ((255 & b10) << i) | (zzfoVar.zza.getInt(obj, j10) & (~(KotlinVersion.MAX_COMPONENT_VALUE << i))));
    }
