...
final class zzbv extends zzby {
    ...
    public zzbv(byte[] bArr, int i, int i10) {
        super(null);
    ...
    public final void zzs(long j4) throws IOException {
        if (!zzby.zzc || this.zzc - this.zzd < 10) {
            while ((j4 & (-128)) != 0) {
                try {
                    ...
                    int i = this.zzd;
                    this.zzd = i + 1;
                    bArr[i] = (byte) ((((int) j4) | 128) & KotlinVersion.MAX_COMPONENT_VALUE);
                    j4 >>>= 7;
                } catch (IndexOutOfBoundsException e4) {
                    throw new zzbw(String.format("Pos: %d, limit: %d, len: %d", Integer.valueOf(this.zzd), Integer.valueOf(this.zzc), 1), e4);
                }
        ...
        while (true) {
            ...
            int i13 = this.zzd;
            this.zzd = i13 + 1;
            zzfp.zzn(bArr4, i13, (byte) ((i11 | 128) & KotlinVersion.MAX_COMPONENT_VALUE));
            j4 >>>= 7;
        }
    }
}
