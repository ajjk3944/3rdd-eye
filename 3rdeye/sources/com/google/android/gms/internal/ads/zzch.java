...
public final class zzch {
    ...
    public zzch(int i, AudioManager.OnAudioFocusChangeListener onAudioFocusChangeListener, Handler handler, zze zzeVar, boolean z10) {
        this.zzc = handler;
        this.zzd = zzeVar;
        ...
        this.zzf = i10 >= 26 ? I2.e.e().setAudioAttributes(zzeVar.zza().zza).setWillPauseWhenDucked(false).setOnAudioFocusChangeListener(onAudioFocusChangeListener, handler).build() : null;
    }
