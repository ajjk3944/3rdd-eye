...
interface zzhat {
    ...
    @Deprecated
    void zzC(List list, zzhaz zzhazVar, zzgyf zzgyfVar) throws IOException;

    void zzD(List list) throws IOException;

    void zzE(List list) throws IOException;

    void zzF(List list, zzhaz zzhazVar, zzgyf zzgyfVar) throws IOException;
    ...
    zzgxn zzp() throws IOException;

    String zzr() throws IOException;

    String zzs() throws IOException;

    void zzt(Object obj, zzhaz zzhazVar, zzgyf zzgyfVar) throws IOException;

    void zzu(Object obj, zzhaz zzhazVar, zzgyf zzgyfVar) throws IOException;
