...
public final class zzbbm extends AbstractSafeParcelable {
    ...
    public static zzbbm zza(Uri uri) {
        try {
            ...
            return new zzbbm(queryParameter, j4, host, str2, str3, bundle, zEquals, 0L, "", 0);
