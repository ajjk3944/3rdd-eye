...
public final class zzamb {
    ...
    private static int zzA(int i, String str, String str2, int i10) {
        if (str.isEmpty() || i == -1) {
            return i;
        }
        if (str.equals(str2)) {
    ...
    public final zzamb zzh(int i) {
        this.zzh = i;
        this.zzi = true;
        return this;
    }

    public final zzamb zzi(boolean z10) {
        this.zzk = 1;
        return this;
    }

    public final zzamb zzj(boolean z10) {
        this.zzp = z10;
        return this;
    }

    public final zzamb zzk(int i) {
        this.zzf = i;
        this.zzg = true;
        return this;
    }
    ...
    public final zzamb zzn(int i) {
        this.zzm = i;
        return this;
    }

    public final zzamb zzo(boolean z10) {
        this.zzl = 1;
        return this;
    }

    public final zzamb zzp(int i) {
        this.zzo = i;
        return this;
    }

    public final zzamb zzq(boolean z10) {
        this.zzj = 1;
        return this;
    }
