...
public final class zzefz implements zzedk {
    ...
    public final void zzb(zzfcf zzfcfVar, zzfbt zzfbtVar, zzedh zzedhVar) throws zzfcv {
        try {
            ...
            zzefy zzefyVar = null;
            if (this.zzd.clientJarVersion < ((Integer) com.google.android.gms.ads.internal.client.zzbd.zzc().zzb(zzbdc.zzbR)).intValue()) {
                zzbrnVar.zzm(zzfbtVar.zzU, zzfbtVar.zzv.toString(), zzfcfVar.zza.zza.zzd, ObjectWrapper.wrap(this.zza), new zzefx(this, zzedhVar, zzefyVar), (zzbpu) zzedhVar.zzc);
                return;
            }
            String str = zzfbtVar.zzU;
            String string = zzfbtVar.zzv.toString();
            zzfco zzfcoVar = zzfcfVar.zza.zza;
            zzbrnVar.zzn(str, string, zzfcoVar.zzd, ObjectWrapper.wrap(this.zza), new zzefx(this, zzedhVar, zzefyVar), (zzbpu) zzedhVar.zzc, zzfcoVar.zzi);
