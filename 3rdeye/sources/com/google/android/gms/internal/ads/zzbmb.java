...
public final class zzbmb extends AbstractSafeParcelable {
    ...
    public zzbmb(@SafeParcelable.Param(id = 1) String str, @SafeParcelable.Param(id = 2) boolean z10, @SafeParcelable.Param(id = 3) int i, @SafeParcelable.Param(id = 4) String str2) {
        this.zza = str;
        this.zzb = z10;
        this.zzc = i;
        this.zzd = str2;
