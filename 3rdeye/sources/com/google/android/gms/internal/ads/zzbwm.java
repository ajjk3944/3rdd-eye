...
public final class zzbwm extends AbstractSafeParcelable {
    ...
    public zzbwm(@SafeParcelable.Param(id = 2) String str, @SafeParcelable.Param(id = 3) int i) {
        this.zza = str;
        this.zzb = i;
    }
    ...
    public final boolean equals(Object obj) {
        if (obj != null && (obj instanceof zzbwm)) {
            ...
            if (Objects.equal(this.zza, zzbwmVar.zza)) {
                if (Objects.equal(Integer.valueOf(this.zzb), Integer.valueOf(zzbwmVar.zzb))) {
                    return true;
                }
            }
        }
