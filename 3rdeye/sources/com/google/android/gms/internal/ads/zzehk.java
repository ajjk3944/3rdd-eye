    ...
    public final void zzb(zzfcf zzfcfVar, zzfbt zzfbtVar, zzedh zzedhVar) throws zzfcv {
        try {
            ...
            if (zzfcoVar.zzo.zza == 3) {
                zzbrnVar.zzo(zzfbtVar.zzU, zzfbtVar.zzv.toString(), zzfcoVar.zzd, ObjectWrapper.wrap(this.zza), new zzehi(this, zzedhVar, null), (zzbpu) zzedhVar.zzc);
            } else {
                zzbrnVar.zzp(zzfbtVar.zzU, zzfbtVar.zzv.toString(), zzfcoVar.zzd, ObjectWrapper.wrap(this.zza), new zzehi(this, zzedhVar, null), (zzbpu) zzedhVar.zzc);
            }
