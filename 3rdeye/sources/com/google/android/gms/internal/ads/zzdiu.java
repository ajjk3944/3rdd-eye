...
public interface zzdiu {
    ...
    void zzm(View view, View view2, Map map, Map map2, boolean z10, ImageView.ScaleType scaleType);

    void zzn(String str);

    void zzo(Bundle bundle);

    void zzq(View view, View view2, Map map, Map map2, boolean z10, ImageView.ScaleType scaleType, int i);
