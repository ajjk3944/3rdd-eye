    ...
    */
    public static boolean zza(android.content.Context r8) {
        ...
        Lc:
            ...
            monitor-enter(r0)
            boolean r2 = com.google.android.gms.internal.measurement.zzha.zzb     // Catch: java.lang.Throwable -> L15
            if (r2 == 0) goto L17
        ...
        L19:
            ...
            r5 = 0
            if (r3 > r4) goto L43
            android.os.UserManager r4 = com.google.android.gms.internal.measurement.zzha.zza     // Catch: java.lang.Throwable -> L15
            if (r4 != 0) goto L2b
            ...
            com.google.android.gms.internal.measurement.zzha.zza = r4     // Catch: java.lang.Throwable -> L15
        L2b:
            android.os.UserManager r4 = com.google.android.gms.internal.measurement.zzha.zza     // Catch: java.lang.Throwable -> L15
            if (r4 != 0) goto L31
            r8 = r2
            goto L56
        L31:
            boolean r6 = G0.n.p(r4)     // Catch: java.lang.Throwable -> L15 java.lang.NullPointerException -> L45
            if (r6 != 0) goto L41
        ...
        L45:
            ...
            com.google.android.gms.internal.measurement.zzha.zza = r5     // Catch: java.lang.Throwable -> L15
            int r3 = r3 + 1
            goto L19
        L52:
            if (r8 == 0) goto L56
        ...
        L56:
            if (r8 == 0) goto L5a
            com.google.android.gms.internal.measurement.zzha.zzb = r2     // Catch: java.lang.Throwable -> L15
        L5a:
            monitor-exit(r0)     // Catch: java.lang.Throwable -> L15
            if (r8 != 0) goto L60
            return r2
