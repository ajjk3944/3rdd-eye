...
public final class zzbk extends zzaw {
    ...
    public final zzap zza(String str, zzg zzgVar, List list) {
        ...
        if (iOrdinal == 3) {
            zzap zzapVarZzb = zzgVar.zzb((zzap) C1154e9.h(zzbl.ASSIGN, 2, list, 0));
            if (!(zzapVarZzb instanceof zzat)) {
                throw new IllegalArgumentException(s.d("Expected string for assign var. got ", zzapVarZzb.getClass().getCanonicalName()));
            }
            if (!zzgVar.zzh(zzapVarZzb.zzi())) {
                throw new IllegalArgumentException(s.d("Attempting to assign undefined value ", zzapVarZzb.zzi()));
            }
        ...
        if (iOrdinal == 14) {
            ...
            if (list.size() % 2 != 0) {
                throw new IllegalArgumentException(C4356c.h(list.size(), "CONST requires an even number of arguments, found "));
            }
            while (i < list.size() - 1) {
                zzap zzapVarZzb3 = zzgVar.zzb((zzap) list.get(i));
                if (!(zzapVarZzb3 instanceof zzat)) {
                    throw new IllegalArgumentException(s.d("Expected string for const name. got ", zzapVarZzb3.getClass().getCanonicalName()));
                }
        ...
        if (iOrdinal == 33) {
            zzap zzapVarZzb5 = zzgVar.zzb((zzap) C1154e9.h(zzbl.GET, 1, list, 0));
            if (zzapVarZzb5 instanceof zzat) {
                return zzgVar.zzd(zzapVarZzb5.zzi());
            }
            throw new IllegalArgumentException(s.d("Expected string for get var. got ", zzapVarZzb5.getClass().getCanonicalName()));
        }
        if (iOrdinal == 49) {
        ...
        if (iOrdinal == 58) {
            zzap zzapVarZzb6 = zzgVar.zzb((zzap) C1154e9.h(zzbl.SET_PROPERTY, 3, list, 0));
            ...
            if (zzapVarZzb6 == zzap.zzf || zzapVarZzb6 == zzap.zzg) {
                throw new IllegalStateException(Oo.f("Can't set property ", zzapVarZzb7.zzi(), " of ", zzapVarZzb6.zzi()));
            }
        ...
        if (iOrdinal == 18) {
            ...
            if (list.size() % 2 != 0) {
                throw new IllegalArgumentException(C4356c.h(list.size(), "CREATE_OBJECT requires an even number of arguments, found "));
            }
        ...
        if (iOrdinal == 35 || iOrdinal == 36) {
            zzap zzapVarZzb12 = zzgVar.zzb((zzap) C1154e9.h(zzbl.GET_PROPERTY, 2, list, 0));
        ...
        switch (iOrdinal) {
            case 62:
                zzap zzapVarZzb14 = zzgVar.zzb((zzap) C1154e9.h(zzbl.TYPEOF, 1, list, 0));
            ...
            case 64:
                ...
                while (it2.hasNext()) {
                    ...
                    if (!(zzapVarZzb15 instanceof zzat)) {
                        throw new IllegalArgumentException(s.d("Expected string for var name. got ", zzapVarZzb15.getClass().getCanonicalName()));
                    }
