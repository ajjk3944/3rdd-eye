...
class zzmj extends AbstractMap {
    ...
    public /* synthetic */ zzmj(int i, zzmi zzmiVar) {
        this.zza = i;
    ...
    private final int zzk(Comparable comparable) {
        ...
        int i10 = 0;
        if (i >= 0) {
            int iCompareTo = comparable.compareTo(((zzmd) this.zzb.get(i)).zza());
            if (iCompareTo > 0) {
                return -(size + 1);
            }
            if (iCompareTo == 0) {
        ...
        while (i10 <= i) {
            int i11 = (i10 + i) / 2;
            int iCompareTo2 = comparable.compareTo(((zzmd) this.zzb.get(i11)).zza());
            if (iCompareTo2 < 0) {
                i = i11 - 1;
            } else {
                if (iCompareTo2 <= 0) {
    ...
    public final Object put(Comparable comparable, Object obj) {
        ...
        int i10 = this.zza;
        if (size == i10) {
            zzmd zzmdVar = (zzmd) this.zzb.remove(i10 - 1);
