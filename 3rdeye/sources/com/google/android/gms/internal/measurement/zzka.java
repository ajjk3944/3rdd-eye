...
public class zzka<MessageType extends zzke<MessageType, BuilderType>, BuilderType extends zzka<MessageType, BuilderType>> extends zzim<MessageType, BuilderType> {
    ...
    public final zzka zzaD(byte[] bArr, int i, int i10, zzjq zzjqVar) throws zzko {
        if (this.zzb) {
            zzaI();
            this.zzb = false;
        }
        try {
            zzlt.zza().zzb(this.zza.getClass()).zzh(this.zza, bArr, 0, i10, new zziq(zzjqVar));
            return this;
        } catch (zzko e4) {
            throw e4;
    ...
    */
    ...
    @Override // com.google.android.gms.internal.measurement.zzim
    public final /* bridge */ /* synthetic */ zzim zzaw(byte[] bArr, int i, int i10) throws zzko {
        zzaD(bArr, 0, i10, zzjq.zza);
        return this;
    }

    @Override // com.google.android.gms.internal.measurement.zzim
    public final /* bridge */ /* synthetic */ zzim zzax(byte[] bArr, int i, int i10, zzjq zzjqVar) throws zzko {
        zzaD(bArr, 0, i10, zzjqVar);
        return this;
    }
