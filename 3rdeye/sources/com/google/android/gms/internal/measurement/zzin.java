...
public abstract class zzin<MessageType extends zzin<MessageType, BuilderType>, BuilderType extends zzim<MessageType, BuilderType>> implements zzll {
    ...
    public final zzjd zzbs() {
        try {
            ...
            throw new RuntimeException(C1154e9.i("Serializing ", getClass().getName(), " to a ByteString threw an IOException (should never happen)."), e4);
        }
    }
    ...
    public final byte[] zzbv() {
        try {
            ...
            throw new RuntimeException(C1154e9.i("Serializing ", getClass().getName(), " to a byte array threw an IOException (should never happen)."), e4);
        }
    }
}
