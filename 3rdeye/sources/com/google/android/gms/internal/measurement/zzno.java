...
public final class zzno implements zznn {
    ...
    static {
        ...
        zzc = zzhxVarZza.zzd("measurement.config.cache_time", b.TWENTY_FOUR_HOURS_MILLIS);
        ...
        zzn = zzhxVarZza.zzd("measurement.monitoring.sample_period_millis", b.TWENTY_FOUR_HOURS_MILLIS);
        ...
        zzt = zzhxVarZza.zzd("measurement.upload.stale_data_deletion_interval", b.TWENTY_FOUR_HOURS_MILLIS);
