...
public final class zzs {
    public static int zza(int i, int i10, String str) {
        ...
        if (i < 0) {
            ...
            strZza = zzy.zza("%s (%s) must be less than size (%s)", "index", Integer.valueOf(i), Integer.valueOf(i10));
        }
    ...
    public static void zzc(int i, int i10, int i11) {
        if (i < 0 || i10 < i || i10 > i11) {
            throw new IndexOutOfBoundsException((i < 0 || i > i11) ? zzd(i, i11, "start index") : (i10 < 0 || i10 > i11) ? zzd(i10, i11, "end index") : zzy.zza("end index (%s) must not be less than start index (%s)", Integer.valueOf(i10), Integer.valueOf(i)));
        }
    }
