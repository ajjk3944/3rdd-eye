...
public class ActivityRecognitionResult extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    @VisibleForTesting
    public ActivityRecognitionResult(DetectedActivity detectedActivity, long j4, long j10) {
        this(Collections.singletonList(detectedActivity), j4, j10, 0, null);
    }
    ...
    */
    ...
    public ActivityRecognitionResult(List<DetectedActivity> list, long j4, long j10) {
        this(list, j4, j10, 0, null);
    }

    @ShowFirstParty
    @SafeParcelable.Constructor
    public ActivityRecognitionResult(@SafeParcelable.Param(id = 1) List<DetectedActivity> list, @SafeParcelable.Param(id = 2) long j4, @SafeParcelable.Param(id = 3) long j10, @SafeParcelable.Param(id = 4) int i, @SafeParcelable.Param(id = 5) Bundle bundle) {
        Preconditions.checkArgument(list != null && list.size() > 0, "Must have at least 1 detected activity");
        Preconditions.checkArgument(j4 > 0 && j10 > 0, "Must set times");
        this.zza = list;
        this.zzb = j4;
        this.zzc = j10;
        this.zzd = i;
