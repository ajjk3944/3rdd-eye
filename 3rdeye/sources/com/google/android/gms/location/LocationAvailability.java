...
public final class LocationAvailability extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    @SafeParcelable.Field(defaultValueUnchecked = CommonUrlParts.Values.FALSE_INTEGER, id = 3)
    long zzc;
    ...
    public LocationAvailability(@SafeParcelable.Param(id = 4) int i, @SafeParcelable.Param(id = 1) int i10, @SafeParcelable.Param(id = 2) int i11, @SafeParcelable.Param(id = 3) long j4, @SafeParcelable.Param(id = 5) zzbo[] zzboVarArr) {
        this.zzd = i;
        this.zza = i10;
        this.zzb = i11;
        this.zzc = j4;
