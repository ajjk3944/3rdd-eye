...
public class SleepSegmentEvent extends AbstractSafeParcelable {
    ...
    public SleepSegmentEvent(@SafeParcelable.Param(id = 1) long j4, @SafeParcelable.Param(id = 2) long j10, @SafeParcelable.Param(id = 3) int i, @SafeParcelable.Param(id = 4) int i10, @SafeParcelable.Param(id = 5) int i11) {
        Preconditions.checkArgument(j4 <= j10, "endTimeMillis must be greater than or equal to startTimeMillis");
        this.zza = j4;
        this.zzb = j10;
        this.zzc = i;
        this.zzd = i10;
