...
public final class LocationRequest extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    public LocationRequest setExpirationDuration(long j4) {
        ...
        long j10 = j4 <= Long.MAX_VALUE - jElapsedRealtime ? j4 + jElapsedRealtime : Long.MAX_VALUE;
        this.zze = j10;
        if (j10 < 0) {
            this.zze = 0L;
        }
    ...
    public LocationRequest(@SafeParcelable.Param(id = 1) int i, @SafeParcelable.Param(id = 2) long j4, @SafeParcelable.Param(id = 3) long j10, @SafeParcelable.Param(id = 4) boolean z10, @SafeParcelable.Param(id = 5) long j11, @SafeParcelable.Param(id = 6) int i10, @SafeParcelable.Param(id = 7) float f10, @SafeParcelable.Param(id = 8) long j12, @SafeParcelable.Param(id = 9) boolean z11) {
        this.zza = i;
        this.zzb = j4;
        this.zzc = j10;
        this.zzd = z10;
