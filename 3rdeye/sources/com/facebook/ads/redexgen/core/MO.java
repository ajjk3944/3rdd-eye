...
public final class MO {
    ...
    private void A04(String str, long j4, long j10, ME me) {
        HashMap map = new HashMap();
        map.put(A02(54, 10, 111), Long.toString(j4));
        map.put(A02(45, 9, 113), Long.toString(j10));
        if (me != null) {
    ...
    public final void A05() {
        ...
        if (this.A06 != null) {
            ...
            if (application != null && (this.A02.getBaseContext() instanceof C3272dL)) {
                ((C3272dL) this.A02.getBaseContext()).A08().AAy(A02(71, 9, 21), AbstractC2885Sv.A22, new C2886Sw(strA02));
            }
            Log.w(A0B, strA02);
        }
