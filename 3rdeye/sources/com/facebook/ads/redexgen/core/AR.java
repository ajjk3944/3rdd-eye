...
public final class AR {
    ...
    public AR(String str, String str2, String str3, MediaCodecInfo.CodecCapabilities codecCapabilities, boolean z10, boolean z11, boolean z12, boolean z13, boolean z14, boolean z15) {
        ...
        this.A08 = z14;
        this.A06 = z15;
        this.A0A = AbstractC22162h.A0F(str2);
    }
    ...
    */
    ...
    public static Point A01(MediaCodecInfo.VideoCapabilities videoCapabilities, int i, int i10) {
        int heightAlignment = videoCapabilities.getWidthAlignment();
        int widthAlignment = videoCapabilities.getHeightAlignment();
        return new Point(AbstractC22614a.A05(i, heightAlignment) * heightAlignment, AbstractC22614a.A05(i10, widthAlignment) * widthAlignment);
    }
    ...
    */
    ...
    private void A05(String str) {
        ...
        AnonymousClass44.A04(A03(97, 14, 99), sbAppend.append(strA03).append(this.A03).append(A03(4, 2, 43)).append(this.A02).append(strA03).append(AbstractC22614a.A04).append(A03(260, 1, 72)).toString());
    }
    ...
    public static boolean A07() {
        return AbstractC22614a.A03.equals(A03(532, 7, 62)) || AbstractC22614a.A03.equals(A03(427, 6, 6)) || AbstractC22614a.A06.startsWith(A03(55, 14, 69)) || AbstractC22614a.A06.startsWith(A03(69, 14, 52)) || AbstractC22614a.A06.startsWith(A03(83, 14, 0));
    }

    public static boolean A09(MediaCodecInfo.CodecCapabilities codecCapabilities) {
        return AbstractC22614a.A02 >= 19 && A0A(codecCapabilities);
    }
    ...
    public static boolean A0B(MediaCodecInfo.CodecCapabilities codecCapabilities) {
        return AbstractC22614a.A02 >= 21 && A0C(codecCapabilities);
    }
    ...
    public static boolean A0D(MediaCodecInfo.CodecCapabilities codecCapabilities) {
        return AbstractC22614a.A02 >= 21 && A0E(codecCapabilities);
    }
    ...
    public static boolean A0F(MediaCodecInfo.VideoCapabilities videoCapabilities, int i, int i10, double d10) {
        Point alignedSize = A01(videoCapabilities, i, i10);
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    private boolean A0G(com.facebook.ads.redexgen.core.C3949or r12, boolean r13) {
        /*
    ...
    public static boolean A0I(String str) {
        return AbstractC22614a.A06.startsWith(A03(253, 7, 89)) && A03(191, 36, 1).equals(str);
    }

    public static boolean A0J(String str) {
        if (AbstractC22614a.A02 <= 22) {
            if ((A03(130, 10, 94).equals(AbstractC22614a.A06) || A03(111, 8, 72).equals(AbstractC22614a.A06)) && (A03(140, 22, 117).equals(str) || A03(162, 29, 74).equals(str))) {
                return true;
            }
        }
        return false;
    ...
    public static boolean A0K(String str) {
        if (A03(227, 26, 94).equals(str) && A03(527, 5, 83).equals(AbstractC22614a.A03)) {
            return false;
        }
        return true;
    }
    ...
    public static boolean A0L(String str, int i) {
        if (A03(751, 10, 121).equals(str) && 2 == i) {
            if (A03(539, 8, 36).equals(AbstractC22614a.A03) || A03(521, 6, 9).equals(AbstractC22614a.A03)) {
                return true;
            }
        }
        return false;
    ...
    public final Point A0N(int i, int i10) {
        MediaCodecInfo.VideoCapabilities videoCapabilities;
        if (this.A00 == null || (videoCapabilities = this.A00.getVideoCapabilities()) == null) {
            return null;
        }
        return A01(videoCapabilities, i, i10);
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final com.facebook.ads.redexgen.core.C22965j A0O(com.facebook.ads.redexgen.core.C3949or r13, com.facebook.ads.redexgen.core.C3949or r14) {
        /*
    ...
    public final boolean A0R(int i, int i10, double d10) {
        if (this.A00 == null) {
            if (A0C[4].length() != 17) {
                throw new RuntimeException();
            }
        ...
        int i11 = AbstractC22614a.A02;
        String strA03 = A03(9, 1, 116);
        String strA032 = A03(780, 1, 62);
        if (i11 >= 29) {
            int iA00 = AP.A00(videoCapabilities, i, i10, d10);
            if (iA00 == 2) {
                return true;
            }
            if (iA00 == 1) {
                A06(A03(629, 19, 41) + i + strA032 + i10 + strA03 + d10);
                return false;
            }
        }
        if (!A0F(videoCapabilities, i, i10, d10)) {
            if (i >= i10 || !A0K(this.A03) || !A0F(videoCapabilities, i10, i, d10)) {
                A06(A03(669, 21, 113) + i + strA032 + i10 + strA03 + d10);
                return false;
            }
            A05(A03(648, 21, 5) + i + strA032 + i10 + strA03 + d10);
        }
        return true;
    }

    @MetaExoPlayerCustomization(type = {"DEPRECATED_LOGIC"}, value = "D51676338: Control Renderer Support behavior")
    public final boolean A0S(C3949or c3949or) {
        String strA07;
        if (c3949or.A0R == null || this.A02 == null || (strA07 = AbstractC22162h.A07(c3949or.A0R)) == null) {
            return true;
        }
        ...
        if (!codecMimeType.equals(strA07)) {
            ...
            String codecMimeType3 = c3949or.A0R;
        ...
        return A0G(c3949or, true);
    }

    public final boolean A0T(C3949or c3949or) {
        if (this.A0A) {
        ...
        Pair<Integer, Integer> profileLevel = C2428Ay.A0B(c3949or);
        return profileLevel != null && ((Integer) profileLevel.first).intValue() == 42;
    }

    @Deprecated
    public final boolean A0U(C3949or c3949or, C3949or c3949or2, boolean z10) {
        if (!z10 && c3949or.A0N != null) {
            ColorInfo colorInfo = c3949or2.A0N;
            String[] strArr = A0C;
            ...
            A0C[2] = "CiueF8sE";
            if (colorInfo == null) {
                c3949or2 = c3949or2.A07().A0t(c3949or.A0N).A14();
            }
        }
        int i = A0O(c3949or, c3949or2).A01;
        return i == 2 || i == 3;
    }
