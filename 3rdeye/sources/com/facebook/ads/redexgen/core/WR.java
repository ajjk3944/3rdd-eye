...
public final class WR {
    ...
    public static int A00(C3272dL c3272dL, int i) {
        return AbstractC2944Ve.A00(c3272dL).getInt(A01(0, 21, 52), i);
    }

    public static String A02(C3272dL c3272dL, String str) {
        int iA00 = A00(c3272dL, -1);
        if (iA00 == -1) {
            return null;
        }
        try {
    ...
    public final InterstitialAd A06(C3272dL c3272dL, String str, String str2) {
        if (c3272dL == null) {
            return null;
        }
        try {
            InterstitialAd interstitialAd = new InterstitialAd(c3272dL, str);
    ...
    public final RewardedVideoAd A07(C3272dL c3272dL, String str, String str2) {
        if (c3272dL == null) {
            return null;
        }
        try {
            RewardedVideoAd rewardedVideoAd = new RewardedVideoAd(c3272dL, str);
    ...
    public final void A08(C3272dL c3272dL, boolean z10) {
        int i = 0;
        String strA01 = A01(0, 21, 52);
        if (!z10) {
            int lastNonChainedAds = AbstractC2944Ve.A00(c3272dL).getInt(strA01, 0);
            i = lastNonChainedAds + 1;
        }
        AbstractC2944Ve.A00(c3272dL).edit().putInt(strA01, i).apply();
    }

    public final boolean A09(C3272dL c3272dL, String str, int i) {
        if (i <= 0) {
            return false;
        }
        try {
            if (!A05(str)) {
                int lastNonChainedAds = A00(c3272dL, i - 1);
