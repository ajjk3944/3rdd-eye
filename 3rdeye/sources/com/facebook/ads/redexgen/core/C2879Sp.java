...
public final class C2879Sp {
    ...
    public static final List<C2880Sq> A07;
    public static final AtomicBoolean A08;
    public static final AtomicInteger A09;
    public static final AtomicReference<InterfaceC2877Sn> A0A;
    public static final AtomicReference<InterfaceC2878So> A0B;
    ...
    public static int A00(String str, int i, SQ sq) {
        if ((A01(462, 7, 5).equals(str) && AbstractC2885Sv.A20 == i) || A01(422, 5, 90).equals(str) || A01(442, 6, 62).equals(str)) {
            return 200;
        }
    ...
    public static void A05(SQ sq, int i, int i10) {
        sq.A08().AAy(A01(427, 10, 35), AbstractC2885Sv.A2Z, new C2886Sw(A01(338, 33, 12) + i, A01(87, 9, 54) + i10));
    }

    @Deprecated
    public static void A06(SQ sq, String str, int i, C2886Sw c2886Sw) {
        if (sq == null) {
            A0F(new RuntimeException(A01(48, 39, 37)));
            return;
        }
        SP.A01(sq.A02());
        if (A02 && c2886Sw.A01() == 0) {
            A0D(new RuntimeException(A01(96, 44, 81) + str + A01(31, 16, 108) + i, c2886Sw));
        }
        try {
            if (A0J(sq, str, i, Math.random(), c2886Sw)) {
                A09(sq, str, i, c2886Sw);
            }
        } catch (Throwable th) {
            if (A05[7].length() == 7) {
                throw new RuntimeException();
    ...
    @Deprecated
    public static void A07(SQ sq, String str, int i, C2886Sw c2886Sw) {
        try {
            c2886Sw.A05(2);
            c2886Sw.A0A(false);
            c2886Sw.A06(1);
    ...
    @Deprecated
    public static void A08(SQ sq, String str, int i, C2886Sw c2886Sw) {
        try {
            c2886Sw.A05(2);
            c2886Sw.A08(false);
            A06(sq, str, i, c2886Sw);
    ...
    public static void A09(SQ sq, String str, int i, C2886Sw c2886Sw) {
        synchronized (C2879Sp.class) {
            if (!A03) {
                int iA01 = U9.A01(sq);
                int threshold = A09.getAndIncrement();
                if (threshold < iA01 - 1) {
                    A07.add(new C2880Sq(str, i, c2886Sw));
                } else if (A09.get() == iA01) {
                    A07.add(new C2880Sq(A01(427, 10, 35), AbstractC2885Sv.A2W, new C2886Sw(A01(140, 42, 70) + str + A01(47, 1, 91) + i)));
                }
            } else {
                A0A(sq, str, i, c2886Sw, true);
            }
        }
    }

    public static void A0A(SQ sq, String str, int i, C2886Sw c2886Sw, boolean z10) {
        InterfaceC2878So interfaceC2878So = A0B.get();
        boolean z11 = interfaceC2878So != null && interfaceC2878So.AAZ();
        boolean z12 = A08.get();
        String[] strArr = A05;
        ...
        if (z12 || z11) {
            int iA01 = c2886Sw.A01();
            String strA01 = A01(289, 17, 3);
            String strA012 = A01(31, 16, 108);
            if (iA01 == 0) {
                Log.e(strA01, A01(182, 37, 114) + str + strA012 + i, c2886Sw);
            } else {
                Log.i(strA01, A01(306, 32, 102) + str + strA012 + i + A01(19, 12, 98) + c2886Sw.getMessage() + A01(0, 19, 12) + c2886Sw.A03());
            }
        }
        C3091aP c3091aP = new C3091aP(sq, str, i, c2886Sw, interfaceC2878So);
        if (z10) {
            A01.execute(c3091aP);
        } else {
            c3091aP.run();
    ...
    public static void A0C(C3246cu c3246cu, InterfaceC2878So interfaceC2878So, InterfaceC2877Sn interfaceC2877Sn, boolean z10) {
        A0A.set(interfaceC2877Sn);
        A0B.set(interfaceC2878So);
        A08.set(z10);
        synchronized (C2879Sp.class) {
            if (!A03) {
                A03 = true;
                A01.execute(new C3146bI(c3246cu));
            }
        }
    }
    ...
    public static void A0D(RuntimeException runtimeException) {
        if (A02) {
            new Handler(Looper.getMainLooper()).post(new RunnableC2876Sm(runtimeException));
        }
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:100:0x017b, code lost:
        ...
        com.facebook.ads.redexgen.core.C2879Sp.A0C.set(true);
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:105:0x018c, code lost:
        ...
        r7 = r7 * r2;
        r2 = com.facebook.ads.redexgen.core.C2879Sp.A05;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:93:0x0164, code lost:
        ...
        r0 = com.facebook.ads.redexgen.core.C2879Sp.A0C.get();
     */
    ...
    */
    public static boolean A0J(com.facebook.ads.redexgen.core.SQ r13, java.lang.String r14, int r15, double r16, com.facebook.ads.redexgen.core.C2886Sw r18) {
        /*
            Method dump skipped, instructions count: 633
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C2879Sp.A0J(com.facebook.ads.redexgen.X.SQ, java.lang.String, int, double, com.facebook.ads.redexgen.X.Sw):boolean");
    }

    public static boolean A0K(SQ sq, String str, int i, C2886Sw c2886Sw) {
        if (!U9.A0P(sq)) {
            return true;
        }
        ...
        if (customLimit >= eventsLimit) {
            if (A06.contains(Integer.valueOf(customLimit)) && c2886Sw.A0D()) {
