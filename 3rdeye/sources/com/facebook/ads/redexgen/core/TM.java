...
public final class TM {
    ...
    public static long A01(SQ sq, String str) {
        try {
            ...
            if (A03.compareAndSet(false, true)) {
                sq.A08().AAy(A02(144, 7, 94), AbstractC2885Sv.A1E, new C2886Sw(e4));
            }
            return -1L;
        }
    }
    ...
    public static String A05(SQ sq, String str) throws JSONException {
    ...
    public static void A07(SQ sq, JSONObject jSONObject, String str, String str2) throws JSONException {
        try {
            jSONObject.put(str, str2);
        } catch (JSONException e4) {
            if (sq.A05().AAF()) {
                Log.e(A02, A02(47, 24, 108), e4);
            }
        }
    }
