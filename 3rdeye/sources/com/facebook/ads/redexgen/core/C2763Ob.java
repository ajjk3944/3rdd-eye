...
public class C2763Ob<K, V> {
    ...
    */
    public final V A0A(int r10) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C2763Ob.A0A(int):java.lang.Object");
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof C2763Ob) {
            C2763Ob c2763Ob = (C2763Ob) obj;
            if (size() != c2763Ob.size()) {
                return false;
            }
            for (int i = 0; i < this.A00; i++) {
                try {
                    K kA09 = A09(i);
                    V vA0B = A0B(i);
                    Object obj2 = c2763Ob.get(kA09);
                    if (vA0B == null) {
                        if (obj2 == null && c2763Ob.containsKey(kA09)) {
                        }
                        return false;
                    }
                    if (!vA0B.equals(obj2)) {
    ...
    public final V put(K k10, V v10) {
        ...
        if (i11 < i) {
            System.arraycopy(this.A01, i11, this.A01, i11 + 1, i - i11);
    ...
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.Ob != com.facebook.ads.internal.androidx.support.v4.util.SimpleArrayMap<K, V> */
    public final V A0C(int i, V v10) {
        int i10 = (i << 1) + 1;
        V v11 = (V) this.A02[i10];
        this.A02[i10] = v10;
        return v11;
