...
public abstract class AbstractC3455gL {
    public static volatile InterfaceC3448gE A02 = C22011q.A00();
    ...
    public static void A01(@Nullable String str, String str2, Object obj) {
        if (A02.AAP(4)) {
            A00(str, AbstractC3450gG.A0J(str2, obj));
        }
    }
