...
public final class RunnableC22393e implements SurfaceTexture.OnFrameAvailableListener, Runnable {
    ...
    public RunnableC22393e(Handler handler) {
        this.A04 = handler;
    }
    ...
    public static EGLConfig A00(EGLDisplay eGLDisplay) {
        ...
        throw new C22373c(AbstractC22614a.A0n(A04(0, 67, 111), Boolean.valueOf(success), Integer.valueOf(iArr[0]), configs[0]));
    }
    ...
    public static void A06(int[] iArr) {
        ...
        if (iGlGetError == 0) {
            ...
            throw new C22373c(A04(181, 29, 50) + Integer.toHexString(iGlGetError));
        }
    }
