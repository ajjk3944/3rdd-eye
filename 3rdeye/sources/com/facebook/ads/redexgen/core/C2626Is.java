...
public final class C2626Is extends AbstractC3106ae {
    ...
    public final MH A0X;
    public final AbstractC3547hy A0Y;
    public final C2915Ua A0Z;
    public final KL A0a;
    public final InterfaceC3072a4 A0b;
    public final C3110ai A0c;
    ...
    public C2626Is(C3110ai c3110ai) {
        super(c3110ai, true);
        this.A0K = false;
        this.A0M = false;
        this.A0N = false;
        ...
        this.A0C = true;
        this.A0d = new RunnableC3153bP(this);
        this.A0b = new J2(this);
        this.A0S = new Handler(Looper.getMainLooper());
        this.A0W = (InputMethodManager) c3110ai.A06().getSystemService(A0J(12, 12, 46));
        this.A0c = c3110ai;
        this.A0Y = this.A0c.A05();
        this.A0Z = new C2915Ua(c3110ai.A05().A25(), c3110ai.A07());
        this.A0R = A00(c3110ai);
        this.A0V = this.A0c.A03();
        this.A0X = MI.A01(c3110ai.A06(), c3110ai.A07(), c3110ai.A05().A25(), WQ.A00(c3110ai.A05().A20().A0J().A05()), new HashMap(), false, true, this.A0Y.A21());
        AbstractC3093aR.A00(c3110ai.A06(), this, c3110ai.A05().A20().A0H().A08());
        this.A0D = false;
        ...
        this.A0e = c3110ai.A05().A1e();
        getAdContextWrapper().A0F().ABe(this.A0e, true, c3110ai.A05().A2C());
        this.A09 = null;
    ...
    private float A00(C3110ai c3110ai) {
        ...
        float mAspectRatio2 = new SF(c3110ai.A06()).A0M(this.A0Y.A20().A0H().A08());
        return mAspectRatio2;
    }

    public static /* synthetic */ int A02(C2626Is c2626Is) {
        int i = c2626Is.A00;
        c2626Is.A00 = i + 1;
        return i;
    }

    public static /* synthetic */ int A04(C2626Is c2626Is) {
        int i = c2626Is.A01;
        c2626Is.A01 = i + 1;
        return i;
    }

    private KL A0F(C3110ai c3110ai) {
        KL c23045r;
        if (A0w(this.A0R)) {
            c23045r = new C23035q(c3110ai.A06(), getCtaButton(), AbstractC2656Jw.A0I, true, getColors(), c3110ai.A05().A0r(), c3110ai.A07(), c3110ai.A0D(), c3110ai.A0G(), c3110ai.A0A(), c3110ai.A05(), c3110ai.A0F(), c3110ai.A08(), true);
        } else if (A0x(this.A0R)) {
            c23045r = new C23025p(c3110ai.A06(), getCtaButton(), AbstractC2656Jw.A0I, true, getColors(), c3110ai.A05().A0r(), c3110ai.A07(), c3110ai.A0D(), c3110ai.A0G(), c3110ai.A0A(), c3110ai.A05(), c3110ai.A0F(), c3110ai.A08(), true);
        } else {
            c23045r = new C23045r(c3110ai.A06(), getCtaButton(), AbstractC2656Jw.A0I, true, getColors(), c3110ai.A05().A0r(), c3110ai.A07(), c3110ai.A0D(), c3110ai.A0G(), c3110ai.A0A(), c3110ai.A05(), c3110ai.A0F(), c3110ai.A08(), true);
        }
        RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-1, -1);
        layoutParams.addRule(12);
        c23045r.setVisibility(8);
        c23045r.setLayoutParams(layoutParams);
        if (c3110ai.A0H() != null) {
            c23045r.setChainedAdInfo(c3110ai.A0H());
        }
        return c23045r;
    }

    private C3084aI A0G(E1 e12) {
        return new C3084aI(this.A0c, this.A0Y, e12, this.A0c.A0D(), new J4(this), this.A0V, this.A0a, this.A03);
    }
    ...
    private void A0O() {
        this.A0c.A06().A0F().AJw(AbstractC2966Wa.A00(this.A0R), getResources().getConfiguration().orientation, false, this.A0c.A0H() != null, MH.A0A());
    ...
    private void A0P() {
        AbstractC3002Xm abstractC3002XmA0C;
        if (this.A0c.A05().A1n() && (abstractC3002XmA0C = this.A0c.A0C()) != null) {
            abstractC3002XmA0C.setProgressSpinnerInvisible(false);
        }
    }
    ...
    private void A0R() {
        if (this.A0Y.A1W()) {
            this.A0U.setOnClickListener(new ViewOnClickListenerC3155bR(this));
        }
        XP.A0H(this.A0U);
        addView(this.A0U, new RelativeLayout.LayoutParams(-1, -1));
        XP.A0I(this.A0U);
        if (U7.A17(this.A0c.A06())) {
            View.OnClickListener onClickListener = new ViewOnClickListenerC3156bS(this);
            this.A0a.setCTAClickListener(onClickListener);
            if (this.A0c.A0C() != null) {
                View.OnClickListener onClickListener2 = new ViewOnClickListenerC3157bT(this);
                this.A0c.A0C().setCTAClickListener(onClickListener2);
            }
        }
        if (U7.A1K(getAdContextWrapper())) {
            AbstractC3060Zs.A00(this.A0U, U7.A1L(getAdContextWrapper()), new ViewOnClickListenerC3158bU(this));
        } else {
            if (!U7.A1I(getAdContextWrapper())) {
                return;
            }
            AbstractC3060Zs.A00(this.A0U, U7.A1J(getAdContextWrapper()), new ViewOnClickListenerC3159bV(this));
        }
    }
    ...
    private void A0S() {
        if (this.A0V != null) {
            XP.A0H(this.A0V);
            RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(AbstractC3106ae.A0J, AbstractC3106ae.A0J);
            layoutParams.setMargins(AbstractC3106ae.A0A, AbstractC3106ae.A0G, AbstractC3106ae.A0A, AbstractC3106ae.A09);
    ...
    private void A0T() {
        AbstractC3002Xm abstractC3002XmA0C = this.A0c.A0C();
        if (abstractC3002XmA0C == null) {
            return;
        }
        abstractC3002XmA0C.setPageDetailsVisible((this.A0D || abstractC3002XmA0C.A0B()) ? false : true);
        String[] strArr = A0g;
    ...
    private void A0V() {
        int videoDuration;
        C2475Cw c2475CwA0F = this.A0c.A0F();
        if (c2475CwA0F != null && c2475CwA0F.getCustomDuration() > (videoDuration = ((E1) this.A0U).getDuration())) {
            c2475CwA0F.setCustomDuration(videoDuration);
        }
    }
    ...
    private final void A0Z(int i, ViewGroup viewGroup, RelativeLayout relativeLayout) {
        ...
        XP.A0H(this.A0a);
        if ((this.A0a instanceof C23045r) || (this.A0a instanceof C23035q)) {
            RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-1, -1);
        ...
        } else if (this.A0a instanceof C23025p) {
    ...
    private void A0b(ViewGroup viewGroup, View view, AbstractC3002Xm abstractC3002Xm, int i) {
        XP.A0Z(this.A03);
        XP.A0H(abstractC3002Xm);
        RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-1, -2);
        layoutParams.addRule(10);
        layoutParams.setMargins(AbstractC3106ae.A0H, AbstractC3106ae.A0G, 0, 0);
    ...
    private void A0c(ViewGroup viewGroup, View view, AbstractC3002Xm abstractC3002Xm, int i) {
        XP.A0H(this.A03);
        XP.A0H(abstractC3002Xm);
        XP.A0H(this.A0a);
        RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-1, -2);
    ...
    public void A0j(String str) {
        ...
        this.A08 = lj;
        if (this.A0Y.A1d()) {
            this.A08.addJavascriptInterface(new C3095aT(new View.OnClickListener() { // from class: com.facebook.ads.redexgen.X.bK
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    this.A00.A1Q(view);
                }
            }, this.A08, new InterfaceC3094aS() { // from class: com.facebook.ads.redexgen.X.JH
                @Override // com.facebook.ads.redexgen.core.InterfaceC3094aS
                public final void ACk() {
                    this.A00.A1O();
                }
            }), C3095aT.A01());
        }
        this.A08.setOnTouchListener(new ViewOnTouchListenerC3150bM(this));
    ...
    private void A0o(boolean z10) {
        ...
        if (A0t()) {
            E1 e12 = (E1) this.A0U;
            Iterator<InterfaceC3289dc> it = e12.getPlugins().iterator();
            while (true) {
        ...
        this.A0B = new C3122au(this.A0c.A06(), this.A0Y, this.A0Z, this.A0T, this.A0c.A0D());
        this.A0B.A0D(z10);
        ...
        if (!z10) {
            ...
            this.A0C = true;
            InterfaceC3219cT interfaceC3219cTA0E = this.A0c.A0E();
            if (A0g[7].charAt(21) != '6') {
                A0g[6] = "OOVaJo";
                if (interfaceC3219cTA0E == null) {
                    return;
                }
            } else if (interfaceC3219cTA0E == null) {
                return;
            }
            ...
            if (this.A0c.A0C() != null && this.A0c.A05().A20().A0K().A00() > 0) {
                ...
                new Handler(Looper.getMainLooper()).postDelayed(new RunnableC3154bQ(this), this.A0c.A05().A20().A0K().A00());
            }
        }
    }

    private void A0p(boolean z10, int i) {
        if (this.A06 == null || !this.A0e) {
            return;
        }
        this.A06.setCloseButtonVisibility(z10 ? 0 : 4);
        getAdContextWrapper().A0F().ABc(!z10, i);
    }
    ...
    public void A0q(boolean z10, boolean z11) {
        ...
        if (z10) {
            A0c(parentView, containerView, abstractC3002XmA0C, i);
        } else if (z11) {
            A0b(parentView, containerView, abstractC3002XmA0C, i);
        } else {
    ...
    public final void A1C() {
        AbstractC3002Xm abstractC3002XmA0C = this.A0c.A0C();
        if (abstractC3002XmA0C != null) {
            abstractC3002XmA0C.setPageDetailsVisible((A1S() || abstractC3002XmA0C.A0B()) ? false : true);
        }
        this.A0O = false;
    }
    ...
    public final void A1G(C2726Mp c2726Mp, String str, double d10, Bundle bundle) {
        ...
        this.A0a.setInfo(c2726Mp.A0I(), c2726Mp.A0J(), str, this.A0Y.A23().A01(), this.A0c.A09(), this.A0b);
    ...
    public final void A1I(DO r82) {
        super.A1I(r82);
        this.A0c.A06().A0F().AJw(AbstractC2966Wa.A00(this.A0R), getResources().getConfiguration().orientation, true, false, MH.A0A());
        this.A0Q = true;
        A0X(getResources().getConfiguration().orientation);
        this.A0a.setVisibility(0);
        A0q(this.A0D, false);
    ...
    private KE getRegularCtaForEndCard() {
        KE ke = new KE(getAdContextWrapper(), this.A0c.A05().A0r(), this.A0Y.A1z().A01(), getAdEventManager(), this.A0c.A0D(), (C3345eX) null, this.A0c.A0A(), this.A0Y.A21());
    ...
    private void setUpBrowserControls(LJ lj) {
        ...
        layoutParams.setMargins(AbstractC3106ae.A0I, AbstractC3106ae.A0I, AbstractC3106ae.A0I, AbstractC3106ae.A0I);
