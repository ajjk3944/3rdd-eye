...
public class QZ {
    ...
    public QZ(int i, int i10) {
        this(i, i10, RecyclerView.UNDEFINED_DURATION, null);
    }

    public QZ(int i, int i10, int i11, Interpolator interpolator) {
        this.A04 = -1;
        this.A06 = false;
        this.A00 = 0;
        this.A02 = i;
    ...
    public final void A04(int i, int i10, int i11, Interpolator interpolator) {
        this.A02 = i;
        this.A03 = i10;
        this.A01 = i11;
        this.A05 = interpolator;
    ...
    public final void A05(C23196g c23196g) {
        if (this.A04 >= 0) {
            int i = this.A04;
            this.A04 = -1;
            c23196g.A1U(i);
        ...
        if (this.A06) {
            ...
            if (interpolator == null) {
                if (this.A01 == Integer.MIN_VALUE) {
                    c23196g.A08.A0A(this.A02, this.A03);
                } else {
                    RunnableC2818Qf runnableC2818Qf = c23196g.A08;
                    int i10 = this.A02;
                    int i11 = this.A03;
                    if (A08[1].length() != 25) {
                        runnableC2818Qf.A0B(i10, i11, this.A01);
                    } else {
                        String[] strArr2 = A08;
                ...
                c23196g.A08.A0C(this.A02, this.A03, this.A01, this.A05);
            }
            this.A00++;
            if (this.A00 > 10) {
