...
public class OD extends RelativeLayout implements InterfaceC3004Xo {
    ...
    public OD(R0 r02, C3272dL c3272dL, US us, InterfaceC3003Xn interfaceC3003Xn) {
        LJ lj;
        super(c3272dL);
        this.A06 = new C2769Oi(this);
        this.A05 = true;
        this.A01 = -1L;
        this.A03 = true;
        this.A07 = r02;
        ...
        this.A0D = A0E();
        if (U8.A02(c3272dL) || c3272dL.A0E() == null) {
            lj = new LJ(c3272dL, this.A0D);
        } else {
            lj = new LJ(c3272dL, c3272dL.A0E(), this.A0D);
        }
        this.A0E = lj;
        this.A0B = new ZO(c3272dL, this.A0E);
        this.A0B.setId(View.generateViewId());
        this.A0B.setListener(new C2766Of(this));
        this.A0E.setBrowserNavigationListener(this.A0B.getBrowserNavigationListener());
        this.A0C = new ZP(c3272dL, null, R.attr.progressBarStyleHorizontal);
        A0F();
        r02.A0A(this.A06);
    }
    ...
    public void A0F() {
        ...
        RelativeLayout.LayoutParams webViewParams2 = new RelativeLayout.LayoutParams(-1, (int) (AbstractC2975Wl.A02 * 2.0f));
