...
public abstract class AbstractC3247cv {
    ...
    public static BitmapDrawable A00(C3272dL c3272dL, String str) {
        try {
            ...
            if (overlayBm != null && (!A00 || A05(c3272dL, overlayBm))) {
                ...
                Resources resources = c3272dL.getResources();
                if (resources != null) {
                    DisplayMetrics displayMetrics = resources.getDisplayMetrics();
                    if (displayMetrics != null) {
                        overlayRepeat.setTargetDensity(displayMetrics.densityDpi);
                    } else {
                        A04(c3272dL, A02(0, 23, 41));
                    }
                } else {
                    A04(c3272dL, A02(23, 18, 119));
                }
                return overlayRepeat;
            }
            return null;
        } catch (Throwable th) {
            c3272dL.A08().AAy(A02(59, 3, 58), AbstractC2885Sv.A1u, new C2886Sw(th));
            return null;
        }
    }

    public static C3248cw A01(C3272dL c3272dL, String str) {
        BitmapDrawable bitmapDrawableA00;
        try {
            if (TextUtils.isEmpty(str) || (bitmapDrawableA00 = A00(c3272dL, str)) == null) {
                return null;
            }
            C3248cw c3248cw = new C3248cw(c3272dL);
            c3248cw.setBackground(bitmapDrawableA00);
            c3248cw.setClickable(false);
            c3248cw.setFocusable(false);
            return c3248cw;
        } catch (Throwable th) {
            c3272dL.A08().AAy(A02(59, 3, 58), AbstractC2885Sv.A1u, new C2886Sw(th));
            return null;
    ...
    public static void A04(C3272dL c3272dL, String str) {
        c3272dL.A08().AAy(A02(59, 3, 58), AbstractC2885Sv.A1u, new C2886Sw(str));
    }
    ...
    */
    public static boolean A05(com.facebook.ads.redexgen.core.C3272dL r4, android.graphics.Bitmap r5) {
        /*
            r3 = 0
        L1:
            int r0 = r5.getWidth()
        ...
        L36:
            r3 = 1
            java.lang.String[] r2 = com.facebook.ads.redexgen.core.AbstractC3247cv.A02
            r0 = 2
            r1 = r2[r0]
            r0 = 3
            r0 = r2[r0]
        ...
        L4f:
            ...
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.AbstractC3247cv.A05(com.facebook.ads.redexgen.X.dL, android.graphics.Bitmap):boolean");
    }
}
