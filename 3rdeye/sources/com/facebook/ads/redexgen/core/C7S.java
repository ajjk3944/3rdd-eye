...
public final class C7S implements InterfaceC3884nl {
    ...
    public boolean A0B;
    public boolean A0C;
    public final InterfaceC3884nl A0D;
    public final InterfaceC3884nl A0E;
    public final InterfaceC3884nl A0F;
    public final InterfaceC2699Ln A0G;
    public final InterfaceC2702Lq A0H;
    public final InterfaceC2708Lw A0I;
    public final boolean A0J;
    public final boolean A0K;
    public final boolean A0L;

    public static String A02(int i, int i10, int i11) {
        byte[] bArrCopyOfRange = Arrays.copyOfRange(A0M, i, i + i10);
    ...
    public final long AFy(AnonymousClass56 anonymousClass56) throws IOException {
        try {
            ...
            this.A09 = new C2695Lj(anonymousClass56.A07);
    ...
    public C7S(InterfaceC2699Ln interfaceC2699Ln, final InterfaceC3884nl interfaceC3884nl, InterfaceC3884nl interfaceC3884nl2, final InterfaceC22814u interfaceC22814u, InterfaceC2708Lw interfaceC2708Lw, int i, final AnonymousClass31 anonymousClass31, final int i10, InterfaceC2702Lq interfaceC2702Lq) {
        this.A0G = interfaceC2699Ln;
        this.A0D = interfaceC3884nl2;
        this.A0I = interfaceC2708Lw == null ? InterfaceC2708Lw.A00 : interfaceC2708Lw;
        this.A0J = (i & 1) != 0;
        this.A0L = (i & 2) != 0;
        this.A0K = (i & 4) != 0;
        if (interfaceC3884nl != null) {
            interfaceC3884nl = anonymousClass31 != null ? new InterfaceC3884nl(interfaceC3884nl, anonymousClass31, i10) { // from class: com.facebook.ads.redexgen.X.9c
                ...
                {
                    this.A02 = (InterfaceC3884nl) C3M.A01(interfaceC3884nl);
            ...
            this.A0F = interfaceC3884nl;
            this.A0E = interfaceC22814u != null ? new InterfaceC3884nl(interfaceC3884nl, interfaceC22814u) { // from class: com.facebook.ads.redexgen.X.9a
                ...
                public long A00;
                public boolean A01;
                public final InterfaceC22814u A02;
                public final InterfaceC3884nl A03;

                {
                    this.A03 = (InterfaceC3884nl) C3M.A01(interfaceC3884nl);
                    this.A02 = (InterfaceC22814u) C3M.A01(interfaceC22814u);
                }
                ...
                public final int read(byte[] bArr, int i11, int i12) throws IOException {
                    if (this.A00 != 0) {
                        int i13 = this.A03.read(bArr, i11, i12);
                        if (i13 > 0) {
                            this.A02.write(bArr, i11, i13);
                            if (this.A00 != -1) {
                                this.A00 -= i13;
                            }
                        }
            ...
            this.A0F = C23819d.A02;
            this.A0E = null;
        }
        this.A0H = interfaceC2702Lq;
    }
    ...
    public static Uri A01(InterfaceC2699Ln interfaceC2699Ln, String str, Uri redirectedUri) {
        Uri redirectedUri2 = M7.A01(interfaceC2699Ln.A7K(str));
    ...
    */
    ...
    private void A08(String str, Uri uri) {
        ...
        try {
            ...
            Log.w(A02(0, 15, 70), message, e4);
        }
    }

    private void A09(Throwable th) {
        if (A0B() || (th instanceof C2696Lk)) {
            this.A0C = true;
        }
    }
    ...
    public final InterfaceC2699Ln A0E() {
        return this.A0G;
    }

    public final InterfaceC2708Lw A0F() {
        return this.A0I;
    }
    ...
    @Override // com.facebook.ads.redexgen.core.AnonymousClass20
    public final int read(byte[] bArr, int i, int i10) throws Throwable {
        if (i10 == 0) {
            return 0;
        }
        if (this.A00 == 0) {
        ...
        try {
            int bytesRead = ((InterfaceC3884nl) C3M.A01(this.A06)).read(bArr, i, i10);
            if (bytesRead != -1) {
                if (A0B()) {
                    this.A04 += bytesRead;
                }
                ...
                A07((String) AbstractC22614a.A0f(currentDataSpec.A08));
