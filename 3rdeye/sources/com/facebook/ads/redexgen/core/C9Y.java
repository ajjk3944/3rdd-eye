...
public final class C9Y extends C3935od {
    ...
    public final AbstractC22112a A05;
    ...
    static {
        ...
        A0E = AbstractC22614a.A0h(1001);
        A0D = AbstractC22614a.A0h(1002);
        A0C = AbstractC22614a.A0h(1003);
        A0A = AbstractC22614a.A0h(GeofenceStatusCodes.GEOFENCE_INSUFFICIENT_LOCATION_PERMISSION);
        A0B = AbstractC22614a.A0h(GeofenceStatusCodes.GEOFENCE_REQUEST_TOO_FREQUENT);
        A09 = AbstractC22614a.A0h(1006);
    }

    public C9Y(int i, Throwable th, int i10) {
        this(i, th, null, i10, null, -1, null, 4, false);
    }

    public C9Y(int i, Throwable th, String str, int i10, String str2, int i11, C3949or c3949or, int i12, boolean z10) {
        this(A06(i, th, str, str2, i11, c3949or, i12), th, i10, i, str2, i11, c3949or, i12, null, SystemClock.elapsedRealtime(), z10);
    }
    ...
    public C9Y(Bundle bundle) {
        ...
        if (bundle2 == null) {
            ...
            c3949or = (C3949or) C3949or.A0b.A6X(bundle2);
        }
        this.A04 = c3949or;
    ...
    public C9Y(String str, Throwable th, int i, int i10, String str2, int i11, C3949or c3949or, int i12, AbstractC22112a abstractC22112a, long j4, boolean z10) {
        super(str, th, i, j4);
        C3M.A07(!z10 || i10 == 1);
        C3M.A07(th != null || i10 == 3);
        this.A03 = i10;
        this.A06 = str2;
        this.A02 = i11;
        this.A04 = c3949or;
        this.A01 = i12;
        this.A05 = abstractC22112a;
        this.A00 = z10;
    }
    ...
    public static C9Y A04(Throwable th, String str, int i, C3949or c3949or, int i10, boolean z10, int i11) {
        int i12 = i10;
        if (c3949or == null) {
            i12 = 4;
        }
        return new C9Y(1, th, null, i11, str, i, c3949or, i12, z10);
    }

    public static String A06(@MetaExoPlayerCustomization(type = {"NEW_METHOD_ARGS"}, value = "Throwable cause - linked with Error reporting") int i, Throwable th, String str, String str2, int i10, C3949or c3949or, int i11) {
        String message;
        String strA05;
        if (str == null) {
        ...
        switch (i) {
            ...
            case 1:
                ...
                StringBuilder sbAppend3 = sbAppend2.append(message3).append(c3949or);
                String message4 = A05(23, 19, 114);
                StringBuilder sbAppend4 = sbAppend3.append(message4);
                String message5 = AbstractC22614a.A0g(i11);
