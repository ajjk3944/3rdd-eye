...
public final class EnumC3541hq {
    ...
    public static final /* synthetic */ EnumC3541hq[] A03;
    public static final EnumC3541hq A04;
    public static final EnumC3541hq A05;
    ...
    public static final /* synthetic */ EnumC3541hq[] A02() {
        EnumC3541hq[] enumC3541hqArr = new EnumC3541hq[2];
        EnumC3541hq enumC3541hq = A04;
        String[] strArr = A01;
        if (strArr[5].charAt(11) == strArr[7].charAt(11)) {
            throw new RuntimeException();
        }
        A01[4] = "Fkm6UCeGNRQRi4wWDBIOpvvd9TujRbQP";
        enumC3541hqArr[0] = enumC3541hq;
        enumC3541hqArr[1] = A05;
        return enumC3541hqArr;
    }

    static {
        A01();
        A04 = new EnumC3541hq(A00(0, 11, 97), 0);
        A05 = new EnumC3541hq(A00(11, 8, 38), 1);
        A03 = A02();
        A02 = AbstractC3965pB.A01(A03);
    }

    public EnumC3541hq(String str, int i) {
    }

    public static EnumC3541hq valueOf(String str) {
        return (EnumC3541hq) Enum.valueOf(EnumC3541hq.class, str);
    }

    public static EnumC3541hq[] values() {
        return (EnumC3541hq[]) A03.clone();
    }
}
