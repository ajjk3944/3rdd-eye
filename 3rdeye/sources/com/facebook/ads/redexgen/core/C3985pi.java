...
public class C3985pi {
    ...
    public final Map<String, C3996pu> A00;
    public final Set<C3996pu> A01;
    ...
    public Collection<C3996pu> A00() {
        return this.A01;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public Collection<C3996pu> A01() {
    ...
    public void A04() {
        this.A00.clear();
        Iterator<C3996pu> it = this.A01.iterator();
        while (true) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public boolean A06(C3996pu c3996pu) {
        if (this.A01.add(c3996pu)) {
            this.A00.remove(c3996pu.A02);
            return true;
        }
        return false;
    }
