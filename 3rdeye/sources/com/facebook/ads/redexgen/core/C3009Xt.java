...
public final class C3009Xt extends AdNativeComponentView {
    ...
    public final C2932Ur A06;
    public final C2686La A07;
    ...
    public static final int A09 = ((int) AbstractC2975Wl.A02) * 500;
    public static final int A0H = (int) (AbstractC2975Wl.A02 * 500.0f);
    public static final int A0D = (int) (AbstractC2975Wl.A02 * 4.0f);
    public static final int A0B = (int) (AbstractC2975Wl.A02 * 8.0f);
    public static final int A0G = (int) (AbstractC2975Wl.A02 * 8.0f);
    public static final int A0E = (int) (AbstractC2975Wl.A02 * 4.0f);
    public static final int A0C = (int) AbstractC2975Wl.A02;
    public static final int A0F = (int) (AbstractC2975Wl.A02 * 4.0f);
    public static final int A0A = (int) (AbstractC2975Wl.A02 * 0.5d);

    public C3009Xt(C3272dL c3272dL, C2932Ur c2932Ur) {
        super(c3272dL);
        this.A06 = c2932Ur;
        this.A05 = new TextView(c3272dL);
        this.A04 = new TextView(c3272dL);
        this.A03 = new TextView(c3272dL);
        this.A02 = new RelativeLayout(c3272dL);
        this.A00 = new LinearLayout(c3272dL);
        this.A01 = new RelativeLayout(c3272dL);
        this.A07 = new C2686La(c3272dL);
        A09();
        A0D();
        A05();
        A0A();
    ...
    private void A0B() {
        ...
        EnumC2980Wq.A04(this.A07, EnumC2980Wq.A0B);
        XP.A0I(this.A07);
    }
    ...
    */
    public final void onMeasure(int r3, int r4) {
        /*
            r2 = this;
            float r0 = com.facebook.ads.redexgen.core.AbstractC2975Wl.A02
            int r1 = (int) r0
        ...
        L22:
            ...
            goto L1e
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C3009Xt.onMeasure(int, int):void");
    }
