...
public final class C22523r extends G2 {
    ...
    public int A00;
    public UZ A01;
    public AbstractC3002Xm A02;
    public AbstractC3106ae A03;
    public InterfaceC3231cf A04;
    public C3269dI A05;
    public EnumC3288db A06;
    public boolean A07;
    public boolean A08;
    public boolean A09;
    public boolean A0A;
    ...
    public final R6 A0I;
    public final InterfaceC3230ce A0J;
    public final EG A0K;
    public final E1 A0L;
    public final C22433i A0M;
    public final DX A0N;
    public final DV A0O;
    public final DR A0P;
    public final DP A0Q;
    public final DN A0R;
    public final DM A0S;
    public final C2475Cw A0T;

    public static String A0A(int i, int i10, int i11) {
        byte[] bArrCopyOfRange = Arrays.copyOfRange(A0U, i, i + i10);
    ...
    public C22523r(C3272dL c3272dL, YY yy, US us, AbstractC3547hy abstractC3547hy, SF sf, InterfaceC3003Xn interfaceC3003Xn) {
        ...
        this.A0N = new DX() { // from class: com.facebook.ads.redexgen.X.3t
            ...
            public final void A03(C22383d c22383d) {
                this.A00.A0O(c22383d, this.A00.A0L.getState() != EnumC3342eU.A06, false);
            }
        };
        this.A0O = new C22533s(this);
        boolean z10 = false;
        this.A0E = false;
        this.A0F = false;
        this.A0D = false;
        ...
        this.A0B = abstractC3547hy.A1k();
        this.A0M = new C22433i(super.A04, super.A05, this.A0L, super.A02.A25(), 0, 0, super.A02.A20().A0U(), null, null);
        if (U7.A1v(super.A04)) {
            this.A0K = new EG(super.A04, super.A05, this.A0L, super.A02.A25(), super.A02.A20().A0U(), this.A0M, null);
        } else {
            this.A0K = null;
        }
        this.A05 = new C3269dI(super.A04, super.A0A, super.A02.A1A(), interfaceC3003Xn);
        if (!A0j()) {
        ...
        if (!A0j()) {
            this.A0T = new C2475Cw(super.A04, iA02);
        } else {
            this.A0T = new C2475Cw(super.A04, iA02, C2475Cw.A0D);
        }
        ...
        this.A08 = z10;
        C2735My colors = super.A02.A1z().A01();
    ...
    private int A01(int i, int i10, int i11) {
        int i12 = 0;
        if (this.A0B) {
            int i13 = this.A00;
    ...
    public static int A02(AbstractC3547hy abstractC3547hy) {
        if (abstractC3547hy.A0v().equals(A0A(18, 14, 49))) {
            return abstractC3547hy.A20().A0H().A03();
        }
        if (abstractC3547hy.A0v().equals(A0A(6, 12, 112))) {
            return abstractC3547hy.A20().A0H().A04();
        }
        String[] strArr = A0V;
    ...
    private AbstractC3106ae A06(int i) throws SecurityException {
        C3109ah c3109ahA0N = new C3109ah(super.A04, super.A05, super.A09, super.A02, this.A0L, super.A0B, super.A07).A0K(super.A08.getToolbarHeight()).A0R(super.A08).A0J(i).A0L(this.A0H).A0T(this.A0T).A0Q(this.A02).A0N(super.A06);
        if (super.A02.A20().A0S() && U7.A1Y(super.A04) && super.A02.A20().A0L() != null) {
            c3109ahA0N.A0P(getPackageInstallListener());
        }
        c3109ahA0N.A0M(MI.A00(super.A04, super.A05, A0A(0, 0, 98), WQ.A00(super.A02.A20().A0J().A05()), new HashMap(), super.A02.A21()));
    ...
    private void A0B() {
        if (!super.A02.A20().A0K().A03()) {
            ...
            this.A02.setToolbarListener(new C2542Fl(this));
            if (super.A02.A2K()) {
                this.A02.setOnClickListener(new ViewOnClickListenerC3225cZ(this));
            }
        }
    }

    private void A0C() {
        this.A0L.postDelayed(new C2533Fc(this), U7.A0O(super.A04));
    }

    private void A0D() {
        this.A0L.postDelayed(new C2532Fb(this), U7.A0P(super.A04));
    }
    ...
    private void A0F() {
        ...
        if (this.A0H instanceof InterfaceC3289dc) {
            this.A0L.A0i((InterfaceC3289dc) this.A0H);
        }
        if (!TextUtils.isEmpty(super.A02.A20().A0H().A08())) {
            C22242p c22242p = new C22242p(super.A04, A0j());
            this.A0L.A0i(c22242p);
            c22242p.setImage(super.A02.A20().A0H().A08());
        }
        if (!A0j()) {
            C2R c2r = new C2R(super.A04, true, super.A06);
            this.A0L.A0i(c2r);
            this.A0L.A0i(new D4(c2r, EnumC3303dr.A02, true));
        }
        this.A0L.A0i(new C2Y(super.A04));
    }

    private void A0H(UZ uz) {
        new C2915Ua(super.A02.A25(), super.A04.A0A()).A04(uz, null);
        super.A09.A4b(super.A0A.A6d());
        this.A05.A05();
        if (this.A03 instanceof C22905d) {
            ((C22905d) this.A03).A1Y();
        }
        if (!super.A02.A1i()) {
            this.A0G.postDelayed(new RunnableC3227cb(this), 2000L);
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void A0O(C22383d c22383d, boolean z10, boolean z11) {
        if (this.A04 != null) {
            if (z10) {
                super.A04.A0F().ADu();
            }
        ...
        if (!z10 && this.A08 && this.A0B) {
            this.A00++;
            this.A0L.A0h(EnumC3288db.A02, 20);
            return;
        }
        if (!this.A0C) {
            A0E();
        ...
        if (!z10 && this.A00 < super.A02.A20().A0G()) {
            this.A0L.A0h(EnumC3288db.A02, 32);
        } else {
            this.A0D = true;
            if (this.A03 != null) {
                this.A03.A1H(c22383d);
            }
        }
        if (this.A00 == 0) {
            A0S(z10, z11);
    ...
    public void A0P(C3Q c3q) {
        if (this.A0L.getState() == EnumC3342eU.A02 && U7.A1Z(super.A04)) {
    ...
    public void A0Q(C3Q c3q) {
        ...
        if (this.A08) {
            ...
            AbstractC3547hy abstractC3547hy = super.A02;
            if (A0V[6].length() != 22) {
                String[] strArr = A0V;
                strArr[0] = "";
                strArr[1] = "CRWrhlQnYLwh";
                if (!KE.A05(abstractC3547hy)) {
        ...
        if (!zA1j) {
            ...
            AbstractC3002Xm abstractC3002Xm = super.A08;
            String[] strArr3 = A0V;
            ...
            if (totalSecondsForNextCta4 != currentPosMs6) {
                ...
                abstractC3002Xm.A09(unskippableSeconds2, i);
            } else {
                A0V[3] = "ksHgyK5pJeiIhpnbSmOLRLGEWkwS8h7S";
                float unskippableSeconds3 = 100.0f * f10;
                abstractC3002Xm.A09(unskippableSeconds3, i);
            }
        }
        if (f10 >= 1.0f && !this.A0C) {
            A0E();
            AbstractC3002Xm abstractC3002Xm2 = super.A08;
            int currentPosMs7 = getCloseButtonStyle();
            abstractC3002Xm2.setToolbarActionMode(currentPosMs7);
        }
    }
    ...
    public void A0R(String str) {
        ...
        if (U7.A1a(super.A04)) {
            A0O(new C22383d(currentPositionInMillis, duration), false, true);
        } else {
    ...
    public final AbstractC3002Xm A0b() {
        ...
        if (!A0j()) {
            c2754Nr = new FullScreenAdToolbar(super.A04, super.A09, super.A06, 1, super.A02.A1t(), super.A02.A1j());
        } else {
            c2754Nr = new C2754Nr(super.A04, super.A09, super.A06, 1);
            A0B();
            if (super.A02.A2K()) {
                c2754Nr.setOnTouchListener(new ViewOnTouchListenerC3229cd(this));
            }
        }
        if (super.A02.A2K()) {
            c2754Nr.setOnClickListener(new ViewOnClickListenerC3224cY(this));
        }
        return c2754Nr;
    }
    ...
    public final void A0h(R0 r02) {
        ...
        XP.A0F(this.A03);
        XP.A0F(super.A08);
        if (super.A02.A1f() && (this.A03 instanceof C22905d)) {
            ((C22905d) this.A03).setVideoAdViewListener(this.A0J);
        }
        AbstractC3106ae abstractC3106ae = this.A03;
        if (A0V[6].length() == 22) {
            throw new RuntimeException();
        }
        A0V[5] = "wo0V9GMefx8z7FmkoRuQRU6XLmQOOAjz";
        if (abstractC3106ae != null && this.A03.A1M()) {
            z10 = true;
        }
    ...
    public final void A0k() {
        ...
        if (A0j()) {
            ...
            if (abstractC3106ae instanceof C22905d) {
                ((C22905d) this.A03).A1Z(getResources().getConfiguration().orientation);
                ((C22905d) this.A03).A1X();
            }
        }
        this.A0L.A0h(EnumC3288db.A02, 20);
    ...
    public final void AF0(boolean z10) {
        ...
        if (this.A0L.getVisibility() != 0 || this.A0L.A0r() || this.A0D || this.A0L.getState() == EnumC3342eU.A06 || this.A06 == null) {
            return;
        }
        if (!this.A0A || z10) {
    ...
    private InterfaceC2985Wv getPackageInstallListener() {
        return new FP(this);
    }
    ...
    public void setVideoLeadingPlayableAdListener(InterfaceC3231cf interfaceC3231cf) {
        this.A04 = interfaceC3231cf;
    }
}
