...
public final class C21840z extends C9Z implements Handler.Callback {
    ...
    public long A04;
    public C3949or A05;
    public InterfaceC3688kN A06;
    public C23487j A07;
    public AbstractC23477i A08;
    public AbstractC23477i A09;
    public boolean A0A;
    public boolean A0B;
    public boolean A0C;
    public final Handler A0D;
    public final C6N A0E;
    public final InterfaceC2492Dn A0F;
    public final InterfaceC2495Dq A0G;
    ...
    public C21840z(InterfaceC2495Dq interfaceC2495Dq, Looper looper, InterfaceC2492Dn interfaceC2492Dn) {
        super(3);
        this.A0G = (InterfaceC2495Dq) C3M.A01(interfaceC2495Dq);
        this.A0D = looper == null ? null : AbstractC22614a.A0c(looper, this);
        this.A0F = interfaceC2492Dn;
        this.A0E = new C6N();
    ...
    @SideEffectFree
    private long A01(long j4) {
        int iA8S = this.A09.A8S(j4);
        if (iA8S != 0) {
    ...
    private void A04() {
        A0B(new C3898o0(MetaExoPlayerCustomizedCollections.A01(), A02(this.A03)));
    }

    private void A05() {
        this.A0C = true;
        this.A06 = this.A0F.A5C((C3949or) C3M.A01(this.A05));
    }
    ...
    private void A07() {
        A06();
        ((InterfaceC3688kN) C3M.A01(this.A06)).AGr();
        this.A06 = null;
        this.A00 = 0;
    }
    ...
    private void A0A(C3898o0 c3898o0) {
        this.A0G.ACw(c3898o0.A01);
        this.A0G.ACv(c3898o0);
    }

    private void A0B(C3898o0 c3898o0) {
        if (this.A0D != null) {
            this.A0D.obtainMessage(0, c3898o0).sendToTarget();
        } else {
            A0A(c3898o0);
        }
    }
    ...
    private void A0C(C2494Dp c2494Dp) {
        if (this.A0D != null) {
            this.A0D.obtainMessage(1, c2494Dp).sendToTarget();
        }
    }

    private void A0D(C3687kM c3687kM) {
        AnonymousClass44.A08(A03(39, 12, 23), A03(0, 39, 112) + this.A05, c3687kM);
        A0C(new C2494Dp(this.A05, c3687kM));
        A04();
        A08();
    }
    ...
    public final void A1a(long j4, boolean z10) {
        ...
        if (this.A00 != 0) {
            ...
            A06();
            ((InterfaceC3688kN) C3M.A01(this.A06)).flush();
        }
    }
    ...
    */
    public final void AHn(long r10, long r12) throws com.facebook.ads.redexgen.core.C5P {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C21840z.AHn(long, long):void");
    }

    @Override // com.facebook.ads.redexgen.core.C7D
    public final int AJb(C3949or c3949or) {
        if (this.A0F.AJc(c3949or)) {
            return AnonymousClass76.A00(4);
        }
        if (AbstractC22162h.A0E(c3949or.A0W)) {
