...
public abstract class IZ {
    ...
    public static Id3Frame A03(int i, String str, C4J c4j, boolean z10, boolean z11) {
        int iA00 = A00(c4j);
        if (z11) {
    ...
    public static Id3Frame A04(C4J c4j) {
        ...
        int endPosition = position2 & KotlinVersion.MAX_COMPONENT_VALUE;
        try {
    ...
    */
    ...
    public static void A0D(int i, C2565Gi c2565Gi, C2D c2d) {
        if (i == 1 && c2565Gi.A03()) {
            c2d.A0d(c2565Gi.A00).A0e(c2565Gi.A01);
        }
    }
}
