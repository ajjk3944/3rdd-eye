...
public abstract class AbstractC3879ng {
    ...
    public static <E> ArrayList<E> A05(Iterator<? extends E> elements) {
        ...
        AbstractC3858nL.A0B(list, elements);
        return list;
    }

    public static boolean A06(@CheckForNull List<?> thisList, Object other) {
        if (other == AbstractC3614jA.A04(thisList)) {
            return true;
        }
        ...
        return AbstractC3858nL.A0G(thisList.iterator(), list.iterator());
    }
}
