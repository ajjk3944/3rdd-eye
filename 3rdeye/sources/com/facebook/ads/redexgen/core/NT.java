...
public final class NT {
    ...
    public NT(String str, V6 v62, AdPlacementType adPlacementType, V4 v42, int i, TL tl) {
        this(str, v62, adPlacementType, v42, i, EnumSet.of(CacheFlag.NONE), tl);
    }

    public NT(String str, V6 v62, AdPlacementType adPlacementType, V4 v42, int i, EnumSet<CacheFlag> cacheFlags, TL tl) {
        this.A0A = str;
    ...
    public final VR A00(C3272dL c3272dL, VB vb, AdExperienceType adExperienceType) {
        return new VR(c3272dL, this.A0A, this.A08 != null ? new X1(this.A08.A04(), this.A08.A03()) : null, this.A09, this.A0C, vb, X7.A01(U7.A0N(c3272dL)), this.A04, adExperienceType != null ? adExperienceType.getAdExperienceType() : null, this.A07);
    }
    ...
    public final void A05(EnumC2926Ul enumC2926Ul) {
        this.A03 = enumC2926Ul;
    }
