...
public final class AnonymousClass64 extends E1 {
    ...
    public AnonymousClass64(C3272dL c3272dL) {
        super(c3272dL);
        ...
        this.A09 = new C2721Mj(this, c3272dL);
        this.A0A = c3272dL;
        A02();
    }

    public AnonymousClass64(C3272dL c3272dL, AttributeSet attributeSet) {
    ...
    public AnonymousClass64(C3272dL c3272dL, AttributeSet attributeSet, int i) {
    ...
    private void A04(Intent intent) {
        ...
        intent.putExtra(A01(322, 8, 97), EnumC2942Vb.A09);
        ...
        intent.putExtra(A01(205, 24, 99), AbstractC2975Wl.A00(this.A0A));
        ...
        intent.putExtra(A01(KotlinVersion.MAX_COMPONENT_VALUE, 11, 7), this.A05.A0c());
        intent.putExtra(A01(295, 27, 99), getVideoProgressReportIntervalMs());
        intent.addFlags(268435456);
    }

    private void A05(String str) {
        this.A0A.A08().AAy(A01(198, 7, 74), AbstractC2885Sv.A28, new C2886Sw(AdErrorType.PARSER_FAILURE.getDefaultErrorMessage(), A01(90, 7, 92) + str));
    ...
    public final void A0v() {
        ...
        try {
            ...
            this.A0A.A08().AAy(A01(176, 11, 123), AbstractC2885Sv.A0D, new C2886Sw(e4));
            Log.e(A01(97, 17, 97), A01(0, 90, 103), e4);
        }
    }
    ...
    public void setClientToken(String str) {
        ...
        EG eg2 = null;
        if (str != null) {
            c22433i = new C22433i(this.A0A, this.A02, this, str);
        } else {
            c22433i = null;
        }
        this.A05 = c22433i;
