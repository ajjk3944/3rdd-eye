...
public final class JA {
    ...
    public static void A05(SpannableStringBuilder spannableStringBuilder, int i, int i10) {
        spannableStringBuilder.setSpan(new StyleSpan(2), i, i10, 33);
    }

    public static void A06(SpannableStringBuilder spannableStringBuilder, int i, int i10) {
        spannableStringBuilder.setSpan(new UnderlineSpan(), i, i10, 33);
    }

    public static void A07(SpannableStringBuilder spannableStringBuilder, int i, int i10, int i11) {
        if (i11 == -1) {
            return;
        }
        spannableStringBuilder.setSpan(new ForegroundColorSpan(i11), i, i10, 33);
    }
    ...
    */
    public final com.facebook.ads.redexgen.core.C3900o2 A08(int r10) {
        /*
    ...
    */
    ...
    public final void A0F(int i, boolean z10) {
        this.A06.add(new J9(i, z10, this.A05.length()));
    }
