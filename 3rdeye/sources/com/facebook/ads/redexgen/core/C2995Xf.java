...
public final class C2995Xf implements SensorEventListener {
    ...
    public final Set<InterfaceC2994Xe> A09 = new CopyOnWriteArraySet();
    ...
    public C2995Xf(C3272dL c3272dL) {
        this.A08 = c3272dL;
    }
    ...
    public final void A03(InterfaceC2994Xe interfaceC2994Xe) {
        if (this.A09.isEmpty()) {
            A01();
        } else if (this.A09.contains(interfaceC2994Xe)) {
            return;
        }
        this.A09.add(interfaceC2994Xe);
    }
        ...
        if (now - this.A06 > 100) {
            ...
            if (speed > 800.0f) {
                ...
                if (i >= 3 && now - this.A05 > 1000) {
                    this.A05 = now;
                    this.A03 = 0;
                    Iterator<InterfaceC2994Xe> it = this.A09.iterator();
                    while (it.hasNext()) {
                        it.next().AFD();
                    }
                }
