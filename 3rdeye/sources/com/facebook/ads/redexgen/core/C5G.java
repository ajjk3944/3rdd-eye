...
public final class C5G extends FrameLayout implements I3 {
    ...
    public final US A04;
    public final XH A05;
    public final InterfaceC3172bi A06;
    public final C3183bt A07;
    ...
    public C5G(C3272dL c3272dL, US us, InterfaceC3172bi interfaceC3172bi, AbstractC3547hy abstractC3547hy, String str, int i, XH xh) throws JSONException {
        super(c3272dL);
        this.A03 = c3272dL;
        this.A04 = us;
        this.A02 = abstractC3547hy;
        this.A08 = str;
        this.A06 = interfaceC3172bi;
        this.A01 = i;
        C3183bt preloadedDynamicWebViewController = AbstractC3184bu.A02(abstractC3547hy.A17());
        if (preloadedDynamicWebViewController != null) {
            this.A07 = preloadedDynamicWebViewController;
            this.A09 = true;
        } else {
            this.A07 = new C3183bt(this.A03, abstractC3547hy, us, i);
            AbstractC3184bu.A03(abstractC3547hy, this.A07);
            this.A09 = false;
        }
        if (xh != null) {
            this.A05 = xh;
        ...
        this.A07.A0a(interfaceC3172bi);
        EnumC2980Wq.A04(this, EnumC2980Wq.A0B);
        if (U7.A1u(c3272dL)) {
            c3272dL.A0B().AK4(this.A07.A0O(), abstractC3547hy.A25(), false, false, true);
        }
        A04();
    }
        ...
        if (!this.A09) {
            ...
            if (this.A07.A0k()) {
                if (this.A01 == 4) {
                    ...
                    if (U7.A1u(this.A03)) {
                        InterfaceC2919Ue interfaceC2919UeA0B = this.A03.A0B();
                        if (A0B[1].length() != 25) {
                            throw new RuntimeException();
                        }
                        A0B[5] = "";
                        interfaceC2919UeA0B.ACx();
                    }
                } else {
                    AJS();
                }
    ...
    private void A05(Intent intent, AbstractC3547hy abstractC3547hy) {
        intent.putExtra(A01(157, 8, 110), EnumC2942Vb.A07);
        intent.putExtra(A01(130, 18, 58), abstractC3547hy);
        intent.addFlags(268435456);
    }

    private final void A06(AbstractC3547hy abstractC3547hy) {
        AdActivityIntent adActivityIntentA05 = WB.A05(this.A03);
        A05(adActivityIntentA05, abstractC3547hy);
        try {
            WB.A0B(this.A03, adActivityIntentA05);
        } catch (Exception e4) {
            this.A03.A08().AAy(A01(107, 11, 42), AbstractC2885Sv.A0D, new C2886Sw(e4));
            Log.e(A01(90, 17, 80), A01(0, 90, 41), e4);
        }
    }
    ...
    public C3183bt getDynamicWebViewController() {
        return this.A07;
    }
    ...
    public void setAdViewabilityChecker(C3345eX c3345eX) {
        this.A00 = c3345eX;
        this.A07.A0e(c3345eX);
    }
}
