...
public final class C3175bl extends FrameLayout {
    ...
    public final C2915Ua A08;
    public final InterfaceC3003Xn A09;
    public final YY A0A;
    public final InterfaceC3174bk A0B;
    public final EG A0C;
    public final E1 A0D;
    public final C22433i A0E;
    public final DX A0F;
    public final DV A0G;
    public final DR A0H;
    public final DP A0I;
    ...
    public C3175bl(C3272dL c3272dL, US us, AbstractC3547hy abstractC3547hy, SF sf, C2915Ua c2915Ua, InterfaceC3003Xn interfaceC3003Xn, YY yy, InterfaceC3174bk interfaceC3174bk) {
        boolean z10;
        super(c3272dL);
        ...
        this.A0F = new DX() { // from class: com.facebook.ads.redexgen.X.55
            ...
            @Override // com.facebook.ads.redexgen.core.AbstractC2895Tf
            /* renamed from: A02, reason: merged with bridge method [inline-methods] */
            public final void A03(C22383d c22383d) throws JSONException {
                this.A00.A07();
        ...
        this.A0A = yy;
        this.A0D = new E1(c3272dL);
        this.A0B = interfaceC3174bk;
        this.A0D.setFunnelLoggingHandler(c2915Ua);
        this.A0D.getEventBus().A03(this.A0J, this.A0I, this.A0H, this.A0K, this.A0F, this.A0G);
        this.A0E = new C22433i(c3272dL, us, this.A0D, abstractC3547hy.A25());
        if (U7.A1v(this.A07)) {
            z10 = true;
            this.A0C = new EG(c3272dL, us, this.A0D, abstractC3547hy.A25(), false, this.A0E, null);
        } else {
            z10 = true;
            this.A0C = null;
        }
        ...
        String videoUrl = abstractC3547hy.A20().A0H().A08();
        if (!TextUtils.isEmpty(videoUrl)) {
            AbstractC3093aR.A00(c3272dL, this, videoUrl);
        }
    ...
    private void A0B() {
        if (!TextUtils.isEmpty(this.A05.A20().A0H().A08())) {
            C22242p c22242p = new C22242p(this.A07);
            this.A0D.A0i(c22242p);
            c22242p.setImage(this.A05.A20().A0H().A08());
        }
        C2R c2r = new C2R(this.A07, true, this.A08);
        this.A0D.A0i(c2r);
        this.A0D.A0i(new D4(c2r, EnumC3303dr.A02, true));
        this.A0D.A0i(new C2Y(this.A07));
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void A0H(C3Q c3q) {
        if (this.A0D.getState() == EnumC3342eU.A02 && U7.A1Z(this.A07)) {
    ...
    public final void A0N() {
        ...
        this.A0D.A0h(EnumC3288db.A02, 26);
        A08();
    }
    ...
    public final void A0T(boolean z10) {
        if (this.A0D.A0r() || this.A02 || this.A0D.getState() == EnumC3342eU.A06 || this.A00 == null) {
            return;
        }
        if (!this.A01 || z10) {
    ...
    public final void A0V(boolean z10) {
        this.A0D.A0h(EnumC3288db.A04, 25);
    }
}
