...
public final class IC {
     ...
     */
    public static Pair<String, List<byte[]>> A02(C4J c4j) throws C22172i {
        try {
            c4j.A0g(16);
            long jA0O = c4j.A0O();
            if (jA0O == 1482049860) {
            ...
            throw C22172i.A01(A03(267, 45, 108), null);
        } catch (ArrayIndexOutOfBoundsException unused) {
            throw C22172i.A01(A03(166, 33, 80), null);
        }
    }

    public static String A03(int i, int i10, int i11) {
        byte[] bArrCopyOfRange = Arrays.copyOfRange(A0p, i, i + i10);
    ...
    public static List<byte[]> A05(byte[] bArr) throws C22172i {
        ...
        try {
            if (bArr[0] == 2) {
                ...
                int i11 = i + (bArr[vorbisInfoLength] & KotlinVersion.MAX_COMPONENT_VALUE);
                int offset = 0;
                while ((bArr[i10] & 255) == 255) {
                    offset += KotlinVersion.MAX_COMPONENT_VALUE;
                    i10++;
                }
                int vorbisInfoLength2 = i10 + 1;
                int offset2 = offset + (bArr[i10] & KotlinVersion.MAX_COMPONENT_VALUE);
    ...
    public static boolean A09(C4J c4j) throws C22172i {
        try {
            int iA0G = c4j.A0G();
            if (iA0G == 1) {
                return true;
            ...
            throw C22172i.A01(A03(199, 34, 58), null);
        }
    }
    ...
    private byte[] A0D(String str) throws C22172i {
        if (this.A0j != null) {
            byte[] bArr = this.A0j;
            if (A0q[1].charAt(11) != 'i') {
                throw new RuntimeException();
        ...
        throw C22172i.A01(A03(329, 31, 93) + str, null);
    }
    ...
    */
    public final void A0G(com.facebook.ads.redexgen.core.GY r20, int r21) throws com.facebook.ads.redexgen.core.C22172i {
        /*
