...
public abstract class PJ {
    ...
    static {
        A01();
        A02 = new C3463gT() { // from class: com.facebook.ads.redexgen.X.6n
            public static byte[] A00;
            ...
            public final void A02(ViewParent viewParent, View view) {
                try {
                    ...
                    Log.e(A00(389, 16, 101), A00(378, 11, 90) + viewParent + A00(323, 55, 96), e4);
                }
            }

            @Override // com.facebook.ads.redexgen.core.PI
            public final void A03(ViewParent viewParent, View view, int i, int i10, int i11, int i12) {
                try {
                    viewParent.onNestedScroll(view, i, i10, i11, i12);
                } catch (AbstractMethodError e4) {
                    Log.e(A00(389, 16, 101), A00(378, 11, 90) + viewParent + A00(157, 51, 53), e4);
                }
            }

            @Override // com.facebook.ads.redexgen.core.PI
            public final void A04(ViewParent viewParent, View view, int i, int i10, int[] iArr) {
                try {
                    viewParent.onNestedPreScroll(view, i, i10, iArr);
                } catch (AbstractMethodError e4) {
                    Log.e(A00(389, 16, 101), A00(378, 11, 90) + viewParent + A00(103, 54, 8), e4);
                }
            }
            ...
            public final void A05(ViewParent viewParent, View view, View view2, int i) {
                try {
                    ...
                    Log.e(A00(389, 16, 101), A00(378, 11, 90) + viewParent + A00(208, 59, 114), e4);
                }
            }
            ...
            public final boolean A06(ViewParent viewParent, View view, float f10, float f11) {
                try {
                    ...
                    Log.e(A00(389, 16, 101), A00(378, 11, 90) + viewParent + A00(50, 53, 25), e4);
                    return false;
                }
            }
            ...
            public final boolean A07(ViewParent viewParent, View view, float f10, float f11, boolean z10) {
                try {
                    ...
                    Log.e(A00(389, 16, 101), A00(378, 11, 90) + viewParent + A00(0, 50, 79), e4);
                    return false;
                }
            }
            ...
            public final boolean A08(ViewParent viewParent, View view, View view2, int i) {
                try {
                    ...
                    Log.e(A00(389, 16, 101), A00(378, 11, 90) + viewParent + A00(267, 56, 74), e4);
                    return false;
                }
            }
        };
    ...
    public static void A03(ViewParent viewParent, View view, int i, int i10, int i11, int i12, int i13) {
        if (0 != 0) {
            throw new NullPointerException(A00(17, 14, 15));
        }
        if (i13 == 0) {
            A02.A03(viewParent, view, i, i10, i11, i12);
        }
    }

    public static void A04(ViewParent viewParent, View view, int i, int i10, int[] iArr, int i11) {
        if (0 != 0) {
            throw new NullPointerException(A00(0, 17, 84));
        }
        if (i11 == 0) {
            A02.A04(viewParent, view, i, i10, iArr);
        }
    }

    public static void A05(ViewParent viewParent, View view, View view2, int i, int i10) {
        if (0 != 0) {
    ...
    public static boolean A08(ViewParent viewParent, View view, View view2, int i, int i10) {
        if (0 != 0) {
