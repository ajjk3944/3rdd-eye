...
public final class C3726lB implements GX {
    ...
    public static final InterfaceC2558Gb A0F = new InterfaceC2558Gb() { // from class: com.facebook.ads.redexgen.X.lC
    ...
    public C3726lB(int i) {
        this.A0D = new byte[42];
        this.A0A = new C4J(new byte[Constants.QUEUE_ELEMENT_MAX_SIZE], 0);
        this.A0C = (i & 1) != 0;
        this.A0B = new C2559Gc();
        this.A03 = 0;
    }

    private int A00(InterfaceC3738lN interfaceC3738lN, C2576Gt c2576Gt) throws IOException {
        C3M.A01(this.A08);
        C3M.A01(this.A07);
        if (this.A09 != null && this.A09.A09()) {
            return this.A09.A06(interfaceC3738lN, c2576Gt);
        }
        long j4 = this.A04;
        if (A0E[2].length() == 19) {
            A0E[2] = "5vsaEOzV8f26KwvJg69";
            if (j4 == -1) {
                this.A04 = AbstractC2560Gd.A01(interfaceC3738lN, this.A07);
                return 0;
            }
            ...
            if (strArr[6].length() != strArr[1].length()) {
                ...
                if (iA0A < 32768) {
                    ...
                    int currentLimit = Constants.QUEUE_ELEMENT_MAX_SIZE - iA0A;
                    int i = interfaceC3738lN.read(bArrA0l, iA0A, currentLimit);
                    z10 = i == -1;
                    if (!z10) {
                        this.A0A.A0e(iA0A + i);
                    } else {
    ...
    */
    private long A01(com.facebook.ads.redexgen.core.C4J r6, boolean r7) {
        ...
        L9:
            ...
            boolean r0 = com.facebook.ads.redexgen.core.AbstractC2560Gd.A07(r6, r2, r1, r0)
            if (r0 == 0) goto L28
            r6.A0f(r3)
            com.facebook.ads.redexgen.X.Gc r0 = r5.A0B
            long r0 = r0.A00
        ...
        L2d:
            ...
            boolean r2 = com.facebook.ads.redexgen.core.AbstractC2560Gd.A07(r6, r2, r1, r0)     // Catch: java.lang.IndexOutOfBoundsException -> L44
            goto L45
        L44:
            r2 = 0
        L45:
        ...
        L68:
            r3 = -1
            java.lang.String[] r2 = com.facebook.ads.redexgen.core.C3726lB.A0E
            r0 = 3
            r1 = r2[r0]
            r0 = 4
            r0 = r2[r0]
        ...
        L82:
            ...
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C3726lB.A01(com.facebook.ads.redexgen.X.4J, boolean):long");
    }

    private InterfaceC2579Gw A02(long j4, long j10) {
        C3M.A01(this.A07);
        if (this.A07.A0A != null) {
            return new C3735lK(this.A07, j4);
        }
        if (j10 != -1 && this.A07.A09 > 0) {
            this.A09 = new C3728lD(this.A07, this.A01, j4, j10);
            return this.A09.A07();
        }
        return new C3733lI(this.A07.A06());
    }

    private void A03() {
        ((H1) AbstractC22614a.A0f(this.A08)).AIA((this.A04 * 1000000) / ((C2564Gh) AbstractC22614a.A0f(this.A07)).A07, 1, this.A00, 0, null);
    }

    private void A04(InterfaceC3738lN interfaceC3738lN) throws IOException {
        this.A01 = AbstractC2562Gf.A00(interfaceC3738lN);
        ((GY) AbstractC22614a.A0f(this.A06)).AIN(A02(interfaceC3738lN.A8f(), interfaceC3738lN.A8G()));
        this.A03 = 5;
    }

    private void A05(InterfaceC3738lN interfaceC3738lN) throws IOException {
        interfaceC3738lN.AG9(this.A0D, 0, this.A0D.length);
        interfaceC3738lN.AI1();
        this.A03 = 2;
    }

    private void A06(InterfaceC3738lN interfaceC3738lN) throws IOException {
        this.A05 = AbstractC2562Gf.A02(interfaceC3738lN, !this.A0C);
        this.A03 = 1;
    }

    private void A07(InterfaceC3738lN interfaceC3738lN) throws IOException {
        boolean zA0B = false;
        C2561Ge metadataHolder = new C2561Ge(this.A07);
        while (!zA0B) {
            zA0B = AbstractC2562Gf.A0B(interfaceC3738lN, metadataHolder);
            this.A07 = (C2564Gh) AbstractC22614a.A0f(metadataHolder.A00);
        }
        C3M.A01(this.A07);
        this.A02 = Math.max(this.A07.A06, 6);
        ((H1) AbstractC22614a.A0f(this.A08)).A6W(this.A07.A08(this.A0D, this.A05));
        this.A03 = 4;
    }

    private void A08(InterfaceC3738lN interfaceC3738lN) throws IOException {
        AbstractC2562Gf.A09(interfaceC3738lN);
        this.A03 = 3;
    }

    public static /* synthetic */ GX[] A09() {
        return new GX[]{new C3726lB()};
    }
    ...
    public final int AGb(InterfaceC3738lN interfaceC3738lN, C2576Gt c2576Gt) throws IOException {
        switch (this.A03) {
            ...
            case 4:
                ...
                return 0;
            case 5:
                return A00(interfaceC3738lN, c2576Gt);
            default:
    ...
    public final boolean AJL(InterfaceC3738lN interfaceC3738lN) throws IOException {
        AbstractC2562Gf.A01(interfaceC3738lN, false);
        return AbstractC2562Gf.A0A(interfaceC3738lN);
    }
}
