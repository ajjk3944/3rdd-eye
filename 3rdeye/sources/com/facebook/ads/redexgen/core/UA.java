...
public abstract class UA {
    ...
    public static long A02(Context context) {
        return U7.A0V(context).A2v(A04(91, 29, 79), b.TWENTY_FOUR_HOURS_MILLIS);
    }
    ...
    public static boolean A0L(Context context, long j4) {
        long lastUpdateTime = System.currentTimeMillis();
        long currentTime = U7.A0U(context);
        return lastUpdateTime - currentTime > j4;
    }
