...
public abstract class AbstractC3897nz {
    ...
    public static int A00(int expectedSize) {
        if (expectedSize < 3) {
            AbstractC3761ll.A00(expectedSize, A07(2, 12, 124));
    ...
    public static <K, V> Map.Entry<K, V> A01(@ParametricNullness K key, @ParametricNullness V value) {
        return new C2417An(key, value);
    }

    public static <K, V> Iterator<K> A02(Iterator<Map.Entry<K, V>> entryIterator) {
        return new C2410Ag(entryIterator);
    }

    public static <K, V> Iterator<V> A03(Iterator<Map.Entry<K, V>> entryIterator) {
        return new C2409Af(entryIterator);
    }

    public static <V> InterfaceC3594ip<Map.Entry<?, V>, V> A04() {
        EnumC2408Ae enumC2408Ae = EnumC2408Ae.A03;
        if (A01[6].charAt(13) == 's') {
            throw new RuntimeException();
        }
    ...
    public static String A08(Map<?, ?> map) {
        StringBuilder sbAppend = AbstractC3766lq.A01(map.size()).append('{');
        boolean z10 = true;
    ...
    public static boolean A0A(@CheckForNull Map<?, ?> map, Object value) {
        return AbstractC3858nL.A0E(A03(map.entrySet().iterator()), value);
    }
