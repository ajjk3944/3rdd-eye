...
public abstract class LB {
    ...
    public static Bitmap A01(InputStream inputStream, int i, int i10) throws IOException {
        ...
        lc.reset();
        if (!lc.A00()) {
            options.inSampleSize = A00(options, i, i10);
    ...
    public static Bitmap A02(String str, int i, int i10) {
        BitmapFactory.Options options = new BitmapFactory.Options();
        options.inJustDecodeBounds = true;
    ...
    public static Bitmap A03(String str, int i, int i10, boolean z10) throws IOException {
        try {
            FileInputStream fileInputStream = new FileInputStream(new File(str));
            if (i > 0 && i10 > 0) {
                if (z10) {
                    Bitmap bitmapA01 = A01(fileInputStream, i, i10);
                    A07(fileInputStream);
                    return bitmapA01;
                }
                Bitmap bitmapA02 = A02(str, i, i10);
                A07(fileInputStream);
                return bitmapA02;
            }
