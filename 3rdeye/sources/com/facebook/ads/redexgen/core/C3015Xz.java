...
public final class C3015Xz extends AdNativeComponentView {
    public static final int A01 = (int) (AbstractC2975Wl.A02 * 1.0f);
    public final ImageView A00;

    public C3015Xz(C3272dL c3272dL) {
        super(c3272dL);
        this.A00 = new YM(c3272dL);
        this.A00.setScaleType(ImageView.ScaleType.CENTER_CROP);
        EnumC2980Wq.A04(this.A00, EnumC2980Wq.A0B);
