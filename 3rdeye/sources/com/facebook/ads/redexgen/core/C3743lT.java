...
public final class C3743lT implements InterfaceC2579Gw {
    ...
    public C3743lT(int[] iArr, long[] jArr, long[] jArr2, long[] jArr3) {
        this.A01 = iArr;
        this.A03 = jArr;
        this.A02 = jArr2;
        this.A04 = jArr3;
    ...
    private final int A00(long j4) {
        return AbstractC22614a.A0L(this.A04, j4, true, true);
    }
    ...
    public final C2578Gv A8t(long j4) {
        int iA00 = A00(j4);
        C2580Gx c2580Gx = new C2580Gx(this.A04[iA00], this.A03[iA00]);
        if (c2580Gx.A01 < j4) {
            ...
            if (iA00 != chunkIndex - 1) {
                ...
                C2580Gx seekPoint = new C2580Gx(j10, this.A03[chunkIndex3]);
                return new C2578Gv(c2580Gx, seekPoint);
            }
        }
