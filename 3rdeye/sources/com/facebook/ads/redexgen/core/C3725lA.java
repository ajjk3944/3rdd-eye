...
public final class C3725lA extends HI {
    ...
    public final boolean A0B(C4J c4j) throws C3721l6 {
        if (!this.A02) {
            ...
            if (this.A00 == 2) {
                ...
                throw new C3721l6(A00(0, 28, 125) + this.A00);
            }
            this.A02 = true;
        } else {
            c4j.A0g(1);
    ...
    public final boolean A0C(C4J c4j, long j4) throws C22172i {
        if (this.A00 == 2) {
            ...
            super.A00.AIA(j4, 1, iA07, 0, null);
            return true;
        }
        int iA0I = c4j.A0I();
        if (iA0I == 0 && !this.A01) {
        ...
        super.A00.AIA(j4, 1, iA072, 0, null);
        return true;
    }
}
