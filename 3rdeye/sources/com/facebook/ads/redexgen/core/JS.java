...
public final class JS extends AbstractC3106ae {
    public RelativeLayout A00;
    public RelativeLayout A01;
    public InterfaceC3230ce A02;
    public EG A03;
    public E1 A04;
    public C22433i A05;
    ...
    public static final int A0V = (int) (AbstractC2975Wl.A02 * 24.0f);
    public static final int A0U = (int) (AbstractC2975Wl.A02 * 8.0f);
    public static final int A0N = (int) (AbstractC2975Wl.A02 * 1.0f);
    public static final int A0O = (int) (AbstractC2975Wl.A02 * 24.0f);
    public static final int A0T = (int) (AbstractC2975Wl.A02 * 3.0f);
    public static final int A0I = (int) (AbstractC2975Wl.A02 * 5.0f);
    public static final int A0W = (int) (AbstractC2975Wl.A02 * 8.0f);
    public static final int A0J = (int) (AbstractC2975Wl.A02 * 16.0f);
    public static final int A0L = (int) (AbstractC2975Wl.A02 * 16.0f);
    public static final int A0K = (int) (AbstractC2975Wl.A02 * 8.0f);
    public static final int A0M = (int) (AbstractC2975Wl.A02 * 8.0f);
    public static final int A0P = (int) (AbstractC2975Wl.A02 * 12.0f);
    public static final int A0H = (int) (AbstractC2975Wl.A02 * 40.0f);
    public static final int A0S = (int) (AbstractC2975Wl.A02 * 16.0f);
    public static final int A0R = (int) (AbstractC2975Wl.A02 * 24.0f);
    public static final int A0Q = (int) (AbstractC2975Wl.A02 * 16.0f);
    public static final int A0G = (int) (AbstractC2975Wl.A02 * 6.0f);

    public JS(C3110ai c3110ai) {
        super(c3110ai, false);
        ...
        this.A0D = new DX() { // from class: com.facebook.ads.redexgen.X.5b
            ...
            public final void A03(C22383d c22383d) {
                this.A00.A04.A0h(EnumC3288db.A02, 20);
            }
        };
    ...
    private LinearLayout A00() {
        ...
        if (!TextUtils.isEmpty(strA0B)) {
            XX xx = XX.RATINGS;
            AbstractC3547hy abstractC3547hyA05 = this.A0C.A05();
            String[] strArr = A0F;
            if (strArr[4].length() != strArr[5].length()) {
                throw new RuntimeException();
            }
            A0F[2] = "";
            LinearLayout videoMetaDataLayout = A01(xx, abstractC3547hyA05.A20().A0I().A0B());
    ...
    private LinearLayout A01(XX xx, String str) {
        ...
        linearLayout.setLayoutParams(layoutParams);
        XP.A0Q(linearLayout, XP.A06(RecyclerView.UNDEFINED_DURATION, A0Q));
        C3080aE c3080aE = new C3080aE(this.A0C.A06(), 0, -1, xx);
        LinearLayout.LayoutParams layoutParams2 = new LinearLayout.LayoutParams(A0P, A0P);
        layoutParams2.gravity = 16;
        c3080aE.setLayoutParams(layoutParams2);
    ...
    private final RelativeLayout A02(String str, int i, XX xx) {
        ...
        C3080aE iconView = new C3080aE(this.A0C.A06(), 0, -1, xx);
    ...
    private TextView A03(String str, boolean z10, int i, int i10, int i11) {
        TextView textView = new TextView(this.A0B);
        textView.setText(str);
        textView.setTextColor(i10);
        XP.A0W(textView, z10, i);
        LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(-1, -2);
        layoutParams.setMargins(A0K, 0, A0K, i11);
    ...
    private E1 A05() {
        ...
        this.A05 = new C22433i(this.A0B, getAdEventManager(), e12, this.A0C.A05().A25(), 0, 0, true, null, null);
        if (U7.A1v(this.A0B)) {
    ...
    private void A07() {
        ...
        this.A00.setOnClickListener(new ViewOnClickListenerC3139bB(this));
        this.A01.setOnClickListener(new ViewOnClickListenerC3140bC(this));
    }

    private void A08() {
        new C2915Ua(this.A0C.A05().A25(), getAdEventManager()).A04(UZ.A0f, null);
        AbstractC3093aR.A00(this.A0C.A06(), this, this.A0C.A05().A20().A0H().A08());
        ...
        this.A04.A0h(EnumC3288db.A02, 20);
