...
public final class C3659ju implements KJ {
    ...
    public C3659ju(boolean z10) {
        this(z10, null);
    }

    public C3659ju(boolean z10, String str) {
    ...
    private void A02() throws C22172i {
        this.A0H.A08(0);
        if (!this.A0G) {
            ...
            C3949or c3949orA14 = c2dA0b.A0m(audioObjectType3).A12(Collections.singletonList(bArrA07)).A10(this.A0J).A14();
            int audioObjectType4 = c3949orA14.A0G;
            this.A08 = 1024000000 / audioObjectType4;
            this.A0C.A6W(c3949orA14);
            this.A0G = true;
        } else {
            this.A0H.A09(10);
        }
    ...
    private void A0D(H1 h12, long j4, int i, int i10) {
        this.A06 = 4;
        this.A00 = i;
        this.A0A = h12;
        this.A07 = j4;
    ...
    */
    private boolean A0G(com.facebook.ads.redexgen.core.C4J r11, int r12) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C3659ju.A0G(com.facebook.ads.redexgen.X.4J, int):boolean");
    }
    ...
    public final void A52(C4J c4j) throws C22172i {
        A01();
        while (c4j.A07() > 0) {
            switch (this.A06) {
                case 0:
    ...
    public final void A5U(GY gy, C2664Ke c2664Ke) {
        c2664Ke.A05();
        this.A0D = c2664Ke.A04();
        this.A0C = gy.AJh(c2664Ke.A03(), 1);
        this.A0A = this.A0C;
        if (this.A0K) {
            c2664Ke.A05();
            this.A0B = gy.AJh(c2664Ke.A03(), 5);
            this.A0B.A6W(new C2D().A0y(c2664Ke.A04()).A11(A00(60, 15, 103)).A14());
            return;
        }
        this.A0B = new C3739lO();
    }
