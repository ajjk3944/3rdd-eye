...
public final class C2838Qz implements AdViewApi {
    ...
    public C2838Qz(Context context, String str, AdSize adSize, AdViewParentApi adViewParentApi, AdView adView) {
        this.A00 = -1L;
        if (adSize != null && adSize != AdSize.INTERSTITIAL) {
            ...
            NT nt = new NT(str, WV.A05(this.A0B), AdPlacementType.BANNER, WV.A04(adSize), 1, new C3504hB());
            nt.A06(this.A05);
            nt.A07(this.A06);
            this.A03 = new AnonymousClass72(this.A0A, nt);
            this.A03.A0S(new C3425fq(this));
            return;
        }
        throw new IllegalArgumentException(A01(100, 6, 115));
    }

    public C2838Qz(Context context, String str, String str2, AdViewParentApi adViewParentApi, AdView adView) throws V2 {
    ...
    public final void A0B(RelativeLayout relativeLayout, View view) {
        ...
        if (this.A06 != null && (c3248cwA01 = AbstractC3247cv.A01(this.A0A, this.A06)) != null) {
            ViewGroup.LayoutParams layoutParams = view.getLayoutParams();
            relativeLayout.addView(c3248cwA01, new RelativeLayout.LayoutParams(layoutParams.width, layoutParams.height));
        }
    }
    ...
    public final void loadAd(AdView.AdViewLoadConfig adViewLoadConfig) {
        ...
        A03(((C2921Ug) adViewLoadConfig).A00());
    }
