...
public final class C21800v extends AbstractC23467h {
    ...
    public int A03;
    public long A05;
    public List<C3900o2> A07;
    public List<C3900o2> A08;
    public boolean A09;
    public boolean A0A;
    public boolean A0B;
    ...
    static {
        ...
        A0P = new int[]{195, 227, 205, 204, 236, 210, 242, 213, 245, 123, 125, 92, 94, 95, 124, 126, 196, 228, 214, 246, Sdk$SDKError.b.STALE_CACHED_RESPONSE_VALUE, 165, 164, 9474, 197, 229, 216, 248, 9484, 9488, 9492, 9496};
    ...
    public C21800v(String str, int i, long j4) {
        this.A0F = j4 > 0 ? 1000 * j4 : -9223372036854775807L;
    ...
    private List<C3900o2> A07() {
        int iMin = 2;
        int size = this.A0H.size();
        ArrayList arrayList = new ArrayList(size);
        for (int i = 0; i < size; i++) {
            C3900o2 c3900o2A08 = this.A0H.get(i).A08(RecyclerView.UNDEFINED_DURATION);
            arrayList.add(c3900o2A08);
            if (c3900o2A08 != null) {
                int positionAnchor = c3900o2A08.A08;
                iMin = Math.min(iMin, positionAnchor);
            }
        }
        List<Cue> displayCues = new ArrayList<>(size);
        for (int i10 = 0; i10 < size; i10++) {
            C3900o2 c3900o2 = (C3900o2) arrayList.get(i10);
            if (c3900o2 != null) {
                int cueBuilderCount = c3900o2.A08;
                if (cueBuilderCount != iMin) {
                    c3900o2 = (C3900o2) C3M.A01(this.A0H.get(i10).A08(iMin));
                }
                displayCues.add(c3900o2);
            }
        }
        return displayCues;
    }
    ...
    */
    private void A0E(int r3) {
        ...
        L34:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C21800v.A0E(int):void");
    }
    ...
    @Override // com.facebook.ads.redexgen.core.AbstractC23467h
    /* renamed from: A0W */
    public final /* bridge */ /* synthetic */ C23487j A5j() throws C3687kM {
        return super.A5j();
    }

    @Override // com.facebook.ads.redexgen.core.AbstractC23467h, com.facebook.ads.redexgen.core.C5O
    /* renamed from: A0X, reason: merged with bridge method [inline-methods] */
    public final AbstractC23477i A5l() throws C3687kM {
        AbstractC23477i abstractC23477iA0Y;
        AbstractC23477i outputBuffer = super.A5l();
        if (outputBuffer != null) {
            return outputBuffer;
        }
        if (A0G() && (abstractC23477iA0Y = A0Y()) != null) {
            this.A07 = Collections.emptyList();
            this.A05 = -9223372036854775807L;
            abstractC23477iA0Y.A0C(A0V(), A0Z(), Long.MAX_VALUE);
            return abstractC23477iA0Y;
        }
        return null;
    }

    @Override // com.facebook.ads.redexgen.core.AbstractC23467h
    public final C3683kI A0Z() {
        this.A08 = this.A07;
        return new C3683kI((List) C3M.A01(this.A07));
    }

    @Override // com.facebook.ads.redexgen.core.AbstractC23467h
    /* renamed from: A0a */
    public final /* bridge */ /* synthetic */ void AGZ(C23487j c23487j) throws C3687kM {
        super.AGZ(c23487j);
    }

    @Override // com.facebook.ads.redexgen.core.AbstractC23467h
    public final void A0b(C23487j c23487j) {
        ByteBuffer subtitleData = (ByteBuffer) C3M.A01(c23487j.A02);
    ...
    @Override // com.facebook.ads.redexgen.core.AbstractC23467h, com.facebook.ads.redexgen.core.InterfaceC3688kN
    public final /* bridge */ /* synthetic */ void AIx(long j4) {
        super.AIx(j4);
    }
