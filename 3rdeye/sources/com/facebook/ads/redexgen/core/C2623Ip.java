...
public final class C2623Ip {
    ...
    public C2623Ip(C2620Im c2620Im, long[] jArr, int[] iArr, int i, long[] jArr2, int[] iArr2, long j4) {
    ...
    public final int A00(long j4) {
        for (int iA0L = AbstractC22614a.A0L(this.A07, j4, true, false); iA0L >= 0; iA0L--) {
    ...
    */
    public final int A01(long r4) {
        /*
            ...
            r0 = 0
            r2 = 1
            int r1 = com.facebook.ads.redexgen.core.AbstractC22614a.A0K(r1, r4, r2, r0)
        L8:
            long[] r0 = r3.A07
            int r0 = r0.length
            if (r1 >= r0) goto L18
        ...
        L18:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C2623Ip.A01(long):int");
    }
}
