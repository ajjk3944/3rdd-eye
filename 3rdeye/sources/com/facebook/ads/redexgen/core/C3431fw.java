...
public class C3431fw implements InterfaceC3003Xn {
    ...
    public C3431fw(R0 r02) {
        this.A00 = new WeakReference<>(r02);
    }

    private void A00(R0 r02) {
        C3248cw c3248cwA07 = r02.A07();
        if (c3248cwA07 != null && r02.A04() != null) {
            r02.A04().bringChildToFront(c3248cwA07);
        }
    }
    ...
    public void A3w(View view, int i, RelativeLayout.LayoutParams layoutParams) {
        ...
        if (r02 != null && r02.A04() != null) {
            r02.A04().addView(view, i, layoutParams);
            A00(r02);
        }
    }
    ...
    @Override // com.facebook.ads.redexgen.core.InterfaceC3003Xn
    public void A4c(String str, C2893Td c2893Td) {
        if (this.A00.get() != null) {
            this.A00.get().A0E(str, c2893Td);
        }
    }
