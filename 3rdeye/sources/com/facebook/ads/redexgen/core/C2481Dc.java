...
public class C2481Dc {
    ...
    public boolean A0A;
    public boolean A0B;
    public final C3476gi A0C;
    public final C3272dL A0D;
    public final US A0E;
    public final InterfaceC3277dQ A0F;
    public final InterfaceC3286dZ A0G;
    public final C3287da A0H;
     ...
     */
    public C2481Dc(C3272dL c3272dL, US us, InterfaceC3277dQ interfaceC3277dQ, String str, boolean z10, int i, int i10, boolean z11, Bundle bundle, Map<String, String> map, InterfaceC3286dZ interfaceC3286dZ) {
        this.A02 = 0;
        this.A01 = 0;
        this.A05 = false;
        this.A0B = false;
        ...
        this.A0D = c3272dL;
        this.A0E = us;
        this.A0F = interfaceC3277dQ;
        this.A0J = str;
        this.A0K = map;
        this.A08 = z10;
        this.A07 = z11;
        this.A0G = interfaceC3286dZ;
        ArrayList arrayList = new ArrayList();
        arrayList.add(new C2483De(this, 0.5d, -1.0d, 2.0d, true));
        arrayList.add(new C2482Dd(this, 1.0E-7d, -1.0d, 0.001d, false));
        if (bundle != null) {
            this.A0C = new C3476gi(arrayList, bundle.getBundle(A0H(6, 16, 57)), this.A0G);
            ...
            this.A02 = i;
            this.A01 = i10;
            this.A0C = new C3476gi(arrayList, this.A0G);
        }
        this.A05 = U7.A2P(this.A0D);
        this.A0B = U7.A2T(this.A0D);
        this.A0H = new C3287da(new Handler(), this);
    }
    ...
    public Map<String, String> A0J(EnumC3279dS enumC3279dS) {
        int currentPositionInMillis = this.A0F.getCurrentPositionInMillis();
        int i = this.A00 + 1;
        this.A00 = i;
        return A0K(enumC3279dS, currentPositionInMillis, i);
    }

    private Map<String, String> A0K(EnumC3279dS enumC3279dS, int i, int i10) {
        HashMap map = new HashMap();
        XM.A03(map, this.A0F.getVideoStartReason() == EnumC3288db.A02, !this.A0F.AAM());
        A0U(map);
        A0S(map);
        A0W(map, i);
        A0V(map);
        A0T(map);
        A0n(enumC3279dS, map);
        map.put(A0H(0, 6, 24), String.valueOf(enumC3279dS.A00));
    ...
    private void A0M() {
        ...
        A0R(this.A0J, A0J(EnumC3279dS.A04));
    }
    ...
    private void A0N() {
        ...
        A0R(str, A0J(EnumC3279dS.A0A));
    }

    private final void A0P(int i, boolean z10, boolean z11) {
        ...
        if (i > this.A02) {
            ...
            this.A02 = i;
            if (z11 || i - this.A01 >= 5000) {
                String str = this.A0J;
                EnumC3279dS enumC3279dS = EnumC3279dS.A09;
                int i10 = this.A00 + 1;
                this.A00 = i10;
                A0R(str, A0K(enumC3279dS, i, i10));
                this.A01 = this.A02;
                this.A0C.A05();
                return;
            }
        ...
        if (z10) {
            ...
            EnumC3279dS enumC3279dS2 = EnumC3279dS.A09;
            int i11 = this.A00 + 1;
            this.A00 = i11;
            A0R(str2, A0K(enumC3279dS2, i, i11));
        }
    }
    ...
    private void A0S(Map<String, String> params) {
        ...
        O0 o0A00 = o1A03.A00();
        params.put(A0H(226, 3, 25), String.valueOf(o0A00.A00()));
    ...
    public final void A0d() {
        ...
        A0R(this.A0J, A0J(EnumC3279dS.A07));
    }
    ...
    public final void A0e() {
        ...
        A0R(this.A0J, A0J(EnumC3279dS.A08));
    }
    ...
    public final void A0i(int i) {
        ...
        this.A0C.A04();
        A0R(this.A0J, A0J(EnumC3279dS.A05));
        if (this.A05) {
            A0P(i, false, true);
        } else {
    ...
    public final void A0m(InterfaceC3278dR interfaceC3278dR) {
        this.A03 = interfaceC3278dR;
    }

    public void A0n(EnumC3279dS enumC3279dS, Map<String, String> params) {
    }

    public final void A0o(C2481Dc c2481Dc) {
        c2481Dc.A06 = this.A06;
        c2481Dc.A07 = this.A07;
        c2481Dc.A0A = this.A0A;
        c2481Dc.A09 = this.A09;
        c2481Dc.A02 = this.A02;
        c2481Dc.A01 = this.A01;
    }
}
