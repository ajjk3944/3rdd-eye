...
public class C21961l<K, V> extends C2406Ac<K, Collection<V>> {
    ...
    public C21961l(final AbstractC21931i this$0, final Map<K, Collection<V>> subMap) {
        super(subMap);
        this.A00 = this$0;
    }

    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.1l != com.google.common.collect.AbstractMapBasedMultimap<K, V>$KeySet */
    @Override // com.facebook.ads.redexgen.core.C2406Ac, java.util.AbstractCollection, java.util.Collection, java.util.Set
    public final void clear() {
        AbstractC3858nL.A0A(iterator());
    }
    ...
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.1l != com.google.common.collect.AbstractMapBasedMultimap<K, V>$KeySet */
    @Override // com.facebook.ads.redexgen.core.C2406Ac, java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, java.util.Set
    public final Iterator<K> iterator() {
        return new C3680kF(this, A00().entrySet().iterator());
    }
    ...
    public final boolean remove(@CheckForNull Object key) {
        ...
        if (collection != null) {
            ...
            collection.clear();
            AbstractC21931i.A03(this.A00, size);
        }
        return size > 0;
    }
}
