...
public final class C8w {
    ...
    public C8w(int i, int i10, float f10, float f11, int i11) {
        this.A0H = i;
        this.A0G = i10;
        this.A0F = f10;
        this.A0D = f11;
    ...
    private int A02(short[] sArr, int i, float f10, int i10) {
        int i11;
        if (f10 < 0.5f) {
        ...
        A0C(i11, this.A0G, this.A0B, this.A05 + i10, sArr, i + i10, sArr, i);
        int newFrameCount5 = this.A05;
        this.A05 = newFrameCount5 + i10 + i11;
        return i11;
    }

    private int A03(short[] sArr, int i, float f10, int i10) {
        int newFrameCount;
        if (f10 >= 2.0f) {
    ...
    private short A05(short[] sArr, int i, int i10, int i11) {
        short s10 = sArr[i];
        short s11 = sArr[this.A0G + i];
    ...
    */
    ...
    private void A0B(int i) {
        int i10 = this.A00 - i;
        System.arraycopy(this.A0A, this.A0G * i, this.A0A, 0, this.A0G * i10);
        this.A00 = i10;
    }

    public static void A0C(int i, int i10, short[] sArr, int i11, short[] sArr2, int i12, short[] sArr3, int i13) {
        for (int i14 = 0; i14 < i10; i14++) {
            int i15 = (i11 * i10) + i14;
            int t10 = (i13 * i10) + i14;
            int d10 = (i12 * i10) + i14;
            for (int u8 = 0; u8 < i; u8++) {
                int i16 = i - u8;
                int o10 = sArr2[d10] * i16;
                int i17 = sArr3[t10] * u8;
                sArr[i15] = (short) ((o10 + i17) / i);
                i15 += i10;
                d10 += i10;
                t10 += i10;
            }
    ...
    private void A0D(short[] sArr, int i, int i10) {
        this.A0B = A0G(this.A0B, this.A05, i10);
        System.arraycopy(sArr, this.A0G * i, this.A0B, this.A05 * this.A0G, this.A0G * i10);
        this.A05 += i10;
    }

    private void A0E(short[] sArr, int i, int i10) {
        int i11 = this.A0J / i10;
        int value = this.A0G * i10;
        int frameCount = this.A0G;
        int i12 = i * frameCount;
    ...
    private boolean A0F(int i, int i10) {
        if (i == 0 || this.A08 == 0 || i10 > i * 3 || i * 2 <= this.A07 * 3) {
            return false;
        }
        return true;
    }

    private short[] A0G(short[] sArr, int i, int i10) {
    ...
    public final void A0K() {
        ...
        int i11 = i10 + ((int) ((((s10 / f10) + remainingFrameCount) / r9) + 0.5f));
        short[] sArr = this.A0A;
        int i12 = this.A00;
        int remainingFrameCount2 = this.A0J;
        this.A0A = A0G(sArr, i12, (remainingFrameCount2 * 2) + i);
    ...
    public final void A0L(ShortBuffer shortBuffer) {
        ...
        System.arraycopy(sArr2, i, sArr3, 0, i10 * framesToRead3);
    }
