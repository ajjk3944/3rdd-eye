...
public class C3771lv<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    public int A07(@CheckForNull Object key) {
        ...
        int iA02 = AbstractC3805mU.A02(key);
        int iA00 = A00();
        int iA05 = AbstractC3774ly.A05(A0C(), iA02 & iA00);
        if (iA05 == 0) {
            return -1;
        }
        int iA022 = AbstractC3774ly.A02(iA02, iA00);
        do {
            int i = iA05 - 1;
            int iA01 = A01(i);
            if (AbstractC3774ly.A02(iA01, iA00) == iA022 && BX.A01(key, A0E(i))) {
                return i;
            }
            iA05 = AbstractC3774ly.A03(iA01, iA00);
        } while (iA05 != 0);
        return -1;
    }
    ...
    public void A0n(int dstIndex, int mask) {
        ...
        iArrA0T[size] = 0;
        int iA02 = AbstractC3805mU.A02(obj) & mask;
        int iA05 = AbstractC3774ly.A05(objA0C, iA02);
        int i11 = size + 1;
        if (iA05 == i11) {
            AbstractC3774ly.A0B(objA0C, iA02, dstIndex + 1);
            return;
        }
        do {
            i = iA05 - 1;
            i10 = iArrA0T[i];
            iA05 = AbstractC3774ly.A03(i10, mask);
        } while (iA05 != i11);
        int iA04 = AbstractC3774ly.A04(i10, dstIndex + 1, mask);
    ...
    public final V put(@ParametricNullness K k10, @ParametricNullness V v10) {
        ...
        int i11 = this.A04;
        int i12 = i11 + 1;
        int iA02 = AbstractC3805mU.A02(k10);
        int iA00 = A00();
        int i13 = iA02 & iA00;
        int iA05 = AbstractC3774ly.A05(A0C(), i13);
        if (iA05 != 0) {
            int iA022 = AbstractC3774ly.A02(iA02, iA00);
            int i14 = 0;
            do {
                i = iA05 - 1;
                i10 = iArrA0T[i];
                if (AbstractC3774ly.A02(i10, iA00) == iA022 && BX.A01(k10, objArrA0V[i])) {
                    V v11 = (V) objArrA0W[i];
                    objArrA0W[i] = v10;
                    A0k(i);
                    return v11;
                }
                iA05 = AbstractC3774ly.A03(i10, iA00);
                i14++;
            } while (iA05 != 0);
            if (i14 >= 9) {
            ...
            if (i12 > iA00) {
                iA00 = A02(iA00, AbstractC3774ly.A00(iA00), iA02, i11);
            } else {
                iArrA0T[i] = AbstractC3774ly.A04(i10, i11 + 1, iA00);
            }
        } else {
            if (i12 <= iA00) {
                AbstractC3774ly.A0B(A0C(), i13, i11 + 1);
                String[] strArr = A0A;
                if (strArr[0].length() != strArr[1].length()) {
    ...
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.lv != com.google.common.collect.CompactHashMap<K, V> */
    public C3771lv(int expectedSize) {
        A0l(expectedSize);
    }
    ...
    private int A02(int oldMask, int newCapacity, int targetHash, int targetEntryIndex) {
        Object objA07 = AbstractC3774ly.A07(newCapacity);
        int hash = newCapacity - 1;
        if (targetEntryIndex != 0) {
            AbstractC3774ly.A0B(objA07, targetHash & hash, targetEntryIndex + 1);
        }
        Object objA0C = A0C();
        int[] iArrA0T = A0T();
        for (int oldTableIndex = 0; oldTableIndex <= oldMask; oldTableIndex++) {
            int iA05 = AbstractC3774ly.A05(objA0C, oldTableIndex);
            while (iA05 != 0) {
                int i = iA05 - 1;
                int newMask = iArrA0T[i];
                int iA02 = AbstractC3774ly.A02(newMask, oldMask) | oldTableIndex;
                int i10 = iA02 & hash;
                int iA052 = AbstractC3774ly.A05(objA07, i10);
                AbstractC3774ly.A0B(objA07, i10, iA05);
                iArrA0T[i] = AbstractC3774ly.A04(iA02, iA052, hash);
                iA05 = AbstractC3774ly.A03(newMask, oldMask);
            }
        }
        this.A05 = objA07;
        A0O(hash);
    ...
    public static /* synthetic */ int A04(C3771lv c3771lv) {
        int i = c3771lv.A04;
        c3771lv.A04 = i - 1;
        return i;
    }
    ...
    private final Set<Map.Entry<K, V>> A08() {
        return new C3767lr(this);
    }

    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.lv != com.google.common.collect.CompactHashMap<K, V> */
    private final Set<K> A09() {
        return new C3769lt(this);
    }

    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.lv != com.google.common.collect.CompactHashMap<K, V> */
    private final Collection<V> A0A() {
        return new C3770lu(this);
    }

    public static <K, V> C3771lv<K, V> A0B(int expectedSize) {
        return new C3771lv<>(expectedSize);
    }
    ...
    public Object A0K(@CheckForNull Object key) {
        ...
        int iA00 = A00();
        int iA06 = AbstractC3774ly.A06(key, null, iA00, A0C(), A0T(), A0V(), null);
        if (iA06 == -1) {
            Object obj = A0B;
            String[] strArr = A0A;
            String str = strArr[7];
    ...
    private void A0O(int mask) {
        int hashTableBits = AbstractC3774ly.A04(this.A03, 32 - Integer.numberOfLeadingZeros(mask), 31);
    ...
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.lv != com.google.common.collect.CompactHashMap<K, V> */
    public int A0Z() {
        AbstractC3614jA.A0F(A0p(), A0L(0, 24, 121));
        int i = this.A03;
        int buckets = AbstractC3774ly.A01(i);
        this.A05 = AbstractC3774ly.A07(buckets);
    ...
    public void A0l(int expectedSize) {
        AbstractC3614jA.A0E(expectedSize >= 0, A0L(24, 26, 16));
    ...
    public void A0o(@ParametricNullness int entryIndex, @ParametricNullness K key, V value, int hash, int mask) {
        A0P(entryIndex, AbstractC3774ly.A04(hash, 0, mask));
        A0Q(entryIndex, key);
    ...
    private void writeObject(ObjectOutputStream stream) throws IOException {
        ...
        while (true) {
            ...
            if (zHasNext) {
                Map.Entry<K, V> e4 = itA0d.next();
                stream.writeObject(e4.getKey());
                stream.writeObject(e4.getValue());
            } else {
                return;
            }
        }
