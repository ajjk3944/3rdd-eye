...
public final class T5 {
    ...
    public static void A09(Context context) {
        ...
        ((ActivityManager) AbstractC3449gF.A00((ActivityManager) context.getSystemService(A01(16, 8, 108)))).getMemoryInfo(memoryInfo);
    ...
    public static void A0A(SQ sq) {
        try {
            ...
            sq.A08().AAy(A01(102, 7, 96), AbstractC2885Sv.A1T, new C2886Sw(e4));
        }
    }
    ...
    public static void A0C(Map<String, String> map) {
        ...
        if (fArr2 != null) {
            ...
            for (int i10 = 0; i10 < iMin2; i10++) {
                map.put(A01(114, 9, 19) + A08[i10], String.valueOf(fArr2[i10]));
            }
        }
    }
}
