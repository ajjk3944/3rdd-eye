...
public final class C2931Uq implements NativeAdRatingApi {
    ...
    public C2931Uq(double d10, double d11) {
        this.A01 = d10;
        this.A00 = d11;
    }

    public static C2931Uq A00(JSONObject jSONObject) {
        if (jSONObject == null) {
            return null;
        }
        ...
        return new C2931Uq(dOptDouble, dOptDouble2);
    }
