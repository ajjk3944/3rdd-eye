...
public final class C3573iS implements MP, NG {
    ...
    private int A00() {
        ...
        EnumC3061Zt enumC3061ZtA02 = A02();
        if (enumC3061ZtA02 == EnumC3061Zt.A05) {
            String[] strArr = A0C;
            String str = strArr[4];
        ...
        } else if (enumC3061ZtA02 == EnumC3061Zt.A03) {
            switch (rotation) {
                case 2:
                case 3:
    ...
    private final EnumC2942Vb A01() {
        return this.A04.A0E();
    }

    private EnumC3061Zt A02() {
        return this.A04.A0F();
    }
    ...
    private void A06(Intent intent) {
        this.A04.A0I(intent, this.A01, C3269dI.A03(this.A01, this.A0A, this.A06));
    }

    private final void A07(C3272dL c3272dL, InterfaceC2712Ma interfaceC2712Ma, NU nu, EnumSet<CacheFlag> cacheFlags, String str) {
        NH nh = new NH(c3272dL, nu, this, str);
        AbstractC2725Mo abstractC2725MoA0D = nh.A0D();
        if (U7.A0v(c3272dL) && (abstractC2725MoA0D instanceof AbstractC3547hy) && ML.A06(this.A05, ML.A01(c3272dL, nu.A03(), ((AbstractC3547hy) abstractC2725MoA0D).A25()), c3272dL.A0A())) {
            this.A05.A0F().A4u();
            this.A02.ADc(this, AdError.NO_FILL);
        } else {
            this.A04 = nh;
            A08(nh.A0E());
            nh.A0J(c3272dL, cacheFlags);
        }
    }

    private void A08(EnumC2942Vb enumC2942Vb) {
        if (enumC2942Vb.equals(EnumC2942Vb.A04)) {
            this.A05.A0F().AJ9(LT.A05);
            return;
        }
        if (enumC2942Vb.equals(EnumC2942Vb.A0A)) {
            this.A05.A0F().AJ9(LT.A04);
            return;
        }
        if (enumC2942Vb.equals(EnumC2942Vb.A0B)) {
            this.A05.A0F().AJ9(LT.A0B);
            return;
        }
        if (enumC2942Vb.equals(EnumC2942Vb.A0D)) {
            this.A05.A0F().AJ9(LT.A0D);
            return;
        }
        if (enumC2942Vb.equals(EnumC2942Vb.A0C)) {
            this.A05.A0F().AJ9(LT.A0C);
            return;
        }
        if (!enumC2942Vb.equals(EnumC2942Vb.A06)) {
            return;
        }
        if (this.A04.A0K()) {
        ...
        if ((A09() instanceof AbstractC3547hy) && this.A04.A0L((AbstractC3547hy) A09())) {
    ...
    public final AbstractC2725Mo A09() {
        return this.A04.A0D();
    }

    public final void A0A(C3272dL c3272dL, InterfaceC2712Ma interfaceC2712Ma, NU nu, EnumSet<CacheFlag> enumSet, String str, String str2, RewardData rewardData) {
        this.A05 = c3272dL;
        this.A02 = interfaceC2712Ma;
        this.A08 = nu.A02();
        this.A06 = this.A08 != null ? this.A08.split(A03(107, 1, 22))[0] : A03(0, 0, 85);
        this.A00 = nu.A00();
        this.A07 = str2;
        this.A01 = rewardData;
        A07(c3272dL, interfaceC2712Ma, nu, enumSet, str);
    }
    ...
    public final boolean A0B() {
        ...
        EnumC2942Vb enumC2942VbA01 = A01();
        A08(enumC2942VbA01);
        adActivityIntentA05.putExtra(A03(186, 8, 88), enumC2942VbA01);
        if (this.A07 != null) {
        ...
        try {
            ...
            this.A05.A08().AAy(A03(108, 11, 27), AbstractC2885Sv.A0D, new C2886Sw(cause2));
    ...
    public final void AGo() {
        this.A03 = new C2713Mb(this.A05, this.A0A, this, this.A02);
        this.A03.A02();
    }
