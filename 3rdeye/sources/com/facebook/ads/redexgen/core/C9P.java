...
public class C9P {
    ...
    public C9P(CopyOnWriteArrayList<DrmSessionEventListener.EventDispatcher.ListenerAndHandler> listenerAndHandlers, int i, C3796mL c3796mL) {
        this.A02 = listenerAndHandlers;
        this.A00 = i;
        this.A01 = c3796mL;
    }

    public final C9P A00(int i, C3796mL c3796mL) {
        return new C9P(this.A02, i, c3796mL);
    }
}
