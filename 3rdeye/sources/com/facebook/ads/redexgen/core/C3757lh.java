...
public final class C3757lh implements EO {
    public int A00;
    public int A01;
    public int A02;
    public EM[] A03;
    ...
    public C3757lh(boolean z10, int i) {
        this(z10, i, 0);
    }

    public C3757lh(boolean z10, int i, int i10) {
        C3M.A07(i > 0);
        C3M.A07(i10 >= 0);
        this.A05 = z10;
        this.A04 = i;
        this.A01 = i10;
        this.A03 = new EM[i10 + 100];
        if (i10 > 0) {
            this.A06 = new byte[i10 * i];
            for (int i11 = 0; i11 < i10; i11++) {
                this.A03[i11] = new EM(this.A06, i11 * i);
            }
            return;
        }
        this.A06 = null;
    ...
    public final synchronized void AJi() {
        int iA05 = AbstractC22614a.A05(this.A02, this.A04);
