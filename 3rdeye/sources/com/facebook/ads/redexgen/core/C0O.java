...
public final class C0O extends AnonymousClass14 {
     ...
     */
    public static Point A07(AR ar, C3949or c3949or) throws C2425Av {
        boolean z10 = c3949or.A0A > c3949or.A0L;
        int i = z10 ? c3949or.A0A : c3949or.A0L;
        int i10 = z10 ? c3949or.A0L : c3949or.A0A;
        float f10 = i10 / i;
        for (int i11 : A13) {
            int i12 = (int) (i11 * f10);
            if (i11 <= i || i12 <= i10) {
            ...
            if (AbstractC22614a.A02 >= 21) {
                ...
                Point pointA0N = ar.A0N(i13, i11);
                if (ar.A0R(pointA0N.x, pointA0N.y, c3949or.A01)) {
                    return pointA0N;
                }
            } else {
                int iA05 = AbstractC22614a.A05(i11, 16) * 16;
                int iA052 = AbstractC22614a.A05(i12, 16) * 16;
                if (iA05 * iA052 <= C2428Ay.A00()) {
                    int i14 = z10 ? iA052 : iA05;
                    if (!z10) {
                        iA05 = iA052;
                    }
    ...
    public static String A0B(int i, int i10, int i11) {
        byte[] bArrCopyOfRange = Arrays.copyOfRange(A11, i, i + i10);
    ...
    public C0O(Context context, C3544hv c3544hv, MediaCodecRendererMetaParameters mediaCodecRendererMetaParameters, InterfaceC2421Ar interfaceC2421Ar, long j4, C9U c9u, boolean z10, boolean z11, Handler handler, InterfaceC2545Fo interfaceC2545Fo, int i, int i10, int i11, int i12, int i13) {
        super(2, c3544hv, mediaCodecRendererMetaParameters, interfaceC2421Ar, c9u, z10, z11, i11, i12);
        this.A0e = true;
        this.A0Z = true;
        boolean z12 = false;
        this.A0f = false;
        ...
        this.A0c = false;
        this.A0h = false;
        this.A0w = MetaExoPlayerUpgradeConfig.A03(EnumC3548i2.A1r);
        this.A0h = MetaExoPlayerUpgradeConfig.A03(EnumC3548i2.A0w);
        this.A0p = j4;
        this.A0l = i;
        this.A0m = i10;
        ...
        this.A0u = new C2544Fn(handler, interfaceC2545Fo);
        this.A0r = new FC(this.A0s, this, this.A0w);
        this.A0v = A0i();
        if (AbstractC22614a.A02 == 29 && AbstractC22614a.A06.startsWith(A0B(811, 6, 62))) {
            z12 = true;
        }
        this.A0a = z12;
    ...
    private int A00(C3949or c3949or) {
        if (c3949or.A0B != -1) {
            int i = 0;
            int i10 = c3949or.A0X.size();
            for (int initializationDataCount = 0; initializationDataCount < i10; initializationDataCount++) {
                int totalInitializationDataSize = c3949or.A0X.get(initializationDataCount).length;
                i += totalInitializationDataSize;
            }
            int totalInitializationDataSize2 = c3949or.A0B;
            return totalInitializationDataSize2 + i;
        }
        int i11 = c3949or.A0L;
        String str = c3949or.A0W;
        int width = c3949or.A0A;
    ...
    */
    public static int A01(com.facebook.ads.redexgen.core.InterfaceC2421Ar r8, com.facebook.ads.redexgen.core.C3949or r9, boolean r10) throws com.facebook.ads.redexgen.core.C2425Av {
        /*
    ...
    */
    ...
    public long A03(long j4, long j10, long j11, long j12, boolean z10) {
        double playbackSpeed = A1f();
        long j13 = (long) ((j12 - j4) / playbackSpeed);
        if (z10) {
            return j13 - (j11 - j10);
        }
        return j13;
    ...
    private final MediaFormat A08(C3949or c3949or, FA fa2, boolean z10, int i) {
        MediaFormat mediaFormat = new MediaFormat();
        mediaFormat.setString(A0B(1462, 4, 83), c3949or.A0W);
        mediaFormat.setInteger(A0B(1755, 5, 79), c3949or.A0L);
        mediaFormat.setInteger(A0B(1307, 6, 73), c3949or.A0A);
        AnonymousClass46.A06(mediaFormat, c3949or.A0X);
        AnonymousClass46.A03(mediaFormat, A0B(1286, 10, 109), c3949or.A01);
        AnonymousClass46.A04(mediaFormat, A0B(1548, 16, 7), c3949or.A0F);
        AnonymousClass46.A02(mediaFormat, c3949or.A0N);
        ...
        AbstractC3526hY.A03(this.A11, mediaFormat);
        if (i != 0) {
            A0T(mediaFormat, i);
        }
        return mediaFormat;
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    private final com.facebook.ads.redexgen.core.FA A0A(com.facebook.ads.redexgen.core.AR r12, com.facebook.ads.redexgen.core.C3949or r13, com.facebook.ads.redexgen.core.C3949or[] r14) throws com.facebook.ads.redexgen.core.C2425Av {
        /*
            r11 = this;
            int r5 = r13.A0L
            int r4 = r13.A0A
    ...
    public static List<AR> A0C(InterfaceC2421Ar interfaceC2421Ar, C3949or c3949or) throws C2425Av {
        ArrayList arrayList = new ArrayList();
        String alternativeMimeType = C2428Ay.A0P(c3949or);
        if (alternativeMimeType != null) {
            List<AR> listA7g = interfaceC2421Ar.A7g(alternativeMimeType, false, false);
            if (AbstractC22614a.A02 >= 26) {
                if (A0B(1664, 18, 7).equals(c3949or.A0W) && !listA7g.isEmpty()) {
                    return listA7g;
                }
                return arrayList;
            }
    ...
    public static List<AR> A0D(InterfaceC2421Ar interfaceC2421Ar, C3949or c3949or, boolean z10) throws C2425Av {
        String str = c3949or.A0W;
        if (str == null) {
            return Collections.emptyList();
        }
        return Collections.unmodifiableList(interfaceC2421Ar.A7g(str, z10, false));
    }

    private void A0E() {
        AO aoA1j;
        this.A0i = false;
        if (AbstractC22614a.A02 >= 23 && this.A0k && (aoA1j = A1j()) != null) {
            this.A00 = new C3750la(this, aoA1j);
        }
    }
    ...
    private void A0G() {
        if (this.A0r.A0G() && MetaExoPlayerUpgradeConfig.A03(EnumC3548i2.A1p)) {
            this.A0r.A0A();
            throw null;
        }
    }
    ...
    private void A0K() {
        ...
        if (this.A0G != this.A08 || this.A0E != this.A06 || this.A0F != this.A07 || this.A03 != this.A01) {
            this.A0u.A07(new C3902o4(this.A08, this.A06, this.A07, this.A01));
            this.A0G = this.A08;
            this.A0E = this.A06;
            this.A0F = this.A07;
            this.A03 = this.A01;
    ...
    private void A0M() {
        if (this.A0G != -1 || this.A0E != -1) {
            this.A0u.A07(new C3902o4(this.A0G, this.A0E, this.A0F, this.A03));
        }
    }
    ...
    */
    private final void A0R(long r10, long r12, float r14) {
        /*
            r9 = this;
            long r0 = com.facebook.ads.redexgen.core.AbstractC22071w.A01(r10)
            int r6 = (int) r0
            long r0 = com.facebook.ads.redexgen.core.AbstractC22071w.A01(r12)
            int r5 = (int) r0
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void A0S(long j4, long j10, C3949or c3949or, MediaFormat mediaFormat) {
        if (this.A0X != null) {
            this.A0X.AFi(j4, j10, c3949or, mediaFormat);
        }
    }
    ...
    */
    ...
    private void A0V(C3949or c3949or) {
        AO codec = A1j();
        if (codec != null && c3949or != null) {
            Pair<Long, Integer> pairA8b = codec.A8b();
            if (((Long) pairA8b.first).longValue() > 0) {
                super.A0j.A04(pairA8b);
                C2544Fn c2544Fn = this.A0u;
                if (A12[2].charAt(6) == 'n') {
                    throw new RuntimeException();
                }
                A12[3] = "UGSzGWhN7NgjOmIm99IkQUILfPM9Cd";
                c2544Fn.A04(super.A0j.A00, c3949or);
            }
        }
    }

    private final void A0W(AO ao, int i, long j4) {
    ...
    @MetaExoPlayerCustomization("D36797879: Adding implementation for calculating avg render time")
    private final void A0X(AO ao, int i, long j4) {
        if (this.A0w) {
            A0Y(ao, i, j4);
            return;
        }
        ...
        try {
            ...
            super.A0h = j10 + (startRenderTime - jElapsedRealtime);
    ...
    @MetaExoPlayerCustomization("D36797879: Adding implementation for calculating avg render time")
    private final void A0Y(AO ao, int i, long j4) {
        C4S.A02(A0B(1529, 19, 51));
        long jElapsedRealtime = SystemClock.elapsedRealtime();
        ao.AGy(i, true);
        long j10 = super.A0h;
    ...
    private final void A0Z(AO ao, int i, long j4) {
    ...
    @MetaExoPlayerCustomization("D36797879: Adding implementation for calculating avg render time")
    private final void A0a(AO ao, int i, long j4, long j10) {
        if (this.A0w) {
            A0c(ao, i, j4, j10, true);
            return;
        }
        A0K();
        A0S(j4, j10, super.A0i, this.A0S);
        try {
            C4S.A02(A0B(1529, 19, 51));
            long jElapsedRealtime = SystemClock.elapsedRealtime();
            ao.AGx(i, j10);
    ...
    private final void A0b(@MetaExoPlayerCustomization AO ao, int i, long j4, long j10, boolean z10) {
        if (this.A0w) {
            A0c(ao, i, j4, j10, z10);
            return;
        }
    ...
    */
    ...
    public static boolean A0h() {
        return AbstractC22614a.A02 >= 21;
    }

    public static boolean A0i() {
        return AbstractC22614a.A02 <= 22 && A0B(1280, 6, 87).equals(AbstractC22614a.A03) && A0B(725, 6, 88).equals(AbstractC22614a.A05);
    }

    public static boolean A0k(long j4) {
        return j4 < -30000;
    }

    public static boolean A0l(long j4) {
        return j4 < -500000;
    }
    ...
    */
    ...
    private final boolean A0n(long j4, long j10) {
        return A0l(j4);
    }

    private final boolean A0o(long j4, long j10) {
        return A0k(j4);
    }

    private final boolean A0p(long j4, long j10) {
        return A0k(j4) && j10 > 100000;
    }

    private final boolean A0q(AO ao, int i, long j4, long j10) throws C9Y {
        int iA1Q = A1Q(j10);
        if (iA1Q == 0) {
            return false;
        }
        C22935g c22935g = super.A0j;
        int droppedSourceBufferCount = c22935g.A06;
        c22935g.A06 = droppedSourceBufferCount + 1;
    ...
    private boolean A0r(AR ar) {
        return AbstractC22614a.A02 >= 23 && this.A0e && !this.A0k && !A0u(ar.A03) && (!ar.A06 || DummySurface.A05(this.A0q));
    }
    ...
    */
    ...
    public static boolean A0v(boolean z10, C3949or c3949or, C3949or c3949or2) {
        return c3949or.A0W.equals(c3949or2.A0W) && c3949or.A0F == c3949or2.A0F && (z10 || (c3949or.A0L == c3949or2.A0L && c3949or.A0A == c3949or2.A0A)) && AbstractC22614a.A1E(c3949or.A0N, c3949or2.A0N);
    }
    ...
    @Override // com.facebook.ads.redexgen.core.AnonymousClass14, com.facebook.ads.redexgen.core.C9Z
    public final void A1c(C3949or[] c3949orArr, long j4, long j10) throws C9Y {
    ...
    public final int A1g(AO ao, AR ar, C3949or c3949or, C3949or c3949or2) {
        if (AbstractC3526hY.A04(this.A11, c3949or.A0L, c3949or.A0A, c3949or2.A0L, c3949or2.A0A)) {
            return 0;
        }
        if (A21() && c3949or.A0W.equals(c3949or2.A0W) && c3949or.A0F == c3949or2.A0F) {
            return 1;
        }
        if (!A0v(ar.A04, c3949or, c3949or2) || c3949or2.A0L > this.A0W.A02 || c3949or2.A0A > this.A0W.A00 || A00(c3949or2) > this.A0W.A01) {
            return 0;
        }
        boolean zA0A = c3949or.A0A(c3949or2);
        if (A12[2].charAt(6) == 'n') {
            throw new RuntimeException();
        }
    ...
    @Override // com.facebook.ads.redexgen.core.AnonymousClass14
    public final int A1h(InterfaceC2421Ar interfaceC2421Ar, C9U c9u, C3949or c3949or) throws C2425Av {
        if (A24(c3949or)) {
            return 20;
        }
        return A01(interfaceC2421Ar, c3949or, super.A0l);
    }

    @Override // com.facebook.ads.redexgen.core.AnonymousClass14
    public final List<AR> A1l(InterfaceC2421Ar interfaceC2421Ar, C3949or c3949or, boolean z10) throws C2425Av {
        return A0D(interfaceC2421Ar, c3949or, z10);
    }
    ...
    @Override // com.facebook.ads.redexgen.core.AnonymousClass14
    public final void A1q(long j4) {
        super.A1q(j4);
        this.A04--;
        while (this.A0C != 0 && j4 >= this.A0y[0]) {
            this.A0R = this.A0x[0];
            this.A0C--;
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final void A1r(com.facebook.ads.redexgen.core.C3949or r6) {
        /*
            r5 = this;
        ...
        L53:
            ...
            throw r0
        L59:
            com.facebook.ads.redexgen.X.i3 r0 = com.facebook.ads.redexgen.core.EnumC3549i3.A09
    ...
    public final void A1s(C3949or c3949or) throws C9Y {
        super.A1s(c3949or);
        this.A0u.A05(c3949or, null);
        this.A02 = c3949or.A02;
        this.A0D = c3949or.A0F;
    }

    @Override // com.facebook.ads.redexgen.core.AnonymousClass14
    public final void A1t(C3949or c3949or) throws C9Y {
        if (!this.A0r.A0G()) {
            this.A0r.A0J(c3949or, A1i());
        }
    }
    ...
    public final void A1u(C3871nY c3871nY) {
        this.A04++;
        this.A0O = Math.max(c3871nY.A01, this.A0O);
        if (AbstractC22614a.A02 < 23 && this.A0k) {
            A27();
        }
    }
    ...
    public final void A1v(AO ao, MediaFormat mediaFormat) {
        ...
        this.A0V = new C3902o4(this.A08, this.A06, this.A07, this.A01);
    ...
    public final void A1w(AR ar, AO ao, C3949or c3949or, MediaCrypto mediaCrypto) throws C2425Av {
        this.A0W = A0A(ar, c3949or, A1e());
        MediaFormat mediaFormatA08 = A08(c3949or, this.A0W, this.A0v, this.A0o);
        if (this.A0U == null) {
            C3M.A08(A0r(ar));
            if (this.A0T == null) {
        ...
        if ((AbstractC22614a.A02 >= 30 || this.A11.A0I) && z13 && !z12) {
    ...
    public final void A1z(String str, C3949or c3949or) throws C9Y {
        this.A0u.A0F(str);
        if (!this.A0r.A0G()) {
            this.A0r.A0J(c3949or, A1i());
        }
    ...
    */
    ...
    public final boolean A28(long j4, long j10, boolean z10) {
        return A0k(j4) && !z10;
    }
    ...
    */
    public final boolean AAV() {
        ...
        L14:
            ...
            boolean r0 = r9.A0k
            if (r0 != 0) goto L22
            com.facebook.ads.redexgen.X.hX r0 = com.facebook.ads.redexgen.core.EnumC3525hX.A08
            r9.A0B = r0
        L22:
            boolean r0 = super.AAV()
            r8 = 1
    ...
    @Override // com.facebook.ads.redexgen.core.AnonymousClass14, com.facebook.ads.redexgen.core.InterfaceC3859nM
    public final void AHn(long j4, long j10) throws C9Y {
        super.AHn(j4, j10);
        if (this.A0r.A0G()) {
            this.A0r.A0B(j4, j10);
        }
