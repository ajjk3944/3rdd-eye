...
public final class C3400fR {
    ...
    public final InterfaceC2848Rj A00;
    public final SF A01;
    ...
    static {
        A02();
        A04 = C3400fR.class.getSimpleName();
    }

    public C3400fR(InterfaceC2848Rj interfaceC2848Rj, C3246cu c3246cu) {
        this.A00 = interfaceC2848Rj;
        this.A00.A3s(new C3402fT(this));
        this.A01 = new SF(c3246cu);
        A01();
    }
    ...
    public void A01() {
        if (BuildConfigApi.isDebug()) {
            ...
            InterfaceC2848Rj interfaceC2848Rj = this.A00;
            if (A03[2].charAt(7) != 'V') {
            ...
            String.format(locale, A00(0, 20, 44), Integer.valueOf(interfaceC2848Rj.A6p().size()));
        }
        for (InterfaceC2851Rm interfaceC2851Rm : this.A00.A6p()) {
            switch (C2847Ri.A00[interfaceC2851Rm.A9G().ordinal()]) {
                case 1:
                    A04(interfaceC2851Rm.getUrl());
                    break;
                case 2:
                    A06(interfaceC2851Rm.getUrl());
                    break;
                case 3:
                    A05(interfaceC2851Rm.getUrl());
                    break;
            }
        }
        this.A01.A0X(new C3401fS(this), new S8(A00(81, 36, 123), A00(125, 7, 50)));
    }
