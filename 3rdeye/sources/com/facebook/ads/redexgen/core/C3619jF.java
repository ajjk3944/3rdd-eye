...
public final class C3619jF implements L9 {
    ...
    static {
        A04();
        A07 = C3619jF.class.getSimpleName();
    }

    public C3619jF(String str) {
        this(str, L7.A01(str));
    }

    public C3619jF(String str, int i) {
        this(str);
        this.A00 = i;
    }

    public C3619jF(String str, String str2) {
    ...
    private int A00(HttpURLConnection httpURLConnection, int i, int i10) throws IOException {
        int contentLength = httpURLConnection.getContentLength();
        return i10 == 200 ? contentLength : i10 == 206 ? contentLength + i : this.A05;
    }
    ...
    */
    private java.net.HttpURLConnection A02(int r9, int r10) throws java.io.IOException, com.facebook.ads.redexgen.core.C3623jJ {
        /*
            Method dump skipped, instructions count: 295
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C3619jF.A02(int, int):java.net.HttpURLConnection");
    }

    private void A03() throws IOException, C3623jJ {
        String str = A01(KotlinVersion.MAX_COMPONENT_VALUE, 23, 59) + this.A03;
        ...
        try {
            try {
                ...
                Log.e(A07, A01(129, 25, 84) + this.A03, e4);
                L7.A05(inputStream);
    ...
    private final void A05(int i, int i10) throws C3623jJ {
        try {
            this.A02 = A02(i, i10);
            ...
            throw new C3623jJ(A01(154, 29, 90) + this.A03 + A01(19, 13, 66) + i, e4);
        }
    }
    ...
    public final void close() throws C3623jJ {
        if (this.A02 != null) {
            try {
                ...
                throw new C3623jJ(A01(92, 37, 89), e4);
            }
        }
    }

    @Override // com.facebook.ads.redexgen.core.L9
    public final synchronized int length() throws C3623jJ {
    ...
    public final int read(byte[] bArr) throws C3623jJ {
        ...
        if (inputStream != null) {
            try {
                ...
                throw new C3623jJ(str, e4) { // from class: com.facebook.ads.redexgen.X.7e
                };
            } catch (IOException e10) {
                throw new C3623jJ(strA01 + this.A03, e10);
            }
        }
        throw new C3623jJ(strA01 + this.A03 + A01(51, 23, 42));
    }
