...
public final class O2 {
            ...
            if (!str.equals(A02(350, 2, 45))) {
                ...
                try {
                    ...
                    if (A04(jSONObject.getString(A02(670, 17, 10))).size() == 0) {
                        A08(AbstractC2885Sv.A28, new C2886Sw(A02(239, 20, 107)));
                        return null;
                    }
                    if (A04(jSONObject.getString(A02(503, 15, 8))).size() == 0) {
                        A08(AbstractC2885Sv.A25, new C2886Sw(A02(221, 18, 45)));
                        return null;
                    }
                    return map;
                } catch (JSONException e4) {
                    A08(AbstractC2885Sv.A27, new C2886Sw(e4));
                    return null;
                }
            }
        }
    ...
    private final void A07() {
        C3474gg c3474ggA6A = this.A00.A6A();
        c3474ggA6A.A00(A02(518, 22, 15), 0L);
        c3474ggA6A.A02();
    }

    public static void A08(int i, C2886Sw c2886Sw) {
        C3246cu sdkContext = SP.A00();
        if (sdkContext != null) {
            sdkContext.A08().AAy(A02(687, 9, 19), i, c2886Sw);
        }
    }
    ...
    public final O6 A0A() {
        ...
        try {
            ...
            A07();
            A08(AbstractC2885Sv.A26, new C2886Sw(e4));
        }
        return o62;
    }
    ...
    public final O6 A0B() {
        ...
        try {
            ...
            A07();
            A08(AbstractC2885Sv.A29, new C2886Sw(e4));
        }
        return o62;
    }
    ...
    public final void A0N(String str) {
        ...
        C3474gg c3474ggA6A = this.A00.A6A();
        for (String str2 : A03) {
            c3474ggA6A.A01(str2, mapA05.get(str2));
        }
        if (A02[1].length() == 0) {
            throw new RuntimeException();
        }
        ...
        strArr[5] = "LB7njF";
        c3474ggA6A.A00(A02(518, 22, 15), System.currentTimeMillis());
        c3474ggA6A.A02();
    }
