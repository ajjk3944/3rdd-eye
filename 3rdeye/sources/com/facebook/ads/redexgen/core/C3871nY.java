...
public class C3871nY extends C5I {
    ...
    public C3871nY(int i) {
        this(i, 0);
    }

    public C3871nY(int i, int i10) {
        this.A05 = new C5N();
        this.A06 = i;
        this.A07 = i10;
    }

    public static C3871nY A02() {
        return new C3871nY(0);
    }
    ...
    private ByteBuffer A04(final int i) {
        if (this.A06 == 1) {
            ...
            if (A09[2].length() != 11) {
                ...
                throw new IllegalStateException(iCapacity, i) { // from class: com.facebook.ads.redexgen.X.5R
