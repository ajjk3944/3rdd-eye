...
public final class C2772Ol {
    ...
    public final void A03(int i) {
        ...
        if (viewParentA00 != null) {
            PJ.A02(viewParentA00, this.A04, i);
            A01(i, null);
        }
    }
    ...
    public final boolean A0B(int i, int i10) {
        ...
        if (A06()) {
            ...
            for (ViewParent parent = this.A04.getParent(); parent != null; parent = parent.getParent()) {
                if (PJ.A08(parent, view, this.A04, i, i10)) {
                    A01(i10, parent);
                    PJ.A05(parent, view, this.A04, i, i10);
                    return true;
                }
    ...
    public final boolean A0C(int i, int i10, int i11, int i12, int[] iArr) {
        return A0D(i, i10, i11, i12, iArr, 0);
    }

    public final boolean A0D(int i, int i10, int startX, int startY, int[] iArr, int i11) {
        ViewParent viewParentA00;
        if (!A06() || (viewParentA00 = A00(i11)) == null) {
            return false;
        }
        if (i != 0 || i10 != 0 || startX != 0 || startY != 0) {
            int i12 = 0;
            int startY2 = 0;
            if (iArr != null) {
            ...
            PJ.A03(viewParentA00, view, i, i10, startX, startY, i11);
            if (iArr != null) {
                this.A04.getLocationInWindow(iArr);
                iArr[0] = iArr[0] - i12;
    ...
    public final boolean A0E(int i, int i10, int[] iArr, int[] iArr2) {
        return A0F(i, i10, iArr, iArr2, 0);
    }
