...
public final class C2987Wx {
    ...
    public C2987Wx(long j4) {
        if (j4 < 0) {
            throw new IllegalArgumentException(String.format(Locale.US, A00(0, 47, 115), Long.valueOf(j4)));
        }
        this.A01 = j4;
        this.A00 = System.nanoTime() + j4;
    }
