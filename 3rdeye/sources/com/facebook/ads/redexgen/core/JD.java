...
public final class JD {
    ...
    */
    ...
    public static int A00(int i, int i10, int i11) {
        return A01(i, i10, i11, 0);
    }

    public static int A01(int i, int i10, int i11, int i12) {
        int i13;
        C3M.A00(i, 0, 4);
        C3M.A00(i10, 0, 4);
        C3M.A00(i11, 0, 4);
        ...
        int alpha = i > 1 ? KotlinVersion.MAX_COMPONENT_VALUE : 0;
        return Color.argb(i13, alpha, i10 > 1 ? KotlinVersion.MAX_COMPONENT_VALUE : 0, i11 > 1 ? KotlinVersion.MAX_COMPONENT_VALUE : 0);
    }
    ...
    public final void A0C(int i, int i10, int i11, boolean z10, boolean z11, int i12, int i13) {
        if (this.A06 != -1) {
            if (!z10) {
    ...
    public final void A0D(int i, int i10, boolean z10, int i11, int i12, int i13, int i14) {
        this.A0E = i;
        this.A07 = i14;
    }
    ...
    public final void A0F(boolean z10, boolean z11, boolean z12, int i, boolean z13, int i10, int i11, int i12, int i13, int i14, int i15, int i16) {
        this.A0G = true;
        this.A0J = z10;
        this.A0I = z11;
        this.A09 = i;
