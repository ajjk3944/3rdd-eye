...
public abstract class AbstractC3169bf {
    public static C5Q A00(final C3110ai c3110ai, int i, final String str, final FH fh) {
        if (i == 1) {
            return new C5Q(c3110ai, str, fh) { // from class: com.facebook.ads.redexgen.X.0e
                public static final int A00 = (int) (AbstractC2975Wl.A02 * 20.0f);
                public static final int A01 = (int) (AbstractC2975Wl.A02 * 16.0f);
                ...
                public final void A1V(C3272dL c3272dL) {
                    C3092aQ titleDescContainer = getTitleDescContainer();
        ...
        return new C5Q(c3110ai, str, fh) { // from class: com.facebook.ads.redexgen.X.0f
            public static final int A00 = (int) (AbstractC2975Wl.A02 * 12.0f);
            ...
            @Override // com.facebook.ads.redexgen.core.C5Q, com.facebook.ads.redexgen.core.AbstractC3106ae
