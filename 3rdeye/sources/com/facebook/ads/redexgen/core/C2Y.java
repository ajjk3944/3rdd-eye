...
public final class C2Y extends AbstractC2479Da {
    ...
    public final AbstractC2895Tf<DO> A00;

    public C2Y(C3272dL c3272dL) {
        this(c3272dL, null);
    }

    public C2Y(C3272dL c3272dL, AttributeSet attributeSet) {
        this(c3272dL, attributeSet, 0);
    }

    public C2Y(C3272dL c3272dL, AttributeSet attributeSet, int i) {
        super(c3272dL, attributeSet, i);
        this.A00 = new C2476Cx(this);
