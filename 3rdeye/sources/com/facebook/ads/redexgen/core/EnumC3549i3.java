...
public enum EnumC3549i3 {
    ...
    public static EnumC3549i3[] valuesCustom() {
        EnumC3549i3[] enumC3549i3ArrValuesCustom = values();
        if (A01[0].charAt(28) == 't') {
            throw new RuntimeException();
        }
        A01[7] = "Z";
        return (EnumC3549i3[]) enumC3549i3ArrValuesCustom.clone();
    }
}
