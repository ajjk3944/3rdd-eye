...
public final class C3813mc implements InterfaceC2436Bh {
    public static byte[] A02;
    public static final SparseArray<Constructor<? extends InterfaceC2434Bf>> A03;
    public final C3602ix A00;
     ...
     */
    public static Constructor<? extends InterfaceC2434Bf> A03(Class<?> cls) {
        try {
            return cls.asSubclass(InterfaceC2434Bf.class).getConstructor(C3940oi.class, C3602ix.class, Executor.class);
        } catch (NoSuchMethodException e4) {
            throw new IllegalStateException(A02(0, 30, 5), e4);
        }
    }
    ...
    public C3813mc(C3602ix c3602ix, Executor executor) {
        this.A00 = (C3602ix) C3M.A01(c3602ix);
        this.A01 = (Executor) C3M.A01(executor);
    }

    public static SparseArray<Constructor<? extends InterfaceC2434Bf>> A00() {
        SparseArray<Constructor<? extends InterfaceC2434Bf>> sparseArray = new SparseArray<>();
        try {
    ...
    private InterfaceC2434Bf A01(DownloadRequest downloadRequest, int i) {
        Constructor<? extends InterfaceC2434Bf> constructor = A03.get(i);
        if (constructor != null) {
            try {
                ...
                throw new IllegalStateException(A02(30, 50, 59) + i, e4);
            }
        }
        throw new IllegalStateException(A02(80, 32, 96) + i);
    }

    @Override // com.facebook.ads.redexgen.core.InterfaceC2436Bh
    public final InterfaceC2434Bf A5E(DownloadRequest downloadRequest) {
        int iA0B = AbstractC22614a.A0B(downloadRequest.A00, downloadRequest.A03);
        switch (iA0B) {
            case 0:
            case 1:
            case 2:
            ...
            case 4:
                return new C3806mV(new C2I().A00(downloadRequest.A00).A02(downloadRequest.A01).A05(), this.A00, this.A01);
        }
    }
}
