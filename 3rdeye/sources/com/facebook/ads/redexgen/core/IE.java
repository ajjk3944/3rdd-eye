...
public final class IE {
    ...
    */
    ...
    public static long A01(byte[] bArr, int i, boolean z10) {
        long j4 = bArr[0] & 255;
        if (z10) {
            long varint = A05[i - 1];
            long j10 = ~varint;
    ...
    public final long A05(InterfaceC3738lN interfaceC3738lN, boolean z10, boolean z11, int i) throws IOException {
        if (this.A01 == 0) {
            if (!interfaceC3738lN.AGh(this.A02, 0, 1, z10)) {
                return -1L;
            }
        ...
        if (this.A00 != 1) {
            interfaceC3738lN.readFully(this.A02, 1, this.A00 - 1);
        }
        this.A01 = 0;
