...
public final class C22905d extends AbstractC2656Jw {
    ...
    public C3272dL A03;
    public C2969Wd A04;
    public AbstractC3002Xm A05;
    public AbstractC3002Xm A06;
    public AbstractC3106ae A07;
    public C3256d4 A08;
    public C3262dA A09;
    public CU A0A;
    public boolean A0B;
    ...
    public final InterfaceC3003Xn A0F;
    public final InterfaceC3083aH A0G;
    public final C3084aI A0H;
    public final C3110ai A0I;
    public final E1 A0J;
    public final C2475Cw A0K;
    ...
    static {
        A0C();
        A0Q = (int) (AbstractC2975Wl.A02 * 16.0f);
        A0b = (int) (AbstractC2975Wl.A02 * 12.0f);
        A0N = (int) (AbstractC2975Wl.A02 * 8.0f);
        A0O = (int) (AbstractC2975Wl.A02 * 10.0f);
        A0W = (int) (AbstractC2975Wl.A02 * 20.0f);
        A0X = (int) (AbstractC2975Wl.A02 * 13.0f);
        A0R = (int) (AbstractC2975Wl.A02 * 48.0f);
        A0a = (int) (AbstractC2975Wl.A02 * 14.0f);
        A0Y = (int) (AbstractC2975Wl.A02 * 12.0f);
        A0P = (int) (AbstractC2975Wl.A02 * 8.0f);
        A0Z = OP.A02(-1, 77);
        A0V = (int) (AbstractC2975Wl.A02 * 16.0f);
        A0c = (int) (AbstractC2975Wl.A02 * 12.0f);
        A0S = (int) (AbstractC2975Wl.A02 * 12.0f);
        A0T = (int) (AbstractC2975Wl.A02 * 16.0f);
        A0U = (int) (AbstractC2975Wl.A02 * 48.0f);
    }

    public C22905d(C3110ai c3110ai) {
        super(c3110ai, false);
        this.A0D = new Handler(Looper.getMainLooper());
        this.A0E = new Handler(Looper.getMainLooper());
        this.A0C = false;
        this.A0B = false;
        this.A03 = c3110ai.A06();
        this.A06 = c3110ai.A0C();
        this.A05 = c3110ai.A0B();
        this.A0I = c3110ai;
        ...
        A09();
        this.A0F = c3110ai.A0D();
        AbstractC3093aR.A00(c3110ai.A06(), this, getAdInfo().A0H().A08());
        this.A0J = A01(c3110ai);
        XP.A0I(this.A0J);
        getAdDetailsView().bringToFront();
        if (!A03()) {
            this.A0K = A02(c3110ai);
        } else {
            this.A0K = null;
        }
        ...
        A1R();
        this.A08 = new C3256d4(this.A03, c3110ai.A07(), getAdDataBundle());
        this.A0G = new C2652Js(this);
        this.A0H = new C3084aI(c3110ai, getAdDataBundle(), this.A0J, this.A0K, getAdDetailsView(), this.A0F, this.A0G);
        C2970Wg c2970WgA02 = super.A09.A02(getAdDataBundle());
        this.A03.A0H().A00(c2970WgA02.A01);
        getCtaButton().setCreativeAsCtaLoggingHelper(super.A09);
        if (c2970WgA02.A00) {
            this.A0J.getVideoImplView().setOnClickListener(new ViewOnClickListenerC3113al(this));
        } else if (U7.A1K(getAdContextWrapper())) {
            AbstractC3060Zs.A00(this.A0J.getVideoImplView(), U7.A1L(getAdContextWrapper()), new ViewOnClickListenerC3114am(this));
        }
        if (c3110ai.A05().A1f()) {
            if (this.A0I.A05().A1i()) {
                this.A07 = new JR(c3110ai);
            } else {
                this.A07 = new JS(c3110ai);
            }
            View view = this.A07;
    ...
    private E1 A01(C3110ai c3110ai) {
        RelativeLayout.LayoutParams layoutParams;
        E1 e12 = (E1) c3110ai.A02();
        int iA1O = A1O(c3110ai.A0C());
        this.A02 = (ImageView) c3110ai.A03();
        if (!A03()) {
            ImageView imageView = this.A02;
            int i = AbstractC2656Jw.A0M;
            int i10 = AbstractC2656Jw.A0M;
            int toolbarHeight = AbstractC2656Jw.A0M;
            imageView.setPadding(i, i10, toolbarHeight, AbstractC2656Jw.A0M);
            int toolbarHeight2 = AbstractC2656Jw.A0N;
            layoutParams = new RelativeLayout.LayoutParams(toolbarHeight2, AbstractC2656Jw.A0N);
            int toolbarHeight3 = AbstractC2656Jw.A0L;
            layoutParams.setMargins(0, iA1O, toolbarHeight3, 0);
            layoutParams.addRule(11);
        } else {
            int toolbarHeight4 = AbstractC3106ae.A0J;
            layoutParams = new RelativeLayout.LayoutParams(toolbarHeight4, AbstractC3106ae.A0J);
            int i11 = A0T;
            int i12 = A0U;
            int toolbarHeight5 = A0T;
            layoutParams.setMargins(i11, i12, toolbarHeight5, A0S);
    ...
    private C2475Cw A02(C3110ai c3110ai) {
        C2475Cw c2475CwA0F = c3110ai.A0F();
        c2475CwA0F.A08(-1, AbstractC2656Jw.A0E, false);
        c2475CwA0F.setPadding(AbstractC2656Jw.A0Q, AbstractC2656Jw.A0Q, AbstractC2656Jw.A0Q, AbstractC2656Jw.A0Q);
        RelativeLayout.LayoutParams progressBarLayoutParams = new RelativeLayout.LayoutParams(-1, AbstractC2656Jw.A0P);
        progressBarLayoutParams.addRule(12);
        addView(c2475CwA0F, progressBarLayoutParams);
        return c2475CwA0F;
    }
    ...
    private void A05() {
        addView(new C3122au(this.A0I.A06(), getAdDataBundle(), this.A0I.A08(), this.A0E, this.A0I.A0D()).A09(getCtaButton()));
    }

    private void A06() {
        XP.A0Z(this.A02, getCtaButton(), getAdDetailsView(), this.A01, this.A0H, this.A0I.A0C());
        for (InterfaceC3289dc interfaceC3289dc : this.A0J.getPlugins()) {
            if (interfaceC3289dc instanceof C2R) {
                this.A0J.A0j(interfaceC3289dc);
                return;
            }
        }
    }
    ...
    private void A0A() {
        new C2915Ua(getAdDataBundle().A25(), getAdEventManager()).A04(UZ.A0z, null);
        if (!getAdInfo().A0V()) {
            return;
        }
        super.A0A.set(true);
        ...
        XP.A0J(this.A06);
        Pair<EnumC3255d3, View> pairA03 = this.A08.A03(getCtaButton());
        this.A00 = (View) pairA03.second;
        A0E((EnumC3255d3) pairA03.first);
        if (getAdInfo().A0K().A00() >= 0) {
            ...
            this.A04 = new C2969Wd((int) getAdInfo().A0K().A00(), 20.0f, 20L, new Handler(Looper.getMainLooper()), new C2650Jq(this));
            this.A04.A07();
        }
    }
    ...
    private void A0D(RelativeLayout relativeLayout) {
        ...
        XP.A0K(c3086aK, 0);
        XP.A0I(c3086aK);
        new KZ(c3086aK, this.A03).A05(A0R, A0R).A07(getAdDataBundle().A23().A01());
        ...
        C3088aM c3088aM = new C3088aM(c3272dL, i, 5, A0Z, -1);
        ...
        linearLayout.addView(c3088aM, ratingCountParams);
        ...
        iconParams.addRule(1, c3086aK.getId());
        ...
        relativeLayout.addView(c3086aK, layoutParams);
        if (TextUtils.isEmpty(getAdDataBundle().A20().A0I().A0B())) {
            linearLayout.setVisibility(8);
            return;
        }
        linearLayout.setVisibility(0);
        c3088aM.setRating(Float.parseFloat(getAdDataBundle().A20().A0I().A0B()));
        ...
        if (!getAdDataBundle().A1j()) {
            ...
            formattingRatingCount = AbstractC2984Wu.A01(Integer.parseInt(getAdDataBundle().A20().A0I().A08()));
        }
    ...
    private void A0E(EnumC3255d3 enumC3255d3) {
        if (!getAdDataBundle().A20().A0K().A02().isEmpty()) {
            if (getAdDataBundle().A20().A0K().A03()) {
                this.A09 = new C3262dA(this.A03, getAdDataBundle(), this.A0F, getCtaButton(), this.A0E, this.A0I.A08());
    ...
    private void A0F(EnumC3255d3 enumC3255d3) {
        this.A0J.A0k(false);
        this.A0J.setVisibility(8);
        if (this.A06 instanceof C2754Nr) {
            AbstractC3002Xm abstractC3002Xm = this.A05;
        ...
        switch (enumC3255d3) {
            case A03:
                AbstractC3063Zv oldEndCardAdDetailsView = getOldEndCardAdDetailsView();
                if (A0M[4].charAt(31) != 'A') {
                    A0M[2] = "XFfDcp5VJF8GQaNSTNs87nOmJmOzmbPV";
                    if (oldEndCardAdDetailsView == null) {
                        AbstractC3063Zv oldEndCard = getAdDetailsView();
                    ...
                    if (oldEndCardAdDetailsView != null) {
                        ...
                        AbstractC3063Zv oldEndCard2 = getAdDetailsView();
            ...
            case A02:
                ...
                RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-1, -1);
                layoutParams.setMargins(AbstractC2656Jw.A0O, AbstractC2656Jw.A0O, AbstractC2656Jw.A0O, AbstractC2656Jw.A0O);
    ...
    public final void A1H(C22383d c22383d) {
        super.A1H(c22383d);
        if (A03()) {
            AbstractC3063Zv adDetailsView = getAdDetailsView();
            if (A0M[0].length() == 5) {
                throw new RuntimeException();
            }
    ...
    public final void A1I(DO r10) {
        ...
        if (A03()) {
            this.A03.A0F().AJw(AbstractC2966Wa.A00((float) this.A0I.A05().A0h()), getResources().getConfiguration().orientation, true, false, MH.A0C(this.A0I.A04()));
        }
    ...
    public final AbstractC3063Zv A1P(C3110ai c3110ai, C2726Mp c2726Mp, String str) {
        double dA0h = c3110ai.A05().A0h();
        if (A03()) {
            if (E1.A0T((float) dA0h)) {
                return new C23035q(c3110ai.A06(), getCtaButton(), AbstractC2656Jw.A0I, false, getColors(), str, c3110ai.A07(), c3110ai.A0D(), c3110ai.A0G(), c3110ai.A0A(), c3110ai.A05(), c3110ai.A0F(), c3110ai.A08(), false);
            }
            if (E1.A0V((float) dA0h)) {
                return new C23025p(c3110ai.A06(), getCtaButton(), AbstractC2656Jw.A0I, false, getColors(), str, c3110ai.A07(), c3110ai.A0D(), c3110ai.A0G(), c3110ai.A0A(), c3110ai.A05(), c3110ai.A0F(), c3110ai.A08(), false);
            }
            return new C23045r(c3110ai.A06(), getCtaButton(), AbstractC2656Jw.A0I, false, getColors(), str, c3110ai.A07(), c3110ai.A0D(), c3110ai.A0G(), c3110ai.A0A(), c3110ai.A05(), c3110ai.A0F(), c3110ai.A08(), false);
        }
        return new C2658Jy(c3110ai.A06(), getCtaButton(), AbstractC2656Jw.A0J, c2726Mp.A0I().A00() == EnumC2731Mu.A05, getColors(), c2726Mp.A0J().A06(), str, c3110ai.A07(), c3110ai.A0D(), c3110ai.A0G(), c3110ai.A0A(), c3110ai.A05());
    }

    @Override // com.facebook.ads.redexgen.core.AbstractC2656Jw
    public final C2658Jy A1Q(C3110ai c3110ai, C2726Mp c2726Mp, String str) {
        return new C2658Jy(c3110ai.A06(), getCtaButton(), AbstractC2656Jw.A0J, c2726Mp.A0I().A00() == EnumC2731Mu.A05, getColors(), c2726Mp.A0J().A06(), str, c3110ai.A07(), c3110ai.A0D(), c3110ai.A0G(), c3110ai.A0A(), c3110ai.A05());
    }
    ...
    public final void A1Y() {
        new C2915Ua(this.A0I.A05().A25(), getAdEventManager()).A04(UZ.A0h, null);
        if (this.A0I.A0C() != null) {
            AbstractC3002Xm abstractC3002XmA0C = this.A0I.A0C();
            if (A0M[4].charAt(31) == 'A') {
                throw new RuntimeException();
            }
            A0M[2] = "qVUXWES3bTCAG5k5pbCpCu4g17099rEp";
            abstractC3002XmA0C.setVisibility(8);
    ...
    public final void A1a(C22433i c22433i) {
        if (this.A07 != null) {
            if (this.A07 instanceof JR) {
                ((JR) this.A07).A1O(c22433i);
            }
            if (this.A07 instanceof JS) {
                ((JS) this.A07).A1O(c22433i);
            }
            this.A07.A1B();
            AbstractC3106ae abstractC3106ae = this.A07;
            String[] strArr = A0M;
            if (strArr[3].charAt(21) == strArr[6].charAt(21)) {
                throw new RuntimeException();
            }
    ...
    @Override // com.facebook.ads.redexgen.core.AbstractC2656Jw, com.facebook.ads.redexgen.core.AbstractC3106ae, android.view.View
    public final void onConfigurationChanged(Configuration configuration) {
        ...
        if (this.A07 != null) {
            ...
            if (abstractC3106ae.getVisibility() == 0) {
                getAdDetailsView().setVisibility(8);
                return;
            }
        }
    ...
    public void setVideoAdViewListener(InterfaceC3230ce interfaceC3230ce) {
        if (this.A07 instanceof JR) {
            ((JR) this.A07).setVideoAdViewListener(interfaceC3230ce);
        }
        if (this.A07 instanceof JS) {
            ((JS) this.A07).setVideoAdViewListener(interfaceC3230ce);
        }
    }
}
