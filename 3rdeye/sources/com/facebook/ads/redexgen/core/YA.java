...
public final class YA extends RelativeLayout {
    ...
    public static final int A08 = (int) (AbstractC2975Wl.A02 * 60.0f);
    public static final int A07 = (int) (AbstractC2975Wl.A02 * 8.0f);
    public static final int A09 = (int) (AbstractC2975Wl.A02 * 16.0f);
    public static final int A0A = (int) (AbstractC2975Wl.A02 * 24.0f);
    public static final int A06 = (int) (AbstractC2975Wl.A02 * 12.0f);

    public YA(C3272dL c3272dL, int i, int i10, String str, String str2, String str3, String str4, Bitmap bitmap) {
        super(c3272dL);
        this.A05 = new TextView(c3272dL);
        this.A02 = new Button(c3272dL);
        this.A01 = new Button(c3272dL);
