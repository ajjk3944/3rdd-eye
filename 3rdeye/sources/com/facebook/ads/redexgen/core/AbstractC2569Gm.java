...
public abstract class AbstractC2569Gm {
    ...
    public static int A00(int i) {
        ...
        int samplingRate;
        int version;
        if (!A06(i) || (i10 = (i >>> 19) & 3) == 1 || (layer = (i >>> 17) & 3) == 0 || (padding = (i >>> 12) & 15) == 0 || padding == 15 || (i11 = (i >>> 10) & 3) == 3) {
            return -1;
        }
        int i12 = A07[i11];
        if (i10 == 2) {
    ...
    public static int A01(int i) {
        int i10;
        int layer;
        if (!A06(i) || (i10 = (i >>> 19) & 3) == 1 || (layer = (i >>> 17) & 3) == 0) {
            return -1;
        }
        int i11 = (i >>> 12) & 15;
        int version = i >>> 10;
