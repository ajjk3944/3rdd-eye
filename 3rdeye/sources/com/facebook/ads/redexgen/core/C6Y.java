...
public final class C6Y {
    ...
    public long A03;
    public C6Y A04;
    public C3786mA A05 = C3786mA.A06;
    public EL A06;
    public final InterfaceC3797mM A07;
    public final Object A08;
    public final InterfaceC2470Cr[] A09;
    ...
    public C6Y(C7D[] c7dArr, long j4, EK ek, EO eo, CL cl, C6Z c6z, EL el) {
        this.A0C = c7dArr;
        this.A03 = j4 - c6z.A03;
        this.A0B = ek;
        ...
        this.A00 = c6z;
        this.A06 = el;
        this.A09 = new InterfaceC2470Cr[c7dArr.length];
        this.A0D = new boolean[c7dArr.length];
        this.A0A = new C3860nN(this, cl);
    ...
    public static InterfaceC3797mM A00(C3796mL c3796mL, C6X c6x, EO eo, long j4, long j10) {
        InterfaceC3797mM interfaceC3797mMA5O = c6x.A5O(c3796mL, eo, j4);
        if (j10 != -9223372036854775807L) {
            return new C9F(interfaceC3797mMA5O, true, 0L, j10);
        }
        return interfaceC3797mMA5O;
    }
    ...
    */
    ...
    public static void A05(C6X c6x, InterfaceC3797mM interfaceC3797mM) {
        try {
            if (interfaceC3797mM instanceof C9F) {
                c6x.AH0(((C9F) interfaceC3797mM).A05);
            } else {
                c6x.AH0(interfaceC3797mM);
            }
        } catch (RuntimeException e4) {
            AnonymousClass44.A08(A01(0, 17, 10), A01(17, 22, 90), e4);
        }
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    private void A06(com.facebook.ads.redexgen.core.InterfaceC2470Cr[] r4) {
        /*
            r3 = this;
            r2 = 0
        L1:
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    private void A07(com.facebook.ads.redexgen.core.InterfaceC2470Cr[] r4) {
        /*
            r3 = this;
            r2 = 0
        L1:
    ...
    public final long A0C(long j4) {
        return this.A07.A6y(j4);
    }

    public final long A0D(long j4) {
        return j4 - A0B();
    }

    public final long A0E(long j4) {
        return A0B() + j4;
    }

    public final long A0F(EL el, long j4, boolean z10) {
        return A0G(el, j4, z10, new boolean[this.A0C.length]);
    }

    public final long A0G(EL el, long j4, boolean z10, boolean[] zArr) {
        int i = 0;
        while (true) {
            boolean z11 = false;
            if (i < el.A00) {
                ...
                if (!z10) {
                    boolean zA01 = el.A01(this.A06, i);
                    if (A0F[5].length() != 8) {
                ...
                this.A06 = el;
                A03();
                long jAIP = this.A07.AIP(el.A04, this.A0D, this.A09, zArr, j4);
                A06(this.A09);
                this.A01 = false;
    ...
    public final EL A0L(float f10, Timeline timeline) throws C9Y {
        ...
        for (InterfaceC3759lj interfaceC3759lj : elA0b.A04) {
    ...
    public final void A0O(long j4) {
        C3M.A08(A08());
        this.A07.A54(A0D(j4));
    }

    public final void A0P(long j4) {
        C3M.A08(A08());
        if (this.A02) {
            this.A07.AGm(A0D(j4));
        }
