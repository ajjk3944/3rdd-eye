...
public enum EnumC2980Wq {
    ...
    EnumC2980Wq(int i, NativeAdBase.NativeComponentTag nativeComponentTag) {
        this.A00 = i;
        this.A01 = nativeComponentTag;
    }

    @Nullable
    public static EnumC2980Wq A00(NativeAdBase.NativeComponentTag nativeComponentTag) {
        for (EnumC2980Wq enumC2980Wq : values()) {
            if (enumC2980Wq.A01 == nativeComponentTag) {
                return enumC2980Wq;
            }
        }
        return null;
    ...
    public static void A03(@Nullable View view, NativeAdBase.NativeComponentTag nativeComponentTag) {
        EnumC2980Wq internalTag = A00(nativeComponentTag);
        if (view != null && internalTag != null) {
            view.setTag(A02, nativeComponentTag);
        }
    }

    public static void A04(@Nullable View view, @Nullable EnumC2980Wq enumC2980Wq) {
        if (view != null && enumC2980Wq != null) {
            view.setTag(A02, enumC2980Wq);
        }
    }
