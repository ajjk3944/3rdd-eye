...
public final class FC {
    ...
    public Handler A04;
    public Pair<Long, C3949or> A05;
    public Pair<Surface, C4N> A06;
    public CopyOnWriteArrayList<InterfaceC22403f> A08;
    public boolean A0A;
    public boolean A0B;
    ...
    public final ArrayDeque<Pair<Long, C3949or>> A0E = new ArrayDeque<>();
    public int A00 = -1;
    public boolean A09 = true;
    public long A02 = -9223372036854775807L;
    public C3902o4 A07 = C3902o4.A06;
    ...
    private void A03(long j4, boolean z10) {
        C3M.A02(null);
    ...
    public static boolean A04(long j4) {
        if (MetaExoPlayerUpgradeConfig.A03(EnumC3548i2.A1s)) {
            return j4 > 50000;
        }
        int releaseLowerThresholdUs = MetaExoPlayerUpgradeConfig.A00(EnumC3549i3.A08);
        int releaseUpperThresholdUs = MetaExoPlayerUpgradeConfig.A00(EnumC3549i3.A07);
        return releaseLowerThresholdUs > 0 && releaseUpperThresholdUs > 0 && j4 > ((long) releaseUpperThresholdUs) && j4 < ((long) releaseLowerThresholdUs);
    }

    public final MediaFormat A06(MediaFormat mediaFormat) {
        if (AbstractC22614a.A02 >= 29 && this.A0C.A0q.getApplicationContext().getApplicationInfo().targetSdkVersion >= 29) {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:42:0x010e, code lost:
        ...
        r30.A0C.A0S(r24, r2, (com.facebook.ads.redexgen.core.C3949or) r30.A05.second, null);
     */
    ...
    */
    ...
    public final void A0D(C3949or c3949or) {
        C3M.A01(null);
        final int i = c3949or.A0L;
        final int i10 = c3949or.A0A;
        new Object(i, i10) { // from class: com.facebook.ads.redexgen.X.3g
    ...
    public final void A0E(String str) {
        this.A00 = AbstractC22614a.A09(this.A0C.A0q, str, false);
    }

    public final void A0F(List<InterfaceC22403f> list) {
        if (this.A08 == null) {
    ...
    public final boolean A0J(C3949or c3949or, long j4) throws C9Y {
        C3M.A08(!A0G());
        if (!this.A09) {
            return false;
        }
        ...
        this.A04 = AbstractC22614a.A0Y();
        this.A0C.A26(c3949or.A0N);
        try {
            if (!C0O.A0h() && c3949or.A0F != 0) {
                CopyOnWriteArrayList<InterfaceC22403f> copyOnWriteArrayList = this.A08;
                FB.A00(c3949or.A0F);
            ...
            new ExecutorC23708l(handler);
            new C3749lZ(this, c3949or);
            throw new NullPointerException(A01(16, 6, 36));
        } catch (Exception e4) {
            throw this.A0C.A1S(e4, c3949or, 7000);
        }
    }

    public final boolean A0K(C3949or c3949or, long j4, boolean z10) {
        C3M.A02(null);
        C3M.A08(this.A00 != -1);
