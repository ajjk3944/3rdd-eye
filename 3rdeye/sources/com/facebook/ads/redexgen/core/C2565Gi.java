...
public final class C2565Gi {
    ...
    private boolean A02(String str) throws NumberFormatException {
        ...
        if (matcher.find()) {
            try {
                int i = Integer.parseInt((String) AbstractC22614a.A0f(matcher.group(1)), 16);
                int i10 = Integer.parseInt((String) AbstractC22614a.A0f(matcher.group(2)), 16);
                if (i > 0 || i10 > 0) {
                    this.A00 = i;
                    this.A01 = i10;
                    return true;
    ...
    */
    public final boolean A05(com.facebook.ads.androidx.media3.common.Metadata r9) {
        ...
        L59:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C2565Gi.A05(com.facebook.ads.androidx.media3.common.Metadata):boolean");
    }
}
