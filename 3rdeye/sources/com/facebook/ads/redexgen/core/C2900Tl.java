...
public final class C2900Tl implements Closeable {
    ...
    public final C2901Tm A03() throws IOException {
        if (!this.A01) {
            return this.A00;
        }
    ...
    public final void A04(C2901Tm c2901Tm) throws IOException {
        if (!this.A01) {
            int iA02 = c2901Tm.A02();
            String[] strArr = A04;
            if (strArr[6].charAt(3) == strArr[1].charAt(3)) {
                throw new RuntimeException();
            }
            A04[2] = "wZJ8kWRxyYeI3b89D2ZfjwX8MEoFWOZU";
            if (iA02 >= 0 && c2901Tm.A03() >= 0) {
                this.A00 = c2901Tm;
                A01();
                return;
            }
            throw new IOException(String.format(Locale.US, A00(28, 25, 107), Integer.valueOf(c2901Tm.A02()), Integer.valueOf(c2901Tm.A03())));
        }
        throw new IOException(A00(0, 28, 100));
    }
