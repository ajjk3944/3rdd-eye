...
public class C3179bp extends WebViewClient {
    ...
    public C3179bp(C3183bt c3183bt) {
        this.A00 = c3183bt;
    }

    private void A02(int i, String str, String str2, boolean z10) throws JSONException {
        if (z10) {
            this.A00.A0S();
        }
        ...
        this.A00.A0E.A04(AbstractC2885Sv.A16, string);
    }
    ...
    public final boolean onRenderProcessGone(WebView webView, RenderProcessGoneDetail renderProcessGoneDetail) throws JSONException {
        ...
        String string = jSONObject.toString();
        C3272dL c3272dL = this.A00.A0B;
        String message = A02[5];
        if (message.charAt(10) == 'q') {
            A02[3] = "cKmn9F08G0LbJgt48cswTZGSotGQ5jj";
            c3272dL.A0F().A62(string);
            AbstractC3184bu.A04(this.A00.A09.A17());
    ...
    public final WebResourceResponse shouldInterceptRequest(WebView webView, WebResourceRequest webResourceRequest) {
        return C3194c4.A00(this.A00.A0B, this.A00.A0A, webResourceRequest, this.A00.A0H, this.A00.A09.A1O());
    }
}
