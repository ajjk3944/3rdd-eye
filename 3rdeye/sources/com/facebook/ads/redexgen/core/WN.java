...
public final class WN {
    ...
    private int A00(C3272dL c3272dL) {
        PackageInfo packageInfo;
        try {
            PackageManager packageManager = c3272dL.getPackageManager();
    ...
    public static Intent A02(C3272dL c3272dL, Uri uri) {
        Intent intentA01 = A01(uri);
        intentA01.addCategory(A07(212, 33, 20));
        intentA01.addFlags(268435456);
        intentA01.putExtra(A07(288, 34, 93), c3272dL.getPackageName());
    ...
    public static Intent A03(C3272dL c3272dL, Uri uri) {
        Intent intentA01 = A01(uri);
        intentA01.setPackage(A07(322, 19, 35));
        intentA01.putExtra(A07(259, 8, 30), c3272dL.getPackageName());
        intentA01.putExtra(A07(682, 7, 117), true);
        return intentA01;
    }

    public static Uri A04(C3272dL c3272dL, Uri uri) {
    ...
    private final ME A05(C3272dL c3272dL, Uri uri, String str, Map<String, String> map) throws W9 {
        boolean zA05 = U8.A05(c3272dL);
        boolean isInAppBrowserEnabled = A0F(uri);
        if (isInAppBrowserEnabled && zA05) {
            A0C(c3272dL, uri, str, map);
            ME me = ME.A08;
            if (A01[7].length() == 30) {
        ...
        c3272dL.A0F().A9p(zA05);
        A0A(c3272dL, uri);
        return ME.A07;
    }

    public static ME A06(WN wn, C3272dL c3272dL, Uri uri, String str, Map<String, String> extraData) throws W9 {
        ...
        if (!isGooglePlayWebLink && !z10) {
            return wn.A05(c3272dL, uri, str, extraData);
        }
        try {
            wn.A0B(c3272dL, uri, str);
            return ME.A03;
        } catch (WL unused) {
            return wn.A05(c3272dL, uri, str, extraData);
        }
    ...
    private void A0A(C3272dL c3272dL, Uri uri) throws W9 {
        WB.A0D(c3272dL, A02(c3272dL, uri));
    }

    private final void A0B(C3272dL c3272dL, Uri uri, String str) throws W9, WL, PackageManager.NameNotFoundException {
        if (A0H(c3272dL)) {
            if (U7.A1H(c3272dL)) {
                ...
                if (!TextUtils.isEmpty(queryParameter)) {
                    ...
                    AbstractC2759Nw.A03(queryParameter, strA07, packageName);
                }
            }
            boolean z10 = (c3272dL.A0H().A01() && U7.A1b(c3272dL)) || (U7.A1z(c3272dL) && A0I(c3272dL));
            if (!z10) {
                boolean shouldTryToOpenSplitScreen = U7.A2L(c3272dL);
                if (shouldTryToOpenSplitScreen) {
                    boolean shouldTryToOpenSplitScreen2 = WB.A0E(c3272dL, A03(c3272dL, uri));
                    if (shouldTryToOpenSplitScreen2) {
                        return;
                    }
                }
            }
            boolean zA0M = A0M(c3272dL, uri, str);
            if (A01[3].charAt(29) != 'Z') {
            ...
            boolean shouldTryToOpenSplitScreen3 = A0K(c3272dL, uri);
            if (shouldTryToOpenSplitScreen3) {
                return;
            }
            Intent intentA02 = A02(c3272dL, uri);
            intentA02.setPackage(A07(322, 19, 35));
            if (Build.VERSION.SDK_INT >= 24 && z10) {
                intentA02.addFlags(268472320);
            }
            WB.A0D(c3272dL, intentA02);
            return;
        }
        throw new WL();
    }

    private void A0C(C3272dL c3272dL, Uri uri, String str, Map<String, String> map) {
        AdActivityIntent adActivityIntentA05 = WB.A05(c3272dL);
        if (!ProcessUtils.isRemoteRenderingProcess()) {
            adActivityIntentA05.addFlags(268435456);
        }
        adActivityIntentA05.putExtra(A07(722, 8, 120), EnumC2942Vb.A03);
        ...
        try {
            WB.A0B(c3272dL, adActivityIntentA05);
        } catch (W9 e4) {
            ...
            c3272dL.A08().AAy(A07(168, 11, 110), AbstractC2885Sv.A0D, new C2886Sw(cause2));
            Log.e(A07(149, 17, 28), A07(50, 90, 84), cause2);
        }
    }

    public static void A0D(WN wn, C3272dL c3272dL, Uri uri, String str) {
        wn.A0N(c3272dL, uri, str);
    }

    public static void A0E(WN wn, C3272dL c3272dL, Uri uri, String str) throws W9 {
        A06(wn, c3272dL, uri, str, null);
    }
    ...
    */
    ...
    private boolean A0G(C3272dL c3272dL) {
        if (!U7.A1E(c3272dL)) {
            return false;
        }
        int deviceFBVersion = U7.A0E(c3272dL);
        int iA00 = A00(c3272dL);
    ...
    private boolean A0H(C3272dL c3272dL) throws SecurityException {
        Intent playStoreIntent = new Intent(A07(186, 26, 10), WQ.A00(A07(548, 34, 3)));
        Iterator<ResolveInfo> it = c3272dL.getPackageManager().queryIntentActivities(playStoreIntent, 0).iterator();
        do {
  ...
  0x0079: PHI (r5v2 java.lang.String) = (r5v0 java.lang.String), (r5v3 java.lang.String) binds: [B:33:0x00d7, B:19:0x0077] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public static boolean A0I(com.facebook.ads.redexgen.core.C3272dL r12) throws java.lang.IllegalAccessException, java.lang.NoSuchFieldException, android.content.res.Resources.NotFoundException, android.content.pm.PackageManager.NameNotFoundException, java.lang.IllegalArgumentException {
        /*
    ...
    public static boolean A0J(C3272dL c3272dL) throws IllegalAccessException, NoSuchFieldException, PackageManager.NameNotFoundException, IllegalArgumentException {
        Activity activityA0E;
        PackageManager packageManager;
        ActivityInfo activityInfo;
        try {
            activityA0E = c3272dL.A0E();
            packageManager = c3272dL.getPackageManager();
        } catch (PackageManager.NameNotFoundException | IllegalAccessException | NoSuchFieldException e4) {
            c3272dL.A0F().ABV(e4.getMessage());
        }
    ...
    public static boolean A0K(C3272dL c3272dL, Uri uri) throws PackageManager.NameNotFoundException {
        ...
        try {
            ...
            if (packageInfo != null && !TextUtils.isEmpty(packageInfo.versionName)) {
                ...
                if (Integer.parseInt(strArrSplit[0]) < U7.A0G(c3272dL)) {
                    c3272dL.A0F().AB3(3);
                    return false;
                }
            }
            Intent intent = new Intent(A07(186, 26, 10));
            String packageName = c3272dL.getPackageName();
            intent.setPackage(strA07);
            Uri hsdpUri = A04(c3272dL, uri);
            if (hsdpUri == null) {
                return false;
            }
    ...
    private boolean A0L(C3272dL c3272dL, Uri uri, String str) throws W9 {
        try {
            Activity activityA0E = c3272dL.A0E();
            ...
            if (activityA0E != null && !TextUtils.isEmpty(string)) {
                ...
                if (U7.A1F(c3272dL)) {
                    String strA06 = AbstractC3547hy.A06(str);
            ...
            c3272dL.A0F().AB2(e4.getMessage());
            return false;
        }
    }

    private boolean A0M(C3272dL c3272dL, Uri uri, String str) throws W9 {
        return A0G(c3272dL) && A0L(c3272dL, uri, str);
    }

    private final boolean A0N(C3272dL c3272dL, Uri uri, String str) {
        return WB.A0G(c3272dL, uri, str);
    }

    public static boolean A0O(WN wn, C3272dL c3272dL, Uri uri, String str) {
        try {
            A0E(wn, c3272dL, uri, str);
            return true;
        } catch (W9 e4) {
            Throwable cause = e4.getCause();
            Throwable cause2 = e4;
            ...
            c3272dL.A08().AAy(A07(168, 11, 110), AbstractC2885Sv.A05, new C2886Sw(cause2));
            return false;
        }
    }
}
