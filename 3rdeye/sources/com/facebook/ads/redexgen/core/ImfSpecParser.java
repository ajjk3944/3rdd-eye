...
public final class ImfSpecParser {
    ...
    public static final List<ImfDataTrack> A01(String str) throws JSONException {
        ...
        for (int i = 0; i < length; i++) {
            ...
            C3963p6.A06(string2);
            C3963p6.A06(string3);
            C3531hd c3531hd = new C3531hd(string2, string3);
            ...
            for (int i10 = 0; i10 < length2; i10++) {
                ...
                long j4 = jSONObject2.getLong(strA002);
                long j10 = dataTrack.getJSONObject(strA00).getJSONObject(A00(22, 7, 94)).getLong(strA002);
                JSONObject jSONObject3 = new JSONObject(dataTrack.getString(A00(102, 15, 77)));
                C3963p6.A06(string);
                arrayList.add(new ImfDataTrack(string, j4, j10, c3531hd, new C3530hc(jSONObject3.getDouble(A00(69, 9, 118)), jSONObject3.getDouble(A00(78, 9, 61)), jSONObject3.getDouble(A00(56, 13, 67)), jSONObject3.getDouble(A00(42, 14, 35)), jSONObject3.getDouble(A00(87, 15, 35)))));
            }
        }
        return arrayList;
    }
