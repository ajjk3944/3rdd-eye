...
public final class C21780t extends C23487j implements Comparable<C21780t> {
    ...
    public final int compareTo(C21780t c21780t) {
        if (A05() != c21780t.A05()) {
            return A05() ? 1 : -1;
        }
        long j4 = this.A01 - c21780t.A01;
        if (j4 == 0) {
            long j10 = this.A00;
            long delta = c21780t.A00;
            j4 = j10 - delta;
            if (j4 == 0) {
                return 0;
            }
