...
public abstract class AbstractC22754o {
     ...
     */
    public static int A00(SQLiteDatabase sQLiteDatabase, int i, String str) throws C22724l {
        try {
            if (!AbstractC22614a.A19(sQLiteDatabase, A01(159, 17, 73))) {
                return -1;
            }
    ...
    public static void A03(SQLiteDatabase sQLiteDatabase, int i, String str) throws C22724l {
        String strA01 = A01(159, 17, 73);
        try {
            if (!AbstractC22614a.A19(sQLiteDatabase, strA01)) {
                return;
            }
    ...
    public static void A04(SQLiteDatabase sQLiteDatabase, int i, String str, int i10) throws C22724l, SQLException {
        try {
