...
public abstract class C3U {
    ...
    public static String A01(int i, int i10, int i11) {
        return String.format(A02(8, 17, 98), Integer.valueOf(i), Integer.valueOf(i10), Integer.valueOf(i11));
    }

    public static String A03(int i, boolean z10, int i10, int i11, int[] iArr, int i12) {
        StringBuilder sb = new StringBuilder(AbstractC22614a.A0n(A02(25, 17, 35), A03[i], Integer.valueOf(i10), Integer.valueOf(i11), Character.valueOf(z10 ? 'H' : 'L'), Integer.valueOf(i12)));
        int length = iArr.length;
        while (length > 0 && iArr[length - 1] == 0) {
            length--;
        }
        for (int i13 = 0; i13 < length; i13++) {
            sb.append(String.format(A02(0, 5, 87), Integer.valueOf(iArr[i13])));
        }
        return sb.toString();
    }
    ...
    public static byte[] A07(byte[] bArr, int i, int i10) {
        byte[] bArr2 = new byte[A02.length + i10];
        byte[] bArr3 = A02;
        byte[] nalUnit = A02;
        System.arraycopy(bArr3, 0, bArr2, 0, nalUnit.length);
        byte[] nalUnit2 = A02;
        System.arraycopy(bArr, i, bArr2, nalUnit2.length, i10);
        return bArr2;
    }
}
