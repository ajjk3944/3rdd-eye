...
public class C3682kH<V> extends AbstractCollection<V> {
    ...
    public final /* synthetic */ AbstractC21931i A04;
    ...
    public final boolean addAll(Collection<? extends V> collection) {
        ...
        if (zAddAll) {
            AbstractC21931i.A02(this.A04, this.A00.size() - size);
            if (size == 0) {
                A03();
            }
        }
    ...
    public C3682kH(@ParametricNullness final AbstractC21931i this$0, @CheckForNull Object key, Collection delegate, C3682kH ancestor) {
        this.A04 = this$0;
        this.A02 = key;
        this.A00 = delegate;
        this.A01 = ancestor;
    ...
    public final void clear() {
        ...
        this.A00.clear();
        AbstractC21931i.A03(this.A04, size);
        A05();
    }
    ...
    public final boolean retainAll(Collection<?> c10) {
        AbstractC3614jA.A04(c10);
        int size = size();
        boolean zRetainAll = this.A00.retainAll(c10);
        if (zRetainAll) {
            int size2 = this.A00.size();
            AbstractC21931i abstractC21931i = this.A04;
            int i = size2 - size;
            String[] strArr = A05;
            String str = strArr[0];
            ...
            AbstractC21931i.A02(abstractC21931i, i);
            A05();
        }
        return zRetainAll;
    }
