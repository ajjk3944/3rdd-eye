...
public abstract class AbstractC3264dC {
    ...
    public static void A01(@Nullable Context context, final View view, long j4, final View view2) {
        if (view2 != null) {
        ...
        new Handler(Looper.getMainLooper()).postDelayed(new Runnable() { // from class: com.facebook.ads.redexgen.X.dB
            ...
            public final void run() {
                AbstractC3264dC.A02(view2, view);
            }
        }, j4);
    }
