...
public final class U1 implements Closeable {
    ...
    public U1(C2906Tr c2906Tr, InterfaceC2914Tz interfaceC2914Tz) throws NumberFormatException, IOException {
        this.A01 = c2906Tr;
        A05(c2906Tr, interfaceC2914Tz);
        if (this.A02.isEmpty()) {
            A00();
        }
    }
    ...
    private U0 A00() throws IOException {
        ...
        int i = iA00 + 1;
        this.A02.add(new U0(i, new C2912Tx(new File(this.A01.A05(), A01(i)))));
    ...
    private void A04(int i, File file) throws IOException {
        C2912Tx c2912Tx = new C2912Tx(file);
        c2912Tx.A05();
        this.A02.addFirst(new U0(i, c2912Tx));
    }

    private void A05(C2906Tr c2906Tr, InterfaceC2914Tz interfaceC2914Tz) throws NumberFormatException, IOException {
        File[] fileArrListFiles = c2906Tr.A05().listFiles();
        if (fileArrListFiles != null) {
            ...
            for (File file : fileArrListFiles) {
                try {
                    ...
                    hashSet.add(file);
                    interfaceC2914Tz.AHs(String.format(Locale.US, A02(260, 39, 118), file.getCanonicalPath()));
                }
            }
            ...
            if (!zIsEmpty) {
                ...
                while (it.hasNext()) {
                    ...
                    if (iIntValue < i11) {
                        interfaceC2914Tz.AHs(String.format(Locale.US, A02(166, 61, 41), Integer.valueOf(iIntValue), Integer.valueOf(i11)));
                ...
                while (i >= i11) {
                    ...
                    try {
                        ...
                        interfaceC2914Tz.AHt(String.format(Locale.US, A02(104, 62, 55), file2.getCanonicalPath(), Integer.valueOf(i)), e4);
            ...
            for (Object obj : hashSet) {
                ...
                if (!file3.delete()) {
                    ...
                    if (A04[7].charAt(19) != 'm') {
                        ...
                        interfaceC2914Tz.AHs(String.format(locale, A02(40, 26, 116), objArr));
                    } else {
                        A04[7] = "xgRJlHLuW2qx7z7dN03x9GIdgxBOKXSD";
                        objArr[0] = canonicalPath;
                        interfaceC2914Tz.AHs(String.format(locale, A02(38, 20, 82), objArr));
                    }
                }
            }
            return;
        }
        IOException e10 = new IOException(String.format(Locale.US, A02(66, 38, 13), c2906Tr.A05().getCanonicalPath()));
        throw e10;
    }
    ...
    public final synchronized C2904Tp A0A(int i, int i10, byte[] bArr, int i11, int[] iArr, int i12) throws IOException {
        if (!this.A00) {
            for (U0 file : this.A02) {
                if (file.A00() == i) {
                    return new C2904Tp(i, file.A02(i10, bArr, i11, iArr, i12));
                }
            }
            return new C2904Tp(-1, new C2903To(EnumC2902Tn.A05, -1, -1, 0));
        }
        throw new IOException(A02(227, 33, 31));
    }
