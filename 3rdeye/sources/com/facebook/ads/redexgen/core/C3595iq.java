...
public final class C3595iq extends C2709Lx {
  ...
  0x00aa: PHI (r8v2 long) = (r8v0 long), (r8v3 long) binds: [B:30:0x00d7, B:25:0x00a8] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    public static com.facebook.ads.redexgen.core.C3595iq A01(java.io.File r14, long r15, long r17, com.facebook.ads.redexgen.core.M6 r19) throws java.lang.NumberFormatException {
        /*
            r12 = r17
            r10 = r15
        ...
        L1f:
            java.lang.String r3 = r14.getName()
        L23:
            java.util.regex.Pattern r0 = com.facebook.ads.redexgen.core.C3595iq.A04
        ...
        L50:
            r4 = 0
            java.lang.String[] r2 = com.facebook.ads.redexgen.core.C3595iq.A01
            r0 = 0
            r1 = r2[r0]
            r0 = 2
            r2 = r2[r0]
        ...
        L77:
            ...
            java.lang.String[] r1 = com.facebook.ads.redexgen.core.C3595iq.A01
            r0 = 7
            r1 = r1[r0]
            r0 = 17
            char r1 = r1.charAt(r0)
        ...
        Lda:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C3595iq.A01(java.io.File, long, long, com.facebook.ads.redexgen.X.M6):com.facebook.ads.redexgen.X.iq");
    }
    ...
    public C3595iq(String str, long j4, long j10, long j11, File file) {
        super(str, j4, j10, j11, file);
    }

    public static C3595iq A02(File file, long j4, M6 m62) {
        return A01(file, j4, -9223372036854775807L, m62);
    }

    public static C3595iq A03(String str, long j4) {
        return new C3595iq(str, j4, -1L, -9223372036854775807L, null);
    }

    public static C3595iq A04(String str, long j4, long j10) {
        return new C3595iq(str, j4, j10, -9223372036854775807L, null);
    }

    public static File A05(File file, int i, long j4, long j10) {
        StringBuilder sbAppend = new StringBuilder().append(i);
        String strA07 = A07(0, 1, 16);
        return new File(file, sbAppend.append(strA07).append(j4).append(strA07).append(j10).append(A07(1, 7, 86)).toString());
    }
    ...
    public static File A06(File file, M6 m62) throws NumberFormatException {
        ...
        if (matcher.matches()) {
            ...
            strA0l = AbstractC22614a.A0l((String) C3M.A01(key));
        } else {
        ...
        long j4 = Long.parseLong((String) C3M.A01(key3));
        String key4 = matcher.group(3);
        File fileA05 = A05(file2, iA0B, j4, Long.parseLong((String) C3M.A01(key4)));
    ...
    public final C3595iq A09(File file, long j4) {
        C3M.A08(this.A05);
        return new C3595iq(this.A04, this.A02, this.A01, j4, file);
    }
}
