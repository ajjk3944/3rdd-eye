...
public final class VE implements UQ {
    ...
    public VE(C3246cu c3246cu, WO wo) {
        this.A00 = c3246cu;
        this.A01 = wo;
    }

    public static JSONArray A01(C3246cu c3246cu, JSONArray jSONArray, JSONArray jSONArray2) {
        int i = 0;
        if (jSONArray != null) {
        ...
        return A02(c3246cu, jSONArray, jSONArray2, i);
    }
    ...
    */
    public static org.json.JSONArray A02(com.facebook.ads.redexgen.core.C3246cu r19, org.json.JSONArray r20, org.json.JSONArray r21, int r22) throws org.json.JSONException {
        /*
    ...
    */
    private org.json.JSONObject A03() throws org.json.JSONException {
        /*
            ...
            if (r0 == 0) goto L46
            com.facebook.ads.redexgen.X.cu r0 = r7.A00
            org.json.JSONArray r6 = com.facebook.ads.redexgen.core.C2887Sx.A03(r0)
            if (r6 == 0) goto L46
            int r0 = r6.length()
            if (r0 <= 0) goto L46
    ...
    private JSONObject A04(int i) throws JSONException {
        ...
        if (U9.A0P(this.A00) && (jSONArrayA04 = C2887Sx.A04(this.A00, (iA08 = U9.A08(this.A00)))) != null && jSONArrayA04.length() > 0) {
    ...
    private void A06(String str) {
        if (C2887Sx.A0I(str)) {
            C3246cu c3246cu = this.A00;
            String[] strArr = A03;
            if (strArr[4].charAt(22) == strArr[7].charAt(22)) {
                throw new RuntimeException();
            }
            A03[2] = "U9Gor";
            C2887Sx.A0B(c3246cu, str);
            return;
        }
        this.A01.A9x(str);
    }
    ...
    public final boolean AAS() {
        ...
        int eventLimit = C2887Sx.A00(this.A00);
    ...
    public final void ACJ() {
        ...
        if (iA4s > 0) {
            this.A00.A08().AAy(A00(379, 8, 37), AbstractC2885Sv.A10, new C2886Sw(A00(28, 44, 62) + iA4s));
        }
    ...
    public final void AD0(JSONArray jSONArray) {
        ...
        for (int i = 0; i < length; i++) {
            try {
                ...
                if (this.A00.A05().AAF()) {
                    String eventId = A04;
                    Log.e(eventId, A00(108, 62, 102), e4);
                }
            }
        }
    }
