...
public final class C3493gz implements InterfaceC2739Nc {
    ...
    static {
        A0A();
        A0A = C3493gz.class.getSimpleName();
    }

    public C3493gz(C3489gv c3489gv, InterfaceC2755Ns interfaceC2755Ns, String str) {
        this.A08 = c3489gv;
        this.A06 = c3489gv.A05();
        this.A07 = new C3478gk(str, interfaceC2755Ns, this);
    }
    ...
    public final C3489gv A0E() {
        return this.A08;
    }

    public final C3272dL A0F() {
        return this.A06;
    }
    ...
    public final void A0G(EnumSet<CacheFlag> cacheFlags, String str) {
        ...
        if (this.A04 && !U7.A0i(this.A06)) {
            this.A06.A08().AAy(A09(130, 3, 68), AbstractC2885Sv.A0L, new C2886Sw(A09(78, 52, 22)));
        ...
        nt.A07(this.A08.A09());
        nt.A04(this.A08.A03());
        this.A03 = new C23376y(this.A06, nt);
        this.A03.A0S(new C3497h4(this));
        this.A03.A0W(str);
    }
    ...
    public final boolean A0J() {
        ...
        if (this.A03 == null) {
            this.A06.A08().AAy(A09(130, 3, 68), AbstractC2885Sv.A0S, new C2886Sw(AdErrorType.INTERSTITIAL_CONTROLLER_IS_NULL.getDefaultErrorMessage()));
            this.A06.A0F().A3F(XG.A01(this.A00), adError.getErrorCode(), adError.getErrorMessage());
            this.A07.onError(this.A08.A6c(), adError);
            return false;
        }
