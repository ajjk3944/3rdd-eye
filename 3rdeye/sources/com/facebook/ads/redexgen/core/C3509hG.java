...
public final class C3509hG implements InterfaceC2737Na {
    ...
    public final AbstractC3506hD A03;
    ...
    public C3509hG(C3272dL c3272dL, AbstractC3506hD abstractC3506hD) {
        this.A04 = c3272dL;
        this.A03 = abstractC3506hD;
    }
    ...
    private void A02(NZ nz, NZ nz2) {
        ...
        InterfaceC2884Su interfaceC2884SuA08 = this.A04.A08();
        int i = AbstractC2885Sv.A0e;
        C2886Sw c2886Sw = new C2886Sw(strA00, string);
        String errorTitle3 = A00(139, 3, 61);
        interfaceC2884SuA08.AAy(errorTitle3, i, c2886Sw);
    ...
    private void A03(String str, String str2, boolean z10) {
        ...
        if (!z10) {
            Log.e(strA002, str3);
            this.A04.A08().AAy(strA00, AbstractC2885Sv.A0c, new C2886Sw(str3));
        ...
        switch (NY.A00[integrationErrorModeA00.ordinal()]) {
            case 1:
                ...
                throw new C2738Nb(errorMessage);
            case 2:
                this.A03.A08();
    ...
    @Override // com.facebook.ads.redexgen.core.InterfaceC2737Na
