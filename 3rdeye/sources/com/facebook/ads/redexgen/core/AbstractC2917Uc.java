...
public abstract class AbstractC2917Uc {
    ...
    public static String A00(int i, int i10, int i11) {
        ...
        while (true) {
            ...
            int i13 = (bArrCopyOfRange[i12] - i11) - 84;
            String[] strArr = A01;
    ...
    public static List<String> A02(C3272dL c3272dL, JSONArray jSONArray) {
        ArrayList arrayList = new ArrayList();
        for (int eventIndex = 0; eventIndex < jSONArray.length(); eventIndex++) {
            try {
                arrayList.add(jSONArray.getString(eventIndex));
            } catch (JSONException e4) {
                c3272dL.A08().AAy(A00(39, 17, 76), AbstractC2885Sv.A1C, new C2886Sw(e4));
            }
        }
        return arrayList;
    }

    public static void A04(View view, C2915Ua c2915Ua, UZ uz) {
        view.addOnAttachStateChangeListener(new ViewOnAttachStateChangeListenerC2916Ub(c2915Ua, uz));
    }

    public static void A05(C3272dL c3272dL, String str, long j4) {
        US adEventManager = c3272dL.A0A();
        C2915Ua c2915Ua = new C2915Ua(str, adEventManager);
        HashMap map = new HashMap();
        map.put(A00(24, 15, 67), XG.A07(j4));
        map.put(A00(12, 12, 71), XG.A05(j4));
        c2915Ua.A04(UZ.A0D, map);
    }

    public static void A06(C3272dL c3272dL, JSONObject jSONObject, long j4, String str) {
        ...
        if (TextUtils.isEmpty(str) && jSONArrayOptJSONArray != null) {
            A07(c3272dL, jSONObjectOptJSONObject, A02(c3272dL, jSONArrayOptJSONArray), j4, null);
            return;
        }
        ...
        A07(c3272dL, jSONObjectOptJSONObject, A03.get(str), j4, str);
    }

    public static void A07(C3272dL c3272dL, JSONObject jSONObject, List<String> list, long j4, String str) {
        String strA00 = A00(0, 2, 106);
        if (jSONObject.has(strA00)) {
            String clientToken = jSONObject.optString(strA00);
            A08(clientToken, str);
            A09(clientToken, list);
            A05(c3272dL, clientToken, j4);
        }
    }
