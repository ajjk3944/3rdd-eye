...
public final class BQ extends Handler {
    ...
    public final InterfaceC2436Bh A09;
    public final InterfaceC3804mT A0A;
    public final ArrayList<B8> A0B;
    public final HashMap<String, C3809mY> A0C;
    ...
    private void A0Q(DownloadRequest downloadRequest, int i) {
        ...
        if (b8A06 != null) {
            A03(BT.A00(b8A06, downloadRequest, i, jCurrentTimeMillis));
        } else {
            A03(new B8(downloadRequest, i != 0 ? 1 : 0, jCurrentTimeMillis, jCurrentTimeMillis, -1L, i, 0));
        }
        A0B();
    }
    ...
    public BQ(HandlerThread handlerThread, InterfaceC3804mT interfaceC3804mT, InterfaceC2436Bh interfaceC2436Bh, Handler handler, int i, int i10, boolean z10) {
        super(handlerThread.getLooper());
        this.A08 = handlerThread;
        this.A0A = interfaceC3804mT;
        this.A09 = interfaceC2436Bh;
        this.A07 = handler;
        this.A02 = i;
        this.A03 = i10;
        this.A05 = z10;
    ...
    public static int A00(B8 b82, B8 b83) {
        return AbstractC22614a.A08(b82.A05, b83.A05);
    }
    ...
    */
    ...
    private B8 A03(B8 b82) {
        ...
        try {
            ...
            AnonymousClass44.A08(A08(2, 15, 106), A08(Sdk$SDKError.b.STALE_CACHED_RESPONSE_VALUE, 23, 46), e4);
        }
        this.A07.obtainMessage(2, new BO(b82, false, new ArrayList(this.A0B), null)).sendToTarget();
        return b82;
    }

    private B8 A04(B8 b82, int i, int i10) {
        C3M.A08((i == 3 || i == 4) ? false : true);
        return A03(A05(b82, i, i10));
    }

    public static B8 A05(B8 b82, int i, int i10) {
        return new B8(b82.A07, i, b82.A05, System.currentTimeMillis(), b82.A04, i10, 0, b82.A00);
    }
    ...
    private B8 A06(String str, boolean z10) {
        ...
        if (z10) {
            try {
                ...
                AnonymousClass44.A08(A08(2, 15, 106), A08(17, 25, 52) + str, e4);
                return null;
            }
        }
        return null;
    ...
    private C3809mY A07(C3809mY c3809mY, B8 b82) {
        if (c3809mY == null) {
            if (A0U() && this.A01 < this.A02) {
                B8 b8A04 = A04(b82, 2, 0);
                C3809mY c3809mY2 = new C3809mY(b8A04.A07, this.A09.A5E(b8A04.A07), b8A04.A00, false, this.A03, this);
                this.A0C.put(b8A04.A07.A02, c3809mY2);
                int i = this.A01;
                this.A01 = i + 1;
                if (i == 0) {
    ...
    private void A09() {
        Iterator<C3809mY> it = this.A0C.values().iterator();
        while (it.hasNext()) {
            it.next().A05(true);
        }
        try {
    ...
    private void A0A() {
        ...
        try {
            C3814md c3814mdA7j = this.A0A.A7j(3, 4);
            while (c3814mdA7j.A01()) {
                try {
                    arrayList.add(c3814mdA7j.A00());
                } finally {
                }
            }
            if (c3814mdA7j != null) {
        ...
        while (true) {
            ...
            if (i10 < size) {
                ...
                try {
                    ...
                    AnonymousClass44.A08(strA08, A08(Sdk$SDKError.b.STALE_CACHED_RESPONSE_VALUE, 23, 46), e4);
                }
                ArrayList arrayList3 = new ArrayList(this.A0B);
                for (int i11 = 0; i11 < this.A0B.size(); i11++) {
                    this.A07.obtainMessage(2, new BO(this.A0B.get(i11), false, arrayList3, null)).sendToTarget();
                }
                A0B();
                return;
            }
    ...
    */
    private void A0B() {
        ...
        L2:
            ...
            com.facebook.ads.redexgen.X.mY r1 = (com.facebook.ads.redexgen.core.C3809mY) r1
            int r0 = r2.A02
            switch(r0) {
                case 0: goto L38;
                case 1: goto L34;
        ...
        L3c:
            if (r1 == 0) goto L46
            boolean r0 = com.facebook.ads.redexgen.core.C3809mY.A03(r1)
            if (r0 != 0) goto L46
            int r4 = r4 + 1
        L46:
            int r3 = r3 + 1
    ...
    */
    ...
    private void A0E(int i) throws IOException {
        this.A04 = i;
        C3814md c3814mdA7j = null;
        try {
            try {
                this.A0A.AIe();
                c3814mdA7j = this.A0A.A7j(0, 1, 2, 5, 7);
                while (c3814mdA7j.A01()) {
                    this.A0B.add(c3814mdA7j.A00());
                }
            } catch (IOException e4) {
                AnonymousClass44.A08(A08(2, 15, 106), A08(67, 21, 14), e4);
                this.A0B.clear();
            }
            AbstractC22614a.A10(c3814mdA7j);
    ...
    private void A0J(B8 b82, int i) {
        ...
        A03(new B8(b82.A07, i11, b82.A05, System.currentTimeMillis(), b82.A04, i, 0, b82.A00));
    }
    ...
    private void A0K(B8 b82, Exception exc) {
        ...
        B8 b83 = new B8(downloadRequest, i10, j4, jCurrentTimeMillis, j10, i11, i, b82.A00);
    ...
    private void A0L(C3809mY c3809mY) {
        String str = c3809mY.A04.A02;
        this.A0C.remove(str);
        boolean z10 = c3809mY.A06;
        if (z10) {
            this.A06 = false;
        } else {
            int i = this.A01 - 1;
        ...
        Exception finalException = c3809mY.A01;
        if (finalException != null) {
            StringBuilder sb = new StringBuilder();
            String downloadId = A08(246, 13, 86);
            StringBuilder sbAppend = sb.append(downloadId).append(c3809mY.A04);
    ...
    private void A0M(C3809mY c3809mY) {
        if (c3809mY == null) {
            return;
        }
        C3M.A08(!c3809mY.A06);
    ...
    private void A0N(C3809mY c3809mY, long j4) {
        B8 b82 = (B8) C3M.A01(A06(c3809mY.A04.A02, false));
        if (j4 == b82.A04 || j4 == -1) {
            return;
        }
        A03(new B8(b82.A07, b82.A02, b82.A05, System.currentTimeMillis(), j4, b82.A03, b82.A01, b82.A00));
    }

    private void A0O(C3809mY c3809mY, B8 b82) {
        if (c3809mY == null) {
            ...
            C3809mY c3809mY2 = new C3809mY(b82.A07, this.A09.A5E(b82.A07), b82.A00, true, this.A03, this);
            this.A0C.put(b82.A07.A02, c3809mY2);
            this.A06 = true;
            c3809mY2.start();
            return;
        }
    ...
    private void A0P(C3809mY c3809mY, B8 b82, int i) {
        C3M.A08(!c3809mY.A06);
        if (!A0U() || i >= this.A02) {
            A04(b82, 0, 0);
            c3809mY.A05(false);
    ...
    private void A0S(String str, int i) {
        ...
        if (str == null) {
            for (int i10 = 0; i10 < this.A0B.size(); i10++) {
                A0J(this.A0B.get(i10), i);
            }
            try {
                this.A0A.AJ6(i);
            } catch (IOException e4) {
                AnonymousClass44.A08(strA08, A08(157, 32, 101), e4);
            }
        } else {
            B8 b8A06 = A06(str, false);
            if (b8A06 != null) {
                ...
                try {
                    ...
                    AnonymousClass44.A08(strA08, A08(189, 34, 0) + str, e10);
                }
            }
        }
        A0B();
        ...
        try {
            switch (message.what) {
                ...
                case 8:
                    ...
                    break;
                case 9:
                    A0L((C3809mY) message.obj);
                    z10 = false;
                    break;
                case 10:
                    A0N((C3809mY) message.obj, AbstractC22614a.A0N(message.arg1, message.arg2));
                    return;
                case 11:
                    A0C();
                    return;
