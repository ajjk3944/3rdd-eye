...
public final class C23286p extends AbstractC3506hD {
    ...
    public C23286p(C3480gm c3480gm, String str) {
        super(c3480gm.A0B, str, A00(c3480gm));
        this.A01 = c3480gm;
    }

    public static C3479gl A00(C3480gm c3480gm) {
        return new C3479gl(c3480gm);
    }
    ...
    public final void A09() {
        this.A00 = new C3490gw(this.A01, this, A04());
    ...
    public final void A0G(RewardData rewardData) {
        ...
        if (super.A01.A01) {
            super.A01.A0F(2003, AbstractC2757Nu.A00(new Bundle(), rewardData));
    ...
    public final boolean A0J(Ad ad, RewardedVideoAd.RewardedVideoShowAdConfig rewardedVideoShowAdConfig) {
        int iA00 = ((C2840Rb) rewardedVideoShowAdConfig).A00();
        long jA01 = ((C2840Rb) rewardedVideoShowAdConfig).A01();
        if (super.A00.A6N()) {
            return false;
        }
        this.A01.A02(ad);
