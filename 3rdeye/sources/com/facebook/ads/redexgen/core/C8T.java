...
public final class C8T {
    ...
    public static String A03(int i, int i10, int i11) {
        ...
        for (int i12 = 0; i12 < bArrCopyOfRange.length; i12++) {
            ...
            bArrCopyOfRange[i12] = (byte) (i13 - 44);
        }
    ...
    private long A00() {
        ...
        if (this.A0M != -9223372036854775807L) {
            ...
            long jA0Q = AbstractC22614a.A0Q(elapsedTimeSinceStopUs, this.A00);
    ...
    private long A02(long j4) {
        return (1000000 * j4) / this.A04;
    }
    ...
    private void A04() {
        ...
        if (playbackPositionUs - systemTimeUs >= 30000) {
            ...
            long[] jArr = this.A0W;
            int i10 = this.A02;
            long systemTimeUs2 = AbstractC22614a.A0R(jA01, this.A00);
            jArr[i10] = systemTimeUs2 - playbackPositionUs;
            int i11 = this.A02 + 1;
            String[] strArr2 = A0Y;
    ...
    private void A07(long j4) {
        ...
        if (Math.abs(jA02 - j4) > 5000000) {
            this.A0V.AFP(jA01, jA02, j4, audioTimestampSystemTimeUs);
            if (A0Y[7].charAt(13) != 'y') {
                throw new RuntimeException();
            }
        ...
        if (Math.abs(A02(jA01) - audioTimestampSystemTimeUs) > 5000000) {
            this.A0V.AEi(jA01, jA02, j4, audioTimestampSystemTimeUs);
            c8q.A04();
        } else {
            c8q.A03();
        }
    ...
    private void A08(long j4) {
        if (this.A0R && this.A0P != null && j4 - this.A09 >= 500000) {
            try {
                this.A0E = (((Integer) AbstractC22614a.A0f((Integer) this.A0P.invoke(C3M.A01(this.A0N), new Object[0]))).intValue() * 1000) - this.A06;
    ...
    private void A09(long j4) {
        ...
        int state3 = AbstractC22614a.A02;
        if (state3 <= 29) {
    ...
    public static boolean A0B(int i) {
        return AbstractC22614a.A02 < 23 && (i == 5 || i == 6);
    }

    public final int A0C(long j4) {
        int bytesPending = (int) (j4 - (A00() * this.A03));
    ...
    public final long A0D(boolean z10) {
        ...
        if (useGetTimestampMode) {
            jA0Q = A02(c8q.A01()) + AbstractC22614a.A0Q(jNanoTime - c8q.A02(), this.A00);
        } else {
            int i = this.A05;
            if (A0Y[0].charAt(8) != '9') {
                throw new RuntimeException();
            ...
            if (i == 0) {
                ...
                jA0Q = AbstractC22614a.A0Q(this.A0K + jNanoTime, this.A00);
            }
            if (!z10) {
        ...
        long j4 = jNanoTime - this.A0H;
        if (j4 < 1000000) {
            long jA0Q2 = this.A0G + AbstractC22614a.A0Q(j4, this.A00);
            long j10 = (j4 * 1000) / 1000000;
            jA0Q = ((jA0Q * j10) + ((1000 - j10) * jA0Q2)) / 1000;
        }
        if (!this.A0U && jA0Q > this.A0B) {
            this.A0U = true;
            this.A0V.AEg(System.currentTimeMillis() - AbstractC22614a.A0P(AbstractC22614a.A0R(AbstractC22614a.A0P(jA0Q - this.A0B), this.A00)));
        }
        this.A0D = jNanoTime;
        this.A0B = jA0Q;
    ...
    public final void A0H(long j4) {
        this.A0L = A00();
        this.A0M = SystemClock.elapsedRealtime() * 1000;
        this.A07 = j4;
    }

    public final void A0I(AudioTrack audioTrack, boolean z10, int i, int i10, int i11) {
        this.A0N = audioTrack;
        this.A03 = i10;
        this.A01 = i11;
        ...
        this.A0T = z10 && A0B(i);
        this.A0R = AbstractC22614a.A15(i);
        this.A06 = this.A0R ? A02(i11 / i10) : -9223372036854775807L;
        this.A0I = 0L;
        this.A0J = 0L;
        this.A0F = 0L;
        this.A0Q = false;
    ...
    public final boolean A0L(long j4) {
        return j4 > A00() || A0A();
    }

    public final boolean A0M(long j4) {
        return this.A08 != -9223372036854775807L && j4 > 0 && SystemClock.elapsedRealtime() - this.A08 >= 200;
    }

    public final boolean A0N(long j4) {
        int playState = ((AudioTrack) C3M.A01(this.A0N)).getPlayState();
        if (this.A0T) {
            if (playState == 2) {
                this.A0Q = false;
        ...
        if (hadData && !this.A0Q && playState != 1) {
            this.A0V.AFY(this.A01, AbstractC22614a.A0P(this.A06));
        }
        return true;
    }
}
