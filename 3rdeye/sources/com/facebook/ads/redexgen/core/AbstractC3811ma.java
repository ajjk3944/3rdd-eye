...
public abstract class AbstractC3811ma<E> extends AbstractCollection<E> implements Serializable {
    public static byte[] A00 = null;
    public static final Object[] A01;
    public static final long serialVersionUID = 912559;

    public static String A0E(int i, int i10, int i11) {
    ...
    public abstract AbstractC2416Am<E> A0J();
    ...
    public final <T> T[] toArray(T[] tArr) {
        AbstractC3614jA.A04(tArr);
        int size = size();
        if (tArr.length < size) {
            Object[] objArrA0L = A0L();
            if (objArrA0L != null) {
                return (T[]) AbstractC3930oY.A02(objArrA0L, A0H(), A0G(), tArr);
            }
            tArr = (T[]) AbstractC3924oR.A05(tArr, size);
