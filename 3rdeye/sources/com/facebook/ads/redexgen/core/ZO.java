...
public final class ZO extends LinearLayout {
    ...
    public ZO(C3272dL c3272dL, WebView webView) {
        this(c3272dL, webView, false, false);
    }

    public ZO(C3272dL c3272dL, WebView webView, boolean z10, boolean z11) {
        super(c3272dL);
        this.A08 = getResources().getDisplayMetrics().density;
        this.A0B = new LQ(this);
        this.A09 = webView;
        this.A0A = c3272dL;
        this.A0C = U8.A06(c3272dL);
        this.A0E = z10;
        this.A0D = z11;
        A08();
        if (z11) {
    ...
    private void A08() {
        ...
        if (U7.A2o(this.A0A) && !this.A0E) {
            ...
            int i10 = (int) (this.A08 * 2.0f);
            int buttonSizePx2 = (int) (this.A08 * 2.0f);
            linearLayout.setPadding(0, i10, 0, buttonSizePx2);
            ...
            int i11 = (int) (this.A08 * 4.0f);
            int buttonSizePx3 = (int) (this.A08 * 4.0f);
            imageView.setPadding(0, i11, 0, buttonSizePx3);
