...
public abstract class XW {
    ...
    public static Bitmap A00(C3272dL c3272dL, Bitmap bitmap, int i) throws RSRuntimeException {
        ...
        try {
            renderScriptCreate = RenderScript.create(c3272dL);
    ...
    public static Bitmap A01(C3272dL c3272dL, Bitmap bitmap, int i, int i10) {
        ...
        if (width != 0 && height != 0) {
            ...
            try {
                bitmapCreateBitmap = A00(c3272dL, bitmapCreateBitmap, i);
                if (i10 != 1) {
                ...
                return new C2777Oq().A02(bitmapCreateBitmap, i);
            }
        }
        return null;
    }
