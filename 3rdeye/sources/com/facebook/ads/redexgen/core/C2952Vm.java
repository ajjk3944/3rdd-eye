...
public final class C2952Vm<T> implements InterfaceC2909Tu<T> {
    ...
    public C2901Tm A00;
    public C2901Tm A01;
    public List<C2952Vm<T>.RecordFileBasedFetch> A02 = new ArrayList();
    public boolean A03;
    public final C2900Tl A04;
    public final U1 A05;
    ...
    public synchronized boolean A06(C2953Vn c2953Vn) {
        if (!this.A02.remove(c2953Vn)) {
            return false;
        }
        if (c2953Vn.A6P() > 0 && c2953Vn.A01().A02.A05(c2953Vn.A01().A01).equals(this.A01)) {
            this.A01 = c2953Vn.A00().A02;
        }
        return true;
    }
    ...
    public C2952Vm(C2906Tr c2906Tr, InterfaceC2914Tz interfaceC2914Tz) throws IOException {
        this.A05 = new U1(c2906Tr.A04(A00(515, 4, 103)), interfaceC2914Tz);
        this.A04 = new C2900Tl(new File(c2906Tr.A05(), A00(509, 6, 60)));
        this.A00 = this.A04.A03();
        A05(interfaceC2914Tz);
        this.A01 = this.A00;
    }

    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.Vm != com.facebook.ads.internal.eventstorage.record.RecordFileBasedRecordDatabase<T> */
    private void A02(int i, int i10) throws IOException {
        this.A00 = new C2901Tm(i, i10);
    ...
    public synchronized void A03(C2953Vn c2953Vn) throws U3 {
        if (!this.A03) {
            if (A06(c2953Vn)) {
                if (c2953Vn.A6P() == 0) {
                    return;
                }
                if (this.A00.A04(c2953Vn.A00().A02) == 0) {
                    try {
                        Iterator<C2913Ty> it = c2953Vn.A00.iterator();
                        while (it.hasNext()) {
                            if (it.next().A00 == this.A05.A07() && this.A05.A0D()) {
                                A02(this.A05.A06(), 0);
                            } else {
                                A02(this.A05.A06(), c2953Vn.A00().A00);
                                break;
                            }
                        }
    ...
    */
    private void A05(com.facebook.ads.redexgen.core.InterfaceC2914Tz r13) throws java.io.IOException {
        /*
            r12 = this;
        ...
        L7c:
            ...
            goto L5c
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C2952Vm.A05(com.facebook.ads.redexgen.X.Tz):void");
    }

    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.Vm != com.facebook.ads.internal.eventstorage.record.RecordFileBasedRecordDatabase<T> */
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.Vn != com.facebook.ads.internal.eventstorage.record.RecordFileBasedRecordDatabase<T>$RecordFileBasedFetch */
    @Override // com.facebook.ads.redexgen.core.InterfaceC2909Tu
    public final synchronized InterfaceC2908Tt A6O(byte[] bArr, int[] iArr) throws U3 {
        C2952Vm<T>.RecordFileBasedFetch c2953Vn;
        if (!this.A03) {
            int i = 0;
            int i10 = 0;
            try {
                ...
                while (true) {
                    C2904Tp c2904TpA0A = this.A05.A0A(this.A01.A02(), this.A01.A03(), bArr, i, iArr, i10);
                    int iA00 = c2904TpA0A.A01().A00();
                    int storageOffset = c2904TpA0A.A01().A01();
                    int i11 = iA00 - storageOffset;
                    int storageOffset2 = c2904TpA0A.A01().A02();
                    i += storageOffset2;
                    i10 += i11;
                    if (c2904TpA0A.A01().A03() == EnumC2902Tn.A03) {
                        arrayList.add(c2904TpA0A);
                    }
                    if (c2904TpA0A.A01().A03() == EnumC2902Tn.A04) {
                        break;
                    }
                    if (c2904TpA0A.A01().A03() == EnumC2902Tn.A05) {
                        ...
                        this.A01 = new C2901Tm(storageOffset5 + 1, 0);
                    } else {
                        this.A01 = this.A01.A05(i11);
                    }
                }
                c2953Vn = new C2953Vn(this, arrayList, mayHaveMoreData);
                this.A02.add(c2953Vn);
                if (!arrayList.isEmpty()) {
                    C2901Tm c2901Tm = c2953Vn.A01().A02;
                    int storageOffset6 = c2953Vn.A01().A01;
                    this.A01 = c2901Tm.A05(storageOffset6);
                }
            } catch (IOException e4) {
                throw new U3(A00(306, 29, 84), e4);
            }
        } else {
