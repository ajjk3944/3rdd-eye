...
public abstract class H8 {
     ...
     */
    public static H7 A06(C4J c4j) throws C22172i {
        A0C(1, c4j, false);
        int iA0F = c4j.A0F();
        int iA0I = c4j.A0I();
        int iA0F2 = c4j.A0F();
    ...
    public static long A01(long j4, long j10) {
    ...
    public static Metadata A02(List<String> list) {
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            String[] strArrA1P = AbstractC22614a.A1P(str, A07(0, 1, 56));
            ...
            if (length != 2) {
                ...
                if (strArrA1P[0].equals(A07(63, 22, 85))) {
                    try {
                        ...
                        AnonymousClass44.A0A(strA07, A07(33, 30, 0), e4);
                    }
                } else {
    ...
    */
    public static com.facebook.ads.redexgen.core.H4 A03(com.facebook.ads.redexgen.core.H3 r15) throws com.facebook.ads.redexgen.core.C22172i {
        /*
    ...
    public static H5 A04(C4J c4j) throws C22172i {
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public static com.facebook.ads.redexgen.core.H5 A05(com.facebook.ads.redexgen.core.C4J r9, boolean r10, boolean r11) throws com.facebook.ads.redexgen.core.C22172i {
        /*
            if (r10 == 0) goto L7
            r1 = 3
            r0 = 0
    ...
    public static void A09(int i, H3 h32) throws C22172i {
        int i10;
        ...
        for (int i11 = 0; i11 < iA02; i11++) {
            ...
            if (iA022 != 0) {
                ...
                if (mappingsCount4 == 0) {
                    ...
                    throw C22172i.A01(A07(491, 58, 71), null);
                }
            }
        }
    }

    public static void A0A(H3 h32) throws C22172i {
        int iA02 = h32.A02(6) + 1;
        for (int i = 0; i < iA02; i++) {
            ...
            switch (iA022) {
                ...
                case 1:
                    ...
                    int j11 = 0;
                    int rangeBits = 0;
                    for (int count = 0; count < j4; count++) {
                ...
                default:
                    throw C22172i.A01(A07(199, 41, 99) + iA022, null);
            }
        }
    }

    public static void A0B(H3 h32) throws C22172i {
        int iA02 = h32.A02(6) + 1;
        for (int i = 0; i < iA02; i++) {
            ...
            if (residueCount <= 2) {
                ...
                throw C22172i.A01(A07(448, 43, 92), null);
            }
        }
    }

    public static boolean A0C(int i, C4J c4j, boolean z10) throws C22172i {
        if (c4j.A07() < 7) {
            if (z10) {
                return false;
            }
            throw C22172i.A01(A07(549, 18, 10) + c4j.A07(), null);
        }
        if (c4j.A0I() != i) {
            if (z10) {
                return false;
            }
            throw C22172i.A01(A07(178, 21, 53) + Integer.toHexString(i), null);
        }
        if (c4j.A0I() != 118 || c4j.A0I() != 111 || c4j.A0I() != 114 || c4j.A0I() != 98 || c4j.A0I() != 105 || c4j.A0I() != 115) {
            if (z10) {
                return false;
            }
            throw C22172i.A01(A07(95, 28, 49), null);
        }
        return true;
    }

    public static H6[] A0D(C4J c4j, int i) throws C22172i {
        A0C(5, c4j, false);
        int iA0I = c4j.A0I() + 1;
        ...
        for (int i10 = 0; i10 < timeCount; i10++) {
            ...
            if (numberOfBooks4 != 0) {
                throw C22172i.A01(A07(396, 52, 114), null);
            }
        }
        A0A(h32);
        A0B(h32);
        ...
        throw C22172i.A01(A07(240, 43, 105), null);
    }
    ...
    public static H6[] A0E(H3 h32) {
        ...
        for (int windowType = 0; windowType < iA02; windowType++) {
            ...
            int iA022 = h32.A02(16);
            int i = h32.A02(16);
            h6Arr[windowType] = new H6(zA04, iA022, i, h32.A02(8));
        }
        return h6Arr;
    }
}
