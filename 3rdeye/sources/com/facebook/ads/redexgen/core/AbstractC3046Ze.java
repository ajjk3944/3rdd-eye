...
public abstract class AbstractC3046Ze extends WebView {
    ...
    static {
        A0C();
        A02 = AbstractC3046Ze.class.getSimpleName();
    }

    public AbstractC3046Ze(Activity activity, C3272dL c3272dL) {
        super(activity);
        A0E(c3272dL);
    }

    public AbstractC3046Ze(C3272dL c3272dL) {
        super(c3272dL);
        A0E(c3272dL);
    }
    ...
    public static void A0D(int i) {
        ...
        if (context != null) {
            context.A08().AAy(A0B(56, 8, 37), i, new C2886Sw(A0B(35, 10, 3)));
        }
    }
