...
public final class Z4 extends ImageView {
    ...
    public Z4(C3272dL c3272dL, final Handler handler, Z6 z62, final int i, final View.OnClickListener onClickListener) {
        super(c3272dL);
        ...
        setOnClickListener(new View.OnClickListener() { // from class: com.facebook.ads.redexgen.X.Z2
            ...
            public final void onClick(View view) {
                this.A03.A02(onClickListener, handler, i, view);
            }
        });
    }
