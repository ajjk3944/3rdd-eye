...
public final class IV {
    ...
    public C2620Im A05;
    public final H1 A06;
    public final C2622Io A07 = new C2622Io();
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void A02() {
        C2621In c2621InA00 = A00();
        if (c2621InA00 == null) {
            return;
        }
        C4J c4j = this.A07.A0H;
        if (c2621InA00.A00 != 0) {
            c4j.A0g(c2621InA00.A00);
        }
    ...
    public final int A04() {
        ...
        if (c2621InA00.A00 != 0) {
            c4j = this.A07.A0H;
            vectorSize = c2621InA00.A00;
        } else {
            byte[] initVectorData = c2621InA00.A04;
    ...
    */
    ...
    public final void A07(DrmInitData drmInitData) {
        C2621In encryptionBox = this.A05.A00(this.A07.A06.A02);
        this.A06.A6W(this.A05.A07.A09(drmInitData.A01(encryptionBox != null ? encryptionBox.A02 : null)));
    }

    public final void A08(C2620Im c2620Im, IP ip) {
        this.A05 = (C2620Im) C3M.A01(c2620Im);
        this.A04 = (IP) C3M.A01(ip);
        this.A06.A6W(c2620Im.A07);
        A05();
    }
