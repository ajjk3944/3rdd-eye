...
public final class C2868Se {
    ...
    public C2868Se(Set<String> options, Integer num, Integer num2, String str) {
        this.A03 = options;
    ...
    public C2868Se(String[] strArr, Integer num, Integer num2) {
    ...
    public static C2868Se A00(String str) {
        if (str == null) {
            return null;
        }
        ...
        while (true) {
            ...
            if (zFind) {
                ...
                return new C2868Se(linkedHashSet, numValueOf, numValueOf2, str);
            }
        }
    }
    ...
    public final boolean equals(Object obj) {
        if (!(obj instanceof C2868Se)) {
            return false;
        }
        C2868Se c2868Se = (C2868Se) obj;
        if (this.A00 == c2868Se.A00 || (this.A00 != null && this.A00.equals(c2868Se.A00))) {
            return (this.A01 == c2868Se.A01 || (this.A01 != null && this.A01.equals(c2868Se.A01))) && this.A03.equals(c2868Se.A03);
        }
        return false;
    }
