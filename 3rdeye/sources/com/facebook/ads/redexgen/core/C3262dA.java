...
public final class C3262dA {
    ...
    public final C2723Ml A0Z;
    public final C2733Mw A0a;
    public final N0 A0b;
    public final N9 A0c;
    public final C3272dL A0d;
    public final C2915Ua A0e;
    ...
    public final int A0V = (int) AbstractC2975Wl.A02;
    ...
    public C3262dA(final C3272dL c3272dL, AbstractC3547hy abstractC3547hy, InterfaceC3003Xn interfaceC3003Xn, KE ke, Handler handler, C2915Ua c2915Ua) {
        this.A0d = c3272dL;
        this.A0Y = abstractC3547hy;
        this.A0e = c2915Ua;
        this.A0c = abstractC3547hy.A23();
        this.A0b = abstractC3547hy.A20().A0K();
        this.A0f = interfaceC3003Xn;
        this.A0W = handler;
        this.A0a = abstractC3547hy.A20().A0I();
        this.A0Z = abstractC3547hy.A1z();
        this.A0g = ke;
        this.A0R = new C23196g(c3272dL) { // from class: com.facebook.ads.redexgen.X.0c
            @Override // com.facebook.ads.redexgen.core.C23196g, android.view.ViewGroup
        ...
        this.A0P = new RelativeLayout(c3272dL);
        this.A0S = new C3086aK(c3272dL);
        this.A0Q = new TextView(c3272dL);
        this.A0M = new ImageView(c3272dL);
    ...
    private LinearLayout A06() {
        ...
        arrayList.add(new C3265dD(this.A0d).A02(new C3075a9(this.A0d, -1, -1, XX.RATINGS)).A04(this.A0a.A0B()).A03(this.A0a.A0A()));
        if (!this.A0a.A08().isEmpty()) {
            try {
                strA08 = AbstractC2984Wu.A01(Integer.parseInt(this.A0a.A08()));
            } catch (NumberFormatException unused) {
                strA08 = this.A0a.A08();
            }
            arrayList.add(new C3265dD(this.A0d).A02(new C3075a9(this.A0d, -1, -1, XX.NUCLEUS_GROUP)).A04(strA08).A03(this.A0a.A09()));
        }
        if (!this.A0a.A05().isEmpty()) {
            arrayList.add(new C3265dD(this.A0d).A02(new C3075a9(this.A0d, -1, -1, XX.DOWNLOAD)).A04(this.A0a.A05()).A03(this.A0a.A06()));
        }
        C2733Mw c2733Mw = this.A0a;
        if (A0j[2].length() == 29) {
            throw new RuntimeException();
        }
        A0j[2] = "3vpsIj";
        if (!c2733Mw.A01().isEmpty()) {
            arrayList.add(new C3265dD(this.A0d).A02(new C3075a9(this.A0d, -1, -1, XX.NUCLEUS_DURATION)).A04(this.A0a.A01()).A03(this.A0a.A0C()));
        }
        if (!this.A0a.A02().isEmpty()) {
            arrayList.add(new C3265dD(this.A0d).A02(new C3075a9(this.A0d, -1, -1, XX.GRID_4)).A04(this.A0a.A02()).A03(this.A0a.A03()));
        }
    ...
    private LinearLayout A07(RelativeLayout relativeLayout, KE ke) {
        ...
        linearLayout.setId(View.generateViewId());
        C3075a9 iconView = new C3075a9(this.A0d, -1, -1, XX.GOOGLE_PLAY_STORE);
    ...
    private RelativeLayout.LayoutParams A08(LinearLayout linearLayout) {
        int i;
        int i10 = this.A0d.getResources().getConfiguration().orientation;
        if (linearLayout == null || this.A0T || i10 == 2) {
    ...
    private RelativeLayout.LayoutParams A0B(C3086aK c3086aK) {
        RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-2, -2);
        layoutParams.addRule(14);
        layoutParams.addRule(3, c3086aK.getId());
    ...
    private TextView A0D(RelativeLayout relativeLayout, C3086aK c3086aK) {
        TextView textView = new TextView(this.A0d);
        ...
        textView.setLayoutParams(A0B(c3086aK));
        relativeLayout.addView(textView);
        textView.setId(View.generateViewId());
        return textView;
    }

    private C23196g A0E(KE ke) {
        this.A0R.setLayoutManager(new C3452gI(this.A0d, 0, false));
        ...
        this.A0R.setAdapter(new C2510Ef(this.A0d, this.A0b.A02(), this.A0H, this.A0R, ke, i));
        return this.A0R;
    }

    private C3086aK A0G(LinearLayout linearLayout) {
        C3086aK c3086aK = new C3086aK(this.A0d);
        c3086aK.setRadius(30);
        XP.A0K(c3086aK, 0);
        KZ downloadImageTask = new KZ(c3086aK, this.A0d).A04();
        downloadImageTask.A07(this.A0c.A01());
        c3086aK.setLayoutParams(A08(linearLayout));
        c3086aK.setId(View.generateViewId());
        return c3086aK;
    }
    ...
    private void A0I() {
        ...
        if (shouldShowThirdEndCard2 && this.A0b.A00() > 0) {
            ...
            AbstractC3264dC.A01(this.A0d, this.A0M, this.A0b.A00(), this.A0N);
        }
    }
    ...
    private void A0L() {
        ...
        if (parent2 instanceof ViewGroup) {
            this.A0h.set(true);
            ((ViewGroup) parent.getParent()).addView(new C3122au(this.A0d, this.A0Y, this.A0e, this.A0W, this.A0f).A0A(this.A0g, this.A0S));
            return;
        }
        this.A0f.A4b(strA0H);
    }
    ...
    public final FrameLayout A0T() {
        ...
        this.A0P = A0C();
        if (U7.A1C(this.A0d)) {
            this.A0P.setOnClickListener(new ViewOnClickListenerC3259d7(this));
        }
        A0P(this.A0P);
        this.A0O = A06();
        ...
        A0S(new InterfaceC3261d9() { // from class: com.facebook.ads.redexgen.X.Ep
            @Override // com.facebook.ads.redexgen.core.InterfaceC3261d9
    ...
    public final void A0W(int i) {
        if (!this.A0h.get()) {
            C2510Ef c2510Ef = (C2510Ef) this.A0R.getAdapter();
            if (this.A0g != null) {
    ...
    public final /* synthetic */ void A0Y(ImageView imageView, InterfaceC3261d9 interfaceC3261d9, C3055Zn c3055Zn) {
        ...
        if (drawable != null) {
            ...
            if (imageWidth > drawable.getIntrinsicHeight()) {
                ...
                if (imageWidth2 == 2) {
                    ...
                    this.A00 = this.A05;
                    AbstractC3547hy abstractC3547hy = this.A0Y;
                    if (A0j[1].charAt(29) == 'N') {
                        throw new RuntimeException();
                    }
                    A0j[1] = "S95acxw01Fp1FcMeAJU8kfpwrSO3Cs6T";
                    if (abstractC3547hy.A2H()) {
                        this.A00 = this.A05 - this.A0F;
                    }
                }
            }
    ...
    public final /* synthetic */ void A0Z(LinearLayout linearLayout) {
        ...
        if (this.A0Y.A2K()) {
            View view = new View(this.A0d);
            view.setOnClickListener(new ViewOnClickListenerC3260d8(this));
            if (this.A0d.getResources().getConfiguration().orientation == 2) {
