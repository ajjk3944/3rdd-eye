...
public class BE<V> extends AbstractC21931i<K, V>.WrappedCollection implements List<V> {
    ...
    public final boolean addAll(int index, Collection<? extends V> c10) {
        ...
        if (zAddAll) {
            AbstractC21931i.A02(this.A00, A02().size() - size);
            if (size == 0) {
                A03();
            }
        }
    ...
    public BE(@ParametricNullness final AbstractC21931i this$0, @CheckForNull Object key, List delegate, C3682kH ancestor) {
