...
public class PH extends ViewGroup {
     ...
     */
    private final void A0J(int i, int i10, int i11) throws Resources.NotFoundException {
        int scrollX;
        if (getChildCount() == 0) {
  ...
  0x0164: PHI (r5v4 float) = (r5v3 float), (r5v5 float) binds: [B:56:0x01c3, B:44:0x0162] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    ...
    private int A01(int i, float f10, int i10, int i11) {
        ...
        if (targetPage2 > 0) {
            ...
            return Math.max(i12, Math.min(i, targetPage4));
        }
        return i;
    }
    ...
    */
    ...
    private final P9 A05(int i, int i10) {
        P9 p92 = new P9();
        p92.A02 = i;
        p92.A03 = this.A01.A04(this, i);
        p92.A01 = this.A01.A00(i);
        if (i10 < 0 || i10 >= this.A0r.size()) {
            this.A0r.add(p92);
        } else {
            this.A0r.add(i10, p92);
        }
        return p92;
    }
    ...
    */
    ...
    private final void A0D() {
        ...
        P3.A0B(this, new C3464gV(this));
        if (P3.A00(this) == 0) {
            P3.A09(this, 1);
        }
        P3.A0C(this, new C3465gW(this));
    }
    ...
    */
    ...
    private void A0H(int i, float f10, int i10) {
        if (this.A0d != null) {
            int z10 = this.A0d.size();
    ...
    private final void A0I(int i, float f10, int i10) {
        int iMax;
        if (this.A0D > 0) {
    ...
    private void A0K(int i, int i10, int i11, int i12) {
        if (i10 > 0 && !this.A0r.isEmpty()) {
            if (!this.A0X.isFinished()) {
                this.A0X.setFinalX(getCurrentItem() * getClientWidth());
                return;
            }
            int paddingLeft = ((i - getPaddingLeft()) - getPaddingRight()) + i11;
    ...
    private final void A0L(int i, boolean z10) throws Resources.NotFoundException {
        this.A0m = false;
        A0N(i, z10, false);
    }

    private void A0M(int i, boolean z10, int i10, boolean z11) throws Resources.NotFoundException {
        P9 p9A04 = A04(i);
        int destX = 0;
        if (p9A04 != null) {
    ...
    private final void A0N(int i, boolean z10, boolean z11) throws Resources.NotFoundException {
        A0O(i, z10, z11, 0);
    }

    private final void A0O(int i, boolean z10, boolean z11, int i10) throws Resources.NotFoundException {
    ...
    */
    ...
    private boolean A0Z(int i) {
        ...
        int i10 = p9A03.A02;
        float f10 = ((i / currentPage) - p9A03.A00) / (p9A03.A01 + (this.A0M / currentPage));
        this.A0e = false;
    ...
    private final boolean A0d(View view, boolean z10, int i, int i10, int i11) {
        if (view instanceof ViewGroup) {
            ...
            for (int childCount = viewGroup.getChildCount() - 1; childCount >= 0; childCount--) {
                ...
                if (i10 + count >= childAt.getLeft() && i10 + count < childAt.getRight() && i11 + scrollY >= childAt.getTop() && i11 + scrollY < childAt.getBottom() && A0d(childAt, true, i, (i10 + count) - childAt.getLeft(), (i11 + scrollY) - childAt.getTop())) {
                    return true;
                }
            }
        }
    ...
    */
    ...
    public AbstractC2775Oo getAdapter() {
        return this.A01;
    }

    @Override // android.view.ViewGroup
    public final int getChildDrawingOrder(int i, int i10) {
        int result = this.A0F == 2 ? (i - 1) - i10 : i10;
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (this.A0M > 0 && this.A0S != null && this.A0r.size() > 0 && this.A01 != null) {
            ...
            for (int i10 = p92.A02; i10 < i; i10++) {
                while (i10 > p92.A02 && firstPos < itemCount) {
                    firstPos++;
  ...
  0x0073: PHI (r1v19 float) = (r1v12 float), (r1v20 float) binds: [B:35:0x00a0, B:27:0x0071] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    ...
    @Override // android.view.ViewGroup, android.view.View
    public final void onLayout(boolean z10, int i, int i10, int i11, int i12) throws Resources.NotFoundException {
        boolean z11;
        P9 p9A07;
        int paddingRight;
        int count;
                ...
                while (paddingBottom3 < scrollX) {
                    ...
                    if (childAt2.getVisibility() != count2) {
                        ...
                        if (!pa3.A05 && (p9A07 = A07(childAt2)) != null) {
                            int i14 = vgrav + ((int) (childLeft2 * p9A07.A00));
                            if (pa3.A03) {
                                pa3.A03 = false;
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public void setAdapter(com.facebook.ads.redexgen.core.AbstractC2775Oo r7) throws android.content.res.Resources.NotFoundException {
        /*
            r6 = this;
