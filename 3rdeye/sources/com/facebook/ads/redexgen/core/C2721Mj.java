...
public final class C2721Mj extends BroadcastReceiver {
    ...
    public C2721Mj(AnonymousClass64 anonymousClass64, Context context) {
        ...
        if (str3.length() == action4.length()) {
            ...
            if (str4.equals(action6)) {
                ...
                if (serializableExtra instanceof DL) {
                    ...
                    this.A01.A0h(EnumC3288db.A04, 1);
                    return;
                }
                if (serializableExtra instanceof DT) {
                    ...
                    if (serializableExtra instanceof C22383d) {
                        if (this.A01.getListener() != null) {
