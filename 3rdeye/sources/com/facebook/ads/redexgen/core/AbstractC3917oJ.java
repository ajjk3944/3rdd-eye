...
public abstract class AbstractC3917oJ {
     ...
     */
    public static boolean A01(@CheckForNull InterfaceC3912oE<?, ?> multimap, Object object) {
        if (object == multimap) {
            return true;
        }
        if (object instanceof InterfaceC3912oE) {
            return multimap.A49().equals(((InterfaceC3912oE) object).A49());
        }
        return false;
    }
    ...
    public static <K, V> InterfaceC2411Ah<K, V> A00(final Map<K, Collection<V>> map, final InterfaceC3625jM<? extends List<V>> factory) {
        return new C0Z<K, V>(map, factory) { // from class: com.facebook.ads.redexgen.X.0H
            public static final long serialVersionUID = 0;
            public transient InterfaceC3625jM<? extends List<V>> A00;
            ...
            /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.jM != com.google.common.base.Supplier<? extends java.util.List<V>> */
            {
                this.A00 = (InterfaceC3625jM) AbstractC3614jA.A04(factory);
            }
            ...
            private void readObject(ObjectInputStream stream) throws ClassNotFoundException, IOException {
                ...
                this.A00 = (InterfaceC3625jM) Objects.requireNonNull(stream.readObject());
