...
public final class C3416fh extends R8 implements MediaViewApi, Repairable, SM {
    ...
    private void A07() {
        ...
        EnumC2980Wq.A04(this.A09, EnumC2980Wq.A0B);
        EnumC2980Wq.A04(this.A05, EnumC2980Wq.A0B);
        EnumC2980Wq.A04(this.A01, EnumC2980Wq.A0B);
    }
    ...
    private void A0A(View view, C2815Qc c2815Qc) {
        if (this.A0B != null) {
        ...
        String strA1D = c2815Qc.A1D();
        if (this.A03.getContext() == null) {
            return;
        }
        this.A0B = AbstractC3247cv.A01(this.A07, strA1D);
        if (this.A0B != null) {
            RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-1, -1);
    ...
    private final void A0C(C3272dL c3272dL, AttributeSet attributeSet, int i, int i10, MediaView mediaView) {
        this.A03 = mediaView;
        A0B(new ImageView(c3272dL, attributeSet, i, i10));
        A0H(new C3053Zl(c3272dL, attributeSet, i, i10));
        this.A08 = new C0L(c3272dL, attributeSet, i);
        A06();
        setVideoRenderer(new DefaultMediaViewVideoRenderer(c3272dL, attributeSet, i, i10));
        A07();
    }

    private final void A0D(C3272dL c3272dL, AttributeSet attributeSet, int i, MediaView mediaView) {
        this.A03 = mediaView;
        A0B(new ImageView(c3272dL, attributeSet, i));
        A0H(new C3053Zl(c3272dL, attributeSet, i));
        this.A08 = new C0L(c3272dL, attributeSet, i);
        A06();
        setVideoRenderer(new DefaultMediaViewVideoRenderer(c3272dL, attributeSet, i));
        A07();
    }

    private final void A0E(C3272dL c3272dL, AttributeSet attributeSet, MediaView mediaView) {
        this.A03 = mediaView;
        A0B(new ImageView(c3272dL, attributeSet));
        A0H(new C3053Zl(c3272dL, attributeSet));
        this.A08 = new C0L(c3272dL, attributeSet);
        A06();
        setVideoRenderer(new DefaultMediaViewVideoRenderer(c3272dL, attributeSet));
        A07();
    }

    private final void A0F(C3272dL c3272dL, MediaView mediaView) {
        this.A03 = mediaView;
        A0B(new ImageView(c3272dL));
        A0H(new C3053Zl(c3272dL));
        this.A08 = new C0L(c3272dL);
        A06();
        setVideoRenderer(new DefaultMediaViewVideoRenderer(c3272dL));
        A07();
    }

    private void A0G(C2815Qc c2815Qc, boolean z10, C2930Up c2930Up) {
        KZ kzA04 = new KZ(this.A02, this.A07).A04();
        if (z10) {
            kzA04.A06(new C3423fo(this, c2815Qc));
        }
        kzA04.A07(c2930Up.getUrl());
    }

    private void A0H(C3053Zl c3053Zl) {
        if (!this.A0D) {
            if (this.A09 != null) {
                this.A03.removeView(this.A09);
            }
            c3053Zl.setVisibility(8);
            RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-1, -1);
            layoutParams.addRule(13);
            this.A03.addView(c3053Zl, layoutParams);
            this.A09 = c3053Zl;
            return;
        }
    ...
    */
    public final void A0L(com.facebook.ads.NativeAd r18) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C3416fh.A0L(com.facebook.ads.NativeAd):void");
    }

    public final void A0M(NativeAdBaseApi nativeAdBaseApi, boolean z10) {
        C3272dL c3272dLA12 = ((C2815Qc) nativeAdBaseApi).A12();
        C3272dL adObjectContext = this.A07;
        adObjectContext.A0L(c3272dLA12);
        c3272dLA12.A0O(this);
        this.A0D = true;
        C2815Qc c2815QcA0L = C2815Qc.A0L(nativeAdBaseApi);
        c2815QcA0L.A1S(this.A03);
        ...
        if (this.A01 != null) {
            ...
            if (this.A01 instanceof C3044Zc) {
                ((C3044Zc) this.A01).A04();
            } else {
                ((C23196g) this.A01).setAdapter(null);
            }
        }
        ...
        if (adIcon != null) {
            ...
            if (bitmapA0N != null) {
                ...
                if (z10) {
                    this.A03.post(new C3424fp(this, c2815QcA0L));
                }
            } else {
                A0G(c2815QcA0L, z10, adIcon);
            }
        } else {
            QQ qqA16 = c2815QcA0L.A16();
            AdErrorType adErrorType = AdErrorType.NATIVE_AD_IS_NOT_LOADED;
            c3272dLA12.A0F().A3F(c2815QcA0L.A0y(), adErrorType.getErrorCode(), adErrorType.getDefaultErrorMessage());
            if (qqA16 != null) {
                qqA16.ADB(V1.A00(adErrorType));
            }
            Log.e(A04(46, 17, 121), adErrorType.getDefaultErrorMessage());
            if (nativeAdBaseApi.isAdLoaded()) {
                C3272dL adObjectContext2 = this.A07;
                adObjectContext2.A08().AAy(A04(258, 3, 44), AbstractC2885Sv.A0W, new C2886Sw(A04(192, 23, 42)));
            }
        }
        A0A(this.A02, c2815QcA0L);
    }
    ...
    */
    public final int getMediaWidth() {
        /*
            ...
            java.lang.String[] r2 = com.facebook.ads.redexgen.core.C3416fh.A0F
            r0 = 2
            r1 = r2[r0]
            r0 = 0
            r2 = r2[r0]
        ...
        L35:
            ...
            java.lang.String[] r1 = com.facebook.ads.redexgen.core.C3416fh.A0F
            r0 = 1
            r1 = r1[r0]
            r0 = 7
            char r1 = r1.charAt(r0)
        ...
        L7c:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C3416fh.getMediaWidth():int");
    }
    ...
    public final void initialize(AdViewConstructorParams adViewConstructorParams, MediaView mediaView) {
        ...
        switch (adViewConstructorParams.getInitializationType()) {
            ...
            case 2:
                ...
                A0D(c3272dL, attributeSet, adViewConstructorParams.getDefStyleAttr(), mediaView);
                break;
            case 3:
    ...
    public final void setListener(MediaViewListener mediaViewListener) {
        ...
        if (mediaViewListener == null) {
            ...
            ((RH) this.A05.getMediaViewVideoRendererApi()).A07(new C3417fi(this, mediaViewListener));
        }
    }
    ...
    public final void setVideoRenderer(MediaViewVideoRenderer mediaViewVideoRenderer) {
        if (!this.A0D) {
            ...
            RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-1, -1);
            layoutParams.addRule(13);
            ((C3416fh) this.A03.getMediaViewApi()).A09(mediaViewVideoRenderer, layoutParams);
