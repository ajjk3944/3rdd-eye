...
public final class C3285dY extends RelativeLayout {
    ...
    public int A00;
    public C22242p A01;
    public WeakReference<InterfaceC3284dX> A02;
    public final InterfaceC3340eS A03;

    public C3285dY(C3272dL c3272dL, InterfaceC3340eS interfaceC3340eS) {
        super(c3272dL);
        this.A00 = 0;
        this.A03 = interfaceC3340eS;
        XP.A0H((View) this.A03);
        addView(this.A03.getView(), new RelativeLayout.LayoutParams(-1, -1));
    }

    private void A00(AnimatorSet animatorSet, final int i, final boolean z10) {
        ...
        valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.facebook.ads.redexgen.X.dU
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                this.A01.A04(z10, i, valueAnimator);
            }
        });
    ...
    public final void A01(AnimatorSet animatorSet, boolean z10) {
        if (z10) {
            ...
            C3282dV c3282dV = new C3282dV(this);
            this.A03.getView().setOutlineProvider(c3282dV);
            if (this.A01 != null) {
                this.A01.setClipToOutline(true);
                this.A01.setOutlineProvider(c3282dV);
            }
    ...
    public final void A02(AbstractC2479Da abstractC2479Da) {
        addView(abstractC2479Da, new RelativeLayout.LayoutParams(-1, -1));
        this.A01 = (C22242p) abstractC2479Da;
    }

    public final void A03(AbstractC2479Da abstractC2479Da) {
        XP.A0H(abstractC2479Da);
        this.A01 = null;
    }

    public final /* synthetic */ void A04(boolean z10, int i, ValueAnimator valueAnimator) {
    ...
    public final void onMeasure(int i, int i10) {
        ...
        WeakReference<InterfaceC3284dX> weakReference = this.A02;
    ...
    public void setRoundedCornersVideoStyle(float f10) {
        this.A03.getView().setClipToOutline(true);
        this.A03.getView().setOutlineProvider(new C3283dW(this, f10));
    }

    public void setViewImplInflationListener(InterfaceC3284dX interfaceC3284dX) {
        this.A02 = new WeakReference<>(interfaceC3284dX);
    }
}
