...
public final class KI extends OE {
    ...
    private void A02() {
        ...
        new KZ(c3086aK, this.A03).A05(A0D, A0D).A07(this.A02.A23().A01());
        ...
        layoutParams2.addRule(3, c3086aK.getId());
        ...
        C3088aM c3088aM = new C3088aM(this.A03, A0B, 5, A0A, -1);
        c3088aM.setGravity(16);
        linearLayout.addView(c3088aM, new LinearLayout.LayoutParams(-2, -1));
        ...
        if (TextUtils.isEmpty(this.A02.A20().A0I().A0B())) {
            ...
            c3088aM.setRating(Float.parseFloat(this.A02.A20().A0I().A0B()));
    ...
    public KI(C3272dL c3272dL, AbstractC3547hy abstractC3547hy, US us, InterfaceC3003Xn interfaceC3003Xn) {
        super(c3272dL);
        this.A05 = new XH();
        this.A03 = c3272dL;
        ...
        AbstractC3093aR.A00(c3272dL, this.A01, abstractC3547hy.A20().A0H().A08());
    ...
    private void A01() {
        KE ke = new KE(this.A03, EnumC3294dh.A04.A03(), this.A02.A1z().A01(), this.A02.A20().A0J().A06(), this.A04, this.A06, null, this.A05, this.A02.A21());
