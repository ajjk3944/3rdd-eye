...
public final class AnonymousClass15 extends AbstractC23899l {
    public int A00;
    public Uri A01;
    ...
    public AnonymousClass15(int i, int i10) {
        super(true);
        this.A06 = i10;
        this.A08 = new byte[i];
    ...
    public final long AFy(AnonymousClass56 anonymousClass56) throws IOException {
        ...
        try {
            ...
            throw new C3872nZ(e4, 2001);
        } catch (SecurityException e10) {
            throw new C3872nZ(e10, 2006);
        }
    }
    ...
    public final int read(byte[] bArr, int i, int i10) throws IOException {
        ...
        if (this.A00 == 0) {
            try {
                ...
                throw new C3872nZ(e4, 2002);
            } catch (IOException e10) {
                throw new C3872nZ(e10, 2001);
            }
        }
