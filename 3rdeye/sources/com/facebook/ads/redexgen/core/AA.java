...
public final class AA implements InterfaceC3999px {
    ...
    public final InterfaceC4002q2 A03;
    ...
    private final void A02(List<Rect> list) {
        ...
        Iterator<InterfaceC4003q3> it = this.A03.iterator();
        if (it.hasNext()) {
            it.next();
    ...
    public AA(View view, InterfaceC4002q2 interfaceC4002q2) {
        this.A00 = new WeakReference<>(view);
        this.A03 = interfaceC4002q2;
    }

    @Override // com.facebook.ads.redexgen.core.InterfaceC3999px
