...
public final class C3692kR implements GX {
    ...
    public static final InterfaceC2558Gb A05;
    public GY A00;
    public AbstractC2633Iz A01;
    public boolean A02;
    ...
    static {
        A02();
        A05 = new InterfaceC2558Gb() { // from class: com.facebook.ads.redexgen.X.kS
    ...
    private boolean A03(InterfaceC3738lN interfaceC3738lN) throws IOException {
        C2629Iv c2629Iv = new C2629Iv();
        if (!c2629Iv.A05(interfaceC3738lN, true) || (c2629Iv.A04 & 2) != 2) {
            return false;
        }
        int length = Math.min(c2629Iv.A00, 8);
        C4J c4j = new C4J(length);
        interfaceC3738lN.AG9(c4j.A0l(), 0, length);
        if (C3694kT.A01(A00(c4j))) {
            this.A01 = new C3694kT();
        } else if (C3689kO.A06(A00(c4j))) {
            this.A01 = new C3689kO();
        } else {
            if (!C3691kQ.A02(A00(c4j))) {
                return false;
            }
            this.A01 = new C3691kQ();
        }
        return true;
    }

    public static /* synthetic */ GX[] A04() {
        return new GX[]{new C3692kR()};
    }
    ...
    public final int AGb(InterfaceC3738lN interfaceC3738lN, C2576Gt c2576Gt) throws IOException {
        ...
        if (this.A01 == null) {
            if (A03(interfaceC3738lN)) {
                ...
                throw C22172i.A01(A01(0, 34, 2), null);
            }
        }
        ...
        return this.A01.A04(interfaceC3738lN, c2576Gt);
    }
