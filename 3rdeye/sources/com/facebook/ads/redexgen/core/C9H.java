...
public final class C9H implements InterfaceC3804mT {
    ...
    public boolean A00;
    public final InterfaceC22734m A01;
    ...
    public static B8 A01(Cursor cursor) {
        ...
        return new B8(downloadRequestA05, i, cursor.getLong(7), cursor.getLong(8), cursor.getLong(9), cursor.getInt(10), i == 4 ? cursor.getInt(11) : 0, bu);
    }
    ...
    public C9H(InterfaceC22734m interfaceC22734m) {
        this(interfaceC22734m, A04(0, 0, 21));
    }

    public C9H(InterfaceC22734m interfaceC22734m, String str) {
        this.A03 = str;
        this.A01 = interfaceC22734m;
        this.A04 = A04(448, 18, 64) + str;
        this.A02 = new Object();
    }

    private Cursor A00(String str, String[] strArr) throws C22724l {
        try {
    ...
    private List<B8> A08(SQLiteDatabase sQLiteDatabase) {
        ...
        if (!AbstractC22614a.A19(sQLiteDatabase, this.A04)) {
            return arrayList;
        }
    ...
    public static List<StreamKey> A09(String str) {
        ...
        for (String str2 : AbstractC22614a.A1O(str, A04(412, 1, 1))) {
            String[] strArrA1O = AbstractC22614a.A1O(str2, A04(466, 2, 2));
    ...
    private void A0A() throws C22724l {
        synchronized (this.A02) {
            ...
            try {
                ...
                int iA00 = AbstractC22754o.A00(readableDatabase, 0, this.A03);
                if (iA00 != 3) {
                    SQLiteDatabase writableDatabase = this.A01.getWritableDatabase();
                    writableDatabase.beginTransactionNonExclusive();
                    try {
                        AbstractC22754o.A04(writableDatabase, 0, this.A03, 3);
    ...
    private void A0C(B8 b82, SQLiteDatabase sQLiteDatabase) throws SQLException {
        byte[] bArr = b82.A07.A06 == null ? AbstractC22614a.A07 : b82.A07.A06;
        ContentValues contentValues = new ContentValues();
        contentValues.put(A04(607, 2, 119), b82.A07.A02);
        contentValues.put(A04(625, 9, 108), b82.A07.A03);
    ...
    public final B8 A7i(String str) throws C22724l {
        A0A();
        try {
    ...
    @Override // com.facebook.ads.redexgen.core.BL
    public final C3814md A7j(int... iArr) throws C22724l {
        A0A();
        return new C3814md(A00(A07(iArr), null));
    }

    @Override // com.facebook.ads.redexgen.core.InterfaceC3804mT
    public final void AGV(B8 b82) throws C22724l, SQLException {
        A0A();
        try {
            SQLiteDatabase writableDatabase = this.A01.getWritableDatabase();
    ...
    @Override // com.facebook.ads.redexgen.core.InterfaceC3804mT
    public final void AHh(String str) throws C22724l {
        A0A();
        try {
    ...
    @Override // com.facebook.ads.redexgen.core.InterfaceC3804mT
    public final void AIe() throws C22724l {
        A0A();
        try {
            ContentValues contentValues = new ContentValues();
    ...
    @Override // com.facebook.ads.redexgen.core.InterfaceC3804mT
    public final void AJ5() throws C22724l {
        A0A();
        try {
            ContentValues contentValues = new ContentValues();
    ...
    @Override // com.facebook.ads.redexgen.core.InterfaceC3804mT
    public final void AJ6(int i) throws C22724l {
        A0A();
        try {
            ContentValues contentValues = new ContentValues();
    ...
    @Override // com.facebook.ads.redexgen.core.InterfaceC3804mT
    public final void AJ7(String str, int i) throws C22724l {
        A0A();
        try {
            ContentValues contentValues = new ContentValues();
            contentValues.put(A04(698, 11, 116), Integer.valueOf(i));
