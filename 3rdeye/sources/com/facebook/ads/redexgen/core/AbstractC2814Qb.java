...
public abstract class AbstractC2814Qb {
    ...
    public abstract void A0H(int i, int i10, C2816Qd c2816Qd, QZ qz);

    public abstract void A0I(View view, C2816Qd c2816Qd, QZ qz);
    ...
    public void A04(int i, int i10) {
        C23196g c23196g = this.A03;
        if (!this.A05 || this.A00 == -1 || c23196g == null) {
            A09();
        }
        this.A04 = false;
        if (this.A01 != null) {
            if (A00(this.A01) == this.A00) {
                A0I(this.A01, c23196g.A0s, this.A06);
                this.A06.A05(c23196g);
                A09();
            } else {
        ...
        if (this.A05) {
            A0H(i, i10, c23196g.A0s, this.A06);
    ...
    public final void A0D(C23196g c23196g, QO qo) {
        this.A03 = c23196g;
        this.A02 = qo;
        if (this.A00 != -1) {
