...
public abstract class AbstractC2666Kg {
    ...
    public static int A00(byte[] bArr, int i, int i10) {
    ...
    public static long A01(C4J c4j, int i, int i10) {
        c4j.A0f(i);
        if (c4j.A07() < 5) {
    ...
    */
    public static boolean A03(byte[] r6, int r7, int r8, int r9) {
        ...
        L2:
            ...
            if (r3 > r0) goto L41
            int r5 = r3 * 188
            java.lang.String[] r2 = com.facebook.ads.redexgen.core.AbstractC2666Kg.A00
            r0 = 3
            r1 = r2[r0]
            r0 = 6
            r0 = r2[r0]
        ...
        L41:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.AbstractC2666Kg.A03(byte[], int, int, int):boolean");
    }
}
