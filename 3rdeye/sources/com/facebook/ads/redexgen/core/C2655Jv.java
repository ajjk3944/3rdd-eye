...
public final class C2655Jv {
    ...
    public static void A0A(C4J c4j, C2659Jz c2659Jz, StringBuilder sb) {
        A09(c4j);
        String strA03 = A03(c4j, sb);
        String strA01 = A01(0, 0, 111);
        if (strA01.equals(strA03)) {
        ...
        if (property.length() != 9) {
            ...
            if (position != value.charAt(6)) {
                A03[7] = Constants.REVENUE_AMOUNT_KEY;
    ...
    private void A0B(C2659Jz c2659Jz, String str) {
        ...
        if (iIndexOf != -1) {
            ...
            if (matcher.matches()) {
                c2659Jz.A0N((String) C3M.A01(matcher.group(1)));
            }
            str = str.substring(0, iIndexOf);
        }
        String[] strArrA1O = AbstractC22614a.A1O(str, A01(47, 2, 9));
        String str2 = strArrA1O[0];
        int iIndexOf2 = str2.indexOf(35);
        if (iIndexOf2 != -1) {
            c2659Jz.A0M(str2.substring(0, iIndexOf2));
            int voiceStartIndex = iIndexOf2 + 1;
            c2659Jz.A0L(str2.substring(voiceStartIndex));
        } else {
            c2659Jz.A0M(str2);
        }
        ...
        if (voiceStartIndex2 > 1) {
            ...
            c2659Jz.A0O((String[]) AbstractC22614a.A1J(strArrA1O, 1, voiceStartIndex3));
        }
    }
    ...
    */
    public static void A0C(java.lang.String r6, com.facebook.ads.redexgen.core.C2659Jz r7) {
        /*
            java.util.regex.Pattern r1 = com.facebook.ads.redexgen.core.C2655Jv.A04
            java.lang.String r0 = com.facebook.ads.redexgen.core.AbstractC3579iY.A01(r6)
        ...
        L94:
            r3 = 3
            java.lang.String[] r1 = com.facebook.ads.redexgen.core.C2655Jv.A03
            r0 = 6
            r0 = r1[r0]
            int r1 = r0.length()
            r0 = 22
            if (r1 == r0) goto Lad
            java.lang.String[] r2 = com.facebook.ads.redexgen.core.C2655Jv.A03
        ...
        Lba:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C2655Jv.A0C(java.lang.String, com.facebook.ads.redexgen.X.Jz):void");
    }
    ...
    public final List<C2659Jz> A0F(C4J c4j) {
        String selector;
        ...
        while (true) {
            ...
            C2659Jz c2659Jz = new C2659Jz();
            A0B(c2659Jz, selector2);
            String strA04 = null;
            boolean z10 = false;
            while (true) {
                ...
                if (!z10) {
                    this.A00.A0f(iA092);
                    A0A(this.A00, c2659Jz, this.A01);
                }
            }
            if (selector.equals(strA04)) {
                arrayList.add(c2659Jz);
            }
        }
    }
}
