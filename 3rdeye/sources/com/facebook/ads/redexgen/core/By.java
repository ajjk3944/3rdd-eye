...
public class By implements InterfaceC3376f2 {
    public static byte[] A05;
    public JSONObject A00;
    public JSONObject A01;
    public final EnumC3377f3 A03;
    public final List<InterfaceC3378f4> A04 = new ArrayList();
    ...
    public By(EnumC3377f3 enumC3377f3) {
        this.A03 = enumC3377f3;
    }
    ...
    private boolean A02(JSONObject jSONObject, JSONObject jSONObject2) {
        ...
        return true ^ AbstractC3375f1.A02(jSONObject, jSONObject2);
    }
    ...
    public final synchronized boolean A03(JSONObject jSONObject, JSONObject jSONObject2) {
        if (jSONObject != null) {
            ...
            if (jSONObject2 == null || this.A03.A05()) {
                ...
                this.A02 = true;
                Iterator<InterfaceC3378f4> it = this.A04.iterator();
                while (it.hasNext()) {
                    it.next().A4e();
                }
                try {
    ...
    @Override // com.facebook.ads.redexgen.core.InterfaceC3376f2
    public final synchronized void A3t(InterfaceC3378f4 interfaceC3378f4) {
        this.A04.add(interfaceC3378f4);
    }
