...
public final class C7K implements InterfaceC3584id {
    ...
    private void A05(C6M c6m, C3556iB c3556iB, SF sf, MX mx, Y9 y92) {
        String strA7G = c3556iB.A7G();
        if (!TextUtils.isEmpty(strA7G)) {
            sf.A0e(new C2915Ua(strA7G, c6m.A0A()));
        }
        C2930Up c2930UpA0F = c3556iB.A0F();
        String[] strArr = A0A;
        ...
        if (c2930UpA0F != null) {
            SD sd = new SD(c3556iB.A0F().getUrl(), c3556iB.A0F().getHeight(), c3556iB.A0F().getWidth(), c3556iB.A0Y(), A03(2, 16, 120));
            sd.A01 = new SL(false, -1, -1);
            sf.A0W();
            sf.A0c(sd);
        }
        if (c3556iB.A0E() != null) {
            sf.A0c(new SD(c3556iB.A0E().getUrl(), c3556iB.A0E().getHeight(), c3556iB.A0E().getWidth(), c3556iB.A0Y(), A03(2, 16, 120)));
        }
        String strA0b = c3556iB.A0b();
        if (strA0b != null && !TextUtils.isEmpty(strA0b)) {
            sf.A0b(new SB(strA0b, c3556iB.A0Y(), A03(2, 16, 120), c3556iB.A0A()));
        }
        C3570iP c3570iP = new C3570iP(this, y92, mx, c6m);
        String strA0Y = c3556iB.A0Y();
        String clientToken2 = A03(2, 16, 120);
        sf.A0X(c3570iP, new S8(strA0Y, clientToken2));
    }
    ...
    public final void AAk(C6M c6m, US us, V4 v42, MX mx, JSONObject jSONObject, TF tf) {
        ...
        C3556iB c3556iBA00 = AbstractC2718Mg.A00(c6m, jSONObject, AbstractC2981Wr.A02(jSONObject, A03(0, 2, 60)));
        this.A04 = c3556iBA00;
        if (!ML.A06(c6m, c3556iBA00, us)) {
            Y8 adViewListener = new C3572iR(this, c6m);
            this.A06 = adViewListener;
            Y9 y92 = new Y9(c6m, us, sf, new WeakReference(adViewListener), tf.A04(), tf.A07(), tf.A08(), tf.A09(), c3556iBA00, this.A08);
            this.A07 = y92;
            this.A03 = new C3558iD(c6m, new C3571iQ(this, c6m, mx), y92.getViewabilityChecker(), us, c3556iBA00);
            A05(c6m, c3556iBA00, sf, mx, y92);
    ...
    public final void onDestroy() {
        if (this.A05 != null) {
            InterfaceC3613j9 interfaceC3613j9A0F = this.A05.A0F();
            String[] strArr = A0A;
            if (strArr[1].charAt(24) == strArr[4].charAt(24)) {
                throw new RuntimeException();
            }
            A0A[7] = "tMGyCfr9ucO4oWdztKDfdPlDfRrhkMp8";
            interfaceC3613j9A0F.A4D(this.A07 != null);
        }
        if (this.A07 != null) {
            this.A07.A0I();
            this.A07 = null;
