...
public final class C2955Vp implements InterfaceC2898Tj {
    ...
    public final InterfaceC2909Tu<UP> A01;
    public final InterfaceC2909Tu<UP> A02;
    ...
    */
    public final int A0B(int r13, java.util.Set<java.lang.String> r14, java.util.Set<java.lang.String> r15) throws org.json.JSONException {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C2955Vp.A0B(int, java.util.Set, java.util.Set):int");
    }

    static {
        A03();
        A05 = C2955Vp.class.getSimpleName();
    }

    public C2955Vp(C3246cu c3246cu) throws IOException {
        this.A00 = c3246cu;
        this.A01 = new C2952Vm(C2906Tr.A00(A00(11, 28, 27), c3246cu), new W7(this));
        this.A02 = new C2952Vm(C2906Tr.A00(A00(322, 37, 96), c3246cu), new W3(this));
    }
    ...
    private List<JSONObject> A01(List<JSONObject> list, byte[] bArr, int[] iArr) {
        ...
        for (int i10 : iArr) {
            ...
            try {
                list.add(A02(bArr, i, i10));
            } catch (JSONException jsone) {
                if (this.A00.A05().AAF()) {
                    Log.e(A05, A00(85, 45, 14), jsone);
                }
                int start = AbstractC2885Sv.A2P;
                A05(start, jsone);
            }
            i += i10;
        }
    ...
    public static JSONObject A02(byte[] bArr, int i, int i10) throws JSONException {
        return new JSONObject(new String(Arrays.copyOfRange(bArr, i, i + i10)));
    }
    ...
    public void A04(int i, String str) {
        ...
        c2886Sw.A05(1);
        this.A00.A08().AAz(A00(425, 15, 3), i, c2886Sw);
    }

    private void A05(int i, Throwable th) {
        this.A00.A08().AAy(A00(425, 15, 3), i, new C2886Sw(th));
    }

    public static byte[] A07(SQ sq, String str, UP up) throws JSONException {
    ...
    */
    public final java.util.List<org.json.JSONObject> A0C(int r8) {
        ...
        L69:
            ...
            com.facebook.ads.redexgen.X.Tt r0 = (com.facebook.ads.redexgen.core.InterfaceC2908Tt) r0     // Catch: com.facebook.ads.redexgen.core.U3 -> L79
        ...
        L79:
            ...
            boolean r0 = r0.AAF()
            if (r0 == 0) goto L95
            java.lang.String r3 = com.facebook.ads.redexgen.core.C2955Vp.A05
        ...
        L95:
            int r0 = com.facebook.ads.redexgen.core.AbstractC2885Sv.A2M
            r7.A05(r0, r4)
        L9a:
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C2955Vp.A0C(int):java.util.List");
    }
    ...
    public final void A4t() {
        try {
            ...
            if (this.A00.A05().AAF()) {
                Log.e(A05, A00(55, 30, 73), e4);
            }
            A05(AbstractC2885Sv.A2J, e4);
        }
    }
    ...
    public final void AKL(UP up, AbstractC2896Tg<String> abstractC2896Tg) {
        XR.A00(XU.A07, new AsyncTaskC2899Tk(up, abstractC2896Tg, this.A01, this.A00), new Void[0]);
    }
}
