...
public final class RL implements NativeAdScrollViewApi {
    ...
    public RL(NativeAdScrollView nativeAdScrollView, Context context, NativeAdsManager nativeAdsManager, NativeAdScrollView.AdViewProvider adViewProvider, int i, NativeAdView.Type type, NativeAdViewAttributes nativeAdViewAttributes, int i10) throws Resources.NotFoundException {
        if (nativeAdsManager.isLoaded()) {
            if (type != null || adViewProvider != null || i > 0) {
                ...
                this.A02 = type;
                this.A00 = i10;
                C3414ff c3414ff = new C3414ff(this);
                this.A05 = new C3413fe(context);
                if (this.A02 == null) {
                    if (i > 0) {
                        this.A05.A00(((int) AbstractC2975Wl.A02) * i);
                    }
                } else {
                    this.A05.A00((int) (AbstractC2975Wl.A02 * this.A02.getHeight()));
                }
                this.A05.setAdapter(c3414ff);
                setInset(20);
                c3414ff.A09();
