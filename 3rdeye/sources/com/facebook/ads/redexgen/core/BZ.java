...
public abstract class BZ implements InterfaceC3615jB<Character> {
    ...
    public static C21600b A02(final char match) {
        return new AbstractC22001p(match) { // from class: com.facebook.ads.redexgen.X.0b
            ...
            public static String A00(int i, int i10, int i11) {
                ...
                for (int i12 = 0; i12 < bArrCopyOfRange.length; i12++) {
                    byte b10 = (byte) ((bArrCopyOfRange[i12] ^ i11) ^ 115);
                    if (A02[2].length() != 26) {
