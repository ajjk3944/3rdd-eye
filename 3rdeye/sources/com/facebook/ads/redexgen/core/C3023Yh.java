...
public final class C3023Yh extends LinearLayout {
    public boolean A00;
    public final ImageView A01;
    public final TextView A02;
    public static final int A04 = (int) (AbstractC2975Wl.A02 * 16.0f);
    public static final int A05 = (int) (AbstractC2975Wl.A02 * 12.0f);
    public static final int A06 = (int) (AbstractC2975Wl.A02 * 12.0f);
    public static final int A03 = (int) (AbstractC2975Wl.A02 * 16.0f);

    public C3023Yh(C3272dL c3272dL) {
        super(c3272dL);
        this.A00 = false;
        setOrientation(0);
