...
public final class C3865nS implements C7H {
    public static byte[] A05;
    public InterfaceC2492Dn A00;
    ...
    public C3865nS(Context context) {
        this(context, 0);
    }

    public C3865nS(Context context, int i) {
        this(context, null, i, 5000L);
    }

    @Deprecated
    public C3865nS(Context context, C9U c9u, int i, long j4) {
        this.A00 = new C3866nT(this);
        this.A03 = context;
        this.A01 = i;
        this.A02 = j4;
        this.A04 = c9u;
    ...
    private final void A02(Context context, C9U c9u, long j4, Handler handler, InterfaceC2545Fo interfaceC2545Fo, int extensionRendererIndex, ArrayList<InterfaceC3859nM> arrayList) throws Exception {
        arrayList.add(new C0O(context, C3544hv.A0S, new MediaCodecRendererMetaParameters(null, false), InterfaceC2421Ar.A00, j4, c9u, false, false, handler, interfaceC2545Fo, 50, 5, 0, 0, 0));
        ...
        try {
            try {
                ...
                try {
                    arrayList.add(size, (InterfaceC3859nM) cls.getConstructor(clazz, clazz2, Handler.class, InterfaceC2545Fo.class, clazz3, clazz3).newInstance(true, Long.valueOf(j4), handler, interfaceC2545Fo, 50, 5));
    ...
    */
    private final void A03(android.content.Context r24, com.facebook.ads.redexgen.core.C9U r25, com.facebook.ads.redexgen.core.AnonymousClass38[] r26, android.os.Handler r27, com.facebook.ads.redexgen.core.C8D r28, int r29, java.util.ArrayList<com.facebook.ads.redexgen.core.InterfaceC3859nM> r30) throws java.lang.Exception {
        /*
            Method dump skipped, instructions count: 322
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C3865nS.A03(android.content.Context, com.facebook.ads.redexgen.X.9U, com.facebook.ads.redexgen.X.38[], android.os.Handler, com.facebook.ads.redexgen.X.8D, int, java.util.ArrayList):void");
    }

    private final void A04(Context context, B3 b32, Looper looper, int i, ArrayList<InterfaceC3859nM> arrayList) {
        arrayList.add(new AnonymousClass13(b32, looper));
    }

    private final void A05(Context context, InterfaceC2495Dq interfaceC2495Dq, Looper looper, int i, ArrayList<InterfaceC3859nM> arrayList) {
        arrayList.add(new C21840z(interfaceC2495Dq, looper, this.A00));
    }
    ...
    public final InterfaceC3859nM[] A5Q(Handler handler, InterfaceC2545Fo interfaceC2545Fo, C8D c8d, InterfaceC2495Dq interfaceC2495Dq, B3 b32, C9U c9u) throws Exception {
        C9U c9u2 = c9u;
        if (c9u2 == null) {
            c9u2 = this.A04;
        }
        ArrayList<InterfaceC3859nM> arrayList = new ArrayList<>();
        A02(this.A03, c9u2, this.A02, handler, interfaceC2545Fo, this.A01, arrayList);
        A03(this.A03, c9u2, A06(), handler, c8d, this.A01, arrayList);
        A05(this.A03, interfaceC2495Dq, handler.getLooper(), this.A01, arrayList);
        A04(this.A03, b32, handler.getLooper(), this.A01, arrayList);
        return (InterfaceC3859nM[]) arrayList.toArray(new InterfaceC3859nM[arrayList.size()]);
    }
}
