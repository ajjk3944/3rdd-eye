...
public final class RC implements View.OnLongClickListener {
    ...
    @Nullable
    public final C3054Zm A01;

    public RC(C3054Zm c3054Zm, RelativeLayout relativeLayout) {
        this.A01 = c3054Zm;
    ...
    public final boolean onLongClick(View view) {
        if (this.A01 != null && this.A00 != null) {
            ...
            A02[7] = "";
            c3054Zm.setBounds(0, 0, width, relativeLayout.getHeight());
