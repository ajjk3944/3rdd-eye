...
public final class C3830mt implements AnonymousClass38 {
    public long A03;
    public long A04;
    public C8w A09;
    public boolean A0D;
    ...
    public final long A00(long j4) {
        if (this.A04 >= 1024) {
            long jA0I = this.A03 - ((C8w) C3M.A01(this.A09)).A0I();
            if (this.A06.A03 == this.A05.A03) {
                long processedInputBytes = AbstractC22614a.A0U(j4, jA0I, this.A04);
                return processedInputBytes;
            }
            long processedInputBytes2 = this.A06.A03;
            long j10 = jA0I * processedInputBytes2;
            long j11 = this.A04;
            long processedInputBytes3 = this.A05.A03;
            return AbstractC22614a.A0U(j4, j10, j11 * processedInputBytes3);
        }
        return (long) (this.A01 * j4);
    }
