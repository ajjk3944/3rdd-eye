...
public final class C2658Jy extends AbstractC3063Zv {
    ...
    private void A04() {
        ...
        XP.A0I(this.A05);
        this.A05.setLayoutParams(AbstractC3063Zv.A0B);
    ...
    static {
        A09();
        A0U = OP.A02(-1, 77);
        A0O = (int) (AbstractC2975Wl.A02 * 12.0f);
        A0P = (int) (AbstractC2975Wl.A02 * 8.0f);
        A0L = (int) (AbstractC2975Wl.A02 * 26.0f);
        A0N = (int) (AbstractC2975Wl.A02 * 144.0f);
        A0M = (int) (AbstractC2975Wl.A02 * 48.0f);
        A0Q = (int) (AbstractC2975Wl.A02 * 16.0f);
        A0V = (int) (AbstractC2975Wl.A02 * 14.0f);
        A0R = (int) (OE.A08 * 21.0f);
        A0S = (int) (OE.A08 * 12.0f);
        A0T = (int) (OE.A08 * 10.0f);
    }

    public C2658Jy(C3272dL c3272dL, KE ke, int i, boolean z10, C2735My c2735My, boolean z11, String str, US us, InterfaceC3003Xn interfaceC3003Xn, C3345eX c3345eX, XH xh, N3 n32, boolean z12, String str2, boolean z13) {
        super(c3272dL, ke, i, c2735My, z11, str, us, interfaceC3003Xn, c3345eX, xh, n32, z12, str2);
        this.A0C = false;
        this.A00 = 0;
        this.A01 = 0;
        this.A0A = true;
        ...
        this.A09 = new C3088aM(this.A0H, A0V, 5, A0U, -1);
    ...
    public C2658Jy(C3272dL c3272dL, KE ke, int i, boolean z10, C2735My c2735My, boolean z11, String str, US us, InterfaceC3003Xn interfaceC3003Xn, C3345eX c3345eX, XH xh, AbstractC3547hy abstractC3547hy) {
        this(c3272dL, ke, i, z10, c2735My, false, str, us, interfaceC3003Xn, c3345eX, xh, abstractC3547hy.A21(), abstractC3547hy.A1c(), abstractC3547hy.A0x(), abstractC3547hy.A1k());
    }

    private GradientDrawable A00(int i, float f10) {
    ...
    private final void A0B() {
        super.A06.setLayoutParams(AbstractC3063Zv.A0B);
        A04();
        A03();
        if (!super.A03) {
            A02();
