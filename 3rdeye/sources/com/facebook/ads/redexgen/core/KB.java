...
public abstract class KB {
     ...
     */
    public static int A06(List<C2659Jz> list, String str, K7 k72) {
        List<K8> listA0E = A0E(list, str, k72);
        for (int i = 0; i < listA0E.size(); i++) {
            C2659Jz c2659Jz = listA0E.get(i).A01;
            if (c2659Jz.A07() != -1) {
                return c2659Jz.A07();
            }
        }
    ...
    */
    public static android.text.SpannedString A07(java.lang.String r11, java.lang.String r12, java.util.List<com.facebook.ads.redexgen.core.C2659Jz> r13) {
        /*
    ...
    java.lang.ArrayIndexOutOfBoundsException
     */
    public static K3 A0A(C4J c4j, List<C2659Jz> list) {
    ...
    java.lang.ArrayIndexOutOfBoundsException
     */
    public static void A0H(SpannableStringBuilder spannableStringBuilder, String str, K7 k72, List<K6> list, List<C2659Jz> list2) {
        ...
        for (int i10 = 0; i10 < arrayList.size(); i10++) {
            if (A0C(415, 2, 49).equals(((K6) arrayList.get(i10)).A01.A01)) {
                K6 k62 = (K6) arrayList.get(i10);
                int iA00 = A00(A06(list2, str, k62.A01), iA06, 1);
                int i11 = k62.A01.A00 - length;
                int i12 = k62.A00 - length;
                CharSequence charSequenceSubSequence = spannableStringBuilder.subSequence(i11, i12);
                spannableStringBuilder.delete(i11, i12);
                spannableStringBuilder.setSpan(new C3893nv(charSequenceSubSequence.toString(), iA00), i, i11, 33);
    ...
    static {
        ...
        map.put(A0C(440, 5, 53), Integer.valueOf(Color.rgb(KotlinVersion.MAX_COMPONENT_VALUE, KotlinVersion.MAX_COMPONENT_VALUE, KotlinVersion.MAX_COMPONENT_VALUE)));
        map.put(A0C(349, 4, 1), Integer.valueOf(Color.rgb(0, KotlinVersion.MAX_COMPONENT_VALUE, 0)));
        map.put(A0C(300, 4, 98), Integer.valueOf(Color.rgb(0, KotlinVersion.MAX_COMPONENT_VALUE, KotlinVersion.MAX_COMPONENT_VALUE)));
        map.put(A0C(405, 3, 61), Integer.valueOf(Color.rgb(KotlinVersion.MAX_COMPONENT_VALUE, 0, 0)));
        map.put(A0C(445, 6, 75), Integer.valueOf(Color.rgb(KotlinVersion.MAX_COMPONENT_VALUE, KotlinVersion.MAX_COMPONENT_VALUE, 0)));
        map.put(A0C(380, 7, 36), Integer.valueOf(Color.rgb(KotlinVersion.MAX_COMPONENT_VALUE, 0, KotlinVersion.MAX_COMPONENT_VALUE)));
        map.put(A0C(289, 4, 107), Integer.valueOf(Color.rgb(0, 0, KotlinVersion.MAX_COMPONENT_VALUE)));
        map.put(A0C(284, 5, 98), Integer.valueOf(Color.rgb(0, 0, 0)));
        Map<String, Integer> defaultColors = Collections.unmodifiableMap(map);
        A04 = defaultColors;
        HashMap map2 = new HashMap();
        map2.put(A0C(267, 8, 36), Integer.valueOf(Color.rgb(KotlinVersion.MAX_COMPONENT_VALUE, KotlinVersion.MAX_COMPONENT_VALUE, KotlinVersion.MAX_COMPONENT_VALUE)));
        map2.put(A0C(244, 7, 18), Integer.valueOf(Color.rgb(0, KotlinVersion.MAX_COMPONENT_VALUE, 0)));
        map2.put(A0C(237, 7, 19), Integer.valueOf(Color.rgb(0, KotlinVersion.MAX_COMPONENT_VALUE, KotlinVersion.MAX_COMPONENT_VALUE)));
        map2.put(A0C(261, 6, 67), Integer.valueOf(Color.rgb(KotlinVersion.MAX_COMPONENT_VALUE, 0, 0)));
        map2.put(A0C(275, 9, 63), Integer.valueOf(Color.rgb(KotlinVersion.MAX_COMPONENT_VALUE, KotlinVersion.MAX_COMPONENT_VALUE, 0)));
        map2.put(A0C(251, 10, 99), Integer.valueOf(Color.rgb(KotlinVersion.MAX_COMPONENT_VALUE, 0, KotlinVersion.MAX_COMPONENT_VALUE)));
        map2.put(A0C(230, 7, 96), Integer.valueOf(Color.rgb(0, 0, KotlinVersion.MAX_COMPONENT_VALUE)));
    ...
    public static int A00(int i, int i10, int i11) {
        if (i != -1) {
            return i;
        }
        if (i10 != -1) {
    ...
    */
    ...
    public static C3900o2 A09(CharSequence charSequence) {
        KA infoBuilder = new KA();
        infoBuilder.A0A = charSequence;
        return infoBuilder.A07().A0H();
    }

    public static K3 A0B(String str, Matcher matcher, C4J c4j, List<C2659Jz> list) {
        KA ka2 = new KA();
        try {
            ...
            while (true) {
                ...
                if (!zIsEmpty) {
                    ...
                    ka2.A0A = A07(str, sb.toString(), list);
                    return ka2.A08();
                }
            }
    ...
    public static String A0D(String str) {
        ...
        return AbstractC22614a.A1P(strTrim, A0C(182, 5, 117))[0];
    }

    public static List<K8> A0E(List<C2659Jz> list, String str, K7 k72) {
        ArrayList arrayList = new ArrayList();
        for (int i = 0; i < list.size(); i++) {
            C2659Jz c2659Jz = list.get(i);
            int i10 = c2659Jz.A09(str, k72.A01, k72.A03, k72.A02);
            if (i10 > 0) {
                arrayList.add(new K8(i10, c2659Jz));
            }
        }
    ...
    public static void A0G(SpannableStringBuilder spannableStringBuilder, C2659Jz c2659Jz, int i, int i10) {
        if (c2659Jz == null) {
            return;
        }
        if (c2659Jz.A08() != -1) {
            C3H.A00(spannableStringBuilder, new StyleSpan(c2659Jz.A08()), i, i10, 33);
        }
        if (c2659Jz.A0S()) {
            spannableStringBuilder.setSpan(new StrikethroughSpan(), i, i10, 33);
        }
        boolean zA0T = c2659Jz.A0T();
        if (A01[3].charAt(21) != 'Z') {
            ...
            if (c2659Jz.A0R()) {
                C3H.A00(spannableStringBuilder, new ForegroundColorSpan(c2659Jz.A05()), i, i10, 33);
            }
            if (c2659Jz.A0Q()) {
                C3H.A00(spannableStringBuilder, new BackgroundColorSpan(c2659Jz.A04()), i, i10, 33);
            }
            if (c2659Jz.A0K() != null) {
                C3H.A00(spannableStringBuilder, new TypefaceSpan(c2659Jz.A0K()), i, i10, 33);
            }
            switch (c2659Jz.A06()) {
                case 1:
                    C3H.A00(spannableStringBuilder, new AbsoluteSizeSpan((int) c2659Jz.A03(), true), i, i10, 33);
                    break;
                case 2:
                    C3H.A00(spannableStringBuilder, new RelativeSizeSpan(c2659Jz.A03()), i, i10, 33);
                    break;
                case 3:
                    C3H.A00(spannableStringBuilder, new RelativeSizeSpan(c2659Jz.A03() / 100.0f), i, i10, 33);
                    break;
            }
            if (c2659Jz.A0P()) {
                spannableStringBuilder.setSpan(new C3894nw(), i, i10, 33);
                return;
            }
            return;
        }
    ...
    public static void A0I(SpannableStringBuilder spannableStringBuilder, Set<String> set, int i, int i10) {
        for (String str : set) {
            ...
            if (zContainsKey) {
                spannableStringBuilder.setSpan(new ForegroundColorSpan(A04.get(str).intValue()), i, i10, 33);
            } else {
                ...
                if (className.charAt(21) != 'Z') {
                    ...
                    if (map.containsKey(str)) {
                        spannableStringBuilder.setSpan(new BackgroundColorSpan(A03.get(str).intValue()), i, i10, 33);
                    }
    ...
    */
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public static void A0K(java.lang.String r8, com.facebook.ads.redexgen.core.K7 r9, java.util.List<com.facebook.ads.redexgen.core.K6> r10, android.text.SpannableStringBuilder r11, java.util.List<com.facebook.ads.redexgen.core.C2659Jz> r12) {
        /*
