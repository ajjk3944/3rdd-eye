...
public class C3414ff extends AbstractC2775Oo {
    ...
    public C3414ff(RL rl) {
        this.A01 = rl;
    }

    @Override // com.facebook.ads.redexgen.core.AbstractC2775Oo
    ...
    public final void A09() {
        ...
        for (int i = 0; i < iMin; i++) {
            ...
            C2815Qc.A0L(ad.getInternalNativeAd()).A1d(true);
            this.A00.add(ad);
        }
        A05();
    }
