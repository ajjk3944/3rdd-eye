...
public final class C3432fx extends R8 implements AdOptionsViewApi {
    ...
    static {
        A02();
        A08 = (int) (AbstractC2975Wl.A02 * 23.0f);
        A09 = (int) (AbstractC2975Wl.A02 * 4.0f);
    }

    public C3432fx(Context context, NativeAdBase nativeAdBase, NativeAdLayout nativeAdLayout, AdOptionsView.Orientation orientation, int i, AdOptionsView adOptionsView) {
        this.A02 = false;
        this.A01 = false;
        this.A00 = false;
        ...
        C2815Qc c2815QcA0L = C2815Qc.A0L(nativeAdBase.getInternalNativeAd());
        c2815QcA0L.A1V(nativeAdLayout);
        c2815QcA0L.A1X(this);
        C3568iN c3568iNA0z = c2815QcA0L.A0z();
        if (c3568iNA0z != null && c3568iNA0z.A0R() && !c3568iNA0z.A0P()) {
            linearLayout.setVisibility(8);
        } else {
            linearLayout.setOnClickListener(new ViewOnClickListenerC2836Qx(this, c2815QcA0L, context, linearLayout));
            EnumC2980Wq.A04(this.A05, EnumC2980Wq.A0C);
        }
    }

    public C3432fx(Context context, NativeAdBase nativeAdBase, NativeAdLayout nativeAdLayout, AdOptionsView adOptionsView) {
    ...
    public final void setIconSizeDp(int i) {
        int iconSize = Math.max(A08, (int) (AbstractC2975Wl.A02 * i));
