...
public class AY extends Exception {
    ...
    public AY(C3949or c3949or, Throwable th, boolean z10, int i) {
        this(A03(23, 22, 80) + i + A03(45, 3, 19) + c3949or, th, c3949or.A0W, z10, null, A02(i), null);
    }

    public AY(C3949or c3949or, Throwable th, boolean z10, AR ar) {
        this(A03(2, 21, 4) + ar.A03 + A03(0, 2, 93) + c3949or, th, c3949or.A0W, z10, ar, AbstractC22614a.A02 >= 21 ? A04(th) : null, null);
    }

    public AY(String str, Throwable th, String str2, boolean z10, AR ar, String str3, AY ay) {
        super(str, th);
        this.A03 = str2;
        this.A04 = z10;
        this.A00 = ar;
