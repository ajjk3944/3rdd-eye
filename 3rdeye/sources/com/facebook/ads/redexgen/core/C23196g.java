...
public class C23196g extends ViewGroup {
    ...
    public C2799Pm A01;
    public C3453gJ A02;
    public RunnableC2812Pz A03;
    public QC A04;
    public QK A05;
    public QO A06;
    public QX A07;
    public RunnableC2818Qf A08;
    public C3436g1 A09;
    public boolean A0A;
    public boolean A0B;
    public boolean A0C;
    ...
    public final QW A0r;
    public final C2816Qd A0s;
    public final C2827Qo A0t;
    public final Runnable A0u;
    public final ArrayList<RecyclerView.ItemDecoration> A0v;
    public final List<AbstractC2819Qg> A0w;
    public final int A0x;
    public final int A0y;
    public final Rect A0z;
    public final AccessibilityManager A10;
    public final C3438g4 A11;
    public final InterfaceC2826Qn A12;
     ...
     */
    public static C23196g A0H(View view) {
        if (!(view instanceof ViewGroup)) {
            return null;
        }
        if (view instanceof C23196g) {
            return (C23196g) view;
        }
        ViewGroup viewGroup = (ViewGroup) view;
        int childCount = viewGroup.getChildCount();
        for (int i = 0; i < childCount; i++) {
            C23196g c23196gA0H = A0H(viewGroup.getChildAt(i));
            if (c23196gA0H != null) {
                return c23196gA0H;
            }
        }
    ...
    public static String A0I(int i, int i10, int i11) {
        byte[] bArrCopyOfRange = Arrays.copyOfRange(A18, i, i + i10);
        int i12 = 0;
        while (true) {
    ...
    private void A0N() {
        ...
        if (this.A0s.A0C) {
            for (int iA05 = this.A01.A05() - 1; iA05 >= 0; iA05--) {
                AbstractC2819Qg abstractC2819QgA0F = A0F(this.A01.A09(iA05));
                if (!abstractC2819QgA0F.A0l()) {
                    long jA0C = A0C(abstractC2819QgA0F);
                    QJ qjA0E = this.A05.A0E(this.A0s, abstractC2819QgA0F);
                    AbstractC2819Qg abstractC2819QgA05 = this.A0t.A05(jA0C);
                    if (abstractC2819QgA05 == null || abstractC2819QgA05.A0l()) {
                        this.A0t.A0E(abstractC2819QgA0F, qjA0E);
                    } else {
                        boolean zA0H = this.A0t.A0H(abstractC2819QgA05);
                        boolean zA0H2 = this.A0t.A0H(abstractC2819QgA0F);
                        if (zA0H && abstractC2819QgA05 == abstractC2819QgA0F) {
                            this.A0t.A0E(abstractC2819QgA0F, qjA0E);
                        } else {
                            QJ qjA04 = this.A0t.A04(abstractC2819QgA05);
                            this.A0t.A0E(abstractC2819QgA0F, qjA0E);
                            QJ qjA03 = this.A0t.A03(abstractC2819QgA0F);
                            if (qjA04 == null) {
                                A0m(jA0C, abstractC2819QgA0F, abstractC2819QgA05);
                            } else {
                                A0t(abstractC2819QgA05, abstractC2819QgA0F, qjA04, qjA03, zA0H, zA0H2);
                            }
                        }
                    }
                }
    ...
    public C23196g(Context context) {
        this(context, null);
    }

    public C23196g(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, 0);
    }

    public C23196g(Context context, AttributeSet attributeSet, int i) {
        super(context, attributeSet, i);
        this.A11 = new C3438g4(this);
        this.A0r = new QW(this);
        this.A0t = new C2827Qo();
        ...
        this.A0U = 0;
        this.A0N = 0;
        this.A05 = new C23226j();
        this.A0W = 0;
        this.A0V = -1;
        this.A0L = Float.MIN_VALUE;
        this.A0M = Float.MIN_VALUE;
        this.A0o = true;
        this.A08 = new RunnableC2818Qf(this);
        this.A02 = A1E ? new C3453gJ() : null;
        this.A0s = new C2816Qd();
        this.A0G = false;
        this.A0H = false;
        this.A0f = new C3441g7(this);
        this.A0K = false;
        this.A14 = new int[2];
        this.A17 = new int[2];
        this.A16 = new int[2];
        ...
        setAccessibilityDelegateCompat(new C3436g1(this));
    ...
    private final long A0C(AbstractC2819Qg abstractC2819Qg) {
        return this.A04.A0M() ? abstractC2819Qg.A0Q() : abstractC2819Qg.A03;
    }

    private View A0D() {
        AbstractC2819Qg abstractC2819QgA1F;
        ...
        for (int startFocusSearchIndex = i; startFocusSearchIndex < iA03; startFocusSearchIndex++) {
            AbstractC2819Qg abstractC2819QgA1F2 = A1F(startFocusSearchIndex);
            if (abstractC2819QgA1F2 == null) {
                break;
            }
            if (abstractC2819QgA1F2.A0H.hasFocusable()) {
                return abstractC2819QgA1F2.A0H;
            }
        }
        int startFocusSearchIndex2 = Math.min(iA03, i);
        for (int limit = startFocusSearchIndex2 - 1; limit >= 0 && (abstractC2819QgA1F = A1F(limit)) != null; limit--) {
            if (abstractC2819QgA1F.A0H.hasFocusable()) {
                return abstractC2819QgA1F.A0H;
            }
        }
        return null;
    }

    private final AbstractC2819Qg A0E(long j4) {
        if (this.A04 == null || !this.A04.A0M()) {
            return null;
        }
        int iA06 = this.A01.A06();
        AbstractC2819Qg abstractC2819Qg = null;
        for (int i = 0; i < iA06; i++) {
            AbstractC2819Qg holder = A0F(this.A01.A0A(i));
            if (holder != null && !holder.A0g() && holder.A0Q() == j4) {
                if (this.A01.A0K(holder.A0H)) {
                    abstractC2819Qg = holder;
                } else {
                    return holder;
                }
            }
    ...
    public static AbstractC2819Qg A0F(View view) {
        if (view == null) {
            return null;
        }
    ...
    private final AbstractC2819Qg A0G(View view) {
    ...
    private void A0L() {
        ...
        if (this.A0s.A0C) {
            ...
            for (int i = 0; i < iA05; i++) {
                AbstractC2819Qg holder = A0F(this.A01.A09(i));
                if (!holder.A0l() && (!holder.A0f() || this.A04.A0M())) {
                    QK qk = this.A05;
                    C2816Qd c2816Qd = this.A0s;
                    int i10 = QK.A06(holder);
                    this.A0t.A0F(holder, qk.A0F(c2816Qd, holder, i10, holder.A0R()));
        ...
        if (this.A0s.A0B) {
            ...
            for (int i11 = 0; i11 < this.A01.A05(); i11++) {
                AbstractC2819Qg abstractC2819QgA0F = A0F(this.A01.A09(i11));
                boolean didStructureChange = abstractC2819QgA0F.A0l();
                if (!didStructureChange) {
                    boolean didStructureChange2 = this.A0t.A0I(abstractC2819QgA0F);
                    if (!didStructureChange2) {
                        int iA06 = QK.A06(abstractC2819QgA0F);
                        boolean zA0o = abstractC2819QgA0F.A0o(8192);
                        if (!zA0o) {
                            iA06 |= 4096;
                        }
                        QJ qjA0F = this.A05.A0F(this.A0s, abstractC2819QgA0F, iA06, abstractC2819QgA0F.A0R());
                        if (zA0o) {
                            A1k(abstractC2819QgA0F, qjA0F);
                        } else {
                            this.A0t.A0D(abstractC2819QgA0F, qjA0F);
                        }
                    }
                }
            }
    ...
    private void A0O() {
        this.A01 = new C2799Pm(new C3443g9(this));
    }
    ...
    */
    private void A0P() {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C23196g.A0P():void");
    }
    ...
    private void A0Q() {
        ...
        if (this.A0o && this.A04 != null && hasFocus() && getDescendantFocusability() != 393216) {
            ...
            AbstractC2819Qg abstractC2819QgA0E = null;
            long j4 = this.A0s.A08;
            String[] strArr = A19;
            if (strArr[3].charAt(2) == strArr[2].charAt(2)) {
                throw new RuntimeException();
            }
            A19[1] = "kf1DBtA0T6eQEv5OJ0aXYpUf8VxTHKxU";
            if (j4 != -1 && this.A04.A0M()) {
                abstractC2819QgA0E = A0E(this.A0s.A08);
            }
            View viewA0D = null;
            if (abstractC2819QgA0E == null || this.A01.A0K(abstractC2819QgA0E.A0H) || !abstractC2819QgA0E.A0H.hasFocusable()) {
                if (this.A01.A05() > 0) {
                    viewA0D = A0D();
                }
            } else {
                viewA0D = abstractC2819QgA0E.A0H;
            }
            if (viewA0D != null) {
    ...
    private void A0U() {
        ...
        AbstractC2819Qg abstractC2819QgA0G = focusedChild == null ? null : A0G(focusedChild);
        if (abstractC2819QgA0G == null) {
            A0S();
            return;
        }
        this.A0s.A08 = this.A04.A0M() ? abstractC2819QgA0G.A0Q() : -1L;
        C2816Qd c2816Qd = this.A0s;
        if (this.A0C) {
            iA0M = -1;
        } else {
            iA0M = abstractC2819QgA0G.A0g() ? abstractC2819QgA0G.A01 : abstractC2819QgA0G.A0M();
        }
        c2816Qd.A01 = iA0M;
        C2816Qd c2816Qd2 = this.A0s;
        View child = abstractC2819QgA0G.A0H;
        c2816Qd2.A02 = A0B(child);
    }
    ...
    private final void A0X() {
        int iA06 = this.A01.A06();
        for (int i = 0; i < iA06; i++) {
            AbstractC2819Qg abstractC2819QgA0F = A0F(this.A01.A0A(i));
            if (!abstractC2819QgA0F.A0l()) {
                abstractC2819QgA0F.A0S();
            }
        }
        this.A0r.A0K();
    }
    ...
    private final void A0Z() {
        ...
        for (int size = this.A0w.size() - 1; size >= 0; size--) {
            AbstractC2819Qg abstractC2819Qg = this.A0w.get(size);
            if (abstractC2819Qg.A0H.getParent() == this && !abstractC2819Qg.A0l() && (state = abstractC2819Qg.A02) != -1) {
                P3.A09(abstractC2819Qg.A0H, state);
                abstractC2819Qg.A02 = -1;
            }
        }
        this.A0w.clear();
    }
    ...
    private final void A0e() {
        this.A00 = new C3456gM(new C3442g8(this));
    }
    ...
    private final void A0h() {
        ...
        for (int i = 0; i < iA06; i++) {
            AbstractC2819Qg abstractC2819QgA0F = A0F(this.A01.A0A(i));
            if (abstractC2819QgA0F != null && !abstractC2819QgA0F.A0l()) {
                abstractC2819QgA0F.A0Z(6);
            }
        }
        A0g();
        this.A0r.A0N();
    ...
    private void A0j(float f10, float f11, float f12, float f13) {
        ...
        if (f11 < 0.0f) {
            A0b();
            AbstractC2790Pd.A00(this.A0a, (-f11) / getWidth(), 1.0f - (f12 / getHeight()));
            z10 = true;
        } else if (f11 > 0.0f) {
            A0c();
            AbstractC2790Pd.A00(this.A0b, f11 / getWidth(), f12 / getHeight());
            z10 = true;
        }
        if (f13 < 0.0f) {
            A0d();
            AbstractC2790Pd.A00(this.A0c, (-f13) / getHeight(), f10 / getWidth());
            z10 = true;
        } else if (f13 > 0.0f) {
            A0a();
            AbstractC2790Pd.A00(this.A0Z, f13 / getHeight(), 1.0f - (f10 / getWidth()));
            z10 = true;
        }
        if (!z10 && f11 == 0.0f) {
            if (A19[7].length() != 1) {
    ...
    private final void A0l(int i, int i10, Interpolator interpolator) {
        if (this.A06 == null) {
        ...
        if (i != 0 || i10 != 0) {
            this.A08.A0D(i, i10, interpolator);
        }
    }

    private void A0m(long j4, AbstractC2819Qg abstractC2819Qg, AbstractC2819Qg abstractC2819Qg2) {
        int iA05 = this.A01.A05();
        for (int i = 0; i < iA05; i++) {
            AbstractC2819Qg other = A0F(this.A01.A09(i));
            if (other != abstractC2819Qg && A0C(other) == j4) {
                QC qc = this.A04;
                String[] strArr = A19;
                String str = strArr[0];
                String str2 = strArr[6];
                ...
                if (qc != null && this.A04.A0M()) {
                    throw new IllegalStateException(A0I(1696, 130, 15) + other + strA0I + abstractC2819Qg + A1J());
                }
                throw new IllegalStateException(A0I(1508, 188, 43) + other + strA0I + abstractC2819Qg + A1J());
            }
        }
        Log.e(A0I(1370, 12, 39), A0I(1202, 111, 51) + abstractC2819Qg2 + A0I(18, 41, 117) + abstractC2819Qg + A1J());
    }
    ...
    private void A0q(QC qc, boolean z10, boolean z11) {
        if (this.A04 != null) {
        ...
        qw.A0U(qc2, oldAdapter, z10);
        this.A0s.A0D = true;
        A1R();
    }

    private void A0r(AbstractC2819Qg abstractC2819Qg) {
        View view = abstractC2819Qg.A0H;
        boolean z10 = view.getParent() == this;
        this.A0r.A0Y(A1I(view));
        boolean zA0i = abstractC2819Qg.A0i();
        String[] strArr = A19;
        if (strArr[4].charAt(24) != strArr[5].charAt(24)) {
            throw new RuntimeException();
        }
    ...
    public static void A0s(AbstractC2819Qg abstractC2819Qg) {
        if (abstractC2819Qg.A09 != null) {
            C23196g c23196g = abstractC2819Qg.A09.get();
            while (c23196g != null) {
                View item = abstractC2819Qg.A0H;
                if (c23196g == item) {
                    return;
                }
                Object parent = c23196g.getParent();
            ...
            abstractC2819Qg.A09 = null;
        }
    }

    private void A0t(AbstractC2819Qg abstractC2819Qg, AbstractC2819Qg abstractC2819Qg2, QJ qj, QJ qj2, boolean z10, boolean z11) {
        ...
        if (abstractC2819Qg != abstractC2819Qg2) {
            if (z11) {
                A0r(abstractC2819Qg2);
            }
            abstractC2819Qg.A06 = abstractC2819Qg2;
            A0r(abstractC2819Qg);
            this.A0r.A0Y(abstractC2819Qg);
            abstractC2819Qg2.A0d(false);
            abstractC2819Qg2.A07 = abstractC2819Qg;
        }
        if (this.A05.A0R(abstractC2819Qg, abstractC2819Qg2, qj, qj2)) {
            A1O();
        }
    }
    ...
    private void A0x(int[] iArr) {
        ...
        for (int i = 0; i < iA05; i++) {
            AbstractC2819Qg abstractC2819QgA0F = A0F(this.A01.A09(i));
            if (!abstractC2819QgA0F.A0l()) {
                int count = abstractC2819QgA0F.A0O();
    ...
    private boolean A0y() {
        ...
        for (int i = 0; i < iA05; i++) {
            AbstractC2819Qg abstractC2819QgA0F = A0F(this.A01.A09(i));
            if (abstractC2819QgA0F != null && !abstractC2819QgA0F.A0l()) {
                boolean zA0j = abstractC2819QgA0F.A0j();
    ...
    private boolean A11(int i, int i10) {
        A0x(this.A14);
        return (this.A14[0] == i && this.A14[1] == i10) ? false : true;
    }

    private final boolean A12(int i, int i10) {
        if (this.A06 == null) {
        ...
        if (!canScrollHorizontal) {
            ...
            dispatchNestedFling(i, i10, canScrollVertical);
            if (this.A0g != null) {
                boolean canScrollHorizontal2 = this.A0g.A0B(i, i10);
    ...
    private final boolean A13(int consumedX, int consumedY, MotionEvent motionEvent) {
        ...
        if (A1v(iA1f, iA1g, i, i10, this.A17, 0)) {
            this.A0S -= this.A17[0];
            this.A0T -= this.A17[1];
            if (motionEvent != null) {
            ...
            if (motionEvent != null && !AbstractC2770Oj.A00(motionEvent, 8194)) {
                A0j(motionEvent.getX(), i, motionEvent.getY(), i10);
            }
    ...
    public final int A1B(View view) {
        AbstractC2819Qg holder = A0F(view);
        if (holder != null) {
            return holder.A0O();
        }
        return -1;
    ...
    public final int A1C(AbstractC2819Qg abstractC2819Qg) {
        if (abstractC2819Qg.A0o(524) || !abstractC2819Qg.A0e()) {
            return -1;
        }
        return this.A00.A05(abstractC2819Qg.A03);
    }
    ...
    public final AbstractC2819Qg A1F(int i) {
        if (this.A0C) {
            return null;
        }
        int iA06 = this.A01.A06();
        AbstractC2819Qg hidden = null;
        for (int i10 = 0; i10 < iA06; i10++) {
            AbstractC2819Qg abstractC2819QgA0F = A0F(this.A01.A0A(i10));
            if (abstractC2819QgA0F != null && !abstractC2819QgA0F.A0g()) {
                int childCount = A1C(abstractC2819QgA0F);
                if (childCount != i) {
                    continue;
                } else if (this.A01.A0K(abstractC2819QgA0F.A0H)) {
                    hidden = abstractC2819QgA0F;
                } else {
    ...
    public final AbstractC2819Qg A1G(int i) {
        return A1H(i, false);
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final com.facebook.ads.redexgen.core.AbstractC2819Qg A1H(int r9, boolean r10) {
        /*
            r8 = this;
        ...
        L25:
            int r6 = r3.A0O()
            java.lang.String[] r1 = com.facebook.ads.redexgen.core.C23196g.A19
            r0 = 7
            r0 = r1[r0]
            int r1 = r0.length()
            r0 = 1
            ...
            throw r0
        L3b:
            java.lang.String[] r2 = com.facebook.ads.redexgen.core.C23196g.A19
        ...
        L57:
            return r7
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C23196g.A1H(int, boolean):com.facebook.ads.redexgen.X.Qg");
    }

    public final AbstractC2819Qg A1I(View view) {
        ViewParent parent = view.getParent();
    ...
    */
    public final void A1K() {
        ...
        Ld5:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C23196g.A1K():void");
    }
    ...
    */
    public final void A1Q() {
        ...
        L41:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C23196g.A1Q():void");
    }
    ...
    public final void A1V(int i) {
        ...
        for (int i10 = 0; i10 < iA05; i10++) {
            this.A01.A09(i10).offsetLeftAndRight(i);
        }
    }
    ...
    public final void A1W(int i) {
        int iA05 = this.A01.A05();
        for (int i10 = 0; i10 < iA05; i10++) {
            this.A01.A09(i10).offsetTopAndBottom(i);
        }
    }
    ...
    public final void A1a(int i, int i10) {
        if (i < 0) {
            A0b();
            this.A0a.onAbsorb(-i);
        } else if (i > 0) {
    ...
    public final void A1b(int i, int i10) {
        boolean zIsFinished = false;
        if (this.A0a != null) {
    ...
    public final void A1c(int i, int i10) {
        int iA02 = QO.A02(i, getPaddingLeft() + getPaddingRight(), P3.A03(this));
        int paddingTop = getPaddingTop();
        int width = getPaddingBottom();
        int i11 = paddingTop + width;
        int width2 = P3.A02(this);
        setMeasuredDimension(iA02, QO.A02(i10, i11, width2));
    }

    public final void A1d(int i, int i10) {
        this.A0N++;
        int scrollY = getScrollX();
        int scrollX = getScrollY();
        onScrollChanged(scrollY, scrollX, scrollY, scrollX);
        if (this.A0i != null) {
            this.A0i.A0M(this, i, i10);
        }
        if (this.A0m != null) {
            for (int scrollY2 = this.A0m.size() - 1; scrollY2 >= 0; scrollY2--) {
                this.A0m.get(scrollY2).A0M(this, i, i10);
            }
        }
        this.A0N--;
    }

    public final void A1e(int i, int i10) {
        A0l(i, i10, null);
    }
    ...
    public final void A1j(C2816Qd c2816Qd) {
        if (getScrollState() == 2) {
            OverScroller overScroller = this.A08.A01;
            c2816Qd.A06 = overScroller.getFinalX() - overScroller.getCurrX();
            c2816Qd.A07 = overScroller.getFinalY() - overScroller.getCurrY();
        } else {
            c2816Qd.A06 = 0;
            c2816Qd.A07 = 0;
        }
    ...
    public final void A1k(AbstractC2819Qg abstractC2819Qg, QJ qj) {
        abstractC2819Qg.A0a(0, 8192);
        if (this.A0s.A0E) {
            boolean zA0j = abstractC2819Qg.A0j();
            if (A19[1].charAt(14) != '5') {
                throw new RuntimeException();
            }
            String[] strArr = A19;
            ...
            if (zA0j && !abstractC2819Qg.A0g() && !abstractC2819Qg.A0l()) {
                this.A0t.A08(A0C(abstractC2819Qg), abstractC2819Qg);
            }
        }
        this.A0t.A0F(abstractC2819Qg, qj);
    }

    public final void A1l(AbstractC2819Qg abstractC2819Qg, QJ qj, QJ qj2) {
        abstractC2819Qg.A0d(false);
        if (this.A05.A0O(abstractC2819Qg, qj, qj2)) {
            A1O();
        }
    }

    public final void A1m(AbstractC2819Qg abstractC2819Qg, QJ qj, QJ qj2) {
        A0r(abstractC2819Qg);
        abstractC2819Qg.A0d(false);
        if (this.A05.A0P(abstractC2819Qg, qj, qj2)) {
            A1O();
        }
    }
    ...
    public final void A1p(boolean z10) {
        ...
        if (this.A0O == 1) {
            if (z10 && this.A0J) {
                ...
                A19[7] = SingularParamsBase.Constants.IDENTIFIER_KEYSPACE_KEY;
    ...
    public final boolean A1u(int i, int i10) {
        return getScrollingChildHelper().A0B(i, i10);
    }

    public final boolean A1v(int i, int i10, int i11, int i12, int[] iArr, int i13) {
        return getScrollingChildHelper().A0D(i, i10, i11, i12, iArr, i13);
    }

    public final boolean A1w(int i, int i10, int[] iArr, int[] iArr2, int i11) {
        return getScrollingChildHelper().A0F(i, i10, iArr, iArr2, i11);
    }
    ...
    public final boolean A1x(View view) {
        ...
        if (zA0L) {
            AbstractC2819Qg viewHolder = A0F(view);
    ...
    public final boolean A1y(AbstractC2819Qg abstractC2819Qg) {
        return this.A05 == null || this.A05.A0S(abstractC2819Qg, abstractC2819Qg.A0R());
    }

    public final boolean A1z(AbstractC2819Qg abstractC2819Qg, int i) {
        if (A1s()) {
            abstractC2819Qg.A02 = i;
            this.A0w.add(abstractC2819Qg);
            return false;
        }
        P3.A09(abstractC2819Qg.A0H, i);
        return true;
    }

    @Override // android.view.ViewGroup, android.view.View
    public final void addFocusables(ArrayList<View> views, int i, int i10) {
        if (this.A06 == null || !this.A06.A1e(this, views, i, i10)) {
    ...
    public final boolean dispatchNestedPreScroll(int i, int i10, int[] iArr, int[] iArr2) {
        return getScrollingChildHelper().A0E(i, i10, iArr, iArr2);
    }

    @Override // android.view.View
    public final boolean dispatchNestedScroll(int i, int i10, int i11, int i12, int[] iArr) {
        return getScrollingChildHelper().A0C(i, i10, i11, i12, iArr);
    }
    ...
    */
    public final void draw(android.graphics.Canvas r8) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C23196g.draw(android.graphics.Canvas):void");
    }
    ...
    */
    public final android.view.View focusSearch(android.view.View r11, int r12) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C23196g.focusSearch(android.view.View, int):android.view.View");
    }
    ...
    public C3436g1 getCompatAccessibilityDelegate() {
        return this.A09;
    }
    ...
    private C2772Ol getScrollingChildHelper() {
        if (this.A0d == null) {
            this.A0d = new C2772Ol(this);
        }
        return this.A0d;
    }
    ...
    public final void onAttachedToWindow() {
        ...
        this.A0K = false;
        if (A1E) {
            this.A03 = RunnableC2812Pz.A07.get();
            RunnableC2812Pz runnableC2812Pz = this.A03;
            String[] strArr = A19;
            if (strArr[4].charAt(24) != strArr[5].charAt(24)) {
                throw new RuntimeException();
            }
            ...
            if (runnableC2812Pz == null) {
                this.A03 = new RunnableC2812Pz();
                ...
                RunnableC2812Pz.A07.set(this.A03);
            }
            this.A03.A09(this);
        }
    }
    ...
    public void onMeasure(int i, int i10) {
        ...
        if (z10) {
            ...
            this.A06.A1L(this.A0r, this.A0s, i, i10);
    ...
    */
    public boolean onTouchEvent(android.view.MotionEvent r21) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C23196g.onTouchEvent(android.view.MotionEvent):boolean");
    }

    @Override // android.view.ViewGroup
    public final void removeDetachedView(View view, boolean z10) {
        AbstractC2819Qg abstractC2819QgA0F = A0F(view);
        if (abstractC2819QgA0F != null) {
            if (abstractC2819QgA0F.A0i()) {
                abstractC2819QgA0F.A0V();
            } else if (!abstractC2819QgA0F.A0l()) {
                throw new IllegalArgumentException(A0I(219, 75, 84) + abstractC2819QgA0F + A1J());
            }
        }
        view.clearAnimation();
        A1g(view);
    ...
    public void setAccessibilityDelegateCompat(C3436g1 c3436g1) {
        this.A09 = c3436g1;
    ...
    public void setViewCacheExtension(AbstractC2817Qe abstractC2817Qe) {
        this.A0r.A0W(abstractC2817Qe);
    }
