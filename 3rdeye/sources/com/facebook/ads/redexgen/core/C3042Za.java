...
public class C3042Za extends WebChromeClient {
    ...
    public final WeakReference<C3272dL> A00;
    ...
    public C3042Za(WeakReference<C3272dL> weakReference, WeakReference<ZY> weakReference2, WeakReference<ZT> weakReference3) {
    ...
    private boolean A02(ValueCallback valueCallback) {
        C3272dL c3272dL = this.A00.get();
        if (c3272dL != null && c3272dL.A0E() != null && LJ.A09) {
            if (LJ.A08 != null) {
            ...
            try {
                ...
                c3272dL.A0E().startActivityForResult(Intent.createChooser(intent, A00(3, 12, 84)), 1001);
                return true;
            } catch (Exception e4) {
                c3272dL.A08().AAz(A00(80, 8, 33), AbstractC2885Sv.A2d, new C2886Sw(e4));
