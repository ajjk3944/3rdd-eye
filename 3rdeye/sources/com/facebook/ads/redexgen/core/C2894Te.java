...
import com.facebook.ads.redexgen.core.AbstractC2895Tf;
import com.facebook.ads.redexgen.core.C2893Td;
...
public final class C2894Te<T extends AbstractC2895Tf, E extends C2893Td> {
    ...
    private void A00(E e4) {
        ...
        if (this.A00 == null || (list = this.A00.get(e4.getClass())) == null) {
            return;
        }
        A01(list);
        if (list.isEmpty()) {
        ...
        while (it.hasNext()) {
            AbstractC2895Tf abstractC2895Tf = (AbstractC2895Tf) ((WeakReference) it.next()).get();
            if (abstractC2895Tf != null && abstractC2895Tf.A00(e4)) {
                abstractC2895Tf.A03(e4);
            }
        }
    }
    ...
    */
    private void A01(java.util.List<java.lang.ref.WeakReference<T>> r5) {
        ...
        L2d:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C2894Te.A01(java.util.List):void");
    }
