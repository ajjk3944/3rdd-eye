...
public final class C3673k8 implements J7 {
    ...
    public final List<List<C3900o2>> A01;

    public C3673k8(List<List<C3900o2>> list, List<Long> cueTimesUs) {
        this.A01 = list;
        this.A00 = cueTimesUs;
    }
    ...
    public final List<C3900o2> A7P(long j4) {
        int iA0H = AbstractC22614a.A0H(this.A00, Long.valueOf(j4), true, false);
        if (iA0H == -1) {
            return Collections.emptyList();
        }
        List<C3900o2> list = this.A01.get(iA0H);
    ...
    public final int A8S(long j4) {
        int iA0G = AbstractC22614a.A0G(this.A00, Long.valueOf(j4), false, false);
