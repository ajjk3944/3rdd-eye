...
public final class AnonymousClass56 {
    ...
    public AnonymousClass56(Uri uri, long j4, int i, byte[] bArr, Map<String, String> map, long j10, long j11, String str, int i10, C2695Lj c2695Lj) {
        boolean z10 = true;
        C3M.A07(j4 + j10 >= 0);
        C3M.A07(j10 >= 0);
        if (j11 <= 0 && j11 != -1) {
    ...
    @MetaExoPlayerCustomization
    @Deprecated
    public AnonymousClass56(Uri uri, int i, int i10) {
        this(uri, 0L, 1, null, Collections.emptyMap(), 0L, -1L, null, i, new C2695Lj(A02(0, 0, 9), -1L, false, -1, -1, -1, -1, false, false, i10, -1L, new C2694Li(), -1L, false, -1, -1, -1L, -1L, -1, null, -1, null, null, C2693Lh.A02, -1, false, null, A02(0, 0, 9), A02(0, 0, 9), null, -1L, -1L));
    }

    @MetaExoPlayerCustomization("creation and passage of FbDataSpecExtension")
    @Deprecated
    public AnonymousClass56(Uri uri, long j4, long j10, String str) {
        this(uri, 0L, 1, null, Collections.emptyMap(), j4, j10, str, 0, new C2695Lj());
    }
    ...
    public final AnonymousClass56 A05(long j4, long j10) {
        if (j4 == 0 && this.A03 == j10) {
            return this;
        }
        return new AnonymousClass56(this.A06, this.A05, this.A01, this.A0A, this.A09, this.A04 + j4, j10, this.A08, this.A00, new C2695Lj(this.A07));
    }
