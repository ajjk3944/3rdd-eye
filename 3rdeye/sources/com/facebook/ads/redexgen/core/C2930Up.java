...
public final class C2930Up implements NativeAdImageApi {
    ...
    public C2930Up(String str, int i, int i10) {
        this.A02 = str;
        this.A01 = i;
        this.A00 = i10;
    }

    public static C2930Up A00(JSONObject jSONObject) {
        String strOptString;
        if (jSONObject == null || (strOptString = jSONObject.optString(A01(6, 3, 75))) == null) {
            return null;
        }
        return new C2930Up(strOptString, jSONObject.optInt(A01(9, 5, 125), 0), jSONObject.optInt(A01(0, 6, 92), 0));
    }
