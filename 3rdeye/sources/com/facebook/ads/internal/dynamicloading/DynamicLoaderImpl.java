...
import com.facebook.ads.redexgen.core.AbstractC2835Qw;
import com.facebook.ads.redexgen.core.C2815Qc;
import com.facebook.ads.redexgen.core.C2837Qy;
import com.facebook.ads.redexgen.core.C2838Qz;
import com.facebook.ads.redexgen.core.C2930Up;
import com.facebook.ads.redexgen.core.C2931Uq;
import com.facebook.ads.redexgen.core.C2932Ur;
import com.facebook.ads.redexgen.core.C3415fg;
import com.facebook.ads.redexgen.core.C3416fh;
import com.facebook.ads.redexgen.core.C3432fx;
import com.facebook.ads.redexgen.core.InterfaceC2929Uo;
...
public class DynamicLoaderImpl implements DynamicLoader, RemoteRenderingApi {
    ...
    public AdOptionsViewApi createAdOptionsView(Context context, NativeAdBase nativeAdBase, NativeAdLayout nativeAdLayout, AdOptionsView.Orientation orientation, int i, AdOptionsView adOptionsView) {
        return new C3432fx(context, nativeAdBase, nativeAdLayout, orientation, i, adOptionsView);
    }
    ...
    public AdOptionsViewApi createAdOptionsView(Context context, NativeAdBase nativeAdBase, NativeAdLayout nativeAdLayout, AdOptionsView adOptionsView) {
        return new C3432fx(context, nativeAdBase, nativeAdLayout, adOptionsView);
    }
    ...
    public AdViewApi createAdViewApi(Context context, String str, AdSize adSize, AdViewParentApi adViewParentApi, AdView adView) {
        return (AdViewApi) AbstractC2835Qw.A00(new C2838Qz(context, str, adSize, adViewParentApi, adView), AdViewApi.class);
    }
    ...
    public AdViewApi createAdViewApi(Context context, String str, String str2, AdViewParentApi adViewParentApi, AdView adView) throws Exception {
        try {
            return (AdViewApi) AbstractC2835Qw.A00(new C2838Qz(context, str, str2, adViewParentApi, adView), AdViewApi.class);
        } catch (V2 e4) {
    ...
    public InterstitialAdApi createInterstitialAd(Context context, String str, InterstitialAd interstitialAd) {
        return (InterstitialAdApi) AbstractC2835Qw.A00(new RE(context, str, interstitialAd), InterstitialAdApi.class);
    }
    ...
    @Override // com.facebook.ads.internal.dynamicloading.DynamicLoader
    public C2931Uq createNativeAdRatingApi(JSONObject jSONObject) {
        return C2931Uq.A00(jSONObject);
    }

    @Override // com.facebook.ads.internal.dynamicloading.DynamicLoader
    public NativeAdScrollViewApi createNativeAdScrollViewApi(NativeAdScrollView nativeAdScrollView, Context context, NativeAdsManager nativeAdsManager, NativeAdScrollView.AdViewProvider adViewProvider, int i, NativeAdView.Type type, NativeAdViewAttributes nativeAdViewAttributes, int i10) {
        return new RL(nativeAdScrollView, context, nativeAdsManager, adViewProvider, i, type, nativeAdViewAttributes, i10);
    }
    ...
    public NativeAdsManagerApi createNativeAdsManagerApi(Context context, String str, int i) {
        return (NativeAdsManagerApi) AbstractC2835Qw.A00(new RO(context, str, i), NativeAdsManagerApi.class);
    }
    ...
    public RewardedInterstitialAdApi createRewardedInterstitialAd(Context context, String str, RewardedInterstitialAd rewardedInterstitialAd) {
        return (RewardedInterstitialAdApi) AbstractC2835Qw.A00(new RV(context, str, rewardedInterstitialAd), RewardedInterstitialAdApi.class);
    }

    @Override // com.facebook.ads.internal.dynamicloading.DynamicLoader
    public RewardedVideoAdApi createRewardedVideoAd(Context context, String str, RewardedVideoAd rewardedVideoAd) {
        return (RewardedVideoAdApi) AbstractC2835Qw.A00(new RZ(context, str, rewardedVideoAd), RewardedVideoAdApi.class);
    }
