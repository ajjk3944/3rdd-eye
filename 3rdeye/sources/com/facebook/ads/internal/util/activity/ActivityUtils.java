...
import com.facebook.ads.redexgen.core.AbstractC2885Sv;
import com.facebook.ads.redexgen.core.C2886Sw;
import com.facebook.ads.redexgen.core.C3246cu;
...
public final class ActivityUtils implements Application.ActivityLifecycleCallbacks {
     ...
     */
    public static synchronized void A04(C3246cu c3246cu, Class<? extends Activity> cls) {
        A02 = c3246cu;
        A01 = c3246cu.getApplicationContext();
            ...
            if (aNActivityLifecycleCallbacksListener != null) {
                ...
                synchronized (activityStateMap) {
                    try {
                        ...
                        c3246cu.A08().AAy(A01(208, 8, 61), AbstractC2885Sv.A02, new C2886Sw(A01(72, 80, 65)));
                    }
                }
                ANActivityLifecycleCallbacksListener.unregisterActivityCallbacks(c3246cu);
            }
            ((Application) A01).registerActivityLifecycleCallbacks(new ActivityUtils(cls));
        } else {
            c3246cu.A08().AAy(A01(216, 3, 3), AbstractC2885Sv.A0d, new C2886Sw(A01(42, 30, 126)));
        }
    }
    ...
    public static synchronized Activity A00() {
        ...
        if (A02 != null && z10 && key != activityA00) {
            C2886Sw c2886Sw = new C2886Sw(A01(19, 23, 76), A01(203, 5, 97) + key + A01(12, 7, 1) + activityA00);
            c2886Sw.A05(1);
            A02.A08().AAy(A01(208, 8, 61), AbstractC2885Sv.A03, c2886Sw);
        }
        return key != null ? key : activityA00;
    }

    public static void A03(C3272dL c3272dL) {
        if (!U7.A1k(c3272dL) || Build.VERSION.SDK_INT >= 29) {
            return;
        }
        WC wc = new WC(c3272dL);
        synchronized (A07) {
            A07.add(wc);
        }
    ...
    public final void onActivityPaused(Activity activity) {
        ...
        if (num == null || num.intValue() != 3) {
            C2886Sw c2886Sw = new C2886Sw(A01(172, 31, 79), A01(152, 20, 101) + num + A01(0, 12, 105) + activity);
            c2886Sw.A05(0);
            A02.A08().AAy(A01(208, 8, 61), AbstractC2885Sv.A03, c2886Sw);
        }
        A08.put(activity, 4);
