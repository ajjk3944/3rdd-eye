...
public class AdSize implements Serializable {
    ...
    public static AdSize fromWidthAndHeight(int i, int i10) {
        AdSize adSize = INTERSTITIAL;
        if (adSize.getHeight() == i10 && adSize.getWidth() == i) {
            return adSize;
        }
        AdSize adSize2 = BANNER_320_50;
        if (adSize2.getHeight() == i10 && adSize2.getWidth() == i) {
            return adSize2;
        }
        AdSize adSize3 = BANNER_HEIGHT_50;
        if (adSize3.getHeight() == i10 && adSize3.getWidth() == i) {
            return adSize3;
        }
        AdSize adSize4 = BANNER_HEIGHT_90;
        if (adSize4.getHeight() == i10 && adSize4.getWidth() == i) {
            return adSize4;
        }
        AdSize adSize5 = RECTANGLE_HEIGHT_250;
        if (adSize5.getHeight() == i10 && adSize5.getWidth() == i) {
            return adSize5;
        }
        throw new IllegalArgumentException("Can't create AdSize using this width = " + i + " && height = " + i10);
    }
