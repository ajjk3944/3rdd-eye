...
public abstract class MediaViewVideoRenderer extends AdComponentFrameLayout {
    ...
    @TargetApi(21)
    public MediaViewVideoRenderer(Context context, AttributeSet attributeSet, int i, int i10) {
        super(context, attributeSet, i, i10);
        initialize(new AdViewConstructorParams(context, attributeSet, i, i10));
    }
