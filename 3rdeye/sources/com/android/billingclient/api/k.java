...
public final class k extends com.google.android.gms.internal.play_billing.zzg {

    /* renamed from: b, reason: collision with root package name */
    public final WeakReference f18663b;

    /* renamed from: c, reason: collision with root package name */
    public final ResultReceiver f18664c;

    public /* synthetic */ k(WeakReference weakReference, ResultReceiver resultReceiver) {
        this.f18663b = weakReference;
        this.f18664c = resultReceiver;
    }

    @Override // com.google.android.gms.internal.play_billing.zzh
    public final void zza(Bundle bundle) throws RemoteException {
        ResultReceiver resultReceiver = this.f18664c;
        if (bundle == null) {
        ...
        try {
            Activity activity = (Activity) this.f18663b.get();
            ...
            com.google.android.gms.internal.play_billing.zzb.zzl("BillingClient", "Runtime error while launching intent for alternative billing only dialog.", e4);
            Bundle bundle2 = new Bundle();
            bundle2.putInt("RESPONSE_CODE", 6);
            bundle2.putString("DEBUG_MESSAGE", "An internal error occurred.");
            bundle2.putInt("INTERNAL_LOG_ERROR_REASON", 75);
            bundle2.putString("INTERNAL_LOG_ERROR_ADDITIONAL_DETAILS", e4.getClass().getName() + ": " + com.google.android.gms.internal.play_billing.zzab.zzb(e4.getMessage()));
