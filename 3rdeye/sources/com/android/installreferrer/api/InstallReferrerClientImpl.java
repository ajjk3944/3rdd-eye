...
class InstallReferrerClientImpl extends InstallReferrerClient {
    ...
    public final class InstallReferrerServiceConnection implements ServiceConnection {
        ...
        public void onServiceConnected(ComponentName componentName, IBinder iBinder) {
            ...
            int i = a.AbstractBinderC0048a.f2751b;
            if (iBinder == null) {
                c0049a = null;
            } else {
                IInterface iInterfaceQueryLocalInterface = iBinder.queryLocalInterface("com.google.android.finsky.externalreferrer.IGetInstallReferrerService");
                c0049a = iInterfaceQueryLocalInterface instanceof a ? (a) iInterfaceQueryLocalInterface : new a.AbstractBinderC0048a.C0049a(iBinder);
            }
            installReferrerClientImpl.service = c0049a;
    ...
    public ReferrerDetails getInstallReferrer() throws RemoteException {
        ...
        try {
            return new ReferrerDetails(this.service.g(bundle));
