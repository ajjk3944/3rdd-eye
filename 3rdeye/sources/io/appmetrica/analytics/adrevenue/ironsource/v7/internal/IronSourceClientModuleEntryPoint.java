...
public class IronSourceClientModuleEntryPoint extends ModuleClientEntryPoint<Object> {
    ...
    private ClientContext f38803a = null;

    /* renamed from: b, reason: collision with root package name */
    private final AtomicBoolean f38804b = new AtomicBoolean(false);
    ...
    public void initClientSide(ClientContext clientContext) {
        this.f38803a = clientContext;
    }

    @Override // io.appmetrica.analytics.modulesapi.internal.client.ModuleClientEntryPoint
    public void onActivated() {
        ClientContext clientContext;
        if (!ReflectionUtils.detectClassExists("com.ironsource.mediationsdk.IronSource") || (clientContext = this.f38803a) == null) {
            return;
        }
        IronSource.addImpressionDataListener(new c(clientContext));
        this.f38804b.set(true);
    }
}
