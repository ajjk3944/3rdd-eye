...
public final class MessageNanoPrinter {
    ...
    public static <T extends MessageNano> String print(T t10) throws SecurityException, IllegalArgumentException {
        if (t10 == null) {
            return "";
        }
        StringBuffer stringBuffer = new StringBuffer();
    ...
    private static void print(String str, Object obj, StringBuffer stringBuffer, StringBuffer stringBuffer2) throws IllegalAccessException, SecurityException, IllegalArgumentException, InvocationTargetException {
        ...
        if (obj instanceof Map) {
            ...
            for (Map.Entry entry : ((Map) obj).entrySet()) {
                ...
                print(AppMeasurementSdk.ConditionalUserProperty.VALUE, entry.getValue(), stringBuffer, stringBuffer2);
