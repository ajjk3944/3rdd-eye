...
import io.appmetrica.analytics.impl.C4920rb;

/* loaded from: classes3.dex */
public class IdentifiersResult implements Parcelable {
    public static final Parcelable.Creator<IdentifiersResult> CREATOR = new C4920rb();
    ...
    public String toString() {
        ...
        return f.c(sb, this.errorExplanation, "'}");
    }
