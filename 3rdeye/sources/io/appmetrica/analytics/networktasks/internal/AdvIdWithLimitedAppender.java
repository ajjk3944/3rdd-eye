...
public class AdvIdWithLimitedAppender implements IParamsAppender<AdvertisingIdsHolder> {
    ...
    public void appendParams(Uri.Builder builder, AdvertisingIdsHolder advertisingIdsHolder) {
        a(builder, CommonUrlParts.ADV_ID, "limit_ad_tracking", advertisingIdsHolder == null ? null : advertisingIdsHolder.getGoogle().mAdTrackingInfo);
        a(builder, "oaid", CommonUrlParts.HUAWEI_OAID_LIMIT_TRACKING, advertisingIdsHolder == null ? null : advertisingIdsHolder.getHuawei().mAdTrackingInfo);
