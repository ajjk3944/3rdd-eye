...
public enum EnumC4997ub {
    ...
    public static final HashMap f41733K = new HashMap();
    ...
    static {
        for (EnumC4997ub enumC4997ub : values()) {
            f41733K.put(Integer.valueOf(enumC4997ub.f41758a), enumC4997ub);
        }
    }

    EnumC4997ub(int i, String str) {
        this.f41758a = i;
        this.f41759b = str;
    }
    ...
    public static EnumC4997ub a(int i) {
        EnumC4997ub enumC4997ub = (EnumC4997ub) f41733K.get(Integer.valueOf(i));
        return enumC4997ub == null ? EVENT_TYPE_UNDEFINED : enumC4997ub;
    }
}
