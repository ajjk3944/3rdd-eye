...
public final class C4475a5 extends Qh {
    public C4475a5(Nf nf) {
        super(nf, new CounterConfiguration(), new T8(new C4853ol(LoggerStorage.getMainPublicOrAnonymousLogger(), "Crash Environment")));
