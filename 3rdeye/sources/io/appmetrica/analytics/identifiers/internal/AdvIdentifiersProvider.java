...
public class AdvIdentifiersProvider {
    ...
    public static final /* synthetic */ int f39070a = 0;
    private static final d retriever = new d();

    public static Bundle requestIdentifiers(Context context, Bundle bundle) {
        c cVarA;
        b bVar = (b) retriever.f39053a.get(bundle.getString("io.appmetrica.analytics.identifiers.extra.PROVIDER"));
        if (bVar == null || (cVarA = bVar.a(context)) == null) {
            return null;
        }
        Bundle bundle2 = new Bundle();
        a aVar = cVarA.f39051b;
        if (aVar != null) {
            Bundle bundle3 = new Bundle();
            bundle3.putString("io.appmetrica.analytics.identifiers.extra.PROVIDER", aVar.f39047a);
            bundle3.putString("io.appmetrica.analytics.identifiers.extra.ID", aVar.f39048b);
            Boolean bool = aVar.f39049c;
            if (bool != null) {
        ...
        bundle2.putString("io.appmetrica.analytics.identifiers.extra.STATUS", cVarA.f39050a.getValue());
        bundle2.putString("io.appmetrica.analytics.identifiers.extra.ERROR_MESSAGE", cVarA.f39052c);
        return bundle2;
    }
}
