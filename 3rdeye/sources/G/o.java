...
public final class o {
    ...
    public static final RectF f1843a = new RectF(-1.0f, -1.0f, 1.0f, 1.0f);

    public static Matrix a(RectF rectF, RectF rectF2, int i, boolean z10) {
    ...
    public static boolean c(int i) {
        ...
        throw new IllegalArgumentException(C4356c.h(i, "Invalid rotation degrees: "));
    }
    ...
    public static Size g(Size size, int i) {
        A2.l.k("Invalid rotation degrees: " + i, i % 90 == 0);
