...
public class aw {
    ...
    private static List<String> f21487a = new ArrayList();
    ...
    public static synchronized a b(Context context, String str) {
        ...
        try {
            ...
            if (fileA == null) {
                return new a(3, e2.getMessage(), "output null");
            }
            if (fileA.exists()) {
                fileA.delete();
            }
            ...
            try {
                ...
                return new a(3, e2.getMessage(), th2.getMessage());
            }
        } catch (Throwable th3) {
