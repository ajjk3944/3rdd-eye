...
public class ab {
    ...
    private static int f21431a = -1;

    /* renamed from: b, reason: collision with root package name */
    private static int f21432b = -1;
    ...
    private static void m(Context context) {
        ...
        ax.b(context, "hac", f21431a);
        ax.b(context, "tac", f21432b);
    }
    ...
    public static void b(Context context) {
        try {
            ...
            if (f21431a != 0) {
                m(context);
                com.pgl.ssdk.ces.a.meta(160, null, new int[]{f21431a, f21432b});
            }
        } catch (Throwable unused) {
        }
    }
