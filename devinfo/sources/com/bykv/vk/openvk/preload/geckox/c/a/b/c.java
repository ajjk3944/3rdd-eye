...
public class c extends com.bykv.vk.openvk.preload.a.d<Pair<Uri, UpdatePackage>, Pair<com.bykv.vk.openvk.preload.geckox.buffer.a, UpdatePackage>> {
    ...
    private com.bykv.vk.openvk.preload.geckox.b f6712d;
    ...
    public final void a(Object... objArr) {
        super.a(objArr);
        this.f6712d = (com.bykv.vk.openvk.preload.geckox.b) objArr[0];
        this.f6713e = (File) objArr[1];
    }
    ...
    public Object a(com.bykv.vk.openvk.preload.a.b<Pair<com.bykv.vk.openvk.preload.geckox.buffer.a, UpdatePackage>> bVar, Pair<Uri, UpdatePackage> pair) throws Throwable {
        ...
        try {
            this.f6712d.i().downloadFile(string, length, new BufferOutputStream(aVarA));
            try {
            ...
            aVarA.e();
            StringBuilder sbA = h.A("download patch single file failed, url:", string, ", channel:");
