    ...
    public static class a {
        ...
        public final a a(JSONObject jSONObject) {
            ...
            if (jSONObject != null) {
                try {
                    if (jSONObject.has("c")) {
                        this.f6762a = (String) com.bykv.vk.openvk.preload.falconx.a.a.a(jSONObject, "c", String.class);
                    }
                    if (jSONObject.has("clean_type")) {
                        this.f6763b = jSONObject.optInt("clean_type");
                    }
                    if (jSONObject.has("version") && (jSONArrayOptJSONArray = jSONObject.optJSONArray("version")) != null && jSONArrayOptJSONArray.length() > 0) {
                        ...
                        for (int i4 = 0; i4 < jSONArrayOptJSONArray.length(); i4++) {
                            this.f6764c.add(Long.valueOf(jSONArrayOptJSONArray.optLong(i4)));
                        }
                    }
