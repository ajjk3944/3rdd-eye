...
public class NativeImpl {
    ...
    private static volatile boolean f3362a = false;

    /* renamed from: b, reason: collision with root package name */
    private static volatile boolean f3363b = false;

    /* renamed from: c, reason: collision with root package name */
    private static boolean f3364c = true;
    ...
    public static boolean a() {
        ...
        f3363b = true;
        if (!f3362a) {
            f3362a = com.apm.insight.a.b("apminsighta");
        }
        return f3362a;
    }
    ...
    public static int c(String str) {
        if (f3362a && !TextUtils.isEmpty(str)) {
            try {
                return doLock(str, -1);
            } catch (Throwable unused) {
            }
