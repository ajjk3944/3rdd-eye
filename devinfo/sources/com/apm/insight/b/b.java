...
public final class b {
    ...
    private static volatile boolean f3015z = true;
    ...
    private volatile boolean f3018c;
    private JSONObject g;

    /* renamed from: h, reason: collision with root package name */
    private JSONObject f3022h;

    /* renamed from: m, reason: collision with root package name */
    private JSONArray f3026m;

    /* renamed from: n, reason: collision with root package name */
    private JSONObject f3027n;

    /* renamed from: q, reason: collision with root package name */
    private JSONArray f3030q;

    /* renamed from: r, reason: collision with root package name */
    private JSONArray f3031r;

    /* renamed from: s, reason: collision with root package name */
    private JSONObject f3032s;

    /* renamed from: t, reason: collision with root package name */
    private boolean f3033t;

    /* renamed from: v, reason: collision with root package name */
    private volatile boolean f3035v;

    /* renamed from: d, reason: collision with root package name */
    private long f3019d = -1;

    /* renamed from: e, reason: collision with root package name */
    private File f3020e = null;

    /* renamed from: f, reason: collision with root package name */
    private boolean f3021f = true;

    /* renamed from: i, reason: collision with root package name */
    private String f3023i = AppLovinMediationProvider.UNKNOWN;
    private String j = AppLovinMediationProvider.UNKNOWN;

    /* renamed from: k, reason: collision with root package name */
    private String f3024k = AppLovinMediationProvider.UNKNOWN;

    /* renamed from: l, reason: collision with root package name */
    private String f3025l = "npth_inner_default";

    /* renamed from: o, reason: collision with root package name */
    private int f3028o = 0;

    /* renamed from: p, reason: collision with root package name */
    private long f3029p = -1;

    /* renamed from: u, reason: collision with root package name */
    private final Object f3034u = new Object();

    /* renamed from: w, reason: collision with root package name */
    private long f3036w = -1;

    /* renamed from: x, reason: collision with root package name */
    private long f3037x = 0;

    /* renamed from: y, reason: collision with root package name */
    private final Runnable f3038y = new Runnable() { // from class: com.apm.insight.b.b.1
    ...
    private File i() {
        if (this.D == null) {
            this.D = new File(this.f3017b.getFilesDir(), "has_anr_signal_" + com.apm.insight.l.a.b().replaceAll(":", "_"));
        }
        return this.D;
    }
    ...
    public final void e() {
        ...
        this.f3036w = SystemClock.uptimeMillis();
        this.f3035v = true;
    }
    ...
    */
    ...
    public final void a() {
        ...
        this.f3016a = new c(this);
        this.f3019d = com.apm.insight.e.j();
        this.f3018c = true;
    }
    ...
    private JSONObject c(JSONArray jSONArray) throws JSONException {
        ...
        try {
            ...
            for (int i4 = 0; i4 < jSONArrayB.length(); i4++) {
                sb2.append(jSONArrayB.getString(i4));
                sb2.append('\n');
            }
    ...
    private void b(long j) {
        if (this.f3037x != this.f3036w) {
            try {
                this.f3029p = System.currentTimeMillis();
                if (com.apm.insight.e.x()) {
                    this.f3031r = f.b().b();
                    this.f3030q = j.a(j);
                    this.f3022h = f.b().a(j).a();
                }
                JSONObject jSONObject = new JSONObject();
                this.f3032s = jSONObject;
                com.apm.insight.l.a.a(this.f3017b, jSONObject);
                this.f3033t = h();
                this.f3021f = !Npth.hasCrash();
            } catch (Throwable unused) {
            }
            try {
                this.f3019d = this.f3029p;
                String strB = com.apm.insight.l.j.b();
                File file = new File(new File(com.apm.insight.l.j.f(this.f3017b), strB), "trace_" + com.apm.insight.l.a.b().replace(':', '_') + ".txt");
            ...
            try {
                ...
                File file2 = new File(new File(com.apm.insight.l.j.f(this.f3017b), strB2), "trace" + com.apm.insight.l.a.b().replace(':', '_') + ".txt");
    ...
    private boolean a(String str) {
        if (this.B == null) {
            ...
            if (jSONArrayB != null) {
                ...
                this.f3025l = jSONArrayB.optString(0);
                for (int i4 = 1; i4 < jSONArrayB.length(); i4++) {
                    try {
                        this.B.add(Pattern.compile(jSONArrayB.optString(i4)));
                    } catch (Throwable unused) {
                    }
                }
            }
  ...
  0x0262: PHI (r29v7 char) = (r29v4 char), (r29v12 char) binds: [B:133:0x025e, B:114:0x0210] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    ...
    private static void a(HashMap<String, Float> map, JSONObject jSONObject, String str) throws JSONException {
        ...
        jSONObject.put(d.h.s(strConcat, "_total"), b(f10));
