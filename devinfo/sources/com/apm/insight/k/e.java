...
public final class e {
    ...
    public static final class a {
        ...
        private static a f3289c = new a("NONE", 0, 0);

        /* renamed from: a, reason: collision with root package name */
        public static final a f3287a = new a("GZIP", 1, 1);

        /* renamed from: b, reason: collision with root package name */
        public static final a f3288b = new a("DEFLATER", 2, 2);

        private a(String str, int i4, int i10) {
            this.f3290d = i10;
        }
    }
    ...
    private static com.apm.insight.l.f a(String str, byte[] bArr, a aVar, String str2) throws IOException {
        ...
        if (a.f3287a == aVar && length > 128) {
            bArr = a(bArr);
            str3 = "gzip";
        } else if (a.f3288b != aVar || length <= 128) {
            str3 = null;
        } else {
    ...
    private static com.apm.insight.l.f d(String str, String str2) {
        try {
            if (!TextUtils.isEmpty(str2) && !TextUtils.isEmpty(str)) {
                return a(str, str2.getBytes(), a.f3287a, "application/json; charset=utf-8");
            }
            return new com.apm.insight.l.f(201);
        } catch (Throwable th2) {
    ...
    private static com.apm.insight.l.f b(String str, String str2, File... fileArr) {
        ...
        try {
            ...
            try {
                ...
                return new com.apm.insight.l.f(0, e2);
            }
    ...
    public static byte[] a(String str, byte[] bArr) {
        try {
            ...
            return a(str, bArr, a.f3287a, "application/json; charset=utf-8").b();
        } catch (IOException e2) {
            e2.printStackTrace();
            return null;
        }
