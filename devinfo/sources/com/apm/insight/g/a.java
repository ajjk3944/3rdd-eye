...
public final class a implements Thread.UncaughtExceptionHandler {
    ...
    private static volatile boolean f3199i = false;
    private static volatile ThreadLocal<Boolean> j = new ThreadLocal<>();

    /* renamed from: l, reason: collision with root package name */
    private static volatile long f3200l = 10000;

    /* renamed from: m, reason: collision with root package name */
    private static ArrayList<b> f3201m = new ArrayList<>();

    /* renamed from: b, reason: collision with root package name */
    private Thread.UncaughtExceptionHandler f3202b;
    ...
    private volatile int f3205e = 0;

    /* renamed from: f, reason: collision with root package name */
    private volatile int f3206f = 0;
    private ConcurrentHashMap<String, Object> g = new ConcurrentHashMap<>();

    /* renamed from: h, reason: collision with root package name */
    private ConcurrentHashMap<String, Object> f3207h = new ConcurrentHashMap<>();

    /* renamed from: k, reason: collision with root package name */
    private JSONArray f3208k;

    private a() {
        Thread.UncaughtExceptionHandler defaultUncaughtExceptionHandler = Thread.getDefaultUncaughtExceptionHandler();
        if (defaultUncaughtExceptionHandler != this) {
            this.f3202b = defaultUncaughtExceptionHandler;
    ...
    private void c(Thread thread, Throwable th2) {
        Thread.UncaughtExceptionHandler uncaughtExceptionHandler = this.f3202b;
    ...
    private void d() {
        ...
        while (this.f3206f != 0 && SystemClock.uptimeMillis() - jUptimeMillis < f3200l) {
    ...
    private static void e() {
        ...
        long jUptimeMillis = SystemClock.uptimeMillis();
        while (!h.a() && SystemClock.uptimeMillis() - jUptimeMillis < f3200l) {
            try {
    ...
    private static int f() {
        int iA = 0;
        for (int i4 = 0; i4 < f3201m.size(); i4++) {
            try {
                try {
                    iA |= f3201m.get(i4).a();
                } catch (Throwable th2) {
  ...
  0x0065: PHI (r0v52 boolean) = (r0v9 boolean), (r0v53 boolean), (r0v53 boolean), (r0v53 boolean) binds: [B:24:0x0064, B:20:0x005a, B:142:0x0065, B:22:0x0060] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    ...
    private String a(File file, Throwable th2, Thread thread, boolean z3) {
        String absolutePath = file.getAbsolutePath();
        this.f3207h.put(file.getName(), file);
        try {
                ...
                try {
                    strA = com.apm.insight.l.m.a(th2, new PrintStream(fileOutputStream), Looper.getMainLooper() == Looper.myLooper() ? new e.a() { // from class: com.apm.insight.g.a.1
                        ...
                        public final boolean a(String str) {
                            if (!this.f3209a && str.contains("android.os.Looper.loop")) {
                                this.f3209a = true;
                            }
                            return !this.f3209a;
                        }
    ...
    public final void a(Thread thread, Throwable th2, boolean z3, com.apm.insight.entity.a aVar) {
        ...
        for (ICrashCallback iCrashCallback : listC) {
            ...
            try {
                if (iCrashCallback instanceof com.apm.insight.b) {
                    ((com.apm.insight.b) iCrashCallback).a(crashType, com.apm.insight.l.m.a(th2), thread, this.f3208k);
                } else {
    ...
    private void a(Thread thread, Throwable th2, boolean z3, long j8) {
        Thread thread2;
        Throwable th3;
        long j9;
        List<IOOMCallback> listA = l.a().a();
        CrashType crashType = z3 ? CrashType.LAUNCH : CrashType.JAVA;
        for (IOOMCallback iOOMCallback : listA) {
            try {
                if (iOOMCallback instanceof com.apm.insight.b) {
                    ...
                    j9 = j8;
                    try {
                        ((com.apm.insight.b) iOOMCallback).a(crashType, th3, thread2, j9, this.f3208k);
                    } catch (Throwable th4) {
                        th = th4;
                    ...
                    th3 = th2;
                    j9 = j8;
                    iOOMCallback.onCrash(crashType, th3, thread2, j9);
                }
            } catch (Throwable th5) {
                th = th5;
                thread2 = thread;
