...
public final class a {
    ...
    public static void a(JSONArray jSONArray, boolean z3) {
        if (jSONArray == null) {
            return;
        }
        com.apm.insight.a.a("apmconfig", "fromnet " + z3 + " : " + jSONArray);
        if (z3) {
    ...
    private static JSONObject a(JSONArray jSONArray, String str) {
        if (jSONArray != null && jSONArray.length() != 0) {
            for (int i4 = 0; i4 < jSONArray.length(); i4++) {
                JSONObject jSONObjectOptJSONObject = jSONArray.optJSONObject(i4).optJSONObject(str);
    ...
    public static int a(int i4, String... strArr) {
        return com.apm.insight.a.a(i(), i4, strArr);
    }
