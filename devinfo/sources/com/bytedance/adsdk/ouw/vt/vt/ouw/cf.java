    ...
    public final Object ouw(Map<String, JSONObject> map) {
        ...
        if ((number instanceof Integer) || (number instanceof Short) || (number instanceof Byte)) {
            ...
            if (number2 instanceof Long) {
                return Long.valueOf(iIntValue - number2.longValue());
            }
            if (number2 instanceof Float) {
                return Float.valueOf(iIntValue - number2.floatValue());
            }
            if (number2 instanceof Double) {
                return Double.valueOf(iIntValue - number2.doubleValue());
            }
        ...
        if (number instanceof Float) {
            ...
            if (number2 instanceof Double) {
                return Double.valueOf(fFloatValue - number2.doubleValue());
            }
            throw new UnsupportedOperationException(h.r(number2, "This type of addition operation is not supported"));
        }
