...
public final class yu extends jg<Integer, Integer> {
    public yu(List<com.bytedance.adsdk.vt.ra.ouw<Integer>> list) {
        super(list);
    }
    ...
    public final com.bytedance.adsdk.vt.ouw.vt.ouw<Integer, Integer> ouw() {
        return new com.bytedance.adsdk.vt.ouw.vt.le(this.ouw);
    }
