...
public final class Pipe {
    ...
    public Pipe(long j) {
        ...
        if (j < 1) {
            throw new IllegalArgumentException(g.j(j, "maxBufferSize < 1: ").toString());
        }
        ...
        this.source = new Source() { // from class: com.applovin.shadow.okio.Pipe.source.1
            ...
            public long read(Buffer buffer, long j8) {
                ...
                try {
                    ...
                    long j9 = pipe.getBuffer$okio().read(buffer, j8);
                    pipe.getCondition().signalAll();
                    lock.unlock();
                    return j9;
                } catch (Throwable th2) {
    ...
    private final void forward(Sink sink, c cVar) {
    ...
    public final Sink m157deprecated_sink() {
        return this.sink;
    }

    @yj.a
    /* renamed from: -deprecated_source, reason: not valid java name */
    public final Source m158deprecated_source() {
        return this.source;
    }
