...
public final class RetryAndFollowUpInterceptor implements Interceptor {
    ...
    private final Request buildRedirectRequest(Response response, String str) {
        ...
        if (HttpMethod.permitsRequestBody(str)) {
            ...
            boolean z3 = httpMethod.redirectsWithBody(str) || iCode == 308 || iCode == 307;
            if (!httpMethod.redirectsToGet(str) || iCode == 308 || iCode == 307) {
                builderNewBuilder.method(str, z3 ? response.request().body() : null);
            } else {
    ...
    private final int retryAfter(Response response, int i4) throws NumberFormatException {
    ...
    */
    public com.applovin.shadow.okhttp3.Response intercept(com.applovin.shadow.okhttp3.Interceptor.Chain r11) throws java.io.IOException {
        ...
        L17:
            ...
            com.applovin.shadow.okhttp3.Response$Builder r6 = r6.body(r3)     // Catch: java.lang.Throwable -> L40
        ...
        L97:
            ...
            if (r9 == 0) goto Lab
            java.util.ArrayList r5 = zj.n.k0(r5, r6)     // Catch: java.lang.Throwable -> L40
        La5:
            r1.exitNetworkInterceptorExchange$okhttp(r4)
            r6 = r2
            goto L17
        Lab:
            java.lang.Throwable r11 = com.applovin.shadow.okhttp3.internal.Util.withSuppressed(r6, r5)     // Catch: java.lang.Throwable -> L40
            throw r11     // Catch: java.lang.Throwable -> L40
        Lb0:
            r6 = move-exception
            java.io.IOException r9 = r6.getLastConnectException()     // Catch: java.lang.Throwable -> L40
            boolean r9 = r10.recover(r9, r1, r0, r2)     // Catch: java.lang.Throwable -> L40
            if (r9 == 0) goto Lc4
        ...
        Lc4:
            ...
            java.lang.Throwable r11 = com.applovin.shadow.okhttp3.internal.Util.withSuppressed(r11, r5)     // Catch: java.lang.Throwable -> L40
            throw r11     // Catch: java.lang.Throwable -> L40
        Lcd:
