...
public final class RealInterceptorChain implements Interceptor.Chain {
    ...
    public RealInterceptorChain(RealCall realCall, List<? extends Interceptor> list, int i4, Exchange exchange, Request request, int i10, int i11, int i12) {
        k.e(realCall, "call");
    ...
    public static /* synthetic */ RealInterceptorChain copy$okhttp$default(RealInterceptorChain realInterceptorChain, int i4, Exchange exchange, Request request, int i10, int i11, int i12, int i13, Object obj) {
        ...
        int i14 = i11;
        int i15 = i12;
        return realInterceptorChain.copy$okhttp(i4, exchange, request, i10, i14, i15);
    }
    ...
    public final RealInterceptorChain copy$okhttp(int i4, Exchange exchange, Request request, int i10, int i11, int i12) {
        k.e(request, "request");
    ...
    public Interceptor.Chain withConnectTimeout(int i4, TimeUnit timeUnit) {
        ...
        if (this.exchange == null) {
            return copy$okhttp$default(this, 0, null, null, Util.checkDuration("connectTimeout", i4, timeUnit), 0, 0, 55, null);
        }
    ...
    public Interceptor.Chain withReadTimeout(int i4, TimeUnit timeUnit) {
        k.e(timeUnit, "unit");
        if (this.exchange == null) {
            return copy$okhttp$default(this, 0, null, null, 0, Util.checkDuration("readTimeout", i4, timeUnit), 0, 47, null);
        }
        throw new IllegalStateException("Timeouts can't be adjusted in a network interceptor");
    }
    ...
    public Interceptor.Chain withWriteTimeout(int i4, TimeUnit timeUnit) {
        k.e(timeUnit, "unit");
        if (this.exchange == null) {
            return copy$okhttp$default(this, 0, null, null, 0, 0, Util.checkDuration("writeTimeout", i4, timeUnit), 31, null);
        }
        throw new IllegalStateException("Timeouts can't be adjusted in a network interceptor");
    }
