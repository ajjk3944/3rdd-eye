...
public final class DatesKt {
        ...
        synchronized (strArr) {
            try {
                ...
                for (int i4 = 0; i4 < length; i4++) {
                    ...
                    DateFormat simpleDateFormat = dateFormatArr[i4];
                    if (simpleDateFormat == null) {
                        simpleDateFormat = new SimpleDateFormat(BROWSER_COMPATIBLE_DATE_FORMAT_STRINGS[i4], Locale.US);
                        simpleDateFormat.setTimeZone(Util.UTC);
    ...
    public static final String toHttpDateString(Date date) {
        ...
        k.d(str, "STANDARD_DATE_FORMAT.get().format(this)");
        return str;
    }
}
