...
public final class Http2 {
    ...
    static {
        ...
        for (int i4 = 0; i4 < 256; i4++) {
            ...
            strArr[i4] = p.t0(Util.format("%8s", binaryString), ' ', '0');
        }
        BINARY = strArr;
        ...
        strArr2[8] = "PADDED";
        int i10 = iArr[0];
        strArr2[i10 | 8] = h.w(new StringBuilder(), strArr2[i10], "|PADDED");
        ...
        for (int i11 = 0; i11 < 3; i11++) {
            ...
            sb2.append('|');
            strArr3[i14 | 8] = h.w(sb2, strArr3[i12], "|PADDED");
        }
    ...
    public final String formatFlags(int i4, int i10) {
        ...
        if (i4 != 2 && i4 != 3) {
            ...
            if (i4 != 7 && i4 != 8) {
                ...
                return (i4 != 5 || (i10 & 4) == 0) ? (i4 != 0 || (i10 & 32) == 0) ? str : p.u0(str, "PRIORITY", "COMPRESSED") : p.u0(str, "HEADERS", "PUSH_PROMISE");
            }
        }
        return BINARY[i10];
    }
    ...
    public final String frameLog(boolean z3, int i4, int i10, int i11, int i12) {
        return Util.format("%s 0x%08x %5d %-13s %s", z3 ? "<<" : ">>", Integer.valueOf(i4), Integer.valueOf(i10), formattedType$okhttp(i11), formatFlags(i11, i12));
    }
}
