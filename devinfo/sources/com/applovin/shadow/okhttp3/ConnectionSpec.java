...
public final class ConnectionSpec {
    ...
    public ConnectionSpec(boolean z3, boolean z10, String[] strArr, String[] strArr2) {
        this.isTls = z3;
    ...
    private final ConnectionSpec supportedSpec(SSLSocket sSLSocket, boolean z3) {
        ...
        if (this.tlsVersionsAsString != null) {
            ...
            enabledProtocols = Util.intersect(enabledProtocols2, this.tlsVersionsAsString, b.f2273b);
        } else {
    ...
    public final void apply$okhttp(SSLSocket sSLSocket, boolean z3) {
        ...
        ConnectionSpec connectionSpecSupportedSpec = supportedSpec(sSLSocket, z3);
    ...
    public final boolean isCompatible(SSLSocket sSLSocket) {
        ...
        if (strArr != null && !Util.hasIntersection(strArr, sSLSocket.getEnabledProtocols(), b.f2273b)) {
            return false;
        }
    ...
    public String toString() {
        ...
        return h.x(sb2, this.supportsTlsExtensions, ')');
    }
