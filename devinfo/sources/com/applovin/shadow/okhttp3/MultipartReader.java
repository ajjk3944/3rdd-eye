        ...
        public long read(Buffer buffer, long j) {
            ...
            if (!timeout.hasDeadline()) {
                ...
                try {
                    ...
                    long j9 = jCurrentPartBytesRemaining == 0 ? -1L : multipartReader.source.read(buffer, jCurrentPartBytesRemaining);
            ...
            try {
                ...
                long j10 = jCurrentPartBytesRemaining2 == j8 ? -1L : multipartReader.source.read(buffer, jCurrentPartBytesRemaining2);
                timeout.timeout(jTimeoutNanos, timeUnit);
                if (timeout2.hasDeadline()) {
