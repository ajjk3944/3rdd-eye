...
public class MaxAdapterError extends MaxErrorImpl {
    ...
    public MaxAdapterError(int i4) {
        this(i4, "", 0, "");
    }

    public MaxAdapterError(int i4, int i10) {
        this(i4, "", i10, "");
    }

    public MaxAdapterError(int i4, String str) {
        this(i4, str, 0, "");
    }

    public MaxAdapterError(MaxAdapterError maxAdapterError, int i4, String str) {
        this(maxAdapterError.getErrorCode(), maxAdapterError.getErrorMessage(), i4, str);
    }

    public MaxAdapterError(int i4, String str, int i10, String str2) {
