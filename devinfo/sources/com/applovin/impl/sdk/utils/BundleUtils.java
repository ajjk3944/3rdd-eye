...
public class BundleUtils {
    ...
    public static JSONObject toJSONObject(Bundle bundle) throws JSONException {
        ...
        try {
            ...
            o.c("AppLovinSdk", "Failed to convert Bundle to JSONObject", e2);
            return jSONObject;
        }
    }
            ...
            if (obj != null) {
                if (obj instanceof Bundle) {
                    ...
                    if (z3 || (obj instanceof Parcelable[])) {
                        Collection collectionAsList = z3 ? (Collection) obj : Arrays.asList((Parcelable[]) obj);
    ...
    public static boolean getBoolean(String str, boolean z3, Bundle bundle) {
    ...
    public static int getInt(String str, int i4, Bundle bundle) {
        if (!TextUtils.isEmpty(str) && bundle != null && bundle.containsKey(str)) {
            Object obj = bundle.get(str);
            if (obj instanceof Number) {
