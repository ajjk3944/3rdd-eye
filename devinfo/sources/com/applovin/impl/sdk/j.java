...
public class j implements AppLovinCommunicatorSubscriber, AppLovinCommunicatorPublisher {
    ...
    private final AppLovinCommunicator f5519b;

    public j(k kVar) {
        this.f5518a = kVar;
        AppLovinCommunicator appLovinCommunicator = AppLovinCommunicator.getInstance(k.o());
        this.f5519b = appLovinCommunicator;
        if (((Boolean) kVar.a(x4.f6076k7)).booleanValue()) {
            appLovinCommunicator.a(kVar);
            appLovinCommunicator.subscribe(this, h7.f4221a);
        }
    }
    ...
    public void a(JSONObject jSONObject, boolean z3) {
        if (b("safedk_init") && com.applovin.impl.j.c()) {
            ...
            bundle.putString(AppLovinWebViewActivity.INTENT_EXTRA_KEY_SDK_KEY, this.f5518a.i0());
            bundle.putString("applovin_random_token", this.f5518a.h0());
            bundle.putString("compass_random_token", this.f5518a.u());
            bundle.putString("device_type", AppLovinSdkUtils.isTablet(k.o()) ? "tablet" : "phone");
            bundle.putString("init_success", String.valueOf(z3));
            bundle.putParcelableArrayList("installed_mediation_adapters", JsonUtils.toBundle(w3.b(this.f5518a)));
            JSONObject jSONObject2 = JsonUtils.getJSONObject(jSONObject, "communicator_settings", (JSONObject) null);
            Bundle bundle2 = (Bundle) bundle.clone();
            bundle2.putString("user_id", this.f5518a.w0().e());
            JSONObject jSONObject3 = JsonUtils.getJSONObject(jSONObject2, "safedk_settings", new JSONObject());
            if (!((Boolean) this.f5518a.a(x4.f6085l7)).booleanValue()) {
            ...
            this.f5518a.O();
            if (o.a()) {
                this.f5518a.O().a("CommunicatorService", "Sending \"safedk_init\" message: " + bundle);
            }
    ...
    public void onMessageReceived(AppLovinCommunicatorMessage appLovinCommunicatorMessage) {
        ...
        if (((Boolean) this.f5518a.a(x4.f6076k7)).booleanValue()) {
            if ("send_http_request".equalsIgnoreCase(appLovinCommunicatorMessage.getTopic())) {
                ...
                if (!map3.containsKey(AppLovinWebViewActivity.INTENT_EXTRA_KEY_SDK_KEY)) {
                    map3.put(AppLovinWebViewActivity.INTENT_EXTRA_KEY_SDK_KEY, this.f5518a.i0());
                }
                this.f5518a.f0().e(new d.b().d(messageData.getString("url")).a(messageData.getString("backup_url")).b(stringMap).c(map3).a(stringMap2).a(((Boolean) this.f5518a.a(x4.f6074k5)).booleanValue()).b(string).a());
                return;
            }
            if (!"send_http_request_v2".equalsIgnoreCase(appLovinCommunicatorMessage.getTopic())) {
                if ("set_ad_request_query_params".equalsIgnoreCase(appLovinCommunicatorMessage.getTopic())) {
                    this.f5518a.k().addCustomQueryParams(n7.a((Map) BundleUtils.toMap(appLovinCommunicatorMessage.getMessageData())));
                    return;
                } else if ("set_ad_request_post_body".equalsIgnoreCase(appLovinCommunicatorMessage.getTopic())) {
                    this.f5518a.k().setCustomPostBody(BundleUtils.toJSONObject(appLovinCommunicatorMessage.getMessageData()));
                    return;
                } else {
                    if ("set_mediate_request_post_body_data".equalsIgnoreCase(appLovinCommunicatorMessage.getTopic())) {
                        this.f5518a.X().setCustomPostBodyData(BundleUtils.toJSONObject(appLovinCommunicatorMessage.getMessageData()));
                        return;
                    }
                    return;
                }
            ...
            long millis = messageData2.containsKey("timeout_sec") ? TimeUnit.SECONDS.toMillis(messageData2.getLong("timeout_sec")) : ((Long) this.f5518a.a(x4.f6064j3)).longValue();
            int i10 = messageData2.getInt("retry_count", ((Integer) this.f5518a.a(x4.f6072k3)).intValue());
            long millis2 = messageData2.containsKey("retry_delay_sec") ? TimeUnit.SECONDS.toMillis(messageData2.getLong("retry_delay_sec")) : ((Long) this.f5518a.a(x4.f6081l3)).longValue();
            ...
            if ("GET".equalsIgnoreCase(string2)) {
                if (messageData2.getBoolean("include_data_collector_info", true)) {
                    map2 = null;
                    stringMap3.putAll(BundleUtils.toStringMap(CollectionUtils.toBundle(this.f5518a.A().a((Map) null, false, false))));
                } else {
                    map2 = null;
                }
                j = millis;
                ...
                if (messageData2.getBoolean("include_data_collector_info", true)) {
                    Map mapG = this.f5518a.A().G();
                    Map mapP = this.f5518a.A().p();
                    j8 = millis2;
                    ...
                    mapG.put("server_installed_at", this.f5518a.a(x4.f6100o));
                    mapG.put(AppLovinWebViewActivity.INTENT_EXTRA_KEY_SDK_KEY, this.f5518a.i0());
                    map.put("app", mapG);
                    map.put("device", mapP);
                } else {
                    j = millis;
            ...
            this.f5518a.q0().a((i5) new n0(appLovinCommunicatorMessage.getPublisherId(), com.applovin.impl.sdk.network.a.a(this.f5518a).b(messageData2.getString("url")).a(messageData2.getString("backup_url")).b(stringMap3).c(string2).a((Map) BundleUtils.toStringMap(messageData2.getBundle("headers"))).a(map != null ? new JSONObject(map) : null).c((int) j).a(i4).b((int) j8).a((Object) new JSONObject()).a(messageData2.getBoolean("is_encoding_enabled", false)).a(), this.f5518a), d6.b.OTHER);
        }
    }
    ...
    public void b(y2 y2Var, String str) {
        if (b("max_ad_events")) {
            ...
            this.f5518a.O();
            if (o.a()) {
                this.f5518a.O().a("CommunicatorService", "Sending \"max_ad_events\" message: " + bundleA);
            }
    ...
    public void b(y2 y2Var) {
        if (b("max_revenue_events")) {
            ...
            bundleA.putString("country_code", this.f5518a.v().getCountryCode());
    ...
    private boolean b(String str) {
        if (((Boolean) this.f5518a.a(x4.f6076k7)).booleanValue()) {
            return this.f5518a.c(x4.f6068j7).contains(str) || this.f5519b.hasSubscriber(str);
        }
        return false;
    }
    ...
    public void a(MaxAdapter.InitializationStatus initializationStatus, String str) {
        if (b("adapter_initialization_status")) {
            Bundle bundleG = r5.c.g("adapter_class", str);
            bundleG.putInt("init_status", initializationStatus.getCode());
            a(bundleG, "adapter_initialization_status");
        }
    }
    ...
    public void a(String str, String str2, int i4, Object obj, String str3, boolean z3) {
    ...
    public void a(Bundle bundle, String str) {
        if (b(str)) {
            this.f5519b.getMessagingService().publish(CommunicatorMessageImpl.create(bundle, str, this, this.f5518a.c(x4.f6068j7).contains(str)));
        }
    }

    public boolean a(String str) {
        return h7.f4221a.contains(str);
    }
