...
public class AppLovinVastMediaView extends AppLovinMediaView implements AppLovinCommunicatorSubscriber {
    ...
    public class d implements AppLovinTouchToClickListener.OnClickListener {
        ...
        public void onClick(View view, MotionEvent motionEvent) {
            ...
            if (AppLovinVastMediaView.this.vastAd.B0() && (uriC0 = AppLovinVastMediaView.this.vastAd.c0()) != null) {
                ...
                AppLovinVastMediaView.this.nativeAd.handleNativeAdClick(uriC0, null, (!((Boolean) AppLovinVastMediaView.this.sdk.a(x4.f6161w)).booleanValue() || AppLovinVastMediaView.this.viewActivity == null) ? AppLovinVastMediaView.this.getContext() : AppLovinVastMediaView.this.viewActivity);
            }
        }
    ...
    public class e implements MediaPlayer.OnPreparedListener, MediaPlayer.OnErrorListener, MediaPlayer.OnInfoListener, MediaPlayer.OnCompletionListener {
        ...
        public void onCompletion(MediaPlayer mediaPlayer) {
            ...
            if (AppLovinVastMediaView.this.replayIconContainer != null) {
                e8.a(AppLovinVastMediaView.this.replayIconContainer, AppLovinVastMediaView.FADE_ANIMATION_DURATION_MILLIS, new com.applovin.impl.sdk.nativeAd.d(0, this));
            } else {
        ...
        public boolean onError(MediaPlayer mediaPlayer, int i4, int i10) {
            AppLovinVastMediaView.this.handleMediaError(r5.c.i(i4, "Video view error (", ",", i10, ")"));
            return true;
        }
        ...
        public void onClick(View view) {
            ...
            if (view != AppLovinVastMediaView.this.muteButtonImageView) {
                if (view == AppLovinVastMediaView.this.replayIconContainer) {
                    e8.b(AppLovinVastMediaView.this.replayIconContainer, AppLovinVastMediaView.FADE_ANIMATION_DURATION_MILLIS, new com.applovin.impl.sdk.nativeAd.d(1, this));
                }
            } else {
    ...
    public AppLovinVastMediaView(AppLovinNativeAdImpl appLovinNativeAdImpl, k kVar, Context context) {
        ...
        if (((Boolean) kVar.a(x4.f6017d5)).booleanValue()) {
            ...
            this.videoWidgetLinearLayout.setAlpha(((Float) kVar.a(x4.f6008c5)).floatValue());
            ImageView imageView = new ImageView(context);
            this.playPauseButtonImageView = imageView;
            imageView.setClickable(true);
            f fVar = new f(this, aVar);
            this.playPauseButtonImageView.setOnClickListener(fVar);
            int iDpToPx3 = AppLovinSdkUtils.dpToPx(context, ((Integer) kVar.a(x4.f5991a5)).intValue());
            ...
            int iDpToPx4 = AppLovinSdkUtils.dpToPx(context, ((Integer) kVar.a(x4.f5999b5)).intValue());
            this.videoWidgetLinearLayout.setPadding(iDpToPx4, iDpToPx4, iDpToPx4, iDpToPx4);
            int i4 = iDpToPx4 * 2;
            this.videoWidgetLinearLayout.setLayoutParams(new FrameLayout.LayoutParams(iDpToPx3 + iDpToPx2 + i4, Math.max(iDpToPx3, iDpToPx2) + i4, 8388691));
            addView(this.videoWidgetLinearLayout);
        }
        if (((Boolean) kVar.a(x4.f6025e5)).booleanValue()) {
            ...
            int iDpToPx5 = AppLovinSdkUtils.dpToPx(context, ((Integer) kVar.a(x4.f6034f5)).intValue());
        ...
        appLovinVideoView.setOnTouchListener(new AppLovinTouchToClickListener(kVar, x4.f6029f0, getContext(), new d(this, aVar)));
        ...
        hashSet.addAll(vastAd.a(o7.d.VIDEO, z7.f6344a));
    }

    private void areCachedAdResourcesMissing(boolean z3) {
        if (n7.a(z3, this.vastAd, this.sdk, getContext()).isEmpty()) {
            return;
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public boolean populateMuteImage(boolean z3) {
        if (this.muteButtonImageView == null) {
            return false;
        }
        if (o0.d()) {
            AnimatedVectorDrawable animatedVectorDrawable = (AnimatedVectorDrawable) getContext().getDrawable(z3 ? R.drawable.applovin_ic_unmute_to_mute : R.drawable.applovin_ic_mute_to_unmute);
        ...
        Uri uriG = z3 ? this.vastAd.G() : this.vastAd.Y();
        if (uriG == null) {
            return false;
        }
    ...
    private void populatePlayPauseImage(boolean z3) {
        ImageView imageView = this.playPauseButtonImageView;
        if (imageView == null) {
            return;
        }
        imageView.setImageResource(z3 ? R.drawable.applovin_ic_play_icon : R.drawable.applovin_ic_pause_icon);
    }
    ...
    public void onMessageReceived(AppLovinCommunicatorMessage appLovinCommunicatorMessage) {
        if ("video_caching_failed".equals(appLovinCommunicatorMessage.getTopic())) {
            ...
            if (messageData.getLong("ad_id") == this.vastAd.getAdIdNumber() && this.isVideoStream) {
                ...
                if ((string == null && !r0.a(i4)) || this.videoWasCompleted || this.videoView.isPlaying()) {
                    return;
                }
                handleMediaError("Video cache error during stream. ResponseCode=" + i4 + ", exception=" + string);
            }
        }
    }
