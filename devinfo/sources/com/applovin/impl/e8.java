...
public abstract class e8 {
    ...
    */
    ...
    public static void a(View view, final com.applovin.impl.sdk.k kVar) {
        ...
        view.setOnApplyWindowInsetsListener(new View.OnApplyWindowInsetsListener() { // from class: com.applovin.impl.g9
    ...
    public static /* synthetic */ WindowInsets a(com.applovin.impl.sdk.k kVar, View view, WindowInsets windowInsets) {
        Insets insets = windowInsets.getInsets(((Integer) kVar.a(x4.f6149u2)).intValue());
    ...
    private static boolean a(View view, View view2) {
        ...
        if (view2 instanceof ViewGroup) {
            ...
            for (int i4 = 0; i4 < viewGroup.getChildCount(); i4++) {
                if (a(view, viewGroup.getChildAt(i4))) {
                    return true;
                }
            }
        }
    ...
    public class a implements Animation.AnimationListener {
        ...
        final /* synthetic */ Runnable f4083b;

        public a(View view, Runnable runnable) {
            this.f4082a = view;
            this.f4083b = runnable;
        }

        @Override // android.view.animation.Animation.AnimationListener
        public void onAnimationEnd(Animation animation) {
            Runnable runnable = this.f4083b;
            if (runnable != null) {
                runnable.run();
            }
        }
