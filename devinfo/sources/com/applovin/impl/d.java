...
public abstract class d {
    ...
    public class a extends com.applovin.impl.b {
        ...
        private WeakReference f3847a = new WeakReference(null);

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ Class f3848b;

        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ b f3849c;

        /* renamed from: d, reason: collision with root package name */
        final /* synthetic */ c f3850d;
        ...
        public void onActivityCreated(Activity activity, Bundle bundle) {
            if (this.f3848b.isInstance(activity) && this.f3847a.get() == null) {
                this.f3847a = new WeakReference(activity);
                this.f3849c.a(activity);
            }
        }

        @Override // com.applovin.impl.b, android.app.Application.ActivityLifecycleCallbacks
        public void onActivityDestroyed(Activity activity) {
            if (this.f3848b.isInstance(activity) && !activity.isChangingConfigurations() && this.f3847a.get() == activity) {
                this.f3850d.b(this);
            }
        }
    }
