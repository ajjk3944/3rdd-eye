...
public abstract class a8 {
    ...
    private static final DateFormat f3599a = new SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ss.SSSZ", Locale.US);

    /* renamed from: b, reason: collision with root package name */
    private static final Random f3600b = new Random(System.currentTimeMillis());

    public static void a(s7 s7Var, AppLovinAdLoadListener appLovinAdLoadListener, t7 t7Var, int i4, com.applovin.impl.sdk.k kVar) {
        if (kVar == null) {
    ...
    private static String a() {
        return Integer.toString(f3600b.nextInt(89999999) + 10000000);
    }
    ...
    public static void a(Set set, long j, Uri uri, t7 t7Var, com.applovin.impl.sdk.k kVar) {
        if (kVar != null) {
            ...
            while (it.hasNext()) {
                ...
                Uri uriA = a(y7Var.c(), j8, uri2, t7Var2, kVar2);
                if (uriA != null) {
