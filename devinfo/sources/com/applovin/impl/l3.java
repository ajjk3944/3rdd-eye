...
public abstract class l3 extends r0 {
    ...
    private static final String[] f4416e = {"ads", "settings", "auto_init_adapters", "test_mode_idfas", "test_mode_auto_init_adapters", "ad_unit_signal_providers"};

    /* renamed from: f, reason: collision with root package name */
    private static final String[] f4417f = {"ads", "settings", "signal_providers", "ad_unit_signal_providers"};

    public static String a(com.applovin.impl.sdk.k kVar) {
        return r0.a((String) kVar.a(r3.f5234q7), "1.0/mediate", kVar);
    }

    public static String b(com.applovin.impl.sdk.k kVar) {
        return r0.a((String) kVar.a(r3.f5232p7), "1.0/mediate", kVar);
    }
    ...
    public static void e(JSONObject jSONObject, com.applovin.impl.sdk.k kVar) {
        ...
        JsonUtils.removeObjectsForKeys(jSONObjectShallowCopy, f4417f);
    ...
    public static void f(JSONObject jSONObject, com.applovin.impl.sdk.k kVar) {
        if (JsonUtils.valueExists(jSONObject, "signal_providers")) {
            JSONObject jSONObjectShallowCopy = JsonUtils.shallowCopy(jSONObject);
            JsonUtils.removeObjectsForKeys(jSONObjectShallowCopy, f4416e);
    ...
    public static void g(JSONObject jSONObject, com.applovin.impl.sdk.k kVar) {
        if (JsonUtils.valueExists(jSONObject, "ad_unit_signal_providers") && JsonUtils.valueExists(jSONObject, "signal_providers")) {
            try {
                ...
                kVar.D().a(d2.f3872a1, "signalProvidersMismatch", CollectionUtils.hashMap("details", "extraSignalProviderNetworks=" + differenceSet + ",extraAdUnitSignalProviderNetworks=" + differenceSet2));
    ...
    public static String h(com.applovin.impl.sdk.k kVar) {
        x4 x4Var = r3.C8;
        return r0.a((String) kVar.a(((Boolean) kVar.a(x4Var)).booleanValue() ? r3.B8 : r3.f5234q7), ((Boolean) kVar.a(x4Var)).booleanValue() ? "2.0/mediate_debug" : "1.0/mediate_debug", kVar);
    }

    public static String i(com.applovin.impl.sdk.k kVar) {
        x4 x4Var = r3.C8;
        return r0.a((String) kVar.a(((Boolean) kVar.a(x4Var)).booleanValue() ? r3.A8 : r3.f5232p7), ((Boolean) kVar.a(x4Var)).booleanValue() ? "2.0/mediate_debug" : "1.0/mediate_debug", kVar);
    }
}
