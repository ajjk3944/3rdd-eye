...
public final class pr implements bb.e {

    /* renamed from: a, reason: collision with root package name */
    public final /* synthetic */ int f15076a;

    /* renamed from: b, reason: collision with root package name */
    public final /* synthetic */ fr f15077b;

    /* renamed from: c, reason: collision with root package name */
    public final /* synthetic */ sr f15078c;

    public /* synthetic */ pr(sr srVar, fr frVar, int i4) {
        this.f15076a = i4;
        this.f15077b = frVar;
        this.f15078c = srVar;
    }
    ...
    public final void i(pa.a aVar) {
        switch (this.f15076a) {
            case 0:
                try {
                    String canonicalName = this.f15078c.f16516a.getClass().getCanonicalName();
                    int i4 = aVar.f31511a;
            ...
            default:
                try {
                    String canonicalName2 = this.f15078c.f16516a.getClass().getCanonicalName();
    ...
    public final /* synthetic */ Object onSuccess(Object obj) {
        switch (this.f15076a) {
            case 0:
                ...
                bb.k kVar = (bb.k) obj;
                try {
                    this.f15078c.f16520e = kVar.getView();
                    frVar.A1();
                } catch (RemoteException e2) {
                    za.i.f("", e2);
                }
