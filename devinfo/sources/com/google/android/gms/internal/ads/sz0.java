...
public final class sz0 {
    ...
    public final ExecutorService f16599b;

    /* renamed from: c, reason: collision with root package name */
    public final lz0 f16600c;

    /* renamed from: d, reason: collision with root package name */
    public final rz0 f16601d;

    /* renamed from: e, reason: collision with root package name */
    public final g21 f16602e;

    /* renamed from: f, reason: collision with root package name */
    public final e51 f16603f;
    public final HashMap g = new HashMap();

    /* renamed from: h, reason: collision with root package name */
    public final long f16604h;

    /* renamed from: i, reason: collision with root package name */
    public final File f16605i;
    public boolean j;
    ...
    public DexClassLoader f16607l;

    public sz0(Context context, ExecutorService executorService, lz0 lz0Var, rz0 rz0Var, File file, g21 g21Var, long j, e51 e51Var) {
        this.f16598a = context;
        this.f16599b = executorService;
        this.f16600c = lz0Var;
        this.f16601d = rz0Var;
        this.f16602e = g21Var;
        this.f16603f = e51Var;
        this.f16605i = new File(file, "rbp");
        this.f16604h = j;
    }
    ...
    /* JADX WARN: Not initialized variable reg: 0, insn: 0x0281: INVOKE (r0 I:com.google.android.gms.internal.ads.f21) VIRTUAL call: com.google.android.gms.internal.ads.f21.c():void A[Catch: all -> 0x027f, MD:():void (m), TRY_ENTER] (LINE:642), block:B:116:0x0281 */
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:65:0x01a3 -> B:133:0x01c3). Please report as a decompilation issue!!! */
    public final synchronized void a() {
        ...
        long length;
        try {
            f21 f21VarA = this.f16602e.a(201);
            try {
                f21VarA.a();
            } catch (yx0 e2) {
                f21VarA.b(e2);
            ...
            try {
                try {
                    byte[] bArrV = yo0.v("n86zgxhQ61zjjm6tfFDGvuoFJBviiscKeJQOTsE9oyA=", false);
                    if (bArrV.length != 32) {
                        throw new qz0();
                    }
                    byte[] bArr = new byte[16];
                    ByteBuffer.wrap(bArrV, 4, 16).get(bArr);
                    ...
                    try {
                        ...
                        if (file4.exists()) {
                            ...
                            if (!file5.exists()) {
                                try {
                                    length = file4.length();
                                } catch (qz0 | IOException | NullPointerException unused) {
                                ...
                                if (length <= 0) {
                                    ...
                                    try {
                                        try {
                                        } catch (qz0 | IOException | NullPointerException unused2) {
                                            fileOutputStream = null;
                                        }
                                        if (fileInputStream.read(bArr3) <= 0) {
                                            ...
                                            int i10 = um1.f17262a;
                                            pd pdVarE = pd.E(bArr3, jn1.f12802b);
                                            if ("1764808731656".equals(new String(pdVarE.C().y())) && Arrays.equals(pdVarE.B().y(), this.f16600c.d(pdVarE.A().y())) && Arrays.equals(pdVarE.D().y(), Build.VERSION.SDK.getBytes())) {
                                                rz0 rz0Var2 = this.f16601d;
                                                byte[] bArr4 = this.f16606k;
                                                String str = new String(pdVarE.A().y());
                                                rz0Var2.getClass();
                                                byte[] bArrA2 = rz0.a(str, bArr4);
                                                file5.createNewFile();
                                                fileOutputStream = new FileOutputStream(file5);
                                                try {
                                                    fileOutputStream.write(bArrA2, 0, bArrA2.length);
                                                } catch (qz0 | IOException | NullPointerException unused3) {
                                                } catch (Throwable th5) {
                                                    th = th5;
                        ...
                        try {
                            this.f16607l = new DexClassLoader(file2.getAbsolutePath(), this.f16605i.getAbsolutePath(), null, this.f16598a.getClassLoader());
                            d(file2);
                            File file6 = this.f16605i;
                            c(file6);
                            d(new File(String.format("%s/%s.dex", file6, "1764808731656")));
                            for (uz0 uz0Var : this.f16603f) {
                                Pair pairCreate = Pair.create(uz0Var.f17389a, uz0Var.f17390b);
                                HashMap map = this.g;
                                if (!map.containsKey(pairCreate)) {
                                    map.put(pairCreate, this.f16599b.submit(new ae(11, this, uz0Var)));
                                }
                            }
                            this.j = true;
                            f21VarA.c();
                            ...
                            d(file2);
                            File file7 = this.f16605i;
                            c(file7);
                            d(new File(String.format("%s/%s.dex", file7, "1764808731656")));
                            throw th7;
                        }
                    } catch (qz0 e10) {
                        e = e10;
    ...
    public final Method b(String str, String str2) {
        ...
        g21 g21Var = this.f16602e;
        if (future == null) {
            g21Var.b(302);
            return null;
        }
        try {
            return (Method) future.get(this.f16604h, TimeUnit.MILLISECONDS);
