...
public abstract class uu0 {
    ...
    public static WindowManager f17342a;

    /* renamed from: b, reason: collision with root package name */
    public static final String[] f17343b = {"x", "y", "width", "height"};

    /* renamed from: c, reason: collision with root package name */
    public static float f17344c = Resources.getSystem().getDisplayMetrics().density;

    public static JSONObject a(int i4, int i10, int i11, int i12) throws JSONException {
        JSONObject jSONObject = new JSONObject();
        try {
            jSONObject.put("x", i4 / f17344c);
            jSONObject.put("y", i10 / f17344c);
            jSONObject.put("width", i11 / f17344c);
            jSONObject.put("height", i12 / f17344c);
            return jSONObject;
        } catch (JSONException e2) {
            yo0.k("Error with creating viewStateObject", e2);
            return jSONObject;
        }
    }
    ...
    public static void d(JSONObject jSONObject) throws JSONException {
        ...
        if (f17342a != null) {
            ...
            f17342a.getDefaultDisplay().getRealSize(point);
            float f12 = point.x;
            float f13 = f17344c;
            f10 = f12 / f13;
            f11 = point.y / f13;
    ...
    */
    public static boolean e(org.json.JSONObject r7, org.json.JSONObject r8) {
        ...
        Lc:
            r2 = 4
            if (r1 >= r2) goto L24
            java.lang.String[] r2 = com.google.android.gms.internal.ads.uu0.f17343b
            r2 = r2[r1]
