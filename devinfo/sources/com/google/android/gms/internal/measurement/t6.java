...
public abstract class t6 {
    ...
    public static final /* synthetic */ int f19938a = 0;

    static {
        if (r6.f19899e && r6.f19898d) {
            int i4 = u4.f19947a;
        }
    }
    ...
    */
    public static boolean a(int r6, int r7, byte[] r8) {
        ...
        L7a:
            ...
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.measurement.t6.a(int, int, byte[]):boolean");
    }
    ...
    public static /* synthetic */ int d(int i4, int i10, byte[] bArr) {
        int i11 = i10 - i4;
        byte b10 = bArr[i4 - 1];
        if (i11 == 0) {
            if (b10 <= -12) {
