...
class c {
    ...
    private static final Pattern f20913a = Pattern.compile("<(head)( [^>]*)?>", 2);

    /* renamed from: b, reason: collision with root package name */
    private static final Pattern f20914b = Pattern.compile("<(head)( [^>]*)?/>", 2);

    /* renamed from: c, reason: collision with root package name */
    private static final Pattern f20915c = Pattern.compile("<(body)( [^>]*?)?>", 2);

    /* renamed from: d, reason: collision with root package name */
    private static final Pattern f20916d = Pattern.compile("<(body)( [^>]*?)?/>", 2);

    /* renamed from: e, reason: collision with root package name */
    private static final Pattern f20917e = Pattern.compile("<(html)( [^>]*?)?>", 2);

    /* renamed from: f, reason: collision with root package name */
    private static final Pattern f20918f = Pattern.compile("<(html)( [^>]*?)?/>", 2);
    ...
    public static String a(String str, String str2) {
        ...
        if (!b(str, sb2, f20914b, str2, iArrA) && !a(str, sb2, f20913a, str2, iArrA) && !b(str, sb2, f20916d, str2, iArrA) && !a(str, sb2, f20915c, str2, iArrA) && !b(str, sb2, f20918f, str2, iArrA) && !a(str, sb2, f20917e, str2, iArrA) && !a(str, sb2, g, str2, iArrA)) {
