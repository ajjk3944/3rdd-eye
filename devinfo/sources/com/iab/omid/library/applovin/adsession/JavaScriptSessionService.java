...
public class JavaScriptSessionService {
    ...
    private void addWebViewListener() {
        ...
        webViewUtil.a(this.webView, JS_MESSAGE_LISTENER_JS_SESSION_SERVICE, new HashSet(Arrays.asList("*")), new e() { // from class: com.iab.omid.library.applovin.adsession.JavaScriptSessionService.2
            @Override // o6.e
            public void onPostMessage(WebView webView, d dVar, Uri uri, boolean z3, o6.a aVar) throws JSONException {
                try {
