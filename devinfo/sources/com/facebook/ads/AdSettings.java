...
public class AdSettings {
    ...
    public static void setDataProcessingOptions(String[] strArr, int i4, int i10) {
        AdInternalSettings.setDataProcessingOptions(strArr, Integer.valueOf(i4), Integer.valueOf(i10));
    }
}
