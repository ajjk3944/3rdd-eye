...
import com.instagram.common.viewpoint.core.C01872p;
import com.instagram.common.viewpoint.core.C0565Hz;
...
public final class EventMessage implements Metadata.Entry {
    ...
    public static final C1996qI A07;
    public static final C1996qI A08;
    ...
    public static void A01() {
        A06 = new byte[]{35, 47, 107, 122, 125, 110, 123, 102, 96, 97, 66, 124, 50, 6, 10, 67, 78, 23, 7, 11, 93, 74, 71, 94, 78, 22, 119, 127, 97, 117, 8, 18, 65, 81, 90, 87, 95, 87, 15, 56, 41, 41, 53, 48, 58, 56, 45, 48, 54, 55, 118, 48, 61, 106, 101, 116, 116, 104, 109, 103, 101, 112, 109, 107, 106, 43, 124, 41, 119, 103, 112, 97, 55, 49, 35, Utf8.REPLACEMENT_BYTE, Utf8.REPLACEMENT_BYTE, 59, 56, 113, 100, 100, 42, 36, 38, 46, 47, 34, 42, 101, 36, 57, 44, 100, 46, 38, 56, 44, 100, 2, 15, 120, 99, 127, 127, 123, 120, 49, 36, 36, 111, 110, 125, 110, 103, 100, 123, 110, 121, 37, 106, 123, 123, 103, 110, 37, 104, 100, 102, 36, 120, 127, 121, 110, 106, 102, 98, 101, 108, 36, 110, 102, 120, 108, 38, 98, 111, 56, 75, 76, 80, 4, 77, 93, 74, 91, 4, 77, 93, 74, 91, 13, 11, 4, 12, 14, 15, 10, 4, 92, 87, 80};
    }

    static {
        A01();
        A07 = new C01872p().A11(A00(39, 15, 32)).A14();
        A08 = new C01872p().A11(A00(54, 20, 125)).A14();
        CREATOR = new C0565Hz();
    }
    ...
    */
    public final com.instagram.common.viewpoint.core.C1996qI A9b() {
        /*
            r4 = this;
    ...
    public final int hashCode() {
        if (this.A00 == 0) {
            ...
            int iHashCode = (((i4 + result) * 31) + (this.A04 != null ? this.A04.hashCode() : 0)) * 31;
