...
import com.instagram.common.viewpoint.core.C02294h;
import com.instagram.common.viewpoint.core.C02434v;
import com.instagram.common.viewpoint.core.C0580Io;
import com.instagram.common.viewpoint.core.C0581Ip;
import com.instagram.common.viewpoint.core.C0582Iq;
import com.instagram.common.viewpoint.core.C1764mK;
import com.instagram.common.viewpoint.core.C1766mM;
import com.instagram.common.viewpoint.core.C1782mn;
...
import com.instagram.common.viewpoint.core.InterfaceC0543Hd;
import com.instagram.common.viewpoint.core.InterfaceC0577Il;
import com.instagram.common.viewpoint.core.InterfaceC1787ms;
...
public final class MatroskaExtractor implements H9 {
    ...
    public SparseArray<C0580Io> A0P;
    public C02294h A0Q;
    public C02294h A0R;
    public HA A0S;
    public C0580Io A0T;
    ...
    public boolean A0e;
    public int[] A0f;
    public final C02434v A0g;
    public final C02434v A0h;
    public final C02434v A0i;
    ...
    public final InterfaceC0577Il A0q;
    public final C0582Iq A0r;
  ...
  0x020d: PHI (r0v193 byte[]) = (r0v192 byte[]), (r0v208 byte[]) binds: [B:63:0x0209, B:37:0x00fe] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    private int A02(com.instagram.common.viewpoint.core.InterfaceC1787ms r13, com.instagram.common.viewpoint.core.C0580Io r14, int r15, boolean r16) throws java.io.IOException {
        /*
    ...
    public static String A06(int i4, int i10, int i11) {
        byte[] bArrCopyOfRange = Arrays.copyOfRange(A0t, i4, i4 + i10);
    ...
    public MatroskaExtractor(InterfaceC0577Il interfaceC0577Il, int i4) {
        this.A0M = -1L;
        ...
        this.A0q = interfaceC0577Il;
        this.A0q.AAD(new C1764mK(this));
        this.A0s = (i4 & 1) == 0;
        this.A0r = new C0582Iq();
        this.A0P = new SparseArray<>();
        this.A0l = new C02434v(4);
        this.A0p = new C02434v(ByteBuffer.allocate(4).putInt(-1).array());
        this.A0m = new C02434v(4);
        this.A0j = new C02434v(HS.A03);
        this.A0i = new C02434v(4);
        this.A0k = new C02434v();
        this.A0n = new C02434v();
        this.A0g = new C02434v(8);
        this.A0h = new C02434v();
        this.A0o = new C02434v();
        this.A0f = new int[1];
    }
    ...
    private int A01(InterfaceC1787ms interfaceC1787ms, InterfaceC0543Hd interfaceC0543Hd, int i4) throws IOException {
        int strippedBytesLeft = this.A0k.A07();
        if (strippedBytesLeft > 0) {
            int bytesWritten = Math.min(i4, strippedBytesLeft);
            interfaceC0543Hd.AIr(this.A0k, bytesWritten);
            return bytesWritten;
        }
        return interfaceC0543Hd.AIp(interfaceC1787ms, i4, false);
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    private com.instagram.common.viewpoint.core.HY A04(com.instagram.common.viewpoint.core.C02294h r11, com.instagram.common.viewpoint.core.C02294h r12) {
        /*
    ...
    private final C0580Io A05(int i4) throws C3K {
        A0D(i4);
        return this.A0T;
    }
    ...
    private void A0C(int i4) throws C3K {
        if (this.A0R != null && this.A0Q != null) {
        } else {
            throw C3K.A01(A06(631, 8, 72) + i4 + A06(0, 18, 118), null);
        }
    }

    @EnsuresNonNull({"currentTrack"})
    private void A0D(int i4) throws C3K {
        if (this.A0T != null) {
        } else {
            throw C3K.A01(A06(631, 8, 72) + i4 + A06(18, 24, 76), null);
        }
    }

    private void A0E(InterfaceC1787ms interfaceC1787ms, int i4) throws IOException {
        if (this.A0l.A0A() >= i4) {
            return;
        }
        if (this.A0l.A08() < i4) {
            this.A0l.A0c(Math.max(this.A0l.A08() * 2, i4));
        }
        interfaceC1787ms.readFully(this.A0l.A0l(), this.A0l.A0A(), i4 - this.A0l.A0A());
        this.A0l.A0e(i4);
    }

    private void A0F(InterfaceC1787ms interfaceC1787ms, byte[] bArr, int i4) throws IOException {
        int length = bArr.length + i4;
        int sizeWithPrefix = this.A0n.A08();
        if (sizeWithPrefix < length) {
            int sizeWithPrefix2 = length + i4;
        ...
        interfaceC1787ms.readFully(bArrA0l2, sizeWithPrefix4, i4);
        this.A0n.A0f(0);
        this.A0n.A0e(length);
    }

    private void A0G(InterfaceC1787ms interfaceC1787ms, byte[] bArr, int i4, int i10) throws IOException {
        int iMin = Math.min(i10, this.A0k.A07());
        int pendingStrippedBytes = i4 + iMin;
        interfaceC1787ms.readFully(bArr, pendingStrippedBytes, i10 - iMin);
        if (iMin > 0) {
            this.A0k.A0k(bArr, i4, iMin);
        }
    }

    private final void A0H(C0580Io c0580Io, int i4, InterfaceC1787ms interfaceC1787ms, int i10) throws IOException {
        if (i4 == 4) {
            if (A06(1280, 5, 88).equals(c0580Io.A0d)) {
                this.A0o.A0d(i10);
                interfaceC1787ms.readFully(this.A0o.A0l(), 0, i10);
                return;
            }
        }
        interfaceC1787ms.AK3(i10);
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    private void A0I(com.instagram.common.viewpoint.core.C0580Io r15, long r16, int r18, int r19, int r20) {
        /*
    ...
    private final void A0J(C0580Io c0580Io, InterfaceC1787ms interfaceC1787ms, int i4) throws IOException {
        if (c0580Io.A0n != 1685485123) {
            int i10 = c0580Io.A0n;
            String[] strArr = A0u;
        ...
        c0580Io.A0k = new byte[i4];
        interfaceC1787ms.readFully(c0580Io.A0k, 0, i4);
    }
    ...
    */
    ...
    public static byte[] A0O(long j, String str, long j8) {
        AbstractC02203y.A07(j != -9223372036854775807L);
        int i4 = (int) (j / 3600000000L);
        long j9 = j - ((i4 * 3600) * 1000000);
        int i10 = (int) (j9 / 60000000);
        long j10 = j9 - ((i10 * 60) * 1000000);
        int i11 = (int) (j10 / 1000000);
        int minutes = (int) ((j10 - (i11 * 1000000)) / j8);
        return C5C.A1G(String.format(Locale.US, str, Integer.valueOf(i4), Integer.valueOf(i10), Integer.valueOf(i11), Integer.valueOf(minutes)));
    }

    public static int[] A0P(int[] iArr, int i4) {
        if (iArr == null) {
            return new int[i4];
        }
        if (iArr.length >= i4) {
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final void A0S(int r15) throws com.instagram.common.viewpoint.core.C3K {
        /*
    ...
    public final void A0T(int i4, double d10) throws C3K {
        switch (i4) {
            case 181:
                C0580Io c0580IoA05 = A05(i4);
                int i10 = (int) d10;
                if (A0u[3].charAt(5) != 'R') {
                    throw new RuntimeException();
                }
            ...
            case 17545:
                ...
                return;
            case 21969:
                A05(i4).A06 = (float) d10;
                return;
            case 21970:
                C0580Io c0580IoA052 = A05(i4);
                if (A0u[7].length() != 16) {
                    A0u[7] = "bgRhYiIqKVlSmtLlUnVbMuj";
                    c0580IoA052.A07 = (float) d10;
                    return;
                } else {
                    c0580IoA052.A07 = (float) d10;
                    return;
            ...
            case 21971:
                A05(i4).A04 = (float) d10;
                return;
            case 21972:
                A05(i4).A05 = (float) d10;
                return;
            case 21973:
                A05(i4).A02 = (float) d10;
                return;
            case 21974:
                A05(i4).A03 = (float) d10;
                return;
            case 21975:
                A05(i4).A0B = (float) d10;
                return;
            case 21976:
                C0580Io c0580IoA053 = A05(i4);
                float f10 = (float) d10;
                String[] strArr = A0u;
                ...
                throw new RuntimeException();
            case 21977:
                A05(i4).A00 = (float) d10;
                return;
            case 21978:
                A05(i4).A01 = (float) d10;
                return;
            case 30323:
                A05(i4).A0A = (float) d10;
                return;
            case 30324:
                A05(i4).A08 = (float) d10;
                return;
            case 30325:
                A05(i4).A09 = (float) d10;
                return;
            default:
                return;
        }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final void A0U(int r21, int r22, com.instagram.common.viewpoint.core.InterfaceC1787ms r23) throws java.io.IOException {
        /*
    ...
    public final void A0V(int i4, long j) throws C3K {
        ...
        switch (i4) {
            ...
            case 18408:
                if (j == 1) {
                    ...
                    throw C3K.A01(A06(AppLovinMediationAdapter.ERROR_MISSING_AD_UNIT_ID, 22, 77) + j + strA06, null);
                }
            case 20529:
                if (j == 0) {
                    return;
    ...
    public final void A0W(int i4, long j, long j8) throws C3K {
        A09();
        switch (i4) {
            case 160:
                this.A0W = false;
            ...
            case 475249515:
                this.A0R = new C02294h();
                this.A0Q = new C02294h();
                return;
            case 524531317:
                if (this.A0e) {
                    return;
                ...
                if (this.A0s && this.A0H != -1) {
                    ...
                    this.A0S.AJ7(new C1782mn(this.A0J));
                    this.A0e = true;
                    return;
                }
        }
    ...
    public final void A0X(int i4, String str) throws C3K {
        switch (i4) {
            case 134:
                A05(i4).A0d = str;
                return;
    ...
    public final boolean A0Y(int i4) {
        if (i4 != 357149030 && i4 != 524531317) {
            String[] strArr = A0u;
            if (strArr[2].length() == strArr[4].length()) {
                throw new RuntimeException();
            }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final int AHL(com.instagram.common.viewpoint.core.InterfaceC1787ms r5, com.instagram.common.viewpoint.core.HV r6) throws java.io.IOException {
        /*
            r4 = this;
            r3 = 0
            r4.A0X = r3
        ...
        L21:
            ...
            com.facebook.ads.redexgen.X.Io r0 = (com.instagram.common.viewpoint.core.C0580Io) r0
            com.instagram.common.viewpoint.core.C0580Io.A08(r0)
            r0.A0E()
            int r1 = r1 + 1
            goto L21
        L3a:
    ...
    */
    ...
    public final boolean AK5(InterfaceC1787ms interfaceC1787ms) throws IOException {
        return new C0581Ip().A01(interfaceC1787ms);
    }
}
