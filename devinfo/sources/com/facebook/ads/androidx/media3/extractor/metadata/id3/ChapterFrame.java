...
public final class ChapterFrame extends Id3Frame {
    ...
    public ChapterFrame(Parcel parcel) {
        ...
        this.A05 = new Id3Frame[i4];
        for (int i10 = 0; i10 < i4; i10++) {
            this.A05[i10] = (Id3Frame) parcel.readParcelable(Id3Frame.class.getClassLoader());
        }
    }

    public ChapterFrame(String str, int i4, int i10, long j, long j8, Id3Frame[] id3FrameArr) {
        super(A00(0, 4, 29));
        this.A04 = str;
        this.A01 = i4;
        this.A00 = i10;
    ...
    */
    ...
    public final int hashCode() {
        int result = this.A01;
        int i4 = ((((17 * 31) + result) * 31) + this.A00) * 31;
        int result2 = (int) this.A03;
        int result3 = (((i4 + result2) * 31) + ((int) this.A02)) * 31;
