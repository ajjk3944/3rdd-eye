...
public enum AdErrorType {
    ...
    DISABLED_APP(WebSocketProtocol.CLOSE_NO_STATUS_CODE, A00(368, 39, 73), true),
    ...
    RV_AD_TIMEOUT(2010, A00(2252, 33, AppLovinMediationAdapter.ERROR_CHILD_USER), true),
    ...
    AdErrorType(int i4, String str, boolean z3) {
        this.A00 = i4;
        this.A01 = str;
        this.A02 = z3;
    }

    public static AdErrorType adErrorTypeFromCode(int i4) {
        return adErrorTypeFromCode(i4, UNKNOWN_ERROR);
    }

    public static AdErrorType adErrorTypeFromCode(int i4, AdErrorType adErrorType) {
        for (AdErrorType adErrorType2 : values()) {
            if (adErrorType2.getErrorCode() == i4) {
                return adErrorType2;
            }
        }
        return adErrorType;
