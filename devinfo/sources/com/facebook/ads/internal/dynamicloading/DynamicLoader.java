...
public interface DynamicLoader {
    AdOptionsViewApi createAdOptionsView(Context context, NativeAdBase nativeAdBase, NativeAdLayout nativeAdLayout, AdOptionsView.Orientation orientation, int i4, AdOptionsView adOptionsView);
    ...
    AdSizeApi createAdSizeApi(int i4);
    ...
    NativeAdScrollViewApi createNativeAdScrollViewApi(NativeAdScrollView nativeAdScrollView, Context context, NativeAdsManager nativeAdsManager, NativeAdScrollView.AdViewProvider adViewProvider, int i4, NativeAdView.Type type, NativeAdViewAttributes nativeAdViewAttributes, int i10);

    NativeAdViewApi createNativeAdViewApi();

    NativeAdViewAttributesApi createNativeAdViewAttributesApi();

    NativeAdViewTypeApi createNativeAdViewTypeApi(int i4);

    NativeAdsManagerApi createNativeAdsManagerApi(Context context, String str, int i4);
