...
public abstract class AdComponentFrameLayout extends FrameLayout implements AdComponentView {
    ...
    public AdComponentFrameLayout(Context context, AttributeSet attributeSet, int i4) {
        super(context, attributeSet, i4);
        this.mAdComponentViewParentApi = new a(this);
    }

    public AdComponentFrameLayout(Context context, AttributeSet attributeSet, int i4, int i10) {
