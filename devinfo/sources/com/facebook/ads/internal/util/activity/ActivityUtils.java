...
import com.instagram.common.viewpoint.core.AbstractC0848Td;
import com.instagram.common.viewpoint.core.AbstractC0939Wt;
import com.instagram.common.viewpoint.core.C0849Te;
import com.instagram.common.viewpoint.core.C0886Up;
import com.instagram.common.viewpoint.core.C1432ge;
import com.instagram.common.viewpoint.core.C1436gi;
import com.instagram.common.viewpoint.core.InterfaceC0942Ww;
import com.instagram.common.viewpoint.core.RunnableC0941Wv;
...
public final class ActivityUtils implements Application.ActivityLifecycleCallbacks {
    ...
    public static final List<InterfaceC0942Ww> A06;
     ...
     */
    public static synchronized void A04(C1432ge c1432ge, Class<? extends Activity> cls) {
        A02 = c1432ge;
        A01 = c1432ge.getApplicationContext();
            ...
            if (aNActivityLifecycleCallbacksListener != null) {
                ...
                synchronized (activityStateMap) {
                    try {
                        ...
                        c1432ge.A08().ABC(A01(208, 8, 61), AbstractC0848Td.A02, new C0849Te(A01(72, 80, 65)));
                    }
                }
                ANActivityLifecycleCallbacksListener.unregisterActivityCallbacks(c1432ge);
            }
            ((Application) A01).registerActivityLifecycleCallbacks(new ActivityUtils(cls));
        } else {
            c1432ge.A08().ABC(A01(216, 3, 3), AbstractC0848Td.A0d, new C0849Te(A01(42, 30, WebSocketProtocol.PAYLOAD_SHORT)));
        }
    }
    ...
    public static synchronized Activity A00() {
        ...
        if (z3) {
            activityA00 = AbstractC0939Wt.A00();
        }
        if (A02 != null && z3 && key != activityA00) {
            C0849Te c0849Te = new C0849Te(A01(19, 23, 76), A01(203, 5, 97) + key + A01(12, 7, 1) + activityA00);
            c0849Te.A05(1);
            A02.A08().ABC(A01(208, 8, 61), AbstractC0848Td.A03, c0849Te);
        }
        return key != null ? key : activityA00;
    }

    public static void A03(C1436gi c1436gi) {
        if (!C0886Up.A1p(c1436gi) || Build.VERSION.SDK_INT >= 29) {
            return;
        }
        RunnableC0941Wv runnableC0941Wv = new RunnableC0941Wv(c1436gi);
        synchronized (A07) {
            A07.add(runnableC0941Wv);
        }
        Y4.A01.A01().postDelayed(runnableC0941Wv, 2000L);
    }

    @Override // android.app.Application.ActivityLifecycleCallbacks
    public final void onActivityCreated(Activity activity, Bundle bundle) {
        A08.put(activity, 1);
        Iterator<InterfaceC0942Ww> it = A06.iterator();
    ...
    public final void onActivityPaused(Activity activity) {
        ...
        if (num == null || num.intValue() != 3) {
            C0849Te c0849Te = new C0849Te(A01(172, 31, 79), A01(152, 20, 101) + num + A01(0, 12, 105) + activity);
            c0849Te.A05(0);
            A02.A08().ABC(A01(208, 8, 61), AbstractC0848Td.A03, c0849Te);
        }
        A08.put(activity, 4);
