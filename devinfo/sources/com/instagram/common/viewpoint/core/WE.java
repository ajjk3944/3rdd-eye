...
public final class WE {
    ...
    private RG A01(C1436gi c1436gi, JSONObject data, long j) throws JSONException {
        JSONArray placements = data.getJSONArray(A04(190, 10, 45));
        JSONObject jSONObject = placements.getJSONObject(0);
        C0868Tx c0868TxA00 = C0868Tx.A00(jSONObject.getJSONObject(A04(124, 10, 90)));
        ...
        String strA042 = A04(TTAdConstant.MATE_VALID, 9, 36);
        ...
        C0867Tw c0867Tw = new C0867Tw(c0868TxA00, strOptString, adReportingConfig, cache, flashConfig, strOptString2, A06(jSONObject));
        ...
        if (jSONObject.has(strA044)) {
            ...
            while (i4 < jSONArray.length()) {
                ...
                VK.A06(c1436gi, jSONObject2, j, str);
                ...
                if (ad2 != null) {
                    c0867Tw.A0F(new C0865Tu(strOptString3, strOptString4, ad2, jSONArrayOptJSONArray));
                } else {
                    ...
                    interfaceC0662LtA0F.A5g(errorCode, A04(72, 18, 80));
                }
                i4++;
                str = null;
            }
        ...
        if (jSONObject.has(strA045)) {
            c0867Tw.A0G(jSONObject.getJSONObject(strA045));
        }
        String anValidationUuid = data.optString(A04(29, 18, 33));
        return new RG(c0867Tw, anValidationUuid);
    }
    ...
    private R4 A03(JSONObject jSONObject) throws JSONException {
        String strA04 = A04(TTAdConstant.MATE_VALID, 9, 36);
        ...
        try {
            ...
            C0868Tx c0868TxA00 = C0868Tx.A00(jSONObject2.getJSONObject(A04(124, 10, 90)));
            ...
            return new R4(jSONObject.optString(A04(183, 7, 16), A04(0, 0, 92)), jSONObject.optInt(A04(64, 4, 96), 0), new C0867Tw(c0868TxA00, strOptString, featureConfig, null, strOptString2, cache, A06(jSONObject2)));
    ...
    */
    public final com.instagram.common.viewpoint.core.WG A07(com.instagram.common.viewpoint.core.C1436gi r8, java.lang.String r9, long r10) throws org.json.JSONException {
        /*
            r7 = this;
