...
public final class C1483hT extends C0806Rm implements AdOptionsViewApi, InterfaceC1042aK {
    ...
    public C1483hT(Context context, NativeAdBase nativeAdBase, NativeAdLayout nativeAdLayout, AdOptionsView.Orientation orientation, int i4, AdOptionsView adOptionsView) {
        this.A05 = false;
        this.A04 = false;
        this.A03 = false;
        ...
        this.A0A.A1e(this);
        C1618ju c1618juA12 = this.A0A.A12();
        if (c1618juA12 != null && c1618juA12.A0R() && !c1618juA12.A0P()) {
            this.A07.setVisibility(8);
            return;
        }
        EnumC0946Xc.A04(this.A08, EnumC0946Xc.A0C);
        if (A0C()) {
            A05();
            return;
        }
    ...
    public C1483hT(Context context, NativeAdBase nativeAdBase, NativeAdLayout nativeAdLayout, AdOptionsView adOptionsView) {
    ...
    public static YM A01(AbstractC1601jd abstractC1601jd) {
        if (AbstractC1043aL.A00(abstractC1601jd) == EnumC1047aP.A02) {
            return YM.AD_CHOICE_COLLAPSED_PILL;
        }
        return YM.CREDIT_LINE_COLLAPSED_PILL;
    }

    public static YM A02(AbstractC1601jd abstractC1601jd) {
        if (AbstractC1043aL.A00(abstractC1601jd) == EnumC1047aP.A02) {
    ...
    private void A05() {
        C1045aN c1045aNA02 = AbstractC1046aO.A02(this.A0A.A15(), EnumC1044aM.A05, this.A0A.A13());
        c1045aNA02.setBackgroundColor(-2145637581);
        LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(-2, -2);
        this.A07.addView(c1045aNA02, layoutParams);
    }
    ...
    private void A06() {
        ...
        if (this.A00 != null && this.A09 != null && this.A0A.A13() != null) {
            this.A02 = AbstractC1046aO.A03(this.A0A.A15(), EnumC1044aM.A05, this.A0A.A13(), this.A00, A02(this.A0A.A13()), this.A09, this);
            if (this.A0A.A13().A2Q()) {
                this.A02.A0A();
            }
        }
    ...
    @Override // com.facebook.ads.internal.api.AdOptionsViewApi
    public final void setIconSizeDp(int i4) {
        int iconSize = Math.max(A0D, (int) (XX.A02 * i4));
