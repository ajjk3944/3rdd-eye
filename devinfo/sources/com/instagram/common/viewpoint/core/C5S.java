...
public final class C5S extends AbstractC0575Ij {
    ...
    public final VI A0L;
    public final AbstractC0971Yb A0M;
    public final AbstractC1099bF A0N;
    public final ViewOnClickListenerC0634Kr A0O;
    public final InterfaceC1256dm A0P;
    public final C1291eM A0Q;
    public final C0483Eu A0R;
    public final C0473Ek A0S;
    ...
    public final E2 A0X;
    public final E0 A0Y;
    public final AbstractC0462Dz A0Z;
    public final C0449Dm A0a;
    public final DZ A0b;
    ...
    public C5S(C1436gi c1436gi, VA va2, AbstractC1601jd abstractC1601jd, C0842Sx c0842Sx, ZU zu, int i4, InterfaceC0977Yh interfaceC0977Yh, VI vi2, AbstractC0971Yb abstractC0971Yb, int i10, int customVideoDurationMs, int i11, boolean z3, int i12, boolean z10, boolean z11, boolean z12, InterfaceC1256dm interfaceC1256dm, int i13, int i14) {
        C0694Na c0694NaA00;
        super(c1436gi, zu, va2, abstractC1601jd, i4, z11, z12, interfaceC0977Yh, i14);
        ...
        this.A0Y = new E0() { // from class: com.facebook.ads.redexgen.X.5g
            ...
            public final void A03(E1 e12) {
                ...
                if (this.A00.getAdDataBundle().A1c()) {
                    this.A00.A0K.A0F().AKh(XL.A00((float) ((AbstractC0575Ij) this.A00).A06.A0k()), this.A00.getResources().getConfiguration().orientation, true, true, AbstractC0688Mt.A0C(C0689Mu.A00(this.A00.A0K, ((AbstractC0575Ij) this.A00).A08, "", XB.A00(((AbstractC0575Ij) this.A00).A06.A29().A0J().A05()), new HashMap(), ((AbstractC0575Ij) this.A00).A06.A2A())));
        ...
        this.A0Z = new AbstractC0462Dz() { // from class: com.facebook.ads.redexgen.X.5Z
            /* JADX INFO: Access modifiers changed from: private */
            @Override // com.instagram.common.viewpoint.core.UN
            /* renamed from: A00, reason: merged with bridge method [inline-methods] */
        ...
        this.A0U = new EA() { // from class: com.facebook.ads.redexgen.X.5U
            ...
            public final void A03(C4K c4k) {
                ...
                if (this.A00.A00 < ((AbstractC0575Ij) this.A00).A06.A29().A0G()) {
                    C5S.A01(this.A00, 1.0f);
                    this.A00.A0S.A0e(EnumC1323et.A02, 28);
                    return;
                }
                C5S c5s = this.A00;
                String[] strArr = A01;
        ...
        this.A0K = c1436gi;
        this.A0L = vi2;
        this.A0M = abstractC0971Yb;
        this.A0H = i13;
        int i15 = -1;
        if (!super.A06.A1c()) {
            this.A0J = new C0442Df(this.A0K, vi2);
        } else {
            i15 = i13;
            this.A0J = new C0440Dd(this.A0K, vi2);
        }
        this.A0b = new DZ(this.A0K, i15);
        if (this.A00 < abstractC1601jd.A29().A0G()) {
        ...
        this.A0P = interfaceC1256dm;
        this.A0D = i11;
        this.A0c = z3;
        this.A0Q = new C1291eM(this.A0K, va2, super.A06);
        ...
        this.A01 = c0694NaA00;
        this.A0S = new C0473Ek(this.A0K);
        this.A0S.getEventBus().A03(this.A0Y, this.A0X, this.A0W, this.A0Z, this.A0U, this.A0V);
        this.A0T = new C4L(c1436gi, va2, this.A0S, abstractC1601jd.A2E(), 0, 0, abstractC1601jd.A29().A0U(), null, null);
        A0I();
        this.A0S.setVideoURI(c0842Sx.A0T(super.A06.A29().A0H().A09()));
        A0H();
        XR xrA02 = super.A09.A02(abstractC1601jd);
        this.A0K.A0H().A00(xrA02.A01);
        this.A0N = A06();
        if (this.A0N instanceof C0620Kd) {
            new DA(this.A0N, 400, 100, 0).A4A(true, false);
        } else {
            this.A0N.setVisibility(8);
        }
        this.A0a = new C0449Dm(true, abstractC1601jd.A29().A0U());
        A0K();
        ...
        if (C0886Up.A1z(this.A0K)) {
            this.A0K.A0B().AKn(this.A0S, super.A06.A2E(), true);
        }
        if (C0886Up.A20(this.A0K)) {
            this.A0R = new C0483Eu(this.A0K, va2, this.A0S, super.A06.A2E(), abstractC1601jd.A29().A0U(), this.A0T, null);
        } else {
            this.A0R = null;
        }
    }
    ...
    private AbstractC1099bF A06() {
        String strA0C;
        AbstractC1099bF c0620Kd;
        ...
        if (super.A06.A10().equals(A0C(37, 14, 3))) {
            strA0C = EnumC1329ez.A04.A03();
        } else {
            strA0C = A0C(0, 37, 118);
        }
        double dA0k = super.A06.A0k();
        if (!getAdDataBundle().A1c()) {
            C1436gi c1436gi = this.A0K;
            int i4 = A0k;
            boolean z3 = super.A06.A29().A0I().A00() == NW.A05;
            C0694Na colors = getColors();
            boolean zA06 = super.A06.A29().A0J().A06();
            VA va2 = super.A08;
            InterfaceC0977Yh interfaceC0977Yh = super.A0B;
            C1381fp c1381fp = super.A0D;
            Y2 y22 = super.A0A;
            AbstractC1601jd abstractC1601jd = super.A06;
            if (A0f[1].charAt(3) != 'F') {
                throw new RuntimeException();
            }
            String[] strArr = A0f;
            ...
            c0620Kd = new C0620Kd(c1436gi, null, i4, z3, colors, zA06, strA0C, va2, interfaceC0977Yh, c1381fp, y22, abstractC1601jd);
        } else {
            c0620Kd = new C1138bs((float) dA0k, strA0C, this.A0K, getColors(), super.A06, super.A0B, this.A0O, AbstractC0575Ij.A0G, false, super.A08, super.A0D, super.A0A, this.A0b, this.A0L, false).A03();
            ((LK) c0620Kd).setChainedAdInfo(super.A00);
        }
        c0620Kd.getCTAButton().getCtaActionHelper().A08(super.A06);
        c0620Kd.getCTAButton().setCreativeAsCtaLoggingHelper(super.A09);
        YB.A0G(1008, c0620Kd);
        c0620Kd.A0l(this.A0G);
        addView(c0620Kd, adDetailsParams);
        c0620Kd.setInfo(super.A06.A29().A0I(), super.A06.A29().A0J(), super.A06.A2E(), super.A06.A2C().A01(), null, null);
        return c0620Kd;
    }
    ...
    private void A0E() {
        if (getAdDataBundle().A29().A0K().A03() && !getAdDataBundle().A29().A0K().A02().isEmpty()) {
            ...
            this.A04 = new C1297eS(this.A0K, getAdDataBundle(), super.A0B, this.A0O, this.A0I, this.A0L);
            A0D();
        } else {
            if (getAdDataBundle().A29().A0K().A04() || getAdDataBundle().A29().A0K().A03()) {
                YB.A0d(this.A0N, this.A0J, this.A0O);
                this.A03 = new C1165cJ(this.A0K, super.A06, this.A0L, this.A0I, super.A0B);
                this.A03.A0I(false);
                addView(this.A03.A0C(this.A0O));
                return;
            }
            Pair<EnumC1290eL, View> pairA03 = this.A0Q.A03(this.A0O);
            View endCardView = (View) pairA03.second;
            YB.A0G(1101, endCardView);
            A0Q((EnumC1290eL) pairA03.first, endCardView);
        }
    }
    ...
    private void A0G() {
        ...
        if (!super.A06.A1c()) {
            ...
            layoutParams.setMargins(0, AbstractC0971Yb.A00, A0l, 0);
    ...
    private void A0H() {
        postDelayed(new IL(this), C0886Up.A0P(this.A0K));
    }

    private void A0I() {
        this.A0S.A0f(this.A0b);
        if (this.A0J instanceof InterfaceC1324eu) {
            this.A0S.A0f((InterfaceC1324eu) this.A0J);
        }
    ...
    private final void A0K() {
        ...
        if (expandableLayout != null) {
            ...
            C0694Na c0694NaA01 = super.A06.A28().A01();
            this.A0a.A0L(new DB(this.A0N.getCTAButton(), 300, -1, c0694NaA01.A0A(true)));
            Drawable drawableA08 = YB.A08(A0i, A0j, A0h);
            Drawable endDrawable = YB.A05(c0694NaA01.A09(true), A0h);
    ...
    public void A0L(int i4) {
        ...
        this.A0K.A0F().AKj(i4);
        this.A0S.A0Z(i4);
        A0M(i4, this.A0S, (RelativeLayout) this.A0S.getVideoView());
    }

    private final void A0M(int i4, ViewGroup viewGroup, RelativeLayout relativeLayout) {
        if (this.A0N instanceof LK) {
            ...
            this.A0N.A0l(i4);
            ((LK) this.A0N).A0y(viewGroup, relativeLayout, i4);
        }
    }

    private void A0Q(EnumC1290eL enumC1290eL, View view) {
        this.A0S.A0h(false);
        this.A0S.setVisibility(8);
        switch (C1233dP.A00[enumC1290eL.ordinal()]) {
            case 1:
                this.A0N.setVisibility(0);
                RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-1, -1);
                layoutParams.setMargins(0, AbstractC0971Yb.A00, 0, 0);
    ...
    public void A0R(C4A c4a) {
        if (this.A0S.getState() == EnumC1378fm.A02 && C0886Up.A1e(this.A0K)) {
    ...
    public final void A1G() {
        ...
        if (this.A0D != 0 || !this.A0c) {
            ...
            if (this.A0M != null && getAdDataBundle().A29().A0K().A00() > 0) {
                ...
                new Handler(Looper.getMainLooper()).postDelayed(new RunnableC1232dO(this), getAdDataBundle().A29().A0K().A00());
                return;
            }
            this.A08 = true;
            return;
    ...
    public final void A1H() {
        ...
        AbstractC0971Yb abstractC0971Yb = this.A0M;
        if (A0f[6].length() != 13) {
            throw new RuntimeException();
        }
        A0f[6] = "z6ph3MLFkPTln";
        abstractC0971Yb.setToolbarActionMode(8);
    }
    ...
    public final void A1K(boolean z3) {
        ...
        if (this.A07 || this.A0S.getState() == EnumC1378fm.A06 || this.A05 == null) {
            return;
        }
        if (!this.A0B || z3) {
