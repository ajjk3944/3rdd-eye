...
public final class V7 {
    ...
    public V7(T8 t82, String str, double d10, String str2, Map<String, String> map, VC vc2, VD vd2, boolean z3) throws JSONException {
        this.A05 = str;
        this.A00 = d10;
        this.A04 = str2;
        this.A02 = vc2;
        ...
        if (z3) {
            map2.put(A00(27, 24, 18), String.valueOf(z3));
        }
        String strA01 = VK.A01(str);
        if (!TextUtils.isEmpty(strA01) && (z3 || vd2 == VD.A0C)) {
            map2.put(A00(6, 21, 46), strA01);
        }
        if (A0B()) {
            Map<String, String> extraData = t82.A04().A6w();
            map2.put(A00(0, 6, FacebookMediationAdapter.ERROR_ADVIEW_CONSTRUCTOR_EXCEPTION), AbstractC0947Xd.A01(extraData));
        }
