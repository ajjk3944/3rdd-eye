...
public final class C03589o {
    ...
    public FF A03 = new C1803n9();
    public int A00 = 1048576;

    @MetaExoPlayerCustomization(type = {"MERGED"}, value = "https://github.com/androidx/media/pull/1754")
    public InterfaceC1677ku<InterfaceExecutorC0490Fb> A04 = new InterfaceC1677ku() { // from class: com.facebook.ads.redexgen.X.nj
    ...
    public C03589o(C5Y c5y) {
        this.A06 = c5y;
    }

    public static /* synthetic */ C1850nu A00(HD hd2, C8O c8o) {
        return new C1850nu(hd2);
    }

    public static /* synthetic */ InterfaceExecutorC0490Fb A01() {
        return null;
    }

    @MetaExoPlayerCustomization("Custom reflection logic to avoid loading DefaultExtractorsFactory")
    public final C03579n A04(Uri uri) throws NoSuchMethodException, SecurityException {
        ...
        return new C03579n(new C01922u().A00(uri).A02(this.A05).A01(this.A07).A05(), this.A06, this.A02, this.A01, this.A03, this.A00, null);
    }
}
