...
public abstract class VK {
    ...
    public static List<String> A02(C1436gi c1436gi, JSONArray jSONArray) {
        ArrayList arrayList = new ArrayList();
        for (int eventIndex = 0; eventIndex < jSONArray.length(); eventIndex++) {
            try {
                arrayList.add(jSONArray.getString(eventIndex));
            } catch (JSONException e2) {
                c1436gi.A08().ABC(A00(39, 17, 76), AbstractC0848Td.A1C, new C0849Te(e2));
            }
        }
        return arrayList;
    }
    ...
    public static void A05(C1436gi c1436gi, String str, long j) {
        VA adEventManager = c1436gi.A0A();
    ...
    public static void A06(C1436gi c1436gi, JSONObject jSONObject, long j, String str) {
        ...
        if (TextUtils.isEmpty(str) && jSONArrayOptJSONArray != null) {
            A07(c1436gi, jSONObjectOptJSONObject, A02(c1436gi, jSONArrayOptJSONArray), j, null);
            return;
        }
        ...
        A07(c1436gi, jSONObjectOptJSONObject, A03.get(str), j, str);
    }

    public static void A07(C1436gi c1436gi, JSONObject jSONObject, List<String> list, long j, String str) {
        String strA00 = A00(0, 2, 106);
        if (jSONObject.has(strA00)) {
            String clientToken = jSONObject.optString(strA00);
            A08(clientToken, str);
            A09(clientToken, list);
            A05(c1436gi, clientToken, j);
        }
    }
