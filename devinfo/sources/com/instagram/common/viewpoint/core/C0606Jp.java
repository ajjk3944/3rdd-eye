...
public final class C0606Jp {
    ...
    */
    public final com.instagram.common.viewpoint.core.C0605Jo A05() {
        /*
            Method dump skipped, instructions count: 302
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C0606Jp.A05():com.facebook.ads.redexgen.X.Jo");
    }
    ...
    public static int A00(int i4, int i10, int i11) {
        return A01(i4, i10, i11, 0);
    }

    public static int A01(int i4, int i10, int i11, int i12) {
        int i13;
        AbstractC02203y.A00(i4, 0, 4);
        AbstractC02203y.A00(i10, 0, 4);
        AbstractC02203y.A00(i11, 0, 4);
        AbstractC02203y.A00(i12, 0, 4);
        switch (i12) {
            case 0:
            case 1:
                i13 = 255;
    ...
    public final void A0C(int i4, int i10, int i11, boolean z3, boolean z10, int i12, int i13) {
        if (this.A06 != -1) {
            if (!z3) {
    ...
    public final void A0D(int i4, int i10, boolean z3, int i11, int i12, int i13, int i14) {
        this.A0E = i4;
        this.A07 = i14;
    }
    ...
    public final void A0F(boolean z3, boolean z10, boolean z11, int i4, boolean z12, int i10, int i11, int i12, int i13, int i14, int i15, int i16) {
        this.A0G = true;
        this.A0J = z3;
        this.A0I = z10;
        this.A09 = i4;
        ...
        if (i15 != 0 && this.A0F != i15) {
            this.A0F = i15;
            int i17 = i15 - 1;
            A0D(A0U[i17], A0Q, A0Y[i17], 0, A0W[i17], A0X[i17], A0V[i17]);
        }
        if (i16 != 0 && this.A08 != i16) {
            this.A08 = i16;
            int i18 = i16 - 1;
            A0C(0, 1, 1, false, false, A0S[i18], A0T[i18]);
            A0B(A0P, A0R[i18], A0O);
        }
    }
