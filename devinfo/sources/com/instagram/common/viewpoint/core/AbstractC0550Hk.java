...
public abstract class AbstractC0550Hk {
     ...
     */
    public static C0549Hj A06(C02434v c02434v) throws C3K {
        A0C(1, c02434v, false);
        int iA0F = c02434v.A0F();
        int iA0I = c02434v.A0I();
        int iA0F2 = c02434v.A0F();
        int iA0E = c02434v.A0E();
        if (iA0E <= 0) {
            iA0E = -1;
        }
        int iA0E2 = c02434v.A0E();
        if (iA0E2 <= 0) {
            iA0E2 = -1;
        }
        int iA0E3 = c02434v.A0E();
        if (iA0E3 <= 0) {
            iA0E3 = -1;
            String[] strArr = A01;
        ...
        return new C0549Hj(iA0F, iA0I, iA0F2, iA0E, iA0E2, iA0E3, (int) Math.pow(2.0d, iA0I2 & 15), (int) Math.pow(2.0d, (iA0I2 & 240) >> 4), (c02434v.A0I() & 1) > 0, Arrays.copyOf(c02434v.A0l(), c02434v.A0A()));
    }
    ...
    public static long A01(long j, long j8) {
        return (long) Math.floor(Math.pow(j, 1.0d / j8));
    }
    ...
    public static Metadata A02(List<String> list) {
        ...
        for (int i4 = 0; i4 < list.size(); i4++) {
            ...
            if (length != 2) {
                AbstractC02284g.A07(strA07, A07(1, 32, 49) + str);
            } else {
                String[] strArr = A01;
                ...
                if (strArrA1P[0].equals(A07(63, 22, 85))) {
                    try {
                        vorbisComments.add(PictureFrame.A00(new C02434v(Base64.decode(strArrA1P[1], 0))));
                    } catch (RuntimeException e2) {
                        AbstractC02284g.A0A(strA07, A07(33, 30, 0), e2);
                    }
                } else {
    ...
    */
    public static com.instagram.common.viewpoint.core.C0546Hg A03(com.instagram.common.viewpoint.core.C0545Hf r15) throws com.instagram.common.viewpoint.core.C3K {
        /*
            Method dump skipped, instructions count: 345
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.AbstractC0550Hk.A03(com.facebook.ads.redexgen.X.Hf):com.facebook.ads.redexgen.X.Hg");
    }

    public static C0547Hh A04(C02434v c02434v) throws C3K {
        return A05(c02434v, true, true);
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public static com.instagram.common.viewpoint.core.C0547Hh A05(com.instagram.common.viewpoint.core.C02434v r9, boolean r10, boolean r11) throws com.instagram.common.viewpoint.core.C3K {
        /*
            if (r10 == 0) goto L7
            r1 = 3
            r0 = 0
        ...
        L50:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.AbstractC0550Hk.A05(com.facebook.ads.redexgen.X.4v, boolean, boolean):com.facebook.ads.redexgen.X.Hh");
    }

    public static void A09(int i4, C0545Hf c0545Hf) throws C3K {
        int i10;
        int iA02 = c0545Hf.A02(6) + 1;
        for (int i11 = 0; i11 < iA02; i11++) {
            int iA022 = c0545Hf.A02(16);
            if (iA022 != 0) {
                AbstractC02284g.A05(A07(85, 10, 6), A07(355, 41, 59) + iA022);
            } else {
                if (c0545Hf.A04()) {
                    int iA023 = c0545Hf.A02(4);
                    String[] strArr = A01;
                    String str = strArr[7];
                ...
                if (c0545Hf.A04()) {
                    int i12 = c0545Hf.A02(8);
                    int i13 = i12 + 1;
                    for (int i14 = 0; i14 < i13; i14++) {
                        int mappingsCount2 = i4 - 1;
                        c0545Hf.A03(A00(mappingsCount2));
                        int mappingsCount3 = i4 - 1;
                        c0545Hf.A03(A00(mappingsCount3));
                    }
                }
                int mappingsCount4 = c0545Hf.A02(2);
                if (mappingsCount4 == 0) {
                    if (i10 > 1) {
                        for (int mappingsCount5 = 0; mappingsCount5 < i4; mappingsCount5++) {
                            c0545Hf.A03(4);
                        }
                    }
    ...
    public static void A0A(C0545Hf c0545Hf) throws C3K {
        int iA02 = c0545Hf.A02(6) + 1;
            ...
            switch (iA022) {
                ...
                case 1:
                    ...
                    for (int floorCount3 = 0; floorCount3 < j; floorCount3++) {
                        partitionClassList[floorCount3] = c0545Hf.A02(4);
                        if (partitionClassList[floorCount3] > i10) {
                            i10 = partitionClassList[floorCount3];
                        }
                    }
                    int[] iArr = new int[i10 + 1];
                    for (int j8 = 0; j8 < iArr.length; j8++) {
                        iArr[j8] = c0545Hf.A02(3) + 1;
                        int iA024 = c0545Hf.A02(2);
                        if (iA024 > 0) {
                            c0545Hf.A03(8);
                        }
    ...
    public static void A0B(C0545Hf c0545Hf) throws C3K {
        int iA02 = c0545Hf.A02(6) + 1;
        for (int i4 = 0; i4 < iA02; i4++) {
            int residueCount = c0545Hf.A02(16);
            if (residueCount <= 2) {
                c0545Hf.A03(24);
                c0545Hf.A03(24);
                c0545Hf.A03(24);
                int iA022 = c0545Hf.A02(6) + 1;
                c0545Hf.A03(8);
                int[] iArr = new int[iA022];
                for (int i10 = 0; i10 < iA022; i10++) {
                    int residueCount2 = 0;
                    int iA023 = c0545Hf.A02(3);
                    if (c0545Hf.A04()) {
                        String[] strArr = A01;
                        String str = strArr[7];
                        String str2 = strArr[0];
                        ...
                        residueCount2 = c0545Hf.A02(5);
                    }
                    iArr[i10] = (residueCount2 * 8) + iA023;
                }
                for (int i11 = 0; i11 < iA022; i11++) {
                    for (int i12 = 0; i12 < 8; i12++) {
                        int residueCount4 = iArr[i11];
                        if ((residueCount4 & (1 << i12)) != 0) {
                            c0545Hf.A03(8);
                        }
                    }
                }
    ...
    public static boolean A0C(int i4, C02434v c02434v, boolean z3) throws C3K {
        if (c02434v.A07() < 7) {
            if (z3) {
                return false;
            }
            throw C3K.A01(A07(549, 18, 10) + c02434v.A07(), null);
        }
        if (c02434v.A0I() != i4) {
            if (z3) {
                return false;
            }
            throw C3K.A01(A07(178, 21, 53) + Integer.toHexString(i4), null);
        }
        if (c02434v.A0I() != 118 || c02434v.A0I() != 111 || c02434v.A0I() != 114 || c02434v.A0I() != 98 || c02434v.A0I() != 105 || c02434v.A0I() != 115) {
            if (z3) {
                return false;
            }
    ...
    public static C0548Hi[] A0D(C02434v c02434v, int i4) throws C3K {
        A0C(5, c02434v, false);
        int iA0I = c02434v.A0I() + 1;
        C0545Hf c0545Hf = new C0545Hf(c02434v.A0l());
        int numberOfBooks = c02434v.A09();
        c0545Hf.A03(numberOfBooks * 8);
        for (int numberOfBooks2 = 0; numberOfBooks2 < iA0I; numberOfBooks2++) {
            A03(c0545Hf);
        }
        int numberOfBooks3 = c0545Hf.A02(6);
        int timeCount = numberOfBooks3 + 1;
        for (int i10 = 0; i10 < timeCount; i10++) {
            int numberOfBooks4 = c0545Hf.A02(16);
            if (numberOfBooks4 != 0) {
        ...
        A0B(c0545Hf);
        A09(i4, c0545Hf);
        C0548Hi[] c0548HiArrA0E = A0E(c0545Hf);
        if (c0545Hf.A04()) {
            return c0548HiArrA0E;
        }
        throw C3K.A01(A07(240, 43, 105), null);
    }

    public static C0548Hi[] A0E(C0545Hf c0545Hf) {
        int iA02 = c0545Hf.A02(6) + 1;
        C0548Hi[] c0548HiArr = new C0548Hi[iA02];
        for (int windowType = 0; windowType < iA02; windowType++) {
            boolean zA04 = c0545Hf.A04();
            int iA022 = c0545Hf.A02(16);
            int i4 = c0545Hf.A02(16);
            c0548HiArr[windowType] = new C0548Hi(zA04, iA022, i4, c0545Hf.A02(8));
        }
        return c0548HiArr;
    }
}
