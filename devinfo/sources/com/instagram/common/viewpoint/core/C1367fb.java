...
public final class C1367fb {
    ...
    public boolean A00;
    public final C1432ge A04;
    public final Handler A01 = new Handler(Looper.getMainLooper());
    public final SparseArray<C1365fZ> A02 = new SparseArray<>();
    public final Runnable A05 = new RunnableC1364fY(this);
    ...
    public C1367fb(C1432ge c1432ge, C5 c52) {
        this.A04 = c1432ge;
        if (c52 != null) {
            A07 = c52;
            c52.A0F(this.A03);
    ...
    public static synchronized MP A04(Context context) {
        if (A08 == null) {
            A08 = new C1645kM(new File(A07(context), A08(121, 14, 26)), new AnonymousClass89(C0886Up.A0T(context)));
        }
        return A08;
    }

    public static C1652kT A05(C1931pE c1931pE, MP mp) {
        return new C1652kT().A06(mp).A05(c1931pE).A04(new C1925p8()).A03(2);
    }

    public static synchronized C1367fb A06(C1432ge c1432ge) {
        if (A09 == null) {
            A09 = new C1367fb(c1432ge, null);
        }
        return A09;
    }
    ...
    public static String A09(C1432ge c1432ge, Uri uri) {
        try {
            if (!C0886Up.A1w(c1432ge)) {
                return null;
            }
            return new URI(uri.getScheme(), uri.getAuthority(), uri.getPath(), null, uri.getFragment()).toString();
        } catch (URISyntaxException e2) {
            c1432ge.A08().ABC(A08(138, 5, 50), AbstractC0848Td.A0u, new C0849Te(e2));
            return null;
        }
    }
    ...
    */
    public void A0A() {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C1367fb.A0A():void");
    }
    ...
    public final C5Y A0H(Context context) {
        return A05(new C1931pE(context, (InterfaceC02675t) null, A02()), A04(context));
    }

    public final void A0I(Uri uri, InterfaceC1366fa interfaceC1366fa, long j) {
        ...
        this.A02.put(downloadRequestA05.A02.hashCode(), new C1365fZ(interfaceC1366fa, j, zA0J, null));
        A0B();
    }
