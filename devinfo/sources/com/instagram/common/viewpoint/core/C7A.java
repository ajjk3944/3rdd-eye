...
public final class C7A {
    ...
    public long A03;
    public C7A A04;
    public C1826nW A05 = C1826nW.A06;
    public C0486Ex A06;
    public final InterfaceC1845np A07;
    public final Object A08;
    public final DT[] A09;
    public final AnonymousClass79 A0A;
    public final AbstractC0485Ew A0B;
    public final InterfaceC03157p[] A0C;
    ...
    public C7A(InterfaceC03157p[] interfaceC03157pArr, long j, AbstractC0485Ew abstractC0485Ew, F0 f02, InterfaceC0434Cx interfaceC0434Cx, C7B c7b, C0486Ex c0486Ex) {
        this.A0C = interfaceC03157pArr;
        this.A03 = j - c7b.A03;
        this.A0B = abstractC0485Ew;
        this.A08 = AbstractC02203y.A01(c7b.A04.A04);
        this.A00 = c7b;
        this.A06 = c0486Ex;
        this.A09 = new DT[interfaceC03157pArr.length];
        this.A0D = new boolean[interfaceC03157pArr.length];
        this.A0A = new C1906op(this, interfaceC0434Cx);
    ...
    public static InterfaceC1845np A00(C1844no c1844no, AnonymousClass79 anonymousClass79, F0 f02, long j, long j8) {
        InterfaceC1845np interfaceC1845npA5W = anonymousClass79.A5W(c1844no, f02, j);
        if (j8 != -9223372036854775807L) {
            return new C9v(interfaceC1845npA5W, true, 0L, j8);
        }
        return interfaceC1845npA5W;
    }
    ...
    */
    ...
    public static void A05(AnonymousClass79 anonymousClass79, InterfaceC1845np interfaceC1845np) {
        try {
            if (interfaceC1845np instanceof C9v) {
                anonymousClass79.AHk(((C9v) interfaceC1845np).A05);
            } else {
                anonymousClass79.AHk(interfaceC1845np);
            }
        } catch (RuntimeException e2) {
            AbstractC02284g.A08(A01(0, 17, 10), A01(17, 22, 90), e2);
        }
    }
    ...
    */
    ...
    public final long A0F(C0486Ex c0486Ex, long j, boolean z3) {
        return A0G(c0486Ex, j, z3, new boolean[this.A0C.length]);
    }

    public final long A0G(C0486Ex c0486Ex, long j, boolean z3, boolean[] zArr) {
        int i4 = 0;
        while (true) {
            boolean z10 = false;
            if (i4 < c0486Ex.A00) {
                ...
                if (!z3) {
                    boolean zA01 = c0486Ex.A01(this.A06, i4);
                    if (A0F[5].length() != 8) {
                ...
                this.A06 = c0486Ex;
                A03();
                long jAJ9 = this.A07.AJ9(c0486Ex.A04, this.A0D, this.A09, zArr, j);
                A06(this.A09);
                this.A01 = false;
                for (int i10 = 0; i10 < this.A09.length; i10++) {
                    if (this.A09[i10] != null) {
                        AbstractC02203y.A08(c0486Ex.A00(i10));
                        if (this.A0C[i10].A9N() != -2) {
                            this.A01 = true;
                        }
                    } else {
                        AbstractC02203y.A08(c0486Ex.A04[i10] == null);
                    }
                }
                return jAJ9;
            }
    ...
    public final C1826nW A0J() {
        return this.A05;
    }

    public final C0486Ex A0K() {
        return this.A06;
    }

    public final C0486Ex A0L(float f10, Timeline timeline) throws AD {
        C0486Ex c0486ExA0b = this.A0B.A0b(this.A0C, A0J(), this.A00.A04, timeline);
        for (InterfaceC1808nE interfaceC1808nE : c0486ExA0b.A04) {
