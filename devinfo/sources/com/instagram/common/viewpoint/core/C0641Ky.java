...
public final class C0641Ky {
    ...
    public static String A00(int i4, int i10, int i11) {
        ...
        for (int i12 = 0; i12 < bArrCopyOfRange.length; i12++) {
            int i13 = (bArrCopyOfRange[i12] - i11) - 40;
    ...
    public final void A03(byte[] bArr, int i4, int i10) {
        ...
        if (length < readLength2 + i11) {
            byte[] bArr3 = this.A02;
            int readLength3 = this.A00;
            this.A02 = Arrays.copyOf(bArr3, (readLength3 + i11) * 2);
        }
        byte[] bArr4 = this.A02;
        int readLength4 = this.A00;
        System.arraycopy(bArr, i4, bArr4, readLength4, i11);
        int readLength5 = this.A00;
        this.A00 = readLength5 + i11;
    }

    public final boolean A04(int i4, int i10) {
        int i11 = this.A03;
        ...
        switch (i11) {
            ...
            case 1:
                if (i4 != 181) {
                    AbstractC02284g.A07(strA002, strA00);
                    A02();
                    break;
                } else {
                    this.A03 = 2;
