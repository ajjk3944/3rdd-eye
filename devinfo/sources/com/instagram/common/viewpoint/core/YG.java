...
public final class YG implements Executor {
    ...
    public static void A05(Context context) {
        A0D.set(C0886Up.A2s(context));
        A0E.set(C0886Up.A2r(context));
    }
    ...
    public final void execute(Runnable runnable) {
        ...
        synchronized (YG.class) {
            ...
            if (size == reservedExecutorQueueSize) {
                ...
                if (c1432geA00 != null) {
                    c1432geA00.A08().ABC(A00(42, 7, 34), AbstractC0848Td.A1d, new C0849Te(A00(21, 21, 34), A00(14, 7, 32) + i4));
                }
            }
        }
