...
public class C0892Uv extends AbstractC1380fo {
    ...
    public C0892Uv(UK uk2, View view, boolean z3, C1618ju c1618ju) {
        this.A02 = uk2;
        this.A00 = view;
        this.A03 = z3;
        this.A01 = c1618ju;
    ...
    public final void A03() {
        this.A02.A0i.A0B();
        if (C0886Up.A2I(this.A02.A16()) && (this.A00 instanceof AdNativeComponentView)) {
            View adContentsView = ((AdNativeComponentView) this.A00).getAdContentsView();
            if ((adContentsView instanceof C1320eq) && !((C1320eq) adContentsView).A05()) {
                this.A02.A0U.A0T();
                this.A02.A0i.A08();
                return;
            }
        ...
        if (this.A02.A0Y != null && this.A02.A0Y.get() != null) {
            ((AbstractC1380fo) this.A02.A0Y.get()).A03();
        }
        if (this.A02.A0j.A07()) {
            this.A02.A0i.A04();
            return;
        ...
        if (this.A02.A0A != null && this.A02.A04 != null) {
            ...
            if (view != null) {
                ...
                this.A02.A0A.A0D(AbstractC1000Ze.A00(this.A02.A08));
