...
public final class FK<T extends FL> extends Handler implements Runnable {
    ...
    public final /* synthetic */ C1801n7 A0A;
    ...
    private void A02() {
        ...
        this.A03 = null;
        this.A0A.A02.execute((Runnable) AbstractC02203y.A01(this.A0A.A00));
    }
    ...
    public final void handleMessage(Message message) throws Throwable {
        ...
        FI fi2 = (FI) AbstractC02203y.A01(this.A02);
        if (this.A05) {
        ...
        switch (message.what) {
            case 1:
                try {
                    ...
                    AbstractC02284g.A08(A01(0, 8, 0), A01(71, 44, 118), e2);
                    this.A0A.A01 = new FP(e2);
                    return;
                }
            case 2:
    ...
    public FK(C1801n7 c1801n7, Looper looper, T loadable, FI<T> fi2, int i4, long j) {
        super(looper);
        this.A0A = c1801n7;
        this.A08 = loadable;
        this.A02 = fi2;
    ...
    private long A00() {
        return AbstractC1563is.A00(this.A01, 0);
    }
    ...
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.FK != com.facebook.ads.androidx.media3.exoplayer.upstream.Loader$LoadTask<T extends com.facebook.ads.redexgen.X.FL> */
    public final void A05(int i4) throws IOException {
        if (this.A03 == null || this.A01 <= i4) {
        } else {
            throw this.A03;
        }
    }
    ...
    public final void A06(long j) {
        AbstractC02203y.A08(this.A0A.A00 == null);
        this.A0A.A00 = this;
        if (j > 0) {
    ...
    public final void A07(boolean z3) {
        ...
        if (z3) {
            A03();
            long jElapsedRealtime = SystemClock.elapsedRealtime();
            ((FI) AbstractC02203y.A01(this.A02)).AEc(this.A08, jElapsedRealtime, jElapsedRealtime - this.A07, true);
            this.A02 = null;
        }
    }
            ...
            try {
                try {
                    try {
                        ...
                        if (!this.A09) {
                            AbstractC02284g.A08(A01(0, 8, 0), A01(8, 32, 20), e10);
                            obtainMessage(2, new FP(e10)).sendToTarget();
                        }
                    }
                } catch (Exception e11) {
                    if (!this.A09) {
                        AbstractC02284g.A08(A01(0, 8, 0), A01(115, 35, 50), e11);
                        obtainMessage(2, new FP(e11)).sendToTarget();
                    }
                }
            } catch (Error e12) {
                if (!this.A09) {
                    AbstractC02284g.A08(A01(0, 8, 0), A01(40, 31, 85), e12);
