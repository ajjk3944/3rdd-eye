...
public abstract class NI {
     ...
     */
    public static C1606ji A01(@Nullable C1436gi c1436gi, JSONObject jSONObject, String str, boolean z3, int i4, int i10) {
        boolean zOptBoolean;
        int iOptInt;
        ...
        XI.A04(c1436gi, A02(0, 23, AppLovinMediationAdapter.ERROR_CHILD_USER));
        ...
        String strA02 = AbstractC0947Xd.A02(jSONObject, A02(266, 12, 52));
        Uri uriA00 = TextUtils.isEmpty(strA02) ? null : XB.A00(strA02);
        String strA022 = AbstractC0947Xd.A02(jSONObject, A02(128, 4, 54));
        String strA01 = AbstractC0965Xv.A01(strA022);
        String strA023 = AbstractC0947Xd.A02(jSONObject, A02(101, 15, 34));
        String strA024 = AbstractC0947Xd.A02(jSONObject, A02(593, 5, 82));
        String strA025 = AbstractC0947Xd.A02(jSONObject, A02(585, 8, 123));
        String strA026 = AbstractC0947Xd.A02(jSONObject, A02(386, 8, FacebookMediationAdapter.ERROR_ADVIEW_CONSTRUCTOR_EXCEPTION));
        String strA027 = AbstractC0947Xd.A02(jSONObject, A02(539, 14, 32));
        String strA028 = AbstractC0947Xd.A02(jSONObject, A02(TTAdConstant.DEEPLINK_UNAVAILABLE_CODE, 16, 125));
        String strA029 = AbstractC0947Xd.A02(jSONObject, A02(553, 21, 41));
        String strA0210 = AbstractC0947Xd.A02(jSONObject, A02(87, 14, 99));
        String strA0211 = AbstractC0947Xd.A02(jSONObject, A02(459, 20, 94));
        String strA0212 = AbstractC0947Xd.A02(jSONObject, A02(443, 16, 123));
        String strA0213 = AbstractC0947Xd.A02(jSONObject, A02(426, 17, 38));
        String strA0214 = AbstractC0947Xd.A02(jSONObject, A02(132, 14, 16));
        C03127m c03127mA00 = C03127m.A00(jSONObject, c1436gi);
        C0898Vb c0898VbA00 = C0898Vb.A00(jSONObject.optJSONObject(A02(394, 4, 38)));
        C0898Vb c0898VbA002 = C0898Vb.A00(jSONObject.optJSONObject(A02(398, 5, 114)));
        C0899Vc c0899VcA00 = C0899Vc.A00(jSONObject.optJSONObject(A02(574, 11, 124)));
        String strA0215 = AbstractC0947Xd.A02(jSONObject, A02(598, 15, 10));
        ...
        C0898Vb c0898VbA003 = jSONObjectOptJSONObject != null ? C0898Vb.A00(jSONObjectOptJSONObject) : null;
        String strA0216 = AbstractC0947Xd.A02(jSONObject, A02(68, 19, 95));
        EnumC0690Mv enumC0690MvA00 = AbstractC0692Mx.A00(jSONObject);
        Collection<String> collectionA03 = AbstractC0692Mx.A03(c1436gi, jSONObject);
        String strA0217 = AbstractC0947Xd.A02(jSONObject, A02(686, 9, 20));
        ...
        String strA0219 = AbstractC0947Xd.A02(jSONObject, A02(653, 9, 120));
        String strA0220 = A02(613, 22, 83);
        EnumC0902Vf enumC0902Vf = !jSONObject.has(strA0220) ? EnumC0902Vf.A03 : jSONObject.optBoolean(strA0220) ? EnumC0902Vf.A05 : EnumC0902Vf.A04;
        ...
        try {
            ...
            if (jSONArrayOptJSONArray != null && jSONArrayOptJSONArray.length() > 0) {
                ...
                for (int i11 = 0; i11 < length; i11++) {
                    try {
                        arrayList2.add(A01(c1436gi, jSONArrayOptJSONArray.getJSONObject(i11), str, true, i11, length));
                    } catch (JSONException e2) {
                        e = e2;
                        arrayList = arrayList2;
                        c1436gi.A08().ABC(A02(419, 7, 72), AbstractC0848Td.A2A, new C0849Te(e));
                        Log.e(C1618ju.A0E, A02(23, 30, 97), e);
                        return new C1606ji(strA0216, strA01, strA022, strA023, strA024, strA025, strA026, strA027, strA028, strA029, strA0210, strA0211, strA0212, strA0213, strA0214, c0898VbA003, c03127mA00, c0898VbA00, c0898VbA002, c0899VcA00, strA0217, strA0219, jOptLong, enumC0902Vf, z3, i4, i10, arrayList, str, strOptString, iOptInt4, strOptString2, uriA00, strA0215, zOptBoolean4, zOptBoolean5, iOptInt6, iOptInt5, iOptInt7, iOptInt8, enumC0690MvA00, collectionA03, iOptInt, zOptBoolean, iOptInt9, zOptBoolean2, iOptInt2, zOptBoolean3, iOptInt3);
                    }
                }
                arrayList = arrayList2;
            }
    ...
    public static C1606ji A00(C1436gi c1436gi, JSONObject jSONObject, String str) {
        return A01(c1436gi, jSONObject, str, false, -1, 0);
    }
}
