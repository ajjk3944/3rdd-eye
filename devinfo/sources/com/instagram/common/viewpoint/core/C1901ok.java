...
public class C1901ok implements AnonymousClass78 {
    ...
    public long A00;
    public long A01;
    public C1975px A02 = C1975px.A06;
    public boolean A03;
    public final AnonymousClass45 A04;

    public C1901ok(AnonymousClass45 anonymousClass45) {
    ...
    @Override // com.instagram.common.viewpoint.core.AnonymousClass78
    public void AJd(C1975px c1975px) {
        if (this.A03) {
            long jA8p = A8p();
            String[] strArr = A05;
