...
public final class C1273e4 extends LinearLayout {
    ...
    public C1273e4(C1436gi c1436gi) {
        super(c1436gi);
        this.A03 = c1436gi;
        A00(c1436gi);
    }

    private final void A00(C1436gi c1436gi) {
        setGravity(16);
        this.A02 = new C1130bk(c1436gi);
        ...
        LinearLayout pageInfoView = new LinearLayout(c1436gi);
    ...
    public final void A02(int i4, int i10) {
        this.A00.setTextColor(i4);
        this.A01.setTextColor(i10);
    }

    public void setPageDetails(C0706Nm c0706Nm) {
        LM lm2 = new LM(this.A02, this.A03);
        lm2.A05(A04, A04);
        lm2.A07(c0706Nm.A01());
        this.A00.setText(c0706Nm.A02());
        this.A01.setText(c0706Nm.A03());
    }
}
