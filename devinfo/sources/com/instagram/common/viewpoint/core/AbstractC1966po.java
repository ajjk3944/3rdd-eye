...
public abstract class AbstractC1966po {
    ...
    public static int A00(int expectedSize) {
        if (expectedSize < 3) {
            AbstractC1813nJ.A00(expectedSize, A07(2, 12, 124));
            int i4 = expectedSize + 1;
    ...
    public static <V> InterfaceC1647kO<Map.Entry<?, V>, V> A04() {
        BJ bj = BJ.A03;
        if (A01[6].charAt(13) == 's') {
            throw new RuntimeException();
        }
    ...
    public static String A08(Map<?, ?> map) {
        StringBuilder sbAppend = AbstractC1832nc.A01(map.size()).append('{');
        boolean z3 = true;
    ...
    public static boolean A0A(@CheckForNull Map<?, ?> map, Object value) {
        return AbstractC1926p9.A0D(A03(map.entrySet().iterator()), value);
    }
