...
public final class C1907oq implements G2, GR, InterfaceC03027c {
    ...
    public final void A9i(int i4, Object obj) {
        switch (i4) {
            case 7:
                this.A01 = (G2) obj;
                return;
    ...
    public final void AGS(long j, long j8, C1996qI c1996qI, MediaFormat mediaFormat) {
        if (this.A00 != null) {
            G2 g22 = this.A00;
            ...
            g22.AGS(j, j8, c1996qI, mediaFormat);
        }
        if (this.A01 != null) {
            this.A01.AGS(j, j8, c1996qI, mediaFormat);
        }
    }
}
