...
public class RH {
    ...
    public final void A04(int i4) {
        if ((this.A04 & i4) != 0) {
            ...
            throw new IllegalStateException(A01(192, 30, 44) + Integer.toBinaryString(i4) + A01(0, 11, 115) + Integer.toBinaryString(this.A04));
        }
    }

    public final void A05(AbstractC0784Qq abstractC0784Qq) {
        this.A04 = 1;
        this.A03 = abstractC0784Qq.A0B();
        this.A09 = false;
        this.A0E = false;
        this.A0A = false;
    }
