...
public abstract class AbstractC0531Gr {
    ...
    static {
        ...
        A02 = new int[]{32, 40, 48, 56, 64, 80, 96, AppLovinMediationAdapter.ERROR_CHILD_USER, 128, 160, 192, 224, 256, 320, 384, 448, 512, 576, 640};
    ...
    public static int A04(ByteBuffer byteBuffer, int i4) {
        boolean z3 = (byteBuffer.get((byteBuffer.position() + i4) + 7) & 255) == 187;
        ...
        return 40 << ((byteBuffer.get(iPosition + (z3 ? 9 : 8)) >> 4) & 7);
    }
    ...
    public static C1996qI A07(C02434v c02434v, String str, String str2, DrmInitData drmInitData) {
        C02424u c02424u = new C02424u();
        c02424u.A0C(c02434v);
        int fscod = c02424u.A04(2);
        int constantBitrate = A05[fscod];
        c02424u.A09(8);
        int i4 = A04[c02424u.A04(3)];
        if (c02424u.A04(1) != 0) {
            i4++;
        }
        int fscod2 = c02424u.A04(5);
        int halfFrmsizecod = A02[fscod2] * 1000;
        c02424u.A06();
        c02434v.A0f(c02424u.A02());
        return new C01872p().A0y(str).A11(A0A(0, 9, 4)).A0b(i4).A0m(constantBitrate).A0u(drmInitData).A10(str2).A0a(halfFrmsizecod).A0j(halfFrmsizecod).A14();
    }

    public static C1996qI A08(C02434v c02434v, String str, String str2, DrmInitData drmInitData) {
        C02424u c02424u = new C02424u();
        c02424u.A0C(c02434v);
        int fscod = c02424u.A04(13) * 1000;
        c02424u.A09(3);
        int peakBitrate = c02424u.A04(2);
        int sampleRate = A05[peakBitrate];
        c02424u.A09(10);
        int channelCount = A04[c02424u.A04(3)];
        if (c02424u.A04(1) != 0) {
            channelCount++;
        }
        c02424u.A09(3);
        ...
        c02424u.A06();
        c02434v.A0f(c02424u.A02());
        return new C01872p().A0y(str).A11(strA0A).A0b(channelCount).A0m(sampleRate).A0u(drmInitData).A10(str2).A0j(fscod).A14();
    }
    ...
    */
    public static com.instagram.common.viewpoint.core.C0530Gq A09(com.instagram.common.viewpoint.core.C02424u r24) {
        /*
            Method dump skipped, instructions count: 888
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.AbstractC0531Gr.A09(com.facebook.ads.redexgen.X.4u):com.facebook.ads.redexgen.X.Gq");
    }
}
