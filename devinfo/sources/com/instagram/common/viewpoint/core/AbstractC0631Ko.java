...
public abstract class AbstractC0631Ko {
    ...
    public static void A04(C02434v c02434v) throws C3K {
        int iA09 = c02434v.A09();
        if (A05(c02434v)) {
            return;
        }
        c02434v.A0f(iA09);
        throw C3K.A01(A02(2, 21, 114) + c02434v.A0T(), null);
    }

    public static boolean A05(C02434v c02434v) {
