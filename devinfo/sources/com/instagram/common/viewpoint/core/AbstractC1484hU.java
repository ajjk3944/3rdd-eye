...
public abstract class AbstractC1484hU extends R5 {
    ...
    public C7M A00;
    public Scroller A01;
    public final R7 A02 = new C1489hZ(this);
    ...
    public abstract int A0C(R2 r22, int i4, int i10);

    public abstract View A0D(R2 r22);

    @Deprecated
    public abstract C1505hq A0E(R2 r22);
    ...
    private final C1505hq A05(R2 r22) {
        return A0E(r22);
    }
    ...
    private boolean A0A(R2 r22, int i4, int i10) {
        C1505hq c1505hqA05;
        int iA0C;
        if (!(r22 instanceof RE) || (c1505hqA05 = A05(r22)) == null || (iA0C = A0C(r22, i4, i10)) == -1) {
            return false;
        }
        c1505hqA05.A0A(iA0C);
        r22.A1N(c1505hqA05);
    ...
    public final boolean A0B(int i4, int i10) {
        ...
        return (Math.abs(i10) > minFlingVelocity || Math.abs(i4) > minFlingVelocity) && A0A(layoutManager, i4, i10);
    }
