...
public abstract class PC<K, V> {
    ...
    public abstract Object A0B(int i4, int i10);

    public abstract V A0C(int i4, V v10);

    public abstract void A0D();

    public abstract void A0E(int i4);

    public abstract void A0F(K k2, V v10);
    ...
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.PC != com.facebook.ads.internal.androidx.support.v4.util.MapCollections<K, V> */
    public final Object[] A0G(int i4) {
        int iA04 = A04();
        Object[] objArr = new Object[iA04];
        for (int i10 = 0; i10 < iA04; i10++) {
            objArr[i10] = A0B(i10, i4);
        }
        return objArr;
    }

    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.PC != com.facebook.ads.internal.androidx.support.v4.util.MapCollections<K, V> */
    public final <T> T[] A0H(T[] tArr, int i4) {
        int iA04 = A04();
        if (tArr.length < iA04) {
