...
public final class C1259dq extends LinearLayout {
    public LinearLayout A00;
    public String A01;
    public boolean A02;
    public final int A03;
    public final C1436gi A04;
    public final C1130bk A05;
    ...
    public C1259dq(Cdo cdo) {
        super(cdo.A08);
        this.A02 = false;
        this.A01 = "";
        this.A04 = cdo.A08;
        this.A05 = new C1130bk(this.A04);
        this.A06 = new C1136bq(this.A04, cdo.A01, true, false, true);
        this.A03 = cdo.A00;
        this.A02 = cdo.A05;
        this.A01 = cdo.A04;
        A03(cdo);
    ...
    public /* synthetic */ C1259dq(Cdo cdo, GX gx) {
        this(cdo);
    }
    ...
    private void A01(View view, int i4) {
        view.setTranslationY(i4);
        view.setScaleY(0.75f);
        view.setScaleX(0.75f);
        view.animate().translationYBy(-i4).scaleX(1.0f).scaleY(1.0f).setDuration(300L).setInterpolator(new DecelerateInterpolator(2.0f));
    }
    ...
    private void A02(Cdo cdo) {
        if (!TextUtils.isEmpty(cdo.A03)) {
            ...
            int i11 = A0C;
            int marginTop = A0C;
            linearLayout.setPadding(i10, i4, i11, marginTop / 2);
            ...
            if (this.A02) {
                C1124be c1124be = new C1124be(getContext(), 0, -1, YM.PLAYABLE_ICON);
                c1124be.setLayoutParams(new LinearLayout.LayoutParams(A0B, A0B));
                this.A00.addView(c1124be);
            } else {
    ...
    public final void A04(InterfaceC1258dp interfaceC1258dp) {
        A00();
        postDelayed(new GX(this, interfaceC1258dp), this.A03);
    }
}
