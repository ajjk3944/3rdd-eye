...
public final class S3 implements NativeAdScrollViewApi {
    ...
    public S3(NativeAdScrollView nativeAdScrollView, Context context, NativeAdsManager nativeAdsManager, NativeAdScrollView.AdViewProvider adViewProvider, int i4, NativeAdView.Type type, NativeAdViewAttributes nativeAdViewAttributes, int i10) throws Resources.NotFoundException {
        if (nativeAdsManager.isLoaded()) {
            if (type != null || adViewProvider != null || i4 > 0) {
                this.A06 = C0809Rp.A03(context);
                this.A04 = nativeAdsManager;
                this.A03 = nativeAdViewAttributes;
                this.A01 = adViewProvider;
                this.A02 = type;
                this.A00 = i10;
                C1464hA c1464hA = new C1464hA(this);
                this.A05 = new C1463h9(context);
                if (this.A02 == null) {
                    if (i4 > 0) {
                        this.A05.A00(((int) XX.A02) * i4);
                    }
                } else {
                    this.A05.A00((int) (XX.A02 * this.A02.getHeight()));
                }
                this.A05.setAdapter(c1464hA);
                setInset(20);
                c1464hA.A09();
    ...
    public final void setInset(int i4) {
        if (i4 > 0) {
            float f10 = XX.A02;
            float density = i4;
