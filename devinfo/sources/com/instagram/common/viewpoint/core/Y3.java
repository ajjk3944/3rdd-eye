...
public final class Y3<T> implements InterfaceC0873Uc<T> {
    ...
    public Y3(UZ uz, InterfaceC0878Uh interfaceC0878Uh) throws IOException {
        this.A05 = new C0880Uj(uz.A04(A00(515, 4, FacebookMediationAdapter.ERROR_REQUIRES_ACTIVITY_CONTEXT)), interfaceC0878Uh);
        this.A04 = new UT(new File(uz.A05(), A00(509, 6, 60)));
        this.A00 = this.A04.A03();
        A05(interfaceC0878Uh);
        this.A01 = this.A00;
    }

    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.Y3 != com.facebook.ads.internal.eventstorage.record.RecordFileBasedRecordDatabase<T> */
    private void A02(int i4, int i10) throws IOException {
        this.A00 = new UU(i4, i10);
    ...
    public synchronized void A03(Y8 y82) throws C0882Ul {
        if (!this.A03) {
            if (A06(y82)) {
                if (y82.A6X() == 0) {
                    return;
                ...
                if (this.A00.A04(y82.A00().A02) == 0) {
                    try {
                        Iterator<C0877Ug> it = y82.A00.iterator();
                        while (it.hasNext()) {
                        ...
                        throw new C0882Ul(A00(361, 30, 22), e2);
                    }
                }
                throw new C0882Ul(A00(0, 54, 30));
            }
            throw new C0882Ul(A00(466, 43, 59));
        }
        throw new C0882Ul(A00(427, 39, 60));
    }
    ...
    */
    private void A05(com.instagram.common.viewpoint.core.InterfaceC0878Uh r13) throws java.io.IOException {
        /*
            r12 = this;
    ...
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.Y3 != com.facebook.ads.internal.eventstorage.record.RecordFileBasedRecordDatabase<T> */
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.Y8 != com.facebook.ads.internal.eventstorage.record.RecordFileBasedRecordDatabase<T>$RecordFileBasedFetch */
    @Override // com.instagram.common.viewpoint.core.InterfaceC0873Uc
    public final synchronized InterfaceC0872Ub A6W(byte[] bArr, int[] iArr) throws C0882Ul {
        ...
        if (!this.A03) {
            ...
            try {
                ...
                while (true) {
                    UX uxA0A = this.A05.A0A(this.A01.A02(), this.A01.A03(), bArr, i4, iArr, i10);
                ...
                throw new C0882Ul(A00(306, 29, 84), e2);
            }
        } else {
            throw new C0882Ul(A00(391, 36, 123));
        }
        return y82;
    }
    ...
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.Y3 != com.facebook.ads.internal.eventstorage.record.RecordFileBasedRecordDatabase<T> */
    @Override // com.instagram.common.viewpoint.core.InterfaceC0873Uc
    public final synchronized int A8s() throws C0882Ul {
        int iA09;
        if (!this.A03) {
            try {
                iA09 = this.A05.A09();
                ...
                throw new C0882Ul(A00(335, 26, 57), e2);
            }
        } else {
            throw new C0882Ul(A00(427, 39, 60));
        }
    ...
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.Y3 != com.facebook.ads.internal.eventstorage.record.RecordFileBasedRecordDatabase<T> */
    @Override // com.instagram.common.viewpoint.core.InterfaceC0873Uc
    public final synchronized void AKH(byte[] bArr) throws C0882Ul {
        if (!this.A03) {
            try {
                this.A05.A0C(bArr);
            } catch (IOException e2) {
                throw new C0882Ul(A00(257, 25, 62), e2);
            }
        } else {
            throw new C0882Ul(A00(427, 39, 60));
        }
    ...
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.Y3 != com.facebook.ads.internal.eventstorage.record.RecordFileBasedRecordDatabase<T> */
    @Override // com.instagram.common.viewpoint.core.InterfaceC0873Uc
    public final synchronized void clear() throws C0882Ul {
        try {
            this.A05.A0B();
            A02(this.A05.A06(), 0);
            this.A02.clear();
        } catch (IOException e2) {
            throw new C0882Ul(A00(282, 24, 87), e2);
        }
    }
