...
public final class C0940Wu {
    ...
    public static final Set<C1436gi> A06;
    ...
    public static int A00(C1436gi c1436gi, Intent intent) throws C0938Ws {
        Intent intentA01 = A01(intent);
        int usedContext = 0;
        try {
            Activity activityA00 = ActivityUtils.A00();
            if (activityA00 == null) {
                activityA00 = c1436gi.A0E();
                usedContext = 1;
            }
            if (activityA00 != null) {
            ...
            c1436gi.startActivity(intentA01);
            return 2;
        } catch (ActivityNotFoundException e2) {
            throw new C0938Ws(e2);
        }
    }
    ...
    public static C1436gi A04(Intent intent) {
        String stringExtra = intent.getStringExtra(A03);
        if (stringExtra != null) {
            for (C1436gi c1436gi : A06) {
                String adId = c1436gi.A0F().getId();
    ...
    public static AdActivityIntent A05(C1436gi c1436gi) {
        AdActivityIntent adActivityIntent = new AdActivityIntent(c1436gi.getApplicationContext(), A06());
        adActivityIntent.putExtra(A03, c1436gi.A0F().getId());
        A06.add(c1436gi);
    ...
    public static Class A06() {
        if (ProcessUtils.isRemoteRenderingProcess()) {
            try {
                return Class.forName(A07(AppLovinMediationAdapter.ERROR_MISSING_AD_UNIT_ID, 59, 72));
    ...
    public static void A09(Activity activity, Intent intent) throws C0938Ws {
        try {
    ...
    public static void A0B(C1436gi c1436gi, AdActivityIntent adActivityIntent) throws C0938Ws {
        Context launchContext;
        Context applicationContext = c1436gi.getApplicationContext();
        if (C0886Up.A2d(c1436gi) && (launchContext = c1436gi.A0E()) != null) {
        ...
        try {
            if (ProcessUtils.isRemoteRenderingProcess()) {
                if (!A0I(c1436gi, adActivityIntent)) {
                    c1436gi.A0F().AIC();
                    return;
                }
                return;
    ...
    public static boolean A0D(C1436gi c1436gi, Intent intent) throws C0938Ws {
        A07.get();
        return A0F(c1436gi, intent, null);
    }

    public static boolean A0E(C1436gi c1436gi, Intent intent) throws C0938Ws {
        A07.get();
        if (0 != 0) {
            ...
            if (activityA0E != null) {
                ...
                try {
                    ...
                    c1436gi.A08().ABC(A07(90, 8, 57), AbstractC0848Td.A07, new C0849Te(e10));
                    return false;
                }
            }
        }
    ...
    public static boolean A0F(C1436gi c1436gi, Intent intent, X3 x32) throws C0938Ws {
        if (A0C(intent, C0886Up.A0Z(c1436gi))) {
            return false;
        }
        Context context = c1436gi;
        if (A01[1].charAt(5) != 'g') {
            A01[2] = "mGLT8eS8inmCxtBfGXr0XCfYNSNKmj30";
            Context startContext = c1436gi.A0E();
            if (startContext != null) {
                context = startContext;
            } else {
                intent.addFlags(268435456);
            }
            if (x32 != null && !A0C(intent, C0886Up.A0b(c1436gi))) {
                c1436gi.A0C();
                try {
                    ...
                    c1436gi.A08().ABC(A07(90, 8, 57), AbstractC0848Td.A08, new C0849Te(e10));
                    return false;
                }
            }
            try {
                ...
                throw new C0938Ws(e11);
            }
        }
        throw new RuntimeException();
    }

    public static boolean A0G(C1436gi c1436gi, Uri uri, String str) throws ActivityNotFoundException {
        A08.get();
        return A0H(c1436gi, uri, str, null);
    }

    public static boolean A0H(C1436gi c1436gi, Uri uri, String str, X5 x52) throws ActivityNotFoundException {
        if (x52 == null || c1436gi.A0E() == null) {
            return false;
        }
    ...
    public static boolean A0I(C1436gi c1436gi, AdActivityIntent adActivityIntent) throws C0938Ws {
        Intent intentA01 = A01(adActivityIntent);
        try {
            Activity currentActivity = ActivityUtils.A00();
            if (currentActivity == null) {
                currentActivity = c1436gi.A0E();
            }
            if (currentActivity == null) {
                return false;
            }
