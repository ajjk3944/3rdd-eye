...
public final class C1227dJ {
    ...
    public WeakReference<C1220dC> A00;
    public WeakReference<InterfaceC0583Is> A01 = new WeakReference<>(null);
    public boolean A02 = false;
    public final C1436gi A03;
    public final C1207cz A04;
    ...
    public C1227dJ(C1436gi c1436gi, C1220dC c1220dC, VA va2, C1207cz c1207cz, String str, String str2) {
        this.A03 = c1436gi;
        this.A00 = new WeakReference<>(c1220dC);
    ...
    private void A04() {
        InterfaceC0583Is uxListener = this.A01.get();
        if (uxListener == null) {
            return;
        }
        uxListener.close();
    ...
    private void A08() {
        InterfaceC0583Is uxActionsJavascriptListener = this.A01.get();
    ...
    private void A0A(C1220dC c1220dC, String str) throws JSONException {
        ...
        c1220dC.A0g(storageValue, strA012);
    }

    private void A0B(C1220dC c1220dC, String str) throws JSONException {
        JSONObject jSONObject = new JSONObject(str);
        ...
        c1220dC.A0f(strOptString2);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void A0C(EnumC1225dH enumC1225dH, String str) throws JSONException {
        switch (enumC1225dH.ordinal()) {
            case 0:
        ...
        switch (enumC1225dH.ordinal()) {
            ...
            case 4:
                ...
                break;
            case 6:
                c1220dC.A0i(A03(new JSONObject(str)));
                break;
            case 17:
                A0B(c1220dC, str);
                break;
    ...
    private void A0D(EnumC1225dH enumC1225dH, String str) throws JSONException {
        InterfaceC0583Is interfaceC0583Is = this.A01.get();
        if (interfaceC0583Is == null) {
        }
        switch (enumC1225dH.ordinal()) {
            case 12:
                A0E(interfaceC0583Is, str);
                break;
            case 13:
                interfaceC0583Is.AE4();
                break;
            case 14:
                interfaceC0583Is.AFz();
                break;
            case 15:
                A0G(interfaceC0583Is, str);
                break;
            case 16:
                A0F(interfaceC0583Is, str);
                break;
        }
    }

    private void A0E(InterfaceC0583Is interfaceC0583Is, String str) throws JSONException {
        JSONObject jSONObject = new JSONObject(str);
        String STATE_KEY = A01(87, 5, 115);
        interfaceC0583Is.AEu(jSONObject.optBoolean(STATE_KEY, false));
    }

    private void A0F(InterfaceC0583Is interfaceC0583Is, String str) throws JSONException {
        JSONObject jSONObject = new JSONObject(str);
        String PAUSED_BY_USER_KEY = A01(62, 12, 5);
        interfaceC0583Is.AGX(jSONObject.optBoolean(PAUSED_BY_USER_KEY, false));
    }

    private void A0G(InterfaceC0583Is interfaceC0583Is, String str) throws JSONException {
        JSONObject jSONObject = new JSONObject(str);
        String STARTED_BY_USER_KEY = A01(74, 13, 98);
        interfaceC0583Is.AGZ(jSONObject.optBoolean(STARTED_BY_USER_KEY, false));
    }
    ...
    private void A0I(JSONObject jSONObject) {
        ...
        if (TextUtils.isEmpty(productUrl)) {
            interfaceC0583Is.A9f();
        } else {
            interfaceC0583Is.A9g(productUrl);
        }
    }
    ...
    private void A0M(JSONObject jSONObject) {
        ...
        interfaceC0583Is.AGo(strOptString);
    }

    public final void A0N(InterfaceC0583Is interfaceC0583Is) {
        this.A01 = new WeakReference<>(interfaceC0583Is);
    }
    ...
    public void postMessage(String str) {
        Y4.A00(new RunnableC1224dG(this, str));
    }
}
