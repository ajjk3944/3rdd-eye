...
public final class C0441De<V> {
     ...
     */
    public final void A05(int i4, V v10) {
        if (this.A00 == -1) {
            AbstractC02203y.A08(this.A01.size() == 0);
            this.A00 = 0;
        }
        if (this.A01.size() > 0) {
            int iKeyAt = this.A01.keyAt(this.A01.size() - 1);
            AbstractC02203y.A07(i4 >= iKeyAt);
            if (iKeyAt == i4) {
                this.A02.A39(this.A01.valueAt(this.A01.size() - 1));
            }
        }
        this.A01.append(i4, v10);
    }
    ...
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.De != com.facebook.ads.androidx.media3.exoplayer.source.SpannedData<V> */
    public C0441De(AnonymousClass49<V> anonymousClass49) {
    ...
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.De != com.facebook.ads.androidx.media3.exoplayer.source.SpannedData<V> */
    public final V A01(int i4) {
        if (this.A00 == -1) {
            this.A00 = 0;
        }
        while (this.A00 > 0 && i4 < this.A01.keyAt(this.A00)) {
            this.A00--;
        }
        while (this.A00 < this.A01.size() - 1 && i4 >= this.A01.keyAt(this.A00 + 1)) {
            int i10 = this.A00;
            String[] strArr = A03;
    ...
    public final void A03(int i4) {
        for (int size = this.A01.size() - 1; size >= 0 && i4 < this.A01.keyAt(size); size--) {
    ...
    public final void A04(int i4) {
        for (int i10 = 0; i10 < this.A01.size() - 1 && i4 >= this.A01.keyAt(i10 + 1); i10++) {
