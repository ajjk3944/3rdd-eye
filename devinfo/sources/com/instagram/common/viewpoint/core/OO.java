...
public final class OO extends Handler {
    ...
    public InterfaceC0951Xh A01;
    public boolean A02;
    public final ServiceConnection A03;
    public final Handler A04;
    public final Messenger A05;
    public final InterfaceC0662Lt A06;
    public final C1432ge A07;
    public final AbstractRunnableC0923Wc A08;
    ...
    public OO(C1432ge c1432ge) {
        super(Looper.getMainLooper());
        this.A04 = new Handler(Looper.getMainLooper());
        this.A03 = new ON(this);
        this.A07 = c1432ge;
        this.A05 = new Messenger(this);
        InterfaceC0666Lx funnelModule = c1432ge.A00(c1432ge);
        if (funnelModule != null) {
            this.A06 = funnelModule.ACM();
        } else {
            this.A06 = new C1656kX();
        }
        this.A08 = new C1536iO(this);
    }
    ...
    public final void A0A(String str, InterfaceC0951Xh interfaceC0951Xh, int i4) throws RemoteException {
        if (this.A02) {
            this.A06.AIN(i4);
            this.A01 = interfaceC0951Xh;
            ...
            try {
                ...
                this.A06.AIO(e2.toString());
                return;
            }
        }
        InterfaceC0662Lt interfaceC0662Lt = this.A06;
        if (A0A[3].charAt(16) != '0') {
            throw new RuntimeException();
        }
        A0A[1] = "UrwnsONYHFKEsBm1tj1C3JCQoMa7O9rm";
        interfaceC0662Lt.AIP();
    }
    ...
    public final void A0B(boolean z3) {
        ...
        if (this.A02) {
            ...
            if (messenger == null) {
                this.A04.postDelayed(this.A08, AbstractC0889Us.A01(this.A07));
                return;
            }
            return;
        }
