...
public class C1618ju implements InterfaceC0691Mw, N1 {
    ...
    public static void A04() {
        A0C = new byte[]{55, 18, 23, 6, 2, 19, 4, 86, 23, 26, 4, 19, 23, 18, 15, 86, 26, 25, 23, 18, 19, 18, 86, 18, 23, 2, 23, 2, 45, 40, 34, 42, 97, 41, 32, 49, 49, 36, 47, 36, 37, 97, 46, 47, 97, 45, 46, 34, 42, 50, 34, 51, 36, 36, 47, 97, 32, 37, 87, 120, 125, 119, 127, 52, 120, 123, 115, 115, 113, 112, 119, 117, 120, 120, 113, 102, 64, 109, 100, 113, 46, 44, Utf8.REPLACEMENT_BYTE, 41, 46, 35, 57, 85, 87, 68, 82, 95, 88, 82, 114, 101, 58, 53, 32, 61, 34, 49, 12, 17, 30, 15, 12, 23, 16, 11, 100, 127, 120, 96, 100, 116, 88, 117, 33, 62, 50, 32};
    }
    ...
    private void A06(Map<String, String> map, Map<String, String> map2) {
        try {
            new Handler().postDelayed(new C1619jv(this, map2, A03(map)), this.A01.A09() * 1000);
    ...
    static {
        A04();
        A0E = C1618ju.class.getSimpleName();
    }

    public C1618ju(C1436gi c1436gi) {
        this(c1436gi, new C1606ji());
    }

    public C1618ju(C1436gi c1436gi, C1606ji c1606ji) {
        this.A0B = UUID.randomUUID().toString();
        this.A00 = TTAdConstant.MATE_VALID;
        this.A01 = c1606ji;
        this.A0A = c1436gi;
    }
    ...
    private void A05(C1606ji c1606ji) {
        if (!this.A06) {
            this.A01 = c1606ji;
            List<C1606ji> listA0f = this.A01.A0f();
            if (listA0f != null && listA0f.size() > 0) {
                int size = listA0f.size();
                ArrayList arrayList = new ArrayList(size);
                for (int i4 = 0; i4 < size; i4++) {
                    C1618ju adapter = new C1618ju(this.A0A);
                    adapter.A05(listA0f.get(i4));
                    arrayList.add(new UK(this.A0A, adapter, (C0868Tx) null, this.A04));
                }
                this.A05 = arrayList;
            }
            this.A06 = true;
    ...
    public final void A0L(C1436gi c1436gi, NG ng2, VA va2, O8 o82, InterfaceC0897Va interfaceC0897Va) {
        int iA06;
        this.A02 = ng2;
        this.A04 = interfaceC0897Va;
        JSONObject jSONObjectA03 = o82.A03();
        C0868Tx c0868TxA01 = o82.A01();
        if (c0868TxA01 != null) {
            iA06 = c0868TxA01.A06();
        } else {
            iA06 = TTAdConstant.MATE_VALID;
        }
        this.A00 = iA06;
        A05(NI.A00(c1436gi, jSONObjectA03, AbstractC0947Xd.A02(jSONObjectA03, A02(94, 2, 10))));
        if (AbstractC0692Mx.A06(c1436gi, this, va2)) {
            c1436gi.A0F().A52();
            ng2.AEz(this, C0908Vm.A00(AdErrorType.NO_FILL));
        } else {
            if (ng2 != null) {
                ng2.AEw(this);
            }
            this.A03 = new NH(c1436gi, this.A0B, this, ng2);
            this.A03.A02();
        }
    }
    ...
    public final void A0M(Map<String, String> extraData) {
        ...
        boolean shouldBlockLockscreenClicks = C0886Up.A26(this.A0A);
        ...
        C1436gi c1436gi = this.A0A;
        VA vaA0A = this.A0A.A0A();
        String strA7O = this.A01.A7O();
        Uri uriA0E = this.A01.A0E();
        if (this.A01.A0F() != null) {
            c0700NgA2A = this.A01.A0F().A2A();
        } else {
            c0700NgA2A = null;
        }
        AbstractC0688Mt abstractC0688MtA00 = C0689Mu.A00(c1436gi, vaA0A, strA7O, uriA0E, map, c0700NgA2A);
        EnumC0685Mq enumC0685MqA0G = EnumC0685Mq.A09;
        if (abstractC0688MtA00 != null) {
            enumC0685MqA0G = abstractC0688MtA00.A0G(null);
        }
        if (enumC0685MqA0G != EnumC0685Mq.A06) {
    ...
    */
    public final void A0O(java.util.Map<java.lang.String, java.lang.String> r9) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C1618ju.A0O(java.util.Map):void");
    }
    ...
    public final boolean A0T() {
        return C0886Up.A1b(this.A0A) && A0R() && this.A01.A0k();
    }

    public final boolean A0U() {
        return C0886Up.A1b(this.A0A) && A0R() && this.A01.A0l();
    }
