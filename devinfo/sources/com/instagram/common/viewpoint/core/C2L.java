...
public abstract class C2L<K, V> extends AbstractC0404Bq<K, V> implements Serializable {
    ...
    public C2L(Map<K, Collection<V>> map) {
        AbstractC1666ki.A0C(map.isEmpty());
        this.A01 = map;
    }
    ...
    public static /* synthetic */ int A02(C2L c2l, int i4) {
        int i10 = c2l.A00 + i4;
        c2l.A00 = i10;
        return i10;
    }

    public static /* synthetic */ int A03(C2L c2l, int i4) {
        int i10 = c2l.A00 - i4;
        c2l.A00 = i10;
        return i10;
    }
    ...
    public void A0A(@CheckForNull Object key) {
        Collection<V> collection = (Collection) AbstractC1966po.A06(this.A01, key);
        if (collection != null) {
    ...
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.2L != com.google.common.collect.AbstractMapBasedMultimap<K, V> */
    @Override // com.instagram.common.viewpoint.core.AbstractC0404Bq
    public final Collection<V> A0B() {
        return new C1737ls(this);
    }

    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.2L != com.google.common.collect.AbstractMapBasedMultimap<K, V> */
    @Override // com.instagram.common.viewpoint.core.AbstractC0404Bq
    public Iterator<V> A0C() {
        return new C0408Bu(this);
    }
    ...
    public final List A0H(@ParametricNullness Object key, @CheckForNull List list, C1734lp ancestor) {
        if (list instanceof RandomAccess) {
            return new C2N(this, key, list, ancestor);
        }
        return new C0405Br(this, key, list, ancestor);
    }
    ...
    public final Map<K, Collection<V>> A0J() {
        ...
        return new C0407Bt(this, this.A01);
    }
    ...
    public final void A0L(Map<K, Collection<V>> map) {
        ...
        for (Collection<V> collection : map.values()) {
            AbstractC1666ki.A0C(!collection.isEmpty());
            this.A00 += collection.size();
        }
    }

    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.2L != com.google.common.collect.AbstractMapBasedMultimap<K, V> */
    @Override // com.instagram.common.viewpoint.core.InterfaceC1981q3
    ...
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.2L != com.google.common.collect.AbstractMapBasedMultimap<K, V> */
    @Override // com.instagram.common.viewpoint.core.AbstractC0404Bq, com.instagram.common.viewpoint.core.InterfaceC1981q3
