...
public abstract class C1F extends C7M implements View.OnTouchListener {
    ...
    public C1F(C1436gi c1436gi, AttributeSet attributeSet) {
    ...
    public C1F(C1436gi c1436gi, AttributeSet attributeSet, int i4) {
    ...
    private int A06(int i4) {
        int delta = this.A00 - i4;
    ...
    private int A07(int i4, int i10) {
        return Math.max(i4 - i10, 0);
    }

    private int A08(int i4, int i10) {
        return Math.min(i4 + i10, getItemCount() - 1);
    }

    public void A20(int i4, boolean z3) {
        if (getAdapter() == null) {
            return;
        }
        this.A05 = i4;
    ...
    public void setLayoutManager(R2 r22) {
        if (r22 instanceof C1506hr) {
            super.setLayoutManager(r22);
            this.A01 = (C1506hr) r22;
            return;
        }
        throw new IllegalArgumentException(A09(0, 50, 59));
    }

    public void setSnapDelegate(InterfaceC1271e2 interfaceC1271e2) {
        this.A02 = interfaceC1271e2;
    }
}
