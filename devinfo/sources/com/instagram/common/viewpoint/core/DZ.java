...
public final class DZ extends RelativeLayout implements InterfaceC1324eu {
    ...
    public DZ(C1436gi c1436gi, int i4) {
        this(c1436gi, A0E, -12549889, 0, i4);
    }

    public DZ(C1436gi c1436gi, int i4, int i10) {
        this(c1436gi, i10, -12549889, 0, i4);
    }

    public DZ(C1436gi c1436gi, int i4, int i10, int i11, int i12) {
        super(c1436gi);
        this.A04 = false;
        this.A01 = -1;
        this.A05 = true;
        this.A0A = new AbstractC0462Dz() { // from class: com.facebook.ads.redexgen.X.33
        ...
        this.A00 = i12;
        this.A06 = new ProgressBar(c1436gi, null, R.attr.progressBarStyleHorizontal);
        A08(i10, i11, false);
        this.A06.setMax(10000);
        addView(this.A06, new RelativeLayout.LayoutParams(-1, i4));
    }
    ...
    public final void A07(int i4) {
        ...
        this.A02 = ObjectAnimator.ofInt(progressBar, A01(0, 8, 56), duration2, i11);
        ObjectAnimator objectAnimator = this.A02;
        int duration3 = Math.min(250, i10 - i4);
    ...
    public final void A08(int i4, int i10, boolean z3) {
    ...
    public final void A09(boolean z3) {
        ...
        int i4 = duration > 0 ? (currentPositionInMillis * 10000) / duration : 0;
        int position2 = this.A01;
        if (position2 >= i4 || duration <= currentPositionInMillis) {
        ...
        if (z3) {
            ...
            this.A02 = ObjectAnimator.ofInt(progressBar2, A01(0, 8, 56), position5, i4);
            ObjectAnimator objectAnimator = this.A02;
    ...
    public final void AAv(C0473Ek c0473Ek) {
        this.A03 = c0473Ek;
        c0473Ek.getEventBus().A03(this.A08, this.A09, this.A0A, this.A07);
    }

    @Override // com.instagram.common.viewpoint.core.InterfaceC1324eu
    public final void AKV(C0473Ek c0473Ek) {
        c0473Ek.getEventBus().A04(this.A0A, this.A09, this.A08, this.A07);
        this.A03 = null;
    }
    ...
    public void setCustomDuration(int i4) {
        this.A00 = i4;
    }
