...
public final class SB implements NativeBannerAdViewApi {
    ...
    public static View A00(C1436gi c1436gi, NativeBannerAd nativeBannerAd, NativeBannerAdView.Type type, NativeAdViewAttributes nativeAdViewAttributes) {
        if (nativeAdViewAttributes == null) {
            nativeAdViewAttributes = new NativeAdViewAttributes();
        }
        UK.A0L(nativeBannerAd.getInternalNativeAd()).A1h(EnumC0901Ve.A00(type.getEnumCode()));
        ?? r12 = new C1465hB() { // from class: com.facebook.ads.redexgen.X.7L
            public InterfaceC1308ee A00;

            /* JADX WARN: Failed to parse debug info
            java.lang.ArrayIndexOutOfBoundsException
             */
            public final void A08(C1436gi c1436gi2, NativeBannerAd nativeBannerAd2, C0900Vd c0900Vd, NativeAdLayout nativeAdLayout) {
                ...
                c0900Vd.A09(adOptionsView, 20);
                UK ukA0L = UK.A0L(nativeBannerAd2.getInternalNativeAd());
                EnumC0901Ve enumC0901VeA1C = ukA0L.A1C();
                ukA0L.A1m(true);
                this.A00 = new F7(c1436gi2, nativeBannerAd2, c0900Vd, enumC0901VeA1C, mediaView, adOptionsView, ukA0L.A1F());
        ...
        NativeAdLayout nativeAdLayout = new NativeAdLayout(c1436gi, (NativeAdLayoutApi) r12);
        r12.A08(c1436gi, nativeBannerAd, (C0900Vd) nativeAdViewAttributes.getInternalAttributes(), nativeAdLayout);
    ...
    public final View render(Context context, NativeBannerAd nativeBannerAd, NativeBannerAdView.Type type, NativeAdViewAttributes nativeAdViewAttributes) {
        try {
            return A00(C0809Rp.A03(context), nativeBannerAd, type, nativeAdViewAttributes);
        } catch (Throwable th2) {
