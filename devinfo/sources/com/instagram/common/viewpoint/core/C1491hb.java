...
public final class C1491hb extends PL {
    public final PL A00 = new C1494he(this);
    public final C7M A01;

    public C1491hb(C7M c7m) {
        this.A01 = c7m;
    }
    ...
    @Override // com.instagram.common.viewpoint.core.PL
    public final boolean A09(View view, int i4, Bundle bundle) {
        if (super.A09(view, i4, bundle)) {
            return true;
        }
        if (!A0B() && this.A01.getLayoutManager() != null) {
            return this.A01.getLayoutManager().A1X(i4, bundle);
        }
        return false;
    }
