...
public final class C1830na implements InterfaceC0543Hd {
    ...
    public C0541Hb[] A0S = new C0541Hb[this.A01];
    public final C0441De<DO> A0X = new C0441De<>(new AnonymousClass49() { // from class: com.facebook.ads.redexgen.X.nb
     ...
     */
    private synchronized int A03(C02996z c02996z, C1917p0 c1917p0, boolean z3, boolean z10, DN dn) {
        c1917p0.A04 = false;
        if (!A0K()) {
            if (!z10 && !this.A0G) {
                ...
                A0H((C1996qI) AbstractC02203y.A01(this.A0D), c02996z);
                return -5;
            }
            c1917p0.A02(4);
            return -4;
        }
        C1996qI c1996qI = this.A0X.A01(A0O()).A00;
        if (z3 || c1996qI != this.A0B) {
            A0H(c1996qI, c02996z);
            return -5;
        }
        ...
        c1917p0.A02(this.A0N[iA00]);
        c1917p0.A01 = this.A0R[iA00];
        if (c1917p0.A01 < this.A09) {
            c1917p0.A00(LinearLayoutManager.INVALID_OFFSET);
        }
    ...
    java.lang.ArrayIndexOutOfBoundsException
     */
    private synchronized void A0G(long j, int i4, long j8, int i10, C0541Hb c0541Hb) {
        if (this.A02 > 0) {
            int iA00 = A00(this.A02 - 1);
            AbstractC02203y.A07(this.A0Q[iA00] + ((long) this.A0O[iA00]) <= j8);
        }
        this.A0G = (536870912 & i4) != 0;
        ...
        this.A0O[iA002] = i10;
        this.A0N[iA002] = i4;
        this.A0S[iA002] = c0541Hb;
        this.A0P[iA002] = this.A05;
        if (this.A0X.A06() || !this.A0X.A00().A00.equals(this.A0D)) {
            this.A0X.A05(A0P(), new DO((C1996qI) AbstractC02203y.A01(this.A0D), this.A0U != null ? this.A0U.AH3(this.A0T, this.A0D) : A5.A00));
        }
        this.A02++;
        if (this.A02 == this.A01) {
            ...
            C0541Hb[] c0541HbArr = new C0541Hb[i11];
            ...
            System.arraycopy(this.A0S, this.A04, c0541HbArr, 0, i12);
            ...
            System.arraycopy(this.A0S, 0, c0541HbArr, i12, i13);
    ...
    public C1830na(F0 f02, A6 a62, A1 a12) {
        this.A0U = a62;
        this.A0T = a12;
        this.A0V = new DL(f02);
    }
    ...
    */
    private int A01(int r6, int r7, long r8, boolean r10) {
        ...
        L27:
            ...
            goto L2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C1830na.A01(int, int, long, boolean):int");
    }
    ...
    */
    private int A02(long r6) {
        ...
        La:
            ...
            if (r3 != r0) goto La
            int r3 = r5.A01
            java.lang.String[] r2 = com.instagram.common.viewpoint.core.C1830na.A0Z
            r0 = 5
            r1 = r2[r0]
            r0 = 2
            r2 = r2[r0]
        ...
        L42:
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C1830na.A02(long):int");
    }
    ...
    private long A06(int i4) {
        this.A06 = Math.max(this.A06, A08(i4));
        this.A02 -= i4;
        this.A00 += i4;
        this.A04 += i4;
    ...
    */
    private long A07(int r8) {
        ...
        L71:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C1830na.A07(int):long");
    }

    private long A08(int i4) {
        if (i4 == 0) {
    ...
    private synchronized long A09(long j, boolean z3, boolean z10) {
    ...
    private final C1996qI A0A(C1996qI c1996qI) {
        if (this.A08 != 0 && c1996qI.A0M != Long.MAX_VALUE) {
            return c1996qI.A07().A0s(c1996qI.A0M + this.A08).A14();
        }
        return c1996qI;
    }

    public static C1830na A0B(F0 f02, A6 a62, A1 a12) {
        return new C1830na(f02, (A6) AbstractC02203y.A01(a62), (A1) AbstractC02203y.A01(a12));
    }
    ...
    private void A0H(C1996qI c1996qI, C02996z c02996z) {
        C1996qI c1996qIA08;
        boolean z3 = this.A0B == null;
        DrmInitData newDrmInitData = z3 ? null : this.A0B.A0O;
        this.A0B = c1996qI;
        DrmInitData oldDrmInitData = c1996qI.A0O;
        if (this.A0U != null) {
            c1996qIA08 = c1996qI.A08(this.A0U.A7W(c1996qI));
        } else {
            c1996qIA08 = c1996qI;
        }
        c02996z.A00 = c1996qIA08;
        c02996z.A01 = this.A0E;
        if (this.A0U == null) {
            return;
        }
        if (!z3) {
        ...
        InterfaceC03629s interfaceC03629s = this.A0E;
        this.A0E = this.A0U.A3C(this.A0T, c1996qI);
        c02996z.A01 = this.A0E;
        if (interfaceC03629s != null) {
            interfaceC03629s.AHc(this.A0T);
        }
    }
    ...
    private boolean A0L(int i4) {
        return this.A0E == null || this.A0E.A9A() == 4 || ((this.A0N[i4] & 1073741824) == 0 && this.A0E.AH1());
    }
    ...
    private synchronized boolean A0N(C1996qI c1996qI) {
        this.A0L = false;
        if (C5C.A1E(c1996qI, this.A0D)) {
            return false;
        }
        if (!this.A0X.A06() && this.A0X.A00().A00.equals(c1996qI)) {
    ...
    public final synchronized int A0Q(long j, boolean z3) {
        int iA00 = A00(this.A03);
        if (A0K() && j >= this.A0R[iA00]) {
            if (j > this.A07 && z3) {
                int i4 = this.A02;
                int relativeReadIndex = this.A03;
                return i4 - relativeReadIndex;
            }
            int i10 = this.A02;
            int relativeReadIndex2 = this.A03;
            int offset = A01(iA00, i10 - relativeReadIndex2, j, true);
            if (offset == -1) {
                return 0;
            }
            return offset;
    ...
    public final int A0R(C02996z c02996z, C1917p0 c1917p0, int i4, boolean z3) {
        int iA03 = A03(c02996z, c1917p0, (i4 & 2) != 0, z3, this.A0W);
        if (iA03 == -4 && !c1917p0.A05()) {
            int result = i4 & 1;
            boolean z10 = result != 0;
            int result2 = i4 & 4;
            if (result2 == 0) {
                if (z10) {
                    this.A0V.A0E(c1917p0, this.A0W);
                } else {
                    this.A0V.A0F(c1917p0, this.A0W);
                }
            }
            if (!z10) {
    ...
    public final synchronized C1996qI A0U() {
    ...
    public final void A0W() throws IOException {
        if (this.A0E == null || this.A0E.A9A() != 1) {
            ...
            throw ((C03609q) AbstractC02203y.A01(this.A0E.A80()));
        }
    }
    ...
    */
    public final synchronized void A0a(int r3) {
        ...
        Lc:
            r0 = 0
        Ld:
            com.instagram.common.viewpoint.core.AbstractC02203y.A07(r0)     // Catch: java.lang.Throwable -> L17
        ...
        L17:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C1830na.A0a(int):void");
    }
    ...
    public final void A0c(long j, boolean z3, boolean z10) {
        this.A0V.A0C(A09(j, z3, z10));
    }
    ...
    public final synchronized boolean A0f(long j, boolean z3) {
        A0F();
        int iA00 = A00(this.A03);
        if (!A0K() || j < this.A0R[iA00] || (j > this.A07 && !z3)) {
            return false;
        }
        int i4 = this.A02;
        int relativeReadIndex = this.A03;
        int offset = A01(iA00, i4 - relativeReadIndex, j, true);
        if (offset == -1) {
            return false;
        }
        this.A09 = j;
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final void AIu(long r16, int r18, int r19, int r20, com.instagram.common.viewpoint.core.C0541Hb r21) {
        /*
            r15 = this;
            r10 = r18
            r8 = r16
            ...
            java.lang.Object r0 = com.instagram.common.viewpoint.core.AbstractC02203y.A02(r0)
        ...
        L97:
            ...
            long r11 = r0.A09()
            java.lang.String[] r1 = com.instagram.common.viewpoint.core.C1830na.A0Z
            r0 = 1
            r1 = r1[r0]
            r0 = 24
            char r1 = r1.charAt(r0)
        ...
        Lad:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C1830na.AIu(long, int, int, int, com.facebook.ads.redexgen.X.Hb):void");
    }
