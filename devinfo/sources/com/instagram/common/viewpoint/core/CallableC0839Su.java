...
public class CallableC0839Su implements Callable<Boolean> {
    public static byte[] A02;
    public final C0838St A00;
    ...
    public CallableC0839Su(C0842Sx c0842Sx, C0838St c0838St) {
        this.A01 = c0842Sx;
        this.A00 = c0838St;
    }
    ...
    private final Boolean A00() throws Throwable {
        ...
        try {
            ...
            return Boolean.valueOf(C0842Sx.A03(this.A01.A04.A02()).AIg(lx) != null);
        } catch (Throwable th2) {
            WU.A00(th2, this);
            return null;
        }
