...
public class C0405Br<V> extends C2L<K, V>.WrappedCollection implements List<V> {
    ...
    public final boolean addAll(int index, Collection<? extends V> c9) {
        ...
        int size = size();
        boolean zAddAll = A06().addAll(index, c9);
        if (zAddAll) {
    ...
    public C0405Br(@ParametricNullness final C2L this$0, @CheckForNull Object key, List delegate, C1734lp ancestor) {
