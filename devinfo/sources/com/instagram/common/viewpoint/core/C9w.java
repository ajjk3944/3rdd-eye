...
public final class C9w implements InterfaceC1852nw {
     ...
     */
    public static C0398Bk A01(Cursor cursor) {
        byte[] blob = cursor.getBlob(14);
        C8 c8A02 = new C8((String) AbstractC02203y.A01(cursor.getString(0)), Uri.parse((String) AbstractC02203y.A01(cursor.getString(2)))).A01(cursor.getString(1)).A02(A09(cursor.getString(3)));
        if (blob.length <= 0) {
            blob = null;
        }
        ...
        return new C0398Bk(downloadRequestA05, i4, cursor.getLong(7), cursor.getLong(8), cursor.getLong(9), cursor.getInt(10), i4 == 4 ? cursor.getInt(11) : 0, c62);
    }
    ...
    java.lang.ArrayIndexOutOfBoundsException: Index 15 out of bounds for length 15
    	...
    	at jadx.core.dex.visitors.debuginfo.DebugInfoAttachVisitor.visit(DebugInfoAttachVisitor.java:38)
     */
    public static C0398Bk A02(Cursor cursor) {
        DownloadRequest downloadRequestA05 = new C8((String) AbstractC02203y.A01(cursor.getString(0)), Uri.parse((String) AbstractC02203y.A01(cursor.getString(2)))).A01(A05(cursor.getString(1))).A02(A09(cursor.getString(3))).A00(cursor.getString(4)).A03(cursor.getBlob(5)).A05();
        C6 c62 = new C6();
        c62.A01 = cursor.getLong(13);
        c62.A00 = cursor.getFloat(12);
        int i4 = cursor.getInt(6);
    ...
    public static String A06(List<StreamKey> streamKeys) {
        ...
        for (int i4 = 0; i4 < streamKeys.size(); i4++) {
            StreamKey streamKey = streamKeys.get(i4);
    ...
    private List<C0398Bk> A08(SQLiteDatabase sQLiteDatabase) {
    ...
    public static List<StreamKey> A09(String str) {
        ...
        for (String str2 : C5C.A1O(str, A04(TTAdConstant.IMAGE_URL_CODE, 1, 1))) {
            ...
            AbstractC02203y.A08(strArrA1O.length == 3);
            ...
            try {
                ...
                if (iA00 != 3) {
                    ...
                    try {
                        ...
                        List<C0398Bk> listA08 = iA00 == 2 ? A08(writableDatabase) : new ArrayList<>();
                        ...
                        Iterator<C0398Bk> it = listA08.iterator();
                        while (it.hasNext()) {
    ...
    private void A0C(C0398Bk c0398Bk, SQLiteDatabase sQLiteDatabase) throws SQLException {
        byte[] bArr = c0398Bk.A07.A06 == null ? C5C.A07 : c0398Bk.A07.A06;
        ContentValues contentValues = new ContentValues();
        contentValues.put(A04(607, 2, 119), c0398Bk.A07.A02);
        contentValues.put(A04(625, 9, 108), c0398Bk.A07.A03);
        contentValues.put(A04(739, 3, 12), c0398Bk.A07.A00.toString());
        contentValues.put(A04(709, 11, 1), A06(c0398Bk.A07.A04));
        contentValues.put(A04(566, 16, 36), c0398Bk.A07.A01);
        contentValues.put(A04(586, 4, 41), c0398Bk.A07.A05);
        contentValues.put(A04(684, 5, 42), Integer.valueOf(c0398Bk.A02));
        contentValues.put(A04(654, 13, 81), Long.valueOf(c0398Bk.A05));
        contentValues.put(A04(725, 14, 8), Long.valueOf(c0398Bk.A06));
        contentValues.put(A04(552, 14, 17), Long.valueOf(c0398Bk.A04));
        contentValues.put(A04(698, 11, 116), Integer.valueOf(c0398Bk.A03));
        contentValues.put(A04(590, 14, 52), Integer.valueOf(c0398Bk.A01));
        contentValues.put(A04(634, 18, 59), Float.valueOf(c0398Bk.A00()));
        contentValues.put(A04(536, 16, 16), Long.valueOf(c0398Bk.A01()));
        contentValues.put(A04(615, 10, 25), bArr);
        sQLiteDatabase.replaceOrThrow(this.A04, null, contentValues);
    }

    @Override // com.instagram.common.viewpoint.core.InterfaceC0411Bx
    public final C0398Bk A7q(String str) throws C5N {
        A0A();
        try {
            ...
            try {
                ...
                C0398Bk c0398BkA01 = A01(cursorA00);
                if (cursorA00 != null) {
                    cursorA00.close();
                }
                return c0398BkA01;
    ...
    @Override // com.instagram.common.viewpoint.core.InterfaceC0411Bx
    public final C1859o4 A7r(int... iArr) throws C5N {
        A0A();
        return new C1859o4(A00(A07(iArr), null));
    }

    @Override // com.instagram.common.viewpoint.core.InterfaceC1852nw
    public final void AHF(C0398Bk c0398Bk) throws C5N, SQLException {
        A0A();
        try {
            SQLiteDatabase writableDatabase = this.A01.getWritableDatabase();
            A0C(c0398Bk, writableDatabase);
        } catch (SQLiteException e2) {
            throw new C5N(e2);
        }
    }
    ...
    @Override // com.instagram.common.viewpoint.core.InterfaceC1852nw
    public final void AJq(int i4) throws C5N {
        A0A();
        try {
            ContentValues contentValues = new ContentValues();
            contentValues.put(A04(698, 11, 116), Integer.valueOf(i4));
    ...
    @Override // com.instagram.common.viewpoint.core.InterfaceC1852nw
    public final void AJr(String str, int i4) throws C5N {
        A0A();
        try {
            ContentValues contentValues = new ContentValues();
            contentValues.put(A04(698, 11, 116), Integer.valueOf(i4));
