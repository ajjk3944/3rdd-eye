...
public abstract class YL {
    ...
    public static Bitmap A00(C1436gi c1436gi, Bitmap bitmap, int i4) throws RSRuntimeException {
        ...
        try {
            renderScriptCreate = RenderScript.create(c1436gi);
    ...
    public static Bitmap A01(C1436gi c1436gi, Bitmap bitmap, int i4, int i10) {
        ...
        if (width != 0 && height != 0) {
            ...
            try {
                bitmapCreateBitmap = A00(c1436gi, bitmapCreateBitmap, i4);
                if (i10 != 1) {
                ...
                return new Q5().A02(bitmapCreateBitmap, i4);
            }
        }
        return null;
    }
