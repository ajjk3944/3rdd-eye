...
public abstract class AbstractC1879oO<E> extends AbstractCollection<E> implements Serializable {
    ...
    public final <T> T[] toArray(T[] tArr) {
        AbstractC1666ki.A04(tArr);
        int size = size();
        if (tArr.length < size) {
            Object[] objArrA0L = A0L();
            if (objArrA0L != null) {
                return (T[]) AbstractC1999qN.A02(objArrA0L, A0H(), A0G(), tArr);
            }
            tArr = (T[]) AbstractC1994qG.A05(tArr, size);
