...
public final class F2 extends FrameLayout implements InterfaceC1308ee {
    public TextView A00;
    public TextView A01;
    public TextView A02;
    public TextView A03;
    ...
    public F2(C1436gi c1436gi, NativeAd nativeAd, C0900Vd c0900Vd, EnumC0901Ve enumC0901Ve, C1130bk c1130bk, MediaView mediaView, AdOptionsView adOptionsView) {
        super(c1436gi);
        this.A07 = new ArrayList<>();
        this.A05 = nativeAd;
        this.A04 = mediaView;
        this.A06 = new C1309ef(c1436gi, this.A05, c0900Vd, c1130bk, adOptionsView);
        this.A06.setPadding(A0C, A0C, A0C, A0E);
        addView(this.A06, new FrameLayout.LayoutParams(-1, -2));
        if (enumC0901Ve == EnumC0901Ve.A09 || enumC0901Ve == EnumC0901Ve.A0B) {
            A07(c0900Vd);
        }
        addView(this.A04, new FrameLayout.LayoutParams(-1, -2));
        if (enumC0901Ve != EnumC0901Ve.A0B || this.A05.getAdCreativeType() != NativeAd.AdCreativeType.CAROUSEL) {
            A06(c0900Vd);
            A04(c0900Vd);
            A05(c0900Vd);
        }
        this.A07.add(c1130bk);
    ...
    */
    private int A00() {
        ...
        L25:
            ...
            java.lang.String[] r1 = com.instagram.common.viewpoint.core.F2.A08
            r0 = 0
            r1 = r1[r0]
            r0 = 24
        ...
        L4c:
            ...
            goto L59
        L4e:
            java.lang.String[] r2 = com.instagram.common.viewpoint.core.F2.A08
        ...
        L59:
            ...
            int r1 = com.instagram.common.viewpoint.core.F2.A0C
            int r3 = r3 + r1
            int r1 = com.instagram.common.viewpoint.core.F2.A0D
            int r3 = r3 + r1
        L71:
            ...
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.F2.A00():int");
    }
    ...
    private void A02(int i4) {
        YB.A0O(this.A04, i4 > A0B ? 0 : 8);
        YB.A0O(this.A03, i4 > A0A ? 0 : 8);
        YB.A0O(this.A00, i4 <= A09 ? 8 : 0);
    }

    public static void A03(int i4, int i10, TextView... textViewArr) {
        for (TextView textView : textViewArr) {
            if (textView != null && textView.getVisibility() == 0) {
                int iA04 = YB.A04(textView, i10);
                textView.setLines(iA04 + 1);
                textView.measure(i4, View.MeasureSpec.makeMeasureSpec(textView.getMeasuredHeight() + (textView.getLineHeight() * iA04), 1073741824));
                i10 -= textView.getLineHeight() * iA04;
            }
        }
    }

    private void A04(C0900Vd c0900Vd) {
        if (this.A05.getAdBodyText() != null && !this.A05.getAdBodyText().trim().isEmpty()) {
            this.A00 = new TextView(getContext());
            c0900Vd.A06(this.A00);
    ...
    public final void onLayout(boolean z3, int i4, int i10, int i11, int i12) {
        C1309ef c1309ef = this.A06;
        int top = this.A06.getMeasuredHeight();
        c1309ef.layout(i4, i10, i11, top + i10);
        ...
        if (this.A00 != null) {
            ...
            if (top8 == 0) {
                ...
                textView2.layout(i4, i14, i11, top9 + i14);
            }
        }
        if (this.A01 != null) {
    ...
    public final void onMeasure(int i4, int i10) {
        ...
        if (emptySpace == 0) {
            ...
            if (emptySpace2 == 0 || ((C1466hC) this.A04.getMediaViewApi()).A0b()) {
                iMin = iA00;
            } else {
        ...
        mediaView.measure(i4, emptySpace6);
        if (iMin < iA00) {
            A03(i4, iA00 - iMin, this.A02, this.A00, this.A03);
        }
    }
