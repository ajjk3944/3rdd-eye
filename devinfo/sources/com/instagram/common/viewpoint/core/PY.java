...
public class PY extends R7 {
    ...
    public final void A0L(C7M c7m, int i4) {
        int iA25;
        InterfaceC0984Yo interfaceC0984Yo;
        super.A0L(c7m, i4);
        C1506hr linearLayoutManager = this.A00.getLayoutManager();
        if (linearLayoutManager != null && (iA25 = linearLayoutManager.A25()) >= 0) {
            ...
            if (c1j.getAdapter() == null || iA25 >= this.A00.getAdapter().A0B() || (interfaceC0984Yo = (InterfaceC0984Yo) c7m.A1F(iA25)) == null) {
                return;
            }
            interfaceC0984Yo.AJF();
        }
    }
}
