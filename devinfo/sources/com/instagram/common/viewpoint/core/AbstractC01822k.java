...
public abstract class AbstractC01822k {
    ...
    public static int A00(Uri uri) {
        ...
        if (!lastPathSegment.endsWith(filename)) {
            ...
            if (!lastPathSegment.endsWith(filename2)) {
                ...
                String filename8 = A03(38, 4, AppLovinMediationAdapter.ERROR_CHILD_USER);
                                            ...
                                            if (!lastPathSegment.endsWith(filename16)) {
                                                ...
                                                if (!lastPathSegment.endsWith(filename17)) {
                                                    ...
                                                    if (!lastPathSegment.endsWith(filename18)) {
                                                        ...
                                                        String filename20 = A03(AppLovinMediationAdapter.ERROR_MISSING_AD_UNIT_ID, 5, 95);
                                                        ...
                                                        String filename24 = A03(42, 5, AppLovinMediationAdapter.ERROR_CHILD_USER);
    ...
    */
    public static int A01(java.lang.String r24) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.AbstractC01822k.A01(java.lang.String):int");
    }
