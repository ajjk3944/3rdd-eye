...
public final class ViewOnAttachStateChangeListenerC0948Xe extends AbstractC2043rL implements View.OnAttachStateChangeListener {
    ...
    public ViewOnAttachStateChangeListenerC0948Xe(View view, C1432ge c1432ge) {
        this.A00 = view;
        this.A01 = c1432ge;
        ...
        if (A05()) {
            try {
                ...
                this.A01.A08().ABC(A00(137, 14, 83), 3600, new C0849Te(A00(0, 45, 1) + th2.getMessage()));
            }
        }
    }
    ...
    public final void A04() {
        try {
            ...
            this.A01.A08().ABC(A00(137, 14, 83), 3600, new C0849Te(A00(45, 48, 117) + th2.getMessage()));
        }
    }
    ...
    public final void onViewDetachedFromWindow(View view) {
        try {
            ...
            this.A01.A08().ABC(A00(137, 14, 83), 3600, new C0849Te(A00(93, 44, 25) + th2.getMessage()));
        }
    }
}
