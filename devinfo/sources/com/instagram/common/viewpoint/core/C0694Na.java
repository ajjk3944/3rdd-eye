...
public final class C0694Na implements Serializable {
    ...
    public C0694Na(int i4, int i10, int i11, int i12, int i13, int i14, int i15, int i16, int i17, int i18) {
        this.A00 = i4;
        this.A01 = i10;
        this.A02 = i11;
        this.A03 = i12;
    ...
    public static int A00(JSONObject jSONObject, String str, int i4) {
    ...
    public static C0694Na A01(JSONObject jSONObject) {
        return new C0694Na(A00(jSONObject, A02(37, 12, 27), A0B), A00(jSONObject, A02(57, 10, AppLovinMediationAdapter.ERROR_CHILD_USER), A0C), A00(jSONObject, A02(152, 14, 101), -16777216), A00(jSONObject, A02(49, 8, 114), A0D), A00(jSONObject, A02(67, 9, 116), A0E), A00(jSONObject, A02(76, 20, FacebookMediationAdapter.ERROR_REQUIRES_ACTIVITY_CONTEXT), -1), A00(jSONObject, A02(AppLovinMediationAdapter.ERROR_MISSING_AD_UNIT_ID, 14, 73), -1), A00(jSONObject, A02(127, 25, 121), A0G), A00(jSONObject, A02(166, 11, AppLovinMediationAdapter.ERROR_MISSING_AD_UNIT_ID), -16777216), A00(jSONObject, A02(96, 17, 106), A0E));
    }
