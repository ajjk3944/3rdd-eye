...
public class Pv extends ViewGroup {
    ...
    public static final C0764Pu A0w;
    public static final Comparator<C0757Pn> A0x;
    public int A00;
    public PS A01;
    public float A02;
    public float A03;
    ...
    public final C0757Pn A0p;
    public final Runnable A0q;
    public final ArrayList<C0757Pn> A0r;
    ...
    private C0757Pn A03() {
        ...
        float f12 = 0.0f;
        boolean z3 = true;
        C0757Pn c0757Pn = null;
        int i10 = 0;
        while (i10 < this.A0r.size()) {
            C0757Pn c0757Pn2 = this.A0r.get(i10);
            if (!z3 && c0757Pn2.A02 != i4 + 1) {
                c0757Pn2 = this.A0p;
                c0757Pn2.A00 = f11 + f12 + f10;
                c0757Pn2.A02 = i4 + 1;
                c0757Pn2.A01 = this.A01.A00(c0757Pn2.A02);
                i10--;
            }
            f11 = c0757Pn2.A00;
            float f13 = c0757Pn2.A01 + f11;
            String[] strArr = A0t;
            ...
            if (scrollX < f14 || i10 == this.A0r.size() - 1) {
                return c0757Pn2;
            }
            z3 = false;
            i4 = c0757Pn2.A02;
    ...
    public static String A08(int i4, int i10, int i11) {
        byte[] bArrCopyOfRange = Arrays.copyOfRange(A0s, i4, i4 + i10);
     ...
     */
    private final void A0J(int i4, int i10, int i11) throws Resources.NotFoundException {
        int scrollX;
        if (getChildCount() == 0) {
        ...
        float fA00 = i14 + (i14 * A00(Math.min(1.0f, (Math.abs(i12) * 1.0f) / clientWidth)));
        int iAbs = Math.abs(i11);
        int iMin = Math.min(iAbs > 0 ? Math.round(Math.abs(fA00 / iAbs) * 1000.0f) * 4 : (int) ((1.0f + (Math.abs(i12) / (this.A0M + (clientWidth * this.A01.A00(this.A00))))) * 100.0f), 600);
        this.A0j = false;
        this.A0X.startScroll(scrollX, scrollY, i12, i13, iMin);
        Ph.A07(this);
    }
    ...
    public final void addTouchables(ArrayList<View> arrayList) {
        ...
        for (int i4 = 0; i4 < getChildCount(); i4++) {
            ...
            if (childAt.getVisibility() == 0 && (c0757PnA07 = A07(childAt)) != null && c0757PnA07.A02 == this.A00) {
    ...
    */
    public void onMeasure(int r16, int r17) throws android.content.res.Resources.NotFoundException {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.Pv.onMeasure(int, int):void");
    }
    ...
    */
    public final boolean onTouchEvent(android.view.MotionEvent r10) throws android.content.res.Resources.NotFoundException {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.Pv.onTouchEvent(android.view.MotionEvent):boolean");
    }
    ...
    public Pv(Context context) {
        ...
        this.A0g = true;
        this.A0l = false;
        this.A0q = new RunnableC0756Pl(this);
        this.A0P = 0;
        A0D();
    }
    ...
    private int A01(int i4, float f10, int i10, int i11) {
        if (Math.abs(i11) > this.A0H && Math.abs(i10) > this.A0K) {
            ...
            float truncator = i4 >= targetPage ? 0.4f : 0.6f;
            i4 = ((int) (f10 + truncator)) + i4;
        }
        int targetPage2 = this.A0r.size();
        if (targetPage2 > 0) {
            C0757Pn lastItem = this.A0r.get(0);
            ArrayList<C0757Pn> arrayList = this.A0r;
            int targetPage3 = this.A0r.size();
            C0757Pn c0757Pn = arrayList.get(targetPage3 - 1);
            int i12 = lastItem.A02;
            int targetPage4 = c0757Pn.A02;
            return Math.max(i12, Math.min(i4, targetPage4));
        }
        return i4;
    }
    ...
    private Rect A02(Rect rect, View view) {
        ...
        while ((parent instanceof ViewGroup) && parent != this) {
            ...
            rect.bottom = i4 + viewGroup.getBottom();
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    private final com.instagram.common.viewpoint.core.C0757Pn A04(int r7) {
        /*
            r6 = this;
            r5 = 0
        L1:
            ...
            com.facebook.ads.redexgen.X.Pn r4 = (com.instagram.common.viewpoint.core.C0757Pn) r4
            int r3 = r4.A02
            java.lang.String[] r1 = com.instagram.common.viewpoint.core.Pv.A0t
            r0 = 6
            r1 = r1[r0]
            r0 = 18
            ...
            r0 = 53
            if (r1 == r0) goto L34
            java.lang.String[] r2 = com.instagram.common.viewpoint.core.Pv.A0t
        ...
        L3a:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.Pv.A04(int):com.facebook.ads.redexgen.X.Pn");
    }

    private final C0757Pn A05(int i4, int i10) {
        C0757Pn c0757Pn = new C0757Pn();
        c0757Pn.A02 = i4;
        c0757Pn.A03 = this.A01.A04(this, i4);
        c0757Pn.A01 = this.A01.A00(i4);
        if (i10 < 0 || i10 >= this.A0r.size()) {
            this.A0r.add(c0757Pn);
        } else {
            this.A0r.add(i10, c0757Pn);
        }
        return c0757Pn;
    }

    private final C0757Pn A06(View view) {
        while (true) {
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    private final com.instagram.common.viewpoint.core.C0757Pn A07(android.view.View r5) {
        /*
            r4 = this;
            r3 = 0
        L1:
            ...
            com.facebook.ads.redexgen.X.Pn r2 = (com.instagram.common.viewpoint.core.C0757Pn) r2
        ...
        L1f:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.Pv.A07(android.view.View):com.facebook.ads.redexgen.X.Pn");
    }
    ...
    */
    private void A0A() {
        ...
        L1:
            ...
            com.facebook.ads.redexgen.X.Po r0 = (com.instagram.common.viewpoint.core.C0758Po) r0
            boolean r0 = r0.A05
            if (r0 != 0) goto L1a
            r2.removeViewAt(r1)
            int r1 = r1 + (-1)
        ...
        L1d:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.Pv.A0A():void");
    }
    ...
    private final void A0D() {
        ...
        Ph.A0B(this, new C1515i1(this));
        if (Ph.A00(this) == 0) {
            Ph.A09(this, 1);
        }
        Ph.A0C(this, new C1516i2(this));
    }

    private void A0E(int i4) {
        List<InterfaceC0760Pq> list = this.A0d;
        String[] strArr = A0t;
        if (strArr[5].charAt(3) == strArr[3].charAt(3)) {
            throw new RuntimeException();
        }
    ...
    */
    private final void A0G(int r17) throws android.content.res.Resources.NotFoundException {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.Pv.A0G(int):void");
    }

    private void A0H(int i4, float f10, int i10) {
        if (this.A0d != null) {
            int z3 = this.A0d.size();
    ...
    private final void A0I(int i4, float f10, int i10) {
        int iMax;
        if (this.A0D > 0) {
            ...
            for (int childCount = 0; childCount < i11; childCount++) {
                View childAt = getChildAt(childCount);
                C0758Po lp = (C0758Po) childAt.getLayoutParams();
                ...
                if (paddingLeft2 != 53) {
                    ...
                    if (lp.A05) {
                        ...
                        int i12 = (iMax + childLeft) - scrollX6;
                        String[] strArr = A0t;
                        String str = strArr[4];
        ...
        if (0 != 0) {
            ...
            for (int i13 = 0; i13 < childCount2; i13++) {
                ...
                if (!((C0758Po) childAt2.getLayoutParams()).A05) {
                    childAt2.getLeft();
                    getClientWidth();
    ...
    private void A0K(int i4, int i10, int i11, int i12) {
        if (i10 > 0 && !this.A0r.isEmpty()) {
        ...
        int paddingLeft2 = (int) (((i4 - getPaddingLeft()) - getPaddingRight()) * scrollOffset);
    ...
    private final void A0L(int i4, boolean z3) throws Resources.NotFoundException {
        this.A0m = false;
        A0N(i4, z3, false);
    }

    private void A0M(int i4, boolean z3, int i10, boolean z10) throws Resources.NotFoundException {
        C0757Pn c0757PnA04 = A04(i4);
        int destX = 0;
        if (c0757PnA04 != null) {
            destX = (int) (getClientWidth() * Math.max(this.A02, Math.min(c0757PnA04.A00, this.A07)));
        }
        if (z3) {
            A0J(destX, 0, i10);
            if (z10) {
    ...
    private final void A0N(int i4, boolean z3, boolean z10) throws Resources.NotFoundException {
        A0O(i4, z3, z10, 0);
    }

    private final void A0O(int i4, boolean z3, boolean z10, int i10) throws Resources.NotFoundException {
        ...
        if (i4 < 0) {
            i4 = 0;
        } else if (i4 >= this.A01.A01()) {
            i4 = this.A01.A01() - 1;
        }
        int i11 = this.A0L;
        if (i4 > this.A00 + i11 || i4 < this.A00 - i11) {
            for (int i12 = 0; i12 < this.A0r.size(); i12++) {
                this.A0r.get(i12).A04 = true;
            }
        }
        boolean z11 = this.A00 != i4;
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    private void A0Q(com.instagram.common.viewpoint.core.C0757Pn r13, int r14, com.instagram.common.viewpoint.core.C0757Pn r15) {
        /*
            Method dump skipped, instructions count: 552
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.Pv.A0Q(com.facebook.ads.redexgen.X.Pn, int, com.facebook.ads.redexgen.X.Pn):void");
    }
    ...
    private void A0R(boolean z3) {
        ...
        for (int i4 = 0; i4 < this.A0r.size(); i4++) {
            C0757Pn c0757Pn = this.A0r.get(i4);
            boolean needPopulate2 = c0757Pn.A04;
            if (needPopulate2) {
                z10 = true;
                c0757Pn.A04 = false;
            }
    ...
    private void A0S(boolean z3) {
        ...
        for (int i4 = 0; i4 < childCount; i4++) {
            ...
            getChildAt(i4).setLayerType(layerType, null);
        }
    }
    ...
    private boolean A0X(float f10) {
        ...
        C0757Pn c0757Pn = this.A0r.get(0);
        C0757Pn c0757Pn2 = this.A0r.get(this.A0r.size() - 1);
        if (c0757Pn.A02 != 0) {
            rightAbsolute = false;
            f12 = c0757Pn.A00 * clientWidth;
        }
        if (c0757Pn2.A02 != this.A01.A01() - 1) {
            leftAbsolute = false;
            float leftBound3 = c0757Pn2.A00;
    ...
    private boolean A0Z(int i4) {
        ...
        C0757Pn c0757PnA03 = A03();
        int currentPage = getClientWidth();
        int widthWithMargin = this.A0M + currentPage;
        int i10 = c0757PnA03.A02;
        float f10 = ((i4 / currentPage) - c0757PnA03.A00) / (c0757PnA03.A01 + (this.A0M / currentPage));
        this.A0e = false;
        A0I(i10, f10, (int) (widthWithMargin * f10));
        if (this.A0e) {
            return true;
        }
        throw new IllegalStateException(strA08);
    ...
    private final boolean A0a(int i4) throws Resources.NotFoundException {
        ...
        boolean zA0V = false;
        View nextFocused = FocusFinder.getInstance().findNextFocus(this, viewFindFocus, i4);
    ...
    private final boolean A0d(View view, boolean z3, int i4, int i10, int i11) {
        if (view instanceof ViewGroup) {
            ...
            for (int childCount = viewGroup.getChildCount() - 1; childCount >= 0; childCount--) {
                ...
                if (i10 + count >= childAt.getLeft() && i10 + count < childAt.getRight() && i11 + scrollY >= childAt.getTop() && i11 + scrollY < childAt.getBottom() && A0d(childAt, true, i4, (i10 + count) - childAt.getLeft(), (i11 + scrollY) - childAt.getTop())) {
                    return true;
                }
            }
        }
    ...
    */
    public final void A0e() throws android.content.res.Resources.NotFoundException {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.Pv.A0e():void");
    }
    ...
    public final void addFocusables(ArrayList<View> views, int i4, int i10) {
        ...
        if (descendantFocusability != 393216) {
            ...
            while (true) {
                ...
                if (focusableCount == 0 && (c0757PnA07 = A07(childAt)) != null) {
                    int descendantFocusability3 = c0757PnA07.A02;
                    int focusableCount2 = this.A00;
                    if (descendantFocusability3 == focusableCount2) {
                        childAt.addFocusables(views, i4, i10);
                    }
                }
                i11++;
            }
        ...
        int descendantFocusability4 = i10 & 1;
    ...
    public final void addView(View view, int i4, ViewGroup.LayoutParams layoutParams) {
        ...
        C0758Po c0758Po = (C0758Po) layoutParams;
        boolean z3 = c0758Po.A05;
        String[] strArr = A0t;
        if (strArr[4].charAt(21) != strArr[2].charAt(21)) {
            throw new RuntimeException();
        }
        A0t[6] = "0hKurRTmjdCHvNVYXWivI507L49T3Iz9";
        c0758Po.A05 = z3 | A0c(view);
        if (this.A0h) {
            if (c0758Po == null || !c0758Po.A05) {
                c0758Po.A03 = true;
    ...
    public final boolean canScrollHorizontally(int i4) {
        ...
        int scrollX = getScrollX();
        return i4 < 0 ? scrollX > ((int) (((float) width) * this.A02)) : i4 > 0 && scrollX < ((int) (((float) width) * this.A07));
    }

    @Override // android.view.ViewGroup
    public final boolean checkLayoutParams(ViewGroup.LayoutParams layoutParams) {
        return (layoutParams instanceof C0758Po) && super.checkLayoutParams(layoutParams);
    }
        ...
        if (accessibilityEvent.getEventType() == 4096) {
            ...
            if (A0t[0].length() == 15) {
                ...
                for (int i4 = 0; i4 < childCount; i4++) {
                    ...
                    if (childCount2 == 0) {
                        C0757Pn c0757PnA07 = A07(childAt);
                        String[] strArr3 = A0t;
                        String str = strArr3[1];
                        String str2 = strArr3[7];
                        int i10 = str.charAt(20);
    ...
    public final ViewGroup.LayoutParams generateLayoutParams(AttributeSet attributeSet) {
        return new C0758Po(getContext(), attributeSet);
    }
    ...
    public final int getChildDrawingOrder(int i4, int i10) {
        int result = this.A0F == 2 ? (i4 - 1) - i10 : i10;
        int index = ((C0758Po) this.A0b.get(result).getLayoutParams()).A01;
        return index;
    }
    ...
    public final void onDraw(Canvas canvas) {
        ...
        if (this.A0M > 0 && this.A0S != null && this.A0r.size() > 0 && this.A01 != null) {
            ...
            int firstPos = 0;
            C0757Pn c0757Pn = this.A0r.get(0);
            float marginOffset = c0757Pn.A00;
            int itemCount = this.A0r.size();
            int i4 = this.A0r.get(itemCount - 1).A02;
            for (int i10 = c0757Pn.A02; i10 < i4; i10++) {
                while (i10 > c0757Pn.A02 && firstPos < itemCount) {
                    firstPos++;
                    c0757Pn = this.A0r.get(firstPos);
                }
                if (i10 == c0757Pn.A02) {
                    f10 = (c0757Pn.A00 + c0757Pn.A01) * pos;
                    float marginOffset2 = c0757Pn.A00;
                    marginOffset = marginOffset2 + c0757Pn.A01 + f11;
                } else {
                    float fA00 = this.A01.A00(i10);
                ...
                if (this.A0M + f10 > scrollX) {
                    ...
                    drawable.setBounds(iRound, i11, width, this.A09);
    ...
    */
    public final boolean onInterceptTouchEvent(android.view.MotionEvent r18) throws android.content.res.Resources.NotFoundException {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.Pv.onInterceptTouchEvent(android.view.MotionEvent):boolean");
    }

    @Override // android.view.ViewGroup, android.view.View
    public final void onLayout(boolean z3, int i4, int i10, int i11, int i12) throws Resources.NotFoundException {
        boolean z10;
        C0757Pn c0757PnA07;
        int paddingRight;
        int count;
        ...
        while (true) {
            ...
            if (paddingTop < scrollX) {
                ...
                if (childAt.getVisibility() != 8) {
                    C0758Po c0758Po = (C0758Po) childAt.getLayoutParams();
                    if (c0758Po.A05) {
                        int count3 = c0758Po.A04 & 7;
                        int childTop2 = c0758Po.A04 & AppLovinMediationAdapter.ERROR_CHILD_USER;
                        switch (count3) {
                            case 1:
                ...
                while (paddingBottom3 < scrollX) {
                    ...
                    if (childAt2.getVisibility() != count2) {
                        C0758Po c0758Po2 = (C0758Po) childAt2.getLayoutParams();
                        if (!c0758Po2.A05 && (c0757PnA07 = A07(childAt2)) != null) {
                            int i14 = vgrav + ((int) (childLeft2 * c0757PnA07.A00));
                            if (c0758Po2.A03) {
                                c0758Po2.A03 = false;
                                int widthSpec = View.MeasureSpec.makeMeasureSpec((int) (childLeft2 * c0758Po2.A00), 1073741824);
                                childAt2.measure(widthSpec, View.MeasureSpec.makeMeasureSpec((childWidth - width) - paddingBottom, 1073741824));
                            }
                            int childTop3 = childAt2.getMeasuredWidth() + i14;
                            width = width;
                            ...
                            if (widthSpec2 != str4.charAt(20)) {
                                ...
                                childAt2.layout(i14, width, childTop3, height);
                            } else {
                                childAt2.layout(i14, width, childTop3, height);
                            }
                        }
    ...
    public final boolean onRequestFocusInDescendants(int i4, Rect rect) {
        ...
        while (i10 != childCount) {
            ...
            if (count2 == 0 && (c0757PnA07 = A07(childAt)) != null) {
                int index = c0757PnA07.A02;
                int count3 = this.A00;
                if (index == count3 && childAt.requestFocus(i4, rect)) {
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public void setAdapter(com.instagram.common.viewpoint.core.PS r7) throws android.content.res.Resources.NotFoundException {
        /*
            r6 = this;
        ...
        Lc:
            ...
            com.facebook.ads.redexgen.X.Pn r0 = (com.instagram.common.viewpoint.core.C0757Pn) r0
        ...
        Lc2:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.Pv.setAdapter(com.facebook.ads.redexgen.X.PS):void");
    }

    public void setCurrentItem(int i4) throws Resources.NotFoundException {
        this.A0m = false;
        A0N(i4, !this.A0g, false);
    }

    public void setOffscreenPageLimit(int i4) throws Resources.NotFoundException {
        if (i4 < 1) {
            Log.w(A08(300, 9, 73), A08(127, 31, 122) + i4 + A08(51, 26, 45) + 1);
            i4 = 1;
        }
        if (i4 != this.A0L) {
            this.A0L = i4;
    ...
    @Deprecated
    public void setOnPageChangeListener(InterfaceC0760Pq interfaceC0760Pq) {
        this.A0Y = interfaceC0760Pq;
    }
    ...
    public void setPageMargin(int i4) {
        ...
        A0K(oldMargin, oldMargin, i4, width);
        requestLayout();
    }

    public void setPageMarginDrawable(int i4) {
        setPageMarginDrawable(AbstractC0744Oy.A00(getContext(), i4));
    }
