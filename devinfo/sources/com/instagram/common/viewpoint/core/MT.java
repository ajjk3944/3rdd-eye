...
public final class MT implements InterfaceC0978Yi {
    ...
    public MT(C1436gi c1436gi, C0798Re c0798Re) {
        this.A01 = c1436gi;
        this.A00 = c0798Re;
    }
    ...
    public final void AAu(Intent intent, Bundle bundle, C0798Re c0798Re) {
        ComponentName component = new ComponentName(AbstractC0889Us.A05(AbstractC0889Us.A02.get()), A00(39, 61, 63));
        Intent intent2 = new Intent();
        intent2.setComponent(component);
        String strA00 = A00(26, 13, 4);
        intent2.putExtra(strA00, intent.getStringExtra(strA00));
        String strA002 = A00(0, 26, WebSocketProtocol.PAYLOAD_SHORT);
        intent2.putExtra(strA002, intent.getIntExtra(strA002, -1));
        try {
            this.A01.A0F().AID();
            C0940Wu.A09(c0798Re.A05(), intent2);
    ...
    public final boolean onActivityResult(int i4, int i10, Intent intent) {
        this.A01.A0F().AHp();
        if (i10 != -1) {
            this.A01.A0F().AHo(i10);
            A02();
            return false;
        }
        C0798Re c0798Re = this.A00;
        String[] strArr = A03;
