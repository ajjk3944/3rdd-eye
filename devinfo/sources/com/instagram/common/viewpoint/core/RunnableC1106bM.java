...
public class RunnableC1106bM implements Runnable {
    ...
    public RunnableC1106bM(C6U c6u) {
        this.A00 = c6u;
    }
    ...
    public final void run() throws Throwable {
        ...
        try {
            ...
            ObjectAnimator duration = ObjectAnimator.ofFloat(((AbstractC1099bF) this.A00).A09, strA00, 1.0f, 0.0f).setDuration(100L);
            duration.addListener(new C1105bL(this));
            duration.start();
        } catch (Throwable th2) {
            WU.A00(th2, this);
        }
