...
public class C0806Rm implements AdComponentViewApi {
    ...
    public final void addView(View view, int i4, int i10) {
        if (!this.A03) {
            this.A02.addView(view, i4, i10);
        }
    }

    @Override // com.facebook.ads.internal.api.AdComponentView
    public final void addView(View view, int i4, ViewGroup.LayoutParams layoutParams) {
        this.A02.addView(view, i4, layoutParams);
    }
    ...
    public void onMeasure(int i4, int i10) {
        this.A02.onMeasure(i4, i10);
    }

    @Override // com.facebook.ads.internal.api.AdComponentViewParentApi
    public void onVisibilityChanged(View view, int i4) {
        this.A02.onVisibilityChanged(view, i4);
    }
    ...
    public final void setMeasuredDimension(int i4, int i10) {
        this.A02.setMeasuredDimension(i4, i10);
    }
}
