...
public abstract class RK {
    ...
    public final List<Object> A0R() {
        if ((this.A0C & Segment.SHARE_MINIMUM) == 0) {
    ...
    public final void A0d(boolean z3) {
        ...
        if (i11 < 0) {
            this.A0D = 0;
            Log.e(A08(143, 4, 66), A08(186, 78, AppLovinMediationAdapter.ERROR_MISSING_AD_UNIT_ID) + this);
    ...
    public final boolean A0o(int i4) {
        return (this.A0C & i4) != 0;
    }

    public final String toString() {
        String strA08;
        StringBuilder sb2 = new StringBuilder(A08(147, 11, 70) + Integer.toHexString(hashCode()) + A08(46, 10, 14) + this.A03 + A08(0, 4, 21) + this.A05 + A08(WebSocketProtocol.PAYLOAD_SHORT, 9, 58) + this.A01 + A08(135, 8, 1) + this.A04);
        if (A0h()) {
