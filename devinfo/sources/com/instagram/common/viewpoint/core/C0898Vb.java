...
public final class C0898Vb implements NativeAdImageApi {
    ...
    public static String A01(int i4, int i10, int i11) {
        ...
        while (true) {
            ...
            byte b10 = (byte) ((bArrCopyOfRange[i12] ^ i11) ^ 66);
            if (A04[7].length() != 18) {
                String[] strArr2 = A04;
                strArr2[4] = "";
                strArr2[3] = "";
    ...
    public C0898Vb(String str, int i4, int i10) {
        this.A02 = str;
        this.A01 = i4;
        this.A00 = i10;
    }

    public static C0898Vb A00(JSONObject jSONObject) {
        String strOptString;
        if (jSONObject == null || (strOptString = jSONObject.optString(A01(6, 3, 75))) == null) {
            return null;
        }
        return new C0898Vb(strOptString, jSONObject.optInt(A01(9, 5, 125), 0), jSONObject.optInt(A01(0, 6, 92), 0));
    }
