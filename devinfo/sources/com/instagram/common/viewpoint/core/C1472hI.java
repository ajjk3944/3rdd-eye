...
public class C1472hI implements InterfaceC1209d1 {
    ...
    public C1472hI(C1466hC c1466hC, UK uk2, NativeAd nativeAd) {
        this.A01 = c1466hC;
        this.A02 = uk2;
        this.A00 = nativeAd;
    }

    @Override // com.instagram.common.viewpoint.core.InterfaceC1209d1
    public final void AAn() {
    }

    @Override // com.instagram.common.viewpoint.core.InterfaceC1209d1
    public final void ADm(AnonymousClass62 anonymousClass62) {
        new Handler(Looper.getMainLooper()).postDelayed(new C1473hJ(this, anonymousClass62), 1L);
    }
