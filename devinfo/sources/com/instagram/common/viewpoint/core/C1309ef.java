...
public final class C1309ef extends LinearLayout {
    public static final int A00 = (int) (XX.A02 * 32.0f);
    public static final int A01 = (int) (XX.A02 * 8.0f);

    public C1309ef(C1436gi c1436gi, NativeAd nativeAd, C0900Vd c0900Vd, C1130bk c1130bk, AdOptionsView adOptionsView) {
        super(c1436gi);
        setOrientation(0);
        ...
        addView(c1130bk, iconViewParams);
        TextView textView = new TextView(c1436gi);
        c0900Vd.A08(textView);
        textView.setMaxLines(1);
        textView.setText(nativeAd.getAdvertiserName());
        TextView sponsoredTextView = new TextView(c1436gi);
        c0900Vd.A06(sponsoredTextView);
