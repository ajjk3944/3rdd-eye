    ...
    */
    ...
    public final Bitmap A02(Bitmap bitmap, float f10) throws InterruptedException {
        ...
        try {
            ...
            ArrayList<JavaBlurProcess.BlurTask> vertical = new ArrayList<>(i4);
            for (int i10 = 0; i10 < i4; i10++) {
                int h9 = h8;
                int cores = i10;
                arrayList.add(new YO(iArr, w10, h9, (int) f10, i4, cores, 1));
                h8 = h9;
                int cores2 = i10;
                vertical.add(new YO(iArr, w10, h8, (int) f10, i4, cores2, 2));
            }
            try {
