...
public final class C4G implements SurfaceTexture.OnFrameAvailableListener, Runnable {
    ...
    public static EGLContext A01(EGLDisplay eGLDisplay, EGLConfig eGLConfig, int i4) {
        int[] iArr;
        if (i4 != 0) {
    ...
    public static EGLSurface A03(EGLDisplay eGLDisplay, EGLConfig eGLConfig, EGLContext eGLContext, int i4) {
    ...
    public final SurfaceTexture A07() {
        return (SurfaceTexture) AbstractC02203y.A01(this.A00);
    }
    ...
    public final void A09(int i4) {
        ...
        this.A01 = A01(this.A02, eGLConfigA00, i4);
        this.A03 = A03(this.A02, eGLConfigA00, this.A01, i4);
        A06(this.A05);
