...
public abstract class AnonymousClass67 extends AbstractC0597Jg implements XQ {
    ...
    public final XS A0C;
    public final InterfaceC0977Yh A0D;
    public final C1153c7 A0E;
    public final EA A0F;
    public final E4 A0G;
    public final E2 A0H;
    public final E0 A0I;
    public final AbstractC0454Dr A0J;
    ...
    public abstract void A1X(C1436gi c1436gi);
    ...
    public AnonymousClass67(C1153c7 c1153c7, boolean z3, String str, C0512Fy c0512Fy) {
        super(c1153c7, z3);
        this.A09 = new Path();
        this.A0A = new RectF();
        this.A0J = new AbstractC0454Dr() { // from class: com.facebook.ads.redexgen.X.6C
        ...
        this.A0D = c1153c7.A0C();
        this.A0E = c1153c7;
        this.A03 = c0512Fy;
        this.A0K = str;
        this.A0B = c1153c7.A06();
        this.A0C = XS.A00(c1153c7.A06(), c1153c7.A05(), this);
        setGravity(17);
    ...
    public final void A1S() {
        if (A1V()) {
            A1T();
            C1277e8 c1277e8 = this.A04;
            EnumC1323et enumC1323et = EnumC1323et.A02;
            if (A0M[2].length() == 4) {
                throw new RuntimeException();
            }
            A0M[2] = "GrzUS";
            c1277e8.A05(enumC1323et);
        }
    }
    ...
    public void setCTAInfo(C0696Nc c0696Nc, Map<String, String> extraData) {
        getCtaButton().setCta(c0696Nc, this.A0K, extraData);
    }

    public void setImageUrl(String str) {
        this.A01.setVisibility(0);
        this.A04.setVisibility(8);
        new LM(this.A01, this.A0B).A04().A06(new C0596Jf(this)).A07(str);
    }
    ...
    public void setOnAssetsLoadedListener(InterfaceC1198cq interfaceC1198cq) {
        this.A02 = interfaceC1198cq;
    }

    public void setUpImageView(C1436gi c1436gi) {
        this.A01 = new ZI(c1436gi);
        if (C0886Up.A1J(c1436gi)) {
            AbstractC1096bC.A00(this.A01, C0886Up.A1K(c1436gi), new ViewOnClickListenerC1204cw(this));
        }
        A04(this.A01);
    }

    public void setUpMediaContainer(C1436gi c1436gi) {
        this.A00 = new RelativeLayout(c1436gi);
        A04(this.A00);
        XR xrA02 = this.A0C.A02(this.A0E.A05());
        this.A0E.A06().A0H().A00(xrA02.A01);
        getCtaButton().setCreativeAsCtaLoggingHelper(this.A0C);
        if (this.A0E.A05().A1e() && C0886Up.A2w(this.A0B)) {
            this.A00.setOnClickListener(new ViewOnClickListenerC1203cv(this));
        } else {
            if (!xrA02.A00) {
                return;
            }
    ...
    public void setUpVideoView(C1436gi c1436gi) {
        this.A04 = new C1277e8(c1436gi, new VI(this.A0K, getAdEventManager()));
        if (C0886Up.A1L(c1436gi)) {
            AbstractC1096bC.A00(this.A04, C0886Up.A1M(c1436gi), new ViewOnClickListenerC1205cx(this));
        }
        A04(this.A04);
    }
