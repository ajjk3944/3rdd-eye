...
public final class WV implements V8 {
    ...
    public WV(C1432ge c1432ge, ZH zh2) {
        this.A00 = c1432ge;
        this.A01 = zh2;
    }

    public static JSONArray A01(C1432ge c1432ge, JSONArray jSONArray, JSONArray jSONArray2) {
        int i4 = 0;
        if (jSONArray != null) {
        ...
        return A02(c1432ge, jSONArray, jSONArray2, i4);
    }
    ...
    */
    public static org.json.JSONArray A02(com.instagram.common.viewpoint.core.C1432ge r19, org.json.JSONArray r20, org.json.JSONArray r21, int r22) throws org.json.JSONException {
        /*
            Method dump skipped, instructions count: 264
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.WV.A02(com.facebook.ads.redexgen.X.ge, org.json.JSONArray, org.json.JSONArray, int):org.json.JSONArray");
    }
    ...
    */
    private org.json.JSONObject A03() throws org.json.JSONException {
        /*
            ...
            boolean r0 = com.instagram.common.viewpoint.core.AbstractC0888Ur.A0P(r0)
            if (r0 == 0) goto L46
            com.facebook.ads.redexgen.X.ge r0 = r7.A00
            org.json.JSONArray r6 = com.instagram.common.viewpoint.core.C0850Tf.A03(r0)
            if (r6 == 0) goto L46
            int r0 = r6.length()
            if (r0 <= 0) goto L46
            com.facebook.ads.redexgen.X.ge r5 = r7.A00
            java.lang.String[] r1 = com.instagram.common.viewpoint.core.WV.A03
            r0 = 2
            r0 = r1[r0]
            int r1 = r0.length()
            r0 = 5
            ...
            throw r0
        L36:
            java.lang.String[] r2 = com.instagram.common.viewpoint.core.WV.A03
        ...
        L8d:
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.WV.A03():org.json.JSONObject");
    }

    private JSONObject A04(int i4) throws JSONException {
        int iA08;
        JSONArray jSONArrayA04;
        Pair<JSONObject, JSONArray> tokensAndEvents = this.A01.A9I(i4);
        JSONObject jSONObject = (JSONObject) tokensAndEvents.first;
        JSONArray jSONArrayA02 = (JSONArray) tokensAndEvents.second;
        if (AbstractC0888Ur.A0P(this.A00) && (jSONArrayA04 = C0850Tf.A04(this.A00, (iA08 = AbstractC0888Ur.A08(this.A00)))) != null && jSONArrayA04.length() > 0) {
            jSONArrayA02 = A02(this.A00, jSONArrayA04, jSONArrayA02, i4 + iA08);
        }
    ...
    private void A06(String str) {
        if (C0850Tf.A0I(str)) {
            C1432ge c1432ge = this.A00;
            String[] strArr = A03;
            if (strArr[4].charAt(22) == strArr[7].charAt(22)) {
                throw new RuntimeException();
            }
            A03[2] = "U9Gor";
            C0850Tf.A0B(c1432ge, str);
            return;
        }
        this.A01.AA5(str);
    }
    ...
    public final JSONObject A5L() {
        int eventLimit = AbstractC0888Ur.A0F(this.A00);
        return eventLimit > 0 ? A04(eventLimit) : A03();
    }

    @Override // com.instagram.common.viewpoint.core.V8
    public final boolean AAb() {
        int eventCount = AbstractC0888Ur.A0F(this.A00);
        if (eventCount < 1) {
            return false;
        }
        int iA82 = this.A01.A82();
        int eventLimit = C0850Tf.A00(this.A00);
        return iA82 + eventLimit > eventCount;
    }

    @Override // com.instagram.common.viewpoint.core.V8
    public final void ACu() {
        int iA50 = this.A01.A50(AbstractC0888Ur.A0G(this.A00));
        if (iA50 > 0) {
            this.A00.A08().ABC(A00(379, 8, 37), AbstractC0848Td.A10, new C0849Te(A00(28, 44, 62) + iA50));
        }
        C0850Tf.A0F(this.A00);
    }
    ...
    public final void ADe(JSONArray jSONArray) {
        ...
        for (int i4 = 0; i4 < length; i4++) {
            try {
                A06(jSONArray.getJSONObject(i4).getString(A00(433, 2, 15)));
            } catch (JSONException e2) {
                if (this.A00.A05().AAO()) {
                    String eventId = A04;
                    Log.e(eventId, A00(108, 62, FacebookMediationAdapter.ERROR_BANNER_SIZE_MISMATCH), e2);
                }
            }
        }
    }
    ...
    */
    public final boolean ADf(org.json.JSONArray r13) throws org.json.JSONException {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.WV.ADf(org.json.JSONArray):boolean");
    }

    @Override // com.instagram.common.viewpoint.core.V8
    public final void AFZ() {
        this.A01.A51();
        C0850Tf.A07(this.A00);
    }
}
