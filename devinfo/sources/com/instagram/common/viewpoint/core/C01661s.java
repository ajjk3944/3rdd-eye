...
public class C01661s<E> extends AbstractC01651r<E>.IteratorImpl implements ListIterator<E> {
    public static byte[] A01;
    public final /* synthetic */ AbstractC01651r<E> A00;
    ...
    public C01661s(AbstractC01651r abstractC01651r, int i4) {
        super(abstractC01651r);
        this.A00 = abstractC01651r;
        AbstractC01651r.A02.A04(i4, this.A00.size());
        A05(i4);
    }
    ...
    public final E previous() {
        if (hasPrevious()) {
            AbstractC01651r<E> abstractC01651r = this.A00;
            A05(getA00() - 1);
            return abstractC01651r.get(getA00());
        }
