...
public abstract class AbstractC1283eE {
    ...
    public static BitmapDrawable A00(C1436gi c1436gi, String str) {
        try {
            ...
            if (overlayBm != null && (!A00 || A05(c1436gi, overlayBm))) {
                ...
                Resources resources = c1436gi.getResources();
                if (resources != null) {
                    DisplayMetrics displayMetrics = resources.getDisplayMetrics();
                    if (displayMetrics != null) {
                        overlayRepeat.setTargetDensity(displayMetrics.densityDpi);
                    } else {
                        A04(c1436gi, A02(0, 23, 41));
                    }
                } else {
                    A04(c1436gi, A02(23, 18, 119));
                }
                return overlayRepeat;
            }
            return null;
        } catch (Throwable th2) {
            c1436gi.A08().ABC(A02(59, 3, 58), AbstractC0848Td.A1u, new C0849Te(th2));
            return null;
        }
    }

    public static C1284eF A01(C1436gi c1436gi, String str) {
        BitmapDrawable bitmapDrawableA00;
        try {
            if (TextUtils.isEmpty(str) || (bitmapDrawableA00 = A00(c1436gi, str)) == null) {
                return null;
            }
            C1284eF c1284eF = new C1284eF(c1436gi);
            c1284eF.setBackground(bitmapDrawableA00);
            c1284eF.setClickable(false);
            c1284eF.setFocusable(false);
            return c1284eF;
        } catch (Throwable th2) {
            c1436gi.A08().ABC(A02(59, 3, 58), AbstractC0848Td.A1u, new C0849Te(th2));
            return null;
    ...
    public static void A04(C1436gi c1436gi, String str) {
        c1436gi.A08().ABC(A02(59, 3, 58), AbstractC0848Td.A1u, new C0849Te(str));
    }
    ...
    */
    public static boolean A05(com.instagram.common.viewpoint.core.C1436gi r4, android.graphics.Bitmap r5) {
        /*
            r3 = 0
        L1:
            int r0 = r5.getWidth()
        ...
        L36:
            r3 = 1
            java.lang.String[] r2 = com.instagram.common.viewpoint.core.AbstractC1283eE.A02
            r0 = 2
            r1 = r2[r0]
            r0 = 3
            r0 = r2[r0]
        ...
        L4f:
            ...
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.AbstractC1283eE.A05(com.facebook.ads.redexgen.X.gi, android.graphics.Bitmap):boolean");
    }
}
