...
public final class C0983Yn extends AdNativeComponentView {
    ...
    public C0983Yn(C1436gi c1436gi, C0900Vd c0900Vd) {
        super(c1436gi);
        this.A06 = c0900Vd;
        this.A05 = new TextView(c1436gi);
        this.A04 = new TextView(c1436gi);
        this.A03 = new TextView(c1436gi);
        this.A02 = new RelativeLayout(c1436gi);
        this.A00 = new LinearLayout(c1436gi);
        this.A01 = new RelativeLayout(c1436gi);
        this.A07 = new MR(c1436gi);
        A09();
        A0D();
        A05();
        A0A();
    ...
    */
    public final void onMeasure(int r3, int r4) {
        /*
            r2 = this;
            float r0 = com.instagram.common.viewpoint.core.XX.A02
            int r1 = (int) r0
            android.content.Context r0 = r2.getContext()
            int r0 = com.instagram.common.viewpoint.core.C0886Up.A0F(r0)
            int r1 = r1 * r0
        ...
        L22:
            ...
            goto L1e
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C0983Yn.onMeasure(int, int):void");
    }
