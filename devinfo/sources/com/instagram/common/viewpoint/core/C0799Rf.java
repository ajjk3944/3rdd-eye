...
public final class C0799Rf implements AudienceNetworkActivityApi {
    ...
    public C0799Rf(AudienceNetworkActivity audienceNetworkActivity, AudienceNetworkActivityApi audienceNetworkActivityApi, C0798Re c0798Re) {
    ...
    private void A02(Throwable th2) {
        ...
        if (logContext != null) {
            logContext.A08().ABC(A00(38, 11, 116), AbstractC0848Td.A0C, new C0849Te(th2));
            return;
        }
        Log.e(A00(0, 17, 10), A00(17, 21, FacebookMediationAdapter.ERROR_ADVIEW_CONSTRUCTOR_EXCEPTION), th2);
    }
    ...
    public final void onActivityResult(int i4, int i10, Intent intent) {
        ...
        if (this.A00) {
            this.A01.onActivityResult(i4, i10, intent);
        } else {
            this.A02.onActivityResult(i4, i10, intent);
            this.A01.onActivityResult(i4, i10, intent);
        }
    }
