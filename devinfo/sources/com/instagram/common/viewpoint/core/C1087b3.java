...
public class C1087b3 extends WebViewClient {
    ...
    public final WeakReference<C1381fp> A07;
    ...
    public static void A02() {
        byte[] bArr = {8, 38, 40, 45, 42, -14, 8, 52, 51, 57, 55, 52, 49, -69, -36, -27, -32, -36, -37, 28, 77, 56, 67, 76, 56, 75, 64, 69, 62, -9, 44, 41, 32, -9, 39, 56, 75, Utf8.REPLACEMENT_BYTE, -9, 61, 70, 73, -9, 29, 64, 67, 60, -9, 24, 58, 58, 60, 74, 74, -9, -46, 5, 1, -1, -18, -83, -15, -18, 1, -18, -57, -83, 60, 72, 72, 68, 20, 57, 102, 102, 99, 102, 59, 84, 89, 71, 76, 75, 6, 56, 75, 87, 91, 75, 89, 90, 6, 76, 85, 88, 6, 44, 79, 82, 75, 6, 39, 73, 73, 75, 89, 89, 6, 34, 59, 64, 46, 51, 50, -19, 31, 50, 62, 66, 50, 64, 65, -19, 51, 60, Utf8.REPLACEMENT_BYTE, -19, 19, 54, 57, 50, -19, 14, 48, 48, 50, 64, 64, -19, 49, 50, 59, 54, 50, 49, 67, 68, 77, 72, 68, 67, 62, 84, 81, 72, 62, 79, 64, 83, 71, 64, 59, 80, 67, 61, 73, 72, 8, 67, 61, 73, 41, 44, 47, 40, 23, 14, 29, -29, -29, -18, -5, -5, 8, -18, -10, -7, -3, 2, 8, -5, -18, -4, -7, -8, -9, -4, -18, 27, 28, -38, 32, 33, 28, 31, 18, 98, 85, 97, 101, 85, 99, 100, 79, 89, 84, 78, Utf8.REPLACEMENT_BYTE, 82, 78, 9, 74, 70, 59, 67, 72, 5, -16, -5, -8, -13, -18, -1, -16, 3, -9, 55, 37, 34, 31, 54, 41, 37, 55};
        String[] strArr = A0C;
    ...
    public C1087b3(C1436gi c1436gi, WeakReference<InterfaceC1085b1> weakReference, WeakReference<C1381fp> weakReference2, WeakReference<Y2> weakReference3, WeakReference<AtomicBoolean> checkAssetsByJavascriptBridge, WeakReference<LV> weakReference4, AtomicInteger atomicInteger, AtomicReference<String> requestId, boolean z3) {
        this.A02 = c1436gi;
    ...
    private WebResourceResponse A00() {
        return new WebResourceResponse(A01(216, 10, 100), StandardCharsets.UTF_8.name(), TTAdConstant.DEEPLINK_UNAVAILABLE_CODE, A01(13, 6, 1), Collections.singletonMap(A01(0, 13, 79), A01(198, 8, 55)), new ByteArrayInputStream(A01(13, 6, 1).getBytes()));
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void A03(int i4, String str) {
        if (A01(175, 23, 51).equals(str)) {
            this.A02.A0F().AKx();
            return;
        }
        this.A02.A0F().AKy(i4, str);
        if (this.A04.get() != null) {
            this.A04.get().ADu(i4, str);
        }
    }
    ...
    private final void A04(WebResourceRequest webResourceRequest, WebResourceResponse webResourceResponse) throws JSONException {
        ...
        this.A02.A0F().AL2(webResourceResponse.getStatusCode(), AbstractC0945Xb.A01(webResourceResponse.getStatusCode(), A01(67, 10, WebSocketProtocol.PAYLOAD_SHORT), A01(0, 0, 53) + webResourceRequest.getUrl()));
    }
    ...
    private void A06(String str, String str2) throws JSONException {
        ...
        if (this.A02 != null) {
            this.A02.A08().ABC(A01(236, 8, 74), AbstractC0848Td.A2c, new C0849Te(AdErrorType.WEB_VIEW_CACHE_FILE_WAS_DENIED.getDefaultErrorMessage(), A01(55, 12, 23) + jSONObject.toString()));
        }
    }
    ...
    */
    private boolean A07(android.net.Uri r8) throws org.json.JSONException {
        /*
            ...
            java.lang.String[] r2 = com.instagram.common.viewpoint.core.C1087b3.A0C
            r0 = 3
            r1 = r2[r0]
            r0 = 6
            r0 = r2[r0]
        ...
        L6c:
            ...
            java.util.List r5 = com.instagram.common.viewpoint.core.C0842Sx.A09(r0)
            ...
            r0.toString()
        L98:
            java.lang.String r4 = com.instagram.common.viewpoint.core.LV.A01()
        ...
        Lbb:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C1087b3.A07(android.net.Uri):boolean");
    }
    ...
    public final void onReceivedError(WebView webView, WebResourceRequest webResourceRequest, WebResourceError webResourceError) throws JSONException {
        boolean zA12 = C0886Up.A12(this.A02);
        ...
        if (zA12 || webResourceRequest.isForMainFrame()) {
            ...
            this.A02.A0F().AL1(AbstractC0945Xb.A01(webResourceError.getErrorCode(), strA01 + ((Object) webResourceError.getDescription()), strA01 + webResourceRequest.getUrl()));
        }
    }
    ...
    public final boolean onRenderProcessGone(WebView webView, RenderProcessGoneDetail renderProcessGoneDetail) {
        AbstractC1082ay.A0D(AbstractC0848Td.A2b);
        InterfaceC1085b1 adWebViewListener = this.A04.get();
    ...
    public final boolean shouldOverrideUrlLoading(WebView webView, String str) {
        if (this.A04.get() != null) {
            this.A04.get().ADN(str, new C1093b9().A03(this.A07.get()).A02(this.A06.get()).A05());
        }
