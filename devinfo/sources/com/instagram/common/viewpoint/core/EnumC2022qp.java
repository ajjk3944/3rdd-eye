...
public enum EnumC2022qp {
    ...
    public static EnumC2022qp[] valuesCustom() {
        EnumC2022qp[] enumC2022qpArrValuesCustom = values();
        if (A01[4].length() == 0) {
            throw new RuntimeException();
        }
        A01[5] = "kC8OQjnUJR";
        return (EnumC2022qp[]) enumC2022qpArrValuesCustom.clone();
    }
}
