...
public final class C1644kL extends MZ {
  ...
  0x00aa: PHI (r8v2 long) = (r8v0 long), (r8v3 long) binds: [B:30:0x00d7, B:25:0x00a8] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    public static com.instagram.common.viewpoint.core.C1644kL A01(java.io.File r14, long r15, long r17, com.instagram.common.viewpoint.core.C0677Mi r19) throws java.lang.NumberFormatException {
        /*
            r12 = r17
            r10 = r15
        ...
        L1f:
            java.lang.String r3 = r14.getName()
        L23:
            java.util.regex.Pattern r0 = com.instagram.common.viewpoint.core.C1644kL.A04
        ...
        L50:
            r4 = 0
            java.lang.String[] r2 = com.instagram.common.viewpoint.core.C1644kL.A01
            r0 = 0
            r1 = r2[r0]
            r0 = 2
            r2 = r2[r0]
        ...
        L77:
            ...
            java.lang.String[] r1 = com.instagram.common.viewpoint.core.C1644kL.A01
            r0 = 7
            r1 = r1[r0]
            r0 = 17
            char r1 = r1.charAt(r0)
            ...
            r0 = 3
            r2[r0] = r1
            java.lang.Object r0 = com.instagram.common.viewpoint.core.AbstractC02203y.A01(r4)
            java.lang.String r0 = (java.lang.String) r0
        ...
        Lda:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C1644kL.A01(java.io.File, long, long, com.facebook.ads.redexgen.X.Mi):com.facebook.ads.redexgen.X.kL");
    }
    ...
    public C1644kL(String str, long j, long j8, long j9, File file) {
        super(str, j, j8, j9, file);
    }

    public static C1644kL A02(File file, long j, C0677Mi c0677Mi) {
        return A01(file, j, -9223372036854775807L, c0677Mi);
    }

    public static C1644kL A03(String str, long j) {
        return new C1644kL(str, j, -1L, -9223372036854775807L, null);
    }

    public static C1644kL A04(String str, long j, long j8) {
        return new C1644kL(str, j, j8, -9223372036854775807L, null);
    }

    public static File A05(File file, int i4, long j, long j8) {
        StringBuilder sbAppend = new StringBuilder().append(i4);
        String strA07 = A07(0, 1, 16);
        return new File(file, sbAppend.append(strA07).append(j).append(strA07).append(j8).append(A07(1, 7, 86)).toString());
    }

    public static File A06(File file, C0677Mi c0677Mi) throws NumberFormatException {
        String strA0l = null;
        String name = file.getName();
        Matcher matcher = A03.matcher(name);
        if (matcher.matches()) {
            String key = matcher.group(1);
            strA0l = C5C.A0l((String) AbstractC02203y.A01(key));
        } else {
            matcher = A02.matcher(name);
            if (matcher.matches()) {
                String key2 = matcher.group(1);
                Object objA01 = AbstractC02203y.A01(key2);
                String[] strArr = A01;
        ...
        File file2 = (File) AbstractC02203y.A02(file.getParentFile());
        int iA0B = c0677Mi.A0B(strA0l);
        String key3 = matcher.group(2);
        long j = Long.parseLong((String) AbstractC02203y.A01(key3));
        String key4 = matcher.group(3);
        File fileA05 = A05(file2, iA0B, j, Long.parseLong((String) AbstractC02203y.A01(key4)));
    ...
    public final C1644kL A09(File file, long j) {
        AbstractC02203y.A08(this.A05);
        return new C1644kL(this.A04, this.A02, this.A01, j, file);
    }
}
