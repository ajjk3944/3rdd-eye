...
public final class C1697lE implements LH {
    ...
    public boolean A08;
    public boolean A09;
    public final InterfaceC0638Kv A0B;
    public final C02424u A0A = new C02424u(new byte[10]);
    public int A03 = 0;
    ...
    public C1697lE(InterfaceC0638Kv interfaceC0638Kv) {
        this.A0B = interfaceC0638Kv;
    }
    ...
    private boolean A04() {
        ...
        if (iA04 != 1) {
            AbstractC02284g.A07(strA00, A00(56, 30, 46) + iA04);
            this.A02 = -1;
            return false;
        }
        this.A0A.A09(8);
        ...
        if (iA042 == 0) {
            ...
            if (startCodePrefix4 < 0) {
                ...
                AbstractC02284g.A07(strA00, sbAppend.append(startCodePrefix5).toString());
                this.A02 = -1;
            }
        }
        return true;
    ...
    private boolean A05(C02434v c02434v, byte[] bArr, int i4) {
    ...
    public final void A5B(C02434v c02434v, int i4) throws C3K {
        ...
        if ((i4 & 1) != 0) {
            ...
            switch (i10) {
                ...
                case 1:
                    ...
                    break;
                case 2:
                    AbstractC02284g.A07(strA00, A00(86, 50, 64));
                    A03(1);
                    break;
                case 3:
                    if (this.A02 != -1) {
                        AbstractC02284g.A07(strA00, A00(136, 37, 57) + this.A02 + A00(0, 11, 83));
                    }
                    this.A0B.AGp();
                    A03(1);
                    break;
        ...
        while (c02434v.A07() > 0) {
            switch (this.A03) {
                case 0:
                    c02434v.A0g(c02434v.A07());
                case 1:
                    if (A05(c02434v, this.A0A.A00, 9)) {
                        boolean zA04 = A04();
                        if (A0D[5].length() == 12) {
                            break;
                        } else {
                ...
                case 2:
                    ...
                    if (A0D[1].length() != 20) {
                        A0D[4] = "l8YJPAfB3X";
                        if (A05(c02434v, bArr, iMin) && A05(c02434v, null, this.A01)) {
                            A01();
                            i4 |= this.A06 ? 4 : 0;
                            this.A0B.AGq(this.A04, i4);
                            A03(3);
                        }
                    } else {
