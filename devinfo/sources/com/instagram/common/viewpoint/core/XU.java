...
public abstract class XU {
    ...
    public static XT A00(T8 t82) {
        try {
            ...
            t82.A08().ABC(A01(40, 7, 92), AbstractC0848Td.A1M, new C0849Te(t10));
            return XT.A04;
        }
    }
    ...
    public static String A02(Context context, String str) throws PackageManager.NameNotFoundException, NoSuchAlgorithmException, CertificateException {
        ...
        for (Signature signature : signatureArr) {
            sb2.append(C0944Xa.A04(MessageDigest.getInstance(A01(31, 4, 124)).digest(A04(signature).getEncoded())));
    ...
    public static String A03(T8 t82, String str) {
        try {
            ...
            t82.A08().ABC(A01(40, 7, 92), AbstractC0848Td.A1M, new C0849Te(e2));
            return null;
        }
    }
    ...
    public static boolean A08(String str) {
        for (String str2 : System.getenv(A01(27, 4, AppLovinMediationAdapter.ERROR_MISSING_AD_UNIT_ID)).split(A01(25, 1, 37))) {
