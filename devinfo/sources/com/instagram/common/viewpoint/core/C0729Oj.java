...
public final class C0729Oj {
    ...
    public final void A07(int i4) {
        this.A01.add(String.valueOf(i4));
    }

    public final void A08(EnumC0728Oi enumC0728Oi) {
        this.A02.add(enumC0728Oi.A03() + A00(1, 4, 26));
        if (this.A00 != null) {
            this.A00.A04(VH.A09, null);
        }
    }

    public final void A09(EnumC0728Oi enumC0728Oi, int i4) {
        this.A02.add(enumC0728Oi.A03() + A00(0, 1, 18) + i4);
    }
