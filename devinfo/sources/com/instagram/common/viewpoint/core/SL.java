...
public class SL {
    ...
    public static SL A00(JSONObject jSONObject) throws JSONException {
        return new SL(jSONObject.getString(A01(30, 3, 49)), jSONObject.getString(A01(26, 4, 87)), jSONObject.optString(A01(5, 9, 106)), jSONObject.getString(A01(14, 8, 37)).equals(A01(22, 4, FacebookMediationAdapter.ERROR_CREATE_NATIVE_AD_FROM_BID_PAYLOAD)), jSONObject.optString(A01(0, 5, 69)));
    }
}
