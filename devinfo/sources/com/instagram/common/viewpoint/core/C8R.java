...
public final class C8R {
    ...
    public static final AbstractC1888oX<Integer, Integer> A06;
    ...
    public static void A06() {
        byte[] bArr = {5, 9, 90, 92, 89, 89, 70, 91, 93, 76, 77, 108, 71, 74, 70, 77, 64, 71, 78, 90, 20, 81, 125, 113, 106, 127, 126, 6, 50, 35, 46, 40, 4, 38, 55, 38, 37, 46, 43, 46, 51, 46, 34, 52, 28, 42, 38, Utf8.REPLACEMENT_BYTE, 4, 47, 38, 41, 41, 34, 43, 4, 40, 50, 41, 51, 122, 123, 74, 66, 76, 78, 74, 68, 52, 59, 49, 39, 58, 60, 49, 123, 56, 48, 49, 60, 52, 123, 52, 54, 33, 60, 58, 59, 123, 29, 17, 24, 28, 10, 20, 0, 17, 28, 26, 10, 5, 25, 0, 18, 30, 17, 27, 13, 16, 22, 27, 81, 18, 26, 27, 22, 30, 81, 26, 7, 11, 13, 30, 81, 62, 42, 59, 54, 48, 32, 47, 51, 42, 56, 32, 44, 43, 62, 43, 58, 114, 125, 119, 97, 124, 122, 119, 61, 126, 118, 119, 122, 114, 61, 118, 107, 103, 97, 114, 61, 86, 93, 80, 92, 87, 90, 93, 84, 64, 17, 30, 20, 2, 31, 25, 20, 94, 29, 21, 20, 25, 17, 94, 21, 8, 4, 2, 17, 94, 61, 49, 40, 47, 51, 56, 49, 62, 62, 53, 60, 47, 51, Utf8.REPLACEMENT_BYTE, 37, 62, 36, 123, 102, 106, 123, 108, 112, 127, 114, 65, 109, 107, 108, 108, 113, 107, 112, 122, 65, 109, 113, 107, 112, 122, 65, 123, 112, 127, 124, 114, 123, 122, 117, 102, 116, 102};
        String[] strArr = A03;
    ...
    static {
        ...
        A06 = new C1886oV().A05(5, 6).A05(17, 6).A05(7, 6).A05(18, 6).A05(6, 8).A05(8, 8).A05(14, 8).A07();
    }

    public C8R(int[] iArr, int i4) {
        if (iArr != null) {
    ...
    */
    public static int A00(int r4) {
        ...
        Lb:
            ...
            java.lang.String r0 = com.instagram.common.viewpoint.core.C5C.A03
            ...
            r4 = 2
        L26:
            int r0 = com.instagram.common.viewpoint.core.C5C.A01(r4)
            return r0
        L2b:
            r0 = 3
            if (r4 == r0) goto L65
            r3 = 4
            java.lang.String[] r1 = com.instagram.common.viewpoint.core.C8R.A03
            r0 = 1
            r1 = r1[r0]
            r0 = 21
            ...
            r0 = 49
            if (r1 == r0) goto L6d
            java.lang.String[] r2 = com.instagram.common.viewpoint.core.C8R.A03
        ...
        L6d:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C8R.A00(int):int");
    }

    public static int A01(int i4, int i10) {
        if (C5C.A02 >= 29) {
            return C8Q.A00(i4, i10);
        }
        Integer orDefault = A06.getOrDefault(Integer.valueOf(i4), 0);
        ...
        return ((Integer) AbstractC02203y.A01(orDefault)).intValue();
    }

    public static C8R A02(Context context) {
        Intent intent = context.registerReceiver(null, new IntentFilter(A05(68, 36, AppLovinMediationAdapter.ERROR_MISSING_AD_UNIT_ID)));
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final android.util.Pair<java.lang.Integer, java.lang.Integer> A09(com.instagram.common.viewpoint.core.C1996qI r9) {
        /*
            r8 = this;
            ...
            int r4 = com.instagram.common.viewpoint.core.C3J.A03(r1, r0)
            com.facebook.ads.redexgen.X.oX<java.lang.Integer, java.lang.Integer> r1 = com.instagram.common.viewpoint.core.C8R.A06
        ...
        La6:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C8R.A09(com.facebook.ads.redexgen.X.qI):android.util.Pair");
    }

    public final boolean A0A(int i4) {
        return Arrays.binarySearch(this.A01, i4) >= 0;
    }

    public final boolean A0B(C1996qI c1996qI) {
        return A09(c1996qI) != null;
    }
