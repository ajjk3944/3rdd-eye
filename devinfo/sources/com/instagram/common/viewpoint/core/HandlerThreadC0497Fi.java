...
public class HandlerThreadC0497Fi extends HandlerThread implements Handler.Callback {
    ...
    public static String A00(int i4, int i10, int i11) {
        ...
        for (int i12 = 0; i12 < bArrCopyOfRange.length; i12++) {
            ...
            bArrCopyOfRange[i12] = (byte) (i13 ^ FacebookMediationAdapter.ERROR_NULL_CONTEXT);
        }
    ...
    public HandlerThreadC0497Fi() {
        super(A00(77, 12, 62));
    }

    private void A01() {
        AbstractC02203y.A01(this.A01);
        this.A01.A08();
    }
    ...
    private void A03(int i4) {
        AbstractC02203y.A01(this.A01);
        this.A01.A09(i4);
        this.A02 = new DummySurface(this, this.A01.A07(), i4 != 0);
    }

    public final DummySurface A04(int i4) {
        start();
        this.A00 = new Handler(getLooper(), this);
        this.A01 = new C4G(this.A00);
        boolean z3 = false;
        synchronized (this) {
            this.A00.obtainMessage(1, i4, 0).sendToTarget();
        ...
        if (this.A04 == null) {
            if (this.A03 == null) {
                return (DummySurface) AbstractC02203y.A01(this.A02);
            }
            throw this.A03;
        }
        throw this.A04;
    ...
    */
    public final boolean handleMessage(android.os.Message r7) {
        ...
        Lb:
            ...
            com.instagram.common.viewpoint.core.AbstractC02284g.A08(r1, r0, r4)     // Catch: java.lang.Throwable -> L26
        L22:
            r6.quit()
            return r5
        L26:
        ...
        L39:
            ...
            com.instagram.common.viewpoint.core.AbstractC02284g.A08(r1, r0, r4)     // Catch: java.lang.Throwable -> L7d
        ...
        L84:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.HandlerThreadC0497Fi.handleMessage(android.os.Message):boolean");
    }
}
