...
public final class C0798Re implements AudienceNetworkActivityApi, Repairable {
    ...
    public WK A07;
    public InterfaceC0978Yi A08;
    public AbstractC0999Zd A09;
    public C1284eF A0A;
    public String A0B;
    public String A0C;
    public boolean A0D;
    ...
    public final C0808Ro A0G;
    public final S1 A0H;
    public final SK A0I;
    public final C1436gi A0J;
    public final List<InterfaceC0804Rk> A0K = new ArrayList();
    public int A01 = -1;
    ...
    public static void A02() {
        A0L = new byte[]{3, 56, 55, 52, 58, 51, 118, 34, 57, 118, Utf8.REPLACEMENT_BYTE, 56, 48, 51, 36, 118, 32, Utf8.REPLACEMENT_BYTE, 51, 33, 2, 47, 38, 51, 118, 48, 36, 57, 59, 118, Utf8.REPLACEMENT_BYTE, 56, 34, 51, 56, 34, 118, 57, 36, 118, 37, 55, 32, 51, 50, 31, 56, 37, 34, 55, 56, 53, 51, 5, 34, 55, 34, 51, 42, 37, 20, 42, 40, Utf8.REPLACEMENT_BYTE, 34, 61, 34, Utf8.REPLACEMENT_BYTE, 50, 122, 120, 117, 117, 124, 107, 77, 96, 105, 124, 121, 118, 115, 127, 116, 110, 78, 117, 113, 127, 116, 116, 120, 122, 57, 113, 118, 116, 114, 117, 120, 120, 124, 57, 118, 115, 100, 57, 126, 121, 99, 114, 101, 100, 99, 126, 99, 126, 118, 123, 57, 115, 126, 100, 103, 123, 118, 110, 114, 115, 110, 99, 108, 102, 113, 97, 99, 114, 103, 62, 37, 60, 60, 49, 40, 59, 44, 44, 55, 58, 59, 26, 43, 51, 46, 45, 39, 45, 46, 49, 44, 42, 44, Utf8.REPLACEMENT_BYTE, 55, 42, 7, 5, 18, 19, 18, 17, 30, 25, 18, 19, 56, 5, 30, 18, 25, 3, 22, 3, 30, 24, 25, 60, 18, 14, 79, 87, 85, 76, 125, 90, 72, 89, 78, 111, 89, 95, 83, 82, 88, 79, 122, 97, 81, 97, 124, 103, 107, 96, 122, 111, 122, 103, 97, 96, 112, 107, 108, 116, 112, 96, 76, 97, 14, 17, 29, 15, 44, 1, 8, 29};
    }
    ...
    public C0798Re(AudienceNetworkActivity audienceNetworkActivity, AudienceNetworkActivityApi audienceNetworkActivityApi) {
        this.A0E = audienceNetworkActivity;
        this.A0F = audienceNetworkActivityApi;
        this.A0J = C0809Rp.A02(audienceNetworkActivity);
        this.A0J.A0O(this);
        this.A0H = new S1(this.A0J, this.A0E);
        this.A0I = new SK(this.A0J, this.A0E);
        this.A0G = new C0808Ro(this, this.A0J, this.A0E);
    }
    ...
    private void A03(Intent intent, Bundle bundle) {
        ...
        if (bundle != null) {
            Bundle bundleA03 = C0940Wu.A03(bundle, DynamicLoaderImpl.class.getClassLoader());
    ...
    public final void A0A(InterfaceC0804Rk interfaceC0804Rk) {
        this.A0K.add(interfaceC0804Rk);
    }

    public final void A0B(InterfaceC0804Rk interfaceC0804Rk) {
        this.A0K.remove(interfaceC0804Rk);
    }
    ...
    public final void A0D(String str, C0706Nm c0706Nm) {
        if (this.A08 == null) {
            return;
        }
        AbstractC0999Zd abstractC0999Zd = this.A09;
        if (A0M[6].charAt(30) != 'X') {
            throw new RuntimeException();
        }
        A0M[0] = "nOOhjPgmgj4ymGbfbhDfGuv2YA";
        if (abstractC0999Zd == null) {
            this.A09 = AbstractC1000Ze.A02(this.A0J, this.A0J.A0A(), str, c0706Nm, this.A08, new C1482hS(this));
    ...
    public final void finish(int i4) {
        if (i4 == 9 && (this.A08 instanceof C0518Ge)) {
            C0518Ge c0518Ge = (C0518Ge) this.A08;
            if (c0518Ge.A0e()) {
                if (this.A09 != null) {
                    YB.A0J(this.A09);
                }
        ...
        this.A0J.A0F().A3D(String.valueOf(A05().hashCode()), i4, A00());
        ...
        audienceNetworkActivityApi.finish(i4);
    }

    @Override // com.facebook.ads.internal.api.AudienceNetworkActivityApi
    public final void onActivityResult(int i4, int i10, Intent intent) {
        if (this.A08 != null && this.A08.onActivityResult(i4, i10, intent)) {
            return;
        }
        M3.A07(i4, i10, intent);
    }
    ...
    public final void onBackPressed() {
        ...
        if (this.A03 > this.A02) {
            ...
            Iterator<InterfaceC0804Rk> it = this.A0K.iterator();
            while (it.hasNext()) {
                if (it.next().AAI()) {
    ...
    public final void onCreate(Bundle bundle) {
        YD.A02();
        this.A0I.A04();
        this.A05 = C0940Wu.A02(this.A0E.getIntent(), DynamicLoaderImpl.class.getClassLoader());
        C1436gi c1436giA04 = C0940Wu.A04(this.A05);
        if (c1436giA04 != null) {
            C1436gi startAdContext = this.A0J;
            startAdContext.A0M(c1436giA04);
        }
        A03(this.A05, bundle);
        C1436gi startAdContext2 = this.A0J;
        ...
        C1436gi startAdContext3 = this.A0J;
        VA vaA0A = startAdContext3.A0A();
        C1436gi startAdContext4 = this.A0J;
        this.A08 = new C0803Rj(this, intent, vaA0A, startAdContext4).A0M(this.A07, this.A06);
        if (this.A08 == null) {
            C1436gi startAdContext5 = this.A0J;
            startAdContext5.A08().ABC(A01(58, 11, 105), AbstractC0848Td.A0A, new C0849Te(A01(0, 58, 116)));
            A09();
            finish(7);
            return;
        }
    ...
    public final void onResume() {
        ...
        this.A04 = System.currentTimeMillis();
        if (this.A08 != null) {
            InterfaceC0978Yi interfaceC0978Yi = this.A08;
            if (A0M[5].charAt(17) != 'w') {
                throw new RuntimeException();
            }
            A0M[6] = "WHwDulcP2dZca7YA0PmotSPySBaz7ZXD";
            interfaceC0978Yi.AFi(false);
            if (this.A0D) {
