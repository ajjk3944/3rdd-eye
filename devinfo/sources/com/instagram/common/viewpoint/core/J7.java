...
public final class J7 {
    ...
    public final C02434v A09 = new C02434v(1);
    public final C02434v A08 = new C02434v();

    public J7(InterfaceC0543Hd interfaceC0543Hd) {
    ...
    public JP A00() {
        JP encryptionBox;
        int i4 = this.A07.A06.A02;
        if (this.A07.A07 != null) {
            encryptionBox = this.A07.A07;
        } else {
            encryptionBox = this.A05.A00(i4);
        }
    ...
    public void A02() {
        ...
        C02434v c02434v = this.A07.A0H;
        if (jpA00.A00 != 0) {
            c02434v.A0g(jpA00.A00);
        }
    ...
    public final int A04() {
        ...
        this.A09.A0f(0);
        InterfaceC0543Hd interfaceC0543Hd = this.A06;
        C02434v initializationVectorData = this.A09;
        interfaceC0543Hd.AIr(initializationVectorData, 1);
        this.A06.AIr(c02434v, vectorSize);
        if (!zA06) {
        ...
        C02434v c02434v2 = this.A07.A0H;
        int iA0M = c02434v2.A0M();
        c02434v2.A0g(-2);
        int i4 = (iA0M * 6) + 2;
        this.A06.AIr(c02434v2, i4);
        return vectorSize + 1 + i4;
    }
    ...
    */
    ...
    public final void A08(JO jo, J1 j12) {
        this.A05 = (JO) AbstractC02203y.A01(jo);
        this.A04 = (J1) AbstractC02203y.A01(j12);
        this.A06.A6e(jo.A07);
        A05();
    }
