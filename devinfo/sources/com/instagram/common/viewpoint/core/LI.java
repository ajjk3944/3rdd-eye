...
public abstract class LI {
    ...
    public static int A00(byte[] bArr, int i4, int i10) {
    ...
    public static long A01(C02434v c02434v, int i4, int i10) {
        c02434v.A0f(i4);
        if (c02434v.A07() < 5) {
        ...
        int tsPacketHeader5 = c02434v.A0I();
        if (tsPacketHeader5 >= 7) {
            int tsPacketHeader6 = c02434v.A07();
            if (tsPacketHeader6 >= 7) {
                int tsPacketHeader7 = c02434v.A0I();
                if ((tsPacketHeader7 & 16) == 16) {
                    byte[] bArr = new byte[6];
                    int tsPacketHeader8 = bArr.length;
                    c02434v.A0k(bArr, 0, tsPacketHeader8);
                    long jA02 = A02(bArr);
                    String[] strArr = A00;
                    String str = strArr[4];
    ...
    */
    public static boolean A03(byte[] r6, int r7, int r8, int r9) {
        ...
        L2:
            ...
            if (r3 > r0) goto L41
            int r5 = r3 * 188
            java.lang.String[] r2 = com.instagram.common.viewpoint.core.LI.A00
            r0 = 3
            r1 = r2[r0]
            r0 = 6
            r0 = r2[r0]
        ...
        L41:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.LI.A03(byte[], int, int, int):boolean");
    }
}
