...
public abstract class BO<E> extends AbstractC1879oO<E> implements Set<E> {
    ...
    public static int A03(int setSize) {
        ...
        AbstractC1666ki.A0E(iMax < 1073741824, A0B(18, 20, 20));
        return 1073741824;
    }

    public static <E> BO<E> A04(int n8, Object... elements) {
        ...
        switch (n8) {
            ...
            default:
                ...
                int i10 = 0;
                for (int j = 0; j < n8; j++) {
                    Object objA00 = AbstractC1994qG.A00(objArrCopyOf[j], j);
                    int iHashCode = objA00.hashCode();
                    int tableSize = AbstractC1873oI.A00(iHashCode);
                    while (true) {
                        int i11 = tableSize & i4;
                ...
                Arrays.fill(objArrCopyOf, i10, n8, (Object) null);
                if (i10 == 1) {
                ...
                return new AnonymousClass29(objArrCopyOf, uniques, objArr, i4, i10);
        }
        throw new RuntimeException();
    }

    public static <E> BO<E> A05(E e12, E e2) {
        return A04(2, e12, e2);
    }

    public static <E> BO<E> A06(E e12, E e2, E e32) {
        return A04(3, e12, e2, e32);
    }
    ...
    public boolean equals(@CheckForNull Object object) {
        ...
        return AbstractC2019qj.A09(this, object);
    }

    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.BO != com.google.common.collect.ImmutableSet<E> */
    @Override // java.util.Collection, java.util.Set
    public int hashCode() {
        return AbstractC2019qj.A00(this);
    }
