...
public final class C1670km {
    public static byte[] A03;
    public File A00;
    public RandomAccessFile A01;
    public final InterfaceC0645Lc A02;
     ...
     */
    public final synchronized void A07() throws C1664kg {
        if (A09()) {
            return;
        }
        A06();
        ...
        if (!this.A00.renameTo(file)) {
            throw new C1664kg(A00(166, 20, 3) + this.A00 + A00(44, 4, 115) + file + A00(14, 16, 47));
        }
        this.A00 = file;
        try {
            this.A01 = new RandomAccessFile(this.A00, A00(256, 1, 61));
        } catch (IOException e2) {
            throw new C1664kg(A00(123, 14, 50) + this.A00 + A00(0, 14, 69), e2);
        }
    }

    public C1670km(File file, InterfaceC0645Lc interfaceC0645Lc) throws C1664kg {
        try {
            if (interfaceC0645Lc != null) {
                this.A02 = interfaceC0645Lc;
                File directory = file.getParentFile();
                C0648Lf.A06(directory);
            ...
            throw new C1664kg(A00(186, 17, 54) + file + A00(0, 14, 69), e2);
        }
    }
    ...
    public final synchronized int A03() throws C1664kg {
        try {
        } catch (IOException e2) {
            throw new C1664kg(A00(137, 29, 78) + this.A00, e2);
        }
    ...
    public final synchronized void A05() throws C1664kg {
        try {
            this.A01.setLength(0L);
        } catch (IOException e2) {
            throw new C1664kg(A00(57, 16, 62), e2);
        }
    }

    public final synchronized void A06() throws C1664kg {
        try {
            this.A01.close();
            this.A02.AKR(this.A00);
        } catch (IOException e2) {
            throw new C1664kg(A00(104, 19, 93) + this.A00, e2);
        }
    }

    public final synchronized void A08(byte[] bArr, int i4) throws C1664kg {
        try {
            if (!A09()) {
                this.A01.seek(A03());
                this.A01.write(bArr, 0, i4);
            } else {
                throw new C1664kg(A00(73, 31, 71) + this.A00 + A00(30, 14, WebSocketProtocol.PAYLOAD_SHORT));
            }
        } catch (IOException e2) {
            throw new C1664kg(String.format(Locale.US, A00(203, 53, 72), Integer.valueOf(i4), this.A01, Integer.valueOf(bArr.length)), e2);
        }
    }
