...
public final class AnonymousClass13<T extends Enum<T>> extends AbstractC01651r<T> implements InterfaceC0366Ac<T>, Serializable {
    ...
    public AnonymousClass13(T[] tArr) {
        C2010qY.A09(tArr, A03(7, 7, AppLovinMediationAdapter.ERROR_MISSING_AD_UNIT_ID));
        this.A00 = tArr;
    }

    private final int A00(T t10) {
        C2010qY.A09(t10, A03(0, 7, FacebookMediationAdapter.ERROR_ADVIEW_CONSTRUCTOR_EXCEPTION));
    ...
    @Override // com.instagram.common.viewpoint.core.AbstractC01651r, java.util.List
    /* renamed from: A02, reason: merged with bridge method [inline-methods] */
    public final T get(int i4) {
        AbstractC01651r.A02.A03(i4, this.A00.length);
        return this.A00[i4];
    }
    ...
    @Override // com.instagram.common.viewpoint.core.AbstractC0372Ai
    /* renamed from: A0C */
    public final int getA00() {
        return this.A00.length;
    }

    @Override // com.instagram.common.viewpoint.core.AbstractC0372Ai, java.util.Collection, java.util.List
