...
public final class AU extends AbstractC1971pt {
    ...
    public AU(int i4) {
        AbstractC02203y.A09(i4 > 0, A02(0, 35, 26));
        this.A01 = i4;
        this.A00 = -1.0f;
    }

    public AU(int i4, float f10) {
        AbstractC02203y.A09(i4 > 0, A02(0, 35, 26));
        AbstractC02203y.A09(f10 >= 0.0f && f10 <= ((float) i4), A02(35, 40, 60));
        this.A01 = i4;
        this.A00 = f10;
    }

    public static AU A00(Bundle bundle) {
        AbstractC02203y.A07(bundle.getInt(AbstractC1971pt.A02, -1) == 2);
        int i4 = bundle.getInt(A05, 5);
        float starRating = bundle.getFloat(A06, -1.0f);
        if (starRating == -1.0f) {
            return new AU(i4);
        }
        return new AU(i4, starRating);
    }
