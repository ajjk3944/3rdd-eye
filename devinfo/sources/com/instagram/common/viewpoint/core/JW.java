...
public final class JW {
    ...
    public final C02434v A03 = new C02434v(new byte[65025], 0);
    public int A00 = -1;
    ...
    */
    private int A00(int r5) {
        ...
        L1f:
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.JW.A00(int):int");
    }

    public final C02434v A01() {
        return this.A03;
    }
    ...
    public final boolean A05(InterfaceC1787ms interfaceC1787ms) throws IOException {
        AbstractC02203y.A08(interfaceC1787ms != null);
        if (this.A02) {
            this.A02 = false;
            this.A03.A0d(0);
        }
        while (!this.A02) {
            ...
            if (A05[2].length() == 22) {
                ...
                if (i4 < 0) {
                    if (!this.A04.A03(interfaceC1787ms) || !this.A04.A05(interfaceC1787ms, true)) {
                        return false;
                    }
                    int bytesToSkip = 0;
                    ...
                    if (!HB.A02(interfaceC1787ms, iA00)) {
                        return false;
                    }
                ...
                if (strArr4[4].charAt(26) != strArr4[5].charAt(26)) {
                    ...
                    if (iA002 > 0) {
                        ...
                        if (!HB.A03(interfaceC1787ms, this.A03.A0l(), this.A03.A0A(), iA002)) {
                            return false;
                        }
                        this.A03.A0e(this.A03.A0A() + iA002);
                        int i10 = this.A04.A09[segmentIndex - 1];
                        if (A05[2].length() == 22) {
                            String[] strArr5 = A05;
