...
public final class C02916r extends C0473Ek {
    ...
    public static String A01(int i4, int i10, int i11) {
        ...
        for (int i12 = 0; i12 < bArrCopyOfRange.length; i12++) {
            ...
            bArrCopyOfRange[i12] = (byte) ((b10 ^ i11) ^ 4);
        }
    ...
    static {
        A03();
        A0H = C02916r.class.getSimpleName();
    }

    public C02916r(C1436gi c1436gi) {
        super(c1436gi);
        ...
        this.A09 = new NL(this, c1436gi);
        this.A0A = c1436gi;
        A02();
    }

    public C02916r(C1436gi c1436gi, AttributeSet attributeSet) {
    ...
    public C02916r(C1436gi c1436gi, AttributeSet attributeSet, int i4) {
    ...
    private void A05(String str) {
        this.A0A.A08().ABC(A01(198, 7, 74), AbstractC0848Td.A28, new C0849Te(AdErrorType.PARSER_FAILURE.getDefaultErrorMessage(), A01(90, 7, 92) + str));
    ...
    public final void A0s() {
        AdActivityIntent adActivityIntentA05 = C0940Wu.A05(this.A0A);
        A04(adActivityIntentA05);
        try {
            A0i(false, 6);
            setVisibility(8);
            C0940Wu.A0B(this.A0A, adActivityIntentA05);
        } catch (Exception e2) {
            this.A0A.A08().ABC(A01(176, 11, 123), AbstractC0848Td.A0D, new C0849Te(e2));
            Log.e(A01(97, 17, 97), A01(0, 90, FacebookMediationAdapter.ERROR_REQUIRES_ACTIVITY_CONTEXT), e2);
        }
    }

    public InterfaceC0991Yv getListener() {
        return this.A03;
    }
    ...
    @Override // com.instagram.common.viewpoint.core.C0473Ek, android.view.ViewGroup, android.view.View
    ...
    public void setClientToken(String str) {
        ...
        this.A05 = c4l;
        if (this.A05 != null && C0886Up.A20(this.A0A)) {
            if (str != null) {
                c0483Eu2 = new C0483Eu(this.A0A, this.A02, this, str, false, this.A05, null);
            }
            this.A04 = c0483Eu2;
            return;
        }
    ...
    public void setListener(InterfaceC0991Yv interfaceC0991Yv) {
        this.A03 = interfaceC0991Yv;
    }
    ...
    @Override // com.instagram.common.viewpoint.core.C0473Ek
