...
public final class C0915Vu {
     ...
     */
    public C0915Vu(T8 t82, String str, String str2, EnumC0911Vq enumC0911Vq) throws C0909Vn {
        ...
        try {
            ...
            switch (EnumC0914Vt.valueOf(jSONObject.getString(strA014).toUpperCase()).ordinal()) {
                case 0:
                    this.A00 = EnumC0914Vt.A03;
                    ...
                    if (!jSONObject.getString(strA012).equals(t82.A05().A9T()) && !ProcessUtils.isRemoteRenderingProcess() && AbstractC0889Us.A03(jSONObject) != Boolean.TRUE) {
                        throw new C0909Vn(AdErrorType.BID_IMPRESSION_MISMATCH, String.format(Locale.US, A01(0, 54, 122), this.A01, jSONObject.getString(strA012), t82.A05().A9T()));
                    }
                    if (!jSONObject.getString(strA01).equals(str2)) {
                        throw new C0909Vn(AdErrorType.BID_IMPRESSION_MISMATCH, String.format(Locale.US, A01(54, 50, 11), this.A01, jSONObject.getString(strA01), str2));
                    }
                    HashSet hashSet = new HashSet(Arrays.asList(Integer.valueOf(EnumC0911Vq.A0H.A04()), Integer.valueOf(EnumC0911Vq.A0K.A04()), Integer.valueOf(EnumC0911Vq.A0I.A04()), Integer.valueOf(EnumC0911Vq.A0J.A04())));
                    if (jSONObject.getInt(strA015) != enumC0911Vq.A04()) {
                        if (!hashSet.contains(Integer.valueOf(jSONObject.getInt(strA015))) || !hashSet.contains(Integer.valueOf(enumC0911Vq.A04()))) {
                            throw new C0909Vn(AdErrorType.BID_IMPRESSION_MISMATCH, String.format(Locale.US, A01(104, 48, 28), this.A01, Integer.valueOf(jSONObject.getInt(strA015)), enumC0911Vq));
                        }
                        return;
                    }
                    return;
                default:
                    throw new C0909Vn(AdErrorType.BID_PAYLOAD_ERROR, A01(210, 28, 68) + jSONObject.getString(strA014));
            }
        } catch (JSONException e2) {
            t82.A08().ABC(A01(238, 3, 5), AbstractC0848Td.A0P, new C0849Te(e2));
            throw new C0909Vn(AdErrorType.BID_PAYLOAD_ERROR, A01(152, 18, 88), e2);
        }
    }
    ...
    public static EnumC0911Vq A00(String str) throws C0909Vn {
        try {
            return EnumC0911Vq.A00(new JSONObject(str).getInt(A01(302, 8, 37)));
        } catch (JSONException e2) {
            throw new C0909Vn(AdErrorType.BID_PAYLOAD_ERROR, A01(152, 18, 88), e2);
        }
    }

    public static void A03(EnumC0911Vq enumC0911Vq) throws C0909Vn {
        if (!EnumC0911Vq.A0G.equals(enumC0911Vq) && !EnumC0911Vq.A0E.equals(enumC0911Vq) && !EnumC0911Vq.A0F.equals(enumC0911Vq)) {
            boolean zEquals = EnumC0911Vq.A0D.equals(enumC0911Vq);
            ...
            if (zEquals) {
                ...
                throw new C0909Vn(AdErrorType.BID_IMPRESSION_MISMATCH, String.format(Locale.US, A01(170, 40, 9), Integer.valueOf(enumC0911Vq.A04())));
            }
        }
    }
    ...
    public final boolean A06() {
        return this.A00 != EnumC0914Vt.A04;
    }
}
