...
public final class VL {
     ...
     */
    public static void A06(T8 t82, InterfaceC1387fv interfaceC1387fv, Map<String, ?> map) throws JSONException {
        ...
        A0A(t82, map3);
        U7 u7A09 = t82.A09();
        JSONObject jSONObjectA05 = C0850Tf.A05(new C0852Th(u7A09.A01(), u7A09.A02(), map3));
        ...
        c1401g9.put(A01(171, 7, 40), jSONObject2.toString());
        interfaceC1387fv.AGy(t82.A05().A86(), c1401g9.A08(), new WJ(t82));
    }
    ...
    public static boolean A0B(double d10, int i4) {
        return i4 <= 0 || d10 >= 1.0d / ((double) i4);
    }
    ...
    public static boolean A0C(T8 t82) {
        ...
        if (!AbstractC0888Ur.A0U(t82)) {
            return true;
        }
        return A0B(t82.A09().A00(), AbstractC0888Ur.A0C(t82));
    }
}
