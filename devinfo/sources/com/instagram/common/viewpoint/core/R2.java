...
public abstract class R2 {
    ...
    public int A0C;
    public int A0D;
    public final RN A0G = new C1498hj(this);
    public final RN A0H = new C1496hh(this);
    ...
    public abstract int A1f(int i4, RA ra, RH rh2);

    public abstract int A1g(int i4, RA ra, RH rh2);
    ...
    public abstract View A1p(View view, int i4, RA ra, RH rh2);

    public abstract R3 A1q();

    public abstract void A1r(int i4);

    public abstract void A1s(int i4, int i10, RH rh2, R0 r02);

    public abstract void A1t(int i4, R0 r02);

    public abstract void A1u(Parcelable parcelable);

    public abstract void A1w(RA ra, RH rh2);

    public abstract void A1z(C7M c7m, RH rh2, int i4);
    ...
    public static int A02(int i4, int i10, int i11) {
    ...
    public static int A03(int i4, int i10, int i11, int i12, boolean z3) {
        int iMax = Math.max(0, i4 - i11);
        int i13 = 0;
        int resultMode = 0;
        if (z3) {
            if (i12 >= 0) {
            ...
            i13 = iMax;
            resultMode = (i10 == Integer.MIN_VALUE || i10 == 1073741824) ? LinearLayoutManager.INVALID_OFFSET : 0;
        }
    ...
    private final int A08(RA ra, RH rh2) {
        return 0;
    }

    private final void A0B(int i4) {
        A0E(i4, A0v(i4));
    }

    private final void A0C(int i4) {
        View child = A0v(i4);
        if (child != null) {
            this.A01.A0D(i4);
        }
    ...
    private final void A0D(int i4, int i10) {
        View view = A0v(i4);
        if (view != null) {
            A0B(i4);
            A0G(view, i10);
        ...
        throw new IllegalArgumentException(A09(85, 44, 81) + i4 + this.A03.toString());
    }

    private void A0E(int i4, View view) {
        this.A01.A0C(i4);
    }
    ...
    private final void A0G(View view, int i4) {
        A0H(view, i4, (R3) view.getLayoutParams());
    }

    private final void A0H(View view, int i4, R3 r32) {
        ...
        this.A01.A0H(view, i4, r32, rkA0F.A0g());
    }

    private void A0I(View view, int i4, boolean z3) {
        RK rkA0F = C7M.A0F(view);
        if (z3 || rkA0F.A0g()) {
            this.A03.A0t.A09(rkA0F);
        } else {
        ...
        if (rkA0F.A0m() || rkA0F.A0h()) {
            ...
            this.A01.A0H(view, i4, view.getLayoutParams(), false);
        } else {
    ...
    private void A0L(RA ra, int i4, View view) {
        RK rkA0F = C7M.A0F(view);
        if (rkA0F.A0l()) {
            return;
        }
    ...
    private final void A0M(RA ra, RH rh2, AccessibilityEvent accessibilityEvent) {
    ...
    */
    private final void A0N(com.instagram.common.viewpoint.core.RA r6, com.instagram.common.viewpoint.core.RH r7, com.instagram.common.viewpoint.core.Q6 r8) {
        /*
            r5 = this;
            ...
            java.lang.String[] r1 = com.instagram.common.viewpoint.core.R2.A0J
            r0 = 3
            r1 = r1[r0]
            r0 = 19
            ...
            if (r1 == r0) goto L8e
            java.lang.String[] r2 = com.instagram.common.viewpoint.core.R2.A0J
        ...
        L63:
            ...
            int r0 = r5.A08(r6, r7)
            com.facebook.ads.redexgen.X.Q3 r0 = com.instagram.common.viewpoint.core.Q3.A00(r3, r2, r1, r0)
            r8.A0P(r0)
            return
        L7b:
            java.lang.String[] r2 = com.instagram.common.viewpoint.core.R2.A0J
        ...
        L8e:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.R2.A0N(com.facebook.ads.redexgen.X.RA, com.facebook.ads.redexgen.X.RH, com.facebook.ads.redexgen.X.Q6):void");
    }
    ...
    public static boolean A0Q(int i4, int i10, int i11) {
    ...
    private final boolean A0R(RA ra, RH rh2) {
        return false;
    }

    private final boolean A0S(RA ra, RH rh2, int i4, Bundle bundle) {
        if (this.A03 == null) {
            return false;
        }
        int hScroll = 0;
    ...
    private final boolean A0T(RA ra, RH rh2, View view, int i4, Bundle bundle) {
        return false;
    }

    private boolean A0U(C7M c7m, int i4, int i10) {
        ...
        if (rect.left - i4 >= parentTop2 || rect.right - i4 <= parentBottom || rect.top - i10 >= parentLeft2 || rect.bottom - i10 <= parentRight) {
            return false;
        }
        return true;
    }
    ...
    public final View A0v(int i4) {
        if (this.A01 != null) {
            return this.A01.A09(i4);
        }
        return null;
    }

    public final View A0w(View view, int i4) {
        return null;
    }
    ...
    public final void A11(int i4) {
        if (this.A03 != null) {
            this.A03.A1V(i4);
        }
    }

    public final void A12(int i4) {
        if (this.A03 != null) {
            this.A03.A1W(i4);
        }
    }

    public final void A13(int i4, int i10) {
        this.A0C = View.MeasureSpec.getSize(i4);
        this.A0D = View.MeasureSpec.getMode(i4);
    ...
    public final void A14(int i4, int i10) {
        int iA0Y = A0Y();
        if (iA0Y == 0) {
            this.A03.A1c(i4, i10);
            String[] strArr = A0J;
        ...
        A17(this.A03.A0p, i4, i10);
    }

    public final void A15(int i4, int i10) {
        this.A03.setMeasuredDimension(i4, i10);
    }

    public final void A16(int i4, RA ra) {
        View view = A0v(i4);
        A0C(i4);
        ra.A0T(view);
    }

    public void A17(Rect rect, int i4, int i10) {
        ...
        int usedWidth3 = A0e();
        int usedHeight2 = A02(i4, usedHeight, usedWidth3);
        int usedWidth4 = A0d();
    ...
    public final void A1A(View view, int i4) {
        A0I(view, i4, true);
    }

    public final void A1B(View view, int i4) {
        A0I(view, i4, false);
    }

    public final void A1C(View view, int i4, int i10) {
        R3 r32 = (R3) view.getLayoutParams();
        Rect rectA1D = this.A03.A1D(view);
        int i11 = i4 + rectA1D.left + rectA1D.right;
        int i12 = i10 + rectA1D.top + rectA1D.bottom;
        int iA03 = A03(A0j(), A0k(), A0g() + A0h() + r32.leftMargin + r32.rightMargin + i11, r32.width, A22());
        int iA0Z = A0Z();
        int iA0a = A0a();
        int widthSpec = A0i();
        int iA032 = A03(iA0Z, iA0a, widthSpec + A0f() + r32.topMargin + r32.bottomMargin + i12, r32.height, A23());
        if (A1Y(view, iA03, iA032, r32)) {
            view.measure(iA03, iA032);
        }
    }

    public final void A1D(View view, int i4, int i10, int i11, int i12) {
        R3 r32 = (R3) view.getLayoutParams();
        Rect rect = r32.A03;
        view.layout(rect.left + i4 + r32.leftMargin, rect.top + i10 + r32.topMargin, (i11 - rect.right) - r32.rightMargin, (i12 - rect.bottom) - r32.bottomMargin);
    }
    ...
    public final void A1I(RA ra) {
        int iA0E = ra.A0E();
        for (int i4 = iA0E - 1; i4 >= 0; i4--) {
            View viewA0F = ra.A0F(i4);
    ...
    public void A1L(RA ra, RH rh2, int i4, int i10) {
        this.A03.A1c(i4, i10);
    }

    public void A1M(RA ra, RH rh2, View view, Q6 q62) {
    ...
    public final boolean A1U() {
        int iA0Y = A0Y();
        for (int i4 = 0; i4 < iA0Y; i4++) {
            ViewGroup.LayoutParams layoutParams = A0v(i4).getLayoutParams();
    ...
    public final boolean A1X(int i4, Bundle bundle) {
        return A0S(this.A03.A0r, this.A03.A0s, i4, bundle);
    }

    public final boolean A1Y(View view, int i4, int i10, R3 r32) {
        if (!view.isLayoutRequested()) {
            ...
            if (z3 && A0Q(view.getWidth(), i4, r32.width) && A0Q(view.getHeight(), i10, r32.height)) {
                return false;
            }
        }
        return true;
    ...
    public final boolean A1Z(View view, int i4, Bundle bundle) {
        return A0T(this.A03.A0r, this.A03.A0s, view, i4, bundle);
    }
    ...
    public final boolean A1c(C7M c7m, View view, Rect rect, boolean z3, boolean z10) {
        int[] scrollAmount = A0W(view, rect);
        int i4 = scrollAmount[0];
        int i10 = scrollAmount[1];
        if ((z10 && !A0U(c7m, i4, i10)) || (i4 == 0 && i10 == 0)) {
            return false;
        }
        if (z3) {
            c7m.scrollBy(i4, i10);
    ...
    public final boolean A1e(C7M c7m, ArrayList<View> views, int i4, int i10) {
        return false;
    }

    public View A1o(int i4) {
        int iA0Y = A0Y();
        for (int i10 = 0; i10 < iA0Y; i10++) {
            ...
            if (rkA0F != null) {
                ...
                if (childCount == i4 && !rkA0F.A0l() && (this.A03.A0s.A07() || !rkA0F.A0g())) {
                    return child;
                }
            }
        }
