...
public final class C1445gr implements InterfaceC0828Sj {
    ...
    public final Map<String, AbstractC0826Sh> A00 = new HashMap();
     ...
     */
    @Override // com.instagram.common.viewpoint.core.InterfaceC0828Sj
    public final synchronized String AIb() {
        StringBuilder sb2;
        sb2 = new StringBuilder();
        Iterator<AbstractC0826Sh> it = this.A00.values().iterator();
        if (it.hasNext()) {
            it.next();
