...
public enum EnumC1597jY {
    ...
    public static EnumC1597jY[] valuesCustom() {
        EnumC1597jY[] enumC1597jYArrValuesCustom = values();
        if (A01[0].charAt(28) == 't') {
            throw new RuntimeException();
        }
        A01[7] = "Z";
        return (EnumC1597jY[]) enumC1597jYArrValuesCustom.clone();
    }
}
