...
public abstract class AbstractC1986q8 {
     ...
     */
    public static boolean A01(@CheckForNull InterfaceC1981q3<?, ?> multimap, Object object) {
        if (object == multimap) {
            return true;
        }
        if (object instanceof InterfaceC1981q3) {
            return multimap.A4H().equals(((InterfaceC1981q3) object).A4H());
        }
        return false;
    }
    ...
    public static <K, V> BM<K, V> A00(final Map<K, Collection<V>> map, final InterfaceC1677ku<? extends List<V>> factory) {
        return new C1A<K, V>(map, factory) { // from class: com.facebook.ads.redexgen.X.0t
            public static final long serialVersionUID = 0;
            public transient InterfaceC1677ku<? extends List<V>> A00;
            ...
            /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.ku != com.google.common.base.Supplier<? extends java.util.List<V>> */
            {
                this.A00 = (InterfaceC1677ku) AbstractC1666ki.A04(factory);
            }
            ...
            private void readObject(ObjectInputStream stream) throws ClassNotFoundException, IOException {
                ...
                this.A00 = (InterfaceC1677ku) Objects.requireNonNull(stream.readObject());
