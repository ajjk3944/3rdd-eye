...
public abstract class AbstractC0372Ai<E> implements Collection<E> {
    ...
    public static void A0B() {
        A00 = new byte[]{30, 66, 94, 95, 69, 22, 117, 89, 90, 90, 83, 85, 66, 95, 89, 88, 31, 10, 6, 5, 58, 47, 56, 43, 62, 35, 37, 36, 106, 35, 57, 106, 36, 37, 62, 106, 57, Utf8.REPLACEMENT_BYTE, 58, 58, 37, 56, 62, 47, 46, 106, 44, 37, 56, 106, 56, 47, 43, 46, 103, 37, 36, 38, 51, 106, 41, 37, 38, 38, 47, 41, 62, 35, 37, 36, 33, 69, 44, Utf8.REPLACEMENT_BYTE, Utf8.REPLACEMENT_BYTE, 44, 52, 8, 1, 8, 0, 8, 3, 25, 30};
    }
    ...
    public boolean contains(E element) {
        AbstractC0372Ai<E> abstractC0372Ai = this;
        if ((abstractC0372Ai instanceof Collection) && abstractC0372Ai.isEmpty()) {
            return false;
        }
        Iterator<E> it = abstractC0372Ai.iterator();
        while (it.hasNext()) {
            if (C2010qY.A0C(it.next(), element)) {
                return true;
            }
        }
        return false;
    ...
    public final boolean containsAll(Collection<? extends Object> elements) {
        C2010qY.A09(elements, A0A(77, 8, 122));
    ...
    public static final CharSequence A08(AbstractC0372Ai abstractC0372Ai, Object obj) {
        return obj == abstractC0372Ai ? A0A(0, 17, 33) : String.valueOf(obj);
    }
    ...
    public Object[] toArray() {
        return AbstractC2012qa.A02(this);
    }

    @Override // java.util.Collection
    public <T> T[] toArray(T[] array) {
        C2010qY.A09(array, A0A(72, 5, 90));
        return (T[]) AbstractC2012qa.A03(this, array);
    }
    ...
    public final String toString() {
        return C0d.A03(this, A0A(17, 2, 49), A0A(70, 1, FacebookMediationAdapter.ERROR_CREATE_NATIVE_AD_FROM_BID_PAYLOAD), A0A(71, 1, 15), 0, null, new AZ() { // from class: com.facebook.ads.redexgen.X.1t
            ...
            public final Object AAK(Object obj) {
                return AbstractC0372Ai.A08(this.A00, obj);
            }
        }, 24, null);
    }
}
