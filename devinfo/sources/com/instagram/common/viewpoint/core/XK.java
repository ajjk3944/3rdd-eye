    ...
    */
    public static int A05(org.xmlpull.v1.XmlPullParser r5) throws org.xmlpull.v1.XmlPullParserException, java.lang.NumberFormatException, java.io.IOException {
        ...
        L23:
            ...
            java.lang.String[] r2 = com.instagram.common.viewpoint.core.XK.A02
            r0 = 0
            r1 = r2[r0]
            r0 = 1
            r2 = r2[r0]
        ...
        L6a:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.XK.A05(org.xmlpull.v1.XmlPullParser):int");
    }
    ...
    public static void A09(Context context) {
        ...
        A04 = XJ.A03;
        Executors.newSingleThreadExecutor().execute(new C0788Qu(context));
    }

    public static void A0A(T8 t82, Throwable th2) {
        t82.A08().ABC(A06(38, 7, 85), AbstractC0848Td.A1c, new C0849Te(th2));
    }
    ...
    public static boolean A0C(T8 t82) {
        ...
        if (cachedValue != null) {
            ...
            boolean z3 = true;
            try {
                xmlResourceParserOpenXmlResourceParser = t82.getAssets().openXmlResourceParser(A06(0, 19, 21));
                loop0: while (true) {
                    ...
                    if (xmlResourceParserOpenXmlResourceParser.getEventType() == 2 && (xmlResourceParserOpenXmlResourceParser.getName().equals(A06(27, 11, 23)) || xmlResourceParserOpenXmlResourceParser.getName().equals(A06(19, 8, 90)))) {
                        for (int i4 = 0; i4 < xmlResourceParserOpenXmlResourceParser.getAttributeCount(); i4++) {
                            if (xmlResourceParserOpenXmlResourceParser.getAttributeName(i4).equals(A06(58, 18, 8)) && !Boolean.parseBoolean(xmlResourceParserOpenXmlResourceParser.getAttributeValue(i4))) {
                                z3 = false;
                                break loop0;
                            }
                        }
