...
public final class C1447gt implements SR {
    ...
    public final InterfaceC1412gK A01;
    ...
    public C1447gt(CY cy) {
        this.A01 = cy.A5U(EnumC1413gL.A0B);
        this.A01.A41(new C1448gu(this));
        A03();
    }
    ...
    public static Set<SU> A01(JSONObject jSONObject) {
        ...
        while (true) {
            ...
            if (i4 < i10) {
                ...
                if (jSONObjectOptJSONObject == null || (c1446gsA00 = C1446gs.A00(jSONObjectOptJSONObject)) == null) {
                    return null;
                }
                hashSet.add(c1446gsA00);
                i4++;
            } else {
                return hashSet;
            }
