...
public final class YK implements V8 {
    ...
    public YK(C1432ge c1432ge, ZD zd2) {
        this.A00 = c1432ge;
        this.A01 = zd2;
    }

    private void A02(Set<String> eventsToRetry, Set<String> eventsToDelete) throws JSONException {
        int iA0B = this.A01.A0B(AbstractC0888Ur.A0G(this.A00), eventsToRetry, eventsToDelete);
        if (iA0B > 0) {
            this.A00.A08().ABC(A00(TTAdConstant.DEEPLINK_FALLBACK_TYPE_CODE, 15, 38), AbstractC0848Td.A10, new C0849Te(A00(28, 44, 75) + iA0B));
        }
    }
    ...
    public final JSONObject A5L() throws JSONException {
        ...
        int iA0F = AbstractC0888Ur.A0F(this.A00);
        ...
        for (JSONObject jSONObject2 : listA0C) {
            try {
                ...
                if (this.A00.A05().AAO()) {
                    Log.e(A04, A00(134, 72, 62), e2);
                }
            }
        }
        JSONArray jSONArray = new JSONArray((Collection) listA0C);
        if (AbstractC0888Ur.A0P(this.A00) && (jSONArrayA04 = C0850Tf.A04(this.A00, (iA08 = AbstractC0888Ur.A08(this.A00)))) != null) {
    ...
    public final void ADe(JSONArray jSONArray) throws JSONException {
        ...
        for (int i4 = 0; i4 < length; i4++) {
            try {
                JSONObject eventJson = jSONArray.getJSONObject(i4);
                String string = eventJson.getString(A00(TTAdConstant.DEEPLINK_UNAVAILABLE_CODE, 2, 94));
                if (C0850Tf.A0I(string)) {
                    C0850Tf.A0B(this.A00, string);
                } else {
                    hashSet.add(string);
                }
            } catch (JSONException e2) {
    ...
    public final boolean ADf(JSONArray jSONArray) throws JSONException {
        ...
        boolean z3 = true;
        boolean zA0P = AbstractC0888Ur.A0P(this.A00);
        ...
        for (int i4 = 0; i4 < jSONArray.length(); i4++) {
            try {
                ...
                if (A00(363, 26, 65).equals(string)) {
                    C0886Up.A0V(this.A00).A36(jSONObject.getString(A00(389, 14, 97)));
                    this.A00.A04().ACP();
                } else {
                    ...
                    if (i10 == 1) {
                        ...
                        if (i10 >= 1000 && i10 < 2000) {
                            ...
                            if (this.A00.A05().AAO()) {
                                Log.e(A04, A00(231, 41, FacebookMediationAdapter.ERROR_REQUIRES_ACTIVITY_CONTEXT) + i10 + strA002 + string + strA00);
                            }
                            eventsToDelete.add(string);
                            if (zA0P) {
                                C0850Tf.A0D(string);
                ...
                if (this.A00.A05().AAO()) {
                    String eventId = A04;
                    Log.e(eventId, A00(309, 44, 108) + i4 + strA00, e2);
                }
                z3 = false;
            }
        }
