...
public final class AnonymousClass95 {
    ...
    public AnonymousClass95(AnonymousClass93 anonymousClass93) {
        this.A0V = (AnonymousClass93) AbstractC02203y.A01(anonymousClass93);
        if (C5C.A02 >= 18) {
            try {
    ...
    private void A07(long j) {
        AnonymousClass92 anonymousClass92 = (AnonymousClass92) AbstractC02203y.A01(this.A0O);
    ...
    private void A08(long j) {
        if (this.A0R && this.A0P != null && j - this.A09 >= 500000) {
            try {
                this.A0E = (((Integer) C5C.A0f((Integer) this.A0P.invoke(AbstractC02203y.A01(this.A0N), new Object[0]))).intValue() * 1000) - this.A06;
    ...
    private void A09(long j) {
        int playState = ((AudioTrack) AbstractC02203y.A01(this.A0N)).getPlayState();
        if (playState == 1) {
            return;
        }
    ...
    private boolean A0A() {
        return this.A0T && ((AudioTrack) AbstractC02203y.A01(this.A0N)).getPlayState() == 2 && A00() == 0;
    }

    public static boolean A0B(int i4) {
        return C5C.A02 < 23 && (i4 == 5 || i4 == 6);
    }
    ...
    public final long A0D(boolean z3) {
        long jA0Q;
        if (((AudioTrack) AbstractC02203y.A01(this.A0N)).getPlayState() == 3) {
            A04();
        }
        ...
        if (j < 1000000) {
            ...
            jA0Q = ((jA0Q * j8) + ((1000 - j8) * jA0Q2)) / 1000;
        }
    ...
    public final void A0F() {
        ((AnonymousClass92) AbstractC02203y.A01(this.A0O)).A05();
    }
    ...
    public final void A0I(AudioTrack audioTrack, boolean z3, int i4, int i10, int i11) {
        this.A0N = audioTrack;
        this.A03 = i10;
        this.A01 = i11;
    ...
    public final boolean A0J() {
        return ((AudioTrack) AbstractC02203y.A01(this.A0N)).getPlayState() == 3;
    }
