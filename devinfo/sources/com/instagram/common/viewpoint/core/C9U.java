...
public final class C9U extends AbstractC1768mZ {
     ...
     */
    public static ApicFrame A04(C02434v c02434v, int i4, int i10) {
        int iA02;
        String strA01;
        int iA0I = c02434v.A0I();
        Charset charsetA0M = A0M(iA0I);
        byte[] bArr = new byte[i4 - 1];
        c02434v.A0k(bArr, 0, i4 - 1);
        String strA0J = A0J(TTAdConstant.AD_ID_IS_NULL_CODE, 6, 90);
        if (i10 == 2) {
            iA02 = 2;
            strA01 = strA0J + AbstractC1631k7.A01(new String(bArr, 0, 3, AbstractC1633k9.A00));
            if (A0J(418, 9, 47).equals(strA01)) {
                strA01 = A0J(TTAdConstant.DOWNLOAD_URL_CODE, 10, 122);
            }
        } else {
            iA02 = A02(bArr, 0);
            strA01 = AbstractC1631k7.A01(new String(bArr, 0, iA02, AbstractC1633k9.A00));
    ...
    java.lang.ArrayIndexOutOfBoundsException
     */
    public static ChapterFrame A06(C02434v c02434v, int i4, int i10, boolean z3, int i11, IE ie2) {
        int iA09 = c02434v.A09();
        int iA02 = A02(c02434v.A0l(), iA09);
        String str = new String(c02434v.A0l(), iA09, iA02 - iA09, AbstractC1633k9.A00);
        c02434v.A0f(iA02 + 1);
        ...
        while (true) {
            ...
            Id3Frame id3FrameA0B = A0B(i10, c02434v, z3, i11, ie2);
            if (id3FrameA0B != null) {
    ...
    java.lang.ArrayIndexOutOfBoundsException
     */
    public static GeobFrame A09(C02434v c02434v, int i4) {
        int iA0I = c02434v.A0I();
        Charset charsetA0M = A0M(iA0I);
        byte[] bArr = new byte[i4 - 1];
        c02434v.A0k(bArr, 0, i4 - 1);
        int iA02 = A02(bArr, 0);
        String str = new String(bArr, 0, iA02, AbstractC1633k9.A00);
        int i10 = iA02 + 1;
    ...
    java.lang.ArrayIndexOutOfBoundsException
     */
    public static MlltFrame A0C(C02434v c02434v, int i4) {
        int iA0M = c02434v.A0M();
        int iA0K = c02434v.A0K();
        int iA0K2 = c02434v.A0K();
        int iA0I = c02434v.A0I();
        int iA0I2 = c02434v.A0I();
        C02424u c02424u = new C02424u();
        c02424u.A0C(c02434v);
        int i10 = ((i4 - 10) * 8) / (iA0I + iA0I2);
        int[] iArr = new int[i10];
        int[] iArr2 = new int[i10];
        for (int i11 = 0; i11 < i10; i11++) {
            int iA04 = c02424u.A04(iA0I);
            int iA042 = c02424u.A04(iA0I2);
            iArr[i11] = iA04;
            iArr2[i11] = iA042;
            if (A02[5].charAt(22) == 'F') {
                throw new RuntimeException();
    ...
    static {
        ...
        A03 = new IE() { // from class: com.facebook.ads.redexgen.X.mT
            ...
            public final boolean A6Q(int i4, int i10, int i11, int i12, int i13) {
                return C9U.A0O(i4, i10, i11, i12, i13);
            }
        };
    }
    ...
    */
    public static int A01(com.instagram.common.viewpoint.core.C02434v r8, int r9) {
        /*
            byte[] r6 = r8.A0l()
            int r8 = r8.A09()
            r7 = r8
        L9:
            ...
            int r0 = r9 - r0
            int r3 = r0 + (-2)
            java.lang.String[] r2 = com.instagram.common.viewpoint.core.C9U.A02
            r0 = 1
            r1 = r2[r0]
            r0 = 7
            r2 = r2[r0]
        ...
        L54:
            return r9
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C9U.A01(com.facebook.ads.redexgen.X.4v, int):int");
    }
    ...
    */
    public static int A02(byte[] r1, int r2) {
        ...
        Lb:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C9U.A02(byte[], int):int");
    }
    ...
    */
    public static int A03(byte[] r2, int r3, int r4) {
        ...
        L23:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C9U.A03(byte[], int, int):int");
    }

    public static BinaryFrame A05(C02434v c02434v, int i4, String str) {
        byte[] bArr = new byte[i4];
        c02434v.A0k(bArr, 0, i4);
        return new BinaryFrame(str, bArr);
    }

    public static ChapterTocFrame A07(C02434v c02434v, int i4, int i10, boolean z3, int elementIdEndIndex, IE ie2) {
        int iA09 = c02434v.A09();
        int iA02 = A02(c02434v.A0l(), iA09);
        String str = new String(c02434v.A0l(), iA09, iA02 - iA09, AbstractC1633k9.A00);
        c02434v.A0f(iA02 + 1);
        int framePosition = c02434v.A0I();
        boolean z10 = (framePosition & 2) != 0;
        boolean z11 = (framePosition & 1) != 0;
        int iA0I = c02434v.A0I();
        String[] strArr = new String[iA0I];
        for (int i11 = 0; i11 < iA0I; i11++) {
            int startIndex = c02434v.A09();
            int iA022 = A02(c02434v.A0l(), startIndex);
            int elementIdEndIndex2 = iA022 - startIndex;
            strArr[i11] = new String(c02434v.A0l(), startIndex, elementIdEndIndex2, AbstractC1633k9.A00);
            c02434v.A0f(iA022 + 1);
        }
        ArrayList arrayList = new ArrayList();
        int i12 = iA09 + i4;
        while (c02434v.A09() < i12) {
            Id3Frame id3FrameA0B = A0B(i10, c02434v, z3, elementIdEndIndex, ie2);
            if (id3FrameA0B != null) {
                arrayList.add(id3FrameA0B);
            }
        }
    ...
    public static CommentFrame A08(C02434v c02434v, int i4) {
        if (i4 < 4) {
            return null;
        }
        int textStartIndex = c02434v.A0I();
        Charset charsetA0M = A0M(textStartIndex);
        byte[] bArr = new byte[3];
        c02434v.A0k(bArr, 0, 3);
        String description = new String(bArr, 0, 3);
        int encoding = i4 - 4;
        byte[] data = new byte[encoding];
        int encoding2 = i4 - 4;
        c02434v.A0k(data, 0, encoding2);
    ...
    public static IF A0A(C02434v c02434v) {
        int iA07 = c02434v.A07();
        String strA0J = A0J(170, 10, 14);
        if (iA07 < 10) {
            AbstractC02284g.A07(strA0J, A0J(30, 31, 108));
            return null;
        }
        int iA0K = c02434v.A0K();
        boolean z3 = false;
        if (iA0K != 4801587) {
            AbstractC02284g.A07(strA0J, A0J(348, 50, 47) + String.format(A0J(0, 4, 50), Integer.valueOf(iA0K)));
            return null;
        }
        int iA0I = c02434v.A0I();
        c02434v.A0g(1);
        int flags = c02434v.A0I();
        int iA0H = c02434v.A0H();
        if (iA0I == 2) {
            int id2 = flags & 64;
            int id3 = id2 != 0 ? 1 : 0;
            if (id3 != 0) {
                AbstractC02284g.A07(strA0J, A0J(180, 68, 11));
                return null;
            }
        } else if (iA0I == 3) {
            int id4 = flags & 64;
            ...
            AbstractC02284g.A07(strA0J, A0J(248, 46, 54) + iA0I);
            return null;
        }
        if (iA0I < 4) {
            int id12 = flags & 128;
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public static com.facebook.ads.androidx.media3.extractor.metadata.id3.Id3Frame A0B(int r21, com.instagram.common.viewpoint.core.C02434v r22, boolean r23, int r24, com.instagram.common.viewpoint.core.IE r25) {
        /*
            Method dump skipped, instructions count: 632
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C9U.A0B(int, com.facebook.ads.redexgen.X.4v, boolean, int, com.facebook.ads.redexgen.X.IE):com.facebook.ads.androidx.media3.extractor.metadata.id3.Id3Frame");
    }

    public static PrivFrame A0D(C02434v c02434v, int i4) {
        byte[] bArr = new byte[i4];
        c02434v.A0k(bArr, 0, i4);
        int iA02 = A02(bArr, 0);
        return new PrivFrame(new String(bArr, 0, iA02, AbstractC1633k9.A00), A0Q(bArr, iA02 + 1, bArr.length));
    }
    ...
    public static TextInformationFrame A0E(C02434v c02434v, int i4) {
        if (i4 < 1) {
            return null;
        }
        int iA0I = c02434v.A0I();
    ...
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.BP != com.google.common.collect.ImmutableList<java.lang.String> */
    public static TextInformationFrame A0F(C02434v c02434v, int i4, String str) {
        if (i4 < 1) {
            return null;
        }
        int iA0I = c02434v.A0I();
        int encoding = i4 - 1;
        byte[] data = new byte[encoding];
        c02434v.A0k(data, 0, i4 - 1);
        return new TextInformationFrame(str, null, A0I(data, iA0I, 0));
    }

    public static UrlLinkFrame A0G(C02434v c02434v, int i4) {
        if (i4 < 1) {
            return null;
        }
        int iA0I = c02434v.A0I();
        ...
        String description = A0L(bArr, descriptionEndIndex, A02(bArr, descriptionEndIndex), AbstractC1633k9.A00);
        return new UrlLinkFrame(A0J(398, 4, 35), str, description);
    }

    public static UrlLinkFrame A0H(C02434v c02434v, int i4, String str) {
        byte[] bArr = new byte[i4];
        c02434v.A0k(bArr, 0, i4);
        return new UrlLinkFrame(str, null, new String(bArr, 0, A02(bArr, 0), AbstractC1633k9.A00));
    }
    ...
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.BP != com.google.common.collect.ImmutableList<java.lang.String> */
    public static BP<String> A0I(byte[] bArr, int i4, int i10) {
        ...
        C2K c2kA01 = BP.A01();
        int valueEndIndex = A03(bArr, i10, i4);
        while (i10 < valueEndIndex) {
            int valueStartIndex = valueEndIndex - i10;
            c2kA01.A04(new String(bArr, i10, valueStartIndex, A0M(i4)));
            i10 = valueEndIndex + A00(i4);
            valueEndIndex = A03(bArr, i10, i4);
        }
        BP<String> bpA05 = c2kA01.A05();
        return bpA05.isEmpty() ? BP.A04(strA0J) : bpA05;
    }

    public static String A0K(int i4, int i10, int i11, int i12, int i13) {
        return i4 == 2 ? String.format(Locale.US, A0J(4, 6, 69), Integer.valueOf(i10), Integer.valueOf(i11), Integer.valueOf(i12)) : String.format(Locale.US, A0J(10, 8, 1), Integer.valueOf(i10), Integer.valueOf(i11), Integer.valueOf(i12), Integer.valueOf(i13));
    }

    public static String A0L(byte[] bArr, int i4, int i10, Charset charset) {
    ...
    public static Charset A0M(int i4) {
        switch (i4) {
            case 1:
                return AbstractC1633k9.A02;
            case 2:
                return AbstractC1633k9.A03;
            case 3:
                return AbstractC1633k9.A05;
            default:
                Charset charset = AbstractC1633k9.A00;
                if (A02[5].charAt(22) == 'F') {
                    throw new RuntimeException();
                }
    ...
    public static /* synthetic */ boolean A0O(int i4, int i10, int i11, int i12, int i13) {
        return false;
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public static boolean A0P(com.instagram.common.viewpoint.core.C02434v r18, int r19, int r20, boolean r21) throws java.lang.Throwable {
        /*
            Method dump skipped, instructions count: 294
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C9U.A0P(com.facebook.ads.redexgen.X.4v, int, int, boolean):boolean");
    }

    public static byte[] A0Q(byte[] bArr, int i4, int i10) {
        if (i10 <= i4) {
            return C5C.A07;
        }
    ...
    @Override // com.instagram.common.viewpoint.core.AbstractC1768mZ
    public final Metadata A0R(C03509e c03509e, ByteBuffer byteBuffer) {
        return A0S(byteBuffer.array(), byteBuffer.limit());
    }

    public final Metadata A0S(byte[] bArr, int i4) {
        ArrayList arrayList = new ArrayList();
        C02434v c02434v = new C02434v(bArr, i4);
        IF ifA0A = A0A(c02434v);
        if (ifA0A == null) {
            return null;
        }
        int startPosition = c02434v.A09();
        int frameHeaderSize = ifA0A.A01 == 2 ? 6 : 10;
        int iA01 = ifA0A.A00;
        if (ifA0A.A02) {
            iA01 = A01(c02434v, ifA0A.A00);
        }
        c02434v.A0e(startPosition + iA01);
        boolean z3 = false;
        if (!A0P(c02434v, ifA0A.A01, frameHeaderSize, false)) {
            if (ifA0A.A01 == 4 && A0P(c02434v, 4, frameHeaderSize, true)) {
                z3 = true;
            } else {
                AbstractC02284g.A07(A0J(170, 10, 14), A0J(88, 45, 57) + ifA0A.A01);
                return null;
            }
        }
        while (c02434v.A07() >= frameHeaderSize) {
            Id3Frame id3FrameA0B = A0B(ifA0A.A01, c02434v, z3, frameHeaderSize, this.A00);
            if (id3FrameA0B != null) {
                arrayList.add(id3FrameA0B);
            }
        }
