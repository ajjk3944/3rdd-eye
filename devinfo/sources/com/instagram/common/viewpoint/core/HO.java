...
public abstract class HO {
    ...
    public static int A00(int i4) {
        ...
        int samplingRate;
        int version;
        if (!A06(i4) || (i10 = (i4 >>> 19) & 3) == 1 || (layer = (i4 >>> 17) & 3) == 0 || (padding = (i4 >>> 12) & 15) == 0 || padding == 15 || (i11 = (i4 >>> 10) & 3) == 3) {
            return -1;
        }
        int i12 = A07[i11];
        if (i10 == 2) {
        ...
        if (i10 == 3) {
            ...
            return (version8 / i12) + i13;
        }
        int version9 = layer == 1 ? 72 : 144;
        return ((version9 * samplingRate) / i12) + i13;
    }

    public static int A01(int i4) {
        int i10;
        int layer;
        if (!A06(i4) || (i10 = (i4 >>> 19) & 3) == 1 || (layer = (i4 >>> 17) & 3) == 0) {
            return -1;
        }
        int i11 = (i4 >>> 12) & 15;
        int version = i4 >>> 10;
        int version2 = version & 3;
        if (i11 == 0 || i11 == 15 || version2 == 3) {
            return -1;
        }
        int version3 = A02(i10, layer);
        return version3;
    }
    ...
    public static boolean A06(int i4) {
