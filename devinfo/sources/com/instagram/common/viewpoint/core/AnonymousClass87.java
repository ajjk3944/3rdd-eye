...
public final class AnonymousClass87 extends AbstractC1640kH {
    ...
    private final List<Intent> A06() {
        List<C0693My> listA05 = A05();
        ArrayList arrayList = new ArrayList();
        if (listA05 != null) {
            Iterator<C0693My> it = listA05.iterator();
            while (it.hasNext()) {
    ...
    public AnonymousClass87(C1436gi c1436gi, VA va2, String str, Uri uri, Map<String, String> extraData, N0 n02, boolean z3, C0700Ng c0700Ng) {
        super(c1436gi, va2, str, n02, z3);
        this.A01 = uri;
        this.A03 = extraData;
        this.A02 = c0700Ng;
    }
    ...
    */
    private android.content.Intent A00(com.instagram.common.viewpoint.core.C0693My r12) {
        /*
    ...
    private Intent A01(C0693My c0693My) {
        Intent intent = new Intent(A04(88, 26, 77));
        intent.addFlags(268435456);
        if (!TextUtils.isEmpty(c0693My.A05()) && !TextUtils.isEmpty(c0693My.A04())) {
            intent.setComponent(new ComponentName(c0693My.A05(), c0693My.A04()));
        }
        if (!TextUtils.isEmpty(c0693My.A03())) {
            intent.setData(XB.A00(c0693My.A03()));
        }
        return intent;
    }
    ...
    private final Uri A02() {
        ...
        String storeUrl2 = A04(WebSocketProtocol.PAYLOAD_SHORT, 22, 5);
        return XB.A00(String.format(locale, storeUrl2, objArr));
    }

    private EnumC0685Mq A03() throws PackageManager.NameNotFoundException, C0938Ws {
        X6 x62 = new X6();
        try {
            return X6.A06(x62, ((AbstractC0688Mt) this).A01, A02(), ((AbstractC0688Mt) this).A03, this.A03);
            ...
            if (queryParameter != null && queryParameter.length() > 0) {
                X6.A0E(x62, ((AbstractC0688Mt) this).A01, XB.A00(queryParameter), ((AbstractC0688Mt) this).A03);
            }
            return EnumC0685Mq.A09;
        }
    }

    private List<C0693My> A05() {
        ...
        try {
            ...
            if (jSONArrayOptJSONArray != null) {
                for (int i4 = 0; i4 < jSONArrayOptJSONArray.length(); i4++) {
                    C0693My c0693MyA00 = C0693My.A00(jSONArrayOptJSONArray.optJSONObject(i4));
                    if (c0693MyA00 != null) {
                        arrayList.add(c0693MyA00);
                    }
                }
            }
        } catch (JSONException e2) {
            InterfaceC0847Tc interfaceC0847TcA08 = ((AbstractC0688Mt) this).A01.A08();
            int i10 = AbstractC0848Td.A24;
            C0849Te c0849Te = new C0849Te(e2);
            String appsiteDataString3 = A04(204, 7, 61);
            interfaceC0847TcA08.ABC(appsiteDataString3, i10, c0849Te);
            String str = A06;
    ...
    private boolean A08() {
        ...
        while (it.hasNext()) {
            if (C0940Wu.A0D(((AbstractC0688Mt) this).A01, it.next())) {
                return true;
            }
        }
        return false;
    ...
    public static boolean A09(C1436gi c1436gi, String str) {
        return Build.VERSION.SDK_INT >= 30 && str != null && C0886Up.A29(c1436gi);
    }

    @Override // com.instagram.common.viewpoint.core.AbstractC1640kH
    public final EnumC0685Mq A0H() {
        EnumC0685Mq enumC0685MqA0M = EnumC0685Mq.A09;
        if (((AbstractC1640kH) this).A03) {
            enumC0685MqA0M = A0M();
        } else {
        ...
        A0J(map, enumC0685MqA0M);
        C0700Ng.A06(this.A02, ((AbstractC0688Mt) this).A01);
        return enumC0685MqA0M;
    }

    public final EnumC0685Mq A0M() {
        EnumC0685Mq enumC0685MqA03 = EnumC0685Mq.A09;
