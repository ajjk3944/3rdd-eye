...
public abstract class AbstractC01511d<F, T> implements Iterator<T> {
    ...
    public AbstractC01511d(Iterator<? extends F> backingIterator) {
        this.A00 = (Iterator) AbstractC1666ki.A04(backingIterator);
    }
