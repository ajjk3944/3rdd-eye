...
public final class C1607jj extends N3 {
    ...
    public NE A03;
    public NF A04;
    public EnumC0901Ve A05;
    public String A06;
    public WeakReference<C1483hT> A07;
    ...
    public C1607jj(C1436gi c1436gi, N4 n42, C1381fp c1381fp, C1618ju c1618ju) {
    ...
    private JSONObject A04(View view) throws JSONException {
        ...
        jSONObject.putOpt(A01(40, 9, FacebookMediationAdapter.ERROR_REQUIRES_ACTIVITY_CONTEXT), Boolean.valueOf(z3));
        ...
        if (view instanceof Button) {
            ...
            boolean z10 = view instanceof MediaView;
        ...
        if (view instanceof ViewGroup) {
            ...
            for (int i4 = 0; i4 < viewGroup.getChildCount(); i4++) {
                JSONObject data = A04(viewGroup.getChildAt(i4));
                list.put(data);
            }
    ...
    private void A07(Map<String, String> map) {
        if (this.A02 != null && (this.A02.getNativeAdLayoutApi() instanceof C1465hB)) {
            C1465hB c1465hB = (C1465hB) this.A02.getNativeAdLayoutApi();
            if (c1465hB.A07()) {
                map.put(A01(87, 7, 108), Boolean.TRUE.toString());
            }
            boolean zA06 = c1465hB.A06();
            if (A0H[2].charAt(5) == '8') {
                throw new RuntimeException();
            }
            String[] strArr = A0H;
    ...
    public final void A08(Map<String, String> map) {
        ...
        if (this.A05 != null) {
            map.put(A01(WebSocketProtocol.PAYLOAD_SHORT, 3, 69), String.valueOf(this.A05.A05()));
        }
        if (this.A09) {
            map.put(A01(AppLovinMediationAdapter.ERROR_CHILD_USER, 3, 87), Boolean.TRUE.toString());
        }
        if (this.A0D) {
    ...
    public final void A0E(EnumC0901Ve enumC0901Ve) {
        this.A05 = enumC0901Ve;
    }
    ...
    public final void A0G(WeakReference<C1483hT> weakReference) {
