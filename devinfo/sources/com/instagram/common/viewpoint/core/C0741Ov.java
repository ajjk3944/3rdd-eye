...
public final class C0741Ov extends Drawable {
    ...
    public C0741Ov(ColorStateList colorStateList, float f10) {
        this.A01 = f10;
        A01(colorStateList);
        this.A0A = new RectF();
        this.A09 = new Rect();
    ...
    private void A02(Rect rect) {
        ...
        this.A09.set(rect);
        if (this.A06) {
            float fA01 = AbstractC0743Ox.A01(this.A00, this.A01, this.A07);
            float vInset = AbstractC0743Ox.A00(this.A00, this.A01, this.A07);
    ...
    public final void A07(float f10, boolean z3, boolean z10) {
        if (f10 == this.A00 && this.A06 == z3 && this.A07 == z10) {
            return;
        }
        this.A00 = f10;
        this.A06 = z3;
