...
public final class C0629Km {
    ...
    public int A05 = LinearLayoutManager.INVALID_OFFSET;
    public float A02 = 1.0f;
    public int A07 = LinearLayoutManager.INVALID_OFFSET;
    ...
    */
    public static float A00(float r6, int r7) {
        /*
            ...
            java.lang.String[] r1 = com.instagram.common.viewpoint.core.C0629Km.A0C
            r0 = 2
            r0 = r1[r0]
            int r1 = r0.length()
            r0 = 32
            ...
            throw r0
        L25:
            java.lang.String[] r2 = com.instagram.common.viewpoint.core.C0629Km.A0C
        ...
        L3c:
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C0629Km.A00(float, int):float");
    }

    public static float A01(int i4) {
        switch (i4) {
            case 4:
                String[] strArr = A0C;
    ...
    public static float A02(int i4, float f10) {
        switch (i4) {
            case 0:
                return 1.0f - f10;
            case 1:
    ...
    public static Layout.Alignment A04(int i4) {
        switch (i4) {
            case 1:
            case 4:
            ...
            default:
                AbstractC02284g.A07(A05(23, 15, 34), A05(0, 23, 23) + i4);
                return null;
        }
    }

    public final C02103o A07() {
        int iA03;
        ...
        C02103o c02103oA0A = new C02103o().A0F(A04(this.A06)).A07(A00(this.A00, this.A04), this.A04).A09(this.A03).A04(fA01).A0A(iA03);
        float f10 = this.A02;
        float position = A02(iA03, fA01);
        C02103o c02103oA0B = c02103oA0A.A06(Math.min(f10, position)).A0B(this.A07);
        if (this.A0A != null) {
            c02103oA0B.A0G(this.A0A);
        }
        return c02103oA0B;
    }

    public final C0622Kf A08() {
        return new C0622Kf(A07().A0H(), this.A09, this.A08);
    }
}
