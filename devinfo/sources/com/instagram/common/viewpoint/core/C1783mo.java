...
public final class C1783mo implements HY {
    public final long A00;
    public final boolean A01;
    public final long[] A02;
    public final long[] A03;

    public C1783mo(long[] jArr, long[] jArr2, long j) {
    ...
    public final HX A91(long j) {
        ...
        if (hz.A01 != j) {
            ...
            if (iA0L != targetIndex - 1) {
                ...
                long j8 = this.A03[targetIndex2];
                int targetIndex3 = iA0L + 1;
                HZ rightSeekPoint = new HZ(j8, this.A02[targetIndex3]);
