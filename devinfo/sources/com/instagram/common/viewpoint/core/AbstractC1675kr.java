...
public abstract class AbstractC1675kr implements InterfaceC0645Lc {
    ...
    public static String A03(int i4, int i10, int i11) {
        ...
        while (true) {
            ...
            byte b10 = (byte) ((bArrCopyOfRange[i12] - i11) - 56);
            if (A02[7].length() == 15) {
                throw new RuntimeException();
            }
    ...
    public abstract boolean A08(File file, long j, int i4);

    static {
        A04();
        A03 = AbstractC1675kr.class.getSimpleName();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void A06(File file) throws IOException {
        C0648Lf.A03(file);
        List<File> files = C0648Lf.A01(file.getParentFile());
        A07(files);
    }

    @Override // com.instagram.common.viewpoint.core.InterfaceC0645Lc
    public void AKR(File file) throws IOException {
        this.A00.submit(new CallableC0649Lg(this, file));
    }
}
