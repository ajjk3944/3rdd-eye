...
public final class KX {
    ...
    public final C02434v A00 = new C02434v();
    ...
    public static char A00(C02434v c02434v, int i4) {
        return (char) c02434v.A0l()[i4];
    }

    public static String A02(C02434v c02434v) {
        int limit = c02434v.A09();
        int iA0A = c02434v.A0A();
        char c9 = 0;
        while (limit < iA0A && c9 == 0) {
            int i4 = limit + 1;
            int position = c02434v.A0l()[limit];
            int limit2 = (char) position;
            c9 = limit2 == 41 ? (char) 1 : (char) 0;
            limit = i4;
        }
        int position2 = c02434v.A09();
        String strTrim = c02434v.A0W((limit - 1) - position2).trim();
    ...
    public static String A03(C02434v c02434v, StringBuilder sb2) {
        sb2.setLength(0);
        int iA09 = c02434v.A09();
        int iA0A = c02434v.A0A();
        boolean z3 = false;
        while (iA09 < iA0A && !z3) {
            int position = c02434v.A0l()[iA09];
        ...
        int position2 = c02434v.A09();
        c02434v.A0g(iA09 - position2);
        return sb2.toString();
    }

    public static String A04(C02434v c02434v, StringBuilder sb2) {
        A09(c02434v);
        if (c02434v.A07() == 0) {
            return null;
        }
        String strA03 = A03(c02434v, sb2);
        String strA01 = A01(0, 0, FacebookMediationAdapter.ERROR_ADVIEW_CONSTRUCTOR_EXCEPTION);
        if (!strA01.equals(strA03)) {
            return strA03;
        }
        String identifier = strA01 + ((char) c02434v.A0I());
        return identifier;
    }

    public static String A05(C02434v c02434v, StringBuilder sb2) {
        StringBuilder sb3 = new StringBuilder();
        boolean z3 = false;
        while (!z3) {
            int iA09 = c02434v.A09();
            String token = A04(c02434v, sb2);
            if (token == null) {
                return null;
            }
    ...
    public static String A06(C02434v c02434v, StringBuilder sb2) {
        A09(c02434v);
        if (c02434v.A07() < 5) {
            return null;
        }
        String strA0W = c02434v.A0W(5);
    ...
    public static void A08(C02434v c02434v) {
        String line;
        do {
            line = c02434v.A0T();
    ...
    public static void A09(C02434v c02434v) {
        boolean skipping = true;
        while (c02434v.A07() > 0 && skipping) {
            boolean zA0E = A0E(c02434v);
            String[] strArr = A03;
            if (strArr[5].charAt(6) == strArr[0].charAt(6)) {
                throw new RuntimeException();
            }
    ...
    public static void A0A(C02434v c02434v, C0618Kb c0618Kb, StringBuilder sb2) {
        A09(c02434v);
        String strA03 = A03(c02434v, sb2);
        String strA01 = A01(0, 0, FacebookMediationAdapter.ERROR_ADVIEW_CONSTRUCTOR_EXCEPTION);
        if (strA01.equals(strA03)) {
        ...
        if (property.length() != 9) {
            ...
            String property2 = A04(c02434v, sb2);
            if (!strA012.equals(property2)) {
                return;
            }
            A09(c02434v);
            String token = A05(c02434v, sb2);
            if (token == null || strA01.equals(token)) {
                return;
            }
            int iA09 = c02434v.A09();
            String strA04 = A04(c02434v, sb2);
            ...
            if (property7.equals(strA03)) {
                ...
                String property9 = A01(237, 5, AppLovinMediationAdapter.ERROR_MISSING_AD_UNIT_ID);
    ...
    private void A0B(C0618Kb c0618Kb, String str) {
        ...
        if (iIndexOf != -1) {
            ...
            if (matcher.matches()) {
                c0618Kb.A0N((String) AbstractC02203y.A01(matcher.group(1)));
            }
        ...
        if (iIndexOf2 != -1) {
            c0618Kb.A0M(str2.substring(0, iIndexOf2));
            int voiceStartIndex = iIndexOf2 + 1;
            c0618Kb.A0L(str2.substring(voiceStartIndex));
        } else {
            c0618Kb.A0M(str2);
        }
        ...
        if (voiceStartIndex2 > 1) {
            ...
            c0618Kb.A0O((String[]) C5C.A1J(strArrA1O, 1, voiceStartIndex3));
        }
    }
    ...
    */
    public static void A0C(java.lang.String r6, com.instagram.common.viewpoint.core.C0618Kb r7) {
        /*
            java.util.regex.Pattern r1 = com.instagram.common.viewpoint.core.KX.A04
            java.lang.String r0 = com.instagram.common.viewpoint.core.AbstractC1631k7.A01(r6)
    ...
    public static boolean A0D(C02434v c02434v) {
        int position = c02434v.A09();
        int limit = c02434v.A0A();
        ...
        if (bArrA0l[i4] == 42) {
            while (i10 + 1 < limit) {
                int i11 = i10 + 1;
                char skippedChar = (char) bArrA0l[i10];
                if (skippedChar == '*') {
                    char skippedChar2 = bArrA0l[i11];
                    if (skippedChar2 == '/') {
                        limit = i11 + 1;
                        i10 = limit;
                    }
            ...
            c02434v.A0g(limit - c02434v.A09());
            return true;
        }
        return false;
    }

    public static boolean A0E(C02434v c02434v) {
        switch (A00(c02434v, c02434v.A09())) {
            case '\t':
            case '\n':
            case '\f':
            case '\r':
    ...
    public final List<C0618Kb> A0F(C02434v c02434v) {
        String selector;
        this.A01.setLength(0);
        int iA09 = c02434v.A09();
        A08(c02434v);
        C02434v c02434v2 = this.A00;
        byte[] bArrA0l = c02434v.A0l();
        int initialInputPosition = c02434v.A09();
        c02434v2.A0j(bArrA0l, initialInputPosition);
        this.A00.A0f(iA09);
        ...
        while (true) {
            ...
            C0618Kb c0618Kb = new C0618Kb();
            A0B(c0618Kb, selector2);
            String strA04 = null;
            boolean z3 = false;
            while (true) {
                ...
                z3 = strA04 == null || selector.equals(strA04);
                if (!z3) {
                    this.A00.A0f(iA092);
                    A0A(this.A00, c0618Kb, this.A01);
                }
            }
            if (selector.equals(strA04)) {
                arrayList.add(c0618Kb);
            }
        }
    }
}
