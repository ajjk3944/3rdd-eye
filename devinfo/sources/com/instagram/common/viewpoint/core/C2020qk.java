...
public final class C2020qk {
    ...
    public /* synthetic */ C2020qk(AbstractC2011qZ abstractC2011qZ) {
        this();
    }
    ...
    public final int A02(Collection<?> collection) {
        C2010qY.A09(collection, A00(31, 1, 39));
        int i4 = 1;
    ...
    public final void A03(int i4, int i10) {
        if (i4 >= 0 && i4 < i10) {
            ...
            throw new IndexOutOfBoundsException(A00(43, 7, 95) + i4 + A00(12, 8, 8) + i10);
        }
    }

    public final void A04(int i4, int i10) {
        if (i4 >= 0 && i4 <= i10) {
        } else {
            throw new IndexOutOfBoundsException(A00(43, 7, 95) + i4 + A00(12, 8, 8) + i10);
        }
    ...
    public final void A05(int i4, int i10, int i11) {
        String strA00 = A00(32, 11, 71);
        if (i4 >= 0 && i10 <= i11) {
            if (i4 <= i10) {
                return;
            } else {
                throw new IllegalArgumentException(strA00 + i4 + A00(0, 12, 21) + i10);
            }
        }
        throw new IndexOutOfBoundsException(strA00 + i4 + A00(20, 11, 49) + i10 + A00(12, 8, 8) + i11);
    }

    public final boolean A06(Collection<?> collection, Collection<?> collection2) {
        C2010qY.A09(collection, A00(31, 1, 39));
        C2010qY.A09(collection2, A00(50, 5, 95));
        ...
        while (it2.hasNext()) {
            if (!C2010qY.A0C(it2.next(), it.next())) {
                return false;
            }
        }
        return true;
