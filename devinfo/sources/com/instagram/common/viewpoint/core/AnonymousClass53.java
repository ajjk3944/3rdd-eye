...
public final class AnonymousClass53 {
    ...
    public final synchronized long A06(long j) {
        ...
        if (this.A01 != -9223372036854775807L) {
            ...
            long j8 = (4294967296L + jA01) / 8589934592L;
            long j9 = ((j8 - 1) * 8589934592L) + j;
            long j10 = (8589934592L * j8) + j;
            if (Math.abs(j9 - jA01) >= Math.abs(j10 - jA01)) {
                j9 = j10;
            }
            j = j9;
        }
    ...
    public final synchronized long A05(long j) {
        ...
        if (this.A02 == -9223372036854775807L) {
            if (this.A00 == 9223372036854775806L) {
                desiredSampleTimestampUs = ((Long) AbstractC02203y.A01(this.A03.get())).longValue();
            } else {
