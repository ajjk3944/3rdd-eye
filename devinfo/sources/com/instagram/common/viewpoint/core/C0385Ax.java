...
public class C0385Ax<E> extends AbstractC2017qh<E> {
    public final /* synthetic */ Set A00;
    public final /* synthetic */ Set A01;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C0385Ax(final Set val$set1, final Set val$set2) {
        super(null);
        this.A00 = val$set1;
        this.A01 = val$set2;
    }
    ...
    public final C4C<E> iterator() {
        return new AbstractC0409Bv<E>() { // from class: com.facebook.ads.redexgen.X.28
