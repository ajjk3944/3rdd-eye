...
public final class C1699lG implements InterfaceC0638Kv {
    ...
    public C1699lG(String str) {
        this.A02 = 0;
        this.A09 = new C02434v(4);
        this.A09.A0l()[0] = -1;
        this.A0A = new HN();
    ...
    */
    private void A00(com.instagram.common.viewpoint.core.C02434v r10) {
        /*
            r9 = this;
            byte[] r8 = r10.A0l()
            int r4 = r10.A09()
        ...
        L24:
            r9.A08 = r2
            java.lang.String[] r2 = com.instagram.common.viewpoint.core.C1699lG.A0C
            r0 = 1
            r1 = r2[r0]
            r0 = 4
            r2 = r2[r0]
        ...
        L6c:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C1699lG.A00(com.facebook.ads.redexgen.X.4v):void");
    }

    @RequiresNonNull({"output"})
    private void A01(C02434v c02434v) {
        int iMin = Math.min(c02434v.A07(), this.A01 - this.A00);
        this.A05.AIr(c02434v, iMin);
        ...
        if (this.A04 != -9223372036854775807L) {
            InterfaceC0543Hd interfaceC0543Hd = this.A05;
            String[] strArr = A0C;
            String str = strArr[5];
            ...
            interfaceC0543Hd.AIu(this.A04, 1, this.A01, 0, null);
            this.A04 += this.A03;
        }
        this.A00 = 0;
        this.A02 = 0;
    ...
    @RequiresNonNull({"output"})
    private void A02(C02434v c02434v) {
        int iMin = Math.min(c02434v.A07(), 4 - this.A00);
        byte[] bArrA0l = this.A09.A0l();
        int bytesToRead = this.A00;
        c02434v.A0k(bArrA0l, bytesToRead, iMin);
        ...
        if (!this.A07) {
            ...
            C01872p c01872pA0h = new C01872p().A0y(this.A06).A11(this.A0A.A06).A0h(Buffer.SEGMENTING_THRESHOLD);
            int bytesToRead8 = this.A0A.A01;
            C01872p c01872pA0b = c01872pA0h.A0b(bytesToRead8);
            int bytesToRead9 = this.A0A.A03;
            this.A05.A6e(c01872pA0b.A0m(bytesToRead9).A10(this.A0B).A14());
            this.A07 = true;
        }
        this.A09.A0f(0);
