...
public final class B3 {
    ...
    public B3(String str, String str2, String str3, MediaCodecInfo.CodecCapabilities codecCapabilities, boolean z3, boolean z10, boolean z11, boolean z12, boolean z13, boolean z14) {
        this.A03 = (String) AbstractC02203y.A01(str);
        this.A02 = str2;
        this.A01 = str3;
    ...
    */
    public static int A00(java.lang.String r5, java.lang.String r6, int r7) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.B3.A00(java.lang.String, java.lang.String, int):int");
    }

    public static Point A01(MediaCodecInfo.VideoCapabilities videoCapabilities, int i4, int i10) {
        int heightAlignment = videoCapabilities.getWidthAlignment();
        int widthAlignment = videoCapabilities.getHeightAlignment();
        return new Point(C5C.A05(i4, heightAlignment) * heightAlignment, C5C.A05(i10, widthAlignment) * widthAlignment);
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public static com.instagram.common.viewpoint.core.B3 A02(java.lang.String r14, java.lang.String r15, java.lang.String r16, android.media.MediaCodecInfo.CodecCapabilities r17, boolean r18, boolean r19, boolean r20, boolean r21, boolean r22) {
        /*
            ...
            if (r8 == 0) goto L20
            boolean r3 = A09(r8)
            java.lang.String[] r1 = com.instagram.common.viewpoint.core.B3.A0C
            r0 = 2
            r0 = r1[r0]
            int r1 = r0.length()
            r0 = 8
        ...
        L20:
            ...
            goto L32
        L22:
            java.lang.String[] r2 = com.instagram.common.viewpoint.core.B3.A0C
        ...
        L55:
            ...
            goto L3b
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.B3.A02(java.lang.String, java.lang.String, java.lang.String, android.media.MediaCodecInfo$CodecCapabilities, boolean, boolean, boolean, boolean, boolean):com.facebook.ads.redexgen.X.B3");
    }

    private void A05(String str) {
        StringBuilder sbAppend = new StringBuilder().append(A03(39, 16, 85)).append(str);
        String strA03 = A03(261, 3, 33);
        AbstractC02284g.A04(A03(97, 14, 99), sbAppend.append(strA03).append(this.A03).append(A03(4, 2, 43)).append(this.A02).append(strA03).append(C5C.A04).append(A03(260, 1, 72)).toString());
    }
    ...
    public static boolean A0F(MediaCodecInfo.VideoCapabilities videoCapabilities, int i4, int i10, double d10) {
        Point alignedSize = A01(videoCapabilities, i4, i10);
        int i11 = alignedSize.x;
        int i12 = alignedSize.y;
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    private boolean A0G(com.instagram.common.viewpoint.core.C1996qI r12, boolean r13) throws java.lang.NumberFormatException {
        /*
            Method dump skipped, instructions count: 327
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.B3.A0G(com.facebook.ads.redexgen.X.qI, boolean):boolean");
    }
    ...
    public static boolean A0L(String str, int i4) {
        if (A03(751, 10, 121).equals(str) && 2 == i4) {
    ...
    public final Point A0N(int i4, int i10) {
        MediaCodecInfo.VideoCapabilities videoCapabilities;
        if (this.A00 == null || (videoCapabilities = this.A00.getVideoCapabilities()) == null) {
            return null;
        }
        return A01(videoCapabilities, i4, i10);
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final com.instagram.common.viewpoint.core.C6L A0O(com.instagram.common.viewpoint.core.C1996qI r13, com.instagram.common.viewpoint.core.C1996qI r14) throws java.lang.NumberFormatException {
        /*
            Method dump skipped, instructions count: 256
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.B3.A0O(com.facebook.ads.redexgen.X.qI, com.facebook.ads.redexgen.X.qI):com.facebook.ads.redexgen.X.6L");
    }

    public final boolean A0P(int i4) {
        if (this.A00 == null) {
            A06(A03(451, 17, 59));
            return false;
        }
        ...
        if (A00(this.A03, this.A02, audioCapabilities.getMaxInputChannelCount()) < i4) {
            A06(A03(468, 22, 78) + i4);
            return false;
        }
        return true;
    }

    public final boolean A0Q(int i4) {
        if (this.A00 == null) {
            A06(A03(563, 15, 4));
            return false;
        }
        ...
        if (!audioCapabilities.isSampleRateSupported(i4)) {
            A06(A03(578, 20, FacebookMediationAdapter.ERROR_NULL_CONTEXT) + i4);
            return false;
        }
        return true;
    }

    public final boolean A0R(int i4, int i10, double d10) {
        if (this.A00 == null) {
            if (A0C[4].length() != 17) {
                throw new RuntimeException();
            }
        ...
        if (i11 >= 29) {
            int iA00 = B1.A00(videoCapabilities, i4, i10, d10);
            if (iA00 == 2) {
                return true;
            }
            if (iA00 == 1) {
                A06(A03(629, 19, 41) + i4 + strA032 + i10 + strA03 + d10);
                return false;
            }
        }
        if (!A0F(videoCapabilities, i4, i10, d10)) {
            if (i4 >= i10 || !A0K(this.A03) || !A0F(videoCapabilities, i10, i4, d10)) {
                A06(A03(669, 21, AppLovinMediationAdapter.ERROR_MISSING_AD_UNIT_ID) + i4 + strA032 + i10 + strA03 + d10);
                return false;
            }
            A05(A03(648, 21, 5) + i4 + strA032 + i10 + strA03 + d10);
        }
        return true;
    }

    @MetaExoPlayerCustomization(type = {"DEPRECATED_LOGIC"}, value = "D51676338: Control Renderer Support behavior")
    public final boolean A0S(C1996qI c1996qI) {
        String strA07;
        if (c1996qI.A0R == null || this.A02 == null || (strA07 = C3J.A07(c1996qI.A0R)) == null) {
            return true;
        }
        ...
        if (!codecMimeType.equals(strA07)) {
            ...
            String codecMimeType3 = c1996qI.A0R;
        ...
        return A0G(c1996qI, true);
    }

    public final boolean A0T(C1996qI c1996qI) throws NumberFormatException {
        if (this.A0A) {
            boolean z3 = this.A04;
        ...
        Pair<Integer, Integer> profileLevel = C0388Ba.A0B(c1996qI);
        return profileLevel != null && ((Integer) profileLevel.first).intValue() == 42;
    }

    @Deprecated
    public final boolean A0U(C1996qI c1996qI, C1996qI c1996qI2, boolean z3) {
        if (!z3 && c1996qI.A0N != null) {
            ColorInfo colorInfo = c1996qI2.A0N;
            String[] strArr = A0C;
            ...
            A0C[2] = "CiueF8sE";
            if (colorInfo == null) {
                c1996qI2 = c1996qI2.A07().A0t(c1996qI.A0N).A14();
            }
        }
        int i4 = A0O(c1996qI, c1996qI2).A01;
        return i4 == 2 || i4 == 3;
    }
