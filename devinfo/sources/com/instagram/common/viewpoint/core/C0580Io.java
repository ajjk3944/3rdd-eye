...
public final class C0580Io {
    ...
    public int A0F = -1;
    public int A0O = 1000;
    public int A0P = TTAdConstant.MATE_VALID;
     ...
     */
    public static Pair<String, List<byte[]>> A02(C02434v c02434v) throws C3K {
        try {
            c02434v.A0g(16);
            long jA0O = c02434v.A0O();
            if (jA0O == 1482049860) {
            ...
            A0q[2] = "JoNevXQ";
            if (jA0O != 826496599) {
                AbstractC02284g.A07(A03(312, 17, 46), A03(492, 51, 65));
                return new Pair<>(A03(1189, 15, 45), null);
            }
            byte[] bArrA0l = c02434v.A0l();
            for (int iA09 = c02434v.A09() + 20; iA09 < bArrA0l.length - 4; iA09++) {
    ...
    public static List<byte[]> A05(byte[] bArr) throws C3K {
        ...
        try {
            if (bArr[0] == 2) {
                ...
                int i10 = vorbisInfoLength + 1;
                int i11 = i4 + (bArr[vorbisInfoLength] & 255);
                int offset = 0;
                while ((bArr[i10] & 255) == 255) {
                    offset += 255;
                    i10++;
                }
                int vorbisInfoLength2 = i10 + 1;
                int offset2 = offset + (bArr[i10] & 255);
                if (bArr[vorbisInfoLength2] == 1) {
                    byte[] bArr2 = new byte[i11];
                    System.arraycopy(bArr, vorbisInfoLength2, bArr2, 0, i11);
                    int vorbisInfoLength3 = vorbisInfoLength2 + i11;
    ...
    public void A06() {
        AbstractC02203y.A01(this.A0b);
    }

    public static boolean A09(C02434v c02434v) throws C3K {
        try {
            ...
            c02434v.A0f(24);
            if (c02434v.A0P() == MatroskaExtractor.A0x.getMostSignificantBits()) {
                if (c02434v.A0P() == MatroskaExtractor.A0x.getLeastSignificantBits()) {
                    return true;
                }
            }
            return false;
    ...
    public final void A0E() {
        if (this.A0c != null) {
            C0544He c0544He = this.A0c;
            InterfaceC0543Hd interfaceC0543Hd = this.A0b;
            String[] strArr = A0q;
            ...
            c0544He.A05(interfaceC0543Hd, this.A0a);
        }
    }
    ...
    */
    public final void A0G(com.instagram.common.viewpoint.core.HA r20, int r21) throws com.instagram.common.viewpoint.core.C3K {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C0580Io.A0G(com.facebook.ads.redexgen.X.HA, int):void");
    }
}
