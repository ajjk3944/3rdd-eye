...
public final class C1772md implements H9 {
    ...
    public boolean A09;
    public boolean A0A;
    public final C02434v A0C = new C02434v(4);
    public final C02434v A0B = new C02434v(9);
    public final C02434v A0E = new C02434v(11);
    public final C02434v A0D = new C02434v();
    public final C1771mc A0F = new C1771mc();
    public int A01 = 1;
    ...
    private C02434v A01(InterfaceC1787ms interfaceC1787ms) throws IOException {
        ...
        interfaceC1787ms.readFully(this.A0D.A0l(), 0, this.A02);
        return this.A0D;
    }
    ...
    private void A02() {
        if (!this.A0A) {
            this.A06.AJ7(new C1782mn(-9223372036854775807L));
            this.A0A = true;
        }
    }

    private void A03(InterfaceC1787ms interfaceC1787ms) throws IOException {
    ...
    @RequiresNonNull({"extractorOutput"})
    private boolean A04(InterfaceC1787ms interfaceC1787ms) throws IOException {
        if (!interfaceC1787ms.AHR(this.A0B.A0l(), 0, 9, true)) {
            return false;
        }
        this.A0B.A0f(0);
        C02434v c02434v = this.A0B;
        String[] strArr = A0G;
        if (strArr[5].charAt(7) == strArr[0].charAt(7)) {
            throw new RuntimeException();
        }
        ...
        boolean hasAudio = i4 != 0;
        if (z3 && this.A07 == null) {
            this.A07 = new C1774mf(this.A06.AKS(8, 1));
        }
        if (hasAudio && this.A08 == null) {
            this.A08 = new C1769ma(this.A06.AKS(9, 2));
        }
        this.A06.A6O();
    ...
    */
    private boolean A05(com.instagram.common.viewpoint.core.InterfaceC1787ms r12) throws java.io.IOException {
        /*
            r11 = this;
            r10 = 1
            r9 = 0
        ...
        L23:
            ...
            if (r0 != 0) goto L5b
            long r3 = r11.A05
            java.lang.String[] r2 = com.instagram.common.viewpoint.core.C1772md.A0G
            r0 = 5
            r1 = r2[r0]
            r0 = 0
            r2 = r2[r0]
        ...
        Lb6:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C1772md.A05(com.facebook.ads.redexgen.X.ms):boolean");
    }

    private boolean A06(InterfaceC1787ms interfaceC1787ms) throws IOException {
        if (!interfaceC1787ms.AHR(this.A0E.A0l(), 0, 11, true)) {
            return false;
        }
        this.A0E.A0f(0);
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final int AHL(com.instagram.common.viewpoint.core.InterfaceC1787ms r6, com.instagram.common.viewpoint.core.HV r7) throws java.io.IOException {
        /*
            r5 = this;
            com.facebook.ads.redexgen.X.HA r0 = r5.A06
            com.instagram.common.viewpoint.core.AbstractC02203y.A02(r0)
        L5:
            int r0 = r5.A01
            r4 = -1
            switch(r0) {
        ...
        L11:
            ...
            java.lang.String[] r1 = com.instagram.common.viewpoint.core.C1772md.A0G
            r0 = 6
            r1 = r1[r0]
            r0 = 17
            char r1 = r1.charAt(r0)
        ...
        L79:
            ...
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C1772md.AHL(com.facebook.ads.redexgen.X.ms, com.facebook.ads.redexgen.X.HV):int");
    }
    ...
    public final boolean AK5(InterfaceC1787ms interfaceC1787ms) throws IOException {
        interfaceC1787ms.AGt(this.A0C.A0l(), 0, 3);
        this.A0C.A0f(0);
        if (this.A0C.A0K() != 4607062) {
            return false;
        }
        interfaceC1787ms.AGt(this.A0C.A0l(), 0, 2);
        this.A0C.A0f(0);
        if ((this.A0C.A0M() & 250) != 0) {
            return false;
        }
        interfaceC1787ms.AGt(this.A0C.A0l(), 0, 4);
        this.A0C.A0f(0);
        int dataOffset = this.A0C.A0C();
        interfaceC1787ms.AIl();
        interfaceC1787ms.A47(dataOffset);
        interfaceC1787ms.AGt(this.A0C.A0l(), 0, 4);
        this.A0C.A0f(0);
