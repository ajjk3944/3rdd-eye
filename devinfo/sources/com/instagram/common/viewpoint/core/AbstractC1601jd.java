...
public abstract class AbstractC1601jd extends NQ implements Serializable {
    ...
    public int A05 = PAGErrorCode.LOAD_FACTORY_NULL_CODE;
    ...
    public AbstractC1601jd(List<NR> list) {
        this.A0P = list;
    }
    ...
    public static List<NR> A08(JSONObject jSONObject, C1436gi c1436gi, InterfaceC0698Ne interfaceC0698Ne) {
        JSONArray jSONArrayOptJSONArray = jSONObject.optJSONArray(A05(156, 8, 28));
        if (jSONArrayOptJSONArray != null && jSONArrayOptJSONArray.length() > 0) {
            return NZ.A01(jSONArrayOptJSONArray, jSONObject, c1436gi, interfaceC0698Ne);
        }
        List<AdInfo> adInfoList = new ArrayList<>();
        NR nrA00 = NR.A00(jSONObject);
        interfaceC0698Ne.A3y(nrA00, jSONObject);
    ...
    private final void A0D(C0700Ng c0700Ng) {
        this.A07 = c0700Ng;
    }

    private void A0E(C0703Nj c0703Nj) {
        this.A08 = c0703Nj;
    }

    private final void A0F(C0706Nm c0706Nm) {
        this.A09 = c0706Nm;
    }

    private void A0G(C0712Ns c0712Ns) {
        this.A0A = c0712Ns;
    }
    ...
    public final C0700Ng A2A() {
        return this.A07;
    }

    public final C0703Nj A2B() {
        return this.A08;
    }

    public final C0706Nm A2C() {
        return this.A09;
    }

    public final C0712Ns A2D() {
        return this.A0A;
    }
    ...
    */
    public final void A2H(com.instagram.common.viewpoint.core.InterfaceC0977Yh r5) {
        /*
            r4 = this;
        ...
        L10:
            ...
            r5.A4j(r0)
        L1d:
            com.facebook.ads.redexgen.X.ez r0 = com.instagram.common.viewpoint.core.EnumC1329ez.A08
        ...
        L39:
            ...
            goto Lc
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.AbstractC1601jd.A2H(com.facebook.ads.redexgen.X.Yh):void");
    }

    public final void A2I(JSONObject jSONObject) {
        String strA05;
        A0D(C0700Ng.A00(jSONObject.optJSONObject(A05(301, 16, 74))));
        A0R = jSONObject.optJSONObject(A05(144, 12, 40));
        C0705Nl c0705NlA06 = new C0705Nl().A06(jSONObject.optString(A05(591, 5, 77)));
        ...
        A0F(c0705NlA06.A05(strA05).A04(jSONObject.optString(A05(0, 19, 64))).A07(AbstractC0707Nn.A03(jSONObject)).A08());
        ...
        C0694Na c0694NaA01 = C0694Na.A01(layoutObject);
        String[] strArr = A0T;
        ...
        A0C(new NN(c0694NaA01, C0694Na.A01(jSONObjectOptJSONObject != null ? jSONObjectOptJSONObject.optJSONObject(A05(361, 9, 71)) : null)));
        A0G(AbstractC0707Nn.A01(jSONObject));
        A0E(AbstractC0707Nn.A00(jSONObject));
        ...
        this.A05 = jSONObject.optInt(A05(50, 36, 36), PAGErrorCode.LOAD_FACTORY_NULL_CODE);
