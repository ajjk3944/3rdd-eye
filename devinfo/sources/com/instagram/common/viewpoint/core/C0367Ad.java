...
public final class C0367Ad implements List, Serializable, RandomAccess {
    public static byte[] A00 = null;
    public static final C0367Ad A01;
    ...
    public final <T> T[] toArray(T[] tArr) {
        C2010qY.A09(tArr, A03(115, 5, 5));
        return (T[]) AbstractC2012qa.A03(this, tArr);
    }
    ...
    private final Void A04(int i4) {
        throw new IndexOutOfBoundsException(A03(11, 44, 74) + i4 + '.');
    }
    ...
    public final boolean containsAll(Collection elements) {
        C2010qY.A09(elements, A03(127, 8, WebSocketProtocol.PAYLOAD_SHORT));
    ...
    public final String toString() {
        return A03(AppLovinMediationAdapter.ERROR_MISSING_AD_UNIT_ID, 2, FacebookMediationAdapter.ERROR_ADVIEW_CONSTRUCTOR_EXCEPTION);
    }
}
