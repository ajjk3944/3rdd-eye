...
public final class C0880Uj implements Closeable {
    ...
    public final UZ A01;
    public final Deque<C0879Ui> A02 = new LinkedList();
    ...
    public final synchronized int A09() throws IOException {
        ...
        iA01 = 0;
        Iterator<C0879Ui> it = this.A02.iterator();
        while (it.hasNext()) {
            iA01 += it.next().A01();
        }
        return iA01;
    ...
    public C0880Uj(UZ uz, InterfaceC0878Uh interfaceC0878Uh) throws NumberFormatException, IOException {
        this.A01 = uz;
        A05(uz, interfaceC0878Uh);
        if (this.A02.isEmpty()) {
            A00();
        }
    }

    private C0879Ui A00() throws IOException {
        int iA00 = -1;
        if (!this.A02.isEmpty()) {
            iA00 = this.A02.getLast().A00();
        }
        int i4 = iA00 + 1;
        this.A02.add(new C0879Ui(i4, new C0876Uf(new File(this.A01.A05(), A01(i4)))));
    ...
    private void A04(int i4, File file) throws IOException {
        C0876Uf c0876Uf = new C0876Uf(file);
        c0876Uf.A05();
        this.A02.addFirst(new C0879Ui(i4, c0876Uf));
    }

    private void A05(UZ uz, InterfaceC0878Uh interfaceC0878Uh) throws NumberFormatException, IOException {
        ...
        if (fileArrListFiles != null) {
            ...
            for (File file : fileArrListFiles) {
                try {
                    ...
                    hashSet.add(file);
                    interfaceC0878Uh.AIc(String.format(Locale.US, A02(260, 39, 118), file.getCanonicalPath()));
                }
            }
            ...
            if (!zIsEmpty) {
                int i11 = i4;
                while (map.containsKey(Integer.valueOf(i11 - 1))) {
                    i11--;
                }
                ...
                while (it.hasNext()) {
                    ...
                    if (iIntValue < i11) {
                        interfaceC0878Uh.AIc(String.format(Locale.US, A02(166, 61, 41), Integer.valueOf(iIntValue), Integer.valueOf(i11)));
                ...
                while (i4 >= i11) {
                    ...
                    try {
                        ...
                        interfaceC0878Uh.AId(String.format(Locale.US, A02(104, 62, 55), file2.getCanonicalPath(), Integer.valueOf(i4)), e2);
            ...
            for (Object obj : hashSet) {
                ...
                if (!file3.delete()) {
                    ...
                    if (A04[7].charAt(19) != 'm') {
                        ...
                        interfaceC0878Uh.AIc(String.format(locale, A02(40, 26, 116), objArr));
                    } else {
                        A04[7] = "xgRJlHLuW2qx7z7dN03x9GIdgxBOKXSD";
                        objArr[0] = canonicalPath;
                        interfaceC0878Uh.AIc(String.format(locale, A02(38, 20, 82), objArr));
                    }
                }
            }
            return;
    ...
    public final synchronized UX A0A(int i4, int i10, byte[] bArr, int i11, int[] iArr, int i12) throws IOException {
        if (!this.A00) {
            for (C0879Ui file : this.A02) {
                if (file.A00() == i4) {
                    return new UX(i4, file.A02(i10, bArr, i11, iArr, i12));
                }
            }
    ...
    public final synchronized boolean A0D() throws IOException {
        if (!this.A00) {
            ...
            C0879Ui first = this.A02.getFirst();
