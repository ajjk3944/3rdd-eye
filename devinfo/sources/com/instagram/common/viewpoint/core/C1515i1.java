...
public class C1515i1 extends PL {
    ...
    public final void A08(View view, Q6 q62) {
        ...
        if (this.A00.canScrollHorizontally(1)) {
            ...
            q62.A0N(Buffer.SEGMENTING_THRESHOLD);
        }
        if (this.A00.canScrollHorizontally(-1)) {
            q62.A0N(Segment.SIZE);
        }
    }

    @Override // com.instagram.common.viewpoint.core.PL
    public final boolean A09(View view, int i4, Bundle bundle) throws Resources.NotFoundException {
