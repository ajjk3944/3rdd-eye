...
public final class C02374p {
    public static C02374p A04;
    ...
    public final CopyOnWriteArrayList<WeakReference<InterfaceC02354n>> A03 = new CopyOnWriteArrayList<>();
    ...
    public C02374p(Context context) {
        IntentFilter intentFilter = new IntentFilter();
        intentFilter.addAction(A04(0, 36, 40));
        context.registerReceiver(new C02364o(this), intentFilter);
    }
    ...
    public static synchronized C02374p A03(Context context) {
        if (A04 == null) {
            A04 = new C02374p(context);
        }
        return A04;
    }

    private void A05() {
        Iterator<WeakReference<InterfaceC02354n>> it = this.A03.iterator();
        while (it.hasNext()) {
            WeakReference<InterfaceC02354n> next = it.next();
            if (next.get() == null) {
    ...
    public void A07(int i4) {
        synchronized (this.A02) {
            ...
            while (it.hasNext()) {
                WeakReference<InterfaceC02354n> next = it.next();
                InterfaceC02354n interfaceC02354n = next.get();
                if (interfaceC02354n != null) {
                    interfaceC02354n.AF1(i4);
                } else {
                    this.A03.remove(next);
                }
            }
    ...
    public final void A0A(final InterfaceC02354n interfaceC02354n) {
        A05();
        this.A03.add(new WeakReference<>(interfaceC02354n));
        this.A01.post(new Runnable() { // from class: com.facebook.ads.redexgen.X.4j
            @Override // java.lang.Runnable
            public final void run() {
                this.A01.A0B(interfaceC02354n);
            }
        });
    }

    public final /* synthetic */ void A0B(InterfaceC02354n interfaceC02354n) {
        interfaceC02354n.AF1(A09());
    }
}
