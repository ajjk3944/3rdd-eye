...
public abstract class AbstractC02304i {
    ...
    public static void A04(MediaFormat mediaFormat, String str, int i4) {
        if (i4 != -1) {
    ...
    */
    public static void A06(android.media.MediaFormat r5, java.util.List<byte[]> r6) {
        ...
        L31:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.AbstractC02304i.A06(android.media.MediaFormat, java.util.List):void");
    }
}
