...
public final class C0932Wl {
    public static C0932Wl A03;
    ...
    public final C0931Wk A01 = new C0931Wk();
    ...
    public C0932Wl(T8 t82) {
        this.A00 = t82;
    }

    public static C0932Wl A00(T8 t82) {
        if (A03 == null) {
            A03 = new C0932Wl(t82);
        }
        return A03;
    ...
    public final int A0A(String str) {
        ...
        if (str.equals(AdPlacementType.MEDIUM_RECTANGLE.toString())) {
            return this.A01.A03(this.A00, A01(88, 26, AppLovinMediationAdapter.ERROR_CHILD_USER), 0);
        }
        ...
        A05[3] = "fotbcTaHfC";
        return c0931Wk.A03(t82, strA01, 0);
    }
                ...
                try {
                    ...
                    if (!A08(str, clientToken)) {
                        ...
                        if (!jSONObject.has(strA01)) {
                            ...
                            if (System.currentTimeMillis() - jSONObject.getLong(strA01) < C0886Up.A02(this.A00)) {
    ...
    public final void A0C(String str) throws JSONException {
        try {
            ...
            String string = jSONObject.getString(A01(14, 2, WebSocketProtocol.PAYLOAD_SHORT));
            String clientToken = jSONArray.getJSONObject(0).getJSONObject(A01(20, 10, 63)).getString(A01(177, 4, WebSocketProtocol.PAYLOAD_SHORT));
    ...
    public final boolean A0F(String str) {
        return !C0886Up.A1A(this.A00) && (str.equals(AdPlacementType.BANNER.toString()) || str.equals(AdPlacementType.MEDIUM_RECTANGLE.toString()));
    }
}
