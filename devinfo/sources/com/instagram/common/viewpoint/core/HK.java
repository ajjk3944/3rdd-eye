...
public final class HK {
    ...
    private boolean A02(String str) throws NumberFormatException {
        ...
        if (matcher.find()) {
            try {
                int i4 = Integer.parseInt((String) C5C.A0f(matcher.group(1)), 16);
                int i10 = Integer.parseInt((String) C5C.A0f(matcher.group(2)), 16);
                if (i4 > 0 || i10 > 0) {
                    this.A00 = i4;
                    this.A01 = i10;
                    return true;
    ...
    public final boolean A04(int i4) {
        int encoderPadding = i4 >> 12;
        int encoderDelay = i4 & 4095;
    ...
    */
    public final boolean A05(com.facebook.ads.androidx.media3.common.Metadata r9) {
        ...
        L59:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.HK.A05(com.facebook.ads.androidx.media3.common.Metadata):boolean");
    }
}
