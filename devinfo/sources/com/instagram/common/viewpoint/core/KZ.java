...
public final class KZ extends AbstractC1149c3 implements XQ {
    ...
    public KZ(C1153c7 c1153c7, boolean z3) {
        FrameLayout.LayoutParams layoutParams;
        super(c1153c7, true);
        this.A02 = c1153c7.A0C();
        this.A00 = c1153c7.A05();
        RelativeLayout relativeLayout = new RelativeLayout(c1153c7.A06());
        RelativeLayout.LayoutParams layoutParams2 = new RelativeLayout.LayoutParams(-1, -2);
        layoutParams2.addRule(12);
        YB.A0U(relativeLayout, getAdContextWrapper());
        LinearLayout linearLayout = new LinearLayout(c1153c7.A06());
        linearLayout.setOrientation(!z3 ? 1 : 0);
        linearLayout.setGravity(80);
        YB.A0K(linearLayout);
        RelativeLayout.LayoutParams layoutParams3 = new RelativeLayout.LayoutParams(-1, -2);
        layoutParams3.setMargins(AbstractC1149c3.A08, 0, AbstractC1149c3.A08, AbstractC1149c3.A08);
        LinearLayout.LayoutParams layoutParams4 = new LinearLayout.LayoutParams(z3 ? -2 : -1, -2);
        layoutParams4.setMargins(z3 ? AbstractC1149c3.A08 : 0, z3 ? 0 : AbstractC1149c3.A08, 0, 0);
        ...
        if (c1153c7.A0H() && !z3) {
            C1273e4 c1273e4 = new C1273e4(c1153c7.A06());
            c1273e4.setPageDetails(c1153c7.A05().A2C());
            int iA05 = this.A07.A05().A28().A00().A05(true);
            c1273e4.A02(iA05, iA05);
            YB.A0G(1007, c1273e4);
            LinearLayout.LayoutParams layoutParams6 = new LinearLayout.LayoutParams(-1, -2);
            layoutParams6.setMargins(0, AbstractC1149c3.A08, 0, 0);
            linearLayout.addView(c1273e4, layoutParams6);
            if (C0886Up.A18(c1153c7.A06())) {
                c1273e4.setOnClickListener(getCtaButton());
            }
        }
        ...
        if (viewA02 != null && (xrA02.A00 || C0886Up.A1J(getAdContextWrapper()))) {
            if (z3) {
            ...
            if (xrA02.A00) {
                ...
                AbstractC1096bC.A00(viewA02, C0886Up.A1K(getAdContextWrapper()), new ViewOnClickListenerC1146c0(this));
            }
