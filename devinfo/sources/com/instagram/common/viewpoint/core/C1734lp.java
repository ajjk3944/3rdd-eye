...
public class C1734lp<V> extends AbstractCollection<V> {
    ...
    public boolean removeAll(Collection<?> c9) {
        ...
        int size = size();
        boolean zRemoveAll = this.A00.removeAll(c9);
        if (zRemoveAll) {
            C2L.A02(this.A04, this.A00.size() - size);
            A05();
        }
    ...
    public C1734lp(@ParametricNullness final C2L this$0, @CheckForNull Object key, Collection delegate, C1734lp ancestor) {
        this.A04 = this$0;
        this.A02 = key;
        this.A00 = delegate;
        this.A01 = ancestor;
    ...
    public final boolean remove(@CheckForNull Object o4) {
        A04();
        boolean zRemove = this.A00.remove(o4);
        if (zRemove) {
            C2L.A01(this.A04);
            A05();
        }
    ...
    public final boolean retainAll(Collection<?> c9) {
        AbstractC1666ki.A04(c9);
        int size = size();
        boolean zRetainAll = this.A00.retainAll(c9);
        if (zRetainAll) {
