...
public final class Z3 extends RelativeLayout {
    ...
    public Z3(C1436gi c1436gi, int i4, int i10, String str, String str2, String str3, String str4, Bitmap bitmap) {
        super(c1436gi);
        this.A05 = new TextView(c1436gi);
        this.A02 = new Button(c1436gi);
        this.A01 = new Button(c1436gi);
        ...
        int iA02 = P3.A02(i10, 20);
        YB.A0Q(this.A02, i4, A07);
