...
public final class KE extends AbstractC1149c3 {
    ...
    public TextView A0D;
    public AbstractC1601jd A0E;
    public AbstractRunnableC0923Wc A0F;
    public M6 A0G;
    public C1065ah A0H;
    public M3 A0I;
    public C1153c7 A0J;
    ...
    public final AbstractC0688Mt A0b;
    public final VI A0c;
    public final InterfaceC1114bU A0d;
    public final InterfaceC1127bh A0e;
    public final C1128bi A0f;
    public final DZ A0g;
    ...
    public KE(C1153c7 c1153c7) {
        ...
        this.A0h = new RunnableC1170cO(this);
        this.A0N = false;
        this.A08 = new Handler(Looper.getMainLooper());
        this.A0A = (InputMethodManager) c1153c7.A06().getSystemService(A0I(12, 12, 29));
        this.A0J = c1153c7;
        this.A0E = this.A0J.A05();
        this.A0c = new VI(c1153c7.A05().A2E(), c1153c7.A07());
        this.A0g = this.A0J.A0E();
        if (this.A0g != null) {
            YB.A0K(this.A0g);
        }
        this.A0a = this.A0J.A03();
        this.A0b = C0689Mu.A01(c1153c7.A06(), c1153c7.A07(), c1153c7.A05().A2E(), XB.A00(c1153c7.A05().A29().A0J().A05()), new HashMap(), false, true, this.A0E.A2A());
        ...
        C0473Ek c0473Ek = this.A0J.A02() instanceof C0473Ek ? (C0473Ek) this.A0J.A02() : null;
        this.A0f = new C1128bi(c1153c7, this.A0E, c0473Ek, this.A0J.A0C(), this.A0e, this.A0D, this.A0K, this.A0g, this.A0a);
        if (c0473Ek != null && C0886Up.A1L(getAdContextWrapper())) {
            AbstractC1096bC.A00(c0473Ek.getVideoImplView(), C0886Up.A1M(getAdContextWrapper()), new ViewOnClickListenerC1171cP(this));
        } else if (c0473Ek == null && this.A09 != null && C0886Up.A1J(getAdContextWrapper())) {
            AbstractC1096bC.A00(this.A09, C0886Up.A1K(getAdContextWrapper()), new ViewOnClickListenerC1172cQ(this));
        }
        this.A0i = c1153c7.A05().A1m();
        this.A0j = c1153c7.A05().A1z();
        getAdContextWrapper().A0F().ACI(this.A0i, this.A0j, c1153c7.A05().A2L());
    }
    ...
    private void A0M() {
        ...
        if (this.A0J.A05().A1x() && (abstractC0971YbA0B = this.A0J.A0B()) != null) {
    ...
    private void A0O() {
        if (this.A0a != null) {
            YB.A0J(this.A0a);
            RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(AbstractC1149c3.A09, AbstractC1149c3.A09);
            layoutParams.addRule(10);
            layoutParams.addRule(11);
            layoutParams.setMargins(AbstractC1149c3.A08, this.A06, AbstractC1149c3.A08, AbstractC1149c3.A08);
    ...
    private void A0Q() {
        AbstractC0971Yb abstractC0971YbA0B = this.A0J.A0B();
        if (abstractC0971YbA0B == null) {
            return;
        }
        abstractC0971YbA0B.setPageDetailsVisible((this.A0M || abstractC0971YbA0B.A0E()) ? false : true);
    }
    ...
    private void A0R() {
        ...
        if (this.A09 != null) {
            if (this.A0E.A1e()) {
                this.A09.setOnClickListener(new ViewOnClickListenerC1173cR(this));
            }
            YB.A0J(this.A09);
            YB.A0K(this.A09);
        ...
        YB.A0K(this.A0D);
        this.A0K = new C1185cd(this.A0J.A06(), getCtaButton(), this.A0J.A05(), this.A0J.A07(), this.A0J.A0C(), this.A0J.A0F(), this.A0J.A0A(), getColors(), this.A0d);
        this.A0K.setAutoClickTime(this.A0J.A05(), this.A0J.A0B());
        YB.A0G(TTAdConstant.IMAGE_MODE_1010, this.A0K);
        addView(this.A0K);
        A0U();
        A0J();
        if (C0886Up.A17(this.A0J.A06())) {
            View.OnClickListener onClickListener = new ViewOnClickListenerC1174cS(this);
            this.A0C.setOnClickListener(onClickListener);
            if (this.A0J.A0B() != null) {
                View.OnClickListener onClickListener2 = new ViewOnClickListenerC1175cT(this);
    ...
    private void A0S() {
        ...
        if (this.A09 instanceof C0473Ek) {
            C0473Ek c0473Ek = (C0473Ek) this.A09;
        ...
        addView(new C1165cJ(this.A0J.A06(), this.A0E, this.A0c, this.A0Z, this.A0J.A0C()).A0C(getRegularCtaForEndCard()));
    }
    ...
    public void A0f(String str) {
        ...
        if (AbstractC0887Uq.A02(this.A0J.A06()) || this.A0J.A06().A0E() == null) {
            m32 = new M3(this.A0J.A06(), kr);
        } else {
            m32 = new M3(this.A0J.A06(), this.A0J.A06().A0E(), kr);
        }
        this.A0I = m32;
        this.A0I.setOnTouchListener(new ViewOnTouchListenerC1167cL(this));
    ...
    public void A0i(boolean z3) {
        ...
        ObjectAnimator objectAnimatorOfFloat2 = ObjectAnimator.ofFloat(linearLayout, strA0I, y10, i4);
        ...
        if (this.A09 != null) {
            ...
            duration.addUpdateListener(new C1168cM(this));
            ...
            animatorSet.addListener(new C1169cN(this, z3));
            if (this.A0j) {
                boolean z10 = this.A09 instanceof C0473Ek;
                String[] strArr = A0l;
                if (strArr[6].charAt(18) != strArr[5].charAt(18)) {
                    throw new RuntimeException();
                }
                ...
                strArr2[1] = "o2de";
                if (z10) {
                    ((C0473Ek) this.A09).A0c(animatorSet, z3);
                }
            }
            animatorSet.start();
        }
    ...
    private void A0j(boolean z3) {
        ...
        if (z10) {
            ...
            if (C0886Up.A1J(getAdContextWrapper()) && getResources().getConfiguration().orientation == 2 && !(this.A09 instanceof C0473Ek)) {
    ...
    private void A0k(boolean z3, int i4) {
        if (this.A0G != null && this.A0i) {
            ...
            adContextWrapper.A0F().ACG(!z3, i4);
        }
    }
    ...
    public final void A1D() {
        AbstractC0971Yb abstractC0971YbA0B = this.A0J.A0B();
        if (abstractC0971YbA0B != null) {
            abstractC0971YbA0B.setPageDetailsVisible((A1Q() || abstractC0971YbA0B.A0E()) ? false : true);
        }
        this.A0X = false;
    }
    ...
    */
    public final void A1H(com.instagram.common.viewpoint.core.NR r6, java.lang.String r7, double r8, android.os.Bundle r10) {
        ...
        L33:
            ...
            boolean r0 = com.instagram.common.viewpoint.core.C0886Up.A17(r0)
            if (r0 == 0) goto L4c
            android.widget.LinearLayout r1 = r5.A0C
            r0 = 0
            r1.setClickable(r0)
    ...
    public final boolean A1P(boolean z3) {
        ...
        if (this.A0E.A29().A0K().A04()) {
            ...
            if (this.A09 instanceof C0473Ek) {
                C0473Ek simpleVideoView = (C0473Ek) this.A09;
    ...
    private ViewOnClickListenerC0634Kr getRegularCtaForEndCard() {
        ViewOnClickListenerC0634Kr viewOnClickListenerC0634Kr = new ViewOnClickListenerC0634Kr(getAdContextWrapper(), this.A0J.A05().A0w(), this.A0E.A28().A01(), getAdEventManager(), this.A0J.A0C(), (C1381fp) null, this.A0J.A0A(), this.A0E.A2A());
        viewOnClickListenerC0634Kr.setViewShowsOverMedia(true);
        YB.A0K(viewOnClickListenerC0634Kr);
        viewOnClickListenerC0634Kr.setText(this.A0E.A29().A0J().A04());
        YB.A0G(1001, viewOnClickListenerC0634Kr);
        viewOnClickListenerC0634Kr.setCta(this.A0E.A29().A0J(), this.A0E.A2E(), new HashMap(), null);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void setBrowserProgressBarValue(int i4) {
        if (this.A0H != null) {
            this.A0H.setProgress(i4);
        }
    }
    ...
    private void setUpBrowserControls(M3 m32) {
        ...
        this.A0G.setOnTouchListener(new ViewOnTouchListenerC1166cK(this));
        this.A0B.addView(this.A0G, layoutParams);
        YB.A0J(this.A0H);
        this.A0H = new C1065ah(this.A0J.A06(), null, R.attr.progressBarStyleHorizontal);
