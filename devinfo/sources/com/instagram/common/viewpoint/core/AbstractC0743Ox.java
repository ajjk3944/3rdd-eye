...
public abstract class AbstractC0743Ox extends Drawable {
    ...
    public static float A00(float f10, float f11, boolean z3) {
        if (z3) {
    ...
    public static float A01(float f10, float f11, boolean z3) {
        if (z3) {
