...
public final class L6 {
    ...
    private int A01(InterfaceC1787ms interfaceC1787ms, HV hv) throws IOException {
        int iMin = (int) Math.min(20000L, interfaceC1787ms.A8O());
        if (interfaceC1787ms.A8n() != 0) {
            hv.A00 = 0;
            return 1;
        }
        C02434v c02434v = this.A06;
        ...
        c02434v.A0d(iMin);
        interfaceC1787ms.AIl();
        interfaceC1787ms.AGt(this.A06.A0l(), 0, iMin);
        this.A01 = A04(this.A06);
        this.A04 = true;
        return 0;
    }

    private int A02(InterfaceC1787ms interfaceC1787ms, HV hv) throws IOException {
        long jA8O = interfaceC1787ms.A8O();
        int iMin = (int) Math.min(20000L, jA8O);
        long j = jA8O - iMin;
        long searchStartPosition = interfaceC1787ms.A8n();
    ...
    private int A03(byte[] bArr, int i4) {
    ...
    */
    private long A04(com.instagram.common.viewpoint.core.C02434v r8) {
        /*
            r7 = this;
            int r6 = r8.A09()
            int r5 = r8.A0A()
        ...
        L2e:
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.L6.A04(com.facebook.ads.redexgen.X.4v):long");
    }

    private long A05(C02434v c02434v) {
        int iA09 = c02434v.A09();
        int searchStartPosition = c02434v.A0A();
        for (int nextStartCode = searchStartPosition - 4; nextStartCode >= iA09; nextStartCode--) {
            int searchEndPosition = A03(c02434v.A0l(), nextStartCode);
            if (searchEndPosition == 442) {
                int searchStartPosition2 = nextStartCode + 4;
                c02434v.A0f(searchStartPosition2);
                long jA06 = A06(c02434v);
    ...
    public static long A06(C02434v c02434v) {
        int iA09 = c02434v.A09();
        if (c02434v.A07() < 9) {
            return -9223372036854775807L;
        }
        ...
        c02434v.A0k(bArr, 0, originalPosition);
        c02434v.A0f(iA09);
        if (A0A(bArr)) {
            return A07(bArr);
        }
    ...
    public final int A0B(InterfaceC1787ms interfaceC1787ms, HV hv) throws IOException {
        if (!this.A05) {
            return A02(interfaceC1787ms, hv);
        }
        ...
        if (this.A00 < 0) {
            AbstractC02284g.A07(A08(45, 16, 119), A08(27, 18, 122) + this.A00 + A08(0, 27, AppLovinMediationAdapter.ERROR_CHILD_USER));
