...
public final class C1911ou implements InterfaceC03197t {
    ...
    public C1911ou(Context context) {
        this(context, 0);
    }

    public C1911ou(Context context, int i4) {
        this(context, null, i4, 5000L);
    }

    @Deprecated
    public C1911ou(Context context, A6 a62, int i4, long j) {
        this.A00 = new C1912ov(this);
        this.A03 = context;
        this.A01 = i4;
        this.A02 = j;
        this.A04 = a62;
    ...
    private final void A02(Context context, A6 a62, long j, Handler handler, GQ gq, int extensionRendererIndex, ArrayList<InterfaceC1905oo> arrayList) throws Exception {
        arrayList.add(new AnonymousClass10(context, C1592jQ.A0T, new MediaCodecRendererMetaParameters(null, false), BT.A00, j, a62, false, false, handler, gq, 50, 5, 0, 0, 0));
        ...
        try {
            try {
                ...
                try {
                    arrayList.add(size, (InterfaceC1905oo) cls.getConstructor(clazz, clazz2, Handler.class, GQ.class, clazz3, clazz3).newInstance(true, Long.valueOf(j), handler, gq, 50, 5));
    ...
    */
    private final void A03(android.content.Context r24, com.instagram.common.viewpoint.core.A6 r25, com.instagram.common.viewpoint.core.InterfaceC02063k[] r26, android.os.Handler r27, com.instagram.common.viewpoint.core.InterfaceC03408p r28, int r29, java.util.ArrayList<com.instagram.common.viewpoint.core.InterfaceC1905oo> r30) throws java.lang.Exception {
        /*
            Method dump skipped, instructions count: 322
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C1911ou.A03(android.content.Context, com.facebook.ads.redexgen.X.A6, com.facebook.ads.redexgen.X.3k[], android.os.Handler, com.facebook.ads.redexgen.X.8p, int, java.util.ArrayList):void");
    }

    private final void A04(Context context, InterfaceC0393Bf interfaceC0393Bf, Looper looper, int i4, ArrayList<InterfaceC1905oo> arrayList) {
        arrayList.add(new C01531f(interfaceC0393Bf, looper));
    }

    private final void A05(Context context, ES es, Looper looper, int i4, ArrayList<InterfaceC1905oo> arrayList) {
        arrayList.add(new C01491b(es, looper, this.A00));
    }

    private final InterfaceC02063k[] A06() {
        return new InterfaceC02063k[0];
    }

    @Override // com.instagram.common.viewpoint.core.InterfaceC03197t
    public final InterfaceC1905oo[] A5Y(Handler handler, GQ gq, InterfaceC03408p interfaceC03408p, ES es, InterfaceC0393Bf interfaceC0393Bf, A6 a62) throws Exception {
        A6 a63 = a62;
        if (a63 == null) {
            a63 = this.A04;
        }
        ArrayList<InterfaceC1905oo> arrayList = new ArrayList<>();
        A02(this.A03, a63, this.A02, handler, gq, this.A01, arrayList);
        A03(this.A03, a63, A06(), handler, interfaceC03408p, this.A01, arrayList);
        A05(this.A03, es, handler.getLooper(), this.A01, arrayList);
        A04(this.A03, interfaceC0393Bf, handler.getLooper(), this.A01, arrayList);
        return (InterfaceC1905oo[]) arrayList.toArray(new InterfaceC1905oo[arrayList.size()]);
    }
}
