...
public final class C0985Yp extends View {
    public int A00;
    public Paint A01;
    public Paint A02;
    public Paint A03;
    ...
    public C0985Yp(C1436gi c1436gi) {
        this(c1436gi, 60, true);
    }

    public C0985Yp(C1436gi c1436gi, int i4, boolean z3) {
        super(c1436gi);
        this.A00 = i4;
        this.A04 = z3;
        if (z3) {
    ...
    public RelativeLayout.LayoutParams getDefaultLayoutParams() {
        ...
        int i4 = (int) (density * f10);
        float density2 = this.A00;
        RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(i4, (int) (density2 * f10));
    ...
    public final void onDraw(Canvas canvas) {
        if (this.A04) {
            ...
            canvas.drawCircle(i4, i10, i11, this.A02);
            int edgeLength2 = i11 - 2;
            canvas.drawCircle(i4, i10, edgeLength2, this.A01);
            int centerY = iMin / 3;
            int centerX = iMin / 3;
