...
public final class HJ {
    ...
    public final HJ A0B(List<String> list) {
        return new HJ(this.A05, this.A03, this.A06, this.A04, this.A07, this.A02, this.A00, this.A09, this.A0A, A02(AbstractC0550Hk.A02(list)));
    }
    ...
    public HJ(int i4, int i10, int i11, int i12, int i13, int i14, int i15, long j, HI hi2, Metadata metadata) {
        this.A05 = i4;
        this.A03 = i10;
        this.A06 = i11;
        this.A04 = i12;
    ...
    public HJ(byte[] bArr, int i4) {
        C02424u c02424u = new C02424u(bArr);
        c02424u.A08(i4 * 8);
        this.A05 = c02424u.A04(16);
        this.A03 = c02424u.A04(16);
        this.A06 = c02424u.A04(24);
        this.A04 = c02424u.A04(24);
        this.A07 = c02424u.A04(20);
        this.A08 = A01(this.A07);
        this.A02 = c02424u.A04(3) + 1;
        this.A00 = c02424u.A04(5) + 1;
        this.A01 = A00(this.A00);
        this.A09 = c02424u.A05(36);
        this.A0A = null;
        this.A0B = null;
    }
    ...
    public final long A05() {
        ...
        return ((j8 * blockSizeSamples) / 8) + 64;
    }
    ...
    public final C1996qI A08(byte[] bArr, Metadata metadata) {
        bArr[4] = -128;
        int i4 = this.A04 > 0 ? this.A04 : -1;
        Metadata metadataA02 = A02(metadata);
        C01872p c01872pA0h = new C01872p().A11(A03(0, 10, 87)).A0h(i4);
        int maxInputSize = this.A02;
        C01872p c01872pA0b = c01872pA0h.A0b(maxInputSize);
        int maxInputSize2 = this.A07;
        return c01872pA0b.A0m(maxInputSize2).A12(Collections.singletonList(bArr)).A0v(metadataA02).A14();
    }
