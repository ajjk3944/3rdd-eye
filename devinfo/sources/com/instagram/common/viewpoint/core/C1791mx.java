...
public class C1791mx implements HY {
    ...
    public C1791mx(long j, long j8, int i4, int i10, boolean z3) {
        this.A05 = j;
        this.A04 = j8;
        ...
        if (j == -1) {
            ...
            this.A02 = j - j8;
            this.A03 = A01(j, j8, i4);
        }
    }

    private long A00(long j) {
        long positionOffset = this.A01;
        long j8 = ((this.A00 * j) / 8000000) / positionOffset;
    ...
    public static long A01(long j, long j8, int i4) {
        return ((Math.max(0L, j - j8) * 8) * 1000000) / i4;
    }
