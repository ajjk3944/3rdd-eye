...
public class C2034rB {
    ...
    public final Map<String, C2045rN> A00;
    public final Set<C2045rN> A01;
    ...
    public Collection<C2045rN> A00() {
        return this.A01;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public Collection<C2045rN> A01() {
    ...
    public void A04() {
        this.A00.clear();
        Iterator<C2045rN> it = this.A01.iterator();
        while (true) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public boolean A06(C2045rN c2045rN) {
        if (this.A01.add(c2045rN)) {
            this.A00.remove(c2045rN.A02);
            return true;
        }
        return false;
    }
