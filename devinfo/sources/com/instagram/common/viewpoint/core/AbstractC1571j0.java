...
public abstract class AbstractC1571j0 implements WC {
    ...
    public abstract void A0R(N1 n12, C0867Tw c0867Tw, C0865Tu c0865Tu, O8 o82);

    static {
        A08();
        YD.A02();
        A0I = AbstractC1571j0.class.getSimpleName();
        A0H = new Handler(Looper.getMainLooper());
    }

    public AbstractC1571j0(C1436gi c1436gi, O7 o72) {
        this.A0B = c1436gi;
        this.A08 = o72;
        if (A0G != null) {
            this.A06 = A0G;
    ...
    private void A09(C0867Tw c0867Tw) {
        if (ProcessUtils.isRemoteRenderingProcess()) {
            return;
        }
        SharedPreferences sharedPreferences = FlashPreferences.getSharedPreferences(this.A0B);
        if (c0867Tw.A0C() != null) {
            sharedPreferences.edit().putString(A07(262, 12, 110), c0867Tw.A0C()).putLong(A07(342, 16, 54), System.currentTimeMillis()).apply();
            return;
        }
        sharedPreferences.edit().clear().apply();
    }

    private void A0A(C0867Tw c0867Tw) {
        this.A0B.A0F().AJS(c0867Tw.A0H());
    }

    private void A0B(RG rg2) throws JSONException {
        C0867Tw placement = rg2.A00();
        if (placement == null || placement.A05() == null) {
            String strA07 = A07(291, 29, 53);
            C0908Vm error = new C0908Vm(AdErrorType.NO_AD_PLACEMENT, strA07);
        ...
        this.A04 = placement;
        this.A00 = null;
        C0867Tw c0867Tw = this.A04;
        JSONObject jSONObjectA0E = c0867Tw.A0E();
        String strA072 = A07(195, 3, 13);
        if (jSONObjectA0E == null) {
            C0865Tu c0865TuA04 = c0867Tw.A04();
            if (!A0F(c0867Tw, c0865TuA04)) {
                return;
            }
            if (this.A00 == null) {
                this.A0B.A08().ABC(strA072, AbstractC0848Td.A0a, new C0849Te(A07(81, 26, 5), c0865TuA04.A02()));
                ADp(C0908Vm.A00(AdErrorType.INTERNAL_ERROR));
                return;
            }
            A0R(this.A00, c0867Tw, c0865TuA04, new O8(c0865TuA04.A04(), c0867Tw.A05(), this.A08.A0A, c0867Tw.A05().A0C()));
        } else {
            ArrayList arrayList = new ArrayList();
            C0865Tu c0865TuA042 = c0867Tw.A04();
            do {
                if (arrayList.isEmpty()) {
                    if (A0F(c0867Tw, c0865TuA042)) {
                        arrayList.add(c0865TuA042);
                    } else {
                        return;
                    }
                } else if (A0E(c0865TuA042)) {
                    arrayList.add(c0865TuA042);
                }
                c0865TuA042 = c0867Tw.A04();
            } while (c0865TuA042 != null);
            N1 n12 = this.A00;
            String[] strArr = A0E;
            ...
            if (n12 == null) {
                this.A0B.A08().ABC(strA072, AbstractC0848Td.A0a, new C0849Te(A07(56, 25, 40), ((C0865Tu) arrayList.get(0)).A02()));
                ADp(C0908Vm.A00(AdErrorType.INTERNAL_ERROR));
                return;
            }
            boolean z3 = false;
            try {
                if (arrayList.size() > 1 && this.A00 != null && this.A00.AKL()) {
                    ...
                    while (it.hasNext()) {
                        jSONArray.put(((C0865Tu) it.next()).A04());
                    }
                    jSONObject.put(A07(192, 3, FacebookMediationAdapter.ERROR_ADVIEW_CONSTRUCTOR_EXCEPTION), jSONArray);
                    jSONObject.put(A07(198, 12, 124), c0867Tw.A0E());
                    A0R(this.A00, c0867Tw, c0865TuA042, new O8(jSONObject, c0867Tw.A05(), this.A08.A0A, c0867Tw.A05().A0C()));
                    z3 = true;
                }
            ...
            if (!z3) {
                if (arrayList.isEmpty()) {
                    C0908Vm c0908VmA01 = C0908Vm.A01(AdErrorType.NO_FILL, A07(0, 0, FacebookMediationAdapter.ERROR_REQUIRES_ACTIVITY_CONTEXT));
                    this.A0B.A0F().A5g(c0908VmA01.A03().getErrorCode(), A07(133, 22, 62));
                    if (this.A07 != null) {
                        this.A07.A0G(c0908VmA01);
                        return;
                    }
                    return;
                }
                if (this.A00 == null) {
                    this.A0B.A08().ABC(strA072, AbstractC0848Td.A0a, new C0849Te(A07(22, 34, 82), ((C0865Tu) arrayList.get(0)).A02()));
                    ADp(C0908Vm.A00(AdErrorType.INTERNAL_ERROR));
                    return;
                }
                C0865Tu c0865Tu = (C0865Tu) arrayList.get(0);
                A0R(this.A00, c0867Tw, c0865Tu, new O8(c0865Tu.A04(), c0867Tw.A05(), this.A08.A0A, c0867Tw.A05().A0C()));
            }
        }
        A09(placement);
        A0A(placement);
    ...
    private final void A0C(String str, AdExperienceType adExperienceType) {
        ...
        try {
            C0915Vu bidPayload = new C0915Vu(this.A0B, str, this.A08.A0A, this.A08.A09);
    ...
    private boolean A0E(C0865Tu c0865Tu) {
        return (c0865Tu == null || c0865Tu.A04() == null) ? false : true;
    }

    private boolean A0F(C0867Tw c0867Tw, C0865Tu c0865Tu) {
        String strA07 = A07(0, 0, FacebookMediationAdapter.ERROR_REQUIRES_ACTIVITY_CONTEXT);
        if (c0865Tu == null) {
            C0908Vm c0908VmA01 = C0908Vm.A01(AdErrorType.NO_FILL, strA07);
            this.A0B.A0F().A5g(c0908VmA01.A03().getErrorCode(), A07(133, 22, 62));
            if (this.A07 != null) {
                this.A07.A0G(c0908VmA01);
            }
        ...
        String strA02 = c0865Tu.A02();
        N1 n1A00 = this.A0A.A00(this.A0B, c0867Tw.A05().A0D());
        if (n1A00 == null) {
            this.A0B.A08().ABC(A07(195, 3, 13), AbstractC0848Td.A0a, new C0849Te(A07(0, 22, 38), strA02));
            ADp(C0908Vm.A00(AdErrorType.INTERNAL_ERROR));
            return false;
        }
        if (!this.A08.A01().contains(n1A00.A8k())) {
            C0908Vm c0908VmA012 = C0908Vm.A01(AdErrorType.INTERNAL_ERROR, strA07);
            this.A0B.A0F().A5g(c0908VmA012.A03().getErrorCode(), A07(ModuleDescriptor.MODULE_VERSION, 19, 24));
            if (this.A07 != null) {
                N2 n22 = this.A07;
                if (A0E[0].length() != 32) {
                    throw new RuntimeException();
        ...
        this.A00 = n1A00;
        JSONObject jSONObjectA04 = c0865Tu.A04();
        if (jSONObjectA04 != null) {
            ...
            if (c1432geA00 != null) {
                c1432geA00.A0D(strOptString);
            }
            JSONObject dataObject = jSONObjectA04.optJSONObject(A07(274, 17, 80));
            A0D(dataObject);
            if (this.A05 == null) {
                String strA072 = A07(242, 20, 120);
                C0908Vm c0908VmA013 = C0908Vm.A01(AdErrorType.UNKNOWN_ERROR, strA072);
                this.A0B.A0F().A5g(c0908VmA013.A03().getErrorCode(), strA072);
                if (this.A07 != null) {
                    this.A07.A0G(c0908VmA013);
                }
                return false;
            }
            return true;
        ...
        C0908Vm c0908VmA014 = C0908Vm.A01(AdErrorType.UNKNOWN_ERROR, strA073);
        this.A0B.A0F().A5g(c0908VmA014.A03().getErrorCode(), strA073);
        if (this.A07 != null) {
            this.A07.A0G(c0908VmA014);
        }
        return false;
    }
    ...
    public NQ A0I() {
        if (this.A01 != null) {
            ...
            if (A0E[2].charAt(15) == 'D') {
                return ((AbstractC1605jh) n12).A0I();
            }
    ...
    public final void A0K() {
        ...
        if (n12 != null) {
            C0932Wl.A00(this.A0B).A0D(this.A01.A8k().toString(), this.A01.A7O());
        }
        if (this.A06 != null) {
            this.A06.A0R(null);
            this.A06 = null;
    ...
    public final void A0M() {
        ...
        if (n12 == null) {
            ...
            this.A0B.A08().ABC(strA07, AbstractC0848Td.A0Q, new C0849Te(strA072));
            ...
            if (this.A07 != null) {
                ...
                n22.A0G(C0908Vm.A01(adErrorType, errorMessage));
            }
            this.A0B.A0F().A5j();
            return;
        }
        if (this.A0C) {
            ...
            this.A0B.A08().ABC(strA07, AbstractC0848Td.A0M, new C0849Te(strA073));
            ...
            if (this.A07 != null) {
                ...
                n23.A0G(C0908Vm.A01(adErrorType2, errorMessage2));
            }
            this.A0B.A0F().A5i();
            return;
        }
    ...
    public final void A0T(O8 o82) {
        A0V(o82.A03().optString(A07(210, 2, 12)));
    }
    ...
    public final synchronized void ADp(C0908Vm c0908Vm) {
        A0H().post(new C1572j1(this, c0908Vm));
    }
    ...
    public final synchronized void AG7(RG rg2) {
        try {
            ...
            this.A0B.A08().ABC(A07(195, 3, 13), AbstractC0848Td.A0T, new C0849Te(e2));
        }
    }
}
