...
public final class C0900Vd implements NativeAdViewAttributesApi {
    ...
    public final int A04(float f10) {
        int i4 = (this.A01 & (-16777216)) | ((~this.A01) & 16777215);
        int textColor = this.A01;
        return P3.A05(i4, textColor, f10);
    }
    ...
    public final void A09(AdOptionsView adOptionsView, int i4) {
        adOptionsView.setIconColor(this.A04);
        adOptionsView.setIconSizeDp(i4);
    }
    ...
    @Override // com.facebook.ads.internal.api.NativeAdViewAttributesApi
    public final void setCTABackgroundColor(int i4) {
        this.A01 = i4;
    }

    @Override // com.facebook.ads.internal.api.NativeAdViewAttributesApi
    public final void setCTABorderColor(int i4) {
        this.A02 = i4;
    }

    @Override // com.facebook.ads.internal.api.NativeAdViewAttributesApi
    public final void setCTATextColor(int i4) {
        this.A03 = i4;
    }

    @Override // com.facebook.ads.internal.api.NativeAdViewAttributesApi
    public final void setPrimaryTextColor(int i4) {
        this.A04 = i4;
    }

    @Override // com.facebook.ads.internal.api.NativeAdViewAttributesApi
    public final void setSecondaryTextColor(int i4) {
        this.A05 = i4;
    }
