...
public class C0571If implements XN {
    ...
    public final /* synthetic */ C02555h A00;

    public C0571If(C02555h c02555h) {
        this.A00 = c02555h;
    }

    @Override // com.instagram.common.viewpoint.core.XN
    public final void ADS() {
        if (!(this.A00.A01 instanceof C0619Kc) || !this.A00.A01.A1M()) {
            if (!(this.A00.A01 instanceof C0599Ji) || !this.A00.A01.A1M()) {
                InterfaceC1256dm interfaceC1256dm = this.A00.A07;
                String[] strArr = A01;
