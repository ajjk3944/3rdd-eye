...
public final class C0903Vg implements NativeAdBase.NativeAdLoadConfigBuilder, NativeAdBase.NativeLoadAdConfig {
    ...
    public C0903Vg(UK uk2, NativeAdBase nativeAdBase) {
        this.A06 = uk2;
    ...
    @Override // com.facebook.ads.NativeAdBase.NativeAdLoadConfigBuilder
    public final NativeAdBase.NativeAdLoadConfigBuilder withPreloadedIconView(int i4, int i10) {
        this.A04 = true;
        this.A01 = i4;
        this.A00 = i10;
        return this;
