...
public final class NO extends RelativeLayout implements InterfaceC0978Yi {
    ...
    public final AbstractC1601jd A0O;
    public final C0708No A0P;
    public final InterfaceC0804Rk A0Q;
    public final C1436gi A0R;
    public final VA A0S;
    public final VI A0T;
    public final XO A0U;
    public final ViewOnSystemUiVisibilityChangeListenerC0967Xx A0V;
    public final InterfaceC0977Yh A0W;
    public final ZU A0X;
    public final InterfaceC1127bh A0Y;
    public final C1128bi A0Z;
    public final C1291eM A0a;
    public final AtomicBoolean A0b;
    public final AtomicBoolean A0c;
    public final boolean A0d;
    public final boolean A0e;
    public final boolean A0f;
    public final AbstractC0971Yb A0g;

    /* JADX WARN: Failed to parse debug info
    java.lang.ArrayIndexOutOfBoundsException
     */
    public NO(C1436gi c1436gi, VA va2, InterfaceC0977Yh interfaceC0977Yh, AbstractC1601jd abstractC1601jd, String str, ZU zu, boolean z3) {
        super(c1436gi);
        String strA0D = A0D(0, 0, AppLovinMediationAdapter.ERROR_MISSING_AD_UNIT_ID);
        this.A0E = strA0D;
        this.A0D = strA0D;
        ...
        this.A0f = z3;
        this.A0R = c1436gi;
        this.A0W = interfaceC0977Yh;
        this.A0S = va2;
        this.A0O = abstractC1601jd;
        this.A0P = abstractC1601jd.A29().A0H().A07();
        this.A0T = new VI(this.A0O.A2E(), this.A0S);
        this.A0X = zu;
        this.A0C = new C1304ea(c1436gi, this.A0X, str, this.A0W);
        if (abstractC1601jd.A29().A0H().A07() != null) {
            this.A0I = abstractC1601jd.A29().A0H().A07().A0X();
            this.A0E = abstractC1601jd.A29().A0H().A07().A0O();
            this.A0D = abstractC1601jd.A29().A0H().A07().A0N();
        }
        ...
        OV ov = null;
        this.A0U = new XO(iA03, new C0715Nv(this, ov));
        this.A0d = C0886Up.A0o(this.A0R);
        this.A0g = A07();
        if (this.A0P.A0c()) {
            this.A0g.A09();
        }
        this.A0a = new C1291eM(this.A0R, this.A0S, this.A0O);
        AbstractC1137br.A00(c1436gi, this, abstractC1601jd.A29().A0H().A08());
        this.A0V = new ViewOnSystemUiVisibilityChangeListenerC0967Xx(this);
        this.A0V.A05(EnumC0966Xw.A02);
        if (C0886Up.A2K(this.A0R)) {
            this.A0g.setProgressSpinnerInvisible(true);
        }
        NP np = new NP(this, ov);
        HashMap map = new HashMap();
        map.put(A0D(56, 9, 90), this.A0X.A8l());
        this.A0B = new C1287eI(this.A0R, this.A0O, this.A0P, this.A0S, np, map);
        A0K();
        this.A0W.A45(this, new RelativeLayout.LayoutParams(-1, -1));
        A0H();
        this.A0Y = new C0719Nz(this);
        this.A0Z = new C1128bi(this.A0R, this.A0g, this.A0O, (C0473Ek) null, this.A0W, this.A0Y, this.A0A, this.A02, this.A0B);
    ...
    public static String A0D(int i4, int i10, int i11) {
        ...
        for (int i12 = 0; i12 < bArrCopyOfRange.length; i12++) {
            bArrCopyOfRange[i12] = (byte) ((bArrCopyOfRange[i12] ^ i11) ^ FacebookMediationAdapter.ERROR_NULL_CONTEXT);
        }
    ...
    public NO(C1436gi c1436gi, VA va2, InterfaceC0977Yh interfaceC0977Yh, AbstractC1601jd abstractC1601jd, String str, ZU zu) {
        this(c1436gi, va2, interfaceC0977Yh, abstractC1601jd, str, zu, false);
    }
    ...
    private FullScreenAdToolbar A07() {
        ...
        fullScreenAdToolbar.A0D(this.A0O.A28().A01(), ViewOnClickListenerC0634Kr.A05(this.A0O));
        ...
        fullScreenAdToolbar.setToolbarListener(new C0716Nw(this));
        return fullScreenAdToolbar;
    }

    private ViewOnClickListenerC0634Kr A09() {
        if (this.A0B == null || this.A0B.getViewabilityChecker() == null || this.A0B.getTouchDataRecorder() == null) {
            return null;
        }
        ViewOnClickListenerC0634Kr viewOnClickListenerC0634Kr = new ViewOnClickListenerC0634Kr(this.A0R, this.A0X.A7M(), this.A0O.A28().A01(), this.A0S, this.A0W, this.A0B.getViewabilityChecker(), this.A0B.getTouchDataRecorder(), this.A0O.A2A());
        YB.A0K(viewOnClickListenerC0634Kr);
        viewOnClickListenerC0634Kr.setText(this.A0O.A29().A0J().A04());
        viewOnClickListenerC0634Kr.setTextSize(14.0f);
        viewOnClickListenerC0634Kr.setPadding(XV.A02, XV.A02, XV.A02, XV.A02);
        viewOnClickListenerC0634Kr.setOnClickListener(new Z6(this));
        return viewOnClickListenerC0634Kr;
    }

    private C1136bq A0B() {
        C1436gi c1436gi = this.A0R;
        C0694Na c0694NaA01 = this.A0O.A28().A01();
        int i4 = !this.A0J ? 16 : 17;
        boolean z3 = this.A0J;
        String[] strArr = A0i;
        ...
        C1136bq c1136bq = new C1136bq(c1436gi, c0694NaA01, true, i4, !z3 ? 14 : 13, 0);
        c1136bq.A04(this.A0O.A29().A0I().A0G(), this.A0O.A29().A0I().A0F(), null, false, true);
        TextView descriptionTv = c1136bq.getDescriptionTextView();
        descriptionTv.setAlpha(0.8f);
        descriptionTv.setMaxLines(1);
        descriptionTv.setEllipsize(TextUtils.TruncateAt.END);
        TextView descriptionTv2 = c1136bq.getTitleTextView();
    ...
    private void A0G() {
        ...
        C1130bk c1130bk = new C1130bk(this.A0R);
        YB.A0N(c1130bk, 0);
        YB.A0K(c1130bk);
        new LM(c1130bk, this.A0R).A05(A0k, A0k).A07(this.A0O.A2C().A01());
        ...
        C1132bm c1132bm = new C1132bm(this.A0R, !this.A0I ? A0o : A0m, 5, A0n, -1);
        ...
        linearLayout.addView(c1132bm, layoutParams2);
        ...
        ratingInfoContainerParams.addRule(1, c1130bk.getId());
        ...
        if (this.A04 != null) {
            ...
            this.A04.addView(c1130bk, layoutParams);
        }
        ...
        c1132bm.setRating(Float.parseFloat(this.A0O.A29().A0I().A0C()));
        ...
        if (!this.A0I) {
            ...
            strA01 = AbstractC0950Xg.A01(Integer.parseInt(this.A0O.A29().A0I().A09()));
        }
        sb2.append(strA01);
    ...
    private void A0J() {
        C1259dq c1259dqA0F = new Cdo(this.A0R, this.A0O.A29().A0I(), this.A0O.A2C()).A0A(this.A0O.A28().A01()).A0D(this.A0P.A0Q()).A0C(this.A0P.A0K()).A09(AdError.SERVER_ERROR_CODE).A0E(this.A0I).A0B(this.A0E).A0F();
        VK.A04(c1259dqA0F, this.A0T, VH.A0U);
        addView(c1259dqA0F, A0p);
        c1259dqA0F.A04(new C0718Ny(this));
    }
    ...
    private void A0K() {
        ...
        if (this.A0d) {
            ...
            C1136bq c1136bqA0B = A0B();
            RelativeLayout.LayoutParams iconAndMetaDataContainerParams = new RelativeLayout.LayoutParams(-2, -2);
            relativeLayout.addView(c1136bqA0B, iconAndMetaDataContainerParams);
        }
        RelativeLayout.LayoutParams layoutParams2 = new RelativeLayout.LayoutParams(-1, -2);
        layoutParams2.setMargins(0, 0, XV.A09, 0);
        this.A02.addView(this.A04, layoutParams2);
        if (this.A0A != null) {
            ViewOnClickListenerC0634Kr viewOnClickListenerC0634Kr = this.A0A;
            String[] strArr = A0i;
            if (strArr[6].charAt(22) == strArr[1].charAt(22)) {
                throw new RuntimeException();
            }
            A0i[3] = "f";
            layoutParams2.addRule(0, viewOnClickListenerC0634Kr.getId());
            if (!this.A0I) {
    ...
    private void A0L() {
        this.A09 = AbstractC1046aO.A02(this.A0R, EnumC1044aM.A03, this.A0O);
        YB.A0K(this.A09);
    ...
    private void A0M() {
        this.A08 = AbstractC1046aO.A01(this.A0R, true, this.A0O, this.A0T, this.A0W, EnumC1044aM.A03, AbstractC1043aL.A00(this.A0O));
        RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-2, -2);
        layoutParams.addRule(11);
        layoutParams.topMargin = XV.A09;
    ...
    public void A0N() {
        if (this.A0O.A2M() && this.A08 != null) {
            this.A08.A0P();
            if (this.A0O.A2U()) {
                AbstractC1043aL.A04(this.A0R, EnumC1044aM.A02);
            } else {
                AbstractC1043aL.A05(this.A0R, EnumC1044aM.A02);
            }
        }
        if (this.A0O.A2W() && this.A09 != null) {
            AbstractC1043aL.A06(this.A0R, EnumC1044aM.A02);
        }
        ...
        YB.A0L(this.A0A);
        Pair<EnumC1290eL, View> pairA03 = this.A0a.A03(this.A0A);
        this.A00 = (View) pairA03.second;
        switch (Z7.A00[((EnumC1290eL) pairA03.first).ordinal()]) {
            case 1:
                ...
                if (!this.A0I) {
                    ...
                    View c1253dj = new C1253dj(this.A0R, this.A0O.A2C(), this.A0O.A29().A0I(), A09(), this.A0D, new Z5(this));
                    ...
                    addView(c1253dj, screenshotParams2);
                    View view = this.A0g;
                    String[] strArr3 = A0i;
    ...
    public void A0O() {
        ...
        if (this.A0A != null && this.A0O.A25() > 0 && this.A07 == null) {
            this.A07 = new XO(this.A0O.A25(), new C0717Nx(this));
            this.A07.A07();
        }
        this.A0U.A07();
        if (this.A08 != null && this.A0O.A2Q()) {
            C1041aJ c1041aJ = this.A08;
            String[] strArr2 = A0i;
    ...
    public void A0W(boolean z3, String str) {
        this.A0H = true;
        HashMap map = new HashMap();
        map.put(A0D(8, 12, 57), z3 ? A0D(79, 13, 2) : A0D(44, 12, 82));
        map.put(A0D(20, 12, 7), str);
        new C1115bV(this.A0R, this.A0X.A7M(), this.A0B.getViewabilityChecker(), this.A0B.getTouchDataRecorder(), this.A0S, this.A0O.A2A(), this.A0W).A05(this.A0O.A2E(), this.A0O.A29().A0J().A05(), map);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public boolean A0X() {
        return this.A0O.A10().equals(A0D(65, 14, AppLovinMediationAdapter.ERROR_MISSING_AD_UNIT_ID)) || (this.A0O.A10().equals(A0D(32, 12, 60)) && this.A0O.A29().A0V());
    }
    ...
    public final void onDestroy() {
        ...
        if (this.A0B != null) {
            if (!TextUtils.isEmpty(this.A0O.A2E())) {
                this.A0S.AB7(this.A0O.A2E(), new C1093b9().A03(this.A0B.getViewabilityChecker()).A02(this.A0B.getTouchDataRecorder()).A05());
            }
            C1287eI c1287eI = this.A0B;
            String[] strArr = A0i;
