...
public class C1730ll<K, V> implements Iterator<Map.Entry<K, Collection<V>>> {
    public static byte[] A03;

    @CheckForNull
    public Collection<V> A00;
    public final Iterator<Map.Entry<K, Collection<V>>> A01;
    public final /* synthetic */ C0407Bt A02;
    ...
    public C1730ll(final C0407Bt this$1) {
        this.A02 = this$1;
    ...
    public final void remove() {
        AbstractC1666ki.A0F(this.A00 != null, A00(0, 50, AppLovinMediationAdapter.ERROR_CHILD_USER));
        this.A01.remove();
