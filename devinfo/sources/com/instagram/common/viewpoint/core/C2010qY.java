...
public final class C2010qY {
    ...
    public static String A00(int i4, int i10, int i11) {
        ...
        for (int i12 = 0; i12 < bArrCopyOfRange.length; i12++) {
            int i13 = (bArrCopyOfRange[i12] ^ i11) ^ 28;
            if (A01[6].charAt(9) == 'Q') {
    ...
    public static String A01(String str) {
        ...
        String name = C2010qY.class.getName();
        int i4 = 0;
    ...
    public static <T extends Throwable> T A02(T t10) {
        return (T) A03(t10, C2010qY.class.getName());
    }

    public static <T extends Throwable> T A03(T throwable, String str) {
        StackTraceElement[] stackTrace = throwable.getStackTrace();
        int i4 = stackTrace.length;
        int lastIntrinsic = -1;
        for (int size = 0; size < i4; size++) {
            if (str.equals(stackTrace[size].getClassName())) {
                lastIntrinsic = size;
            }
        }
        StackTraceElement[] stackTrace2 = (StackTraceElement[]) Arrays.copyOfRange(stackTrace, lastIntrinsic + 1, i4);
