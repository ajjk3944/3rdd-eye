...
public final class C0819Rz implements MediaViewVideoRendererApi {
    ...
    public final AbstractC0460Dx A0E = new AbstractC0460Dx() { // from class: com.facebook.ads.redexgen.X.7H
        /* JADX INFO: Access modifiers changed from: private */
        @Override // com.instagram.common.viewpoint.core.UN
        /* renamed from: A00, reason: merged with bridge method [inline-methods] */
        public final void A03(C0461Dy c0461Dy) {
            this.A00.A00.onSeek();
        }
    };
    public final EA A09 = new EA() { // from class: com.facebook.ads.redexgen.X.7G
        ...
        public final void A03(C4K c4k) {
            ...
            if (!C0886Up.A1j(this.A00.A00.getContext())) {
                return;
            }
            this.A00.A00.play(VideoStartReason.AUTO_STARTED);
        }
    };
    public final AbstractC0454Dr A0F = new AbstractC0454Dr() { // from class: com.facebook.ads.redexgen.X.7F
        /* JADX INFO: Access modifiers changed from: private */
        @Override // com.instagram.common.viewpoint.core.UN
        /* renamed from: A00, reason: merged with bridge method [inline-methods] */
    ...
    public C0806Rm A02 = new C0806Rm();
    ...
    public final void A04(NativeAd nativeAd) {
        this.A08 = nativeAd;
        C1436gi c1436giA16 = ((UK) nativeAd.getInternalNativeAd()).A16();
        C1436gi adObjectContext = this.A03;
        ...
        C1618ju c1618juA12 = UK.A0L(nativeAd.getInternalNativeAd()).A12();
        if (c1618juA12 != null) {
            this.A05.setVideoProgressReportIntervalMs(c1618juA12.A0B());
        }
    ...
    public final void A07(InterfaceC0991Yv interfaceC0991Yv) {
        this.A05.setListener(interfaceC0991Yv);
    }
    ...
    public final void engageSeek() {
        if (this.A06) {
            ...
            this.A06 = true;
            this.A07 = EnumC1378fm.A0A.equals(this.A05.getState());
    ...
    public final void initialize(AdViewConstructorParams adViewConstructorParams, MediaViewVideoRenderer mediaViewVideoRenderer) {
        ...
        if (context instanceof C1436gi) {
            c1436giA03 = (C1436gi) context;
        } else {
            c1436giA03 = C0809Rp.A03(context);
        }
        this.A03 = c1436giA03;
        switch (adViewConstructorParams.getInitializationType()) {
            case 0:
                this.A05 = new C02916r(c1436giA03);
                break;
            case 1:
                this.A05 = new C02916r(c1436giA03, adViewConstructorParams.getAttributeSet());
                break;
            case 2:
                this.A05 = new C02916r(c1436giA03, adViewConstructorParams.getAttributeSet(), adViewConstructorParams.getDefStyleAttr());
                break;
            case 3:
                this.A05 = new C02916r(c1436giA03, adViewConstructorParams.getAttributeSet(), adViewConstructorParams.getDefStyleRes());
                break;
            default:
        ...
        EnumC0946Xc.A04(this.A05, EnumC0946Xc.A0B);
    ...
    public final boolean shouldAutoplay() {
        if (this.A05 == null || this.A05.getState() == EnumC1378fm.A06) {
            return false;
        }
