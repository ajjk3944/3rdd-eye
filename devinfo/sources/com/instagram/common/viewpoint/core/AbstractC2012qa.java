...
public abstract class AbstractC2012qa {
    ...
    public static final Object[] A02(Collection<?> collection) {
        C2010qY.A09(collection, A00(0, 10, 17));
        ...
        while (true) {
            ...
            if (i10 >= objArrCopyOf.length) {
                ...
                if (!it.hasNext()) {
                    ...
                    C2010qY.A08(objArrCopyOf2, A00(10, 11, FacebookMediationAdapter.ERROR_REQUIRES_ACTIVITY_CONTEXT));
            ...
            if (size == 0) {
                ...
                if (!it.hasNext()) {
                    ...
                    if (size <= length) {
                        ...
                        C2010qY.A07(objNewInstance, A00(21, 62, 11));
                            ...
                            if (!it.hasNext()) {
                                if (objArrCopyOf == objArr) {
                                    ...
                                    if (size$iv3 != $i$f$toArrayImpl6) {
                                        ...
                                        C2010qY.A08(objArr, A00(10, 11, FacebookMediationAdapter.ERROR_REQUIRES_ACTIVITY_CONTEXT));
                                    } else {
                                        Object[] result$iv2 = A01;
                                        result$iv2[3] = "wQC4VnYrG9FSwrmyUZJgsxR7nFQ96o5n";
                                        result$iv2[1] = "JKwZ5zO4Pn7yvVfezxQSNQHnVQkdTLIv";
                                        C2010qY.A08(objArr, A00(10, 11, 84));
                                    }
                                }
                                return objArr;
                            }
