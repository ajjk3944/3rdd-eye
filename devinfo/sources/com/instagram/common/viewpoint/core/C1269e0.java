...
public final class C1269e0 {
    public final int[] A00(View view, int i4, int i10) {
        ...
        int childHeightSpec = ViewGroup.getChildMeasureSpec(i4, view.getPaddingLeft() + view.getPaddingRight(), r32.width);
        int childWidthSpec = view.getPaddingTop();
        view.measure(childHeightSpec, ViewGroup.getChildMeasureSpec(i10, childWidthSpec + view.getPaddingBottom(), r32.height));
