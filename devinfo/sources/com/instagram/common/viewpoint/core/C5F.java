...
public final class C5F extends AbstractC0575Ij {
    ...
    public final AbstractC0688Mt A0V;
    public final C1436gi A0W;
    public final VI A0X;
    public final AbstractC0971Yb A0Y;
    ...
    public C5F(C1436gi c1436gi, VA va2, AbstractC0971Yb abstractC0971Yb, AbstractC1601jd abstractC1601jd, C0842Sx c0842Sx, ZU zu, int i4, InterfaceC0977Yh interfaceC0977Yh, VI vi2, int i10, boolean z3, boolean z10, InterfaceC1256dm interfaceC1256dm, int i11, int i12) {
        C0694Na c0694NaA00;
        ...
        this.A02 = 0;
        this.A0R = true;
        this.A0l = new RunnableC1241dX(this);
        this.A0L = false;
        this.A0T = false;
        this.A01 = 0.0f;
        ...
        this.A0i = new AbstractC0462Dz() { // from class: com.facebook.ads.redexgen.X.5K
            /* JADX INFO: Access modifiers changed from: private */
            @Override // com.instagram.common.viewpoint.core.UN
            /* renamed from: A00, reason: merged with bridge method [inline-methods] */
        ...
        this.A0Y = abstractC0971Yb;
        this.A0U = i11;
        this.A08 = new Handler(Looper.getMainLooper());
        this.A09 = (InputMethodManager) c1436gi.getSystemService(A0L(12, 12, 28));
        this.A0V = C0689Mu.A01(c1436gi, va2, abstractC1601jd.A2E(), XB.A00(abstractC1601jd.A29().A0J().A05()), new HashMap(), false, true, abstractC1601jd.A2A());
        this.A0W = c1436gi;
        this.A0X = vi2;
        this.A0j = new C0442Df(this.A0W, this.A0X);
        ...
        A0O();
        A0N();
        C1436gi c1436gi2 = this.A0W;
        String videoUrl2 = abstractC1601jd.A29().A0H().A08();
        AbstractC1137br.A00(c1436gi2, this, videoUrl2);
        setupLayoutConfiguration(false);
        A0T();
        A0S();
        postDelayed(new C0558Hs(this), 1000L);
        if (C0886Up.A1z(this.A0W)) {
            VM vmA0B = this.A0W.A0B();
            C0473Ek c0473Ek = this.A0b;
            String videoUrl3 = super.A06.A2E();
            vmA0B.AKn(c0473Ek, videoUrl3, true);
        }
        if (C0886Up.A20(this.A0W)) {
            this.A0a = new C0483Eu(this.A0W, va2, this.A0b, super.A06.A2E(), false, this.A0c, null);
        } else {
            this.A0a = null;
        }
        A0Y(abstractC1601jd.A29());
    ...
    private void A0O() {
        ...
        layoutParams.setMargins(0, AbstractC0971Yb.A00, A0t, 0);
    ...
    private void A0R() {
        postDelayed(new C0561Hv(this), C0886Up.A0P(this.A0W));
    }
    ...
    private void A0T() {
        View view = this.A0b;
        if (super.A06.A1e()) {
            view.setOnClickListener(new ViewOnClickListenerC1243dZ(this));
        }
        YB.A0J(view);
        YB.A0K(view);
        ...
        YB.A0K(mMediaView3);
        this.A0H = new C1185cd(this.A0W, null, super.A06, super.A08, super.A0B, super.A0D, super.A0A, getColors(), new I4(this));
        ...
        A0W();
        A0M();
        if (C0886Up.A17(this.A0W)) {
            this.A0B.setOnClickListener(new ViewOnClickListenerC1235dR(this));
            View mMediaView6 = this.A0Y;
            if (mMediaView6 != null) {
                this.A0Y.setCTAClickListener(new ViewOnClickListenerC1236dS(this));
            }
        }
    }
    ...
    private void A0Y(NR nr) {
        double dA00 = AbstractC1140bu.A00(nr);
    ...
    public void A0f(C4A c4a) {
        if (this.A0b.getState() == EnumC1378fm.A02 && C0886Up.A1e(this.A0W)) {
            postDelayed(new C0559Ht(this, c4a), 5000L);
        }
    }
    ...
    public void A0g(String str) {
        ...
        boolean zA02 = AbstractC0887Uq.A02(this.A0W);
        ...
        this.A0G = m32;
        this.A0G.setOnTouchListener(new ViewOnTouchListenerC1237dT(this));
    ...
    public void A0j(boolean z3) {
        ...
        ObjectAnimator objectAnimatorOfFloat2 = ObjectAnimator.ofFloat(linearLayout, strA0L, y10, i4);
        ...
        duration.addUpdateListener(new C1239dV(this));
        ...
        animatorSet.addListener(new C1240dW(this, z3));
        if (this.A0n) {
    ...
    private void A0l(boolean z3, int i4) {
        this.A0W.A0F().ACG(!z3, i4);
        if (this.A0E == null) {
            return;
        }
    ...
    public final EnumC0685Mq A1D(String str) {
        if (!A0m()) {
            EnumC0685Mq enumC0685MqA02 = this.A0H.A02(str);
            String[] strArr = A0p;
            if (strArr[2].length() != strArr[3].length()) {
                throw new RuntimeException();
            }
            A0p[1] = "gDqV8VnRL5n4dziTmRcIoSoDocYisV3G";
            return enumC0685MqA02;
        }
    ...
    public final void A1H() {
        ...
        if (iA02 != 0) {
            ...
            if (iA02 < secondsForNextCta2) {
                ...
                new XO(iA02, new C0563Hx(this)).A07();
                return;
            }
        }
    ...
    public final void A1K(boolean z3) {
        if (this.A0b.getState() != EnumC1378fm.A06) {
            EnumC1323et enumC1323et = this.A0I;
            String[] strArr = A0p;
            if (strArr[4].length() != strArr[5].length()) {
                throw new RuntimeException();
            }
    ...
    private void setUpBrowserControls(M3 m32) {
        ...
        this.A0E.setListener(new C0564Hy(this));
        this.A0E.setOnTouchListener(new ViewOnTouchListenerC1238dU(this));
        this.A0A.addView(this.A0E, layoutParams);
        YB.A0J(this.A0F);
        this.A0F = new C1065ah(this.A0W, null, R.attr.progressBarStyleHorizontal);
