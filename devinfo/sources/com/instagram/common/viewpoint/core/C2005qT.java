...
public final class C2005qT implements AnonymousClass24 {
    ...
    public static final AnonymousClass23<C2005qT> A09 = new AnonymousClass23() { // from class: com.facebook.ads.redexgen.X.qU
        @Override // com.instagram.common.viewpoint.core.AnonymousClass23
        public final AnonymousClass24 A6f(Bundle bundle) {
            return C2005qT.A00(bundle);
        }
    };
     ...
     */
    public static C2005qT A00(Bundle bundle) {
        long j = bundle.getLong(A0G);
        int i4 = bundle.getInt(A0B);
        ...
        return new C2005qT(j, i4, i10, intArray, uriArr, longArray, j8, z3);
    }

    /* JADX WARN: Failed to parse debug info
    java.lang.ArrayIndexOutOfBoundsException
     */
    public final C2005qT A06(int i4) {
        int[] iArrA02 = A02(this.A05, i4);
        long[] jArrA03 = A03(this.A06, i4);
        return new C2005qT(this.A03, i4, this.A01, iArrA02, (Uri[]) Arrays.copyOf(this.A07, i4), jArrA03, this.A02, this.A04);
    }

    public C2005qT(long j) {
        this(j, -1, -1, new int[0], new Uri[0], new long[0], 0L, false);
    }

    public C2005qT(long j, int i4, int i10, int[] iArr, Uri[] uriArr, long[] jArr, long j8, boolean z3) {
        AbstractC02203y.A07(iArr.length == uriArr.length);
        this.A03 = j;
        this.A00 = i4;
        this.A01 = i10;
        this.A05 = iArr;
    ...
    public static int[] A02(int[] iArr, int i4) {
        int length = iArr.length;
        int iMax = Math.max(i4, length);
        int[] iArrCopyOf = Arrays.copyOf(iArr, iMax);
        Arrays.fill(iArrCopyOf, length, iMax, 0);
        return iArrCopyOf;
    }

    public static long[] A03(long[] jArr, int i4) {
    ...
    */
    public final boolean A07() {
        ...
        L1c:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C2005qT.A07():boolean");
    }
    ...
    public final boolean equals(Object obj) {
        ...
        C2005qT c2005qT = (C2005qT) obj;
        if (this.A03 == c2005qT.A03 && this.A00 == c2005qT.A00 && this.A01 == c2005qT.A01 && Arrays.equals(this.A07, c2005qT.A07) && Arrays.equals(this.A05, c2005qT.A05) && Arrays.equals(this.A06, c2005qT.A06)) {
            long j = this.A02;
            ...
            if (j == c2005qT.A02 && this.A04 == c2005qT.A04) {
                return true;
            }
        }
        return false;
