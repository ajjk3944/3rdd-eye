...
public final class C8Q {
    ...
    public static int A00(int i4, int i10) throws IllegalArgumentException {
        for (int i11 = 8; i11 > 0; i11--) {
            AudioFormat.Builder sampleRate = new AudioFormat.Builder().setEncoding(i4).setSampleRate(i10);
            int channelCount = C5C.A01(i11);
    ...
    public static int[] A01() {
        ...
        c2kA01.A04(2);
        return AbstractC0380As.A0B(c2kA01.A05());
    }
}
