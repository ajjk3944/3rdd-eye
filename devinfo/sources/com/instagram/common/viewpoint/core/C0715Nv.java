...
public class C0715Nv implements XN {
    ...
    public C0715Nv(NO no) {
        this.A00 = no;
    }

    public /* synthetic */ C0715Nv(NO no, OV ov) {
        this(no);
    }
    ...
    public final void AFV(float f10) {
        ...
        if (this.A00.A0e) {
            if (this.A00.A0J) {
                AbstractC1601jd abstractC1601jd = this.A00.A0O;
                if (A02[6].charAt(27) != 'a') {
                    throw new RuntimeException();
                }
                A02[4] = "3MuDy2E798EtOoHK0e0a3SiH1QgAy5";
                fA04 = 1.0f - (f10 / abstractC1601jd.A29().A0H().A03());
                if (this.A00.A0M || fA04 < 1.0f) {
                    ...
                    this.A00.A0M = true;
                    AbstractC0971Yb abstractC0971Yb = this.A00.A0g;
                    String strA00 = A00(0, 0, 19);
                    if (A02[3].length() != 16) {
                        abstractC0971Yb.setToolbarActionMessage(strA00);
                    } else {
                        String[] strArr = A02;
            ...
            boolean z3 = fA03 >= percentageOfReward;
            if (!this.A00.A0M && z3) {
                this.A00.A0g.setToolbarActionMode(1);
                return;
            }
