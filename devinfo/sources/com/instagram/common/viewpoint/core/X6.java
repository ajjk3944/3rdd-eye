...
public final class X6 {
    ...
    private int A00(C1436gi c1436gi) {
        PackageInfo packageInfo;
        try {
            PackageManager packageManager = c1436gi.getPackageManager();
    ...
    public static Intent A02(C1436gi c1436gi, Uri uri) {
        Intent intentA01 = A01(uri);
        intentA01.addCategory(A07(212, 33, 20));
        intentA01.addFlags(268435456);
        intentA01.putExtra(A07(288, 34, 93), c1436gi.getPackageName());
        intentA01.putExtra(A07(494, 14, 41), false);
        if (C0886Up.A24(c1436gi)) {
    ...
    public static Intent A03(C1436gi c1436gi, Uri uri) {
        Intent intentA01 = A01(uri);
        intentA01.setPackage(A07(322, 19, 35));
        intentA01.putExtra(A07(259, 8, 30), c1436gi.getPackageName());
        intentA01.putExtra(A07(694, 7, 6), true);
        return intentA01;
    }

    public static Uri A04(C1436gi c1436gi, Uri uri) {
    ...
    private final EnumC0685Mq A05(C1436gi c1436gi, Uri uri, String str, Map<String, String> map) throws C0938Ws {
        boolean zA05 = AbstractC0887Uq.A05(c1436gi);
        boolean isInAppBrowserEnabled = A0F(uri);
        if (isInAppBrowserEnabled && zA05) {
            A0C(c1436gi, uri, str, map);
            EnumC0685Mq enumC0685Mq = EnumC0685Mq.A08;
            if (A01[7].length() == 30) {
        ...
        c1436gi.A0F().A9x(zA05);
        A0A(c1436gi, uri);
        return EnumC0685Mq.A07;
    }

    public static EnumC0685Mq A06(X6 x62, C1436gi c1436gi, Uri uri, String str, Map<String, String> extraData) throws PackageManager.NameNotFoundException, C0938Ws {
        ...
        if (!isGooglePlayWebLink && !z3) {
            return x62.A05(c1436gi, uri, str, extraData);
        }
        try {
            x62.A0B(c1436gi, uri, str);
            return EnumC0685Mq.A03;
        } catch (X4 unused) {
            return x62.A05(c1436gi, uri, str, extraData);
        }
    }
    ...
    private void A0A(C1436gi c1436gi, Uri uri) throws C0938Ws {
        C0940Wu.A0D(c1436gi, A02(c1436gi, uri));
    }

    private final void A0B(C1436gi c1436gi, Uri uri, String str) throws PackageManager.NameNotFoundException, C0938Ws, X4 {
        if (A0H(c1436gi)) {
            if (C0886Up.A1I(c1436gi)) {
                ...
                if (!TextUtils.isEmpty(queryParameter)) {
                    ...
                    AbstractC0720Oa.A03(queryParameter, strA07, packageName);
                }
            }
            boolean z3 = (c1436gi.A0H().A01() && C0886Up.A1g(c1436gi)) || (C0886Up.A25(c1436gi) && A0I(c1436gi));
            if (!z3) {
                boolean shouldTryToOpenSplitScreen = C0886Up.A2S(c1436gi);
                if (shouldTryToOpenSplitScreen) {
                    boolean shouldTryToOpenSplitScreen2 = C0940Wu.A0E(c1436gi, A03(c1436gi, uri));
                    if (shouldTryToOpenSplitScreen2) {
                        return;
                    }
                }
            }
            boolean zA0M = A0M(c1436gi, uri, str);
            if (A01[3].charAt(29) != 'Z') {
            ...
            boolean shouldTryToOpenSplitScreen3 = A0K(c1436gi, uri);
            if (shouldTryToOpenSplitScreen3) {
                return;
            }
            Intent intentA02 = A02(c1436gi, uri);
            intentA02.setPackage(A07(322, 19, 35));
            if (Build.VERSION.SDK_INT >= 24 && z3) {
                intentA02.addFlags(268472320);
            }
            C0940Wu.A0D(c1436gi, intentA02);
            return;
        }
        throw new X4();
    }

    private void A0C(C1436gi c1436gi, Uri uri, String str, Map<String, String> map) {
        AdActivityIntent adActivityIntentA05 = C0940Wu.A05(c1436gi);
        ...
        try {
            C0940Wu.A0B(c1436gi, adActivityIntentA05);
        } catch (C0938Ws e2) {
            ...
            c1436gi.A08().ABC(A07(168, 11, 110), AbstractC0848Td.A0D, new C0849Te(cause2));
            Log.e(A07(149, 17, 28), A07(50, 90, 84), cause2);
        }
    }

    public static void A0D(X6 x62, C1436gi c1436gi, Uri uri, String str) {
        x62.A0N(c1436gi, uri, str);
    }

    public static void A0E(X6 x62, C1436gi c1436gi, Uri uri, String str) throws PackageManager.NameNotFoundException, C0938Ws {
        A06(x62, c1436gi, uri, str, null);
    }
    ...
    */
    ...
    private boolean A0G(C1436gi c1436gi) {
        if (!C0886Up.A1F(c1436gi)) {
            return false;
        }
        int deviceFBVersion = C0886Up.A0E(c1436gi);
        int iA00 = A00(c1436gi);
    ...
    private boolean A0H(C1436gi c1436gi) throws SecurityException {
        Intent playStoreIntent = new Intent(A07(186, 26, 10), XB.A00(A07(548, 34, 3)));
        Iterator<ResolveInfo> it = c1436gi.getPackageManager().queryIntentActivities(playStoreIntent, 0).iterator();
        do {
  ...
  0x0079: PHI (r5v2 java.lang.String) = (r5v0 java.lang.String), (r5v3 java.lang.String) binds: [B:33:0x00d7, B:19:0x0077] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public static boolean A0I(com.instagram.common.viewpoint.core.C1436gi r12) throws java.lang.IllegalAccessException, java.lang.NoSuchFieldException, android.content.res.Resources.NotFoundException, android.content.pm.PackageManager.NameNotFoundException, java.lang.IllegalArgumentException {
        /*
    ...
    public static boolean A0J(C1436gi c1436gi) throws IllegalAccessException, NoSuchFieldException, PackageManager.NameNotFoundException, IllegalArgumentException {
        Activity activityA0E;
        PackageManager packageManager;
        ActivityInfo activityInfo;
        try {
            activityA0E = c1436gi.A0E();
            packageManager = c1436gi.getPackageManager();
        } catch (PackageManager.NameNotFoundException | IllegalAccessException | NoSuchFieldException e2) {
            c1436gi.A0F().AC5(e2.getMessage());
        }
    ...
    public static boolean A0K(C1436gi c1436gi, Uri uri) throws PackageManager.NameNotFoundException {
        String strA07 = A07(322, 19, 35);
        if (!C0886Up.A1H(c1436gi)) {
            return false;
        }
        ...
        try {
            ...
            if (packageInfo != null && !TextUtils.isEmpty(packageInfo.versionName)) {
                ...
                if (Integer.parseInt(strArrSplit[0]) < C0886Up.A0G(c1436gi)) {
                    c1436gi.A0F().ABH(3);
                    return false;
                }
            }
            Intent intent = new Intent(A07(186, 26, 10));
            String packageName = c1436gi.getPackageName();
            intent.setPackage(strA07);
            Uri hsdpUri = A04(c1436gi, uri);
            if (hsdpUri == null) {
                return false;
            }
    ...
    private boolean A0L(C1436gi c1436gi, Uri uri, String str) throws C0938Ws {
        try {
            Activity activityA0E = c1436gi.A0E();
            String string = uri.toString();
            if (activityA0E != null && !TextUtils.isEmpty(string)) {
                Intent fbIntent = new Intent();
                if (C0886Up.A1G(c1436gi)) {
                    String strA06 = AbstractC1601jd.A06(str);
                ...
                if (!C0940Wu.A0E(c1436gi, fbIntent)) {
            ...
            c1436gi.A0F().ABG(e2.getMessage());
            return false;
        }
    }

    private boolean A0M(C1436gi c1436gi, Uri uri, String str) throws C0938Ws {
        return A0G(c1436gi) && A0L(c1436gi, uri, str);
    }

    private final boolean A0N(C1436gi c1436gi, Uri uri, String str) {
        return C0940Wu.A0G(c1436gi, uri, str);
    }

    public static boolean A0O(X6 x62, C1436gi c1436gi, Uri uri, String str) {
        try {
            A0E(x62, c1436gi, uri, str);
            return true;
        } catch (C0938Ws e2) {
            Throwable cause = e2.getCause();
            Throwable cause2 = e2;
            ...
            c1436gi.A08().ABC(A07(168, 11, 110), AbstractC0848Td.A05, new C0849Te(cause2));
            return false;
        }
    }
}
