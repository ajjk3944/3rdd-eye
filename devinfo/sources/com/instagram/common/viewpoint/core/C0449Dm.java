...
public final class C0449Dm implements InterfaceC1324eu {
    ...
    public final E4 A09 = new E4() { // from class: com.facebook.ads.redexgen.X.42
        ...
        public final void A03(C4B c4b) {
            ...
            if (this.A00.A0G(EnumC1349fJ.A04)) {
                this.A00.A03();
    ...
    public final E2 A0A = new C02193x(this);
    public final AbstractC0462Dz A0B = new AbstractC0462Dz() { // from class: com.facebook.ads.redexgen.X.3w
        /* JADX INFO: Access modifiers changed from: private */
        @Override // com.instagram.common.viewpoint.core.UN
        /* renamed from: A00, reason: merged with bridge method [inline-methods] */
        public final void A03(C4A c4a) {
            if (this.A00.A04 || !this.A00.A0G(EnumC1349fJ.A04)) {
                return;
            }
            this.A00.A03();
            this.A00.A06(true, false);
    ...
    public final AbstractC0456Dt A0C = new C02173v(this);
    public final Handler A07 = new Handler();
    public final List<InterfaceC1350fK> A0D = new ArrayList();
    public int A00 = AdError.SERVER_ERROR_CODE;
    public boolean A02 = false;

    public C0449Dm(boolean z3, boolean z10) {
        this.A04 = z3;
        this.A03 = z10;
    }
    ...
    public void A03() {
        ...
        Iterator<InterfaceC1350fK> it = this.A0D.iterator();
        while (true) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public boolean A0G(EnumC1349fJ enumC1349fJ) {
        Iterator<InterfaceC1350fK> it = this.A0D.iterator();
        while (it.hasNext()) {
            if (it.next().A9B() != enumC1349fJ) {
                return false;
            }
        }
        return true;
    ...
    public final void A0L(InterfaceC1350fK interfaceC1350fK) {
        this.A0D.add(interfaceC1350fK);
    }
    ...
    public final void AAv(C0473Ek c0473Ek) {
        this.A01 = c0473Ek;
        c0473Ek.getEventBus().A03(this.A09, this.A0C, this.A0A, this.A0B, this.A08);
    }

    @Override // com.instagram.common.viewpoint.core.InterfaceC1324eu
    public final void AKV(C0473Ek c0473Ek) {
        A03();
        c0473Ek.getEventBus().A04(this.A08, this.A0C, this.A0A, this.A0B, this.A09);
        this.A01 = null;
    }
}
