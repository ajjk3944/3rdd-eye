...
public final class C1646kN implements InterfaceC0679Mk {
    ...
    public static final C1646kN A03 = new C1646kN(Collections.emptyMap());
    public int A00;
    ...
    public C1646kN(Map<String, byte[]> metadata) {
        this.A01 = Collections.unmodifiableMap(metadata);
    }

    public static Map<String, byte[]> A00(Map<String, byte[]> otherMetadata, C0680Ml c0680Ml) {
    ...
    */
    public static void A01(java.util.HashMap<java.lang.String, byte[]> r2, java.util.List<java.lang.String> r3) {
        ...
        L11:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C1646kN.A01(java.util.HashMap, java.util.List):void");
    }
    ...
    public static byte[] A04(Object obj) {
        ...
        if (obj instanceof String) {
            return ((String) obj).getBytes(AbstractC1633k9.A05);
        }
    ...
    public final C1646kN A05(C0680Ml c0680Ml) {
        Map<String, byte[]> mapA00 = A00(this.A01, c0680Ml);
        Map<String, byte[]> mutatedMetadata = this.A01;
        if (A03(mutatedMetadata, mapA00)) {
            return this;
        }
        return new C1646kN(mapA00);
    }
    ...
    @Override // com.instagram.common.viewpoint.core.InterfaceC0679Mk
    public final long A6h(String str, long j) {
        byte[] bytes = this.A01.get(str);
        if (bytes != null) {
            long j8 = ByteBuffer.wrap(bytes).getLong();
            if (A02[4].length() != 10) {
                throw new RuntimeException();
            }
            String[] strArr = A02;
    ...
    public final boolean equals(Object obj) {
        ...
        return A03(this.A01, ((C1646kN) obj).A01);
    }
