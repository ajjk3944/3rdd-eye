...
public final class C1880oP implements AnonymousClass93 {
    ...
    public final /* synthetic */ C1877oM A00;
    ...
    @Override // com.instagram.common.viewpoint.core.AnonymousClass93
    public final void AFP(long j, long j8, long j9, long j10) {
        StringBuilder sbAppend = new StringBuilder().append(A00(59, 52, 71)).append(j);
        String strA00 = A00(0, 2, 26);
        String string = sbAppend.append(strA00).append(j8).append(strA00).append(j9).append(strA00).append(j10).append(strA00).append(this.A00.A06()).append(strA00).append(this.A00.A07()).toString();
        if (!C1877oM.A0v) {
            String message = A00(2, 16, 116);
            AbstractC02284g.A07(message, string);
            return;
        }
    ...
    @Override // com.instagram.common.viewpoint.core.AnonymousClass93
    public final void AG9(long j, long j8, long j9, long j10) {
    ...
    @Override // com.instagram.common.viewpoint.core.AnonymousClass93
    public final void AGI(int i4, long j) {
        if (this.A00.A0I != null) {
            this.A00.A0I.AGJ(i4, j, SystemClock.elapsedRealtime() - this.A00.A07);
        }
    }
}
