...
public final class C1792my implements HY {
    ...
    public C1792my(int[] iArr, long[] jArr, long[] jArr2, long[] jArr3) {
        this.A01 = iArr;
        this.A03 = jArr;
        this.A02 = jArr2;
        this.A04 = jArr3;
    ...
    public final HX A91(long j) {
        ...
        if (hz.A01 < j) {
            ...
            if (iA00 != chunkIndex - 1) {
                ...
                long j8 = this.A04[chunkIndex2];
                int chunkIndex3 = iA00 + 1;
                HZ seekPoint = new HZ(j8, this.A03[chunkIndex3]);
    ...
    public final String toString() {
        return A01(42, 18, 116) + this.A00 + A01(25, 8, 1) + Arrays.toString(this.A01) + A01(15, 10, 91) + Arrays.toString(this.A03) + A01(33, 9, 93) + Arrays.toString(this.A04) + A01(1, 14, 13) + Arrays.toString(this.A02) + A01(0, 1, AppLovinMediationAdapter.ERROR_CHILD_USER);
    }
}
