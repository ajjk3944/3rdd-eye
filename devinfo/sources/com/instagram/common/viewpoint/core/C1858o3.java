...
public final class C1858o3 implements CJ {
    public static byte[] A02;
    public static final SparseArray<Constructor<? extends CH>> A03;
    public final C1652kT A00;
    ...
    public static Constructor<? extends CH> A03(Class<?> cls) {
        try {
            return cls.asSubclass(CH.class).getConstructor(C1985q7.class, C1652kT.class, Executor.class);
        } catch (NoSuchMethodException e2) {
            throw new IllegalStateException(A02(0, 30, 5), e2);
        }
    }
    ...
    public C1858o3(C1652kT c1652kT, Executor executor) {
        this.A00 = (C1652kT) AbstractC02203y.A01(c1652kT);
        this.A01 = (Executor) AbstractC02203y.A01(executor);
    }
    ...
    private CH A01(DownloadRequest downloadRequest, int i4) {
        Constructor<? extends CH> constructor = A03.get(i4);
        if (constructor != null) {
            try {
                return constructor.newInstance(new C01922u().A00(downloadRequest.A00).A04(downloadRequest.A04).A02(downloadRequest.A01).A05(), this.A00, this.A01);
            } catch (Exception e2) {
                throw new IllegalStateException(A02(30, 50, 59) + i4, e2);
            }
        }
        throw new IllegalStateException(A02(80, 32, 96) + i4);
    }
    ...
    public final CH A5M(DownloadRequest downloadRequest) {
        ...
        switch (iA0B) {
            ...
            case 3:
            default:
                throw new IllegalArgumentException(A02(AppLovinMediationAdapter.ERROR_CHILD_USER, 18, 52) + iA0B);
            case 4:
                return new C1853nx(new C01922u().A00(downloadRequest.A00).A02(downloadRequest.A01).A05(), this.A00, this.A01);
        }
    }
}
