...
public final class Y2 {
    ...
    private EnumC0946Xc A00() {
        if (this.A0G == null || this.A0F == null) {
            return EnumC0946Xc.A0J;
        }
        View view = this.A0G;
        String[] strArr = A0J;
        if (strArr[6].length() == strArr[4].length()) {
            ...
            strArr2[4] = "";
            if (view != this.A0F) {
                EnumC0946Xc enumC0946Xc = EnumC0946Xc.A0H;
                String[] strArr3 = A0J;
            ...
            Object tag = this.A0G.getTag(EnumC0946Xc.A02);
            if (tag == null) {
                return EnumC0946Xc.A0I;
            }
            if (!(tag instanceof EnumC0946Xc)) {
                EnumC0946Xc enumC0946Xc2 = EnumC0946Xc.A0K;
                if (A0J[2].charAt(2) == 'm') {
                    A0J[0] = "fnwPYOgaVMSkQLAdq2SZMccx8Jl2b0fK";
                    return enumC0946Xc2;
                }
            } else {
                return (EnumC0946Xc) tag;
            }
        }
        throw new RuntimeException();
    }
    ...
    public final Map<String, String> A04() {
        ...
        String radius12 = A01(89, 4, AppLovinMediationAdapter.ERROR_CHILD_USER);
    ...
    public final void A06(C1436gi c1436gi, MotionEvent motionEvent, View view, View view2) {
        if (view == null) {
            c1436gi.A0F().AKl();
            return;
        }
    ...
    public final boolean A09(Context context) {
        ...
        if (BuildConfigApi.isDebug()) {
            String str = A01(108, 21, 55) + z3 + A01(2, 18, 57) + iA07 + A01(0, 2, 74) + jA03;
        }
        return z3;
    }
}
