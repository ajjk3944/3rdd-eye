...
public final class ImfSpecParser {
    ...
    public static final List<ImfDataTrack> A01(String str) throws JSONException {
        ...
        for (int i4 = 0; i4 < length; i4++) {
            ...
            String string3 = jSONObject.getString(A00(WebSocketProtocol.PAYLOAD_SHORT, 14, 42));
            C2010qY.A06(string2);
            C2010qY.A06(string3);
            C1578j7 c1578j7 = new C1578j7(string2, string3);
            JSONArray jSONArray2 = imfTrack.getJSONArray(A00(1, 12, 63));
            int length2 = jSONArray2.length();
            for (int i10 = 0; i10 < length2; i10++) {
                JSONObject dataTrack = jSONArray2.getJSONObject(i10);
                ...
                long j8 = dataTrack.getJSONObject(strA00).getJSONObject(A00(22, 7, 94)).getLong(strA002);
                JSONObject jSONObject3 = new JSONObject(dataTrack.getString(A00(FacebookMediationAdapter.ERROR_BANNER_SIZE_MISMATCH, 15, 77)));
                C2010qY.A06(string);
                arrayList.add(new ImfDataTrack(string, j, j8, c1578j7, new C1577j6(jSONObject3.getDouble(A00(69, 9, 118)), jSONObject3.getDouble(A00(78, 9, 61)), jSONObject3.getDouble(A00(56, 13, 67)), jSONObject3.getDouble(A00(42, 14, 35)), jSONObject3.getDouble(A00(87, 15, 35)))));
            }
        }
        return arrayList;
    }
