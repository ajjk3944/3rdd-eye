...
public final class C0812Rs implements InterstitialAdApi, Repairable {
    ...
    public C0812Rs(Context context, String str, InterstitialAd interstitialAd) {
        String string;
        this.A00 = interstitialAd;
        if (context instanceof C1436gi) {
            this.A03 = (C1436gi) context;
            string = this.A03.A0F().getId();
        } else {
            string = UUID.randomUUID().toString();
            this.A03 = C0809Rp.A06(context, string);
        }
        InterfaceC0662Lt interfaceC0662LtA0F = this.A03.A0F();
        String adId = AdPlacementType.INTERSTITIAL.toString();
        interfaceC0662LtA0F.A3T(adId, str);
        this.A01 = new C1546iY(this.A03, interstitialAd, str);
        this.A03.A0O(this);
    ...
    public final void A05(EnumSet<CacheFlag> enumSet, String str) {
        AbstractC0919Vy.A05(A00(129, 8, 122), A00(65, 30, FacebookMediationAdapter.ERROR_ADVIEW_CONSTRUCTOR_EXCEPTION), A00(16, 8, 42));
        if (str == null) {
            this.A03.A0F().A3Q();
        } else {
            this.A03.A0F().A3P();
    ...
    public final void destroy() {
        AbstractC0919Vy.A05(A00(122, 7, 21), A00(40, 25, 105), A00(0, 8, 21));
        if (C0886Up.A2M(this.A03)) {
            return;
        }
        this.A02.A08();
        this.A03.A0F().A3U();
    ...
    public final void loadAd(InterstitialAd.InterstitialLoadAdConfig interstitialLoadAdConfig) {
        ((C0813Rt) interstitialLoadAdConfig).A00();
    }

    @Override // com.facebook.ads.internal.context.Repairable
    public final void repair(Throwable th2) {
        if (this.A01.A6o() != null) {
            this.A01.A6o().onError(this.A00, new AdError(AdError.INTERNAL_ERROR_CODE, A00(24, 16, 63) + AbstractC0963Xt.A03(this.A03, th2)));
        }
    }
    ...
    public final boolean show() {
        AbstractC0919Vy.A05(A00(137, 4, 11), A00(95, 27, 100), A00(8, 8, 56));
        this.A03.A0F().A3Z();
        boolean zA0I = this.A02.A0I(this.A00, new C0814Ru());
