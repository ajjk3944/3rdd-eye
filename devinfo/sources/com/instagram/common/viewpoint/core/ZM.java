...
public final class ZM extends LinearLayout {
    ...
    public ZM(C1436gi c1436gi, AbstractC1601jd abstractC1601jd, int i4) {
        super(c1436gi);
        ...
        this.A05 = new RelativeLayout(c1436gi);
        this.A06 = new TextView(c1436gi);
        this.A00 = i4;
        A00();
    }
    ...
    private void A00() {
        ...
        this.A02.setShape(0);
        this.A02.setColor(LinearLayoutManager.INVALID_OFFSET);
