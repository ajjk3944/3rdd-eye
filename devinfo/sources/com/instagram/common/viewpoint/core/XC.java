...
public final class XC {
    ...
    public static int A00(C1436gi c1436gi, int i4) {
        return WN.A00(c1436gi).getInt(A01(0, 21, 52), i4);
    }

    public static String A02(C1436gi c1436gi, String str) {
        int iA00 = A00(c1436gi, -1);
        if (iA00 == -1) {
            return null;
        }
        try {
    ...
    public final InterstitialAd A06(C1436gi c1436gi, String str, String str2) {
        if (c1436gi == null) {
            return null;
        }
        try {
            InterstitialAd interstitialAd = new InterstitialAd(c1436gi, str);
    ...
    public final RewardedVideoAd A07(C1436gi c1436gi, String str, String str2) {
        if (c1436gi == null) {
            return null;
        }
        try {
            RewardedVideoAd rewardedVideoAd = new RewardedVideoAd(c1436gi, str);
    ...
    public final void A08(C1436gi c1436gi, boolean z3) {
        int i4 = 0;
        String strA01 = A01(0, 21, 52);
        if (!z3) {
            int lastNonChainedAds = WN.A00(c1436gi).getInt(strA01, 0);
            i4 = lastNonChainedAds + 1;
        }
        WN.A00(c1436gi).edit().putInt(strA01, i4).apply();
    }

    public final boolean A09(C1436gi c1436gi, String str, int i4) {
        if (i4 <= 0) {
            return false;
        }
        try {
            if (!A05(str)) {
                int lastNonChainedAds = A00(c1436gi, i4 - 1);
                return lastNonChainedAds >= i4 + (-1);
            }
        } catch (JSONException unused) {
        }
        return false;
