...
public class AN extends BS<String, List<String>> {
    ...
    @Override // com.instagram.common.viewpoint.core.AbstractC1868oD
    ...
    public final Set<Map.Entry<String, List<String>>> entrySet() {
        return AbstractC2019qj.A07(super.entrySet(), new InterfaceC1667kj() { // from class: com.facebook.ads.redexgen.X.pC
    ...
    public final Set<String> keySet() {
        return AbstractC2019qj.A07(super.keySet(), new InterfaceC1667kj() { // from class: com.facebook.ads.redexgen.X.pD
            @Override // com.instagram.common.viewpoint.core.InterfaceC1667kj
            public final boolean A4C(Object obj) {
