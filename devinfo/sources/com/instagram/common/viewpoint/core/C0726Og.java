...
public final class C0726Og {
    ...
    public final InterfaceC0732Om A00;
    ...
    public static List<C0730Ok> A04(String str) throws JSONException {
        ...
        for (int i4 = 0; i4 < jSONArray.length(); i4++) {
            ...
            C0730Ok c0730Ok = new C0730Ok(jSONObject.getInt(A02(604, 12, 116)), jSONObject.getString(A02(593, 11, 55)), jSONObject.optString(A02(369, 16, 63)));
            Iterator<C0730Ok> it = A04(jSONObject.optString(A02(385, 16, 127))).iterator();
            while (it.hasNext()) {
                c0730Ok.A06(it.next());
            }
            arrayList.add(c0730Ok);
        }
        return arrayList;
    }
            ...
            if (!str.equals(A02(353, 2, 45))) {
                ...
                try {
                    ...
                    if (A04(jSONObject.getString(A02(673, 17, 10))).size() == 0) {
                        A08(AbstractC0848Td.A28, new C0849Te(A02(239, 20, FacebookMediationAdapter.ERROR_NULL_CONTEXT)));
                        return null;
                    }
                    if (A04(jSONObject.getString(A02(PglCryptUtils.DECRYPT_FAILED, 15, 8))).size() == 0) {
                        A08(AbstractC0848Td.A25, new C0849Te(A02(221, 18, 45)));
                        return null;
                    }
                    return map;
                } catch (JSONException e2) {
                    A08(AbstractC0848Td.A27, new C0849Te(e2));
                    return null;
                }
            }
        }
    ...
    private final void A07() {
        C1525iC c1525iCA6I = this.A00.A6I();
        c1525iCA6I.A00(A02(521, 22, 15), 0L);
        c1525iCA6I.A02();
    }

    public static void A08(int i4, C0849Te c0849Te) {
        C1432ge sdkContext = T7.A00();
        if (sdkContext != null) {
            sdkContext.A08().ABC(A02(690, 9, 19), i4, c0849Te);
        }
    }
    ...
    public final C0730Ok A0A() {
        C0730Ok c0730Ok = new C0730Ok(A00());
        try {
            for (C0730Ok hideAdParent : A04(A03(A02(PglCryptUtils.DECRYPT_FAILED, 15, 8), A02(0, 0, 48)))) {
                c0730Ok.A06(hideAdParent);
            }
        } catch (JSONException e2) {
            A07();
            A08(AbstractC0848Td.A26, new C0849Te(e2));
        }
        return c0730Ok;
    }

    public final C0730Ok A0B() {
        C0730Ok c0730Ok = new C0730Ok(A01());
        try {
            for (C0730Ok reportAdParent : A04(A03(A02(673, 17, 10), A02(0, 0, 48)))) {
                c0730Ok.A06(reportAdParent);
            }
        } catch (JSONException e2) {
            A07();
            A08(AbstractC0848Td.A29, new C0849Te(e2));
        }
        return c0730Ok;
    }
    ...
    public final String A0D() {
        return A03(A02(TTAdConstant.MATE_IS_NULL_CODE, 20, 41), A02(315, 38, 95));
    }

    public final String A0E() {
        return A03(A02(StatusLine.HTTP_MISDIRECTED_REQUEST, 16, 22), A02(38, 10, 19));
    }
    ...
    public final String A0J() {
        return A03(A02(543, 21, 127), A02(TTAdConstant.MATE_VALID, 21, 1));
    }

    public final String A0K() {
        return A03(A02(625, 21, FacebookMediationAdapter.ERROR_ADVIEW_CONSTRUCTOR_EXCEPTION), A02(0, 38, AppLovinMediationAdapter.ERROR_CHILD_USER));
    }
    ...
    public final void A0N(String str) {
        ...
        C1525iC c1525iCA6I = this.A00.A6I();
        for (String str2 : A03) {
            c1525iCA6I.A01(str2, mapA05.get(str2));
        }
        if (A02[1].length() == 0) {
            throw new RuntimeException();
        }
        ...
        strArr[5] = "LB7njF";
        c1525iCA6I.A00(A02(521, 22, 15), System.currentTimeMillis());
        c1525iCA6I.A02();
    }

    public final boolean A0O(Context context, boolean z3) {
        return (z3 || C0886Up.A2h(context)) && ((A09() > 0L ? 1 : (A09() == 0L ? 0 : -1)) > 0);
    }
}
