...
public final class C1681ky implements HY {
    ...
    public C1681ky(LN ln, int i4, long j, long j8) {
        this.A04 = ln;
        this.A00 = i4;
        this.A03 = j;
        this.A01 = (j8 - j) / ln.A02;
    ...
    public final HX A91(long j) {
        ...
        long j8 = this.A03 + (this.A04.A02 * jA0T);
        long jA00 = A00(jA0T);
        HZ hz = new HZ(jA00, j8);
        if (jA00 >= j || jA0T == this.A01 - 1) {
            return new HX(hz);
        }
        long j9 = 1 + jA0T;
        return new HX(hz, new HZ(A00(j9), this.A03 + (this.A04.A02 * j9)));
    }
