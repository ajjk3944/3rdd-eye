...
public final class TextureViewSurfaceTextureListenerC0436Cz extends TextureView implements TextureView.SurfaceTextureListener, InterfaceC1360fU, InterfaceC1376fk, InterfaceC1362fW {
    ...
    public EnumC1378fm A0E;
    public InterfaceC1379fn A0F;
    public String A0G;
    public boolean A0H;
    public boolean A0I;
    public boolean A0J;
    ...
    public final void onSurfaceTextureUpdated(SurfaceTexture surfaceTexture) {
        if (C0886Up.A20(this.A0A)) {
            EnumC1378fm enumC1378fm = this.A0D;
            if (A0P[6].length() != 18) {
            ...
            strArr[0] = "Md";
            strArr[1] = "f0";
            if (enumC1378fm == EnumC1378fm.A08) {
                return;
            }
            if (!this.A0L) {
                this.A0L = true;
    ...
    static {
        A07();
        A0Q = TextureViewSurfaceTextureListenerC0436Cz.class.getSimpleName();
    }

    public TextureViewSurfaceTextureListenerC0436Cz(C1436gi c1436gi) {
        super(c1436gi);
        this.A0D = EnumC1378fm.A04;
        this.A0E = EnumC1378fm.A04;
        this.A0M = false;
        this.A0N = false;
        this.A0J = false;
        this.A03 = 0;
    ...
    public TextureViewSurfaceTextureListenerC0436Cz(C1436gi c1436gi, AttributeSet attributeSet) {
    ...
    public TextureViewSurfaceTextureListenerC0436Cz(C1436gi c1436gi, AttributeSet attributeSet, int i4) {
    ...
    */
    private void A04() {
        ...
        L4a:
            ...
            java.lang.String[] r1 = com.instagram.common.viewpoint.core.TextureViewSurfaceTextureListenerC0436Cz.A0P
            r0 = 6
            r0 = r1[r0]
            int r1 = r0.length()
            r0 = 18
        ...
        L66:
            ...
            if (r1 == r0) goto L7f
            java.lang.String[] r2 = com.instagram.common.viewpoint.core.TextureViewSurfaceTextureListenerC0436Cz.A0P
        ...
        La4:
            ...
            r2.A0F(r1, r0)
        Lb1:
            com.facebook.ads.redexgen.X.fm r0 = com.instagram.common.viewpoint.core.EnumC1378fm.A08
            r5.setVideoState(r0)
        ...
        Lc3:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.TextureViewSurfaceTextureListenerC0436Cz.A04():void");
    }
    ...
    private void A08(int i4, int i10) {
    ...
    @Override // com.instagram.common.viewpoint.core.InterfaceC1360fU
    public final void AFL(String str, Exception exc) {
        this.A0A.A0F().ACW(str);
        this.A0A.A0F().A3i(1);
        setVideoState(EnumC1378fm.A03);
        this.A0A.A08().ABC(A03(362, 7, 50), AbstractC0848Td.A1N, new C0849Te(exc));
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:19:0x005e, code lost:
        ...
        r3 = com.instagram.common.viewpoint.core.EnumC1378fm.A05;
        r2 = com.instagram.common.viewpoint.core.TextureViewSurfaceTextureListenerC0436Cz.A0P;
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:21:0x0072, code lost:
        ...
        com.instagram.common.viewpoint.core.TextureViewSurfaceTextureListenerC0436Cz.A0P[6] = "dNFvbzP2EYglZVOCcO";
        setVideoState(r3);
     */
    ...
    */
    public final void AFM(boolean r8, int r9) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.TextureViewSurfaceTextureListenerC0436Cz.AFM(boolean, int):void");
    }

    @Override // com.instagram.common.viewpoint.core.InterfaceC1362fW
    public final void AGa(int i4, int i10, int i11, float f10) {
        A08(i4, i10);
    }

    @Override // com.instagram.common.viewpoint.core.InterfaceC1376fk
    public final void AGr(boolean z3, int i4) {
        this.A0A.A0F().A3e(i4);
        this.A0E = EnumC1378fm.A05;
        this.A0M = z3;
        if (this.A0C != null) {
            this.A0C.A0I(false);
        } else {
    ...
    @Override // com.instagram.common.viewpoint.core.InterfaceC1376fk
    public final void AK6(EnumC1323et enumC1323et, int i4) {
        this.A0A.A0F().A3p(i4);
        this.A0M = false;
        this.A0E = EnumC1378fm.A0A;
        this.A0B = enumC1323et;
        if (this.A0C == null) {
            setup(this.A06);
            return;
        }
        if (this.A0D != EnumC1378fm.A07 && this.A0D != EnumC1378fm.A05 && this.A0D != EnumC1378fm.A06) {
            return;
        }
        this.A0C.A0I(true);
        EnumC1378fm enumC1378fm = EnumC1378fm.A0A;
        String[] strArr = A0P;
        ...
        strArr2[0] = "Wi";
        strArr2[1] = "9L";
        setVideoState(enumC1378fm);
    }

    @Override // com.instagram.common.viewpoint.core.InterfaceC1376fk
    public final void AKF(int i4) {
        this.A0A.A0F().A3r(i4);
        this.A0E = EnumC1378fm.A04;
        if (this.A0C != null) {
            this.A0C.A0B();
    ...
    public final void onAttachedToWindow() {
        ...
        if (C0886Up.A2l(getContext()) && !isHardwareAccelerated()) {
            setVideoState(EnumC1378fm.A03);
            AKF(8);
        }
    }
    ...
    public final void onSurfaceTextureAvailable(SurfaceTexture surfaceTexture, int i4, int i10) {
        ...
        if (this.A0D == EnumC1378fm.A05 && !this.A0M) {
            AK6(this.A0B, 7);
        }
    }
        ...
        if (this.A07 != null) {
            ...
            if (this.A0C != null) {
                try {
                    ...
                    this.A0A.A0F().ACW(A03(0, 75, 53) + e2.getMessage());
                }
            }
        }
        if (this.A0D != EnumC1378fm.A05) {
            try {
                AGr(false, 5);
                return true;
            } catch (Exception e10) {
    ...
    public final void onWindowFocusChanged(boolean z3) {
        ...
        if (!z3) {
            if (this.A0D != EnumC1378fm.A05) {
                if ((this.A0A.A0H().A01() || C0886Up.A25(this.A0A)) && Build.VERSION.SDK_INT >= 24) {
    ...
    public void setControlsAnchorView(View view) {
        this.A08 = view;
        view.setOnTouchListener(new ViewOnTouchListenerC1371ff(this));
    }
    ...
    public void setFullScreen(boolean z3) {
        this.A0J = z3;
        if (z3 && !this.A0I) {
            setOnTouchListener(new ViewOnTouchListenerC1370fe(this));
        }
    }
    ...
    public void setRequestedVolume(float f10) {
        this.A00 = f10;
        if (this.A0C != null && this.A0D != EnumC1378fm.A08 && this.A0D != EnumC1378fm.A04) {
            this.A0C.A0C(f10);
        }
    }
    ...
    private void setVideoState(EnumC1378fm enumC1378fm) {
        if (enumC1378fm != this.A0D) {
            if (this.A0A.A05().AAO()) {
                String str = A03(339, 23, 30) + enumC1378fm;
            }
            this.A0D = enumC1378fm;
            if (this.A0D == EnumC1378fm.A0A) {
                this.A0N = true;
            }
            if (this.A0F != null) {
                this.A0F.AGd(enumC1378fm);
            }
        }
    }
