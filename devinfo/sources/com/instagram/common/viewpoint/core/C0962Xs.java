...
public class C0962Xs extends Writer {
    ...
    public int A00;
    public char[] A01 = new char[Segment.SHARE_MINIMUM];
    public final InterfaceC0961Xr A02;

    public C0962Xs(InterfaceC0961Xr interfaceC0961Xr) {
    ...
    */
    public final void write(char[] r6, int r7, int r8) throws java.io.IOException {
        ...
        L1:
            int r4 = r7 + r8
            java.lang.String[] r2 = com.instagram.common.viewpoint.core.C0962Xs.A03
            r0 = 2
            r1 = r2[r0]
            r0 = 4
            r0 = r2[r0]
        ...
        L46:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C0962Xs.write(char[], int, int):void");
    }
}
