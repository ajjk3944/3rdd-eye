...
public final class KB extends AbstractC1149c3 {
    ...
    public final VI A0O;
    public final C1130bk A0P;
    public final C1132bm A0Q;
    public final C1153c7 A0R;
    ...
    public static String A0J(int i4, int i10, int i11) {
        byte[] bArrCopyOfRange = Arrays.copyOfRange(A0W, i4, i4 + i10);
    ...
    public KB(C1153c7 c1153c7) {
        ...
        this.A0T = new EA() { // from class: com.facebook.ads.redexgen.X.6D
            ...
            public final void A03(C4K c4k) {
                this.A00.A0S.A0e(EnumC1323et.A02, 20);
            }
        };
        this.A0V = new RunnableC1179cX(this);
        this.A0N = c1153c7.A06();
        this.A0R = c1153c7;
        ...
        YB.A0K(this.A0F);
        AbstractC1137br.A00(this.A0R.A06(), this, this.A0R.A05().A29().A0H().A08());
    ...
    private RelativeLayout A07(String str, int i4) {
        RelativeLayout relativeLayout = new RelativeLayout(this.A0N);
        relativeLayout.setPadding(XV.A0b, XV.A0b, XV.A0b, XV.A0b);
        YB.A0V(relativeLayout, YB.A06(i4, 30));
    ...
    private C1130bk A0D() {
        C1130bk c1130bk = new C1130bk(this.A0N);
        YB.A0N(c1130bk, 0);
        int i4 = (int) (this.A00 * 0.13f);
        new LM(c1130bk, this.A0N).A05(i4, i4).A07(this.A0R.A05().A2C().A01());
        return c1130bk;
    }

    private C1132bm A0E() {
        C1132bm c1132bm = new C1132bm(this.A0N, A0Y, 5, 0, -1);
        c1132bm.setRating(getRating());
        return c1132bm;
    }

    private C0473Ek A0G() {
        C0473Ek c0473Ek = new C0473Ek(this.A0R.A06());
        this.A0A = new C4L(this.A0N, getAdEventManager(), c0473Ek, this.A0R.A05().A2E(), 0, 0, true, null, null);
        if (C0886Up.A20(this.A0N)) {
            this.A09 = new C0483Eu(this.A0N, getAdEventManager(), c0473Ek, this.A0R.A05().A2E(), false, this.A0A, null);
        } else {
            String[] strArr = A0X;
            if (strArr[2].length() == strArr[4].length()) {
                throw new RuntimeException();
        ...
        c0473Ek.setRoundedCornerVideoView(44.0f);
        return c0473Ek;
    }

    private void A0K() {
        this.A0F.setOnClickListener(new ViewOnClickListenerC1181cZ(this));
        if (this.A0R.A05().A1p()) {
            this.A0M.setOnClickListener(new ViewOnClickListenerC1182ca(this));
        } else {
            this.A0H.setOnClickListener(new ViewOnClickListenerC1183cb(this));
        }
    }

    private void A0L() {
        if (this.A0R.A05().A2M()) {
            this.A06 = A00(this.A0N, this.A0R.A05(), this.A0O, EnumC1044aM.A06, this.A0R.A0C());
            YB.A0K(this.A06);
        } else {
            if (!this.A0R.A05().A1p()) {
                return;
            }
            this.A05 = AbstractC0727Oh.A00(this.A0N.A02());
            this.A04 = A03();
            YB.A0K(this.A04);
            A0O();
        }
    ...
    private void A0M() {
        if (this.A0R.A05().A2W()) {
            this.A07 = A01(this.A0N, EnumC1044aM.A06);
            YB.A0K(this.A07);
        }
    }
    ...
    private void A0O() {
        if (this.A04 != null) {
            this.A04.setOnClickListener(new ViewOnClickListenerC1180cY(this));
        }
        A0T(8);
    }
    ...
    public void A0P() {
        ...
        C0706Nm c0706NmA2C = this.A0R.A05().A2C();
        if (this.A05 != null && this.A05.A0O(this.A0N.A02(), true)) {
            this.A0R.A0C().AAo(this.A0R.A05().A2E(), c0706NmA2C);
        } else {
            if (TextUtils.isEmpty(c0706NmA2C.A00())) {
                return;
            }
            X6.A0O(new X6(), this.A0N, XB.A00(c0706NmA2C.A00()), this.A0R.A05().A2E());
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void A0T(int i4) {
        if (this.A03 == null || this.A02 == null) {
            return;
        }
        if (i4 == 0) {
            this.A03.setVisibility(i4);
    ...
    private void A0Y(int i4) {
        ...
        if (this.A0R.A05().A2U()) {
            ...
            layoutParams.addRule(9);
            layoutParams.setMargins(i10, XV.A0r, 0, 0);
        } else {
            layoutParams.addRule(12);
            layoutParams.addRule(9);
            layoutParams.setMargins(i10, 0, 0, XV.A0b);
        }
    ...
    private void A0e(int i4) {
        ...
        if (i4 == 1) {
            ...
            layoutParams.setMargins(XV.A0n, 0, XV.A0n, i10);
    ...
    */
    private void A0g(int r11) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.KB.A0g(int):void");
    }
    ...
    private void A0i(int i4) {
        ...
        if (i4 == 1) {
            ...
            layoutParams.setMargins(bottomMargin, 0, XV.A0n, i10);
        } else {
