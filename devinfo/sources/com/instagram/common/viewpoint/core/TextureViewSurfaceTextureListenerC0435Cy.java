...
public final class TextureViewSurfaceTextureListenerC0435Cy extends TextureView implements MediaPlayer.OnBufferingUpdateListener, MediaPlayer.OnCompletionListener, MediaPlayer.OnErrorListener, MediaPlayer.OnInfoListener, MediaPlayer.OnPreparedListener, MediaPlayer.OnVideoSizeChangedListener, MediaPlayer.OnSeekCompleteListener, TextureView.SurfaceTextureListener, InterfaceC1376fk {
    ...
    public EnumC1323et A0B;
    public EnumC1378fm A0C;
    public EnumC1378fm A0D;
    public InterfaceC1379fn A0E;
    public boolean A0F;
    public boolean A0G;
    public boolean A0H;
    public boolean A0I;
    ...
    static {
        A04();
        A0Q = TextureViewSurfaceTextureListenerC0435Cy.class.getSimpleName();
    }

    public TextureViewSurfaceTextureListenerC0435Cy(C1436gi c1436gi) {
        super(c1436gi);
        this.A0C = EnumC1378fm.A04;
        this.A0D = EnumC1378fm.A04;
        this.A0J = false;
        this.A03 = 0;
        this.A05 = 0;
        this.A04 = 0;
        ...
        this.A02 = 0;
        this.A0G = false;
        this.A0B = EnumC1323et.A03;
        this.A0M = new C1373fh(this);
        this.A0I = false;
        this.A0N = c1436gi;
    }

    public TextureViewSurfaceTextureListenerC0435Cy(C1436gi c1436gi, AttributeSet attributeSet) {
    ...
    public TextureViewSurfaceTextureListenerC0435Cy(C1436gi c1436gi, AttributeSet attributeSet, int i4) {
    ...
    private boolean A06() {
        return (this.A0C == EnumC1378fm.A08 || this.A0C == EnumC1378fm.A07) ? false : true;
    }

    private boolean A07() {
        return this.A0C == EnumC1378fm.A07 || this.A0C == EnumC1378fm.A0A || this.A0C == EnumC1378fm.A05 || this.A0C == EnumC1378fm.A06;
    }
    ...
    private boolean A09() {
        ...
        try {
            ...
            this.A0N.A08().ABC(A03(384, 6, 110), AbstractC0848Td.A2H, new C0849Te(e2));
            return false;
        }
    }
    ...
    private boolean A0A(Surface surface) {
        ...
        try {
            ...
            this.A0N.A08().ABC(A03(384, 6, 110), AbstractC0848Td.A2I, new C0849Te(e2));
            return false;
        }
    }
    ...
    @Override // com.instagram.common.viewpoint.core.InterfaceC1376fk
    ...
    @Override // com.instagram.common.viewpoint.core.InterfaceC1376fk
    public final void AGr(boolean z3, int i4) throws IllegalStateException {
        this.A0N.A0F().A3e(i4);
        this.A0D = EnumC1378fm.A05;
        if (this.A06 != null) {
            if (!A06()) {
                return;
            }
            this.A0J = z3;
            this.A06.pause();
            if (this.A0C != EnumC1378fm.A06) {
                setVideoState(EnumC1378fm.A05);
                return;
            }
            return;
        }
        setVideoState(EnumC1378fm.A04);
    }

    @Override // com.instagram.common.viewpoint.core.InterfaceC1376fk
    public final void AK1(int i4) throws IllegalStateException {
        this.A0N.A0F().ACX(i4);
        setVideoState(EnumC1378fm.A09);
        AKF(5);
        this.A03 = 0;
    }

    @Override // com.instagram.common.viewpoint.core.InterfaceC1376fk
    public final void AK6(EnumC1323et enumC1323et, int i4) throws IllegalStateException, IOException, SecurityException, IllegalArgumentException {
        this.A0N.A0F().A3p(i4);
        this.A0J = false;
        this.A0D = EnumC1378fm.A0A;
        this.A0B = enumC1323et;
        if (this.A0C == EnumC1378fm.A0A || this.A0C == EnumC1378fm.A07 || this.A0C == EnumC1378fm.A04 || this.A0C == EnumC1378fm.A05 || this.A0C == EnumC1378fm.A06) {
            if (this.A06 == null) {
                setup(this.A07);
            } else {
                if (this.A03 > 0) {
                ...
                this.A06.start();
                if (this.A0C != EnumC1378fm.A07 || this.A0K) {
                    setVideoState(EnumC1378fm.A0A);
                }
            }
        }
        if (isAvailable()) {
    ...
    @Override // com.instagram.common.viewpoint.core.InterfaceC1376fk
    public final void AKF(int i4) throws IllegalStateException {
        this.A0N.A0F().A3r(i4);
        this.A0D = EnumC1378fm.A04;
        if (this.A06 != null) {
    ...
    @Override // com.instagram.common.viewpoint.core.InterfaceC1376fk
    public EnumC1323et getStartReason() {
        return this.A0B;
    }
    ...
    public EnumC1378fm getTargetState() {
        return this.A0D;
    }
    ...
    public final void onCompletion(MediaPlayer mediaPlayer) throws IllegalStateException {
        ...
        setVideoState(EnumC1378fm.A06);
        seekTo(0);
        this.A03 = 0;
    }

    @Override // android.media.MediaPlayer.OnErrorListener
    public final boolean onError(MediaPlayer mediaPlayer, int i4, int i10) throws IllegalStateException, IOException, SecurityException, IllegalArgumentException {
        this.A0N.A0F().ACW(A03(390, 11, 85) + i4 + A03(0, 14, 21) + i10 + A03(14, 2, 108));
        if (this.A01 > 0 && getState() == EnumC1378fm.A0A) {
            this.A01--;
            AKF(6);
            AK6(this.A0B, 10);
        } else {
    ...
    public final boolean onInfo(MediaPlayer mediaPlayer, int i4, int i10) {
        switch (i4) {
            case 3:
                this.A0K = true;
                if (this.A0D == EnumC1378fm.A0A) {
                    setVideoState(EnumC1378fm.A0A);
                }
                return true;
            case 701:
                setVideoState(EnumC1378fm.A02);
                return false;
            case 702:
                if (!A08()) {
                    return false;
    ...
    public final void onPrepared(MediaPlayer mediaPlayer) throws IllegalStateException, IOException, SecurityException, IllegalArgumentException {
        ...
        if (this.A03 > 0) {
            int i4 = this.A03;
            int duration = ((MediaPlayer) AbstractC1487hX.A00(this.A06)).getDuration();
            if (A0P[3].length() != 17) {
                throw new RuntimeException();
            }
    ...
    public final void onSurfaceTextureAvailable(SurfaceTexture surfaceTexture, int i4, int i10) {
        ...
        if (!A0A(this.A08)) {
            ...
            this.A0N.A0F().A3i(4);
            destroy();
        } else if (this.A0C == EnumC1378fm.A05 && !this.A0J) {
            AK6(this.A0B, 7);
        }
    }
    ...
    */
    public final void onWindowFocusChanged(boolean r6) throws java.lang.IllegalStateException, java.io.IOException, java.lang.SecurityException, java.lang.IllegalArgumentException {
        ...
        L15:
            ...
            com.facebook.ads.redexgen.X.fm r0 = com.instagram.common.viewpoint.core.EnumC1378fm.A05
            if (r1 == r0) goto La6
            ...
            if (r0 != 0) goto L8d
            com.facebook.ads.redexgen.X.gi r0 = r5.A0N
            boolean r3 = com.instagram.common.viewpoint.core.C0886Up.A25(r0)
            java.lang.String[] r1 = com.instagram.common.viewpoint.core.TextureViewSurfaceTextureListenerC0435Cy.A0P
            r0 = 2
            r0 = r1[r0]
            int r1 = r0.length()
            r0 = 22
        ...
        L42:
            ...
            com.facebook.ads.redexgen.X.fm r3 = com.instagram.common.viewpoint.core.EnumC1378fm.A05
            java.lang.String[] r1 = com.instagram.common.viewpoint.core.TextureViewSurfaceTextureListenerC0435Cy.A0P
            r0 = 6
            r0 = r1[r0]
            int r1 = r0.length()
        ...
        L54:
            ...
            throw r0
        L6d:
            java.lang.String[] r2 = com.instagram.common.viewpoint.core.TextureViewSurfaceTextureListenerC0435Cy.A0P
        ...
        La7:
            ...
            goto La6
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.TextureViewSurfaceTextureListenerC0435Cy.onWindowFocusChanged(boolean):void");
    }

    @Override // com.instagram.common.viewpoint.core.InterfaceC1376fk
    public final void seekTo(int i4) throws IllegalStateException {
        if (this.A06 != null && A07()) {
            if (i4 < getDuration() && i4 > 0) {
    ...
    public void setControlsAnchorView(View view) {
        this.A09 = view;
        view.setOnTouchListener(new ViewOnTouchListenerC1375fj(this));
    }
    ...
    public void setFullScreen(boolean z3) {
        this.A0H = z3;
        if (this.A0H && !this.A0G) {
            setOnTouchListener(new ViewOnTouchListenerC1374fi(this));
        }
    }
    ...
    public void setRequestedVolume(float f10) {
        this.A00 = f10;
        if (this.A06 == null || this.A0C == EnumC1378fm.A08) {
            return;
        }
        EnumC1378fm enumC1378fm = this.A0C;
        String[] strArr = A0P;
        if (strArr[0].charAt(16) == strArr[7].charAt(16)) {
            throw new RuntimeException();
        }
        A0P[3] = "xC5rxgqNbqLUjjPrr";
        if (enumC1378fm != EnumC1378fm.A04) {
    ...
    private void setVideoState(EnumC1378fm enumC1378fm) {
        if (enumC1378fm != this.A0C) {
            if (this.A0N.A05().AAO()) {
                String str = A03(356, 23, 106) + enumC1378fm;
            }
            this.A0C = enumC1378fm;
            if (this.A0E != null) {
                this.A0E.AGd(enumC1378fm);
            }
        }
    }

    @Override // com.instagram.common.viewpoint.core.InterfaceC1376fk
    public void setVideoStateChangeListener(InterfaceC1379fn interfaceC1379fn) {
        this.A0E = interfaceC1379fn;
    }
    ...
    public void setup(Uri uri) throws IllegalStateException, IOException, SecurityException, IllegalArgumentException {
        ...
        try {
            if (((String) AbstractC1487hX.A00(uri.getScheme())).equals(A03(379, 5, 2))) {
                A05(mediaPlayer, uri);
            } else {
            ...
            setVideoState(EnumC1378fm.A08);
        } catch (Exception e2) {
            setVideoState(EnumC1378fm.A03);
            this.A0N.A0F().A3i(3);
            mediaPlayer.release();
            Log.e(A0Q, A03(16, 49, 14) + e2);
        }
