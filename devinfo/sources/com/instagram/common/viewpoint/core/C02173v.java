...
public class C02173v extends AbstractC0456Dt {
    ...
    public C02173v(C0449Dm c0449Dm) {
        this.A00 = c0449Dm;
    }
    ...
    public final void A03(C0457Du c0457Du) {
        if (this.A00.A01 != null && !this.A00.A05 && c0457Du.A00().getAction() == 0) {
            C0449Dm c0449Dm = this.A00;
            String[] strArr = A01;
            if (strArr[5].length() == strArr[2].length()) {
                throw new RuntimeException();
            }
            A01[4] = "8qKCS4QoQxaUoDKBRazWJt0HJmuP0GoR";
            c0449Dm.A07.removeCallbacksAndMessages(null);
            if (this.A00.A0G(EnumC1349fJ.A04)) {
                this.A00.A03();
                C0449Dm c0449Dm2 = this.A00;
                if (A01[3].charAt(1) != 'x') {
                    A01[3] = "krfS0sgwBFPIM38aK2Y5K2a50FO4BQxK";
                    c0449Dm2.A06(true, false);
                } else {
                    c0449Dm2.A06(true, false);
                }
            }
            if (this.A00.A04) {
                this.A00.A07.postDelayed(new C0450Dn(this), this.A00.A00);
            }
        }
    }
}
