...
public class C1333f3 extends AbstractRunnableC0923Wc {
    public static byte[] A05;
    public final /* synthetic */ int A00;
    public final /* synthetic */ T8 A01;
    public final /* synthetic */ TW A02;
    public final /* synthetic */ C0849Te A03;
    ...
    public C1333f3(T8 t82, String str, int i4, C0849Te c0849Te, TW tw) {
        this.A01 = t82;
        this.A04 = str;
        this.A00 = i4;
        this.A03 = c0849Te;
    ...
    public final void A07() {
        ...
        try {
            ...
            if (cause != null) {
                strA03 = AbstractC0963Xt.A03(this.A01, cause);
            } else if (AbstractC0888Ur.A0R(this.A01)) {
                T8 t82 = this.A01;
                Throwable deLogExceptionCause = this.A03;
                strA03 = AbstractC0963Xt.A03(t82, deLogExceptionCause);
            } else {
                strA03 = A00(0, 0, 81) + this.A03.getMessage();
            }
            if (AbstractC0888Ur.A0V(this.A01)) {
            ...
            if ((A00(106, 5, 124).equals(this.A04) || A00(FacebookMediationAdapter.ERROR_ADVIEW_CONSTRUCTOR_EXCEPTION, 15, 29).equals(this.A04)) && (strA8L = this.A01.A04().A8L()) != null) {
                mapA5a.put(A00(86, 20, 12), strA8L);
            }
            String strA0C = this.A01.A0C();
            if (strA0C != null && !TextUtils.isEmpty(strA0C)) {
                mapA5a.put(A00(WebSocketProtocol.PAYLOAD_SHORT, 10, 76), strA0C);
            }
            TV tv = (TV) TX.A0A.get();
            if (tv == null) {
