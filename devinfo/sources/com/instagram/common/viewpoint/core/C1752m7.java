...
public final class C1752m7 implements H9 {
    ...
    public static final C1996qI A0c;
    ...
    public boolean A0G;
    public boolean A0H;
    public InterfaceC0543Hd[] A0I;
    public InterfaceC0543Hd[] A0J;
    public final int A0K;
    public final SparseArray<JA> A0L;
    public final C02434v A0M;
    public final C02434v A0N;
    public final C02434v A0O;
    public final C02434v A0P;
    public final C02434v A0Q;
    public final AnonymousClass53 A0R;
    public final InterfaceC0543Hd A0S;
    public final I0 A0T;
    public final JO A0U;
    public final ArrayDeque<C1759mE> A0V;
    public final ArrayDeque<J9> A0W;
    public final List<C1996qI> A0X;
    public final byte[] A0Y;

    /* JADX WARN: Failed to parse debug info
    java.lang.ArrayIndexOutOfBoundsException
     */
    public static int A01(JA ja2, int i4, int i10, C02434v c02434v, int i11) throws C3K {
        int iA0C;
        int i12 = i11;
        c02434v.A0f(8);
        ...
        jq.A0C[i4] = c02434v.A0L();
        jq.A0E[i4] = jq.A04;
        if ((iA00 & 1) != 0) {
            long[] jArr = jq.A0E;
            jArr[i4] = jArr[i4] + c02434v.A0C();
        }
        boolean z3 = (iA00 & 4) != 0;
        int iA0C2 = j12.A01;
        if (z3) {
        ...
        boolean z12 = (iA00 & Segment.SHARE_MINIMUM) != 0;
        boolean z13 = (iA00 & 2048) != 0;
        long j = A0a(jo) ? ((long[]) C5C.A0f(jo.A09))[0] : 0L;
        int[] iArr = jq.A0B;
        long[] jArr2 = jq.A0D;
        boolean[] zArr = jq.A0G;
        boolean z14 = jo.A03 == 2 && (i10 & 1) != 0;
        int i13 = i12 + jq.A0C[i4];
        long j8 = jo.A06;
        long j9 = jq.A05;
        while (i12 < i13) {
            if (z10) {
            ...
            int iA002 = A00(iA0C);
            int iA003 = A00(z11 ? c02434v.A0C() : j12.A03);
            int iA0C3 = z12 ? c02434v.A0C() : (i12 == 0 && z3) ? iA0C2 : j12.A01;
            jArr2[i12] = C5C.A0U(((z13 ? c02434v.A0C() : 0) + j9) - j, 1000000L, j8);
            if (!jq.A09) {
                jArr2[i12] = jArr2[i12] + ja2.A05.A02;
            }
            iArr[i12] = iA003;
            zArr[i12] = ((iA0C3 >> 16) & 1) == 0 && (!z14 || i12 == 0);
            j9 += iA002;
            i12++;
        }
        jq.A05 = j9;
    ...
    java.lang.ArrayIndexOutOfBoundsException
     */
    public static Pair<Long, C1792my> A05(C02434v c02434v, long j) throws C3K {
        long jA0R;
        long jA0R2;
        c02434v.A0f(8);
    ...
    java.lang.ArrayIndexOutOfBoundsException
     */
    public static JA A09(C02434v c02434v, SparseArray<JA> sparseArray, boolean z3) {
        c02434v.A0f(8);
        int iA00 = AbstractC0585Iu.A00(c02434v.A0C());
        JA jaValueAt = z3 ? sparseArray.valueAt(0) : sparseArray.get(c02434v.A0C());
        if (jaValueAt == null) {
            String[] strArr = A0a;
        ...
        jaValueAt.A09.A06 = new J1((iA00 & 2) != 0 ? c02434v.A0C() - 1 : j12.A02, (iA00 & 8) != 0 ? c02434v.A0C() : j12.A00, (iA00 & 16) != 0 ? c02434v.A0C() : j12.A03, (iA00 & 32) != 0 ? c02434v.A0C() : j12.A01);
        return jaValueAt;
    }

    public static String A0A(int i4, int i10, int i11) {
        byte[] bArrCopyOfRange = Arrays.copyOfRange(A0Z, i4, i4 + i10);
        int i12 = 0;
        while (true) {
    ...
    private void A0H(C02434v c02434v, Uri uri) {
        String str;
        String str2;
        long jA05;
        long jA0U;
        ...
        switch (iA01) {
            ...
            case 1:
                ...
                break;
            default:
                AbstractC02284g.A07(A0A(204, 22, 75), A0A(645, 35, 24) + iA01);
                return;
        }
        byte[] bArr = new byte[c02434v.A07()];
        c02434v.A0k(bArr, 0, c02434v.A07());
        int i4 = 0;
        C02434v c02434v2 = new C02434v(this.A0T.A01(new EventMessage(str, str2, jA0U, jA0Q, bArr)));
        int iA07 = c02434v2.A07();
        InterfaceC0543Hd[] interfaceC0543HdArr = this.A0J;
        ...
        if (this.A0A != -9223372036854775807L && !MetaExoPlayerUpgradeConfig.A03(EnumC1596jX.A11)) {
            jA05 = this.A0A;
        }
        InterfaceC0543Hd[] interfaceC0543HdArr2 = this.A0J;
        if (A0a[0].length() != 3) {
            throw new RuntimeException();
        }
        A0a[2] = "lJ55r5gDB38Ao7rNsYIhv4IUy3LH5Ini";
        for (InterfaceC0543Hd interfaceC0543Hd2 : interfaceC0543HdArr2) {
    ...
    java.lang.ArrayIndexOutOfBoundsException
     */
    public static void A0R(C1759mE c1759mE, SparseArray<JA> sparseArray, boolean z3, int i4, byte[] bArr) throws C3K {
        JA jaA09 = A09(((C1758mD) AbstractC02203y.A01(c1759mE.A07(1952868452))).A00, sparseArray, z3);
        if (jaA09 == null) {
            return;
        }
        JQ jq = jaA09.A09;
        ...
        jaA09.A08();
        jaA09.A06 = true;
        C1758mD c1758mDA07 = c1759mE.A07(1952867444);
        if (c1758mDA07 == null || (i4 & 2) != 0) {
            jq.A05 = j;
            String[] strArr = A0a;
            if (strArr[4].charAt(20) == strArr[6].charAt(20)) {
                throw new RuntimeException();
            ...
            jq.A05 = A03(c1758mDA07.A00);
            jq.A09 = true;
        }
        A0S(c1759mE, jaA09, i4);
        JO jo = jaA09.A05.A03;
        Object objA01 = AbstractC02203y.A01(jq.A06);
        String[] strArr2 = A0a;
        ...
        C1758mD c1758mDA072 = c1759mE.A07(1935763834);
        if (c1758mDA072 != null) {
            A0V((JP) AbstractC02203y.A01(jpA00), c1758mDA072.A00, jq);
        }
        C1758mD c1758mDA073 = c1759mE.A07(1935763823);
        if (c1758mDA073 != null) {
            A0I(c1758mDA073.A00, jq);
        }
        C1758mD c1758mDA074 = c1759mE.A07(1936027235);
        if (c1758mDA074 != null) {
            A0J(c1758mDA074.A00, jq);
        }
        A0T(c1759mE, jpA00 != null ? jpA00.A02 : null, jq);
        int size = c1759mE.A02.size();
        for (int i10 = 0; i10 < size; i10++) {
            C1758mD c1758mD = c1759mE.A02.get(i10);
            if (((AbstractC0585Iu) c1758mD).A00 == 1970628964) {
                A0K(c1758mD.A00, jq, bArr);
            }
        }
    }
    ...
    java.lang.ArrayIndexOutOfBoundsException
     */
    public static void A0T(C1759mE c1759mE, String str, JQ jq) throws C3K {
        C02434v c02434v = null;
        C02434v c02434v2 = null;
        for (int i4 = 0; i4 < c1759mE.A02.size(); i4++) {
            C1758mD c1758mD = c1759mE.A02.get(i4);
            C02434v c02434v3 = c1758mD.A00;
            if (((AbstractC0585Iu) c1758mD).A00 == 1935828848) {
                c02434v3.A0f(12);
                if (c02434v3.A0C() == 1936025959) {
                    c02434v = c02434v3;
                }
            } else if (((AbstractC0585Iu) c1758mD).A00 == 1936158820) {
                c02434v3.A0f(12);
                if (c02434v3.A0C() == 1936025959) {
                    c02434v2 = c02434v3;
                }
        ...
        if (c02434v.A0C() != 1) {
            throw C3K.A00(A0A(WebSocketProtocol.PAYLOAD_SHORT, 39, 73));
        }
        c02434v2.A0f(8);
        int iA012 = AbstractC0585Iu.A01(c02434v2.A0C());
        c02434v2.A0g(4);
        if (iA012 == 1) {
            if (c02434v2.A0Q() == 0) {
        ...
        if (z3) {
            ...
            jq.A08 = true;
            jq.A07 = new JP(z3, str, iA0I2, bArr, i10, i11, bArr2);
        }
    }
    ...
    java.lang.ArrayIndexOutOfBoundsException
     */
    public static void A0V(JP jp, C02434v c02434v, JQ jq) throws C3K {
        int i4 = jp.A00;
        c02434v.A0f(8);
    ...
    static {
        ...
        A0c = new C01872p().A11(A0A(839, 18, 77)).A14();
    }
    ...
    public C1752m7(int i4) {
        this(i4, null);
    }

    public C1752m7(int i4, AnonymousClass53 anonymousClass53) {
        this(i4, anonymousClass53, null, Collections.emptyList());
    }

    public C1752m7(int i4, AnonymousClass53 anonymousClass53, JO jo, List<C1996qI> list) {
        this(i4, anonymousClass53, jo, list, null);
    }

    @MetaExoPlayerCustomization("Additional fields for custom behaviors")
    public C1752m7(int i4, AnonymousClass53 anonymousClass53, JO jo, List<C1996qI> list, InterfaceC0543Hd interfaceC0543Hd) {
        this.A0A = -9223372036854775807L;
        this.A0K = i4;
        this.A0R = anonymousClass53;
        this.A0U = jo;
        this.A0X = Collections.unmodifiableList(list);
        this.A0S = interfaceC0543Hd;
        this.A0T = new I0();
        this.A0M = new C02434v(16);
        this.A0P = new C02434v(HS.A03);
        this.A0O = new C02434v(5);
        this.A0N = new C02434v();
        this.A0Y = new byte[16];
        this.A0Q = new C02434v(this.A0Y);
        ...
        this.A0E = HA.A00;
        this.A0J = new InterfaceC0543Hd[0];
        this.A0I = new InterfaceC0543Hd[0];
    }

    public static int A00(int i4) throws C3K {
        if (i4 >= 0) {
            return i4;
        }
        throw C3K.A01(A0A(700, 27, 67) + i4, null);
    }
    ...
    public static long A03(C02434v c02434v) {
        c02434v.A0f(8);
        int fullAtom = c02434v.A0C();
    ...
    public static Pair<Integer, J1> A04(C02434v c02434v) {
        c02434v.A0f(12);
        int defaultSampleDescriptionIndex = c02434v.A0C();
        int trackId = c02434v.A0C();
        int defaultSampleFlags = c02434v.A0C();
        int defaultSampleSize = c02434v.A0C();
    ...
    public static DrmInitData A06(List<C1758mD> list) {
        ArrayList arrayList = null;
        int size = list.size();
        for (int i4 = 0; i4 < size; i4++) {
            C1758mD c1758mD = list.get(i4);
            int leafChildrenSize = ((AbstractC0585Iu) c1758mD).A00;
            if (leafChildrenSize == 1886614376) {
                if (arrayList == null) {
                    arrayList = new ArrayList();
                }
                byte[] bArrA0l = c1758mD.A00.A0l();
                UUID uuidA02 = JH.A02(bArrA0l);
                if (uuidA02 == null) {
                    AbstractC02284g.A07(A0A(204, 22, 75), A0A(550, 42, 28));
                } else {
    ...
    private J1 A07(SparseArray<J1> sparseArray, int i4) {
    ...
    */
    private void A0C() {
        ...
        L3a:
            if (r2 >= r3) goto L46
            r1 = r4[r2]
            com.facebook.ads.redexgen.X.qI r0 = com.instagram.common.viewpoint.core.C1752m7.A0c
            r1.A6e(r0)
            int r2 = r2 + 1
            goto L3a
        L46:
        ...
        L72:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C1752m7.A0C():void");
    }
    ...
    private void A0E(long j) {
        while (!this.A0W.isEmpty()) {
            ...
            for (InterfaceC0543Hd interfaceC0543Hd : this.A0J) {
                interfaceC0543Hd.AIu(jA05, 1, j9RemoveFirst.A00, this.A03, null);
            }
        }
    }
    ...
    public static void A0G(C02434v c02434v, int i4, JQ jq) throws C3K {
        c02434v.A0f(i4 + 8);
        int fullAtom = c02434v.A0C();
    ...
    public static void A0I(C02434v c02434v, JQ jq) throws C3K {
        c02434v.A0f(8);
    ...
    public static void A0J(C02434v c02434v, JQ jq) throws C3K {
        A0G(c02434v, 0, jq);
    }

    public static void A0K(C02434v c02434v, JQ jq, byte[] bArr) throws C3K {
        c02434v.A0f(8);
    ...
    private void A0L(InterfaceC1787ms interfaceC1787ms) throws IOException {
        int i4 = ((int) this.A07) - this.A00;
        C02434v c02434v = this.A0D;
        if (c02434v != null) {
            interfaceC1787ms.readFully(c02434v.A0l(), 8, i4);
            A0U(new C1758mD(this.A01, c02434v), interfaceC1787ms.A8n(), interfaceC1787ms.A9P());
        } else {
            interfaceC1787ms.AK3(i4);
        }
        A0F(interfaceC1787ms.A8n());
    }

    private void A0M(InterfaceC1787ms interfaceC1787ms) throws IOException {
        JA jaValueAt = null;
        long j = Long.MAX_VALUE;
        int size = this.A0L.size();
        for (int i4 = 0; i4 < size; i4++) {
            JA nextTrackBundle = this.A0L.valueAt(i4);
            JQ jq = nextTrackBundle.A09;
            if (jq.A0A && jq.A03 < j) {
                j = jq.A03;
                jaValueAt = this.A0L.valueAt(i4);
            }
        }
        if (jaValueAt == null) {
            this.A02 = 3;
        ...
        if (iA8n >= 0) {
            ...
            jaValueAt.A09.A05(interfaceC1787ms);
            return;
        }
        throw C3K.A01(A0A(384, 39, 59), null);
    }

    private void A0N(C1759mE c1759mE) throws C3K {
        if (((AbstractC0585Iu) c1759mE).A00 == 1836019574) {
            A0P(c1759mE);
            return;
        }
        if (((AbstractC0585Iu) c1759mE).A00 == 1836019558) {
            A0O(c1759mE);
            return;
        }
        if (this.A0V.isEmpty()) {
        ...
        C1759mE c1759mEPeek = this.A0V.peek();
        if (A0a[1].length() == 3) {
            throw new RuntimeException();
        }
        A0a[5] = "pjYwVuiFyV8fJrHeJXv5AlOqs";
        c1759mEPeek.A08(c1759mE);
    }

    private void A0O(C1759mE c1759mE) throws C3K {
        A0Q(c1759mE, this.A0L, this.A0U != null, this.A0K, this.A0Y);
        DrmInitData drmInitDataA06 = A06(c1759mE.A02);
        if (drmInitDataA06 != null) {
            int i4 = this.A0L.size();
        ...
        if (A0a[5].length() != 30) {
            ...
            if (j != -9223372036854775807L) {
                int size = this.A0L.size();
                for (int i10 = 0; i10 < size; i10++) {
                    JA jaValueAt = this.A0L.valueAt(i10);
                    long j8 = this.A0B;
    ...
    private void A0P(C1759mE c1759mE) throws C3K {
        AbstractC02203y.A0A(this.A0U == null, A0A(680, 20, 8));
        DrmInitData drmInitDataA06 = A06(c1759mE.A02);
        C1759mE c1759mE2 = (C1759mE) AbstractC02203y.A01(c1759mE.A06(1836475768));
        SparseArray<J1> sparseArray = new SparseArray<>();
        long jA02 = -9223372036854775807L;
        int size = c1759mE2.A02.size();
        for (int i4 = 0; i4 < size; i4++) {
            C1758mD c1758mD = c1759mE2.A02.get(i4);
            if (((AbstractC0585Iu) c1758mD).A00 == 1953654136) {
                Pair<Integer, J1> pairA04 = A04(c1758mD.A00);
            ...
            } else if (((AbstractC0585Iu) c1758mD).A00 == 1835362404) {
                jA02 = A02(c1758mD.A00);
            }
        }
        List<JR> listA0O = J0.A0O(c1759mE, new HK(), jA02, drmInitDataA06, (this.A0K & 16) != 0, false, new InterfaceC1647kO() { // from class: com.facebook.ads.redexgen.X.m9
        ...
        if (this.A0L.size() == 0) {
            for (int i10 = 0; i10 < size2; i10++) {
                JR jr = listA0O.get(i10);
                JO jo = jr.A03;
                this.A0L.put(jo.A00, new JA(this.A0E.AKS(i10, jo.A03), jr, A07(sparseArray, jo.A00)));
                this.A08 = Math.max(this.A08, jo.A04);
            }
            this.A0E.A6O();
            return;
        }
        AbstractC02203y.A08(this.A0L.size() == size2);
        for (int i11 = 0; i11 < size2; i11++) {
            JR jr2 = listA0O.get(i11);
            JO jo2 = jr2.A03;
            this.A0L.get(jo2.A00).A0C(jr2, A07(sparseArray, jo2.A00));
        }
    }

    public static void A0Q(C1759mE c1759mE, SparseArray<JA> sparseArray, boolean z3, int i4, byte[] bArr) throws C3K {
        int size = c1759mE.A01.size();
        for (int i10 = 0; i10 < size; i10++) {
            C1759mE child = c1759mE.A01.get(i10);
            int i11 = ((AbstractC0585Iu) child).A00;
            if (i11 == 1953653094) {
                A0R(child, sparseArray, z3, i4, bArr);
            }
        }
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public static void A0S(com.instagram.common.viewpoint.core.C1759mE r8, com.instagram.common.viewpoint.core.JA r9, int r10) throws com.instagram.common.viewpoint.core.C3K {
        /*
            r4 = 0
            r3 = 0
        ...
        L9:
            ...
            java.lang.String[] r1 = com.instagram.common.viewpoint.core.C1752m7.A0a
            r0 = 5
            r0 = r1[r0]
            int r1 = r0.length()
            r0 = 30
            if (r1 == r0) goto L67
            java.lang.String[] r2 = com.instagram.common.viewpoint.core.C1752m7.A0a
            java.lang.String r1 = "g5KWW"
            r0 = 1
            r2[r0] = r1
            if (r5 >= r7) goto L3f
            java.lang.Object r1 = r8.get(r5)
            com.facebook.ads.redexgen.X.mD r1 = (com.instagram.common.viewpoint.core.C1758mD) r1
            int r0 = r1.A00
            if (r0 != r6) goto L3c
        ...
        L4e:
            ...
            com.facebook.ads.redexgen.X.mD r3 = (com.instagram.common.viewpoint.core.C1758mD) r3
            int r1 = r3.A00
            if (r1 != r6) goto L63
            int r2 = r5 + 1
        ...
        L67:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C1752m7.A0S(com.facebook.ads.redexgen.X.mE, com.facebook.ads.redexgen.X.JA, int):void");
    }

    @MetaExoPlayerCustomization("Adding Uri for eMsg")
    private void A0U(C1758mD c1758mD, long j, Uri uri) throws C3K {
        if (!this.A0V.isEmpty()) {
            this.A0V.peek().A09(c1758mD);
            return;
        }
        if (((AbstractC0585Iu) c1758mD).A00 == 1936286840) {
            Pair<Long, C1792my> pairA05 = A05(c1758mD.A00, j);
        ...
        if (((AbstractC0585Iu) c1758mD).A00 != 1701671783 || uri == null) {
            return;
        }
        A0H(c1758mD.A00, uri);
    }

    public static boolean A0W(int i4) {
    ...
    */
    public static boolean A0X(int r4) {
        ...
        Lc8:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C1752m7.A0X(int):boolean");
    }

    private boolean A0Y(InterfaceC1787ms interfaceC1787ms) throws IOException {
        int trackCount;
        int i4;
        if (this.A00 == 0) {
            C02434v c02434v = this.A0M;
            if (A0a[2].charAt(14) != 'D') {
                A0a[5] = "Du9yMjOrUhZNFJE5GgCY";
                if (!interfaceC1787ms.AHR(c02434v.A0l(), 0, 8, true)) {
                    return false;
                }
                this.A00 = 8;
                this.A0M.A0f(0);
        ...
        if (this.A07 == 1) {
            interfaceC1787ms.readFully(this.A0M.A0l(), 8, 8);
        ...
        if (this.A07 >= this.A00) {
            ...
            if ((this.A01 == 1836019558 || this.A01 == 1835295092) && !this.A0G) {
                this.A0E.AJ7(new C1782mn(this.A08, jA8n2));
                this.A0G = true;
            }
            ...
            if (A0W(this.A01)) {
                ...
                this.A0V.push(new C1759mE(this.A01, jA8n3));
                if (this.A07 == this.A00) {
                    A0F(jA8n3);
                } else {
                    A0B();
                ...
                if (this.A07 <= 2147483647L) {
                    C02434v c02434v2 = new C02434v((int) this.A07);
                    C02434v atomData = this.A0M;
                    System.arraycopy(atomData.A0l(), 0, c02434v2.A0l(), 0, 8);
                    this.A0D = c02434v2;
                    this.A02 = 1;
                } else {
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    private boolean A0Z(com.instagram.common.viewpoint.core.InterfaceC1787ms r19) throws java.io.IOException {
        /*
            Method dump skipped, instructions count: 774
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C1752m7.A0Z(com.facebook.ads.redexgen.X.ms):boolean");
    }
    ...
    public final int AHL(InterfaceC1787ms interfaceC1787ms, HV hv) throws IOException {
        while (true) {
            switch (this.A02) {
                case 0:
                    if (!A0Y(interfaceC1787ms)) {
                        return -1;
                    }
                    break;
                case 1:
                    A0L(interfaceC1787ms);
                    break;
                case 2:
                    A0M(interfaceC1787ms);
                    break;
                default:
