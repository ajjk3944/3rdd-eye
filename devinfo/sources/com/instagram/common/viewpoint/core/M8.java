...
public final class M8 extends LinearLayout implements InterfaceC1079av {
    ...
    public C1070am A04;
    public InterfaceC1078au A05;
    public String A06;
    public final WebView A07;
    public final C1436gi A08;
    public final InterfaceC1075ar A09;
    ...
    static {
        ...
        A0I = new ViewOnTouchListenerC1055aX();
    }

    public M8(C1436gi c1436gi, WebView webView, boolean z3) {
        super(c1436gi);
        this.A09 = new M9(this);
        this.A07 = webView;
        this.A08 = c1436gi;
        this.A0A = AbstractC0887Uq.A06(c1436gi);
        this.A0B = z3;
        A08();
        A0C(false);
    }
    ...
    private void A08() {
        ...
        this.A01.setOnClickListener(new ViewOnClickListenerC1056aY(this));
        addView(this.A01, layoutParams);
        if (this.A0A && !C0886Up.A2w(this.A08)) {
            ...
            this.A00.setOnClickListener(new ViewOnClickListenerC1057aZ(this));
            addView(this.A00, layoutParams2);
        }
        this.A04 = new C1070am(this.A08);
        ...
        if (C0886Up.A2w(this.A08) && !this.A0B) {
        ...
        if (this.A0A && !C0886Up.A2w(this.A08)) {
            ...
            this.A02.setOnClickListener(new ViewOnClickListenerC1058aa(this));
        ...
        this.A03.setOnClickListener(new ViewOnClickListenerC1059ab(this));
