...
public final class C1054aW extends ImageView {
    ...
    public final YM A09;
    public final InterfaceC1042aK A0A;

    public C1054aW(C1436gi c1436gi, EnumC1044aM enumC1044aM, AbstractC1601jd abstractC1601jd, View view, YM ym, NativeAdLayout nativeAdLayout, InterfaceC1042aK interfaceC1042aK) {
        super(c1436gi);
        this.A05 = view;
        this.A09 = ym;
        this.A08 = c1436gi;
        this.A06 = nativeAdLayout;
        this.A0A = interfaceC1042aK;
        this.A07 = abstractC1601jd;
        AbstractC1043aL.A02(c1436gi, enumC1044aM);
        A02();
    }
    ...
    private void A02() {
        ...
        this.A01 = new View.OnLayoutChangeListener() { // from class: com.facebook.ads.redexgen.X.aS
            ...
            public final void onLayoutChange(View view, int i4, int i10, int i11, int i12, int i13, int i14, int i15, int i16) {
                this.A00.A0D(view, i4, i10, i11, i12, i13, i14, i15, i16);
            }
        };
        ...
        this.A03.addOnAttachStateChangeListener(new ViewOnAttachStateChangeListenerC1053aV(this));
    }
    ...
    public final /* synthetic */ void A0D(View view, int i4, int i10, int i11, int i12, int i13, int i14, int i15, int i16) {
        A05();
    }
}
