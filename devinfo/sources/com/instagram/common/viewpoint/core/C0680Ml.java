...
public final class C0680Ml {
    ...
    public static C0680Ml A00(C0680Ml c0680Ml, long j) {
        return c0680Ml.A03(A06(0, 7, 94), j);
    }

    public static C0680Ml A01(C0680Ml c0680Ml, Uri uri) {
        String strA06 = A06(7, 9, 58);
        if (uri == null) {
            return c0680Ml.A02(strA06);
        }
        return c0680Ml.A05(strA06, uri.toString());
    }

    private final C0680Ml A02(String str) {
        this.A00.add(str);
        this.A01.remove(str);
        return this;
    }

    private final C0680Ml A03(String str, long j) {
        return A04(str, Long.valueOf(j));
    }

    private C0680Ml A04(String str, Object obj) {
        this.A01.put((String) AbstractC02203y.A01(str), AbstractC02203y.A01(obj));
        this.A00.remove(str);
        return this;
    }

    private final C0680Ml A05(String str, String str2) {
        return A04(str, str2);
    }
