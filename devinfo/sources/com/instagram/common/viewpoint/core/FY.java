...
public final class FY extends RK implements InterfaceC0984Yo {
    public C0700Ng A00;
    ...
    public FY(AnonymousClass67 anonymousClass67, SparseBooleanArray sparseBooleanArray, C1381fp c1381fp, int i4, int i10, int i11, int i12, C1436gi c1436gi, C0700Ng c0700Ng) {
    ...
    private void A05(VA va2, Y2 y22, String str, C1274e5 c1274e5) {
        ...
        this.A01 = new C0491Fc(this, str, c1274e5, va2, c1274e5.A04(), y22);
        this.A03 = new C1381fp(this.A0A, 10, new WeakReference(this.A01), this.A09);
        this.A03.A0Y(false);
        this.A03.A0W(100);
        this.A03.A0X(100);
        this.A0A.setOnAssetsLoadedListener(new FZ(this, c1274e5));
    }

    public final ViewOnClickListenerC0634Kr A0p() {
        return this.A0A.getCtaButton();
    }

    public final void A0q(C1274e5 c1274e5, VA va2, C0842Sx c0842Sx, Y2 y22, String str) {
        ...
        String imageUrl = c1274e5.A03().A0H().A08();
        String strA09 = c1274e5.A03().A0H().A09();
        this.A0A.setIsVideo(!TextUtils.isEmpty(strA09));
        if (this.A0A.A1V()) {
            this.A0A.setVideoPlaceholderUrl(imageUrl);
            this.A0A.setVideoUrl(c0842Sx.A0T(strA09));
        } else {
            this.A0A.setImageUrl(imageUrl);
        }
        this.A0A.setLayoutParams(marginLayoutParams);
        this.A0A.setAdTitleAndDescription(c1274e5.A03().A0I().A0G(), c1274e5.A03().A0I().A04());
        this.A0A.setCTAInfo(c1274e5.A03().A0J(), c1274e5.A04());
        this.A0A.A1Y(c1274e5.A04());
