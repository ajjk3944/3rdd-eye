...
public final class ViewOnClickListenerC02976x extends PZ implements View.OnClickListener, View.OnTouchListener {
    ...
    public ViewOnClickListenerC02976x(C0798Re c0798Re, C1436gi c1436gi, VA va2, InterfaceC0977Yh interfaceC0977Yh, String str, int i4) {
        super(c0798Re, c1436gi, va2, interfaceC0977Yh, false);
        this.A00 = 0;
        this.A01 = 0;
        this.A03 = false;
        this.A07 = new RunnableC0980Yk(this);
        this.A08 = str;
        this.A05 = new Handler(Looper.getMainLooper());
        this.A06 = (InputMethodManager) c1436gi.getSystemService(A05(AppLovinMediationAdapter.ERROR_CHILD_USER, 12, 70));
        this.A04 = i4;
    }

    public static /* synthetic */ int A02(ViewOnClickListenerC02976x viewOnClickListenerC02976x) {
        int i4 = viewOnClickListenerC02976x.A00;
        viewOnClickListenerC02976x.A00 = i4 + 1;
        return i4;
    }
    ...
    private void A07() {
        ...
        if (AdPlacementType.NATIVE.name().equals(this.A08)) {
            ...
            super.A08.A0E(EnumC1329ez.A04.A03(), null);
        }
    }
    ...
    public final InterfaceC1074aq A0F() {
        return new C0749Pd(this);
    }
    ...
    public final void A0G() {
        ...
        super.A07.setOnTouchListener(new View.OnTouchListener() { // from class: com.facebook.ads.redexgen.X.Yj
            ...
            public final boolean onTouch(View view, MotionEvent motionEvent) {
                return ViewOnClickListenerC02976x.A0B(view, motionEvent);
            }
        });
    ...
    public final void A0H() {
        ...
        translateAnimation.setAnimationListener(new AnimationAnimationListenerC0982Ym(this));
    ...
    @Override // com.instagram.common.viewpoint.core.PZ, com.instagram.common.viewpoint.core.InterfaceC0978Yi
    public final void AAu(Intent intent, Bundle bundle, C0798Re c0798Re) {
        super.AAu(intent, bundle, c0798Re);
    ...
    public final void onAttachedToWindow() {
        ...
        translateAnimation.setFillAfter(true);
        translateAnimation.setAnimationListener(new AnimationAnimationListenerC0981Yl(this));
        startAnimation(translateAnimation);
    }
    ...
    public final boolean onTouch(View view, MotionEvent motionEvent) {
        switch (motionEvent.getActionMasked()) {
            ...
            case 1:
                ...
                A0I(A05(124, 30, AppLovinMediationAdapter.ERROR_MISSING_AD_UNIT_ID));
                return false;
            default:
                return false;
        }
