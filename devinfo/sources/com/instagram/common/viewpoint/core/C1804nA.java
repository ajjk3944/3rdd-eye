...
public final class C1804nA implements F6, InterfaceC02675t {
    public int A00;
    public int A01;
    ...
    @Deprecated
    public C1804nA() {
        this(null, Collections.emptyMap(), AdError.SERVER_ERROR_CODE, AnonymousClass45.A00, false);
    }

    public C1804nA(Context context, Map<Integer, Long> initialBitrateEstimates, int i4, AnonymousClass45 anonymousClass45, boolean z3) {
        ...
        this.A0F = z3;
        if (context != null) {
            C02374p c02374pA03 = C02374p.A03(context);
            this.A00 = c02374pA03.A09();
            this.A04 = A00(this.A00);
            c02374pA03.A0A(new InterfaceC02354n() { // from class: com.facebook.ads.redexgen.X.nB
                @Override // com.instagram.common.viewpoint.core.InterfaceC02354n
                public final void AF1(int i10) {
                    this.A00.A01(i10);
                }
            });
            return;
    ...
    private long A00(int i4) {
        Long initialBitrateEstimate = this.A0E.get(Integer.valueOf(i4));
    ...
    public synchronized void A01(int i4) {
    ...
    private void A02(int i4, long j, long j8) {
        if (i4 == 0 && j == 0 && j8 == this.A05) {
            return;
        }
        this.A05 = j8;
        this.A0C.A00(i4, j, j8);
    }

    public static boolean A04(C02565i c02565i, boolean z3) {
        return z3 && !c02565i.A06(8);
    }

    @Override // com.instagram.common.viewpoint.core.InterfaceC02675t
    public final synchronized void ADK(InterfaceC1932pF interfaceC1932pF, C02565i c02565i, boolean z3, int i4) {
        if (A04(c02565i, z3)) {
            this.A06 += i4;
        }
    }
    ...
    @Override // com.instagram.common.viewpoint.core.InterfaceC02675t
    public final synchronized void AGG(InterfaceC1932pF interfaceC1932pF, C02565i c02565i, boolean z3) {
        if (A04(c02565i, z3)) {
            AbstractC02203y.A08(this.A03 > 0);
            long nowMs = this.A0B.A6J();
            int i4 = (int) (nowMs - this.A07);
            this.A09 += i4;
            this.A08 += this.A06;
            if (i4 > 0) {
                FW fw = this.A0D;
                int sampleElapsedTimeMs = (int) Math.sqrt(this.A06);
                fw.A07(sampleElapsedTimeMs, (this.A06 * 8000.0f) / i4);
    ...
    @Override // com.instagram.common.viewpoint.core.InterfaceC02675t
    public final synchronized void AGH(@MetaExoPlayerCustomization InterfaceC1932pF interfaceC1932pF, C02565i c02565i, boolean z3, boolean z10) {
        if (A04(c02565i, z3)) {
            if (this.A03 == 0) {
