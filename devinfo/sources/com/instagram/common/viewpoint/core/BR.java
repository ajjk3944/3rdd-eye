...
public abstract class BR<E> extends AbstractC1878oN<E> {
    ...
    public BR(int initialCapacity) {
        AbstractC1813nJ.A00(initialCapacity, A00(0, 15, 58));
    ...
    private void A02(int newElements) {
        ...
        int newCapacity = AbstractC1878oN.A03(objArr.length, this.A00 + newElements);
