...
public final class Wm implements V9 {
    ...
    public final C1432ge A06;
    public final V8 A07;
    public final InterfaceC1387fv A08;
    public volatile boolean A0C;
    public final Runnable A0A = new C0937Wr(this);
    public final Runnable A09 = new C0936Wq(this);
    ...
    public Wm(C1432ge c1432ge, V8 v82) {
        this.A07 = v82;
        this.A06 = c1432ge;
        this.A04 = (ConnectivityManager) c1432ge.getSystemService(A03(293, 12, 115));
        this.A08 = C1405gD.A01(c1432ge);
        this.A03 = AbstractC0888Ur.A0K(c1432ge);
        this.A02 = AbstractC0888Ur.A0J(c1432ge);
    }
    ...
    private void A06() {
        if (this.A00 >= AbstractC0888Ur.A09(this.A06)) {
            A05();
            A61();
            return;
        }
        ...
        if (A0E[4].charAt(15) == 'm') {
            ...
            if (i4 == 1) {
                this.A01 = AbstractC0888Ur.A0I(this.A06);
            } else {
                long j = this.A01 * 2;
                String[] strArr2 = A0E;
        ...
        try {
            ...
            if (zAAO && jSONObjectA5L.has(strA03)) {
                ...
                for (int i4 = 0; i4 < jSONArray.length(); i4++) {
                    String str = A03(4, 19, 81) + i4 + A03(0, 3, 14) + jSONArray.get(i4);
                }
            }
            ...
            C1401g9 c1401g9 = new C1401g9();
            c1401g9.put(A03(315, 7, 6), jSONObjectA5L.toString());
            InterfaceC1386fu interfaceC1386fuAGx = this.A08.AGx(this.A06.A05().A86(), c1401g9.A08());
            String strA73 = interfaceC1386fuAGx != null ? interfaceC1386fuAGx.A73() : null;
            if (!TextUtils.isEmpty(strA73) && interfaceC1386fuAGx != null) {
                if (interfaceC1386fuAGx.A9C() != 200) {
                    if (this.A06.A05().AAO()) {
                        String responseBody = A0F;
                        Log.e(responseBody, A03(138, 48, 30) + interfaceC1386fuAGx.A9C() + A03(3, 1, 55));
                    }
                    if (interfaceC1386fuAGx.A9C() == 413 && C0886Up.A2Y(this.A06)) {
                        this.A07.AFZ();
                        A05();
                        return;
                    } else {
            ...
            if (this.A06.A05().AAO()) {
                Log.e(A0F, A03(AppLovinMediationAdapter.ERROR_MISSING_AD_UNIT_ID, 25, 71));
            }
            if (C0886Up.A2N(this.A06) && jSONObjectA5L.has(strA03)) {
                this.A07.ADe(jSONObjectA5L.getJSONArray(strA03));
            }
            A06();
        } catch (Exception e2) {
            C1432ge c1432ge = this.A06;
            String[] strArr = A0E;
