...
public final class C0884Un {
    ...
    public final ServiceConnection A02 = new ServiceConnectionC0883Um(this);
    ...
    public C0884Un(C1436gi c1436gi, String str, String str2) {
        this.A03 = c1436gi;
        this.A05 = str;
        this.A04 = str2;
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void A07(int i4, C0849Te c0849Te) {
        this.A03.A08().ABC(A05(189, 14, 110), i4, c0849Te);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void A08(int i4, C0849Te c0849Te) {
        c0849Te.A05(1);
        this.A03.A08().ABD(A05(189, 14, 110), i4, c0849Te);
    }

    public final void A0C() {
        A08(AbstractC0848Td.A1t, new C0849Te(A05(101, 18, 23), this.A05));
        Intent intent = new Intent();
        intent.setClassName(A05(170, 19, 75), A05(119, 51, 74));
        try {
            if (!this.A03.bindService(intent, this.A02, 1)) {
                A08(AbstractC0848Td.A1p, new C0849Te(A05(51, 50, 106)));
                this.A03.unbindService(this.A02);
            }
        } catch (Exception e2) {
            A07(AbstractC0848Td.A1o, new C0849Te(e2));
        }
    }
}
