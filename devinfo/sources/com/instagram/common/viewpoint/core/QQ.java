...
public final class QQ {
    ...
    private int A00(int i4) {
        ...
        int limit = i4;
        while (limit < offset) {
            int iA03 = i4 - (limit - this.A00.A03(limit));
            if (iA03 == 0) {
    ...
    public final View A09(int i4) {
        return this.A01.A7H(A00(i4));
    }

    public final View A0A(int i4) {
        return this.A01.A7H(i4);
    }
    ...
    public final void A0H(View view, int i4, ViewGroup.LayoutParams layoutParams, boolean z3) {
        int iA00;
        if (i4 < 0) {
            iA00 = this.A01.A7I();
        } else {
    ...
    public final void A0I(View view, int i4, boolean z3) {
        int iA00;
        if (i4 < 0) {
            QP qp = this.A01;
            String[] strArr = A04;
