...
public class C02966w extends C1505hq {
    ...
    public final /* synthetic */ C02956v A00;

    /* JADX WARN: Failed to parse debug info
    java.lang.ArrayIndexOutOfBoundsException
     */
    @Override // com.instagram.common.viewpoint.core.C1505hq
    public final int A0O(View view, int i4) {
        R2 r2A08 = A08();
        if (!r2A08.A22()) {
            return 0;
        }
        R3 r32 = (R3) view.getLayoutParams();
        int iA0N = A0N(r2A08.A0m(view) - r32.leftMargin, r2A08.A0p(view) + r32.rightMargin, r2A08.A0g(), r2A08.A0j() - r2A08.A0h(), i4) + this.A00.A02;
        if (A01[0].length() != 6) {
    ...
    public C02966w(C02956v c02956v, C1436gi c1436gi) {
        super(c1436gi);
        this.A00 = c02956v;
    }
    ...
    @Override // com.instagram.common.viewpoint.core.C1505hq
    public final PointF A0P(int i4) {
        return this.A00.A56(i4);
    }
}
