...
public class C1505hq extends RF {
     ...
     */
    private final int A03(View view, int i4) {
        R2 r2A08 = A08();
        if (r2A08 == null || !r2A08.A23()) {
            return 0;
        }
        R3 r32 = (R3) view.getLayoutParams();
        return A0N(r2A08.A0q(view) - r32.topMargin, r2A08.A0l(view) + r32.bottomMargin, r2A08.A0i(), r2A08.A0Z() - r2A08.A0f(), i4);
    }
    ...
    java.lang.ArrayIndexOutOfBoundsException
     */
    public int A0O(View view, int i4) {
        R2 r2A08 = A08();
        if (r2A08 == null || !r2A08.A22()) {
            return 0;
        }
        R3 r32 = (R3) view.getLayoutParams();
        return A0N(r2A08.A0m(view) - r32.leftMargin, r2A08.A0p(view) + r32.rightMargin, r2A08.A0g(), r2A08.A0j() - r2A08.A0h(), i4);
    }
    ...
    public C1505hq(Context context) {
    ...
    private int A01(int i4, int i10) {
        int before = i4 - i10;
        if (i4 * before <= 0) {
            return 0;
        }
    ...
    @Override // com.instagram.common.viewpoint.core.RF
    public final void A0H(int i4, int i10, RH rh2, RD rd) {
        if (A06() == 0) {
            A09();
            if (A07[2].length() != 19) {
                throw new RuntimeException();
    ...
    @Override // com.instagram.common.viewpoint.core.RF
    public void A0I(View view, RH rh2, RD rd) {
    ...
    public int A0L(int i4) {
        return (int) Math.ceil(Math.abs(i4) * this.A03);
    }

    public final int A0M(int i4) {
        return (int) Math.ceil(A0L(i4) / 0.3356d);
    }

    public final int A0N(int i4, int i10, int i11, int i12, int i13) {
        switch (i13) {
            case -1:
                return i11 - i4;
            case 0:
            ...
            case 1:
                return i12 - i10;
            default:
                throw new IllegalArgumentException(A04(AppLovinMediationAdapter.ERROR_MISSING_AD_UNIT_ID, 93, 125));
        }
    }

    public PointF A0P(int i4) {
        Object objA08 = A08();
        if (objA08 instanceof RE) {
            return ((RE) objA08).A56(i4);
        }
