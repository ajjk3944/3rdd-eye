...
public final class C01571j extends AQ {
    ...
    public final long AGi(C02565i c02565i) throws C1927pA {
        ...
        try {
            try {
                this.A02.seek(c02565i.A04);
                this.A00 = c02565i.A03 == -1 ? this.A02.length() - c02565i.A04 : c02565i.A03;
                AnonymousClass54.A00();
                if (this.A00 < 0) {
                    throw new C1927pA(null, null, AdError.REMOTE_ADS_SERVICE_ERROR);
                }
                this.A03 = true;
                A0H(c02565i);
                long j = this.A00;
                ...
                throw new C1927pA(e2, AdError.SERVER_ERROR_CODE);
            }
        } catch (Throwable th2) {
            AnonymousClass54.A00();
            throw th2;
    ...
    public static RandomAccessFile A00(Uri uri) throws C1927pA {
        int i4 = AdError.INTERNAL_ERROR_2006;
        try {
            return new RandomAccessFile((String) AbstractC02203y.A01(uri.getPath()), A01(29, 1, 31));
            ...
            if (zIsEmpty && TextUtils.isEmpty(uri.getFragment())) {
                if (C5C.A02 < 21 || !C02585k.A00(e2.getCause())) {
                    i4 = 2005;
                }
                throw new C1927pA(e2, i4);
            }
            throw new C1927pA(String.format(A01(30, 192, 19), uri.getPath(), uri.getQuery(), uri.getFragment()), e2, TTAdConstant.IMAGE_MODE_CAROUSEL_IMG);
        } catch (SecurityException e10) {
            throw new C1927pA(e10, AdError.INTERNAL_ERROR_2006);
        } catch (RuntimeException e11) {
            throw new C1927pA(e11, AdError.SERVER_ERROR_CODE);
        }
    }
    ...
    */
    public final void close() throws com.instagram.common.viewpoint.core.C1927pA {
        /*
            r6 = this;
            r4 = 0
            r6.A01 = r4
        ...
        Ld:
            r6.A02 = r4
            boolean r4 = r6.A03
            java.lang.String[] r2 = com.instagram.common.viewpoint.core.C01571j.A05
            r0 = 0
            r1 = r2[r0]
            r0 = 2
            r0 = r2[r0]
        ...
        L73:
            ...
            goto L6d
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C01571j.close():void");
    }

    @Override // com.instagram.common.viewpoint.core.InterfaceC01762c
    @MetaExoPlayerCustomization("FB tracing added in D4783963 for calls to TraceUtil.beginSection and TraceUtil.endSection")
    public final int read(byte[] bArr, int i4, int i10) throws C1927pA {
        if (i10 == 0) {
            return 0;
        }
        try {
            ...
            try {
                ...
                int i11 = ((RandomAccessFile) C5C.A0f(this.A02)).read(bArr, i4, (int) Math.min(this.A00, i10));
                if (i11 > 0) {
                    this.A00 -= i11;
                    A0F(i11);
                }
