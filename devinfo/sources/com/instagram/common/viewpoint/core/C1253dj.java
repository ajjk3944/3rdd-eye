...
public final class C1253dj extends RelativeLayout {
    ...
    public C1253dj(C1436gi c1436gi, C0706Nm c0706Nm, NY ny, ViewOnClickListenerC0634Kr viewOnClickListenerC0634Kr, String str, View.OnClickListener onClickListener) {
        super(c1436gi);
        this.A04 = c1436gi;
        this.A03 = c0706Nm;
        this.A02 = ny;
        ...
        this.A06 = new C1136bq(this.A04, C0694Na.A01(null), true, false, true);
        A00();
    }

    private void A00() {
        AbstractC1137br.A00(this.A04, this, this.A03.A01());
