...
public abstract class UP {
    ...
    public static UR A00(C1432ge c1432ge) {
        try {
            return new ZD(c1432ge);
        } catch (IOException e2) {
            c1432ge.A08().ABC(A02(0, 15, 104), AbstractC0848Td.A2K, new C0849Te(e2));
            return new ZG();
        }
    }

    /* JADX WARN: Type inference failed for: r0v0, types: [com.facebook.ads.redexgen.X.71] */
    public static AnonymousClass71 A01(C1432ge c1432ge) {
        return new ZH(c1432ge) { // from class: com.facebook.ads.redexgen.X.71
            ...
            private JSONArray A01(Cursor cursor) throws JSONException {
                ...
                while (cursor.moveToNext()) {
                    ...
                    jSONObject.put(A00(54, 2, 12), cursor.getString(C1384fs.A04.A00));
                    jSONObject.put(A00(82, 8, 79), cursor.getString(C1384fs.A09.A00));
                    jSONObject.put(A00(90, 4, 58), cursor.getString(C1384fs.A0A.A00));
                    jSONObject.put(A00(78, 4, 94), Y1.A03(cursor.getDouble(C1384fs.A08.A00)));
                    jSONObject.put(A00(66, 12, 26), Y1.A03(cursor.getDouble(C1384fs.A07.A00)));
                    jSONObject.put(A00(56, 10, 44), cursor.getString(C1384fs.A06.A00));
                    String string = cursor.getString(C1384fs.A03.A00);
                    jSONObject.put(A00(50, 4, 100), string != null ? new JSONObject(string) : new JSONObject());
                    jSONObject.put(A00(43, 7, 94), cursor.getString(C1384fs.A02.A00));
            ...
            public static JSONObject A03(Cursor cursor) throws JSONException {
                JSONObject jSONObject = new JSONObject();
                while (cursor.moveToNext()) {
                    jSONObject.put(cursor.getString(C1377fl.A03.A00), cursor.getString(C1377fl.A02.A00));
                }
                return jSONObject;
            }

            @Override // com.instagram.common.viewpoint.core.UQ
            public final int A50(int i4) {
                int iA08 = 0;
                if (i4 > -1) {
                    try {
                        iA08 = this.A02.A08(i4);
                    } catch (Exception e2) {
                        if (this.A01.A05().AAO()) {
                            Log.e(ZH.A00, A00(0, 38, 88), e2);
                        }
                    }
                }
                this.A02.A0I();
            ...
            public final String A85(String str) {
                ...
                if (cursorA0D != null) {
                    ...
                    if (zMoveToNext && cursorA0D.getCount() > 0) {
                        String eventType2 = C1384fs.A0A.A01;
            ...
            @Override // com.instagram.common.viewpoint.core.UQ
            public final Pair<JSONObject, JSONArray> A9I(int i4) {
                Cursor cursorA0C = null;
                try {
                    try {
                        cursorA0C = this.A02.A0C(i4);
