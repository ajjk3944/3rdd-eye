...
public class ViewOnClickListenerC1345fF implements View.OnClickListener {
    public final /* synthetic */ AnonymousClass34 A00;

    public ViewOnClickListenerC1345fF(AnonymousClass34 anonymousClass34) {
        ...
        try {
            if (this.A00.getVideoView() != null) {
                ...
                switch (this.A00.getVideoView().getState()) {
                    ...
                    case A05:
                    case A06:
                        this.A00.getVideoView().A0e(EnumC1323et.A04, 12);
                        break;
                    case A0A:
