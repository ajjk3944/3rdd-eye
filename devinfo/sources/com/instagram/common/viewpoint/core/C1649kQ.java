...
public final class C1649kQ implements InterfaceC0676Mh {
    public static byte[] A04;
    public static final String[] A05;
    public String A00;
    public String A01;
    public final SparseArray<C0675Mg> A02 = new SparseArray<>();
    ...
    public final void AAs(HashMap<String, C0675Mg> map, SparseArray<String> sparseArray) throws IOException {
        AbstractC02203y.A08(this.A02.size() == 0);
        try {
            if (C5Q.A00(this.A03.getReadableDatabase(), 1, (String) AbstractC02203y.A01(this.A00)) != 1) {
            ...
            while (cursorA00.moveToNext()) {
                try {
                    C0675Mg c0675Mg = new C0675Mg(cursorA00.getInt(0), (String) AbstractC02203y.A01(cursorA00.getString(1)), C0677Mi.A02(new DataInputStream(new ByteArrayInputStream(cursorA00.getBlob(2)))));
                    map.put(c0675Mg.A02, c0675Mg);
                    sparseArray.put(c0675Mg.A01, c0675Mg.A02);
                } finally {
                }
            }
            if (cursorA00 != null) {
    ...
    public final void AKJ(HashMap<String, C0675Mg> map) throws IOException {
        ...
        try {
            ...
            for (int i4 = 0; i4 < this.A02.size(); i4++) {
                try {
                    C0675Mg c0675MgValueAt = this.A02.valueAt(i4);
                    if (c0675MgValueAt == null) {
                        A05(writableDatabase, this.A02.keyAt(i4));
                    } else {
                        A06(writableDatabase, c0675MgValueAt);
                    }
                } finally {
                    writableDatabase.endTransaction();
                }
    ...
    public C1649kQ(C5O c5o) {
        this.A03 = c5o;
    }

    private Cursor A00() {
        return this.A03.getReadableDatabase().query((String) AbstractC02203y.A01(this.A01), A05, null, null, null, null, null);
    }
    ...
    private void A04(SQLiteDatabase sQLiteDatabase) throws C5N, SQLException {
        C5Q.A04(sQLiteDatabase, 1, (String) AbstractC02203y.A01(this.A00), 1);
        A07(sQLiteDatabase, (String) AbstractC02203y.A01(this.A01));
        sQLiteDatabase.execSQL(A01(75, 13, 108) + this.A01 + A01(0, 1, 22) + A01(1, 74, 2));
    }

    private void A05(SQLiteDatabase sQLiteDatabase, int i4) {
        sQLiteDatabase.delete((String) AbstractC02203y.A01(this.A01), A01(130, 6, 122), new String[]{Integer.toString(i4)});
    }

    private void A06(SQLiteDatabase sQLiteDatabase, C0675Mg c0675Mg) throws IOException, SQLException {
        ByteArrayOutputStream byteArrayOutputStream = new ByteArrayOutputStream();
        C0677Mi.A08(c0675Mg.A03(), new DataOutputStream(byteArrayOutputStream));
        byte[] byteArray = byteArrayOutputStream.toByteArray();
        ContentValues contentValues = new ContentValues();
        contentValues.put(A01(128, 2, 48), Integer.valueOf(c0675Mg.A01));
        contentValues.put(A01(136, 3, 37), c0675Mg.A02);
        contentValues.put(A01(139, 8, 1), byteArray);
        sQLiteDatabase.replaceOrThrow((String) AbstractC02203y.A01(this.A01), null, contentValues);
    }
    ...
    public final void A5p() throws C5N {
        A08(this.A03, (String) AbstractC02203y.A01(this.A00));
    }

    @Override // com.instagram.common.viewpoint.core.InterfaceC0676Mh
    public final boolean A6S() throws C5N {
        try {
            return C5Q.A00(this.A03.getReadableDatabase(), 1, (String) AbstractC02203y.A01(this.A00)) != -1;
        } catch (SQLException e2) {
            throw new C5N(e2);
        }
    }
    ...
    public final void AFd(C0675Mg c0675Mg, boolean z3) {
        if (z3) {
            this.A02.delete(c0675Mg.A01);
        } else {
            this.A02.put(c0675Mg.A01, null);
        }
    }

    @Override // com.instagram.common.viewpoint.core.InterfaceC0676Mh
    public final void AGK(C0675Mg c0675Mg) {
        this.A02.put(c0675Mg.A01, c0675Mg);
    }
    ...
    public final void AKI(HashMap<String, C0675Mg> map) throws IOException {
        try {
            ...
            try {
                A04(writableDatabase);
                Iterator<C0675Mg> it = map.values().iterator();
                while (it.hasNext()) {
