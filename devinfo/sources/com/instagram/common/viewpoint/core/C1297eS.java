...
public final class C1297eS {
    ...
    public final NN A0e;
    public final NY A0f;
    public final C0697Nd A0g;
    public final C0706Nm A0h;
    public final C1436gi A0i;
    public final VI A0j;
    public final InterfaceC0977Yh A0k;
    public final ViewOnClickListenerC0634Kr A0l;
    public int A06 = 160;
    public int A07 = 130;
    public int A03 = 56;
    public int A04 = 430;
    ...
    public static String A0H(int i4, int i10, int i11) {
        ...
        for (int i12 = 0; i12 < bArrCopyOfRange.length; i12++) {
            int i13 = (bArrCopyOfRange[i12] ^ i11) ^ 50;
            String[] strArr = A0o;
    ...
    public static void A0M() {
        A0n = new byte[]{13, 31, 111, 31, 111, 31, 111, 44, 55, Utf8.REPLACEMENT_BYTE, Utf8.REPLACEMENT_BYTE, Utf8.REPLACEMENT_BYTE, Utf8.REPLACEMENT_BYTE, Utf8.REPLACEMENT_BYTE, Utf8.REPLACEMENT_BYTE, Utf8.REPLACEMENT_BYTE, 91, 84, 101, 91, 89, 78, 83, 76, 83, 78, 67, 117, 121, 123, 56, 112, 119, 117, 115, 116, 121, 121, 125, 56, 119, 114, 101, 56, 127, 120, 98, 115, 100, 101, 98, 127, 98, 127, 119, 122, 56, 112, 127, 120, 127, 101, 126, 73, 119, 117, 98, 127, 96, 127, 98, 111, 88, 83, 89, 126, 92, 79, 89, 107, 15, 110, 94, 79, 88, 88, 83, 78, 85, 82, 73, 111, 88, 94, 68, 94, 81, 88, 79, 124, 89, 92, 77, 73, 88, 79, 29, 84, 78, 29, 83, 72, 81, 81, 21, 13, 15, 22};
    }
    ...
    public C1297eS(final C1436gi c1436gi, AbstractC1601jd abstractC1601jd, InterfaceC0977Yh interfaceC0977Yh, ViewOnClickListenerC0634Kr viewOnClickListenerC0634Kr, Handler handler, VI vi2) {
        this.A0i = c1436gi;
        this.A0d = abstractC1601jd;
        this.A0j = vi2;
        this.A0h = abstractC1601jd.A2C();
        this.A0g = abstractC1601jd.A29().A0K();
        this.A0k = interfaceC0977Yh;
        this.A0b = handler;
        this.A0f = abstractC1601jd.A29().A0I();
        this.A0e = abstractC1601jd.A28();
        this.A0l = viewOnClickListenerC0634Kr;
        this.A0S = new C7M(c1436gi) { // from class: com.facebook.ads.redexgen.X.1E
        ...
        this.A0P = new RelativeLayout(c1436gi);
        this.A0W = new C1130bk(c1436gi);
        this.A0R = new TextView(c1436gi);
        this.A0M = new ImageView(c1436gi);
    ...
    private FrameLayout.LayoutParams A01() {
        if (this.A0i.getResources().getConfiguration().orientation == 2) {
            ...
            layoutParams.setMargins(0, i4, 0, orientation);
            return layoutParams;
        }
    ...
    private ImageView A03() {
        ...
        if (this.A0l != null && this.A0l.getCtaActionHelper().A06() == null) {
            this.A0l.getCtaActionHelper().A07(new InterfaceC0686Mr() { // from class: com.facebook.ads.redexgen.X.FQ
    ...
    private LinearLayout.LayoutParams A04() {
        ...
        int height = this.A0B;
        int width3 = this.A0B;
        layoutParams.setMargins(height, i11, width3, 0);
        return layoutParams;
    }
    ...
    private LinearLayout A06() {
        ...
        arrayList.add(new C1300eV(this.A0i).A02(new C1119bZ(this.A0i, -1, -1, YM.RATINGS)).A04(this.A0f.A0C()).A03(this.A0f.A0B()));
        if (!this.A0f.A09().isEmpty()) {
            try {
                strA09 = AbstractC0950Xg.A01(Integer.parseInt(this.A0f.A09()));
            } catch (NumberFormatException unused) {
                strA09 = this.A0f.A09();
            }
            arrayList.add(new C1300eV(this.A0i).A02(new C1119bZ(this.A0i, -1, -1, YM.NUCLEUS_GROUP)).A04(strA09).A03(this.A0f.A0A()));
        }
        if (!this.A0f.A05().isEmpty()) {
            arrayList.add(new C1300eV(this.A0i).A02(new C1119bZ(this.A0i, -1, -1, YM.DOWNLOAD)).A04(this.A0f.A05()).A03(this.A0f.A06()));
        }
        NY ny = this.A0f;
        if (A0o[2].length() == 29) {
            throw new RuntimeException();
        ...
        A0o[2] = "3vpsIj";
        if (!ny.A01().isEmpty()) {
            arrayList.add(new C1300eV(this.A0i).A02(new C1119bZ(this.A0i, -1, -1, YM.NUCLEUS_DURATION)).A04(this.A0f.A01()).A03(this.A0f.A0D()));
        }
        if (!this.A0f.A02().isEmpty()) {
            arrayList.add(new C1300eV(this.A0i).A02(new C1119bZ(this.A0i, -1, -1, YM.GRID_4)).A04(this.A0f.A02()).A03(this.A0f.A03()));
        }
    ...
    private LinearLayout A07(RelativeLayout relativeLayout, ViewOnClickListenerC0634Kr viewOnClickListenerC0634Kr) {
        LinearLayout linearLayout = new LinearLayout(this.A0i);
        linearLayout.setOrientation(0);
        linearLayout.setGravity(17);
        RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-2, -2);
        layoutParams.addRule(3, viewOnClickListenerC0634Kr.getId());
        ...
        linearLayout.setId(View.generateViewId());
        C1119bZ iconView = new C1119bZ(this.A0i, -1, -1, YM.GOOGLE_PLAY_STORE);
    ...
    private RelativeLayout.LayoutParams A08(LinearLayout linearLayout) {
        int i4;
        int i10 = this.A0i.getResources().getConfiguration().orientation;
        if (linearLayout == null || this.A0Y || i10 == 2) {
        ...
        RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(i11, orientation3);
    ...
    private RelativeLayout.LayoutParams A0B(C1130bk c1130bk) {
        RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-2, -2);
        layoutParams.addRule(14);
        layoutParams.addRule(3, c1130bk.getId());
    ...
    private TextView A0E(RelativeLayout relativeLayout, C1130bk c1130bk) {
        TextView textView = new TextView(this.A0i);
        ...
        textView.setLayoutParams(A0B(c1130bk));
        relativeLayout.addView(textView);
        textView.setId(View.generateViewId());
        return textView;
    }

    private C1130bk A0G(LinearLayout linearLayout) {
        C1130bk c1130bk = new C1130bk(this.A0i);
        c1130bk.setRadius(30);
        YB.A0N(c1130bk, 0);
        LM downloadImageTask = new LM(c1130bk, this.A0i).A04();
        downloadImageTask.A07(this.A0h.A01());
        c1130bk.setLayoutParams(A08(linearLayout));
        c1130bk.setId(View.generateViewId());
        return c1130bk;
    }
    ...
    private void A0I() {
        ...
        if (shouldShowThirdEndCard2 && this.A0g.A00() > 0) {
            ...
            AbstractC1299eU.A01(this.A0i, this.A0M, this.A0g.A00(), this.A0N);
        }
    }
    ...
    private void A0L() {
        ...
        if (parent2 instanceof ViewGroup) {
            this.A0m.set(true);
            this.A0X = new C1165cJ(this.A0i, this.A0d, this.A0j, this.A0b, this.A0k);
    ...
    private void A0O(View view, int i4, float[] fArr) {
    ...
    private void A0Q(RelativeLayout relativeLayout, LinearLayout linearLayout, ViewOnClickListenerC0634Kr viewOnClickListenerC0634Kr) {
        this.A0T = AbstractC1046aO.A01(this.A0i, false, this.A0d, this.A0j, this.A0k, EnumC1044aM.A02, AbstractC1043aL.A00(this.A0d));
        YB.A0K(this.A0T);
        RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-2, -2);
        layoutParams.setMargins(0, this.A0B, 0, this.A0B);
        layoutParams.addRule(7, viewOnClickListenerC0634Kr.getId());
        layoutParams.addRule(3, linearLayout.getId());
        this.A0T.setLayoutParams(layoutParams);
        relativeLayout.addView(this.A0T);
    }

    private void A0R(RelativeLayout relativeLayout, LinearLayout linearLayout, ViewOnClickListenerC0634Kr viewOnClickListenerC0634Kr) {
        this.A0U = AbstractC1046aO.A01(this.A0i, false, this.A0d, this.A0j, this.A0k, EnumC1044aM.A02, EnumC1047aP.A04);
        YB.A0K(this.A0U);
        RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-2, -2);
        layoutParams.setMargins(0, this.A0H, 0, this.A0B);
        layoutParams.addRule(5, viewOnClickListenerC0634Kr.getId());
        layoutParams.addRule(3, linearLayout.getId());
        this.A0U.setLayoutParams(layoutParams);
        relativeLayout.addView(this.A0U);
    }

    private void A0S(RelativeLayout relativeLayout, LinearLayout linearLayout, ViewOnClickListenerC0634Kr viewOnClickListenerC0634Kr) {
        this.A0V = AbstractC1046aO.A02(this.A0i, EnumC1044aM.A02, this.A0d);
        RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-2, -2);
        layoutParams.setMargins(0, this.A0B, 0, this.A0B);
        layoutParams.addRule(5, viewOnClickListenerC0634Kr.getId());
        layoutParams.addRule(3, linearLayout.getId());
    ...
    private void A0T(RelativeLayout relativeLayout, ViewOnClickListenerC0634Kr viewOnClickListenerC0634Kr, LinearLayout linearLayout, TextView textView) {
        RelativeLayout.LayoutParams layoutParamsA09 = A09(linearLayout, textView);
        viewOnClickListenerC0634Kr.setIncludeFontPadding(false);
        viewOnClickListenerC0634Kr.setLayoutParams(layoutParamsA09);
        viewOnClickListenerC0634Kr.A0D();
        viewOnClickListenerC0634Kr.setHeight(this.A03);
        viewOnClickListenerC0634Kr.setTextSize(18.0f);
        viewOnClickListenerC0634Kr.setCornerRadiusPx(40);
        viewOnClickListenerC0634Kr.setTextColor(A00(this.A0e.A01().A04()));
        YB.A0V(viewOnClickListenerC0634Kr, YB.A06(this.A0e.A01().A04(), 40));
        ...
        relativeLayout.addView(viewOnClickListenerC0634Kr);
        String[] strArr = A0o;
        if (strArr[7].length() == strArr[5].length()) {
            throw new RuntimeException();
        }
    ...
    private void A0U(ViewOnClickListenerC0634Kr viewOnClickListenerC0634Kr) {
        this.A0S.setLayoutManager(new C1506hr(this.A0i, 0, false));
        ...
        this.A0S.setAdapter(new FO(this.A0i, this.A0g.A02(), this.A0H, this.A0S, viewOnClickListenerC0634Kr, i4));
    }

    private void A0V(final InterfaceC1296eR interfaceC1296eR) {
        final ImageView imageView = new ImageView(this.A0i);
        imageView.setAdjustViewBounds(true);
        LM lm2 = new LM(imageView, this.A0i);
        if (!this.A0g.A02().isEmpty()) {
            lm2.A06(new InterfaceC1092b8() { // from class: com.facebook.ads.redexgen.X.FR
                @Override // com.instagram.common.viewpoint.core.InterfaceC1092b8
                public final void AE7(C1091b7 c1091b7) {
                    this.A02.A0c(imageView, interfaceC1296eR, c1091b7);
                }
            });
            lm2.A07(this.A0g.A02().get(0));
        } else {
            interfaceC1296eR.AE9();
        }
    }
    ...
    public final FrameLayout A0W() {
        ...
        this.A0P = A0C();
        if (C0886Up.A1D(this.A0i)) {
            this.A0P.setOnClickListener(new ViewOnClickListenerC1294eP(this));
        }
        A0P(this.A0P);
        this.A0O = A06();
        ...
        if (this.A0d.A2T()) {
            ...
            blackBackgroundView.setOnClickListener(new ViewOnClickListenerC1295eQ(this));
        ...
        A0V(new InterfaceC1296eR() { // from class: com.facebook.ads.redexgen.X.FX
            @Override // com.instagram.common.viewpoint.core.InterfaceC1296eR
    ...
    public final void A0a(int i4) {
        if (!this.A0m.get()) {
            ...
            if (fo == null) {
                this.A0i.A08().ABC(A0H(16, 11, 8), AbstractC0848Td.A0A, new C0849Te(A0H(72, 42, 15)));
            }
            if (this.A0l != null) {
    ...
    public final /* synthetic */ void A0b(View view) {
        if (this.A0l != null) {
            EnumC0685Mq enumC0685MqA0E = this.A0l.A0E(A0H(114, 4, 84));
            if (this.A0d.A2N()) {
                return;
            }
            EnumC0685Mq actionOutcome = EnumC0685Mq.A09;
            if (enumC0685MqA0E != actionOutcome) {
                EnumC0685Mq actionOutcome2 = EnumC0685Mq.A06;
                if (enumC0685MqA0E != actionOutcome2) {
                    A0Z();
                }
            }
        }
    ...
    public final /* synthetic */ void A0c(ImageView imageView, InterfaceC1296eR interfaceC1296eR, C1091b7 c1091b7) {
