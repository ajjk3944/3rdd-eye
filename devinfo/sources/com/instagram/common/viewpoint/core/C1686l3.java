...
public final class C1686l3 implements H9 {
    ...
    public C1686l3(int i4) {
        this(1, i4, 112800);
    }

    public C1686l3(int i4, int i10, int i11) {
        this(i4, new AnonymousClass53(0L), new C1708lP(i10), i11);
    }

    public C1686l3(int i4, AnonymousClass53 anonymousClass53, LE le2, int i10) {
        this.A0H = (LE) AbstractC02203y.A01(le2);
        this.A0A = i10;
        this.A09 = i4;
        if (i4 == 1 || i4 == 2) {
        ...
        this.A0F = new C02434v(new byte[9400], 0);
    ...
    public static /* synthetic */ int A02(C1686l3 c1686l3) {
        int i4 = c1686l3.A02;
        c1686l3.A02 = i4 + 1;
        return i4;
    }
    ...
    private void A0F() {
        ...
        for (int i4 = 0; i4 < size; i4++) {
            ...
            int initialPayloadReadersSize2 = sparseArrayA5Q.keyAt(i4);
            sparseArray.put(initialPayloadReadersSize2, sparseArrayA5Q.valueAt(i4));
        }
        this.A0B.put(0, new C1692l9(new C1688l5(this)));
        this.A05 = null;
    }
    ...
    private void A0H(long j) {
        if (!this.A06) {
            ...
            if (this.A0G.A08() != -9223372036854775807L) {
                this.A04 = new C1690l7(this.A0G.A09(), this.A0G.A08(), j, this.A01, this.A0A);
                this.A03.AJ7(this.A04.A07());
            } else {
                this.A03.AJ7(new C1782mn(this.A0G.A08()));
            }
        }
    }

    private boolean A0I(int i4) {
        return this.A09 == 2 || this.A08 || !this.A0D.get(i4, false);
    }

    private boolean A0J(InterfaceC1787ms interfaceC1787ms) throws IOException {
        ...
        while (this.A0F.A07() < 188) {
            ...
            int limit = interfaceC1787ms.read(bArrA0l, iA0A, 9400 - iA0A);
            if (limit == -1) {
                return false;
            }
    ...
    public final int AHL(InterfaceC1787ms interfaceC1787ms, HV hv) throws IOException {
        ...
        if (this.A08) {
            if (((jA8O == -1 || this.A09 == 2) ? false : true) && !this.A0G.A0A()) {
                return this.A0G.A07(interfaceC1787ms, hv, this.A01);
            }
            A0H(jA8O);
            if (this.A07) {
                this.A07 = false;
            ...
            if (c1690l7 != null && this.A04.A09()) {
                return this.A04.A06(interfaceC1787ms, hv);
            }
        }
        boolean zA0J = A0J(interfaceC1787ms);
        if (A0K[5].charAt(9) == '6') {
            throw new RuntimeException();
        }
        ...
        if ((8388608 & iA0C) == 0) {
            ...
            if (this.A09 != 2 && !z3 && this.A08 && jA8O != -1) {
                this.A07 = true;
            }
            this.A0F.A0f(iA00);
            return 0;
    ...
    */
    public final void AJ6(long r16, long r18) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C1686l3.AJ6(long, long):void");
    }

    @Override // com.instagram.common.viewpoint.core.H9
    public final boolean AK5(InterfaceC1787ms interfaceC1787ms) throws IOException {
        byte[] bArrA0l = this.A0F.A0l();
        interfaceC1787ms.AGt(bArrA0l, 0, 940);
        for (int i4 = 0; i4 < 188; i4++) {
            ...
            while (true) {
                ...
                int startPosCandidate = bArrA0l[(i10 * 188) + i4];
