...
public class C1463h9 extends Pv {
    public int A00;

    public C1463h9(Context context) {
        super(context);
        this.A00 = 0;
    }
    ...
    */
    public final void onMeasure(int r5, int r6) throws android.content.res.Resources.NotFoundException {
        ...
        L1f:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C1463h9.onMeasure(int, int):void");
    }
}
