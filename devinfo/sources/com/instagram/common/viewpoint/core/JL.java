...
public final class JL {
    ...
    public static final C1673kp A05;
    public static final C1673kp A06;
    public int A01;
     ...
     */
    private void A06(InterfaceC1787ms interfaceC1787ms, List<Metadata.Entry> list) throws IOException {
        long jA8n = interfaceC1787ms.A8n();
        int iA8O = (int) ((interfaceC1787ms.A8O() - interfaceC1787ms.A8n()) - this.A01);
        C02434v c02434v = new C02434v(iA8O);
        interfaceC1787ms.readFully(c02434v.A0l(), 0, iA8O);
        for (int i4 = 0; i4 < this.A02.size(); i4++) {
            JI ji2 = this.A02.get(i4);
            c02434v.A0f((int) (ji2.A02 - jA8n));
            c02434v.A0g(4);
            ...
            int iA00 = A00(c02434v.A0W(iA0E));
            int i10 = ji2.A01 - (iA0E + 8);
            switch (iA00) {
                case 2192:
                    list.add(A01(c02434v, i10));
                    break;
                case 2816:
                case 2817:
                case 2819:
    ...
    */
    public static int A00(java.lang.String r3) throws com.instagram.common.viewpoint.core.C3K {
        /*
            int r0 = r3.hashCode()
            switch(r0) {
        ...
        L80:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.JL.A00(java.lang.String):int");
    }

    public static SlowMotionData A01(C02434v c02434v, int i4) throws C3K, NumberFormatException {
        List<SlowMotionData.Segment> segments = new ArrayList<>();
        String dataString = c02434v.A0W(i4);
    ...
    private void A04(InterfaceC1787ms interfaceC1787ms, HV hv) throws IOException {
        C02434v c02434v = new C02434v(8);
        interfaceC1787ms.readFully(c02434v.A0l(), 0, 8);
        this.A01 = c02434v.A0E() + 8;
        if (c02434v.A0C() != 1397048916) {
            hv.A00 = 0L;
        } else {
            hv.A00 = interfaceC1787ms.A8n() - (this.A01 - 12);
            this.A00 = 2;
        }
    }

    private void A05(InterfaceC1787ms interfaceC1787ms, HV hv) throws IOException {
        long jA8O = interfaceC1787ms.A8O();
        int i4 = (this.A01 - 12) - 8;
        ...
        for (int i10 = 0; i10 < i4 / 12; i10++) {
            ...
            switch (i11) {
                ...
                case 2820:
                    ...
                    long streamLength2 = c02434v.A0E();
                    int size = c02434v.A0E();
                    this.A02.add(new JI(i11, j - streamLength2, size));
                    break;
                default:
                    c02434v.A0g(8);
                    break;
    ...
    public final int A07(InterfaceC1787ms interfaceC1787ms, HV hv, List<Metadata.Entry> slowMotionMetadataEntries) throws IOException {
        long j = 0;
        switch (this.A00) {
            case 0:
                long jA8O = interfaceC1787ms.A8O();
                ...
                return 1;
            case 1:
                A04(interfaceC1787ms, hv);
                return 1;
            case 2:
                A05(interfaceC1787ms, hv);
                return 1;
            case 3:
                A06(interfaceC1787ms, slowMotionMetadataEntries);
                hv.A00 = 0L;
                return 1;
            default:
                throw new IllegalStateException();
