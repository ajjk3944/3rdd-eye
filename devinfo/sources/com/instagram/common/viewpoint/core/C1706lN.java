...
public final class C1706lN implements InterfaceC0638Kv {
    ...
    public final InterfaceC0543Hd[] A05;
    ...
    public C1706lN(List<LC> list) {
        this.A04 = list;
        this.A05 = new InterfaceC0543Hd[list.size()];
    }

    private boolean A02(C02434v c02434v, int i4) {
        if (c02434v.A07() == 0) {
            return false;
        }
        if (c02434v.A0I() != i4) {
    ...
    public final void A5A(C02434v c02434v) {
        if (this.A03) {
            if (this.A00 == 2 && !A02(c02434v, 32)) {
                return;
            }
            if (this.A00 == 1 && !A02(c02434v, 0)) {
                return;
            }
            int iA09 = c02434v.A09();
            int iA07 = c02434v.A07();
            for (InterfaceC0543Hd interfaceC0543Hd : this.A05) {
                c02434v.A0f(iA09);
    ...
    */
    public final void A5c(com.instagram.common.viewpoint.core.HA r8, com.instagram.common.viewpoint.core.LG r9) {
        ...
        L52:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C1706lN.A5c(com.facebook.ads.redexgen.X.HA, com.facebook.ads.redexgen.X.LG):void");
    }
    ...
    public final void AGp() {
        if (this.A03) {
            if (this.A02 != -9223372036854775807L) {
                for (InterfaceC0543Hd interfaceC0543Hd : this.A05) {
                    interfaceC0543Hd.AIu(this.A02, 1, this.A01, 0, null);
                }
            }
            this.A03 = false;
        }
