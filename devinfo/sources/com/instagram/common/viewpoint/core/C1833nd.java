...
public class C1833nd<K, V> extends AbstractSet<Map.Entry<K, V>> {
    ...
    public C1833nd(final C1837nh this$0) {
        this.A00 = this$0;
    }
    ...
    public final boolean contains(@CheckForNull Object o4) {
        ...
        boolean z3 = o4 instanceof Map.Entry;
        if (A01[5].charAt(2) != '2') {
    ...
    public final boolean remove(@CheckForNull Object o4) {
        ...
        Map.Entry entry = (Map.Entry) o4;
        if (this.A00.A0p() || (iA06 = AbstractC1840nk.A06(entry.getKey(), entry.getValue(), (iA00 = this.A00.A00()), this.A00.A0C(), this.A00.A0T(), this.A00.A0V(), this.A00.A0W())) == -1) {
            return false;
        }
