...
public final class MetaExoPlayerUpgradeConfig {
    ...
    public static final Map<EnumC1596jX, Boolean> A02;
    public static final Map<EnumC1597jY, Integer> A03;
    public static final Map<EnumC1598jZ, Long> A04;
    ...
    static {
        ...
        A02 = new EnumMap(EnumC1596jX.class);
        A03 = new EnumMap(EnumC1597jY.class);
        A04 = new EnumMap(EnumC1598jZ.class);
        for (EnumC1596jX enumC1596jX : EnumC1596jX.valuesCustom()) {
            A02.put(enumC1596jX, false);
        }
        for (EnumC1597jY enumC1597jY : EnumC1597jY.valuesCustom()) {
            A03.put(enumC1597jY, -1);
        }
        for (EnumC1598jZ id2 : EnumC1598jZ.values()) {
            A04.put(id2, -1L);
        }
        A02.put(EnumC1596jX.A0W, true);
        A02.put(EnumC1596jX.A0Q, true);
        A02.put(EnumC1596jX.A1j, true);
        A03.put(EnumC1597jY.A05, 100);
    }

    @JvmStatic
    public static final int A00(EnumC1597jY enumC1597jY) {
        C2010qY.A09(enumC1597jY, A01(24, 17, 40));
        Integer num = A03.get(enumC1597jY);
        if (num != null) {
            return num.intValue();
        }
    ...
    @JvmStatic
    public static final boolean A03(EnumC1596jX enumC1596jX) {
        C2010qY.A09(enumC1596jX, A01(24, 17, 40));
        return C2010qY.A0C(true, A02.get(enumC1596jX));
    }
}
