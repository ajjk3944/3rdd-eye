...
public final class C3B extends ED {
    ...
    public C3B(C1436gi c1436gi) {
        this(c1436gi, null);
    }

    public C3B(C1436gi c1436gi, AttributeSet attributeSet) {
        this(c1436gi, attributeSet, 0);
    }

    public C3B(C1436gi c1436gi, AttributeSet attributeSet, int i4) {
        super(c1436gi, attributeSet, i4);
        this.A00 = new C0437Da(this);
