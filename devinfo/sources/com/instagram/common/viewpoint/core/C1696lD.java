...
public final class C1696lD implements H1 {
    ...
    public final C02434v A00;
    public final AnonymousClass53 A01;

    public C1696lD(AnonymousClass53 anonymousClass53) {
        this.A01 = anonymousClass53;
        this.A00 = new C02434v();
    }

    private C0539Gz A00(C02434v c02434v, long scrValue, long scrTimeUs) {
        int iA09 = -1;
        int iA092 = -1;
        long j = -9223372036854775807L;
        while (c02434v.A07() >= 4) {
            if (C1695lC.A00(c02434v.A0l(), c02434v.A09()) != 442) {
                c02434v.A0g(1);
            } else {
                c02434v.A0g(4);
                long jA06 = L6.A06(c02434v);
                if (jA06 != -9223372036854775807L) {
                    long jA062 = this.A01.A06(jA06);
                    if (jA062 > scrValue) {
                        if (j == -9223372036854775807L) {
                            return C0539Gz.A04(jA062, scrTimeUs);
                        }
                        return C0539Gz.A03(iA09 + scrTimeUs);
                    }
                    ...
                    if (lastScrTimeUsInRange > scrValue) {
                        return C0539Gz.A03(c02434v.A09() + scrTimeUs);
                    }
                    j = jA062;
                    iA09 = c02434v.A09();
                }
        ...
        if (j != -9223372036854775807L) {
            return C0539Gz.A05(j, iA092 + scrTimeUs);
        }
        return C0539Gz.A03;
    }
    ...
    */
    public static void A01(com.instagram.common.viewpoint.core.C02434v r5) {
        /*
            int r4 = r5.A0A()
            int r1 = r5.A07()
            r0 = 10
        ...
        L33:
            byte[] r1 = r5.A0l()
            int r0 = r5.A09()
            int r1 = com.instagram.common.viewpoint.core.C1695lC.A01(r1, r0)
        ...
        L86:
            ...
            goto L57
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C1696lD.A01(com.facebook.ads.redexgen.X.4v):void");
    }
    ...
    public final C0539Gz AIw(InterfaceC1787ms interfaceC1787ms, long j) throws IOException {
        ...
        int iMin = (int) Math.min(20000L, interfaceC1787ms.A8O() - jA8n);
        this.A00.A0d(iMin);
        interfaceC1787ms.AGt(this.A00.A0l(), 0, iMin);
