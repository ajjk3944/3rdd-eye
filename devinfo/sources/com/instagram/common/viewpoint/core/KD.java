...
public final class KD extends AbstractC1149c3 {
    public RelativeLayout A00;
    public RelativeLayout A01;
    public InterfaceC1266dx A02;
    public C0483Eu A03;
    public C0473Ek A04;
    public C4L A05;
    ...
    public KD(C1153c7 c1153c7) {
        ...
        this.A0D = new EA() { // from class: com.facebook.ads.redexgen.X.6F
            ...
            public final void A03(C4K c4k) {
                this.A00.A04.A0e(EnumC1323et.A02, 20);
            }
        };
        this.A0B = c1153c7.A06();
        this.A0C = c1153c7;
    ...
    private LinearLayout A00() {
        ...
        if (!TextUtils.isEmpty(strA0C)) {
            YM ym = YM.RATINGS;
            AbstractC1601jd abstractC1601jdA05 = this.A0C.A05();
            String[] strArr = A0F;
            if (strArr[4].length() != strArr[5].length()) {
                throw new RuntimeException();
            }
            A0F[2] = "";
            LinearLayout videoMetaDataLayout = A01(ym, abstractC1601jdA05.A29().A0I().A0C());
    ...
    private LinearLayout A01(YM ym, String str) {
        ...
        linearLayout.setLayoutParams(layoutParams);
        YB.A0V(linearLayout, YB.A06(LinearLayoutManager.INVALID_OFFSET, A0Q));
        C1124be c1124be = new C1124be(this.A0C.A06(), 0, -1, ym);
        LinearLayout.LayoutParams layoutParams2 = new LinearLayout.LayoutParams(A0P, A0P);
        layoutParams2.gravity = 16;
        c1124be.setLayoutParams(layoutParams2);
    ...
    private final RelativeLayout A02(String str, int i4, YM ym) {
        ...
        YB.A0V(relativeLayout, YB.A06(i4, A0G));
        ...
        C1124be iconView = new C1124be(this.A0C.A06(), 0, -1, ym);
    ...
    private TextView A03(String str, boolean z3, int i4, int i10, int i11) {
        TextView textView = new TextView(this.A0B);
        textView.setText(str);
        textView.setTextColor(i10);
        YB.A0a(textView, z3, i4);
    ...
    private C0473Ek A05() {
        C0473Ek c0473Ek = new C0473Ek(this.A0C.A06());
        YB.A0V(c0473Ek, YB.A06(436207616, A0Q));
        c0473Ek.setLayoutParams(new RelativeLayout.LayoutParams(-1, -1));
        this.A05 = new C4L(this.A0B, getAdEventManager(), c0473Ek, this.A0C.A05().A2E(), 0, 0, true, null, null);
        if (C0886Up.A20(this.A0B)) {
            this.A03 = new C0483Eu(this.A0B, getAdEventManager(), c0473Ek, this.A0C.A05().A2E(), false, this.A05, null);
        } else {
            this.A03 = null;
        }
        return c0473Ek;
    ...
    private void A07() {
        ...
        this.A00.setOnClickListener(new ViewOnClickListenerC1177cV(this));
        this.A01.setOnClickListener(new ViewOnClickListenerC1178cW(this));
    }

    private void A08() {
        new VI(this.A0C.A05().A2E(), getAdEventManager()).A04(VH.A0f, null);
        AbstractC1137br.A00(this.A0C.A06(), this, this.A0C.A05().A29().A0H().A08());
        ...
        this.A04.A0e(EnumC1323et.A02, 20);
    ...
    private void A0A(int i4) {
        int height;
        int width;
        this.A06.setOrientation(i4 == 1 ? 1 : 0);
        ...
        setRewardDescContainerVisibility(i4);
    }
    ...
    private void A0C(int i4) {
        ...
        layoutParams.weight = i4 == 1 ? 3.0f : 1.0f;
    ...
    private void setRewardDescContainerVisibility(int i4) {
        if (i4 == 1) {
