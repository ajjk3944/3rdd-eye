...
public class KA implements InterfaceC1074aq {
    ...
    public final void AF9(String str) throws SecurityException {
        ...
        C0599Ji c0599Ji = this.A00;
        String[] strArr = A02;
        if (strArr[4].charAt(17) != strArr[5].charAt(17)) {
            A02[2] = "wX256yuF2";
            if (!c0599Ji.A0I && this.A00.A00 > 1) {
                this.A00.A0I = true;
                this.A00.A0o(A00(0, 19, 95));
            }
            C0599Ji.A02(this.A00);
            if (A02[2].length() != 27) {
