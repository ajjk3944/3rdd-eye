...
public abstract class AbstractC0766Px {
    ...
    public static final C0765Pw A02;
    ...
    static {
        A01();
        A02 = new C1514hz() { // from class: com.facebook.ads.redexgen.X.7T
            public static byte[] A00;
            ...
            @Override // com.instagram.common.viewpoint.core.C0765Pw
            public final void A02(ViewParent viewParent, View view) {
                try {
                    viewParent.onStopNestedScroll(view);
                } catch (AbstractMethodError e2) {
                    Log.e(A00(389, 16, 101), A00(378, 11, 90) + viewParent + A00(323, 55, 96), e2);
                }
            }

            @Override // com.instagram.common.viewpoint.core.C0765Pw
            public final void A03(ViewParent viewParent, View view, int i4, int i10, int i11, int i12) {
                try {
                    viewParent.onNestedScroll(view, i4, i10, i11, i12);
                } catch (AbstractMethodError e2) {
                    Log.e(A00(389, 16, 101), A00(378, 11, 90) + viewParent + A00(157, 51, 53), e2);
                }
            }

            @Override // com.instagram.common.viewpoint.core.C0765Pw
            public final void A04(ViewParent viewParent, View view, int i4, int i10, int[] iArr) {
                try {
                    viewParent.onNestedPreScroll(view, i4, i10, iArr);
                } catch (AbstractMethodError e2) {
                    Log.e(A00(389, 16, 101), A00(378, 11, 90) + viewParent + A00(FacebookMediationAdapter.ERROR_REQUIRES_ACTIVITY_CONTEXT, 54, 8), e2);
                }
            }

            @Override // com.instagram.common.viewpoint.core.C0765Pw
            public final void A05(ViewParent viewParent, View view, View view2, int i4) {
                try {
                    viewParent.onNestedScrollAccepted(view, view2, i4);
                } catch (AbstractMethodError e2) {
                    Log.e(A00(389, 16, 101), A00(378, 11, 90) + viewParent + A00(208, 59, 114), e2);
                }
            }
            ...
            public final boolean A06(ViewParent viewParent, View view, float f10, float f11) {
                try {
                    ...
                    Log.e(A00(389, 16, 101), A00(378, 11, 90) + viewParent + A00(50, 53, 25), e2);
                    return false;
                }
            }

            @Override // com.instagram.common.viewpoint.core.C0765Pw
            public final boolean A07(ViewParent viewParent, View view, float f10, float f11, boolean z3) {
                try {
                    return viewParent.onNestedFling(view, f10, f11, z3);
                } catch (AbstractMethodError e2) {
                    Log.e(A00(389, 16, 101), A00(378, 11, 90) + viewParent + A00(0, 50, 79), e2);
                    return false;
                }
            }

            @Override // com.instagram.common.viewpoint.core.C0765Pw
            public final boolean A08(ViewParent viewParent, View view, View view2, int i4) {
                try {
                    return viewParent.onStartNestedScroll(view, view2, i4);
                } catch (AbstractMethodError e2) {
                    Log.e(A00(389, 16, 101), A00(378, 11, 90) + viewParent + A00(267, 56, 74), e2);
                    return false;
                }
            }
        };
    ...
    public static void A02(ViewParent viewParent, View view, int i4) {
        if (0 != 0) {
            throw new NullPointerException(A00(72, 18, AppLovinMediationAdapter.ERROR_CHILD_USER));
        }
        if (i4 == 0) {
    ...
    public static void A03(ViewParent viewParent, View view, int i4, int i10, int i11, int i12, int i13) {
        if (0 != 0) {
            throw new NullPointerException(A00(17, 14, 15));
        }
        if (i13 == 0) {
            A02.A03(viewParent, view, i4, i10, i11, i12);
        }
    }

    public static void A04(ViewParent viewParent, View view, int i4, int i10, int[] iArr, int i11) {
        if (0 != 0) {
            throw new NullPointerException(A00(0, 17, 84));
        }
        if (i11 == 0) {
            A02.A04(viewParent, view, i4, i10, iArr);
        }
    }

    public static void A05(ViewParent viewParent, View view, View view2, int i4, int i10) {
        if (0 != 0) {
        ...
        if (i10 == 0) {
            ...
            if (A01[1].length() != 12) {
                ...
                c0765Pw.A05(viewParent, view, view2, i4);
                return;
            }
            throw new RuntimeException();
        }
    ...
    public static boolean A07(ViewParent viewParent, View view, float f10, float f11, boolean z3) {
        return A02.A07(viewParent, view, f10, f11, z3);
    }

    public static boolean A08(ViewParent viewParent, View view, View view2, int i4, int i10) {
        if (0 != 0) {
            throw new NullPointerException(A00(53, 19, 16));
        }
        if (i10 == 0) {
            boolean zA08 = A02.A08(viewParent, view, view2, i4);
            if (A01[1].length() == 12) {
                throw new RuntimeException();
            }
