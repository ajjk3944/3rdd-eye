...
public enum EnumC0946Xc {
    ...
    EnumC0946Xc(int i4, NativeAdBase.NativeComponentTag nativeComponentTag) {
        this.A00 = i4;
        this.A01 = nativeComponentTag;
    }

    @Nullable
    public static EnumC0946Xc A00(NativeAdBase.NativeComponentTag nativeComponentTag) {
        for (EnumC0946Xc enumC0946Xc : values()) {
            if (enumC0946Xc.A01 == nativeComponentTag) {
                return enumC0946Xc;
            }
        }
        return null;
    ...
    public static void A03(@Nullable View view, NativeAdBase.NativeComponentTag nativeComponentTag) {
        EnumC0946Xc internalTag = A00(nativeComponentTag);
        if (view != null && internalTag != null) {
            view.setTag(A02, nativeComponentTag);
        }
    }

    public static void A04(@Nullable View view, @Nullable EnumC0946Xc enumC0946Xc) {
        if (view != null && enumC0946Xc != null) {
            view.setTag(A02, enumC0946Xc);
        }
    }
