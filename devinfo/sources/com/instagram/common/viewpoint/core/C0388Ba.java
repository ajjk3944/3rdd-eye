...
public final class C0388Ba {
    ...
    public static String A0N(int i4, int i10, int i11) {
  ...
  0x013c: PHI (r0v18 java.lang.String) = (r0v16 java.lang.String), (r0v22 java.lang.String) binds: [B:66:0x013a, B:63:0x012d] A[DONT_GENERATE, DONT_INLINE], TRY_ENTER, TryCatch #7 {Exception -> 0x01b2, blocks: (B:3:0x0014, B:5:0x002a, B:8:0x0035, B:11:0x0040, B:59:0x0101, B:71:0x0170, B:72:0x01aa, B:67:0x013c, B:69:0x0142), top: B:93:0x0014 }] */
    ...
    */
    public static java.util.ArrayList<com.instagram.common.viewpoint.core.B3> A0Q(com.instagram.common.viewpoint.core.BW r23, com.instagram.common.viewpoint.core.BY r24) throws java.lang.Exception {
        /*
            Method dump skipped, instructions count: 442
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C0388Ba.A0Q(com.facebook.ads.redexgen.X.BW, com.facebook.ads.redexgen.X.BY):java.util.ArrayList");
    }
    ...
    static {
        A0S();
        A04 = Pattern.compile(A0N(1409, 10, AppLovinMediationAdapter.ERROR_CHILD_USER));
        A03 = new HashMap<>();
        A00 = -1;
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public static android.util.Pair<java.lang.Integer, java.lang.Integer> A0B(com.instagram.common.viewpoint.core.C1996qI r8) throws java.lang.NumberFormatException {
        /*
            Method dump skipped, instructions count: 322
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C0388Ba.A0B(com.facebook.ads.redexgen.X.qI):android.util.Pair");
    }
    ...
    public static Pair<Integer, Integer> A0C(String str, String[] strArr) throws NumberFormatException {
        ...
        if (length != 3) {
            AbstractC02284g.A07(strA0N2, strA0N + str);
            return null;
        }
        try {
    ...
    public static Pair<Integer, Integer> A0D(String str, String[] strArr) throws NumberFormatException {
        ...
        int i10;
        int length = strArr.length;
        String strA0N = A0N(StatusLine.HTTP_TEMP_REDIRECT, 37, 34);
        String strA0N2 = A0N(615, 14, 80);
        if (length < 2) {
            AbstractC02284g.A07(strA0N2, strA0N + str);
            return null;
        ...
        try {
            ...
            int iA04 = A04(i4);
            if (iA04 == -1) {
                AbstractC02284g.A07(strA0N2, A0N(1212, 21, 74) + i4);
                return null;
            }
            int levelInteger = A02(i10);
            if (levelInteger == -1) {
                AbstractC02284g.A07(strA0N2, A0N(1193, 19, 34) + i10);
                return null;
            }
    ...
    public static Pair<Integer, Integer> A0E(String str, String[] strArr) {
        ...
        if (length < 3) {
            AbstractC02284g.A07(levelString, strA0N + str);
            return null;
        }
        ...
        if (profile == null) {
            AbstractC02284g.A07(levelString, A0N(1268, 37, 2) + strGroup);
            return null;
        }
        String str2 = strArr[2];
        Integer numA0K = A0K(str2);
        if (numA0K == null) {
            AbstractC02284g.A07(levelString, A0N(1233, 35, 47) + str2);
            return null;
        }
    ...
    public static Pair<Integer, Integer> A0F(String str, String[] strArr) throws NumberFormatException {
        ...
        try {
            ...
            int profile = A07(i4);
            if (profile == -1) {
                AbstractC02284g.A07(strA0N2, A0N(1380, 21, 57) + i4);
                return null;
            }
            int profileInteger = A06(i10);
            if (profileInteger == -1) {
                AbstractC02284g.A07(strA0N2, A0N(1361, 19, 65) + i10);
                return null;
            }
    ...
    */
    public static android.util.Pair<java.lang.Integer, java.lang.Integer> A0G(java.lang.String r8, java.lang.String[] r9, com.facebook.ads.androidx.media3.common.ColorInfo r10) throws java.lang.NumberFormatException {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C0388Ba.A0G(java.lang.String, java.lang.String[], com.facebook.ads.androidx.media3.common.ColorInfo):android.util.Pair");
    }
        ...
        if (A02[7].length() != 25) {
            ...
            if (A0N(77, 1, 121).equals(strGroup)) {
                ...
                if (colorInfo != null && colorInfo.A03 == 6) {
                    i4 = Buffer.SEGMENTING_THRESHOLD;
                } else {
                    i4 = 2;
                }
            } else {
                AbstractC02284g.A07(strA0N2, A0N(1332, 29, 106) + strGroup);
                return null;
            }
            String[] strArr3 = A02;
            if (strArr3[6].charAt(8) == strArr3[5].charAt(8)) {
                ...
                if (numA0M == null) {
                    AbstractC02284g.A07(strA0N2, A0N(1305, 27, 83) + profileString);
                    return null;
                }
                return new Pair<>(Integer.valueOf(i4), numA0M);
            }
        }
        throw new RuntimeException();
    }
    ...
    public static B3 A0J(String str, boolean z3, boolean z10) throws BX {
        List<B3> listA0R = A0R(str, z3, z10);
        if (listA0R.isEmpty()) {
            return null;
        }
    ...
    */
    public static java.lang.Integer A0K(java.lang.String r11) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C0388Ba.A0K(java.lang.String):java.lang.Integer");
    }
    ...
    */
    public static java.lang.Integer A0L(java.lang.String r8) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C0388Ba.A0L(java.lang.String):java.lang.Integer");
    }
    ...
    */
    public static java.lang.Integer A0M(java.lang.String r12) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C0388Ba.A0M(java.lang.String):java.lang.Integer");
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public static java.lang.String A0P(com.instagram.common.viewpoint.core.C1996qI r5) {
        /*
            ...
            java.lang.String[] r1 = com.instagram.common.viewpoint.core.C0388Ba.A02
            r0 = 7
            r0 = r1[r0]
            int r1 = r0.length()
            r0 = 25
            if (r1 == r0) goto Lb0
            java.lang.String[] r2 = com.instagram.common.viewpoint.core.C0388Ba.A02
        ...
        Lb0:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C0388Ba.A0P(com.facebook.ads.redexgen.X.qI):java.lang.String");
    }
    ...
    public static synchronized List<B3> A0R(String str, boolean z3, boolean z10) throws BX {
        BY c1863o8;
        BW bw = new BW(str, z3, z10);
        List<B3> list = A03.get(bw);
        if (list != null) {
            return list;
        }
        if (C5C.A02 >= 21) {
            c1863o8 = new C1862o7(z3, z10);
        } else {
            c1863o8 = new C1863o8();
        }
        ArrayList<B3> arrayListA0Q = A0Q(bw, c1863o8);
        if (z3 && arrayListA0Q.isEmpty() && 21 <= C5C.A02 && C5C.A02 <= 23) {
            arrayListA0Q = A0Q(bw, new C1863o8());
            if (!arrayListA0Q.isEmpty()) {
                AbstractC02284g.A07(A0N(615, 14, 80), A0N(564, 51, 61) + str + A0N(34, 12, 86) + arrayListA0Q.get(0).A03);
            }
        }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public static void A0T(java.lang.String r13, java.util.List<com.instagram.common.viewpoint.core.B3> r14) {
        /*
            Method dump skipped, instructions count: 275
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C0388Ba.A0T(java.lang.String, java.util.List):void");
    }
    ...
    public static <T> void A0U(List<T> list, final BZ<T> bz) {
        Collections.sort(list, new Comparator() { // from class: com.facebook.ads.redexgen.X.BU
            ...
            public final int compare(Object obj, Object obj2) {
                return C0388Ba.A0A(bz, obj, obj2);
            }
        });
    }
    ...
    public static boolean A0Z(MediaCodecInfo mediaCodecInfo) {
        ...
        String strA01 = AbstractC1631k7.A01(mediaCodecInfo.getName());
    ...
    /* JADX WARN: Code restructure failed: missing block: B:109:0x0335, code lost:
        ...
        if (A0N(1104, 5, 115).equals(com.instagram.common.viewpoint.core.C5C.A03) != false) goto L110;
     */
    ...
    */
    public static boolean A0d(android.media.MediaCodecInfo r8, java.lang.String r9, boolean r10, java.lang.String r11) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C0388Ba.A0d(android.media.MediaCodecInfo, java.lang.String, boolean, java.lang.String):boolean");
    }
}
