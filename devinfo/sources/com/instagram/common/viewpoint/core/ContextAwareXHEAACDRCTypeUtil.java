...
public final class ContextAwareXHEAACDRCTypeUtil {
    ...
    @JvmStatic
    public static final int A00(int i4, int i10, int i11) {
        if (A00.A01(i4) && !GlobalSystemVolumeHolder.A01.A00()) {
            return i4;
        }
        if (A02(i10, i11)) {
            return 1;
    ...
    private final boolean A01(int i4) {
        return -1 <= i4 && i4 < 7;
    }

    @JvmStatic
    public static final boolean A02(int i4, int i10) {
        int i11 = Calendar.getInstance().get(11);
        return i11 >= i4 || i11 <= i10;
    }
}
