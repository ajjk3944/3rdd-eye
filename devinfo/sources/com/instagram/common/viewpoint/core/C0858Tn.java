...
public final class C0858Tn {
    ...
    public static void A09(Context context) {
        ...
        ((ActivityManager) AbstractC1487hX.A00((ActivityManager) context.getSystemService(A01(16, 8, 108)))).getMemoryInfo(memoryInfo);
    ...
    public static void A0A(T8 t82) {
        try {
            ...
            String strA01 = z3 ? A01(1, 1, 69) : A01(0, 1, 82);
            ...
            t82.A08().ABC(A01(FacebookMediationAdapter.ERROR_BANNER_SIZE_MISMATCH, 7, 96), AbstractC0848Td.A1T, new C0849Te(e2));
        }
    }
    ...
    public static void A0C(Map<String, String> map) {
        ...
        if (fArr != null) {
            ...
            for (int i4 = 0; i4 < iMin; i4++) {
                map.put(A01(2, 14, 28) + A09[i4], String.valueOf(fArr[i4]));
            }
        }
        if (fArr2 != null) {
            int iMin2 = Math.min(A09.length, fArr2.length);
            for (int i10 = 0; i10 < iMin2; i10++) {
                map.put(A01(114, 9, 19) + A09[i10], String.valueOf(fArr2[i10]));
            }
        }
    }
}
