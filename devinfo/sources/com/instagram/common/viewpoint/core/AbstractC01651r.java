...
public abstract class AbstractC01651r<E> extends AbstractC0372Ai<E> implements List<E> {
    ...
    public static final C2020qk A02;
    ...
    public static String A06(int i4, int i10, int i11) {
        ...
        for (int i12 = 0; i12 < bArrCopyOfRange.length; i12++) {
            ...
            bArrCopyOfRange[i12] = (byte) (i13 - 84);
        }
    ...
    public int lastIndexOf(E element) {
        AbstractC01651r<E> abstractC01651r = this;
        ListIterator<E> listIterator = abstractC01651r.listIterator(abstractC01651r.size());
        while (listIterator.hasPrevious()) {
            if (C2010qY.A0C(listIterator.previous(), element)) {
    ...
    @Override // com.instagram.common.viewpoint.core.AbstractC0372Ai, java.util.Collection, java.lang.Iterable, java.util.List
    public Iterator<E> iterator() {
        return new C0371Ah(this);
    }

    @Override // java.util.List
    public ListIterator<E> listIterator() {
        return new C01661s(this, 0);
    }

    @Override // java.util.List
    public ListIterator<E> listIterator(int index) {
        return new C01661s(this, index);
    }
