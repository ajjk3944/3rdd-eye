...
public class PZ extends RelativeLayout implements InterfaceC0978Yi {
    ...
    public String A04;
    public boolean A05;
    public final InterfaceC0804Rk A06;
    public final LinearLayout A07;
    public final C0798Re A08;
    public final C1436gi A09;
    public final VA A0A;
    public final InterfaceC0977Yh A0B;
    public final C1065ah A0C;
    public final InterfaceC1074aq A0D;
    public final M3 A0E;
    public final InterfaceC1079av A0F;
    ...
    public PZ(C0798Re c0798Re, C1436gi c1436gi, VA va2, InterfaceC0977Yh interfaceC0977Yh, boolean z3) {
        M3 m32;
        super(c1436gi);
        this.A06 = new C0748Pc(this);
        this.A05 = true;
        this.A01 = -1L;
        this.A03 = true;
        this.A08 = c0798Re;
        ...
        this.A0D = A0F();
        if (AbstractC0887Uq.A02(c1436gi) || c1436gi.A0E() == null) {
            m32 = new M3(c1436gi, this.A0D);
        } else {
            m32 = new M3(c1436gi, c1436gi.A0E(), this.A0D);
        }
        this.A0E = m32;
        this.A0F = A0C(z3);
        this.A07 = (LinearLayout) this.A0F;
        this.A07.setId(View.generateViewId());
        this.A0F.setListener(new C0747Pb(this));
        this.A0E.setBrowserNavigationListener(this.A0F.getBrowserNavigationListener());
        this.A0C = new C1065ah(c1436gi, null, R.attr.progressBarStyleHorizontal);
        A0G();
        c0798Re.A0A(this.A06);
    }

    private InterfaceC1079av A0C(boolean z3) {
        if (z3) {
    ...
    public InterfaceC1074aq A0F() {
        return new C0746Pa(this);
    }
    ...
    public void AAu(Intent intent, Bundle bundle, C0798Re c0798Re) {
        if (this.A01 < 0) {
    ...
    public final void AFA(boolean z3) {
        ...
        if (this.A03) {
            this.A03 = false;
            C1068ak c1068akA07 = new C1067aj(this.A0E.getFirstUrl()).A01(this.A00).A03(this.A01).A04(this.A0E.getResponseEndMs()).A00(this.A0E.getDomContentLoadedMs()).A05(this.A0E.getScrollReadyMs()).A02(this.A0E.getLoadFinishMs()).A06(System.currentTimeMillis()).A07();
            this.A0A.AB5(this.A04, c1068akA07.A02());
            if (BuildConfigApi.isDebug()) {
                String str = A0D(169, 30, 15) + System.currentTimeMillis() + A0D(149, 20, 60) + c1068akA07.A01 + A0D(53, 22, 121) + c1068akA07.A03 + A0D(75, 24, 83) + c1068akA07.A04 + A0D(0, 30, 124) + c1068akA07.A00 + A0D(99, 24, 75) + c1068akA07.A05 + A0D(30, 23, 22) + c1068akA07.A02 + A0D(123, 26, AppLovinMediationAdapter.ERROR_MISSING_AD_UNIT_ID) + c1068akA07.A06;
            }
        }
    }
