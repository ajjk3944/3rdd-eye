...
public final class C0920Vz extends C0806Rm implements DefaultMediaViewVideoRendererApi {
    ...
    static {
        A0K();
        A0K = C0920Vz.class.getSimpleName();
    }
    ...
    private C1381fp A08() {
        return new C1381fp(this.A01, 50, true, new WeakReference(this.A0A), this.A04);
    }

    private void A0C() {
        if (this.A07 != null) {
            C02916r c02916r = this.A07;
            if (A0J[6].charAt(16) != 'd') {
                throw new RuntimeException();
            }
            A0J[5] = "Ntv0Vby76dSesAjQjgB6ptCIElpzOEzL";
            ((C1320eq) c02916r.getVideoView()).setViewImplInflationListener(this.A0F);
        }
    }
        ...
        if (this.A07 != null) {
            this.A07.getVideoView().setOnTouchListener(new View.OnTouchListener() { // from class: com.facebook.ads.redexgen.X.VQ
                ...
                public final boolean onTouch(View view, MotionEvent motionEvent) {
                    return C0920Vz.A0U(view, motionEvent);
                }
            });
        }
    }
    ...
    private void A0F() {
        if (this.A07 != null) {
            ((C1320eq) this.A07.getVideoView()).setViewImplInflationListener(null);
        }
    }
    ...
    public void A0G() {
        ...
        if (this.A09 != null) {
            if (this.A02 != null && this.A02.getHideMediaControls() != null && this.A02.getHideMediaControls().booleanValue() && !C0886Up.A1Z(this.A04)) {
    ...
    public void A0H() {
        ...
        if (!C0886Up.A1a(this.A04)) {
            InterfaceC0662Lt interfaceC0662LtA0F = this.A04.A0F();
            String[] strArr = A0J;
        ...
        if (this.A03 != null) {
            ...
            if (nativeOptions != null && this.A02.getUnMuteVolume() != null && this.A02.getUnMuteVolume().booleanValue() && !C0886Up.A1a(this.A04)) {
    ...
    private void A0I() {
        ...
        if (this.A07 != null) {
            EnumC1378fm state = this.A07.getState();
            String[] strArr = A0J;
            if (strArr[7].length() != strArr[1].length()) {
                throw new RuntimeException();
            }
            A0J[4] = "z79LrkWpr7afRwAllWq14kp6jWBswbkV";
            if (state == EnumC1378fm.A05) {
                this.A0E = true;
            }
        }
        this.A0B.A0V();
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void A0R(EnumC1323et enumC1323et) {
        if (this.A07 != null) {
            this.A07.A0e(enumC1323et, 24);
        } else {
    ...
    private boolean A0S() {
        ...
        if (!C0886Up.A1Y(this.A04)) {
            this.A04.A0F().ABf();
        }
        return (this.A02 == null || this.A02.getDisableFullScreen() == null || !this.A02.getDisableFullScreen().booleanValue() || C0886Up.A1Y(this.A04)) ? false : true;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public boolean A0T() {
        if (this.A07 == null || this.A07.getState() == EnumC1378fm.A06) {
            return false;
        }
        return this.A06 == EnumC0902Vf.A05 || this.A06 == EnumC0902Vf.A03;
    }
    ...
    public final void initialize(Context context, MediaViewVideoRenderer mediaViewVideoRenderer, MediaViewVideoRendererApi mediaViewVideoRendererApi, int i4) {
        VX vxA04;
        ((C0806Rm) mediaViewVideoRendererApi.getAdComponentViewApi()).A00(this);
        ...
        ((C0819Rz) mediaViewVideoRendererApi).A06(vxA04);
        this.A04 = C0809Rp.A03(context);
        ...
        int i10 = 0;
        while (true) {
            int i11 = this.A01.getChildCount();
            if (A0J[2].length() == 26) {
                throw new RuntimeException();
            }
            ...
            if (i10 < i11) {
                ...
                if (childAt instanceof C02916r) {
                    this.A07 = (C02916r) childAt;
                } else {
                    i10++;
                }
            }
    ...
    public final void onPrepared() {
        boolean zA0s = C0886Up.A0s(this.A04);
        boolean zA0S = A0S();
