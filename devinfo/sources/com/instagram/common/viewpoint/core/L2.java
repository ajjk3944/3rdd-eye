...
public final class L2 {
    ...
    public boolean A09;
    public boolean A0A;
    public final InterfaceC0543Hd A0F;
  ...
  0x021e: PHI (r20v2 int) = (r20v0 int), (r20v0 int), (r20v1 int), (r20v1 int), (r20v0 int), (r20v0 int) binds: [B:92:0x01fa, B:94:0x01fe, B:99:0x0211, B:100:0x0213, B:82:0x01c6, B:83:0x01c8] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    public final void A05(byte[] r23, int r24, int r25) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.L2.A05(byte[], int, int):void");
    }

    public L2(InterfaceC0543Hd interfaceC0543Hd, boolean z3, boolean z10) {
        this.A0F = interfaceC0543Hd;
        this.A0G = z3;
        this.A0H = z10;
        A01();
    }
    ...
    private void A00(int i4) {
        ...
        boolean z3 = this.A0A;
        this.A0F.AIu(this.A05, z3 ? 1 : 0, (int) (this.A02 - this.A04), i4, null);
    }
    ...
    public final void A02(long j, int i4, long j8) {
        this.A01 = i4;
        this.A03 = j8;
        this.A02 = j;
    ...
    public final boolean A07(long j, int i4, boolean z3, boolean z10) {
        boolean z11 = false;
        if (this.A01 == 9 || (this.A0H && this.A07.A00(this.A06))) {
            if (z3 && this.A09) {
                A00(i4 + ((int) (j - this.A02)));
            }
            this.A04 = this.A02;
            this.A05 = this.A03;
            this.A0A = false;
