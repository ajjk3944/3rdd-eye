...
public class C0875Ue {
     ...
     */
    public static C0875Ue A04(File file) throws IOException {
        try {
            ...
            long j8 = randomAccessFile.readLong();
            ...
            if (j8 < 0 || j8 > 100000) {
                throw new IOException(String.format(Locale.US, A05(77, 40, 27), Long.valueOf(j8)));
            }
            if (randomAccessFile.length() < A02((int) j8)) {
                throw new IOException(String.format(Locale.US, A05(117, 63, 56), Long.valueOf(j8), Long.valueOf(file.length())));
            }
            long[] jArr = new long[(int) j8];
            for (int i4 = 0; i4 < jArr.length; i4++) {
                jArr[i4] = randomAccessFile.readLong();
            }
            return new C0875Ue(randomAccessFile, jArr, randomAccessFile.length());
    ...
    public C0875Ue(RandomAccessFile randomAccessFile, long[] jArr, long j) throws IOException {
    ...
    public static long A02(int i4) {
        return A00() + (i4 * 8);
    }

    public static C0875Ue A03(File file) throws IOException {
        RandomAccessFile randomAccessFile = new RandomAccessFile(file, A05(TTAdConstant.PACKAGE_NAME_CODE, 3, 33));
        try {
            randomAccessFile.writeLong(-360011992771067903L);
            randomAccessFile.writeLong(C0876Uf.A03);
            randomAccessFile.write(new byte[C0876Uf.A03 * 8]);
            randomAccessFile.getFD().sync();
            return new C0875Ue(randomAccessFile, new long[C0876Uf.A03], randomAccessFile.length());
        } catch (IOException unused) {
