...
public final class C1766mM implements InterfaceC0577Il {
    ...
    public int A01;
    public long A02;
    public InterfaceC0576Ik A03;
    public final byte[] A06 = new byte[8];
    public final ArrayDeque<C0574Ii> A05 = new ArrayDeque<>();
    public final C0582Iq A04 = new C0582Iq();
    ...
    private double A00(InterfaceC1787ms interfaceC1787ms, int i4) throws IOException {
        long jA02 = A02(interfaceC1787ms, i4);
        if (i4 == 4) {
    ...
    private long A01(InterfaceC1787ms interfaceC1787ms) throws IOException {
        interfaceC1787ms.AIl();
        while (true) {
            interfaceC1787ms.AGt(this.A06, 0, 4);
            int iA00 = C0582Iq.A00(this.A06[0]);
            if (iA00 != -1 && iA00 <= 4) {
                int iA01 = (int) C0582Iq.A01(this.A06, iA00, false);
                if (this.A03.AAW(iA01)) {
                    interfaceC1787ms.AK3(iA00);
                    return iA01;
                }
            }
    ...
    private long A02(InterfaceC1787ms interfaceC1787ms, int i4) throws IOException {
        interfaceC1787ms.readFully(this.A06, 0, i4);
        long j = 0;
    ...
    public static String A04(InterfaceC1787ms interfaceC1787ms, int i4) throws IOException {
        if (i4 == 0) {
            return A03(0, 0, 32);
        }
        byte[] bArr = new byte[i4];
        interfaceC1787ms.readFully(bArr, 0, i4);
    ...
    @Override // com.instagram.common.viewpoint.core.InterfaceC0577Il
    public final void AAD(InterfaceC0576Ik interfaceC0576Ik) {
        this.A03 = interfaceC0576Ik;
    }
    ...
    */
    public final boolean AHO(com.instagram.common.viewpoint.core.InterfaceC1787ms r13) throws java.io.IOException {
        /*
            Method dump skipped, instructions count: 454
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.instagram.common.viewpoint.core.C1766mM.AHO(com.facebook.ads.redexgen.X.ms):boolean");
    }
