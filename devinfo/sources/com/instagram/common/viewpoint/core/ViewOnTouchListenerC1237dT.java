...
public class ViewOnTouchListenerC1237dT implements View.OnTouchListener {
    ...
    public ViewOnTouchListenerC1237dT(C5F c5f) {
        this.A00 = c5f;
    }
    ...
    public final boolean onTouch(View view, MotionEvent motionEvent) {
        switch (motionEvent.getActionMasked()) {
            ...
            case 1:
                C5F.A07(this.A00);
                boolean z3 = this.A00.A0N;
                if (A02[2].charAt(15) != 'o') {
                    String[] strArr2 = A02;
                    strArr2[0] = "JX78O96";
                    strArr2[7] = "bIdbL9K";
                    if (!z3 && this.A00.A07 >= 5) {
                        this.A00.A0N = true;
                        this.A00.A0i(A00(0, 14, WebSocketProtocol.PAYLOAD_SHORT));
                        return false;
                    }
                    return false;
                }
