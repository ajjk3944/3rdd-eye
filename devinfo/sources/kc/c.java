...
public abstract class c extends e {
    ...
    public VelocityTracker f28133i;

    public final void A(CoordinatorLayout coordinatorLayout, View view, int i4) {
        z(coordinatorLayout, view, i4, LinearLayoutManager.INVALID_OFFSET, Integer.MAX_VALUE);
    }
    ...
    */
    public final boolean k(androidx.coordinatorlayout.widget.CoordinatorLayout r8, android.view.View r9, android.view.MotionEvent r10) {
        ...
        L42:
            ...
            java.lang.ref.WeakReference r5 = r5.f20312n
            if (r5 == 0) goto L72
        ...
        L7b:
            ...
            r7.f28131f = r8
            android.view.VelocityTracker r8 = r7.f28133i
            if (r8 != 0) goto L91
            android.view.VelocityTracker r8 = android.view.VelocityTracker.obtain()
            r7.f28133i = r8
        L91:
            android.widget.OverScroller r8 = r7.f28129d
            if (r8 == 0) goto La1
        ...
        La8:
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: kc.c.k(androidx.coordinatorlayout.widget.CoordinatorLayout, android.view.View, android.view.MotionEvent):boolean");
    }
    ...
    */
    public final boolean v(androidx.coordinatorlayout.widget.CoordinatorLayout r21, android.view.View r22, android.view.MotionEvent r23) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: kc.c.v(androidx.coordinatorlayout.widget.CoordinatorLayout, android.view.View, android.view.MotionEvent):boolean");
    }

    public abstract int y();

    public abstract int z(CoordinatorLayout coordinatorLayout, View view, int i4, int i10, int i11);
}
