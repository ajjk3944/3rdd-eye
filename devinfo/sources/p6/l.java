...
public abstract class l {
    ...
    public static final b f31387a;

    /* renamed from: b, reason: collision with root package name */
    public static final b f31388b;

    /* renamed from: c, reason: collision with root package name */
    public static final b f31389c;

    /* renamed from: d, reason: collision with root package name */
    public static final b f31390d;

    /* renamed from: e, reason: collision with root package name */
    public static final b f31391e;

    /* renamed from: f, reason: collision with root package name */
    public static final b f31392f;
    public static final k g;

    /* renamed from: h, reason: collision with root package name */
    public static final b f31393h;
    ...
    static {
        ...
        f31387a = new b("WEB_MESSAGE_ARRAY_BUFFER", "WEB_MESSAGE_ARRAY_BUFFER", 2);
        ...
        f31388b = new b("GET_WEB_VIEW_CLIENT", "GET_WEB_VIEW_CLIENT", 3);
        ...
        f31389c = new b("MULTI_PROCESS", "MULTI_PROCESS_QUERY", 2);
        new b("FORCE_DARK", "FORCE_DARK", 6);
        new b("FORCE_DARK_STRATEGY", "FORCE_DARK_BEHAVIOR", 2);
        f31390d = new b("WEB_MESSAGE_LISTENER", "WEB_MESSAGE_LISTENER", 2);
        f31391e = new b("DOCUMENT_START_SCRIPT", "DOCUMENT_START_SCRIPT:1", 2);
        new b("PROXY_OVERRIDE_REVERSE_BYPASS", "PROXY_OVERRIDE_REVERSE_BYPASS", 2);
        f31392f = new b("GET_VARIATIONS_HEADER", "GET_VARIATIONS_HEADER", 2);
        ...
        g = new k("MULTI_PROFILE", "MULTI_PROFILE", 2);
        ...
        f31393h = new b("MUTE_AUDIO", "MUTE_AUDIO", 2);
