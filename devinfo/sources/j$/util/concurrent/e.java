...
public final class e extends b implements Set, j$.util.Set {
    ...
    public final boolean add(Object obj) {
        ...
        return this.f26316a.f(entry.getKey(), entry.getValue(), false) == null;
    }
    ...
    public final boolean contains(Object obj) {
        ...
        Object obj2;
        Object value;
        if (!(obj instanceof Map.Entry) || (key = (entry = (Map.Entry) obj).getKey()) == null || (obj2 = this.f26316a.get(key)) == null || (value = entry.getValue()) == null) {
            return false;
        }
    ...
    public final boolean remove(Object obj) {
        ...
        Object key;
        Object value;
        return (obj instanceof Map.Entry) && (key = (entry = (Map.Entry) obj).getKey()) != null && (value = entry.getValue()) != null && this.f26316a.remove(key, value);
    }

    @Override // j$.util.concurrent.b, java.util.Collection, java.lang.Iterable
    public final Iterator iterator() {
        ConcurrentHashMap concurrentHashMap = this.f26316a;
        l[] lVarArr = concurrentHashMap.f26303a;
    ...
    public final boolean addAll(java.util.Collection collection) {
        ...
        while (it.hasNext()) {
            ...
            if (this.f26316a.f(entry.getKey(), entry.getValue(), false) == null) {
                z3 = true;
            }
        }
        return z3;
    ...
    public final void forEach(Consumer consumer) {
        ...
        while (true) {
            ...
            if (lVarA == null) {
                ...
                consumer.n(new k(lVarA.f26325b, lVarA.f26326c, this.f26316a));
            }
        }
    }
}
