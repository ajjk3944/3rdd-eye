...
public abstract class a {
    ...
    public static final ThreadLocal f35791a = new ThreadLocal();
    ...
    public static int b(int i4, int i10) {
        ...
        return Color.argb(i11, c(Color.red(i4), iAlpha2, Color.red(i10), iAlpha, i11), c(Color.green(i4), iAlpha2, Color.green(i10), iAlpha, i11), c(Color.blue(i4), iAlpha2, Color.blue(i10), iAlpha, i11));
    }

    public static int c(int i4, int i10, int i11, int i12, int i13) {
        if (i13 == 0) {
            return 0;
        }
        return (((255 - i10) * (i11 * i12)) + ((i4 * 255) * i10)) / (i13 * 255);
    }
