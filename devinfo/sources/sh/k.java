...
public final class k implements e4.s {
    ...
    public /* synthetic */ k(int i4, View view) {
        this.f33700a = i4;
        this.f33701b = view;
    }
    ...
    public final c2 j(View view, c2 c2Var) throws Resources.NotFoundException {
        switch (this.f33700a) {
            case 0:
                ...
                this.f33701b.setPadding(bVarX.f35793a, 0, bVarX.f35795c, bVarX.f35796d);
                break;
            case 1:
                v3.b bVarX2 = nh.a.x(c2Var);
                int dimensionPixelSize = view.getResources().getDimensionPixelSize(R.dimen.toolbar_height);
                this.f33701b.setPadding(bVarX2.f35793a, dimensionPixelSize + bVarX2.f35794b, bVarX2.f35795c, bVarX2.f35796d);
                break;
            case 2:
                v3.b bVarX3 = nh.a.x(c2Var);
                int dimensionPixelSize2 = view.getResources().getDimensionPixelSize(R.dimen.toolbar_height);
                this.f33701b.setPadding(bVarX3.f35793a, dimensionPixelSize2 + bVarX3.f35794b, bVarX3.f35795c, bVarX3.f35796d);
                break;
            default:
                v3.b bVarX4 = nh.a.x(c2Var);
                int dimensionPixelSize3 = view.getResources().getDimensionPixelSize(R.dimen.toolbar_height);
                this.f33701b.setPadding(bVarX4.f35793a, dimensionPixelSize3 + bVarX4.f35794b, bVarX4.f35795c, bVarX4.f35796d);
                break;
        }
