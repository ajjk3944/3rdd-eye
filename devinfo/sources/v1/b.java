...
public abstract class b {
    ...
    public static final void a(c cVar, f0 f0Var) {
        ...
        for (int i4 = 0; i4 < size; i4++) {
            ...
            if (h0Var instanceof j0) {
                g gVar = new g();
                j0 j0Var = (j0) h0Var;
                gVar.f35678d = j0Var.f35712b;
                gVar.f35686n = true;
                gVar.c();
                gVar.f35691s.f30986a.setFillType(j0Var.f35713c == 1 ? Path.FillType.EVEN_ODD : Path.FillType.WINDING);
                gVar.c();
                gVar.c();
                gVar.f35676b = j0Var.f35714d;
                gVar.c();
                gVar.f35677c = j0Var.f35715e;
                gVar.c();
                gVar.g = j0Var.f35716f;
                gVar.c();
                gVar.f35679e = j0Var.g;
                gVar.c();
                gVar.f35680f = j0Var.f35717h;
                gVar.f35687o = true;
                gVar.c();
                gVar.f35681h = j0Var.f35718i;
                gVar.f35687o = true;
                gVar.c();
                gVar.f35682i = j0Var.j;
                gVar.f35687o = true;
                gVar.c();
                gVar.j = j0Var.f35719k;
                gVar.f35687o = true;
                gVar.c();
                gVar.f35683k = j0Var.f35720l;
                gVar.f35688p = true;
                gVar.c();
                gVar.f35684l = j0Var.f35721m;
                gVar.f35688p = true;
                gVar.c();
                gVar.f35685m = j0Var.f35722n;
                gVar.f35688p = true;
                gVar.c();
                cVar.e(i4, gVar);
                ...
                c cVar2 = new c();
                f0 f0Var2 = (f0) h0Var;
                cVar2.f35624k = f0Var2.f35668a;
                cVar2.c();
                cVar2.f35625l = f0Var2.f35669b;
                cVar2.f35632s = true;
                cVar2.c();
                cVar2.f35628o = f0Var2.f35672e;
                cVar2.f35632s = true;
                cVar2.c();
                cVar2.f35629p = f0Var2.f35673f;
                cVar2.f35632s = true;
                cVar2.c();
                cVar2.f35630q = f0Var2.g;
                cVar2.f35632s = true;
                cVar2.c();
                cVar2.f35631r = f0Var2.f35674h;
                cVar2.f35632s = true;
                cVar2.c();
                cVar2.f35626m = f0Var2.f35670c;
                cVar2.f35632s = true;
                cVar2.c();
                cVar2.f35627n = f0Var2.f35671d;
                cVar2.f35632s = true;
                cVar2.c();
                cVar2.f35621f = f0Var2.f35675i;
                cVar2.g = true;
                cVar2.c();
                a(cVar2, f0Var2);
                cVar.e(i4, cVar2);
    ...
    public static final void b(p1.j jVar, double d10, double d11, double d12, double d13, double d14, double d15, double d16, boolean z3, boolean z10) {
        double d17;
        double d18;
        double d19 = d14;
        ...
        if (d31 < 0.0d) {
            ...
            b(jVar, d10, d11, d12, d13, d19 * dSqrt, d15 * dSqrt, d16, z3, z10);
            return;
        }
        ...
        while (i4 < iCeil) {
            ...
            jVar.f30986a.cubicTo((float) ((d49 * dSqrt3) + d50), (float) ((d51 * dSqrt3) + d52), (float) (d54 - (dSqrt3 * d56)), (float) (d55 - (dSqrt3 * d57)), (float) d54, (float) d55);
            dSin2 = dSin2;
            d50 = d54;
            i4 = i10 + 1;
            d36 = d36;
    ...
    */
    public static final long c(int r32, int r33, java.lang.String r34) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: v1.b.c(int, int, java.lang.String):long");
    }

    public static final void d(List list, p1.j jVar) {
        Path path;
        int i4;
        float f10;
        int i10;
        ...
        float f18;
        List list2 = list;
        Path path2 = jVar.f30986a;
        Path path3 = jVar.f30986a;
        ...
        a0 a0Var2 = list2.isEmpty() ? i.f35701c : (a0) list2.get(0);
        int size = list2.size();
        float f19 = 0.0f;
        int i11 = 0;
        float f20 = 0.0f;
        ...
        float f25 = 0.0f;
        while (i11 < size) {
            a0 a0Var3 = (a0) list2.get(i11);
            if (a0Var3 instanceof i) {
                path3.close();
                path = path3;
                i4 = size;
                f10 = f19;
                ...
                if (a0Var3 instanceof u) {
                    u uVar = (u) a0Var3;
                    float f26 = uVar.f35752c;
                    f22 += f26;
                    float f27 = uVar.f35753d;
                    f23 += f27;
                    ...
                    if (a0Var3 instanceof m) {
                        m mVar = (m) a0Var3;
                        float f28 = mVar.f35726c;
                        float f29 = mVar.f35727d;
                        ...
                        if (a0Var3 instanceof t) {
                            t tVar = (t) a0Var3;
                            float f30 = tVar.f35751d;
                            float f31 = tVar.f35750c;
                            path3.rLineTo(f31, f30);
                            f22 += f31;
                            f23 += f30;
                        } else if (a0Var3 instanceof l) {
                            l lVar = (l) a0Var3;
                            float f32 = lVar.f35725d;
                            float f33 = lVar.f35724c;
                            path3.lineTo(f33, f32);
                            f22 = f33;
                            path = path3;
                            f23 = f32;
                        } else if (a0Var3 instanceof s) {
                            float f34 = ((s) a0Var3).f35749c;
                            path3.rLineTo(f34, f19);
                            f22 += f34;
                        } else if (a0Var3 instanceof k) {
                            float f35 = ((k) a0Var3).f35723c;
                            path3.lineTo(f35, f23);
                            f22 = f35;
                        } else {
                            if (a0Var3 instanceof y) {
                                f18 = ((y) a0Var3).f35764c;
                                path3.rLineTo(f19, f18);
                            } else if (a0Var3 instanceof z) {
                                float f36 = ((z) a0Var3).f35765c;
                                path3.lineTo(f22, f36);
                                f23 = f36;
                            } else if (a0Var3 instanceof r) {
                                r rVar = (r) a0Var3;
                                path3.rCubicTo(rVar.f35744c, rVar.f35745d, rVar.f35746e, rVar.f35747f, rVar.g, rVar.f35748h);
                                f20 = rVar.f35746e + f22;
                                f21 = rVar.f35747f + f23;
                                f22 += rVar.g;
                                f18 = rVar.f35748h;
                            } else {
                                if (a0Var3 instanceof j) {
                                    j jVar2 = (j) a0Var3;
                                    path3.cubicTo(jVar2.f35706c, jVar2.f35707d, jVar2.f35708e, jVar2.f35709f, jVar2.g, jVar2.f35710h);
                                    f20 = jVar2.f35708e;
                                    f21 = jVar2.f35709f;
                                    f14 = jVar2.g;
                                    f15 = jVar2.f35710h;
                                } else if (a0Var3 instanceof w) {
                                    if (a0Var2.f35612a) {
                                        f17 = f23 - f21;
                                        f16 = f22 - f20;
                                    } else {
                                    ...
                                    w wVar = (w) a0Var3;
                                    path3.rCubicTo(f16, f17, wVar.f35758c, wVar.f35759d, wVar.f35760e, wVar.f35761f);
                                    f20 = wVar.f35758c + f22;
                                    f21 = wVar.f35759d + f23;
                                    f22 += wVar.f35760e;
                                    f18 = wVar.f35761f;
                                } else if (a0Var3 instanceof o) {
                                    if (a0Var2.f35612a) {
                                        float f37 = 2;
                                        f22 = (f22 * f37) - f20;
                                        f23 = (f37 * f23) - f21;
                                    ...
                                    o oVar = (o) a0Var3;
                                    path3.cubicTo(f22, f23, oVar.f35732c, oVar.f35733d, oVar.f35734e, oVar.f35735f);
                                    f20 = oVar.f35732c;
                                    f21 = oVar.f35733d;
                                    f14 = oVar.f35734e;
                                    f15 = oVar.f35735f;
                                } else if (a0Var3 instanceof v) {
                                    v vVar = (v) a0Var3;
                                    float f38 = vVar.f35757f;
                                    float f39 = vVar.f35756e;
                                    float f40 = vVar.f35755d;
                                    float f41 = vVar.f35754c;
                                    ...
                                    if (a0Var3 instanceof n) {
                                        n nVar = (n) a0Var3;
                                        float f44 = nVar.f35731f;
                                        float f45 = nVar.f35730e;
                                        float f46 = nVar.f35729d;
                                        f13 = nVar.f35728c;
                                        ...
                                        x xVar = (x) a0Var3;
                                        float f47 = xVar.f35763d;
                                        float f48 = xVar.f35762c;
                                        ...
                                        p pVar = (p) a0Var3;
                                        float f51 = pVar.f35737d;
                                        float f52 = pVar.f35736c;
                                        ...
                                        f20 = f22;
                                        f22 = f52;
                                    } else if (a0Var3 instanceof q) {
                                        q qVar = (q) a0Var3;
                                        float f53 = qVar.f35742h + f22;
                                        float f54 = qVar.f35743i + f23;
                                        i4 = size;
                                        f10 = 0.0f;
                                        path = path3;
                                        i10 = i11;
                                        b(jVar, f22, f23, f53, f54, qVar.f35738c, qVar.f35739d, qVar.f35740e, qVar.f35741f, qVar.g);
                                        f20 = f53;
                                        f22 = f20;
                                        f21 = f54;
                                        f23 = f21;
                                        ...
                                        h hVar = (h) a0Var3;
                                        float f55 = hVar.f35700i;
                                        float f56 = hVar.f35699h;
                                        a0Var = a0Var3;
                                        b(jVar, f22, f23, f56, f55, hVar.f35695c, hVar.f35696d, hVar.f35697e, hVar.f35698f, hVar.g);
                                        f21 = f55;
                                        f23 = f21;
                                        f20 = f56;
                                        f22 = f20;
