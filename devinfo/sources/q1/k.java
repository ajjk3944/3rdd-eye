...
public final class k extends c {
    ...
    public /* synthetic */ k(int i4, long j, int i10, String str) {
        super(i4, j, str);
        this.f32111d = i10;
    }
    ...
    public final float e(float f10, float f11, float f12) {
        switch (this.f32111d) {
            case 0:
                ...
                return (f13 > 0.20689656f ? f13 * f13 * f13 : 0.12841855f * (f13 - 0.13793103f)) * j.f32110e[2];
            default:
                if (f12 < -2.0f) {
                    f12 = -2.0f;
                }
    ...
    public final long f(float f10, float f11, float f12, float f13, c cVar) {
        switch (this.f32111d) {
            case 0:
                ...
                return z.a(f17, f18, fCbrt3 <= 128.0f ? fCbrt3 : 128.0f, f13, cVar);
            default:
                if (f10 < -2.0f) {
                    f10 = -2.0f;
                }
                ...
                return z.a(f10, f11, f12 <= 2.0f ? f12 : 2.0f, f13, cVar);
        }
    }
}
