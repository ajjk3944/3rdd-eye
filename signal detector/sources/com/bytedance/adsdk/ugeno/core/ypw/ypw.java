...
public class ypw implements zz.emc {
    ...
    public void emc() {
        ...
        try {
            int i = Integer.parseInt(com.bytedance.adsdk.ugeno.xq.ypw.emc(szVar.xq().optString("delay"), this.bw.sup()));
            this.emc = i;
            this.ycc.sendEmptyMessageDelayed(BackupConstant.SCENE_RENDER_FAIL, i);
    ...
    public void emc(Message message) {
        ...
        if (TextUtils.equals(jSONObjectXq.optString("type"), "onAnimation")) {
        ...
        this.ycc.removeMessages(BackupConstant.SCENE_RENDER_FAIL);
    }
}
