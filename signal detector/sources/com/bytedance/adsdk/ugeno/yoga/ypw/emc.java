...
public class emc extends com.bytedance.adsdk.ugeno.ypw.emc<xq> {
    ...
    public static class C0016emc extends emc.C0017emc {
        public int cuf;
        public int db;
        public int dr;
        public int iyl;
        ...
        public C0016emc(com.bytedance.adsdk.ugeno.ypw.emc emcVar) {
            super(emcVar);
            this.db = 1;
            this.sb = 0.0f;
            this.sf = 1.0f;
        ...
        public boolean xq() {
            float f2 = this.emc;
            if (f2 == -1.0f && this.ypw == -1.0f) {
                return false;
            }
            return f2 == -2.0f || this.ypw == -2.0f;
        }
    ...
    public void sf() {
        ...
        if (this.wo) {
            com.bytedance.adsdk.ugeno.bw.emc().ypw().emc(this.zz, this.tp, new emc.InterfaceC0009emc() { // from class: com.bytedance.adsdk.ugeno.yoga.ypw.emc.1
        ...
        com.bytedance.adsdk.ugeno.bw.emc().ypw().emc(this.zz, this.tp, emcVar, this.bw.getWidth(), this.bw.getHeight(), new emc.InterfaceC0009emc() { // from class: com.bytedance.adsdk.ugeno.yoga.ypw.emc.2
            @Override // com.bytedance.adsdk.ugeno.emc.InterfaceC0009emc
            public void emc(Bitmap bitmap) {
                if (bitmap == null) {
                    if (((com.bytedance.adsdk.ugeno.ypw.xq) emc.this).xxs != null) {
        ...
        T t6 = this.bw;
        if (t6 instanceof xq) {
            ((xq) t6).addView(emcVar, 0, emcVar2);
            emc(emcVar);
        }
    }
