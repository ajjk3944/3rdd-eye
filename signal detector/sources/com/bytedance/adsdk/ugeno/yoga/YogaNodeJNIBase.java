...
public abstract class YogaNodeJNIBase extends ru implements Cloneable {
    ...
    private final long replaceChild(YogaNodeJNIBase yogaNodeJNIBase, int i) {
        ...
        list.remove(i);
        this.xq.add(i, yogaNodeJNIBase);
        yogaNodeJNIBase.ypw = this;
        return yogaNodeJNIBase.emc;
    }

    @com.bytedance.adsdk.ugeno.yoga.emc.emc
    public final float baseline(float f2, float f5) {
        return this.bw.emc(this, f2, f5);
    }

    @Override // com.bytedance.adsdk.ugeno.yoga.ru
    public void bw(float f2) {
        YogaNative.jni_YGNodeStyleSetWidthPercentJNI(this.emc, f2);
    }

    @Override // com.bytedance.adsdk.ugeno.yoga.ru
    /* renamed from: dg, reason: merged with bridge method [inline-methods] */
    public YogaNodeJNIBase ypw(int i) {
        List<YogaNodeJNIBase> list = this.xq;
        if (list == null) {
    ...
    @com.bytedance.adsdk.ugeno.yoga.emc.emc
    public final long measure(float f2, int i, float f5, int i3) {
        if (sup()) {
            return this.dg.emc(this, f2, msw.emc(i), f5, msw.emc(i3));
        }
    ...
    public void msw(float f2) {
        YogaNative.jni_YGNodeStyleSetMinWidthJNI(this.emc, f2);
    }

    @Override // com.bytedance.adsdk.ugeno.yoga.ru
    public void ru(float f2) {
        YogaNative.jni_YGNodeStyleSetMaxWidthJNI(this.emc, f2);
    }

    @Override // com.bytedance.adsdk.ugeno.yoga.ru
    public void sup(float f2) {
        YogaNative.jni_YGNodeStyleSetAspectRatioJNI(this.emc, f2);
    }

    @Override // com.bytedance.adsdk.ugeno.yoga.ru
    public void uym(float f2) {
        YogaNative.jni_YGNodeStyleSetHeightPercentJNI(this.emc, f2);
    }

    @Override // com.bytedance.adsdk.ugeno.yoga.ru
    /* renamed from: xq, reason: merged with bridge method [inline-methods] */
    public YogaNodeJNIBase emc(int i) {
        List<YogaNodeJNIBase> list = this.xq;
        if (list != null) {
            return list.get(i);
        }
    ...
    public void ycc(float f2) {
        YogaNative.jni_YGNodeStyleSetHeightJNI(this.emc, f2);
    }

    @Override // com.bytedance.adsdk.ugeno.yoga.ru
    public void zz(float f2) {
        YogaNative.jni_YGNodeStyleSetMinHeightJNI(this.emc, f2);
    }
    ...
    public void gbl(float f2) {
        YogaNative.jni_YGNodeStyleSetMaxHeightJNI(this.emc, f2);
    }
    ...
    @Override // com.bytedance.adsdk.ugeno.yoga.ru
    public void emc(ru ruVar, int i) {
        if (ruVar instanceof YogaNodeJNIBase) {
            ...
            if (yogaNodeJNIBase.ypw == null) {
                ...
                this.xq.add(i, yogaNodeJNIBase);
                yogaNodeJNIBase.ypw = this;
                YogaNative.jni_YGNodeInsertChildJNI(this.emc, yogaNodeJNIBase.emc, i);
                return;
            }
    ...
    public void xq(float f2) {
        YogaNative.jni_YGNodeStyleSetFlexBasisJNI(this.emc, f2);
    }

    @Override // com.bytedance.adsdk.ugeno.yoga.ru
    public void ypw(float f2) {
        YogaNative.jni_YGNodeStyleSetFlexShrinkJNI(this.emc, f2);
    }

    @Override // com.bytedance.adsdk.ugeno.yoga.ru
    public void dg(float f2) {
        YogaNative.jni_YGNodeStyleSetWidthJNI(this.emc, f2);
    }
    ...
    @Override // com.bytedance.adsdk.ugeno.yoga.ru
    public void ypw(dg dgVar, float f2) {
        YogaNative.jni_YGNodeStyleSetPaddingJNI(this.emc, dgVar.emc(), f2);
    }
    ...
    @Override // com.bytedance.adsdk.ugeno.yoga.ru
    public void xq(dg dgVar, float f2) {
        YogaNative.jni_YGNodeStyleSetPositionJNI(this.emc, dgVar.emc(), f2);
    }
    ...
    public void emc(float f2, float f5) {
        ...
        for (int i3 = 0; i3 < yogaNodeJNIBaseArr.length; i3++) {
            jArr[i3] = yogaNodeJNIBaseArr[i3].emc;
        }
        YogaNative.jni_YGNodeCalculateLayoutJNI(this.emc, f2, f5, jArr, yogaNodeJNIBaseArr);
    }
    ...
    public void emc(float f2) {
        YogaNative.jni_YGNodeStyleSetFlexGrowJNI(this.emc, f2);
    }

    @Override // com.bytedance.adsdk.ugeno.yoga.ru
    public void emc(dg dgVar, float f2) {
        YogaNative.jni_YGNodeStyleSetMarginJNI(this.emc, dgVar.emc(), f2);
    }
    ...
    public void emc(boolean z6) {
        YogaNative.jni_YGNodeSetAlwaysFormsContainingBlockJNI(this.emc, z6);
    }
