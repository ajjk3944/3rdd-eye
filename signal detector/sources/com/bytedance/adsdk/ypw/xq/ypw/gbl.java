...
public class gbl implements xq {
    ...
    public gbl(String str, com.bytedance.adsdk.ypw.xq.emc.sz<PointF, PointF> szVar, com.bytedance.adsdk.ypw.xq.emc.sz<PointF, PointF> szVar2, com.bytedance.adsdk.ypw.xq.emc.ypw ypwVar, boolean z6) {
        this.emc = str;
        this.ypw = szVar;
        this.xq = szVar2;
        this.dg = ypwVar;
