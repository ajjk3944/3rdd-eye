...
public class qh {
    ...
    public qh(PointF pointF, boolean z6, List<com.bytedance.adsdk.ypw.xq.emc> list) {
        this.ypw = pointF;
        this.xq = z6;
    ...
    public void emc(qh qhVar, qh qhVar2, float f2) {
        if (this.ypw == null) {
            this.ypw = new PointF();
        }
        ...
        emc(com.bytedance.adsdk.ypw.ycc.bw.emc(pointFEmc.x, pointFEmc2.x, f2), com.bytedance.adsdk.ypw.ycc.bw.emc(pointFEmc.y, pointFEmc2.y, f2));
        for (int size3 = this.emc.size() - 1; size3 >= 0; size3--) {
            ...
            this.emc.get(size3).emc(com.bytedance.adsdk.ypw.ycc.bw.emc(pointFEmc3.x, pointFEmc4.x, f2), com.bytedance.adsdk.ypw.ycc.bw.emc(pointFEmc3.y, pointFEmc4.y, f2));
            this.emc.get(size3).ypw(com.bytedance.adsdk.ypw.ycc.bw.emc(pointFYpw.x, pointFYpw2.x, f2), com.bytedance.adsdk.ypw.ycc.bw.emc(pointFYpw.y, pointFYpw2.y, f2));
            this.emc.get(size3).xq(com.bytedance.adsdk.ypw.ycc.bw.emc(pointFXq.x, pointFXq2.x, f2), com.bytedance.adsdk.ypw.ycc.bw.emc(pointFXq.y, pointFXq2.y, f2));
        }
    }
}
