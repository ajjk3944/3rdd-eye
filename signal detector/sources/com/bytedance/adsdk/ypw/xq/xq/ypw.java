...
public class ypw extends emc {
    ...
    public ypw(com.bytedance.adsdk.ypw.zz zzVar, bw bwVar, List<bw> list, com.bytedance.adsdk.ypw.uym uymVar, Context context) {
        ...
        while (true) {
            ...
            if (emcVarEmc2 != null) {
                ...
                if (emcVar2 != null) {
                    ...
                    if (bwVar2 != null && (ypwVarSup = bwVar2.sup()) != null && ((i3 = AnonymousClass1.emc[ypwVarSup.ordinal()]) == 1 || i3 == 2)) {
                        emcVar2 = emcVarEmc2;
                    }
                }
            }
        ...
        for (i = 0; i < longSparseArray.size(); i++) {
            emc emcVar3 = (emc) longSparseArray.get(longSparseArray.keyAt(i));
    ...
    public void ypw(Canvas canvas, Matrix matrix, int i) {
        ...
        boolean z6 = this.ypw.zz() && this.msw.size() > 1 && i != 255;
        if (z6) {
            this.gbl.setAlpha(i);
        ...
        for (int size = this.msw.size() - 1; size >= 0; size--) {
            if (((this.sup || !"__container".equals(this.xq.ycc())) && !this.ru.isEmpty()) ? canvas.clipRect(this.ru) : true) {
                this.msw.get(size).emc(canvas, matrix, i);
            }
        }
        canvas.restore();
    ...
    public void emc(float f2) {
        super.emc(f2);
        if (this.uym != null) {
            f2 = ((this.xq.emc().sup() * this.uym.uym().floatValue()) - this.xq.emc().ycc()) / (this.ypw.db().aa() + 0.01f);
        }
        if (this.uym == null) {
            f2 -= this.xq.xq();
        }
