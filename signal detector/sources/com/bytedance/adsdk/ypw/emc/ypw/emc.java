...
public abstract class emc<K, A> {
    ...
    final List<InterfaceC0021emc> emc = new ArrayList(1);
    ...
    public static final class dg<T> implements xq<T> {
        ...
        private com.bytedance.adsdk.ypw.uym.emc<T> xq(float f2) {
            ...
            for (int size = this.emc.size() - 2; size > 0; size--) {
                ...
                if (this.ypw != emcVar2 && emcVar2.emc(f2)) {
                    return emcVar2;
                }
            }
    ...
    public interface InterfaceC0021emc {
        void emc();
    }
    ...
    public interface xq<T> {
        ...
        boolean emc(float f2);

        float xq();

        com.bytedance.adsdk.ypw.uym.emc<T> ypw();

        boolean ypw(float f2);
    }
    ...
    public abstract A emc(com.bytedance.adsdk.ypw.uym.emc<K> emcVar, float f2);
    ...
    public void emc(InterfaceC0021emc interfaceC0021emc) {
        this.emc.add(interfaceC0021emc);
    }
    ...
    public A emc(com.bytedance.adsdk.ypw.uym.emc<K> emcVar, float f2, float f5, float f6) {
