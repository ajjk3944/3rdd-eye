...
public class sup extends uym<com.bytedance.adsdk.ypw.uym.xq> {
    ...
    public com.bytedance.adsdk.ypw.uym.xq emc(com.bytedance.adsdk.ypw.uym.emc<com.bytedance.adsdk.ypw.uym.xq> emcVar, float f2) {
        ...
        if (this.xq == null) {
            this.dg.emc(com.bytedance.adsdk.ypw.ycc.bw.emc(xqVar3.emc(), xqVar4.emc(), f2), com.bytedance.adsdk.ypw.ycc.bw.emc(xqVar3.ypw(), xqVar4.ypw(), f2));
            return this.dg;
        }
        emcVar.uym.getClass();
        dg();
