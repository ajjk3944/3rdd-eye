...
public class cf implements gbl, sz, emc.InterfaceC0021emc {
    ...
    public Path dg() {
        ...
        if (fZz == 0.0f && (emcVar = this.ru) != null) {
            fZz = Math.min(emcVar.uym().floatValue(), Math.min(f2, f5));
        }
        ...
        this.emc.moveTo(pointFUym2.x + f2, (pointFUym2.y - f5) + fZz);
        this.emc.lineTo(pointFUym2.x + f2, (pointFUym2.y + f5) - fZz);
        if (fZz > 0.0f) {
            RectF rectF = this.ypw;
            float f6 = pointFUym2.x;
            float f7 = fZz * 2.0f;
            float f8 = pointFUym2.y;
            rectF.set((f6 + f2) - f7, (f8 + f5) - f7, f6 + f2, f8 + f5);
            this.emc.arcTo(this.ypw, 0.0f, 90.0f, false);
        }
        this.emc.lineTo((pointFUym2.x - f2) + fZz, pointFUym2.y + f5);
        if (fZz > 0.0f) {
            RectF rectF2 = this.ypw;
            float f9 = pointFUym2.x;
            float f10 = pointFUym2.y;
            float f11 = fZz * 2.0f;
            rectF2.set(f9 - f2, (f10 + f5) - f11, (f9 - f2) + f11, f10 + f5);
        ...
        if (fZz > 0.0f) {
            ...
            float f13 = pointFUym2.y;
            float f14 = fZz * 2.0f;
            rectF3.set(f12 - f2, f13 - f5, (f12 - f2) + f14, (f13 - f5) + f14);
        ...
        if (fZz > 0.0f) {
            ...
            float f16 = fZz * 2.0f;
            float f17 = pointFUym2.y;
            rectF4.set((f15 + f2) - f16, f17 - f5, f15 + f2, (f17 - f5) + f16);
