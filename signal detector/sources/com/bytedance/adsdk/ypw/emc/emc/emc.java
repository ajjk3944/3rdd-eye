...
public abstract class emc implements bw, gbl, emc.InterfaceC0021emc {
    private com.bytedance.adsdk.ypw.emc.ypw.xq aa;
    ...
    private final List<C0020emc> zz = new ArrayList();

    /* renamed from: com.bytedance.adsdk.ypw.emc.emc.emc$emc, reason: collision with other inner class name */
    public static final class C0020emc {
        private final List<sz> emc;
        private final ylm ypw;

        private C0020emc(ylm ylmVar) {
            this.emc = new ArrayList();
            this.ypw = ylmVar;
        }
    }

    public emc(com.bytedance.adsdk.ypw.zz zzVar, com.bytedance.adsdk.ypw.xq.xq.emc emcVar, Paint.Cap cap, Paint.Join join, float f2, com.bytedance.adsdk.ypw.xq.emc.dg dgVar, com.bytedance.adsdk.ypw.xq.emc.ypw ypwVar, List<com.bytedance.adsdk.ypw.xq.emc.ypw> list, com.bytedance.adsdk.ypw.xq.emc.ypw ypwVar2) {
        ...
        for (int i = 0; i < list.size(); i++) {
            this.sz.add(list.get(i).emc());
        }
        emcVar.emc(this.sup);
        emcVar.emc(this.gbl);
        for (int i3 = 0; i3 < this.sz.size(); i3++) {
            emcVar.emc(this.sz.get(i3));
        }
        ...
        if (emcVar.gbl() != null) {
            this.aa = new com.bytedance.adsdk.ypw.emc.ypw.xq(this, emcVar, emcVar.gbl());
        }
    }
    ...
    */
    public void emc(java.util.List<com.bytedance.adsdk.ypw.emc.emc.xq> r8, java.util.List<com.bytedance.adsdk.ypw.emc.emc.xq> r9) {
        ...
        L55:
            ...
            r0.<init>(r2)
        L60:
            java.util.List r4 = com.bytedance.adsdk.ypw.emc.emc.emc.C0020emc.emc(r0)
    ...
    public void emc(Canvas canvas, Matrix matrix, int i) {
        ...
        this.ypw.setAlpha(com.bytedance.adsdk.ypw.ycc.bw.emc((int) ((((i / 255.0f) * ((com.bytedance.adsdk.ypw.emc.ypw.ycc) this.sup).zz()) / 100.0f) * 255.0f), 0, 255));
        this.ypw.setStrokeWidth(com.bytedance.adsdk.ypw.ycc.ycc.emc(matrix) * ((com.bytedance.adsdk.ypw.emc.ypw.dg) this.gbl).zz());
        ...
        com.bytedance.adsdk.ypw.emc.ypw.xq xqVar = this.aa;
        if (xqVar != null) {
            xqVar.emc(this.ypw);
        }
        for (int i3 = 0; i3 < this.zz.size(); i3++) {
            C0020emc c0020emc = this.zz.get(i3);
            if (c0020emc.ypw != null) {
                emc(canvas, c0020emc, matrix);
            } else {
                com.bytedance.adsdk.ypw.bw.emc("StrokeContent#buildPath");
                this.bw.reset();
                for (int size = c0020emc.emc.size() - 1; size >= 0; size--) {
                    this.bw.addPath(((sz) c0020emc.emc.get(size)).dg(), matrix);
                }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    private void emc(android.graphics.Canvas r17, com.bytedance.adsdk.ypw.emc.emc.emc.C0020emc r18, android.graphics.Matrix r19) {
        /*
    ...
    public void emc(RectF rectF, Matrix matrix, boolean z6) {
        ...
        for (int i = 0; i < this.zz.size(); i++) {
            C0020emc c0020emc = this.zz.get(i);
            for (int i3 = 0; i3 < c0020emc.emc.size(); i3++) {
                this.bw.addPath(((sz) c0020emc.emc.get(i3)).dg(), matrix);
            }
        }
    ...
    private void emc(Matrix matrix) {
        ...
        for (int i = 0; i < this.sz.size(); i++) {
            this.ru[i] = this.sz.get(i).uym().floatValue();
            if (i % 2 == 0) {
                float[] fArr = this.ru;
                if (fArr[i] < 1.0f) {
                    fArr[i] = 1.0f;
