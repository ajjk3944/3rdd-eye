...
public class dg implements bw, sz, emc.InterfaceC0021emc {
    ...
    private boolean bw() {
        int i = 0;
        for (int i3 = 0; i3 < this.msw.size(); i3++) {
            if ((this.msw.get(i3) instanceof bw) && (i = i + 1) >= 2) {
                return true;
            }
        }
        return false;
    ...
    private static List<xq> emc(com.bytedance.adsdk.ypw.zz zzVar, com.bytedance.adsdk.ypw.uym uymVar, com.bytedance.adsdk.ypw.xq.xq.emc emcVar, List<com.bytedance.adsdk.ypw.xq.ypw.xq> list) {
        ...
        for (int i = 0; i < list.size(); i++) {
            xq xqVarEmc = list.get(i).emc(zzVar, uymVar, emcVar);
            if (xqVarEmc != null) {
    ...
    public dg(com.bytedance.adsdk.ypw.zz zzVar, com.bytedance.adsdk.ypw.xq.xq.emc emcVar, String str, boolean z6, List<xq> list, com.bytedance.adsdk.ypw.xq.emc.sup supVar) {
    ...
    public static com.bytedance.adsdk.ypw.xq.emc.sup emc(List<com.bytedance.adsdk.ypw.xq.ypw.xq> list) {
        for (int i = 0; i < list.size(); i++) {
            com.bytedance.adsdk.ypw.xq.ypw.xq xqVar = list.get(i);
    ...
    public void emc(List<xq> list, List<xq> list2) {
        ArrayList arrayList = new ArrayList(this.msw.size() + list.size());
    ...
    public void emc(Canvas canvas, Matrix matrix, int i) {
        ...
        if (vkVar != null) {
            ...
            i = (int) (((((this.gbl.emc() == null ? 100 : this.gbl.emc().uym().intValue()) / 100.0f) * i) / 255.0f) * 255.0f);
        }
        boolean z6 = this.zz.zz() && bw() && i != 255;
        if (z6) {
    ...
    public void emc(RectF rectF, Matrix matrix, boolean z6) {
        ...
        for (int size = this.msw.size() - 1; size >= 0; size--) {
            xq xqVar = this.msw.get(size);
            if (xqVar instanceof bw) {
                ((bw) xqVar).emc(this.bw, this.xq, z6);
                rectF.union(this.bw);
            }
        }
    }
