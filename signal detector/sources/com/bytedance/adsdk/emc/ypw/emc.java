...
public class emc {
    ...
    static {
        ...
        final com.bytedance.adsdk.emc.ypw.xq.emc emcVar = new com.bytedance.adsdk.emc.ypw.xq.emc() { // from class: com.bytedance.adsdk.emc.ypw.emc.1
            ...
            public int emc(String str, int i3, Deque<com.bytedance.adsdk.emc.ypw.ypw.emc> deque) {
                return i3;
            }
        };
        while (i >= 0) {
            final ycc yccVar = yccVarArr[i];
            i--;
            emcVar = new com.bytedance.adsdk.emc.ypw.xq.emc() { // from class: com.bytedance.adsdk.emc.ypw.emc.2
                @Override // com.bytedance.adsdk.emc.ypw.xq.emc
                public int emc(String str, int i3, Deque<com.bytedance.adsdk.emc.ypw.ypw.emc> deque) {
                    return yccVar.emc(str, i3, deque, emcVar);
                }
            };
        }
        emc = emcVar;
    ...
    private emc(String str, com.bytedance.adsdk.emc.ypw.xq.emc emcVar) {
        ...
        try {
            ...
            throw new com.bytedance.adsdk.emc.emc.ypw(str, e6);
        }
    }
    ...
    private void emc() {
        ...
        int i = 0;
        while (i < length) {
            int iEmc = this.ypw.emc(this.bw, i, this.dg);
            if (iEmc == i) {
                throw new IllegalArgumentException("Unrecognized expression, unrecognized characters encountered during parsing:" + this.bw.substring(0, i));
            }
            i = iEmc;
        }
        ...
        while (true) {
            ...
            if (emcVarPollFirst == null) {
                this.xq = com.bytedance.adsdk.emc.ypw.bw.ypw.emc(arrayList, this.bw, i);
                this.dg = null;
                return;
            }
