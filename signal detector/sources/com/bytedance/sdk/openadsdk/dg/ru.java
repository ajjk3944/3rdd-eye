...
public class ru {
    ...
    public static JSONObject ypw(rie rieVar, String str, int i, JSONObject jSONObject) {
    ...
    public static void emc(final rie rieVar, String str, String str2, final String str3, final JSONObject jSONObject, final int i) {
        ...
        xq.emc(System.currentTimeMillis(), rieVar, str2, str, new com.bytedance.sdk.openadsdk.vk.xq.emc() { // from class: com.bytedance.sdk.openadsdk.dg.ru.1
            ...
            public JSONObject emc() {
                return ru.ypw(rieVar, str3, i, jSONObject);
            }
    ...
    public static void emc(String str, boolean z6, boolean z7, rie rieVar) {
        try {
            JSONObject jSONObject = new JSONObject();
            jSONObject.put("has_close_invoke", z6 ? 1 : 2);
            jSONObject.put("has_show_invoke", z7 ? 1 : 2);
            emc(rieVar, str, rieVar != null ? rieVar.bw() : null, null, jSONObject);
        } catch (JSONException unused) {
        }
    }

    public static void emc(rie rieVar, String str, int i) {
        emc(rieVar, "close".equals(str) ? "close_listen_empty" : "show_listen_empty", rieVar != null ? rieVar.bw() : null, null, null, i);
    }
}
