...
public class emc {
    ...
    private void emc(com.bytedance.sdk.openadsdk.dg.emc emcVar, boolean z6) {
        if (emcVar == null) {
            return;
        }
        try {
            String strOptString = z6 ? emcVar.xq().optJSONObject("params").optString("log_extra", "") : emcVar.xq().optString("log_extra", "");
            ...
            ul.xq("AdLogParamsGenerate", "getInfoFromLogExtra exception", e6.getMessage());
        }
    }

    public JSONObject emc(List<com.bytedance.sdk.openadsdk.dg.emc> list, long j6, JSONObject jSONObject, boolean z6) {
        ...
        try {
            ...
            jSONObject2.put("_gen_time", j6);
            jSONObject2.put("local_time", j6 / 1000);
        } catch (JSONException unused) {
        }
        return jSONObject2;
    }

    public List<com.bytedance.sdk.openadsdk.dg.emc> emc(List<com.bytedance.sdk.openadsdk.dg.emc> list, boolean z6) {
        ArrayList arrayList = new ArrayList();
        for (com.bytedance.sdk.openadsdk.dg.emc emcVar : list) {
            try {
                JSONObject jSONObject = new JSONObject();
                JSONObject jSONObjectXq = emcVar.xq();
                jSONObject.putOpt("event", jSONObjectXq.optString("label"));
                ...
                ul.xq("AdLogParamsGenerate", e6.getMessage());
            }
        }
        return arrayList;
    }
