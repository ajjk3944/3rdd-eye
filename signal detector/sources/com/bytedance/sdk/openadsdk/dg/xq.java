...
public class xq {
    ...
    public static void dg(final rie rieVar, final String str, final int i) {
    ...
    public static void xq(rie rieVar, String str, final long j6) {
    ...
    public static void xq(rie rieVar, String str, final int i) {
    ...
    public static class emc {
        public static void emc(String str, final JSONObject jSONObject, rie rieVar) {
            ...
            xq.emc(System.currentTimeMillis(), rieVar, strEmc.concat("_landingpage"), str, new com.bytedance.sdk.openadsdk.vk.xq.emc() { // from class: com.bytedance.sdk.openadsdk.dg.xq.emc.1
                @Override // com.bytedance.sdk.openadsdk.vk.xq.emc, com.bytedance.sdk.openadsdk.vk.xq.ypw
                public JSONObject xq() {
                    return jSONObject;
                }
        ...
        public static void emc(final int i, final int i3, rie rieVar) {
            String strEmc = tp.emc(rieVar);
            if (strEmc == null) {
                return;
            }
            xq.emc(System.currentTimeMillis(), rieVar, strEmc.concat("_landingpage"), "local_res_hit_rate", new com.bytedance.sdk.openadsdk.vk.xq.emc() { // from class: com.bytedance.sdk.openadsdk.dg.xq.emc.2
                @Override // com.bytedance.sdk.openadsdk.vk.xq.emc, com.bytedance.sdk.openadsdk.vk.xq.ypw
                public JSONObject xq() {
                    JSONObject jSONObject = new JSONObject();
                    try {
        ...
        public static void emc(final long j6, final rie rieVar, String str, final ILoader iLoader, final String str2) {
            if (str == null) {
                return;
            }
        ...
        public static void emc(final int i, final int i3, final int i6, final int i7, final rie rieVar, String str, final int i8) {
            ...
            xq.emc(System.currentTimeMillis(), rieVar, str, "landing_page_resource_detail", new com.bytedance.sdk.openadsdk.vk.xq.emc() { // from class: com.bytedance.sdk.openadsdk.dg.xq.emc.4
                ...
                public JSONObject xq() {
                    ...
                    try {
                        ...
                        jSONObject.put("first_page", i8);
                        jSONObject.put("preload_h5_type", rieVar.tp());
                        JSONObject jSONObject2 = new JSONObject();
                        jSONObject2.put("channel_response", i);
                        jSONObject2.put("failResourceCount", i3);
                        jSONObject2.put("successCount", i6);
                        jSONObject2.put("failCount", i7);
                        jSONObject.put("resource_info", jSONObject2);
                        return jSONObject;
                    } catch (Throwable th) {
                        Log.d("TTAD.AdEvent", "Gecko.localResHitRate error", th);
    ...
    public static void emc(rie rieVar, String str, final int i) {
    ...
    public static void xq(final rie rieVar, String str) {
        ...
        emc(System.currentTimeMillis(), rieVar, str, "endcard_show", new com.bytedance.sdk.openadsdk.vk.xq.emc() { // from class: com.bytedance.sdk.openadsdk.dg.xq.25
            @Override // com.bytedance.sdk.openadsdk.vk.xq.emc, com.bytedance.sdk.openadsdk.vk.xq.ypw
            public JSONObject xq() throws JSONException {
                JSONObject jSONObject = new JSONObject();
                try {
                    ...
                    if (rieVar.iat() != null) {
                        jSONObject.putOpt("render_type", Integer.valueOf(rieVar.iat().f6590l));
                    }
                } catch (Exception unused) {
                }
                return jSONObject;
            ...
            public JSONObject xq() throws JSONException {
                ...
                try {
                    if (rie.xq(rieVar)) {
                        ...
                        jSONObject.putOpt("url", rieVar.iat().f6587h);
                    ...
                    ul.xq(e6.getMessage(), new Object[0]);
                    return jSONObject;
                }
            }
        });
    ...
    public static void emc(final rie rieVar, String str, final long j6) {
    ...
    public static void emc(final rie rieVar, String str, final long j6, final int i, final String str2, final String str3) {
    ...
    public static void ypw(rie rieVar, String str, final long j6) {
        if (rieVar != null && j6 > 0 && j6 < 200000) {
            emc(System.currentTimeMillis(), rieVar, str, "video_click_duration", new com.bytedance.sdk.openadsdk.vk.xq.emc() { // from class: com.bytedance.sdk.openadsdk.dg.xq.3
                ...
                public JSONObject xq() {
                    JSONObject jSONObject = new JSONObject();
                    try {
                        jSONObject.put("video_click_duration_time", j6);
                    } catch (Throwable unused) {
                    }
                    return jSONObject;
                }
    ...
    public static void emc(final rie rieVar, String str, final long j6, final int i, final int i3) {
        emc(System.currentTimeMillis(), rieVar, str, "load", new com.bytedance.sdk.openadsdk.vk.xq.emc() { // from class: com.bytedance.sdk.openadsdk.dg.xq.43
            ...
            public JSONObject xq() throws JSONException {
                ...
                try {
                    ...
                    jSONObject.put("first_page", i3);
                    jSONObject.put("preload_h5_type", rieVar.tp());
                    int i6 = i;
                    if (i6 >= 0) {
                        jSONObject.putOpt("preload_status", Integer.valueOf(i6));
                    }
                } catch (Exception unused) {
                }
                return jSONObject;
            ...
            public JSONObject ypw() {
                JSONObject jSONObject = new JSONObject();
                try {
                    jSONObject.put("duration", Math.min(j6, TTAdConstant.AD_MAX_EVENT_TIME));
                } catch (Throwable unused) {
                }
                return jSONObject;
            }
    ...
    public static void ypw(rie rieVar, String str, final int i) {
                            ...
                            com.bytedance.sdk.component.utils.zz.emc().postDelayed(new Runnable() { // from class: com.bytedance.sdk.openadsdk.dg.xq.49.2
                                ...
                                public void run() throws JSONException {
                                    ...
                                    try {
                                        ...
                                        AnonymousClass49 anonymousClass49 = AnonymousClass49.this;
                                        xq.ypw(rieVar, str2, "click", jSONObject4);
                                    } catch (Exception unused) {
    ...
    public static void ypw(final long j6, final rie rieVar, String str, final String str2) {
            ...
            public JSONObject xq() throws JSONException {
                ...
                try {
                    if (rie.xq(rieVar)) {
                        ...
                        jSONObject.put("url", rieVar.iat().f6587h);
    ...
    public static void ypw(rie rieVar, String str, String str2, final JSONObject jSONObject, final long j6) {
        if (rieVar == null || jSONObject == null) {
            return;
        }
    ...
    public static void ypw(rie rieVar, String str, int i, JSONObject jSONObject) throws JSONException {
        if (jSONObject == null) {
            jSONObject = new JSONObject();
        }
        try {
    ...
    public static void emc(rie rieVar, final String str, final int i, final String str2, final long j6, final boolean z6, final int i3, final long j7) {
        emc(System.currentTimeMillis(), rieVar, str, ypw.dg, new com.bytedance.sdk.openadsdk.vk.xq.emc() { // from class: com.bytedance.sdk.openadsdk.dg.xq.4
            ...
            public JSONObject xq() {
                ...
                try {
                    ...
                    jSONObject.put("loading_visible_time", j6);
                    jSONObject.put("arbi_trigger_start", z6);
                    jSONObject.put("arbi_convert_count", i3);
                    jSONObject.put("loading_start_timestamp", j7);
                } catch (Throwable th) {
                    ul.xq(th.toString(), new Object[0]);
                }
                return jSONObject;
    ...
    public static void emc(rie rieVar, String str, final long j6, final boolean z6) {
    ...
    public static void emc(rie rieVar, String str, final int i, final String str2, final int i3) {
    ...
    public static void emc(rie rieVar, final String str, final int i, final String str2, final float f2) {
    ...
    public static void emc(rie rieVar, final String str, final int i, final String str2, final String str3, final int i3) {
    ...
    @DungeonFlag
    public static void emc(final String str, final rie rieVar, final com.bytedance.sdk.openadsdk.core.model.sup supVar, final String str2, final boolean z6, final Map<String, Object> map, final int i) {
        final long jCurrentTimeMillis = System.currentTimeMillis();
        emc(new com.bytedance.sdk.component.msw.msw("onClick") { // from class: com.bytedance.sdk.openadsdk.dg.xq.15
            ...
            public void run() {
                    ...
                    public JSONObject ypw() throws JSONException {
                        ...
                        try {
                            ...
                            if (supVar2 != null) {
                                ...
                                jSONObjectEmc.put("is_valid", z6);
                                int i3 = i;
                                if (i3 > 0 && i3 <= 2) {
                                    jSONObjectEmc.put("user_behavior_type", i3);
                                }
                                Map map2 = map;
                                if (map2 != null) {
                ...
                if (!TextUtils.isEmpty(com.bytedance.sdk.openadsdk.core.sup.emc(com.bytedance.sdk.openadsdk.core.aa.emc())) && "click".equals(str)) {
        ...
        emc(System.currentTimeMillis(), rieVar, str, str2, new com.bytedance.sdk.openadsdk.vk.xq.emc() { // from class: com.bytedance.sdk.openadsdk.dg.xq.16
            ...
            public JSONObject ypw() throws JSONException {
                ...
                try {
                    ...
                    ul.xq("TTAD.AdEvent", e6.getMessage());
                    return jSONObject2;
                }
            }
        });
    ...
    public static void emc(rie rieVar, String str, final String str2, final long j6, final int i, JSONObject jSONObject, final uym uymVar) {
        if (jSONObject == null) {
            jSONObject = new JSONObject();
        }
    ...
    public static void emc(rie rieVar, String str, String str2, final JSONObject jSONObject, final long j6) {
    ...
    @DungeonFlag
    public static void emc(long j6, rie rieVar, String str, String str2) {
        emc(j6, rieVar, str, str2, (com.bytedance.sdk.openadsdk.vk.xq.ypw) null);
    }

    @DungeonFlag
    public static void emc(final long j6, final rie rieVar, final String str, final String str2, final com.bytedance.sdk.openadsdk.vk.xq.ypw ypwVar) {
        ...
        emc(new com.bytedance.sdk.component.msw.msw(str2) { // from class: com.bytedance.sdk.openadsdk.dg.xq.21
            ...
            public void run() throws JSONException {
                ...
                new emc.C0085emc(j6, rieVar).ypw(str).xq(str2).bw(rieVar.ye()).msw(rieVar.wa()).emc(rieVar.rlt()).emc(jSONObject).uym(rieVar.lvs()).emc((com.bytedance.sdk.openadsdk.dg.ypw.emc) null);
            }
        });
    }

    public static void emc(rie rieVar, String str, final String str2, final int i) {
    ...
    public static void emc(final long j6, final rie rieVar, String str) {
        if (rieVar == null || !rie.xq(rieVar) || rieVar.iyl() == null) {
            return;
        }
    ...
    public static void emc(rie rieVar, String str, String str2, final long j6, final JSONObject jSONObject) {
        if (rieVar == null || jSONObject == null) {
            return;
        }
    ...
    public static void emc(String str, long j6) {
        com.bytedance.sdk.openadsdk.core.msw.xq.emc(str, j6);
    }

    @DungeonFlag
    public static void emc(final rie rieVar, final String str, final String str2, final String str3, final long j6, final long j7, final JSONObject jSONObject, final boolean z6) {
            ...
            public void run() throws JSONException {
                ...
                if (jSONObject != null) {
                    ...
                    try {
                            ...
                            if (!TextUtils.isEmpty(com.bytedance.sdk.openadsdk.core.sup.emc(com.bytedance.sdk.openadsdk.core.aa.emc()))) {
                                if (z6 && iOptInt == 2) {
                                    ...
                                    if (jSONArrayOptJSONArray2 != null) {
                                        ...
                                        com.bytedance.sdk.openadsdk.dg.emc.ypw.emc(com.bytedance.sdk.openadsdk.ee.emc.emc(arrayList, true), 2, String.valueOf(j6));
                                    }
                                } else {
                                    rie rieVar2 = rieVar;
                                    if (rieVar2 != null) {
                        ...
                        } else if ("show".equals(str3) && !TextUtils.isEmpty(com.bytedance.sdk.openadsdk.core.sup.emc(com.bytedance.sdk.openadsdk.core.aa.emc())) && z6 && iOptInt == 2 && (jSONArrayOptJSONArray = jSONObject2.optJSONArray("show_tracking_url")) != null) {
                            ArrayList arrayList2 = new ArrayList();
                            while (i < jSONArrayOptJSONArray.length()) {
                                arrayList2.add(jSONArrayOptJSONArray.optString(i));
                                i++;
                            }
                            com.bytedance.sdk.openadsdk.dg.emc.ypw.emc(com.bytedance.sdk.openadsdk.ee.emc.emc(arrayList2, true), 1, String.valueOf(j6));
                        }
                    } catch (Exception unused2) {
                    }
                }
                new emc.C0085emc(jCurrentTimeMillis, rieVar).dg(str).ypw(str2).xq(str3).bw(String.valueOf(j6)).ycc(String.valueOf(j7)).emc(strRlt).emc(jSONObject).msw(rieVar.wa()).uym(rieVar.lvs()).emc((com.bytedance.sdk.openadsdk.dg.ypw.emc) null);
            }
        });
    }

    public static void emc(final rie rieVar, String str, final long j6, final JSONObject jSONObject, final JSONObject jSONObject2) {
    ...
    public static void emc(JSONObject jSONObject, int i, int i3) throws JSONException {
        try {
            jSONObject.put("skip_show_time", i);
            jSONObject.put("skip_time", i3);
            JSONObject jSONObject2 = new JSONObject();
            jSONObject2.put("skip_after_time", i3 - (i * TTAdConstant.STYLE_SIZE_RADIO_1_1));
            jSONObject.put("pag_json_data", jSONObject2.toString());
        } catch (JSONException unused) {
        }
    }

    public static void emc(rie rieVar, String str, int i, JSONObject jSONObject) throws JSONException {
        if (jSONObject == null) {
            jSONObject = new JSONObject();
        }
        try {
    ...
    public static void emc(rie rieVar, String str, final boolean z6, final boolean z7, final boolean z8, final boolean z9, final int i, final Map<String, Object> map) {
        emc(System.currentTimeMillis(), rieVar, str, "start_show_plb", new com.bytedance.sdk.openadsdk.vk.xq.emc() { // from class: com.bytedance.sdk.openadsdk.dg.xq.42
            ...
            public JSONObject xq() {
                JSONObject jSONObject = new JSONObject();
                try {
                    jSONObject.put("isSkip", z6);
                    jSONObject.put("force", z7);
                    jSONObject.put("isFromLandingPage", z8);
                    jSONObject.put("finishing", z9);
    ...
    public static void emc(final rie rieVar, final boolean z6, String str, final String str2, final long j6, final String str3, final String str4, final int i, final String str5) {
    ...
    private static boolean emc(int i, String str) {
        int iYpw;
        try {
            Set<String> setQhy = com.bytedance.sdk.openadsdk.core.settings.gbl.xq().qhy();
            if ((i == 1 && setQhy != null && setQhy.contains(str)) || (iYpw = com.bytedance.sdk.openadsdk.core.settings.gbl.xq().ypw(str)) == 0) {
                return true;
            }
            if (iYpw != 100) {
    ...
    public static JSONObject emc(int i) {
        try {
            JSONObject jSONObject = new JSONObject();
