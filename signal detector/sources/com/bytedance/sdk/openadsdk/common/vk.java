...
public abstract class vk {
    ...
    public void xq(boolean z6) {
        this.uym.ylm.ul();
        if (z6) {
            this.uym.rie.emc(TTAdConstant.STYLE_SIZE_RADIO_1_1);
        }
        this.uym.aa.set(false);
    }
    ...
    private boolean ypw(boolean z6, boolean z7, Runnable runnable) {
        if ((z6 || !ycc() || !msw()) && runnable == null) {
            if (z7) {
                xq();
                return true;
            }
    ...
    public abstract void emc(boolean z6);
    ...
    public final boolean emc(boolean z6, boolean z7, Runnable runnable) {
        com.bytedance.sdk.openadsdk.component.reward.emc.emc emcVar = this.uym;
    ...
    private void xq(final boolean z6, final Runnable runnable) {
        ypw(z6);
        com.bytedance.sdk.openadsdk.component.reward.emc.emc emcVar = this.uym;
        if (emcVar != null && !emcVar.mxo.isFinishing() && !this.uym.mxo.isDestroyed()) {
            ...
            ypwVar.emc(new ypw.InterfaceC0080ypw() { // from class: com.bytedance.sdk.openadsdk.common.vk.1
    ...
    private void ypw(boolean z6, Runnable runnable) {
    ...
    private void ypw(boolean z6) {
        ...
        this.uym.aa.set(true);
    }

    private boolean emc(boolean z6, Runnable runnable) {
        if (z6 || !emc()) {
            return false;
        }
        if (!this.uym.wbn) {
