...
public class ypw {
    ...
    private final Map<rie, Long> ycc = DesugarCollections.synchronizedMap(new HashMap());
    ...
    private String ypw() {
        return ((C0115c) CacheDirFactory.getICacheDir(0)).b();
    }
    ...
    public static class emc {
        ...
        public String emc(String str) {
            ...
            return AbstractC1135f5.n(new StringBuilder(), this.emc, "_cache_", str);
        }
    ...
    public boolean emc(com.bytedance.sdk.openadsdk.core.model.emc emcVar, boolean z6) {
    ...
    public String emc(String str, long j6) {
        long jDg = this.dg.dg(str);
        boolean zBw = this.dg.bw(str);
        if (System.currentTimeMillis() - jDg >= j6 || zBw) {
            return null;
        }
        return ypw(str);
    }
