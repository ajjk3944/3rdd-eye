...
public class ylm {
    ...
    public ylm(Context context, RelativeLayout relativeLayout, rie rieVar, com.bytedance.sdk.component.zz.ycc yccVar, String str, boolean z6) {
        this.msw = context;
    ...
    private void msw() {
        ...
        view.setOnClickListener(new g(27, this));
    }
    ...
    private boolean dg(String str) {
        ...
        for (char c6 : str.toCharArray()) {
            if (Character.getDirectionality(c6) == 1 || Character.getDirectionality(c6) == 2) {
                return true;
            }
        }
        return false;
    ...
    public void ypw() {
        try {
            ...
            int i3 = this.qh;
            if (i == i3) {
                ValueAnimator valueAnimatorOfInt = ValueAnimator.ofInt(i3, i3 / 2);
    ...
    public void emc() {
        try {
            ...
            int i3 = this.qh;
            if (i == i3 / 2) {
                ValueAnimator valueAnimatorOfInt = ValueAnimator.ofInt(i3 / 2, i3);
                valueAnimatorOfInt.setDuration(300L);
