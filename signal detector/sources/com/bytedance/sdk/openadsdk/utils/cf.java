...
public class cf implements com.bytedance.sdk.openadsdk.oem.emc {
    ...
    public void emc(String str, final int i) {
        ...
        iyl.emc(new Runnable() { // from class: com.bytedance.sdk.openadsdk.utils.cf.1
            ...
            public void run() {
                ...
                if (cf.xq) {
                    ...
                    com.bytedance.sdk.openadsdk.dg.xq.emc("click", cf.ypw.ypw, new sup.emc().emc(), cf.ypw.bw, true, (Map<String, Object>) map, 1);
                } else {
                    z6 = z7;
                }
                if (z6) {
