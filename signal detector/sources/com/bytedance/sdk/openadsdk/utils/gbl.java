...
public class gbl {
    ...
    public static Drawable emc(Context context, String str, boolean z6) {
    ...
    */
    ...
    private static GradientDrawable emc(int i, Integer num, int[] iArr, int[] iArr2, Integer num2, Integer num3) {
    ...
    public static Drawable emc(Context context, int i) {
        return emc(context, Color.parseColor("#1A73E8"), i);
    }

    public static Drawable emc(Context context, int i, int i3) {
        GradientDrawable gradientDrawable = new GradientDrawable();
        gradientDrawable.setColor(i);
        gradientDrawable.setCornerRadius(vw.ypw(context, i3));
        return gradientDrawable;
    }
}
