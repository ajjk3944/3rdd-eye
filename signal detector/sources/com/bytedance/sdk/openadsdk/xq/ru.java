...
public class ru {
    ...
    public IListenerManager emc(int i) {
        if (this.ycc == null) {
            this.ycc = IListenerManager.Stub.asInterface(com.bytedance.sdk.openadsdk.multipro.aidl.emc.emc().emc(i));
        }
        return this.ycc;
    }

    public static void emc(final int i, final String str, final uym.emc emcVar) {
        if (com.bytedance.sdk.openadsdk.multipro.ypw.xq()) {
            iyl.xq(new com.bytedance.sdk.component.msw.msw("DislikeClosed_registerMultiProcessListener") { // from class: com.bytedance.sdk.openadsdk.xq.ru.2
                ...
                public void run() {
                    ...
                    try {
                        ...
                        ul.xq("TTDislikeManager", e6.getMessage());
                    }
                }
            }, 5);
        }
    ...
    public static void emc(final int i, final String str) {
        if (com.bytedance.sdk.openadsdk.multipro.ypw.xq()) {
