...
public class sup extends Dialog {
    ...
    public interface emc {
        ...
        void emc(int i, FilterWord filterWord, String str);
    ...
    public sup(Context context, ru ruVar) {
    ...
    public static void emc(EditText editText) {
        editText.setFilters(new InputFilter[]{new InputFilter() { // from class: com.bytedance.sdk.openadsdk.xq.sup.4
            ...
            public CharSequence filter(CharSequence charSequence, int i, int i3, Spanned spanned, int i6, int i7) {
                while (i < i3) {
    ...
    private com.bytedance.sdk.openadsdk.core.ycc.bw emc(Context context) {
        ...
        this.xq = ypwVar;
        ypwVar.setFilters(new InputFilter[]{new InputFilter.LengthFilter(TTAdConstant.MATE_VALID), new InputFilter.AllCaps()});
