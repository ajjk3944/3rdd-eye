...
public class xq {
        ...
        if (this.xq != null) {
            ...
            if (jCurrentTimeMillis >= 0) {
                ...
                if (jCurrentTimeMillis <= j7) {
                    j6 = j7 - jCurrentTimeMillis;
                }
            }
            Log.i("StrategyCenter", "after  realInterval=".concat(String.valueOf(j6)));
            this.xq.dg().removeCallbacks(this.ycc);
            if (this.bw > 24) {
                return;
            }
            this.xq.dg().postDelayed(this.ycc, j6);
        }
    }

    public int emc(String str, int i) {
        ypw ypwVar = this.ypw;
        return ypwVar == null ? i : ypwVar.emc(str, i);
    }
    ...
    public boolean emc(String str, boolean z6) {
        ypw ypwVar = this.ypw;
        return ypwVar == null ? z6 : ypwVar.emc(str, z6);
    }
}
