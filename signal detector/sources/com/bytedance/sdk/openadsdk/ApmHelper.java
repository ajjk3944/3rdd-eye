...
public class ApmHelper {
    ...
    public static Pair<String, String> generateRequestHeader() {
        ...
        try {
            ...
            jSONObject.put("region", aa.dg().pxa());
    ...
    private static void ypw(String str, String str2) throws JSONException {
        ...
        String strM = f.m("https://", str2, "/monitor/collect/c/session?version_code=7852&device_platform=android&aid=10000001");
        aa.xq().emc(ypw(str), strM);
    }
