...
public class bw {
    ...
    public static boolean emc(Context context, int i) {
        boolean zEmc;
        boolean zEmc2;
        if (ycc == 0) {
    ...
    public static boolean emc(Context context) {
        ...
        boolean z7;
        if (Build.VERSION.SDK_INT >= 33) {
            z6 = context.checkSelfPermission("android.permission.READ_MEDIA_IMAGES") == 0;
        } else {
            z6 = context.checkSelfPermission("android.permission.READ_EXTERNAL_STORAGE") == 0;
