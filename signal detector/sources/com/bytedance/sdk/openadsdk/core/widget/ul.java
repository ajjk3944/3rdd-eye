...
public class ul {
    ...
    private void emc(Context context, View view, boolean z6) {
    ...
    public boolean emc(int i, c cVar, boolean z6) {
        Context context = this.xq;
        if (context == null || cVar == null) {
            return true;
        }
        emc(context, this.msw, z6);
        this.uym = cVar;
        if (i == 1 || i == 2) {
            return emc(i);
        }
    ...
    private void emc(c cVar, boolean z6) {
        View view;
        String str;
        View view2;
        if (cVar == null || (view = this.emc) == null || this.xq == null || view.getVisibility() == 0) {
            return;
        }
        ypw ypwVar = this.bw;
        if (ypwVar != null) {
        ...
        double dCeil = Math.ceil((cVar.f6582c * 1.0d) / 1048576.0d);
        if (z6) {
