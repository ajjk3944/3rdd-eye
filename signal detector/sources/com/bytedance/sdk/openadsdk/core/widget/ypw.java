...
public class ypw extends Dialog {
    ...
    public interface InterfaceC0080ypw {
        void emc();
    ...
    private void emc() {
        this.ycc.setOnClickListener(new View.OnClickListener() { // from class: com.bytedance.sdk.openadsdk.core.widget.ypw.1
            ...
            public void onClick(View view) {
                InterfaceC0080ypw interfaceC0080ypw = ypw.this.emc;
                if (interfaceC0080ypw != null) {
                    interfaceC0080ypw.emc();
                }
            }
        });
    ...
    public ypw emc(InterfaceC0080ypw interfaceC0080ypw) {
        this.emc = interfaceC0080ypw;
        return this;
    }
