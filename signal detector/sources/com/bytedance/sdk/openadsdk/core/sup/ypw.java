...
public class ypw extends xq {
    ...
    public ypw(int i, int i3, long j6, long j7, emc.EnumC0072emc enumC0072emc, emc.ypw ypwVar, String str, List<com.bytedance.sdk.openadsdk.core.sup.ypw.xq> list, List<com.bytedance.sdk.openadsdk.core.sup.ypw.xq> list2, String str2) {
        super(i, i3, enumC0072emc, ypwVar, str, list, list2, str2);
        this.ru = j6;
        this.gbl = j7;
        this.zz = "icon_click";
    }
