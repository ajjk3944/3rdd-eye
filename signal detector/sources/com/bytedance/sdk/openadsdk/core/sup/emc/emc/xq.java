...
public class xq {
    ...
    */
    ...
    private static List<com.bytedance.sdk.openadsdk.core.sup.ypw.xq> xq(XmlPullParser xmlPullParser) {
        return emc(xmlPullParser, false);
    }

    public static double ypw(XmlPullParser xmlPullParser) {
    ...
    private static String emc(XmlPullParser xmlPullParser, int i, double d6, com.bytedance.sdk.openadsdk.core.sup.emc emcVar) {
        ...
        while (true) {
            ...
            if (xmlPullParser.getEventType() == 2 && xmlPullParser.getName().equals("MediaFile")) {
                ...
                if (iYpw > 0 && iYpw2 > 0 && com.bytedance.sdk.openadsdk.core.sup.xq.dg.emc.contains(attributeValue) && !TextUtils.isEmpty(strYpw)) {
                    double dEmc = com.bytedance.sdk.openadsdk.core.sup.xq.dg.emc(i, d6, iYpw, iYpw2, iYpw3, attributeValue);
                    if (dEmc > d7) {
                        str = strYpw;
                        d7 = dEmc;
                        i3 = iYpw;
        ...
        while (true) {
            ...
            if (xmlPullParser.getEventType() == 2 && xmlPullParser.getName().equals("Icon")) {
                ...
                if (iYpw > 0 && iYpw <= 300 && iYpw2 > 0 && iYpw2 <= 300) {
                    ...
                    String strYpw = null;
                    while (true) {
                        if (xmlPullParser.next() == i7 && xmlPullParser.getName().equals("Icon")) {
                            ...
                            if (xmlPullParser.getEventType() == i8) {
                                ...
                                switch (name) {
                                    ...
                                    case "IFrameResource":
                                        ...
                                        i6 = 2;
                                        if (emcVar == null) {
                                            emcVar = new bw.emc(bw.ypw(xmlPullParser, "IFrameResource"), emc.EnumC0072emc.NONE, emc.ypw.IFRAME_RESOURCE);
                                            break;
                                        } else {
                                    ...
                                    case "StaticResource":
                                        ...
                                        if (set.contains(lowerCase)) {
                                            enumC0072emc = emc.EnumC0072emc.IMAGE;
                                        } else {
                                            enumC0072emc = emc.EnumC0072emc.JAVASCRIPT;
                                        }
                                        emcVar = new bw.emc(strYpw2, enumC0072emc, emc.ypw.STATIC_RESOURCE);
                                        break;
                                    case "IconClicks":
                                        while (true) {
                                            i3 = 3;
                                    ...
                                    case "HTMLResource":
                                        if (emcVar == null || emcVar.xq == emc.ypw.IFRAME_RESOURCE) {
                                            emcVar = new bw.emc(bw.ypw(xmlPullParser, "HTMLResource"), emc.EnumC0072emc.NONE, emc.ypw.HTML_RESOURCE);
                                            ypwVar3 = ypwVar2;
                                            iEmc2 = i;
                                            i7 = 3;
                                            i8 = 2;
    ...
    */
    ...
    private static void emc(XmlPullParser xmlPullParser, com.bytedance.sdk.openadsdk.core.sup.emc emcVar) {
        while (true) {
    ...
    private static List<com.bytedance.sdk.openadsdk.core.sup.ypw.xq> emc(XmlPullParser xmlPullParser, boolean z6) {
        return bw.emc(xmlPullParser, "Tracking", z6);
    }
}
