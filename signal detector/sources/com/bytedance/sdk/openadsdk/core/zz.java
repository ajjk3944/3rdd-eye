...
public class zz {
    ...
    private com.bytedance.sdk.openadsdk.core.sz.xq.xq aa;
    private String bw;
    private boolean cf;
    private String dg;
    private Integer gbl;
    ...
    public String dg() {
        if (TextUtils.isEmpty(this.dg)) {
            String strEmc = emc("app_id", Long.MAX_VALUE);
            if (!TextUtils.isEmpty(strEmc)) {
                this.dg = strEmc;
            }
        }
    ...
    public com.bytedance.sdk.openadsdk.core.sz.xq.xq qh() {
        if (this.aa == null) {
            this.aa = new com.bytedance.sdk.openadsdk.core.sz.xq.xq(10, 8);
        }
        return this.aa;
    }
    ...
    private static JSONObject sup(String str) {
        ...
        try {
            ...
            com.bytedance.sdk.component.utils.ul.xq("TTAD.GlobalInfo", e6.getMessage());
            return null;
        }
    }
    ...
    public void xq(int i) {
        if (com.bytedance.sdk.openadsdk.multipro.ypw.xq()) {
            com.bytedance.sdk.openadsdk.multipro.dg.dg.emc("sp_global_icon_id", "icon_id", Integer.valueOf(i));
        }
        this.uym = i;
    }

    public void ypw(boolean z6) {
        com.bytedance.sdk.openadsdk.multipro.dg.dg.emc("sp_global_file", "sdk_activate_init", Boolean.valueOf(z6));
    }
    ...
    public static void ypw(int i) throws JSONException {
        if (i >= 0) {
            emc("config_fail_times", String.valueOf(i));
        }
    }
    ...
    public void ycc(int i) {
        if (com.bytedance.sdk.openadsdk.multipro.ypw.xq()) {
            com.bytedance.sdk.openadsdk.multipro.dg.dg.emc("sp_global_file", "title_bar_theme", Integer.valueOf(i));
        }
        this.zz = i;
    }

    public static void emc(int i) throws JSONException {
        if (i >= 0) {
            emc("domain_index", String.valueOf(i));
        }
    }
    ...
    public static Pair<String, Long> dg(String str) throws JSONException {
        ...
        try {
            ...
            return new Pair<>(jSONObjectSup.getString("value"), Long.valueOf(jSONObjectSup.getLong("time")));
        } catch (JSONException e6) {
            com.bytedance.sdk.component.utils.ul.xq("TTAD.GlobalInfo", e6.getMessage());
            return null;
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void emc(Integer num, int i) {
        if (num != null) {
            com.bytedance.sdk.openadsdk.multipro.dg.dg.emc("sp_global_privacy", "tt_gdpr", Integer.valueOf(i));
            com.bytedance.sdk.openadsdk.core.settings.gbl.xq().emc(4, true);
        } else if (com.bytedance.sdk.openadsdk.multipro.dg.dg.emc("sp_global_privacy", "tt_gdpr", -1) != i) {
            com.bytedance.sdk.openadsdk.multipro.dg.dg.emc("sp_global_privacy", "tt_gdpr", Integer.valueOf(i));
            com.bytedance.sdk.openadsdk.core.settings.gbl.xq().emc(4, true);
        }
    }
    ...
    public static String emc(String str, long j6) {
        ...
        if (System.currentTimeMillis() - jSONObjectSup.getLong("time") <= j6) {
            return jSONObjectSup.getString("value");
        }
        return null;
    }
