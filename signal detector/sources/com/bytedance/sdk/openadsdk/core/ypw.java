...
public class ypw {
        ...
        try {
            ...
            if (jSONArrayOptJSONArray != null && jSONArrayOptJSONArray.length() > 0) {
                for (int i = 0; i < jSONArrayOptJSONArray.length(); i++) {
                    FilterWord filterWordBw = bw(jSONArrayOptJSONArray.optJSONObject(i));
    ...
    private static com.bytedance.sdk.openadsdk.core.model.uym dg(JSONObject jSONObject) {
        ...
        long j6 = jOptLong >= 0 ? jOptLong : 0L;
    ...
    private static com.bytedance.sdk.openadsdk.core.model.ycc ycc(JSONObject jSONObject) {
        ...
        yccVar.xq(jSONObject.optString("package_name"));
        yccVar.emc(jSONObject.optString("download_url"));
        yccVar.emc(jSONObject.optDouble("score", -1.0d));
        yccVar.emc(jSONObject.optInt("comment_num", -1));
        yccVar.ypw(jSONObject.optInt("app_size", 0));
    ...
    public static Pair<com.bytedance.sdk.openadsdk.core.model.emc, ArrayList<Integer>> emc(JSONObject jSONObject, AdSlot adSlot, com.bytedance.sdk.openadsdk.core.model.sb sbVar) {
        Pair<com.bytedance.sdk.openadsdk.core.model.emc, ArrayList<Integer>> pair;
        ...
        try {
            ...
            if (jSONArrayOptJSONArray != null) {
                ...
                while (i < jSONArrayOptJSONArray.length()) {
                    com.bytedance.sdk.openadsdk.core.model.rie rieVarEmc = emc(jSONArrayOptJSONArray.optJSONObject(i), adSlot, sbVar, emcVar, i);
                    ...
                    if (iEmc != 200) {
                        ...
                        if (arrayList3 == 0 || rieVarEmc == null) {
                            rieVar2 = rieVar3;
                        } else {
                            rieVar = rieVar3;
                            try {
                                arrayList3.add(new emc(rieVarEmc.wa(), iEmc));
                                rieVar2 = rieVar;
                            } catch (Throwable th) {
                                th = th;
                                pair = rieVar;
                ...
                if (listDg != null) {
                    ...
                    for (int i3 = 0; i3 < size; i3++) {
                        com.bytedance.sdk.openadsdk.core.model.rie rieVar5 = listDg.get(i3);
                        if (rieVar5 != null) {
                            if (i3 > 0) {
                                rieVar5.ksn();
                            }
    ...
    */
    ...
    private static int emc(c cVar, boolean z6) {
        return cVar == null ? TTAdConstant.VIDEO_INFO_CODE : TextUtils.isEmpty(cVar.f6586g) ? TTAdConstant.VIDEO_URL_CODE : (z6 || !TextUtils.isEmpty(cVar.f6585f)) ? TTAdConstant.MATE_VALID : TTAdConstant.VIDEO_COVER_URL_CODE;
    }
    ...
    /* JADX WARN: Removed duplicated region for block: B:176:0x06a8 A[PHI: r0
  0x06a8: PHI (r0v88 int) = (r0v87 int), (r0v138 int) binds: [B:169:0x0694, B:174:0x06a5] A[DONT_GENERATE, DONT_INLINE]] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    ...
    private static Pair<com.bytedance.sdk.openadsdk.core.sup.emc, ypw.emc> emc(String str, int i, int i3) {
        int iXq;
        int iBw;
    ...
    private static void emc(com.bytedance.sdk.openadsdk.core.sup.emc emcVar, com.bytedance.sdk.openadsdk.core.model.rie rieVar) {
        ...
        cVarIat.f6586g = emcVar.uym();
        cVarIat.f6583d = emcVar.msw();
        cVarIat.f6588j = null;
        cVarIat.f6585f = null;
        cVarIat.f6587h = null;
        rieVar.emc(cVarIat);
    ...
    private static c emc(JSONObject jSONObject, com.bytedance.sdk.openadsdk.core.model.rie rieVar, boolean z6) {
        int iOptInt;
        if (jSONObject == null) {
            return null;
        }
        c cVar = new c();
        cVar.f6580a = jSONObject.optInt("cover_height");
        cVar.f6581b = jSONObject.optInt("cover_width");
        cVar.f6584e = jSONObject.optString("resolution");
        cVar.f6582c = jSONObject.optLong("size");
        double dOptDouble = jSONObject.optDouble("video_duration", 0.0d);
        cVar.f6583d = dOptDouble;
        ...
        cVar.f6596r = Math.min(4, Math.max(1, iOptInt2));
        cVar.f6585f = jSONObject.optString("cover_url");
        cVar.f6586g = jSONObject.optString("video_url");
        cVar.f6587h = jSONObject.optString("endcard");
        cVar.i = jSONObject.optString("playable_download_url");
        cVar.f6588j = jSONObject.optString("file_hash");
        cVar.f6591m = jSONObject.optInt("if_playable_loading_show", 0);
        cVar.f6592n = jSONObject.optInt("remove_loading_page_type", 0);
        cVar.f6589k = jSONObject.optInt("fallback_endcard_judge", 0);
        cVar.f6595q = jSONObject.optInt("video_preload_size", 307200);
        cVar.f6593o = jSONObject.optInt("reward_video_cached_type", 0);
        cVar.f6594p = jSONObject.optInt("execute_cached_type", 0);
        if (z6) {
    ...
    */
    private static int emc(com.bytedance.sdk.openadsdk.core.model.rie r5) {
        ...
        L64:
            ...
            goto La9
        L89:
            com.bykv.vk.openvk.emc.emc.emc.xq.c r0 = r5.iat()
            boolean r1 = r5.ak()
            int r0 = emc(r0, r1)
            if (r0 == r3) goto La9
    ...
    private static int emc(com.bytedance.sdk.openadsdk.core.model.sz szVar) {
        return szVar == null ? TTAdConstant.MATE_VALID : TextUtils.isEmpty(szVar.emc()) ? TTAdConstant.DEEPLINK_UNAVAILABLE_CODE : TextUtils.isEmpty(szVar.ypw()) ? TTAdConstant.DEEPLINK_FALLBACK_CODE : (szVar.xq() == 1 || szVar.xq() == 2) ? TTAdConstant.MATE_VALID : TTAdConstant.DEEPLINK_FALLBACK_TYPE_CODE;
    }

    private static int emc(com.bytedance.sdk.openadsdk.core.model.ycc yccVar) {
        return yccVar == null ? TTAdConstant.DOWNLOAD_APP_INFO_CODE : TextUtils.isEmpty(yccVar.emc()) ? TTAdConstant.DOWNLOAD_URL_CODE : TextUtils.isEmpty(yccVar.xq()) ? TTAdConstant.PACKAGE_NAME_CODE : TTAdConstant.MATE_VALID;
    }
        ...
        com.bytedance.sdk.openadsdk.vk.xq.emc("multiple_ads_parsing_error", false, new com.bytedance.sdk.openadsdk.vk.ypw() { // from class: com.bytedance.sdk.openadsdk.core.ypw.1
            ...
            public com.bytedance.sdk.openadsdk.vk.emc.xq emc() throws JSONException {
                ...
                while (i < size) {
                    ...
                    jSONObject2.put("cid", emcVar.emc);
