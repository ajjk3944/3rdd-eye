...
public class ypw {
    ...
    public ypw(JSONObject jSONObject) {
        ...
        this.qh = 1;
        this.cf = 2;
        this.vk = TTAdConstant.STYLE_SIZE_RADIO_3_2;
        this.aa = 2;
        this.sba = 3500;
        this.yzg = 0;
        this.ul = 5;
        ...
        this.vk = jSONObject.optInt("stop_time", TTAdConstant.STYLE_SIZE_RADIO_3_2);
        this.aa = jSONObject.optInt("native_playable_delay", 2);
    ...
    public void emc(JSONArray jSONArray) {
        ...
        for (int i = 0; i < jSONArray.length(); i++) {
            try {
                this.rie.add(jSONArray.get(i).toString());
