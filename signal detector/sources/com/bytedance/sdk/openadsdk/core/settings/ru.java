...
public abstract class ru implements bw {
    ...
    private void bw() throws InterruptedException {
        ...
        try {
            ...
            ul.emc("SdkSettings.Prop", "awaitLoadedLocked: ", e6);
        }
    }
    ...
    public int emc(String str, int i) {
        if (str != null && !str.isEmpty()) {
            bw();
            try {
                return Integer.parseInt(this.msw.getProperty(str, String.valueOf(i)));
            } catch (NumberFormatException e6) {
                ul.emc("SdkSettings.Prop", "", e6);
            }
        }
        return i;
    }
    ...
    public long emc(String str, long j6) {
        if (str != null && !str.isEmpty()) {
            bw();
            try {
                return Long.parseLong(this.msw.getProperty(str, String.valueOf(j6)));
            } catch (NumberFormatException e6) {
                ul.emc("SdkSettings.Prop", "", e6);
            }
        }
    ...
    public float emc(String str, float f2) throws InterruptedException {
        if (str != null && !str.isEmpty()) {
            bw();
            try {
                return Float.parseFloat(this.msw.getProperty(str, String.valueOf(f2)));
            } catch (NumberFormatException e6) {
                ul.emc("SdkSettings.Prop", "", e6);
            }
        }
    ...
    public class ypw implements bw.emc {
        ...
        @Override // com.bytedance.sdk.openadsdk.core.settings.bw.emc
        public bw.emc emc(String str, int i) {
            synchronized (this.xq) {
                this.ypw.put(str, Integer.valueOf(i));
            }
            return this;
        }

        @Override // com.bytedance.sdk.openadsdk.core.settings.bw.emc
        public bw.emc emc(String str, long j6) {
            synchronized (this.xq) {
                this.ypw.put(str, Long.valueOf(j6));
            }
            return this;
        }
        ...
        @Override // com.bytedance.sdk.openadsdk.core.settings.bw.emc
        public bw.emc emc(String str, float f2) {
            synchronized (this.xq) {
                this.ypw.put(str, Float.valueOf(f2));
            }
            return this;
        }

        @Override // com.bytedance.sdk.openadsdk.core.settings.bw.emc
        public bw.emc emc(String str, boolean z6) {
            synchronized (this.xq) {
                this.ypw.put(str, Boolean.valueOf(z6));
            }
            return this;
        }
    }

    public boolean emc(String str, boolean z6) throws InterruptedException {
        if (str != null && !str.isEmpty()) {
            bw();
            try {
                return Boolean.parseBoolean(this.msw.getProperty(str, String.valueOf(z6)));
            } catch (Exception e6) {
                ul.emc("SdkSettings.Prop", "", e6);
            }
        }
    ...
    */
    ...
    public <T> T emc(String str, T t6, bw.ypw<T> ypwVar) throws InterruptedException {
        T tYpw;
        if (str != null && !str.isEmpty()) {
            T t7 = (T) this.xq.get(str);
            if (t7 != null) {
                return t7;
            }
            bw();
