...
public class xq {
    ...
    private static HashMap<String, ypw> ypw(JSONArray jSONArray) {
        ...
        for (int i = 0; i < jSONArray.length(); i++) {
            try {
                ypw ypwVarEmc = emc(jSONArray.getJSONObject(i));
                if (ypwVarEmc != null) {
    ...
    */
    public static void emc(org.json.JSONArray r5) {
        /*
            if (r5 != 0) goto L4
            goto La9
        L4:
        ...
        L8b:
            ...
            j$.util.concurrent.ConcurrentHashMap<java.lang.String, com.bytedance.sdk.openadsdk.core.settings.ypw> r2 = com.bytedance.sdk.openadsdk.core.settings.xq.emc
            r2.put(r1, r0)
            goto L8b
        La9:
            return
