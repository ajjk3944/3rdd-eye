...
public class zz extends com.bytedance.sdk.component.msw.msw {
        ...
        try {
            if (!TextUtils.isEmpty(str) && map != null) {
                ...
                if (str2 != null) {
                    ...
                    if (str3 != null) {
                        long j6 = Long.parseLong(str3);
                        String str4 = (String) map2.get("pst");
                        String strA = a.a(str + i3 + j6);
                        if (strA != null) {
    ...
    public static JSONObject emc(int i) throws JSONException {
        ...
        try {
            ...
            jSONObject.put("conn_type", tp.uym(i));
            jSONObject.put("os", 1);
            ...
            jSONObject.put("package_name", tp.ycc());
    ...
    public boolean emc(JSONObject jSONObject) throws JSONException {
