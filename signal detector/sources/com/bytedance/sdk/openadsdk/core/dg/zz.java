...
public class zz extends com.bytedance.sdk.openadsdk.core.zz.emc implements b, d {
    private PAGBannerAdWrapperListener aa;
    private String cf;
    public boolean emc;
    ...
    public void setAdInteractionListener(PAGBannerAdWrapperListener pAGBannerAdWrapperListener) {
        this.aa = pAGBannerAdWrapperListener;
    }
    ...
    public void emc(View view, int i, vk vkVar) {
        ul ulVar = this.sup;
        if (ulVar != null) {
        ...
        if (rieVar != null) {
            ...
            if (videoView != null) {
                ...
                this.qh.setAdCreativeClickListener(new ycc.emc() { // from class: com.bytedance.sdk.openadsdk.core.dg.zz.1
                    ...
                    public void emc(View view2, int i) {
                        if (zz.this.aa != null) {
                            zz.this.aa.onAdClicked();
                        }
                    }
                });
            }
