...
public class emc {
    ...
    public static class C0053emc extends com.bytedance.sdk.component.msw.msw {
        boolean emc;
        WeakReference<emc> xq;
        rie ypw;

        public C0053emc(boolean z6, rie rieVar, emc emcVar) {
    ...
    public emc(Context context, rie rieVar, AdSlot adSlot, uym uymVar, boolean z6) {
        this.qh = false;
        this.ycc = context;
        this.dg = rieVar;
        this.ypw = adSlot;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void ypw(boolean z6, rie rieVar) {
        try {
            if (z6) {
                this.uym = System.currentTimeMillis();
            } else {
            ...
            com.bytedance.sdk.component.utils.ul.xq("PAGBannerAdImpl", e6.getMessage());
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void emc(boolean z6, rie rieVar) {
        if (z6 && this.dg.pdv() && !this.dg.sb()) {
            this.dg.ycc(true);
            rie rieVar2 = this.dg;
            com.bytedance.sdk.openadsdk.dg.xq.emc(rieVar2, this.xq, rieVar2.du());
        }
        iyl.ypw(new C0053emc(z6, rieVar, this), 10);
    }
    ...
    public void emc(final ul ulVar, final rie rieVar) {
        emc emcVar;
        rie rieVar2;
        final ul ulVar2;
