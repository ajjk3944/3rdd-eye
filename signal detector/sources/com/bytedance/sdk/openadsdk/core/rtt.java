...
public class rtt implements com.bytedance.sdk.component.adexpress.bw.ypw, sf.emc, com.bytedance.sdk.openadsdk.gbl.ypw {
    ...
    private com.bytedance.sdk.openadsdk.core.model.rie aa;
    private int cf;
    ...
    private boolean dr() {
        com.bytedance.sdk.openadsdk.core.model.rie rieVar = this.aa;
        if (rieVar == null || rieVar.orp() == null || com.bytedance.sdk.openadsdk.core.model.dr.ypw(this.aa) || this.lt || this.aa.orp().optInt("parent_type") != 2) {
            return false;
        }
        int iMfx = this.aa.mfx();
        if (iMfx != 8 && iMfx != 7) {
            return false;
        }
        this.lt = true;
    ...
    private void qh(JSONObject jSONObject) throws JSONException {
        if (TextUtils.isEmpty(com.bytedance.sdk.openadsdk.core.model.dr.ru(this.aa))) {
            return;
        }
        jSONObject.put("playable_style", com.bytedance.sdk.openadsdk.core.model.dr.ru(this.aa));
    }
    ...
    private void sb() {
        ...
        TTWebsiteActivity.emc(this.yz, this.aa, this.mxo);
    }
    ...
    private void sz(JSONObject jSONObject) throws JSONException {
        emc(jSONObject, this.aa);
    }
    ...
    private void vk(JSONObject jSONObject) {
        ...
        xqVar.emc(jSONObject.optBoolean("isRenderSuc", false), jSONObject.optInt("code", -1), jSONObject.optString("msg", ""));
    }

    private void xmt() {
        if (this.zz == null) {
            this.zz = com.bytedance.sdk.openadsdk.gbl.emc.emc(this, this.aa);
        }
    }
    ...
    private void yzg(JSONObject jSONObject) {
        ...
        try {
            String strOptString = jSONObject.optString("msg", msw.emc(i3));
            i = i3;
            try {
                int iOptInt = jSONObject.optInt("code", i);
                qhVar.emc(z6);
        ...
        try {
            ...
            if (jSONObject != null) {
                ...
                if (rieVar != null && rieVar.ix() != null) {
                    this.ylm.put("dynamic_configs", this.aa.ix());
                }
                com.bytedance.sdk.openadsdk.core.model.rie rieVar2 = this.aa;
                if (rieVar2 != null) {
    ...
    public void ycc(JSONObject jSONObject) {
        ...
        if (rieVarEmc != null) {
            boolean zUym = com.bytedance.sdk.openadsdk.core.model.ul.uym(this.aa);
    ...
    private boolean ul(JSONObject jSONObject) {
    ...
    public void bw(JSONObject jSONObject) {
        ...
        try {
            ...
            com.bytedance.sdk.openadsdk.core.model.vk vkVarEmc = new vk.emc().dg((float) d10).xq((float) dOptDouble).ypw((float) d7).emc((float) d6).ypw((long) d8).emc((long) d9).emc(strOptString2).emc((SparseArray<xq.emc>) null).emc(true).ypw(iOptInt).emc(jSONObjectOptJSONObject).emc(jSONObject.optInt("clickAreaCategory", -1)).ypw(jSONObjectOptJSONObject2).emc();
    ...
    public void xq(JSONObject jSONObject) {
        sba.emc(rie(), this.yz instanceof Activity, jSONObject, this.aa, this.mxo, this.sz, ul(), this.uym);
    }
    ...
    public rtt ypw(int i) {
        this.sz = i;
        return this;
    }

    public static void ypw(JSONObject jSONObject) throws JSONException {
        ...
        com.bytedance.sdk.openadsdk.dg.xq.emc(new com.bytedance.sdk.component.msw.msw("sendLogV3") { // from class: com.bytedance.sdk.openadsdk.core.rtt.3
            ...
            public void run() throws JSONException {
                ...
                if (jSONObjectOptJSONObject != null && jSONObjectOptJSONObject.has("category") && jSONObjectOptJSONObject.has("tag") && jSONObjectOptJSONObject.has("label")) {
                    ...
                    new emc.C0085emc(System.currentTimeMillis(), rtt.this.aa).dg(strOptString).ypw(strOptString2).xq(strOptString3).bw(String.valueOf(jOptLong)).ycc(String.valueOf(jOptLong2)).emc(jSONObjectOptJSONObject).emc((com.bytedance.sdk.openadsdk.dg.ypw.emc) null);
                }
            }
        });
    }
        ...
        if (yccVar != null && (webView = yccVar.getWebView()) != null) {
            try {
                ...
                if (com.bytedance.sdk.openadsdk.sra.emc.uym()) {
                    ...
                    com.bytedance.sdk.openadsdk.sup.emc.ul.emc(this.mkp, yccVar, this, this.aa);
                } else {
                    com.bytedance.sdk.openadsdk.sup.emc.uym.emc(this.mkp, this);
                    com.bytedance.sdk.openadsdk.sup.emc.zz.emc(this.mkp, this);
                    com.bytedance.sdk.openadsdk.sup.emc.yzg.emc(this.mkp, yccVar, this, this.aa);
                }
                ...
                com.bytedance.sdk.openadsdk.sup.emc.qh.emc(this.mkp, this, this.aa);
                ...
                com.bytedance.sdk.openadsdk.sup.emc.sba.emc(this.mkp, this.aa);
            } catch (Exception unused) {
            }
        }
        return this;
    ...
    public JSONObject zz(JSONObject jSONObject) throws JSONException {
        ...
        try {
            ...
            if (ypwVar != null && (listFfd = ypwVar.ffd()) != null) {
                for (int i = 0; i < listFfd.size(); i++) {
                    jSONArray.put(xq(listFfd.get(i)));
                }
            }
    ...
    public static void ypw(com.bytedance.sdk.openadsdk.core.zz.cf cfVar, JSONObject jSONObject) {
        ...
        try {
            cfVar.emc(jSONObject.optBoolean("mute", false), !jSONObject.has("mute") ? "jsb_def" : "jsb_web");
        } catch (Exception unused) {
        }
    }
    ...
    public static JSONObject ypw(com.bytedance.sdk.openadsdk.core.model.rie rieVar) throws JSONException {
        ...
        if (aa.dg() != null) {
            ...
            boolean z6 = aa.dg().sz(String.valueOf(iTx)) == 1;
            if (iMfx != 7 && iMfx != 8) {
            ...
            if (com.bytedance.sdk.openadsdk.core.model.ul.xq(rieVar)) {
                ...
                jSONObject.put("skip_change_to_close", z6);
            }
    ...
    public static void emc(JSONObject jSONObject, com.bytedance.sdk.openadsdk.core.model.rie rieVar) throws JSONException {
        String strYe = rieVar.ye();
        if (!TextUtils.isEmpty(strYe)) {
            jSONObject.put("cid", strYe);
        }
        ...
        if (!TextUtils.isEmpty(strDrx)) {
            jSONObject.put("download_url", strDrx);
        }
            ...
            com.bytedance.sdk.openadsdk.dg.xq.emc(new com.bytedance.sdk.component.msw.msw("log_event_handleUri") { // from class: com.bytedance.sdk.openadsdk.core.rtt.2
                ...
                public void run() throws JSONException, NumberFormatException {
                    ...
                    if (rtt.this.msw(queryParameter3)) {
                        long j7 = 0;
                        try {
                            j6 = Long.parseLong(uri.getQueryParameter("value"));
                        } catch (Exception unused) {
                            j6 = 0;
                        }
                        try {
                            j7 = Long.parseLong(uri.getQueryParameter("ext_value"));
                        } catch (Exception unused2) {
                        }
                        long j8 = j7;
                        ...
                        com.bytedance.sdk.openadsdk.dg.xq.emc(rtt.this.aa, queryParameter, strEmc, queryParameter3, j6, j8, jSONObject, com.bytedance.sdk.openadsdk.core.model.ul.uym(rtt.this.aa));
                    }
                }
            });
        } catch (Exception unused) {
    ...
    /* JADX WARN: Removed duplicated region for block: B:222:0x03b7 A[PHI: r4
  0x03b7: PHI (r4v19 org.json.JSONObject) = (r4v14 org.json.JSONObject), (r4v20 org.json.JSONObject) binds: [B:239:0x0402, B:221:0x03b5] A[DONT_GENERATE, DONT_INLINE]] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public org.json.JSONObject emc(com.bytedance.sdk.openadsdk.core.rtt.ypw r27, int r28) throws org.json.JSONException {
        /*
    ...
    private void emc(JSONObject jSONObject, boolean z6, String str) {
        com.bytedance.sdk.openadsdk.core.widget.bw bwVar;
        if (z6) {
            try {
                String strOptString = jSONObject.optString("ad_extra_data");
                if (TextUtils.isEmpty(strOptString) || new JSONObject(strOptString).optInt("agg_request_type", -1) != 1 || !"click".equals(str) || (bwVar = this.uym) == null) {
                    return;
                }
                bwVar.emc();
            } catch (Throwable th) {
    ...
    private boolean emc(JSONObject jSONObject, JSONObject jSONObject2) throws JSONException {
        ...
        if (iOptInt == 1) {
            if (!com.bytedance.sdk.component.utils.sba.emc(strOptString)) {
                try {
                    ...
                    com.bytedance.sdk.component.utils.ul.emc("TTAD.AndroidObject", "handleUrl, EX1->: ", e6);
                }
                return false;
            }
            return true;
        ...
        if (iOptInt == 2) {
            try {
                ...
                com.bytedance.sdk.component.utils.ul.emc("TTAD.AndroidObject", "handleUrl, EX2->: ", e7);
            }
        }
        return true;
    }
    ...
    public void emc(final ypw ypwVar, final JSONObject jSONObject) {
        ...
        try {
            emc(ypwVar.dg, new com.bytedance.sdk.openadsdk.sz.dg() { // from class: com.bytedance.sdk.openadsdk.core.rtt.8
                ...
                public void emc(boolean z6, com.bytedance.sdk.openadsdk.core.model.emc emcVar) throws JSONException {
                    if (!z6) {
    ...
    private boolean emc(String str, int i, com.bytedance.sdk.openadsdk.core.model.vk vkVar) {
    ...
    public void emc(JSONObject jSONObject, final com.bytedance.sdk.openadsdk.sz.dg dgVar) throws JSONException {
        ...
        try {
            final com.bytedance.sdk.openadsdk.sz.dg dgVar2 = new com.bytedance.sdk.openadsdk.sz.dg() { // from class: com.bytedance.sdk.openadsdk.core.rtt.9
                @Override // com.bytedance.sdk.openadsdk.sz.dg
                public void emc(final boolean z6, final com.bytedance.sdk.openadsdk.core.model.emc emcVar) {
            ...
            if (this.aa != null && !TextUtils.isEmpty(this.sup)) {
                int iMfx = this.aa.mfx();
                AdSlot adSlotVaf = this.aa.vaf();
                com.bytedance.sdk.openadsdk.core.model.sb sbVar = new com.bytedance.sdk.openadsdk.core.model.sb();
                sbVar.ycc = true;
                if (this.aa.zhk() != null || this.aa.kv() != null) {
                    sbVar.zz = 2;
                }
            ...
            com.bytedance.sdk.component.utils.ul.emc("TTAD.AndroidObject", "get ads error", e6);
        }
    }
    ...
    public String emc(String str, String str2) {
        if (com.bytedance.sdk.openadsdk.core.model.ul.uym(this.aa)) {
            if ("show".equals(str2)) {
                return com.bytedance.sdk.openadsdk.utils.tp.emc(this.sz);
            }
            return "aggregate_page";
        }
        if (com.bytedance.sdk.openadsdk.core.model.dr.bw(this.aa)) {
            return this.ycc;
        }
        if (this.sb != null) {
            return com.bytedance.sdk.openadsdk.utils.tp.emc(this.sz);
    ...
    private void emc(com.bytedance.sdk.openadsdk.core.model.rie rieVar, String str, boolean z6) {
