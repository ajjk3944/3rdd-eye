...
public class dg extends bw {
    ...
    public dg(Context context, ViewGroup viewGroup, boolean z6, int i, rie rieVar, f fVar, boolean z7) {
        super(context, viewGroup, z6, i, rieVar, fVar, z7);
    ...
    @Override // com.bytedance.sdk.openadsdk.core.sz.ypw.bw, L1.g
    @SuppressLint({"ClickableViewAccessibility"})
    ...
    public void xq(boolean z6) {
        ...
        if (textView != null) {
            vw.emc((View) textView, (!this.ylm && z6) ? 0 : 8);
        }
    }
    ...
    public void ypw(boolean z6) {
        int i = ru() ? this.pm : this.aa;
        int iYpw = ru() ? this.bv : this.sba;
        if (this.ul <= 0 || this.yzg <= 0 || i <= 0) {
            return;
        }
        ...
        float f2 = this.yzg;
        float f5 = this.ul;
        int i3 = (int) (((i * 1.0f) / f2) * f5);
        if (i3 > iYpw) {
            i = (int) (((iYpw * 1.0f) / f5) * f2);
        } else {
            iYpw = i3;
        }
        if (!z6 && !ru()) {
    ...
    public void emc(int i) {
        ...
        if (view == null || view.getVisibility() != 0) {
            this.rqm.setProgress(i);
        }
    }

    @Override // com.bytedance.sdk.openadsdk.core.sz.ypw.bw
    public void emc(long j6, long j7) {
        this.wad.setText(a.b(j7));
        this.but.setText(a.b(j6));
        this.rqm.setProgress(a.a(j6, j7));
    }
    ...
    @Override // com.bytedance.sdk.openadsdk.core.sz.ypw.bw
    @SuppressLint({"ClickableViewAccessibility"})
    public void emc(rie rieVar, WeakReference<Context> weakReference, boolean z6) {
        String strVyk;
        String strEmc;
        rie rieVar2;
        if (rieVar == null) {
        ...
        vw.emc(this.sup, 0);
        if (this.gbl != null && (rieVar2 = this.ee) != null && rieVar2.iat() != null && this.ee.iat().f6585f != null) {
            com.bytedance.sdk.openadsdk.yzg.ypw.ypw().emc(this.ee.iat().f6585f, this.ee.iat().f6581b, this.ee.iat().f6580a, this.gbl, this.ee);
        }
