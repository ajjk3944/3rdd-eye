...
public class hxp extends com.bytedance.sdk.component.adexpress.bw.emc {
    private com.bytedance.sdk.component.adexpress.ypw.uym aa;
    ...
    public hxp(Context context, com.bytedance.sdk.component.adexpress.ypw.sz szVar, ThemeStatusBroadcastReceiver themeStatusBroadcastReceiver, com.bytedance.sdk.openadsdk.dg.dg.bw bwVar, com.bytedance.sdk.openadsdk.core.model.rie rieVar) {
        ...
        this.cf = DesugarCollections.synchronizedMap(new HashMap());
        this.yzg = 0;
        ...
        this.sra = new Runnable() { // from class: com.bytedance.sdk.openadsdk.core.zz.hxp.2
            @Override // java.lang.Runnable
            public void run() {
                if (((com.bytedance.sdk.component.adexpress.bw.emc) hxp.this).ycc.get() || hxp.this.aa == null) {
                    return;
                }
                hxp.this.sup();
                hxp hxpVar = hxp.this;
                hxp.super.emc(hxpVar.aa);
            }
        };
        if (this.dg == null) {
            return;
    ...
    public void onThemeChanged(int i) throws JSONException {
        if (this.vk == null) {
            return;
        }
    ...
    public void ypw(int i) {
        ...
        try {
            ...
            com.bytedance.sdk.component.utils.ul.xq("TTAD.WebViewRender", e6.getMessage());
        }
    }
    ...
    private void ypw(boolean z6) throws JSONException {
    ...
    private void emc(com.bytedance.sdk.component.zz.ycc yccVar) {
        ...
        try {
            ...
            com.bytedance.sdk.component.utils.ul.xq("TTAD.WebViewRender", e6.toString());
        }
    }
