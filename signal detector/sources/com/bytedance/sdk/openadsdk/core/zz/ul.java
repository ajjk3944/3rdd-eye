...
public class ul extends com.bytedance.sdk.openadsdk.core.ycc.xq implements com.bytedance.sdk.component.adexpress.dynamic.dg, com.bytedance.sdk.component.adexpress.ypw.cf, com.bytedance.sdk.component.adexpress.ypw.msw, emc.InterfaceC0081emc, cf {
    boolean aa;
    ...
    public ul(Context context, com.bytedance.sdk.openadsdk.core.model.rie rieVar, AdSlot adSlot, String str) {
        super(context);
        this.emc = true;
        this.ypw = 0;
        this.ru = "embeded_ad";
    ...
    private void cf() {
        ...
        try {
            ...
            com.bytedance.sdk.component.utils.ul.emc("NativeExpressView", "NativeExpressView dynamicRender fail", e6);
        }
        aa();
        this.wad = new com.bytedance.sdk.component.adexpress.ypw.sup(this.but, this.xhi);
    }
            ...
            if (!com.bytedance.sdk.openadsdk.core.gbl.ycc.emc.dg.emc(this.ru) || (rieVar = this.sup) == null || rieVar.yid() == 2) {
                ...
                if (i != 0) {
                    if (i == 3) {
                        ...
                        boolean z6 = this.sra;
                        com.bytedance.sdk.component.adexpress.ypw.ypw ypwVar = new com.bytedance.sdk.component.adexpress.ypw.ypw(applicationContext, szVar, themeStatusBroadcastReceiver, z6, uymVar, this, emcVar, new ycc(this.zz, themeStatusBroadcastReceiver, z6, uymVar, szVar, emcVar));
                        this.sb = ypwVar;
                        this.but.add(ypwVar);
                        return;
                    }
    ...
    */
    ...
    public void a_(int i) {
        ...
        if (pAGExpressAdWrapperListener != null) {
            pAGExpressAdWrapperListener.onRenderFail(this, com.bytedance.sdk.openadsdk.core.msw.emc(i), i);
        }
        sra sraVar = this.vw;
        if (sraVar != null) {
    ...
    public boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        if (actionMasked != 0) {
            ...
            if (actionMasked == 1) {
                ...
                this.ltx = Math.abs(motionEvent.getX() - this.wbn) + this.ltx;
                this.rig = Math.abs(motionEvent.getY() - this.jp) + this.rig;
                this.wbn = motionEvent.getX();
                this.jp = motionEvent.getY();
                i = (System.currentTimeMillis() - this.pe <= 200 || (this.ltx <= 8.0f && this.rig <= 8.0f)) ? 2 : 1;
            }
        } else {
        ...
        if (sparseArray != null) {
            sparseArray.put(motionEvent.getActionMasked(), new xq.emc(i, motionEvent.getSize(), motionEvent.getPressure(), System.currentTimeMillis()));
        }
        try {
    ...
    public void onWindowFocusChanged(boolean z6) {
        ...
        sb();
        com.bytedance.sdk.openadsdk.ee.emc.xq.emc(this.sup, z6);
        if (z6) {
    ...
    public void setClickCreativeListener(msw mswVar) {
        this.ycc = mswVar;
        if (mswVar != null) {
            mswVar.emc((emc.InterfaceC0081emc) this);
        }
    }
    ...
    public void setSoundMute(boolean z6) {
        ...
        if (ypwVar != null && ypwVar.ypw() != null) {
            this.sb.ypw().setSoundMute(z6);
        }
        com.bytedance.sdk.component.adexpress.ypw.dg<? extends View> dgVar = this.sf;
        if (dgVar instanceof com.bytedance.sdk.openadsdk.core.gbl.ycc.dg) {
            ((com.bytedance.sdk.openadsdk.core.gbl.ycc.dg) dgVar).setSoundMute(z6);
        }
    }
    ...
    public void setTime(CharSequence charSequence, int i, int i3, boolean z6) throws NumberFormatException {
        try {
            int i6 = Integer.parseInt(String.valueOf(charSequence));
            ypw(i6, i);
    ...
    public void ypw(int i, int i3) {
        ...
        String str = this.ru;
        int i6 = this.rie;
        int i7 = ((i3 < i6 || i6 < 0 || !(this.hxp || TextUtils.equals(str, "open_ad"))) && !((i == 0 && TextUtils.equals(this.ru, "open_ad")) || bw() == 5)) ? 0 : 1;
        if (i3 <= this.rie) {
            com.bytedance.sdk.openadsdk.core.model.rie rieVar = this.sup;
            if (rieVar != null && rieVar.iat() != null) {
                iMin = (int) (Math.min(this.rie, this.sup.iat().f6583d * this.sup.iat().f6596r) - i3);
            } else {
                iMin = this.rie - i3;
            }
        } else {
        ...
        com.bytedance.sdk.component.adexpress.ypw.ypw ypwVar = this.sb;
        if (ypwVar != null && ypwVar.ypw() != null) {
            this.sb.ypw().setTime(String.valueOf(i), i7, iMin, false);
        }
        com.bytedance.sdk.component.adexpress.ypw.dg<? extends View> dgVar = this.sf;
        if (dgVar instanceof com.bytedance.sdk.openadsdk.core.gbl.ycc.dg) {
            ((com.bytedance.sdk.openadsdk.core.gbl.ycc.dg) dgVar).setTime(String.valueOf(i), i7, iMin, false);
        }
    }
    ...
    public void emc(int i, boolean z6, boolean z7) {
        this.aa = z6;
    ...
    public void emc(View view, int i, com.bytedance.sdk.component.adexpress.xq xqVar) {
        ...
        com.bytedance.sdk.component.utils.ul.emc("ClickCreativeListener", "trigger Class2 method1", Integer.valueOf(i));
        if (i == -1 || xqVar == null) {
            return;
        }
        ...
        if (i != 13) {
            switch (i) {
                case 1:
                    ...
                    com.bytedance.sdk.openadsdk.core.model.rie rieVar = this.sup;
                    if (rieVar == null || rieVar.jp() != 1 || z6) {
                        zz zzVar2 = this.uym;
                        if (zzVar2 != null) {
                            zzVar2.emc(vkVar);
                            this.uym.emc(str);
                            this.uym.emc(view2, f2, f5, f6, f7, sparseArray2, z6);
                        }
                        PAGExpressAdWrapperListener pAGExpressAdWrapperListener = this.bw;
                ...
                case 2:
                    ...
                    if (mswVar2 != null) {
                        ...
                        this.ycc.emc(view2, f2, f5, f6, f7, sparseArray2, z6);
                    }
                ...
                case 4:
                    ...
                    com.bytedance.sdk.openadsdk.core.model.rie rieVar2 = this.sup;
                    if (rieVar2 == null || rieVar2.jp() != 1 || z6) {
                        tp.xq(this.sup);
    ...
    public void ypw(int i, String str) throws JSONException {
        rtt rttVarVk;
        com.bytedance.sdk.component.adexpress.ypw.dg<? extends View> dgVar = this.sf;
    ...
    public void uym(int i) {
        com.bytedance.sdk.component.adexpress.ypw.dg<? extends View> dgVar = this.sf;
        if ((dgVar instanceof com.bytedance.sdk.openadsdk.core.gbl.ycc.uym) && i == 4) {
            ((com.bytedance.sdk.openadsdk.core.gbl.ycc.uym) dgVar).ru();
        }
    }

    public ul(Context context, com.bytedance.sdk.openadsdk.core.model.rie rieVar, AdSlot adSlot, String str, boolean z6, boolean z7) {
        super(context);
        this.emc = true;
        this.ypw = 0;
        this.ru = "embeded_ad";
    ...
    public void emc(com.bytedance.sdk.component.adexpress.ypw.dg<? extends View> dgVar, com.bytedance.sdk.component.adexpress.ypw.qh qhVar) {
        ...
        if (dgVar.xq() != 1 || (dgVar instanceof com.bytedance.sdk.openadsdk.core.gbl.ycc.dg)) {
            ...
            for (int i3 = 0; i3 < arrayList.size(); i3++) {
                if (arrayList.get(i3) instanceof com.bytedance.sdk.component.zz.ycc) {
    ...
    public void emc(com.bytedance.sdk.openadsdk.core.model.rie rieVar, AdSlot adSlot, String str, boolean z6, boolean z7) {
        if (rieVar == null) {
            return;
        }
        this.ru = str;
