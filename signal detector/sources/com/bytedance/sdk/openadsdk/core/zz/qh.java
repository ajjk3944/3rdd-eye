...
public class qh {
    ...
    public static File emc(String str) {
        ...
        if (com.bytedance.sdk.openadsdk.multipro.ypw.xq()) {
            strE = AbstractC2763b.e(name, "/express_static_res/");
        } else {
            strE = AbstractC2763b.e(name, "/express_static_res/");
        }
        return com.bytedance.sdk.component.utils.uym.emc(com.bytedance.sdk.openadsdk.core.aa.emc(), com.bytedance.sdk.openadsdk.multipro.ypw.xq(), strE, strEmc);
    }
}
