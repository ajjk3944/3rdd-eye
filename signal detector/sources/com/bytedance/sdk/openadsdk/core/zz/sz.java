...
public class sz implements com.bytedance.adsdk.ugeno.core.sba, com.bytedance.sdk.component.adexpress.ypw.zz {
    ...
    public sz(com.bytedance.sdk.openadsdk.dg.dg.bw bwVar, String str, com.bytedance.sdk.openadsdk.core.model.rie rieVar, String str2, boolean z6) {
        this.emc = bwVar;
        this.ypw = str;
        this.dg = str2;
        this.xq = rieVar;
    ...
    public void emc(int i, String str) throws JSONException {
        this.emc.emc(i, str);
        gbl.emc("Web", i, str, this.ypw, this.dg, this.xq);
    }
    ...
    @Override // com.bytedance.sdk.component.adexpress.ypw.zz
    public void emc(int i, int i3, String str, boolean z6) throws JSONException {
        if (!z6) {
            this.emc.emc(true);
        }
        if (i == 3) {
            this.emc.ypw(i3, "dynamic_render2_error");
        } else {
            this.emc.ypw(i3, "dynamic_render_error");
        }
        gbl.emc("NDR", i3, str, this.ypw, this.dg, this.xq);
    }
