...
public class yzg extends ul implements b, d {
    int bw;
    ...
    public yzg(Context context, com.bytedance.sdk.openadsdk.core.model.rie rieVar, AdSlot adSlot, String str, boolean z6) {
    ...
    private void setShowAdInteractionView(boolean z6) {
        vk vkVar = this.emc;
        if (vkVar != null) {
            vkVar.setShowAdInteractionView(z6);
        }
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void xq(com.bytedance.sdk.component.adexpress.ypw.qh qhVar) {
    ...
    public void dg(int i) {
        int iYpw = com.bytedance.sdk.openadsdk.core.aa.dg().ypw(i);
        if (3 == iYpw) {
            this.xq = false;
            this.dg = false;
        } else if (4 == iYpw) {
    ...
    private void ypw(long j6, long j7) throws JSONException {
        int iAbs = (int) Math.abs(this.sba - j6);
        int i = this.sba;
        if (i < 0 || iAbs > 500 || i > j7 || iAbs >= 500 || this.ul.contains(this.yzg)) {
            return;
        }
        if (this.sba > j6) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public boolean emc(com.bytedance.sdk.component.adexpress.ypw.qh qhVar, boolean z6) {
        int i;
        double dBw = qhVar.bw();
        double dYcc = qhVar.ycc();
        double dUym = qhVar.uym();
        double dMsw = qhVar.msw();
        if ((dUym == 0.0d || dMsw == 0.0d) && (i = this.msw) != 7 && i != 10 && i != 9 && !(this.sf instanceof com.bytedance.sdk.openadsdk.core.gbl.ycc.dg)) {
            return false;
        }
    ...
    @Override // L1.d
    public void emc(long j6, long j7) throws JSONException {
        this.ycc = false;
        int i = this.ypw;
        if (i != 5 && i != 3 && j6 > this.xmt) {
            this.ypw = 2;
        }
        this.xmt = j6;
        this.lt = j7;
        com.bytedance.sdk.component.adexpress.ypw.ypw ypwVar = this.sb;
        if (ypwVar != null && ypwVar.ypw() != null) {
            this.sb.ypw().setTimeUpdate(((int) (j7 - j6)) / TTAdConstant.STYLE_SIZE_RADIO_1_1);
        }
        com.bytedance.sdk.component.adexpress.ypw.dg<? extends View> dgVar = this.sf;
        if (dgVar instanceof com.bytedance.sdk.openadsdk.core.gbl.ycc.dg) {
            ((com.bytedance.sdk.openadsdk.core.gbl.ycc.dg) dgVar).setTimeUpdate(((int) (j7 - j6)) / TTAdConstant.STYLE_SIZE_RADIO_1_1);
            ((com.bytedance.sdk.openadsdk.core.gbl.ycc.dg) this.sf).emc(j6, j7);
        }
        ypw(j6, j7);
    }
