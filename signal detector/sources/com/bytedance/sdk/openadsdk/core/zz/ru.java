...
public class ru extends com.bytedance.sdk.openadsdk.core.widget.emc.bw {
    ...
    private WebResourceResponse bw() throws Resources.NotFoundException {
        ...
        if (resources != null) {
            try {
                ...
                com.bytedance.sdk.component.utils.ul.xq("ExpressClient", e6.toString());
            }
        } else {
            inputStreamOpenRawResource = null;
        }
        if (inputStreamOpenRawResource != null) {
            return new WebResourceResponse(zz.emc.IMAGE.emc(), "UTF-8", inputStreamOpenRawResource);
        }
        return null;
    }
    ...
    private WebResourceResponse dg(String str, zz.emc emcVar) {
        ...
        WebResourceResponse webResourceResponse = new WebResourceResponse(emcVar.emc(), "UTF-8", inputStreamYpw);
    ...
    */
            ...
            if (emcVarEmc != zz.emc.IMAGE) {
                ...
                while (true) {
                    ...
                    if (!TextUtils.isEmpty(next.emc()) && !TextUtils.isEmpty(str)) {
                        ...
                        if (strEmc.startsWith("https")) {
                            strEmc = strEmc.replaceFirst("https", "http");
                        }
                        if ((str.startsWith("https") ? str.replaceFirst("https", "http") : str).equals(strEmc)) {
                            sbaVar = next;
                            break;
                        }
                    }
    ...
    private WebResourceResponse bw(String str) {
        ...
        WebResourceResponse webResourceResponse = new WebResourceResponse("audio/*", "UTF-8", inputStreamEmc);
        emc(webResourceResponse);
        return webResourceResponse;
    }
    ...
    private com.bytedance.sdk.component.adexpress.emc.ypw.emc emc(String str, zz.emc emcVar) {
        ...
        if (cufVarKv != null && (emcVarYcc = cufVarKv.ycc()) != null && (jSONArrayEmc = emcVarYcc.emc()) != null && jSONArrayEmc.length() > 0) {
            for (int i = 0; i < jSONArrayEmc.length(); i++) {
                if (TextUtils.equals(com.bytedance.sdk.openadsdk.core.gbl.dg.emc(jSONArrayEmc.optString(i), com.bytedance.sdk.openadsdk.core.settings.gbl.xq().ylm()), str) && emcVar == zz.emc.IMAGE) {
                    com.bytedance.sdk.component.adexpress.emc.ypw.emc emcVar2 = new com.bytedance.sdk.component.adexpress.emc.ypw.emc();
                    emcVar2.emc(5);
    ...
    private com.bytedance.sdk.component.adexpress.emc.ypw.emc emc(JSONArray jSONArray, String str, zz.emc emcVar) {
        if (jSONArray != null && jSONArray.length() > 0) {
            for (int i = 0; i < jSONArray.length(); i++) {
                if (TextUtils.equals(com.bytedance.sdk.openadsdk.core.gbl.dg.emc(jSONArray.optString(i), com.bytedance.sdk.openadsdk.core.settings.gbl.xq().ylm()), str)) {
                    com.bytedance.sdk.component.adexpress.emc.ypw.emc emcVar2 = new com.bytedance.sdk.component.adexpress.emc.ypw.emc();
                    emcVar2.emc(5);
    ...
    private void emc(long j6, long j7, String str, int i) {
        ...
        if (emcVarEmc == zz.emc.HTML) {
            this.ycc.ypw().emc(str, j6, j7, i);
        } else if (emcVarEmc == zz.emc.JS) {
            this.ycc.ypw().ypw(str, j6, j7, i);
        }
    }
