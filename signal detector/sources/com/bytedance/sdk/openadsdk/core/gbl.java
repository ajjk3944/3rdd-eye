...
public class gbl {
            ...
            public void run() throws JSONException {
                ...
                try {
                    ...
                    if (jSONObjectEncryptType4 == null || jSONObjectEncryptType4.optInt("cypher") != 4) {
                        ...
                        dgVarYpw.ypw("Content-Type", "application/json; charset=utf-8");
                    }
                    ...
                    com.bytedance.sdk.openadsdk.vk.xq.emc(-1, strYzg, -2, e6.getMessage());
                    com.bytedance.sdk.openadsdk.vk.emc.bw.emc("ipv6", strYzg, -3, e6.getMessage());
                    ...
                    com.bytedance.sdk.component.utils.ul.xq("build ipv6 request failed:" + e6.getMessage(), new Object[0]);
                }
            }
        });
    }
    ...
    public static class emc implements sb.emc {
        ...
        public void emc(Context context, Intent intent, boolean z6, int i) {
            if (System.currentTimeMillis() - ypw >= 2000 && i != 0) {
                gbl.xq();
                gbl.ypw(sup.emc(aa.emc()));
                ypw();
            }
