...
public class ypw implements vk, emc.InterfaceC0056emc {
    ...
    public void emc() {
        ...
        this.zz = this.dg.uie();
        this.ru.emc("endcard");
        com.bytedance.sdk.openadsdk.core.gbl.emc.ypw.emc().emc("endcard", this.msw, this.ycc, this.uym, "", new ypw.emc() { // from class: com.bytedance.sdk.openadsdk.core.gbl.dg.ypw.1
    ...
    public void emc(JSONObject jSONObject, JSONObject jSONObject2) throws JSONException {
        this.ypw.emc((emc.InterfaceC0056emc) this);
    ...
    @Override // com.bytedance.sdk.openadsdk.core.gbl.dg.emc.InterfaceC0056emc
    ...
    private void emc(sz szVar, rie rieVar) throws JSONException {
        ...
        try {
            ...
            if (viewGbl != null) {
                ...
                jSONObject2.put("left", f2);
                jSONObject2.put("top", f5);
            ...
            com.bytedance.sdk.openadsdk.dg.xq.emc(rieVar, this.sup, "click", jSONObject);
    ...
    public void emc(xq xqVar, MotionEvent motionEvent) {
        ...
        if (Math.abs(this.vk - this.qh) >= emc || Math.abs(this.aa - this.cf) >= emc) {
            this.ul = false;
        }
