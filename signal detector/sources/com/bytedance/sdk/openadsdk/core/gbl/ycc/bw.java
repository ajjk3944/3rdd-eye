...
public class bw {
    ...
    public void xq() {
        ...
        if (!(xqVar instanceof com.bytedance.adsdk.ugeno.xq) || (i = this.emc) == -1) {
            return;
        }
        ((com.bytedance.adsdk.ugeno.xq) xqVar).emc(i + 1);
    }
    ...
    private void emc(TextView textView, int i) {
