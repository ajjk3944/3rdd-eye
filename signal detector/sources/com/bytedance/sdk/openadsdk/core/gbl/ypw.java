...
public class ypw {
    ...
    public ypw(Context context, boolean z6) {
        this.yzg = context;
        this.ul = z6;
    }
    ...
    */
    ...
    private void dg(com.bytedance.adsdk.ugeno.zz.ycc.emc emcVar) {
        if (!this.ul) {
            emcVar.setShadowLayer(this.aa, this.cf, this.vk, this.sz);
        } else if (this.qh) {
            float f2 = this.aa;
            if (f2 <= 0.0f) {
                f2 = 1.0E-5f;
            }
            emcVar.setShadowLayer(f2, this.cf, this.vk, this.sz);
        }
    }
    ...
    private void xq(com.bytedance.adsdk.ugeno.zz.ycc.emc emcVar) {
        float f2 = this.gbl;
        if (f2 <= 3.0f) {
            emcVar.setLineSpacing(0.0f, f2);
        } else if (Build.VERSION.SDK_INT >= 28) {
            int iRound = Math.round(msw.emc(this.yzg, (f2 - (this.xq * 1.2f)) / 2.0f));
    ...
    public void emc(String str, String str2) {
        ...
        switch (str) {
            ...
            case "textStyle":
                ...
                break;
            case "shadowBlur":
                this.aa = com.bytedance.adsdk.ugeno.uym.xq.emc(str2, 0.0f);
                break;
            case "textSize":
