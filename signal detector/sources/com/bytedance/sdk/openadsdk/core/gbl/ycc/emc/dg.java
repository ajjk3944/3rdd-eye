...
public class dg extends uym {
    ...
    public dg(Context context, rie rieVar, boolean z6, com.bytedance.sdk.openadsdk.core.gbl.ycc.emc emcVar, ViewGroup viewGroup, float f2, float f5, boolean z7, String str) throws JSONException {
        super(context, rieVar, z6, emcVar, viewGroup);
        this.ee = ypw.emc.emc(rieVar, emcVar);
        this.sra = str;
        emc(f2, f5, z7, rieVar, str);
    }

    private void emc(float f2, float f5, boolean z6, rie rieVar, String str) throws JSONException {
        JSONObject jSONObjectEmc = com.bytedance.sdk.openadsdk.core.zz.emc.ypw.emc(f2, f5, z6, rieVar, str);
    ...
    private boolean qh() {
        ...
        int iBlf = rieVar.blf();
        boolean z6 = iBlf == 7 || iBlf == 8;
        int iFu = this.bw.fu();
        return z6 && (iFu == 43 || iFu == 44);
    }
