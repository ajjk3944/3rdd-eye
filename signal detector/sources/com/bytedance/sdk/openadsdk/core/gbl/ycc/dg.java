...
public class dg implements cf, vk, com.bytedance.sdk.component.adexpress.dynamic.dg, com.bytedance.sdk.component.adexpress.ypw.dg<View> {
    ...
    public dg(Context context, rie rieVar, boolean z6, emc emcVar, ViewGroup viewGroup) {
        this.ypw = context;
        this.db = z6;
    ...
    @Override // com.bytedance.sdk.component.adexpress.dynamic.dg
    public void setSoundMute(boolean z6) throws JSONException {
        com.bytedance.adsdk.ugeno.ypw.xq<T> xqVarBw;
        com.bytedance.adsdk.ugeno.ypw.xq<View> xqVar = this.xq;
        if (xqVar == null || (xqVarBw = xqVar.bw("mute")) == 0) {
            return;
        }
        if (z6) {
    ...
    public void emc(rie rieVar, boolean z6, emc emcVar, ViewGroup viewGroup) {
        this.bw = rieVar;
        this.ycc = emcVar;
        this.sra = emcVar.dg();
        this.hxp = ypw();
    ...
    private void emc(sz szVar) {
        ...
        String strOptString = szVar.xq().optString("type");
        ...
        vk.emc emcVarEmc = new vk.emc().dg(this.qh).xq(this.cf).ypw(this.vk).emc(this.aa).ypw(this.sba).emc(this.yzg).emc(this.rie).emc(szVar.ypw() != 1 || this.ul);
        if (xqVarEmc == null) {
            str = "";
        } else {
            str = xqVarEmc.mkp() + "_" + xqVarEmc.rtt();
        }
        this.msw.emc(szVar.emc().gbl(), i, emcVarEmc.emc(str).ypw(zEmc).ypw(jSONObjectDg).emc());
    }
    ...
    private void ypw(CharSequence charSequence, boolean z6, int i, boolean z7) {
        com.bytedance.adsdk.ugeno.ypw.xq<T> xqVarBw;
        View viewGbl;
        com.bytedance.adsdk.ugeno.ypw.xq<View> xqVar = this.xq;
        ...
        if (viewGbl instanceof TextView) {
            ...
            if (!z7 && i3 > 0 && !this.tp) {
                ...
                if (!z6 && this.ycc.emc() && com.bytedance.sdk.component.adexpress.dg.ycc.ypw(this.ycc.dg())) {
                    ((TextView) viewGbl).setText(String.format(com.bytedance.sdk.component.utils.rie.emc(com.bytedance.sdk.component.adexpress.dg.emc(), "tt_reward_full_skip"), Integer.valueOf(i)));
                    return;
                }
