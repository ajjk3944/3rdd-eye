...
public class dr {
    ...
    public dr(JSONObject jSONObject) {
        ...
        if (jSONObjectOptJSONObject != null) {
            ...
            this.aa = jSONObjectOptJSONObject.optString("next_ad_in_xs");
    ...
    public static boolean qh(rie rieVar) {
        ...
        return cVarIat != null && cVarIat.f6592n == 1;
    }
    ...
    public static int emc(rie rieVar) {
        int i;
        dr drVarCn = rieVar.cn();
        if (drVarCn != null && (i = drVarCn.emc) >= 0 && i <= 100) {
            return i;
        }
        return 0;
    }
    ...
    public void emc(JSONObject jSONObject) {
        try {
            ...
            com.bytedance.sdk.component.utils.ul.xq("PlayableModel", e6.getMessage());
        }
        if (!TextUtils.isEmpty(this.ycc)) {
            ...
            try {
                ...
                jSONObject2.put("next_ad_in_xs", this.aa);
                ...
                com.bytedance.sdk.component.utils.ul.xq("PlayableModel", e7.getMessage());
            }
        }
        try {
            jSONObject.put("playable_type", this.dg);
        } catch (JSONException e8) {
            com.bytedance.sdk.component.utils.ul.xq("PlayableModel", e8.getMessage());
        }
        try {
            jSONObject.put("playable_style", this.bw);
        } catch (JSONException e9) {
            com.bytedance.sdk.component.utils.ul.xq("PlayableModel", e9.getMessage());
        }
    }
}
