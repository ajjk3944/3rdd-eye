        ...
        PAGLogoView pAGLogoView = new PAGLogoView(aa.emc()) { // from class: com.bytedance.sdk.openadsdk.emc.ypw.emc.4
            ...
            public void onLayout(boolean z6, int i, int i3, int i6, int i7) {
                ...
                try {
                    ...
                    int i8 = this.emc;
                    if (width < i8 || height < this.ypw) {
                        float fMin = Math.min(height / this.ypw, width / i8);
                        int i9 = (width - this.emc) / 2;
                        if (fMin != 1.0f) {
                            setScaleX(fMin);
                            setScaleY(fMin);
                            setTranslationX(i9);
            ...
            public void onMeasure(int i, int i3) {
                if (this.emc == 0) {
                    super.onMeasure(View.MeasureSpec.makeMeasureSpec(1073741823, LinearLayoutManager.INVALID_OFFSET), i3);
    ...
    private PAGMediaView emc(final View view) {
        ...
        PAGMediaView pAGMediaView = new PAGMediaView(this.ypw) { // from class: com.bytedance.sdk.openadsdk.emc.ypw.emc.3
            private void emc(boolean z6) {
                ...
                if (num != null) {
                    com.bytedance.sdk.openadsdk.ee.ypw.bw.emc(com.bytedance.sdk.openadsdk.ee.ypw.bw.emc(num), z6 ? 4 : 8);
                }
                rie rieVar = emc.this.emc;
                if (rieVar != null) {
                    com.bytedance.sdk.openadsdk.ee.emc.xq.emc(rieVar, z6);
                }
            }
