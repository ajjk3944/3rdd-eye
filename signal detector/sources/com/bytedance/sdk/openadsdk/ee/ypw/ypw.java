...
public abstract class ypw {
    ...
    public ypw(Integer num, View view, rie rieVar, int i, bw.emc emcVar) {
        this.msw = num;
        this.uym = i;
        this.ypw = rieVar;
        this.ycc = emcVar;
    ...
    public static ypw emc(boolean z6, Integer num, View view, rie rieVar, bw.emc emcVar) {
        return z6 ? new msw(num, view, rieVar, emcVar) : new xq(num, view, rieVar, emcVar);
    }
    ...
    public abstract void ypw(int i);
