...
public class uym extends emc {
    private static final Map<String, RemoteCallbackList<IRewardAdInteractionListener>> emc = DesugarCollections.synchronizedMap(new HashMap());
    ...
    public void executeRewardVideoCallback(String str, String str2, boolean z6, int i, String str3, int i3, String str4) {
        emc(str, str2, z6, i, str3, i3, str4);
    }
    ...
    private synchronized void emc(String str, String str2, boolean z6, int i, String str3, int i3, String str4) {
            ...
            if (map != null) {
                ...
                if (remoteCallbackListRemove != null) {
                    ...
                    for (int i6 = 0; i6 < iBeginBroadcast; i6++) {
                        try {
                            IRewardAdInteractionListener iRewardAdInteractionListener = (IRewardAdInteractionListener) remoteCallbackListRemove.getBroadcastItem(i6);
                            if (iRewardAdInteractionListener != null) {
                                if ("onAdShow".equals(str2)) {
                                    ...
                                    iRewardAdInteractionListener.onRewardVerify(z6, i, str3, i3, str4);
