...
public class PAGRewardFullExpressAdListenerProxy implements PAGExpressAdWrapperListener {
    ...
    public void onRenderFail(final View view, final String str, final int i) {
        ypw(new Runnable() { // from class: com.bytedance.sdk.openadsdk.api.reward.PAGRewardFullExpressAdListenerProxy.2
            ...
            public void run() {
                PAGRewardFullExpressAdListenerProxy.this.emc.onRenderFail(view, str, i);
            }
        });
    }

    @Override // com.bytedance.sdk.openadsdk.api.PAGExpressAdWrapperListener
    public void onRenderSuccess(final View view, final float f2, final float f5) {
        ypw(new Runnable() { // from class: com.bytedance.sdk.openadsdk.api.reward.PAGRewardFullExpressAdListenerProxy.3
            @Override // java.lang.Runnable
            public void run() {
                PAGRewardFullExpressAdListenerProxy.this.emc.onRenderSuccess(view, f2, f5);
            }
        });
    }
