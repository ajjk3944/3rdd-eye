...
public class PAGVideoMediaView extends PAGMediaView implements emc.InterfaceC0081emc {
    private rie dg;
    private final com.bytedance.sdk.openadsdk.emc.ypw.emc xq;
    private ycc ypw;

    public PAGVideoMediaView(Context context, View view, com.bytedance.sdk.openadsdk.emc.ypw.emc emcVar) {
        super(context);
        emc(view);
        this.xq = emcVar;
    }
    ...
    public void setOnClickListener(View.OnClickListener onClickListener) {
        ...
        if (onClickListener instanceof emc) {
            ((emc) onClickListener).emc((emc.InterfaceC0081emc) this);
        }
    }
