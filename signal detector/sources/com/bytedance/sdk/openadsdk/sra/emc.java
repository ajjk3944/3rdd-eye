...
public class emc {
                    ...
                    if (xq == null) {
                        try {
                            xq xqVar = new xq(new dg() { // from class: com.bytedance.sdk.openadsdk.sra.emc.1
                                ...
                                public JSONObject ycc() {
                                    try {
                                        ...
                                        if (!jSONObjectEmc.has("app_id")) {
                                            if (!TextUtils.isEmpty(str)) {
                                                jSONObjectEmc.put("app_id", str);
                                            } else {
                                                if (TextUtils.isEmpty(com.bytedance.sdk.openadsdk.core.zz.ypw().dg())) {
                                                    return null;
                                                }
                                                jSONObjectEmc.put("app_id", com.bytedance.sdk.openadsdk.core.zz.ypw().dg());
                                            }
                                        }
                                ...
                                @Override // com.bytedance.sdk.openadsdk.rie.dg
                                public HandlerThread emc(String str2, int i) {
                                    return msw.emc(str2, i);
                                }
                            });
                            xq = xqVar;
                            xqVar.emc(new com.bytedance.sdk.openadsdk.rie.emc() { // from class: com.bytedance.sdk.openadsdk.sra.emc.2
                                ...
                                @Override // com.bytedance.sdk.openadsdk.rie.emc
                                public void emc(int i, String str2) {
    ...
    public static int emc(String str, int i) {
        xq xqVarGbl = gbl();
        return xqVarGbl != null ? xqVarGbl.emc(str, i) : i;
    }

    public static boolean emc(String str, boolean z6) {
        xq xqVarGbl = gbl();
        return xqVarGbl != null ? xqVarGbl.emc(str, z6) : z6;
    }
    ...
    public static int emc(String str, String str2, int i) {
        if (!TextUtils.isEmpty(str) && !TextUtils.isEmpty(str2)) {
            String strF = AbstractC2763b.f(str, "_", str2);
            ConcurrentHashMap<String, Object> concurrentHashMap = emc;
            Object obj = concurrentHashMap.get(strF);
            ...
            try {
                ...
                if (!TextUtils.isEmpty(strEmc)) {
                    int iOptInt = new JSONObject(strEmc).optInt(str2, i);
                    concurrentHashMap.put(strF, Integer.valueOf(iOptInt));
                    return iOptInt;
                }
            } catch (Throwable th) {
                ul.xq("StrategyUtils", th.getMessage());
        ...
        if (!TextUtils.isEmpty(str) && !TextUtils.isEmpty(str2)) {
            ...
            try {
                ...
                if (!TextUtils.isEmpty(strEmc)) {
                    ...
                    concurrentHashMap.put(strF, strOptString);
                    return strOptString;
                }
            } catch (Throwable th) {
                ul.xq("StrategyUtils", th.getMessage());
