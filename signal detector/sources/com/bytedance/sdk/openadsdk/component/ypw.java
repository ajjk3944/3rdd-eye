...
public class ypw extends xq {
    ...
    public ypw(Activity activity, rie rieVar, FrameLayout frameLayout, emc emcVar, int i, boolean z6, com.bytedance.sdk.openadsdk.component.msw.emc emcVar2, com.bytedance.sdk.openadsdk.component.ycc.ypw ypwVar) {
        super(activity, rieVar, frameLayout, emcVar, i, z6, emcVar2);
        this.sz = ypwVar;
    }
        ...
        this.qh.setBackupListener(new com.bytedance.sdk.component.adexpress.ypw.xq() { // from class: com.bytedance.sdk.openadsdk.component.ypw.4
            ...
            public boolean emc(ViewGroup viewGroup, int i) {
                ...
                try {
                    ...
                    Log.e("AppOpenAdExpressManager", "", e6);
                    return false;
                }
            }
        });
    ...
    @Override // com.bytedance.sdk.openadsdk.component.xq
    public void emc(int i, boolean z6) throws NumberFormatException {
        super.emc(i, z6);
        com.bytedance.sdk.openadsdk.component.zz.ypw ypwVar = this.qh;
        if (ypwVar != null) {
            ypwVar.setTime(String.valueOf(i), (int) (this.sup.xq() / 1000), i, false);
        }
    }
