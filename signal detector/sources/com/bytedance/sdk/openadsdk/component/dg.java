...
public class dg extends PAGAppOpenAd {
    ...
    public dg(Context context, rie rieVar, boolean z6, AdSlot adSlot) {
        this.emc = context;
        this.ypw = rieVar;
        this.uym = z6;
        this.xq = adSlot;
    ...
    public void show(Activity activity) {
        ...
        com.bytedance.sdk.component.utils.ypw.emc(contextEmc, intent, new ypw.InterfaceC0037ypw() { // from class: com.bytedance.sdk.openadsdk.component.dg.2
            ...
            iyl.xq(new msw("AppOpenAd_registerMultiProcessListener") { // from class: com.bytedance.sdk.openadsdk.component.dg.1
                ...
                public void run() {
                    ...
                    try {
                        ...
                        ul.xq("TTAppOpenAdImpl", e6.getMessage());
                    }
                }
            }, 5);
        }
