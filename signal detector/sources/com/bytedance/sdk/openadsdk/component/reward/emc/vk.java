...
public class vk implements com.bytedance.sdk.openadsdk.sz.msw {
    ...
    public void gbl() {
        ...
        if (j6 > 0) {
            if (this.tp > 0) {
                this.vw = (SystemClock.elapsedRealtime() - this.tp) + j6;
            }
    ...
    public boolean ul() {
        return rie.xq(this.dr.ypw) ? this.mkp && !this.iyl && this.dr.lt.sup() : this.mkp && !this.iyl && this.aa.get() && this.sba;
    }

    public void uym() {
        this.emc.emc("showPlayableEndCardOverlay", (JSONObject) null);
        this.dr.ra.sendEmptyMessageDelayed(600, 1000L);
    ...
    public void vk() throws JSONException {
        ...
        if (this.tp > 0) {
            this.vw = (SystemClock.elapsedRealtime() - this.tp) + this.vw;
            this.tp = 0L;
        }
        rtt rttVar = this.emc;
        if (rttVar != null) {
    ...
    public void ycc() {
        ...
        if (TextUtils.isEmpty(rie.emc(emcVar.vw, rieVar))) {
            ...
            if (this.ypw) {
                boolean z6 = this.dr.ltx;
                if (this.cf != null && ((z6 || !TextUtils.isEmpty(this.xq)) && rie.ypw(rieVar))) {
                    if (this.ffd) {
                        return;
                    }
                    String strP = f.p(new StringBuilder(), this.xq, "&is_pre_render=1");
                    com.bytedance.sdk.openadsdk.dg.sz szVar2 = this.dg;
                    if (szVar2 != null) {
                        szVar2.dg();
                    }
                    sra.emc(this.cf, strP);
                    this.ffd = true;
                    return;
                }
                if (rie.xq(rieVar)) {
    ...
    public void xq(boolean z6) throws JSONException {
        ypw(this.emc, z6);
    }
    ...
    public void ypw(rtt rttVar, boolean z6) throws JSONException {
        try {
            JSONObject jSONObject = new JSONObject();
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void emc(int i, com.bytedance.sdk.openadsdk.core.sz.dg.ypw ypwVar) {
        this.dr.ul.get();
        com.bytedance.sdk.openadsdk.component.reward.emc.emc emcVar = this.dr;
    ...
    public void emc(com.bytedance.sdk.openadsdk.sz.ycc yccVar, String str, final com.bytedance.sdk.openadsdk.core.sz.dg.ypw ypwVar) {
        ...
        this.emc.emc(this.dr.mkp.ru()).emc(this.dr.rie.xq()).emc(new com.bytedance.sdk.openadsdk.sz.xq() { // from class: com.bytedance.sdk.openadsdk.component.reward.emc.vk.9
            ...
            public void emc(boolean z6, int i, String str2) throws JSONException {
                if (z6) {
                    vk vkVar = vk.this;
                    vkVar.zz = true;
                    if (vkVar.wad) {
    ...
    public void emc(int i, int i3) throws JSONException {
        if (this.emc == null || this.dr.mxo.isFinishing()) {
            return;
        }
        try {
    ...
    private static String emc(String str, rie rieVar, int i, int i3, int i6) {
        String strConcat;
        String strConcat2;
        float fKx = rieVar.kx();
        if (!TextUtils.isEmpty(str)) {
            if (i == 1) {
                ...
                str = AbstractC2763b.e(strConcat2, "orientation=portrait");
            }
            if (str.contains("?")) {
            ...
            str = strConcat + "height=" + i3 + "&width=" + i6 + "&aspect_ratio=" + fKx;
        }
        return !dr.ypw(rieVar) ? com.bytedance.sdk.openadsdk.utils.ycc.emc(str) : str;
    }

    public void emc(int i) {
        if (this.sba || !this.aa.get()) {
            emc(0, this.dr.tp);
        }
        vw.emc((View) this.cf, i);
        com.bytedance.sdk.component.zz.ycc yccVar = this.cf;
        if (yccVar != null) {
            vw.emc((View) yccVar.getWebView(), i);
        }
        rie rieVar = this.dr.ypw;
    ...
    public void emc(rtt rttVar, boolean z6) {
        if (this.emc == null || this.dr.mxo.isFinishing()) {
            return;
        }
        rttVar.emc(z6);
    ...
    private void emc(String str, final dg dgVar) {
        ...
        com.bytedance.sdk.openadsdk.dg.sz szVarYpw = new com.bytedance.sdk.openadsdk.dg.sz(rieVar, this.cf.getWebView(), new com.bytedance.sdk.openadsdk.dg.sup() { // from class: com.bytedance.sdk.openadsdk.component.reward.emc.vk.11
            ...
            public void emc(int i) {
                ...
                xq.emc.emc(vk.this.wo, vk.this.ra, vk.this.wa, vk.this.pxa - vk.this.wa, rieVar, "landingpage_endcard", i);
            }
        }, this.xxg).ypw(true);
        this.dg = szVarYpw;
        ...
        this.cf.getWebView().setOnScrollChangeListener(new View.OnScrollChangeListener() { // from class: com.bytedance.sdk.openadsdk.component.reward.emc.vk.12
            ...
            public void onScrollChange(View view, int i3, int i6, int i7, int i8) {
                ...
                public boolean onTouch(View view, MotionEvent motionEvent) {
                    ...
                    if (actionMasked != 0) {
                        ...
                        if (actionMasked == 1) {
                            ...
                            i3 = (System.currentTimeMillis() - vk.this.hxp <= 200 || (vk.this.sb <= 8.0f && vk.this.sf <= 8.0f)) ? 2 : 1;
                        }
                        return false;
                    }
                    vk.this.db = true;
                    ...
                    vk.this.sf = -1.0f;
                    i3 = 0;
                    vk.this.ee.put(motionEvent.getActionMasked(), new xq.emc(i3, motionEvent.getSize(), motionEvent.getPressure(), System.currentTimeMillis()));
                    ...
                    if (motionEvent.getAction() == 1 && view.getVisibility() == 0 && Float.valueOf(view.getAlpha()).intValue() == 1 && ((!vk.this.vk || ul.ru(rieVar)) && vk.this.db)) {
                        ...
                        if (!vk.this.vk && !ul.zz(rieVar)) {
                            if (vk.this.sup) {
                                com.bytedance.sdk.openadsdk.dg.xq.emc(rieVar, "rewarded_video", "click", jSONObject);
                            } else {
                                com.bytedance.sdk.openadsdk.dg.xq.emc(rieVar, "fullscreen_interstitial_ad", "click", jSONObject);
                            }
                            vk.this.vk = true;
                        }
                        return false;
    ...
    public void emc(boolean z6, boolean z7) throws JSONException {
        emc(this.emc, z6, z7);
    }

    public void emc(rtt rttVar, boolean z6, boolean z7) throws JSONException {
        try {
            JSONObject jSONObject = new JSONObject();
            jSONObject.put("endcard_mute", z6);
    ...
    public void emc(boolean z6, int i, String str) {
        com.bytedance.sdk.openadsdk.dg.dg.bw bwVar = this.uym;
        if (bwVar == null) {
            return;
        }
