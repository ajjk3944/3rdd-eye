...
public class bw {
    ...
    public interface emc {
        void emc(boolean z6, boolean z7, boolean z8, com.bytedance.sdk.openadsdk.component.reward.ypw.ypw ypwVar, int i);
    }
    ...
    private int ycc() {
        ...
        if (iJl <= 5000 && iJl >= 0) {
            if (iJl < 1000) {
                iJl += TTAdConstant.STYLE_SIZE_RADIO_1_1;
            }
            int iEmc = com.bytedance.sdk.openadsdk.core.aa.dg().emc(this.emc.ypw.tx());
            if (iEmc <= 5000 && iEmc >= 0) {
                if (iEmc < 1000) {
                    iEmc += TTAdConstant.STYLE_SIZE_RADIO_1_1;
                }
    ...
    */
    ...
    private boolean ypw(boolean z6) {
        com.bytedance.sdk.openadsdk.component.reward.view.xq xqVarEmc;
        if (!ul.xq(this.emc.ypw) || (xqVarEmc = this.emc.hxp.emc()) == null || xqVarEmc.dg != 0 || z6) {
            return true;
        }
    ...
    private void emc(boolean z6, boolean z7, boolean z8, int i) {
        int i3;
        HashMap map = new HashMap();
        if (this.emc.xmt.sf()) {
            i3 = 1;
        } else {
            i3 = !this.emc.xmt.qh() ? -1 : 2;
        }
        map.put("webview_state", Integer.valueOf(i3));
        com.bytedance.sdk.openadsdk.component.reward.emc.emc emcVar = this.emc;
        com.bytedance.sdk.openadsdk.dg.xq.emc(emcVar.ypw, emcVar.bw, z6, z7, z8, emcVar.mxo.isFinishing(), i, map);
    }

    public void emc(boolean z6, com.bytedance.sdk.openadsdk.component.reward.ypw.ypw ypwVar) throws JSONException {
        sz szVar;
        this.emc.cf.set(z6);
        ypwVar.sup();
        this.emc.ypw.ak();
