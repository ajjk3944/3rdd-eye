...
public class cf {
    ...
    private static volatile cf emc;
    ...
    private cf(Context context) {
        ...
        this.xq = new ypw.emc("sp_reward_video");
    }

    public void emc(String str, rie rieVar) {
        if (com.bytedance.sdk.openadsdk.utils.ypw.emc()) {
            com.bytedance.sdk.openadsdk.common.ypw.emc("sp_reward_video_new").emc(str, rieVar);
            return;
        }
    ...
    public com.bytedance.sdk.openadsdk.core.model.emc ypw(String str, boolean z6) {
        ...
        if (System.currentTimeMillis() - jDg < 10500000 && !zBw && (!z6 || !zUym)) {
            try {
    ...
    public void emc() {
        ...
        if (com.bytedance.sdk.openadsdk.utils.ypw.emc()) {
            com.bytedance.sdk.openadsdk.common.ypw.emc("sp_reward_video_new").emc();
            return;
        }
        try {
            int i = Build.VERSION.SDK_INT;
            boolean zUym = com.bytedance.sdk.openadsdk.core.zz.uym("sp_reward_video");
            if (zUym) {
                str = "files";
            } else {
                str = "shared_prefs";
    ...
    public void emc(AdSlot adSlot, com.bytedance.sdk.openadsdk.core.model.emc emcVar) {
        ...
        if (emcVar == null || emcVar.ycc() == null || !emcVar.ycc().wh()) {
            if (com.bytedance.sdk.openadsdk.utils.ypw.emc()) {
                com.bytedance.sdk.openadsdk.common.ypw.emc("sp_reward_video_new").emc(adSlot, emcVar);
                return;
            }
            if (emcVar == null || emcVar.msw() || adSlot == null || !TextUtils.isEmpty(adSlot.getBidAdm()) || (rieVarYcc = emcVar.ycc()) == null || rieVarYcc.lad() == 2) {
                return;
            }
    ...
    public static cf emc(Context context) {
        if (emc == null) {
    ...
    public String emc(String str, boolean z6) {
        com.bytedance.sdk.openadsdk.common.ypw ypwVarEmc = com.bytedance.sdk.openadsdk.common.ypw.emc("sp_reward_video_new");
    ...
    public boolean emc(com.bytedance.sdk.openadsdk.core.model.emc emcVar) {
        return com.bytedance.sdk.openadsdk.common.ypw.emc("sp_reward_video_new").emc(emcVar, true);
    }
    ...
    public void emc(String str) {
        if (com.bytedance.sdk.openadsdk.utils.ypw.emc()) {
            com.bytedance.sdk.openadsdk.common.ypw.emc("sp_reward_video_new").xq(str);
        } else {
            this.xq.ycc(str);
        }
    }
