...
public class xq {
    ...
    public void emc(com.bytedance.sdk.openadsdk.component.reward.ypw.ypw ypwVar) {
        ...
        boolean z6 = (mswVar2 instanceof com.bytedance.sdk.openadsdk.activity.bw) && ((com.bytedance.sdk.openadsdk.activity.bw) mswVar2).emc;
        if (emcVar.gbl.get() || !((mswVar = this.emc.pe) == null || !mswVar.wo().db() || z6)) {
            if (this.xq == null) {
