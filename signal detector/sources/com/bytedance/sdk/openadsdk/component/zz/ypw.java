...
public class ypw extends ul {
    ...
    public ypw(Context context, rie rieVar, AdSlot adSlot, String str, com.bytedance.sdk.openadsdk.component.emc emcVar, com.bytedance.sdk.openadsdk.component.ycc.ypw ypwVar, com.bytedance.sdk.openadsdk.component.msw.emc emcVar2) {
    ...
    public void xq(JSONObject jSONObject) throws JSONException {
        rie rieVar = this.sup;
        boolean z6 = rieVar != null && rieVar.ej() == 0;
        rie rieVar2 = this.sup;
        com.bytedance.sdk.openadsdk.component.uym.emc.emc(jSONObject, rieVar2 != null ? rieVar2.tx() : 0, z6);
    }
