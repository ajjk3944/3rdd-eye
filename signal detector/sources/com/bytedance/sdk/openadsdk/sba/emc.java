        ...
        public void run() {
            ...
            try {
                ...
                if (sQLiteDatabaseYpw != null) {
                    ...
                    int i3 = i;
                    Cursor cursorQuery = sQLiteDatabaseYpw.query("monitor_table", strArr, "timestamp < ?", strArr2, null, null, null, String.valueOf(i));
                    if (cursorQuery != null) {
                        ...
                        try {
                            ...
                            while (cursorQuery.moveToNext()) {
                                ...
                                if (cursorQuery.getColumnIndex("_id") >= 0) {
                                    str = str4;
                                    str2 = str5;
                                    long j6 = cursorQuery.getLong(cursorQuery.getColumnIndex("_id"));
                                    emcVar.emc(j6);
                                ...
                                if (cursorQuery.getColumnIndex("timestamp") >= 0) {
                                    emcVar.ypw(cursorQuery.getLong(cursorQuery.getColumnIndex("timestamp")));
                                }
                            ...
                            if (!arrayList4.isEmpty()) {
                                try {
                                    ...
                                    if (arrayList4.size() < i3 || emc.this.uym > 1000) {
                                        return;
                                    }
                                    emc.this.emc(false);
                        ...
                        try {
                            ...
                            for (int i = 0; i < list.size(); i++) {
                                ...
                                if (dgVar != null && (emcVarEmc = dgVar.emc()) != null) {
                                    ...
                                    contentValues.put("timestamp", Long.valueOf(emcVarEmc.ru()));
