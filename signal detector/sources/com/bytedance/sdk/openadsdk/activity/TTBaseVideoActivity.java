...
public abstract class TTBaseVideoActivity extends TTBaseActivity implements sf.emc, com.bytedance.sdk.openadsdk.core.sz.dg.ypw {
    ...
    public static class emc implements Runnable {
        ...
        public emc(boolean z6, AdSlot adSlot) {
            this.emc = z6;
            this.ypw = adSlot;
        }
        ...
        if (this.vk) {
            com.bytedance.sdk.openadsdk.common.emc.ypw(new qh.emc(this.ypw, "TTAD.BVA", new Runnable() { // from class: com.bytedance.sdk.openadsdk.activity.TTBaseVideoActivity.1
                ...
                public void emc(boolean z6, int i) {
                    TTBaseVideoActivity.this.emc(z6, i);
                }
    ...
    public abstract void emc(long j6, long j7);
    ...
    public void emc(boolean z6, boolean z7, int i) {
        com.bytedance.sdk.openadsdk.component.reward.ypw.ypw ypwVar = this.xq;
        if (ypwVar == null) {
            return;
        }
        ypwVar.emc(z6, z7, false, i);
    }
    ...
    public void emc(boolean z6, boolean z7) {
        ...
        com.bytedance.sdk.openadsdk.core.sf.emc().emc(this.ru, z6, z7);
    }
    ...
    public IListenerManager emc(int i) {
        if (this.bw == null) {
            this.bw = IListenerManager.Stub.asInterface(com.bytedance.sdk.openadsdk.multipro.aidl.emc.emc().emc(i));
        }
        return this.bw;
    }
    ...
    public boolean emc(long j6, boolean z6) {
        ...
        c cVar = new c() { // from class: com.bytedance.sdk.openadsdk.activity.TTBaseVideoActivity.4
            @Override // L1.c
            public void emc(long j7, int i) {
                com.bytedance.sdk.openadsdk.utils.qh qhVar;
                com.bytedance.sdk.openadsdk.utils.qh qhVar2;
                TTBaseVideoActivity.this.aa.get();
                if (TTBaseVideoActivity.this.aa.getAndSet(true)) {
                    return;
                }
                ...
                TTBaseVideoActivity.this.ypw.ylm.emc(j7, j7);
            ...
            @Override // L1.c
            public void emc(long j7, long j8) {
                com.bytedance.sdk.openadsdk.component.reward.emc.emc emcVar = TTBaseVideoActivity.this.ypw;
                ...
                TTBaseVideoActivity.this.dg.removeMessages(300);
                if (j7 != TTBaseVideoActivity.this.ypw.ylm.sz()) {
                    TTBaseVideoActivity.this.sra();
                }
                if (!TTBaseVideoActivity.this.db() || TTBaseVideoActivity.this.ypw.ylm.ycc()) {
                    TTBaseVideoActivity.this.ypw.ylm.emc(j7, j8);
                    TTBaseVideoActivity tTBaseVideoActivity = TTBaseVideoActivity.this;
                    long j9 = j7 / 1000;
                    tTBaseVideoActivity.ycc = (int) (tTBaseVideoActivity.ypw.ylm.iyl() - j9);
                    int i = (int) j9;
                    if ((TTBaseVideoActivity.this.ypw.aa.get() || TTBaseVideoActivity.this.ypw.ru.get()) && TTBaseVideoActivity.this.ypw.ylm.ycc()) {
                        TTBaseVideoActivity.this.ypw.ylm.ylm();
                    }
                    if (TTBaseVideoActivity.this.hxp()) {
                        TTBaseVideoActivity.this.ypw.mkp.bw(i);
                    }
                    if (TTBaseVideoActivity.this.ee()) {
                        ...
                        if (ltVar2 == null || !ltVar2.emc()) {
                            TTBaseVideoActivity.this.emc(j7, j8);
                            return;
                        }
                        return;
                    }
        ...
        this.ypw.ylm.emc(cVar);
        if (!this.ypw.ypw.ycc() && (gblVar = this.ypw.mkp) != null && (ulVar = gblVar.cf) != null) {
            ulVar.emc(cVar);
        }
        boolean zEmc = this.ypw.ylm.emc(j6, z6, mapRtt, this.xq);
        ypw(zEmc, z6);
        return zEmc;
    }
}
