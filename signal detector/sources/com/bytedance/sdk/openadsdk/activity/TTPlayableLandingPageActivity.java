...
public class TTPlayableLandingPageActivity extends TTBaseLandingPageActivity implements sf.emc, com.bytedance.sdk.openadsdk.core.sz.dg.ypw, com.bytedance.sdk.openadsdk.core.xq.dg {
    ...
    private void ul() {
        com.bytedance.sdk.openadsdk.core.xq.emc emcVar = new com.bytedance.sdk.openadsdk.core.xq.emc(this, this.ee, "embeded_ad", this.ylm) { // from class: com.bytedance.sdk.openadsdk.activity.TTPlayableLandingPageActivity.6
            ...
            public void emc(View view, float f2, float f5, float f6, float f7, SparseArray<xq.emc> sparseArray, boolean z6) throws JSONException {
                rie rieVar = ((com.bytedance.sdk.openadsdk.core.xq.ypw) this).ycc;
                if (rieVar == null || rieVar.ltx() != 1 || z6) {
                    ...
                    try {
                        ...
                        ul.emc("TTPWPActivity", "onClick JSON ERROR", e6);
                    }
    ...
    private void zz() {
        int i = aa.dg().db(String.valueOf(this.ee.tx())).aa;
        if (i >= 0) {
            this.db.sendEmptyMessageDelayed(1, i * 1000);
        } else {
    ...
    public void ycc(boolean z6) {
        try {
            this.tp = z6;
            this.qh.setImageDrawable(z6 ? gbl.emc(this.cf, "tt_mute_wrapper") : gbl.emc(this.cf, "tt_unmute_wrapper"));
            com.bytedance.sdk.openadsdk.ylm.msw mswVar = this.iyl;
            if (mswVar != null) {
                mswVar.emc(z6);
            }
            ...
            ul.xq("TTPWPActivity", e6.getMessage());
        }
    }
            ...
            if (com.bytedance.sdk.openadsdk.multipro.ypw.xq()) {
                ...
                if (stringExtra != null) {
                    try {
                        ...
                        ul.emc("TTPWPActivity", "TTPlayableLandingPageActivity - onCreate MultiGlobalInfo : ", e6);
                    }
                }
                this.aa = intent.getStringExtra("adid");
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public Message emc(int i, int i3) {
    ...
    public void emc(Message message) throws JSONException {
        ...
        if (ruVar == null || !ruVar.dg()) {
            ...
            try {
                ...
                ul.emc("TTPWPActivity", "handleMsg json error", e6);
            }
