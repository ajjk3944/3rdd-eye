...
public class TTAppOpenAdActivity extends TTBaseActivity implements sf.emc, emc.InterfaceC0077emc {
    ...
    private final com.bytedance.sdk.openadsdk.component.emc tp = new com.bytedance.sdk.openadsdk.component.emc() { // from class: com.bytedance.sdk.openadsdk.activity.TTAppOpenAdActivity.1
        ...
        @Override // com.bytedance.sdk.openadsdk.component.emc, L1.c
        public void emc() {
        ...
        public void xq() {
            ...
            TTAppOpenAdActivity.this.aa.bw();
        ...
        public void emc(long j6, long j7) {
            TTAppOpenAdActivity.this.sup.xq(j6);
            ...
            if (TTAppOpenAdActivity.this.cuf instanceof com.bytedance.sdk.openadsdk.component.ypw) {
                ((com.bytedance.sdk.openadsdk.component.ypw) TTAppOpenAdActivity.this.cuf).emc(j6, j7);
            }
        }
        ...
        public void emc(int i, boolean z6) {
            if (TTAppOpenAdActivity.this.cuf != null) {
                TTAppOpenAdActivity.this.cuf.emc(i, z6);
            }
        }
    };
        ...
        public void run() throws JSONException {
            ...
            if (viewFindViewById != null) {
                try {
                    ...
                    Log.e("TTAppOpenAdActivity", "run: ", e6);
                    TTAppOpenAdActivity.this.finish();
                    return;
                }
            }
            ...
            public void onSystemUiVisibilityChange(int i) {
                if (i == 0) {
                    try {
                        ...
                        ul.xq("TTAppOpenAdActivity", e6.getMessage());
                    }
                }
            }
        });
    ...
    public void onCreate(Bundle bundle) {
        ...
        boolean z6 = false;
        if (bundle != null) {
            z6 = bundle.getBoolean("enable_new_arch", false);
        ...
        if (this.ylm) {
            this.sup.emc((float) this.hxp.iat().f6583d);
        } else {
    ...
    public void onDestroy() throws JSONException {
        ...
        if (this.aa.ycc() && this.vk.get()) {
            com.bytedance.sdk.openadsdk.dg.xq.emc(String.valueOf(this.aa.dg()), this.hxp, "open_ad", this.sba);
            this.aa = mxo.xq();
        }
    ...
    public void onWindowFocusChanged(boolean z6) {
        ...
        com.bytedance.sdk.openadsdk.ee.ypw.bw.emc(this.hxp, z6 ? 4 : 8);
        com.bytedance.sdk.openadsdk.ee.emc.xq.emc(this.hxp, z6);
    }
            ...
            if (intent != null) {
                ...
                if (stringExtra2 != null) {
                    try {
                        ...
                        ul.xq("TTAppOpenAdActivity", "open_ad", "initData MultiGlobalInfo throws ", e6);
                    }
                }
    ...
    public void emc(Bundle bundle) {
        if (bundle != null) {
            ...
            try {
                ...
                this.hxp = com.bytedance.sdk.openadsdk.core.sf.emc().emc(i);
            } catch (Throwable th) {
                ul.xq("TTAppOpenAdActivity", th.getMessage());
            }
        }
