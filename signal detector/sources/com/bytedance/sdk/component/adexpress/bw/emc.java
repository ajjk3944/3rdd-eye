...
public abstract class emc implements com.bytedance.sdk.component.adexpress.emc, com.bytedance.sdk.component.adexpress.theme.emc, com.bytedance.sdk.component.adexpress.ypw.dg<ycc>, gbl {
    ...
    public abstract void emc(int i);
        ...
        if (emc() != null && emc().getWebView() != null) {
            ...
            if (this.ypw) {
                try {
                    ...
                    bw.emc().dg(this.dg);
                    this.ru.emc(102, "load exception is " + e6.getMessage());
                    return;
                }
            }
            ycc yccVarEmc = emc();
    ...
    public void emc(com.bytedance.sdk.component.adexpress.ypw.qh qhVar, float f2, float f5) {
        qhVar.ru();
        boolean z6 = this.xq;
        if (z6 && !this.sz) {
            emc(f2, f5);
    ...
    private void emc(float f2, float f5) {
        this.sup.bw().bw();
        if (xq() == 9) {
        ...
        int iEmc = (int) com.bytedance.sdk.component.adexpress.dg.uym.emc(this.uym, f2);
        int iEmc2 = (int) com.bytedance.sdk.component.adexpress.dg.uym.emc(this.uym, f5);
    ...
    private void emc(int i, String str) {
        if (this.ru != null) {
            this.ru.emc(i, str);
        }
    }
