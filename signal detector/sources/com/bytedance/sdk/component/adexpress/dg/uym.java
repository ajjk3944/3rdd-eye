...
public class uym {
    ...
    public static int emc(float f2, float f5, float f6, float f7) {
        return (((int) ((f2 * 255.0f) + 0.5f)) << 24) | (((int) ((f5 * 255.0f) + 0.5f)) << 16) | (((int) ((f6 * 255.0f) + 0.5f)) << 8) | ((int) ((f7 * 255.0f) + 0.5f));
    }

    public static float xq(Context context, float f2) {
        if (context == null) {
            context = com.bytedance.sdk.component.adexpress.emc.emc.emc.emc().xq().ypw();
        }
        return f2 * dg(context);
    }
