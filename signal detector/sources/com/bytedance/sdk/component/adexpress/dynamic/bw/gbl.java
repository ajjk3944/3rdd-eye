...
public class gbl {
    ...
    /* JADX WARN: Removed duplicated region for block: B:228:0x044c A[Catch: Exception -> 0x045d, TryCatch #1 {Exception -> 0x045d, blocks: (B:226:0x0440, B:228:0x044c, B:233:0x0456), top: B:278:0x0440 }] */
    /*
    ...
    */
    ...
    public static int[] ypw(String str, float f2, boolean z6) {
        try {
    ...
    public static ypw.xq emc(String str, String str2, boolean z6) {
        ypw.xq xqVar = new ypw.xq();
        try {
            JSONObject jSONObject = new JSONObject(str2);
            int[] iArrEmc = emc(str, (float) ypw(str2), z6);
            xqVar.emc = iArrEmc[0];
            xqVar.ypw = iArrEmc[1];
    ...
    public static int[] emc(String str, float f2, boolean z6) {
        int[] iArrYpw = ypw(str, f2, z6);
