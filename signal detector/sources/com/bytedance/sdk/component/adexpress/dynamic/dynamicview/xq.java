...
public class xq extends ycc {
    ...
    public void emc() {
        ...
        if (i + 1 >= getChildCount() || ((ViewGroup) getChildAt(this.ul + 1)).getChildCount() <= 0) {
            this.ylm = true;
            childAt = getChildAt(this.ul - 1);
            this.emc = ObjectAnimator.ofFloat(childAt2, "translationX", 0.0f, (getChildAt(this.ul).getWidth() + this.uym) / 2);
        } else {
            childAt = getChildAt(this.ul + 1);
            this.emc = ObjectAnimator.ofFloat(childAt2, "translationX", 0.0f, (-(getChildAt(this.ul).getWidth() + this.uym)) / 2);
        }
        ...
        if (this.ylm) {
            this.ypw = ObjectAnimator.ofFloat(childAt, "translationX", (-(childAt.getWidth() + this.uym)) / 2, 0.0f);
        } else {
            this.ypw = ObjectAnimator.ofFloat(childAt, "translationX", (childAt.getWidth() + this.uym) / 2, 0.0f);
        }
