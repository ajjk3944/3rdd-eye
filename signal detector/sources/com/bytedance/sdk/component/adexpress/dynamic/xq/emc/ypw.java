    ...
    public boolean onTouch(View view, MotionEvent motionEvent) {
        ...
        if (action == 0) {
            ...
            if (action == 2) {
                ...
                if (Math.abs(x6 - this.emc) >= com.bytedance.sdk.component.adexpress.dg.uym.emc(com.bytedance.sdk.component.adexpress.dg.emc(), 10.0f) || Math.abs(y3 - this.ypw) >= com.bytedance.sdk.component.adexpress.dg.uym.emc(com.bytedance.sdk.component.adexpress.dg.emc(), 10.0f)) {
                    this.dg = true;
                    this.bw.ycc();
                }
            }
