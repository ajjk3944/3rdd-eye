...
public class db extends uym implements com.bytedance.sdk.component.adexpress.dynamic.xq {
    ...
    public void emc(CharSequence charSequence, boolean z6, int i, boolean z7) {
        ...
        setVisibility(0);
        if (!z6 && this.qh.getRenderRequest().emc() && com.bytedance.sdk.component.adexpress.dg.ycc.ypw(this.qh.getRenderRequest().dg())) {
            if (com.bytedance.sdk.component.adexpress.dg.ypw()) {
                ((TextView) this.cf).setText(i + "s");
            } else {
                ((TextView) this.cf).setText(String.format(com.bytedance.sdk.component.utils.rie.emc(com.bytedance.sdk.component.adexpress.dg.emc(), "tt_reward_full_skip"), Integer.valueOf(i)));
            }
            this.emc = true;
            return;
        }
        ...
        this.ypw = true;
        if (this.emc) {
            FrameLayout.LayoutParams layoutParams = new FrameLayout.LayoutParams((int) (com.bytedance.sdk.component.adexpress.dg.uym.emc(com.bytedance.sdk.component.adexpress.dg.emc(), this.sup.dg() + this.sup.xq()) + com.bytedance.sdk.component.adexpress.dynamic.bw.gbl.ypw(((TextView) this.cf).getText() != null ? r5.toString() : "", this.sup.bw(), true)[0]), this.msw);
