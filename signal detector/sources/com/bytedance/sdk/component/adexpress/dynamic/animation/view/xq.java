...
public class xq {
    ...
    */
    ...
    public void emc(View view, float f2) {
        ...
        layoutParams.width = (int) (this.ycc * f2);
        ...
        if (view instanceof gbl) {
            ...
            while (true) {
                ...
                viewGroup.getChildAt(i).setTranslationX((-(this.ycc - layoutParams.width)) / 2);
                i++;
            }
        }
    ...
    public void emc(View view, int i, int i3) {
        String str;
        this.dg = i / 2;
        this.bw = i3 / 2;
        ...
        try {
            ...
            try {
                this.xq.addRoundRect(new RectF(0.0f, 0.0f, i, i3), i3 / 2, i3 / 2, Path.Direction.CW);
