...
public class ycc extends dg {
    ...
    public List<ObjectAnimator> emc() {
        float f2 = this.xq.getLayoutParams().width;
        this.xq.setTranslationX(f2);
        ObjectAnimator duration = ObjectAnimator.ofFloat(this.xq, "translationX", f2, 0.0f).setDuration((int) (this.ypw.ru() * 1000.0d));
