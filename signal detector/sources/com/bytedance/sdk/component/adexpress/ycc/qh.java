    ...
    public qh(Context context) {
        ...
        post(new Runnable() { // from class: com.bytedance.sdk.component.adexpress.ycc.qh.1
            ...
            public void run() {
                ...
                layoutParams.bottomMargin = (int) (com.bytedance.sdk.component.adexpress.dg.uym.emc(qh.this.getContext(), 5.0f) + ((-qh.this.xq.getMeasuredHeight()) / 2.0f));
                layoutParams.rightMargin = (int) (com.bytedance.sdk.component.adexpress.dg.uym.emc(qh.this.getContext(), 5.0f) + ((-qh.this.xq.getMeasuredWidth()) / 2.0f));
