    ...
    public vk(Context context) {
        ...
        post(new Runnable() { // from class: com.bytedance.sdk.component.adexpress.ycc.vk.1
            ...
            public void run() {
                ...
                layoutParams.bottomMargin = (int) (com.bytedance.sdk.component.adexpress.dg.uym.emc(vk.this.getContext(), 5.0f) + ((-iEmc) / 2.0f));
                layoutParams.rightMargin = (int) (com.bytedance.sdk.component.adexpress.dg.uym.emc(vk.this.getContext(), 5.0f) + ((-iEmc2) / 2.0f));
