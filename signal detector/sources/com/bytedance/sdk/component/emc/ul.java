...
public class ul extends emc {
    ...
    public void emc(String str, qh qhVar) {
        if (qhVar != null && !TextUtils.isEmpty(qhVar.msw)) {
            ...
            String strEncodeToString2 = Base64.encodeToString(("iframe[src=\"" + str2 + "\"").getBytes(), 2);
            StringBuilder sb = new StringBuilder("javascript:(function(){   const iframe = document.querySelector(atob('");
            sb.append(strEncodeToString2);
            sb.append("'));   if (iframe && iframe.contentWindow) {        iframe.contentWindow.postMessage(");
            sb.append(str);
            sb.append(", atob('");
            emc(str, f.p(sb, strEncodeToString, "'));   }})()"));
            return;
        }
        super.emc(str, qhVar);
    }
    ...
    public void emc(String str) {
        emc(str, AbstractC1135f5.o(new StringBuilder("javascript:"), this.msw, "._handleMessageFromToutiao(", str, ")"));
    }
