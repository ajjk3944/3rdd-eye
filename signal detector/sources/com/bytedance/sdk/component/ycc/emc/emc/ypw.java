...
public class ypw extends emc {
    ...
    public synchronized void emc(com.bytedance.sdk.component.ycc.emc.dg.emc emcVar, int i) {
        dg dgVar;
        if (i != 5) {
            try {
    ...
    @Override // com.bytedance.sdk.component.ycc.emc.emc.dg
    public synchronized void emc(int i, List<com.bytedance.sdk.component.ycc.emc.dg.emc> list) {
        try {
