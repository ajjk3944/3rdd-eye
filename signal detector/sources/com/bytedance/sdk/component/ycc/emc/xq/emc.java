...
public class emc {
    ...
    public static String emc(com.bytedance.sdk.component.ycc.emc.dg.emc emcVar) {
        ...
        if (emcVar.ypw() == 3) {
            return emcVar.uym().optString("event");
        }
    ...
    public static String ypw(com.bytedance.sdk.component.ycc.emc.dg.emc emcVar) {
        ...
        return emcVar.uym().optString("type");
    }
    ...
    public static void emc(List<com.bytedance.sdk.component.ycc.emc.dg.emc> list, int i) {
        try {
            if (msw.uym().vk().uym()) {
    ...
    public static void emc(List<com.bytedance.sdk.component.ycc.emc.dg.emc> list, int i, String str) {
        bw bwVarVk = msw.uym().vk();
            ...
            if (emcVar.dg() == 0) {
                ...
                if (emcVar.ypw() == 3) {
                    if (jSONObjectUym != null) {
                        strEmc = jSONObjectUym.optString("event");
                    }
                    sb.append(" [v3:");
                    sb.append(strEmc);
                    sb.append("] ");
    ...
    private static void emc(com.bytedance.sdk.component.ycc.emc.dg.emc emcVar, String str, bw bwVar) {
        ...
        if (emcVar.dg() == 0 && bwVar.emc()) {
            StringBuilder sbB = AbstractC2984e.b(strEmc, "_");
            sbB.append(zz(emcVar));
            sbB.append("_");
            sbB.append(strBw);
            sbB.append("_");
            sbB.append(str);
    ...
    public static void emc(boolean z6, int i, com.bytedance.sdk.component.ycc.emc.dg.emc emcVar) {
        bw bwVarVk = msw.uym().vk();
    ...
    public static void emc(int i, List<com.bytedance.sdk.component.ycc.emc.dg.emc> list, long j6) {
        if (msw.uym().vk().uym()) {
