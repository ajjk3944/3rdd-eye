...
public class ycc implements dg {
    ...
    public List<com.bytedance.sdk.component.ycc.emc.dg.emc> emc(int i, int i3, List<String> list) {
        ...
        if (com.bytedance.sdk.component.ycc.emc.ypw.emc.emc() && this.ypw.ypw(i, i3) && (listEmc6 = this.ypw.emc(i, i3)) != null && listEmc6.size() != 0) {
            com.bytedance.sdk.component.ycc.emc.xq.ypw.emc(com.bytedance.sdk.component.ycc.emc.ypw.dg.dg.sba(), 1);
            return listEmc6;
        }
        if (com.bytedance.sdk.component.ycc.emc.ypw.emc.bw() && this.dg.ypw(i, i3) && (listEmc5 = this.dg.emc(i, i3)) != null && listEmc5.size() != 0) {
            return listEmc5;
        }
        if (com.bytedance.sdk.component.ycc.emc.ypw.emc.ypw() && this.xq.ypw(i, i3) && (listEmc4 = this.xq.emc(i, i3)) != null && listEmc4.size() != 0) {
            com.bytedance.sdk.component.ycc.emc.xq.ypw.emc(com.bytedance.sdk.component.ycc.emc.ypw.dg.dg.yzg(), 1);
            return listEmc4;
        }
        if (com.bytedance.sdk.component.ycc.emc.ypw.emc.xq() && this.bw.ypw(i, i3) && (listEmc3 = this.bw.emc(i, i3)) != null && listEmc3.size() != 0) {
            com.bytedance.sdk.component.ycc.emc.xq.ypw.emc(com.bytedance.sdk.component.ycc.emc.ypw.dg.dg.ul(), 1);
            return listEmc3;
        }
        if (com.bytedance.sdk.component.ycc.emc.ypw.emc.dg() && this.ycc.ypw(i, i3) && (listEmc2 = this.ycc.emc(i, i3)) != null && listEmc2.size() != 0) {
            com.bytedance.sdk.component.ycc.emc.xq.ypw.emc(com.bytedance.sdk.component.ycc.emc.ypw.dg.dg.ylm(), 1);
            return listEmc2;
        }
        if (!com.bytedance.sdk.component.ycc.emc.ypw.emc.ycc() || !this.uym.ypw(i, i3) || (listEmc = this.uym.emc(i, i3)) == null || listEmc.size() == 0) {
            return null;
        }
        return listEmc;
    }
    ...
    public boolean emc(int i, boolean z6) {
        ...
        if (com.bytedance.sdk.component.ycc.emc.ypw.emc.emc() && (bwVar = this.ypw) != null && (emcVar7 = this.msw) != null && bwVar.ypw(i, emcVar7.emc())) {
            return true;
        }
        if (com.bytedance.sdk.component.ycc.emc.ypw.emc.bw() && (ypwVar = this.dg) != null && (emcVar6 = this.ru) != null && ypwVar.ypw(i, emcVar6.emc())) {
            return true;
        }
        if (com.bytedance.sdk.component.ycc.emc.ypw.emc.ypw() && (emcVar4 = this.xq) != null && (emcVar5 = this.zz) != null && emcVar4.ypw(i, emcVar5.emc())) {
            return true;
        }
        if (com.bytedance.sdk.component.ycc.emc.ypw.emc.xq() && (uymVar = this.bw) != null && (emcVar3 = this.gbl) != null && uymVar.ypw(i, emcVar3.emc())) {
            return true;
        }
        if (!com.bytedance.sdk.component.ycc.emc.ypw.emc.dg() || (xqVar = this.ycc) == null || (emcVar2 = this.sup) == null || !xqVar.ypw(i, emcVar2.emc())) {
            return com.bytedance.sdk.component.ycc.emc.ypw.emc.ycc() && (yccVar = this.uym) != null && (emcVar = this.sz) != null && yccVar.ypw(i, emcVar.emc());
        }
        return true;
    }
}
