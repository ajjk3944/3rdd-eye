...
public class ypw {
    ...
    private static String dg() {
        return f.p(new StringBuilder(), uym.ypw, "/ad_log_event/");
    }
    ...
    public static void emc(String str, List<String> list, boolean z6, int i, String str2) {
        ...
        try {
            ...
            String str3 = "?did=" + String.valueOf(str) + "&track=" + String.valueOf(com.bytedance.sdk.component.ycc.emc.emc.emc.ycc.emc(sb.toString())) + "&replace=" + String.valueOf(z6) + "&urlType=" + String.valueOf(i) + "&adId=" + str2;
            ycc yccVarEmc = emc(msw.uym().ycc());
            if (yccVarEmc != null) {
    ...
    public static void emc(String str, boolean z6) {
        ...
        try {
            ycc yccVarEmc = emc(msw.uym().ycc());
            if (yccVarEmc != null) {
                yccVarEmc.emc(Uri.parse(dg() + "trackAdFailed?did=" + String.valueOf(str) + "&triggerOnInit=" + z6));
            }
        } catch (Throwable unused) {
        }
    }
