...
public class emc {
    ...
    public static void emc(String str, List<String> list, boolean z6) {
        ...
        try {
            ...
            String str2 = "?did=" + String.valueOf(str) + "&track=" + String.valueOf(ycc.emc(sb.toString())) + "&replace=" + String.valueOf(z6);
            ContentResolver contentResolverXq = xq();
            if (contentResolverXq != null) {
