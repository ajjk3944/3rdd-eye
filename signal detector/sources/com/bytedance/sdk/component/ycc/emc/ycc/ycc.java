            ...
            while (cursorEmc.moveToNext()) {
                try {
                    try {
                        ...
                        boolean z6 = cursorEmc.getInt(cursorEmc.getColumnIndex("replaceholder")) > 0;
                        int i = cursorEmc.getInt(cursorEmc.getColumnIndex("retry"));
                        int i3 = cursorEmc.getInt(cursorEmc.getColumnIndex("url_type"));
                        ...
                        dg dgVar = new dg(string, string2, z6, i3, string3);
                        dgVar.emc(i);
