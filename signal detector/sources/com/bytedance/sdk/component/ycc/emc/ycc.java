...
public interface ycc extends IInterface {
    ...
    String emc(Uri uri, ContentValues contentValues);

    Map emc(Uri uri, String[] strArr, String str, String[] strArr2, String str2);
    ...
    public static abstract class emc extends Binder implements ycc {
        ...
        public static ycc emc(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof ycc)) ? new C0042emc(iBinder) : (ycc) iInterfaceQueryLocalInterface;
        }
        ...
        public static class C0042emc implements ycc {
            public static ycc emc;
            private IBinder ypw;

            public C0042emc(IBinder iBinder) {
                this.ypw = iBinder;
            }
