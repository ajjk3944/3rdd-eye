...
public class dr {
    ...
    public static com.bytedance.sdk.component.zz.ycc emc(Context context, AttributeSet attributeSet, int i, ycc.xq xqVar) {
        WebView webViewEmc = emc(context, attributeSet, i, xqVar, false);
        if (webViewEmc == null) {
            return null;
        }
    ...
    public static WebView ypw(Context context, AttributeSet attributeSet, int i, ycc.xq xqVar) {
        return emc(context, attributeSet, i, xqVar, true);
    }
    ...
    public static void ypw(com.bytedance.sdk.component.zz.ycc yccVar) {
        ...
        try {
            ...
            yccVar.setDefaultTextEncodingName("UTF-8");
    ...
    private static WebView emc(Context context, AttributeSet attributeSet, int i, ycc.xq xqVar, boolean z6) {
        WebView webViewYpw;
        emc emcVar;
        if (xqVar == null || attributeSet != null || i != 0 || (emcVar = emc.get(xqVar.sz)) == null) {
            webViewYpw = null;
        } else {
        ...
        emc(xqVar, true);
        return i != 0 ? new com.bytedance.sdk.component.zz.bw(context, attributeSet, i) : new com.bytedance.sdk.component.zz.bw(context, attributeSet);
    }
    ...
    private static void emc(final ycc.xq xqVar, final boolean z6) {
