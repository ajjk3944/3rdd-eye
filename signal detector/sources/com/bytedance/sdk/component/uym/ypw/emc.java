...
public class emc extends xq {
    ...
    public void emc(String str, String str2) {
        ...
        this.ypw = new File(str, AbstractC2763b.e(str2, ".temp"));
    }
    ...
    public void emc(final com.bytedance.sdk.component.uym.emc.emc emcVar) {
        ...
        if (file.exists() && this.emc.length() != 0 && emcVar != null) {
            ...
            com.bytedance.sdk.component.uym.ypw ypwVar = new com.bytedance.sdk.component.uym.ypw(true, TTAdConstant.MATE_VALID, "Success", null, null, jCurrentTimeMillis, jCurrentTimeMillis);
            ypwVar.emc(this.emc);
            emcVar.emc(this, ypwVar);
            return;
        }
        long length = this.ypw.length();
        final long j6 = length >= 0 ? length : 0L;
