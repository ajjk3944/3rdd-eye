...
import com.bytedance.sdk.component.bw.xq.xq;
...
public class ypw implements cf {
    ...
    public InputStream emc(String str, String str2) throws NoSuchAlgorithmException {
        if (this.emc != null) {
            ...
            Collection<sba> collectionYpw = this.emc.ypw();
            if (collectionYpw != null) {
                Iterator<sba> it = collectionYpw.iterator();
                while (it.hasNext()) {
                    byte[] bArrEmc = it.next().emc(str2);
                    if (bArrEmc != null) {
            ...
            if (collectionXq != null) {
                Iterator<com.bytedance.sdk.component.bw.xq> it2 = collectionXq.iterator();
                while (it2.hasNext()) {
                    InputStream inputStreamEmc = it2.next().emc(str2);
