...
public class ypw implements zz {
    ...
    public void emc(com.bytedance.sdk.component.bw.xq.xq xqVar) {
        ...
        if (iSup == 2) {
            bwVar = com.bytedance.sdk.component.utils.ycc.emc(this.emc) ? new bw(this.emc, this.ypw) : this.ypw == null ? new gbl() : new msw(BackupConstant.SCENE_RENDER_FAIL, "not image format", null);
        } else if (iSup != 3) {
