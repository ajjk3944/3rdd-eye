...
public final class g {
    ...
    private static final ConcurrentHashMap<Object, ConcurrentLinkedQueue<com.apm.insight.entity.c>> f6260a = new ConcurrentHashMap<>();

    /* renamed from: b, reason: collision with root package name */
    private static final HashMap<Object, HashMap<String, ConcurrentLinkedQueue<com.apm.insight.entity.c>>> f6261b = new HashMap<>();

    /* renamed from: c, reason: collision with root package name */
    private static volatile g f6262c;

    /* renamed from: e, reason: collision with root package name */
    private volatile boolean f6264e = false;

    /* renamed from: f, reason: collision with root package name */
    private Runnable f6265f = new Runnable() { // from class: com.apm.insight.k.g.1
        @Override // java.lang.Runnable
        public final void run() {
            if (Npth.isStopUpload()) {
                return;
            }
            if (!g.f6261b.isEmpty() && l.e()) {
                g.f();
            }
            g.this.c();
            g.this.f6263d.a(g.this.f6265f, 30000L);
        }
    };

    /* renamed from: d, reason: collision with root package name */
    private final p f6263d = m.a();
    ...
    private static void c(Object obj, com.apm.insight.entity.c cVar) throws JSONException {
        ...
        try {
            ...
            HashMap<Object, HashMap<String, ConcurrentLinkedQueue<com.apm.insight.entity.c>>> map = f6261b;
            synchronized (map) {
                try {
    ...
    public static void f() {
        HashMap map;
        HashMap<Object, HashMap<String, ConcurrentLinkedQueue<com.apm.insight.entity.c>>> map2 = f6261b;
        synchronized (map2) {
    ...
    public final void b() {
        if (f6260a.isEmpty()) {
            this.f6263d.a(this.f6265f, 30000L);
        } else {
            this.f6263d.a(this.f6265f);
        }
    }
    ...
    public final void c() {
        synchronized (this.f6263d) {
            try {
                ...
                for (Map.Entry<Object, ConcurrentLinkedQueue<com.apm.insight.entity.c>> entry : f6260a.entrySet()) {
