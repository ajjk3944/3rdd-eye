...
public final class e {
    ...
    public static final class a {
        ...
        private static a f6246c = new a("NONE", 0, 0);

        /* renamed from: a, reason: collision with root package name */
        public static final a f6244a = new a("GZIP", 1, 1);

        /* renamed from: b, reason: collision with root package name */
        public static final a f6245b = new a("DEFLATER", 2, 2);

        private a(String str, int i, int i3) {
            this.f6247d = i3;
        }
    }
    ...
    private static com.apm.insight.l.f a(String str, byte[] bArr, a aVar, String str2) throws IOException {
        ...
        if (a.f6244a == aVar && length > 128) {
            bArr = a(bArr);
            str3 = "gzip";
        } else if (a.f6245b != aVar || length <= 128) {
            str3 = null;
        } else {
    ...
    private static com.apm.insight.l.f d(String str, String str2) {
        try {
            if (!TextUtils.isEmpty(str2) && !TextUtils.isEmpty(str)) {
                return a(str, str2.getBytes(), a.f6244a, "application/json; charset=utf-8");
            }
            return new com.apm.insight.l.f(201);
        } catch (Throwable th) {
    ...
    private static com.apm.insight.l.f b(String str, String str2, File... fileArr) throws Throwable {
        ...
        try {
            ...
            try {
                ...
                return new com.apm.insight.l.f(0, e6);
            }
    ...
    public static byte[] a(String str, byte[] bArr) {
        try {
            ...
            return a(str, bArr, a.f6244a, "application/json; charset=utf-8").b();
        } catch (IOException e6) {
            e6.printStackTrace();
            return null;
        }
