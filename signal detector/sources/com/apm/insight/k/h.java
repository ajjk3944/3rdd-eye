...
public final class h implements Runnable {
    ...
    public final void run() {
        try {
            com.apm.insight.b.f.a(this.f6269a).a().f();
        } catch (Throwable unused) {
        }
        try {
            if (com.apm.insight.l.a.b(this.f6269a)) {
                b.a().a(com.apm.insight.l.k.b(this.f6269a));
            } else {
                NativeImpl.j();
            }
        } catch (Throwable th) {
            try {
                ...
                o.a().a(com.apm.insight.e.a().b(), com.apm.insight.entity.b.b());
                if (m.a().a() != null) {
                    com.apm.insight.j.d.a(m.a().a(), this.f6269a).a();
                }
            }
        }
    }
