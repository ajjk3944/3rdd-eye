...
public final class b extends a<com.apm.insight.d.a> {
    ...
    public final /* synthetic */ ContentValues a(com.apm.insight.d.a aVar) {
        ...
        contentValues.put("path", aVar2.f6079a);
        contentValues.put("insert_time", Long.valueOf(aVar2.f6080b));
    ...
    */
    public final boolean a(android.database.sqlite.SQLiteDatabase r11, java.lang.String r12) {
        /*
            ...
            goto L30
        La:
            java.lang.String r3 = r10.f6110a     // Catch: java.lang.Throwable -> L26
    ...
    public final void a(SQLiteDatabase sQLiteDatabase, com.apm.insight.d.a aVar) throws SQLException {
        if (aVar == null || a(sQLiteDatabase, aVar.f6079a)) {
            return;
        }
        super.a(sQLiteDatabase, (SQLiteDatabase) aVar);
        try {
            sQLiteDatabase.execSQL("delete from " + this.f6110a + " where _id in (select _id from " + this.f6110a + " order by insert_time desc limit 1000 offset 500)");
        } catch (Exception e6) {
