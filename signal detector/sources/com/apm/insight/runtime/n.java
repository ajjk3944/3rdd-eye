...
public final class n {
    ...
    public static class a {
        ...
        public a(String str) {
            ...
            this.f6457b = strArrSplit[0];
            this.f6456a = strArrSplit[1];
            try {
                this.f6458c = Long.parseLong(strArrSplit[2]);
            } catch (Throwable th) {
                com.apm.insight.c.a();
    ...
    public static File a(long j6) {
        return new File(com.apm.insight.l.j.j(com.apm.insight.e.g()), "apminsight/ProcessTrack/" + ((j6 - (j6 % 86400000)) / 86400000));
    }

    public static HashMap<String, a> a(long j6, String str) throws Throwable {
        File file = new File(com.apm.insight.l.j.j(com.apm.insight.e.g()), "apminsight/ProcessTrack/" + ((j6 - (j6 % 86400000)) / 86400000));
        ...
        try {
            if (f6455a == null) {
                ...
                if (strB == null) {
                    ...
                    f6455a = new File(com.apm.insight.l.j.j(com.apm.insight.e.g()), "apminsight/ProcessTrack/" + ((jCurrentTimeMillis - (jCurrentTimeMillis % 86400000)) / 86400000) + '/' + strB.replace(':', '_') + ".txt");
                    file = f6455a;
                }
            } else {
                file = f6455a;
