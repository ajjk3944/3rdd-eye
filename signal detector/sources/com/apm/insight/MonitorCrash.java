...
public class MonitorCrash {
    ...
    private MonitorCrash(Context context, String str, long j6, String str2) {
        Config config = new Config();
        this.mConfig = config;
        config.mAid = str;
        config.mVersionInt = j6;
        config.mVersionStr = str2;
        d.a(context, this);
    }

    public static MonitorCrash init(Context context, String str, long j6, String str2) {
        ...
        synchronized (MonitorCrash.class) {
            try {
                ...
                l.a(context);
                return new MonitorCrash(context, str, j6, str2);
            } finally {
            }
        }
    }

    public static MonitorCrash initSDK(Context context, String str, long j6, String str2, String str3, String[] strArr) {
        l.a(context);
        MonitorCrash monitorCrash = new MonitorCrash(str, j6, str2, str3);
    ...
    public static MonitorCrash initSDK(Context context, String str, long j6, String str2, String[] strArr, String[] strArr2) {
        l.a(context);
        MonitorCrash monitorCrash = new MonitorCrash(str, j6, str2, strArr);
        monitorCrash.config().setPackageName(strArr).setSoList(strArr2);
        return monitorCrash;
    }

    public static MonitorCrash initSDK(Context context, String str, long j6, String str2, String str3) {
        l.a(context);
        MonitorCrash monitorCrash = new MonitorCrash(str, j6, str2, str3);
    ...
    private MonitorCrash(String str, long j6, String str2, String... strArr) {
        Config config = new Config();
        this.mConfig = config;
        config.mAid = str;
        config.mVersionInt = j6;
    ...
    public static MonitorCrash initSDK(Context context, String str, long j6, String str2, String... strArr) {
        l.a(context);
        MonitorCrash monitorCrash = new MonitorCrash(str, j6, str2, strArr);
