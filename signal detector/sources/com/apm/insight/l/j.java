...
public final class j {
    ...
    private static File f6309b;

    /* renamed from: c, reason: collision with root package name */
    private static File f6310c;
    ...
    public static File d(Context context) {
        if (f6309b == null) {
            ...
            f6309b = new File(j(context), "apminsight/CrashLogNative");
        }
        return f6309b;
    }
    ...
    public static File e(Context context) {
        if (f6310c == null) {
            f6310c = new File(j(context) + "/apminsight/CrashCommonLog/" + com.apm.insight.e.f());
        }
        return f6310c;
    }
    ...
    public static String c() {
        return A.f.l("ensure_", com.apm.insight.e.e());
    }
    ...
    public static String j(Context context) {
        if (TextUtils.isEmpty(f6308a)) {
            try {
                f6308a = context.getFilesDir().getAbsolutePath();
            } catch (Exception e6) {
                f6308a = "/sdcard/";
                e6.printStackTrace();
            }
