...
public final class a implements Thread.UncaughtExceptionHandler {
    ...
    private static a f6150a = null;
    private static volatile boolean i = false;

    /* renamed from: j, reason: collision with root package name */
    private static volatile ThreadLocal<Boolean> f6151j = new ThreadLocal<>();

    /* renamed from: l, reason: collision with root package name */
    private static volatile long f6152l = 10000;

    /* renamed from: m, reason: collision with root package name */
    private static ArrayList<b> f6153m = new ArrayList<>();

    /* renamed from: b, reason: collision with root package name */
    private Thread.UncaughtExceptionHandler f6154b;
    ...
    private volatile int f6157e = 0;

    /* renamed from: f, reason: collision with root package name */
    private volatile int f6158f = 0;

    /* renamed from: g, reason: collision with root package name */
    private ConcurrentHashMap<String, Object> f6159g = new ConcurrentHashMap<>();

    /* renamed from: h, reason: collision with root package name */
    private ConcurrentHashMap<String, Object> f6160h = new ConcurrentHashMap<>();

    /* renamed from: k, reason: collision with root package name */
    private JSONArray f6161k;

    private a() {
        Thread.UncaughtExceptionHandler defaultUncaughtExceptionHandler = Thread.getDefaultUncaughtExceptionHandler();
        if (defaultUncaughtExceptionHandler != this) {
            this.f6154b = defaultUncaughtExceptionHandler;
    ...
    private void c(Thread thread, Throwable th) {
        Thread.UncaughtExceptionHandler uncaughtExceptionHandler = this.f6154b;
    ...
    private void d() {
        ...
        while (this.f6158f != 0 && SystemClock.uptimeMillis() - jUptimeMillis < f6152l) {
    ...
    private static void e() {
        ...
        long jUptimeMillis = SystemClock.uptimeMillis();
        while (!h.a() && SystemClock.uptimeMillis() - jUptimeMillis < f6152l) {
            try {
    ...
    private static int f() {
        int iA = 0;
        for (int i3 = 0; i3 < f6153m.size(); i3++) {
            try {
                try {
                    iA |= f6153m.get(i3).a();
                } catch (Throwable th) {
    ...
    public final boolean b(String str) {
        return this.f6159g.containsKey(str);
    }
  ...
  0x0065: PHI (r0v52 boolean) = (r0v9 boolean), (r0v53 boolean), (r0v53 boolean), (r0v53 boolean) binds: [B:24:0x0064, B:20:0x005a, B:142:0x0065, B:22:0x0060] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    ...
    private String a(File file, Throwable th, Thread thread, boolean z6) {
        String absolutePath = file.getAbsolutePath();
        this.f6160h.put(file.getName(), file);
        try {
                ...
                try {
                    strA = com.apm.insight.l.m.a(th, new PrintStream(fileOutputStream), Looper.getMainLooper() == Looper.myLooper() ? new e.a() { // from class: com.apm.insight.g.a.1
                        ...
                        public final boolean a(String str) {
                            if (!this.f6162a && str.contains("android.os.Looper.loop")) {
                                this.f6162a = true;
                            }
                            return !this.f6162a;
                        }
    ...
    public final void a(Thread thread, Throwable th, boolean z6, com.apm.insight.entity.a aVar) {
        ...
        for (ICrashCallback iCrashCallback : listC) {
            ...
            try {
                if (iCrashCallback instanceof com.apm.insight.b) {
                    ((com.apm.insight.b) iCrashCallback).a(crashType, com.apm.insight.l.m.a(th), thread, this.f6161k);
                } else {
    ...
    private void a(Thread thread, Throwable th, boolean z6, long j6) {
        Thread thread2;
        Throwable th2;
        long j7;
        ...
        for (IOOMCallback iOOMCallback : listA) {
            try {
                if (iOOMCallback instanceof com.apm.insight.b) {
                    ...
                    j7 = j6;
                    try {
                        ((com.apm.insight.b) iOOMCallback).a(crashType, th2, thread2, j7, this.f6161k);
                    } catch (Throwable th3) {
                        th = th3;
                    ...
                    th2 = th;
                    j7 = j6;
                    iOOMCallback.onCrash(crashType, th2, thread2, j7);
                }
            } catch (Throwable th4) {
                th = th4;
                thread2 = thread;
    ...
    public final void a(String str) {
        this.f6159g.put(str, new Object());
    }
