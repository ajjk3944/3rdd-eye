...
public final class b implements c {
    ...
    private synchronized void b(final long j6, final Thread thread, final Throwable th, final String str, final String str2, final boolean z6) {
        final File file = new File(j.a(this.f6185a), str);
        ...
        com.apm.insight.entity.a aVarA = com.apm.insight.runtime.a.f.a().a(CrashType.LAUNCH, new c.a() { // from class: com.apm.insight.i.b.1
            ...
            public final com.apm.insight.entity.a a(int i, com.apm.insight.entity.a aVar) throws JSONException {
                this.f6186a = SystemClock.uptimeMillis();
                if (i == 0) {
                    ...
                    if (i == 1) {
                        aVar.a("timestamp", Long.valueOf(j6));
                        aVar.a("main_process", Boolean.valueOf(com.apm.insight.l.a.b(b.this.f6185a)));
                    ...
                    if (i == 2) {
                        if (zC) {
                            com.apm.insight.l.a.a(b.this.f6185a, aVar.c());
                        }
                        aVar.a("launch_did", (Object) a.a(b.this.f6185a));
                        if (e.x()) {
    ...
    public final void a(long j6, Thread thread, Throwable th, String str, String str2, boolean z6) {
        b(j6, thread, th, str, str2, z6);
    }
}
