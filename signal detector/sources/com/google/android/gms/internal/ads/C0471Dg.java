...
public final class C0471Dg extends AbstractC0454Cg {

    /* renamed from: f, reason: collision with root package name */
    public static final Set f7817f = Collections.synchronizedSet(new HashSet());

    /* renamed from: g, reason: collision with root package name */
    public static final DecimalFormat f7818g = new DecimalFormat("#,###");
    ...
    */
    public final boolean b(java.lang.String r31) throws java.io.IOException {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.C0471Dg.b(java.lang.String):boolean");
    }
    ...
    public final File o(File file) {
        return new File(new File(this.f7819d, String.valueOf(file.getName()).concat(".done")).getPath());
    }
}
