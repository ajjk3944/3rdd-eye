...
public final class a {
    ...
    private final Map<Class<? extends d<?, ?>>, b> f6628a = new HashMap();
    ...
    public static WebResourceResponse a(InputStream inputStream, Map<String, String> map) {
        ...
        try {
            ...
            if (strReplace != null ? strReplace.contains("font/ttf") : false) {
                return new WebResourceResponse(str, strSubstring, TTAdConstant.MATE_VALID, "OK", map, inputStream);
            }
    ...
    public final void a(Class<? extends d<?, ?>> cls, com.bykv.vk.openvk.preload.a.b.a aVar) {
        synchronized (this.f6628a) {
            try {
                b bVar = this.f6628a.get(cls);
                if (bVar == null) {
                    bVar = new b(new com.bykv.vk.openvk.preload.a.b.a[0]);
                    this.f6628a.put(cls, bVar);
                }
                bVar.a(aVar);
            } catch (Throwable th) {
                throw th;
