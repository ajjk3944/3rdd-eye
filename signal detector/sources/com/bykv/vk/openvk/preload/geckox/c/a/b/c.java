...
public class c extends com.bykv.vk.openvk.preload.a.d<Pair<Uri, UpdatePackage>, Pair<com.bykv.vk.openvk.preload.geckox.buffer.a, UpdatePackage>> {
    ...
    private com.bykv.vk.openvk.preload.geckox.b f6724d;
    ...
    public final void a(Object... objArr) {
        super.a(objArr);
        this.f6724d = (com.bykv.vk.openvk.preload.geckox.b) objArr[0];
        this.f6725e = (File) objArr[1];
    }
    ...
    public Object a(com.bykv.vk.openvk.preload.a.b<Pair<com.bykv.vk.openvk.preload.geckox.buffer.a, UpdatePackage>> bVar, Pair<Uri, UpdatePackage> pair) throws IOException {
        ...
        try {
            this.f6724d.i().downloadFile(string, length, new BufferOutputStream(aVarA));
            try {
            ...
            aVarA.e();
            StringBuilder sbQ = AbstractC1135f5.q("download patch single file failed, url:", string, ", channel:");
            sbQ.append(updatePackage.getChannel());
            sbQ.append(", pkg id:");
            sbQ.append(updatePackage.getPatch().getId());
