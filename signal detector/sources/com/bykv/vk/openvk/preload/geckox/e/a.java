...
final class a {
    ...
    private volatile File f6746c;

    /* renamed from: d, reason: collision with root package name */
    private volatile Long f6747d;

    /* renamed from: e, reason: collision with root package name */
    private volatile com.bykv.vk.openvk.preload.geckox.e.a.a f6748e;
    ...
    private synchronized com.bykv.vk.openvk.preload.geckox.e.a.a d(String str) {
        ...
        if (file2.exists() && file2.isDirectory()) {
            this.f6748e = new c(fileE);
        } else {
            if (!file.exists() || !file.isFile()) {
                throw new RuntimeException("can not find res, dir:" + fileE.getAbsolutePath());
            }
            this.f6748e = new com.bykv.vk.openvk.preload.geckox.e.a.b(fileE);
        }
        return this.f6748e;
    }
    ...
    private synchronized File e(String str) {
        ...
        if (this.f6747d != null && this.f6747d.longValue() == -1) {
            return null;
        }
        ...
        try {
            if (this.f6747d == null) {
                this.f6747d = g.a(new File(this.f6744a, str));
            }
            if (this.f6747d == null) {
                this.f6747d = -1L;
                bVarA.a();
            ...
            File file = new File(this.f6744a, str2 + str + str2 + this.f6747d + str2 + "using.lock");
            this.f6746c = file.getParentFile();
            com.bykv.vk.openvk.preload.geckox.f.c.a(file.getAbsolutePath());
            File file2 = this.f6746c;
            bVarA.a();
            return file2;
        } catch (Throwable th) {
            bVarA.a();
    ...
    public final InputStream a(String str) {
        return d(this.f6745b).a(a(this.f6745b, str));
    }

    public final boolean b(String str) {
        return d(this.f6745b).b(a(this.f6745b, str));
    }
    ...
    public final void c() throws Exception {
        ...
        try {
            ...
            com.bykv.vk.openvk.preload.geckox.f.c.b(this.f6746c.getAbsolutePath() + str + "using.lock");
            bVarA.a();
            com.bykv.vk.openvk.preload.geckox.a.c.a(this.f6744a + str + this.f6745b);
        } finally {
            bVarA.a();
        }
    }
