...
public class AppCompatImageView extends ImageView {
    ...
    public final C0305b f4863a;

    /* renamed from: b, reason: collision with root package name */
    public final I.d f4864b;
    ...
    public final void drawableStateChanged() {
        ...
        C0305b c0305b = this.f4863a;
        if (c0305b != null) {
            c0305b.a();
        }
        I.d dVar = this.f4864b;
        if (dVar != null) {
            dVar.a();
        }
    }
    ...
    public final boolean hasOverlappingRendering() {
        return !(((ImageView) this.f4864b.f1851c).getBackground() instanceof RippleDrawable) && super.hasOverlappingRendering();
    }
    ...
    public void setImageDrawable(Drawable drawable) {
        I.d dVar = this.f4864b;
        if (dVar != null && drawable != null && !this.f4865c) {
