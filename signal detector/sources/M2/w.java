...
public abstract class w {
    ...
    public static final Uri f2821a = new Uri.Builder().scheme("content").authority("com.google.android.gms.chimera").build();
    ...
    */
    public static android.content.Intent a(android.content.Context r5, M2.D r6) throws android.os.RemoteException, M2.v {
        /*
            java.lang.String r0 = "ServiceBindIntentUtils"
            java.lang.String r1 = r6.f2712a
            r2 = 0
            if (r1 != 0) goto L11
        ...
        L11:
            ...
            android.net.Uri r4 = M2.w.f2821a     // Catch: java.lang.IllegalArgumentException -> L35 android.os.RemoteException -> L37
        ...
        La5:
            ...
            android.content.Intent r5 = new android.content.Intent
            r5.<init>(r1)
            java.lang.String r6 = r6.f2713b
            android.content.Intent r5 = r5.setPackage(r6)
            return r5
        Lb3:
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: M2.w.a(android.content.Context, M2.D):android.content.Intent");
    }
}
