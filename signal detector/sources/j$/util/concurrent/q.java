...
public final class q extends l {
    ...
    public static final j$.sun.misc.a f20753h;
    ...
    public volatile r f20755f;

    /* renamed from: g, reason: collision with root package name */
    public volatile Thread f20756g;
  ...
  0x004b: PHI (r7v3 java.lang.Class<?>) = (r7v2 java.lang.Class<?>), (r7v4 java.lang.Class<?>) binds: [B:24:0x0049, B:16:0x0033] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    public q(j$.util.concurrent.r r11) {
        ...
        L8:
            if (r11 == 0) goto L6c
            j$.util.concurrent.l r2 = r11.f20740d
        ...
        L19:
            ...
            goto L68
        L1b:
            java.lang.Object r4 = r11.f20738b
            int r5 = r11.f20737a
            r6 = r0
            r7 = r1
        L21:
            java.lang.Object r8 = r6.f20738b
            int r9 = r6.f20737a
            if (r9 <= r5) goto L29
            r8 = -1
            goto L51
        ...
        L2d:
            ...
            if (r7 == 0) goto L4b
        L35:
            int r9 = j$.util.concurrent.ConcurrentHashMap.f20707g
            if (r8 == 0) goto L48
        ...
        L51:
            if (r8 > 0) goto L56
            j$.util.concurrent.r r9 = r6.f20758f
            goto L58
        L56:
            j$.util.concurrent.r r9 = r6.f20759g
        L58:
            if (r9 != 0) goto L6a
            r11.f20757e = r6
            if (r8 > 0) goto L61
    ...
    public final void d() {
        ...
        while (true) {
            ...
            if ((i3 & (-3)) == 0) {
                if (f20753h.c(this, i, i3, 1)) {
                    break;
                }
            } else if ((i3 & 2) == 0) {
                if (f20753h.c(this, i, i3, i3 | 2)) {
                    this.f20756g = Thread.currentThread();
                    z6 = true;
                }
            } else if (z6) {
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final j$.util.concurrent.l a(java.lang.Object r9, int r10) {
        /*
            r8 = this;
            j$.util.concurrent.r r0 = r8.f20755f
        L2:
            r1 = 0
            if (r0 == 0) goto L59
            int r6 = r8.lockState
            ...
            int r1 = r0.f20737a
            if (r1 != r10) goto L1c
            java.lang.Object r1 = r0.f20738b
            if (r1 == r9) goto L1b
            if (r1 == 0) goto L1c
        ...
        L1b:
            return r0
        L1c:
            j$.util.concurrent.l r0 = r0.f20740d
            r3 = r8
            goto L2
        L20:
            j$.sun.misc.a r2 = j$.util.concurrent.q.f20753h
            ...
            if (r6 == 0) goto L2
            r6 = 6
            j$.util.concurrent.r r0 = r3.f20754e     // Catch: java.lang.Throwable -> L45
            if (r0 != 0) goto L33
            goto L37
        L33:
            j$.util.concurrent.r r1 = r0.b(r10, r9, r1)     // Catch: java.lang.Throwable -> L45
        L37:
            int r9 = r2.e(r8, r4)
            if (r9 != r6) goto L44
            java.lang.Thread r9 = r3.f20756g
            if (r9 == 0) goto L44
        ...
        L45:
            r0 = move-exception
            r9 = r0
            j$.sun.misc.a r10 = j$.util.concurrent.q.f20753h
            long r0 = j$.util.concurrent.q.i
            int r10 = r10.e(r8, r0)
            if (r10 != r6) goto L58
            java.lang.Thread r10 = r3.f20756g
            if (r10 == 0) goto L58
        ...
        L59:
            ...
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: j$.util.concurrent.q.a(java.lang.Object, int):j$.util.concurrent.l");
    }
    ...
    */
    public final j$.util.concurrent.r e(int r12, java.lang.Object r13, java.lang.Object r14) {
        /*
            r11 = this;
            j$.util.concurrent.r r0 = r11.f20754e
            r7 = 0
            r8 = 0
            r6 = r0
            r0 = r7
        ...
        L20:
            ...
            goto L70
        L24:
            java.lang.Object r4 = r6.f20738b
            if (r4 == r13) goto Lac
            if (r4 == 0) goto L32
        ...
        L32:
            ...
            if (r0 == 0) goto L50
        L3a:
            int r5 = j$.util.concurrent.ConcurrentHashMap.f20707g
            if (r4 == 0) goto L4d
        ...
        L50:
            if (r1 != 0) goto L6a
            j$.util.concurrent.r r1 = r6.f20758f
            if (r1 == 0) goto L5e
        ...
        L5d:
            return r1
        L5e:
            j$.util.concurrent.r r1 = r6.f20759g
            if (r1 == 0) goto L69
            j$.util.concurrent.r r1 = r1.b(r12, r13, r0)
            if (r1 == 0) goto L69
            return r1
        ...
        L70:
            if (r10 > 0) goto L75
            j$.util.concurrent.r r4 = r6.f20758f
            goto L77
        L75:
            j$.util.concurrent.r r4 = r6.f20759g
        L77:
            if (r4 != 0) goto La9
            j$.util.concurrent.r r5 = r11.f20755f
            j$.util.concurrent.r r1 = new j$.util.concurrent.r
            r2 = r12
            r3 = r13
            r4 = r14
        ...
        L97:
            r11.d()
            j$.util.concurrent.r r0 = r11.f20754e     // Catch: java.lang.Throwable -> La5
            j$.util.concurrent.r r0 = c(r0, r1)     // Catch: java.lang.Throwable -> La5
            r11.f20754e = r0     // Catch: java.lang.Throwable -> La5
            r11.lockState = r8
            return r7
        La5:
            r0 = move-exception
  ...
  0x008e: PHI (r0v4 j$.util.concurrent.r) = (r0v3 j$.util.concurrent.r), (r0v12 j$.util.concurrent.r) binds: [B:55:0x008a, B:51:0x0083] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    ...
    public static r g(r rVar, r rVar2) {
        r rVar3;
        if (rVar2 != null && (rVar3 = rVar2.f20759g) != null) {
            r rVar4 = rVar3.f20758f;
            rVar2.f20759g = rVar4;
            if (rVar4 != null) {
                rVar4.f20757e = rVar2;
            }
            r rVar5 = rVar2.f20757e;
            rVar3.f20757e = rVar5;
            if (rVar5 == null) {
                rVar3.i = false;
                rVar = rVar3;
            } else if (rVar5.f20758f == rVar2) {
                rVar5.f20758f = rVar3;
            } else {
                rVar5.f20759g = rVar3;
            }
    ...
    public static r h(r rVar, r rVar2) {
        r rVar3;
        if (rVar2 != null && (rVar3 = rVar2.f20758f) != null) {
            r rVar4 = rVar3.f20759g;
            rVar2.f20758f = rVar4;
            if (rVar4 != null) {
                rVar4.f20757e = rVar2;
            }
    ...
    public static r c(r rVar, r rVar2) {
        ...
        rVar2.i = true;
        while (true) {
            r rVar4 = rVar2.f20757e;
            if (rVar4 == null) {
                rVar2.i = false;
                return rVar2;
            }
            if (!rVar4.i || (rVar3 = rVar4.f20757e) == null) {
                break;
            }
            r rVar5 = rVar3.f20758f;
            if (rVar4 == rVar5) {
                r rVar6 = rVar3.f20759g;
                if (rVar6 != null && rVar6.i) {
                    ...
                    if (rVar2 == rVar4.f20759g) {
                        rVar = g(rVar, rVar4);
                        r rVar7 = rVar4.f20757e;
                        rVar3 = rVar7 == null ? null : rVar7.f20757e;
                        rVar4 = rVar7;
                        rVar2 = rVar4;
                    }
                    if (rVar4 != null) {
                ...
                if (rVar2 == rVar4.f20758f) {
                    rVar = h(rVar, rVar4);
                    r rVar8 = rVar4.f20757e;
                    rVar3 = rVar8 == null ? null : rVar8.f20757e;
                    rVar4 = rVar8;
                    rVar2 = rVar4;
                }
                if (rVar4 != null) {
    ...
    public static r b(r rVar, r rVar2) {
        while (rVar2 != null && rVar2 != rVar) {
            ...
            r rVar4 = rVar3.f20758f;
            if (rVar4 == rVar2) {
                r rVar5 = rVar3.f20759g;
                if (rVar5 != null && rVar5.i) {
                    rVar5.i = false;
                    rVar3.i = true;
                    rVar = g(rVar, rVar3);
                    rVar3 = rVar2.f20757e;
                    rVar5 = rVar3 == null ? null : rVar3.f20759g;
                }
                if (rVar5 != null) {
                    r rVar6 = rVar5.f20758f;
                    r rVar7 = rVar5.f20759g;
                    if ((rVar7 == null || !rVar7.i) && (rVar6 == null || !rVar6.i)) {
                        ...
                        if (rVar7 == null || !rVar7.i) {
                            ...
                            rVar = h(rVar, rVar5);
                            rVar3 = rVar2.f20757e;
                            rVar5 = rVar3 != null ? rVar3.f20759g : null;
                        }
                        if (rVar5 != null) {
                            rVar5.i = rVar3 == null ? false : rVar3.i;
                            r rVar8 = rVar5.f20759g;
                            if (rVar8 != null) {
                                rVar8.i = false;
                            }
                        }
                ...
                if (rVar4 != null && rVar4.i) {
                    ...
                    rVar = h(rVar, rVar3);
                    rVar3 = rVar2.f20757e;
                    rVar4 = rVar3 == null ? null : rVar3.f20758f;
                }
                if (rVar4 != null) {
                    r rVar9 = rVar4.f20758f;
                    r rVar10 = rVar4.f20759g;
                    if ((rVar9 == null || !rVar9.i) && (rVar10 == null || !rVar10.i)) {
                        ...
                        if (rVar9 == null || !rVar9.i) {
                            ...
                            rVar = g(rVar, rVar4);
                            rVar3 = rVar2.f20757e;
                            rVar4 = rVar3 != null ? rVar3.f20758f : null;
                        }
                        if (rVar4 != null) {
                            rVar4.i = rVar3 == null ? false : rVar3.i;
                            r rVar11 = rVar4.f20758f;
                            if (rVar11 != null) {
                                rVar11.i = false;
                            }
                        }
