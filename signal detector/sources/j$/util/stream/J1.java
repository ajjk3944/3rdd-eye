...
public final class J1 extends S1 implements R1 {
    ...
    public final /* synthetic */ Supplier f20892b;

    /* renamed from: c, reason: collision with root package name */
    public final /* synthetic */ BiConsumer f20893c;

    /* renamed from: d, reason: collision with root package name */
    public final /* synthetic */ BinaryOperator f20894d;
    ...
    public final void i(R1 r12) {
        this.f20964a = this.f20894d.apply(this.f20964a, ((J1) r12).f20964a);
    }

    @Override // j$.util.stream.InterfaceC2472o2
    public final void c(long j6) {
        this.f20964a = this.f20892b.get();
    }

    @Override // java.util.function.Consumer
    /* renamed from: accept */
    public final void o(Object obj) {
        this.f20893c.accept(this.f20964a, obj);
    }

    public J1(Supplier supplier, BiConsumer biConsumer, BinaryOperator binaryOperator) {
        this.f20892b = supplier;
        this.f20893c = biConsumer;
        this.f20894d = binaryOperator;
    }
}
