...
public final class i extends PhoneStateListener {
    ...
    public final /* synthetic */ l f3717b;
        ...
        switch (this.f3716a) {
            case 0:
                ...
                if (textView != null) {
                    ...
                    TelephonyManager telephonyManager = lVar.f3738o0;
                ...
                Context contextM2 = lVar.m();
                String str = lVar.f3736m0;
                q5.i.e(str, "string");
                if (contextM2 != null && G.c.a(contextM2, str) == 0) {
                    String str2 = "5G";
                    if (Build.VERSION.SDK_INT < 24) {
                        TextView textView2 = lVar.f3721B0;
                        if (textView2 != null) {
                            TelephonyManager telephonyManager2 = lVar.f3738o0;
                        ...
                        TextView textView3 = lVar.f3721B0;
                        if (textView3 != null) {
                            TelephonyManager telephonyManager3 = lVar.f3738o0;
            ...
            default:
                super.onServiceStateChanged(serviceState);
                l lVar2 = this.f3717b;
                TextView textView4 = lVar2.f3720A0;
                if (textView4 != null) {
                    Context contextM3 = lVar2.m();
                    TelephonyManager telephonyManager4 = lVar2.f3738o0;
                ...
                Context contextM4 = lVar2.m();
                String str3 = lVar2.f3736m0;
                q5.i.e(str3, "string");
                if (contextM4 != null && G.c.a(contextM4, str3) == 0) {
                    String str4 = "5G";
                    if (Build.VERSION.SDK_INT < 24) {
                        TextView textView5 = lVar2.f3721B0;
                        if (textView5 != null) {
                            TelephonyManager telephonyManager5 = lVar2.f3738o0;
                        ...
                        TextView textView6 = lVar2.f3721B0;
                        if (textView6 != null) {
                            TelephonyManager telephonyManager6 = lVar2.f3738o0;
    ...
    public final void onSignalStrengthsChanged(SignalStrength signalStrength) {
        switch (this.f3716a) {
            case 0:
                ...
                l.Y(this.f3717b, signalStrength);
                break;
            default:
                super.onSignalStrengthsChanged(signalStrength);
                l.Y(this.f3717b, signalStrength);
