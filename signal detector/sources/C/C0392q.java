...
public final class C0392q extends a4.t {
    @Override // a4.t
    public void t(C0375O c0375o, C0375O c0375o2, Window window, View view, boolean z6, boolean z7) {
        ...
        window.setNavigationBarColor(c0375o2.f5816b);
        C0152f c0152f = new C0152f(view);
        int i = Build.VERSION.SDK_INT;
        (i >= 35 ? new v0(window, c0152f) : i >= 30 ? new u0(window, c0152f) : i >= 26 ? new t0(window, c0152f) : new s0(window, c0152f)).D(!z6);
    }
}
