...
public final class t implements TextWatcher, SpanWatcher {
    ...
    public final AtomicInteger f20019b = new AtomicInteger(0);
    ...
    public final void afterTextChanged(Editable editable) {
        ((TextWatcher) this.f20018a).afterTextChanged(editable);
    }

    @Override // android.text.TextWatcher
    public final void beforeTextChanged(CharSequence charSequence, int i, int i3, int i6) {
        ((TextWatcher) this.f20018a).beforeTextChanged(charSequence, i, i3, i6);
    }

    @Override // android.text.SpanWatcher
    public final void onSpanAdded(Spannable spannable, Object obj, int i, int i3) {
        if (this.f20019b.get() <= 0 || !(obj instanceof w)) {
            ((SpanWatcher) this.f20018a).onSpanAdded(spannable, obj, i, i3);
        }
    }
  ...
  0x001c: PHI (r11v1 int) = (r11v0 int), (r11v3 int) binds: [B:8:0x0011, B:12:0x0017] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    public final void onSpanChanged(android.text.Spannable r9, java.lang.Object r10, int r11, int r12, int r13, int r14) {
        /*
            r8 = this;
            java.util.concurrent.atomic.AtomicInteger r0 = r8.f20019b
            int r0 = r0.get()
            if (r0 <= 0) goto Ld
            boolean r0 = r10 instanceof f0.w
            if (r0 == 0) goto Ld
            return
        Ld:
        ...
        L1c:
            ...
            r6 = r13
        L1e:
            java.lang.Object r11 = r8.f20018a
            r1 = r11
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: f0.t.onSpanChanged(android.text.Spannable, java.lang.Object, int, int, int, int):void");
    }

    @Override // android.text.SpanWatcher
    public final void onSpanRemoved(Spannable spannable, Object obj, int i, int i3) {
        if (this.f20019b.get() <= 0 || !(obj instanceof w)) {
            ((SpanWatcher) this.f20018a).onSpanRemoved(spannable, obj, i, i3);
        }
    }

    @Override // android.text.TextWatcher
    public final void onTextChanged(CharSequence charSequence, int i, int i3, int i6) {
        ((TextWatcher) this.f20018a).onTextChanged(charSequence, i, i3, i6);
    }
}
