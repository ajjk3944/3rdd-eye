...
public abstract class ru3 {
    ...
    public static qu3 d(ECPoint eCPoint, BigInteger bigInteger) {
        if (eCPoint.equals(ECPoint.POINT_INFINITY)) {
            return qu3.d;
        }
        BigInteger bigIntegerMod = new BigInteger(1, hw3.a((bigInteger.bitLength() + 8) / 8)).mod(bigInteger);
        BigInteger bigIntegerMod2 = bigIntegerMod.multiply(bigIntegerMod).mod(bigInteger);
        return new qu3(eCPoint.getAffineX().multiply(bigIntegerMod2).mod(bigInteger), eCPoint.getAffineY().multiply(bigIntegerMod2.multiply(bigIntegerMod).mod(bigInteger)).mod(bigInteger), bigIntegerMod);
    }

    public static qu3 e(qu3 qu3Var, BigInteger bigInteger, BigInteger bigInteger2) {
        BigInteger bigInteger3 = qu3Var.b;
        if (bigInteger3.equals(BigInteger.ZERO)) {
            return qu3.d;
        }
        BigInteger bigInteger4 = qu3Var.a;
        ...
        BigInteger bigInteger5 = qu3Var.c;
        ...
        return new qu3(bigIntegerMod5, bigIntegerMod6, bigIntegerAdd3.multiply(bigIntegerAdd3).mod(bigInteger2).subtract(bigIntegerMod2).subtract(bigIntegerMod4).mod(bigInteger2));
    }

    public static qu3 f(qu3 qu3Var, qu3 qu3Var2, BigInteger bigInteger, BigInteger bigInteger2) {
        BigInteger bigInteger3 = qu3Var.c;
        BigInteger bigInteger4 = BigInteger.ZERO;
        if (bigInteger3.equals(bigInteger4)) {
            return qu3Var2;
        }
        if (qu3Var2.c.equals(bigInteger4)) {
            return qu3Var;
        }
        BigInteger bigInteger5 = qu3Var.c;
        BigInteger bigIntegerMod = bigInteger5.multiply(bigInteger5).mod(bigInteger2);
        BigInteger bigInteger6 = qu3Var2.c;
        BigInteger bigIntegerMod2 = bigInteger6.multiply(bigInteger6).mod(bigInteger2);
        BigInteger bigIntegerMod3 = qu3Var.a.multiply(bigIntegerMod2).mod(bigInteger2);
        BigInteger bigIntegerMod4 = qu3Var2.a.multiply(bigIntegerMod).mod(bigInteger2);
        BigInteger bigIntegerMod5 = qu3Var.b.multiply(bigInteger6).mod(bigInteger2).multiply(bigIntegerMod2).mod(bigInteger2);
        BigInteger bigIntegerMod6 = qu3Var2.b.multiply(bigInteger5).mod(bigInteger2).multiply(bigIntegerMod).mod(bigInteger2);
        if (bigIntegerMod3.equals(bigIntegerMod4)) {
            return !bigIntegerMod5.equals(bigIntegerMod6) ? qu3.d : e(qu3Var, bigInteger, bigInteger2);
        }
        ...
        return new qu3(bigIntegerMod12, bigIntegerMod13, bigIntegerAdd.multiply(bigIntegerAdd).mod(bigInteger2).subtract(bigIntegerMod).subtract(bigIntegerMod2).multiply(bigIntegerMod7).mod(bigInteger2));
    }
