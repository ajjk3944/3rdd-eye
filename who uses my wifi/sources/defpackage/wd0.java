...
public final class wd0 extends e6 implements MenuItem {
    public final iz0 c;
    public Method d;

    public wd0(Context context, iz0 iz0Var) {
        super(context);
        if (iz0Var == null) {
    ...
    public final View getActionView() {
        ...
        return actionView instanceof ud0 ? (View) ((ud0) actionView).f : actionView;
    }
    ...
    public final MenuItem setActionProvider(ActionProvider actionProvider) {
        td0 td0Var = new td0(this, actionProvider);
    ...
    public final MenuItem setOnActionExpandListener(MenuItem.OnActionExpandListener onActionExpandListener) {
        this.c.setOnActionExpandListener(onActionExpandListener != null ? new vd0(this, onActionExpandListener) : null);
        return this;
    }

    @Override // android.view.MenuItem
    public final MenuItem setOnMenuItemClickListener(MenuItem.OnMenuItemClickListener onMenuItemClickListener) {
        this.c.setOnMenuItemClickListener(onMenuItemClickListener != null ? new fz0(this, onMenuItemClickListener) : null);
        return this;
    }
    ...
    public final MenuItem setActionView(int i) {
        iz0 iz0Var = this.c;
        iz0Var.setActionView(i);
        View actionView = iz0Var.getActionView();
        if (actionView instanceof CollapsibleActionView) {
            iz0Var.setActionView(new ud0(actionView));
        }
        return this;
    }
}
