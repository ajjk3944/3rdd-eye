...
public final class x7 {
    ...
    public final int c(RectF rectF) {
        ...
        while (i3 <= i) {
            ...
            StaticLayout staticLayoutA = t7.a(charSequence, (Layout.Alignment) objInvoke, Math.round(rectF.right), maxLines, this.i, this.h, this.k);
    ...
    public final void f(int i, float f) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
