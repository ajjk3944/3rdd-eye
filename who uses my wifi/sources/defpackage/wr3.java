...
public final class wr3 implements ew3 {
    public static final wr3 a = new wr3();
    public static final aw3 b = new aw3(fv3.class, cr3.class, su2.q);
    ...
    public final Object b(jr3 jr3Var, hv3 hv3Var, lv2 lv2Var) throws GeneralSecurityException {
        ...
        for (int i = 0; i < ((List) jr3Var.g).size(); i++) {
            ...
            if (ir3VarO.b.equals(er3.h)) {
                ...
                if (gi2VarA instanceof sr3) {
                    v34VarR0 = ((sr3) gi2VarA).r0();
                } else {
                ...
                ur3 ur3Var = new ur3((cr3) lv2Var.g(ir3VarO), ir3VarO.c);
