...
public abstract class tm0 {
    ...
    public static long a(Context context) {
        ...
        return Build.VERSION.SDK_INT >= 33 ? yg.b(packageManager, context).lastUpdateTime : packageManager.getPackageInfo(context.getPackageName(), 0).lastUpdateTime;
    }
    ...
    */
    public static void c(android.content.Context r19, boolean r20) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.tm0.c(android.content.Context, boolean):void");
    }
}
