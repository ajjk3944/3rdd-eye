...
public final class i61 {
    public static final zn0 v = new zn0(1);
    public int a;
    public final int b;
    public float[] d;
    public float[] e;
    ...
    public int c = -1;
    public final a9 u = new a9(17, this);

    public i61(Context context, CoordinatorLayout coordinatorLayout, i30 i30Var) {
        if (i30Var == null) {
    ...
    */
    public final boolean c(android.view.View r4, float r5, float r6) {
        ...
        L45:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.i61.c(android.view.View, float, float):boolean");
    }
    ...
    public final boolean h(int i, int i2, int i3, int i4) {
        ...
        float f6 = f3 / f4;
        i30 i30Var = this.q;
        overScroller.startScroll(left, top, i5, i6, (int) ((e(i6, i4, i30Var.C()) * f6) + (e(i5, i3, i30Var.B(view)) * f5)));
        n(2);
        return true;
    }
    ...
    public final void j(MotionEvent motionEvent) {
        ...
        if (this.a == 1) {
            if (i(this.c)) {
                ...
                if (i8 != 0) {
                    left = i30Var.o(this.r, left);
                    WeakHashMap weakHashMap = e61.a;
                    this.r.offsetLeftAndRight(left - left2);
                }
                if (i9 != 0) {
                    top = i30Var.p(this.r, top);
                    WeakHashMap weakHashMap2 = e61.a;
                    this.r.offsetTopAndBottom(top - top2);
                }
                if (i8 != 0 || i9 != 0) {
                    i30Var.O(this.r, left, top);
                }
                m(motionEvent);
                return;
            }
    ...
    */
    public final boolean p(android.view.MotionEvent r18) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.i61.p(android.view.MotionEvent):boolean");
    }
