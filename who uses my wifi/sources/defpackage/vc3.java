...
public abstract class vc3 {
    ...
    public static JSONObject a(int i, int i2, int i3, int i4) throws JSONException {
        ...
        try {
            ...
            ob1.w("Error with creating viewStateObject", e);
            return jSONObject;
        }
    }
    ...
    */
    public static boolean e(org.json.JSONObject r7, org.json.JSONObject r8) {
        ...
        Lc:
            r2 = 4
            if (r1 >= r2) goto L24
            java.lang.String[] r2 = defpackage.vc3.b
            r2 = r2[r1]
        ...
        Ldb:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.vc3.e(org.json.JSONObject, org.json.JSONObject):boolean");
    }
}
