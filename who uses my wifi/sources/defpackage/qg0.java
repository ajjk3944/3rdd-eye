...
public final class qg0 {
    ...
    public qg0(ViewGroup viewGroup) {
        this.c = viewGroup;
    }
    ...
    public final boolean a(float f, float f2, boolean z) {
        ...
        if (this.d && (viewParentE = e(0)) != null) {
            try {
                return t61.a(viewParentE, this.c, f, f2, z);
    ...
    public final boolean b(float f, float f2) {
        ...
        if (this.d && (viewParentE = e(0)) != null) {
            try {
                return t61.b(viewParentE, this.c, f, f2);
            } catch (AbstractMethodError e) {
    ...
    public final boolean c(int i, int i2, int i3, int[] iArr, int[] iArr2) {
        ...
        iArr3[0] = 0;
        iArr3[1] = 0;
        if (viewParentE instanceof rg0) {
            ((rg0) viewParentE).c(viewGroup, i, i2, iArr3, i3);
        } else if (i3 == 0) {
            try {
                t61.c(viewParentE, viewGroup, i, i2, iArr3);
            } catch (AbstractMethodError e) {
    ...
    public final boolean d(int i, int i2, int i3, int i4, int[] iArr, int i5, int[] iArr2) {
        ...
        if (this.d && (viewParentE = e(i5)) != null) {
            if (i != 0 || i2 != 0 || i3 != 0 || i4 != 0) {
                ...
                if (viewParentE instanceof sg0) {
                    ((sg0) viewParentE).d(viewGroup, i, i2, i3, i4, i5, iArr3);
                } else {
                    iArr3[0] = iArr3[0] + i3;
                    iArr3[1] = iArr3[1] + i4;
                    if (viewParentE instanceof rg0) {
                        ((rg0) viewParentE).e(viewGroup, i, i2, i3, i4, i5);
                    } else if (i5 == 0) {
                        try {
                            t61.d(viewParentE, viewGroup, i, i2, i3, i4);
                        } catch (AbstractMethodError e) {
        ...
        if (!f(i2)) {
            if (this.d) {
                ...
                for (ViewParent parent = viewGroup.getParent(); parent != null; parent = parent.getParent()) {
                    boolean z = parent instanceof rg0;
                    if (z) {
                        zF = ((rg0) parent).f(view, viewGroup, i, i2);
                    } else if (i2 == 0) {
                        try {
                            zF = t61.f(parent, view, viewGroup, i);
                        } catch (AbstractMethodError e) {
                    ...
                    if (zF) {
                        ...
                        if (z) {
                            ((rg0) parent).a(view, viewGroup, i, i2);
                        } else if (i2 == 0) {
                            try {
                                t61.e(parent, view, viewGroup, i);
    ...
    public final void h(int i) {
        ...
        if (viewParentE != null) {
            boolean z = viewParentE instanceof rg0;
            ViewGroup viewGroup = this.c;
            if (z) {
                ((rg0) viewParentE).b(viewGroup, i);
            } else if (i == 0) {
                try {
                    t61.g(viewParentE, viewGroup);
                } catch (AbstractMethodError e) {
