    ...
    */
    public static int b(double r6) {
        ...
        L73:
            ...
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.qo3.b(double):int");
    }

    public static boolean c(double d) {
        if (um.J(d)) {
            return d == 0.0d || 52 - Long.numberOfTrailingZeros(um.C(d)) <= Math.getExponent(d);
        }
        return false;
    }
}
