...
public final class ji {
    ...
    public final void a(Context context, AttributeSet attributeSet) {
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, zm0.e);
        ...
        for (int i = 0; i < indexCount; i++) {
            ...
            switch (i2) {
                case 1:
                    this.p = ni.f(typedArrayObtainStyledAttributes, index, this.p);
                    break;
                case 2:
                    this.I = typedArrayObtainStyledAttributes.getDimensionPixelSize(index, this.I);
                    break;
                case 3:
                    this.o = ni.f(typedArrayObtainStyledAttributes, index, this.o);
                    break;
                case 4:
                    this.n = ni.f(typedArrayObtainStyledAttributes, index, this.n);
                    break;
                case 5:
                ...
                case 8:
                    ...
                    break;
                case 9:
                    this.v = ni.f(typedArrayObtainStyledAttributes, index, this.v);
                    break;
                case 10:
                    this.u = ni.f(typedArrayObtainStyledAttributes, index, this.u);
                    break;
                case 11:
                ...
                case 23:
                    ...
                    break;
                case 24:
                    this.h = ni.f(typedArrayObtainStyledAttributes, index, this.h);
                    break;
                case 25:
                    this.i = ni.f(typedArrayObtainStyledAttributes, index, this.i);
                    break;
                case 26:
                ...
                case 27:
                    ...
                    break;
                case 28:
                    this.j = ni.f(typedArrayObtainStyledAttributes, index, this.j);
                    break;
                case 29:
                    this.k = ni.f(typedArrayObtainStyledAttributes, index, this.k);
                    break;
                case 30:
                    this.K = typedArrayObtainStyledAttributes.getDimensionPixelSize(index, this.K);
                    break;
                case 31:
                    this.s = ni.f(typedArrayObtainStyledAttributes, index, this.s);
                    break;
                case 32:
                    this.t = ni.f(typedArrayObtainStyledAttributes, index, this.t);
                    break;
                case 33:
                    this.H = typedArrayObtainStyledAttributes.getDimensionPixelSize(index, this.H);
                    break;
                case 34:
                    this.m = ni.f(typedArrayObtainStyledAttributes, index, this.m);
                    break;
                case 35:
                    this.l = ni.f(typedArrayObtainStyledAttributes, index, this.l);
                    break;
                case 36:
                ...
                case 40:
                    ...
                    break;
                case 41:
                    ni.g(this, typedArrayObtainStyledAttributes, index, 0);
                    break;
                case 42:
                    ni.g(this, typedArrayObtainStyledAttributes, index, 1);
                    break;
                default:
                    switch (i2) {
                        case 61:
                            this.z = ni.f(typedArrayObtainStyledAttributes, index, this.z);
                            break;
                        case 62:
                        ...
                        default:
                            switch (i2) {
                                ...
                                case 76:
                                    ...
                                    break;
                                case 77:
                                    this.q = ni.f(typedArrayObtainStyledAttributes, index, this.q);
                                    break;
                                case 78:
                                    this.r = ni.f(typedArrayObtainStyledAttributes, index, this.r);
                                    break;
                                case 79:
