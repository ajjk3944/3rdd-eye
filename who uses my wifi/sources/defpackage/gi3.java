...
public final class gi3 {
    ...
    public gi3(Context context, ExecutorService executorService, wh3 wh3Var, fi3 fi3Var, File file, gk3 gk3Var, long j, dn3 dn3Var) {
        this.a = context;
    ...
    /* JADX WARN: Not initialized variable reg: 0, insn: 0x027c: INVOKE (r0 I:fk3) VIRTUAL call: fk3.c():void A[Catch: all -> 0x027a, MD:():void (m), TRY_ENTER] (LINE:637), block:B:115:0x027c */
    ...
    public final synchronized void a() {
        ...
        try {
            ...
            try {
                try {
                    byte[] bArrM = m54.M("VaL1Wm3LFQTS8VrG634CJrexcardiZdKd3KQwG0TrmE=", false);
                    if (bArrM.length != 32) {
                        throw new ei3();
                    }
                    byte[] bArr = new byte[16];
                    ByteBuffer.wrap(bArrM, 4, 16).get(bArr);
                    for (int i = 0; i < 16; i++) {
                    ...
                    try {
                        ...
                        if (file4.exists()) {
                            ...
                            if (!file5.exists()) {
                                try {
                                    length = file4.length();
                                } catch (ei3 | IOException | NullPointerException unused) {
                                ...
                                if (length <= 0) {
                                    ...
                                    } catch (ei3 | IOException | NullPointerException unused2) {
                                        fileOutputStream = null;
                                    }
                                    if (fileInputStream.read(bArr3) <= 0) {
                                        ...
                                        h54 h54Var = h54.a;
                                        int i2 = u44.a;
                                        vr1 vr1VarE = vr1.E(bArr3, h54.b);
                                        if ("1758913286824".equals(new String(vr1VarE.C().p())) && Arrays.equals(vr1VarE.B().p(), this.c.c(vr1VarE.A().p())) && Arrays.equals(vr1VarE.D().p(), Build.VERSION.SDK.getBytes())) {
                                            fi3 fi3Var2 = this.d;
                                            byte[] bArr4 = this.k;
                                            String str = new String(vr1VarE.A().p());
                                            fi3Var2.getClass();
                                            byte[] bArrA2 = fi3.a(str, bArr4);
                                            file5.createNewFile();
                                            fileOutputStream = new FileOutputStream(file5);
                                            try {
                                                fileOutputStream.write(bArrA2, 0, bArrA2.length);
                                            } catch (ei3 | IOException | NullPointerException unused3) {
                                            } catch (Throwable th5) {
                                                th = th5;
                        ...
                        try {
                            ...
                            for (hi3 hi3Var : this.f) {
                                Pair pairCreate = Pair.create(hi3Var.a, hi3Var.b);
                                HashMap map = this.g;
                                if (!map.containsKey(pairCreate)) {
                                    map.put(pairCreate, this.b.submit(new gs1(this, hi3Var, 13)));
                                }
                            }
                            this.j = true;
                            fk3VarA.c();
                            ...
                            File file6 = this.i;
                            c(file6);
                            d(new File(String.format("%s/%s.dex", file6, "1758913286824")));
                        }
                    } catch (ei3 e2) {
                        e = e2;
                        throw new dg3(e);
