...
public class e {
    ...
    private static Method f202b = null;

    /* renamed from: c, reason: collision with root package name */
    private static boolean f203c = false;

    /* renamed from: d, reason: collision with root package name */
    private static Field f204d;
    ...
    private static boolean a(ActionBar actionBar, KeyEvent keyEvent) {
        if (!f201a) {
            try {
                f202b = actionBar.getClass().getMethod("onMenuKeyEvent", KeyEvent.class);
    ...
    public static boolean e(a aVar, View view, Window.Callback callback, KeyEvent keyEvent) {
        ...
        return Build.VERSION.SDK_INT >= 28 ? aVar.i(keyEvent) : callback instanceof Activity ? b((Activity) callback, keyEvent) : callback instanceof Dialog ? c((Dialog) callback, keyEvent) : (view != null && s.f(view, keyEvent)) || aVar.i(keyEvent);
    }
