...
public class AlertDialogLayout extends i0 {
    ...
    private boolean A(int i2, int i3) throws NoSuchFieldException {
        ...
        if (view2 != null) {
            int i6 = paddingTop - iZ;
            int iMin = Math.min(i5, measuredHeight);
            if (iMin > 0) {
                i5 -= iMin;
                iZ += iMin;
            }
            view2.measure(i2, View.MeasureSpec.makeMeasureSpec(iZ, 1073741824));
    ...
    private static int z(View view) throws NoSuchFieldException {
        int iU = a0.s.u(view);
        if (iU > 0) {
            return iU;
        }
