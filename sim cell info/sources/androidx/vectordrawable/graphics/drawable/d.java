...
public class d {
    ...
    private static class a implements TypeEvaluator<c.b[]> {
        ...
        public c.b[] evaluate(float f2, c.b[] bVarArr, c.b[] bVarArr2) {
            if (!t.c.b(bVarArr, bVarArr2)) {
                throw new IllegalArgumentException("Can't interpolate between two incompatible pathData");
            }
            if (!t.c.b(this.f2260a, bVarArr)) {
                this.f2260a = t.c.f(bVarArr);
            }
            for (int i2 = 0; i2 < bVarArr.length; i2++) {
                this.f2260a[i2].d(bVarArr[i2], bVarArr2[i2], f2);
            }
            return this.f2260a;
        }
    }
    ...
    */
    ...
    private static PropertyValuesHolder e(TypedArray typedArray, int i2, int i3, int i4, String str) {
        ...
        c.b[] bVarArrD = t.c.d(string);
        c.b[] bVarArrD2 = t.c.d(string2);
    ...
    private static int g(Resources resources, Resources.Theme theme, AttributeSet attributeSet, XmlPullParser xmlPullParser) {
        TypedArray typedArrayK = s.g.k(resources, theme, attributeSet, androidx.vectordrawable.graphics.drawable.a.f2244j);
        int i2 = 0;
        TypedValue typedValueL = s.g.l(typedArrayK, xmlPullParser, "value", 0);
    ...
    private static ValueAnimator l(Context context, Resources resources, Resources.Theme theme, AttributeSet attributeSet, ValueAnimator valueAnimator, float f2, XmlPullParser xmlPullParser) {
        TypedArray typedArrayK = s.g.k(resources, theme, attributeSet, androidx.vectordrawable.graphics.drawable.a.f2241g);
        TypedArray typedArrayK2 = s.g.k(resources, theme, attributeSet, androidx.vectordrawable.graphics.drawable.a.f2245k);
        if (valueAnimator == null) {
            valueAnimator = new ValueAnimator();
        }
        q(valueAnimator, typedArrayK, typedArrayK2, f2, xmlPullParser);
        int iH = s.g.h(typedArrayK, xmlPullParser, "interpolator", 0, 0);
        if (iH > 0) {
    ...
    private static Keyframe m(Context context, Resources resources, Resources.Theme theme, AttributeSet attributeSet, int i2, XmlPullParser xmlPullParser) {
        TypedArray typedArrayK = s.g.k(resources, theme, attributeSet, androidx.vectordrawable.graphics.drawable.a.f2244j);
        float f2 = s.g.f(typedArrayK, xmlPullParser, "fraction", 3, -1.0f);
        TypedValue typedValueL = s.g.l(typedArrayK, xmlPullParser, "value", 0);
        boolean z2 = typedValueL != null;
        if (i2 == 4) {
            i2 = (z2 && h(typedValueL.type)) ? 3 : 0;
        }
        Keyframe keyframeOfInt = z2 ? i2 != 0 ? (i2 == 1 || i2 == 3) ? Keyframe.ofInt(f2, s.g.g(typedArrayK, xmlPullParser, "value", 0, 0)) : null : Keyframe.ofFloat(f2, s.g.f(typedArrayK, xmlPullParser, "value", 0, 0.0f)) : i2 == 0 ? Keyframe.ofFloat(f2) : Keyframe.ofInt(f2);
        int iH = s.g.h(typedArrayK, xmlPullParser, "interpolator", 1, 0);
        if (iH > 0) {
    ...
    private static PropertyValuesHolder[] p(Context context, Resources resources, Resources.Theme theme, XmlPullParser xmlPullParser, AttributeSet attributeSet) throws XmlPullParserException, IOException {
        ...
        while (true) {
            ...
            if (eventType == 2 && xmlPullParser.getName().equals("propertyValuesHolder")) {
                TypedArray typedArrayK = s.g.k(resources, theme, attributeSet, androidx.vectordrawable.graphics.drawable.a.f2243i);
                String strI = s.g.i(typedArrayK, xmlPullParser, "propertyName", 3);
                int iG = s.g.g(typedArrayK, xmlPullParser, "valueType", 2, 4);
    ...
    private static void q(ValueAnimator valueAnimator, TypedArray typedArray, TypedArray typedArray2, float f2, XmlPullParser xmlPullParser) {
        long jG = s.g.g(typedArray, xmlPullParser, "duration", 1, 300);
        long jG2 = s.g.g(typedArray, xmlPullParser, "startOffset", 2, 0);
        int iG = s.g.g(typedArray, xmlPullParser, "valueType", 7, 4);
        if (s.g.j(xmlPullParser, "valueFrom") && s.g.j(xmlPullParser, "valueTo")) {
            if (iG == 4) {
                iG = f(typedArray, 5, 6);
            }
        ...
        valueAnimator.setRepeatCount(s.g.g(typedArray, xmlPullParser, "repeatCount", 3, 0));
        valueAnimator.setRepeatMode(s.g.g(typedArray, xmlPullParser, "repeatMode", 4, 1));
        if (typedArray2 != null) {
    ...
    private static void r(ValueAnimator valueAnimator, TypedArray typedArray, int i2, float f2, XmlPullParser xmlPullParser) {
        ...
        String strI = s.g.i(typedArray, xmlPullParser, "pathData", 1);
        if (strI == null) {
            objectAnimator.setPropertyName(s.g.i(typedArray, xmlPullParser, "propertyName", 0));
            return;
        }
        String strI2 = s.g.i(typedArray, xmlPullParser, "propertyXName", 2);
        String strI3 = s.g.i(typedArray, xmlPullParser, "propertyYName", 3);
        if (i2 != 2) {
        }
        if (strI2 != null || strI3 != null) {
            s(t.c.e(strI), objectAnimator, f2 * 0.5f, strI2, strI3);
            return;
        }
